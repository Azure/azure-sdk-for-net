...
namespace Azure.ResourceManager.Sphere
{
    internal partial class CatalogsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<SphereCatalogData>
    {
        ...
        /// <summary> Initializes a new instance of CatalogsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CatalogsGetByResourceGroupAsyncCollectionResultOfT(Catalogs client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CatalogsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
