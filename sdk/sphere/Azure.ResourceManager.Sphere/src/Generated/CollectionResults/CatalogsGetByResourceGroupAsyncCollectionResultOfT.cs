...
namespace Azure.ResourceManager.Sphere
{
    internal partial class CatalogsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<SphereCatalogData>
    {
        ...
        public CatalogsGetByResourceGroupAsyncCollectionResultOfT(Catalogs client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
