...
namespace Azure.ResourceManager.Sphere
{
    internal partial class CatalogsGetDeviceInsightsCollectionResultOfT : Pageable<SphereDeviceInsight>
    {
        ...
        public CatalogsGetDeviceInsightsCollectionResultOfT(Catalogs client, string subscriptionId, string resourceGroupName, string catalogName, string filter, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
