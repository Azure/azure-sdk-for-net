...
{
    internal partial class CatalogsGetDeviceGroupsAsyncCollectionResultOfT : AsyncPageable<SphereDeviceGroupData>
    {
        ...
        /// <summary> Initializes a new instance of CatalogsGetDeviceGroupsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public CatalogsGetDeviceGroupsAsyncCollectionResultOfT(Catalogs client, string subscriptionId, string resourceGroupName, string catalogName, RequestContent content, string filter, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of CatalogsGetDeviceGroupsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of CatalogsGetDeviceGroupsAsyncCollectionResultOfT as an enumerable collection. </returns>
