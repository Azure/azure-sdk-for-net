...
namespace Azure.ResourceManager.Sphere
{
    internal partial class CatalogsGetDeviceGroupsAsyncCollectionResultOfT : AsyncPageable<SphereDeviceGroupData>
    {
        ...
        public CatalogsGetDeviceGroupsAsyncCollectionResultOfT(Catalogs client, string subscriptionId, string resourceGroupName, string catalogName, RequestContent content, string filter, int? maxCount, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
