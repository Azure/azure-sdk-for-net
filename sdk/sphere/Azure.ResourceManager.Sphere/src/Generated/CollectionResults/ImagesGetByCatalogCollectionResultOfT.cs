...
namespace Azure.ResourceManager.Sphere
{
    internal partial class ImagesGetByCatalogCollectionResultOfT : Pageable<SphereImageData>
    {
        ...
        /// <summary> Initializes a new instance of ImagesGetByCatalogCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ImagesGetByCatalogCollectionResultOfT(Images client, string subscriptionId, string resourceGroupName, string catalogName, string filter, int? maxCount, int? skip, int? maxpagesize, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ImagesGetByCatalogCollectionResultOfT as an enumerable collection. </summary>
