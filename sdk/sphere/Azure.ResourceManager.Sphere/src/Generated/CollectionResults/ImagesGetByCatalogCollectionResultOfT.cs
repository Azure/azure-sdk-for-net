...
namespace Azure.ResourceManager.Sphere
{
    internal partial class ImagesGetByCatalogCollectionResultOfT : Pageable<SphereImageData>
    {
        ...
        public ImagesGetByCatalogCollectionResultOfT(Images client, string subscriptionId, string resourceGroupName, string catalogName, string filter, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
