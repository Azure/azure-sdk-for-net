...
namespace Azure.ResourceManager.Sphere
{
    internal partial class CertificatesGetByCatalogCollectionResultOfT : Pageable<SphereCertificateData>
    {
        ...
        public CertificatesGetByCatalogCollectionResultOfT(Certificates client, string subscriptionId, string resourceGroupName, string catalogName, string filter, int? maxCount, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
