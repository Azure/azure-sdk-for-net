...
namespace Azure.ResourceManager.Sphere
{
    internal partial class CertificatesGetByCatalogAsyncCollectionResultOfT : AsyncPageable<SphereCertificateData>
    {
        ...
        public CertificatesGetByCatalogAsyncCollectionResultOfT(Certificates client, string subscriptionId, string resourceGroupName, string catalogName, string filter, int? top, int? skip, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
