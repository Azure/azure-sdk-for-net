...
namespace Azure.ResourceManager.Sphere
{
    ...
    public partial class SphereDeviceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SphereDeviceResource>> UpdateAsync(WaitUntil waitUntil, SphereDeviceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _devicesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, SphereDeviceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SphereArmOperation<SphereDeviceResource> operation = new SphereArmOperation<SphereDeviceResource>(
                    new SphereDeviceResourceOperationSource(Client),
                    _devicesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SphereDeviceResource> Update(WaitUntil waitUntil, SphereDeviceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
