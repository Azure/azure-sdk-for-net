...
namespace Azure.ResourceManager.Sphere
{
    ...
    public partial class DeploymentResource : IJsonModel<DeploymentData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeploymentData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<DeploymentData>(Data, options, AzureResourceManagerSphereContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DeploymentData IPersistableModel<DeploymentData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<DeploymentData>(data, options, AzureResourceManagerSphereContext.Default);
