...
namespace Azure.ResourceManager.Sphere
{
    ...
    public partial class SphereDeploymentCollection : ArmCollection, IEnumerable<SphereDeploymentResource>, IAsyncEnumerable<SphereDeploymentResource>
    {
        ...
        /// <summary> Initializes a new instance of SphereDeploymentCollection for mocking. </summary>
        protected SphereDeploymentCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SphereDeploymentCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<SphereDeploymentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string deploymentName, SphereDeploymentData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _deploymentsClientDiagnostics.CreateScope("SphereDeploymentCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SphereDeploymentResource>> GetAsync(string deploymentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _deploymentsClientDiagnostics.CreateScope("SphereDeploymentCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<SphereDeploymentResource> GetAllAsync(string filter = default, int? maxCount = default, int? skip = default, int? maxpagesize = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SphereDeploymentResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SphereDeploymentResource> GetAll(string filter = default, int? maxCount = default, int? skip = default, int? maxpagesize = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string deploymentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _deploymentsClientDiagnostics.CreateScope("SphereDeploymentCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<SphereDeploymentData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(SphereDeploymentData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((SphereDeploymentData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<SphereDeploymentResource>> GetIfExistsAsync(string deploymentName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _deploymentsClientDiagnostics.CreateScope("SphereDeploymentCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
