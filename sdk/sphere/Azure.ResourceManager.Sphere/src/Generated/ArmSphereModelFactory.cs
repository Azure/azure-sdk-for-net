...
namespace Azure.ResourceManager.Sphere.Models
{
    ...
    public static partial class ArmSphereModelFactory
    {
        ...
        public static SphereCatalogData SphereCatalogData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SphereProvisioningState? provisioningState = null)
        {
            ...
            return new SphereCatalogData(id, name, resourceType, systemData, tags, location, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SphereCertificateData(id, name, resourceType, systemData, certificate, status, subject, thumbprint, expiryUtc, notBeforeUtc, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SphereCertificateProperties(certificate, status, subject, thumbprint, expiryUtc, notBeforeUtc, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SphereCertificateChainResult(certificateChain, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProofOfPossessionNonceResponse(certificate, status, subject, thumbprint, expiryUtc, notBeforeUtc, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CountDeviceResult(value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CountElementsResult(value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SphereImageData(id, name, resourceType, systemData, image, imageId, imageName, regionalDataBoundary, uri, description, componentId, imageType, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static SphereDeploymentData SphereDeploymentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string deploymentId = null, IEnumerable<SphereImageData> deployedImages = null, DateTimeOffset? deploymentDateUtc = null, SphereProvisioningState? provisioningState = null)
        {
            ...
            return new SphereDeploymentData(id, name, resourceType, systemData, deploymentId, deployedImages?.ToList(), deploymentDateUtc, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SphereDeviceGroupData(id, name, resourceType, systemData, description, osFeedType, updatePolicy, allowCrashDumpsCollection, regionalDataBoundary, hasDeployment, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SphereDeviceInsight(deviceId, description, startTimestampUtc, endTimestampUtc, eventCategory, eventClass, eventType, eventCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SphereDeviceData(id, name, resourceType, systemData, deviceId, chipSku, lastAvailableOSVersion, lastInstalledOSVersion, lastOSUpdateUtc, lastUpdateRequestUtc, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SphereProductData(id, name, resourceType, systemData, description, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SignedCapabilityImageResponse(image, new Dictionary<string, BinaryData>());
        }
    }
}
