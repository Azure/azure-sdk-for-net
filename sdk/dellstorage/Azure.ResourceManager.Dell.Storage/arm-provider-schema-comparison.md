# ARM provider schema comparison: Azure.ResourceManager.Dell.Storage
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dell.Storage/filesystems/{filesystemName}` | `DellFileSystem` | `FileSystemResource` |
