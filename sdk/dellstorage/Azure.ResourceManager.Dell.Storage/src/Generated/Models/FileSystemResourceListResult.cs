...
namespace Azure.ResourceManager.Dell.Storage.Models
{
    ...
    internal partial class FileSystemResourceListResult
    {
        ...
        internal FileSystemResourceListResult(IList<DellFileSystemData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<DellFileSystemData> Value { get; }
