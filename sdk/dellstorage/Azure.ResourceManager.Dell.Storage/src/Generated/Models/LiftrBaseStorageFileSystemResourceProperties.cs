...
namespace Azure.ResourceManager.Dell.Storage.Models
{
    ...
    public partial class LiftrBaseStorageFileSystemResourceProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseStorageFileSystemResourceProperties"/>. </summary>
        ...
        public LiftrBaseStorageFileSystemResourceProperties(LiftrBaseMarketplaceDetails marketplace, string delegatedSubnetId, string delegatedSubnetCidr, LiftrBaseUserDetails user, string dellReferenceNumber, LiftrBaseEncryptionProperties encryption)
        {
        ...
        internal LiftrBaseStorageFileSystemResourceProperties(LiftrBaseStorageCapacity capacity, LiftrBaseMarketplaceDetails marketplace, ProvisioningState? provisioningState, string delegatedSubnetId, string delegatedSubnetCidr, LiftrBaseUserDetails user, string fileSystemId, string smartConnectFqdn, string oneFsUri, string dellReferenceNumber, LiftrBaseEncryptionProperties encryption, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Capacity = capacity;
            Marketplace = marketplace;
        ...
        /// <summary> Initializes a new instance of <see cref="LiftrBaseStorageFileSystemResourceProperties"/> for deserialization. </summary>
        internal LiftrBaseStorageFileSystemResourceProperties()
        {
        }

        /// <summary> Capacity for Dell Filesystem, Will be received as part of Job Status. </summary>
        public LiftrBaseStorageCapacity Capacity { get; set; }
        ...
        internal LiftrBaseUserDetails User { get; set; }
        /// <summary> User Email. </summary>
        public string UserEmail
        {
            get => User is null ? default : User.Email;
            set => User = new LiftrBaseUserDetails(value);
        }
        ...
        public LiftrBaseEncryptionProperties Encryption { get; set; }
    }
}
