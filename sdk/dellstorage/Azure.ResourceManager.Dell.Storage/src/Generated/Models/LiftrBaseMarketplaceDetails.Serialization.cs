...
namespace Azure.ResourceManager.Dell.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LiftrBaseMarketplaceDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LiftrBaseMarketplaceDetails)} does not support writing '{format}' format.");
            }
        ...
        LiftrBaseMarketplaceDetails IJsonModel<LiftrBaseMarketplaceDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LiftrBaseMarketplaceDetails)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LiftrBaseMarketplaceDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LiftrBaseMarketplaceDetails)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        LiftrBaseMarketplaceDetails IPersistableModel<LiftrBaseMarketplaceDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LiftrBaseMarketplaceDetails)} does not support reading '{options.Format}' format.");
            }
        }
