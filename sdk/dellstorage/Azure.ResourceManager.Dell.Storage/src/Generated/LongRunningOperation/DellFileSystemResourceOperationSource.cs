...
{
    /// <summary></summary>
    internal partial class DellFileSystemResourceOperationSource : IOperationSource<DellFileSystemResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DellFileSystemResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
