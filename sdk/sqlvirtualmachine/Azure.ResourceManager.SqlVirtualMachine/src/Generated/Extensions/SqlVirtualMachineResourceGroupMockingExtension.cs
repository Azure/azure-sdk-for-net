...
namespace Azure.ResourceManager.SqlVirtualMachine.Mocking
{
    ...
    internal partial class SqlVirtualMachineResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SqlVirtualMachineResourceGroupMockingExtension"/> class for mocking. </summary>
        protected SqlVirtualMachineResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SqlVirtualMachineResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SqlVirtualMachineResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
