...
namespace Azure.ResourceManager.SqlVirtualMachine.Mocking
{
    ...
    internal partial class SqlVirtualMachineArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SqlVirtualMachineArmClientMockingExtension"/> class for mocking. </summary>
        protected SqlVirtualMachineArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SqlVirtualMachineArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SqlVirtualMachineArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal SqlVirtualMachineArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
