...
namespace Azure.ResourceManager.SqlVirtualMachine.Mock
{
    ...
    public partial class SqlVmResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SqlVmResourceExtension"/> class for mocking. </summary>
        protected SqlVmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SqlVmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SqlVmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<SqlVmResource> GetSqlVmsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new SqlVmResource(Client, SqlVmData.DeserializeSqlVmData(e)), SqlVmSqlVirtualMachinesClientDiagnostics, Pipeline, "SqlVmResourceExtension.GetSqlVms", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SqlVmResource> GetSqlVms(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => SqlVmSqlVirtualMachinesRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => SqlVmSqlVirtualMachinesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new SqlVmResource(Client, SqlVmData.DeserializeSqlVmData(e)), SqlVmSqlVirtualMachinesClientDiagnostics, Pipeline, "SqlVmResourceExtension.GetSqlVms", "value", "nextLink", cancellationToken);
        }
    }
}
