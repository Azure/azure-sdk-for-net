...
namespace Azure.ResourceManager.SqlVirtualMachine
{
    ...
    public partial class SqlVmGroupResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SqlVmGroupResource>> UpdateAsync(WaitUntil waitUntil, SqlVmGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _sqlVirtualMachineGroupsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, SqlVmGroupData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SqlVirtualMachineArmOperation<SqlVmGroupResource> operation = new SqlVirtualMachineArmOperation<SqlVmGroupResource>(
                    new SqlVmGroupResourceOperationSource(Client),
                    _sqlVirtualMachineGroupsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SqlVmGroupResource> Update(WaitUntil waitUntil, SqlVmGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
