...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class SqlTempDBSettings
    {
        ...
        internal SqlTempDBSettings(int? dataFileSize, int? dataGrowth, int? logFileSize, int? logGrowth, int? dataFileCount, bool? persistFolder, string persistFolderPath, IList<int> logicalUnitNumbers, string defaultFilePath, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
