...
{
    public partial class MultiSubnetIPConfiguration : IUtf8JsonSerializable, IJsonModel<MultiSubnetIPConfiguration>, IPersistableModel<MultiSubnetIPConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrivateIPAddress))
            {
                ...
                AppendChildObject(builder, PrivateIPAddress, options, 2);
            }

            if (Optional.IsDefined(SqlVmInstance))
            {
                builder.Append("  sqlVirtualMachineInstance:");
                builder.AppendLine($" '{SqlVmInstance}'");
            }
