...
{
    internal partial class AdditionalFeaturesServerConfigurations : IUtf8JsonSerializable, IJsonModel<AdditionalFeaturesServerConfigurations>, IPersistableModel<AdditionalFeaturesServerConfigurations>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdditionalFeaturesServerConfigurations>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsRServicesEnabled))
            {
                builder.Append("  isRServicesEnabled:");
                var boolValue = IsRServicesEnabled.Value == true ? "true" : "false";
