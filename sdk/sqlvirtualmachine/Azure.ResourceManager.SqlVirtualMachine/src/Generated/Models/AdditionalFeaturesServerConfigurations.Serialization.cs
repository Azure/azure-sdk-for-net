...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdditionalFeaturesServerConfigurations>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdditionalFeaturesServerConfigurations>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdditionalFeaturesServerConfigurations>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdditionalFeaturesServerConfigurations>)} interface");
            }
        ...
        string IPersistableModel<AdditionalFeaturesServerConfigurations>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
