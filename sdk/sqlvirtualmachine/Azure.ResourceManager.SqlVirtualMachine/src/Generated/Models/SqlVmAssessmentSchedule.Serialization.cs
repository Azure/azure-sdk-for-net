...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    public partial class SqlVmAssessmentSchedule : IUtf8JsonSerializable, IJsonModel<SqlVmAssessmentSchedule>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlVmAssessmentSchedule>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlVmAssessmentSchedule>)} interface");
            }
