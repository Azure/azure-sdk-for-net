...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlVmAssessmentSchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlVmAssessmentSchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlVmAssessmentSchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SqlVmAssessmentSchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
