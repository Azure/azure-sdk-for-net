...
{
    public partial class SqlVmAssessmentSchedule : IUtf8JsonSerializable, IJsonModel<SqlVmAssessmentSchedule>, IPersistableModel<SqlVmAssessmentSchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WeeklyInterval))
            {
                ...
                builder.AppendLine($" '{WeeklyInterval.Value.ToString()}'");
            }

            if (Optional.IsDefined(MonthlyOccurrence))
            {
                builder.Append("  monthlyOccurrence:");
                builder.AppendLine($" '{MonthlyOccurrence.Value.ToString()}'");
            }
