...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class SqlStorageUpdateSettings
    {
        ...
        internal SqlStorageUpdateSettings(int? diskCount, int? startingDeviceId, SqlVmDiskConfigurationType? diskConfigurationType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DiskCount = diskCount;
