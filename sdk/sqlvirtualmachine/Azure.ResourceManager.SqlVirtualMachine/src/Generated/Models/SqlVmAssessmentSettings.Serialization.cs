...
{
    public partial class SqlVmAssessmentSettings : IUtf8JsonSerializable, IJsonModel<SqlVmAssessmentSettings>, IPersistableModel<SqlVmAssessmentSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RunImmediately))
            {
                builder.Append("  runImmediately:");
                var boolValue = RunImmediately.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
