...
{
    public partial class WindowsServerFailoverClusterDomainProfile : IUtf8JsonSerializable, IJsonModel<WindowsServerFailoverClusterDomainProfile>, IPersistableModel<WindowsServerFailoverClusterDomainProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterSubnetType))
            {
                ...
                builder.AppendLine($" '{ClusterSubnetType.ToString()}'");
            }
