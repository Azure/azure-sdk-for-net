...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WindowsServerFailoverClusterDomainProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WindowsServerFailoverClusterDomainProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WindowsServerFailoverClusterDomainProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WindowsServerFailoverClusterDomainProfile>)} interface");
            }
        ...
        string IPersistableModel<WindowsServerFailoverClusterDomainProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
