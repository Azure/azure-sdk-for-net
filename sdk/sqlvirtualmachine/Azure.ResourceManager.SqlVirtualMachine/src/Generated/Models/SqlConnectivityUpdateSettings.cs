...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class SqlConnectivityUpdateSettings
    {
        ...
        internal SqlConnectivityUpdateSettings(SqlServerConnectivityType? connectivityType, int? port, string sqlAuthUpdateUserName, string sqlAuthUpdatePassword, Dictionary<string, BinaryData> rawData)
        {
