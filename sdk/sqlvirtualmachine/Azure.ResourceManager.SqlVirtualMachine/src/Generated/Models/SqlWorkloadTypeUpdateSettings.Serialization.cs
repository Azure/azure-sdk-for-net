...
{
    internal partial class SqlWorkloadTypeUpdateSettings : IUtf8JsonSerializable, IJsonModel<SqlWorkloadTypeUpdateSettings>, IPersistableModel<SqlWorkloadTypeUpdateSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SqlWorkloadType))
            {
                builder.Append("  sqlWorkloadType:");
                builder.AppendLine($" '{SqlWorkloadType.ToString()}'");
            }
