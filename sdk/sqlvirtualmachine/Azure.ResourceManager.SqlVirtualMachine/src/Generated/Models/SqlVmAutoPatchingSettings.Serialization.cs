...
{
    public partial class SqlVmAutoPatchingSettings : IUtf8JsonSerializable, IJsonModel<SqlVmAutoPatchingSettings>, IPersistableModel<SqlVmAutoPatchingSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaintenanceWindowStartingHour))
            {
                ...
                builder.AppendLine($" '{MaintenanceWindowStartingHour.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaintenanceWindowDurationInMinutes))
            {
                builder.Append("  maintenanceWindowDuration:");
                builder.AppendLine($" '{MaintenanceWindowDurationInMinutes.Value.ToString()}'");
            }
