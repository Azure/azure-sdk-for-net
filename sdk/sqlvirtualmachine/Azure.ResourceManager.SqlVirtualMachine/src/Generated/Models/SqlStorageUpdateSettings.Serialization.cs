...
{
    public partial class SqlStorageUpdateSettings : IUtf8JsonSerializable, IJsonModel<SqlStorageUpdateSettings>, IPersistableModel<SqlStorageUpdateSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StartingDeviceId))
            {
                builder.Append("  startingDeviceId:");
                builder.AppendLine($" '{StartingDeviceId.Value.ToString()}'");
            }

            if (Optional.IsDefined(DiskConfigurationType))
            {
                builder.Append("  diskConfigurationType:");
                builder.AppendLine($" '{DiskConfigurationType.ToString()}'");
            }
