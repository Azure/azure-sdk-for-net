...
{
    /// <summary> The SqlVirtualMachineAssessmentSchedule. </summary>
    public partial class SqlVirtualMachineAssessmentSchedule
    {
        /// <summary> Initializes a new instance of SqlVirtualMachineAssessmentSchedule. </summary>
        ...
        internal SqlVirtualMachineAssessmentSchedule(bool? isEnabled, int? weeklyInterval, int? monthlyOccurrence, SqlVirtualMachineAssessmentDayOfWeek? dayOfWeek, string startTime)
        {
            IsEnabled = isEnabled;
        ...
        public SqlVirtualMachineAssessmentDayOfWeek? DayOfWeek { get; set; }
