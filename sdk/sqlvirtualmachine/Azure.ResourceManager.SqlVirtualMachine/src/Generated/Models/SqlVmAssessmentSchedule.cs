...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class SqlVmAssessmentSchedule
    {
        ...
        internal SqlVmAssessmentSchedule(bool? isEnabled, int? weeklyInterval, int? monthlyOccurrence, SqlVmAssessmentDayOfWeek? dayOfWeek, string startTime, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IsEnabled = isEnabled;
