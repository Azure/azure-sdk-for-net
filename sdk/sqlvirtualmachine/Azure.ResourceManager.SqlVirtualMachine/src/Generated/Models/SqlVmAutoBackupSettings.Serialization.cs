...
{
    public partial class SqlVmAutoBackupSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlVmAutoBackupSettings DeserializeSqlVmAutoBackupSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
