...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    public partial class SqlInstanceSettings
    {
        ...
        internal SqlInstanceSettings(string collation, int? maxDop, bool? isOptimizeForAdHocWorkloadsEnabled, int? minServerMemoryInMB, int? maxServerMemoryInMB, bool? isLpimEnabled, bool? isIfiEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Collation = collation;
            MaxDop = maxDop;
