...
namespace Azure.ResourceManager.SqlVirtualMachine
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlVmGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlVmGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlVmGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlVmGroupData>)} interface");
            }
        ...
        string IPersistableModel<SqlVmGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
