...
{
    public partial class SqlVmGroupData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlVmGroupData DeserializeSqlVmGroupData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
