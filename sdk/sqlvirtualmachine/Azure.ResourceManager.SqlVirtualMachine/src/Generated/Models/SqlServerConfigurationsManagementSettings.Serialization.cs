...
{
    public partial class SqlServerConfigurationsManagementSettings : IUtf8JsonSerializable, IJsonModel<SqlServerConfigurationsManagementSettings>, IPersistableModel<SqlServerConfigurationsManagementSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SqlConnectivityUpdateSettings))
            {
                ...
                AppendChildObject(builder, SqlConnectivityUpdateSettings, options, 2);
            }

            if (Optional.IsDefined(SqlWorkloadTypeUpdateSettings))
            {
                builder.Append("  sqlWorkloadTypeUpdateSettings:");
                AppendChildObject(builder, SqlWorkloadTypeUpdateSettings, options, 2);
            }

            if (Optional.IsDefined(SqlStorageUpdateSettings))
            {
                builder.Append("  sqlStorageUpdateSettings:");
                AppendChildObject(builder, SqlStorageUpdateSettings, options, 2);
            }

            if (Optional.IsDefined(AdditionalFeaturesServerConfigurations))
            {
                builder.Append("  additionalFeaturesServerConfigurations:");
                AppendChildObject(builder, AdditionalFeaturesServerConfigurations, options, 2);
            }

            if (Optional.IsDefined(SqlInstanceSettings))
            {
                builder.Append("  sqlInstanceSettings:");
                AppendChildObject(builder, SqlInstanceSettings, options, 2);
            }
