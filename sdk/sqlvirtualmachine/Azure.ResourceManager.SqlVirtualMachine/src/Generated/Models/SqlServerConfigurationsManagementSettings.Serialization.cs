...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlServerConfigurationsManagementSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlServerConfigurationsManagementSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlServerConfigurationsManagementSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlServerConfigurationsManagementSettings>)} interface");
            }
        ...
        string IPersistableModel<SqlServerConfigurationsManagementSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
