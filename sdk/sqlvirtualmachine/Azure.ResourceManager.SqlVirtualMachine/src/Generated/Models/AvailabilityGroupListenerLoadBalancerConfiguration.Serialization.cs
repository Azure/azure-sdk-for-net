...
{
    public partial class AvailabilityGroupListenerLoadBalancerConfiguration : IUtf8JsonSerializable, IJsonModel<AvailabilityGroupListenerLoadBalancerConfiguration>, IPersistableModel<AvailabilityGroupListenerLoadBalancerConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublicIPAddressResourceId))
            {
                builder.Append("  publicIpAddressResourceId:");
                builder.AppendLine($" '{PublicIPAddressResourceId.ToString()}'");
            }

            if (Optional.IsDefined(LoadBalancerResourceId))
            {
                builder.Append("  loadBalancerResourceId:");
                builder.AppendLine($" '{LoadBalancerResourceId.ToString()}'");
            }
            ...
            if (Optional.IsCollectionDefined(SqlVmInstances))
            {
                builder.Append("  sqlVirtualMachineInstances:");
                builder.AppendLine(" [");
                foreach (var item in SqlVmInstances)
                {
                    if (item == null)
