...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailabilityGroupListenerLoadBalancerConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailabilityGroupListenerLoadBalancerConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailabilityGroupListenerLoadBalancerConfiguration>)} interface");
            }
        ...
        string IPersistableModel<AvailabilityGroupListenerLoadBalancerConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
