...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    public partial class SqlInstanceSettings : IUtf8JsonSerializable, IModelJsonSerializable<SqlInstanceSettings>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlInstanceSettings>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SqlInstanceSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SqlInstanceSettings"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SqlInstanceSettings"/>. </summary>
