...
{
    public partial class SqlInstanceSettings : IUtf8JsonSerializable, IJsonModel<SqlInstanceSettings>, IPersistableModel<SqlInstanceSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxDop))
            {
                ...
                builder.AppendLine($" '{MaxDop.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MinServerMemoryInMB))
            {
                ...
                builder.AppendLine($" '{MinServerMemoryInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxServerMemoryInMB))
            {
                builder.Append("  maxServerMemoryMB:");
                builder.AppendLine($" '{MaxServerMemoryInMB.Value.ToString()}'");
            }
