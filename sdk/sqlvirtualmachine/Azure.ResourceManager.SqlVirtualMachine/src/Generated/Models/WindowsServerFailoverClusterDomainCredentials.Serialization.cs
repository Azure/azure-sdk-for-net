...
{
    public partial class WindowsServerFailoverClusterDomainCredentials : IUtf8JsonSerializable, IJsonModel<WindowsServerFailoverClusterDomainCredentials>, IPersistableModel<WindowsServerFailoverClusterDomainCredentials>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterBootstrapAccountPassword))
            {
                builder.Append("  clusterBootstrapAccountPassword:");
                builder.AppendLine($" '{ClusterBootstrapAccountPassword}'");
            }

            if (Optional.IsDefined(ClusterOperatorAccountPassword))
            {
                builder.Append("  clusterOperatorAccountPassword:");
                builder.AppendLine($" '{ClusterOperatorAccountPassword}'");
            }

            if (Optional.IsDefined(SqlServiceAccountPassword))
            {
                builder.Append("  sqlServiceAccountPassword:");
                builder.AppendLine($" '{SqlServiceAccountPassword}'");
            }
