...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WindowsServerFailoverClusterDomainCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WindowsServerFailoverClusterDomainCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WindowsServerFailoverClusterDomainCredentials>)} interface");
            }
        ...
        string IPersistableModel<WindowsServerFailoverClusterDomainCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
