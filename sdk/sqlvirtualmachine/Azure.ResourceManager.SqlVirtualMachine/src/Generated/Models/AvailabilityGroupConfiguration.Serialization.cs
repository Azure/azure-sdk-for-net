...
namespace Azure.ResourceManager.SqlVirtualMachine.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailabilityGroupConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailabilityGroupConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailabilityGroupConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailabilityGroupConfiguration>)} interface");
            }
        ...
        string IPersistableModel<AvailabilityGroupConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
