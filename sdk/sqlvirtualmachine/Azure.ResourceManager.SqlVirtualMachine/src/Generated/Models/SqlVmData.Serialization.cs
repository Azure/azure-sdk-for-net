...
namespace Azure.ResourceManager.SqlVirtualMachine
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlVmData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlVmData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlVmData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlVmData>)} interface");
            }
        ...
        string IPersistableModel<SqlVmData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
