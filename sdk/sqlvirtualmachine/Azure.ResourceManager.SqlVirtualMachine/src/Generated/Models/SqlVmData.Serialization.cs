...
{
    public partial class SqlVmData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlVmData DeserializeSqlVmData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
