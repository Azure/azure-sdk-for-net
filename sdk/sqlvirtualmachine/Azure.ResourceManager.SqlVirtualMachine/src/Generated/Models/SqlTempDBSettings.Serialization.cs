...
{
    public partial class SqlTempDBSettings : IUtf8JsonSerializable, IJsonModel<SqlTempDBSettings>, IPersistableModel<SqlTempDBSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataFileSize))
            {
                ...
                builder.AppendLine($" '{DataFileSize.Value.ToString()}'");
            }

            if (Optional.IsDefined(DataGrowth))
            {
                builder.Append("  dataGrowth:");
                builder.AppendLine($" '{DataGrowth.Value.ToString()}'");
            }

            if (Optional.IsDefined(LogFileSize))
            {
                builder.Append("  logFileSize:");
                builder.AppendLine($" '{LogFileSize.Value.ToString()}'");
            }

            if (Optional.IsDefined(LogGrowth))
            {
                builder.Append("  logGrowth:");
                builder.AppendLine($" '{LogGrowth.Value.ToString()}'");
            }

            if (Optional.IsDefined(DataFileCount))
            {
                builder.Append("  dataFileCount:");
                builder.AppendLine($" '{DataFileCount.Value.ToString()}'");
            }
