...
{
    public partial class WsfcDomainProfile : IUtf8JsonSerializable
    {
        ...
        internal static WsfcDomainProfile DeserializeWsfcDomainProfile(JsonElement element)
        {
            ...
            Optional<ClusterSubnetType> clusterSubnetType = default;
            ...
            return new WsfcDomainProfile(domainFqdn.Value, ouPath.Value, clusterBootstrapAccount.Value, clusterOperatorAccount.Value, sqlServiceAccount.Value, fileShareWitnessPath.Value, storageAccountUrl.Value, storageAccountPrimaryKey.Value, Optional.ToNullable(clusterSubnetType));
        }
    }
}
