...
{
    /// <summary></summary>
    internal partial class AvailabilityGroupListenerResourceOperationSource : IOperationSource<AvailabilityGroupListenerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AvailabilityGroupListenerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
