...
namespace Azure.ResourceManager.SqlVirtualMachine
{
    internal partial class SqlVirtualMachineArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SqlVirtualMachineArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
