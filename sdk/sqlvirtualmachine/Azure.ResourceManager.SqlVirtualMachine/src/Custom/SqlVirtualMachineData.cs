...
[assembly:CodeGenSuppressType("SqlVirtualMachineData")]
namespace Azure.ResourceManager.SqlVirtualMachine
{
    ...
    public partial class SqlVirtualMachineData : TrackedResourceData
    {
        ...
        /// <param name="location"> The location. </param>
        /// <param name="identity"> Azure Active Directory identity of the server. Current supported identity types: SystemAssigned, None. </param>
