...
namespace Microsoft.Azure.Management.SqlVirtualMachine
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<SqlVirtualMachineManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(SqlVirtualMachineManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.SqlVirtualMachine/operations").ToString();
