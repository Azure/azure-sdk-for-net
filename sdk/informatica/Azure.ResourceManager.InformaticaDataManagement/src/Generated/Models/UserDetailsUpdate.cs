...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class UserDetailsUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="UserDetailsUpdate"/>. </summary>
        ...
        internal UserDetailsUpdate(string firstName, string lastName, string emailAddress, string upn, string phoneNumber, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FirstName = firstName;
            LastName = lastName;
