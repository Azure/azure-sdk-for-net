...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class InfaRuntimeResourceFetchMetaData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InfaRuntimeResourceFetchMetaData"/>. </summary>
        ...
        internal InfaRuntimeResourceFetchMetaData(string name, string createdTime, string updatedTime, string createdBy, string updatedBy, string id, RuntimeType runtimeType, string status, string statusLocalized, string statusMessage, InfaServerlessFetchConfigProperties serverlessConfigProperties)
        {
        ...
        internal InfaRuntimeResourceFetchMetaData(string name, string createdTime, string updatedTime, string createdBy, string updatedBy, string id, RuntimeType runtimeType, string status, string statusLocalized, string statusMessage, InfaServerlessFetchConfigProperties serverlessConfigProperties, string description, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            CreatedTime = createdTime;
            UpdatedTime = updatedTime;
        ...
        /// <summary> Initializes a new instance of <see cref="InfaRuntimeResourceFetchMetaData"/> for deserialization. </summary>
        internal InfaRuntimeResourceFetchMetaData()
        {
        }
        ...
        public InfaServerlessFetchConfigProperties ServerlessConfigProperties { get; }
