...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class NetworkInterfaceConfigurationUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="NetworkInterfaceConfigurationUpdate"/>. </summary>
        ...
        internal NetworkInterfaceConfigurationUpdate(string vnetId, string subnetId, string vnetResourceGuid, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VnetId = vnetId;
            SubnetId = subnetId;
