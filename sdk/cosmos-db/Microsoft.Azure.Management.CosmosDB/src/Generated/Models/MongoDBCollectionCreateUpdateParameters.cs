...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public MongoDBCollectionCreateUpdateParameters(MongoDBCollectionResource resource, IDictionary<string, string> options, string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
