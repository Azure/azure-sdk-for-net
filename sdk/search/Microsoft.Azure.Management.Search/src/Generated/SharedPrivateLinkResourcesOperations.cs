...
namespace Microsoft.Azure.Management.Search
{
    ...
    internal partial class SharedPrivateLinkResourcesOperations : IServiceOperations<SearchManagementClient>, ISharedPrivateLinkResourcesOperations
    {
        ...
        {
            // Send Request
            AzureOperationResponse<SharedPrivateLinkResource> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, searchServiceName, sharedPrivateLinkResourceName, sharedPrivateLinkResource, searchManagementRequestOptions, customHeaders, cancellationToken).ConfigureAwait(false);
