...
namespace Microsoft.Azure.Search
{
    ...
    public partial interface ISynonymMapsOperations
    {
        ...
        /// </returns>
        Task<AzureOperationResponse<bool>> ExistsWithHttpMessagesAsync(string synonymMapName, SearchRequestOptions searchRequestOptions = default(SearchRequestOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
