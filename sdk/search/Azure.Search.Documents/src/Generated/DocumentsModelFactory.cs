...
namespace Azure.Search.Documents.Models
{
    ...
    public static partial class DocumentsModelFactory
    {
        ...
        public static VectorQuery VectorQuery(int? kNearestNeighbors = default, IEnumerable<string> fields = default, bool? exhaustive = default, double? oversampling = default, float? weight = default, VectorThreshold threshold = default, string filterOverride = default, int? perDocumentVectorLimit = default, string kind = default)
        {
        ...
        public static VectorizedQuery VectorizedQuery(int? kNearestNeighbors = default, IEnumerable<string> fields = default, bool? exhaustive = default, double? oversampling = default, float? weight = default, VectorThreshold threshold = default, string filterOverride = default, int? perDocumentVectorLimit = default, ReadOnlyMemory<float> vector = default)
        {
            fields ??= new ChangeTrackingList<string>();
        ...
        public static VectorizableTextQuery VectorizableTextQuery(int? kNearestNeighbors = default, IEnumerable<string> fields = default, bool? exhaustive = default, double? oversampling = default, float? weight = default, VectorThreshold threshold = default, string filterOverride = default, int? perDocumentVectorLimit = default, string text = default, QueryRewritesType? queryRewrites = default)
        {
            fields ??= new ChangeTrackingList<string>();
        ...
        public static VectorizableImageUrlQuery VectorizableImageUrlQuery(int? kNearestNeighbors = default, IEnumerable<string> fields = default, bool? exhaustive = default, double? oversampling = default, float? weight = default, VectorThreshold threshold = default, string filterOverride = default, int? perDocumentVectorLimit = default, string url = default)
        {
            fields ??= new ChangeTrackingList<string>();
        ...
        public static VectorizableImageBinaryQuery VectorizableImageBinaryQuery(int? kNearestNeighbors = default, IEnumerable<string> fields = default, bool? exhaustive = default, double? oversampling = default, float? weight = default, VectorThreshold threshold = default, string filterOverride = default, int? perDocumentVectorLimit = default, string base64Image = default)
        {
            fields ??= new ChangeTrackingList<string>();
        ...
        /// <returns> A new <see cref="Models.IndexDocumentsBatch"/> instance for mocking. </returns>
        public static IndexDocumentsBatch IndexDocumentsBatch(IEnumerable<IndexAction> actions = default)
        {
            actions ??= new ChangeTrackingList<IndexAction>();

            return new Models.IndexDocumentsBatch(actions.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        public static IndexDocumentsResult IndexDocumentsResult(IEnumerable<IndexingResult> results = default)
        {
            ...
            return new IndexDocumentsResult(results.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        {
            return new IndexingResult(key, errorMessage, succeeded, statusCode, additionalBinaryDataProperties: null);
        }
        ...
        {
            return new AutocompleteItem(text, queryPlusText, additionalBinaryDataProperties: null);
        }
        ...
        public static SynonymMap SynonymMap(string name = default, IEnumerable<string> synonyms = default, SearchResourceEncryptionKey encryptionKey = default, string eTag = default)
        {
        ...
        public static SearchResourceEncryptionKey SearchResourceEncryptionKey(string keyName = default, string keyVersion = default, string vaultUri = default, AzureActiveDirectoryApplicationCredentials accessCredentials = default, SearchIndexerDataIdentity identity = default)
        {
        ...
        public static AzureActiveDirectoryApplicationCredentials AzureActiveDirectoryApplicationCredentials(string applicationId = default, string applicationSecret = default)
        {
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.SearchIndexerDataNoneIdentity"/> and <see cref="Models.SearchIndexerDataUserAssignedIdentity"/>.
        /// </summary>
        /// <param name="odataType"> A URI fragment specifying the type of identity. </param>
        /// <returns> A new <see cref="Models.SearchIndexerDataIdentity"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerDataNoneIdentity"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerDataUserAssignedIdentity"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchField"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.TextWeights"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.DistanceScoringFunction"/>, <see cref="Models.FreshnessScoringFunction"/>, <see cref="Models.MagnitudeScoringFunction"/>, and <see cref="Models.TagScoringFunction"/>.
        /// </summary>
        ...
        {
            return new UnknownScoringFunction(fieldName, boost, interpolation, @type, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.DistanceScoringParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.FreshnessScoringParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.TagScoringParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchSuggester"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.CustomAnalyzer"/>, <see cref="Models.PatternAnalyzer"/>, <see cref="Models.LuceneStandardAnalyzer"/>, and <see cref="Models.StopAnalyzer"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        /// <param name="name"> The name of the analyzer. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        /// <returns> A new <see cref="Models.LexicalAnalyzer"/> instance for mocking. </returns>
        public static LexicalAnalyzer LexicalAnalyzer(string odataType = default, string name = default)
        {
            return new UnknownLexicalAnalyzer(odataType, name, additionalBinaryDataProperties: null);
        }
        ...
        public static CustomAnalyzer CustomAnalyzer(string name = default, LexicalTokenizerName tokenizer = default, IEnumerable<TokenFilterName> tokenFilters = default, IEnumerable<CharFilterName> charFilters = default)
        {
        ...
        public static PatternAnalyzer PatternAnalyzer(string name = default, bool? lowerCaseTerms = default, string pattern = default, IEnumerable<RegexFlags> flags = default, IEnumerable<string> stopwords = default)
        {
        ...
        /// <param name="stopwords"> A list of stopwords. </param>
        /// <returns> A new <see cref="Models.LuceneStandardAnalyzer"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.ClassicTokenizer"/>, <see cref="Models.EdgeNGramTokenizer"/>, <see cref="Models.KeywordTokenizer"/>, <see cref="Models.KeywordTokenizerV2"/>, <see cref="Models.MicrosoftLanguageTokenizer"/>, <see cref="Models.MicrosoftLanguageStemmingTokenizer"/>, <see cref="Models.NGramTokenizer"/>, <see cref="Models.PathHierarchyTokenizerV2"/>, <see cref="Models.PatternTokenizer"/>, <see cref="Models.LuceneStandardTokenizer"/>, <see cref="Models.LuceneStandardTokenizerV2"/>, and <see cref="Models.UaxUrlEmailTokenizer"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        /// <param name="name"> The name of the tokenizer. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        /// <returns> A new <see cref="Models.LexicalTokenizer"/> instance for mocking. </returns>
        public static LexicalTokenizer LexicalTokenizer(string odataType = default, string name = default)
        {
            return new UnknownLexicalTokenizer(odataType, name, additionalBinaryDataProperties: null);
        }
        ...
        public static KeywordTokenizerV2 KeywordTokenizerV2(string name = default, int? maxTokenLength = default)
        {
            return new KeywordTokenizerV2("#Microsoft.Azure.Search.KeywordTokenizerV2", name, additionalBinaryDataProperties: null, maxTokenLength);
        }
        ...
        public static PathHierarchyTokenizerV2 PathHierarchyTokenizerV2(string name = default, string delimiter = default, string replacement = default, int? maxTokenLength = default, bool? reverseTokenOrder = default, int? numberOfTokensToSkip = default)
        {
        ...
        public static PatternTokenizer PatternTokenizer(string name = default, string pattern = default, RegexFlags? flags = default, int? @group = default)
        {
        ...
        /// <returns> A new <see cref="Models.LuceneStandardTokenizer"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.AsciiFoldingTokenFilter"/>, <see cref="Models.CjkBigramTokenFilter"/>, <see cref="Models.CommonGramTokenFilter"/>, <see cref="Models.DictionaryDecompounderTokenFilter"/>, <see cref="Models.EdgeNGramTokenFilter"/>, <see cref="Models.EdgeNGramTokenFilterV2"/>, <see cref="Models.ElisionTokenFilter"/>, <see cref="Models.KeepTokenFilter"/>, <see cref="Models.KeywordMarkerTokenFilter"/>, <see cref="Models.LengthTokenFilter"/>, <see cref="Models.LimitTokenFilter"/>, <see cref="Models.NGramTokenFilter"/>, <see cref="Models.NGramTokenFilterV2"/>, <see cref="Models.PatternCaptureTokenFilter"/>, <see cref="Models.PatternReplaceTokenFilter"/>, <see cref="Models.PhoneticTokenFilter"/>, <see cref="Models.ShingleTokenFilter"/>, <see cref="Models.SnowballTokenFilter"/>, <see cref="Models.StemmerTokenFilter"/>, <see cref="Models.StemmerOverrideTokenFilter"/>, <see cref="Models.StopwordsTokenFilter"/>, <see cref="Models.SynonymTokenFilter"/>, <see cref="Models.TruncateTokenFilter"/>, <see cref="Models.UniqueTokenFilter"/>, and <see cref="Models.WordDelimiterTokenFilter"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        /// <param name="name"> The name of the token filter. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        /// <returns> A new <see cref="Models.TokenFilter"/> instance for mocking. </returns>
        public static TokenFilter TokenFilter(string odataType = default, string name = default)
        {
            return new UnknownTokenFilter(odataType, name, additionalBinaryDataProperties: null);
        }
        ...
        public static NGramTokenFilterV2 NGramTokenFilterV2(string name = default, int? minGram = default, int? maxGram = default)
        {
            return new NGramTokenFilterV2("#Microsoft.Azure.Search.NGramTokenFilterV2", name, additionalBinaryDataProperties: null, minGram, maxGram);
        }
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.MappingCharFilter"/> and <see cref="Models.PatternReplaceCharFilter"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        /// <param name="name"> The name of the char filter. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        /// <returns> A new <see cref="Models.CharFilter"/> instance for mocking. </returns>
        public static CharFilter CharFilter(string odataType = default, string name = default)
        {
            return new UnknownCharFilter(odataType, name, additionalBinaryDataProperties: null);
        }
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.CustomNormalizer"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        /// <param name="name"> The name of the char filter. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        /// <returns> A new <see cref="Models.LexicalNormalizer"/> instance for mocking. </returns>
        public static LexicalNormalizer LexicalNormalizer(string odataType = default, string name = default)
        {
            return new UnknownLexicalNormalizer(odataType, name, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.CustomNormalizer"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.ClassicSimilarityAlgorithm"/> and <see cref="Models.BM25SimilarityAlgorithm"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        /// <returns> A new <see cref="Models.SimilarityAlgorithm"/> instance for mocking. </returns>
        public static SimilarityAlgorithm SimilarityAlgorithm(string odataType = default)
        {
            return new UnknownSimilarityAlgorithm(odataType, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.ClassicSimilarityAlgorithm"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.BM25SimilarityAlgorithm"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SemanticSearch"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SemanticConfiguration"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SemanticPrioritizedFields"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SemanticField"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.VectorSearch"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.VectorSearchProfile"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.HnswAlgorithmConfiguration"/> and <see cref="Models.ExhaustiveKnnAlgorithmConfiguration"/>.
        /// </summary>
        ...
        /// <returns> A new <see cref="Models.VectorSearchAlgorithmConfiguration"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.HnswAlgorithmConfiguration"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.HnswParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.ExhaustiveKnnAlgorithmConfiguration"/> instance for mocking. </returns>
        ...
        /// <param name="metric"> The similarity metric to use for vector comparisons. </param>
        /// <returns> A new <see cref="Models.ExhaustiveKnnParameters"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.AzureOpenAIVectorizer"/>, <see cref="Models.WebApiVectorizer"/>, <see cref="Models.AIServicesVisionVectorizer"/>, and <see cref="Models.AzureMachineLearningVectorizer"/>.
        /// </summary>
        ...
        /// <returns> A new <see cref="Models.VectorSearchVectorizer"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AzureOpenAIVectorizer"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AzureOpenAIVectorizerParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.WebApiVectorizer"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.WebApiVectorizerParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AIServicesVisionVectorizer"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AIServicesVisionParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AzureMachineLearningVectorizer"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AzureMachineLearningParameters"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.ScalarQuantizationCompression"/> and <see cref="Models.BinaryQuantizationCompression"/>.
        /// </summary>
        ...
        /// <returns> A new <see cref="Models.VectorSearchCompression"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.RescoringOptions"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.ScalarQuantizationCompression"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.ScalarQuantizationParameters"/> instance for mocking. </returns>
        ...
        /// <param name="rescoringOptions"> Contains the options for rescoring. </param>
        /// <param name="truncationDimension"> The number of dimensions to truncate the vectors to. Truncating the vectors reduces the size of the vectors and the amount of data that needs to be transferred during search. This can save storage cost and improve search performance at the expense of recall. It should be only used for embeddings trained with Matryoshka Representation Learning (MRL) such as OpenAI text-embedding-3-large (small). The default value is null, which means no truncation. </param>
        /// <returns> A new <see cref="Models.BinaryQuantizationCompression"/> instance for mocking. </returns>
        ...
        {
            return new GetIndexStatisticsResult(documentCount, storageSize, vectorIndexSize, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.AnalyzeTextOptions"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AnalyzedTokenInfo"/> instance for mocking. </returns>
        ...
        {
            return new AnalyzedTokenInfo(token, startOffset, endOffset, position, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.SearchAlias"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBase"/> instance for mocking. </returns>
        public static KnowledgeBase KnowledgeBase(string name = default, IEnumerable<KnowledgeSourceReference> knowledgeSources = default, IEnumerable<KnowledgeBaseModel> models = default, KnowledgeRetrievalReasoningEffort retrievalReasoningEffort = default, KnowledgeRetrievalOutputMode? outputMode = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default, string description = default, string retrievalInstructions = default, string answerInstructions = default)
        {
        ...
        /// <returns> A new <see cref="Models.KnowledgeSourceReference"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.KnowledgeBaseAzureOpenAIModel"/>.
        /// </summary>
        /// <param name="kind"> The AI model to be used for query planning. </param>
        /// <returns> A new <see cref="Models.KnowledgeBaseModel"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseAzureOpenAIModel"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.KnowledgeRetrievalMinimalReasoningEffort"/>, <see cref="Models.KnowledgeRetrievalLowReasoningEffort"/>, and <see cref="Models.KnowledgeRetrievalMediumReasoningEffort"/>.
        /// </summary>
        /// <param name="kind"> The kind of reasoning effort. </param>
        /// <returns> A new <see cref="Models.KnowledgeRetrievalReasoningEffort"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeRetrievalMinimalReasoningEffort"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeRetrievalLowReasoningEffort"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeRetrievalMediumReasoningEffort"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.SearchIndexKnowledgeSource"/>, <see cref="Models.AzureBlobKnowledgeSource"/>, <see cref="Models.IndexedSharePointKnowledgeSource"/>, <see cref="Models.IndexedOneLakeKnowledgeSource"/>, <see cref="Models.WebKnowledgeSource"/>, and <see cref="Models.RemoteSharePointKnowledgeSource"/>.
        /// </summary>
        /// <param name="name"> The name of the knowledge source. </param>
        ...
        /// <returns> A new <see cref="Models.KnowledgeSource"/> instance for mocking. </returns>
        public static KnowledgeSource KnowledgeSource(string name = default, string description = default, string kind = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default)
        {
        ...
        /// <returns> A new <see cref="Models.SearchIndexKnowledgeSource"/> instance for mocking. </returns>
        public static SearchIndexKnowledgeSource SearchIndexKnowledgeSource(string name = default, string description = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default, SearchIndexKnowledgeSourceParameters searchIndexParameters = default)
        {
        ...
        /// <returns> A new <see cref="Models.SearchIndexKnowledgeSourceParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexFieldReference"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AzureBlobKnowledgeSource"/> instance for mocking. </returns>
        public static AzureBlobKnowledgeSource AzureBlobKnowledgeSource(string name = default, string description = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default, AzureBlobKnowledgeSourceParameters azureBlobParameters = default)
        {
        ...
        /// <returns> A new <see cref="Models.AzureBlobKnowledgeSourceParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeSourceIngestionParameters"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.KnowledgeSourceAzureOpenAIVectorizer"/>.
        /// </summary>
        /// <param name="kind"> The name of the kind of vectorization method being configured for use with vector search. </param>
        /// <returns> A new <see cref="Models.KnowledgeSourceVectorizer"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeSourceAzureOpenAIVectorizer"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AIServices"/> instance for mocking. </returns>
        ...
        /// <param name="additionalProperties"></param>
        /// <returns> A new <see cref="Models.CreatedResources"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.IndexedSharePointKnowledgeSource"/> instance for mocking. </returns>
        public static IndexedSharePointKnowledgeSource IndexedSharePointKnowledgeSource(string name = default, string description = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default, IndexedSharePointKnowledgeSourceParameters indexedSharePointParameters = default)
        {
        ...
        /// <param name="ingestionParameters"> Consolidates all general ingestion settings. </param>
        /// <param name="createdResources"> Resources created by the knowledge source. </param>
        /// <returns> A new <see cref="Models.IndexedSharePointKnowledgeSourceParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.IndexedOneLakeKnowledgeSource"/> instance for mocking. </returns>
        public static IndexedOneLakeKnowledgeSource IndexedOneLakeKnowledgeSource(string name = default, string description = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default, IndexedOneLakeKnowledgeSourceParameters indexedOneLakeParameters = default)
        {
        ...
        /// <param name="ingestionParameters"> Consolidates all general ingestion settings. </param>
        /// <param name="createdResources"> Resources created by the knowledge source. </param>
        /// <returns> A new <see cref="Models.IndexedOneLakeKnowledgeSourceParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.WebKnowledgeSource"/> instance for mocking. </returns>
        public static WebKnowledgeSource WebKnowledgeSource(string name = default, string description = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default, WebKnowledgeSourceParameters webParameters = default)
        {
        ...
        /// <returns> A new <see cref="Models.WebKnowledgeSourceParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.WebKnowledgeSourceDomains"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.WebKnowledgeSourceDomain"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.RemoteSharePointKnowledgeSource"/> instance for mocking. </returns>
        public static RemoteSharePointKnowledgeSource RemoteSharePointKnowledgeSource(string name = default, string description = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default, RemoteSharePointKnowledgeSourceParameters remoteSharePointParameters = default)
        {
        ...
        /// <returns> A new <see cref="Models.RemoteSharePointKnowledgeSourceParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeSourceStatus"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SynchronizationState"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.CompletedSynchronizationState"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeSourceStatistics"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchServiceCounters"/> instance for mocking. </returns>
        public static SearchServiceCounters SearchServiceCounters(ResourceCounter aliasCounter = default, ResourceCounter documentCounter = default, ResourceCounter indexCounter = default, ResourceCounter indexerCounter = default, ResourceCounter dataSourceCounter = default, ResourceCounter storageSizeCounter = default, ResourceCounter synonymMapCounter = default, ResourceCounter skillsetCounter = default, ResourceCounter vectorIndexSizeCounter = default)
        {
        ...
        {
            return new ResourceCounter(usage, quota, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.ServiceIndexersRuntime"/> instance for mocking. </returns>
        ...
        /// <param name="storageSize"> The amount of storage in bytes consumed by the index. </param>
        /// <param name="vectorIndexSize"> The amount of memory in bytes consumed by vectors in the index. </param>
        /// <returns> A new <see cref="Models.IndexStatisticsSummary"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerDataSourceConnection"/> instance for mocking. </returns>
        public static SearchIndexerDataSourceConnection SearchIndexerDataSourceConnection(string name = default, string description = default, SearchIndexerDataSourceType @type = default, string subType = default, DataSourceCredentials credentials = default, SearchIndexerDataContainer container = default, SearchIndexerDataIdentity identity = default, IEnumerable<IndexerPermissionOption> indexerPermissionOptions = default, DataChangeDetectionPolicy dataChangeDetectionPolicy = default, DataDeletionDetectionPolicy dataDeletionDetectionPolicy = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default)
        {
            ...
            return new SearchIndexerDataSourceConnection(
                ...
                container,
                identity,
                indexerPermissionOptions.ToList(),
        ...
        public static DataSourceCredentials DataSourceCredentials(string connectionString = default)
        {
            return new DataSourceCredentials(connectionString, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.SearchIndexerDataContainer"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.HighWaterMarkChangeDetectionPolicy"/> and <see cref="Models.SqlIntegratedChangeTrackingPolicy"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        /// <returns> A new <see cref="Models.DataChangeDetectionPolicy"/> instance for mocking. </returns>
        public static DataChangeDetectionPolicy DataChangeDetectionPolicy(string odataType = default)
        {
            return new UnknownDataChangeDetectionPolicy(odataType, additionalBinaryDataProperties: null);
        }
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.SoftDeleteColumnDeletionDetectionPolicy"/> and <see cref="Models.NativeBlobSoftDeleteDeletionDetectionPolicy"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        /// <returns> A new <see cref="Models.DataDeletionDetectionPolicy"/> instance for mocking. </returns>
        public static DataDeletionDetectionPolicy DataDeletionDetectionPolicy(string odataType = default)
        {
            return new UnknownDataDeletionDetectionPolicy(odataType, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.NativeBlobSoftDeleteDeletionDetectionPolicy"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.IndexerResyncBody"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.DocumentKeysOrIds"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexer"/> instance for mocking. </returns>
        public static SearchIndexer SearchIndexer(string name = default, string description = default, string dataSourceName = default, string skillsetName = default, string targetIndexName = default, IndexingSchedule schedule = default, IndexingParameters parameters = default, IEnumerable<FieldMapping> fieldMappings = default, IEnumerable<FieldMapping> outputFieldMappings = default, bool? isDisabled = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default, SearchIndexerCache cache = default)
        {
        ...
        public static IndexingParameters IndexingParameters(int? batchSize = default, int? maxFailedItems = default, int? maxFailedItemsPerBatch = default, IndexingParametersConfiguration configuration = default)
        {
            return new IndexingParameters(batchSize, maxFailedItems, maxFailedItemsPerBatch, configuration, additionalBinaryDataProperties: null);
        }
        ...
        /// <param name="additionalProperties"></param>
        /// <returns> A new <see cref="Models.IndexingParametersConfiguration"/> instance for mocking. </returns>
        ...
        public static FieldMappingFunction FieldMappingFunction(string name = default, IDictionary<string, BinaryData> parameters = default)
        {
        ...
        /// <returns> A new <see cref="Models.SearchIndexerCache"/> instance for mocking. </returns>
        ...
        /// <param name="beginningTime"> Beginning UTC time of the 24-hour period considered for indexer runtime usage (inclusive). </param>
        /// <param name="endingTime"> End UTC time of the 24-hour period considered for indexer runtime usage (inclusive). </param>
        /// <returns> A new <see cref="Models.IndexerRuntime"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerError"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerWarning"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerLimits"/> instance for mocking. </returns>
        ...
        {
            return new SearchIndexerLimits(maxRunTime, maxDocumentExtractionSize, maxDocumentContentCharactersToExtract, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.IndexerCurrentState"/> instance for mocking. </returns>
        public static IndexerCurrentState IndexerCurrentState(IndexingMode? mode = default, string allDocsInitialTrackingState = default, string allDocsFinalTrackingState = default, string resetDocsInitialTrackingState = default, string resetDocsFinalTrackingState = default, string resyncInitialTrackingState = default, string resyncFinalTrackingState = default, IEnumerable<string> resetDocumentKeys = default, IEnumerable<string> resetDatasourceDocumentIds = default)
        {
        ...
        /// <returns> A new <see cref="Models.SearchIndexerSkillset"/> instance for mocking. </returns>
        public static SearchIndexerSkillset SearchIndexerSkillset(string name = default, string description = default, IEnumerable<SearchIndexerSkill> skills = default, CognitiveServicesAccount cognitiveServicesAccount = default, SearchIndexerKnowledgeStore knowledgeStore = default, SearchIndexerIndexProjection indexProjection = default, string eTag = default, SearchResourceEncryptionKey encryptionKey = default)
        {
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.ConditionalSkill"/>, <see cref="Models.KeyPhraseExtractionSkill"/>, <see cref="Models.OcrSkill"/>, <see cref="Models.ImageAnalysisSkill"/>, <see cref="Models.LanguageDetectionSkill"/>, <see cref="Models.ShaperSkill"/>, <see cref="Models.MergeSkill"/>, <see cref="Models.EntityRecognitionSkill"/>, <see cref="Models.SentimentSkill"/>, <see cref="Models.SentimentSkillV3"/>, <see cref="Models.EntityLinkingSkill"/>, <see cref="Models.EntityRecognitionSkillV3"/>, <see cref="Models.PIIDetectionSkill"/>, <see cref="Models.SplitSkill"/>, <see cref="Models.CustomEntityLookupSkill"/>, <see cref="Models.TextTranslationSkill"/>, <see cref="Models.DocumentExtractionSkill"/>, <see cref="Models.DocumentIntelligenceLayoutSkill"/>, <see cref="Models.WebApiSkill"/>, <see cref="Models.AzureMachineLearningSkill"/>, <see cref="Models.AzureOpenAIEmbeddingSkill"/>, <see cref="Models.VisionVectorizeSkill"/>, <see cref="Models.ContentUnderstandingSkill"/>, and <see cref="Models.ChatCompletionSkill"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerSkill"/> instance for mocking. </returns>
        ...
        /// <param name="modelVersion"> The version of the model to use when calling the Text Analytics service. It will default to the latest available when not specified. We recommend you do not specify this value unless absolutely necessary. </param>
        /// <returns> A new <see cref="Models.SentimentSkillV3"/> instance for mocking. </returns>
        public static SentimentSkillV3 SentimentSkillV3(string name = default, string description = default, string context = default, IEnumerable<InputFieldMappingEntry> inputs = default, IEnumerable<OutputFieldMappingEntry> outputs = default, string defaultLanguageCode = default, bool? includeOpinionMining = default, string modelVersion = default)
        {
            inputs ??= new ChangeTrackingList<InputFieldMappingEntry>();
            outputs ??= new ChangeTrackingList<OutputFieldMappingEntry>();
        ...
        /// <param name="minimumPrecision"> A value between 0 and 1 that be used to only include entities whose confidence score is greater than the value specified. If not set (default), or if explicitly set to null, all entities will be included. </param>
        /// <param name="modelVersion"> The version of the model to use when calling the Text Analytics service. It will default to the latest available when not specified. We recommend you do not specify this value unless absolutely necessary. </param>
        /// <returns> A new <see cref="Models.EntityLinkingSkill"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.PIIDetectionSkill"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AzureOpenAITokenizerParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.CustomEntityLookupSkill"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.CustomEntity"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.CustomEntityAlias"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.DocumentExtractionSkill"/> instance for mocking. </returns>
        public static DocumentExtractionSkill DocumentExtractionSkill(string name = default, string description = default, string context = default, IEnumerable<InputFieldMappingEntry> inputs = default, IEnumerable<OutputFieldMappingEntry> outputs = default, string parsingMode = default, string dataToExtract = default, IDictionary<string, BinaryData> configuration = default)
        {
            inputs ??= new ChangeTrackingList<InputFieldMappingEntry>();
            outputs ??= new ChangeTrackingList<OutputFieldMappingEntry>();
        ...
        /// <returns> A new <see cref="Models.DocumentIntelligenceLayoutSkill"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.DocumentIntelligenceLayoutSkillChunkingProperties"/> instance for mocking. </returns>
        ...
        /// <param name="additionalProperties"></param>
        /// <returns> A new <see cref="Models.WebApiHttpHeaders"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AzureMachineLearningSkill"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.AzureOpenAIEmbeddingSkill"/> instance for mocking. </returns>
        ...
        /// <param name="outputs"> The output of a skill is either a field in a search index, or a value that can be consumed as an input by another skill. </param>
        /// <param name="modelVersion"> The version of the model to use when calling the AI Services Vision service. It will default to the latest available when not specified. </param>
        /// <returns> A new <see cref="Models.VisionVectorizeSkill"/> instance for mocking. </returns>
        ...
        /// <param name="extractionOptions"> Controls the cardinality of the content extracted from the document by the skill. </param>
        /// <param name="chunkingProperties"> Controls the cardinality for chunking the content. </param>
        /// <returns> A new <see cref="Models.ContentUnderstandingSkill"/> instance for mocking. </returns>
        ...
        /// <param name="maximumLength"> The maximum chunk length in characters. Default is 500. </param>
        /// <param name="overlapLength"> The length of overlap provided between two text chunks. Default is 0. </param>
        /// <returns> A new <see cref="Models.ContentUnderstandingSkillChunkingProperties"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.ChatCompletionSkill"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.ChatCompletionCommonModelParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.ChatCompletionResponseFormat"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.ChatCompletionSchemaProperties"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.ChatCompletionSchema"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.DefaultCognitiveServicesAccount"/>, <see cref="Models.CognitiveServicesAccountKey"/>, <see cref="Models.AIServicesAccountKey"/>, and <see cref="Models.AIServicesAccountIdentity"/>.
        /// </summary>
        /// <param name="odataType"> The discriminator for derived types. </param>
        ...
        public static CognitiveServicesAccount CognitiveServicesAccount(string odataType = default, string description = default)
        {
            return new UnknownCognitiveServicesAccount(odataType, description, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.AIServicesAccountKey"/> instance for mocking. </returns>
        ...
        /// <param name="subdomainUrl"> The subdomain url for the corresponding AI Service. </param>
        /// <returns> A new <see cref="Models.AIServicesAccountIdentity"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerKnowledgeStore"/> instance for mocking. </returns>
        public static SearchIndexerKnowledgeStore SearchIndexerKnowledgeStore(string storageConnectionString = default, IEnumerable<SearchIndexerKnowledgeStoreProjection> projections = default, SearchIndexerDataIdentity identity = default, SearchIndexerKnowledgeStoreParameters parameters = default)
        {
            projections ??= new ChangeTrackingList<SearchIndexerKnowledgeStoreProjection>();

            return new SearchIndexerKnowledgeStore(storageConnectionString, projections.ToList(), identity, parameters, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.SearchIndexerKnowledgeStoreProjection"/> instance for mocking. </returns>
        public static SearchIndexerKnowledgeStoreProjection SearchIndexerKnowledgeStoreProjection(IEnumerable<SearchIndexerKnowledgeStoreTableProjectionSelector> tables = default, IEnumerable<SearchIndexerKnowledgeStoreObjectProjectionSelector> objects = default, IEnumerable<SearchIndexerKnowledgeStoreFileProjectionSelector> files = default)
        {
            ...
            return new SearchIndexerKnowledgeStoreProjection(tables.ToList(), objects.ToList(), files.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.SearchIndexerKnowledgeStoreTableProjectionSelector"/> instance for mocking. </returns>
        public static SearchIndexerKnowledgeStoreTableProjectionSelector SearchIndexerKnowledgeStoreTableProjectionSelector(string referenceKeyName = default, string source = default, string sourceContext = default, IEnumerable<InputFieldMappingEntry> inputs = default, string generatedKeyName = default, string tableName = default)
        {
            inputs ??= new ChangeTrackingList<InputFieldMappingEntry>();
        ...
        /// <param name="sourceContext"> Source context for complex projections. </param>
        /// <param name="inputs"> Nested inputs for complex projections. </param>
        /// <returns> A new <see cref="Models.SearchIndexerKnowledgeStoreProjectionSelector"/> instance for mocking. </returns>
        public static SearchIndexerKnowledgeStoreProjectionSelector SearchIndexerKnowledgeStoreProjectionSelector(string referenceKeyName = default, string generatedKeyName = default, string source = default, string sourceContext = default, IEnumerable<InputFieldMappingEntry> inputs = default)
        {
            inputs ??= new ChangeTrackingList<InputFieldMappingEntry>();
        ...
        /// <returns> A new <see cref="Models.SearchIndexerKnowledgeStoreObjectProjectionSelector"/> instance for mocking. </returns>
        public static SearchIndexerKnowledgeStoreObjectProjectionSelector SearchIndexerKnowledgeStoreObjectProjectionSelector(string referenceKeyName = default, string generatedKeyName = default, string source = default, string sourceContext = default, IEnumerable<InputFieldMappingEntry> inputs = default, string storageContainer = default)
        {
            inputs ??= new ChangeTrackingList<InputFieldMappingEntry>();
        ...
        /// <param name="inputs"> Nested inputs for complex projections. </param>
        /// <param name="storageContainer"> Blob container to store projections in. </param>
        /// <returns> A new <see cref="Models.SearchIndexerKnowledgeStoreBlobProjectionSelector"/> instance for mocking. </returns>
        public static SearchIndexerKnowledgeStoreBlobProjectionSelector SearchIndexerKnowledgeStoreBlobProjectionSelector(string referenceKeyName = default, string generatedKeyName = default, string source = default, string sourceContext = default, IEnumerable<InputFieldMappingEntry> inputs = default, string storageContainer = default)
        {
            inputs ??= new ChangeTrackingList<InputFieldMappingEntry>();

            return new SearchIndexerKnowledgeStoreBlobProjectionSelector(
                referenceKeyName,
                generatedKeyName,
                source,
                sourceContext,
        ...
        /// <param name="inputs"> Nested inputs for complex projections. </param>
        /// <param name="storageContainer"> Blob container to store projections in. </param>
        /// <returns> A new <see cref="Models.SearchIndexerKnowledgeStoreFileProjectionSelector"/> instance for mocking. </returns>
        public static SearchIndexerKnowledgeStoreFileProjectionSelector SearchIndexerKnowledgeStoreFileProjectionSelector(string referenceKeyName = default, string generatedKeyName = default, string source = default, string sourceContext = default, IEnumerable<InputFieldMappingEntry> inputs = default, string storageContainer = default)
        {
            inputs ??= new ChangeTrackingList<InputFieldMappingEntry>();

            return new SearchIndexerKnowledgeStoreFileProjectionSelector(
                referenceKeyName,
                generatedKeyName,
                source,
                sourceContext,
        ...
        /// <returns> A new <see cref="Models.SearchIndexerIndexProjection"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexerIndexProjectionSelector"/> instance for mocking. </returns>
        ...
        /// <param name="additionalProperties"></param>
        /// <returns> A new <see cref="Models.SearchIndexerIndexProjectionsParameters"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SkillNames"/> instance for mocking. </returns>
        public static SkillNames SkillNames(IEnumerable<string> skillNameList = default)
        {
            skillNameList ??= new ChangeTrackingList<string>();

            return new SkillNames(skillNameList.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseRetrievalRequest"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseMessage"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.KnowledgeBaseMessageTextContent"/> and <see cref="Models.KnowledgeBaseMessageImageContent"/>.
        /// </summary>
        /// <param name="type"> The type of the message. </param>
        /// <returns> A new <see cref="Models.KnowledgeBaseMessageContent"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseMessageTextContent"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseMessageImageContent"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseImageContent"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.KnowledgeRetrievalSemanticIntent"/>.
        /// </summary>
        /// <param name="type"> The type of the intent. </param>
        /// <returns> A new <see cref="Models.KnowledgeRetrievalIntent"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeRetrievalSemanticIntent"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.SearchIndexKnowledgeSourceParams"/>, <see cref="Models.AzureBlobKnowledgeSourceParams"/>, <see cref="Models.IndexedSharePointKnowledgeSourceParams"/>, <see cref="Models.IndexedOneLakeKnowledgeSourceParams"/>, <see cref="Models.WebKnowledgeSourceParams"/>, and <see cref="Models.RemoteSharePointKnowledgeSourceParams"/>.
        /// </summary>
        ...
        /// <param name="kind"> The type of the knowledge source. </param>
        /// <returns> A new <see cref="Models.KnowledgeSourceParams"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SearchIndexKnowledgeSourceParams"/> instance for mocking. </returns>
        ...
        /// <param name="alwaysQuerySource"> Indicates that this knowledge source should bypass source selection and always be queried at retrieval time. </param>
        /// <param name="rerankerThreshold"> The reranker threshold all retrieved documents must meet to be included in the response. </param>
        /// <returns> A new <see cref="Models.AzureBlobKnowledgeSourceParams"/> instance for mocking. </returns>
        ...
        /// <param name="alwaysQuerySource"> Indicates that this knowledge source should bypass source selection and always be queried at retrieval time. </param>
        /// <param name="rerankerThreshold"> The reranker threshold all retrieved documents must meet to be included in the response. </param>
        /// <returns> A new <see cref="Models.IndexedSharePointKnowledgeSourceParams"/> instance for mocking. </returns>
        ...
        /// <param name="alwaysQuerySource"> Indicates that this knowledge source should bypass source selection and always be queried at retrieval time. </param>
        /// <param name="rerankerThreshold"> The reranker threshold all retrieved documents must meet to be included in the response. </param>
        /// <returns> A new <see cref="Models.IndexedOneLakeKnowledgeSourceParams"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.WebKnowledgeSourceParams"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.RemoteSharePointKnowledgeSourceParams"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseRetrievalResponse"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.KnowledgeBaseModelQueryPlanningActivityRecord"/>, <see cref="Models.KnowledgeBaseModelAnswerSynthesisActivityRecord"/>, and <see cref="Models.KnowledgeBaseAgenticReasoningActivityRecord"/>.
        /// </summary>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseActivityRecord"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseErrorDetail"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseErrorAdditionalInfo"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseModelQueryPlanningActivityRecord"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseModelAnswerSynthesisActivityRecord"/> instance for mocking. </returns>
        ...
        /// <param name="retrievalReasoningEffort"> The retrieval reasoning effort configuration. </param>
        /// <returns> A new <see cref="Models.KnowledgeBaseAgenticReasoningActivityRecord"/> instance for mocking. </returns>
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Models.KnowledgeBaseSearchIndexReference"/>, <see cref="Models.KnowledgeBaseAzureBlobReference"/>, <see cref="Models.KnowledgeBaseIndexedSharePointReference"/>, <see cref="Models.KnowledgeBaseIndexedOneLakeReference"/>, <see cref="Models.KnowledgeBaseWebReference"/>, and <see cref="Models.KnowledgeBaseRemoteSharePointReference"/>.
        /// </summary>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseReference"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseSearchIndexReference"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseAzureBlobReference"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseIndexedSharePointReference"/> instance for mocking. </returns>
        ...
        /// <param name="rerankerScore"> The reranker score for the document reference. </param>
        /// <param name="docUrl"> The document URL for the reference. </param>
        /// <returns> A new <see cref="Models.KnowledgeBaseIndexedOneLakeReference"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseWebReference"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.KnowledgeBaseRemoteSharePointReference"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Models.SharePointSensitivityLabelInfo"/> instance for mocking. </returns>
