...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class UnknownTokenFilter : TokenFilter
    {
        ...
        internal UnknownTokenFilter(string oDataType, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
