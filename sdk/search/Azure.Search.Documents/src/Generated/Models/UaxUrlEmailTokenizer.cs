...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class UaxUrlEmailTokenizer : LexicalTokenizer
    {
        ...
        internal UaxUrlEmailTokenizer(string oDataType, string name, int? maxTokenLength, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
