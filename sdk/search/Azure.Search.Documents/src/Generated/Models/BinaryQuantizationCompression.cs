...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class BinaryQuantizationCompression : VectorSearchCompression
    {
        ...
        internal BinaryQuantizationCompression(string compressionName, VectorSearchCompressionKind kind, bool? rerankWithOriginalVectors, double? defaultOversampling, RescoringOptions rescoringOptions, int? truncationDimension, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(compressionName, kind, rerankWithOriginalVectors, defaultOversampling, rescoringOptions, truncationDimension, serializedAdditionalRawData)
        {
            Kind = kind;
        }
