...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class LuceneStandardTokenizerV2 : LexicalTokenizer
    {
        ...
        public LuceneStandardTokenizerV2(string name) : base("#Microsoft.Azure.Search.StandardTokenizerV2", name)
        {
        ...
        internal LuceneStandardTokenizerV2(string odataType, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? maxTokenLength) : base(odataType, name, additionalBinaryDataProperties)
        {
