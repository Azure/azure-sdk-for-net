...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseModelAnswerSynthesisActivityRecord : KnowledgeBaseActivityRecord
    {
        ...
        internal KnowledgeBaseModelAnswerSynthesisActivityRecord(int id, KnowledgeBaseActivityRecordType @type, int? elapsedMs, KnowledgeBaseErrorDetail error, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? inputTokens, int? outputTokens, string modelName) : base(id, @type, elapsedMs, error, additionalBinaryDataProperties)
        {
        ...
        /// <summary> The name of the model used for the LLM answer synthesis activity. </summary>
