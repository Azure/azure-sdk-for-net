...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchSuggester>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchSuggester>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchSuggester>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchSuggester>)} interface");
            }
        ...
        string IPersistableModel<SearchSuggester>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
