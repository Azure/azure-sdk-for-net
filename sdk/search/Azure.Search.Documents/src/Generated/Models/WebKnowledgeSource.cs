...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class WebKnowledgeSource : KnowledgeSource
    {
        ...
        internal WebKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, WebKnowledgeSourceParameters webParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
