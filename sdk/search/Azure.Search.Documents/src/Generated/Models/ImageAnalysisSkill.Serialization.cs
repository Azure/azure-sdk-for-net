...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class ImageAnalysisSkill : IUtf8JsonSerializable, IModelJsonSerializable<ImageAnalysisSkill>
    {
        ...
        internal static ImageAnalysisSkill DeserializeImageAnalysisSkill(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ImageAnalysisSkill(odataType, name.Value, description.Value, context.Value, inputs, outputs, Optional.ToNullable(defaultLanguageCode), Optional.ToList(visualFeatures), Optional.ToList(details), rawData);
        }
