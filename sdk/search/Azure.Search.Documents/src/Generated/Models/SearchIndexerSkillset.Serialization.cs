...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class SearchIndexerSkillset : IUtf8JsonSerializable
    {
        ...
        internal static SearchIndexerSkillset DeserializeSearchIndexerSkillset(JsonElement element)
        {
            ...
            return new SearchIndexerSkillset(name, description.HasValue ? description.Value : null, skills, cognitiveServices.HasValue ? cognitiveServices.Value : null, odataEtag.HasValue ? odataEtag.Value : null);
        }
    }
}
