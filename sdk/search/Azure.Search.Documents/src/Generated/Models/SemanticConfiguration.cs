...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SemanticConfiguration
    {
        ...
        internal SemanticConfiguration(string name, SemanticPrioritizedFields prioritizedFields, RankingOrder? rankingOrder, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            PrioritizedFields = prioritizedFields;
