...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class TagScoringFunction : ScoringFunction
    {
        ...
        internal TagScoringFunction(string type, string fieldName, double boost, ScoringFunctionInterpolation? interpolation, TagScoringParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, fieldName, boost, interpolation, serializedAdditionalRawData)
        {
