...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.PatternCaptureTokenFilter"/>. </summary>
        /// <param name="name"> The name of the token filter. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        /// <param name="patterns"> A list of patterns to match against each token. </param>
        /// <exception cref="global::System.ArgumentNullException"> <paramref name="name"/> or <paramref name="patterns"/> is null. </exception>
        public PatternCaptureTokenFilter(string name, IEnumerable<string> patterns) : base("#Microsoft.Azure.Search.PatternCaptureTokenFilter", name)
        {
            ...
            global::Azure.Search.Documents.Argument.AssertNotNull(patterns, nameof(patterns));
        ...
        internal PatternCaptureTokenFilter(string odataType, string name, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, IList<string> patterns, bool? preserveOriginal) : base(odataType, name, additionalBinaryDataProperties)
        {
            Patterns = patterns;
