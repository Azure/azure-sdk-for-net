...
{
    public partial class NGramTokenizer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NGramTokenizer DeserializeNGramTokenizer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
