...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public readonly partial struct KnowledgeSourceKind : IEquatable<global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(KnowledgeSourceKind left, KnowledgeSourceKind right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(KnowledgeSourceKind left, KnowledgeSourceKind right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is KnowledgeSourceKind other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(KnowledgeSourceKind other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
