...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UniqueTokenFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UniqueTokenFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UniqueTokenFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UniqueTokenFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
