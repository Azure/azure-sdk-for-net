...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UniqueTokenFilter>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static UniqueTokenFilter DeserializeUniqueTokenFilter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UniqueTokenFilter(odataType, name, serializedAdditionalRawData, onlyOnSamePosition);
        }
