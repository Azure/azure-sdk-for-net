...
{
    public partial class SearchIndexer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SearchIndexer DeserializeSearchIndexer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
