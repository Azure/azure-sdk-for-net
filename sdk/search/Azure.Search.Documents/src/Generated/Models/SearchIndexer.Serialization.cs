...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchIndexer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchIndexer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchIndexer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchIndexer>)} interface");
            }
        ...
        string IPersistableModel<SearchIndexer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
