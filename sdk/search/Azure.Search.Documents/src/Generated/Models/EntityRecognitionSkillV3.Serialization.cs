...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EntityRecognitionSkillV3>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EntityRecognitionSkillV3>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EntityRecognitionSkillV3>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EntityRecognitionSkillV3>)} interface");
            }
        ...
        string IPersistableModel<EntityRecognitionSkillV3>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
