...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.AzureBlobKnowledgeSource"/>. </summary>
        ...
        /// <exception cref="global::System.ArgumentNullException"> <paramref name="name"/> or <paramref name="azureBlobParameters"/> is null. </exception>
        public AzureBlobKnowledgeSource(string name, AzureBlobKnowledgeSourceParameters azureBlobParameters) : base(name, global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind.AzureBlob)
        {
            global::Azure.Search.Documents.Argument.AssertNotNull(name, nameof(name));
            global::Azure.Search.Documents.Argument.AssertNotNull(azureBlobParameters, nameof(azureBlobParameters));
        ...
        /// <param name="azureBlobParameters"> The type of the knowledge source. </param>
        internal AzureBlobKnowledgeSource(string name, string description, KnowledgeSourceKind kind, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, AzureBlobKnowledgeSourceParameters azureBlobParameters) : base(name, description, kind, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            AzureBlobParameters = azureBlobParameters;
        }
