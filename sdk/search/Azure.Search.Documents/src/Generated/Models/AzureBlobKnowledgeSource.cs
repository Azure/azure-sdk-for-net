...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class AzureBlobKnowledgeSource : KnowledgeSource
    {
        ...
        public AzureBlobKnowledgeSource(string name, AzureBlobKnowledgeSourceParameters azureBlobParameters) : base(name, KnowledgeSourceKind.AzureBlob)
        {
        ...
        /// <param name="azureBlobParameters"> The type of the knowledge source. </param>
        internal AzureBlobKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureBlobKnowledgeSourceParameters azureBlobParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            AzureBlobParameters = azureBlobParameters;
        }
