...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public readonly partial struct VisualFeature : IEquatable<global::Azure.Search.Documents.Indexes.Models.VisualFeature>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.VisualFeature"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.VisualFeature"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(VisualFeature left, VisualFeature right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.VisualFeature"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(VisualFeature left, VisualFeature right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Search.Documents.Indexes.Models.VisualFeature"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is VisualFeature other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(VisualFeature other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
