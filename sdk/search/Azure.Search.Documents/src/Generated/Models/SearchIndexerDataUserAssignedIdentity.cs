...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchIndexerDataUserAssignedIdentity : SearchIndexerDataIdentity
    {
        ...
        internal SearchIndexerDataUserAssignedIdentity(string oDataType, string userAssignedIdentity, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, serializedAdditionalRawData)
        {
            UserAssignedIdentity = userAssignedIdentity;
