...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class HnswParameters
    {
        ...
        internal HnswParameters(int? m, int? efConstruction, int? efSearch, VectorSearchAlgorithmMetric? metric, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            M = m;
