...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class UaxUrlEmailTokenizer : IUtf8JsonSerializable, IModelJsonSerializable<UaxUrlEmailTokenizer>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<UaxUrlEmailTokenizer>(this, options.Format);
        ...
        internal static UaxUrlEmailTokenizer DeserializeUaxUrlEmailTokenizer(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UaxUrlEmailTokenizer(odataType, name, Optional.ToNullable(maxTokenLength), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="UaxUrlEmailTokenizer"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="UaxUrlEmailTokenizer"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="UaxUrlEmailTokenizer"/>. </summary>
