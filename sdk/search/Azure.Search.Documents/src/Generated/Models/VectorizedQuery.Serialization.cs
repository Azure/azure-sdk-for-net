...
namespace Azure.Search.Documents.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VectorizedQuery>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VectorizedQuery>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VectorizedQuery>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VectorizedQuery>)} interface");
            }
        ...
        string IPersistableModel<VectorizedQuery>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
