...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseAzureBlobActivityRecord : KnowledgeBaseActivityRecord
    {
        ...
        internal KnowledgeBaseAzureBlobActivityRecord(int id, KnowledgeBaseActivityRecordType @type, DateTimeOffset? startedOn, DateTimeOffset? completedOn, int? elapsedMs, KnowledgeBaseErrorDetail error, string warning, IDictionary<string, BinaryData> additionalBinaryDataProperties, string knowledgeSourceName, DateTimeOffset? queryOn, int? count, ImageServingStatistics imageServing, KnowledgeBaseAzureBlobActivityArguments azureBlobArguments, KnowledgeBaseQueryHintProcessing queryHintProcessing) : base(id, @type, startedOn, completedOn, elapsedMs, error, warning, additionalBinaryDataProperties)
        {
