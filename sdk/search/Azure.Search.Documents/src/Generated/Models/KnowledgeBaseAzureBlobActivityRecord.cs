...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseAzureBlobActivityRecord : KnowledgeBaseActivityRecord
    {
        ...
        internal KnowledgeBaseAzureBlobActivityRecord(int id, KnowledgeBaseActivityRecordType @type, int? elapsedMs, KnowledgeBaseErrorDetail error, IDictionary<string, BinaryData> additionalBinaryDataProperties, string knowledgeSourceName, DateTimeOffset? queryTime, int? count, KnowledgeBaseAzureBlobActivityArguments azureBlobArguments) : base(id, @type, elapsedMs, error, additionalBinaryDataProperties)
        {
