...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.EdgeNGramTokenizer"/>. </summary>
        ...
        public EdgeNGramTokenizer(string name) : base("#Microsoft.Azure.Search.EdgeNGramTokenizer", name)
        {
        ...
        internal EdgeNGramTokenizer(string odataType, string name, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, int? minGram, int? maxGram, IList<global::Azure.Search.Documents.Indexes.Models.TokenCharacterKind> tokenChars) : base(odataType, name, additionalBinaryDataProperties)
        {
            MinGram = minGram;
            MaxGram = maxGram;
