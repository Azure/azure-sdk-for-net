...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class AutocompleteResult
    {
        ...
        internal AutocompleteResult(double? coverage, IReadOnlyList<AutocompleteItem> results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Coverage = coverage;
            Results = results;
