...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class LanguageDetectionSkill : SearchIndexerSkill
    {
        ...
        internal LanguageDetectionSkill(string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, string defaultCountryHint, string modelVersion, Dictionary<string, BinaryData> rawData) : base(oDataType, name, description, context, inputs, outputs, rawData)
        {
