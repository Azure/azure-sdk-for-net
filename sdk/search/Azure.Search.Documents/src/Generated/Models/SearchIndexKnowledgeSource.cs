...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchIndexKnowledgeSource : KnowledgeSource
    {
        ...
        /// <param name="searchIndexParameters"> The parameters for the knowledge source. </param>
        internal SearchIndexKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, SearchIndexKnowledgeSourceParameters searchIndexParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            SearchIndexParameters = searchIndexParameters;
        }
