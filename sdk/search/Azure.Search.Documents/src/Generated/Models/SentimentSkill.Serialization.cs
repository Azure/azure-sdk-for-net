...
{
    public partial class SentimentSkill : Core.IUtf8JsonSerializable
    {
        ...
        internal static SentimentSkill DeserializeSentimentSkill(JsonElement element)
        {
            ...
            Core.Optional<SentimentSkillLanguage?> defaultLanguageCode = default;
            ...
            return new SentimentSkill(odataType, name.Value, description.Value, context.Value, inputs, outputs, Core.Optional.ToNullable(defaultLanguageCode));
        }
    }
}
