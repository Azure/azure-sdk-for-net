...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AMLParameters"/>. </summary>
        ...
        public AMLParameters(Uri scoringUri)
        {
        ...
        internal AMLParameters(Uri scoringUri, string authenticationKey, string resourceId, TimeSpan? timeout, string region, AIStudioModelCatalogName? modelName)
        {
            ScoringUri = scoringUri;
