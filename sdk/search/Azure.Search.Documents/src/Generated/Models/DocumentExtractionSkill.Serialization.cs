...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class DocumentExtractionSkill : SearchIndexerSkill, IJsonModel<global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill"/> for deserialization. </summary>
        ...
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    ...
                    {
                        return global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill.DeserializeDocumentExtractionSkill(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DocumentExtractionSkill IPersistableModel<global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill>.Create(BinaryData data, ModelReaderWriterOptions options) => ((DocumentExtractionSkill)this.PersistableModelCreateCore(data, options));

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill)} does not support writing '{format}' format.");
            }
            ...
            if (global::Azure.Search.Documents.Optional.IsCollectionDefined(Configuration))
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DocumentExtractionSkill IJsonModel<global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => ((DocumentExtractionSkill)this.JsonModelCreateCore(ref reader, options));
        ...
        protected override SearchIndexerSkill JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Search.Documents.Indexes.Models.DocumentExtractionSkill)} does not support reading '{format}' format.");
            }
