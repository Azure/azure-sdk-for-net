...
{
    public partial class AmlSkill : IUtf8JsonSerializable
    {
        ...
        internal static AmlSkill DeserializeAmlSkill(JsonElement element)
        {
            ...
            return new AmlSkill(odataType, name.Value, description.Value, context.Value, inputs, outputs, uri.Value, key.Value, resourceId.Value, Optional.ToNullable(timeout), region.Value, Optional.ToNullable(degreeOfParallelism));
        }
    }
}
