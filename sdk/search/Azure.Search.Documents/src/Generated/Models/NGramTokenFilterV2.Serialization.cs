...
namespace Azure.Search.Documents.Indexes.Models
{
    internal partial class NGramTokenFilterV2 : TokenFilter, IJsonModel<NGramTokenFilterV2>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NGramTokenFilterV2)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NGramTokenFilterV2 IJsonModel<NGramTokenFilterV2>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NGramTokenFilterV2)JsonModelCreateCore(ref reader, options);
        ...
        protected override TokenFilter JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NGramTokenFilterV2)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NGramTokenFilterV2>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NGramTokenFilterV2)} does not support writing '{options.Format}' format.");
            }
        }
