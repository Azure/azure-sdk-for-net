...
{
    public partial class LanguageDetectionSkill : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LanguageDetectionSkill DeserializeLanguageDetectionSkill(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
