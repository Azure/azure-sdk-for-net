...
{
    public partial class CharFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CharFilter DeserializeCharFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
