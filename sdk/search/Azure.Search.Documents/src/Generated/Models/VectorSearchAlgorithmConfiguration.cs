...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownVectorSearchAlgorithmConfiguration))]
    public abstract partial class VectorSearchAlgorithmConfiguration
    {
        ...
        internal VectorSearchAlgorithmConfiguration(string name, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Kind = kind;
