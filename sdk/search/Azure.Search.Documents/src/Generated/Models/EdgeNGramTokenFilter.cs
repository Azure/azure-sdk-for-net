...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class EdgeNGramTokenFilter : TokenFilter
    {
        ...
        public EdgeNGramTokenFilter(string name) : base("#Microsoft.Azure.Search.EdgeNGramTokenFilter", name)
        {
        ...
        internal EdgeNGramTokenFilter(string odataType, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, int? minGram, int? maxGram, EdgeNGramTokenFilterSide? side) : base(odataType, name, additionalBinaryDataProperties)
        {
            MinGram = minGram;
            MaxGram = maxGram;
            Side = side;
