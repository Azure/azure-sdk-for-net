...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class UnknownVectorQuery : VectorQuery
    {
        ...
        /// </param>
        internal UnknownVectorQuery(VectorQueryKind kind, int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold) : base(kind, kNearestNeighborsCount, fieldsRaw, exhaustive, oversampling, weight, threshold)
        {
            Kind = kind;
        }
    }
