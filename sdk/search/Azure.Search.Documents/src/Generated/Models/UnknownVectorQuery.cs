...
namespace Azure.Search.Documents.Models
{
    internal partial class UnknownVectorQuery : VectorQuery
    {
        ...
        internal UnknownVectorQuery(int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive, double? oversampling, float? weight, VectorQueryKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(kNearestNeighborsCount, fieldsRaw, exhaustive, oversampling, weight, kind != default ? kind : "unknown", additionalBinaryDataProperties)
        {
        }
    }
}
