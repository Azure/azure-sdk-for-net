...
namespace Azure.Search.Documents.Models
{
    internal partial class UnknownVectorQuery : VectorQuery
    {
        ...
        internal UnknownVectorQuery(int? kNearestNeighbors, string fieldsRaw, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string filterOverride, int? perDocumentVectorLimit, VectorQueryKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(kNearestNeighbors, fieldsRaw, exhaustive, oversampling, weight, threshold, filterOverride, perDocumentVectorLimit, kind != default ? kind : "unknown", additionalBinaryDataProperties)
        {
        }
    }
}
