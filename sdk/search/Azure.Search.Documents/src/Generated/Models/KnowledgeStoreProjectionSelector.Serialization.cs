...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KnowledgeStoreProjectionSelector>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KnowledgeStoreProjectionSelector>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KnowledgeStoreProjectionSelector>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KnowledgeStoreProjectionSelector>)} interface");
            }
        ...
        string IPersistableModel<KnowledgeStoreProjectionSelector>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
