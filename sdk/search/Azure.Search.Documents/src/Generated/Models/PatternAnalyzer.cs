...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class PatternAnalyzer : LexicalAnalyzer
    {
        ...
        internal PatternAnalyzer(string oDataType, string name, bool? lowerCaseTerms, string pattern, string flagsInternal, IList<string> stopwords, Dictionary<string, BinaryData> rawData) : base(oDataType, name, rawData)
        {
