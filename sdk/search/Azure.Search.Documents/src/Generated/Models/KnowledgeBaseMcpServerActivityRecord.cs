...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseMcpServerActivityRecord : KnowledgeBaseActivityRecord
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.KnowledgeBases.Models.KnowledgeBaseMcpServerActivityRecord"/>. </summary>
        /// <param name="id"> The ID of the activity record. </param>
        internal KnowledgeBaseMcpServerActivityRecord(int id) : base(id, global::Azure.Search.Documents.KnowledgeBases.Models.KnowledgeBaseActivityRecordType.McpServer)
        {
        }
        ...
        /// <summary> The MCP server arguments for the retrieval activity. </summary>
        public KnowledgeBaseMcpServerActivityArguments McpServerArguments { get; }
    }
}
