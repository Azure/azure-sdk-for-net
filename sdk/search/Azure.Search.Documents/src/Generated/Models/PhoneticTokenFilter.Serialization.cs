...
{
    public partial class PhoneticTokenFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PhoneticTokenFilter DeserializePhoneticTokenFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
