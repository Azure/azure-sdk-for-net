...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class ScalarQuantizationCompression : VectorSearchCompression
    {
        ...
        public ScalarQuantizationCompression(string compressionName) : base(compressionName, VectorSearchCompressionKind.ScalarQuantization)
        {
        ...
        internal ScalarQuantizationCompression(string compressionName, RescoringOptions rescoringOptions, int? truncationDimension, VectorSearchCompressionKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, ScalarQuantizationParameters parameters) : base(compressionName, rescoringOptions, truncationDimension, kind, additionalBinaryDataProperties)
        {
