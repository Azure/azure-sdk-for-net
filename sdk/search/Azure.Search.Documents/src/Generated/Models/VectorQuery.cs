...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class VectorQuery : VectorizableQuery
    {
        ...
        internal VectorQuery(VectorQueryKind kind, int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive, IReadOnlyList<float> vector) : base(kind, kNearestNeighborsCount, fieldsRaw, exhaustive)
        {
            Vector = vector;
            Kind = kind;
        }
