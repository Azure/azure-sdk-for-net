...
{
    public partial class DistanceScoringFunction : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DistanceScoringFunction DeserializeDistanceScoringFunction(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
