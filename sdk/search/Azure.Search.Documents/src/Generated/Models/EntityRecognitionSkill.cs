...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class EntityRecognitionSkill : Skill
    {
        ...
        internal EntityRecognitionSkill(IList<EntityCategory> categories, EntityRecognitionSkillLanguage? defaultLanguageCode, bool? includeTypelessEntities, double? minimumPrecision, string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs) : base(oDataType, name, description, context, inputs, outputs)
        {
