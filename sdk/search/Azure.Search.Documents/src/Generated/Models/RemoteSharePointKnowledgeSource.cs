...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class RemoteSharePointKnowledgeSource : KnowledgeSource
    {
        ...
        internal RemoteSharePointKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, RemoteSharePointKnowledgeSourceParameters remoteSharePointParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
