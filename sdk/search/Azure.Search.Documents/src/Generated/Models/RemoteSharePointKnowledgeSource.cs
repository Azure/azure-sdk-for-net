...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.RemoteSharePointKnowledgeSource"/>. </summary>
        ...
        public RemoteSharePointKnowledgeSource(string name) : base(name, global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind.RemoteSharePoint)
        {
        ...
        internal RemoteSharePointKnowledgeSource(string name, string description, KnowledgeSourceKind kind, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, RemoteSharePointKnowledgeSourceParameters remoteSharePointParameters) : base(name, description, kind, eTag, encryptionKey, additionalBinaryDataProperties)
        {
