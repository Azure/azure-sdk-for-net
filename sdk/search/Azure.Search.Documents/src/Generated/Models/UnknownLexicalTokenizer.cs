...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class UnknownLexicalTokenizer : LexicalTokenizer
    {
        ...
        internal UnknownLexicalTokenizer(string oDataType, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
