...
{
    public partial class LexicalTokenizer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LexicalTokenizer DeserializeLexicalTokenizer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
