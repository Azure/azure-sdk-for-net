...
{
    public partial class SearchIndex : IUtf8JsonSerializable, IModelJsonSerializable<SearchIndex>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SearchIndex>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SearchIndex>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SearchIndex>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Suggesters))
            {
                ...
                foreach (var item in Suggesters)
                {
                    ...
                    {
                        ((IModelJsonSerializable<SearchSuggester>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(Analyzers))
            {
                ...
                foreach (var item in Analyzers)
                {
                    ...
                    {
                        ((IModelJsonSerializable<LexicalAnalyzer>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(Tokenizers))
            {
                ...
                foreach (var item in Tokenizers)
                {
                    ...
                    {
                        ((IModelJsonSerializable<LexicalTokenizer>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            ...
            if (Optional.IsCollectionDefined(Normalizers))
            {
                ...
                foreach (var item in Normalizers)
                {
                    ...
                    {
                        ((IModelJsonSerializable<LexicalNormalizer>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            ...
            if (Optional.IsDefined(Similarity))
            {
                ...
                {
                    ((IModelJsonSerializable<SimilarityAlgorithm>)Similarity).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(SemanticSettings))
            {
                if (SemanticSettings != null)
                {
                    ...
                    if (SemanticSettings is null)
                    {
                        writer.WriteNullValue();
                    }
                    else
                    {
                        ((IModelJsonSerializable<SemanticSettings>)SemanticSettings).Serialize(writer, options);
                    }
                }
                else
                {
            ...
            if (Optional.IsDefined(VectorSearch))
            {
                if (VectorSearch != null)
                {
                    ...
                    {
                        ((IModelJsonSerializable<VectorSearch>)VectorSearch).Serialize(writer, options);
                    }
                }
                else
                {
        ...
        internal static SearchIndex DeserializeSearchIndex(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SearchIndex(name, fields, Optional.ToList(scoringProfiles), defaultScoringProfile.Value, corsOptions.Value, Optional.ToList(suggesters), Optional.ToList(analyzers), Optional.ToList(tokenizers), Optional.ToList(tokenFilters), Optional.ToList(charFilters), Optional.ToList(normalizers), encryptionKey.Value, similarity.Value, semantic.Value, vectorSearch.Value, odataEtag.Value, serializedAdditionalRawData);
        }

        SearchIndex IModelJsonSerializable<SearchIndex>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SearchIndex>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSearchIndex(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SearchIndex>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SearchIndex>(this, options.Format);
        ...
        SearchIndex IModelSerializable<SearchIndex>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SearchIndex>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SearchIndex"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SearchIndex"/> to convert. </param>
        public static implicit operator RequestContent(SearchIndex model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SearchIndex"/>. </summary>
        ...
        public static explicit operator SearchIndex(Response response)
        {
            ...
            return DeserializeSearchIndex(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
