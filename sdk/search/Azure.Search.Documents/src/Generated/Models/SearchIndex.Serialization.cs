...
{
    public partial class SearchIndex : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SearchIndex DeserializeSearchIndex(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
