...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class PrioritizedFields
    {
        ...
        /// <param name="prioritizedKeywordsFields"> Defines the keyword fields to be used for semantic ranking, captions, highlights, and answers. For the best result, the selected fields should contain a list of keywords. The order of the fields in the array represents their priority. Fields with lower priority may get truncated if the content is long. </param>
        internal PrioritizedFields(SemanticField titleField, IList<SemanticField> prioritizedContentFields, IList<SemanticField> prioritizedKeywordsFields)
        {
