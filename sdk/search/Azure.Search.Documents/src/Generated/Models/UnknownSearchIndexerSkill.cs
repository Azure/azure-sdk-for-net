...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class UnknownSearchIndexerSkill : SearchIndexerSkill
    {
        ...
        internal UnknownSearchIndexerSkill(string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, Dictionary<string, BinaryData> rawData) : base(oDataType, name, description, context, inputs, outputs, rawData)
        {
