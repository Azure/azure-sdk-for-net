...
namespace Azure.Search.Documents.Models
{
    ...
    public readonly partial struct QueryDebugMode : IEquatable<global::Azure.Search.Documents.Models.QueryDebugMode>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Models.QueryDebugMode"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Models.QueryDebugMode"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(QueryDebugMode left, QueryDebugMode right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Models.QueryDebugMode"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(QueryDebugMode left, QueryDebugMode right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Search.Documents.Models.QueryDebugMode"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is QueryDebugMode other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(QueryDebugMode other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
