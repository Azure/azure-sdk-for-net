...
{
    public partial class VectorSearchAlgorithmConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VectorSearchAlgorithmConfiguration DeserializeVectorSearchAlgorithmConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
