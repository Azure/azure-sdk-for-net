...
{
    public partial class StopAnalyzer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StopAnalyzer DeserializeStopAnalyzer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
