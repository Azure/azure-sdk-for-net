...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class UnknownVectorSearchAlgorithmConfiguration : VectorSearchAlgorithmConfiguration
    {
        ...
        internal UnknownVectorSearchAlgorithmConfiguration(string name, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, kind, serializedAdditionalRawData)
        {
            Kind = kind ?? "Unknown";
        }
