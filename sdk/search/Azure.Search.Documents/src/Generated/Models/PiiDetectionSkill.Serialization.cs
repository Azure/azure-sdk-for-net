...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PiiDetectionSkill>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PiiDetectionSkill>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PiiDetectionSkill>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PiiDetectionSkill>)} interface");
            }
        ...
        PiiDetectionSkill IJsonModel<PiiDetectionSkill>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(PiiDetectionSkill)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<PiiDetectionSkill>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
