...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class LuceneStandardTokenizer : IUtf8JsonSerializable, IJsonModel<LuceneStandardTokenizer>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LuceneStandardTokenizer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LuceneStandardTokenizer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
