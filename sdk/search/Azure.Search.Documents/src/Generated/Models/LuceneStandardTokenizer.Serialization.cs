...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class LuceneStandardTokenizer : IUtf8JsonSerializable, IJsonModel<LuceneStandardTokenizer>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LuceneStandardTokenizer>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LuceneStandardTokenizer>)} interface");
            }
