...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class WorkIQKnowledgeSource : KnowledgeSource
    {
        /// <summary> Initializes a new instance of <see cref="WorkIQKnowledgeSource"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="workIQParameters"/> is null. </exception>
        public WorkIQKnowledgeSource(string name, WorkIQKnowledgeSourceParameters workIQParameters) : base(name, KnowledgeSourceKind.WorkIQ)
        {
            Argument.AssertNotNull(name, nameof(name));
            Argument.AssertNotNull(workIQParameters, nameof(workIQParameters));

            WorkIQParameters = workIQParameters;
        }
        ...
        /// <param name="workIQParameters"> The parameters for the WorkIQ knowledge source, including the customer-owned Entra app configuration used for on-behalf-of authentication. </param>
        internal WorkIQKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, WorkIQKnowledgeSourceParameters workIQParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            WorkIQParameters = workIQParameters;
        }

        /// <summary> The parameters for the WorkIQ knowledge source, including the customer-owned Entra app configuration used for on-behalf-of authentication. </summary>
        public WorkIQKnowledgeSourceParameters WorkIQParameters { get; set; }
    }
}
