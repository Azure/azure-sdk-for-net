...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class WorkIQKnowledgeSource : KnowledgeSource
    {
        ...
        public WorkIQKnowledgeSource(string name) : base(name, KnowledgeSourceKind.WorkIQ)
        {
        ...
        internal WorkIQKnowledgeSource(string name, string description, KnowledgeSourceKind kind, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(name, description, kind, eTag, encryptionKey, additionalBinaryDataProperties)
        {
        }
    }
}
