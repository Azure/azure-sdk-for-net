...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.WorkIQKnowledgeSource"/>. </summary>
        ...
        public WorkIQKnowledgeSource(string name) : base(name, global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind.WorkIQ)
        {
        ...
        internal WorkIQKnowledgeSource(string name, string description, KnowledgeSourceKind kind, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties) : base(name, description, kind, eTag, encryptionKey, additionalBinaryDataProperties)
        {
        }
    }
}
