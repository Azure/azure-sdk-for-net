...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    internal partial class EdgeNGramTokenFilterV1 : TokenFilter
    {
        /// <summary> Initializes a new instance of <see cref="EdgeNGramTokenFilterV1"/>. </summary>
        /// <param name="name"> The name of the token filter. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public EdgeNGramTokenFilterV1(string name) : base(name)
        {
        ...
        internal EdgeNGramTokenFilterV1(string oDataType, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, int? minGram, int? maxGram, EdgeNGramTokenFilterSide? side) : base(oDataType, name, serializedAdditionalRawData)
        {
            MinGram = minGram;
            MaxGram = maxGram;
            Side = side;
        ...
        /// <summary> Initializes a new instance of <see cref="EdgeNGramTokenFilterV1"/> for deserialization. </summary>
        internal EdgeNGramTokenFilterV1()
        {
        }
