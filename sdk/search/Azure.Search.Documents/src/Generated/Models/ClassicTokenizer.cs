...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class ClassicTokenizer : LexicalTokenizer
    {
        ...
        internal ClassicTokenizer(string oDataType, string name, int? maxTokenLength, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
