...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class UnknownVectorSearchCompressionConfiguration : VectorSearchCompressionConfiguration
    {
        ...
        internal UnknownVectorSearchCompressionConfiguration(string name, VectorSearchCompressionKind kind, bool? rerankWithOriginalVectors, double? defaultOversampling) : base(name, kind, rerankWithOriginalVectors, defaultOversampling)
        {
            Kind = kind;
        }
    }
