...
namespace Azure.Search.Documents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchOptions>)} interface");
            }
        ...
        string IPersistableModel<SearchOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
