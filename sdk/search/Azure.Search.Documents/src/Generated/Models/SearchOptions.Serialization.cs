...
{
    public partial class SearchOptions : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SearchOptions DeserializeSearchOptions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
