...
namespace Azure.Search.Documents
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SearchOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchOptions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
