...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class CustomEntityAlias
    {
        ...
        internal CustomEntityAlias(string text, bool? caseSensitive, bool? accentSensitive, int? fuzzyEditDistance, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
