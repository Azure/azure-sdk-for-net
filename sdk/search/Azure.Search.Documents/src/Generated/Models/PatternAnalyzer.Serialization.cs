...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class PatternAnalyzer : IUtf8JsonSerializable
    {
        ...
        internal static PatternAnalyzer DeserializePatternAnalyzer(JsonElement element)
        {
            ...
            return new PatternAnalyzer(odataType, name, lowercase.HasValue ? lowercase.Value : (bool?)null, pattern.HasValue ? pattern.Value : null, flags.HasValue ? flags.Value : null, new ChangeTrackingList<string>(stopwords));
        }
    }
}
