...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class PatternAnalyzer : IUtf8JsonSerializable, IModelJsonSerializable<PatternAnalyzer>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PatternAnalyzer>(this, options.Format);
        ...
        internal static PatternAnalyzer DeserializePatternAnalyzer(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PatternAnalyzer(odataType, name, Optional.ToNullable(lowercase), pattern.Value, flags.Value, Optional.ToList(stopwords), serializedAdditionalRawData);
        }
