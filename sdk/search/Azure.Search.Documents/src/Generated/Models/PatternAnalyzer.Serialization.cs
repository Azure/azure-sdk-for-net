...
{
    public partial class PatternAnalyzer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PatternAnalyzer DeserializePatternAnalyzer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
