...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class SearchIndexerError
    {
        internal static SearchIndexerError DeserializeSearchIndexerError(JsonElement element)
        {
            ...
            return new SearchIndexerError(key.HasValue ? key.Value : null, errorMessage, statusCode, name.HasValue ? name.Value : null, details.HasValue ? details.Value : null, documentationLink.HasValue ? documentationLink.Value : null);
        }
    }
}
