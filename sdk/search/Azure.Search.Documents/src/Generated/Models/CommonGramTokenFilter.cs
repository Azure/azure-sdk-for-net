...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.CommonGramTokenFilter"/>. </summary>
        /// <param name="name"> The name of the token filter. It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters. </param>
        /// <param name="commonWords"> The set of common words. </param>
        /// <exception cref="global::System.ArgumentNullException"> <paramref name="name"/> or <paramref name="commonWords"/> is null. </exception>
        public CommonGramTokenFilter(string name, IEnumerable<string> commonWords) : base("#Microsoft.Azure.Search.CommonGramTokenFilter", name)
        {
            global::Azure.Search.Documents.Argument.AssertNotNull(name, nameof(name));
            global::Azure.Search.Documents.Argument.AssertNotNull(commonWords, nameof(commonWords));
        ...
        internal CommonGramTokenFilter(string odataType, string name, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, IList<string> commonWords, bool? ignoreCase, bool? useQueryMode) : base(odataType, name, additionalBinaryDataProperties)
        {
