...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="BM25SimilarityAlgorithm"/>. </summary>
        public BM25SimilarityAlgorithm() : base("#Microsoft.Azure.Search.BM25Similarity")
        {
        }
        ...
        internal BM25SimilarityAlgorithm(string odataType, IDictionary<string, BinaryData> additionalBinaryDataProperties, double? k1, double? b) : base(odataType, additionalBinaryDataProperties)
        {
            K1 = k1;
            B = b;
        }
