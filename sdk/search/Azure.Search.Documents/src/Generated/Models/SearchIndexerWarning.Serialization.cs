...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchIndexerWarning>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchIndexerWarning>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchIndexerWarning>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SearchIndexerWarning>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
