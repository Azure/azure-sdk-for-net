...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class VectorizedQuery : VectorQuery
    {
        ...
        /// <param name="vector"> The vector representation of a search query. </param>
        internal VectorizedQuery(int? kNearestNeighbors, string fieldsRaw, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string filterOverride, int? perDocumentVectorLimit, VectorQueryKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, ReadOnlyMemory<float> vector) : base(kNearestNeighbors, fieldsRaw, exhaustive, oversampling, weight, threshold, filterOverride, perDocumentVectorLimit, kind, additionalBinaryDataProperties)
        {
            Vector = vector;
        }
    }
