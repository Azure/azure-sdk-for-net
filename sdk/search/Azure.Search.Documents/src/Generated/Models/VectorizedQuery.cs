...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class VectorizedQuery : VectorQuery
    {
        ...
        /// <param name="vector"> The vector representation of a search query. </param>
        internal VectorizedQuery(int? kNearestNeighbors, IList<string> fields, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string filterOverride, int? perDocumentVectorLimit, VectorQueryKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, ReadOnlyMemory<float> vector) : base(kNearestNeighbors, fields, exhaustive, oversampling, weight, threshold, filterOverride, perDocumentVectorLimit, kind, additionalBinaryDataProperties)
        {
            Vector = vector;
        }
    }
