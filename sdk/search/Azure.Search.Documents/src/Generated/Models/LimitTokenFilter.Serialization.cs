...
{
    public partial class LimitTokenFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LimitTokenFilter DeserializeLimitTokenFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
