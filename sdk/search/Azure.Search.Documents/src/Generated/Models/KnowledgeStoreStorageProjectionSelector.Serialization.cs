...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class KnowledgeStoreStorageProjectionSelector : IUtf8JsonSerializable, IModelJsonSerializable<KnowledgeStoreStorageProjectionSelector>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<KnowledgeStoreStorageProjectionSelector>(this, options.Format);
        ...
        internal static KnowledgeStoreStorageProjectionSelector DeserializeKnowledgeStoreStorageProjectionSelector(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new Models.KnowledgeStoreStorageProjectionSelector(referenceKeyName.Value, generatedKeyName.Value, source.Value, sourceContext.Value, Optional.ToList(inputs), storageContainer, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="KnowledgeStoreStorageProjectionSelector"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="KnowledgeStoreStorageProjectionSelector"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="KnowledgeStoreStorageProjectionSelector"/>. </summary>
