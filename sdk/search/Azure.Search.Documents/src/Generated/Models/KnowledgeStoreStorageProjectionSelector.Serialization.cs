...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KnowledgeStoreStorageProjectionSelector>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KnowledgeStoreStorageProjectionSelector>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KnowledgeStoreStorageProjectionSelector>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KnowledgeStoreStorageProjectionSelector>)} interface");
            }
        ...
        string IPersistableModel<KnowledgeStoreStorageProjectionSelector>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
