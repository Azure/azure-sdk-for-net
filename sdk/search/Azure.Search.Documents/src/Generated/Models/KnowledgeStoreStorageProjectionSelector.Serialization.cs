...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KnowledgeStoreStorageProjectionSelector>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        KnowledgeStoreStorageProjectionSelector IJsonModel<KnowledgeStoreStorageProjectionSelector>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(KnowledgeStoreStorageProjectionSelector)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<KnowledgeStoreStorageProjectionSelector>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        KnowledgeStoreStorageProjectionSelector IModel<KnowledgeStoreStorageProjectionSelector>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<KnowledgeStoreStorageProjectionSelector>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
