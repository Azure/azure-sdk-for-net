...
{
    public partial class KnowledgeStoreStorageProjectionSelector : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KnowledgeStoreStorageProjectionSelector DeserializeKnowledgeStoreStorageProjectionSelector(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
            ...
            return new Models.KnowledgeStoreStorageProjectionSelector(referenceKeyName.Value, generatedKeyName.Value, source.Value, sourceContext.Value, Optional.ToList(inputs), storageContainer);
        }
    }
}
