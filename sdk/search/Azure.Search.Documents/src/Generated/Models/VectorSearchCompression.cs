...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public abstract partial class VectorSearchCompression
    {
        ...
        internal VectorSearchCompression(string compressionName, VectorSearchCompressionKind kind, RescoringOptions rescoringOptions, int? truncationDimension, bool? rerankWithOriginalVectors, double? defaultOversampling, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CompressionName = compressionName;
            Kind = kind;
