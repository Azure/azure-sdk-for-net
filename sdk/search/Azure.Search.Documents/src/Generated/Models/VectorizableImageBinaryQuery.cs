...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class VectorizableImageBinaryQuery : VectorQuery
    {
        ...
        internal VectorizableImageBinaryQuery(int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive, double? oversampling, float? weight, VectorQueryKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, string base64Image) : base(kNearestNeighborsCount, fieldsRaw, exhaustive, oversampling, weight, kind, additionalBinaryDataProperties)
        {
