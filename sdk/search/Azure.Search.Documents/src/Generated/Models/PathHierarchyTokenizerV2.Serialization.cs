...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class PathHierarchyTokenizerV2 : LexicalTokenizer, IJsonModel<PathHierarchyTokenizerV2>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PathHierarchyTokenizerV2>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PathHierarchyTokenizerV2 IJsonModel<PathHierarchyTokenizerV2>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PathHierarchyTokenizerV2)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PathHierarchyTokenizerV2 DeserializePathHierarchyTokenizerV2(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PathHierarchyTokenizerV2>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PathHierarchyTokenizerV2 IPersistableModel<PathHierarchyTokenizerV2>.Create(BinaryData data, ModelReaderWriterOptions options) => (PathHierarchyTokenizerV2)PersistableModelCreateCore(data, options);
