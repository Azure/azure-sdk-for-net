...
namespace Azure.Search.Documents
{
    ...
    public partial class SuggestOptions : IJsonModel<global::Azure.Search.Documents.SuggestOptions>
    {
        ...
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Search.Documents.SuggestOptions>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    ...
                    {
                        return global::Azure.Search.Documents.SuggestOptions.DeserializeSuggestOptions(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Search.Documents.SuggestOptions)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Search.Documents.SuggestOptions)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::Azure.Search.Documents.SuggestOptions>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SuggestOptions IPersistableModel<global::Azure.Search.Documents.SuggestOptions>.Create(BinaryData data, ModelReaderWriterOptions options) => this.PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::Azure.Search.Documents.SuggestOptions>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="suggestOptions"> The <see cref="global::Azure.Search.Documents.SuggestOptions"/> to serialize into <see cref="global::Azure.Core.RequestContent"/>. </param>
        public static implicit operator RequestContent(SuggestOptions suggestOptions)
        {
            ...
            return global::Azure.Core.RequestContent.Create(suggestOptions, global::Azure.Search.Documents.ModelSerializationExtensions.WireOptions);
        }

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::Azure.Search.Documents.SuggestOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Search.Documents.SuggestOptions)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SuggestOptions IJsonModel<global::Azure.Search.Documents.SuggestOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => this.JsonModelCreateCore(ref reader, options);
        ...
        protected virtual SuggestOptions JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Search.Documents.SuggestOptions)} does not support reading '{format}' format.");
            }
