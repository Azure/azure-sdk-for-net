...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class SearchServiceLimits
    {
        internal static SearchServiceLimits DeserializeSearchServiceLimits(JsonElement element)
        {
            ...
            return new SearchServiceLimits(maxFieldsPerIndex.HasValue ? maxFieldsPerIndex.Value : null, maxFieldNestingDepthPerIndex.HasValue ? maxFieldNestingDepthPerIndex.Value : null, maxComplexCollectionFieldsPerIndex.HasValue ? maxComplexCollectionFieldsPerIndex.Value : null, maxComplexObjectsInCollectionsPerDocument.HasValue ? maxComplexObjectsInCollectionsPerDocument.Value : null);
        }
    }
}
