...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class SearchIndexerLimits
    {
        internal static SearchIndexerLimits DeserializeSearchIndexerLimits(JsonElement element)
        {
            ...
            return new SearchIndexerLimits(maxRunTime.HasValue ? maxRunTime.Value : (TimeSpan?)null, maxDocumentExtractionSize.HasValue ? maxDocumentExtractionSize.Value : (long?)null, maxDocumentContentCharactersToExtract.HasValue ? maxDocumentContentCharactersToExtract.Value : (long?)null);
        }
    }
}
