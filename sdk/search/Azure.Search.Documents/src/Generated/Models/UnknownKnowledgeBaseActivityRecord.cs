...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.KnowledgeBases.Models.UnknownKnowledgeBaseActivityRecord"/>. </summary>
        ...
        internal UnknownKnowledgeBaseActivityRecord(int id, KnowledgeBaseActivityRecordType @type, int? elapsedMs, KnowledgeBaseErrorDetail error, string warning, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties) : base(id, (@type != default) ? @type : "unknown", elapsedMs, error, warning, additionalBinaryDataProperties)
        {
        }
    }
}
