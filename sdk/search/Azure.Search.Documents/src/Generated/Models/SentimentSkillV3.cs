...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    internal partial class SentimentSkillV3 : SearchIndexerSkill
    {
        ...
        internal SentimentSkillV3(string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, string defaultLanguageCode, bool? includeOpinionMining, string modelVersion, Dictionary<string, BinaryData> rawData) : base(oDataType, name, description, context, inputs, outputs, rawData)
        {
