...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class KnowledgeStoreProjection
    {
        ...
        internal KnowledgeStoreProjection(IList<KnowledgeStoreTableProjectionSelector> tables, IList<KnowledgeStoreObjectProjectionSelector> objects, IList<KnowledgeStoreFileProjectionSelector> files, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tables = tables;
            Objects = objects;
            Files = files;
