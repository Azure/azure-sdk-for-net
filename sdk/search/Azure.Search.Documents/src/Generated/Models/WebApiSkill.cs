...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class WebApiSkill : SearchIndexerSkill
    {
        ...
        public WebApiSkill(IEnumerable<InputFieldMappingEntry> inputs, IEnumerable<OutputFieldMappingEntry> outputs, string uri) : base("#Microsoft.Skills.Custom.WebApiSkill", inputs, outputs)
        {
