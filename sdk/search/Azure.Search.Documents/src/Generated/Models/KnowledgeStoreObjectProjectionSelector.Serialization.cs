...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KnowledgeStoreObjectProjectionSelector>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KnowledgeStoreObjectProjectionSelector>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KnowledgeStoreObjectProjectionSelector>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KnowledgeStoreObjectProjectionSelector>)} interface");
            }
        ...
        string IPersistableModel<KnowledgeStoreObjectProjectionSelector>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
