...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KnowledgeStoreObjectProjectionSelector>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        KnowledgeStoreObjectProjectionSelector IJsonModel<KnowledgeStoreObjectProjectionSelector>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(KnowledgeStoreObjectProjectionSelector)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<KnowledgeStoreObjectProjectionSelector>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        KnowledgeStoreObjectProjectionSelector IModel<KnowledgeStoreObjectProjectionSelector>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<KnowledgeStoreObjectProjectionSelector>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
