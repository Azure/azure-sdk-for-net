...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="ExhaustiveKnnVectorSearchAlgorithmConfiguration"/>. </summary>
        ...
        internal ExhaustiveKnnVectorSearchAlgorithmConfiguration(string name, VectorSearchAlgorithmKind kind, ExhaustiveKnnParameters parameters) : base(name, kind)
        {
