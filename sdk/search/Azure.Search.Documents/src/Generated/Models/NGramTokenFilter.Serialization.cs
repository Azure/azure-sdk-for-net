...
{
    public partial class NGramTokenFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NGramTokenFilter DeserializeNGramTokenFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
