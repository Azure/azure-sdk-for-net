...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchResourceEncryptionKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchResourceEncryptionKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchResourceEncryptionKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SearchResourceEncryptionKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
