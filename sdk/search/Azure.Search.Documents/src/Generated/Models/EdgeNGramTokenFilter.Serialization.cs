...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class EdgeNGramTokenFilter : IUtf8JsonSerializable, IJsonModel<EdgeNGramTokenFilter>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeNGramTokenFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EdgeNGramTokenFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
