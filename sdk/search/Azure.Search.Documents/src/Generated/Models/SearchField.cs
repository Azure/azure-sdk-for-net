...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchField
    {
        ...
        internal SearchField(string name, SearchFieldDataType type, bool? key, bool? retrievable, bool? searchable, bool? filterable, bool? sortable, bool? facetable, LexicalAnalyzerName? analyzer, LexicalAnalyzerName? searchAnalyzer, LexicalAnalyzerName? indexAnalyzer, LexicalNormalizerName? normalizer, IList<string> synonymMaps, IList<SearchField> fields)
        {
            Name = name;
            Type = type;
            Key = key;
