...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class SearchField
    {
        ...
        internal SearchField(string name, DataType type, bool? key, bool? isHidden, bool? searchable, bool? filterable, bool? sortable, bool? facetable, AnalyzerName? analyzer, AnalyzerName? searchAnalyzer, AnalyzerName? indexAnalyzer, IList<string> synonymMaps, IList<SearchField> fields)
        {
            Name = name;
            Type = type;
            Key = key;
