...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class VectorizableTextQuery : VectorQuery
    {
        ...
        /// <param name="text"> The text to be vectorized to perform a vector search query. </param>
        internal VectorizableTextQuery(VectorQueryKind kind, int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive, double? oversampling, float? weight, IDictionary<string, BinaryData> serializedAdditionalRawData, string text) : base(kind, kNearestNeighborsCount, fieldsRaw, exhaustive, oversampling, weight, serializedAdditionalRawData)
        {
            Text = text;
            Kind = kind;
        }
