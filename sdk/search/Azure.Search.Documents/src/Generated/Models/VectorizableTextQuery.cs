...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class VectorizableTextQuery : VectorQuery
    {
        ...
        /// <param name="text"> The text to be vectorized to perform a vector search query. </param>
        internal VectorizableTextQuery(int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive, double? oversampling, float? weight, VectorQueryKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, string text) : base(kNearestNeighborsCount, fieldsRaw, exhaustive, oversampling, weight, kind, additionalBinaryDataProperties)
        {
            Text = text;
        }
