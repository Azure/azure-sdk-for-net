...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class SearchIndexerKnowledgeStoreProjectionSelector
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SearchIndexerKnowledgeStoreProjectionSelector"/>. </summary>
        ...
        internal SearchIndexerKnowledgeStoreProjectionSelector(string referenceKeyName, string generatedKeyName, string source, string sourceContext, IList<InputFieldMappingEntry> inputs, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
