...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class SearchIndexerDataSourceConnection : IUtf8JsonSerializable
    {
        ...
        internal static SearchIndexerDataSourceConnection DeserializeSearchIndexerDataSourceConnection(JsonElement element)
        {
            ...
            return new SearchIndexerDataSourceConnection(name, description.HasValue ? description.Value : null, type, credentials, container, dataChangeDetectionPolicy.HasValue ? dataChangeDetectionPolicy.Value : null, dataDeletionDetectionPolicy.HasValue ? dataDeletionDetectionPolicy.Value : null, odataEtag.HasValue ? odataEtag.Value : null);
        }
    }
}
