...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchIndexerDataSourceConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchIndexerDataSourceConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchIndexerDataSourceConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchIndexerDataSourceConnection>)} interface");
            }
        ...
        string IPersistableModel<SearchIndexerDataSourceConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
