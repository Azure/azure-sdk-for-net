...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public readonly partial struct TokenFilterName : IEquatable<global::Azure.Search.Documents.Indexes.Models.TokenFilterName>
    {
        ...
        /// <summary> Folds Scandinavian characters Ã¥Ã…Ã¤Ã¦Ã„Ã†-&gt;a and Ã¶Ã–Ã¸Ã˜-&gt;o. It also discriminates against use of double vowels aa, ae, ao, oe and oo, leaving just the first one. See http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/ScandinavianFoldingFilter.html. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.TokenFilterName"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.TokenFilterName"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(TokenFilterName left, TokenFilterName right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.TokenFilterName"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(TokenFilterName left, TokenFilterName right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Search.Documents.Indexes.Models.TokenFilterName"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator TokenFilterName(string value) => new TokenFilterName(value);

        /// <summary> Converts a string to a <see cref="global::Azure.Search.Documents.Indexes.Models.TokenFilterName"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator TokenFilterName?(string value) => (value == null) ? null : new TokenFilterName(value);

        /// <inheritdoc/>
        [EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        public override bool Equals(object obj) => ((obj is TokenFilterName other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(TokenFilterName other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
