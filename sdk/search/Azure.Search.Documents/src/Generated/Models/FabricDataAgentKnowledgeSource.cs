...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="FabricDataAgentKnowledgeSource"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="fabricDataAgentParameters"/> is null. </exception>
        public FabricDataAgentKnowledgeSource(string name, FabricDataAgentKnowledgeSourceParameters fabricDataAgentParameters) : base(name, KnowledgeSourceKind.FabricDataAgent)
        {
            Argument.AssertNotNull(name, nameof(name));
            Argument.AssertNotNull(fabricDataAgentParameters, nameof(fabricDataAgentParameters));
        ...
        /// <param name="fabricDataAgentParameters"> The parameters for the Fabric Data Agent knowledge source. </param>
        internal FabricDataAgentKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, FabricDataAgentKnowledgeSourceParameters fabricDataAgentParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            FabricDataAgentParameters = fabricDataAgentParameters;
        }
