...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class PathHierarchyTokenizerV2 : LexicalTokenizer
    {
        ...
        public PathHierarchyTokenizerV2(string name) : base("#Microsoft.Azure.Search.PathHierarchyTokenizerV2", name)
        {
        ...
        internal PathHierarchyTokenizerV2(string odataType, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, string delimiter, string replacement, int? maxTokenLength, bool? reverseTokenOrder, int? numberOfTokensToSkip) : base(odataType, name, additionalBinaryDataProperties)
        {
            Delimiter = delimiter;
