...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchIndexerStatus
    {
        ...
        internal SearchIndexerStatus(IndexerStatus status, IndexerExecutionResult lastResult, IReadOnlyList<IndexerExecutionResult> executionHistory, SearchIndexerLimits limits, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
