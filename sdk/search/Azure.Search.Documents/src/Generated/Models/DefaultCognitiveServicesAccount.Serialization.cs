...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefaultCognitiveServicesAccount>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static DefaultCognitiveServicesAccount DeserializeDefaultCognitiveServicesAccount(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DefaultCognitiveServicesAccount(odataType, description, serializedAdditionalRawData);
        }
