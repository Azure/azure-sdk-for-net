...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class SynonymMap
    {
        ...
        public SynonymMap(string name, IEnumerable<string> synonyms)
        {
        ...
        internal SynonymMap(string name, string format, IList<string> synonyms, SearchResourceEncryptionKey encryptionKey, string eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Format = format;
            Synonyms = synonyms;
