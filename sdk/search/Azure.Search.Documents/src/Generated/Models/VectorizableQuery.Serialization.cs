...
{
    public partial class VectorizableQuery : IUtf8JsonSerializable
    {
        ...
        internal static VectorizableQuery DeserializeVectorizableQuery(JsonElement element)
        {
            ...
            if (element.TryGetProperty("kind", out JsonElement discriminator))
            {
                ...
                {
                    case "vector": return VectorQuery.DeserializeVectorQuery(element);
                }
            }
            return UnknownVectorizableQuery.DeserializeUnknownVectorizableQuery(element);
        }
    }
}
