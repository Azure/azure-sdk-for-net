...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public readonly partial struct DocumentIntelligenceLayoutSkillMarkdownHeaderDepth : IEquatable<global::Azure.Search.Documents.Indexes.Models.DocumentIntelligenceLayoutSkillMarkdownHeaderDepth>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.DocumentIntelligenceLayoutSkillMarkdownHeaderDepth"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.DocumentIntelligenceLayoutSkillMarkdownHeaderDepth"/> values are the same. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.DocumentIntelligenceLayoutSkillMarkdownHeaderDepth"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(DocumentIntelligenceLayoutSkillMarkdownHeaderDepth left, DocumentIntelligenceLayoutSkillMarkdownHeaderDepth right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Search.Documents.Indexes.Models.DocumentIntelligenceLayoutSkillMarkdownHeaderDepth"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is DocumentIntelligenceLayoutSkillMarkdownHeaderDepth other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(DocumentIntelligenceLayoutSkillMarkdownHeaderDepth other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
