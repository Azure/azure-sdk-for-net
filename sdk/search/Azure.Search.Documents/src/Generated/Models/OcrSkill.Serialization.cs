...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class OcrSkill : IUtf8JsonSerializable, IModelJsonSerializable<OcrSkill>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<OcrSkill>(this, options.Format);
        ...
        internal static OcrSkill DeserializeOcrSkill(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new OcrSkill(odataType, name.Value, description.Value, context.Value, inputs, outputs, Optional.ToNullable(defaultLanguageCode), Optional.ToNullable(detectOrientation), Optional.ToNullable(lineEnding), serializedAdditionalRawData);
        }
