...
{
    public partial class OcrSkill : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OcrSkill DeserializeOcrSkill(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
