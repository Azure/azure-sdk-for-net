...
{
    /// <summary> The UnknownSearchQueryVector. </summary>
    internal partial class UnknownSearchQueryVector : SearchQueryVector
    {
        /// <summary> Initializes a new instance of UnknownSearchQueryVector. </summary>
        ...
        internal UnknownSearchQueryVector(string kind, int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive) : base(kind, kNearestNeighborsCount, fieldsRaw, exhaustive)
        {
            Kind = kind ?? "Unknown";
        }
    }
