...
{
    public partial class TokenFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TokenFilter DeserializeTokenFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
