...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseSearchIndexActivityRecord : KnowledgeBaseActivityRecord
    {
        ...
        internal KnowledgeBaseSearchIndexActivityRecord(int id, KnowledgeBaseActivityRecordType @type, DateTimeOffset? startedAt, DateTimeOffset? completedAt, int? elapsedMs, KnowledgeBaseErrorDetail error, string warning, IDictionary<string, BinaryData> additionalBinaryDataProperties, string knowledgeSourceName, DateTimeOffset? queryTime, int? count, ImageServingStatistics imageServing, KnowledgeBaseSearchIndexActivityArguments searchIndexArguments, KnowledgeBaseQueryHintProcessing queryHintProcessing) : base(id, @type, startedAt, completedAt, elapsedMs, error, warning, additionalBinaryDataProperties)
        {
