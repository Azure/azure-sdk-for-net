...
namespace Azure.Search.Documents.Indexes.Models
{
    internal partial class UnknownKnowledgeSource : KnowledgeSource
    {
        ...
        internal UnknownKnowledgeSource(string name, string description, KnowledgeSourceKind kind, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(name, description, kind != default ? kind : "unknown", eTag, encryptionKey, additionalBinaryDataProperties)
        {
        }
    }
}
