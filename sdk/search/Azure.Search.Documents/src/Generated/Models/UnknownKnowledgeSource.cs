...
namespace Azure.Search.Documents.Indexes.Models
{
    internal partial class UnknownKnowledgeSource : KnowledgeSource
    {
        ...
        internal UnknownKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(name, description, kind != default ? kind : "unknown", resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
        }
    }
}
