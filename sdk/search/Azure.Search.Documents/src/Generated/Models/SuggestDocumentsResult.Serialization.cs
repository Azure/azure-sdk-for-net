...
namespace Azure.Search.Documents.Models
{
    internal partial class SuggestDocumentsResult : IUtf8JsonSerializable, IJsonModel<SuggestDocumentsResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SuggestDocumentsResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SuggestDocumentsResult>)} interface");
            }
