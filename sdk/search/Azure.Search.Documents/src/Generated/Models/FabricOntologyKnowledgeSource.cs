...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="FabricOntologyKnowledgeSource"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="fabricOntologyParameters"/> is null. </exception>
        public FabricOntologyKnowledgeSource(string name, FabricOntologyKnowledgeSourceParameters fabricOntologyParameters) : base(name, KnowledgeSourceKind.FabricOntology)
        {
            Argument.AssertNotNull(name, nameof(name));
            Argument.AssertNotNull(fabricOntologyParameters, nameof(fabricOntologyParameters));
        ...
        /// <param name="fabricOntologyParameters"> The parameters for the Fabric Ontology knowledge source. </param>
        internal FabricOntologyKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, FabricOntologyKnowledgeSourceParameters fabricOntologyParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            FabricOntologyParameters = fabricOntologyParameters;
        }
