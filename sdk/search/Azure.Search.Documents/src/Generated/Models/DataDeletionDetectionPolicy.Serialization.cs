...
{
    public partial class DataDeletionDetectionPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataDeletionDetectionPolicy DeserializeDataDeletionDetectionPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
