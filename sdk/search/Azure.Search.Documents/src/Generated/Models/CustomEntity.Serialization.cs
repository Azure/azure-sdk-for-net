...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomEntity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomEntity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomEntity>)} interface");
            }
        ...
        string IPersistableModel<CustomEntity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
