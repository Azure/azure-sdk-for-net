...
{
    public partial class CustomEntity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CustomEntity DeserializeCustomEntity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
