...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class PatternReplaceCharFilter : CharFilter
    {
        ...
        /// <param name="pattern"> A regular expression pattern. </param>
        /// <param name="replacement"> The replacement text. </param>
        internal PatternReplaceCharFilter(string odataType, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, string pattern, string replacement) : base(odataType, name, additionalBinaryDataProperties)
        {
            Pattern = pattern;
            Replacement = replacement;
        }
