...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class VectorizableImageUrlQuery : VectorQuery
    {
        ...
        internal VectorizableImageUrlQuery(int? kNearestNeighbors, IList<string> fields, bool? exhaustive, double? oversampling, float? weight, VectorThreshold threshold, string filterOverride, int? perDocumentVectorLimit, VectorQueryKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, string url) : base(kNearestNeighbors, fields, exhaustive, oversampling, weight, threshold, filterOverride, perDocumentVectorLimit, kind, additionalBinaryDataProperties)
        {
            Url = url;
        }
