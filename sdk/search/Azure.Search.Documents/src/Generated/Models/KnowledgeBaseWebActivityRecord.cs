...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseWebActivityRecord : KnowledgeBaseActivityRecord
    {
        ...
        internal KnowledgeBaseWebActivityRecord(int id, KnowledgeBaseActivityRecordType @type, int? elapsedMs, KnowledgeBaseErrorDetail error, IDictionary<string, BinaryData> additionalBinaryDataProperties, string knowledgeSourceName, DateTimeOffset? queryTime, int? count, KnowledgeBaseWebActivityArguments webArguments) : base(id, @type, elapsedMs, error, additionalBinaryDataProperties)
        {
