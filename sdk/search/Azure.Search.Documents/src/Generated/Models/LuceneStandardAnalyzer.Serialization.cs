...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LuceneStandardAnalyzer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LuceneStandardAnalyzer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LuceneStandardAnalyzer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LuceneStandardAnalyzer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
