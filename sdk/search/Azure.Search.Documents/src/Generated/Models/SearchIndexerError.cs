...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchIndexerError
    {
        ...
        internal SearchIndexerError(string key, string errorMessage, int statusCode, string name, string details, string documentationLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Key = key;
            ErrorMessage = errorMessage;
            StatusCode = statusCode;
