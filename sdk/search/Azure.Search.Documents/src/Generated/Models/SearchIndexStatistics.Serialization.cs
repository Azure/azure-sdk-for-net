...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchIndexStatistics>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchIndexStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchIndexStatistics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchIndexStatistics>)} interface");
            }
        ...
        string IPersistableModel<SearchIndexStatistics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
