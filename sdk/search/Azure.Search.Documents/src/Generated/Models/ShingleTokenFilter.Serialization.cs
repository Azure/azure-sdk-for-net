...
{
    public partial class ShingleTokenFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ShingleTokenFilter DeserializeShingleTokenFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
