...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchServiceCounters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchServiceCounters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchServiceCounters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchServiceCounters>)} interface");
            }
        ...
        string IPersistableModel<SearchServiceCounters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
