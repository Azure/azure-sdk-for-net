...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class LuceneStandardAnalyzer : LexicalAnalyzer
    {
        ...
        internal LuceneStandardAnalyzer(string oDataType, string name, int? maxTokenLength, IList<string> stopwords, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
