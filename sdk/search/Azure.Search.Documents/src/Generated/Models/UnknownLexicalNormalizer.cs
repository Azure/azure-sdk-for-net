...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class UnknownLexicalNormalizer : LexicalNormalizer
    {
        ...
        internal UnknownLexicalNormalizer(string oDataType, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
