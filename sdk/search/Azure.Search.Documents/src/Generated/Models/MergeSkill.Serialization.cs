...
{
    public partial class MergeSkill : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MergeSkill DeserializeMergeSkill(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
