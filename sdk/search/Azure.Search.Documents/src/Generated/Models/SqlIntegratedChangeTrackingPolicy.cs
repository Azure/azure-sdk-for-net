...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SqlIntegratedChangeTrackingPolicy : DataChangeDetectionPolicy
    {
        ...
        internal SqlIntegratedChangeTrackingPolicy(string oDataType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, serializedAdditionalRawData)
        {
