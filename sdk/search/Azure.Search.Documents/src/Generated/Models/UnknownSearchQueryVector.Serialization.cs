...
{
    internal partial class UnknownSearchQueryVector : IUtf8JsonSerializable
    {
        ...
        internal static UnknownSearchQueryVector DeserializeUnknownSearchQueryVector(JsonElement element)
        {
            ...
            return new UnknownSearchQueryVector(kind, Optional.ToNullable(k), fields.Value, Optional.ToNullable(exhaustive));
        }
    }
}
