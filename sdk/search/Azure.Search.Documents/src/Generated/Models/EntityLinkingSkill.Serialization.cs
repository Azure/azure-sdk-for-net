...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class EntityLinkingSkill : SearchIndexerSkill, IJsonModel<global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill"/> for deserialization. </summary>
        ...
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    ...
                    {
                        return global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill.DeserializeEntityLinkingSkill(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EntityLinkingSkill IPersistableModel<global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill>.Create(BinaryData data, ModelReaderWriterOptions options) => ((EntityLinkingSkill)this.PersistableModelCreateCore(data, options));

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EntityLinkingSkill IJsonModel<global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => ((EntityLinkingSkill)this.JsonModelCreateCore(ref reader, options));
        ...
        protected override SearchIndexerSkill JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Search.Documents.Indexes.Models.EntityLinkingSkill)} does not support reading '{format}' format.");
            }
