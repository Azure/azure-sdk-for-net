...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class EntityLinkingSkill : IUtf8JsonSerializable, IModelJsonSerializable<EntityLinkingSkill>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<EntityLinkingSkill>(this, options.Format);
        ...
        internal static EntityLinkingSkill DeserializeEntityLinkingSkill(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new EntityLinkingSkill(odataType, name.Value, description.Value, context.Value, inputs, outputs, defaultLanguageCode.Value, Optional.ToNullable(minimumPrecision), modelVersion.Value, serializedAdditionalRawData);
        }
