...
{
    public partial class CustomAnalyzer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CustomAnalyzer DeserializeCustomAnalyzer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
