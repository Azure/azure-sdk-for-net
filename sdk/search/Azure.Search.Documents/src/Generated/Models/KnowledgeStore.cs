...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class KnowledgeStore
    {
        ...
        internal KnowledgeStore(string storageConnectionString, IList<KnowledgeStoreProjection> projections, SearchIndexerDataIdentity identity, Dictionary<string, BinaryData> rawData)
        {
            StorageConnectionString = storageConnectionString;
