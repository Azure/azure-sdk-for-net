...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KnowledgeStore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KnowledgeStore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KnowledgeStore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KnowledgeStore>)} interface");
            }
        ...
        string IPersistableModel<KnowledgeStore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
