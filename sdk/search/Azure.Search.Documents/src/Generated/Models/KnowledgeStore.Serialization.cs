...
{
    public partial class KnowledgeStore : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KnowledgeStore DeserializeKnowledgeStore(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
