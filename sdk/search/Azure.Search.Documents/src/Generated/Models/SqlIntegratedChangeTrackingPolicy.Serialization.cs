...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class SqlIntegratedChangeTrackingPolicy : IUtf8JsonSerializable, IModelJsonSerializable<SqlIntegratedChangeTrackingPolicy>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlIntegratedChangeTrackingPolicy>(this, options.Format);
        ...
        internal static SqlIntegratedChangeTrackingPolicy DeserializeSqlIntegratedChangeTrackingPolicy(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SqlIntegratedChangeTrackingPolicy(odataType, rawData);
        }
        ...
        /// <summary> Converts a <see cref="SqlIntegratedChangeTrackingPolicy"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SqlIntegratedChangeTrackingPolicy"/> to convert. </param>
        public static implicit operator RequestContent(SqlIntegratedChangeTrackingPolicy model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SqlIntegratedChangeTrackingPolicy"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SqlIntegratedChangeTrackingPolicy(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSqlIntegratedChangeTrackingPolicy(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
