...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomEntityAlias>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomEntityAlias>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomEntityAlias>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CustomEntityAlias>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
