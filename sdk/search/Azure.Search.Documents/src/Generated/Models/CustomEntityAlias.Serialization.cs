...
{
    public partial class CustomEntityAlias : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CustomEntityAlias DeserializeCustomEntityAlias(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
