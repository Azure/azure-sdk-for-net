...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseFabricOntologyActivityRecord : KnowledgeBaseActivityRecord
    {
        /// <summary> Initializes a new instance of <see cref="KnowledgeBaseFabricOntologyActivityRecord"/>. </summary>
        /// <param name="id"> The ID of the activity record. </param>
        internal KnowledgeBaseFabricOntologyActivityRecord(int id) : base(id, KnowledgeBaseActivityRecordType.FabricOntology)
        {
        }
        ...
        internal KnowledgeBaseFabricOntologyActivityRecord(int id, KnowledgeBaseActivityRecordType @type, DateTimeOffset? startedOn, DateTimeOffset? completedOn, int? elapsedMs, KnowledgeBaseErrorDetail error, string warning, IDictionary<string, BinaryData> additionalBinaryDataProperties, string knowledgeSourceName, DateTimeOffset? queryOn, int? count, ImageServingStatistics imageServing, KnowledgeBaseFabricOntologyActivityArguments fabricOntologyArguments) : base(id, @type, startedOn, completedOn, elapsedMs, error, warning, additionalBinaryDataProperties)
        {
        ...
        /// <summary> The Fabric Ontology arguments for the retrieval activity. </summary>
        public KnowledgeBaseFabricOntologyActivityArguments FabricOntologyArguments { get; }
    }
}
