...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.KnowledgeBases.Models.KnowledgeBaseFabricOntologyActivityRecord"/>. </summary>
        /// <param name="id"> The ID of the activity record. </param>
        internal KnowledgeBaseFabricOntologyActivityRecord(int id) : base(id, global::Azure.Search.Documents.KnowledgeBases.Models.KnowledgeBaseActivityRecordType.FabricOntology)
        {
        }
