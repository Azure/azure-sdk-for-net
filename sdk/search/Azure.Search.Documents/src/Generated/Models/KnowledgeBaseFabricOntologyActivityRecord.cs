...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseFabricOntologyActivityRecord : KnowledgeBaseActivityRecord
    {
        ...
        internal KnowledgeBaseFabricOntologyActivityRecord(int id, KnowledgeBaseActivityRecordType @type, DateTimeOffset? startedAt, DateTimeOffset? completedAt, int? elapsedMs, KnowledgeBaseErrorDetail error, string warning, IDictionary<string, BinaryData> additionalBinaryDataProperties, string knowledgeSourceName, DateTimeOffset? queryTime, int? count, ImageServingStatistics imageServing, KnowledgeBaseFabricOntologyActivityArguments fabricOntologyArguments) : base(id, @type, startedAt, completedAt, elapsedMs, error, warning, additionalBinaryDataProperties)
        {
