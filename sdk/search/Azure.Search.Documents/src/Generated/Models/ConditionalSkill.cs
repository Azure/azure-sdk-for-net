...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class ConditionalSkill : SearchIndexerSkill
    {
        ...
        internal ConditionalSkill(string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, description, context, inputs, outputs, serializedAdditionalRawData)
        {
