...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.SnowballTokenFilter"/>. </summary>
        ...
        /// <param name="language"> The language to use. </param>
        internal SnowballTokenFilter(string odataType, string name, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, SnowballTokenFilterLanguage language) : base(odataType, name, additionalBinaryDataProperties)
        {
            Language = language;
        }
