...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class PatternReplaceTokenFilter : TokenFilter
    {
        ...
        internal PatternReplaceTokenFilter(string oDataType, string name, string pattern, string replacement, Dictionary<string, BinaryData> rawData) : base(oDataType, name, rawData)
        {
            Pattern = pattern;
            Replacement = replacement;
