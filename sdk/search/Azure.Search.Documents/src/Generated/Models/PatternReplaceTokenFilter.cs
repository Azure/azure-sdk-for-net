...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class PatternReplaceTokenFilter : TokenFilter
    {
        ...
        internal PatternReplaceTokenFilter(string oDataType, string name, string pattern, string replacement, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
            Pattern = pattern;
            Replacement = replacement;
