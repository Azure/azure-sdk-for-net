...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class PatternReplaceTokenFilter : TokenFilter
    {
        ...
        /// <param name="pattern"> A regular expression pattern. </param>
        /// <param name="replacement"> The replacement text. </param>
        internal PatternReplaceTokenFilter(string odataType, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, string pattern, string replacement) : base(odataType, name, additionalBinaryDataProperties)
        {
            Pattern = pattern;
            Replacement = replacement;
        }
