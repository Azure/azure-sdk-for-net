...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="McpServerKnowledgeSource"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="mcpServerParameters"/> is null. </exception>
        public McpServerKnowledgeSource(string name, McpServerKnowledgeSourceParameters mcpServerParameters) : base(name, KnowledgeSourceKind.McpServer)
        {
            Argument.AssertNotNull(name, nameof(name));
            Argument.AssertNotNull(mcpServerParameters, nameof(mcpServerParameters));
        ...
        /// <param name="mcpServerParameters"> The parameters for the MCP server knowledge source. </param>
        internal McpServerKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, McpServerKnowledgeSourceParameters mcpServerParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            McpServerParameters = mcpServerParameters;
        }
