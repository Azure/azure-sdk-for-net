...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class McpServerKnowledgeSource : KnowledgeSource
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.McpServerKnowledgeSource"/>. </summary>
        ...
        /// <exception cref="global::System.ArgumentNullException"> <paramref name="name"/> or <paramref name="mcpServerParameters"/> is null. </exception>
        public McpServerKnowledgeSource(string name, McpServerKnowledgeSourceParameters mcpServerParameters) : base(name, global::Azure.Search.Documents.Indexes.Models.KnowledgeSourceKind.McpServer)
        {
            global::Azure.Search.Documents.Argument.AssertNotNull(name, nameof(name));
            global::Azure.Search.Documents.Argument.AssertNotNull(mcpServerParameters, nameof(mcpServerParameters));

            McpServerParameters = mcpServerParameters;
        }
        ...
        /// <param name="mcpServerParameters"> The parameters for the MCP server knowledge source. </param>
        internal McpServerKnowledgeSource(string name, string description, KnowledgeSourceKind kind, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, McpServerKnowledgeSourceParameters mcpServerParameters) : base(name, description, kind, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            McpServerParameters = mcpServerParameters;
        }

        /// <summary> The parameters for the MCP server knowledge source. </summary>
        public McpServerKnowledgeSourceParameters McpServerParameters { get; set; }
    }
}
