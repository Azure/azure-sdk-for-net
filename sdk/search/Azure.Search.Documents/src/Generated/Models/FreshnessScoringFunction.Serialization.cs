...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FreshnessScoringFunction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FreshnessScoringFunction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FreshnessScoringFunction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FreshnessScoringFunction>)} interface");
            }
        ...
        string IPersistableModel<FreshnessScoringFunction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
