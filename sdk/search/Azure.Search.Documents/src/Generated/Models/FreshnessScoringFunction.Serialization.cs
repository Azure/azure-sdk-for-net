...
{
    public partial class FreshnessScoringFunction : Core.IUtf8JsonSerializable
    {
        ...
        internal static FreshnessScoringFunction DeserializeFreshnessScoringFunction(JsonElement element)
        {
            ...
            return new FreshnessScoringFunction(type, fieldName, boost, Core.Optional.ToNullable(interpolation), freshness);
        }
    }
}
