...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class VectorSearch
    {
        ...
        internal VectorSearch(IList<VectorSearchProfile> profiles, IList<VectorSearchAlgorithmConfiguration> algorithms, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Profiles = profiles;
