...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class IndexedSqlKnowledgeSource : KnowledgeSource
    {
        ...
        /// <param name="indexedSqlParameters"> The parameters for the SQL knowledge source. </param>
        internal IndexedSqlKnowledgeSource(string name, string description, KnowledgeSourceKind kind, KnowledgeSourceResultsProcessing? resultsProcessing, ETag? eTag, SearchResourceEncryptionKey encryptionKey, IDictionary<string, BinaryData> additionalBinaryDataProperties, IndexedSqlKnowledgeSourceParameters indexedSqlParameters) : base(name, description, kind, resultsProcessing, eTag, encryptionKey, additionalBinaryDataProperties)
        {
            IndexedSqlParameters = indexedSqlParameters;
        }
