...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class IndexerExecutionResult : IUtf8JsonSerializable, IModelJsonSerializable<IndexerExecutionResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IndexerExecutionResult>(this, options.Format);
        ...
        internal static IndexerExecutionResult DeserializeIndexerExecutionResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IndexerExecutionResult(status, Optional.ToNullable(statusDetail), currentState.Value, errorMessage.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), errors, warnings, itemsProcessed, itemsFailed, initialTrackingState.Value, finalTrackingState.Value, serializedAdditionalRawData);
        }
