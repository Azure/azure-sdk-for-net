...
{
    internal partial class UnknownVectorThreshold : VectorThreshold, IJsonModel<global::Azure.Search.Documents.Models.VectorThreshold>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Models.UnknownVectorThreshold"/> for deserialization. </summary>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownVectorThreshold DeserializeUnknownVectorThreshold(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownVectorThreshold(kind, additionalBinaryDataProperties);
        }
    }
}
