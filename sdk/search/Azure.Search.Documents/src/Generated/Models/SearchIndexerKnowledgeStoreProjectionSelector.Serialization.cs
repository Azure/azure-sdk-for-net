...
{
    public partial class SearchIndexerKnowledgeStoreProjectionSelector : IUtf8JsonSerializable
    {
        ...
        internal static SearchIndexerKnowledgeStoreProjectionSelector DeserializeSearchIndexerKnowledgeStoreProjectionSelector(JsonElement element)
        {
            ...
            return new SearchIndexerKnowledgeStoreProjectionSelector(referenceKeyName.Value, generatedKeyName.Value, source.Value, sourceContext.Value, Optional.ToList(inputs));
        }
    }
}
