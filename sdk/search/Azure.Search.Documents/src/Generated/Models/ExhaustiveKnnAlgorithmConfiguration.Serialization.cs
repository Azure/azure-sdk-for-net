...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExhaustiveKnnAlgorithmConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExhaustiveKnnAlgorithmConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExhaustiveKnnAlgorithmConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExhaustiveKnnAlgorithmConfiguration>)} interface");
            }
        ...
        string IPersistableModel<ExhaustiveKnnAlgorithmConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
