...
{
    public partial class CorsOptions : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CorsOptions DeserializeCorsOptions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
