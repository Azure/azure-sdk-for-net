...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class ShaperSkill : SearchIndexerSkill
    {
        ...
        internal ShaperSkill(string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, Dictionary<string, BinaryData> rawData) : base(oDataType, name, description, context, inputs, outputs, rawData)
        {
