...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class WebApiVectorizerParameters
    {
        ...
        internal WebApiVectorizerParameters(Uri uri, IDictionary<string, string> httpHeaders, string httpMethod, TimeSpan? timeout, ResourceIdentifier authResourceId, SearchIndexerDataIdentity authIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
