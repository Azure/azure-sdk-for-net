...
{
    public partial class SplitSkill : Core.IUtf8JsonSerializable
    {
        ...
        internal static SplitSkill DeserializeSplitSkill(JsonElement element)
        {
            ...
            Core.Optional<SplitSkillLanguage?> defaultLanguageCode = default;
            Core.Optional<TextSplitMode> textSplitMode = default;
            Core.Optional<int?> maximumPageLength = default;
            ...
            return new SplitSkill(odataType, name.Value, description.Value, context.Value, inputs, outputs, Core.Optional.ToNullable(defaultLanguageCode), Core.Optional.ToNullable(textSplitMode), Core.Optional.ToNullable(maximumPageLength));
        }
    }
}
