...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class IndexingParameters
    {
        ...
        internal IndexingParameters(int? batchSize, int? maxFailedItems, int? maxFailedItemsPerBatch, IndexingParametersConfiguration indexingParametersConfiguration, Dictionary<string, BinaryData> rawData)
        {
            BatchSize = batchSize;
