...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public readonly partial struct SentimentSkillLanguage : IEquatable<global::Azure.Search.Documents.Indexes.Models.SentimentSkillLanguage>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.SentimentSkillLanguage"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.SentimentSkillLanguage"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(SentimentSkillLanguage left, SentimentSkillLanguage right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Search.Documents.Indexes.Models.SentimentSkillLanguage"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(SentimentSkillLanguage left, SentimentSkillLanguage right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Search.Documents.Indexes.Models.SentimentSkillLanguage"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is SentimentSkillLanguage other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(SentimentSkillLanguage other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
