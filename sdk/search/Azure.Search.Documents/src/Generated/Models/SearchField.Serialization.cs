...
{
    public partial class SearchField : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SearchField DeserializeSearchField(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
