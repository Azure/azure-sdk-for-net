...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class KeywordTokenizer : LexicalTokenizer
    {
        ...
        internal KeywordTokenizer(string oDataType, string name, int? maxTokenLength, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
