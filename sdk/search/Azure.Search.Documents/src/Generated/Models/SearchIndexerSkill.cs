...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SearchIndexerSkill
    {
        ...
        internal SearchIndexerSkill(string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ODataType = oDataType;
            Name = name;
