...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class LengthTokenFilter : TokenFilter
    {
        ...
        internal LengthTokenFilter(string oDataType, string name, int? minLength, int? maxLength, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
            MinLength = minLength;
            MaxLength = maxLength;
