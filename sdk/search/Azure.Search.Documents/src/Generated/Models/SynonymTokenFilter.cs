...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class SynonymTokenFilter : TokenFilter
    {
        ...
        internal SynonymTokenFilter(string odataType, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> synonyms, bool? ignoreCase, bool? expand) : base(odataType, name, additionalBinaryDataProperties)
        {
            Synonyms = synonyms;
