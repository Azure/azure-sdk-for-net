...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Search.Documents.Indexes.Models.SynonymTokenFilter"/>. </summary>
        ...
        /// <exception cref="global::System.ArgumentNullException"> <paramref name="name"/> or <paramref name="synonyms"/> is null. </exception>
        public SynonymTokenFilter(string name, IEnumerable<string> synonyms) : base("#Microsoft.Azure.Search.SynonymTokenFilter", name)
        {
            global::Azure.Search.Documents.Argument.AssertNotNull(name, nameof(name));
            global::Azure.Search.Documents.Argument.AssertNotNull(synonyms, nameof(synonyms));
        ...
        internal SynonymTokenFilter(string odataType, string name, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, IList<string> synonyms, bool? ignoreCase, bool? expand) : base(odataType, name, additionalBinaryDataProperties)
        {
            Synonyms = synonyms;
