...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class PathHierarchyTokenizer : IUtf8JsonSerializable, IModelJsonSerializable<PathHierarchyTokenizer>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PathHierarchyTokenizer>(this, options.Format);
        ...
        internal static PathHierarchyTokenizer DeserializePathHierarchyTokenizer(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PathHierarchyTokenizer(odataType, name, Optional.ToNullable(delimiter), Optional.ToNullable(replacement), Optional.ToNullable(maxTokenLength), Optional.ToNullable(reverse), Optional.ToNullable(skip), serializedAdditionalRawData);
        }
