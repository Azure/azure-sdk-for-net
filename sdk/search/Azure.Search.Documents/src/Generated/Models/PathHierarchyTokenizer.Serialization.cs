...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class PathHierarchyTokenizer : IUtf8JsonSerializable
    {
        ...
        internal static PathHierarchyTokenizer DeserializePathHierarchyTokenizer(JsonElement element)
        {
            ...
            return new PathHierarchyTokenizer(odataType, name, delimiter.HasValue ? delimiter.Value : (char?)null, replacement.HasValue ? replacement.Value : (char?)null, maxTokenLength.HasValue ? maxTokenLength.Value : (int?)null, reverse.HasValue ? reverse.Value : (bool?)null, skip.HasValue ? skip.Value : (int?)null);
        }
    }
}
