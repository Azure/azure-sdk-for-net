...
{
    public partial class KeepTokenFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KeepTokenFilter DeserializeKeepTokenFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
