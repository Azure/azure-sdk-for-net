...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class CustomNormalizer : LexicalNormalizer
    {
        ...
        internal CustomNormalizer(string oDataType, string name, IList<TokenFilterName> tokenFilters, IList<CharFilterName> charFilters, Dictionary<string, BinaryData> rawData) : base(oDataType, name, rawData)
        {
