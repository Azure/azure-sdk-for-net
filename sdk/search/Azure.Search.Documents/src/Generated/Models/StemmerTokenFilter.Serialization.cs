...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class StemmerTokenFilter : IUtf8JsonSerializable, IModelJsonSerializable<StemmerTokenFilter>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StemmerTokenFilter>(this, options.Format);
        ...
        internal static StemmerTokenFilter DeserializeStemmerTokenFilter(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new StemmerTokenFilter(odataType, name, language, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="StemmerTokenFilter"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StemmerTokenFilter"/> to convert. </param>
        public static implicit operator RequestContent(StemmerTokenFilter model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StemmerTokenFilter"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator StemmerTokenFilter(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeStemmerTokenFilter(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
