...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class SearchQueryVector
    {
        ...
        internal SearchQueryVector(IReadOnlyList<float> value, int? kNearestNeighborsCount, string fieldsRaw, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
