...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class VisionVectorizeSkill : SearchIndexerSkill
    {
        ...
        /// <param name="outputs"> The output of a skill is either a field in a search index, or a value that can be consumed as an input by another skill. </param>
        /// <param name="modelVersion"> The version of the model to use when calling the AI Services Vision service. It will default to the latest available when not specified. </param>
        internal VisionVectorizeSkill(string oDataType, string name, string description, string context, IList<InputFieldMappingEntry> inputs, IList<OutputFieldMappingEntry> outputs, string modelVersion) : base(oDataType, name, description, context, inputs, outputs)
        {
            ModelVersion = modelVersion;
