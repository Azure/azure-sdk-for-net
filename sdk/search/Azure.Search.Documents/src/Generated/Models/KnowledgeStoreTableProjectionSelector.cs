...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class KnowledgeStoreTableProjectionSelector : KnowledgeStoreProjectionSelector
    {
        ...
        internal KnowledgeStoreTableProjectionSelector(string referenceKeyName, string generatedKeyName, string source, string sourceContext, IList<InputFieldMappingEntry> inputs, string tableName, Dictionary<string, BinaryData> rawData) : base(referenceKeyName, generatedKeyName, source, sourceContext, inputs, rawData)
        {
            TableName = tableName;
        }
