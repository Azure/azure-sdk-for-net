...
namespace Azure.Search.Documents.Indexes.Models
{
    public partial class SearchResourceCounter : IUtf8JsonSerializable, IJsonModel<SearchResourceCounter>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchResourceCounter>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchResourceCounter>)} interface");
            }
