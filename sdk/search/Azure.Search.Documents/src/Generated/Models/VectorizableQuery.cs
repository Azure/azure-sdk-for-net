...
namespace Azure.Search.Documents.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VectorizableQuery. </summary>
        ...
        internal VectorizableQuery(VectorQueryKind kind, int? kNearestNeighborsCount, string fieldsRaw, bool? exhaustive)
        {
            Kind = kind;
