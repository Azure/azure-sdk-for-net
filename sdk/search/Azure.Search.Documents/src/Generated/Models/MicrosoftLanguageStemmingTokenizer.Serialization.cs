...
{
    public partial class MicrosoftLanguageStemmingTokenizer : Core.IUtf8JsonSerializable
    {
        ...
        internal static MicrosoftLanguageStemmingTokenizer DeserializeMicrosoftLanguageStemmingTokenizer(JsonElement element)
        {
            ...
            Core.Optional<MicrosoftStemmingTokenizerLanguage> language = default;
            ...
            return new MicrosoftLanguageStemmingTokenizer(odataType, name, Core.Optional.ToNullable(maxTokenLength), Core.Optional.ToNullable(isSearchTokenizer), Core.Optional.ToNullable(language));
        }
    }
}
