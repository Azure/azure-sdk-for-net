...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MicrosoftLanguageStemmingTokenizer>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MicrosoftLanguageStemmingTokenizer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MicrosoftLanguageStemmingTokenizer)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MicrosoftLanguageStemmingTokenizer>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MicrosoftLanguageStemmingTokenizer)} does not support '{options.Format}' format.");
            }
        }
