...
{
    public partial class WebApiSkill : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebApiSkill DeserializeWebApiSkill(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
