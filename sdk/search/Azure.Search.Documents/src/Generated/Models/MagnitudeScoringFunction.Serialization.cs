...
{
    public partial class MagnitudeScoringFunction : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MagnitudeScoringFunction DeserializeMagnitudeScoringFunction(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
