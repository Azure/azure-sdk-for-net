...
{
    public partial class MagnitudeScoringFunction : Core.IUtf8JsonSerializable
    {
        ...
        internal static MagnitudeScoringFunction DeserializeMagnitudeScoringFunction(JsonElement element)
        {
            ...
            return new MagnitudeScoringFunction(type, fieldName, boost, Core.Optional.ToNullable(interpolation), magnitude);
        }
    }
}
