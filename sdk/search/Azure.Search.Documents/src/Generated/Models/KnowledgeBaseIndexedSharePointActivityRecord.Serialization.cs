...
namespace Azure.Search.Documents.KnowledgeBases.Models
{
    ...
    public partial class KnowledgeBaseIndexedSharePointActivityRecord : KnowledgeBaseActivityRecord, IJsonModel<KnowledgeBaseIndexedSharePointActivityRecord>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<KnowledgeBaseIndexedSharePointActivityRecord>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KnowledgeBaseIndexedSharePointActivityRecord>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KnowledgeBaseIndexedSharePointActivityRecord IPersistableModel<KnowledgeBaseIndexedSharePointActivityRecord>.Create(BinaryData data, ModelReaderWriterOptions options) => (KnowledgeBaseIndexedSharePointActivityRecord)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KnowledgeBaseIndexedSharePointActivityRecord IJsonModel<KnowledgeBaseIndexedSharePointActivityRecord>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (KnowledgeBaseIndexedSharePointActivityRecord)JsonModelCreateCore(ref reader, options);
