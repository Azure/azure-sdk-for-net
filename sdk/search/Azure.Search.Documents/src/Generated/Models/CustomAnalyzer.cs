...
namespace Azure.Search.Documents.Models
{
    ...
    public partial class CustomAnalyzer : LexicalAnalyzer
    {
        ...
        internal CustomAnalyzer(string odataType, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, LexicalTokenizerName tokenizer, IList<TokenFilterName> tokenFilters, IList<CharFilterName> charFilters) : base(odataType, name, additionalBinaryDataProperties)
        {
            Tokenizer = tokenizer;
