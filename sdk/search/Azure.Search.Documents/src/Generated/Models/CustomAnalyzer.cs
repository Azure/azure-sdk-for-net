...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class CustomAnalyzer : LexicalAnalyzer
    {
        ...
        internal CustomAnalyzer(string oDataType, string name, LexicalTokenizerName tokenizerName, IList<TokenFilterName> tokenFilters, IList<string> charFilters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(oDataType, name, serializedAdditionalRawData)
        {
