...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class CustomAnalyzer : LexicalAnalyzer
    {
        ...
        internal CustomAnalyzer(string odataType, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, LexicalTokenizerName tokenizerName, IList<TokenFilterName> tokenFilters, IList<CharFilterName> charFilters) : base(odataType, name, additionalBinaryDataProperties)
        {
            TokenizerName = tokenizerName;
