...
namespace Azure.Search.Documents
{
    internal partial class IndexesRestClient
    {
        ...
        public IndexesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, Guid? xMsClientRequestId = null, string apiVersion = "2025-05-01-preview")
        {
        ...
        internal HttpMessage CreateCreateRequest(SearchIndex index)
        {
            ...
            ((IJsonModel<SearchIndex>)index).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateAnalyzeRequest(string indexName, AnalyzeTextOptions request)
        {
            ...
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<AnalyzeTextOptions>)request).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
