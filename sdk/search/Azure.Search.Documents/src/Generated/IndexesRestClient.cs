...
namespace Azure.Search.Documents
{
    internal partial class IndexesRestClient
    {
        ...
        internal HttpMessage CreateAnalyzeRequest(string indexName, AnalyzeTextRequest request)
        {
            var message = _pipeline.CreateMessage();
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<AnalyzeResult>> AnalyzeAsync(string indexName, AnalyzeTextRequest request, CancellationToken cancellationToken = default)
        {
            if (indexName == null)
            {
                throw new ArgumentNullException(nameof(indexName));
        ...
        /// <param name="request"> The text and analyzer or analysis components to test. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<AnalyzeResult> Analyze(string indexName, AnalyzeTextRequest request, CancellationToken cancellationToken = default)
        {
            if (indexName == null)
            {
                throw new ArgumentNullException(nameof(indexName));
