...
namespace Azure.Search.Documents.Models
{
    ...
    public static partial class SearchModelFactory
    {
        ...
        public static IndexerState IndexerState(IndexingMode? mode = null, string allDocumentsInitialChangeTrackingState = null, string allDocumentsFinalChangeTrackingState = null, string resetDocumentsInitialChangeTrackingState = null, string resetDocumentsFinalChangeTrackingState = null, IEnumerable<string> resetDocumentKeys = null, IEnumerable<string> resetDataSourceDocumentIds = null)
        {
            resetDocumentKeys ??= new List<string>();
            resetDataSourceDocumentIds ??= new List<string>();

            return new IndexerState(mode, allDocumentsInitialChangeTrackingState, allDocumentsFinalChangeTrackingState, resetDocumentsInitialChangeTrackingState, resetDocumentsFinalChangeTrackingState, resetDocumentKeys?.ToList(), resetDataSourceDocumentIds?.ToList());
        }
    }
}
