...
namespace Azure.Search.Documents.Models
{
    ...
    public static partial class SearchModelFactory
    {
        ...
        public static VectorizedQuery VectorizedQuery(int? kNearestNeighborsCount = default, string fieldsRaw = default, bool? exhaustive = default, double? oversampling = default, float? weight = default, IEnumerable<float> vector = default)
        {
        ...
        public static CustomAnalyzer CustomAnalyzer(string name = default, LexicalTokenizerName tokenizerName = default, IEnumerable<TokenFilterName> tokenFilters = default, IEnumerable<CharFilterName> charFilters = default)
        {
        ...
        public static AnalyzeTextOptions AnalyzeTextOptions(string text = default, LexicalAnalyzerName? analyzerName = default, LexicalTokenizerName? tokenizerName = default, LexicalNormalizerName? normalizerName = default, IEnumerable<TokenFilterName> tokenFilters = default, IEnumerable<CharFilterName> charFilters = default)
        {
            tokenFilters ??= new ChangeTrackingList<TokenFilterName>();
            charFilters ??= new ChangeTrackingList<CharFilterName>();
