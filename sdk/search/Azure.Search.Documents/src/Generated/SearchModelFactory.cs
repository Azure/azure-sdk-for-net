...
namespace Azure.Search.Documents.Models
{
    ...
    public static partial class SearchModelFactory
    {
        ...
        public static AutocompleteResults AutocompleteResults(double? coverage = null, IEnumerable<AutocompleteItem> results = null)
        {
            ...
            return new AutocompleteResults(coverage, results?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SearchIndexerStatus SearchIndexerStatus(IndexerStatus status = default, IndexerExecutionResult lastResult = null, IEnumerable<IndexerExecutionResult> executionHistory = null, SearchIndexerLimits limits = null)
        {
            ...
            return new SearchIndexerStatus(status, lastResult, executionHistory?.ToList(), limits, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchIndexStatistics(documentCount, storageSize, vectorIndexSize, new Dictionary<string, BinaryData>());
        }
        ...
        public static AnalyzeTextOptions AnalyzeTextOptions(string text = null, LexicalAnalyzerName? analyzerName = null, LexicalTokenizerName? tokenizerName = null, IEnumerable<TokenFilterName> tokenFilters = null, IEnumerable<string> charFilters = null)
        {
            ...
            return new AnalyzeTextOptions(text, analyzerName, tokenizerName, tokenFilters?.ToList(), charFilters?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchServiceCounters(documentCounter, indexCounter, indexerCounter, dataSourceCounter, storageSizeCounter, synonymMapCounter, skillsetCounter, vectorIndexSizeCounter, new Dictionary<string, BinaryData>());
        }
    }
}
