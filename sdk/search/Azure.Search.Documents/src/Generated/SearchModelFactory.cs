...
namespace Azure.Search.Documents.Models
{
    ...
    public static partial class SearchModelFactory
    {
        ...
        {
            return new DocumentDebugInfo(semantic, default);
        }
        ...
        public static SemanticDebugInfo SemanticDebugInfo(QueryResultDocumentSemanticField titleField = null, IEnumerable<QueryResultDocumentSemanticField> contentFields = null, IEnumerable<QueryResultDocumentSemanticField> keywordFields = null, QueryResultDocumentRerankerInput rerankerInput = null)
        {
            ...
            return new SemanticDebugInfo(titleField, contentFields?.ToList(), keywordFields?.ToList(), rerankerInput, default);
        }
        ...
        {
            return new QueryResultDocumentSemanticField(name, state, default);
        }
        ...
        {
            return new QueryResultDocumentRerankerInput(title, content, keywords, default);
        }
        ...
        public static AutocompleteResults AutocompleteResults(double? coverage = null, IEnumerable<AutocompleteItem> results = null)
        {
            ...
            return new AutocompleteResults(coverage, results?.ToList(), default);
        }
        ...
        public static SearchIndexerStatus SearchIndexerStatus(IndexerStatus status = default, IndexerExecutionResult lastResult = null, IEnumerable<IndexerExecutionResult> executionHistory = null, SearchIndexerLimits limits = null)
        {
            ...
            return new SearchIndexerStatus(status, lastResult, executionHistory?.ToList(), limits, default);
        }
        ...
        public static IndexerExecutionResult IndexerExecutionResult(IndexerExecutionStatus status = default, IndexerExecutionStatusDetail? statusDetail = null, IndexerState currentState = null, string errorMessage = null, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, IEnumerable<SearchIndexerError> errors = null, IEnumerable<SearchIndexerWarning> warnings = null, int itemCount = default, int failedItemCount = default, string initialTrackingState = null, string finalTrackingState = null)
        {
            ...
            return new IndexerExecutionResult(status, statusDetail, currentState, errorMessage, startTime, endTime, errors?.ToList(), warnings?.ToList(), itemCount, failedItemCount, initialTrackingState, finalTrackingState, default);
        }
        ...
        {
            return new SearchIndexStatistics(documentCount, storageSize, vectorIndexSize, default);
        }
        ...
        public static AnalyzeTextOptions AnalyzeTextOptions(string text = null, LexicalAnalyzerName? analyzerName = null, LexicalTokenizerName? tokenizerName = null, LexicalNormalizerName? normalizerName = null, IEnumerable<TokenFilterName> tokenFilters = null, IEnumerable<string> charFilters = null)
        {
            ...
            return new AnalyzeTextOptions(text, analyzerName, tokenizerName, normalizerName, tokenFilters?.ToList(), charFilters?.ToList(), default);
        }
        ...
        {
            return new SearchServiceCounters(aliasCounter, documentCounter, indexCounter, indexerCounter, dataSourceCounter, storageSizeCounter, synonymMapCounter, skillsetCounter, vectorIndexSizeCounter, default);
        }
    }
}
