...
#pragma warning disable SCME0005 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        public virtual async Task<AsyncStreamingClientResult<SseItem<BinaryData>>> RetrieveStreamAsync(RequestContent content, string querySourceAuthorization = default, string queryWorkIQSourceAuthorization = default, RequestContext context = null)
        {
            ...
            try
            {
                ...
                return AsyncStreamingClientResult.CreateSse(new AzurePipelineResponse(await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false)));
            }
            catch (Exception e)
            {
                scope.Failed(e);
...
#pragma warning restore SCME0005 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
#pragma warning disable SCME0005 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        public virtual async Task<AsyncStreamingClientResult<SseItem<BinaryData>>> RetrieveStreamAsync(KnowledgeBaseRetrievalRequest retrievalRequest, string querySourceAuthorization = default, string queryWorkIQSourceAuthorization = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(retrievalRequest, nameof(retrievalRequest));

            using HttpMessage message = CreateRetrieveStreamRequest(retrievalRequest, querySourceAuthorization, queryWorkIQSourceAuthorization, cancellationToken.ToRequestContext());
            message.BufferResponse = false;
            return AsyncStreamingClientResult.CreateSse(new AzurePipelineResponse(await Pipeline.ProcessMessageAsync(message, cancellationToken.ToRequestContext()).ConfigureAwait(false)), null, cancellationToken);
        }
#pragma warning restore SCME0005 // Type is for evaluation purposes only and is subject to change or removal in future updates.
