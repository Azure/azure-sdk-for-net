...
namespace Azure.Search.Documents
{
    internal partial class AliasesRestClient
    {
        ...
        public AliasesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, Guid? xMsClientRequestId = null, string apiVersion = "2025-05-01-preview")
        {
        ...
        internal HttpMessage CreateCreateRequest(SearchAlias @alias)
        {
            ...
            ((IJsonModel<SearchAlias>)@alias).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
