...
namespace Azure.Search.Documents
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureSearchDocumentsContext.Default) } };
