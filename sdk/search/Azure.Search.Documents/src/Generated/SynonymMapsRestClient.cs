...
namespace Azure.Search.Documents
{
    internal partial class SynonymMapsRestClient
    {
        ...
        public SynonymMapsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, Guid? xMsClientRequestId = null, string apiVersion = "2025-05-01-preview")
        {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string synonymMapName, SynonymMap synonymMap, string ifMatch, string ifNoneMatch)
        {
            ...
            ((IJsonModel<SynonymMap>)synonymMap).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
