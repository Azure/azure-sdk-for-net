...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetKnowledgeSourcesAsyncCollectionResultOfT : AsyncPageable<KnowledgeSource>
    {
        ...
        public SearchIndexClientGetKnowledgeSourcesAsyncCollectionResultOfT(SearchIndexClient client, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _search = search;
            _pageSize = pageSize;
