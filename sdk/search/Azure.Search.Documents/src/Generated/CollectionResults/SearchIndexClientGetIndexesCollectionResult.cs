...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetIndexesCollectionResult : Pageable<BinaryData>
    {
        ...
        public SearchIndexClientGetIndexesCollectionResult(SearchIndexClient client, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _search = search;
            _pageSize = pageSize;
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetIndexesRequest(nextLink, _search, _pageSize, _searchType, _context) : _client.CreateGetIndexesRequest(_search, _pageSize, _searchType, _context);
