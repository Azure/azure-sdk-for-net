...
{
    internal partial class SearchIndexClientGetKnowledgeSourceFilesCollectionResult : Pageable<BinaryData>
    {
        ...
        public SearchIndexClientGetKnowledgeSourceFilesCollectionResult(SearchIndexClient client, string sourceName, string prefix, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
