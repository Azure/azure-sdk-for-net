...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetKnowledgeSourcesCollectionResult : Pageable<BinaryData>
    {
        ...
        public SearchIndexClientGetKnowledgeSourcesCollectionResult(SearchIndexClient client, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
        }

        /// <summary> Gets the pages of SearchIndexClientGetKnowledgeSourcesCollectionResult as an enumerable collection. </summary>
