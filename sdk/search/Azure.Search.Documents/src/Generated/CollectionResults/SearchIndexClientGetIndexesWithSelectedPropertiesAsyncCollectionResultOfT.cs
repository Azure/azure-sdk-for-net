...
{
    internal partial class SearchIndexClientGetIndexesWithSelectedPropertiesAsyncCollectionResultOfT : AsyncPageable<global::Azure.Search.Documents.Indexes.Models.SearchIndexResponse>
    {
        ...
        /// <summary> Gets the pages of SearchIndexClientGetIndexesWithSelectedPropertiesAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Search.Documents.Indexes.Models.SearchIndexResponse>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<SearchIndexResponse>.FromValues(((IReadOnlyList<global::Azure.Search.Documents.Indexes.Models.SearchIndexResponse>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
