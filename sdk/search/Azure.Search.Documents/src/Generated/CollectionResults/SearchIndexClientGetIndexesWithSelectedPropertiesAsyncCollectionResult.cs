...
{
    internal partial class SearchIndexClientGetIndexesWithSelectedPropertiesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public SearchIndexClientGetIndexesWithSelectedPropertiesAsyncCollectionResult(SearchIndexClient client, IEnumerable<string> @select, int? top, int? skip, bool? count, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _select = @select;
            _top = top;
