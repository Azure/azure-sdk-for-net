...
{
    internal partial class SearchIndexerClientGetIndexersAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of SearchIndexerClientGetIndexersAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The SearchIndexerClient client used to send requests. </param>
        ...
        public SearchIndexerClientGetIndexersAsyncCollectionResult(SearchIndexerClient client, IEnumerable<string> @select, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _select = @select;
            _search = search;
        ...
        /// <summary> Gets the pages of SearchIndexerClientGetIndexersAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SearchIndexerClientGetIndexersAsyncCollectionResult as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ListIndexersResult result = (ListIndexersResult)response;
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetIndexersRequest(nextLink, _select, _search, _pageSize, _searchType, _context) : _client.CreateGetIndexersRequest(_select, _search, _pageSize, _searchType, _context);
