...
{
    internal partial class SearchIndexClientGetSynonymMapsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of SearchIndexClientGetSynonymMapsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public SearchIndexClientGetSynonymMapsCollectionResult(SearchIndexClient client, IEnumerable<string> @select, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _select = @select;
            _search = search;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetSynonymMapsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SearchIndexClientGetSynonymMapsCollectionResult as an enumerable collection. </returns>
        public override IEnumerable<Page<BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ListSynonymMapsResult result = (ListSynonymMapsResult)response;
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetSynonymMapsRequest(nextLink, _select, _search, _pageSize, _searchType, _context) : _client.CreateGetSynonymMapsRequest(_select, _search, _pageSize, _searchType, _context);
