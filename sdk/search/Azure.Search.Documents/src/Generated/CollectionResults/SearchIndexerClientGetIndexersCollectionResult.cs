...
{
    internal partial class SearchIndexerClientGetIndexersCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of SearchIndexerClientGetIndexersCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public SearchIndexerClientGetIndexersCollectionResult(SearchIndexerClient client, IEnumerable<string> @select, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _select = @select;
            _search = search;
        ...
        /// <summary> Gets the pages of SearchIndexerClientGetIndexersCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SearchIndexerClientGetIndexersCollectionResult as an enumerable collection. </returns>
