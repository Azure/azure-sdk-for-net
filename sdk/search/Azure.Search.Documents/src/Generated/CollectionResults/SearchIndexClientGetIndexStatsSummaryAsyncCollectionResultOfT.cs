...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetIndexStatsSummaryAsyncCollectionResultOfT : AsyncPageable<IndexStatisticsSummary>
    {
        ...
        public SearchIndexClientGetIndexStatsSummaryAsyncCollectionResultOfT(SearchIndexClient client, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
