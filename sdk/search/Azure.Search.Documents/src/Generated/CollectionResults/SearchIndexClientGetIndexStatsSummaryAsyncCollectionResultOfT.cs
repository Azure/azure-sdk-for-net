...
{
    internal partial class SearchIndexClientGetIndexStatsSummaryAsyncCollectionResultOfT : AsyncPageable<global::Azure.Search.Documents.Indexes.Models.IndexStatisticsSummary>
    {
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Search.Documents.Indexes.Models.IndexStatisticsSummary>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<IndexStatisticsSummary>.FromValues(((IReadOnlyList<global::Azure.Search.Documents.Indexes.Models.IndexStatisticsSummary>)result.IndexesStatistics), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
