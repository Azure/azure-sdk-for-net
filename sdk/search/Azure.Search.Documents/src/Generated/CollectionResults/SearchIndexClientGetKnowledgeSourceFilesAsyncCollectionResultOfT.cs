...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetKnowledgeSourceFilesAsyncCollectionResultOfT : AsyncPageable<KnowledgeSourceFile>
    {
        ...
        public SearchIndexClientGetKnowledgeSourceFilesAsyncCollectionResultOfT(SearchIndexClient client, string sourceName, string prefix, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
