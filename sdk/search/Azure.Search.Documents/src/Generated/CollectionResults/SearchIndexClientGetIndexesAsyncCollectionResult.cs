...
{
    internal partial class SearchIndexClientGetIndexesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public SearchIndexClientGetIndexesAsyncCollectionResult(SearchIndexClient client, int? top, int? skip, bool? count, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _top = top;
            _skip = skip;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetIndexesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SearchIndexClientGetIndexesAsyncCollectionResult as an enumerable collection. </returns>
