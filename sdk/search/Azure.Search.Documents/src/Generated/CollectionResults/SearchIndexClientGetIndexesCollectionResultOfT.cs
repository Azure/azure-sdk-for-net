...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetIndexesCollectionResultOfT : Pageable<SearchIndex>
    {
        ...
        /// <summary> Initializes a new instance of SearchIndexClientGetIndexesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SearchIndexClientGetIndexesCollectionResultOfT(SearchIndexClient client, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _search = search;
            _pageSize = pageSize;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetIndexesCollectionResultOfT as an enumerable collection. </summary>
