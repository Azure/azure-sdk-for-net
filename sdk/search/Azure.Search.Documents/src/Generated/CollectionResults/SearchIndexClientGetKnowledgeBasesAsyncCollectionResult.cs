...
{
    internal partial class SearchIndexClientGetKnowledgeBasesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of SearchIndexClientGetKnowledgeBasesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public SearchIndexClientGetKnowledgeBasesAsyncCollectionResult(SearchIndexClient client, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _search = search;
            _pageSize = pageSize;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetKnowledgeBasesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SearchIndexClientGetKnowledgeBasesAsyncCollectionResult as an enumerable collection. </returns>
