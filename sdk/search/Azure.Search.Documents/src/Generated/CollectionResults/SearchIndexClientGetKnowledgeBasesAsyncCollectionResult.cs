...
{
    internal partial class SearchIndexClientGetKnowledgeBasesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public SearchIndexClientGetKnowledgeBasesAsyncCollectionResult(SearchIndexClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
