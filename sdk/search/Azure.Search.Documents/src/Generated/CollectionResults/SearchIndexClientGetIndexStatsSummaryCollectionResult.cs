...
namespace Azure.Search.Documents.Indexes
{
    internal partial class SearchIndexClientGetIndexStatsSummaryCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of SearchIndexClientGetIndexStatsSummaryCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public SearchIndexClientGetIndexStatsSummaryCollectionResult(SearchIndexClient client, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _search = search;
            _pageSize = pageSize;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetIndexStatsSummaryCollectionResult as an enumerable collection. </summary>
