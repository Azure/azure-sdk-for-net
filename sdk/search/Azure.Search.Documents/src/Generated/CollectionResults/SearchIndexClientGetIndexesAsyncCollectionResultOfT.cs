...
{
    internal partial class SearchIndexClientGetIndexesAsyncCollectionResultOfT : AsyncPageable<global::Azure.Search.Documents.Indexes.Models.SearchIndex>
    {
        ...
        public SearchIndexClientGetIndexesAsyncCollectionResultOfT(SearchIndexClient client, int? top, int? skip, bool? count, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _top = top;
            _skip = skip;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Search.Documents.Indexes.Models.SearchIndex>> AsPages(string continuationToken, int? pageSizeHint)
        {
