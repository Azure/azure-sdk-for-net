...
{
    internal partial class SearchIndexClientGetKnowledgeSourcesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of SearchIndexClientGetKnowledgeSourcesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public SearchIndexClientGetKnowledgeSourcesAsyncCollectionResult(SearchIndexClient client, string search, int? pageSize, string searchType, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _search = search;
            _pageSize = pageSize;
        ...
        /// <summary> Gets the pages of SearchIndexClientGetKnowledgeSourcesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SearchIndexClientGetKnowledgeSourcesAsyncCollectionResult as an enumerable collection. </returns>
