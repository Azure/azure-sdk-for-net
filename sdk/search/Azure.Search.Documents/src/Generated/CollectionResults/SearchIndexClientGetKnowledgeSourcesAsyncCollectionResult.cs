...
{
    internal partial class SearchIndexClientGetKnowledgeSourcesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public SearchIndexClientGetKnowledgeSourcesAsyncCollectionResult(SearchIndexClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
