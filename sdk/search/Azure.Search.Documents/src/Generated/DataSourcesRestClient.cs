...
namespace Azure.Search.Documents
{
    internal partial class DataSourcesRestClient
    {
        ...
        public DataSourcesRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, Guid? xMsClientRequestId = null, string apiVersion = "2024-03-01-Preview")
        {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string dataSourceName, SearchIndexerDataSourceConnection dataSource, string ifMatch, string ifNoneMatch, bool? skipIndexerResetRequirementForCache)
        {
            ...
            content.JsonWriter.WriteObjectValue<SearchIndexerDataSourceConnection>(dataSource);
