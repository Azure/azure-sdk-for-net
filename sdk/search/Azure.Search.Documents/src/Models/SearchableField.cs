...
{
    /// <summary>
    /// A <see cref="DataType.String"/> or "Collection(String)" field that can be searched.
    /// </summary>
    public class SearchableField : SimpleField
    {
        ...
        public SearchableField(string name, bool collection = false) : base(name, collection ? DataType.Collection(DataType.String) : DataType.String)
        {
