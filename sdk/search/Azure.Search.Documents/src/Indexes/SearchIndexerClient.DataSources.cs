...
namespace Azure.Search.Documents.Indexes
{
    ...
    public partial class SearchIndexerClient
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return CreateOrUpdateDataSourceConnection(dataSourceConnection?.Name, dataSourceConnection, matchConditions, cancellationToken: cancellationToken);
        }
        /// <summary>
        /// Creates a new data source or updates an existing data source connection.
        /// </summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            MatchConditions matchConditions = onlyIfUnchanged ? new MatchConditions { IfMatch = dataSourceConnection?.ETag } : null;
            return await CreateOrUpdateDataSourceConnectionAsync(dataSourceConnection?.Name, dataSourceConnection, matchConditions, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
