...
namespace Azure.Search.Documents.Tests
{
    public class BatchingTests : SearchTestBase
    {
        ...
        #region Utilities
        private const int BatchSize = SearchIndexingBufferedSenderOptions<object>.DefaultBatchActionSize;
        ...
        public async Task Champion_OneShotUpload()
        {
            ...
            await WaitForDocumentCountAsync(client, data.Length);
        }
        ...
        public async Task Champion_FineGrainedErrors()
        {
            ...
            await indexer.FlushAsync();
            await WaitForDocumentCountAsync(client, 1000);
        ...
        public async Task AutoFlush_FullBatch()
        {
            ...
            await WaitForDocumentCountAsync(client, BatchSize, delay: TimeSpan.FromSeconds(2));
        ...
        public async Task AutoFlush_MultipleBatches()
        {
            ...
            await WaitForDocumentCountAsync(client, 3 * BatchSize, delay: TimeSpan.FromSeconds(5));
        ...
        public async Task Convenience_Delete()
        {
            ...
            await indexer.FlushAsync();
            await WaitForDocumentCountAsync(client, 0);
        }
        ...
        public async Task Convenience_None()
        {
            ...
            await indexer.FlushAsync();
            await WaitForDocumentCountAsync(client, 2);
        }
        #endregion
