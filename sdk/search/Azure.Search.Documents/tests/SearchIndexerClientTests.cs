...
namespace Azure.Search.Documents.Tests
{
    ...
    public class SearchIndexerClientTests : SearchTestBase
    {
        ...
        public async Task CrudSkillset()
        {
            ...
            SearchIndexerSkillset skillset = CreateSkillsetModel(skillsetName);
        ...
        [Test]
        [ServiceVersion(Min = SearchClientOptions.ServiceVersion.V2020_06_30_Preview)]
        public async Task CrudSkillsetPreview()
        {
            await using SearchResources resources = await SearchResources.CreateWithBlobStorageAndIndexAsync(this);
            ...
            Assert.AreEqual(2, createdSkillset.KnowledgeStore.Projections.Count);

            SearchIndexerKnowledgeStoreProjection p1 = createdSkillset.KnowledgeStore.Projections[0];
            ...
            SearchIndexerKnowledgeStoreProjection p2 = createdSkillset.KnowledgeStore.Projections[1];
        ...
        private SearchIndexerSkillset CreateSkillsetModel(string skillsetName)
        {
