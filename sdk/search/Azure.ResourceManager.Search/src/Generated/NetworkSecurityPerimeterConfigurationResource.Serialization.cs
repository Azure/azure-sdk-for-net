...
namespace Azure.ResourceManager.Search
{
    public partial class NetworkSecurityPerimeterConfigurationResource : IJsonModel<NetworkSecurityPerimeterConfigurationData>
    {
        ...
        BinaryData IPersistableModel<NetworkSecurityPerimeterConfigurationData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<NetworkSecurityPerimeterConfigurationData>(Data, options, AzureResourceManagerSearchContext.Default);

        NetworkSecurityPerimeterConfigurationData IPersistableModel<NetworkSecurityPerimeterConfigurationData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<NetworkSecurityPerimeterConfigurationData>(data, options, AzureResourceManagerSearchContext.Default);
