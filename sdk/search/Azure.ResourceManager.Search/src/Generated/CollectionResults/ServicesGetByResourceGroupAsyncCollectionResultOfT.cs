...
{
    internal partial class ServicesGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<SearchServiceData>
    {
        ...
        public override async IAsyncEnumerable<Page<SearchServiceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
