...
{
    internal partial class OfferingsGetOfferingsCollectionResultOfT : Pageable<SearchOfferingsByRegion>
    {
        ...
        /// <returns> The pages of OfferingsGetOfferingsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<SearchOfferingsByRegion>> AsPages(string continuationToken, int? pageSizeHint)
        {
            Response response = GetNextResponse(pageSizeHint, null);
            OfferingsListResult result = OfferingsListResult.FromResponse(response);
            yield return Page<SearchOfferingsByRegion>.FromValues(result.Value, null, response);
        }
