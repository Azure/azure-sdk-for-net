...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SharedPrivateLinkResourceData : ResourceData
    {
        ...
        internal SharedPrivateLinkResourceData(ResourceIdentifier id, string name, Core.ResourceType resourceType, SystemData systemData, SharedPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
