...
namespace Azure.ResourceManager.Search
{
    internal partial class SearchArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SearchArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
