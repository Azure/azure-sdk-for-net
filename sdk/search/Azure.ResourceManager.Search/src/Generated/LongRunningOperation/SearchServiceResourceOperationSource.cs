...
{
    /// <summary></summary>
    internal partial class SearchServiceResourceOperationSource : IOperationSource<SearchServiceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SearchServiceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
