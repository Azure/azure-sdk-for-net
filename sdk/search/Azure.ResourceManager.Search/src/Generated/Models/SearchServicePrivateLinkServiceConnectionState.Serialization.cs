...
{
    public partial class SearchServicePrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static SearchServicePrivateLinkServiceConnectionState DeserializeSearchServicePrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<SearchServicePrivateLinkServiceConnectionStatus> status = default;
            ...
            return new SearchServicePrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
