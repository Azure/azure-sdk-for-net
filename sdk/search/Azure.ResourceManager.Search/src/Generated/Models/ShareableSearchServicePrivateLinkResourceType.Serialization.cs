...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareableSearchServicePrivateLinkResourceType>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ShareableSearchServicePrivateLinkResourceType IJsonModel<ShareableSearchServicePrivateLinkResourceType>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ShareableSearchServicePrivateLinkResourceType>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ShareableSearchServicePrivateLinkResourceType IModel<ShareableSearchServicePrivateLinkResourceType>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ShareableSearchServicePrivateLinkResourceType>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
