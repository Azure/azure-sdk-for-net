...
namespace Azure.ResourceManager.Search.Models
{
    ...
    internal partial class DataPlaneAadOrApiKeyAuthOption : IJsonModel<DataPlaneAadOrApiKeyAuthOption>
    {
        ...
        protected virtual DataPlaneAadOrApiKeyAuthOption PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataPlaneAadOrApiKeyAuthOption>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DataPlaneAadOrApiKeyAuthOption>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DataPlaneAadOrApiKeyAuthOption IPersistableModel<DataPlaneAadOrApiKeyAuthOption>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataPlaneAadOrApiKeyAuthOption IJsonModel<DataPlaneAadOrApiKeyAuthOption>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DataPlaneAadOrApiKeyAuthOption JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataPlaneAadOrApiKeyAuthOption>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataPlaneAadOrApiKeyAuthOption DeserializeDataPlaneAadOrApiKeyAuthOption(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("aadAuthFailureMode"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    aadAuthFailureMode = prop.Value.GetString().ToSearchAadAuthFailureMode();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new DataPlaneAadOrApiKeyAuthOption(aadAuthFailureMode, additionalBinaryDataProperties);
        }
    }
}
