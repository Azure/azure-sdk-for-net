...
{
    internal partial class DataPlaneAadOrApiKeyAuthOption : IUtf8JsonSerializable, IJsonModel<DataPlaneAadOrApiKeyAuthOption>, IPersistableModel<DataPlaneAadOrApiKeyAuthOption>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AadAuthFailureMode))
            {
                ...
                builder.AppendLine($" '{AadAuthFailureMode.ToString()}'");
            }
