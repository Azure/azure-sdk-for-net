...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataPlaneAadOrApiKeyAuthOption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataPlaneAadOrApiKeyAuthOption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataPlaneAadOrApiKeyAuthOption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataPlaneAadOrApiKeyAuthOption>)} interface");
            }
        ...
        string IPersistableModel<DataPlaneAadOrApiKeyAuthOption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
