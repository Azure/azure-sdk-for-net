...
{
    public partial class SearchPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static SearchPrivateEndpointConnectionData DeserializeSearchPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new SearchPrivateEndpointConnectionData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
