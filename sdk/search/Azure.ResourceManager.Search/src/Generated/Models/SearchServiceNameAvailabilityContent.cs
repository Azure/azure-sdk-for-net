...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchServiceNameAvailabilityContent
    {
        ...
        internal SearchServiceNameAvailabilityContent(string name, SearchServiceResourceType resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
