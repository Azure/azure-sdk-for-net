...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchResourceEncryptionKey
    {
        ...
        internal SearchResourceEncryptionKey(string keyName, string keyVersion, Uri vaultUri, DataIdentity identity, AzureActiveDirectoryApplicationCredentials accessCredentials, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            KeyName = keyName;
