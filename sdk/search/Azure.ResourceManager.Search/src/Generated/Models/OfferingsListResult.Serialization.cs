...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class OfferingsListResult : IJsonModel<OfferingsListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (OfferingsByRegion item in Value)
                {
        ...
        internal static OfferingsListResult DeserializeOfferingsListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IReadOnlyList<OfferingsByRegion> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("value"u8))
                {
                    ...
                    List<OfferingsByRegion> array = new List<OfferingsByRegion>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(OfferingsByRegion.DeserializeOfferingsByRegion(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new OfferingsListResult(value ?? new ChangeTrackingList<OfferingsByRegion>(), nextLink, additionalBinaryDataProperties);
        }
    }
}
