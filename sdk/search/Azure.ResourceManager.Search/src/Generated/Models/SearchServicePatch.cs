...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchServicePatch : TrackedResourceData
    {
        ...
        /// <summary> Defines the level of reuse for the auto-generated domain name label for the search service (e.g. myservice-&lt;uniqueId&gt;.search.windows.net). If not specified, no auto-generated domain name label is created for the search service. </summary>
        [WirePath("properties.autoGeneratedDomainNameLabelScope")]
        public SearchDomainNameLabelScope? AutoGeneratedDomainNameLabelScope
        {
            get
            {
