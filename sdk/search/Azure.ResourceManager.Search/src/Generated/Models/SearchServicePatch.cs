...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchServicePatch : TrackedResourceData
    {
        ...
        /// <param name="disableLocalAuth"> When set to true, calls to the search service will not be permitted to utilize API keys for authentication. This cannot be set to true if &apos;dataPlaneAuthOptions&apos; are defined. </param>
