...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchServicePatch : TrackedResourceData
    {
        ...
        /// <param name="knowledgeRetrieval"> Sets options that control the availability of knowledge retrieval. This configuration is only possible for certain Azure AI Search SKUs in certain locations. </param>
        ...
        /// <summary> Sets options that control the availability of knowledge retrieval. This configuration is only possible for certain Azure AI Search SKUs in certain locations. </summary>
        [WirePath("properties.knowledgeRetrieval")]
        public KnowledgeRetrievalBillingTier? KnowledgeRetrieval { get; set; }
