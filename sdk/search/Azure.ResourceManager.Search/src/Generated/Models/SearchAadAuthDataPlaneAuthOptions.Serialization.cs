...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchAadAuthDataPlaneAuthOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchAadAuthDataPlaneAuthOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchAadAuthDataPlaneAuthOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchAadAuthDataPlaneAuthOptions>)} interface");
            }
        ...
        string IPersistableModel<SearchAadAuthDataPlaneAuthOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
