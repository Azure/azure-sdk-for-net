...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        internal static SearchPrivateLinkResourceProperties DeserializeSearchPrivateLinkResourceProperties(JsonElement element, SerializableOptions options = default)
        {
