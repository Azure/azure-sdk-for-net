...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListQueryKeysResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListQueryKeysResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListQueryKeysResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListQueryKeysResult>)} interface");
            }
        ...
        string IPersistableModel<ListQueryKeysResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
