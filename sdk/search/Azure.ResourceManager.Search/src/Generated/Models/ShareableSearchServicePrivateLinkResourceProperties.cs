...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class ShareableSearchServicePrivateLinkResourceProperties
    {
        ...
        internal ShareableSearchServicePrivateLinkResourceProperties(string shareablePrivateLinkResourcePropertiesType, string groupId, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
