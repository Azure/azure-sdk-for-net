...
namespace Azure.ResourceManager.Search.Models
{
    internal partial class PrivateLinkResourcesResult : IUtf8JsonSerializable, IJsonModel<PrivateLinkResourcesResult>
    {
        ...
        void IJsonModel<PrivateLinkResourcesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PrivateLinkResourcesResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PrivateLinkResourcesResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PrivateLinkResourcesResult)} does not support '{options.Format}' format.");
            }
        }
