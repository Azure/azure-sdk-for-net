...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        internal static SearchServiceNameAvailabilityResult DeserializeSearchServiceNameAvailabilityResult(JsonElement element, SerializableOptions options = default)
        {
