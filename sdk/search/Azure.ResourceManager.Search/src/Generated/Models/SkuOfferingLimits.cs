...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SkuOfferingLimits
    {
        ...
        internal SkuOfferingLimits(int? indexes, int? indexers, int? partitionStorageInGigabytes, int? partitionVectorStorageInGigabytes, int? searchUnits, int? replicas, int? partitions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Indexes = indexes;
            Indexers = indexers;
        ...
        public int? PartitionStorageInGigabytes { get; }
        ...
        public int? PartitionVectorStorageInGigabytes { get; }
