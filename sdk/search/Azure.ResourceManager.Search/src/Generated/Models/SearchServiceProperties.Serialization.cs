...
namespace Azure.ResourceManager.Search.Models
{
    ...
    internal partial class SearchServiceProperties : IJsonModel<SearchServiceProperties>
    {
        ...
        internal static SearchServiceProperties DeserializeSearchServiceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SearchDomainNameLabelScope? autoGeneratedDomainNameLabelScope = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("autoGeneratedDomainNameLabelScope"u8))
                {
                    ...
                    autoGeneratedDomainNameLabelScope = new SearchDomainNameLabelScope(prop.Value.GetString());
                    continue;
                }
