...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchServiceAdminKeyResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchServiceAdminKeyResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchServiceAdminKeyResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchServiceAdminKeyResult>)} interface");
            }
        ...
        string IPersistableModel<SearchServiceAdminKeyResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
