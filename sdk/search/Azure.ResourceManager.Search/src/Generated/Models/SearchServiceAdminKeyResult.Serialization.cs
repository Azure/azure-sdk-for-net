...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        internal static SearchServiceAdminKeyResult DeserializeSearchServiceAdminKeyResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
