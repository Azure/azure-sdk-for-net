...
namespace Azure.ResourceManager.Search.Models
{
    internal partial class SearchSku : IUtf8JsonSerializable, IJsonModel<SearchSku>
    {
        ...
        void IJsonModel<SearchSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SearchSku)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SearchSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SearchSku)} does not support '{options.Format}' format.");
            }
        }
