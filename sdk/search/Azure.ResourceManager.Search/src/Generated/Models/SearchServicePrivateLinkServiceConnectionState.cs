...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchServicePrivateLinkServiceConnectionState
    {
        ...
        internal SearchServicePrivateLinkServiceConnectionState(SearchServicePrivateLinkServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
