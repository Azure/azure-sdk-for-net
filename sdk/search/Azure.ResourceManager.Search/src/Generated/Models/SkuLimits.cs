...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SkuLimits
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SkuLimits"/>. </summary>
        internal SkuLimits()
        {
        }
        ...
        internal SkuLimits(int? indexes, int? indexers, float? partitionStorageInGigabytes, float? partitionVectorStorageInGigabytes, int? searchUnits, int? replicas, int? partitions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Indexes = indexes;
            Indexers = indexers;
