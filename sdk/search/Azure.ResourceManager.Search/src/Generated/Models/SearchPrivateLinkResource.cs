...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchPrivateLinkResource : ResourceData
    {
        ...
        internal SearchPrivateLinkResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SearchPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
