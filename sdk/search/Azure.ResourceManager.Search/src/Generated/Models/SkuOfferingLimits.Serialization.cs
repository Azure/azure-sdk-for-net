...
namespace Azure.ResourceManager.Search.Models
{
    public partial class SkuOfferingLimits : IUtf8JsonSerializable, IJsonModel<SkuOfferingLimits>
    {
        ...
        internal static SkuOfferingLimits DeserializeSkuOfferingLimits(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            int? partitionStorageInGigabytes = default;
            int? partitionVectorStorageInGigabytes = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("partitionStorageInGigabytes"u8))
                {
                    ...
                    partitionStorageInGigabytes = property.Value.GetInt32();
                    continue;
                }
                if (property.NameEquals("partitionVectorStorageInGigabytes"u8))
                {
                    ...
                    partitionVectorStorageInGigabytes = property.Value.GetInt32();
                    continue;
                }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            else
            {
                ...
                {
                    builder.Append("  partitionStorageInGigabytes: ");
                    builder.AppendLine($"{PartitionStorageInGigabytes.Value}");
                }
            }
            ...
            else
            {
                ...
                {
                    builder.Append("  partitionVectorStorageInGigabytes: ");
                    builder.AppendLine($"{PartitionVectorStorageInGigabytes.Value}");
                }
            }
