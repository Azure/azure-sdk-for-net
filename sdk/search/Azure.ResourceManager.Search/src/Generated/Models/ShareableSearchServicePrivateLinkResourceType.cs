...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class ShareableSearchServicePrivateLinkResourceType
    {
        ...
        internal ShareableSearchServicePrivateLinkResourceType(string name, ShareableSearchServicePrivateLinkResourceProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
