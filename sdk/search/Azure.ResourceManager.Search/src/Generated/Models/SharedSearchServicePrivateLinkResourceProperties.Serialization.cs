...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SharedSearchServicePrivateLinkResourceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SharedSearchServicePrivateLinkResourceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SharedSearchServicePrivateLinkResourceProperties>)} interface");
            }
        ...
        string IPersistableModel<SharedSearchServicePrivateLinkResourceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
