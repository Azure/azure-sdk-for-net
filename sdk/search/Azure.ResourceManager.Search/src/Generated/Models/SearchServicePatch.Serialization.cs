...
{
    public partial class SearchServicePatch : IUtf8JsonSerializable, IModelJsonSerializable<SearchServicePatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<SearchServicePatch>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<SearchServicePatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SearchServicePatch>(this, options.Format);
            ...
            if (Optional.IsDefined(Sku))
            {
                ...
                {
                    ((IModelJsonSerializable<SearchSku>)Sku).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(EncryptionWithCmk))
            {
                ...
                if (EncryptionWithCmk is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<SearchEncryptionWithCmk>)EncryptionWithCmk).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(AuthOptions))
            {
                ...
                {
                    ((IModelJsonSerializable<SearchAadAuthDataPlaneAuthOptions>)AuthOptions).Serialize(writer, options);
                }
            }
            writer.WriteEndObject();
        ...
        internal static SearchServicePatch DeserializeSearchServicePatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SearchServicePatch(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, sku.Value, identity, Optional.ToNullable(replicaCount), Optional.ToNullable(partitionCount), Optional.ToNullable(hostingMode), Optional.ToNullable(publicNetworkAccess), Optional.ToNullable(status), statusDetails.Value, Optional.ToNullable(provisioningState), networkRuleSet.Value, encryptionWithCmk.Value, Optional.ToNullable(disableLocalAuth), authOptions.Value, Optional.ToList(privateEndpointConnections), Optional.ToList(sharedPrivateLinkResources), serializedAdditionalRawData);
        }

        SearchServicePatch IModelJsonSerializable<SearchServicePatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SearchServicePatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeSearchServicePatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<SearchServicePatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SearchServicePatch>(this, options.Format);
        ...
        SearchServicePatch IModelSerializable<SearchServicePatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<SearchServicePatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="SearchServicePatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SearchServicePatch"/> to convert. </param>
        public static implicit operator RequestContent(SearchServicePatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SearchServicePatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SearchServicePatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSearchServicePatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
