...
{
    public partial class SearchServicePatch : IUtf8JsonSerializable, IJsonModel<SearchServicePatch>, IPersistableModel<SearchServicePatch>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EncryptionWithCmk))
            {
                ...
                AppendChildObject(builder, EncryptionWithCmk, options, 2);
            }
            ...
            if (Optional.IsDefined(AuthOptions))
            {
                ...
                AppendChildObject(builder, AuthOptions, options, 2);
            }
