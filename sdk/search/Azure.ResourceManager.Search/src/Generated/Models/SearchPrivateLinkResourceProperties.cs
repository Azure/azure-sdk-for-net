...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class SearchPrivateLinkResourceProperties
    {
        ...
        internal SearchPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, IReadOnlyList<ShareableSearchServicePrivateLinkResourceType> shareablePrivateLinkResourceTypes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
