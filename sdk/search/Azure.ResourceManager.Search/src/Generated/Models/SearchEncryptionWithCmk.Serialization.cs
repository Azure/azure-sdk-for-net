...
{
    public partial class SearchEncryptionWithCmk : IUtf8JsonSerializable, IJsonModel<SearchEncryptionWithCmk>, IPersistableModel<SearchEncryptionWithCmk>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Enforcement))
            {
                ...
                builder.AppendLine($" '{Enforcement.ToString()}'");
            }

            if (Optional.IsDefined(EncryptionComplianceStatus))
            {
                builder.Append("  encryptionComplianceStatus:");
                builder.AppendLine($" '{EncryptionComplianceStatus.ToString()}'");
            }
