...
namespace Azure.ResourceManager.Search.Models
{
    public partial class SearchEncryptionWithCmk : IUtf8JsonSerializable, IJsonModel<SearchEncryptionWithCmk>
    {
        ...
        internal static SearchEncryptionWithCmk DeserializeSearchEncryptionWithCmk(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            SearchServiceEncryptionKey serviceLevelEncryptionKey = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("serviceLevelEncryptionKey"u8))
                {
                    ...
                    serviceLevelEncryptionKey = SearchServiceEncryptionKey.DeserializeSearchServiceEncryptionKey(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
