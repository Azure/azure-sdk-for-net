...
namespace Azure.ResourceManager.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchEncryptionWithCmk>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchEncryptionWithCmk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchEncryptionWithCmk>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SearchEncryptionWithCmk>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
