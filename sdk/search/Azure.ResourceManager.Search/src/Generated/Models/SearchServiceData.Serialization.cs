...
namespace Azure.ResourceManager.Search
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchServiceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchServiceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchServiceData>)} interface");
            }
        ...
        string IPersistableModel<SearchServiceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
