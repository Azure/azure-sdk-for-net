...
{
    public partial class SearchServiceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SearchServiceData DeserializeSearchServiceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
