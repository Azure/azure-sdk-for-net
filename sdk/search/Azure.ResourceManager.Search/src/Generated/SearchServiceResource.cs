...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SearchServiceResource : ArmResource
    {
        ...
        internal SearchServiceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _adminKeysRestClient = new AdminKeys(_adminKeysClientDiagnostics, Pipeline, Endpoint, searchServiceApiVersion ?? "2026-09-01-preview");
            _queryKeysClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Search", ResourceType.Namespace, Diagnostics);
            _queryKeysRestClient = new QueryKeys(_queryKeysClientDiagnostics, Pipeline, Endpoint, searchServiceApiVersion ?? "2026-09-01-preview");
            ...
            _privateLinkResourcesRestClient = new PrivateLinkResources(_privateLinkResourcesClientDiagnostics, Pipeline, Endpoint, searchServiceApiVersion ?? "2026-09-01-preview");
