...
namespace Azure.ResourceManager.Search.Mocking
{
    ...
    internal partial class SearchResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SearchResourceGroupMockingExtension"/> class for mocking. </summary>
        protected SearchResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SearchResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SearchResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
