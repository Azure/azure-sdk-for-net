...
using Azure.ResourceManager.Search.Testing;
...
namespace Azure.ResourceManager.Search
{
    ...
    {
        private static SearchResourceGroupResourceExtension GetSearchResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new SearchResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static SearchResourceGroupResourceExtension GetSearchResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new SearchResourceGroupResourceExtension(client, scope);
            });
        }

        private static SearchSubscriptionResourceExtension GetSearchSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new SearchSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static SearchSubscriptionResourceExtension GetSearchSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new SearchSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetSearchResourceGroupResourceExtension(resourceGroupResource).GetSearchServices();
        }
        ...
        {
            return GetSearchSubscriptionResourceExtension(subscriptionResource).GetSearchServicesAsync(searchManagementRequestOptions, cancellationToken);
        }
        ...
        {
            return GetSearchSubscriptionResourceExtension(subscriptionResource).GetSearchServices(searchManagementRequestOptions, cancellationToken);
        }
        ...
        public static async Task<Response<SearchServiceNameAvailabilityResult>> CheckSearchServiceNameAvailabilityAsync(this SubscriptionResource subscriptionResource, SearchServiceNameAvailabilityContent content, SearchManagementRequestOptions searchManagementRequestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSearchSubscriptionResourceExtension(subscriptionResource).CheckSearchServiceNameAvailabilityAsync(content, searchManagementRequestOptions, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<SearchServiceNameAvailabilityResult> CheckSearchServiceNameAvailability(this SubscriptionResource subscriptionResource, SearchServiceNameAvailabilityContent content, SearchManagementRequestOptions searchManagementRequestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSearchSubscriptionResourceExtension(subscriptionResource).CheckSearchServiceNameAvailability(content, searchManagementRequestOptions, cancellationToken);
        }
    }
}
