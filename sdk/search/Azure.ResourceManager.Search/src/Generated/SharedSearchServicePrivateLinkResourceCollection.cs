...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SharedSearchServicePrivateLinkResourceCollection : ArmCollection, IEnumerable<SharedSearchServicePrivateLinkResource>, IAsyncEnumerable<SharedSearchServicePrivateLinkResource>
    {
        ...
        {
            async Task<Page<SharedSearchServicePrivateLinkResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _sharedSearchServicePrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SharedSearchServicePrivateLinkResourceCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _sharedSearchServicePrivateLinkResourceSharedPrivateLinkResourcesRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, searchManagementRequestOptions, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SharedSearchServicePrivateLinkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<SharedSearchServicePrivateLinkResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _sharedSearchServicePrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SharedSearchServicePrivateLinkResourceCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _sharedSearchServicePrivateLinkResourceSharedPrivateLinkResourcesRestClient.ListByServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, searchManagementRequestOptions, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new SharedSearchServicePrivateLinkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<SharedSearchServicePrivateLinkResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _sharedSearchServicePrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SharedSearchServicePrivateLinkResourceCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _sharedSearchServicePrivateLinkResourceSharedPrivateLinkResourcesRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, searchManagementRequestOptions, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SharedSearchServicePrivateLinkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<SharedSearchServicePrivateLinkResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _sharedSearchServicePrivateLinkResourceSharedPrivateLinkResourcesClientDiagnostics.CreateScope("SharedSearchServicePrivateLinkResourceCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _sharedSearchServicePrivateLinkResourceSharedPrivateLinkResourcesRestClient.ListByServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, searchManagementRequestOptions, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new SharedSearchServicePrivateLinkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
