...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SearchPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal SearchPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SearchServicePrivateEndpointConnectionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
