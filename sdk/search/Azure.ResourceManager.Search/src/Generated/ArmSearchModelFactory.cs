...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public static partial class ArmSearchModelFactory
    {
        ...
        {
            return new SearchServiceAdminKeyResult(primaryKey, secondaryKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchServiceQueryKey(name, key, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchEncryptionWithCmk(enforcement, encryptionComplianceStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchPrivateEndpointConnectionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SharedSearchServicePrivateLinkResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchPrivateLinkResource(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SearchPrivateLinkResourceProperties SearchPrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null, IEnumerable<ShareableSearchServicePrivateLinkResourceType> shareablePrivateLinkResourceTypes = null)
        {
            ...
            return new SearchPrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), shareablePrivateLinkResourceTypes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ShareableSearchServicePrivateLinkResourceType(name, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ShareableSearchServicePrivateLinkResourceProperties(shareablePrivateLinkResourcePropertiesType, groupId, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchServiceNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchServiceNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaUsageResult(id, unit, currentValue, limit, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaUsageResultName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
    }
}
