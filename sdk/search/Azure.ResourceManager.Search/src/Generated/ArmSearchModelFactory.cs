...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public static partial class ArmSearchModelFactory
    {
        ...
        /// <returns> A new <see cref="Models.OfferingsListResult"/> instance for mocking. </returns>
        public static OfferingsListResult OfferingsListResult(IEnumerable<OfferingsByRegion> value = default, string nextLink = default)
        {
            value ??= new ChangeTrackingList<OfferingsByRegion>();

            return new OfferingsListResult(value.ToList(), nextLink, additionalBinaryDataProperties: null);
        }
        ...
        public static OfferingsByRegion OfferingsByRegion(string regionName = default, IEnumerable<FeatureOffering> features = default, IEnumerable<SkuOffering> skus = default)
        {
            features ??= new ChangeTrackingList<FeatureOffering>();
            skus ??= new ChangeTrackingList<SkuOffering>();

            return new OfferingsByRegion(regionName, features.ToList(), skus.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        public static FeatureOffering FeatureOffering(string name = default)
        {
            return new FeatureOffering(name, additionalBinaryDataProperties: null);
        }
        ...
        public static SkuOffering SkuOffering(SearchServiceSkuName? searchSkuName = default, SkuLimits limits = default)
        {
            return new SkuOffering(searchSkuName is null ? default : new SearchSku(searchSkuName, null), limits, additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.SkuLimits"/> instance for mocking. </returns>
        public static SkuLimits SkuLimits(int? indexes = default, int? indexers = default, float? partitionStorageInGigabytes = default, float? partitionVectorStorageInGigabytes = default, int? searchUnits = default, int? replicas = default, int? partitions = default)
        {
            return new SkuLimits(
                indexes,
                indexers,
