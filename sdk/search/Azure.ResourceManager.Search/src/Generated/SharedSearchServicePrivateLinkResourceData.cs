...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SharedSearchServicePrivateLinkResourceData : ResourceData
    {
        ...
        internal SharedSearchServicePrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SharedSearchServicePrivateLinkResourceProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
