...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SharedSearchServicePrivateLinkResourceData : ResourceData
    {
        ...
        internal SharedSearchServicePrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SharedSearchServicePrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
