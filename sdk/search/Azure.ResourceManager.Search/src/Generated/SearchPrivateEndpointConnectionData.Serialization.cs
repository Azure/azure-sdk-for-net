    ...
    public partial class SearchPrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<SearchPrivateEndpointConnectionData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<SearchServicePrivateEndpointConnectionProperties>)Properties).Write(writer, options);
            }
        }
        ...
        internal static SearchPrivateEndpointConnectionData DeserializeSearchPrivateEndpointConnectionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<SearchServicePrivateEndpointConnectionProperties>(property.Value);
                    continue;
                }
