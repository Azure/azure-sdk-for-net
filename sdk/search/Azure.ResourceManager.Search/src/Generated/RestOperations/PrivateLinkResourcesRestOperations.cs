...
namespace Azure.ResourceManager.Search
{
    internal partial class PrivateLinkResources
    {
        ...
        internal HttpMessage CreateGetSupportedPrivateLinkResourcesRequest(Guid subscriptionId, string resourceGroupName, string searchServiceName, string clientRequestId, RequestContext context)
        {
        ...
        internal HttpMessage CreateNextGetSupportedPrivateLinkResourcesRequest(Uri nextPage, Guid subscriptionId, string resourceGroupName, string searchServiceName, string clientRequestId, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
