# Azure Search Management client library for .NET
...
Install the Azure Search management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Search --prerelease
```
