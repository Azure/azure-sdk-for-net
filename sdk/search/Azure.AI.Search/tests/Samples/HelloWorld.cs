...
#region Snippet:Azure_AI_Search_Tests_Samples_Namespaces
using Azure.AI.Search;
using Azure.AI.Search.Models;
#endregion Snippet:Azure_AI_Search_Tests_Samples_Namespaces
using Azure.Core.Testing;
using NUnit.Framework;

namespace Azure.AI.Search.Tests.Samples
{
    public class HelloWorld : SearchTestBase
    {
        ...
        public async Task CreateClient()
        {
            ...
            #region Snippet:Azure_AI_Search_Tests_Samples_CreateClient
            ...
            #endregion Snippet:Azure_AI_Search_Tests_Samples_CreateClient
        ...
        public async Task CreateClientAsync()
        {
            ...
            #region Snippet:Azure_AI_Search_Tests_Samples_CreateClientAsync
            // Get the service endpoint and API key from the environment
            Uri endpoint = new Uri(Environment.GetEnvironmentVariable("SEARCH_ENDPOINT"));
            SearchApiKeyCredential credential = new SearchApiKeyCredential(
                Environment.GetEnvironmentVariable("SEARCH_API_KEY"));
            ...
            Response<SearchServiceStatistics> stats = await search.GetStatisticsAsync();
            Console.WriteLine($"You are using {stats.Value.Counters.IndexCounter.Usage} indexes.");
            #endregion Snippet:Azure_AI_Search_Tests_Samples_CreateClientAsync
        ...
        public async Task HandleErrors()
        {
            ...
            #region Snippet:Azure_AI_Search_Tests_Samples_HandleErrors
            Uri endpoint = new Uri(Environment.GetEnvironmentVariable("SEARCH_ENDPOINT"));
            SearchApiKeyCredential credential = new SearchApiKeyCredential(
                Environment.GetEnvironmentVariable("SEARCH_API_KEY"));
            ...
            #endregion Snippet:Azure_AI_Search_Tests_Samples_HandleErrors
        }
        ...
        public async Task HandleErrorsAsync()
        {
            ...
            #region Snippet:Azure_AI_Search_Tests_Samples_HandleErrorsAsync
            Uri endpoint = new Uri(Environment.GetEnvironmentVariable("SEARCH_ENDPOINT"));
            SearchApiKeyCredential credential = new SearchApiKeyCredential(
                Environment.GetEnvironmentVariable("SEARCH_API_KEY"));
            ...
            #endregion Snippet:Azure_AI_Search_Tests_Samples_HandleErrorsAsync
        }
        ...
        public async Task GetStatisticsAsync()
        {
            ...
            #region Snippet:Azure_AI_Search_Tests_Samples_GetStatisticsAsync
            // Create a new SearchServiceClient
            Uri endpoint = new Uri(Environment.GetEnvironmentVariable("SEARCH_ENDPOINT"));
            SearchApiKeyCredential credential = new SearchApiKeyCredential(
                Environment.GetEnvironmentVariable("SEARCH_API_KEY"));
            ...
            #endregion Snippet:Azure_AI_Search_Tests_Samples_GetStatisticsAsync
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            #region Snippet:Azure_AI_Search_Tests_Samples_GetCountAsync
            ...
            #endregion Snippet:Azure_AI_Search_Tests_Samples_GetCountAsync
        }
    }
}
