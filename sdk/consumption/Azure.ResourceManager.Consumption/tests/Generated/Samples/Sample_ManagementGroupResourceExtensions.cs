...
namespace Azure.ResourceManager.Consumption.Samples
{
    public partial class Sample_ManagementGroupResourceExtensions
    {
        ...
        {
            // Generated from example definition: specification/consumption/resource-manager/Microsoft.Consumption/stable/2024-08-01/examples/AggregatedCostByManagementGroup.json
        ...
        {
            // Generated from example definition: specification/consumption/resource-manager/Microsoft.Consumption/stable/2024-08-01/examples/AggregatedCostByManagementGroupFilterByDate.json
            // this example is just showing the usage of "AggregatedCost_GetByManagementGroup" operation, for the dependent resources, they will have to be created separately.
