...
namespace Azure.ResourceManager.Consumption.Models
{
    public static partial class ArmConsumptionModelFactory
    {
        ...
        public static Azure.ResourceManager.Consumption.Models.ConsumptionBalanceResult ConsumptionBalanceResult(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, string currency, decimal? beginningBalance, decimal? endingBalance, decimal? newPurchases, decimal? adjustments, decimal? utilized, decimal? serviceOverage, decimal? chargesBilledSeparately, decimal? totalOverage, decimal? totalUsage, decimal? azureMarketplaceServiceCharges, Azure.ResourceManager.Consumption.Models.ConsumptionBillingFrequency? billingFrequency, bool? isPriceHidden, decimal? overageRefund, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Consumption.Models.ConsumptionBalanceNewPurchasesDetail> newPurchasesDetails, System.Collections.Generic.IEnumerable<Azure.ResourceManager.Consumption.Models.ConsumptionBalanceAdjustmentDetail> adjustmentDetails, Azure.ETag? eTag, System.Collections.Generic.IReadOnlyDictionary<string, string> tags) { throw null; }
        ...
        public static Azure.ResourceManager.Consumption.Models.ConsumptionEventSummary ConsumptionEventSummary(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.DateTimeOffset? transactOn, string description, Azure.ResourceManager.Consumption.Models.ConsumptionAmount newCredit, Azure.ResourceManager.Consumption.Models.ConsumptionAmount adjustments, Azure.ResourceManager.Consumption.Models.ConsumptionAmount creditExpired, Azure.ResourceManager.Consumption.Models.ConsumptionAmount charges, Azure.ResourceManager.Consumption.Models.ConsumptionAmount closedBalance, string billingAccountId, string billingAccountDisplayName, Azure.ResourceManager.Consumption.Models.ConsumptionEventType? eventType, string invoiceNumber, Azure.Core.ResourceIdentifier billingProfileId, string billingProfileDisplayName, Azure.Core.ResourceIdentifier lotId, string lotSource, Azure.ResourceManager.Consumption.Models.ConsumptionAmount canceledCredit, string creditCurrency, string billingCurrency, Azure.ResourceManager.Consumption.Models.ConsumptionReseller reseller, Azure.ResourceManager.Consumption.Models.ConsumptionAmountWithExchangeRate creditExpiredInBillingCurrency, Azure.ResourceManager.Consumption.Models.ConsumptionAmountWithExchangeRate newCreditInBillingCurrency, Azure.ResourceManager.Consumption.Models.ConsumptionAmountWithExchangeRate adjustmentsInBillingCurrency, Azure.ResourceManager.Consumption.Models.ConsumptionAmountWithExchangeRate chargesInBillingCurrency, Azure.ResourceManager.Consumption.Models.ConsumptionAmountWithExchangeRate closedBalanceInBillingCurrency, bool? isEstimatedBalance = default(bool?), string propertiesETag = null, Azure.ETag? internalETag = default(Azure.ETag?)) { throw null; }
        ...
        public static Azure.ResourceManager.Consumption.Models.ConsumptionLotSummary ConsumptionLotSummary(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, Azure.ResourceManager.Consumption.Models.ConsumptionAmount originalAmount, Azure.ResourceManager.Consumption.Models.ConsumptionAmount closedBalance, Azure.ResourceManager.Consumption.Models.ConsumptionLotSource? source, System.DateTimeOffset? startOn, System.DateTimeOffset? expireOn, string poNumber, System.DateTimeOffset? purchasedOn, Azure.ResourceManager.Consumption.Models.ConsumptionLotStatus? status, string creditCurrency, string billingCurrency, Azure.ResourceManager.Consumption.Models.ConsumptionAmountWithExchangeRate originalAmountInBillingCurrency, Azure.ResourceManager.Consumption.Models.ConsumptionAmountWithExchangeRate closedBalanceInBillingCurrency, Azure.ResourceManager.Consumption.Models.ConsumptionReseller reseller, bool? isEstimatedBalance, string propertiesETag, Azure.ResourceManager.Consumption.Models.OrganizationType? organizationType = default(Azure.ResourceManager.Consumption.Models.OrganizationType?), Azure.ResourceManager.Consumption.Models.ConsumptionAmount usedAmount = null, Azure.ETag? eTag = default(Azure.ETag?)) { throw null; }
        ...
        public static Azure.ResourceManager.Consumption.Models.ConsumptionModernChargeSummary ConsumptionModernChargeSummary(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, Azure.ETag? eTag, string billingPeriodId, string usageStart, string usageEnd, Azure.ResourceManager.Consumption.Models.ConsumptionAmount azureCharges, Azure.ResourceManager.Consumption.Models.ConsumptionAmount chargesBilledSeparately, Azure.ResourceManager.Consumption.Models.ConsumptionAmount marketplaceCharges, string billingAccountId, string billingProfileId, string invoiceSectionId, string customerId, bool? isInvoiced, string subscriptionId) { throw null; }
        public static Azure.ResourceManager.Consumption.Models.ConsumptionModernReservationRecommendation ConsumptionModernReservationRecommendation(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, Azure.Core.AzureLocation? location, string sku, Azure.ETag? eTag, System.Collections.Generic.IReadOnlyDictionary<string, string> tags, Azure.ResourceManager.Consumption.Models.ModernReservationRecommendationProperties properties) { throw null; }
        ...
        public static Azure.ResourceManager.Consumption.Models.PriceSheetProperties PriceSheetProperties(Azure.Core.ResourceIdentifier billingPeriodId, System.Guid? meterId, Azure.ResourceManager.Consumption.Models.ConsumptionMeterDetails meterDetails, string unitOfMeasure, decimal? includedQuantity, string partNumber, decimal? unitPrice, string currencyCode, string offerId, Azure.ResourceManager.Consumption.Models.SavingsPlan savingsPlan) { throw null; }
