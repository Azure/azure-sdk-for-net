...
namespace Azure.ResourceManager.Consumption
{
    internal partial class ReservationsSummaries
    {
        ...
        internal ReservationsSummaries(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ReservationsSummaries).Assembly, applicationId);
        }
