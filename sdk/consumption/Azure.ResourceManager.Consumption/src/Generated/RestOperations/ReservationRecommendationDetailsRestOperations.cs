...
namespace Azure.ResourceManager.Consumption
{
    internal partial class ReservationRecommendationDetails
    {
        ...
        internal ReservationRecommendationDetails(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ReservationRecommendationDetails).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetConsumptionReservationRecommendationDetailsRequest(string resourceScope, string reservationScope, string region, string term, string lookBackPeriod, string product, string filter, string managementGroupId, RequestContext context)
        {
            ...
            {
                uri.AppendQuery("managementGroupId", managementGroupId, true);
            }
