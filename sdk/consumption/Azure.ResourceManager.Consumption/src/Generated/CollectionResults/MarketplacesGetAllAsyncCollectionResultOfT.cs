...
namespace Azure.ResourceManager.Consumption
{
    internal partial class MarketplacesGetAllAsyncCollectionResultOfT : AsyncPageable<ConsumptionMarketplace>
    {
        ...
        public MarketplacesGetAllAsyncCollectionResultOfT(Marketplaces client, string scope, string filter, int? top, string skiptoken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _filter = filter;
