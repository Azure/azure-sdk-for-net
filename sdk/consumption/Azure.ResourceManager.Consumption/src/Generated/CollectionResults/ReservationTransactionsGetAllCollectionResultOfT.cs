    ...
    internal partial class ReservationTransactionsGetAllCollectionResultOfT : Pageable<ConsumptionReservationTransaction>
    {
        ...
        public override IEnumerable<Page<ConsumptionReservationTransaction>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ConsumptionReservationTransaction>.FromValues(result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
