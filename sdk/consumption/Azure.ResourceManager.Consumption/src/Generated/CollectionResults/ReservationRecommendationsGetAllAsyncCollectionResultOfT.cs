...
namespace Azure.ResourceManager.Consumption
{
    internal partial class ReservationRecommendationsGetAllAsyncCollectionResultOfT : AsyncPageable<ConsumptionReservationRecommendation>
    {
        ...
        public ReservationRecommendationsGetAllAsyncCollectionResultOfT(ReservationRecommendations client, string resourceScope, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
