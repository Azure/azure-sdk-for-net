...
namespace Azure.ResourceManager.Consumption
{
    internal partial class EventsGetEventsCollectionResultOfT : Pageable<ConsumptionEventSummary>
    {
        ...
        public EventsGetEventsCollectionResultOfT(Events client, string billingAccountId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
