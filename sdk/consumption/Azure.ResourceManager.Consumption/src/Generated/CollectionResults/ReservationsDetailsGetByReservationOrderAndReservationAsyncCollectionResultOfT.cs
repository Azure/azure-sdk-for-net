...
{
    internal partial class ReservationsDetailsGetByReservationOrderAndReservationAsyncCollectionResultOfT : AsyncPageable<ConsumptionReservationDetail>
    {
        ...
        /// <summary> Initializes a new instance of ReservationsDetailsGetByReservationOrderAndReservationAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ReservationsDetailsGetByReservationOrderAndReservationAsyncCollectionResultOfT(ReservationsDetails client, string reservationOrderId, string reservationId, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ReservationsDetailsGetByReservationOrderAndReservationAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ReservationsDetailsGetByReservationOrderAndReservationAsyncCollectionResultOfT as an enumerable collection. </returns>
