...
namespace Azure.ResourceManager.Consumption
{
    internal partial class ReservationsDetailsGetByReservationOrderAndReservationAsyncCollectionResultOfT : AsyncPageable<ConsumptionReservationDetail>
    {
        ...
        public ReservationsDetailsGetByReservationOrderAndReservationAsyncCollectionResultOfT(ReservationsDetails client, string reservationOrderId, string reservationId, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
