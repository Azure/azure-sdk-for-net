...
{
    internal partial class LotsGetByBillingProfileCollectionResultOfT : Pageable<ConsumptionLotSummary>
    {
        ...
        /// <returns> The pages of LotsGetByBillingProfileCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ConsumptionLotSummary>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ConsumptionLotSummary>.FromValues(result.Value, nextPage?.AbsoluteUri, response);
