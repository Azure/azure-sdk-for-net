...
namespace Azure.ResourceManager.Consumption
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ConsumptionBudgetResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetConsumptionBudgets method.
    /// </summary>
    public partial class ConsumptionBudgetResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ConsumptionBudgetResource for mocking. </summary>
        protected ConsumptionBudgetResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ConsumptionBudgetResource"/> class. </summary>
        ...
        {
            string resourceId = $"{scope}/providers/Microsoft.Consumption/budgets/{budgetName}";
        ...
        {
            using DiagnosticScope scope = _budgetsClientDiagnostics.CreateScope("ConsumptionBudgetResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _budgetsRestClient.CreateGetRequest(Id.Parent, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _budgetsClientDiagnostics.CreateScope("ConsumptionBudgetResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _budgetsRestClient.CreateDeleteRequest(Id.Parent, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                ConsumptionArmOperation operation = new ConsumptionArmOperation(response, rehydrationToken);
        ...
        public virtual async Task<ArmOperation<ConsumptionBudgetResource>> UpdateAsync(WaitUntil waitUntil, ConsumptionBudgetData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _budgetsClientDiagnostics.CreateScope("ConsumptionBudgetResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _budgetsRestClient.CreateCreateOrUpdateRequest(Id.Parent, Id.Name, ConsumptionBudgetData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ConsumptionBudgetData> response = Response.FromValue(ConsumptionBudgetData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
