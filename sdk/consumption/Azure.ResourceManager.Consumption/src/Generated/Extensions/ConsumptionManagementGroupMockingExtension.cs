...
namespace Azure.ResourceManager.Consumption.Mocking
{
    ...
    internal partial class ConsumptionManagementGroupMockingExtension : ArmResource
    {
        private ClientDiagnostics _aggregatedCostClientDiagnostics;
        private AggregatedCostRestOperations _aggregatedCostRestClient;

        /// <summary> Initializes a new instance of the <see cref="ConsumptionManagementGroupMockingExtension"/> class for mocking. </summary>
        protected ConsumptionManagementGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConsumptionManagementGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConsumptionManagementGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = AggregatedCostClientDiagnostics.CreateScope("ConsumptionManagementGroupMockingExtension.GetAggregatedCost");
            scope.Start();
            try
            {
