...
namespace Azure.ResourceManager.Consumption
{
    ...
    public static partial class ConsumptionExtensions
    {
        ...
        {
            return GetArmResourceExtension(client, scope).GetConsumptionBudgets();
        }
        ...
        {
            return await GetManagementGroupResourceExtension(managementGroupResource).GetAggregatedCostAsync(filter, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetManagementGroupResourceExtension(managementGroupResource).GetAggregatedCost(filter, cancellationToken);
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).GetPriceSheetAsync(expand, skipToken, top, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetPriceSheet(expand, skipToken, top, cancellationToken);
        }
    }
}
