...
namespace Azure.ResourceManager.Consumption
{
    ...
    public static partial class ConsumptionExtensions
    {
        ...
        private static ConsumptionArmResourceMockingExtension GetConsumptionArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ConsumptionArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        /// <returns> An object representing collection of ConsumptionBudgetResources and their operations over a ConsumptionBudgetResource. </returns>
        public static ConsumptionBudgetCollection GetConsumptionBudgets(this ArmResource armResource)
        {
            return GetConsumptionArmResourceMockingExtension(armResource).GetConsumptionBudgets();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="budgetName"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<ConsumptionBudgetResource>> GetConsumptionBudgetAsync(this ArmResource armResource, string budgetName, CancellationToken cancellationToken = default)
        {
            return await GetConsumptionArmResourceMockingExtension(armResource).GetConsumptionBudgetAsync(budgetName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="budgetName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<ConsumptionBudgetResource> GetConsumptionBudget(this ArmResource armResource, string budgetName, CancellationToken cancellationToken = default)
        {
            return GetConsumptionArmResourceMockingExtension(armResource).GetConsumptionBudget(budgetName, cancellationToken);
        }
