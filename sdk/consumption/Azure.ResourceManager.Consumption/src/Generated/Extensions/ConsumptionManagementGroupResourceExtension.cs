...
namespace Azure.ResourceManager.Consumption.Mock
{
    ...
    public partial class ConsumptionManagementGroupResourceExtension : ArmResource
    {
        private ClientDiagnostics _aggregatedCostClientDiagnostics;
        private AggregatedCostRestOperations _aggregatedCostRestClient;

        /// <summary> Initializes a new instance of the <see cref="ConsumptionManagementGroupResourceExtension"/> class for mocking. </summary>
        protected ConsumptionManagementGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConsumptionManagementGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConsumptionManagementGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = AggregatedCostClientDiagnostics.CreateScope("ConsumptionManagementGroupResourceExtension.GetAggregatedCost");
            scope.Start();
            try
            {
