...
namespace Azure.ResourceManager.Consumption.Mocking
{
    ...
    internal partial class ConsumptionSubscriptionMockingExtension : ArmResource
    {
        private ClientDiagnostics _priceSheetClientDiagnostics;
        private PriceSheetRestOperations _priceSheetRestClient;

        /// <summary> Initializes a new instance of the <see cref="ConsumptionSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ConsumptionSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConsumptionSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConsumptionSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = PriceSheetClientDiagnostics.CreateScope("ConsumptionSubscriptionMockingExtension.GetPriceSheet");
            scope.Start();
            try
            {
