...
namespace Azure.ResourceManager.Consumption.Mock
{
    ...
    public partial class ConsumptionSubscriptionResourceExtension : ArmResource
    {
        private ClientDiagnostics _priceSheetClientDiagnostics;
        private PriceSheetRestOperations _priceSheetRestClient;

        /// <summary> Initializes a new instance of the <see cref="ConsumptionSubscriptionResourceExtension"/> class for mocking. </summary>
        protected ConsumptionSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConsumptionSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConsumptionSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = PriceSheetClientDiagnostics.CreateScope("ConsumptionSubscriptionResourceExtension.GetPriceSheet");
            scope.Start();
            try
            {
