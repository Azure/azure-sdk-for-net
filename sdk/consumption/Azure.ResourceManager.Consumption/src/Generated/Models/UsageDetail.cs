...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    /// </summary>
    public partial class UsageDetail : ResourceData
    {
        ...
        internal UsageDetail(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, UsageDetailsKind kind, ETag? etag, IReadOnlyDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            ETag = etag;
            Tags = tags;
