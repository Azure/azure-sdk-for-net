...
namespace Azure.ResourceManager.Consumption
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConsumptionBudgetData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConsumptionBudgetData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConsumptionBudgetData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConsumptionBudgetData>)} interface");
            }
        ...
        string IPersistableModel<ConsumptionBudgetData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
