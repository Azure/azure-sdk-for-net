...
{
    public partial class ConsumptionTag : IUtf8JsonSerializable, IJsonModel<ConsumptionTag>, IPersistableModel<ConsumptionTag>
    {
        ...
        void IJsonModel<ConsumptionTag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConsumptionTag)} does not support '{format}' format.");
            }
