...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConsumptionTag>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ConsumptionTag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConsumptionTag>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
