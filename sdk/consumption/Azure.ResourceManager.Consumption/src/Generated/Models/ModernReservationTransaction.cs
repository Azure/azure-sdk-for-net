...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ModernReservationTransaction : ResourceData
    {
        /// <summary> Initializes a new instance of ModernReservationTransaction. </summary>
        ...
        /// <param name="eventOn"> The date of the transaction. </param>
        ...
        internal ModernReservationTransaction(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, decimal? amount, string armSkuName, string billingFrequency, string billingProfileId, string billingProfileName, string currency, string description, DateTimeOffset? eventOn, string eventType, string invoice, string invoiceId, string invoiceSectionId, string invoiceSectionName, Guid? purchasingSubscriptionGuid, string purchasingSubscriptionName, decimal? quantity, string region, string reservationOrderId, string reservationOrderName, string term, IReadOnlyList<string> tags) : base(id, name, resourceType, systemData)
        {
            Amount = amount;
