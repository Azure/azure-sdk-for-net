...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConsumptionModernReservationTransaction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConsumptionModernReservationTransaction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConsumptionModernReservationTransaction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConsumptionModernReservationTransaction>)} interface");
            }
        ...
        string IPersistableModel<ConsumptionModernReservationTransaction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
