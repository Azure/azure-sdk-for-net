...
{
    /// <summary> The properties of the legacy reservation recommendation for management group scope. </summary>
    public partial class LegacyManagementGroupScopeReservationRecommendationProperties : LegacyReservationRecommendationProperties
    {
        /// <summary> Initializes a new instance of <see cref="LegacyManagementGroupScopeReservationRecommendationProperties"/>. </summary>
        internal LegacyManagementGroupScopeReservationRecommendationProperties() : base("ManagementGroup")
        {
        }
        ...
        /// <summary> The tenant ID associated with the management group. </summary>
