...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionMeterDetailsInfo
    {
        ...
        internal ConsumptionMeterDetailsInfo(string meterName, string meterCategory, string meterSubCategory, string unitOfMeasure, string serviceFamily, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MeterName = meterName;
