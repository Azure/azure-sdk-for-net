...
{
    public partial class ConsumptionReseller : IUtf8JsonSerializable, IJsonModel<ConsumptionReseller>, IPersistableModel<ConsumptionReseller>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResellerId))
            {
                ...
                builder.AppendLine($" '{ResellerId.ToString()}'");
            }

            if (Optional.IsDefined(ResellerDescription))
            {
                builder.Append("  resellerDescription:");
                builder.AppendLine($" '{ResellerDescription}'");
            }
