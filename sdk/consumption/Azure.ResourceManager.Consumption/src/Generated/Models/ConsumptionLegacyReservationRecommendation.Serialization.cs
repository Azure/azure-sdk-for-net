...
{
    public partial class ConsumptionLegacyReservationRecommendation : IUtf8JsonSerializable, IJsonModel<ConsumptionLegacyReservationRecommendation>, IPersistableModel<ConsumptionLegacyReservationRecommendation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CostWithNoReservedInstances))
            {
                ...
                builder.AppendLine($" '{CostWithNoReservedInstances.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(TotalCostWithReservedInstances))
            {
                ...
                builder.AppendLine($" '{TotalCostWithReservedInstances.Value.ToString()}'");
            }

            if (Optional.IsDefined(NetSavings))
            {
                builder.Append("  netSavings:");
                builder.AppendLine($" '{NetSavings.Value.ToString()}'");
            }
