...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionModernUsageDetail : ConsumptionUsageDetail, IJsonModel<ConsumptionModernUsageDetail>
    {
        /// <summary> Initializes a new instance of <see cref="ConsumptionModernUsageDetail"/> for deserialization. </summary>
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConsumptionModernUsageDetail>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConsumptionModernUsageDetail>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionModernUsageDetail IPersistableModel<ConsumptionModernUsageDetail>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConsumptionModernUsageDetail)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionModernUsageDetail IJsonModel<ConsumptionModernUsageDetail>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConsumptionModernUsageDetail)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConsumptionModernUsageDetail DeserializeConsumptionModernUsageDetail(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    properties = ModernUsageDetailProperties.DeserializeModernUsageDetailProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
