...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        internal static ConsumptionModernUsageDetail DeserializeConsumptionModernUsageDetail(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
