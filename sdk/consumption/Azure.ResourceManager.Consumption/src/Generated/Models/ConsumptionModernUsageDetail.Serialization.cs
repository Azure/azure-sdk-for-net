...
{
    public partial class ConsumptionModernUsageDetail : IUtf8JsonSerializable, IJsonModel<ConsumptionModernUsageDetail>, IPersistableModel<ConsumptionModernUsageDetail>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExchangeRateOn))
            {
                ...
                builder.AppendLine($" '{ExchangeRateOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ServicePeriodStartOn))
            {
                ...
                builder.AppendLine($" '{ServicePeriodStartOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(ServicePeriodEndOn))
            {
                builder.Append("  servicePeriodEndDate:");
                builder.AppendLine($" '{ServicePeriodEndOn.Value.ToString()}'");
            }
