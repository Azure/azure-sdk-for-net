...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConsumptionCalculatedSavingsProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConsumptionCalculatedSavingsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConsumptionCalculatedSavingsProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ConsumptionCalculatedSavingsProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
