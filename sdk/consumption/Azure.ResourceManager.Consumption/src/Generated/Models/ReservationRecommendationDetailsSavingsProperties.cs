...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ReservationRecommendationDetailsSavingsProperties. </summary>
        internal ReservationRecommendationDetailsSavingsProperties()
        {
            CalculatedSavings = new ChangeTrackingList<ReservationRecommendationDetailsCalculatedSavingsProperties>();
        }
        ...
        internal ReservationRecommendationDetailsSavingsProperties(IReadOnlyList<ReservationRecommendationDetailsCalculatedSavingsProperties> calculatedSavings, int? lookBackPeriod, float? recommendedQuantity, string reservationOrderTerm, string savingsType, string unitOfMeasure)
        {
        ...
        public IReadOnlyList<ReservationRecommendationDetailsCalculatedSavingsProperties> CalculatedSavings { get; }
