...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class TagsResult : ResourceData
    {
        ...
        internal TagsResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<Tag> tags, string nextLink, string previousLink, ETag? etag) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
            NextLink = nextLink;
