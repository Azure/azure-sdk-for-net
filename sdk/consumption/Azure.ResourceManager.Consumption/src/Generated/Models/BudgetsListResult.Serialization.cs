...
{
    internal partial class BudgetsListResult : IUtf8JsonSerializable, IJsonModel<BudgetsListResult>, IPersistableModel<BudgetsListResult>
    {
        ...
        void IJsonModel<BudgetsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BudgetsListResult)} does not support '{format}' format.");
            }
