...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ReservationRecommendationDetailsUsageProperties. </summary>
        internal ReservationRecommendationDetailsUsageProperties()
        {
        ...
        internal ReservationRecommendationDetailsUsageProperties(string firstConsumptionDate, string lastConsumptionDate, string lookBackUnitType, IReadOnlyList<float> usageData, string usageGrain)
        {
