...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionLegacyUsageDetail : ConsumptionUsageDetail
    {
        ...
        /// <param name="properties"> Properties for legacy usage details. </param>
        internal ConsumptionLegacyUsageDetail(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, UsageDetailsKind kind, string eTag, IReadOnlyDictionary<string, string> tags, LegacyUsageDetailProperties properties) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, kind, eTag, tags)
        {
            Properties = properties;
        }
