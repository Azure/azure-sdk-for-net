...
{
    public partial class ConsumptionReservationTransaction : IUtf8JsonSerializable, IJsonModel<ConsumptionReservationTransaction>, IPersistableModel<ConsumptionReservationTransaction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BillingMonth))
            {
                ...
                builder.AppendLine($" '{BillingMonth.Value.ToString()}'");
            }
