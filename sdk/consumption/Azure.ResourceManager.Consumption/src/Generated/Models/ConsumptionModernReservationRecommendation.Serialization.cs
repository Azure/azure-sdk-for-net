...
namespace Azure.ResourceManager.Consumption.Models
{
    public partial class ConsumptionModernReservationRecommendation : IUtf8JsonSerializable, IModelJsonSerializable<ConsumptionModernReservationRecommendation>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ConsumptionModernReservationRecommendation>(this, options.Format);
        ...
        internal static ConsumptionModernReservationRecommendation DeserializeConsumptionModernReservationRecommendation(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ConsumptionModernReservationRecommendation(id, name, type, systemData.Value, kind, Optional.ToNullable(etag), Optional.ToDictionary(tags), Optional.ToNullable(location), sku.Value, location0.Value, Optional.ToNullable(lookBackPeriod), Optional.ToNullable(instanceFlexibilityRatio), instanceFlexibilityGroup.Value, normalizedSize.Value, Optional.ToNullable(recommendedQuantityNormalized), Optional.ToNullable(meterId), term.Value, costWithNoReservedInstances.Value, Optional.ToNullable(recommendedQuantity), totalCostWithReservedInstances.Value, netSavings.Value, Optional.ToNullable(firstUsageDate), scope.Value, Optional.ToList(skuProperties), skuName.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ConsumptionModernReservationRecommendation"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ConsumptionModernReservationRecommendation"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ConsumptionModernReservationRecommendation"/>. </summary>
