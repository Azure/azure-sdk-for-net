...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionModernReservationRecommendation : ConsumptionReservationRecommendation, IJsonModel<ConsumptionModernReservationRecommendation>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConsumptionModernReservationRecommendation>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConsumptionModernReservationRecommendation>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionModernReservationRecommendation IPersistableModel<ConsumptionModernReservationRecommendation>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConsumptionModernReservationRecommendation)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConsumptionModernReservationRecommendation IJsonModel<ConsumptionModernReservationRecommendation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConsumptionModernReservationRecommendation)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConsumptionModernReservationRecommendation DeserializeConsumptionModernReservationRecommendation(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    properties = ModernReservationRecommendationProperties.DeserializeModernReservationRecommendationProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
