...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionSavingsProperties
    {
        ...
        internal ConsumptionSavingsProperties(IReadOnlyList<ConsumptionCalculatedSavingsProperties> calculatedSavings, int? lookBackPeriod, float? recommendedQuantity, string reservationOrderTerm, string savingsType, string unitOfMeasure, Dictionary<string, BinaryData> rawData)
        {
