...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        internal static ConsumptionReservationDetail DeserializeConsumptionReservationDetail(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
