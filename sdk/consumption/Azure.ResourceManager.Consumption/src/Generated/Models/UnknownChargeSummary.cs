...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    internal partial class UnknownChargeSummary : ResourceData
    {
        ...
        internal UnknownChargeSummary(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ChargeSummaryKind kind, ETag? etag) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            ETag = etag;
        }
