...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionMarketplace : ResourceData
    {
        ...
        internal ConsumptionMarketplace(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MarketplaceProperties properties, ETag? eTag, IReadOnlyDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
