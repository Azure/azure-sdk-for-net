...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Events>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<Events>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Events)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && !(Value is ChangeTrackingList<ConsumptionEventSummary> collection && collection.IsUndefined))
            {
        ...
        internal static Events DeserializeEvents(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new Events(value ?? new ChangeTrackingList<ConsumptionEventSummary>(), nextLink.Value, serializedAdditionalRawData);
        }
