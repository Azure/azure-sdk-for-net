...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionResourceProperties
    {
        ...
        internal ConsumptionResourceProperties(IReadOnlyList<string> appliedScopes, float? onDemandRate, string product, string region, float? reservationRate, string resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
