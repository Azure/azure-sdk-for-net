...
{
    public partial class ConsumptionAmountWithExchangeRate : IUtf8JsonSerializable, IJsonModel<ConsumptionAmountWithExchangeRate>, IPersistableModel<ConsumptionAmountWithExchangeRate>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExchangeRateMonth))
            {
                ...
                builder.AppendLine($" '{ExchangeRateMonth.Value.ToString()}'");
            }
