...
{
    public partial class CreditBalanceSummary : IUtf8JsonSerializable, IJsonModel<CreditBalanceSummary>, IPersistableModel<CreditBalanceSummary>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  estimatedBalance:");
                AppendChildObject(builder, EstimatedBalance, options, 2);
            }

            if (Optional.IsDefined(CurrentBalance))
            {
                builder.Append("  currentBalance:");
                AppendChildObject(builder, CurrentBalance, options, 2);
            }

            if (Optional.IsDefined(EstimatedBalanceInBillingCurrency))
            {
                builder.Append("  estimatedBalanceInBillingCurrency:");
                AppendChildObject(builder, EstimatedBalanceInBillingCurrency, options, 2);
            }
