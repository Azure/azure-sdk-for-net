    ...
    public partial class CreditBalanceSummary : IUtf8JsonSerializable, IJsonModel<CreditBalanceSummary>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EstimatedBalance))
            {
                ...
                AppendChildObject(builder, EstimatedBalance, options, 2, false);
            }

            if (Optional.IsDefined(CurrentBalance))
            {
                builder.Append("  currentBalance:");
                AppendChildObject(builder, CurrentBalance, options, 2, false);
            }

            if (Optional.IsDefined(EstimatedBalanceInBillingCurrency))
            {
                builder.Append("  estimatedBalanceInBillingCurrency:");
                AppendChildObject(builder, EstimatedBalanceInBillingCurrency, options, 2, false);
            }
