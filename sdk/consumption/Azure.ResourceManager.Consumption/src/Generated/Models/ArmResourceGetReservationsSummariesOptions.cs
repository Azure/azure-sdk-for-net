...
{
    /// <summary> The ArmResourceGetReservationsSummariesOptions. </summary>
    public partial class ArmResourceGetReservationsSummariesOptions
    {
        /// <summary> Initializes a new instance of ArmResourceGetReservationsSummariesOptions. </summary>
        /// <param name="grain"> Can be daily or monthly. </param>
        public ArmResourceGetReservationsSummariesOptions(ReservationSummaryDataGrain grain)
        {
            Grain = grain;
        }
