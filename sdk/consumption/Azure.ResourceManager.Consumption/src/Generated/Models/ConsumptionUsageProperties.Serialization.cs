    ...
    public partial class ConsumptionUsageProperties : IUtf8JsonSerializable, IJsonModel<ConsumptionUsageProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FirstConsumptionDate))
            {
                ...
                if (FirstConsumptionDate.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LastConsumptionDate))
            {
                ...
                if (LastConsumptionDate.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LookBackUnitType))
            {
                ...
                if (LookBackUnitType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(UsageGrain))
            {
                ...
                if (UsageGrain.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
