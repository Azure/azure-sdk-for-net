...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        internal static ConsumptionUsageProperties DeserializeConsumptionUsageProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
