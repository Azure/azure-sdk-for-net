...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ReservationRecommendationDetailsResourceProperties. </summary>
        internal ReservationRecommendationDetailsResourceProperties()
        {
        ...
        internal ReservationRecommendationDetailsResourceProperties(IReadOnlyList<string> appliedScopes, float? onDemandRate, string product, string region, float? reservationRate, string resourceType)
        {
