...
namespace Azure.ResourceManager.Consumption.Models
{
    public partial class ReservationRecommendation
    {
        internal static ReservationRecommendation DeserializeReservationRecommendation(JsonElement element)
        {
            ...
            return new ReservationRecommendation(id, name, type, systemData.Value, kind, Optional.ToNullable(etag), Optional.ToDictionary(tags), Optional.ToNullable(location), sku.Value);
        }
    }
}
