...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionCalculatedSavingsProperties
    {
        ...
        internal ConsumptionCalculatedSavingsProperties(float? onDemandCost, float? overageCost, float? quantity, float? reservationCost, float? totalReservationCost, float? reservedUnitCount, float? savings, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
