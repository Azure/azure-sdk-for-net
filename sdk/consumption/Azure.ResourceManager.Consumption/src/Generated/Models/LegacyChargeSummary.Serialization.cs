...
{
    public partial class LegacyChargeSummary : IUtf8JsonSerializable
    {
        ...
        internal static LegacyChargeSummary DeserializeLegacyChargeSummary(JsonElement element)
        {
            ...
            return new LegacyChargeSummary(id, name, type, systemData.Value, kind, Optional.ToNullable(eTag), billingPeriodId.Value, usageStart.Value, usageEnd.Value, Optional.ToNullable(azureCharges), Optional.ToNullable(chargesBilledSeparately), Optional.ToNullable(marketplaceCharges), currency.Value);
        }
    }
}
