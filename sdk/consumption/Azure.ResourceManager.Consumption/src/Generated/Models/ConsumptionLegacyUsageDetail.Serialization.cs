...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        internal static ConsumptionLegacyUsageDetail DeserializeConsumptionLegacyUsageDetail(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
