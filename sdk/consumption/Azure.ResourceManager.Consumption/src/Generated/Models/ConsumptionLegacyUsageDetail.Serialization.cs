...
{
    public partial class ConsumptionLegacyUsageDetail : IUtf8JsonSerializable, IJsonModel<ConsumptionLegacyUsageDetail>, IPersistableModel<ConsumptionLegacyUsageDetail>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BillingPeriodStartOn))
            {
                ...
                builder.AppendLine($" '{BillingPeriodStartOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(BillingPeriodEndOn))
            {
                builder.Append("  billingPeriodEndDate:");
                builder.AppendLine($" '{BillingPeriodEndOn.Value.ToString()}'");
            }
            ...
            {
                builder.Append("  date:");
                builder.AppendLine($" '{On.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(PricingModel))
            {
                ...
                builder.AppendLine($" '{PricingModel.ToString()}'");
            }
