...
namespace Azure.ResourceManager.Consumption.Models
{
    public partial class ModernUsageDetail
    {
        internal static ModernUsageDetail DeserializeModernUsageDetail(JsonElement element)
        {
            ...
            Optional<PricingModelType> pricingModel = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("pricingModel"u8))
                        {
                            ...
                            pricingModel = new PricingModelType(property0.Value.GetString());
                            continue;
                        }
