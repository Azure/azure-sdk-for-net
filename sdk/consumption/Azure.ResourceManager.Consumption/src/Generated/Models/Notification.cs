...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class Notification
    {
        ...
        public Notification(bool enabled, OperatorType @operator, decimal threshold, IEnumerable<string> contactEmails)
        {
        ...
        internal Notification(bool enabled, OperatorType @operator, decimal threshold, IList<string> contactEmails, IList<string> contactRoles, IList<string> contactGroups, ThresholdType? thresholdType, CultureCode? locale)
        {
            Enabled = enabled;
            Operator = @operator;
            Threshold = threshold;
