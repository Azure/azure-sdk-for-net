...
{
    public partial class ConsumptionBudgetFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ConsumptionBudgetFilter DeserializeConsumptionBudgetFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
