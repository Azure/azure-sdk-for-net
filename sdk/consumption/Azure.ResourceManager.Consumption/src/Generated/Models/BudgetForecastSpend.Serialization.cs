...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BudgetForecastSpend>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BudgetForecastSpend>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BudgetForecastSpend>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BudgetForecastSpend>)} interface");
            }
        ...
        string IPersistableModel<BudgetForecastSpend>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
