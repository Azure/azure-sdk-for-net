...
{
    public partial class ConsumptionReservationSummary : IUtf8JsonSerializable, IJsonModel<ConsumptionReservationSummary>, IPersistableModel<ConsumptionReservationSummary>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UseOn))
            {
                ...
                builder.AppendLine($" '{UseOn.Value.ToString()}'");
            }
