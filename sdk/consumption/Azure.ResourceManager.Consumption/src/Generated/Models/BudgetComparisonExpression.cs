...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class BudgetComparisonExpression
    {
        ...
        internal BudgetComparisonExpression(string name, BudgetOperatorType @operator, IList<string> values, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Operator = @operator;
            Values = values;
