...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class LegacyReservationRecommendation : ReservationRecommendation
    {
        ...
        internal LegacyReservationRecommendation(string scope)
        {
        ...
        internal LegacyReservationRecommendation(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ReservationRecommendationKind kind, ETag? etag, IReadOnlyDictionary<string, string> tags, AzureLocation? location, string sku, string lookBackPeriod, float? instanceFlexibilityRatio, string instanceFlexibilityGroup, string normalizedSize, float? recommendedQuantityNormalized, Guid? meterId, string term, decimal? costWithNoReservedInstances, decimal? recommendedQuantity, decimal? totalCostWithReservedInstances, decimal? netSavings, DateTimeOffset? firstUsageOn, string scope, IReadOnlyList<SkuProperty> skuProperties) : base(id, name, resourceType, systemData, kind, etag, tags, location, sku)
        {
