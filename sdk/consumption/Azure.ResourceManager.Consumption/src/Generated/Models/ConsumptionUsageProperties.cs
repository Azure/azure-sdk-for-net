...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionUsageProperties
    {
        ...
        internal ConsumptionUsageProperties(string firstConsumptionDate, string lastConsumptionDate, string lookBackUnitType, IReadOnlyList<float> usageData, string usageGrain, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
