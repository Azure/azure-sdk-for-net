...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionMeterDetails
    {
        ...
        internal ConsumptionMeterDetails(string meterName, string meterCategory, string meterSubCategory, string unit, string meterLocation, decimal? totalIncludedQuantity, decimal? pretaxStandardRate, string serviceName, string serviceTier, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MeterName = meterName;
