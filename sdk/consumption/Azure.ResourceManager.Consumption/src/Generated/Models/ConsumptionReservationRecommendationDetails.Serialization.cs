...
{
    public partial class ConsumptionReservationRecommendationDetails : IUtf8JsonSerializable, IJsonModel<ConsumptionReservationRecommendationDetails>, IPersistableModel<ConsumptionReservationRecommendationDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Savings))
            {
                ...
                AppendChildObject(builder, Savings, options, 2);
            }
