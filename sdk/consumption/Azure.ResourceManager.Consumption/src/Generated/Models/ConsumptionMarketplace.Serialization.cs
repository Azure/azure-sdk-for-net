...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConsumptionMarketplace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConsumptionMarketplace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConsumptionMarketplace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConsumptionMarketplace>)} interface");
            }
        ...
        string IPersistableModel<ConsumptionMarketplace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
