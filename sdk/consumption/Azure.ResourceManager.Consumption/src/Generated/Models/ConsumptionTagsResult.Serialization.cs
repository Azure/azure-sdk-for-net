...
{
    public partial class ConsumptionTagsResult : IUtf8JsonSerializable, IJsonModel<ConsumptionTagsResult>, IPersistableModel<ConsumptionTagsResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PreviousLink))
            {
                ...
                builder.AppendLine($" '{PreviousLink}'");
            }
