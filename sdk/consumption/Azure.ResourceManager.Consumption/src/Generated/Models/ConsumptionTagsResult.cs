...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ConsumptionTagsResult : ResourceData
    {
        ...
        internal ConsumptionTagsResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, TagProperties properties, string eTag) : base(id, name, resourceType, systemData)
        {
