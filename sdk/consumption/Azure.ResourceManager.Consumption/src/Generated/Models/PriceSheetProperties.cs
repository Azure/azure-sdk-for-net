...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class PriceSheetProperties
    {
        ...
        internal PriceSheetProperties(ResourceIdentifier billingPeriodId, Guid? meterId, ConsumptionMeterDetails meterDetails, string unitOfMeasure, decimal? includedQuantity, string partNumber, decimal? unitPrice, string currencyCode, string offerId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
