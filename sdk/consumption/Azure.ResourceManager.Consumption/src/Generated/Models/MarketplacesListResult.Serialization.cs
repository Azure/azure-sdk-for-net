...
{
    internal partial class MarketplacesListResult : IUtf8JsonSerializable, IJsonModel<MarketplacesListResult>, IPersistableModel<MarketplacesListResult>
    {
        ...
        void IJsonModel<MarketplacesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MarketplacesListResult)} does not support '{format}' format.");
            }
