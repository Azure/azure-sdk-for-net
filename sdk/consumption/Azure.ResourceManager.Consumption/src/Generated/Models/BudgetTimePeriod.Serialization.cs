...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BudgetTimePeriod>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BudgetTimePeriod>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BudgetTimePeriod>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BudgetTimePeriod>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
