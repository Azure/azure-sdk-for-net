...
namespace Azure.ResourceManager.Consumption.Models
{
    internal partial class UsageDetailsListResult : IUtf8JsonSerializable, IJsonModel<UsageDetailsListResult>
    {
        ...
        void IJsonModel<UsageDetailsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && !(Value is ChangeTrackingList<ConsumptionUsageDetail> collection && collection.IsUndefined))
            {
        ...
        internal static UsageDetailsListResult DeserializeUsageDetailsListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UsageDetailsListResult(value ?? new ChangeTrackingList<ConsumptionUsageDetail>(), nextLink.Value, serializedAdditionalRawData);
        }
