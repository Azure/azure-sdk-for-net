...
namespace Azure.ResourceManager.Consumption.Models
{
    internal partial class UsageDetailsListResult : IUtf8JsonSerializable, IJsonModel<UsageDetailsListResult>
    {
        ...
        void IJsonModel<UsageDetailsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UsageDetailsListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UsageDetailsListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UsageDetailsListResult)} does not support '{options.Format}' format.");
            }
        }
