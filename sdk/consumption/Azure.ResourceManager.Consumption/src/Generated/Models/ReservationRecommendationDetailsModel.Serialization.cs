...
namespace Azure.ResourceManager.Consumption.Models
{
    public partial class ReservationRecommendationDetailsModel
    {
        internal static ReservationRecommendationDetailsModel DeserializeReservationRecommendationDetailsModel(JsonElement element)
        {
            ...
            return new ReservationRecommendationDetailsModel(id, name, type, systemData.Value, Optional.ToNullable(location), sku.Value, currency.Value, resource.Value, resourceGroup.Value, savings.Value, scope.Value, usage.Value, Optional.ToNullable(etag), Optional.ToDictionary(tags));
        }
    }
}
