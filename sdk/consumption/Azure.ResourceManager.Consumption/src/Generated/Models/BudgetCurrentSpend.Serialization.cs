...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BudgetCurrentSpend>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BudgetCurrentSpend>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BudgetCurrentSpend>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BudgetCurrentSpend>)} interface");
            }
        ...
        string IPersistableModel<BudgetCurrentSpend>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
