...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ReservationDetail : ResourceData
    {
        ...
        /// <param name="usageOn"> The date on which consumption occurred. </param>
        ...
        internal ReservationDetail(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string reservationOrderId, string instanceFlexibilityRatio, string instanceFlexibilityGroup, string reservationId, string skuName, decimal? reservedHours, DateTimeOffset? usageOn, decimal? usedHours, string instanceId, decimal? totalReservedQuantity, string kind, ETag? etag, IReadOnlyDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
