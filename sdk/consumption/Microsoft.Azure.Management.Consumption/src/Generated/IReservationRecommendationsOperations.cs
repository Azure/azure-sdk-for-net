...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public partial interface IReservationRecommendationsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<ReservationRecommendation>>> ListWithHttpMessagesAsync(string resourceScope, string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List of recommendations for purchasing reserved instances.
        /// <see href="https://docs.microsoft.com/en-us/rest/api/consumption/" />
        /// </summary>
