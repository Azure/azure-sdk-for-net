...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    /// </summary>
    internal partial class AggregatedCostOperations : IServiceOperations<ConsumptionManagementClient>, IAggregatedCostOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ManagementGroupAggregatedCostResult>> GetByManagementGroupWithHttpMessagesAsync(string managementGroupId, string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ManagementGroupAggregatedCostResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ManagementGroupAggregatedCostResult>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ManagementGroupAggregatedCostResult>> GetForBillingPeriodByManagementGroupWithHttpMessagesAsync(string managementGroupId, string billingPeriodName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (managementGroupId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "managementGroupId");
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/aggregatedCost").ToString();
            _url = _url.Replace("{managementGroupId}", System.Uri.EscapeDataString(managementGroupId));
