...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    internal partial class ReservationRecommendationDetailsOperations : IServiceOperations<ConsumptionManagementClient>, IReservationRecommendationDetailsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ReservationRecommendationDetailsModel>> GetWithHttpMessagesAsync(string resourceScope, string scope, string region, string term, string lookBackPeriod, string product, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{resourceScope}/providers/Microsoft.Consumption/reservationRecommendationDetails").ToString();
