...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    internal partial class ReservationRecommendationsOperations : IServiceOperations<ConsumptionManagementClient>, IReservationRecommendationsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<ReservationRecommendation>>> ListWithHttpMessagesAsync(string resourceScope, string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{resourceScope}/providers/Microsoft.Consumption/reservationRecommendations").ToString();
