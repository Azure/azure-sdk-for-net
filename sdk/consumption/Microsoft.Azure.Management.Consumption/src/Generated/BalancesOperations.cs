...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    /// </summary>
    internal partial class BalancesOperations : IServiceOperations<ConsumptionManagementClient>, IBalancesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<Balance>> GetByBillingAccountWithHttpMessagesAsync(string billingAccountId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<Balance>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Balance>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Balance>> GetForBillingPeriodByBillingAccountWithHttpMessagesAsync(string billingAccountId, string billingPeriodName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/balances").ToString();
            _url = _url.Replace("{billingAccountId}", System.Uri.EscapeDataString(billingAccountId));
