...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public static partial class ReservationsSummariesOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<ReservationSummary> List(this IReservationsSummariesOperations operations, string resourceScope, string grain, string startDate = default(string), string endDate = default(string), string filter = default(string), string reservationId = default(string), string reservationOrderId = default(string))
            {
                return operations.ListAsync(resourceScope, grain, startDate, endDate, filter, reservationId, reservationOrderId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<ReservationSummary>> ListAsync(this IReservationsSummariesOperations operations, string resourceScope, string grain, string startDate = default(string), string endDate = default(string), string filter = default(string), string reservationId = default(string), string reservationOrderId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(resourceScope, grain, startDate, endDate, filter, reservationId, reservationOrderId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
