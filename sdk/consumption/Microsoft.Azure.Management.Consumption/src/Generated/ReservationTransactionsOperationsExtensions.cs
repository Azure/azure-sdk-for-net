...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    {
            /// <summary>
            /// List of transactions for reserved instances on billing account scope. Note:
            /// The refund transactions are posted along with its purchase transaction
            /// (i.e. in the purchase billing month). For example, The refund is requested
            /// in May 2021. This refund transaction will have event date as May 2021 but
            ...
            /// start date and end date. The filter supports 'le' and  'ge'. Note: API
            /// returns data for the entire start date's and end date's billing month. For
            /// example, filter
            /// properties/eventDate+ge+2020-01-01+AND+properties/eventDate+le+2020-12-29
            /// will include data for the entire December 2020 month (i.e. will contain
            ...
            /// <summary>
            /// List of transactions for reserved instances on billing profile scope. The
            /// refund transactions are posted along with its purchase transaction (i.e. in
            /// the purchase billing month). For example, The refund is requested in May
            /// 2021. This refund transaction will have event date as May 2021 but the
            ...
            /// example, filter
            /// properties/eventDate+ge+2020-01-01+AND+properties/eventDate+le+2020-12-29
            /// will include data for entire December 2020 month (i.e. will contain records
            /// for dates December 30 and 31)
            /// </param>
