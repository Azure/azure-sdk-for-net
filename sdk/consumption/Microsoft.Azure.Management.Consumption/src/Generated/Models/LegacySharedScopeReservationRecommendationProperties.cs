...
namespace Microsoft.Azure.Management.Consumption.Models
{
    ...
    /// <summary>
    /// The properties of the legacy reservation recommendation for shared
    /// scope.
    /// </summary>
    ...
    public partial class LegacySharedScopeReservationRecommendationProperties : LegacyReservationRecommendationProperties
    {
        ...
        /// LegacySharedScopeReservationRecommendationProperties class.
        /// </summary>
        ...
        public LegacySharedScopeReservationRecommendationProperties(string lookBackPeriod = default(string), double? instanceFlexibilityRatio = default(double?), string instanceFlexibilityGroup = default(string), string normalizedSize = default(string), double? recommendedQuantityNormalized = default(double?), System.Guid? meterId = default(System.Guid?), string resourceType = default(string), string term = default(string), decimal? costWithNoReservedInstances = default(decimal?), decimal? recommendedQuantity = default(decimal?), decimal? totalCostWithReservedInstances = default(decimal?), decimal? netSavings = default(decimal?), System.DateTime? firstUsageDate = default(System.DateTime?), IList<SkuProperty> skuProperties = default(IList<SkuProperty>))
            : base(lookBackPeriod, instanceFlexibilityRatio, instanceFlexibilityGroup, normalizedSize, recommendedQuantityNormalized, meterId, resourceType, term, costWithNoReservedInstances, recommendedQuantity, totalCostWithReservedInstances, netSavings, firstUsageDate, skuProperties)
        {
            CustomInit();
        }
