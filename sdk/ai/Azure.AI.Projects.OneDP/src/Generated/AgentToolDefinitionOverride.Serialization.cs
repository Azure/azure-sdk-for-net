...
{
    public partial class AgentToolDefinitionOverride : IUtf8JsonSerializable, IJsonModel<AgentToolDefinitionOverride>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentToolDefinitionOverride>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentToolDefinitionOverride>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        string IPersistableModel<AgentToolDefinitionOverride>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
