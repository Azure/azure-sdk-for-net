...
namespace Azure.AI.Projects.OneDP
{
    ...
    internal partial class UnknownChatMessage : ChatMessage
    {
        ...
        internal UnknownChatMessage(string userId, string agentId, string messageId, string agentRunId, string conversationId, AuthorRole role, IList<AIContent> content, string authorName, long? createdAt, long? completedAt, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(userId, agentId, messageId, agentRunId, conversationId, role, content, authorName, createdAt, completedAt, serializedAdditionalRawData)
        {
        }
