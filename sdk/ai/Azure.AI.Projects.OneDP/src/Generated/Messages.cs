...
namespace Azure.AI.Projects.OneDP
{
    ...
    public partial class Messages
    {
        ...
        public virtual async Task<Response<ChatMessage>> SendMessageAsync(string conversationId, ChatMessage body, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Response<ChatMessage> SendMessage(string conversationId, ChatMessage body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNull(body, nameof(body));
        ...
        public virtual async Task<Response<ChatMessage>> GetMessageAsync(string conversationId, string messageId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetMessageAsync(conversationId, messageId, context).ConfigureAwait(false);
            return Response.FromValue(ChatMessage.FromResponse(response), response);
        }
        ...
        public virtual Response<ChatMessage> GetMessage(string conversationId, string messageId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = GetMessage(conversationId, messageId, context);
            return Response.FromValue(ChatMessage.FromResponse(response), response);
        }
        ...
        public virtual async Task<Response> GetMessageAsync(string conversationId, string messageId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
            ...
            try
            {
                using HttpMessage message = CreateGetMessageRequest(conversationId, messageId, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        public virtual Response GetMessage(string conversationId, string messageId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
        ...
        public virtual async Task<Response> UpdateMessageAsync(string conversationId, string messageId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                using HttpMessage message = CreateUpdateMessageRequest(conversationId, messageId, content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        public virtual Response UpdateMessage(string conversationId, string messageId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<Response> DeleteMessageAsync(string conversationId, string messageId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
            ...
            try
            {
                using HttpMessage message = CreateDeleteMessageRequest(conversationId, messageId, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        public virtual Response DeleteMessage(string conversationId, string messageId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
        ...
        internal HttpMessage CreateGetMessageRequest(string conversationId, string messageId, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
        ...
        internal HttpMessage CreateDeleteMessageRequest(string conversationId, string messageId, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetMessagesRequest(string conversationId, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
