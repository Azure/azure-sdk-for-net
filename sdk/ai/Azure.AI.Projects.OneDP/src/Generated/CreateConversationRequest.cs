...
namespace Azure.AI.Projects.OneDP
{
    ...
    internal partial class CreateConversationRequest
    {
        ...
        internal CreateConversationRequest(IEnumerable<ChatMessage> messages)
        {
        ...
        internal CreateConversationRequest(IReadOnlyList<ChatMessage> messages, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Messages = messages;
