...
namespace Azure.AI.Projects.OneDP
{
    ...
    public partial class Run
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="runInputs"/> or <paramref name="runOutputs"/> is null. </exception>
        internal Run(long createdAt, long completedAt, RunInputs runInputs, RunOutputs runOutputs)
        {
        ...
        internal Run(string runId, long createdAt, long completedAt, RunInputs runInputs, RunOutputs runOutputs, string userId, bool? store, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RunId = runId;
            CreatedAt = createdAt;
            CompletedAt = completedAt;
