...
{
    public partial class DeveloperMessage : IUtf8JsonSerializable, IJsonModel<DeveloperMessage>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeveloperMessage>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeveloperMessage>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DeveloperMessage DeserializeDeveloperMessage(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        internal static new DeveloperMessage FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeDeveloperMessage(document.RootElement);
        }
