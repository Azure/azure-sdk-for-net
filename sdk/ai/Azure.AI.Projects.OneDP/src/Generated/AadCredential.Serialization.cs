...
{
    public partial class AadCredential : IUtf8JsonSerializable, IJsonModel<AadCredential>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AadCredential>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AadCredential>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        string IPersistableModel<AadCredential>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
