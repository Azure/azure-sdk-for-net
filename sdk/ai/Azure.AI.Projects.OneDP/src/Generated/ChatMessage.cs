...
namespace Azure.AI.Projects.OneDP
{
    ...
    public abstract partial class ChatMessage
    {
        ...
        internal ChatMessage(string userId, string agentId, string messageId, string agentRunId, string conversationId, AuthorRole role, IList<AIContent> content, string authorName, long? createdAt, long? completedAt, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserId = userId;
            AgentId = agentId;
            MessageId = messageId;
        ...
        /// <summary> The conversation to which this message belongs. </summary>
