...
public class Sample_Evaluations : SamplesBase<AIProjectsTestEnvironment>
{
    ...
    public void EvaluationsExampleSync()
    {
        ...
        Evaluation evaluation = new Evaluation(
            data: new InputDataset("azureai://accounts/anksingtest1rp/projects/anksingtest1rpproject/data/eval-data-2025-04-29_151733_UTC/versions/1"), // new InputDataset("<dataset_id>"), // TODO: Update this to use the correct dataset ID
