...
namespace OpenAI
{
    ...
    internal partial class ResponseUsage
    {
        ...
        internal ResponseUsage(int inputTokens, ResponseUsageInputTokensDetails inputTokensDetails, int outputTokens, ResponseUsageOutputTokensDetails outputTokensDetails, int totalTokens, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            InputTokens = inputTokens;
            InputTokensDetails = inputTokensDetails;
            OutputTokens = outputTokens;
