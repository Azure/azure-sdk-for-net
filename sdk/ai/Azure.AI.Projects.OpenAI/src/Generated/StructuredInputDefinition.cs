...
namespace Azure.AI.Projects.OpenAI
{
    ...
    public partial class StructuredInputDefinition
    {
        ...
        internal StructuredInputDefinition(string description, BinaryData defaultValue, IList<StructuredInputToolArgumentBinding> toolArgumentBindings, BinaryData schema, bool? isRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        /// <summary> When provided, the input value is bound to the specified tool arguments. </summary>
        public IList<StructuredInputToolArgumentBinding> ToolArgumentBindings { get; }
