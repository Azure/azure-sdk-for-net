...
namespace Azure.AI.Projects.OpenAI
{
    ...
    public partial class MemorySearchTool : AgentTool
    {
        ...
        internal MemorySearchTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string memoryStoreName, string scope, MemorySearchToolOptions searchOptions, int? updateDelay) : base(@type, additionalBinaryDataProperties)
        {
            MemoryStoreName = memoryStoreName;
            Scope = scope;
