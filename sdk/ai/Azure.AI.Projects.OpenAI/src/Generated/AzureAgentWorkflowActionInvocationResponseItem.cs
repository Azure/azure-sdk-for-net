...
namespace Azure.AI.Projects.OpenAI
{
    ...
    public partial class AzureAgentWorkflowActionInvocationResponseItem : AgentWorkflowActionResponseItem
    {
        /// <summary> Initializes a new instance of <see cref="AzureAgentWorkflowActionInvocationResponseItem"/>. </summary>
        /// <param name="id"></param>
        ...
        internal AzureAgentWorkflowActionInvocationResponseItem(string id, string actionId, AgentWorkflowActionStatus? status, AgentInfo agent, string responseId) : base(id, "InvokeAzureAgent", actionId, status)
        {
            Agent = agent;
