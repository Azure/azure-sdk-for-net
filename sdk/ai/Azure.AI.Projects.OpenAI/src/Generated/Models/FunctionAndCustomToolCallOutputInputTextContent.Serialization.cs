...
namespace OpenAI
{
    ...
    internal partial class FunctionAndCustomToolCallOutputInputTextContent : InternalFunctionAndCustomToolCallOutput, IJsonModel<FunctionAndCustomToolCallOutputInputTextContent>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FunctionAndCustomToolCallOutputInputTextContent)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FunctionAndCustomToolCallOutputInputTextContent IJsonModel<FunctionAndCustomToolCallOutputInputTextContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (FunctionAndCustomToolCallOutputInputTextContent)JsonModelCreateCore(ref reader, options);
        ...
        protected override InternalFunctionAndCustomToolCallOutput JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FunctionAndCustomToolCallOutputInputTextContent)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FunctionAndCustomToolCallOutputInputTextContent DeserializeFunctionAndCustomToolCallOutputInputTextContent(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FunctionAndCustomToolCallOutputInputTextContent)} does not support writing '{options.Format}' format.");
            }
        }
