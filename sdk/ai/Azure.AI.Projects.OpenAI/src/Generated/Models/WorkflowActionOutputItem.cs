...
namespace Azure.AI.Projects.OpenAI
{
    ...
    public partial class WorkflowActionOutputItem : AgentResponseItem
    {
        ...
        internal WorkflowActionOutputItem(string kind, string actionId, WorkflowActionOutputItemStatus status) : base(AgentResponseItemKind.WorkflowAction)
        {
            Kind = kind;
            ActionId = actionId;
            Status = status;
        ...
        /// <param name="status"> Status of the action (e.g., 'in_progress', 'completed', 'failed', 'cancelled'). </param>
        internal WorkflowActionOutputItem(AgentResponseItemKind @type, string id, AgentReference agentReference, string responseId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string kind, string actionId, string parentActionId, string previousActionId, WorkflowActionOutputItemStatus status) : base(@type, id, agentReference, responseId, additionalBinaryDataProperties)
        {
            Kind = kind;
            ActionId = actionId;
