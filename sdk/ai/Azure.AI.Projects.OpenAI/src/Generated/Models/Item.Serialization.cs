            ...
            if (element.TryGetProperty("type"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "apply_patch_call":
                        return InternalApplyPatchToolCallItemParam.DeserializeInternalApplyPatchToolCallItemParam(element, options);
                    ...
                    case "computer_call":
                        return InternalItemComputerToolCall.DeserializeInternalItemComputerToolCall(element, options);
                    ...
                    case "mcp_list_tools":
                        return InternalItemMcpListTools.DeserializeInternalItemMcpListTools(element, options);
