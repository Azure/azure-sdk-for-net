...
namespace Azure.AI.Projects.OpenAI
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InternalOutputItemApplyPatchToolCall"/> for deserialization. </summary>
        internal InternalOutputItemApplyPatchToolCall()
        {
        }
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InternalOutputItemApplyPatchToolCall>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeInternalOutputItemApplyPatchToolCall(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(InternalOutputItemApplyPatchToolCall)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalOutputItemApplyPatchToolCall)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InternalOutputItemApplyPatchToolCall>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<InternalOutputItemApplyPatchToolCall>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<InternalOutputItemApplyPatchToolCall>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemApplyPatchToolCall)} does not support writing '{format}' format.");
            }
        ...
        protected override AgentResponseItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemApplyPatchToolCall)} does not support reading '{format}' format.");
            }
        ...
        internal static InternalOutputItemApplyPatchToolCall DeserializeInternalOutputItemApplyPatchToolCall(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalOutputItemApplyPatchToolCall(
                @type,
                id,
                agentReference,
                responseId,
