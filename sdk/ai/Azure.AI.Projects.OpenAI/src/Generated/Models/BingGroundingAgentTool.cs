...
namespace Azure.AI.Projects.OpenAI
{
    ...
    public partial class BingGroundingAgentTool : AgentTool
    {
        ...
        public BingGroundingAgentTool(BingGroundingSearchToolOptions bingGrounding) : base(ToolType.BingGrounding)
        {
        ...
        /// <param name="bingGrounding"> The bing grounding search tool parameters. </param>
        internal BingGroundingAgentTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, BingGroundingSearchToolOptions bingGrounding) : base(@type, additionalBinaryDataProperties)
        {
            BingGrounding = bingGrounding;
        }
