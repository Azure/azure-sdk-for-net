...
{
    internal partial class InternalOutputItemFunctionToolCallOutputResource : AgentResponseItem, IJsonModel<InternalOutputItemFunctionToolCallOutputResource>
    {
        /// <summary> Initializes a new instance of <see cref="InternalOutputItemFunctionToolCallOutputResource"/> for deserialization. </summary>
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemFunctionToolCallOutputResource)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InternalOutputItemFunctionToolCallOutputResource IJsonModel<InternalOutputItemFunctionToolCallOutputResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InternalOutputItemFunctionToolCallOutputResource)JsonModelCreateCore(ref reader, options);
        ...
        protected override AgentResponseItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemFunctionToolCallOutputResource)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InternalOutputItemFunctionToolCallOutputResource DeserializeInternalOutputItemFunctionToolCallOutputResource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalOutputItemFunctionToolCallOutputResource(
                @type,
                id,
                agentReference,
                responseId,
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InternalOutputItemFunctionToolCallOutputResource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalOutputItemFunctionToolCallOutputResource)} does not support writing '{options.Format}' format.");
            }
        }
