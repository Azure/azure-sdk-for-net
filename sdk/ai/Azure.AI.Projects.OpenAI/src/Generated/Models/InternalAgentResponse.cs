...
namespace OpenAI
{
    internal partial class InternalAgentResponse
    {
        ...
        /// </param>
        /// <param name="promptCacheKey"> Used by OpenAI to cache responses for similar requests to optimize your cache hit rates. Replaces the `user` field. [Learn more](https://platform.openai.com/docs/guides/prompt-caching). </param>
        ...
        /// <summary> Used by OpenAI to cache responses for similar requests to optimize your cache hit rates. Replaces the `user` field. [Learn more](https://platform.openai.com/docs/guides/prompt-caching). </summary>
