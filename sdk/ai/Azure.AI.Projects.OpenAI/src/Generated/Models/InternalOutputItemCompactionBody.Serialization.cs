...
{
    internal partial class InternalOutputItemCompactionBody : AgentResponseItem, IJsonModel<InternalOutputItemCompactionBody>
    {
        /// <summary> Initializes a new instance of <see cref="InternalOutputItemCompactionBody"/> for deserialization. </summary>
        internal InternalOutputItemCompactionBody()
        {
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalOutputItemCompactionBody)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InternalOutputItemCompactionBody>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemCompactionBody)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InternalOutputItemCompactionBody IJsonModel<InternalOutputItemCompactionBody>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InternalOutputItemCompactionBody)JsonModelCreateCore(ref reader, options);
        ...
        protected override AgentResponseItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemCompactionBody)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InternalOutputItemCompactionBody DeserializeInternalOutputItemCompactionBody(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalOutputItemCompactionBody(
                @type,
                id,
                agentReference,
                responseId,
