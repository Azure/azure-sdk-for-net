...
namespace Azure.AI.Projects.OpenAI
{
    ...
    public partial class SharepointGroundingToolCallOutput : AgentResponseItem
    {
        ...
        internal SharepointGroundingToolCallOutput(string callId, ToolCallStatus status) : base(AgentResponseItemKind.SharepointGroundingPreviewCallOutput)
        {
            CallId = callId;
            Status = status;
        }
        ...
        /// <param name="status"> The status of the tool call. </param>
        internal SharepointGroundingToolCallOutput(AgentResponseItemKind @type, string id, AgentReference agentReference, string responseId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string callId, BinaryData output, ToolCallStatus status) : base(@type, id, agentReference, responseId, additionalBinaryDataProperties)
        {
            CallId = callId;
            Output = output;
            Status = status;
