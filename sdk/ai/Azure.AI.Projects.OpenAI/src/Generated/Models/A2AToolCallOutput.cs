...
namespace Azure.AI.Projects.OpenAI
{
    ...
    public partial class A2AToolCallOutput : AgentResponseItem
    {
        ...
        internal A2AToolCallOutput(string callId, string name, ToolCallStatus status) : base(AgentResponseItemKind.A2aPreviewCallOutput)
        {
            CallId = callId;
            Name = name;
            Status = status;
