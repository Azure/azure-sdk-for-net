...
namespace Azure.AI.Projects.OpenAI
{
    ...
    public partial class AzureFunctionToolCallOutput : AgentResponseItem
    {
        ...
        internal AzureFunctionToolCallOutput(string callId, string name, ToolCallStatus status) : base(AgentResponseItemKind.AzureFunctionCallOutput)
        {
            CallId = callId;
            Name = name;
            Status = status;
        ...
        /// <summary> The name of the Azure Function that was called. </summary>
