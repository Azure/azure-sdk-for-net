...
{
    internal partial class UnknownInternalToolChoiceParam : InternalToolChoiceParam, IJsonModel<InternalToolChoiceParam>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownInternalToolChoiceParam"/> for deserialization. </summary>
        internal UnknownInternalToolChoiceParam()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownInternalToolChoiceParam DeserializeUnknownInternalToolChoiceParam(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownInternalToolChoiceParam(@type, additionalBinaryDataProperties);
        }
    }
}
