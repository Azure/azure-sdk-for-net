...
namespace Azure.AI.Projects.OpenAI
{
    internal partial class InternalOutputItemCompactionBody : AgentResponseItem
    {
        ...
        /// <param name="encryptedContent"> The encrypted content that was produced by compaction. </param>
        internal InternalOutputItemCompactionBody(AgentResponseItemKind @type, string id, AgentReference agentReference, string responseId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string encryptedContent) : base(@type, id, agentReference, responseId, additionalBinaryDataProperties)
        {
            EncryptedContent = encryptedContent;
        }
