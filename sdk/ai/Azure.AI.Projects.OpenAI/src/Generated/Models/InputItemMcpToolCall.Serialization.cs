...
namespace OpenAI
{
    ...
    internal partial class InputItemMcpToolCall : InputItem, IJsonModel<InputItemMcpToolCall>
    {
        /// <summary> Initializes a new instance of <see cref="InputItemMcpToolCall"/> for deserialization. </summary>
        internal InputItemMcpToolCall()
        {
        }
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InputItemMcpToolCall>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputItemMcpToolCall)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InputItemMcpToolCall IJsonModel<InputItemMcpToolCall>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InputItemMcpToolCall)JsonModelCreateCore(ref reader, options);
        ...
        protected override InputItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputItemMcpToolCall)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeInputItemMcpToolCall(document.RootElement, options);
        }

        /// <param name="element"> The JSON element to deserialize. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InputItemMcpToolCall DeserializeInputItemMcpToolCall(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InputItemMcpToolCall)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override InputItem PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InputItemMcpToolCall)} does not support reading '{options.Format}' format.");
            }
        }
