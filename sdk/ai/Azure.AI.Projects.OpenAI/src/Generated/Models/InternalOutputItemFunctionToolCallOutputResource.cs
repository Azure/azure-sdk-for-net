...
{
    internal partial class InternalOutputItemFunctionToolCallOutputResource : AgentResponseItem
    {
        /// <summary> Initializes a new instance of <see cref="InternalOutputItemFunctionToolCallOutputResource"/>. </summary>
        /// <param name="callId"> The unique ID of the function tool call generated by the model. </param>
        /// <param name="output">
        /// The output from the function call generated by your code.
        ///   Can be a string or an list of output content.
        /// </param>
        internal InternalOutputItemFunctionToolCallOutputResource(string callId, BinaryData output) : base(AgentResponseItemKind.FunctionCallOutput)
        {
            CallId = callId;
            Output = output;
        }
