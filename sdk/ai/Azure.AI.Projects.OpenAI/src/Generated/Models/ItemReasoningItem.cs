...
namespace Azure.AI.Projects.OpenAI
{
    ...
    internal partial class ItemReasoningItem : Item
    {
        ...
        public ItemReasoningItem(string id, IEnumerable<InternalSummaryTextObject> summary) : base(ItemType.Reasoning)
        {
        ...
        /// </param>
        internal ItemReasoningItem(ItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string encryptedContent, IList<InternalSummaryTextObject> summary, IList<ReasoningTextContent> content, OutputItemReasoningItemStatus? status) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
