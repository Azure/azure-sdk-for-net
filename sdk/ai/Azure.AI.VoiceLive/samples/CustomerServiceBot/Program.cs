...
public class Program
{
    ...
    private static RootCommand CreateRootCommand()
    {
        ...
        rootCommand.SetHandler(async (
            ...
            bool verbose) =>
        {
            await RunCustomerServiceBotAsync(apiKey, endpoint, model, voice, instructions, useTokenCredential, verbose);
        },
        apiKeyOption,
        endpointOption,
        modelOption,
...
public static class VoiceLiveExtensions
{
    ...
    public static string[] GetCustomerServiceCategories()
    {
        return new[]
        {
            "technical",
    ...
    public static string[] GetUrgencyLevels()
    {
        return new[]
        {
            "low",
