...
public class CustomerServiceFunctions : ICustomerServiceFunctions
{
    ...
    public async Task<object> ExecuteFunctionAsync(string functionName, string argumentsJson, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            {
                "check_order_status" => await CheckOrderStatusAsync(argumentsJson, cancellationToken),
                "get_customer_info" => await GetCustomerInfoAsync(argumentsJson, cancellationToken),
                "schedule_support_call" => await ScheduleSupportCallAsync(argumentsJson, cancellationToken),
                "initiate_return_process" => await InitiateReturnProcessAsync(argumentsJson, cancellationToken),
                "update_shipping_address" => await UpdateShippingAddressAsync(argumentsJson, cancellationToken),
