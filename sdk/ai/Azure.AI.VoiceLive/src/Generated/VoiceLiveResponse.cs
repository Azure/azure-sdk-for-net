...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class VoiceLiveResponse
    {
        ...
        internal VoiceLiveResponse(string id, VoiceLiveResponseObject? @object, VoiceLiveResponseStatus? status, VoiceLiveResponseStatusDetails statusDetails, IReadOnlyList<VoiceLiveConversationResponseItem> output, VoiceLiveResponseUsage usage, string conversationId, BinaryData voice, IReadOnlyList<VoiceLiveResponseModality> modalities, VoiceLiveResponseOutputAudioFormat? outputAudioFormat, float? temperature, BinaryData maxOutputTokens, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            Status = status;
        ...
        public VoiceLiveResponseStatusDetails StatusDetails { get; }
        /// <summary>
        /// The list of output items generated by the response.
        /// Please note <see cref="VoiceLiveConversationResponseItem"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="VoiceLiveResponseFunctionCallItem"/>, <see cref="VoiceLiveResponseFunctionCallOutputItem"/> and <see cref="VoiceLiveResponseMessageItem"/>.
        /// </summary>
        public IReadOnlyList<VoiceLiveConversationResponseItem> Output { get; }
        /// <summary>
        /// Usage statistics for the Response, this will correspond to billing. A
        /// VoiceLive API session will maintain a conversation context and append new
        /// Items to the Conversation, thus output from previous turns (text and
        /// audio tokens) will become the input for later turns.
        /// </summary>
        public VoiceLiveResponseUsage Usage { get; }
        /// <summary>
        /// Which conversation the response is added to, determined by the `conversation`
        /// field in the `response.create` event. If `auto`, the response will be added to
        /// the default conversation and the value of `conversation_id` will be an id like
        ...
        /// could be responding in either text or audio.
        /// </summary>
        public IReadOnlyList<VoiceLiveResponseModality> Modalities { get; }
        /// <summary> The format of output audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`. </summary>
        public VoiceLiveResponseOutputAudioFormat? OutputAudioFormat { get; }
