...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class VoiceLiveAnimation
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceLiveAnimation"/>. </summary>
        public VoiceLiveAnimation()
        {
            Outputs = new ChangeTrackingList<VoiceLiveAnimationOutputType>();
        }
        ...
        internal VoiceLiveAnimation(string modelName, IList<VoiceLiveAnimationOutputType> outputs, int? emotionDetectionIntervalMs, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ModelName = modelName;
            Outputs = outputs;
        ...
        public IList<VoiceLiveAnimationOutputType> Outputs { get; }
