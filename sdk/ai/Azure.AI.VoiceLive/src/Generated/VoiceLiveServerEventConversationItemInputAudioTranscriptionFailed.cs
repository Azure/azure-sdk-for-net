...
namespace Azure.AI.VoiceLive
{
    ...
    /// </summary>
    public partial class VoiceLiveServerEventConversationItemInputAudioTranscriptionFailed : VoiceLiveServerEvent
    {
        /// <summary> Initializes a new instance of <see cref="VoiceLiveServerEventConversationItemInputAudioTranscriptionFailed"/>. </summary>
        ...
        internal VoiceLiveServerEventConversationItemInputAudioTranscriptionFailed(string itemId, int contentIndex, ErrorDetails error)
        {
            ...
            Type = VoiceLiveServerEventType.ConversationItemInputAudioTranscriptionFailed;
            ItemId = itemId;
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceLiveServerEventConversationItemInputAudioTranscriptionFailed"/> for deserialization. </summary>
        internal VoiceLiveServerEventConversationItemInputAudioTranscriptionFailed()
        {
        }
