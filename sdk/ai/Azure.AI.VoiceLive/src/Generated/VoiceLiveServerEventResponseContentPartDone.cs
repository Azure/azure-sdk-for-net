...
namespace Azure.AI.VoiceLive
{
    ...
    /// </summary>
    public partial class VoiceLiveServerEventResponseContentPartDone : VoiceLiveServerEvent
    {
        /// <summary> Initializes a new instance of <see cref="VoiceLiveServerEventResponseContentPartDone"/>. </summary>
        ...
        internal VoiceLiveServerEventResponseContentPartDone(string responseId, string itemId, int outputIndex, int contentIndex, VoiceLiveContentPart part)
        {
            Argument.AssertNotNull(responseId, nameof(responseId));
            Argument.AssertNotNull(itemId, nameof(itemId));
            Argument.AssertNotNull(part, nameof(part));

            Type = VoiceLiveServerEventType.ResponseContentPartDone;
        ...
        /// The available derived classes include <see cref="VoiceLiveResponseAudioContentPart"/>, <see cref="VoiceLiveRequestAudioContentPart"/>, <see cref="VoiceLiveRequestTextContentPart"/> and <see cref="VoiceLiveResponseTextContentPart"/>.
        /// </param>
        internal VoiceLiveServerEventResponseContentPartDone(VoiceLiveServerEventType type, string eventId, IDictionary<string, BinaryData> serializedAdditionalRawData, string responseId, string itemId, int outputIndex, int contentIndex, VoiceLiveContentPart part) : base(type, eventId, serializedAdditionalRawData)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceLiveServerEventResponseContentPartDone"/> for deserialization. </summary>
        internal VoiceLiveServerEventResponseContentPartDone()
        {
        }
