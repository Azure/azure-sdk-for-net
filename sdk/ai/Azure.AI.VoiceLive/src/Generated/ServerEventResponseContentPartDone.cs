...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseContentPartDone : ServerEvent
    {
        ...
        internal ServerEventResponseContentPartDone(string responseId, string itemId, int outputIndex, int contentIndex, ContentPart part) : base("response.content_part.done")
        {
        ...
        /// <param name="contentIndex"> The index of the content part in the item's content array. </param>
        /// <param name="part"> The content part that is done. </param>
        internal ServerEventResponseContentPartDone(string @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, string itemId, int outputIndex, int contentIndex, ContentPart part) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
