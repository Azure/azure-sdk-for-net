...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class RequestAssistantMessageItem : RequestMessageItem
    {
        ...
        internal RequestAssistantMessageItem(IEnumerable<RequestTextContentPart> content)
        {
        ...
        /// <param name="content"></param>
        internal RequestAssistantMessageItem(ItemType type, string id, IDictionary<string, BinaryData> serializedAdditionalRawData, MessageRole role, ItemStatus? status, IReadOnlyList<RequestTextContentPart> content) : base(type, id, serializedAdditionalRawData, role, status)
        {
            Content = content;
        }
