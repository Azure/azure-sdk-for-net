...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class VoiceLiveConversationItemWithReference
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceLiveConversationItemWithReference"/>. </summary>
        internal VoiceLiveConversationItemWithReference()
        {
        ...
        internal VoiceLiveConversationItemWithReference(string id, VoiceLiveConversationItemWithReferenceType? type, VoiceLiveConversationItemWithReferenceObject? @object, VoiceLiveConversationItemWithReferenceStatus? status, VoiceLiveConversationItemWithReferenceRole? role, IReadOnlyList<VoiceLiveConversationItemWithReferenceContent> content, string callId, string name, string arguments, string output, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Type = type;
            Object = @object;
        ...
        public VoiceLiveConversationItemWithReferenceType? Type { get; }
        /// <summary> Identifier for the API object being returned - always `realtime.item`. </summary>
        public VoiceLiveConversationItemWithReferenceObject? Object { get; }
        /// <summary>
        /// The status of the item (`completed`, `incomplete`). These have no effect
        /// on the conversation, but are accepted for consistency with the
        /// `conversation.item.created` event.
        /// </summary>
        public VoiceLiveConversationItemWithReferenceStatus? Status { get; }
        /// <summary>
        /// The role of the message sender (`user`, `assistant`, `system`), only
        /// applicable for `message` items.
        /// </summary>
        public VoiceLiveConversationItemWithReferenceRole? Role { get; }
        /// <summary>
        /// The content of the message, applicable for `message` items.
        /// - Message items of role `system` support only `input_text` content
        /// - Message items of role `user` support `input_text` and `input_audio`
        ...
        /// - Message items of role `assistant` support `text` content.
        /// </summary>
        public IReadOnlyList<VoiceLiveConversationItemWithReferenceContent> Content { get; }
        /// <summary>
        /// The ID of the function call (for `function_call` and
        /// `function_call_output` items). If passed on a `function_call_output`
        /// item, the server will check that a `function_call` item with the same
