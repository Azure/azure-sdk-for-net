...
namespace Azure.AI.VoiceLive
{
    ...
    public abstract partial class ResponseStatusDetails
    {
        ...
        private protected ResponseStatusDetails(VoiceLiveResponseStatus @type)
        {
            Type = @type;
        }
        ...
        internal ResponseStatusDetails(VoiceLiveResponseStatus @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
        ...
        internal VoiceLiveResponseStatus Type { get; set; }
    }
}
