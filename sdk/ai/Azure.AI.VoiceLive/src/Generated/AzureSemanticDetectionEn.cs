...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class AzureSemanticDetectionEn : EouDetection
    {
        ...
        internal AzureSemanticDetectionEn(EOUDetectionModel model, IDictionary<string, BinaryData> additionalBinaryDataProperties, float? threshold, float? timeoutMs, float? secondaryThreshold, float? secondaryTimeoutMs, bool? disableRules, float? srBoost, bool? extraImendCheck) : base(model, additionalBinaryDataProperties)
        {
            Threshold = threshold;
            TimeoutMs = timeoutMs;
