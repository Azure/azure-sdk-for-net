...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class AzurePlatformVoice : IJsonModel<AzurePlatformVoice>
    {
        /// <summary> Initializes a new instance of <see cref="AzurePlatformVoice"/> for deserialization. </summary>
        internal AzurePlatformVoice()
        {
        }

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<AzurePlatformVoice>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzurePlatformVoice)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzurePlatformVoice IJsonModel<AzurePlatformVoice>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzurePlatformVoice)JsonModelCreateCore(ref reader, options);
        ...
        protected override object JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzurePlatformVoice)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeAzurePlatformVoice(document.RootElement, options);
        }

        /// <param name="element"> The JSON element to deserialize. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzurePlatformVoice DeserializeAzurePlatformVoice(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string @type = "azure-platform";
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzurePlatformVoice>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzurePlatformVoice)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzurePlatformVoice IPersistableModel<AzurePlatformVoice>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzurePlatformVoice)PersistableModelCreateCore(data, options);
        ...
        protected override object PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzurePlatformVoice)} does not support reading '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<AzurePlatformVoice>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
