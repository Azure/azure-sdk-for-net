...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class SessionUpdateResponseAnimationVisemeDone : SessionUpdate, IJsonModel<SessionUpdateResponseAnimationVisemeDone>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SessionUpdateResponseAnimationVisemeDone>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeSessionUpdateResponseAnimationVisemeDone(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(SessionUpdateResponseAnimationVisemeDone)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SessionUpdateResponseAnimationVisemeDone)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SessionUpdateResponseAnimationVisemeDone IJsonModel<SessionUpdateResponseAnimationVisemeDone>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SessionUpdateResponseAnimationVisemeDone)JsonModelCreateCore(ref reader, options);
        ...
        protected override SessionUpdate JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SessionUpdateResponseAnimationVisemeDone)} does not support reading '{format}' format.");
            }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SessionUpdateResponseAnimationVisemeDone)} does not support writing '{options.Format}' format.");
            }
        }
