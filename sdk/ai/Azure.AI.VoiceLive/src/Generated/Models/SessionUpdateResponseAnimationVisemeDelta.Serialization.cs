    ...
    public partial class SessionUpdateResponseAnimationVisemeDelta : SessionUpdate, IJsonModel<SessionUpdateResponseAnimationVisemeDelta>
    {
        ...
        protected override SessionUpdate PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SessionUpdateResponseAnimationVisemeDelta)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SessionUpdateResponseAnimationVisemeDelta)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<SessionUpdateResponseAnimationVisemeDelta>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SessionUpdateResponseAnimationVisemeDelta IJsonModel<SessionUpdateResponseAnimationVisemeDelta>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SessionUpdateResponseAnimationVisemeDelta)JsonModelCreateCore(ref reader, options);
        ...
        protected override SessionUpdate JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SessionUpdateResponseAnimationVisemeDelta)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SessionUpdateResponseAnimationVisemeDelta DeserializeSessionUpdateResponseAnimationVisemeDelta(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SessionUpdateResponseAnimationVisemeDelta IPersistableModel<SessionUpdateResponseAnimationVisemeDelta>.Create(BinaryData data, ModelReaderWriterOptions options) => (SessionUpdateResponseAnimationVisemeDelta)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SessionUpdateResponseAnimationVisemeDelta>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
