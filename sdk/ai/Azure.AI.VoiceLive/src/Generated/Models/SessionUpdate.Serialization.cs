            ...
            if (element.TryGetProperty("type"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "response.foundry_agent_call_arguments.delta":
                        return SessionUpdateResponseFoundryAgentCallArgumentsDelta.DeserializeSessionUpdateResponseFoundryAgentCallArgumentsDelta(element, options);
                    case "response.foundry_agent_call_arguments.done":
                        return SessionUpdateResponseFoundryAgentCallArgumentsDone.DeserializeSessionUpdateResponseFoundryAgentCallArgumentsDone(element, options);
                    case "response.foundry_agent_call.in_progress":
                        return SessionUpdateResponseFoundryAgentCallInProgress.DeserializeSessionUpdateResponseFoundryAgentCallInProgress(element, options);
                    case "response.foundry_agent_call.completed":
                        return SessionUpdateResponseFoundryAgentCallCompleted.DeserializeSessionUpdateResponseFoundryAgentCallCompleted(element, options);
                    case "response.foundry_agent_call.failed":
                        return SessionUpdateResponseFoundryAgentCallFailed.DeserializeSessionUpdateResponseFoundryAgentCallFailed(element, options);
                }
            }
