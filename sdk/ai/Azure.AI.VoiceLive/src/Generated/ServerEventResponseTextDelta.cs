...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseTextDelta : ServerEvent
    {
        ...
        internal ServerEventResponseTextDelta(string responseId, string itemId, int outputIndex, int contentIndex, string delta)
        {
        ...
        /// <param name="contentIndex"> The index of the content part in the item's content array. </param>
        /// <param name="delta"> The text delta. </param>
        internal ServerEventResponseTextDelta(ServerEventType type, string eventId, IDictionary<string, BinaryData> serializedAdditionalRawData, string responseId, string itemId, int outputIndex, int contentIndex, string delta) : base(type, eventId, serializedAdditionalRawData)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
