...
{
    internal partial class UnknownServerEvent : IJsonModel<ServerEvent>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownServerEvent DeserializeUnknownServerEvent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownServerEvent(@type, eventId, additionalBinaryDataProperties);
        }
