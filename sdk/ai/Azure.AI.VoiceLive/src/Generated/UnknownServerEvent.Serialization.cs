...
{
    internal partial class UnknownServerEvent : IUtf8JsonSerializable, IJsonModel<ServerEvent>
    {
        ...
        internal static UnknownServerEvent DeserializeUnknownServerEvent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownServerEvent(type, eventId, serializedAdditionalRawData);
        }
        ...
        internal static new UnknownServerEvent FromResponse(Azure.Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeUnknownServerEvent(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ServerEvent>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
