...
{
    /// <summary> The VoiceLiveResponseSession. </summary>
    public partial class VoiceLiveResponseSession
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceLiveResponseSession"/>. </summary>
        internal VoiceLiveResponseSession()
        {
        ...
        internal VoiceLiveResponseSession(string id, string model, IReadOnlyList<VoiceLiveModality> modalities, string instructions, VoiceLiveAnimation animation, BinaryData voice, VoiceLiveInputAudio inputAudio, VoiceLiveAudioFormat? inputAudioFormat, VoiceLiveAudioFormat? outputAudioFormat, int? inputAudioSamplingRate, VoiceLiveTurnDetection turnDetection, VoiceLiveAudioNoiseReduction inputAudioNoiseReduction, VoiceLiveAudioEchoCancellation inputAudioEchoCancellation, VoiceLiveAvatarConfig avatar, VoiceLiveAudioInputTranscriptionSettings inputAudioTranscription, IReadOnlyList<VoiceLiveAudioTimestampType> outputAudioTimestampTypes, IReadOnlyList<VoiceLiveTool> tools, BinaryData toolChoice, float? temperature, BinaryData maxResponseOutputTokens, AgentConfig agent, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Model = model;
        ...
        public VoiceLiveAnimation Animation { get; }
        /// <summary>
        /// Gets the voice
        /// <para>
        ...
        public VoiceLiveInputAudio InputAudio { get; }
        /// <summary> Gets the input audio format. </summary>
        public VoiceLiveAudioFormat? InputAudioFormat { get; }
        ...
        /// The available derived classes include <see cref="VoiceLiveAzureSemanticVad"/>, <see cref="VoiceLiveNoTurnDetection"/> and <see cref="VoiceLiveServerVad"/>.
        /// </summary>
        public VoiceLiveTurnDetection TurnDetection { get; }
        /// <summary> Gets the input audio noise reduction. </summary>
        public VoiceLiveAudioNoiseReduction InputAudioNoiseReduction { get; }
        /// <summary> Gets the input audio echo cancellation. </summary>
        public VoiceLiveAudioEchoCancellation InputAudioEchoCancellation { get; }
        /// <summary> Gets the avatar. </summary>
        public VoiceLiveAvatarConfig Avatar { get; }
        /// <summary> Gets the input audio transcription. </summary>
        public VoiceLiveAudioInputTranscriptionSettings InputAudioTranscription { get; }
        /// <summary> Gets the output audio timestamp types. </summary>
        public IReadOnlyList<VoiceLiveAudioTimestampType> OutputAudioTimestampTypes { get; }
        /// <summary>
        /// Gets the tools
        /// Please note <see cref="VoiceLiveTool"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="VoiceLiveFunctionTool"/>.
