...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ConversationItemWithReferenceContent
    {
        ...
        internal ConversationItemWithReferenceContent(ConversationItemWithReferenceContentType? type, string text, string id, string audio, string transcript, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            Text = text;
            Id = id;
