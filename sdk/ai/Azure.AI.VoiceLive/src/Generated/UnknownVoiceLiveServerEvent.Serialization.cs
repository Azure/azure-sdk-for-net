...
{
    internal partial class UnknownVoiceLiveServerEvent : IUtf8JsonSerializable, IJsonModel<VoiceLiveServerEvent>
    {
        ...
        internal static UnknownVoiceLiveServerEvent DeserializeUnknownVoiceLiveServerEvent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            VoiceLiveServerEventType type = "Unknown";
            ...
            return new UnknownVoiceLiveServerEvent(type, eventId, serializedAdditionalRawData);
        }
        ...
        internal static new UnknownVoiceLiveServerEvent FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeUnknownVoiceLiveServerEvent(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<VoiceLiveServerEvent>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
