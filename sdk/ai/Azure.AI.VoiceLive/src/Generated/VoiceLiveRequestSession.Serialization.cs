...
{
    public partial class VoiceLiveRequestSession : IUtf8JsonSerializable, IJsonModel<VoiceLiveRequestSession>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VoiceLiveRequestSession>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<VoiceLiveRequestSession>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<VoiceLiveRequestSession>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceLiveRequestSession)} does not support writing '{format}' format.");
            }
        ...
        VoiceLiveRequestSession IJsonModel<VoiceLiveRequestSession>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VoiceLiveRequestSession>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceLiveRequestSession)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeVoiceLiveRequestSession(document.RootElement, options);
        }

        internal static VoiceLiveRequestSession DeserializeVoiceLiveRequestSession(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<VoiceLiveModality> modalities = default;
            ...
            IList<VoiceLiveAudioTimestampType> outputAudioTimestampTypes = default;
            IList<VoiceLiveTool> tools = default;
            ...
            return new VoiceLiveRequestSession(
                model,
        ...
        BinaryData IPersistableModel<VoiceLiveRequestSession>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VoiceLiveRequestSession>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceLiveRequestSession)} does not support writing '{options.Format}' format.");
            }
        }

        VoiceLiveRequestSession IPersistableModel<VoiceLiveRequestSession>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VoiceLiveRequestSession>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceLiveRequestSession)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<VoiceLiveRequestSession>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static VoiceLiveRequestSession FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeVoiceLiveRequestSession(document.RootElement);
        }
