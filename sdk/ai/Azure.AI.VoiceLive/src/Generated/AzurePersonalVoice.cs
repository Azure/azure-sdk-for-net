...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class AzurePersonalVoice : AzureVoice
    {
        ...
        public AzurePersonalVoice(string name, PersonalVoiceModels model) : base("azure-personal")
        {
        ...
        /// <param name="model"> Underlying neural model to use for personal voice. </param>
        internal AzurePersonalVoice(string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, float? temperature, PersonalVoiceModels model) : base(@type, additionalBinaryDataProperties)
        {
            Name = name;
