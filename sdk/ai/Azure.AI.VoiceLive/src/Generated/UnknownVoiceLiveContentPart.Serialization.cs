...
namespace Azure.AI.VoiceLive
{
    internal partial class UnknownVoiceLiveContentPart : VoiceLiveContentPart, IJsonModel<VoiceLiveContentPart>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownVoiceLiveContentPart DeserializeUnknownVoiceLiveContentPart(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownVoiceLiveContentPart(@type, additionalBinaryDataProperties);
        }
