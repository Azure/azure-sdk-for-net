...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class VoiceLiveResponseCreateParams
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceLiveResponseCreateParams"/>. </summary>
        internal VoiceLiveResponseCreateParams()
        {
        ...
        /// Please note <see cref="VoiceLiveConversationRequestItem"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="VoiceLiveRequestAssistantMessageItem"/>, <see cref="VoiceLiveRequestFunctionCallItem"/>, <see cref="VoiceLiveRequestFunctionCallOutputItem"/>, <see cref="VoiceLiveRequestMessageItem"/>, <see cref="VoiceLiveRequestSystemMessageItem"/> and <see cref="VoiceLiveRequestUserMessageItem"/>.
        /// </param>
        ...
        internal VoiceLiveResponseCreateParams(bool? commit, bool? cancelPrevious, IReadOnlyList<VoiceLiveConversationRequestItem> appendInputItems, IReadOnlyList<VoiceLiveConversationRequestItem> inputItems, IReadOnlyList<VoiceLiveModality> modalities, string instructions, BinaryData voice, VoiceLiveAudioFormat? outputAudioFormat, IReadOnlyList<VoiceLiveTool> tools, string toolChoice, float? temperature, BinaryData maxOutputTokens, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Commit = commit;
        ...
        /// The available derived classes include <see cref="VoiceLiveRequestAssistantMessageItem"/>, <see cref="VoiceLiveRequestFunctionCallItem"/>, <see cref="VoiceLiveRequestFunctionCallOutputItem"/>, <see cref="VoiceLiveRequestMessageItem"/>, <see cref="VoiceLiveRequestSystemMessageItem"/> and <see cref="VoiceLiveRequestUserMessageItem"/>.
        /// </summary>
        public IReadOnlyList<VoiceLiveConversationRequestItem> AppendInputItems { get; }
        /// <summary>
        /// Input items to be used as the context for this response.
        /// An empty array clears previous context.
        /// Please note <see cref="VoiceLiveConversationRequestItem"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="VoiceLiveRequestAssistantMessageItem"/>, <see cref="VoiceLiveRequestFunctionCallItem"/>, <see cref="VoiceLiveRequestFunctionCallOutputItem"/>, <see cref="VoiceLiveRequestMessageItem"/>, <see cref="VoiceLiveRequestSystemMessageItem"/> and <see cref="VoiceLiveRequestUserMessageItem"/>.
        /// </summary>
        public IReadOnlyList<VoiceLiveConversationRequestItem> InputItems { get; }
        /// <summary>
        /// The set of modalities the model can respond with. To disable audio,
        /// set this to ["text"].
        /// </summary>
        public IReadOnlyList<VoiceLiveModality> Modalities { get; }
        /// <summary>
        /// The default system instructions (i.e. system message) prepended to model
        /// calls. This field allows the client to guide the model on desired
        /// responses. The model can be instructed on response content and format,
        ...
        public VoiceLiveAudioFormat? OutputAudioFormat { get; }
        /// <summary>
        /// Tools (functions) available to the model.
        /// Please note <see cref="VoiceLiveTool"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        /// The available derived classes include <see cref="VoiceLiveFunctionTool"/>.
        /// </summary>
        public IReadOnlyList<VoiceLiveTool> Tools { get; }
        /// <summary>
        /// How the model chooses tools. Options are `auto`, `none`, `required`, or
        /// specify a function, like `{"type": "function", "function": {"name": "my_function"}}`.
        /// </summary>
