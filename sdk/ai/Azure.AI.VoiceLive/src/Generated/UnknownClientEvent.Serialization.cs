...
{
    internal partial class UnknownClientEvent : IUtf8JsonSerializable, IJsonModel<ClientEvent>
    {
        ...
        internal static UnknownClientEvent DeserializeUnknownClientEvent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownClientEvent(type, eventId, serializedAdditionalRawData);
        }
        ...
        internal static new UnknownClientEvent FromResponse(Azure.Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeUnknownClientEvent(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ClientEvent>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
