...
{
    internal partial class ForceModelsRequest : IUtf8JsonSerializable, IJsonModel<ForceModelsRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ForceModelsRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ForceModelsRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ForceModelsRequest IJsonModel<ForceModelsRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ForceModelsRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ForceModelsRequest DeserializeForceModelsRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        ForceModelsRequest IPersistableModel<ForceModelsRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ForceModelsRequest>)this).GetFormatFromOptions(options) : options.Format;
