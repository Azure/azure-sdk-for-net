...
namespace Azure.AI.VoiceLive
{
    ...
    /// </summary>
    public abstract partial class VoiceLiveTurnDetection
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="VoiceLiveTurnDetection"/>. </summary>
        protected VoiceLiveTurnDetection()
        {
        }
        ...
        internal VoiceLiveTurnDetection(VoiceLiveTurnDetectionType type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
        ...
        internal VoiceLiveTurnDetectionType Type { get; set; }
    }
}
