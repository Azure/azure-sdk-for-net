...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseAudioDone : ServerEvent
    {
        ...
        internal ServerEventResponseAudioDone(string responseId, string itemId, int outputIndex, int contentIndex)
        {
        ...
        /// <param name="outputIndex"> The index of the output item in the response. </param>
        /// <param name="contentIndex"> The index of the content part in the item's content array. </param>
        internal ServerEventResponseAudioDone(ServerEventType type, string eventId, IDictionary<string, BinaryData> serializedAdditionalRawData, string responseId, string itemId, int outputIndex, int contentIndex) : base(type, eventId, serializedAdditionalRawData)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
