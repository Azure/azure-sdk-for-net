...
namespace Azure.AI.Inference
{
    ...
    public partial class EmbeddingsClient
    {
        ...
        public virtual async Task<Response<EmbeddingsResult>> EmbedAsync(IEnumerable<string> input, int? dimensions = null, EmbeddingEncodingFormat? encodingFormat = null, EmbeddingInputType? inputType = null, UnknownParams? unknownParams = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(input, nameof(input));

            EmbedRequest embedRequest = new EmbedRequest(input.ToList(), dimensions, encodingFormat, inputType, null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await EmbedAsync(embedRequest.ToRequestContent(), unknownParams?.ToString(), context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="input"/> is null. </exception>
        public virtual Response<EmbeddingsResult> Embed(IEnumerable<string> input, int? dimensions = null, EmbeddingEncodingFormat? encodingFormat = null, EmbeddingInputType? inputType = null, UnknownParams? unknownParams = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(input, nameof(input));

            EmbedRequest embedRequest = new EmbedRequest(input.ToList(), dimensions, encodingFormat, inputType, null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = Embed(embedRequest.ToRequestContent(), unknownParams?.ToString(), context);
            return Response.FromValue(EmbeddingsResult.FromResponse(response), response);
        }
        ...
        internal virtual async Task<Response> EmbedAsync(RequestContent content, string unknownParams = null, RequestContext context = null)
        {
            ...
            try
            {
                using HttpMessage message = CreateEmbedRequest(content, unknownParams, context);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        internal virtual Response Embed(RequestContent content, string unknownParams = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateEmbedRequest(RequestContent content, string unknownParams, RequestContext context)
        {
