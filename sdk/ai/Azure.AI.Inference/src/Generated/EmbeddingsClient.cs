...
namespace Azure.AI.Inference
{
    ...
    public partial class EmbeddingsClient
    {
        ...
        public EmbeddingsClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new AIModelClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EmbeddingsClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new AIModelClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EmbeddingsClient(Uri endpoint, AzureKeyCredential credential, AIModelClientOptions options)
        {
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public EmbeddingsClient(Uri endpoint, TokenCredential credential, AIModelClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new AIModelClientOptions();
