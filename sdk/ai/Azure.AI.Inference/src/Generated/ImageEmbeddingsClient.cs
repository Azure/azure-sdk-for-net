...
namespace Azure.AI.Inference
{
    ...
    public partial class ImageEmbeddingsClient
    {
        ...
        public virtual async Task<Response<EmbeddingsResult>> EmbedImageAsync(IEnumerable<EmbeddingInput> input, int? dimensions = null, EmbeddingEncodingFormat? encodingFormat = null, EmbeddingInputType? inputType = null, UnknownParams? unknownParams = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(input, nameof(input));

            EmbedImageRequest embedImageRequest = new EmbedImageRequest(input.ToList(), dimensions, encodingFormat, inputType, null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await EmbedImageAsync(embedImageRequest.ToRequestContent(), unknownParams?.ToString(), context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="input"/> is null. </exception>
        public virtual Response<EmbeddingsResult> EmbedImage(IEnumerable<EmbeddingInput> input, int? dimensions = null, EmbeddingEncodingFormat? encodingFormat = null, EmbeddingInputType? inputType = null, UnknownParams? unknownParams = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(input, nameof(input));

            EmbedImageRequest embedImageRequest = new EmbedImageRequest(input.ToList(), dimensions, encodingFormat, inputType, null);
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = EmbedImage(embedImageRequest.ToRequestContent(), unknownParams?.ToString(), context);
            return Response.FromValue(EmbeddingsResult.FromResponse(response), response);
        }
        ...
        internal virtual async Task<Response> EmbedImageAsync(RequestContent content, string unknownParams = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("ImageEmbeddingsClient.EmbedImage");
            scope.Start();
            try
            {
                using HttpMessage message = CreateEmbedImageRequest(content, unknownParams, context);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        internal virtual Response EmbedImage(RequestContent content, string unknownParams = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateEmbedImageRequest(RequestContent content, string unknownParams, RequestContext context)
        {
