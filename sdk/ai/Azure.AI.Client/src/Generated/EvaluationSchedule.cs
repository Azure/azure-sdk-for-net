...
namespace Azure.AI.Client
{
    ...
    public partial class EvaluationSchedule
    {
        ...
        /// Please note <see cref="Client.Trigger"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
