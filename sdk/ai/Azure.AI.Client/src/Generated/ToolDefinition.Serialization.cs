        ...
        internal static ToolDefinition DeserializeToolDefinition(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("type", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "bing_search": return BingSearchToolDefinition.DeserializeBingSearchToolDefinition(element, options);
                    ...
                    case "sharepoint": return SharepointToolDefinition.DeserializeSharepointToolDefinition(element, options);
                }
            }
