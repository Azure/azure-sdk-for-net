...
{
    public partial class AgentThreadCreationOptions : IUtf8JsonSerializable, IJsonModel<AgentThreadCreationOptions>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentThreadCreationOptions>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AgentThreadCreationOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentThreadCreationOptions>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AgentThreadCreationOptions IJsonModel<AgentThreadCreationOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentThreadCreationOptions>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AgentThreadCreationOptions DeserializeAgentThreadCreationOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AgentThreadCreationOptions(messages ?? new ChangeTrackingList<ThreadMessageOptions>(), toolResources, metadata ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<AgentThreadCreationOptions>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentThreadCreationOptions>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AgentThreadCreationOptions IPersistableModel<AgentThreadCreationOptions>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentThreadCreationOptions>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AgentThreadCreationOptions>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
