...
namespace Azure.AI.Client.Models
{
    ...
    internal partial class CredentialsSASAuth
    {
        ...
        {
            Argument.AssertNotNull(sas, nameof(sas));
        ...
        /// <summary> Initializes a new instance of <see cref="CredentialsSASAuth"/> for deserialization. </summary>
        internal CredentialsSASAuth()
        {
        }
