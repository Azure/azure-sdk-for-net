...
namespace Azure.AI.Client.Models
{
    ...
    public partial class AgentThread
    {
        ...
        internal AgentThread(string id, AgentThreadObject @object, DateTimeOffset createdAt, ToolResources toolResources, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            CreatedAt = createdAt;
