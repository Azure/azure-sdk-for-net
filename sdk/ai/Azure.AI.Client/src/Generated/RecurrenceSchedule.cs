...
{
    /// <summary> RecurrenceSchedule Definition. </summary>
    public partial class RecurrenceSchedule
    {
        ...
        internal RecurrenceSchedule(IList<int> hours, IList<int> minutes, IList<WeekDays> weekDays, IList<int> monthDays, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Hours = hours;
            Minutes = minutes;
            WeekDays = weekDays;
        ...
        /// <summary> List of hours for the schedule. </summary>
        public IList<int> Hours { get; }
        /// <summary> List of minutes for the schedule. </summary>
        public IList<int> Minutes { get; }
        /// <summary> List of days for the schedule. </summary>
        public IList<WeekDays> WeekDays { get; }
