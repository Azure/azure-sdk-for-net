...
namespace Azure.AI.Client
{
    ...
    public partial class AgentThread
    {
        ...
        internal AgentThread(string id, DateTimeOffset createdAt, ToolResources toolResources, IReadOnlyDictionary<string, string> metadata)
        {
        ...
        internal AgentThread(string id, string @object, DateTimeOffset createdAt, ToolResources toolResources, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            CreatedAt = createdAt;
        ...
        /// <summary> Initializes a new instance of <see cref="AgentThread"/> for deserialization. </summary>
