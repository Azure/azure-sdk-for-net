...
{
    public partial class AgentMessage : IUtf8JsonSerializable, IJsonModel<AgentMessage>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentMessage>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentMessage>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        string IPersistableModel<AgentMessage>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
