...
{
    /// <summary> A system message within a chat, always with the 'system' role. </summary>
    public partial class SystemMessage : ChatMessage
    {
        ...
        public SystemMessage(IEnumerable<AIContent> content) : base(content)
        {
            Argument.AssertNotNull(content, nameof(content));

            Role = Projects1DP.AuthorRole?.System;
        }
