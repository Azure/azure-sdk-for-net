...
{
    internal partial class UnknownAIContent : IUtf8JsonSerializable, IJsonModel<AIContent>
    {
        ...
        internal static UnknownAIContent DeserializeUnknownAIContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownAIContent(type, serializedAdditionalRawData);
        }
        ...
        internal static new UnknownAIContent FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeUnknownAIContent(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AIContent>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
