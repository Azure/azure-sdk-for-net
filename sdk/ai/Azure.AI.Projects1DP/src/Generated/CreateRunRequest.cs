...
namespace Azure.AI.Projects1DP
{
    ...
    internal partial class CreateRunRequest
    {
        ...
        internal CreateRunRequest(Agent agent, IEnumerable<ChatMessage> input)
        {
        ...
        internal CreateRunRequest(Agent agent, IReadOnlyList<ChatMessage> input, string threadId, IReadOnlyDictionary<string, string> metadata, RunOptions options, string userId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Agent = agent;
            Input = input;
            ThreadId = threadId;
