...
namespace Azure.AI.Projects1DP
{
    ...
    internal partial class CreateAgentRequest
    {
        ...
        /// Please note <see cref="Projects1DP.AgentModel"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
        ...
        internal CreateAgentRequest(AgentModel agentModel)
        {
