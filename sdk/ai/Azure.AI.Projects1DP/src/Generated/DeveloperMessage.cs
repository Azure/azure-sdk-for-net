...
{
    /// <summary> A developer message within a chat, always with the 'developer' role. </summary>
    public partial class DeveloperMessage : ChatMessage
    {
        ...
        public DeveloperMessage(IEnumerable<AIContent> content) : base(content)
        {
            Argument.AssertNotNull(content, nameof(content));

            Role = Projects1DP.AuthorRole?.Developer;
        }
