...
namespace Azure.AI.Projects1DP
{
    ...
    public partial class RunInputs
    {
        ...
        public RunInputs(Agent agent, IEnumerable<ChatMessage> input)
        {
        ...
        internal RunInputs(Agent agent, IList<ChatMessage> input, string threadId, IDictionary<string, string> metadata, RunOptions options, string userId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Agent = agent;
            Input = input;
            ThreadId = threadId;
