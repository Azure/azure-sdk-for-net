...
namespace Azure.AI.Projects1DP
{
    ...
    public partial class Run
    {
        ...
        internal Run(string agentId, long createdAt, long completedAt, RunInputs runInputs, RunOutputs runOutputs)
        {
        ...
        internal Run(string agentId, string runId, long createdAt, long completedAt, RunInputs runInputs, RunOutputs runOutputs, RunOptions options, string userId, bool? store, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AgentId = agentId;
            RunId = runId;
            CreatedAt = createdAt;
