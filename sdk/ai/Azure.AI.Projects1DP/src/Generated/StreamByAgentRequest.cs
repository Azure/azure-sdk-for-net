...
{
    /// <summary> The StreamByAgentRequest. </summary>
    internal partial class StreamByAgentRequest
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="StreamByAgentRequest"/>. </summary>
        ...
        internal StreamByAgentRequest(Agent agent, IEnumerable<ChatMessage> input)
        {
        ...
        internal StreamByAgentRequest(Agent agent, IReadOnlyList<ChatMessage> input, string threadId, IReadOnlyDictionary<string, string> metadata, RunOptions options, string userId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Agent = agent;
            Input = input;
            ThreadId = threadId;
        ...
        /// <summary> Initializes a new instance of <see cref="StreamByAgentRequest"/> for deserialization. </summary>
        internal StreamByAgentRequest()
        {
        }
