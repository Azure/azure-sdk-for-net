...
namespace Azure.AI.Projects1DP
{
    ...
    public abstract partial class AgentToolOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AgentToolOptions"/>. </summary>
        ...
        internal AgentToolOptions(string type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Discriminates the various child 'tool options' types. </summary>
