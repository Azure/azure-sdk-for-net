...
{
    /// <summary> An agent message within a chat, always with the 'agent' role. </summary>
    public partial class AgentMessage : ChatMessage
    {
        /// <summary> Initializes a new instance of <see cref="AgentMessage"/>. </summary>
        /// <param name="content">
        ...
        public AgentMessage(IEnumerable<AIContent> content) : base(content)
        {
            Argument.AssertNotNull(content, nameof(content));

            Role = Projects1DP.AuthorRole?.Agent;
        }
        ...
        /// <summary> Initializes a new instance of <see cref="AgentMessage"/> for deserialization. </summary>
