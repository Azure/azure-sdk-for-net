...
{
    public partial class FileDatasetVersion : IUtf8JsonSerializable, IJsonModel<FileDatasetVersion>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileDatasetVersion>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FileDatasetVersion>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static FileDatasetVersion DeserializeFileDatasetVersion(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        internal static new FileDatasetVersion FromResponse(Response response)
        {
            ...
            return DeserializeFileDatasetVersion(document.RootElement);
        }
