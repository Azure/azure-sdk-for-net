...
`Azure.AI.Projects` can be used only to create a `ProjectsAgentVersion` object; however hosted Agent represents the running container that exposes the OpenAI-compatible API.
