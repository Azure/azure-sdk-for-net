...
3. Create the Agent using MCP tool.
...
4. Get the response from Agent and approve the call to an MCP server if necessary.
...
5. Delete the Agent, skill and a Toolbox we have created.
