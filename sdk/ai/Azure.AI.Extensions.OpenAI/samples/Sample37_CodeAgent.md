...
## Run the sample
`Azure.AI.Projects` can be used only to create an `ProjectsAgentVersion` object; however hosted Agent represents the running container that exposes the OpenAI-compatible API.
