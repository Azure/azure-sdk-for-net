...
namespace Azure.AI.Extensions.OpenAI
{
    internal partial class InternalOutputItemCodeInterpreterToolCall : AgentResponseItem
    {
        ...
        internal InternalOutputItemCodeInterpreterToolCall(OutputItemCodeInterpreterToolCallStatus status, string containerId, string code, IEnumerable<BinaryData> outputs) : base(AgentResponseItemKind.CodeInterpreterCall)
        {
            Status = status;
