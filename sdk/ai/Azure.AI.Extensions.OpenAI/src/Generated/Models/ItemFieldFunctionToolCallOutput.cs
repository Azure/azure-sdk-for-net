...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class ItemFieldFunctionToolCallOutput : ItemField
    {
        /// <summary> Initializes a new instance of <see cref="ItemFieldFunctionToolCallOutput"/>. </summary>
        /// <param name="callId"> The unique ID of the function tool call generated by the model. </param>
        /// <param name="output">
        /// The output from the function call generated by your code.
        ///   Can be a string or an list of output content.
        /// </param>
        internal ItemFieldFunctionToolCallOutput(string callId, BinaryData output) : base(ItemFieldType.FunctionCallOutput)
        {
            CallId = callId;
            Output = output;
        }
