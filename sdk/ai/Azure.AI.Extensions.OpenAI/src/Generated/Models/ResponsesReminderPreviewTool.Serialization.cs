...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    /// </summary>
    public partial class ResponsesReminderPreviewTool : ResponseTool, IJsonModel<ResponsesReminderPreviewTool>
    {
        ...
        internal static ResponsesReminderPreviewTool DeserializeResponsesReminderPreviewTool(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ResponseToolKind @type = "reminder_preview";
            string name = default;
            ...
            return new ResponsesReminderPreviewTool(@type, name, description, additionalBinaryDataProperties);
        }
    }
}
