...
namespace Azure.AI.Extensions.OpenAI.Internal
{
    ...
    internal partial class InputItemCodeInterpreterToolCall : InputItem
    {
        ...
        internal InputItemCodeInterpreterToolCall(string id, InputItemCodeInterpreterToolCallStatus status, string containerId, string code, IEnumerable<BinaryData> outputs) : base(InputItemType.CodeInterpreterCall)
        {
            Id = id;
            Status = status;
        ...
        /// <param name="code"></param>
        /// <param name="outputs"></param>
        internal InputItemCodeInterpreterToolCall(InputItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, InputItemCodeInterpreterToolCallStatus status, string containerId, string code, IList<BinaryData> outputs) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            Status = status;
            ContainerId = containerId;
