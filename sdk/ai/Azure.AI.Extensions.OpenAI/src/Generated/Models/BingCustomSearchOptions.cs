...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class BingCustomSearchOptions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BingCustomSearchOptions"/>. </summary>
        ...
        internal BingCustomSearchOptions(string projectConnectionId, string instanceName, string market, string setLang, long? count, string freshness, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ProjectConnectionId = projectConnectionId;
            InstanceName = instanceName;
            Market = market;
