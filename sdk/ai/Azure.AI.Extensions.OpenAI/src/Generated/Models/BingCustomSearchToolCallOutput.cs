...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class BingCustomSearchToolCallOutput : AgentResponseItem
    {
        ...
        public BingCustomSearchToolCallOutput(string callId, ToolCallStatus status) : base("bing_custom_search_preview_call_output")
        {
        ...
        internal BingCustomSearchToolCallOutput(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Output = output;
            Status = status;
