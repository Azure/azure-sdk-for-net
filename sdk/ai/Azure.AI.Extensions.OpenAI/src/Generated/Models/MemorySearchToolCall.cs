...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class MemorySearchToolCall : ResponseItem
    {
        ...
        internal MemorySearchToolCall(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, ToolCallStatus status, IList<MemoryOutputItem> memories, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            Status = status;
            Memories = memories;
