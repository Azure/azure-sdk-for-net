...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class FabricDataAgentToolCallOutput : ResponseItem
    {
        ...
        internal FabricDataAgentToolCallOutput(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Output = output;
            Status = status;
