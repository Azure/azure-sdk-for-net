...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class BingGroundingToolCallOutput : AgentResponseItem
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Extensions.OpenAI.BingGroundingToolCallOutput"/>. </summary>
        ...
        public BingGroundingToolCallOutput(string callId, ToolCallStatus status) : base(global::Azure.AI.Extensions.OpenAI.AgentResponseItemKind.BingGroundingCallOutput)
        {
        ...
        /// <param name="status"> The status of the tool call. </param>
        internal BingGroundingToolCallOutput(AgentResponseItemKind @type, string id, AgentReference agentReference, string responseId, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, string callId, BinaryData output, ToolCallStatus status) : base(@type, id, agentReference, responseId, additionalBinaryDataProperties)
        {
            CallId = callId;
            Output = output;
            Status = status;
