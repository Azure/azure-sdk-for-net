...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class BingGroundingToolCallOutput : ResponseItem
    {
        ...
        internal BingGroundingToolCallOutput(string callId, ToolCallStatus status)
        {
            CallId = callId;
            Status = status;
        }
        ...
        internal BingGroundingToolCallOutput(string id, AgentReference agentReference, string responseId, string callId, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, agentReference, responseId)
        {
            CallId = callId;
            Output = output;
            Status = status;
