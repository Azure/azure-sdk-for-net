...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class BingGroundingToolCallOutput : AgentResponseItem
    {
        ...
        public BingGroundingToolCallOutput(string callId, ToolCallStatus status) : base("bing_grounding_call_output")
        {
        ...
        internal BingGroundingToolCallOutput(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Output = output;
            Status = status;
