...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class BingGroundingToolCallOutput : AgentResponseItem
    {
        ...
        internal BingGroundingToolCallOutput(string callId, ToolCallStatus status) : base(AgentResponseItemKind.BingGroundingCallOutput)
        {
            CallId = callId;
            Status = status;
        }
