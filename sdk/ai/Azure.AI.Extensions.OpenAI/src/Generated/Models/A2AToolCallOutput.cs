...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class A2AToolCallOutput : AgentResponseItem
    {
        ...
        public A2AToolCallOutput(string callId, string name, ToolCallStatus status) : base("a2a_preview_call_output")
        {
        ...
        internal A2AToolCallOutput(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, string name, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Name = name;
            Output = output;
