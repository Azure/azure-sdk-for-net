...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class A2AToolCallOutput : ResponseItem
    {
        ...
        internal A2AToolCallOutput(string callId, string name, ToolCallStatus status)
        {
            CallId = callId;
            Name = name;
            Status = status;
        ...
        internal A2AToolCallOutput(string id, AgentReference agentReference, string responseId, string callId, string name, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, agentReference, responseId)
        {
            CallId = callId;
            Name = name;
            Output = output;
