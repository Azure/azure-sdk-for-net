...
namespace Azure.AI.Extensions.OpenAI.Internal
{
    ...
    public partial class OutputMessageContentOutputTextContent : OutputMessageContent, IJsonModel<OutputMessageContentOutputTextContent>
    {
        ...
        protected override OutputMessageContent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeOutputMessageContentOutputTextContent(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(OutputMessageContentOutputTextContent)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OutputMessageContentOutputTextContent)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OutputMessageContentOutputTextContent IJsonModel<OutputMessageContentOutputTextContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OutputMessageContentOutputTextContent)JsonModelCreateCore(ref reader, options);
        ...
        protected override OutputMessageContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OutputMessageContentOutputTextContent)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OutputMessageContentOutputTextContent DeserializeOutputMessageContentOutputTextContent(JsonElement element, ModelReaderWriterOptions options)
        {
