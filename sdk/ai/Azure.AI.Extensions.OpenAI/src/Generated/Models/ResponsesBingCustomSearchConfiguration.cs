...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class ResponsesBingCustomSearchConfiguration
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ResponsesBingCustomSearchConfiguration"/>. </summary>
        ...
        internal ResponsesBingCustomSearchConfiguration(string projectConnectionId, string instanceName)
        {
        ...
        internal ResponsesBingCustomSearchConfiguration(string projectConnectionId, string instanceName, string market, string setLang, long? count, string freshness, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ProjectConnectionId = projectConnectionId;
            InstanceName = instanceName;
            Market = market;
