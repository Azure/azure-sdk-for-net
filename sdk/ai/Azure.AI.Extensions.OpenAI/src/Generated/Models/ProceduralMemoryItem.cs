...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class ProceduralMemoryItem : MemoryOutputItem
    {
        ...
        public ProceduralMemoryItem(string memoryId, DateTimeOffset updatedOn, string scope, string content) : base(memoryId, updatedOn, scope, content, MemoryItemKind.Procedural)
        {
        ...
        internal ProceduralMemoryItem(string memoryId, DateTimeOffset updatedOn, string scope, string content, MemoryItemKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(memoryId, updatedOn, scope, content, kind, additionalBinaryDataProperties)
        {
        }
    }
}
