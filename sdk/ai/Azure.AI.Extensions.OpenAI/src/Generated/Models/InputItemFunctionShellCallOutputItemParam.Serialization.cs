...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    internal partial class InputItemFunctionShellCallOutputItemParam : InputItem, IJsonModel<InputItemFunctionShellCallOutputItemParam>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InputItemFunctionShellCallOutputItemParam>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeInputItemFunctionShellCallOutputItemParam(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(InputItemFunctionShellCallOutputItemParam)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InputItemFunctionShellCallOutputItemParam)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputItemFunctionShellCallOutputItemParam)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InputItemFunctionShellCallOutputItemParam IJsonModel<InputItemFunctionShellCallOutputItemParam>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InputItemFunctionShellCallOutputItemParam)JsonModelCreateCore(ref reader, options);
        ...
        protected override InputItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputItemFunctionShellCallOutputItemParam)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InputItemFunctionShellCallOutputItemParam DeserializeInputItemFunctionShellCallOutputItemParam(JsonElement element, ModelReaderWriterOptions options)
        {
