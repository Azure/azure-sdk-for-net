...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Extensions.OpenAI.AzureFunctionToolCall"/>. </summary>
        ...
        public AzureFunctionToolCall(string callId, string name, string arguments, ToolCallStatus status) : base(global::Azure.AI.Extensions.OpenAI.AgentResponseItemKind.AzureFunctionCall)
        {
        ...
        /// <param name="arguments"> A JSON string of the arguments to pass to the tool. </param>
        /// <param name="status"> The status of the tool call. </param>
        internal AzureFunctionToolCall(AgentResponseItemKind @type, string id, AgentReference agentReference, string responseId, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, string callId, string name, string arguments, ToolCallStatus status) : base(@type, id, agentReference, responseId, additionalBinaryDataProperties)
        {
            CallId = callId;
            Name = name;
            Arguments = arguments;
