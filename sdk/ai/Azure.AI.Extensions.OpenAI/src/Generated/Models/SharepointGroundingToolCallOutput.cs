...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Extensions.OpenAI.SharepointGroundingToolCallOutput"/>. </summary>
        ...
        public SharepointGroundingToolCallOutput(string callId, ToolCallStatus status) : base(global::Azure.AI.Extensions.OpenAI.AgentResponseItemKind.SharepointGroundingPreviewCallOutput)
        {
        ...
        /// <param name="status"> The status of the tool call. </param>
        internal SharepointGroundingToolCallOutput(AgentResponseItemKind @type, string id, AgentReference agentReference, string responseId, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, string callId, BinaryData output, ToolCallStatus status) : base(@type, id, agentReference, responseId, additionalBinaryDataProperties)
        {
            CallId = callId;
            Output = output;
            Status = status;
