...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InternalOutputItemFunctionToolCall"/> for deserialization. </summary>
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalOutputItemFunctionToolCall)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InternalOutputItemFunctionToolCall>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemFunctionToolCall)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InternalOutputItemFunctionToolCall IJsonModel<InternalOutputItemFunctionToolCall>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InternalOutputItemFunctionToolCall)JsonModelCreateCore(ref reader, options);
        ...
        protected override AgentResponseItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemFunctionToolCall)} does not support reading '{format}' format.");
            }
