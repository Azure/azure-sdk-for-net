...
namespace OpenAI
{
    internal partial class InternalImageGenTool : ResponsesTool, IJsonModel<global::OpenAI.InternalImageGenTool>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (global::Azure.AI.Extensions.OpenAI.Optional.IsDefined(Quality))
            {
                writer.WritePropertyName("quality"u8);
                writer.WriteStringValue(Quality.Value.ToString());
            }
            if (global::Azure.AI.Extensions.OpenAI.Optional.IsDefined(Size))
            {
                writer.WritePropertyName("size"u8);
                writer.WriteStringValue(Size.Value.ToString());
            }
            if (global::Azure.AI.Extensions.OpenAI.Optional.IsDefined(OutputFormat))
            {
                writer.WritePropertyName("output_format"u8);
                writer.WriteStringValue(OutputFormat.Value.ToString());
            }
            if (global::Azure.AI.Extensions.OpenAI.Optional.IsDefined(OutputCompression))
            {
                writer.WritePropertyName("output_compression"u8);
                writer.WriteNumberValue(OutputCompression.Value);
            }
            if (global::Azure.AI.Extensions.OpenAI.Optional.IsDefined(Moderation))
            {
            ...
            if (global::Azure.AI.Extensions.OpenAI.Optional.IsDefined(InputFidelity))
            {
                writer.WritePropertyName("input_fidelity"u8);
                writer.WriteStringValue(InputFidelity.Value.ToSerialString());
            }
            if (global::Azure.AI.Extensions.OpenAI.Optional.IsDefined(InputImageMask))
            {
            ...
            if (global::Azure.AI.Extensions.OpenAI.Optional.IsDefined(PartialImages))
            {
        ...
        internal static InternalImageGenTool DeserializeInternalImageGenTool(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("input_image_mask"u8))
                {
                    ...
                    inputImageMask = global::OpenAI.InternalImageGenToolInputImageMask.DeserializeInternalImageGenToolInputImageMask(prop.Value, options);
                    continue;
                }
