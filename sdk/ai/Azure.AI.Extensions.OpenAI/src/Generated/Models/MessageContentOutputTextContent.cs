...
namespace Azure.AI.Extensions.OpenAI.Internal
{
    ...
    internal partial class MessageContentOutputTextContent : InternalMessageContent
    {
        ...
        internal MessageContentOutputTextContent(string text, IEnumerable<ResponseMessageAnnotation> annotations, IEnumerable<InternalLogProb> logprobs) : base(MessageContentType.OutputText)
        {
            Text = text;
        ...
        /// <param name="annotations"> The annotations of the text output. </param>
        /// <param name="logprobs"></param>
        internal MessageContentOutputTextContent(MessageContentType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string text, IList<ResponseMessageAnnotation> annotations, IList<InternalLogProb> logprobs) : base(@type, additionalBinaryDataProperties)
        {
            Text = text;
