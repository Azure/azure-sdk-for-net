...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class AgentWorkflowPreviewActionResponseItem : ResponseItem
    {
        ...
        internal AgentWorkflowPreviewActionResponseItem(string kind, string actionId, AgentWorkflowPreviewActionStatus? status)
        {
            Kind = kind;
            ActionId = actionId;
            Status = status;
