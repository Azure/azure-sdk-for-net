...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class ResponseWebSearchCallCompletedEvent : ResponseStreamEvent
    {
        ...
        internal ResponseWebSearchCallCompletedEvent(long outputIndex, string itemId, long sequenceNumber) : base("response.web_search_call.completed")
        {
        ...
        /// <param name="itemId"> Unique ID for the output item associated with the web search call. </param>
        /// <param name="sequenceNumber"> The sequence number of the web search call being processed. </param>
        internal ResponseWebSearchCallCompletedEvent(ResponseStreamEventType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, long outputIndex, string itemId, long sequenceNumber) : base(@type, additionalBinaryDataProperties)
        {
            OutputIndex = outputIndex;
            ItemId = itemId;
            SequenceNumber = sequenceNumber;
