...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class OAuthConsentRequestResponseItem : ResponseItem
    {
        ...
        internal OAuthConsentRequestResponseItem(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string internalConsentLink, string serverLabel, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
