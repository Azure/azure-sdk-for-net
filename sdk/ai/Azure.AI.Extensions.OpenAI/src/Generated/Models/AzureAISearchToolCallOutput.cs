...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class AzureAISearchToolCallOutput : AgentResponseItem
    {
        ...
        public AzureAISearchToolCallOutput(string callId, ToolCallStatus status) : base("azure_ai_search_call_output")
        {
        ...
        internal AzureAISearchToolCallOutput(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Output = output;
            Status = status;
