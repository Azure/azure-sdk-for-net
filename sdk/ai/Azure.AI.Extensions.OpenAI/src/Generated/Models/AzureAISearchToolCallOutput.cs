...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class AzureAISearchToolCallOutput : ResponseItem
    {
        ...
        internal AzureAISearchToolCallOutput(string callId, ToolCallStatus status)
        {
            CallId = callId;
            Status = status;
        }
        ...
        internal AzureAISearchToolCallOutput(string id, AgentReference agentReference, string responseId, string callId, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, agentReference, responseId)
        {
            CallId = callId;
            Output = output;
            Status = status;
