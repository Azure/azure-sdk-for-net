...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class SharePointGroundingToolCall : AgentResponseItem
    {
        ...
        public SharePointGroundingToolCall(string callId, string arguments, ToolCallStatus status) : base("sharepoint_grounding_preview_call")
        {
        ...
        internal SharePointGroundingToolCall(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, string arguments, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
