...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class SharepointGroundingToolCall : ResponseItem
    {
        ...
        internal SharepointGroundingToolCall(string callId, string arguments, ToolCallStatus status)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
        ...
        internal SharepointGroundingToolCall(string id, AgentReference agentReference, string responseId, string callId, string arguments, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, agentReference, responseId)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
