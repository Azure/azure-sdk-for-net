...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class ResponseContentPartDoneEvent : ResponseStreamEvent, IJsonModel<ResponseContentPartDoneEvent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResponseContentPartDoneEvent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResponseContentPartDoneEvent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponseContentPartDoneEvent IPersistableModel<ResponseContentPartDoneEvent>.Create(BinaryData data, ModelReaderWriterOptions options) => (ResponseContentPartDoneEvent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponseContentPartDoneEvent IJsonModel<ResponseContentPartDoneEvent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ResponseContentPartDoneEvent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ResponseContentPartDoneEvent DeserializeResponseContentPartDoneEvent(JsonElement element, ModelReaderWriterOptions options)
        {
