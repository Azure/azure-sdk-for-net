...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class AzureFunctionToolCallOutput : ResponseItem
    {
        ...
        public AzureFunctionToolCallOutput(string callId, string name, ToolCallStatus status) : base("azure_function_call_output")
        {
        ...
        internal AzureFunctionToolCallOutput(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, string name, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Name = name;
            Output = output;
