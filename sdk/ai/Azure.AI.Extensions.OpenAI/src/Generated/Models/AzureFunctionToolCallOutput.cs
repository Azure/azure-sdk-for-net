...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class AzureFunctionToolCallOutput : ResponseItem
    {
        ...
        internal AzureFunctionToolCallOutput(string callId, string name, ToolCallStatus status)
        {
            CallId = callId;
            Name = name;
            Status = status;
        ...
        internal AzureFunctionToolCallOutput(string id, AgentReference agentReference, string responseId, string callId, string name, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, agentReference, responseId)
        {
            CallId = callId;
            Name = name;
            Output = output;
