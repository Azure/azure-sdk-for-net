...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class BrowserAutomationToolCallOutput : ResponseItem
    {
        ...
        public BrowserAutomationToolCallOutput(string callId, ToolCallStatus status) : base("browser_automation_preview_call_output")
        {
        ...
        internal BrowserAutomationToolCallOutput(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Output = output;
            Status = status;
