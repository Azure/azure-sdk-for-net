...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class ResponsesWebIQPreviewTool : ResponsesTool
    {
        /// <summary> Initializes a new instance of <see cref="ResponsesWebIQPreviewTool"/>. </summary>
        ...
        public ResponsesWebIQPreviewTool(string projectConnectionId) : base(ToolType.WebIqPreview)
        {
        ...
        internal ResponsesWebIQPreviewTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string projectConnectionId, string serverLabel, Uri serverUri, BinaryData requireApproval) : base(@type, additionalBinaryDataProperties)
        {
            ProjectConnectionId = projectConnectionId;
