...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    internal partial class InputItemWebSearchToolCall : InputItem, IJsonModel<InputItemWebSearchToolCall>
    {
        ...
        protected override InputItem PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeInputItemWebSearchToolCall(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(InputItemWebSearchToolCall)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputItemWebSearchToolCall)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InputItemWebSearchToolCall IJsonModel<InputItemWebSearchToolCall>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InputItemWebSearchToolCall)JsonModelCreateCore(ref reader, options);
        ...
        protected override InputItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputItemWebSearchToolCall)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InputItemWebSearchToolCall DeserializeInputItemWebSearchToolCall(JsonElement element, ModelReaderWriterOptions options)
        {
