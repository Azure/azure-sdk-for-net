...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class SharePointGroundingToolCallOutput : AgentResponseItem
    {
        ...
        public SharePointGroundingToolCallOutput(string callId, ToolCallStatus status) : base("sharepoint_grounding_preview_call_output")
        {
        ...
        internal SharePointGroundingToolCallOutput(ResponseItemKind @type, string id, AgentReference agentReference, string responseId, string callId, BinaryData output, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, id, agentReference, responseId)
        {
            CallId = callId;
            Output = output;
            Status = status;
