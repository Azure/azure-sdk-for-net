...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    internal partial class OpenApiToolCall : AgentResponseItem
    {
        ...
        public OpenApiToolCall(string callId, string name, string arguments, ToolCallStatus status) : base(AgentResponseItemKind.OpenapiCall)
        {
