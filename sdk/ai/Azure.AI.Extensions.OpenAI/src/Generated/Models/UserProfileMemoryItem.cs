...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class UserProfileMemoryItem : MemoryOutputItem
    {
        ...
        public UserProfileMemoryItem(string memoryId, DateTimeOffset updatedOn, string scope, string content) : base(memoryId, updatedOn, scope, content, MemoryItemKind.UserProfile)
        {
        ...
        internal UserProfileMemoryItem(string memoryId, DateTimeOffset updatedOn, string scope, string content, MemoryItemKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(memoryId, updatedOn, scope, content, kind, additionalBinaryDataProperties)
        {
        }
    }
}
