...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class ResponsesOpenApiFunctionDefinition
    {
        ...
        public ResponsesOpenApiFunctionDefinition(string name, IDictionary<string, BinaryData> spec, ResponsesOpenApiAuthDetails auth)
        {
        ...
        internal ResponsesOpenApiFunctionDefinition(string name, string description, IDictionary<string, BinaryData> spec, ResponsesOpenApiAuthDetails auth, IList<string> defaultParams, IReadOnlyList<ResponsesOpenApiFunctionDefinitionFunction> functions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
