...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public partial class BingGroundingSearchConfiguration
    {
        ...
        internal BingGroundingSearchConfiguration(string projectConnectionId, string market, string language, long? count, string freshness, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ProjectConnectionId = projectConnectionId;
            Market = market;
            Language = language;
