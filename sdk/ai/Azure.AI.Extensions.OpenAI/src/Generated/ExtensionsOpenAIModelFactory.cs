...
namespace Azure.AI.Extensions.OpenAI
{
    ...
    public static partial class ExtensionsOpenAIModelFactory
    {
        ...
        public static OAuthConsentRequestResponseItem OAuthConsentRequestResponseItem(string id = default, AgentReference agentReference = default, string responseId = default, string id0 = default, string consentLink = default, string serverLabel = default)
        {
