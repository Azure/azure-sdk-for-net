...
public partial class BrowserAutomationToolCall
{
    ...
    internal BrowserAutomationToolCall(string callId, string arguments, ToolCallStatus status) : base(ResponseItemKind.BrowserAutomationPreviewCall)
    {
        CallId = callId;
        Arguments = arguments;
        Status = status;
    ...
    internal BrowserAutomationToolCall(string id, AgentReference agentReference, string responseId, string callId, string arguments, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(ResponseItemKind.BrowserAutomationPreviewCall)
    {
        CallId = callId;
        Arguments = arguments;
        Status = status;
