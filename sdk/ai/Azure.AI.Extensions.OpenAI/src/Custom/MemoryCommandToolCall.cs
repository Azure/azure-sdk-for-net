...
public partial class MemoryCommandToolCall
{
    ...
    internal MemoryCommandToolCall(string callId, string arguments, ToolCallStatus status) : base(ResponseItemKind.MemoryCommandPreviewCall)
    {
        CallId = callId;
        Arguments = arguments;
        Status = status;
    ...
    internal MemoryCommandToolCall(string id, AgentReference agentReference, string responseId, string callId, string arguments, ToolCallStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(ResponseItemKind.MemoryCommandPreviewCall)
    {
        CallId = callId;
        Arguments = arguments;
        Status = status;
