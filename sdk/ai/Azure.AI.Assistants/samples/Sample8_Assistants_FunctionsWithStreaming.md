# Sample using assistants with functions and streaming in Azure.AI.Assistants.

In this example we are demonstrating how to use the local functions with the assistants in streaming scenarios. The functions can be used to provide assistant specific information in response to user question.

1. First we need to create assistant client and read the environment variables that will be used in the next steps.
```C# Snippet:AssistantsFunctionsWithStreaming_CreateClient
...
```C# Snippet:AssistantsFunctionsWithStreaming_DefineFunctionTools
...
```C# Snippet:AssistantsFunctionsWithStreamingUpdateHandling
...
4. Create assistant with the `FunctionToolDefinitions` we have created in step 2.

Synchronous sample:
```C# Snippet:AssistantsFunctionsWithStreamingSync_CreateAgent
...
Asynchronous sample:
```C# Snippet:AssistantsFunctionsWithStreaming_CreateAgent
...
Synchronous sample:
```C# Snippet:AssistantsFunctionsWithStreamingSync_CreateThread
...
Asynchronous sample:
```C# Snippet:AssistantsFunctionsWithStreaming_CreateThread
...
Synchronous sample:
```C# Snippet:AssistantsFunctionsWithStreamingSyncUpdateCycle
...
Synchronous sample:
```C# Snippet:AssistantsFunctionsWithStreamingSync_Cleanup
client.DeleteThread(thread.Id);
client.DeleteAssistant(assistant.Id);
```

Asynchronous sample:
```C# Snippet:AssistantsFunctionsWithStreaming_Cleanup
