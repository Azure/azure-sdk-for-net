# Sample for using Azure Functions with assistants in Azure.AI.Assistants.
...
2. Next we need to create an assistant. In this scenario we are asking it to supply storage queue URI to the azure function whenever it is called.
