# Sample for using Azure Functions with agents in Azure.AI.Assistants.
...
Synchronous sample:
```C# Snippet:AssistantsAzureFunctionsCreateAgentWithFunctionToolsSync
...
Synchronous sample:
```C# Snippet:AssistantsAzureFunctionsHandlePollingWithRequiredActionSync
...
Synchronous sample:
```C# Snippet:AssistantsAzureFunctionsPrintSync
...
Asynchronous sample:
```C# Snippet:AssistantsAzureFunctionsPrint
...
Synchronous sample:
```C# Snippet:AssistantsAzureFunctionsCleanupSync
client.DeleteThread(thread.Id);
client.DeleteAgent(agent.Id);
```

Asynchronous sample:
```C# Snippet:AssistantsAzureFunctionsCleanup
