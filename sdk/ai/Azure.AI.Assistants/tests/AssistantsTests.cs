...
{
    public class AssistantsTests : RecordedTestBase<AIAssistantsTestEnvironment>
    {
        ...
        public AssistantsTests(bool isAsync) : base(isAsync) {
        ...
        private static async Task DeleteAndAssert(AssistantsClient client, Assistant agent)
        {
