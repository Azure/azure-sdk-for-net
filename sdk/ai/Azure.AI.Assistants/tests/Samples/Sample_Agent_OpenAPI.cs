...
public partial class Sample_Agent_OpenAPI : SamplesBase<AIAssistantsTestEnvironment>
{
...
#endif
        AIAssistantClient client = new(connectionString, new AzureCliCredential());
    ...
    public void OpenAPICallingExample()
    {
        ...
        var modelDeploymentName = TestEnvironment.MODELDEPLOYMENTNAME;
#endif
        AIAssistantClientOptions options = new();
        options.AddPolicy(new CustomHeadersPolicy(), HttpPipelinePosition.PerCall);
