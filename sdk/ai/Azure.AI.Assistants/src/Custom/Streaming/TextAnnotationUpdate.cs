...
public class TextAnnotationUpdate
{
    ...
    /// </summary>
    public string Url => _urlAnnotation?.UrlCitation?.Url;

    /// <summary>
    /// The title from url annotation if any.
    /// </summary>
    public string Title => _urlAnnotation?.UrlCitation?.Title;
    ...
    private readonly MessageDeltaTextUrlCitationAnnotation _urlAnnotation;
    ...
    internal TextAnnotationUpdate(MessageDeltaTextAnnotation internalAnnotation)
    {
        ...
        _urlAnnotation = internalAnnotation as MessageDeltaTextUrlCitationAnnotation;
    }
}
