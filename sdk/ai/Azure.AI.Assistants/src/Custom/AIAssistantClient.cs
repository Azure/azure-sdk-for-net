...
namespace Azure.AI.Assistants
{
    ...
    public partial class AIAssistantClient
    {
        ...
        public AIAssistantClient(string connectionString, TokenCredential credential) : this(connectionString, credential, new AIAssistantClientOptions())
        {
        }
        ...
        public AIAssistantClient(string connectionString, TokenCredential credential, AIAssistantClientOptions options)
