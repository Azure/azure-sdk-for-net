...
namespace Azure.AI.Assistants
{
    public partial class AssistantsClient
    {
        ...
        public AssistantsClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new AssistantsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/>, or <paramref name="credential"/> is null. </exception>
        /// <exception cref="ArgumentException"> is an empty string, and was expected to be non-empty. </exception>
        public AssistantsClient(string endpoint, AzureKeyCredential credential, AssistantsClientOptions options) : this(new Uri(endpoint), credential, options)
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        /// <exception cref="ArgumentException"> is an empty string, and was expected to be non-empty. </exception>
        public AssistantsClient(string endpoint, AzureKeyCredential credential) : this(endpoint, credential, new AssistantsClientOptions())
        {
        }
