...
namespace Azure.AI.Assistants
{
    public partial class AssistantsClient
    {
        ...
        public AssistantsClient(string connectionString, TokenCredential credential) : this(connectionString, credential, new AssistantsClientOptions())
        {
        }
        ...
        public AssistantsClient(string connectionString, TokenCredential credential, AssistantsClientOptions options)
        ...
        public AssistantsClient(Uri endpoint, string subscriptionId, string resourceGroupName, string projectName, TokenCredential credential) : this(endpoint, subscriptionId, resourceGroupName, projectName, credential, new AssistantsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/>, <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="projectName"/> or <paramref name="credential"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="projectName"/> is an empty string, and was expected to be non-empty. </exception>
        public AssistantsClient(Uri endpoint, string subscriptionId, string resourceGroupName, string projectName, TokenCredential credential, AssistantsClientOptions options)
        {
        ...
        */
        ...
        public virtual Response<ThreadRun> CreateRun(AssistantThread thread, Assistant assistant, CancellationToken cancellationToken = default)
            => CreateRun(thread.Id, assistant.Id, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A new <see cref="ThreadRun"/> instance. </returns>
        public virtual Task<Response<ThreadRun>> CreateRunAsync(AssistantThread thread, Assistant assistant, CancellationToken cancellationToken = default)
             => CreateRunAsync(thread.Id, assistant.Id, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, cancellationToken);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AssistantsClient.SubmitToolOutputsInternal");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("AssistantsClient.SubmitToolOutputsInternalAsync");
            scope.Start();
            try
            {
                using HttpMessage message = CreateSubmitToolOutputsToRunRequest(threadId, runId, content, context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AssistantFile> UploadFile(
            string filePath,
            AssistantFilePurpose purpose,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="purpose"> The intended purpose of the uploaded file. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<AssistantFile>> UploadFileAsync(
            string filePath,
            AssistantFilePurpose purpose,
            CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<AssistantFile>> UploadFileAsync(Stream data, AssistantFilePurpose purpose, string filename, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Uploads a file for use by other operations. </summary>
        /// <param name="data"> The file data, in bytes. </param>
        /// <param name="purpose"> The intended purpose of the uploaded file. Use `assistants` for Assistant and Message files, `vision` for Assistants image file inputs, `batch` for Batch API, and `fine-tune` for Fine-tuning. </param>
        /// <param name="filename"> The name of the file. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<AssistantFile> UploadFile(Stream data, AssistantFilePurpose purpose, string filename, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            Argument.AssertNotNullOrEmpty(filename, nameof(filename));
            File azureFile = new(BinaryData.FromStream(data));
        ...
        internal virtual async Task<Response<AssistantFile>> UploadFileAsync(UploadFileRequest body, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        internal virtual Response<AssistantFile> UploadFile(UploadFileRequest body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistants.DeleteAssistant");
            scope.Start();
        ...
        public virtual Response<bool> DeleteThread(
            ...
            CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistants.DeleteThread");
            scope.Start();
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IReadOnlyList<AssistantFile>> GetFiles(AssistantFilePurpose? purpose = null, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistant.GetFiles");
            scope.Start();
        ...
        /// <param name="purpose"> Limits files in the response to those with the specified purpose. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<IReadOnlyList<AssistantFile>>> GetFilesAsync(
            AssistantFilePurpose? purpose = null,
            CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistant.GetFiles");
            scope.Start();
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistant.DeleteFile");
            scope.Start();
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistants.DeleteFile");
            scope.Start();
        ...
        public virtual Response<PageableList<Assistant>> GetAssistants(
            ...
            CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistants.GetAssistants");
            scope.Start();
        ...
        public virtual Response<PageableList<RunStep>> GetRunSteps(
            ...
            CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistants.GetRunSteps");
            scope.Start();
        ...
        public virtual Response<PageableList<ThreadMessage>> GetMessages(
            ...
            CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistants.GetMessages");
            scope.Start();
        ...
        public virtual Response<PageableList<ThreadRun>> GetRuns(
            ...
            CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Assistants.GetRuns");
            scope.Start();
