...
public static partial class AIClientModelFactory
{
    ...
    /// <summary> Initializes a new instance of <see cref="Azure.AI.Assistants.ThreadRun"/>. </summary>
    /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
    ...
    /// Please note <see cref="Azure.AI.Assistants.RequiredAction"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    /// <returns> A new <see cref="Azure.AI.Assistants.ThreadRun"/> instance for mocking. </returns>
    ...
    /// <returns> A new <see cref="Azure.AI.Assistants.RunStep"/> instance for mocking. </returns>
    ...
    /// <summary> Initializes a new instance of <see cref="Azure.AI.Assistants.ThreadMessage"/>. </summary>
    /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
    /// <param name="createdAt"> The Unix timestamp, in seconds, representing when this object was created. </param>
    ...
    /// <returns> A new <see cref="Azure.AI.Assistants.ThreadMessage"/> instance for mocking. </returns>
    ...
    /// <summary>
    /// Instantiates a new instance of <see cref="Azure.AI.Assistants.SubmitToolOutputsAction"/>.
    /// </summary>
