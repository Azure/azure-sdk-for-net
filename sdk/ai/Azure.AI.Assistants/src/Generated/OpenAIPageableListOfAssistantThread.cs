...
namespace Azure.AI.Assistants
{
    ...
    internal partial class OpenAIPageableListOfAssistantThread
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfAssistantThread"/>. </summary>
        ...
        internal OpenAIPageableListOfAssistantThread(IEnumerable<AssistantThread> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal OpenAIPageableListOfAssistantThread(OpenAIPageableListOfAssistantThreadObject @object, IReadOnlyList<AssistantThread> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfAssistantThread"/> for deserialization. </summary>
        internal OpenAIPageableListOfAssistantThread()
        {
        }

        /// <summary> The object type, which is always list. </summary>
        public OpenAIPageableListOfAssistantThreadObject Object { get; } = OpenAIPageableListOfAssistantThreadObject.List;
