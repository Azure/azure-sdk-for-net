...
{
    /// <summary> The UpdateAssistantRequest. </summary>
    internal partial class UpdateAssistantRequest
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="UpdateAssistantRequest"/>. </summary>
        internal UpdateAssistantRequest()
        {
        ...
        internal UpdateAssistantRequest(string model, string name, string description, string instructions, IReadOnlyList<ToolDefinition> tools, ToolResources toolResources, float? temperature, float? topP, BinaryData responseFormat, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Model = model;
            Name = name;
