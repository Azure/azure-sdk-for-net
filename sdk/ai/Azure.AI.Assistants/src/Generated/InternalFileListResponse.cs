...
namespace Azure.AI.Assistants
{
    ...
    internal partial class InternalFileListResponse
    {
        ...
        internal InternalFileListResponse(IEnumerable<AssistantFile> data)
        {
        ...
        internal InternalFileListResponse(InternalFileListResponseObject @object, IReadOnlyList<AssistantFile> data, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
