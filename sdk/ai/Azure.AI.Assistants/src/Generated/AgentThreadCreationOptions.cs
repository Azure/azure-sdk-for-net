...
namespace Azure.AI.Assistants
{
    ...
    public partial class AgentThreadCreationOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AgentThreadCreationOptions"/>. </summary>
        ...
        internal AgentThreadCreationOptions(IList<ThreadMessageOptions> messages, ToolResources toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Messages = messages;
