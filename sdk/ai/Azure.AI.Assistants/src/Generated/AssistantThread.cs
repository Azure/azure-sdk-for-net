...
namespace Azure.AI.Assistants
{
    ...
    public partial class AssistantThread
    {
        ...
        internal AssistantThread(string id, AssistantThreadObject @object, DateTimeOffset createdAt, ToolResources toolResources, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            CreatedAt = createdAt;
