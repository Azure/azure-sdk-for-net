...
namespace Azure.AI.Assistants
{
    ...
    public partial class AssistantThreadCreationOptions
    {
        ...
        internal AssistantThreadCreationOptions(IList<ThreadMessageOptions> messages, ToolResources toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Messages = messages;
