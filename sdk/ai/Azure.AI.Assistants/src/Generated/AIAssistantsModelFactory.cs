...
namespace Azure.AI.Assistants
{
    ...
    public static partial class AIAssistantsModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.Agent"/>. </summary>
        ...
        /// <returns> A new <see cref="Assistants.Agent"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.AgentThread"/>. </summary>
        /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
        ...
        /// </param>
        /// <param name="metadata"> A set of up to 16 key/value pairs that can be attached to an object, used for storing additional information about that object in a structured format. Keys may be up to 64 characters in length and values may be up to 512 characters in length. </param>
        /// <returns> A new <see cref="Assistants.AgentThread"/> instance for mocking. </returns>
