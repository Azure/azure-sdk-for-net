...
namespace Azure.AI.Assistants
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Assistants.AzureFunctionBinding"/>. </summary>
        /// <param name="type"> The type of binding, which is always 'storage_queue'. </param>
        /// <param name="storageQueue"> Storage queue. </param>
        /// <returns> A new <see cref="Assistants.AzureFunctionBinding"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.ResponseFormatJsonSchemaType"/>. </summary>
        /// <param name="type"> Type. </param>
        /// <param name="jsonSchema"> The JSON schema, describing response format. </param>
        /// <returns> A new <see cref="Assistants.ResponseFormatJsonSchemaType"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageInputTextBlock"/>. </summary>
        /// <param name="text"> The plain text content for this block. </param>
        /// <returns> A new <see cref="Assistants.MessageInputTextBlock"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageInputImageFileBlock"/>. </summary>
        /// <param name="imageFile"> Information about the referenced image file, including file ID and optional detail level. </param>
        /// <returns> A new <see cref="Assistants.MessageInputImageFileBlock"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageImageFileParam"/>. </summary>
        ...
        /// <returns> A new <see cref="Assistants.MessageImageFileParam"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageInputImageUrlBlock"/>. </summary>
        /// <param name="imageUrl"> Information about the external image URL, including the URL and optional detail level. </param>
        /// <returns> A new <see cref="Assistants.MessageInputImageUrlBlock"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageImageUrlParam"/>. </summary>
        ...
        /// <returns> A new <see cref="Assistants.MessageImageUrlParam"/> instance for mocking. </returns>
        ...
        public static AssistantThread AssistantThread(string id = null, AssistantThreadObject @object = default, DateTimeOffset createdAt = default, ToolResources toolResources = null, IReadOnlyDictionary<string, string> metadata = null)
        {
            metadata ??= new Dictionary<string, string>();
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageTextUrlCitationAnnotation"/>. </summary>
        /// <param name="text"> The textual content associated with this text annotation item. </param>
        ...
        /// <returns> A new <see cref="Assistants.MessageTextUrlCitationAnnotation"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageTextUrlCitationDetails"/>. </summary>
        /// <param name="url"> The URL associated with this citation. </param>
        /// <param name="title"> The title of the URL. </param>
        /// <returns> A new <see cref="Assistants.MessageTextUrlCitationDetails"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.IncompleteRunDetails"/>. </summary>
        ...
        /// <returns> A new <see cref="Assistants.IncompleteRunDetails"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.RunStepFileSearchToolCallResults"/>. </summary>
        ...
        /// <returns> A new <see cref="Assistants.RunStepFileSearchToolCallResults"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.RunStepFileSearchToolCallResult"/>. </summary>
        ...
        /// <returns> A new <see cref="Assistants.RunStepFileSearchToolCallResult"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.FileSearchToolCallContent"/>. </summary>
        /// <param name="type"> The type of the content. </param>
        /// <param name="text"> The text content of the file. </param>
        /// <returns> A new <see cref="Assistants.FileSearchToolCallContent"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.RunStepBingGroundingToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="bingGrounding"> Reserved for future use. </param>
        /// <returns> A new <see cref="Assistants.RunStepBingGroundingToolCall"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.RunStepAzureAISearchToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="azureAISearch"> Reserved for future use. </param>
        /// <returns> A new <see cref="Assistants.RunStepAzureAISearchToolCall"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.RunStepSharepointToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="sharePoint"> Reserved for future use. </param>
        /// <returns> A new <see cref="Assistants.RunStepSharepointToolCall"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.RunStepMicrosoftFabricToolCall"/>. </summary>
        /// <param name="id"> The ID of the tool call. This ID must be referenced when you submit tool outputs. </param>
        /// <param name="microsoftFabric"> Reserved for future use. </param>
        /// <returns> A new <see cref="Assistants.RunStepMicrosoftFabricToolCall"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.AssistantPageableListOfVectorStore"/>. </summary>
        ...
        /// <returns> A new <see cref="Assistants.AssistantPageableListOfVectorStore"/> instance for mocking. </returns>
        public static AssistantPageableListOfVectorStore AssistantPageableListOfVectorStore(AssistantPageableListOfVectorStoreObject @object = default, IEnumerable<VectorStore> data = null, string firstId = null, string lastId = null, bool hasMore = default)
        {
            data ??= new List<VectorStore>();

            return new AssistantPageableListOfVectorStore(
                @object,
                data?.ToList(),
                firstId,
                lastId,
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.AssistantPageableListOfVectorStoreFile"/>. </summary>
        /// <param name="object"> The object type, which is always list. </param>
        /// <param name="data"> The requested list of items. </param>
        /// <param name="firstId"> The first ID represented in this list. </param>
        /// <param name="lastId"> The last ID represented in this list. </param>
        /// <param name="hasMore"> A value indicating whether there are additional values available not captured in this list. </param>
        /// <returns> A new <see cref="Assistants.AssistantPageableListOfVectorStoreFile"/> instance for mocking. </returns>
        public static AssistantPageableListOfVectorStoreFile AssistantPageableListOfVectorStoreFile(AssistantPageableListOfVectorStoreFileObject @object = default, IEnumerable<VectorStoreFile> data = null, string firstId = null, string lastId = null, bool hasMore = default)
        {
            data ??= new List<VectorStoreFile>();

            return new AssistantPageableListOfVectorStoreFile(
                @object,
                data?.ToList(),
                firstId,
                lastId,
        ...
        /// The available derived classes include <see cref="Assistants.MessageDeltaImageFileContent"/> and <see cref="Assistants.MessageDeltaTextContent"/>.
        /// </param>
        ...
        /// The available derived classes include <see cref="Assistants.MessageDeltaTextFileCitationAnnotation"/>, <see cref="Assistants.MessageDeltaTextFilePathAnnotation"/> and <see cref="Assistants.MessageDeltaTextUrlCitationAnnotation"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageDeltaTextUrlCitationAnnotation"/>. </summary>
        /// <param name="index"> The index of the annotation within a text content part. </param>
        /// <param name="urlCitation"> The details of the URL citation. </param>
        /// <param name="startIndex"> The first text index associated with this text annotation. </param>
        /// <param name="endIndex"> The last text index associated with this text annotation. </param>
        /// <returns> A new <see cref="Assistants.MessageDeltaTextUrlCitationAnnotation"/> instance for mocking. </returns>
        ...
        /// <summary> Initializes a new instance of <see cref="Assistants.MessageDeltaTextUrlCitationDetails"/>. </summary>
        /// <param name="url"> The URL associated with this citation. </param>
        /// <param name="title"> The title of the URL. </param>
        /// <returns> A new <see cref="Assistants.MessageDeltaTextUrlCitationDetails"/> instance for mocking. </returns>
