...
{
    public partial class VectorStoreExpirationPolicy : IUtf8JsonSerializable, IJsonModel<VectorStoreExpirationPolicy>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VectorStoreExpirationPolicy>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static VectorStoreExpirationPolicy DeserializeVectorStoreExpirationPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    anchor = new VectorStoreExpirationPolicyAnchor(property.Value.GetString());
                    continue;
                }
        ...
        internal static VectorStoreExpirationPolicy FromResponse(Response response)
        {
