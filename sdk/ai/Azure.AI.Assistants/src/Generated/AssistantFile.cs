...
namespace Azure.AI.Assistants
{
    ...
    public partial class AssistantFile
    {
        ...
        internal AssistantFile(string id, int size, string filename, DateTimeOffset createdAt, AssistantFilePurpose purpose)
        {
        ...
        internal AssistantFile(string @object, string id, int size, string filename, DateTimeOffset createdAt, AssistantFilePurpose purpose, FileState? status, string statusDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Id = id;
            Size = size;
