...
namespace Azure.AI.Assistants
{
    ...
    public partial class AssistantPageableListOfVectorStore
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AssistantPageableListOfVectorStore"/>. </summary>
        ...
        internal AssistantPageableListOfVectorStore(IEnumerable<VectorStore> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal AssistantPageableListOfVectorStore(AssistantPageableListOfVectorStoreObject @object, IReadOnlyList<VectorStore> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="AssistantPageableListOfVectorStore"/> for deserialization. </summary>
        internal AssistantPageableListOfVectorStore()
        {
        }

        /// <summary> The object type, which is always list. </summary>
        public AssistantPageableListOfVectorStoreObject Object { get; } = AssistantPageableListOfVectorStoreObject.List;
