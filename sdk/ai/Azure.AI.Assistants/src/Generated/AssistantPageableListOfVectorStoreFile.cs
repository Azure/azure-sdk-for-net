...
namespace Azure.AI.Assistants
{
    ...
    public partial class AssistantPageableListOfVectorStoreFile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssistantPageableListOfVectorStoreFile"/>. </summary>
        ...
        internal AssistantPageableListOfVectorStoreFile(IEnumerable<VectorStoreFile> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal AssistantPageableListOfVectorStoreFile(AssistantPageableListOfVectorStoreFileObject @object, IReadOnlyList<VectorStoreFile> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="AssistantPageableListOfVectorStoreFile"/> for deserialization. </summary>
        internal AssistantPageableListOfVectorStoreFile()
        {
        }

        /// <summary> The object type, which is always list. </summary>
        public AssistantPageableListOfVectorStoreFileObject Object { get; } = AssistantPageableListOfVectorStoreFileObject.List;
