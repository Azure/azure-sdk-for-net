...
{
    internal partial class CreateAssistantRequest : IUtf8JsonSerializable, IJsonModel<CreateAssistantRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateAssistantRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static CreateAssistantRequest FromResponse(Response response)
        {
