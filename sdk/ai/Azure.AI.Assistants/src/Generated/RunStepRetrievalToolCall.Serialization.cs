...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepRetrievalToolCall>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<RunStepRetrievalToolCall>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunStepRetrievalToolCall)} does not support writing '{format}' format.");
            }
        ...
        RunStepRetrievalToolCall IJsonModel<RunStepRetrievalToolCall>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunStepRetrievalToolCall)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RunStepRetrievalToolCall>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RunStepRetrievalToolCall)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RunStepRetrievalToolCall IPersistableModel<RunStepRetrievalToolCall>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RunStepRetrievalToolCall)} does not support reading '{options.Format}' format.");
            }
        }
