...
```C# Snippet:Sample_CreateAgentClient_Function_2
...
Synchronous sample:
```C# Snippet:Sample_CreateAgent_Function_Sync_2
...
Synchronous sample:
```C# Snippet:Sample_WaitForResponse_Function_Sync_2
...
Synchronous sample:
```C# Snippet:Sample_CreateResponse_Function_Sync_2
