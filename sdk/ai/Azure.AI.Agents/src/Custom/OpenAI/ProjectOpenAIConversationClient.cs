...
public partial class ProjectOpenAIConversationClient : ConversationClient
{
    ...
    {
        options ??= new();
        ClientResult protocolResult = base.CreateConversation(BinaryContent.Create(ModelReaderWriter.Write(options, ModelSerializationExtensions.WireOptions, AzureAIAgentsContext.Default)), cancellationToken.ToRequestOptions());
    ...
    {
        options ??= new();
        ClientResult protocolResult = await base.CreateConversationAsync(BinaryContent.Create(ModelReaderWriter.Write(options, ModelSerializationExtensions.WireOptions, AzureAIAgentsContext.Default)), cancellationToken.ToRequestOptions()).ConfigureAwait(false);
        return protocolResult.ToAgentClientResult<AgentConversation>();
    }
    ...
    public virtual CollectionResult<AgentConversation> GetAgentConversations(int? limit = default, AgentListOrder? order = default, string after = default, string before = default, string agentName = default, string agentId = default, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
    /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
    public virtual AsyncCollectionResult<AgentConversation> GetAgentConversationsAsync(int? limit = default, AgentListOrder? order = default, string after = default, string before = default, string agentName = default, string agentId = default, CancellationToken cancellationToken = default)
    {
    ...
    {
        ClientResult protocolResult = base.UpdateConversation(conversationId, BinaryContent.Create(ModelReaderWriter.Write(options, ModelSerializationExtensions.WireOptions, AzureAIAgentsContext.Default)), cancellationToken.ToRequestOptions());
        return protocolResult.ToAgentClientResult<AgentConversation>();
    }
    ...
    {
        ClientResult protocolResult = await base.UpdateConversationAsync(conversationId, BinaryContent.Create(ModelReaderWriter.Write(options, ModelSerializationExtensions.WireOptions, AzureAIAgentsContext.Default)), cancellationToken.ToRequestOptions()).ConfigureAwait(false);
        return protocolResult.ToAgentClientResult<AgentConversation>();
    }
