...
namespace Azure.AI.Agents
{
    ...
    public partial class AgentsClient
    {
        ...
        public AgentsClient(string connectionString, TokenCredential credential) : this(connectionString, credential, new AgentsClientOptions())
        {
        }
        ...
        public AgentsClient(string connectionString, TokenCredential credential, AgentsClientOptions options)
