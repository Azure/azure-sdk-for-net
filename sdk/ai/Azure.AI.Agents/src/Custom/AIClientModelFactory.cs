...
{
    /// <summary> Initializes a new instance of <see cref="Azure.AI.Agents.Agent"/>. </summary>
    ...
    /// </param>
    /// <param name="metadata"> A set of up to 16 key/value pairs that can be attached to an object, used for storing additional information about that object in a structured format. Keys may be up to 64 characters in length and values may be up to 512 characters in length. </param>
    /// <returns> A new <see cref="Azure.AI.Agents.AgentThread"/> instance for mocking. </returns>
    ...
    /// <summary> Initializes a new instance of <see cref="Azure.AI.Agents.ThreadRun"/>. </summary>
    /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
    ...
    /// Please note <see cref="Azure.AI.Agents.RequiredAction"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    /// <returns> A new <see cref="Azure.AI.Agents.ThreadRun"/> instance for mocking. </returns>
    ...
    /// <summary> Initializes a new instance of <see cref="Azure.AI.Agents.AgentFile"/>. </summary>
    /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
    /// <param name="size"> The size of the file, in bytes. </param>
    /// <param name="filename"> The name of the file. </param>
    /// <param name="createdAt"> The Unix timestamp, in seconds, representing when this object was created. </param>
    /// <param name="purpose"> The intended purpose of a file. </param>
    /// <returns> A new <see cref="Azure.AI.Agents.AgentFile"/> instance for mocking. </returns>
    ...
    /// <summary> Initializes a new instance of <see cref="Azure.AI.Agents.RunStep"/>. </summary>
    /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
    ...
    /// <returns> A new <see cref="Azure.AI.Agents.RunStep"/> instance for mocking. </returns>
    ...
    /// <summary> Initializes a new instance of <see cref="Azure.AI.Agents.ThreadMessage"/>. </summary>
    /// <param name="id"> The identifier, which can be referenced in API endpoints. </param>
    /// <param name="createdAt"> The Unix timestamp, in seconds, representing when this object was created. </param>
    ...
    /// <returns> A new <see cref="Azure.AI.Agents.ThreadMessage"/> instance for mocking. </returns>
    ...
    /// <summary>
    /// Instantiates a new instance of <see cref="Azure.AI.Agents.SubmitToolOutputsAction"/>.
    /// </summary>
