...
{
    /// <summary> The MemoryStoreClient sub-client. </summary>
    public partial class MemoryStoreClient
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;

        /// <summary> Initializes a new instance of MemoryStoreClient for mocking. </summary>
        ...
        internal MemoryStoreClient(ClientPipeline pipeline, Uri endpoint, string apiVersion)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
