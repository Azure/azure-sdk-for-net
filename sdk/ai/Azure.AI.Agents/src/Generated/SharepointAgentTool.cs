...
namespace Azure.AI.Agents
{
    ...
    public partial class SharepointAgentTool : AgentTool
    {
        ...
        public SharepointAgentTool(SharepointGroundingToolParameters sharepointGroundingPreview) : base(ToolType.SharepointGroundingPreview)
        {
        ...
        /// <param name="sharepointGroundingPreview"> The sharepoint grounding tool parameters. </param>
        internal SharepointAgentTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, SharepointGroundingToolParameters sharepointGroundingPreview) : base(@type, additionalBinaryDataProperties)
        {
            SharepointGroundingPreview = sharepointGroundingPreview;
        }
