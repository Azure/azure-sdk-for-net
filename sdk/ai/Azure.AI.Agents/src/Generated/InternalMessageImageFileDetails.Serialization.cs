...
namespace Azure.AI.Agents
{
    internal partial class InternalMessageImageFileDetails : IUtf8JsonSerializable, IJsonModel<InternalMessageImageFileDetails>
    {
        ...
        InternalMessageImageFileDetails IJsonModel<InternalMessageImageFileDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalMessageImageFileDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<InternalMessageImageFileDetails>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalMessageImageFileDetails>)this).GetFormatFromOptions(options) : options.Format;
        ...
        InternalMessageImageFileDetails IPersistableModel<InternalMessageImageFileDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalMessageImageFileDetails>)this).GetFormatFromOptions(options) : options.Format;
