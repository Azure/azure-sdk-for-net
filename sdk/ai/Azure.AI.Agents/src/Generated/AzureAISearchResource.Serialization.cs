...
{
    public partial class AzureAISearchResource : IUtf8JsonSerializable, IJsonModel<AzureAISearchResource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureAISearchResource>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureAISearchResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureAISearchResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureAISearchResource IJsonModel<AzureAISearchResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureAISearchResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureAISearchResource IPersistableModel<AzureAISearchResource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureAISearchResource>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AzureAISearchResource>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
