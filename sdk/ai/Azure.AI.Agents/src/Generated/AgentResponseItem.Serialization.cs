...
namespace Azure.AI.Agents
{
    ...
    /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="AgentStructuredOutputsResponseItem"/>, <see cref="AgentWorkflowActionResponseItem"/>, <see cref="OAuthConsentRequestItemResource"/>, and <see cref="MemorySearchToolCallItemResource"/>.
    /// </summary>
    ...
    public abstract partial class AgentResponseItem : IJsonModel<AgentResponseItem>
    {
            ...
            if (element.TryGetProperty("type"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "oauth_consent_request":
                        return OAuthConsentRequestItemResource.DeserializeOAuthConsentRequestItemResource(element, options);
                    case "message":
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="AgentResponseItem"/> from. </param>
        public static explicit operator AgentResponseItem(ClientResult result)
        {
            PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeAgentResponseItem(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
