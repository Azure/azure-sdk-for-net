...
namespace OpenAI
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InternalLocalShellToolCallOutputItemParam"/> for deserialization. </summary>
        internal InternalLocalShellToolCallOutputItemParam()
        {
        }
        ...
        internal static InternalLocalShellToolCallOutputItemParam DeserializeInternalLocalShellToolCallOutputItemParam(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalLocalShellToolCallOutputItemParam(@type, additionalBinaryDataProperties, output);
        }
