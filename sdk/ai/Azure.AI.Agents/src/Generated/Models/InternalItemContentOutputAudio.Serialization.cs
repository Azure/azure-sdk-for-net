...
namespace OpenAI
{
    internal partial class InternalItemContentOutputAudio : InternalItemContent, IJsonModel<InternalItemContentOutputAudio>
    {
        /// <summary> Initializes a new instance of <see cref="InternalItemContentOutputAudio"/> for deserialization. </summary>
        internal InternalItemContentOutputAudio()
        {
        }
        ...
        internal static InternalItemContentOutputAudio DeserializeInternalItemContentOutputAudio(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalItemContentOutputAudio(@type, additionalBinaryDataProperties, data, transcript);
        }
