...
namespace Azure.AI.Agents
{
    ...
    public partial class OpenApiAnonymousAuthDetails : OpenApiAuthDetails, IJsonModel<OpenApiAnonymousAuthDetails>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OpenApiAnonymousAuthDetails IJsonModel<OpenApiAnonymousAuthDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OpenApiAnonymousAuthDetails)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OpenApiAnonymousAuthDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
