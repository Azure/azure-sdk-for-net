...
namespace OpenAI
{
    internal partial class InternalMCPCallItemParam : InternalItemParam
    {
        ...
        public InternalMCPCallItemParam(string serverLabel, string name, string arguments) : base(AgentResponseItemKind.McpCall)
        {
        ...
        internal InternalMCPCallItemParam(AgentResponseItemKind @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string serverLabel, string name, string arguments, string output, string error) : base(@type, additionalBinaryDataProperties)
        {
            ServerLabel = serverLabel;
            Name = name;
            Arguments = arguments;
