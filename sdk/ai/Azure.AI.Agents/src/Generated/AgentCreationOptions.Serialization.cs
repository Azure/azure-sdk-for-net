...
namespace Azure.AI.Agents
{
    internal partial class AgentCreationOptions : IJsonModel<AgentCreationOptions>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AgentCreationOptions DeserializeAgentCreationOptions(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="agentCreationOptions"> The <see cref="AgentCreationOptions"/> to serialize into <see cref="BinaryContent"/>. </param>
