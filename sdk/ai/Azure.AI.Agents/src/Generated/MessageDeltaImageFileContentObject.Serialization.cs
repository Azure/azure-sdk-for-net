...
{
    public partial class MessageDeltaImageFileContentObject : IUtf8JsonSerializable, IJsonModel<MessageDeltaImageFileContentObject>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageDeltaImageFileContentObject>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageDeltaImageFileContentObject>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MessageDeltaImageFileContentObject IJsonModel<MessageDeltaImageFileContentObject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageDeltaImageFileContentObject>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<MessageDeltaImageFileContentObject>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageDeltaImageFileContentObject>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MessageDeltaImageFileContentObject IPersistableModel<MessageDeltaImageFileContentObject>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageDeltaImageFileContentObject>)this).GetFormatFromOptions(options) : options.Format;
