...
{
    public class AgentClientTests : RecordedTestBase<AIAgentsTestEnvironment>
    {
        ...
        private AgentsClient GetClient()
        {
            ...
            {
                return InstrumentClient(new AgentsClient(connectionString, new MockCredential(), InstrumentClientOptions(new AgentsClientOptions())));
            }
            ...
            {
                return InstrumentClient(new AgentsClient(connectionString, new AzureCliCredential(), InstrumentClientOptions(new AgentsClientOptions())));
            }
            else
            {
                return InstrumentClient(new AgentsClient(connectionString, new DefaultAzureCredential(), InstrumentClientOptions(new AgentsClientOptions())));
            }
        }
