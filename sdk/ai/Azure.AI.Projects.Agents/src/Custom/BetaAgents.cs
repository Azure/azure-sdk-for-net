...
// Restores the strongly-typed GenerateAgent/GenerateAgentAsync(GenerateVoiceAgentRequest, ...)
// convenience overloads that existed directly on AgentAdministrationClient before this
// operation was relocated here by an unrelated upstream spec reorganization (see
// AgentAdministrationClient.GetBetaAgentsClient() and the CHANGELOG for details). Mirrors the
// implementation that previously lived in AgentAdministrationClient's own Custom file.
