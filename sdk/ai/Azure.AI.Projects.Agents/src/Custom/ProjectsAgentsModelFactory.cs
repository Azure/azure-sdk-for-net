...
[CodeGenSuppress("ProjectsAgentRecord", typeof(string), typeof(string), typeof(AgentState), typeof(AgentState), typeof(AgentStateSource?), typeof(AgentObjectVersions), typeof(AgentEndpointConfiguration), typeof(DigitalWorkerType?), typeof(AgentIdentity), typeof(AgentIdentity), typeof(AgentBlueprintReference), typeof(AgentCard))]
public partial class ProjectsAgentsModelFactory
{
    ...
    {
        return new ProjectsAgentRecord("agent", id, name, state, default, default, new AgentObjectVersions(), default, digitalWorkerType, default, default, default, default, null);
    }
    ...
    {
        return new ProjectsAgentRecord("agent", id, name, state, configurationState, stateSource, versions, agentEndpoint, digitalWorkerType, instanceIdentity, blueprint, blueprintReference, agentCard, additionalBinaryDataProperties: null);
    }
}
