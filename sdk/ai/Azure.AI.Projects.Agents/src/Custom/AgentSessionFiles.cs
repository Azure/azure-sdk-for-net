...
public partial class AgentSessionFiles
{
    ...
    public virtual async Task<ClientResult<SessionFileWriteResponse>> UploadSessionFileAsync(string sessionStoragePath, string localPath, string userIsolationKey=default, CancellationToken cancellationToken=default)
    {
        ...
        ClientResult result = await UploadSessionFileAsync(_agentName, _sessionId, sessionStoragePath, content, userIsolationKey, cancellationToken.ToRequestOptions()).ConfigureAwait(false);
    ...
    /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
    /// <returns> The response returned from the service. </returns>
    public ClientResult<SessionFileWriteResponse> UploadSessionFile(string sessionStoragePath, string localPath, string userIsolationKey=default, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNullOrEmpty(localPath, nameof(localPath));
        Argument.AssertNotNullOrEmpty(sessionStoragePath, nameof(sessionStoragePath));

        using BinaryContent content = BinaryContent.Create(new BinaryData(File.ReadAllBytes(localPath)));
        ClientResult result = UploadSessionFile(_agentName, _sessionId, sessionStoragePath, content, userIsolationKey, cancellationToken.ToRequestOptions());
        return ClientResult.FromValue((SessionFileWriteResponse)result, result.GetRawResponse());
    }
    ...
    /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
    /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
    public virtual CollectionResult<SessionDirectoryEntry> GetSessionFiles(string sessionStoragePath = default, string userIsolationKey = default, int? limit = default, AgentListOrder? order = default, string after = default, string before = default, CancellationToken cancellationToken = default)
    {
        ...
        return new InternalOpenAICollectionResultOfT<SessionDirectoryEntry>(
            ...
            new InternalOpenAICollectionResultOptions(limit, order?.ToString(), after, before, filters: [_agentName, _sessionId, sessionStoragePath, userIsolationKey]),
    ...
    /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
    /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
    public virtual AsyncCollectionResult<SessionDirectoryEntry> GetSessionFilesAsync(string sessionStoragePath = default, string userIsolationKey = default, int? limit = default, AgentListOrder? order = default, string after = default, string before = default, CancellationToken cancellationToken = default)
    {
        sessionStoragePath ??= "<unset>";
    ...
    /// <exception cref="ArgumentException"> <paramref name="localPath"/> or <paramref name="sessionStoragePath"/> is an empty string, and was expected to be non-empty. </exception>
    /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
    public virtual async Task<BinaryData> DownloadSessionFileAsync(string sessionStoragePath, string localPath, string userIsolationKey=default, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNullOrEmpty(sessionStoragePath, nameof(sessionStoragePath));
        Argument.AssertNotNullOrEmpty(localPath, nameof(localPath));

        ClientResult result = await DownloadSessionFileAsync(_agentName, _sessionId, sessionStoragePath, userIsolationKey, cancellationToken.ToRequestOptions()).ConfigureAwait(false);
    ...
    /// <exception cref="ArgumentException"> <paramref name="localPath"/> or <paramref name="sessionStoragePath"/> is an empty string, and was expected to be non-empty. </exception>
    /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
    public virtual BinaryData DownloadSessionFile(string sessionStoragePath, string localPath, string userIsolationKey=default, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNullOrEmpty(sessionStoragePath, nameof(sessionStoragePath));
        Argument.AssertNotNullOrEmpty(localPath, nameof(localPath));

        ClientResult result = DownloadSessionFile(_agentName, _sessionId, sessionStoragePath, userIsolationKey, cancellationToken.ToRequestOptions());
        File.WriteAllBytes(localPath, result.GetRawResponse().Content.ToArray());
        return result.GetRawResponse().Content;
    }
    ...
    /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
    public virtual ClientResult DeleteSessionFile(string localPath, bool? recursive = default, string userIsolationKey=default, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNullOrEmpty(localPath, nameof(localPath));

        return DeleteSessionFile(_agentName, _sessionId, localPath, recursive, userIsolationKey, cancellationToken.ToRequestOptions());
    }
    ...
    /// <exception cref="ArgumentException"> <paramref name="localPath"/> is an empty string, and was expected to be non-empty. </exception>
    /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
    public virtual async Task<ClientResult> DeleteSessionFileAsync(string localPath, bool? recursive = default, string userIsolationKey=default, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNullOrEmpty(localPath, nameof(localPath));

        return await DeleteSessionFileAsync(_agentName, _sessionId, localPath, recursive, userIsolationKey, cancellationToken.ToRequestOptions()).ConfigureAwait(false);
    }
}
