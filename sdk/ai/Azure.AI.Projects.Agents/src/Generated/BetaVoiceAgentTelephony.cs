...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class BetaVoiceAgentTelephony
    {
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        internal virtual ClientResult DeleteTelephonyBinding(string agentName, string bindingId, string ifMatch, AgentDefinitionOptInKeys? foundryFeatures = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        internal virtual async Task<ClientResult> DeleteTelephonyBindingAsync(string agentName, string bindingId, string ifMatch, AgentDefinitionOptInKeys? foundryFeatures = default, CancellationToken cancellationToken = default)
        {
