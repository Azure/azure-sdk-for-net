...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class AgentsClient
    {
        ...
        internal AgentsClient(AuthenticationPolicy authenticationPolicy, Uri endpoint, AgentsClientOptions options)
        {
            ...
            {
                Pipeline = ClientPipeline.Create(options, Array.Empty<PipelinePolicy>(), new PipelinePolicy[] { new UserAgentPolicy(typeof(AgentsClient).Assembly), authenticationPolicy }, Array.Empty<PipelinePolicy>());
            }
            else
            {
        ...
        public AgentsClient(AgentsClientSettings settings) : this(AuthenticationPolicy.Create(settings), settings?.Endpoint, settings?.Options)
        {
        }
