...
namespace OpenAI
{
    internal partial class InternalAgentResponse : IJsonModel<InternalAgentResponse>
    {
        ...
        internal static InternalAgentResponse DeserializeInternalAgentResponse(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ModelResponsePropertiesServiceTier? serviceTier = default;
            ModelResponsePropertiesPromptCacheRetention? promptCacheRetention = default;
            ...
            ResponsePropertiesTruncation? truncation = default;
            string id = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("service_tier"u8))
                {
                    ...
                    serviceTier = prop.Value.GetString().ToModelResponsePropertiesServiceTier();
                    continue;
                }
                if (prop.NameEquals("prompt_cache_retention"u8))
                {
                    ...
                    promptCacheRetention = prop.Value.GetString().ToModelResponsePropertiesPromptCacheRetention();
                    continue;
                }
                ...
                if (prop.NameEquals("truncation"u8))
                {
                    ...
                    truncation = prop.Value.GetString().ToResponsePropertiesTruncation();
                    continue;
                }
