...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class CreateAgentVersionRequest
    {
        ...
        internal CreateAgentVersionRequest(IDictionary<string, string> metadata, string description, AgentDefinition definition, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Metadata = metadata;
