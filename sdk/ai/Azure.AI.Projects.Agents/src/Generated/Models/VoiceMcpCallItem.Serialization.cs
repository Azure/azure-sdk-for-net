...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class VoiceMcpCallItem : RealtimeMCPToolCall, IJsonModel<VoiceMcpCallItem>
    {
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="VoiceMcpCallItem"/> from. </param>
        public static explicit operator VoiceMcpCallItem(ClientResult result)
        {
            PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeVoiceMcpCallItem(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
