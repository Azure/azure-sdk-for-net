...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class CreateAgentRequest1
    {
        ...
        internal CreateAgentRequest1(string name, IDictionary<string, string> metadata, string description, AgentDefinition definition, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Metadata = metadata;
