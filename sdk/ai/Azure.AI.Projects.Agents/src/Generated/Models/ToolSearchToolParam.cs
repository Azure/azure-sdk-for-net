...
namespace OpenAI
{
    ...
    public partial class ToolSearchToolParam : Tool
    {
        ...
        internal ToolSearchToolParam(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, ToolSearchExecutionKind? execution, string description, EmptyModelParam parameters) : base(@type, additionalBinaryDataProperties)
        {
            Execution = execution;
