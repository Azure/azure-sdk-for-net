...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class BingCustomSearchToolCallOutput : AgentResponseItem
    {
        ...
        internal BingCustomSearchToolCallOutput(string callId, ToolCallStatus status) : base("bing_custom_search_preview_call_output")
        {
            CallId = callId;
            Status = status;
        }
        ...
        /// <param name="status"> The status of the tool call. </param>
        internal BingCustomSearchToolCallOutput(AgentResponseItemKind @type, string id, AgentReference agentReference, string responseId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string callId, BinaryData output, ToolCallStatus status) : base(@type, id, agentReference, responseId, additionalBinaryDataProperties)
        {
            CallId = callId;
            Output = output;
            Status = status;
