...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class AgentOptimizationCandidate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AgentOptimizationCandidate"/>. </summary>
        ...
        internal AgentOptimizationCandidate(string name, double avgScore, double avgTokens)
        {
            Name = name;
        ...
        internal AgentOptimizationCandidate(string candidateId, string name, IDictionary<string, BinaryData> mutations, double avgScore, double avgTokens, string evalId, string evalRunId, PromotionInfo promotion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
