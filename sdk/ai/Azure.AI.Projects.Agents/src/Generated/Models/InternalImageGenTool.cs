...
namespace OpenAI
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::OpenAI.InternalImageGenTool"/>. </summary>
        public InternalImageGenTool() : base(global::OpenAI.ToolType.ImageGeneration)
        {
        ...
        /// </param>
        internal InternalImageGenTool(ToolType @type, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, ImageGenToolModel? model, ImageGenToolQuality? quality, ImageGenToolSize? size, ImageGenToolOutputFormat? outputFormat, long? outputCompression, ImageGenToolModeration? moderation, ImageGenToolBackground? background, InputFidelity? inputFidelity, InternalImageGenToolInputImageMask inputImageMask, long? partialImages, ImageGenActionEnum? action, string name, string description, IDictionary<string, global::Azure.AI.Projects.Agents.ToolConfig> toolConfigs) : base(@type, additionalBinaryDataProperties)
        {
            Model = model;
            Quality = quality;
            Size = size;
