...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class VoiceFunctionCallItem : RealtimeConversationItemFunctionCall
    {
        ...
        public VoiceFunctionCallItem(string name, string arguments) : base(name, arguments)
        {
