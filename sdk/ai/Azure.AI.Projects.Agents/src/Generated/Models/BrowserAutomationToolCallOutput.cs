...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class BrowserAutomationToolCallOutput : AgentResponseItem
    {
        ...
        internal BrowserAutomationToolCallOutput(string callId, ToolCallStatus status) : base("browser_automation_preview_call_output")
        {
            CallId = callId;
            Status = status;
        }
        ...
        /// <param name="status"> The status of the tool call. </param>
        internal BrowserAutomationToolCallOutput(AgentResponseItemKind @type, string id, AgentReference agentReference, string responseId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string callId, BinaryData output, ToolCallStatus status) : base(@type, id, agentReference, responseId, additionalBinaryDataProperties)
        {
            CallId = callId;
            Output = output;
            Status = status;
