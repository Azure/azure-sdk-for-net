...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class VoiceAgentAzureSemanticVadEnTurnDetection : VoiceAgentTurnDetectionConfig, IJsonModel<VoiceAgentAzureSemanticVadEnTurnDetection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VoiceAgentAzureSemanticVadEnTurnDetection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeVoiceAgentAzureSemanticVadEnTurnDetection(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(VoiceAgentAzureSemanticVadEnTurnDetection)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceAgentAzureSemanticVadEnTurnDetection)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VoiceAgentAzureSemanticVadEnTurnDetection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAgentAzureSemanticVadEnTurnDetection IPersistableModel<VoiceAgentAzureSemanticVadEnTurnDetection>.Create(BinaryData data, ModelReaderWriterOptions options) => (VoiceAgentAzureSemanticVadEnTurnDetection)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<VoiceAgentAzureSemanticVadEnTurnDetection>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<VoiceAgentAzureSemanticVadEnTurnDetection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAgentAzureSemanticVadEnTurnDetection)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAgentAzureSemanticVadEnTurnDetection IJsonModel<VoiceAgentAzureSemanticVadEnTurnDetection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VoiceAgentAzureSemanticVadEnTurnDetection)JsonModelCreateCore(ref reader, options);
        ...
        protected override VoiceAgentTurnDetectionConfig JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAgentAzureSemanticVadEnTurnDetection)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VoiceAgentAzureSemanticVadEnTurnDetection DeserializeVoiceAgentAzureSemanticVadEnTurnDetection(JsonElement element, ModelReaderWriterOptions options)
        {
