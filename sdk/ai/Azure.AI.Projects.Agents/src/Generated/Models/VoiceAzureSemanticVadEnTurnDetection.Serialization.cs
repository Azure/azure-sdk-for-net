...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class VoiceAzureSemanticVadEnTurnDetection : VoiceTurnDetection, IJsonModel<VoiceAzureSemanticVadEnTurnDetection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VoiceAzureSemanticVadEnTurnDetection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeVoiceAzureSemanticVadEnTurnDetection(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(VoiceAzureSemanticVadEnTurnDetection)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceAzureSemanticVadEnTurnDetection)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VoiceAzureSemanticVadEnTurnDetection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAzureSemanticVadEnTurnDetection IPersistableModel<VoiceAzureSemanticVadEnTurnDetection>.Create(BinaryData data, ModelReaderWriterOptions options) => (VoiceAzureSemanticVadEnTurnDetection)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<VoiceAzureSemanticVadEnTurnDetection>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<VoiceAzureSemanticVadEnTurnDetection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAzureSemanticVadEnTurnDetection)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAzureSemanticVadEnTurnDetection IJsonModel<VoiceAzureSemanticVadEnTurnDetection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VoiceAzureSemanticVadEnTurnDetection)JsonModelCreateCore(ref reader, options);
        ...
        protected override VoiceTurnDetection JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAzureSemanticVadEnTurnDetection)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VoiceAzureSemanticVadEnTurnDetection DeserializeVoiceAzureSemanticVadEnTurnDetection(JsonElement element, ModelReaderWriterOptions options)
        {
