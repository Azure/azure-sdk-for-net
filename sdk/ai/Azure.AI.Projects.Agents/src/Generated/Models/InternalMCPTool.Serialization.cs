...
namespace OpenAI
{
    internal partial class InternalMCPTool : ProjectsAgentTool, IJsonModel<global::OpenAI.InternalMCPTool>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (global::Azure.AI.Projects.Agents.Optional.IsDefined(ConnectorId))
            {
                writer.WritePropertyName("connector_id"u8);
                writer.WriteStringValue(ConnectorId.Value.ToSerialString());
            }
            if (global::Azure.AI.Projects.Agents.Optional.IsDefined(Authorization))
            {
                writer.WritePropertyName("authorization"u8);
                writer.WriteStringValue(Authorization);
            }
            if (global::Azure.AI.Projects.Agents.Optional.IsDefined(ServerDescription))
            {
                writer.WritePropertyName("server_description"u8);
                writer.WriteStringValue(ServerDescription);
            }
            if (global::Azure.AI.Projects.Agents.Optional.IsCollectionDefined(Headers))
            {
            ...
            if (global::Azure.AI.Projects.Agents.Optional.IsDefined(AllowedTools))
            {
