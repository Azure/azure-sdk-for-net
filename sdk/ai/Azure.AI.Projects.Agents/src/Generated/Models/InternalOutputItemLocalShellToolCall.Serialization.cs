...
namespace Azure.AI.Projects.Agents
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InternalOutputItemLocalShellToolCall"/> for deserialization. </summary>
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InternalOutputItemLocalShellToolCall>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeInternalOutputItemLocalShellToolCall(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(InternalOutputItemLocalShellToolCall)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalOutputItemLocalShellToolCall)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemLocalShellToolCall)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InternalOutputItemLocalShellToolCall IJsonModel<InternalOutputItemLocalShellToolCall>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InternalOutputItemLocalShellToolCall)JsonModelCreateCore(ref reader, options);
        ...
        protected override AgentResponseItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOutputItemLocalShellToolCall)} does not support reading '{format}' format.");
            }
