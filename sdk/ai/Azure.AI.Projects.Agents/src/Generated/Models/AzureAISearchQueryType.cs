...
namespace Azure.AI.Projects.Agents
{
    ...
    public readonly partial struct AzureAISearchQueryType : IEquatable<global::Azure.AI.Projects.Agents.AzureAISearchQueryType>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Projects.Agents.AzureAISearchQueryType"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Projects.Agents.AzureAISearchQueryType"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(AzureAISearchQueryType left, AzureAISearchQueryType right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.Projects.Agents.AzureAISearchQueryType"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(AzureAISearchQueryType left, AzureAISearchQueryType right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.Projects.Agents.AzureAISearchQueryType"/>. </summary>
        /// <param name="value"> The value. </param>
