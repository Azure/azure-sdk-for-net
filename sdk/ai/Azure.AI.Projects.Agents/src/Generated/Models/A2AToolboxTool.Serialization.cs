...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class A2AToolboxTool : ToolboxTool, IJsonModel<A2AToolboxTool>
    {
        /// <summary> Initializes a new instance of <see cref="A2AToolboxTool"/> for deserialization. </summary>
        internal A2AToolboxTool()
        {
        }
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<A2AToolboxTool>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeA2AToolboxTool(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(A2AToolboxTool)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(A2AToolboxTool)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<A2AToolboxTool>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        A2AToolboxTool IPersistableModel<A2AToolboxTool>.Create(BinaryData data, ModelReaderWriterOptions options) => (A2AToolboxTool)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<A2AToolboxTool>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<A2AToolboxTool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(A2AToolboxTool)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        A2AToolboxTool IJsonModel<A2AToolboxTool>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (A2AToolboxTool)JsonModelCreateCore(ref reader, options);
        ...
        protected override ToolboxTool JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(A2AToolboxTool)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static A2AToolboxTool DeserializeA2AToolboxTool(JsonElement element, ModelReaderWriterOptions options)
        {
