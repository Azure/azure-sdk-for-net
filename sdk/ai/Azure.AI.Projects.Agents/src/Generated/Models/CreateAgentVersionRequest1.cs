...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class CreateAgentVersionRequest1
    {
        ...
        internal CreateAgentVersionRequest1(IDictionary<string, string> metadata, string description, ProjectsAgentDefinition definition, AgentBlueprintReference blueprintReference, bool? draft, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Metadata = metadata;
