...
{
    internal partial class UnknownVoiceTurnDetection : VoiceTurnDetection, IJsonModel<VoiceTurnDetection>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownVoiceTurnDetection"/> for deserialization. </summary>
        internal UnknownVoiceTurnDetection()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownVoiceTurnDetection DeserializeUnknownVoiceTurnDetection(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownVoiceTurnDetection(@type, autoTruncate, additionalBinaryDataProperties);
        }
    }
}
