...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class VoiceAgentAzureSemanticVadTurnDetection : VoiceAgentTurnDetectionConfig, IJsonModel<VoiceAgentAzureSemanticVadTurnDetection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VoiceAgentAzureSemanticVadTurnDetection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeVoiceAgentAzureSemanticVadTurnDetection(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(VoiceAgentAzureSemanticVadTurnDetection)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceAgentAzureSemanticVadTurnDetection)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VoiceAgentAzureSemanticVadTurnDetection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAgentAzureSemanticVadTurnDetection IPersistableModel<VoiceAgentAzureSemanticVadTurnDetection>.Create(BinaryData data, ModelReaderWriterOptions options) => (VoiceAgentAzureSemanticVadTurnDetection)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<VoiceAgentAzureSemanticVadTurnDetection>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<VoiceAgentAzureSemanticVadTurnDetection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAgentAzureSemanticVadTurnDetection)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAgentAzureSemanticVadTurnDetection IJsonModel<VoiceAgentAzureSemanticVadTurnDetection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VoiceAgentAzureSemanticVadTurnDetection)JsonModelCreateCore(ref reader, options);
        ...
        protected override VoiceAgentTurnDetectionConfig JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAgentAzureSemanticVadTurnDetection)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VoiceAgentAzureSemanticVadTurnDetection DeserializeVoiceAgentAzureSemanticVadTurnDetection(JsonElement element, ModelReaderWriterOptions options)
        {
