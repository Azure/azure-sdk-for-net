...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class AgentsPagedResultToolboxVersionObject
    {
        ...
        internal AgentsPagedResultToolboxVersionObject(IEnumerable<ToolboxVersion> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultToolboxVersionObject(IList<ToolboxVersion> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<ToolboxVersion> Data { get; }
