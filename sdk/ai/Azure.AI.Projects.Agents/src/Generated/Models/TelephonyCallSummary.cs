...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class TelephonyCallSummary
    {
        ...
        internal TelephonyCallSummary(string id, TelephonyProvider provider, TelephonyCallStatus status, TelephonyCallPhase phase, DateTimeOffset startedOn)
        {
            Id = id;
            Provider = provider;
            Status = status;
