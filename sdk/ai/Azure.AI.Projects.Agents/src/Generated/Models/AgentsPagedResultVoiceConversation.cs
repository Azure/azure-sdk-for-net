...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class AgentsPagedResultVoiceConversation
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultVoiceConversation"/>. </summary>
        ...
        internal AgentsPagedResultVoiceConversation(IEnumerable<VoiceConversation> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultVoiceConversation(IList<VoiceConversation> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<VoiceConversation> Data { get; }
