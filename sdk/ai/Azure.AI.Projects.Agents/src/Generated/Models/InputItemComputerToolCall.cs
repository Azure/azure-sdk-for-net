...
namespace OpenAI
{
    ...
    internal partial class InputItemComputerToolCall : InputItem
    {
        ...
        /// </param>
        internal InputItemComputerToolCall(string id, string callId, InternalComputerAction action, IEnumerable<OpenAI.ComputerCallSafetyCheckParam> pendingSafetyChecks, OpenAI.OutputItemComputerToolCallStatus status) : base("computer_call")
        {
            Id = id;
            CallId = callId;
            Action = action;
        ...
        ///   `incomplete`. Populated when items are returned via API.
        /// </param>
        internal InputItemComputerToolCall(InputItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, InternalComputerAction action, IList<OpenAI.ComputerCallSafetyCheckParam> pendingSafetyChecks, OpenAI.OutputItemComputerToolCallStatus status) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Action = action;
