...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class AgentsPagedResultTelephonyCallSummary
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultTelephonyCallSummary"/>. </summary>
        ...
        internal AgentsPagedResultTelephonyCallSummary(IEnumerable<TelephonyCallSummary> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultTelephonyCallSummary(IList<TelephonyCallSummary> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<TelephonyCallSummary> Data { get; }
