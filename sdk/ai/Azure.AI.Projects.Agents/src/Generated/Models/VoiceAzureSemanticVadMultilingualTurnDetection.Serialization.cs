...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class VoiceAzureSemanticVadMultilingualTurnDetection : VoiceTurnDetection, IJsonModel<VoiceAzureSemanticVadMultilingualTurnDetection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VoiceAzureSemanticVadMultilingualTurnDetection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeVoiceAzureSemanticVadMultilingualTurnDetection(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(VoiceAzureSemanticVadMultilingualTurnDetection)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceAzureSemanticVadMultilingualTurnDetection)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VoiceAzureSemanticVadMultilingualTurnDetection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAzureSemanticVadMultilingualTurnDetection IPersistableModel<VoiceAzureSemanticVadMultilingualTurnDetection>.Create(BinaryData data, ModelReaderWriterOptions options) => (VoiceAzureSemanticVadMultilingualTurnDetection)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<VoiceAzureSemanticVadMultilingualTurnDetection>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<VoiceAzureSemanticVadMultilingualTurnDetection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAzureSemanticVadMultilingualTurnDetection)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAzureSemanticVadMultilingualTurnDetection IJsonModel<VoiceAzureSemanticVadMultilingualTurnDetection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VoiceAzureSemanticVadMultilingualTurnDetection)JsonModelCreateCore(ref reader, options);
        ...
        protected override VoiceTurnDetection JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAzureSemanticVadMultilingualTurnDetection)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VoiceAzureSemanticVadMultilingualTurnDetection DeserializeVoiceAzureSemanticVadMultilingualTurnDetection(JsonElement element, ModelReaderWriterOptions options)
        {
