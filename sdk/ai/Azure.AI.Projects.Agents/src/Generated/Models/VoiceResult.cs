...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class VoiceResult : VoiceResponseBase
    {
        /// <summary> Initializes a new instance of <see cref="VoiceResult"/>. </summary>
        ...
        internal VoiceResult(string id, string conversationId)
        {
            Id = id;
