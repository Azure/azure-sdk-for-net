...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class VoiceAzureSemanticVadTurnDetection : VoiceTurnDetection, IJsonModel<VoiceAzureSemanticVadTurnDetection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VoiceAzureSemanticVadTurnDetection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeVoiceAzureSemanticVadTurnDetection(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(VoiceAzureSemanticVadTurnDetection)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceAzureSemanticVadTurnDetection)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VoiceAzureSemanticVadTurnDetection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAzureSemanticVadTurnDetection IPersistableModel<VoiceAzureSemanticVadTurnDetection>.Create(BinaryData data, ModelReaderWriterOptions options) => (VoiceAzureSemanticVadTurnDetection)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<VoiceAzureSemanticVadTurnDetection>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<VoiceAzureSemanticVadTurnDetection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAzureSemanticVadTurnDetection)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VoiceAzureSemanticVadTurnDetection IJsonModel<VoiceAzureSemanticVadTurnDetection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VoiceAzureSemanticVadTurnDetection)JsonModelCreateCore(ref reader, options);
        ...
        protected override VoiceTurnDetection JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceAzureSemanticVadTurnDetection)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VoiceAzureSemanticVadTurnDetection DeserializeVoiceAzureSemanticVadTurnDetection(JsonElement element, ModelReaderWriterOptions options)
        {
