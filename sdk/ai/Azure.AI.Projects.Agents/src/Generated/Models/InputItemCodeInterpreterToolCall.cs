...
namespace OpenAI
{
    ...
    internal partial class InputItemCodeInterpreterToolCall : InputItem
    {
        ...
        internal InputItemCodeInterpreterToolCall(string id, OpenAI.OutputItemCodeInterpreterToolCallStatus status, string containerId, string code, IEnumerable<BinaryData> outputs) : base("code_interpreter_call")
        {
            Id = id;
            Status = status;
        ...
        /// <param name="code"></param>
        /// <param name="outputs"></param>
        internal InputItemCodeInterpreterToolCall(InputItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, OpenAI.OutputItemCodeInterpreterToolCallStatus status, string containerId, string code, IList<BinaryData> outputs) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            Status = status;
            ContainerId = containerId;
