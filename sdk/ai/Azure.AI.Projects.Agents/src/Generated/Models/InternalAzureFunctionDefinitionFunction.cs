...
{
    internal partial class InternalAzureFunctionDefinitionFunction
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="InternalAzureFunctionDefinitionFunction"/>. </summary>
        ...
        internal InternalAzureFunctionDefinitionFunction(string name, IDictionary<string, BinaryData> parameters)
        {
            Name = name;
        ...
        internal InternalAzureFunctionDefinitionFunction(string name, string description, IDictionary<string, BinaryData> parameters, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
