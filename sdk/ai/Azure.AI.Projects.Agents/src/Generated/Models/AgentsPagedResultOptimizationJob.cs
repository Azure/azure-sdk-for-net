...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class AgentsPagedResultOptimizationJob
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultOptimizationJob"/>. </summary>
        ...
        internal AgentsPagedResultOptimizationJob(IEnumerable<OptimizationJob> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultOptimizationJob(IList<OptimizationJob> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<OptimizationJob> Data { get; }
