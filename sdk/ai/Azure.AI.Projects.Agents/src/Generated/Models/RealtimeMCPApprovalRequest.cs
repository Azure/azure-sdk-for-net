...
namespace OpenAI
{
    ...
    public partial class RealtimeMCPApprovalRequest : RealtimeConversationItem
    {
        ...
        internal RealtimeMCPApprovalRequest(RealtimeConversationItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string serverLabel, string name, string arguments, DateTimeOffset? createdOn, string responseId) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            ServerLabel = serverLabel;
            Name = name;
