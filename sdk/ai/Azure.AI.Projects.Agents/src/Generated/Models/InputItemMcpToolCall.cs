...
namespace OpenAI
{
    ...
    internal partial class InputItemMcpToolCall : InputItem
    {
        ...
        internal InputItemMcpToolCall(string id, string serverLabel, string name, string arguments) : base("mcp_call")
        {
            Id = id;
