...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class A2AToolboxTool : ToolboxTool
    {
        /// <summary> Initializes a new instance of <see cref="A2AToolboxTool"/>. </summary>
        /// <param name="a2aVersion"> The A2A protocol version supported by the agent. </param>
        public A2AToolboxTool(A2AProtocolVersion a2aVersion) : base(ToolboxToolType.A2a)
        {
        ...
        /// </param>
        /// <param name="a2aVersion"> The A2A protocol version supported by the agent. </param>
        internal A2AToolboxTool(ToolboxToolType @type, string name, string description, IDictionary<string, ToolConfig> toolConfigs, IDictionary<string, BinaryData> additionalBinaryDataProperties, Uri baseUrl, string agentCardPath, string projectConnectionId, bool? sendCredentialsForAgentCard, A2AProtocolVersion a2aVersion) : base(@type, name, description, toolConfigs, additionalBinaryDataProperties)
        {
            BaseUrl = baseUrl;
