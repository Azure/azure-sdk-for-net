...
namespace OpenAI
{
    internal partial class InternalWebSearchPreviewTool : ProjectsAgentTool, IJsonModel<global::OpenAI.InternalWebSearchPreviewTool>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (global::Azure.AI.Projects.Agents.Optional.IsCollectionDefined(SearchContentTypes))
            {
        ...
        internal static InternalWebSearchPreviewTool DeserializeInternalWebSearchPreviewTool(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<global::OpenAI.SearchContentType> searchContentTypes = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("user_location"u8))
                {
                    ...
                    userLocation = global::Azure.AI.Projects.Agents.InternalApproximateLocation.DeserializeInternalApproximateLocation(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("search_content_types"u8))
                {
                    ...
                    List<global::OpenAI.SearchContentType> array = new List<global::OpenAI.SearchContentType>();
            ...
            return new InternalWebSearchPreviewTool(@type, additionalBinaryDataProperties, userLocation, searchContextSize, (searchContentTypes ?? new ChangeTrackingList<global::OpenAI.SearchContentType>()));
        }
    }
}
