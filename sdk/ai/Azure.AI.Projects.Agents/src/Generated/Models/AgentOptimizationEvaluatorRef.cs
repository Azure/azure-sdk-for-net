...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class AgentOptimizationEvaluatorRef
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AgentOptimizationEvaluatorRef"/>. </summary>
        ...
        internal AgentOptimizationEvaluatorRef(string name, string version, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Version = version;
