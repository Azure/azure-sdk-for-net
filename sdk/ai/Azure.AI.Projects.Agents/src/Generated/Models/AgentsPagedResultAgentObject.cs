...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class AgentsPagedResultAgentObject
    {
        ...
        internal AgentsPagedResultAgentObject(IEnumerable<AgentRecord> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultAgentObject(IList<AgentRecord> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<AgentRecord> Data { get; }
