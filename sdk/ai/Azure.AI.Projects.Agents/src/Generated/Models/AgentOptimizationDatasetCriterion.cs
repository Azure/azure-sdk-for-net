...
namespace Azure.AI.Projects.Agents
{
    ...
    public partial class AgentOptimizationDatasetCriterion
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AgentOptimizationDatasetCriterion"/>. </summary>
        ...
        internal AgentOptimizationDatasetCriterion(string name, string instruction, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Instruction = instruction;
