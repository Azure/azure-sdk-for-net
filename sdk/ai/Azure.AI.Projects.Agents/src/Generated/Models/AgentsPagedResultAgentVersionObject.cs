...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class AgentsPagedResultAgentVersionObject
    {
        ...
        internal AgentsPagedResultAgentVersionObject(IEnumerable<AgentVersion> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultAgentVersionObject(IList<AgentVersion> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<AgentVersion> Data { get; }
