...
namespace Azure.AI.Projects.Agents
{
    ...
    public static partial class ProjectsAgentsModelFactory
    {
        ...
        /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="Agents.FabricIQPreviewTool"/>, <see cref="Agents.BingGroundingTool"/>, <see cref="Agents.MicrosoftFabricPreviewTool"/>, <see cref="Agents.SharepointPreviewTool"/>, <see cref="Agents.AzureAISearchTool"/>, <see cref="Agents.OpenAPITool"/>, <see cref="Agents.BingCustomSearchPreviewTool"/>, <see cref="Agents.BrowserAutomationPreviewTool"/>, <see cref="Agents.AzureFunctionTool"/>, <see cref="Agents.CaptureStructuredOutputsTool"/>, <see cref="Agents.A2APreviewTool"/>, <see cref="Agents.WorkIQPreviewTool"/>, <see cref="Agents.MemorySearchPreviewTool"/>, and <see cref="OpenAI.ToolSearchToolParam"/>.
        /// </summary>
        /// <param name="type"></param>
        /// <returns> A new <see cref="OpenAI.Tool"/> instance for mocking. </returns>
        ...
        [Experimental("AAIP001")]
        public static A2APreviewTool A2APreviewTool(Uri baseUrl = default, string agentCardPath = default, string projectConnectionId = default, bool? sendCredentialsForAgentCard = default)
        {
        ...
        /// <returns> A new <see cref="OpenAI.RankingOptions"/> instance for mocking. </returns>
        ...
        public static ToolSearchToolParam ToolSearchToolParam(ToolSearchExecutionKind? execution = default, string description = default, EmptyModelParam parameters = default)
        {
        ...
        public static FileSearchToolboxTool FileSearchToolboxTool(string name = default, string description = default, IDictionary<string, ToolConfig> toolConfigs = default, long? maxNumResults = default, RankingOptions rankingOptions = default, BinaryData filters = default, IEnumerable<string> vectorStoreIds = default)
        {
            toolConfigs ??= new ChangeTrackingDictionary<string, ToolConfig>();
        ...
        public static AzureAISearchToolboxTool AzureAISearchToolboxTool(string name = default, string description = default, IDictionary<string, ToolConfig> toolConfigs = default, AzureAISearchToolResource azureAiSearch = default)
        {
            toolConfigs ??= new ChangeTrackingDictionary<string, ToolConfig>();
