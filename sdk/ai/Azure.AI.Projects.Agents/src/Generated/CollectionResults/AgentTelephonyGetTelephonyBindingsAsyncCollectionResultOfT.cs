...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class AgentTelephonyGetTelephonyBindingsAsyncCollectionResultOfT : AsyncCollectionResult<TelephonyBindingListItem>
    {
        ...
        /// <summary> Initializes a new instance of AgentTelephonyGetTelephonyBindingsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentTelephonyGetTelephonyBindingsAsyncCollectionResultOfT(AgentTelephony client, string agentName, string foundryFeatures, string provider, string status, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
        ...
        {
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("AgentTelephony.GetTelephonyBindings");
            scope.Start();
            try
            {
