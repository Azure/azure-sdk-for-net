...
namespace Azure.AI.Projects.Agents._Beta.VoiceAgents
{
    ...
    internal partial class BetaVoiceAgentsTelephonyGetTelephonyBindingsAsyncCollectionResultOfT : AsyncCollectionResult<TelephonyBindingListItem>
    {
        ...
        /// <summary> Initializes a new instance of BetaVoiceAgentsTelephonyGetTelephonyBindingsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BetaVoiceAgentsTelephonyGetTelephonyBindingsAsyncCollectionResultOfT(BetaVoiceAgentsTelephony client, string agentName, string foundryFeatures, string provider, string status, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
