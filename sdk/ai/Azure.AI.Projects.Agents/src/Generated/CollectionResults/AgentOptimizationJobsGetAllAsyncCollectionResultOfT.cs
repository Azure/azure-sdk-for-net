...
{
    internal partial class AgentOptimizationJobsGetAllAsyncCollectionResultOfT : AsyncCollectionResult<OptimizationJob>
    {
        ...
        public AgentOptimizationJobsGetAllAsyncCollectionResultOfT(AgentOptimizationJobs client, string foundryFeatures, int? limit, string order, string after, string before, string status, string agentName, RequestOptions options)
        {
            _client = client;
        ...
        protected override async IAsyncEnumerable<OptimizationJob> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (OptimizationJob item in ((AgentsPagedResultOptimizationJob)page).Data)
            {
                yield return item;
                await Task.Yield();
            }
