...
namespace Azure.AI.Projects.Agents._Beta.VoiceAgents
{
    ...
    internal partial class BetaVoiceAgentsConversationsGetAgentConversationResponsesCollectionResultOfT : CollectionResult<VoiceResult>
    {
        ...
        /// <summary> Initializes a new instance of BetaVoiceAgentsConversationsGetAgentConversationResponsesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BetaVoiceAgentsConversationsGetAgentConversationResponsesCollectionResultOfT(BetaVoiceAgentsConversations client, string agentName, string conversationId, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
