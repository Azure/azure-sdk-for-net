...
namespace Azure.AI.Projects.Agents
{
    internal partial class AgentTelephonyGetTelephonyBindingsCollectionResultOfT : CollectionResult<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of AgentTelephonyGetTelephonyBindingsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentTelephonyGetTelephonyBindingsCollectionResultOfT(AgentTelephony client, string agentName, string foundryFeatures, string provider, string status, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
