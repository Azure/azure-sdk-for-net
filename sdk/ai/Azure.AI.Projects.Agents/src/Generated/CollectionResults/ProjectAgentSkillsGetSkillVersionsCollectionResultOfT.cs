...
{
    internal partial class ProjectAgentSkillsGetSkillVersionsCollectionResultOfT : CollectionResult<global::Azure.AI.Projects.Agents.SkillVersion>
    {
        ...
        /// <summary> Initializes a new instance of ProjectAgentSkillsGetSkillVersionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProjectAgentSkillsGetSkillVersionsCollectionResultOfT(ProjectAgentSkills client, string name, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _name = name;
            _limit = limit;
        ...
        protected override IEnumerable<global::Azure.AI.Projects.Agents.SkillVersion> GetValuesFromPage(ClientResult page)
        {
            return ((AgentsPagedResultSkillVersion)page).Data;
        }
