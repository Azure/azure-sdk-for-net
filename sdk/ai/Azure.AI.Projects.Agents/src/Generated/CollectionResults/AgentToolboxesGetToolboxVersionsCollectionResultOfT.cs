...
{
    internal partial class AgentToolboxesGetToolboxVersionsCollectionResultOfT : CollectionResult<ToolboxVersion>
    {
        ...
        /// <summary> Initializes a new instance of AgentToolboxesGetToolboxVersionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentToolboxesGetToolboxVersionsCollectionResultOfT(AgentToolboxes client, string toolboxName, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
        ...
        protected override IEnumerable<ToolboxVersion> GetValuesFromPage(ClientResult page)
        {
