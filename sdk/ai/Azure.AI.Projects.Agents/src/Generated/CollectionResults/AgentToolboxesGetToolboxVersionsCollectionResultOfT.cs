...
namespace Azure.AI.Projects.Agents
{
    internal partial class AgentToolboxesGetToolboxVersionsCollectionResultOfT : CollectionResult<ToolboxVersion>
    {
        ...
        public AgentToolboxesGetToolboxVersionsCollectionResultOfT(AgentToolboxes client, string name, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _name = name;
            _limit = limit;
