...
namespace Azure.AI.Projects.Agents._Beta.VoiceAgents
{
    ...
    internal partial class BetaVoiceAgentsConversationsGetAgentConversationResponseItemsAsyncCollectionResultOfT : AsyncCollectionResult<RealtimeItem>
    {
        ...
        /// <summary> Initializes a new instance of BetaVoiceAgentsConversationsGetAgentConversationResponseItemsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BetaVoiceAgentsConversationsGetAgentConversationResponseItemsAsyncCollectionResultOfT(BetaVoiceAgentsConversations client, string agentName, string conversationId, string responseId, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
        ...
        {
            PipelineMessage message = _client.CreateGetAgentConversationResponseItemsRequest(_agentName, _conversationId, _responseId, _limit, _order, _after, _before, _options);
            ...
            while (true)
            {
                ...
                message = _client.CreateGetAgentConversationResponseItemsRequest(_agentName, _conversationId, _responseId, _limit, _order, nextToken, _before, _options);
            }
        }
        ...
        {
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("BetaVoiceAgentsConversations.GetAgentConversationResponseItems");
            scope.Start();
            try
            {
