...
{
    internal partial class BetaVoiceAgentsTelephonyGetTelephonyCallsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of BetaVoiceAgentsTelephonyGetTelephonyCallsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public BetaVoiceAgentsTelephonyGetTelephonyCallsCollectionResult(BetaVoiceAgentsTelephony client, string agentName, string foundryFeatures, string provider, string status, DateTimeOffset? startedAfter, DateTimeOffset? startedBefore, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
