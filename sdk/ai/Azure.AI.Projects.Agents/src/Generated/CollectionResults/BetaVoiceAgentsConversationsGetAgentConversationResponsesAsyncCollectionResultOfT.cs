...
namespace Azure.AI.Projects.Agents._Beta.VoiceAgents
{
    ...
    internal partial class BetaVoiceAgentsConversationsGetAgentConversationResponsesAsyncCollectionResultOfT : AsyncCollectionResult<VoiceResponse>
    {
        ...
        /// <summary> Initializes a new instance of BetaVoiceAgentsConversationsGetAgentConversationResponsesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BetaVoiceAgentsConversationsGetAgentConversationResponsesAsyncCollectionResultOfT(BetaVoiceAgentsConversations client, string agentName, string conversationId, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
