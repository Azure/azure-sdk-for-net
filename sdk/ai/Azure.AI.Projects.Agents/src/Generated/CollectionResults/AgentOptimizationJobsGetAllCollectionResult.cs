...
{
    internal partial class AgentOptimizationJobsGetAllCollectionResult : CollectionResult
    {
        ...
        public AgentOptimizationJobsGetAllCollectionResult(AgentOptimizationJobs client, string foundryFeatures, int? limit, string order, string after, string before, string status, string agentName, RequestOptions options)
        {
            _client = client;
