...
namespace Azure.AI.Projects.Agents
{
    internal partial class AgentSkillsGetSkillsAsyncCollectionResultOfT : AsyncCollectionResult<AgentsSkill>
    {
        ...
        /// <summary> Initializes a new instance of AgentSkillsGetSkillsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentSkillsGetSkillsAsyncCollectionResultOfT(AgentSkills client, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _limit = limit;
            _order = order;
