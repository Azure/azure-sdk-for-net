...
{
    internal partial class AgentTelephonyGetTelephonyCallsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AgentTelephonyGetTelephonyCallsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentTelephonyGetTelephonyCallsCollectionResult(AgentTelephony client, string agentName, string foundryFeatures, string provider, string status, DateTimeOffset? startedAfter, DateTimeOffset? startedBefore, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
