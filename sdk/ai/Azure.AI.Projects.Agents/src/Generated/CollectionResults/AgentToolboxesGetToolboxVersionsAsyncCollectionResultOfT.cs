...
{
    internal partial class AgentToolboxesGetToolboxVersionsAsyncCollectionResultOfT : AsyncCollectionResult<ToolboxVersion>
    {
        ...
        /// <summary> Initializes a new instance of AgentToolboxesGetToolboxVersionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentToolboxesGetToolboxVersionsAsyncCollectionResultOfT(AgentToolboxes client, string toolboxName, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
        ...
        protected override async IAsyncEnumerable<ToolboxVersion> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (ToolboxVersion item in ((AgentsPagedResultToolboxVersionObject)page).Data)
            {
                yield return item;
                await Task.Yield();
            }
