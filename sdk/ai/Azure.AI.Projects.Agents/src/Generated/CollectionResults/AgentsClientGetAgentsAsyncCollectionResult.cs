...
{
    internal partial class AgentsClientGetAgentsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AgentsClientGetAgentsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentsClientGetAgentsAsyncCollectionResult(AgentsClient client, string kind, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _kind = kind;
            _limit = limit;
