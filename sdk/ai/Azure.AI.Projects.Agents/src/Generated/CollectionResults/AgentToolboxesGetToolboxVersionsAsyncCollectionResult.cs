...
namespace Azure.AI.Projects.Agents
{
    internal partial class AgentToolboxesGetToolboxVersionsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public AgentToolboxesGetToolboxVersionsAsyncCollectionResult(AgentToolboxes client, string toolboxName, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
