...
{
    internal partial class AgentsClientGetAgentsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AgentsClientGetAgentsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentsClientGetAgentsCollectionResult(AgentsClient client, string kind, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _kind = kind;
            _limit = limit;
