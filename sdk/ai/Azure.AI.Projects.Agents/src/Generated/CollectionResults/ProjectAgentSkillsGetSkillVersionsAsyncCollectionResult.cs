...
{
    internal partial class ProjectAgentSkillsGetSkillVersionsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of ProjectAgentSkillsGetSkillVersionsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProjectAgentSkillsGetSkillVersionsAsyncCollectionResult(ProjectAgentSkills client, string name, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _name = name;
            _limit = limit;
