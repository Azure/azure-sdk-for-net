...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class BetaVoiceAgentsTelephonyGetTelephonyCallsAsyncCollectionResultOfT : AsyncCollectionResult<TelephonyCallSummary>
    {
        ...
        /// <summary> Initializes a new instance of BetaVoiceAgentsTelephonyGetTelephonyCallsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BetaVoiceAgentsTelephonyGetTelephonyCallsAsyncCollectionResultOfT(BetaVoiceAgentsTelephony client, string agentName, string foundryFeatures, string provider, string status, DateTimeOffset? startedAfter, DateTimeOffset? startedBefore, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
        ...
        protected override async IAsyncEnumerable<TelephonyCallSummary> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (TelephonyCallSummary item in ((AgentsPagedResultTelephonyCallSummary)page).Data)
            {
                yield return item;
                await Task.Yield();
            }
