...
namespace Azure.AI.Projects.Agents
{
    ...
    internal partial class AgentEndpointConversationsGetAgentConversationItemsCollectionResultOfT : CollectionResult<RealtimeItem>
    {
        ...
        /// <summary> Initializes a new instance of AgentEndpointConversationsGetAgentConversationItemsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentEndpointConversationsGetAgentConversationItemsCollectionResultOfT(AgentEndpointConversations client, string agentName, string conversationId, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
