namespace Azure.AI.Agents.Persistent
{
    ...
    public static partial class PersistentAgentsModelFactory
    {
        ...
        public static Azure.AI.Agents.Persistent.RunStepDeltaSharepointToolCall RunStepDeltaSharepointToolCall(int index = 0, string id = null, System.Collections.Generic.IReadOnlyDictionary<string, string> sharePoint = null) { throw null; }
