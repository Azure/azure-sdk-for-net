...
namespace System.Net.ServerSentEvents
{
    ...
    internal sealed class SseParser<T>
    {
        ...
        /// <exception cref="InvalidOperationException">The parser has already been enumerated. Such an exception may propagate out of a call to "IEnumerator.MoveNext"/>.</exception>
