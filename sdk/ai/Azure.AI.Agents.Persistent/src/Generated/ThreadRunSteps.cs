...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class ThreadRunSteps
    {
        ...
        /// <include file="Docs/ThreadRunSteps.xml" path="doc/members/member[@name='GetRunStepAsync(string,string,string,IEnumerable{RunAdditionalFieldList},CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="threadId"/>, <paramref name="runId"/> or <paramref name="stepId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="threadId"/>, <paramref name="runId"/> or <paramref name="stepId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ThreadRunSteps.xml" path="doc/members/member[@name='GetRunStep(string,string,string,IEnumerable{RunAdditionalFieldList},CancellationToken)']/*" />
        ...
        /// <include file="Docs/ThreadRunSteps.xml" path="doc/members/member[@name='GetRunStepAsync(string,string,string,IEnumerable{RunAdditionalFieldList},RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ThreadRunSteps.xml" path="doc/members/member[@name='GetRunStep(string,string,string,IEnumerable{RunAdditionalFieldList},RequestContext)']/*" />
