...
{
    public partial class MessageTextUriCitationDetails : IUtf8JsonSerializable, IJsonModel<MessageTextUriCitationDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTextUriCitationDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageTextUriCitationDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MessageTextUriCitationDetails IJsonModel<MessageTextUriCitationDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageTextUriCitationDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<MessageTextUriCitationDetails>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageTextUriCitationDetails>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MessageTextUriCitationDetails IPersistableModel<MessageTextUriCitationDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageTextUriCitationDetails>)this).GetFormatFromOptions(options) : options.Format;
