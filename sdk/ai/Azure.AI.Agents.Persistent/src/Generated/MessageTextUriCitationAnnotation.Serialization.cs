...
{
    public partial class MessageTextUriCitationAnnotation : IUtf8JsonSerializable, IJsonModel<MessageTextUriCitationAnnotation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTextUriCitationAnnotation>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageTextUriCitationAnnotation>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            ((IJsonModel<MessageTextUriCitationDetails>)UriCitation).Write(writer, options);
        ...
        MessageTextUriCitationAnnotation IJsonModel<MessageTextUriCitationAnnotation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageTextUriCitationAnnotation>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static MessageTextUriCitationAnnotation DeserializeMessageTextUriCitationAnnotation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    urlCitation = ModelSerializationExtensions.JsonDeserialize<MessageTextUriCitationDetails>(property.Value);
                    continue;
                }
        ...
        BinaryData IPersistableModel<MessageTextUriCitationAnnotation>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageTextUriCitationAnnotation>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MessageTextUriCitationAnnotation IPersistableModel<MessageTextUriCitationAnnotation>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageTextUriCitationAnnotation>)this).GetFormatFromOptions(options) : options.Format;
