...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class PersistentAgentPageableListOfVectorStoreFile
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="PersistentAgentPageableListOfVectorStoreFile"/>. </summary>
        ...
        internal PersistentAgentPageableListOfVectorStoreFile(IEnumerable<VectorStoreFile> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal PersistentAgentPageableListOfVectorStoreFile(PersistentAgentPageableListOfVectorStoreFileObject @object, IReadOnlyList<VectorStoreFile> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="PersistentAgentPageableListOfVectorStoreFile"/> for deserialization. </summary>
        internal PersistentAgentPageableListOfVectorStoreFile()
        {
        }

        /// <summary> The object type, which is always list. </summary>
        public PersistentAgentPageableListOfVectorStoreFileObject Object { get; } = PersistentAgentPageableListOfVectorStoreFileObject.List;
