...
{
    public partial class MessageInputImageUriBlock : IUtf8JsonSerializable, IJsonModel<MessageInputImageUriBlock>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageInputImageUriBlock>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MessageInputImageUriBlock>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageInputImageUriBlock>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<MessageInputImageUriBlock>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageInputImageUriBlock>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MessageInputImageUriBlock IPersistableModel<MessageInputImageUriBlock>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageInputImageUriBlock>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<MessageInputImageUriBlock>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
