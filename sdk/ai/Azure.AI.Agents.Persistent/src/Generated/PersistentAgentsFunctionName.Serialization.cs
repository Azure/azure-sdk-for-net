...
{
    public partial class PersistentAgentsFunctionName : IUtf8JsonSerializable, IJsonModel<PersistentAgentsFunctionName>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PersistentAgentsFunctionName>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PersistentAgentsFunctionName>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PersistentAgentsFunctionName IJsonModel<PersistentAgentsFunctionName>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PersistentAgentsFunctionName>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<PersistentAgentsFunctionName>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PersistentAgentsFunctionName>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PersistentAgentsFunctionName IPersistableModel<PersistentAgentsFunctionName>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PersistentAgentsFunctionName>)this).GetFormatFromOptions(options) : options.Format;
