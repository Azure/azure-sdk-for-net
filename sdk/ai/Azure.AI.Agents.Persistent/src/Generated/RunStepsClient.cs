...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class RunStepsClient
    {
        ...
        /// <summary> Initializes a new instance of RunStepsClient for mocking. </summary>
        ...
        internal RunStepsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> GetRunStepAsync(string threadId, string runId, string stepId, IEnumerable<RunAdditionalFieldList> include, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunStepsClient.GetRunStep");
            scope.Start();
            try
            {
        ...
        internal virtual async Task<Response> InternalGetRunStepsAsync(string threadId, string runId, IEnumerable<RunAdditionalFieldList> include, int? limit, string order, string after, string before, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunStepsClient.InternalGetRunSteps");
            scope.Start();
            try
            {
