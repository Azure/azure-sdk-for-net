...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class ActivityFunctionDefinition
    {
        ...
        internal ActivityFunctionDefinition(string description, ActivityFunctionParameters parameters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
