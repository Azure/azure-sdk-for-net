...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class MessageTextUriCitationAnnotation : MessageTextAnnotation
    {
        ...
        internal MessageTextUriCitationAnnotation(string @type, string text, IDictionary<string, BinaryData> additionalBinaryDataProperties, MessageTextUriCitationDetails uriCitation, int? startIndex, int? endIndex) : base(@type, text, additionalBinaryDataProperties)
        {
            UriCitation = uriCitation;
