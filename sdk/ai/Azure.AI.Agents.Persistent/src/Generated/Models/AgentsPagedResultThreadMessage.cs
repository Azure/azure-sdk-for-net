...
namespace Azure.AI.Agents.Persistent
{
    ...
    internal partial class AgentsPagedResultThreadMessage
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultThreadMessage"/>. </summary>
        ...
        internal AgentsPagedResultThreadMessage(IEnumerable<PersistentThreadMessage> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultThreadMessage(IList<PersistentThreadMessage> data, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            LastId = lastId;
            HasMore = hasMore;
        ...
        public IList<PersistentThreadMessage> Data { get; }
