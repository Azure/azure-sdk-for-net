...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class OpenApiConnectionSecurityScheme : IJsonModel<OpenApiConnectionSecurityScheme>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OpenApiConnectionSecurityScheme>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OpenApiConnectionSecurityScheme>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OpenApiConnectionSecurityScheme IPersistableModel<OpenApiConnectionSecurityScheme>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OpenApiConnectionSecurityScheme IJsonModel<OpenApiConnectionSecurityScheme>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
