...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class RunStepDeltaBingGroundingToolCall : RunStepDeltaToolCall
    {
        ...
        /// <param name="bingGrounding"> The dictionary with request and response from Bing Grounding search tool. </param>
        internal RunStepDeltaBingGroundingToolCall(int index, string id, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> bingGrounding) : base(index, id, @type, additionalBinaryDataProperties)
        {
            BingGrounding = bingGrounding;
        }
