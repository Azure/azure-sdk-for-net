...
namespace Azure.AI.Agents.Persistent
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Agents.Persistent.RunStepOpenAPIToolCall"/>. </summary>
        ...
        /// <param name="openAPI"> Reserved for future use. </param>
        internal RunStepOpenAPIToolCall(string @type, string id, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, IReadOnlyDictionary<string, string> openAPI) : base(@type, id, additionalBinaryDataProperties)
        {
            OpenAPI = openAPI;
        }
