...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class ResponseFormatJsonSchema : IJsonModel<ResponseFormatJsonSchema>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponseFormatJsonSchema IPersistableModel<ResponseFormatJsonSchema>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponseFormatJsonSchema IJsonModel<ResponseFormatJsonSchema>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
