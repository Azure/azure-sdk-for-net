...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class MessageTextFileCitationAnnotation : MessageTextAnnotation
    {
        ...
        internal MessageTextFileCitationAnnotation(string @type, string text, IDictionary<string, BinaryData> additionalBinaryDataProperties, InternalMessageTextFileCitationDetails internalDetails, int? startIndex, int? endIndex) : base(@type, text, additionalBinaryDataProperties)
        {
