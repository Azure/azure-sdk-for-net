...
namespace Azure.AI.Agents.Persistent
{
    ...
    internal partial class CreateThreadRequest
    {
        ...
        internal CreateThreadRequest(IList<ThreadMessageOptions> messages, ToolResources toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Messages = messages;
