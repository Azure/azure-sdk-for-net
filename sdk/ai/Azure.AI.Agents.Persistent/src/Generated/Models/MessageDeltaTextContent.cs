...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class MessageDeltaTextContent : MessageDeltaContent
    {
        ...
        internal MessageDeltaTextContent(int index, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, MessageDeltaTextContentObject text) : base(index, @type, additionalBinaryDataProperties)
        {
            Text = text;
        }
