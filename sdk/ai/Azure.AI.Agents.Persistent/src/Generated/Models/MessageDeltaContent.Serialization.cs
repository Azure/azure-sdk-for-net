    ...
    public abstract partial class MessageDeltaContent : IJsonModel<MessageDeltaContent>
    {
        ...
        internal static MessageDeltaContent DeserializeMessageDeltaContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("type"u8, out JsonElement discriminator))
            {
                ...
                {
                    case "image_file":
                        return MessageDeltaImageFileContent.DeserializeMessageDeltaImageFileContent(element, options);
                    case "text":
                        return MessageDeltaTextContent.DeserializeMessageDeltaTextContent(element, options);
                }
            }
