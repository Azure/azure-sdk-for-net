...
namespace Azure.AI.Agents.Persistent
{
    ...
    internal partial class CreateThreadRequest : IJsonModel<CreateThreadRequest>
    {
        ...
        /// <param name="createThreadRequest"> The <see cref="CreateThreadRequest"/> to serialize into <see cref="RequestContent"/>. </param>
        public static implicit operator RequestContent(CreateThreadRequest createThreadRequest)
        {
            if (createThreadRequest == null)
            {
                return null;
            }
            return RequestContent.Create(createThreadRequest, ModelSerializationExtensions.WireOptions);
        }
