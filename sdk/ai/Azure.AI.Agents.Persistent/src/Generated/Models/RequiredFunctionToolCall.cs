...
namespace Azure.AI.Agents.Persistent
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Agents.Persistent.RequiredFunctionToolCall"/>. </summary>
        ...
        /// <param name="id"> The ID of the tool call. This ID must be referenced when submitting tool outputs. </param>
        /// <param name="internalDetails"> Detailed information about the function to be executed by the tool that includes name and arguments. </param>
        internal RequiredFunctionToolCall(string @type, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties, string id, InternalRequiredFunctionToolCallDetails internalDetails) : base(@type, additionalBinaryDataProperties, id)
        {
            InternalDetails = internalDetails;
        }
    }
