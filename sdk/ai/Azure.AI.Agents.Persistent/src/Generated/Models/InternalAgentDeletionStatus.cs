...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class InternalAgentDeletionStatus
    {
        ...
        internal InternalAgentDeletionStatus(string id, bool deleted, string @object, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Deleted = deleted;
            Object = @object;
