...
{
    internal partial class InternalCodeInterpreterToolCallDetails : IJsonModel<InternalCodeInterpreterToolCallDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InternalCodeInterpreterToolCallDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InternalCodeInterpreterToolCallDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InternalCodeInterpreterToolCallDetails IPersistableModel<InternalCodeInterpreterToolCallDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InternalCodeInterpreterToolCallDetails IJsonModel<InternalCodeInterpreterToolCallDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static InternalCodeInterpreterToolCallDetails DeserializeInternalCodeInterpreterToolCallDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<RunStepCodeInterpreterToolCallOutput> outputs = default;
