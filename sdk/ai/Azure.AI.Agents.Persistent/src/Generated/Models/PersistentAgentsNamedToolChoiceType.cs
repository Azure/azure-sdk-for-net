...
namespace Azure.AI.Agents.Persistent
{
    ...
    public readonly partial struct PersistentAgentsNamedToolChoiceType : IEquatable<global::Azure.AI.Agents.Persistent.PersistentAgentsNamedToolChoiceType>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Agents.Persistent.PersistentAgentsNamedToolChoiceType"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Agents.Persistent.PersistentAgentsNamedToolChoiceType"/> values are the same. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.Agents.Persistent.PersistentAgentsNamedToolChoiceType"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(PersistentAgentsNamedToolChoiceType left, PersistentAgentsNamedToolChoiceType right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.Agents.Persistent.PersistentAgentsNamedToolChoiceType"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is PersistentAgentsNamedToolChoiceType other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(PersistentAgentsNamedToolChoiceType other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
