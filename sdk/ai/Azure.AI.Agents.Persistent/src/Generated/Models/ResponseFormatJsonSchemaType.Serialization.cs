...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class ResponseFormatJsonSchemaType : IJsonModel<ResponseFormatJsonSchemaType>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResponseFormatJsonSchemaType>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResponseFormatJsonSchemaType>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponseFormatJsonSchemaType IPersistableModel<ResponseFormatJsonSchemaType>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResponseFormatJsonSchemaType IJsonModel<ResponseFormatJsonSchemaType>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static ResponseFormatJsonSchemaType DeserializeResponseFormatJsonSchemaType(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    jsonSchema = ResponseFormatJsonSchema.DeserializeResponseFormatJsonSchema(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
