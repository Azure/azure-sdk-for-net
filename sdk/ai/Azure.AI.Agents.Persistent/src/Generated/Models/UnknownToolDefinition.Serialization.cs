...
{
    internal partial class UnknownToolDefinition : ToolDefinition, IJsonModel<global::Azure.AI.Agents.Persistent.ToolDefinition>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Agents.Persistent.UnknownToolDefinition"/> for deserialization. </summary>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownToolDefinition DeserializeUnknownToolDefinition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownToolDefinition(@type, additionalBinaryDataProperties);
        }
    }
}
