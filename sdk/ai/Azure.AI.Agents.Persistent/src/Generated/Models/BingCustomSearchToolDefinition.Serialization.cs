...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class BingCustomSearchToolDefinition : ToolDefinition, IJsonModel<BingCustomSearchToolDefinition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<BingCustomSearchToolDefinition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BingCustomSearchToolDefinition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BingCustomSearchToolDefinition IPersistableModel<BingCustomSearchToolDefinition>.Create(BinaryData data, ModelReaderWriterOptions options) => (BingCustomSearchToolDefinition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BingCustomSearchToolDefinition IJsonModel<BingCustomSearchToolDefinition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (BingCustomSearchToolDefinition)JsonModelCreateCore(ref reader, options);
        ...
        internal static BingCustomSearchToolDefinition DeserializeBingCustomSearchToolDefinition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    bingCustomSearch = BingCustomSearchToolParameters.DeserializeBingCustomSearchToolParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
