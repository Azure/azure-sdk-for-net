...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class MessageTextFilePathAnnotation : MessageTextAnnotation
    {
        ...
        internal MessageTextFilePathAnnotation(string @type, string text, IDictionary<string, BinaryData> additionalBinaryDataProperties, InternalMessageTextFilePathDetails internalDetails, int? startIndex, int? endIndex) : base(@type, text, additionalBinaryDataProperties)
        {
