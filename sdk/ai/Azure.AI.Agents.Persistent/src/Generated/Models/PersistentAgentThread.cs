...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class PersistentAgentThread
    {
        ...
        internal PersistentAgentThread(string id, string @object, DateTimeOffset createdAt, ToolResources toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Object = @object;
            CreatedAt = createdAt;
