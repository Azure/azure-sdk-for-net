...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class RunStepSharepointToolCall : RunStepToolCall, IJsonModel<RunStepSharepointToolCall>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RunStepSharepointToolCall>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RunStepSharepointToolCall>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RunStepSharepointToolCall IPersistableModel<RunStepSharepointToolCall>.Create(BinaryData data, ModelReaderWriterOptions options) => (RunStepSharepointToolCall)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RunStepSharepointToolCall IJsonModel<RunStepSharepointToolCall>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RunStepSharepointToolCall)JsonModelCreateCore(ref reader, options);
