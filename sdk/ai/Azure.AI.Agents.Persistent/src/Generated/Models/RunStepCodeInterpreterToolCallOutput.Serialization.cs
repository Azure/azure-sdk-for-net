...
namespace Azure.AI.Agents.Persistent
{
    ...
    public abstract partial class RunStepCodeInterpreterToolCallOutput : IJsonModel<RunStepCodeInterpreterToolCallOutput>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RunStepCodeInterpreterToolCallOutput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RunStepCodeInterpreterToolCallOutput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RunStepCodeInterpreterToolCallOutput IPersistableModel<RunStepCodeInterpreterToolCallOutput>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RunStepCodeInterpreterToolCallOutput IJsonModel<RunStepCodeInterpreterToolCallOutput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static RunStepCodeInterpreterToolCallOutput DeserializeRunStepCodeInterpreterToolCallOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("type"u8, out JsonElement discriminator))
            {
                ...
                {
                    case "logs":
                        return RunStepCodeInterpreterLogOutput.DeserializeRunStepCodeInterpreterLogOutput(element, options);
                    case "image":
                        return RunStepCodeInterpreterImageOutput.DeserializeRunStepCodeInterpreterImageOutput(element, options);
                }
            }
