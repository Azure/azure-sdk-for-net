...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class GetVectorStores
    {
        ...
        /// <summary> Initializes a new instance of GetVectorStores for mocking. </summary>
        protected GetVectorStores()
        {
        }
        ...
        internal GetVectorStores(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("GetVectorStores.GetVectorStores");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> CreateVectorStoreAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GetVectorStores.CreateVectorStore");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetVectorStoreAsync(string vectorStoreId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GetVectorStores.GetVectorStore");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> ModifyVectorStoreAsync(string vectorStoreId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GetVectorStores.ModifyVectorStore");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteVectorStoreAsync(string vectorStoreId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GetVectorStores.DeleteVectorStore");
            scope.Start();
            try
            {
