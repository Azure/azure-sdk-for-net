...
namespace Azure.AI.Agents.Persistent
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepCodeInterpreterLogOutput>)this).Write(writer, ModelSerializationExtensions.WireOptions);
