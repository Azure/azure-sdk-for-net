...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class PersistentAgentsFunctionName
    {
        ...
        internal PersistentAgentsFunctionName(string name, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="PersistentAgentsFunctionName"/> for deserialization. </summary>
