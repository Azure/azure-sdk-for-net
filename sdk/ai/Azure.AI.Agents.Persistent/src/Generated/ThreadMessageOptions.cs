...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class ThreadMessageOptions
    {
        ...
        internal ThreadMessageOptions(MessageRole role, BinaryData content, IList<MessageAttachment> attachments, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Role = role;
            Content = content;
