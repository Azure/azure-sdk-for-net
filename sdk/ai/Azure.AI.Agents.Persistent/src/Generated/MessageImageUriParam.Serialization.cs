...
{
    public partial class MessageImageUriParam : IUtf8JsonSerializable, IJsonModel<MessageImageUriParam>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageImageUriParam>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MessageImageUriParam>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageImageUriParam>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MessageImageUriParam IJsonModel<MessageImageUriParam>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageImageUriParam>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<MessageImageUriParam>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageImageUriParam>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MessageImageUriParam IPersistableModel<MessageImageUriParam>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageImageUriParam>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<MessageImageUriParam>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
