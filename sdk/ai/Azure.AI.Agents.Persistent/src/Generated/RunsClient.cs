...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class RunsClient
    {
        ...
        /// <summary> Initializes a new instance of RunsClient for mocking. </summary>
        ...
        internal RunsClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> CreateRunAsync(string threadId, RequestContent content, IEnumerable<RunAdditionalFieldList> include = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClient.CreateRun");
            scope.Start();
            try
            {
        ...
        internal virtual async Task<Response> InternalGetRunsAsync(string threadId, int? limit, string order, string after, string before, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClient.InternalGetRuns");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetRunAsync(string threadId, string runId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClient.GetRun");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> UpdateRunAsync(string threadId, string runId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClient.UpdateRun");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> CancelRunAsync(string threadId, string runId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("RunsClient.CancelRun");
            scope.Start();
            try
            {
