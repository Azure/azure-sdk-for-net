...
namespace Azure.AI.Agents.Persistent
{
    ...
    internal partial class OpenAIPageableListOfAgentThread
    {
        ...
        internal OpenAIPageableListOfAgentThread(IEnumerable<PersistentAgentThread> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal OpenAIPageableListOfAgentThread(OpenAIPageableListOfAgentThreadObject @object, IReadOnlyList<PersistentAgentThread> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        public IReadOnlyList<PersistentAgentThread> Data { get; }
