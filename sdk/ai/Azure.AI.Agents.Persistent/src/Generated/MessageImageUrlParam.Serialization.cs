...
{
    public partial class MessageImageUrlParam : IUtf8JsonSerializable, IJsonModel<MessageImageUrlParam>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageImageUrlParam>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MessageImageUrlParam>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageImageUrlParam>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MessageImageUrlParam IJsonModel<MessageImageUrlParam>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageImageUrlParam>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<MessageImageUrlParam>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageImageUrlParam>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MessageImageUrlParam IPersistableModel<MessageImageUrlParam>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageImageUrlParam>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<MessageImageUrlParam>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
