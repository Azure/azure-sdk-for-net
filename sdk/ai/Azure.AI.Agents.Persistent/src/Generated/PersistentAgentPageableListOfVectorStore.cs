...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class PersistentAgentPageableListOfVectorStore
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="PersistentAgentPageableListOfVectorStore"/>. </summary>
        ...
        internal PersistentAgentPageableListOfVectorStore(IEnumerable<VectorStore> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal PersistentAgentPageableListOfVectorStore(PersistentAgentPageableListOfVectorStoreObject @object, IReadOnlyList<VectorStore> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="PersistentAgentPageableListOfVectorStore"/> for deserialization. </summary>
        internal PersistentAgentPageableListOfVectorStore()
        {
        }

        /// <summary> The object type, which is always list. </summary>
        public PersistentAgentPageableListOfVectorStoreObject Object { get; } = PersistentAgentPageableListOfVectorStoreObject.List;
