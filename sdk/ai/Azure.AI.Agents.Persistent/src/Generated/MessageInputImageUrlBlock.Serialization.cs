...
{
    public partial class MessageInputImageUrlBlock : IUtf8JsonSerializable, IJsonModel<MessageInputImageUrlBlock>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageInputImageUrlBlock>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<MessageInputImageUrlBlock>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageInputImageUrlBlock>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MessageInputImageUrlBlock IJsonModel<MessageInputImageUrlBlock>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageInputImageUrlBlock>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<MessageInputImageUrlBlock>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageInputImageUrlBlock>)this).GetFormatFromOptions(options) : options.Format;
        ...
        MessageInputImageUrlBlock IPersistableModel<MessageInputImageUrlBlock>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageInputImageUrlBlock>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<MessageInputImageUrlBlock>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
