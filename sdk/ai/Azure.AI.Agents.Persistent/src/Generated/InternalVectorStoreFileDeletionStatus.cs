...
{
    /// <summary> Response object for deleting a vector store file relationship. </summary>
    internal partial class InternalVectorStoreFileDeletionStatus
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InternalVectorStoreFileDeletionStatus"/>. </summary>
        ...
        internal InternalVectorStoreFileDeletionStatus(string id, bool deleted, InternalVectorStoreFileDeletionStatusObject @object, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Deleted = deleted;
            Object = @object;
