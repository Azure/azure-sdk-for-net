...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class VectorStoreChunkingStrategy : IUtf8JsonSerializable, IJsonModel<VectorStoreChunkingStrategy>
    {
        ...
        internal static VectorStoreChunkingStrategy DeserializeVectorStoreChunkingStrategy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("type", out JsonElement discriminator))
            {
                ...
                {
                    case "auto": return VectorStoreAutoChunkingStrategy.DeserializeVectorStoreAutoChunkingStrategy(element, options);
