...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class VectorStoresClient
    {
        ...
        internal VectorStoresClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> DeleteVectorStoreAsync(string vectorStoreId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("VectorStoresClient.DeleteVectorStore");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<VectorStore> GetVectorStoresAsync(int? limit = null, ListSortOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => VectorStore.DeserializeVectorStore(e), ClientDiagnostics, _pipeline, "VectorStoresClient.GetVectorStores", "data", null, context);
        }
        ...
        public virtual Pageable<VectorStore> GetVectorStores(int? limit = null, ListSortOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetVectorStoresRequest(limit, order?.ToString(), after, before, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => VectorStore.DeserializeVectorStore(e), ClientDiagnostics, _pipeline, "VectorStoresClient.GetVectorStores", "data", null, context);
        }
