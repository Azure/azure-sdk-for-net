...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class Messages
    {
        ...
        internal Messages(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Messages.CreateMessage");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="threadId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Pageable<PersistentThreadMessage> GetMessages(string threadId, string runId = default, int? limit = default, ListSortOrder? order = default, string after = default, string before = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        /// <exception cref="ArgumentException"> <paramref name="threadId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual AsyncPageable<PersistentThreadMessage> GetMessagesAsync(string threadId, string runId = default, int? limit = default, ListSortOrder? order = default, string after = default, string before = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Messages.GetMessage");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Messages.UpdateMessage");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Messages.InternalDeleteMessage");
            scope.Start();
            try
            {
