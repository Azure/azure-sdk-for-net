...
{
    public partial class MessageDeltaTextUriCitationDetails : IUtf8JsonSerializable, IJsonModel<MessageDeltaTextUriCitationDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageDeltaTextUriCitationDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageDeltaTextUriCitationDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MessageDeltaTextUriCitationDetails IJsonModel<MessageDeltaTextUriCitationDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageDeltaTextUriCitationDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        MessageDeltaTextUriCitationDetails IPersistableModel<MessageDeltaTextUriCitationDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MessageDeltaTextUriCitationDetails>)this).GetFormatFromOptions(options) : options.Format;
