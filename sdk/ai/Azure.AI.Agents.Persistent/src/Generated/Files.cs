...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class Files
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Files.InternalListFiles");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Files.UploadFile");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Files.InternalDeleteFile");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Files.GetFile");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Files.GetFileContent");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(fileId, nameof(fileId));
