...
namespace Azure.AI.Agents.Persistent
{
    public partial class OpenApiToolDefinition : IUtf8JsonSerializable, IJsonModel<OpenApiToolDefinition>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            ((IJsonModel<OpenApiFunctionDefinition>)Openapi).Write(writer, options);
        }
        ...
        internal static OpenApiToolDefinition DeserializeOpenApiToolDefinition(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    openapi = ModelSerializationExtensions.JsonDeserialize<OpenApiFunctionDefinition>(property.Value);
                    continue;
                }
