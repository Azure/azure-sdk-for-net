...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class GetThreads
    {
        ...
        /// <summary> Initializes a new instance of GetThreads for mocking. </summary>
        ...
        internal GetThreads(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        public virtual async Task<Response> CreateThreadAsync(RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GetThreads.CreateThread");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("GetThreads.InternalGetThreads");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetThreadAsync(string threadId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GetThreads.GetThread");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> UpdateThreadAsync(string threadId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GetThreads.UpdateThread");
            scope.Start();
            try
            {
        ...
        internal virtual async Task<Response> InternalDeleteThreadAsync(string threadId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("GetThreads.InternalDeleteThread");
            scope.Start();
            try
            {
