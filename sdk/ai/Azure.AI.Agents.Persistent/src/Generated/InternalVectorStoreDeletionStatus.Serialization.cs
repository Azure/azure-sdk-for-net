...
{
    internal partial class InternalVectorStoreDeletionStatus : IUtf8JsonSerializable, IJsonModel<InternalVectorStoreDeletionStatus>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalVectorStoreDeletionStatus>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalVectorStoreDeletionStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        InternalVectorStoreDeletionStatus IJsonModel<InternalVectorStoreDeletionStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalVectorStoreDeletionStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<InternalVectorStoreDeletionStatus>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalVectorStoreDeletionStatus>)this).GetFormatFromOptions(options) : options.Format;
        ...
        InternalVectorStoreDeletionStatus IPersistableModel<InternalVectorStoreDeletionStatus>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalVectorStoreDeletionStatus>)this).GetFormatFromOptions(options) : options.Format;
