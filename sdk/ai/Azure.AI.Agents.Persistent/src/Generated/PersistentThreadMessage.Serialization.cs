...
{
    public partial class PersistentThreadMessage : IUtf8JsonSerializable, IJsonModel<PersistentThreadMessage>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PersistentThreadMessage>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PersistentThreadMessage>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        PersistentThreadMessage IJsonModel<PersistentThreadMessage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PersistentThreadMessage>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static PersistentThreadMessage DeserializePersistentThreadMessage(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<PersistentThreadMessage>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PersistentThreadMessage>)this).GetFormatFromOptions(options) : options.Format;
        ...
        PersistentThreadMessage IPersistableModel<PersistentThreadMessage>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PersistentThreadMessage>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static PersistentThreadMessage FromResponse(Response response)
        {
            ...
            return DeserializePersistentThreadMessage(document.RootElement);
        }
