...
namespace Azure.AI.Agents.Persistent
{
    ...
    internal partial class InternalOpenAIPageableListOfAgent
    {
        ...
        internal InternalOpenAIPageableListOfAgent(IEnumerable<PersistentAgent> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal InternalOpenAIPageableListOfAgent(OpenAIPageableListOfAgentObject @object, IReadOnlyList<PersistentAgent> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        public IReadOnlyList<PersistentAgent> Data { get; }
