...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class Runs
    {
        ...
        internal virtual Response InternalCreateRun(string threadId, RequestContent content, IEnumerable<RunAdditionalFieldList> include = default, RequestContext context = null)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Runs.InternalCreateRun");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        internal virtual async Task<Response> InternalCreateRunAsync(string threadId, RequestContent content, IEnumerable<RunAdditionalFieldList> include = default, RequestContext context = null)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Runs.InternalCreateRun");
            scope.Start();
            try
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual Pageable<BinaryData> GetRuns(string threadId, int? limit, string order, string after, string before, RequestContext context)
        {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual AsyncPageable<BinaryData> GetRunsAsync(string threadId, int? limit, string order, string after, string before, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        /// <exception cref="ArgumentException"> <paramref name="threadId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Pageable<ThreadRun> GetRuns(string threadId, int? limit = default, ListSortOrder? order = default, string after = default, string before = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        /// <exception cref="ArgumentException"> <paramref name="threadId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual AsyncPageable<ThreadRun> GetRunsAsync(string threadId, int? limit = default, ListSortOrder? order = default, string after = default, string before = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Runs.GetRun");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Runs.UpdateRun");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Runs.SubmitToolOutputsToRun");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Runs.CancelRun");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
