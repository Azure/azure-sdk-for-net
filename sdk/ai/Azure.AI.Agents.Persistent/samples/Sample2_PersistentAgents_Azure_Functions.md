...
**Note:** The Azure Function may be only used in standard agent setup. Please follow the [instruction](https://github.com/microsoft-foundry/foundry-samples) to find appropriate agent setup samples, as the specific setup path has been reorganized.
