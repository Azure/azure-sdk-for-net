...
public class ResponsesParityTests : AgentsTestBase
{
    ...
    public async Task FileSearchToolWorks()
    {
        ...
        OpenAIResponseClient responseClient = projectClient.OpenAI.GetOpenAIResponseClient(TestEnvironment.MODELDEPLOYMENTNAME);
    ...
    {
        AIProjectClient projectClient = GetTestProjectClient();
        OpenAIResponseClient responseClient = projectClient.OpenAI.GetProjectOpenAIResponseClientForModel(TestEnvironment.MODELDEPLOYMENTNAME);
    ...
    public async Task GetResponseStreamingWorks()
    {
        ...
        List<StreamingResponseUpdate> streamedUpdates = [];
        await foreach (StreamingResponseUpdate responseUpdate in projectClient.OpenAI.Responses.GetResponseStreamingAsync(response.Id))
        {
