...
public partial class ResponsesTelemetryTests : AgentsTestBase
{
    private const string TraceContentsEnvironmentVariable = "OTEL_INSTRUMENTATION_GENAI_CAPTURE_MESSAGE_CONTENT";
    private const string EnableOpenTelemetryEnvironmentVariable = "AZURE_EXPERIMENTAL_ENABLE_ACTIVITY_SOURCE";
    ...
    public async Task TestResponseWithTracingContentRecordingEnabled()
    {
        ...
        // Content recording is enabled — verify messages contain actual content
    ...
    public async Task TestResponseWithTracingContentRecordingDisabled()
    {
        ...
        // Content recording is disabled — messages should NOT contain actual text
        string inputMessages = span.GetTagItem("gen_ai.input.messages") as string;
    ...
    public async Task TestResponseWithAgentSpanNaming()
    {
        ...
        // Create an agent to use with responses
        ...
        try
        {
            ...
            // When using an agent, span should be named "invoke_agent {agentName}"
    ...
    private static void ReinitializeResponseScopeConfiguration()
    {
        ...
        Type scopeType = assembly.GetType("Azure.AI.Projects.OpenAI.Telemetry.OpenTelemetryResponseScope");
