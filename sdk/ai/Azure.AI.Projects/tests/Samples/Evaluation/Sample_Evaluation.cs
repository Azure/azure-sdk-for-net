...
{
    #region Snippet:Sample_GetError_Evaluations
    ...
    #endregion
    #region Snippet:Sample_GetResultCounts_Evaluations
    ...
    #endregion
    #region Snippet:Sample_GetStringValues_Evaluations
    ...
    #endregion
    #region Snippet:Sample_GetResultsList_Evaluations_Async
    ...
    #endregion
    #region Snippet:Sample_GetResultsList_Evaluations_Sync
    ...
    {
        #region Snippet:Sample_CreateClients_Evaluations
#if SNIPPET
