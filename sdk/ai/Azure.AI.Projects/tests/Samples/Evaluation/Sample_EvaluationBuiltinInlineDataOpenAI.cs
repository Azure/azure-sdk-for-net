...
public class Sample_EvaluationsBuiltinInlineDataOpenAI : SamplesBase
{
    #region Snippet:Sample_HeaderPolicy_EvaluationsBuiltinInlineDataOpenAI
    ...
    #endregion
    #region Snippet:Sample_GetError_EvaluationsBuiltinInlineDataOpenAI
    ...
    #endregion
    #region Snippet:Sample_GetResultCounts_EvaluationsBuiltinInlineDataOpenAI
    ...
    #endregion
    #region Snippet:Sample_GetStringValues_EvaluationsBuiltinInlineDataOpenAI
    ...
    #endregion
    #region Snippet:Sample_GetResultsList_EvaluationsBuiltinInlineDataOpenAI_Async
    ...
    #endregion
    #region Snippet:Sample_GetResultsList_EvaluationsBuiltinInlineDataOpenAI_Sync
    ...
    #endregion
    #region Snippet:Sample_CreateData_EvaluationsBuiltinInlineDataOpenAI
    ...
    #endregion
    #region Snippet:Sample_CreateDataSource_EvaluationsBuiltinInlineDataOpenAI
    ...
    [Test]
    [AsyncOnly]
    public async Task EvaluationsBuiltinInlineDataOpenAIExampleAsync()
    {
        #region Snippet:Sample_CreateClients_EvaluationsBuiltinInlineDataOpenAI
#if SNIPPET
        ...
        #endregion
        #region Snippet:Sample_CreateEvaluation_EvaluationsBuiltinInlineDataOpenAI_Async
        ...
        #endregion
        #region Snippet:Sample_GetEvaluation_EvaluationsBuiltinInlineDataOpenAI_Async
        ...
        #endregion
        #region Snippet:Sample_CreateRun_EvaluationsBuiltinInlineDataOpenAI_Async
        ...
        #endregion
        #region Snippet:Sample_GetRun_EvaluationsBuiltinInlineDataOpenAI_Async
        ...
        #endregion
        #region Snippet:Sample_WaitForRun_EvaluationsBuiltinInlineDataOpenAI_Async
        ...
        #endregion
        #region Snippet:Sample_ParseResults_EvaluationsBuiltinInlineDataOpenAI_Async
        ...
        Console.WriteLine($"------------------------------------------------------------");
        #endregion
        #region Snippet:Sample_Cleanup_EvaluationsBuiltinInlineDataOpenAI_Async
    ...
    [Test]
    [SyncOnly]
    public void EvaluationsBuiltinInlineDataOpenAIExampleSync()
    {
#if SNIPPET
        var endpoint = System.Environment.GetEnvironmentVariable("FOUNDRY_PROJECT_ENDPOINT");
        var modelDeploymentName = System.Environment.GetEnvironmentVariable("FOUNDRY_MODEL_NAME");
        ...
        OpenAIClient client = new(authenticationPolicy: auth, options: options);
        EvaluationClient evaluationClient = client.GetEvaluationClient();
        #region Snippet:Sample_CreateEvaluation_EvaluationsBuiltinInlineDataOpenAI_Sync
        Console.WriteLine("Creating Evaluation");
        using BinaryContent evaluationDataContent = BinaryContent.Create(GetDataConfig(modelDeploymentName));
        ...
        Console.WriteLine($"Evaluation created (id: {evaluationId}, name: {evaluationName})");
        #endregion
        #region Snippet:Sample_GetEvaluation_EvaluationsBuiltinInlineDataOpenAI_Sync
        Console.WriteLine("Get Evaluation by Id");
        ClientResult evaluationResponse = evaluationClient.GetEvaluation(evaluationId, new());
        Console.WriteLine($"Retrieved evaluation: {evaluationResponse.GetRawResponse().Content}");
        #endregion
        #region Snippet:Sample_CreateRun_EvaluationsBuiltinInlineDataOpenAI_Sync
        Console.WriteLine("Creating Eval Run with Inline Data");
        using BinaryContent runDataContent = BinaryContent.Create(GetData());
        ...
        Console.WriteLine($"Evaluation run created (id: {runId})");
        #endregion
        #region Snippet:Sample_GetRun_EvaluationsBuiltinInlineDataOpenAI_Sync
        Console.WriteLine("Get Eval Run by Id");
        ...
        Console.WriteLine($"Eval Run Response: {evalRunResponse.GetRawResponse().Content}");
        #endregion
        #region Snippet:Sample_WaitForRun_EvaluationsBuiltinInlineDataOpenAI_Sync
        while (runStatus != "failed" && runStatus != "completed")
        {
        ...
        #endregion
        #region Snippet:Sample_ParseResults_EvaluationsBuiltinInlineDataOpenAI_Sync
        Console.WriteLine("Evaluation run completed successfully!");
        Console.WriteLine($"Result Counts: {GetResultsCounts(run)}");
        ...
        Console.WriteLine($"------------------------------------------------------------");
        #endregion
        #region Snippet:Sample_Cleanup_EvaluationsBuiltinInlineDataOpenAI_Sync
        evaluationClient.DeleteEvaluation(evaluationId, new System.ClientModel.Primitives.RequestOptions());
        Console.WriteLine("Evaluation deleted");
        #endregion
    }

    public Sample_EvaluationsBuiltinInlineDataOpenAI(bool isAsync) : base(isAsync)
    {
    }
}
