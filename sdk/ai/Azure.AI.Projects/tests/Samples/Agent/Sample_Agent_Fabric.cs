...
public partial class Sample_Agent_Fabric : SamplesBase<AIProjectsTestEnvironment>
{
    [Test]
    [AsyncOnly]
    public async Task FabricExampleAsync()
    {
        #region Snippet:Fabric_CreateProject
#if SNIPPET
        ...
        var fabricConnectionName = TestEnvironment.FABRICCONNECTIONNAME;
#endif
        ...
        #endregion
        #region Snippet:FabricAsync_GetConnection
        ...
        #endregion
        #region Snippet:FabricAsync_CreateAgent
        ...
        # region Snippet:FabricAsync_CreateThreadMessage
        ...
        #region Snippet:FabricAsync_Print
        ...
        #endregion
        #region Snippet:FabricCleanupAsync
    ...
    public void FabricExample()
    {
        ...
        var projectClient = new AIProjectClient(connectionString, new DefaultAzureCredential());
        AgentsClient agentClient = projectClient.GetAgentsClient();
        #region Snippet:Fabric_GetConnection
        ...
        MicrosoftFabricToolDefinition fabricTool = new(connectionList);
        #endregion
        #region Snippet:Fabric_CreateAgent
        ...
        #endregion
        // Create thread for communication
        # region Snippet:Fabric_CreateThreadMessage
