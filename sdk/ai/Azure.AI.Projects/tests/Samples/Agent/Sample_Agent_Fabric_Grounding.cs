...
public partial class Sample_Agent_Fabric_Grounding : SamplesBase<AIProjectsTestEnvironment>
{
    [Test]
    public async Task FabricGroundingExample()
    {
        ...
        ConnectionResponse fabricConnection = await projectClient.GetConnectionsClient().GetConnectionAsync(TestEnvironment.FABRICCONNECTIONNAME);
