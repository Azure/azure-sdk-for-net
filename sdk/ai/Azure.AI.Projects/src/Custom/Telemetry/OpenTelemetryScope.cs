...
using Azure.Core;
using static Azure.AI.Projects.Telemetry.OpenTelemetryConstants;
...
namespace Azure.AI.Projects.Telemetry
{
    internal class OpenTelemetryScope : IDisposable
    {
        ...
        public void RecordCreateAgentResponse(ClientResult response)
        {
            ...
            {
                AgentRecord agentClientResult = response.ToProjectOpenAIResult<AgentRecord>();
        ...
        public void RecordCreateAgentVersionResponse(ClientResult response)
        {
            if (s_enableTelemetry)
            {
                AgentVersion agentVersion = response.ToProjectOpenAIResult<AgentVersion>();
                _response = new RecordedResponse(s_traceContent);
                //var agentResponse = Response.FromValue(PersistentAgent.FromResponse(response), response);
