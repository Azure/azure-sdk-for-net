...
namespace Azure.AI.Projects
{
    public partial class IndexesOperations
    {
        ...
        public virtual ClientResult<SearchIndex> CreateOrUpdate(string name, string version, SearchIndex index, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult<SearchIndex>> CreateOrUpdateAsync(string name, string version, SearchIndex index, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            Argument.AssertNotNullOrEmpty(version, nameof(version));
            Argument.AssertNotNull(index, nameof(index));
