...
namespace Azure.AI.Projects
{
    internal partial class AIProjectConnectionsOperationsGetConnectionsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public AIProjectConnectionsOperationsGetConnectionsAsyncCollectionResult(AIProjectConnectionsOperations client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
