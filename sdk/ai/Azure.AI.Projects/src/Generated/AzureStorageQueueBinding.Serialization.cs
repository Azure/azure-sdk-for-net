...
{
    public partial class AzureStorageQueueBinding : IUtf8JsonSerializable, IJsonModel<AzureStorageQueueBinding>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureStorageQueueBinding>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AzureStorageQueueBinding>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureStorageQueueBinding>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureStorageQueueBinding IJsonModel<AzureStorageQueueBinding>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureStorageQueueBinding>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AzureStorageQueueBinding>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureStorageQueueBinding>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureStorageQueueBinding IPersistableModel<AzureStorageQueueBinding>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureStorageQueueBinding>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AzureStorageQueueBinding>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
