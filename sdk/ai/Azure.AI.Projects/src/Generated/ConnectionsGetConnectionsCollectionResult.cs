...
{
    internal partial class ConnectionsGetConnectionsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of ConnectionsGetConnectionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConnectionsGetConnectionsCollectionResult(Connections client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
