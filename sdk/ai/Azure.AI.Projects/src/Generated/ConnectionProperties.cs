...
namespace Azure.AI.Projects
{
    ...
    public partial class ConnectionProperties
    {
        ...
        internal ConnectionProperties(string name, string id, ConnectionType type, string target, bool isDefault, BaseCredentials credentials, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
            Type = type;
