...
namespace Azure.AI.Projects
{
    ...
    public static partial class AIProjectsModelFactory
    {
        ...
        public static ConnectionProperties ConnectionProperties(string name = null, string id = null, ConnectionType type = default, string target = null, bool isDefault = default, BaseCredentials credentials = null, IReadOnlyDictionary<string, string> metadata = null)
        {
        ...
        public static BlobReference BlobReference(Uri blobUri = null, string storageAccountArmId = null, BlobReferenceSasCredential credential = null)
        {
            return new BlobReference(blobUri, storageAccountArmId, credential, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Projects.BlobReferenceSasCredential"/>. </summary>
        ...
        public static BlobReferenceSasCredential BlobReferenceSasCredential(Uri sasUri = null, BlobReferenceSasCredentialType type = default)
        {
            return new BlobReferenceSasCredential(sasUri, type, serializedAdditionalRawData: null);
        }
        ...
        public static DatasetIndex DatasetIndex(string type = null, string id = null, string name = null, string version = null, string description = null, IDictionary<string, string> tags = null)
        {
            tags ??= new Dictionary<string, string>();
        ...
        public static ModelDeployment ModelDeployment(string name = null, string modelName = null, string modelVersion = null, string modelPublisher = null, IReadOnlyDictionary<string, string> capabilities = null, ModelDeploymentSku sku = null, string connectionName = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Projects.ModelDeploymentSku"/>. </summary>
        ...
        public static ModelDeploymentSku ModelDeploymentSku(long capacity = default, string family = null, string name = null, string size = null, string tier = null)
        {
