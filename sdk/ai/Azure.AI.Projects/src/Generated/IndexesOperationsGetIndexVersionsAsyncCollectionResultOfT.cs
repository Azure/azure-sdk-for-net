...
{
    internal partial class IndexesOperationsGetIndexVersionsAsyncCollectionResultOfT : AsyncCollectionResult<SearchIndex>
    {
        private readonly IndexesOperations _client;
        private readonly string _name;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of IndexesOperationsGetIndexVersionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public IndexesOperationsGetIndexVersionsAsyncCollectionResultOfT(IndexesOperations client, string name, RequestOptions options)
        {
