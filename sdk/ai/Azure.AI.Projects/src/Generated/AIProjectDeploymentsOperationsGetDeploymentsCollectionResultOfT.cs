...
namespace Azure.AI.Projects
{
    internal partial class AIProjectDeploymentsOperationsGetDeploymentsCollectionResultOfT : CollectionResult<AIProjectDeployment>
    {
        ...
        public AIProjectDeploymentsOperationsGetDeploymentsCollectionResultOfT(AIProjectDeploymentsOperations client, string modelPublisher, string modelName, string deploymentType, string clientRequestId, RequestOptions options)
        {
            _client = client;
