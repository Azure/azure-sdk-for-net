...
{
    internal partial class ConnectionsOperationsGetConnectionsCollectionResultOfT : CollectionResult<ConnectionProperties>
    {
        ...
        /// <summary> Initializes a new instance of ConnectionsOperationsGetConnectionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConnectionsOperationsGetConnectionsCollectionResultOfT(ConnectionsOperations client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
