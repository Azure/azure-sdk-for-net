...
{
    public partial class AOAIModelConfig : IUtf8JsonSerializable, IJsonModel<AOAIModelConfig>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AOAIModelConfig>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AOAIModelConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AOAIModelConfig>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AOAIModelConfig IJsonModel<AOAIModelConfig>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AOAIModelConfig>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AOAIModelConfig>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AOAIModelConfig>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AOAIModelConfig IPersistableModel<AOAIModelConfig>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AOAIModelConfig>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AOAIModelConfig>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
