...
{
    internal partial class InsightsGetAllCollectionResultOfT : CollectionResult<Insight>
    {
        ...
        /// <summary> Initializes a new instance of InsightsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public InsightsGetAllCollectionResultOfT(Insights client, string @type, string evalId, string runId, string agentName, bool? includeCoordinates, string clientRequestId, RequestOptions options)
        {
            _client = client;
            _type = @type;
            _evalId = evalId;
        ...
        protected override IEnumerable<Insight> GetValuesFromPage(ClientResult page)
        {
