...
{
    internal partial class DeploymentsGetDeploymentsAsyncCollectionResultOfT : AsyncCollectionResult<AssetDeployment>
    {
        ...
        public DeploymentsGetDeploymentsAsyncCollectionResultOfT(Deployments client, string modelPublisher, string modelName, string deploymentType, string clientRequestId, RequestOptions options)
        {
            _client = client;
