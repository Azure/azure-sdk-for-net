...
{
    internal partial class ConnectionsOperationsGetConnectionsAsyncCollectionResultOfT : AsyncCollectionResult<ConnectionProperties>
    {
        ...
        /// <summary> Initializes a new instance of ConnectionsOperationsGetConnectionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConnectionsOperationsGetConnectionsAsyncCollectionResultOfT(ConnectionsOperations client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
