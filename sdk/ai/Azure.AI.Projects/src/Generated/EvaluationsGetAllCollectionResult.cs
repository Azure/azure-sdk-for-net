...
{
    internal partial class EvaluationsGetAllCollectionResult : CollectionResult
    {
        private readonly Evaluations _client;
        private readonly string _clientRequestId;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of EvaluationsGetAllCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluationsGetAllCollectionResult(Evaluations client, string clientRequestId, RequestOptions options)
        {
            _client = client;
