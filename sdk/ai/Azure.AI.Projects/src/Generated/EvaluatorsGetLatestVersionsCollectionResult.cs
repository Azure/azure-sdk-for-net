...
{
    internal partial class EvaluatorsGetLatestVersionsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of EvaluatorsGetLatestVersionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluatorsGetLatestVersionsCollectionResult(Evaluators client, string @type, int? limit, RequestOptions options)
        {
            _client = client;
            _type = @type;
            _limit = limit;
