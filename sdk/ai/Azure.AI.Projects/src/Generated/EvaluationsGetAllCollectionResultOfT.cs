...
{
    internal partial class EvaluationsGetAllCollectionResultOfT : CollectionResult<Evaluation>
    {
        private readonly Evaluations _client;
        private readonly string _clientRequestId;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of EvaluationsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluationsGetAllCollectionResultOfT(Evaluations client, string clientRequestId, RequestOptions options)
        {
            _client = client;
