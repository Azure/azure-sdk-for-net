...
namespace Azure.AI.Projects
{
    ...
    public partial class IndexesOperations
    {
        ...
        internal IndexesOperations(ClientPipeline pipeline, Uri endpoint, string apiVersion)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
        ...
        public virtual CollectionResult GetIndexVersions(string name, RequestOptions options)
        {
            ...
            return new IndexesOperationsGetIndexVersionsCollectionResult(this, name, options);
        }
        ...
        public virtual AsyncCollectionResult GetIndexVersionsAsync(string name, RequestOptions options)
        {
            ...
            return new IndexesOperationsGetIndexVersionsAsyncCollectionResult(this, name, options);
        }
        ...
        public virtual CollectionResult<SearchIndex> GetIndexVersions(string name, CancellationToken cancellationToken = default)
        {
            ...
            return new IndexesOperationsGetIndexVersionsCollectionResultOfT(this, name, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
        }
        ...
        public virtual AsyncCollectionResult<SearchIndex> GetIndexVersionsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            return new IndexesOperationsGetIndexVersionsAsyncCollectionResultOfT(this, name, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
        }
        ...
        {
            return new IndexesOperationsGetIndexesCollectionResult(this, options);
        }
        ...
        {
            return new IndexesOperationsGetIndexesAsyncCollectionResult(this, options);
        }
        ...
        {
            return new IndexesOperationsGetIndexesCollectionResultOfT(this, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
        }
        ...
        {
            return new IndexesOperationsGetIndexesAsyncCollectionResultOfT(this, cancellationToken.CanBeCanceled ? new RequestOptions { CancellationToken = cancellationToken } : null);
        }
