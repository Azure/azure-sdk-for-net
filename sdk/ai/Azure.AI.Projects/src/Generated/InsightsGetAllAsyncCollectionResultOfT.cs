...
namespace Azure.AI.Projects
{
    internal partial class InsightsGetAllAsyncCollectionResultOfT : AsyncCollectionResult<Insight>
    {
        ...
        public InsightsGetAllAsyncCollectionResultOfT(Insights client, string @type, string evalId, string runId, string agentName, bool? includeCoordinates, string clientRequestId, RequestOptions options)
        {
            _client = client;
            _type = @type;
            _evalId = evalId;
