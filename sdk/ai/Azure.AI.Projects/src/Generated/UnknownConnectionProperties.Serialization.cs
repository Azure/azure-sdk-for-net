...
{
    internal partial class UnknownConnectionProperties : IUtf8JsonSerializable, IJsonModel<ConnectionProperties>
    {
        ...
        internal static UnknownConnectionProperties DeserializeUnknownConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownConnectionProperties(authType, serializedAdditionalRawData);
        }
        ...
        internal static new UnknownConnectionProperties FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownConnectionProperties(document.RootElement);
        }
