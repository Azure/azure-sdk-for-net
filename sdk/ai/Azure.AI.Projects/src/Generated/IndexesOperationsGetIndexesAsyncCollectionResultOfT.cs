...
{
    internal partial class IndexesOperationsGetIndexesAsyncCollectionResultOfT : AsyncCollectionResult<SearchIndex>
    {
        private readonly IndexesOperations _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of IndexesOperationsGetIndexesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The IndexesOperations client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public IndexesOperationsGetIndexesAsyncCollectionResultOfT(IndexesOperations client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
