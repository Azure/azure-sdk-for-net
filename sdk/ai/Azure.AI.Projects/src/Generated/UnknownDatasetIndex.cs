...
{
    /// <summary> Unknown version of DatasetIndex. </summary>
    internal partial class UnknownDatasetIndex : DatasetIndex
    {
        ...
        internal UnknownDatasetIndex(IndexType type, string id, string name, string version, string description, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(type, id, name, version, description, tags, serializedAdditionalRawData)
        {
        }
