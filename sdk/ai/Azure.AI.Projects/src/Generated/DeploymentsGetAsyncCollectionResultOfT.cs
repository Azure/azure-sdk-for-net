...
{
    internal partial class DeploymentsGetAsyncCollectionResultOfT : AsyncCollectionResult<Deployment>
    {
        ...
        protected override async IAsyncEnumerable<Deployment> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (Deployment item in ((PagedDeployment)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
