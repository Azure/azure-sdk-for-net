...
namespace Azure.AI.Projects
{
    ...
    public static partial class AzureAIProjectsModelFactory
    {
        ...
        public static Connection Connection(string name = default, string id = default, ConnectionType @type = default, string target = default, bool isDefault = default, BaseCredentials credentials = default, IReadOnlyDictionary<string, string> metadata = default)
        {
        ...
        public static Evaluation Evaluation(string name = default, InputData data = default, string displayName = default, string description = default, string status = default, IDictionary<string, string> tags = default, IDictionary<string, string> properties = default, IDictionary<string, EvaluatorConfiguration> evaluators = default)
        {
        ...
        public static BlobReference BlobReference(string blobUri = default, string storageAccountArmId = default, SasCredential credential = default)
        {
        ...
        public static SasCredential SasCredential(string sasUri = default, string @type = default)
        {
            return new SasCredential(sasUri, @type, additionalBinaryDataProperties: null);
        }
        ...
        public static Index Index(string @type = default, string id = default, string name = default, string version = default, string description = default, IDictionary<string, string> tags = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static Deployment Deployment(string @type = default, string name = default)
        {
            return new UnknownDeployment(new DeploymentType(@type), name, additionalBinaryDataProperties: null);
        }
        ...
        public static ModelDeployment ModelDeployment(string name = default, string modelName = default, string modelVersion = default, string modelPublisher = default, IReadOnlyDictionary<string, string> capabilities = default, Sku sku = default, string connectionName = default)
        {
        ...
        public static Sku Sku(long capacity = default, string family = default, string name = default, string size = default, string tier = default)
        {
            return new Sku(
                capacity,
                family,
