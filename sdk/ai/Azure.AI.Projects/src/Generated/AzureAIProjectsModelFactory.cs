...
namespace Azure.AI.Projects
{
    ...
    public static partial class AzureAIProjectsModelFactory
    {
        ...
        [Experimental("AAIP001")]
        public static EvaluatorMetric EvaluatorMetric(EvaluatorMetricType? @type, EvaluatorMetricDirection? desirableDirection, float? minValue, float? maxValue, float? threshold, bool? isPrimary = default)
        {
        ...
        [Experimental("AAIP001")]
        public static CodeBasedEvaluatorDefinition CodeBasedEvaluatorDefinition(BinaryData initParameters, BinaryData dataSchema, IDictionary<string, EvaluatorMetric> metrics, string codeText, string entryPoint, string imageTag, Uri blobUri)
        {
            metrics ??= new ChangeTrackingDictionary<string, EvaluatorMetric>();
        ...
        [Experimental("AAIP001")]
        public static MemoryStoreDefaultOptions MemoryStoreDefaultOptions(bool isUserProfileEnabled, string userProfileDetails, bool isChatSummaryEnabled, bool? isProceduralMemoryEnabled, TimeSpan? defaultTtlSeconds)
        {
