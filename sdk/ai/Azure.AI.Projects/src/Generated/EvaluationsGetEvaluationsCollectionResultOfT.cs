...
{
    internal partial class EvaluationsGetEvaluationsCollectionResultOfT : CollectionResult<Evaluation>
    {
        private readonly Evaluations _client;
        private readonly string _clientRequestId;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of EvaluationsGetEvaluationsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluationsGetEvaluationsCollectionResultOfT(Evaluations client, string clientRequestId, RequestOptions options)
        {
            _client = client;
