...
namespace Azure.AI.Projects
{
    internal partial class AIProjectConnectionsOperationsGetConnectionsAsyncCollectionResultOfT : AsyncCollectionResult<AIProjectConnection>
    {
        ...
        public AIProjectConnectionsOperationsGetConnectionsAsyncCollectionResultOfT(AIProjectConnectionsOperations client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
