...
{
    internal partial class DatasetsGetVersionsCollectionResult : CollectionResult
    {
        private readonly Datasets _client;
        private readonly string _name;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of DatasetsGetVersionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public DatasetsGetVersionsCollectionResult(Datasets client, string name, RequestOptions options)
        {
