...
{
    internal partial class DatasetsGetCollectionResultOfT : CollectionResult<DatasetVersion>
    {
        private readonly Datasets _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of DatasetsGetCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Datasets client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public DatasetsGetCollectionResultOfT(Datasets client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
