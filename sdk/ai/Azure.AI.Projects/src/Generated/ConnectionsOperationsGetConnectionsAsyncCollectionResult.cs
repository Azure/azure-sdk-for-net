...
{
    internal partial class ConnectionsOperationsGetConnectionsAsyncCollectionResult : AsyncCollectionResult
    {
        private readonly ConnectionsOperations _client;
        private readonly string _connectionType;
        private readonly bool? _defaultConnection;
        private readonly string _clientRequestId;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of ConnectionsOperationsGetConnectionsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ConnectionsOperations client used to send requests. </param>
        ...
        public ConnectionsOperationsGetConnectionsAsyncCollectionResult(ConnectionsOperations client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
