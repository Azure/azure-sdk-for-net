...
namespace Azure.AI.Projects
{
    internal partial class ConnectionsGetAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        {
            PipelineMessage message = _client.CreateListRequest(_connectionType, _defaultConnection, _clientRequestId, _options);
            ...
            while (true)
            {
                ...
                message = _client.CreateNextListRequest(nextPageUri, _connectionType, _defaultConnection, _clientRequestId, _options);
            }
        }
