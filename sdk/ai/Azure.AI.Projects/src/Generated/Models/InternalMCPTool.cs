...
namespace OpenAI
{
    internal partial class InternalMCPTool : InternalTool
    {
        ...
        internal InternalMCPTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string serverLabel, Uri serverUrl, MCPToolConnectorId? connectorId, string tunnelId, string authorization, string serverDescription, IDictionary<string, string> headers, BinaryData allowedTools, IList<InternalCallableToolAllowedCaller> allowedCallers, BinaryData requireApproval, bool? deferLoading, string projectConnectionId, IDictionary<string, ToolConfig> toolConfigs) : base(@type, additionalBinaryDataProperties)
        {
            ServerLabel = serverLabel;
            ServerUrl = serverUrl;
