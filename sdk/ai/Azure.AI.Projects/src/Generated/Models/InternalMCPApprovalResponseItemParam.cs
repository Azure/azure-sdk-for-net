...
namespace OpenAI
{
    internal partial class InternalMCPApprovalResponseItemParam : InternalItemParam
    {
        ...
        public InternalMCPApprovalResponseItemParam(string approvalRequestId, bool approve) : base(ItemType.McpApprovalResponse)
        {
        ...
        internal InternalMCPApprovalResponseItemParam(ItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string approvalRequestId, bool approve, string reason) : base(@type, additionalBinaryDataProperties)
        {
            ApprovalRequestId = approvalRequestId;
            Approve = approve;
            Reason = reason;
