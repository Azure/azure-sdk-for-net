...
namespace Azure.AI.Projects
{
    ...
    /// </summary>
    public abstract partial class AssetDeployment
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AssetDeployment"/>. </summary>
        /// <param name="type"> The type of the deployment. </param>
        private protected AssetDeployment(DeploymentType @type)
        {
            Type = @type;
        }
        ...
        internal AssetDeployment(DeploymentType @type, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Name = name;
