...
namespace Azure.AI.Projects
{
    ...
    public partial class BlobReference
    {
        ...
        internal BlobReference(string blobUri, string storageAccountArmId, SasCredential credential, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            BlobUri = blobUri;
            StorageAccountArmId = storageAccountArmId;
            Credential = credential;
