...
namespace Azure.AI.Projects
{
    ...
    public partial class BingCustomSearchPreviewTool : InternalTool
    {
        ...
        /// </param>
        /// <param name="bingCustomSearchPreview"> The bing custom search tool parameters. </param>
        internal BingCustomSearchPreviewTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string description, IDictionary<string, ToolConfig> toolConfigs, BingCustomSearchToolParameters bingCustomSearchPreview) : base(@type, additionalBinaryDataProperties)
        {
            Name = name;
