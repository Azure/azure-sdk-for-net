...
namespace Azure.AI.Projects
{
    internal partial class InternalFunctionToolParam
    {
        ...
        internal InternalFunctionToolParam(string name, string description, InternalEmptyModelParam parameters, bool? strict, string @type, IDictionary<string, BinaryData> outputSchema, bool? deferLoading, IList<InternalCallableToolAllowedCaller> allowedCallers, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
