...
namespace Azure.AI.Projects
{
    ...
    internal partial class AgentsPagedResultAgentInsight
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultAgentInsight"/>. </summary>
        ...
        internal AgentsPagedResultAgentInsight(IEnumerable<AgentInsight> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultAgentInsight(IList<AgentInsight> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<AgentInsight> Data { get; }
