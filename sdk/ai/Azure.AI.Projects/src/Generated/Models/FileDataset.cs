...
namespace Azure.AI.Projects
{
    ...
    public partial class FileDataset : AIProjectDatasetVersion
    {
        ...
        public FileDataset(string dataUri) : base(dataUri, DatasetType.UriFile)
        {
