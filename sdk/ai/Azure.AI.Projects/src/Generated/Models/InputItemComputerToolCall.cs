...
namespace Azure.AI.Projects
{
    ...
    internal partial class InputItemComputerToolCall : InputItem
    {
        ...
        public InputItemComputerToolCall(string id, string callId, InternalComputerAction action, IEnumerable<ComputerCallSafetyCheckParam> pendingSafetyChecks, InputItemComputerToolCallStatus status) : base(InputItemType.ComputerCall)
        {
        ...
        ///   `incomplete`. Populated when items are returned via API.
        /// </param>
        internal InputItemComputerToolCall(InputItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, InternalComputerAction action, IList<ComputerCallSafetyCheckParam> pendingSafetyChecks, InputItemComputerToolCallStatus status) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Action = action;
