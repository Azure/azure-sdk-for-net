...
namespace Azure.AI.Projects
{
    ...
    public partial class Evaluation
    {
        ...
        internal Evaluation(string name, InputData data, string displayName, string description, string status, IDictionary<string, string> tags, IDictionary<string, string> properties, IDictionary<string, EvaluatorConfiguration> evaluators, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Data = data;
