...
namespace Azure.AI.Projects
{
    internal static partial class FoundryFeaturesOptInKeysExtensions
    {
        ...
        {
            FoundryFeaturesOptInKeys.ContainerAgentsV1Preview => "ContainerAgents=V1Preview",
            FoundryFeaturesOptInKeys.HostedAgentsV1Preview => "HostedAgents=V1Preview",
            FoundryFeaturesOptInKeys.WorkflowAgentsV1Preview => "WorkflowAgents=V1Preview",
        ...
        public static FoundryFeaturesOptInKeys ToFoundryFeaturesOptInKeys(this string value)
        {
            ...
            {
                return FoundryFeaturesOptInKeys.ContainerAgentsV1Preview;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "HostedAgents=V1Preview"))
            {
                return FoundryFeaturesOptInKeys.HostedAgentsV1Preview;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "WorkflowAgents=V1Preview"))
            {
                return FoundryFeaturesOptInKeys.WorkflowAgentsV1Preview;
            }
