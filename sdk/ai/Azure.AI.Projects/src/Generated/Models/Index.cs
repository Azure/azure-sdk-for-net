...
namespace Azure.AI.Projects
{
    ...
    public abstract partial class Index
    {
        ...
        private protected Index(IndexType @type)
        {
            Type = @type;
        ...
        internal Index(IndexType @type, string id, string name, string version, string description, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Id = id;
            Name = name;
