...
namespace Azure.AI.Projects
{
    ...
    public partial class TracesDataGenerationJobOptions : DataGenerationJobOptions
    {
        ...
        public TracesDataGenerationJobOptions(int maxSamples) : base(DataGenerationJobType.Traces, maxSamples)
        {
        }
        ...
        internal TracesDataGenerationJobOptions(DataGenerationJobType @type, int maxSamples, float? trainSplit, DataGenerationModelOptions modelOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, maxSamples, trainSplit, modelOptions, additionalBinaryDataProperties)
        {
        }
    }
}
