...
namespace Azure.Core
{
    ...
    internal partial class PagedInsight
    {
        ...
        internal PagedInsight(IEnumerable<ProjectInsight> value)
        {
            Value = value.ToList();
        }
        ...
        internal PagedInsight(IList<ProjectInsight> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ProjectInsight> Value { get; }
