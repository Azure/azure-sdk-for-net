...
namespace Azure.AI.Projects
{
    ...
    internal partial class CreateAgentRequest1
    {
        ...
        internal CreateAgentRequest1(string name, InternalAgentDefinition definition)
        {
            Name = name;
        ...
        internal CreateAgentRequest1(string name, IDictionary<string, string> metadata, string description, InternalAgentDefinition definition, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Metadata = metadata;
