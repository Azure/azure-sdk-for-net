...
namespace Azure.AI.Projects
{
    ...
    internal partial class InputItemMcpListTools : InputItem, IJsonModel<InputItemMcpListTools>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InputItemMcpListTools>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputItemMcpListTools)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InputItemMcpListTools IJsonModel<InputItemMcpListTools>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InputItemMcpListTools)JsonModelCreateCore(ref reader, options);
        ...
        protected override InputItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputItemMcpListTools)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeInputItemMcpListTools(document.RootElement, options);
        }

        /// <param name="element"> The JSON element to deserialize. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InputItemMcpListTools DeserializeInputItemMcpListTools(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InputItemMcpListTools)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override InputItem PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InputItemMcpListTools)} does not support reading '{options.Format}' format.");
            }
        }
