...
{
    internal partial class UnknownTrigger : Projects.ScheduleTrigger, IJsonModel<Projects.ScheduleTrigger>
    {
        ...
        protected override Projects.ScheduleTrigger PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        Projects.ScheduleTrigger IPersistableModel<Projects.ScheduleTrigger>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        Projects.ScheduleTrigger IJsonModel<Projects.ScheduleTrigger>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override Projects.ScheduleTrigger JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<Projects.ScheduleTrigger>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownTrigger DeserializeUnknownTrigger(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownTrigger(@type, additionalBinaryDataProperties);
        }
    }
}
