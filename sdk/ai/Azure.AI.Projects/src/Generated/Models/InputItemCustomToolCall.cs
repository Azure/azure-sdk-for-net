...
namespace Azure.AI.Projects
{
    ...
    public partial class InputItemCustomToolCall : InputItem
    {
        ...
        /// <param name="name"> The name of the custom tool being called. </param>
        /// <param name="input"> The input for the custom tool call generated by the model. </param>
        internal InputItemCustomToolCall(InputItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, string @namespace, string name, string input) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Namespace = @namespace;
