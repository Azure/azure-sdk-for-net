    ...
    public partial class PromptEvaluatorGenerationJobSource : EvaluatorGenerationJobSource, IJsonModel<PromptEvaluatorGenerationJobSource>
    {
        ...
        protected override EvaluatorGenerationJobSource PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializePromptEvaluatorGenerationJobSource(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(PromptEvaluatorGenerationJobSource)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PromptEvaluatorGenerationJobSource)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PromptEvaluatorGenerationJobSource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<PromptEvaluatorGenerationJobSource>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<PromptEvaluatorGenerationJobSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PromptEvaluatorGenerationJobSource)} does not support writing '{format}' format.");
            }
        ...
        protected override EvaluatorGenerationJobSource JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PromptEvaluatorGenerationJobSource)} does not support reading '{format}' format.");
            }
