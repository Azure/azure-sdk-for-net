...
namespace Azure.AI.Projects
{
    ...
    public partial class AIProjectConnection
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Projects.AIProjectConnection"/>. </summary>
        ...
        internal AIProjectConnection(string name, string id, ConnectionType @type, string target, bool isDefault, AIProjectConnectionBaseCredential credentials, IReadOnlyDictionary<string, string> metadata, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Id = id;
            Type = @type;
