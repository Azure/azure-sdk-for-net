...
namespace Azure.AI.Projects
{
    ...
    internal partial class AgentsPagedResultAgentInsightMonitorListItem
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultAgentInsightMonitorListItem"/>. </summary>
        ...
        internal AgentsPagedResultAgentInsightMonitorListItem(IEnumerable<AgentInsightMonitorListItem> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultAgentInsightMonitorListItem(IList<AgentInsightMonitorListItem> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<AgentInsightMonitorListItem> Data { get; }
