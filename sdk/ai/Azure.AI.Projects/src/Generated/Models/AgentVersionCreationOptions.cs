...
namespace Azure.AI.Projects
{
    ...
    public partial class AgentVersionCreationOptions
    {
        ...
        public AgentVersionCreationOptions(Projects.OpenAI.AgentDefinition definition)
        {
        ...
        internal AgentVersionCreationOptions(IDictionary<string, string> metadata, string description, Projects.OpenAI.AgentDefinition definition, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Metadata = metadata;
