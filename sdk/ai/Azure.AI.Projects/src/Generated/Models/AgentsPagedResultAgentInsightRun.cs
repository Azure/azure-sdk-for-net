...
namespace Azure.AI.Projects
{
    ...
    internal partial class AgentsPagedResultAgentInsightRun
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultAgentInsightRun"/>. </summary>
        ...
        internal AgentsPagedResultAgentInsightRun(IEnumerable<AgentInsightRun> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultAgentInsightRun(IList<AgentInsightRun> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<AgentInsightRun> Data { get; }
