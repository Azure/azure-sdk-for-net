...
namespace Azure.AI.Projects
{
    ...
    public partial class CodeInterpreterContainerAuto
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CodeInterpreterContainerAuto"/>. </summary>
        ...
        internal CodeInterpreterContainerAuto(string @type, IList<string> fileIds, ContainerMemoryLimit? memoryLimit, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            FileIds = fileIds;
