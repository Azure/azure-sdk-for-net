...
namespace OpenAI
{
    internal partial class InternalFileSearchTool : InternalTool
    {
        ...
        public InternalFileSearchTool(IEnumerable<string> vectorStoreIds) : base(global::Azure.AI.Projects.ToolType.FileSearch)
        {
