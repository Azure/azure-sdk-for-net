...
namespace Azure.AI.Projects
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.Projects.ToolUseFineTuningDataGenerationJobOptions"/>. </summary>
        /// <param name="maxSamples"> Maximum number of samples to generate. </param>
        public ToolUseFineTuningDataGenerationJobOptions(int maxSamples) : base(global::Azure.AI.Projects.DataGenerationJobKind.ToolUse, maxSamples)
        {
        }
        ...
        internal ToolUseFineTuningDataGenerationJobOptions(DataGenerationJobKind @type, int maxSamples, float? trainSplit, DataGenerationModelOptions modelOptions, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties) : base(@type, maxSamples, trainSplit, modelOptions, additionalBinaryDataProperties)
        {
        }
    }
}
