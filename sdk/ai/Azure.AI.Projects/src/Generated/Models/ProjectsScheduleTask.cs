...
namespace Azure.AI.Projects
{
    ...
    public abstract partial class ProjectsScheduleTask
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ProjectsScheduleTask"/>. </summary>
        ...
        internal ProjectsScheduleTask(ScheduleTaskType @type, IDictionary<string, string> configuration, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
