...
namespace Azure.Core.Foundations
{
    ...
    internal partial class PagedConnection
    {
        ...
        internal PagedConnection(IEnumerable<Connection> value)
        {
            Value = value.ToList();
        }
        ...
        internal PagedConnection(IList<Connection> value, Uri nextLink, string clientRequestId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<Connection> Value { get; }
