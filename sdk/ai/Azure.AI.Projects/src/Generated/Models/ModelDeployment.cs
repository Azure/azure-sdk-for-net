...
namespace Azure.AI.Projects
{
    ...
    public partial class ModelDeployment : Deployment
    {
        ...
        internal ModelDeployment(DeploymentType @type, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties, string modelName, string modelVersion, string modelPublisher, IReadOnlyDictionary<string, string> capabilities, Sku sku, string connectionName) : base(@type, name, additionalBinaryDataProperties)
        {
            ModelName = modelName;
