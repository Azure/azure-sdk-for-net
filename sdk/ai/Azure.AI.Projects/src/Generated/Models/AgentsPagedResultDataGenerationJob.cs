...
namespace Azure.AI.Projects
{
    ...
    internal partial class AgentsPagedResultDataGenerationJob
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultDataGenerationJob"/>. </summary>
        ...
        internal AgentsPagedResultDataGenerationJob(IEnumerable<DataGenerationJob> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultDataGenerationJob(IList<DataGenerationJob> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<DataGenerationJob> Data { get; }
