...
namespace Azure.AI.Projects
{
    ...
    public partial class SimulationSeedDataGenerationJobOptions : DataGenerationJobOptions
    {
        ...
        public SimulationSeedDataGenerationJobOptions(int maxSamples) : base(DataGenerationJobKind.SimulationSeed, maxSamples)
        {
        }
        ...
        internal SimulationSeedDataGenerationJobOptions(DataGenerationJobKind @type, int maxSamples, float? trainSplit, DataGenerationModelOptions modelOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, maxSamples, trainSplit, modelOptions, additionalBinaryDataProperties)
        {
        }
    }
}
