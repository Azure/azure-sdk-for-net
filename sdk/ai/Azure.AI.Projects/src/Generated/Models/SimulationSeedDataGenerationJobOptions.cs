...
namespace Azure.AI.Projects
{
    ...
    public partial class SimulationSeedDataGenerationJobOptions : DataGenerationJobOptions
    {
        ...
        public SimulationSeedDataGenerationJobOptions() : base(DataGenerationJobKind.SimulationSeed)
        {
        }
        ...
        internal SimulationSeedDataGenerationJobOptions(DataGenerationJobKind @type, float? trainSplit, DataGenerationModelOptions modelOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type, trainSplit, modelOptions, additionalBinaryDataProperties)
        {
        }
    }
}
