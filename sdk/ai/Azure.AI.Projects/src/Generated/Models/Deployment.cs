...
namespace Azure.AI.Projects
{
    ...
    public abstract partial class Deployment
    {
        ...
        private protected Deployment(DeploymentType @type)
        {
            Type = @type;
        }
        ...
        internal Deployment(DeploymentType @type, string name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Name = name;
