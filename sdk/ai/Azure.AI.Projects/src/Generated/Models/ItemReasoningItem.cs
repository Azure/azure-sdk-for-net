...
namespace Azure.AI.Projects
{
    ...
    internal partial class ItemReasoningItem : Item
    {
        ...
        public ItemReasoningItem(string id, IEnumerable<Summary> summary) : base(ItemType.Reasoning)
        {
        ...
        /// </param>
        internal ItemReasoningItem(ItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string encryptedContent, IList<Summary> summary, IList<ReasoningTextContent> content, OutputItemReasoningItemStatus? status) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
