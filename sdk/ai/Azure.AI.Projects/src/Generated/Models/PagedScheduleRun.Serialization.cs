...
namespace Azure.Core
{
    ...
    public partial class PagedScheduleRun : IJsonModel<PagedScheduleRun>
    {
        ...
        void IJsonModel<PagedScheduleRun>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PagedScheduleRun)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PagedScheduleRun IJsonModel<PagedScheduleRun>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        protected virtual PagedScheduleRun JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PagedScheduleRun)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializePagedScheduleRun(document.RootElement, options);
        }
        ...
        internal static PagedScheduleRun DeserializePagedScheduleRun(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<ScheduleRun> array = new List<ScheduleRun>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(ScheduleRun.DeserializeScheduleRun(item, options));
                    }
                    value = array;
                    continue;
                }
        ...
        public static explicit operator PagedScheduleRun(ClientResult result)
        {
            ...
            return DeserializePagedScheduleRun(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
