...
namespace Azure.AI.Projects
{
    ...
    public partial class Connection
    {
        ...
        internal Connection(string name, string id, ConnectionType @type, string target, bool isDefault, BaseCredentials credentials, IReadOnlyDictionary<string, string> metadata, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Id = id;
            Type = @type;
