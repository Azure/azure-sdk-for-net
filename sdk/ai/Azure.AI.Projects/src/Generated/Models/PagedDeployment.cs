...
namespace Azure.Core.Foundations
{
    ...
    internal partial class PagedDeployment
    {
        ...
        internal PagedDeployment(IEnumerable<AIDeployment> value)
        {
            Value = value.ToList();
        }
        ...
        internal PagedDeployment(IList<AIDeployment> value, Uri nextLink, string clientRequestId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<AIDeployment> Value { get; }
