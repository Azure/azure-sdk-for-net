...
namespace Azure.Core.Foundations
{
    ...
    internal partial class PagedSchedule
    {
        ...
        internal PagedSchedule(IEnumerable<Schedule> value)
        {
            Value = value.ToList();
        }
        ...
        internal PagedSchedule(IList<Schedule> value, Uri nextLink, string clientRequestId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<Schedule> Value { get; }
