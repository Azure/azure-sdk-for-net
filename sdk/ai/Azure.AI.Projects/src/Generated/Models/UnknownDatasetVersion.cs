...
namespace Azure.AI.Projects
{
    internal partial class UnknownDatasetVersion : DatasetVersion
    {
        ...
        internal UnknownDatasetVersion(DatasetType @type, bool? isReference, string connectionName, string id, string name, string version, string description, IDictionary<string, string> tags, Uri dataUri, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type != default ? @type : "unknown", isReference, connectionName, id, name, version, description, tags, dataUri, additionalBinaryDataProperties)
        {
        }
    }
}
