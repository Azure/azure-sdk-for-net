...
namespace Azure.AI.Projects
{
    ...
    public partial class TracesDataGenerationJobSource : DataGenerationJobSource
    {
        ...
        public TracesDataGenerationJobSource(DateTimeOffset startOn) : base(DataGenerationJobSourceType.Traces)
        {
            StartOn = startOn;
        }
        ...
        internal TracesDataGenerationJobSource(DataGenerationJobSourceType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string description, string agentId, string agentName, string agentVersion, DateTimeOffset startOn, DateTimeOffset? endOn) : base(@type, description, additionalBinaryDataProperties)
        {
            AgentId = agentId;
            AgentName = agentName;
