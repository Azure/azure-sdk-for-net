...
namespace Azure.AI.Projects
{
    ...
    internal partial class OpenApiProjectConnectionAuthDetails : OpenApiAuthDetails
    {
        ...
        public OpenApiProjectConnectionAuthDetails(OpenApiProjectConnectionSecurityScheme securityScheme) : base(OpenApiAuthType.ProjectConnection)
        {
        ...
        /// <param name="securityScheme"> Project connection auth security details. </param>
        internal OpenApiProjectConnectionAuthDetails(OpenApiAuthType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, OpenApiProjectConnectionSecurityScheme securityScheme) : base(@type, additionalBinaryDataProperties)
        {
            SecurityScheme = securityScheme;
        }
