...
namespace Azure.AI.Projects
{
    ...
    internal partial class InputItemCustomToolCallOutput : InputItem
    {
        ...
        ///   Can be a string or an list of output content.
        /// </param>
        internal InputItemCustomToolCallOutput(InputItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, ToolCallCallerParam caller, BinaryData output) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Caller = caller;
