...
namespace Azure.AI.Projects
{
    ...
    internal partial class MemorySearchTool : InternalTool
    {
        ...
        internal MemorySearchTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string memoryStoreName, string scope, MemorySearchResultOptions searchOptions, int? updateDelay) : base(@type, additionalBinaryDataProperties)
        {
            MemoryStoreName = memoryStoreName;
            Scope = scope;
