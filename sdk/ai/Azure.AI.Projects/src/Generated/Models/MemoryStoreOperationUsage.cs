...
namespace Azure.AI.Projects.Memory
{
    ...
    public partial class MemoryStoreOperationUsage
    {
        ...
        internal MemoryStoreOperationUsage(int embeddingTokens, long inputTokens, Projects.ResponseUsageInputTokensDetails inputTokensDetails, long outputTokens, Projects.ResponseUsageOutputTokensDetails outputTokensDetails, long totalTokens)
        {
        ...
        internal MemoryStoreOperationUsage(int embeddingTokens, long inputTokens, Projects.ResponseUsageInputTokensDetails inputTokensDetails, long outputTokens, Projects.ResponseUsageOutputTokensDetails outputTokensDetails, long totalTokens, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            EmbeddingTokens = embeddingTokens;
            InputTokens = inputTokens;
            InputTokensDetails = inputTokensDetails;
        ...
        public Projects.ResponseUsageInputTokensDetails InputTokensDetails { get; }

        /// <summary> The number of output tokens. </summary>
        public long OutputTokens { get; }

        /// <summary> A detailed breakdown of the output tokens. </summary>
        public Projects.ResponseUsageOutputTokensDetails OutputTokensDetails { get; }
