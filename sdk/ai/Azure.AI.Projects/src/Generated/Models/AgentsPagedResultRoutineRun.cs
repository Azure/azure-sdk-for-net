...
namespace Azure.AI.Projects
{
    ...
    internal partial class AgentsPagedResultRoutineRun
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultRoutineRun"/>. </summary>
        ...
        internal AgentsPagedResultRoutineRun(IEnumerable<RoutineRun> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultRoutineRun(IList<RoutineRun> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
