...
namespace Azure.AI.Projects
{
    ...
    internal partial class InputItemFunctionCallOutputItemParam : InputItem
    {
        ...
        internal InputItemFunctionCallOutputItemParam(InputItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, BinaryData output, ToolCallCallerParam caller, FunctionCallItemStatus? status) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Output = output;
