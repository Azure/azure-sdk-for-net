...
namespace Azure.AI.Projects
{
    ...
    internal partial class ItemMcpToolCall : Item
    {
        ...
        internal ItemMcpToolCall(ItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string serverLabel, string name, string arguments, string output, string error, MCPToolCallStatus? status, string approvalRequestId) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            ServerLabel = serverLabel;
            Name = name;
