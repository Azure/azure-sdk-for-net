...
namespace Azure.Core
{
    ...
    internal partial class PagedIndex
    {
        ...
        internal PagedIndex(IEnumerable<AI.Projects.Index> value)
        {
            Value = value.ToList();
        }
        ...
        internal PagedIndex(IList<AI.Projects.Index> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<AI.Projects.Index> Value { get; }
