...
namespace Azure.AI.Projects
{
    ...
    internal partial class WebIQPreviewTool : InternalTool, IJsonModel<WebIQPreviewTool>
    {
        ...
        protected override InternalTool PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeWebIQPreviewTool(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(WebIQPreviewTool)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WebIQPreviewTool>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WebIQPreviewTool IPersistableModel<WebIQPreviewTool>.Create(BinaryData data, ModelReaderWriterOptions options) => (WebIQPreviewTool)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<WebIQPreviewTool>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<WebIQPreviewTool>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WebIQPreviewTool)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WebIQPreviewTool IJsonModel<WebIQPreviewTool>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WebIQPreviewTool)JsonModelCreateCore(ref reader, options);
        ...
        protected override InternalTool JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WebIQPreviewTool)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WebIQPreviewTool DeserializeWebIQPreviewTool(JsonElement element, ModelReaderWriterOptions options)
        {
