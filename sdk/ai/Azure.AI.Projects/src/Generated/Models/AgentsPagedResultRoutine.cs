...
namespace Azure.AI.Projects
{
    ...
    internal partial class AgentsPagedResultRoutine
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultRoutine"/>. </summary>
        ...
        internal AgentsPagedResultRoutine(IEnumerable<ProjectsRoutine> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultRoutine(IList<ProjectsRoutine> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
