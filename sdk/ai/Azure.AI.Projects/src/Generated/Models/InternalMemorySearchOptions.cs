...
namespace Azure.AI.Projects
{
    internal partial class InternalMemorySearchOptions
    {
        ...
        internal InternalMemorySearchOptions(string scope, IList<InputItem> items, string previousSearchId, MemorySearchOptions options, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Scope = scope;
            Items = items;
