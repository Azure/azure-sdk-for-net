...
namespace OpenAI
{
    internal partial class InternalFileSearchToolCallItemParam : InternalItemParam
    {
        ...
        public InternalFileSearchToolCallItemParam(IEnumerable<string> queries) : base(ItemType.FileSearchCall)
        {
        ...
        internal InternalFileSearchToolCallItemParam(ItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> queries, IList<InternalFileSearchToolCallItemParamResult> results) : base(@type, additionalBinaryDataProperties)
        {
            Queries = queries;
            Results = results;
        }
