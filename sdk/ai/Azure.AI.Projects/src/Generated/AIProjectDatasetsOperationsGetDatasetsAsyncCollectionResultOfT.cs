...
namespace Azure.AI.Projects
{
    internal partial class AIProjectDatasetsOperationsGetDatasetsAsyncCollectionResultOfT : AsyncCollectionResult<DatasetVersion>
    {
        ...
        /// <summary> Initializes a new instance of AIProjectDatasetsOperationsGetDatasetsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AIProjectDatasetsOperations client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AIProjectDatasetsOperationsGetDatasetsAsyncCollectionResultOfT(AIProjectDatasetsOperations client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
