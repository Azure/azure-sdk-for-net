...
{
    internal partial class AIProjectDatasetsOperationsGetDatasetVersionsAsyncCollectionResult : AsyncCollectionResult
    {
        private readonly AIProjectDatasetsOperations _client;
        private readonly string _name;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectDatasetsOperationsGetDatasetVersionsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AIProjectDatasetsOperationsGetDatasetVersionsAsyncCollectionResult(AIProjectDatasetsOperations client, string name, RequestOptions options)
        {
