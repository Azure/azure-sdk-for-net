...
{
    internal partial class RedTeamsGetCollectionResult : CollectionResult
    {
        private readonly RedTeams _client;
        private readonly string _clientRequestId;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of RedTeamsGetCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public RedTeamsGetCollectionResult(RedTeams client, string clientRequestId, RequestOptions options)
        {
            _client = client;
