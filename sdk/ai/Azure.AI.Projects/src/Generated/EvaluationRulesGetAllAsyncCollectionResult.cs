...
namespace Azure.AI.Projects
{
    internal partial class EvaluationRulesGetAllAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public EvaluationRulesGetAllAsyncCollectionResult(EvaluationRules client, string actionType, string agentName, bool? enabled, string clientRequestId, RequestOptions options)
        {
            _client = client;
