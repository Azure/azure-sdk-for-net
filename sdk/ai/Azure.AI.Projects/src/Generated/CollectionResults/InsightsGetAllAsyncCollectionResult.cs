...
namespace Azure.AI.Projects
{
    internal partial class InsightsGetAllAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public InsightsGetAllAsyncCollectionResult(Insights client, string foundryFeatures, string @type, string evalId, string runId, string agentName, bool? includeCoordinates, RequestOptions options)
        {
            _client = client;
