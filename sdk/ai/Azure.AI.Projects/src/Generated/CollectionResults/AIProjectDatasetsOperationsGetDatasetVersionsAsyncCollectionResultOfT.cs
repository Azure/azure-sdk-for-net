...
{
    internal partial class AIProjectDatasetsOperationsGetDatasetVersionsAsyncCollectionResultOfT : AsyncCollectionResult<global::Azure.AI.Projects.AIProjectDataset>
    {
        ...
        protected override async IAsyncEnumerable<global::Azure.AI.Projects.AIProjectDataset> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (AIProjectDataset item in ((PagedDatasetVersion)page).Value)
            {
                yield return item;
