...
{
    internal partial class AgentInsightMonitorsGetAllCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AgentInsightMonitorsGetAllCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentInsightMonitorsGetAllCollectionResult(AgentInsightMonitors client, string foundryFeatures, string after, string before, int? limit, string order, string agentName, RequestOptions options)
        {
            _client = client;
