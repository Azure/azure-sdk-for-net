...
namespace Azure.AI.Projects
{
    ...
    internal partial class AIProjectRoutinesGetRoutineRunsCollectionResultOfT : CollectionResult<RoutineRun>
    {
        ...
        public AIProjectRoutinesGetRoutineRunsCollectionResultOfT(AIProjectRoutines client, string routineName, string foundryFeatures, string filter, int? limit, string after, string order, RequestOptions options)
        {
            _client = client;
        ...
        {
            return ((PagedResultWithNextLinkRoutineRun)page).Data;
        }
