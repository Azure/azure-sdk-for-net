...
{
    internal partial class AIProjectRoutinesGetRoutineRunsCollectionResultOfT : CollectionResult<RoutineRun>
    {
        ...
        /// <summary> Initializes a new instance of AIProjectRoutinesGetRoutineRunsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AIProjectRoutinesGetRoutineRunsCollectionResultOfT(AIProjectRoutines client, string routineName, string foundryFeatures, string filter, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
        ...
        protected override IEnumerable<RoutineRun> GetValuesFromPage(ClientResult page)
        {
            return ((AgentsPagedResultRoutineRun)page).Data;
        }
