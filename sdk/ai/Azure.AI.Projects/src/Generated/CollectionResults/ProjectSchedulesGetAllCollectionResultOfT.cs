...
{
    internal partial class ProjectSchedulesGetAllCollectionResultOfT : CollectionResult<global::Azure.AI.Projects.Evaluation.ProjectsSchedule>
    {
        ...
        /// <summary> Initializes a new instance of ProjectSchedulesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProjectSchedulesGetAllCollectionResultOfT(ProjectSchedules client, string @type, bool? enabled, RequestOptions options)
        {
            _client = client;
            _type = @type;
            _enabled = enabled;
        ...
        protected override IEnumerable<global::Azure.AI.Projects.Evaluation.ProjectsSchedule> GetValuesFromPage(ClientResult page)
        {
