...
{
    internal partial class EvaluatorsGetLatestVersionsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of EvaluatorsGetLatestVersionsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluatorsGetLatestVersionsAsyncCollectionResult(Evaluators client, string @type, int? limit, RequestOptions options)
        {
            _client = client;
            _type = @type;
            _limit = limit;
