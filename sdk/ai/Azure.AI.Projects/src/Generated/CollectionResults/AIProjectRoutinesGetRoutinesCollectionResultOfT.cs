...
{
    internal partial class AIProjectRoutinesGetRoutinesCollectionResultOfT : CollectionResult<ProjectsRoutine>
    {
        ...
        /// <summary> Initializes a new instance of AIProjectRoutinesGetRoutinesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AIProjectRoutinesGetRoutinesCollectionResultOfT(AIProjectRoutines client, string foundryFeatures, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
        ...
        protected override IEnumerable<ProjectsRoutine> GetValuesFromPage(ClientResult page)
        {
            return ((AgentsPagedResultRoutine)page).Data;
        }
