...
namespace Azure.AI.Projects
{
    ...
    internal partial class AIProjectRoutinesGetRoutinesCollectionResultOfT : CollectionResult<ProjectsRoutine>
    {
        ...
        public AIProjectRoutinesGetRoutinesCollectionResultOfT(AIProjectRoutines client, string foundryFeatures, int? limit, string after, string order, RequestOptions options)
        {
            _client = client;
        ...
        {
            return ((PagedResultWithNextLinkRoutine)page).Data;
        }
