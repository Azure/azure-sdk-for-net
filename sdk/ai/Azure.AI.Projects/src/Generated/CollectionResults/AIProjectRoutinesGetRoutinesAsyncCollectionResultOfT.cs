...
namespace Azure.AI.Projects
{
    internal partial class AIProjectRoutinesGetRoutinesAsyncCollectionResultOfT : AsyncCollectionResult<ProjectsRoutine>
    {
        ...
        public AIProjectRoutinesGetRoutinesAsyncCollectionResultOfT(AIProjectRoutines client, string foundryFeatures, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
        ...
        {
            foreach (ProjectsRoutine item in ((AgentsPagedResultRoutine)page).Data)
            {
                yield return item;
                await Task.Yield();
            }
