...
{
    internal partial class AIProjectIndexesOperationsGetIndexesAsyncCollectionResultOfT : AsyncCollectionResult<global::Azure.AI.Projects.AIProjectIndex>
    {
        private readonly AIProjectIndexesOperations _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectIndexesOperationsGetIndexesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AIProjectIndexesOperations client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AIProjectIndexesOperationsGetIndexesAsyncCollectionResultOfT(AIProjectIndexesOperations client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
