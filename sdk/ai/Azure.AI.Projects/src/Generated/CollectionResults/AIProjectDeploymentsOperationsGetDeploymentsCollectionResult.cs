...
namespace Azure.AI.Projects
{
    internal partial class AIProjectDeploymentsOperationsGetDeploymentsCollectionResult : CollectionResult
    {
        ...
        public AIProjectDeploymentsOperationsGetDeploymentsCollectionResult(AIProjectDeploymentsOperations client, string modelPublisher, string modelName, string deploymentType, RequestOptions options)
        {
            _client = client;
