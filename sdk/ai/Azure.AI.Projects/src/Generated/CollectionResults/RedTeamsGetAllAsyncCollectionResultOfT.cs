...
{
    internal partial class RedTeamsGetAllAsyncCollectionResultOfT : AsyncCollectionResult<global::Azure.AI.Projects.Evaluation.RedTeam>
    {
        ...
        public RedTeamsGetAllAsyncCollectionResultOfT(RedTeams client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
        ...
        protected override async IAsyncEnumerable<global::Azure.AI.Projects.Evaluation.RedTeam> GetValuesFromPageAsync(ClientResult page)
        {
