...
namespace Azure.AI.Projects
{
    internal partial class AIProjectRoutinesGetRoutineRunsCollectionResult : CollectionResult
    {
        ...
        public AIProjectRoutinesGetRoutineRunsCollectionResult(AIProjectRoutines client, string routineName, string foundryFeatures, string filter, int? limit, string after, string order, RequestOptions options)
        {
            _client = client;
