...
{
    internal partial class AIProjectAgentsOperationsGetAgentsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AIProjectAgentsOperationsGetAgentsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AIProjectAgentsOperationsGetAgentsAsyncCollectionResult(AIProjectAgentsOperations client, string kind, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _kind = kind;
            _limit = limit;
