...
{
    internal partial class AIProjectIndexesOperationsGetIndexVersionsAsyncCollectionResultOfT : AsyncCollectionResult<AIProjectIndex>
    {
        private readonly AIProjectIndexesOperations _client;
        private readonly string _name;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectIndexesOperationsGetIndexVersionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AIProjectIndexesOperations client used to send requests. </param>
        /// <param name="name"> The name of the resource. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AIProjectIndexesOperationsGetIndexVersionsAsyncCollectionResultOfT(AIProjectIndexesOperations client, string name, RequestOptions options)
        {
            _client = client;
            _name = name;
            _options = options;
        ...
        protected override async IAsyncEnumerable<AIProjectIndex> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (AIProjectIndex item in ((PagedIndex)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
        ...
        {
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("AIProjectIndexesOperations.GetIndexVersions");
            scope.Start();
            try
            {
