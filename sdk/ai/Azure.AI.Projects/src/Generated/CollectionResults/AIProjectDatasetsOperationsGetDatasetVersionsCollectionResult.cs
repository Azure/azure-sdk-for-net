...
{
    internal partial class AIProjectDatasetsOperationsGetDatasetVersionsCollectionResult : CollectionResult
    {
        private readonly AIProjectDatasetsOperations _client;
        private readonly string _name;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectDatasetsOperationsGetDatasetVersionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        {
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("AIProjectDatasetsOperations.GetDatasetVersions");
            scope.Start();
            try
            {
