...
{
    internal partial class AgentInsightMonitorsGetRunsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AgentInsightMonitorsGetRunsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentInsightMonitorsGetRunsAsyncCollectionResult(AgentInsightMonitors client, string monitorId, string foundryFeatures, string after, string before, int? limit, string order, string status, string trigger, RequestOptions options)
        {
            _client = client;
