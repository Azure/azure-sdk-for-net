...
namespace Azure.AI.Projects
{
    internal partial class EvaluationRulesGetAllCollectionResultOfT : CollectionResult<EvaluationRule>
    {
        ...
        public EvaluationRulesGetAllCollectionResultOfT(EvaluationRules client, string actionType, string agentName, bool? enabled, string foundryFeatures, RequestOptions options)
        {
            _client = client;
        ...
        {
            PipelineMessage message = _client.CreateGetAllRequest(_actionType, _agentName, _enabled, _foundryFeatures, _options);
            ...
            while (true)
            {
                ...
                message = _client.CreateNextGetAllRequest(nextPageUri, _actionType, _agentName, _enabled, _foundryFeatures, _options);
            }
        }
