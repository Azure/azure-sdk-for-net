...
{
    internal partial class EvaluatorsGetVersionsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of EvaluatorsGetVersionsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluatorsGetVersionsAsyncCollectionResult(Evaluators client, string name, string @type, int? limit, RequestOptions options)
        {
