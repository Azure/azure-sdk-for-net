...
namespace Azure.AI.Projects
{
    internal partial class AIProjectRoutinesGetRoutinesAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public AIProjectRoutinesGetRoutinesAsyncCollectionResult(AIProjectRoutines client, string foundryFeatures, int? limit, string after, string order, RequestOptions options)
        {
            _client = client;
