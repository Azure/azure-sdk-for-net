...
{
    internal partial class AIProjectRoutinesGetRoutinesAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AIProjectRoutinesGetRoutinesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AIProjectRoutinesGetRoutinesAsyncCollectionResult(AIProjectRoutines client, string foundryFeatures, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
