...
{
    internal partial class ProjectEvaluatorsGetVersionsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of ProjectEvaluatorsGetVersionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProjectEvaluatorsGetVersionsCollectionResult(ProjectEvaluators client, string name, string @type, int? limit, RequestOptions options)
        {
            _client = client;
            _name = name;
            _type = @type;
