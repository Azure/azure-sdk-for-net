...
namespace Azure.AI.Projects
{
    internal partial class AgentInsightMonitorsGetInsightsAsyncCollectionResultOfT : AsyncCollectionResult<AgentInsight>
    {
        ...
        public AgentInsightMonitorsGetInsightsAsyncCollectionResultOfT(AgentInsightMonitors client, string monitorId, string foundryFeatures, string after, string before, int? limit, string order, string category, string severity, string status, bool? includeDetails, RequestOptions options)
        {
            _client = client;
