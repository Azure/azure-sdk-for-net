...
{
    internal partial class EvaluationTaxonomiesGetAllAsyncCollectionResultOfT : AsyncCollectionResult<global::Azure.AI.Projects.Evaluation.EvaluationTaxonomy>
    {
        ...
        /// <summary> Initializes a new instance of EvaluationTaxonomiesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluationTaxonomiesGetAllAsyncCollectionResultOfT(EvaluationTaxonomies client, string inputName, string inputType, RequestOptions options)
        {
            _client = client;
        ...
        {
            global::System.Uri nextPage = ((PagedEvaluationTaxonomy)page).NextLink;
            if ((nextPage != null))
            {
        ...
        protected override async IAsyncEnumerable<global::Azure.AI.Projects.Evaluation.EvaluationTaxonomy> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (EvaluationTaxonomy item in ((PagedEvaluationTaxonomy)page).Value)
            {
                yield return item;
