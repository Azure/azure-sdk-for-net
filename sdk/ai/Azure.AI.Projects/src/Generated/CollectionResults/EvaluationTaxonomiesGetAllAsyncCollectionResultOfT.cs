...
{
    internal partial class EvaluationTaxonomiesGetAllAsyncCollectionResultOfT : AsyncCollectionResult<EvaluationTaxonomy>
    {
        ...
        protected override async IAsyncEnumerable<EvaluationTaxonomy> GetValuesFromPageAsync(ClientResult page)
        {
        ...
        {
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("EvaluationTaxonomies.GetAll");
            scope.Start();
            try
            {
