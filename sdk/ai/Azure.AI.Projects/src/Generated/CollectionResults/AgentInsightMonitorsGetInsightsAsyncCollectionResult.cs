...
{
    internal partial class AgentInsightMonitorsGetInsightsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AgentInsightMonitorsGetInsightsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentInsightMonitorsGetInsightsAsyncCollectionResult(AgentInsightMonitors client, string monitorId, string foundryFeatures, string after, string before, int? limit, string order, string category, string severity, string status, bool? includeDetails, RequestOptions options)
        {
            _client = client;
