...
{
    internal partial class AgentInsightMonitorsGetRunsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AgentInsightMonitorsGetRunsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentInsightMonitorsGetRunsCollectionResult(AgentInsightMonitors client, string monitorId, string foundryFeatures, string after, string before, int? limit, string order, string status, string trigger, RequestOptions options)
        {
            _client = client;
