...
{
    internal partial class AIProjectDatasetsOperationsGetDatasetsCollectionResult : CollectionResult
    {
        private readonly AIProjectDatasetsOperations _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectDatasetsOperationsGetDatasetsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AIProjectDatasetsOperations client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AIProjectDatasetsOperationsGetDatasetsCollectionResult(AIProjectDatasetsOperations client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
        ...
        {
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("AIProjectDatasetsOperations.GetDatasets");
            scope.Start();
            try
            {
