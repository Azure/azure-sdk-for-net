...
{
    internal partial class AIProjectDatasetsOperationsGetDatasetsAsyncCollectionResult : AsyncCollectionResult
    {
        private readonly AIProjectDatasetsOperations _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectDatasetsOperationsGetDatasetsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AIProjectDatasetsOperations client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AIProjectDatasetsOperationsGetDatasetsAsyncCollectionResult(AIProjectDatasetsOperations client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
