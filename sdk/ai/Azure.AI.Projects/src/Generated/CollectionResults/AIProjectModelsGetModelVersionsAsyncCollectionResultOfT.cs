...
{
    internal partial class AIProjectModelsGetModelVersionsAsyncCollectionResultOfT : AsyncCollectionResult<global::Azure.AI.Projects.ModelVersion>
    {
        private readonly AIProjectModels _client;
        private readonly string _name;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectModelsGetModelVersionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AIProjectModels client used to send requests. </param>
        /// <param name="name"> The name of the resource. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AIProjectModelsGetModelVersionsAsyncCollectionResultOfT(AIProjectModels client, string name, RequestOptions options)
        {
            _client = client;
            _name = name;
            _options = options;
