...
{
    internal partial class ProjectSchedulesGetAllAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of ProjectSchedulesGetAllAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProjectSchedulesGetAllAsyncCollectionResult(ProjectSchedules client, string @type, bool? enabled, RequestOptions options)
        {
            _client = client;
            _type = @type;
            _enabled = enabled;
