...
{
    internal partial class ModelsListModelVersionsAsyncCollectionResultOfT : AsyncCollectionResult<ModelVersion>
    {
        private readonly Models _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of ModelsListModelVersionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Models client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public ModelsListModelVersionsAsyncCollectionResultOfT(Models client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
