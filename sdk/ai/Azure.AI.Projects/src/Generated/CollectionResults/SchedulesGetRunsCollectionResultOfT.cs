...
{
    internal partial class SchedulesGetRunsCollectionResultOfT : CollectionResult<ScheduleRun>
    {
        ...
        /// <summary> Initializes a new instance of SchedulesGetRunsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SchedulesGetRunsCollectionResultOfT(Schedules client, string id, string @type, bool? enabled, RequestOptions options)
        {
            _client = client;
            _id = id;
            _type = @type;
