...
{
    internal partial class AIProjectDeploymentsOperationsGetDeploymentsCollectionResultOfT : CollectionResult<AIProjectDeployment>
    {
        ...
        /// <summary> Initializes a new instance of AIProjectDeploymentsOperationsGetDeploymentsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AIProjectDeploymentsOperationsGetDeploymentsCollectionResultOfT(AIProjectDeploymentsOperations client, string modelPublisher, string modelName, string deploymentType, RequestOptions options)
        {
            _client = client;
        ...
        protected override IEnumerable<AIProjectDeployment> GetValuesFromPage(ClientResult page)
        {
        ...
        {
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("AIProjectDeploymentsOperations.GetDeployments");
            scope.Start();
            try
            {
