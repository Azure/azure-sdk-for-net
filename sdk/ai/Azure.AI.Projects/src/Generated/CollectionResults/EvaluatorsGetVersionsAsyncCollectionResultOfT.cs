...
{
    internal partial class EvaluatorsGetVersionsAsyncCollectionResultOfT : AsyncCollectionResult<EvaluatorVersion>
    {
        ...
        /// <summary> Initializes a new instance of EvaluatorsGetVersionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluatorsGetVersionsAsyncCollectionResultOfT(Evaluators client, string name, string @type, int? limit, RequestOptions options)
        {
