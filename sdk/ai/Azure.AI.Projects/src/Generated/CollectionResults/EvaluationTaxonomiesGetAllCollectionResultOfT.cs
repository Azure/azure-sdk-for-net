...
{
    internal partial class EvaluationTaxonomiesGetAllCollectionResultOfT : CollectionResult<global::Azure.AI.Projects.Evaluation.EvaluationTaxonomy>
    {
        ...
        /// <summary> Initializes a new instance of EvaluationTaxonomiesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public EvaluationTaxonomiesGetAllCollectionResultOfT(EvaluationTaxonomies client, string inputName, string inputType, RequestOptions options)
        {
            _client = client;
        ...
        protected override IEnumerable<global::Azure.AI.Projects.Evaluation.EvaluationTaxonomy> GetValuesFromPage(ClientResult page)
        {
            return ((PagedEvaluationTaxonomy)page).Value;
        }
