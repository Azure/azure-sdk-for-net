...
{
    internal partial class AIProjectIndexesOperationsGetIndexVersionsCollectionResultOfT : CollectionResult<global::Azure.AI.Projects.AIProjectIndex>
    {
        private readonly AIProjectIndexesOperations _client;
        private readonly string _name;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectIndexesOperationsGetIndexVersionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AIProjectIndexesOperations client used to send requests. </param>
        /// <param name="name"> The name of the resource. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AIProjectIndexesOperationsGetIndexVersionsCollectionResultOfT(AIProjectIndexesOperations client, string name, RequestOptions options)
        {
            _client = client;
            _name = name;
            _options = options;
        ...
        protected override IEnumerable<global::Azure.AI.Projects.AIProjectIndex> GetValuesFromPage(ClientResult page)
        {
