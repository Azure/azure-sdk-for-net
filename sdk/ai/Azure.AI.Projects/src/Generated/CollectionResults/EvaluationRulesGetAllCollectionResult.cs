...
namespace Azure.AI.Projects
{
    internal partial class EvaluationRulesGetAllCollectionResult : CollectionResult
    {
        ...
        public EvaluationRulesGetAllCollectionResult(EvaluationRules client, string actionType, string agentName, bool? enabled, string foundryFeatures, RequestOptions options)
        {
            _client = client;
