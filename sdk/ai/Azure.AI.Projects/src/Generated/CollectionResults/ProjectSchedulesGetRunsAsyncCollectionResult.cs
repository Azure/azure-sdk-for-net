...
{
    internal partial class ProjectSchedulesGetRunsAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        /// <summary> Initializes a new instance of ProjectSchedulesGetRunsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProjectSchedulesGetRunsAsyncCollectionResult(ProjectSchedules client, string id, string @type, bool? enabled, RequestOptions options)
        {
            _client = client;
            _id = id;
            _type = @type;
