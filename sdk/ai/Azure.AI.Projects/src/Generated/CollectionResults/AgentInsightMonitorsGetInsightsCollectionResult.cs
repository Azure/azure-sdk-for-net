...
{
    internal partial class AgentInsightMonitorsGetInsightsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AgentInsightMonitorsGetInsightsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AgentInsightMonitorsGetInsightsCollectionResult(AgentInsightMonitors client, string monitorId, string foundryFeatures, string after, string before, int? limit, string order, string category, string severity, string status, bool? includeDetails, RequestOptions options)
        {
            _client = client;
