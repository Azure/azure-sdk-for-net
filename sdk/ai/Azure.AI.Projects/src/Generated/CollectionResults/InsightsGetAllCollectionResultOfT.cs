...
namespace Azure.AI.Projects
{
    internal partial class InsightsGetAllCollectionResultOfT : CollectionResult<Insight>
    {
        ...
        public InsightsGetAllCollectionResultOfT(Insights client, string @type, string evalId, string runId, string agentName, bool? includeCoordinates, RequestOptions options)
        {
            _client = client;
            _type = @type;
            _evalId = evalId;
