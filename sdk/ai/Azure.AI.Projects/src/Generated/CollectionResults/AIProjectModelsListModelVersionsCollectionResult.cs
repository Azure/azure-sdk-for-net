...
{
    internal partial class AIProjectModelsListModelVersionsCollectionResult : CollectionResult
    {
        private readonly AIProjectModels _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of AIProjectModelsListModelVersionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AIProjectModels client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public AIProjectModelsListModelVersionsCollectionResult(AIProjectModels client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
