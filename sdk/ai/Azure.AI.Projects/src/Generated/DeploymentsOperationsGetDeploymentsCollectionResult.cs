...
{
    internal partial class DeploymentsOperationsGetDeploymentsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of DeploymentsOperationsGetDeploymentsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeploymentsOperationsGetDeploymentsCollectionResult(DeploymentsOperations client, string modelPublisher, string modelName, string deploymentType, string clientRequestId, RequestOptions options)
        {
            _client = client;
