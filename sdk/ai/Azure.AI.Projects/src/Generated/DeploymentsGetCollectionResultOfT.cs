...
{
    internal partial class DeploymentsGetCollectionResultOfT : CollectionResult<Deployment>
    {
        ...
        {
            PipelineMessage message = _client.CreateListRequest(_modelPublisher, _modelName, _deploymentType, _clientRequestId, _options);
            ...
            while (true)
            {
                ...
                message = _client.CreateNextListRequest(nextPageUri, _modelPublisher, _modelName, _deploymentType, _clientRequestId, _options);
            }
        }
        ...
        protected override IEnumerable<Deployment> GetValuesFromPage(ClientResult page)
        {
