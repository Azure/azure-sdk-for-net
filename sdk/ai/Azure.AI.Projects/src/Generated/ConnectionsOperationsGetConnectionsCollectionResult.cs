...
{
    internal partial class ConnectionsOperationsGetConnectionsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of ConnectionsOperationsGetConnectionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConnectionsOperationsGetConnectionsCollectionResult(ConnectionsOperations client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
