...
namespace Azure.AI.Projects
{
    ...
    public partial class HourlyRecurrenceSchedule : RecurrenceSchedule, IJsonModel<HourlyRecurrenceSchedule>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HourlyRecurrenceSchedule>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HourlyRecurrenceSchedule)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HourlyRecurrenceSchedule IJsonModel<HourlyRecurrenceSchedule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HourlyRecurrenceSchedule)JsonModelCreateCore(ref reader, options);
        ...
        protected override RecurrenceSchedule JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HourlyRecurrenceSchedule)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeHourlyRecurrenceSchedule(document.RootElement, options);
        }
        ...
        protected override RecurrenceSchedule PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HourlyRecurrenceSchedule)} does not support reading '{options.Format}' format.");
            }
        }
