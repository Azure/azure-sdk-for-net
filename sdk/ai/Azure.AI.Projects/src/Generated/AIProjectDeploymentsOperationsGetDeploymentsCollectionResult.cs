...
{
    internal partial class AIProjectDeploymentsOperationsGetDeploymentsCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of AIProjectDeploymentsOperationsGetDeploymentsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public AIProjectDeploymentsOperationsGetDeploymentsCollectionResult(AIProjectDeploymentsOperations client, string modelPublisher, string modelName, string deploymentType, string clientRequestId, RequestOptions options)
        {
            _client = client;
