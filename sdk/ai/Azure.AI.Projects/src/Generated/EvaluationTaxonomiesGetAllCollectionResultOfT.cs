...
namespace Azure.AI.Projects
{
    internal partial class EvaluationTaxonomiesGetAllCollectionResultOfT : CollectionResult<EvaluationTaxonomy>
    {
        ...
        public EvaluationTaxonomiesGetAllCollectionResultOfT(EvaluationTaxonomies client, string inputName, string inputType, string clientRequestId, RequestOptions options)
        {
            _client = client;
