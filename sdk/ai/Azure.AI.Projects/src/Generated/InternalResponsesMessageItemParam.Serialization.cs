...
namespace OpenAI
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="InternalResponsesMessageItemParam"/> for deserialization. </summary>
        internal InternalResponsesMessageItemParam()
        {
        }
        ...
        internal static InternalResponsesMessageItemParam DeserializeInternalResponsesMessageItemParam(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return UnknownResponsesMessageItemParam.DeserializeUnknownResponsesMessageItemParam(element, options);
        }
