...
namespace Azure.AI.Projects
{
    ...
    public partial class AgentPageableListOfVectorStoreFile
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AgentPageableListOfVectorStoreFile"/>. </summary>
        ...
        internal AgentPageableListOfVectorStoreFile(IEnumerable<VectorStoreFile> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal AgentPageableListOfVectorStoreFile(AgentPageableListOfVectorStoreFileObject @object, IReadOnlyList<VectorStoreFile> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="AgentPageableListOfVectorStoreFile"/> for deserialization. </summary>
        internal AgentPageableListOfVectorStoreFile()
        {
        }

        /// <summary> The object type, which is always list. </summary>
        public AgentPageableListOfVectorStoreFileObject Object { get; } = AgentPageableListOfVectorStoreFileObject.List;
