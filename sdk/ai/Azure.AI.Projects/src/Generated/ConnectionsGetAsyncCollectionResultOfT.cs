...
{
    internal partial class ConnectionsGetAsyncCollectionResultOfT : AsyncCollectionResult<Connection>
    {
        ...
        /// <summary> Initializes a new instance of ConnectionsGetAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConnectionsGetAsyncCollectionResultOfT(Connections client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
        ...
        protected override async IAsyncEnumerable<Connection> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (Connection item in ((PagedConnection)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
