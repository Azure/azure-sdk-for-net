...
namespace Azure.AI.Projects
{
    internal partial class AIProjectConnectionsOperationsGetConnectionsCollectionResult : CollectionResult
    {
        ...
        public AIProjectConnectionsOperationsGetConnectionsCollectionResult(AIProjectConnectionsOperations client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
