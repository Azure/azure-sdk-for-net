...
{
    internal partial class DeploymentsGetCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of DeploymentsGetCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeploymentsGetCollectionResult(Deployments client, string modelPublisher, string modelName, string deploymentType, string clientRequestId, RequestOptions options)
        {
            _client = client;
