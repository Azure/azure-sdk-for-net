...
{
    internal partial class DatasetsOperationsGetDatasetVersionsAsyncCollectionResultOfT : AsyncCollectionResult<DatasetVersion>
    {
        private readonly DatasetsOperations _client;
        private readonly string _name;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of DatasetsOperationsGetDatasetVersionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DatasetsOperationsGetDatasetVersionsAsyncCollectionResultOfT(DatasetsOperations client, string name, RequestOptions options)
        {
