...
{
    internal partial class IndexesGetVersionsAsyncCollectionResultOfT : AsyncCollectionResult<Index>
    {
        ...
        protected override async IAsyncEnumerable<Index> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (Index item in ((PagedIndex)page).Value)
            {
                yield return item;
                await Task.Yield();
            }
