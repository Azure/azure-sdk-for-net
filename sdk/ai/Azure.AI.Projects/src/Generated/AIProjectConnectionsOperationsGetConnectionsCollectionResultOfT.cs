...
namespace Azure.AI.Projects
{
    internal partial class AIProjectConnectionsOperationsGetConnectionsCollectionResultOfT : CollectionResult<AIProjectConnection>
    {
        ...
        public AIProjectConnectionsOperationsGetConnectionsCollectionResultOfT(AIProjectConnectionsOperations client, string connectionType, bool? defaultConnection, string clientRequestId, RequestOptions options)
        {
            _client = client;
