...
namespace Azure.AI.Language.Models
{
    ...
    internal partial class LanguageResult
    {
        ...
        internal LanguageResult(IEnumerable<DocumentLanguage> documents, IEnumerable<DocumentError> errors, string modelVersion)
        {
            if (documents == null)
            {
        ...
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        internal LanguageResult(IReadOnlyList<DocumentLanguage> documents, IReadOnlyList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion)
        {
            Documents = documents;
            Errors = errors;
        ...
        public IReadOnlyList<DocumentLanguage> Documents { get; }
