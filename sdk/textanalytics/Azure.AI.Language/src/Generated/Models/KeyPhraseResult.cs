...
namespace Azure.AI.Language.Models
{
    ...
    internal partial class KeyPhraseResult
    {
        ...
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        internal KeyPhraseResult(IReadOnlyList<DocumentKeyPhrases> documents, IReadOnlyList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion)
        {
            Documents = documents;
            Errors = errors;
