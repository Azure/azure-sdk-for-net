...
namespace Azure.AI.Language
{
    ...
    /// </summary>
    internal partial class TextAnalyticsClient
    {
        private readonly Uri _baseUri;
        private readonly TextAnalyticsRestClient _serviceRestClient;
        private readonly KnowledgebaseRestClient _qaServiceRestClient;
        ...
        public TextAnalyticsClient(Uri endpoint, TokenCredential credential, TextAnalyticsClientOptions options)
        {
            ...
            _qaServiceRestClient = new KnowledgebaseRestClient(_clientDiagnostics, pipeline, endpoint.AbsoluteUri);
        }
...
#pragma warning restore AZC0007 // DO provide a minimal constructor that takes only the parameters required to connect to the service.
        ...
        /// <returns></returns>
        public virtual async Task<Response<QnASearchResultList>> GenerateAnswerAsync(string kbId, Query query, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                Response<QnASearchResultList> result = await _qaServiceRestClient.GenerateAnswerAsync(kbId, query, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public virtual Response<QnASearchResultList> GenerateAnswer(string kbId, Query query, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(query.Question, nameof(query.Question));
            ...
            try
            {
                Response<QnASearchResultList> result = _qaServiceRestClient.GenerateAnswer(kbId, query);
                Response response = result.GetRawResponse();
