...
``` yaml
input-file:
    -  https://github.com/Azure/azure-rest-api-specs/blob/86bb1c91f57a9337fa09e79d9793e7f3e7a419ac/specification/cognitiveservices/data-plane/TextAnalytics/preview/v3.2-preview.1/TextAnalytics.json
```
