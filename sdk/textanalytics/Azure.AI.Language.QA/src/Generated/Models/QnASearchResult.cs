...
namespace Azure.AI.Language.QA.Models
{
    ...
    internal partial class QnASearchResult
    {
        ...
        internal QnASearchResult(IReadOnlyList<string> questions, string answer, float? score, int? id, string source, IReadOnlyList<MetadataDTO> metadata, ContextDTO context, AnswerSpanResponseDTO answerSpan)
        {
            Questions = questions;
            Answer = answer;
            Score = score;
