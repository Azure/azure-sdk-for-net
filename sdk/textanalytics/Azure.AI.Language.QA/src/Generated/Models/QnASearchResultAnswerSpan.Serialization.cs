...
{
    public partial class QnASearchResultAnswerSpan
    {
        internal static QnASearchResultAnswerSpan DeserializeQnASearchResultAnswerSpan(JsonElement element)
        {
            ...
            return new QnASearchResultAnswerSpan(text.Value, Optional.ToNullable(score), Optional.ToNullable(startIndex), Optional.ToNullable(endIndex));
        }
    }
}
