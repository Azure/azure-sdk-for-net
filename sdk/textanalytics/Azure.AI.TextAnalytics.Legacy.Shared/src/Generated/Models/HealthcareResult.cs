...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class HealthcareResult
    {
        ...
        internal HealthcareResult(IReadOnlyList<DocumentHealthcareEntities> documents, IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, Dictionary<string, BinaryData> rawData)
        {
            Documents = documents;
            Errors = errors;
