...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class AnalyzeBatchInput : JobDescriptor
    {
        ...
        internal AnalyzeBatchInput(string displayName, MultiLanguageBatchInput analysisInput, JobManifestTasks tasks, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(displayName, serializedAdditionalRawData)
        {
            AnalysisInput = analysisInput;
            Tasks = tasks;
        }
