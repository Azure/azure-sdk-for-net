...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class AnalyzeBatchInput : JobDescriptor
    {
        ...
        internal AnalyzeBatchInput(string displayName, MultiLanguageBatchInput analysisInput, JobManifestTasks tasks, Dictionary<string, BinaryData> rawData) : base(displayName, rawData)
        {
            AnalysisInput = analysisInput;
            Tasks = tasks;
        }
