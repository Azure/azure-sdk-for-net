...
namespace Azure.AI.TextAnalytics.Legacy
{
    internal partial class AnalyzeJobState
    {
        internal static AnalyzeJobState DeserializeAnalyzeJobState(JsonElement element)
        {
            ...
            return new AnalyzeJobState(createdDateTime, Core.Optional.ToNullable(expirationDateTime), jobId, lastUpdateDateTime, status, displayName.Value, tasks, Core.Optional.ToList(errors), statistics.Value, nextLink.Value);
        }
    }
}
