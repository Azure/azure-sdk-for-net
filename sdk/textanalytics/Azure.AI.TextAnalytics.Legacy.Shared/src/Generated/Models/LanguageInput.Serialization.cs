...
namespace Azure.AI.TextAnalytics.Legacy
{
    internal partial class LanguageInput : IUtf8JsonSerializable, IJsonModel<LanguageInput>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LanguageInput>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LanguageInput>)} interface");
            }
