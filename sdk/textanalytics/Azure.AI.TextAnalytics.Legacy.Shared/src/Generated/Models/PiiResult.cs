...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class PiiResult
    {
        ...
        internal PiiResult(IReadOnlyList<PiiDocumentEntities> documents, IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Documents = documents;
            Errors = errors;
