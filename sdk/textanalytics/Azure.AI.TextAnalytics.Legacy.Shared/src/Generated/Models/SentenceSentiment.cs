...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class SentenceSentiment
    {
        ...
        internal SentenceSentiment(string text, SentenceSentimentValue sentiment, SentimentConfidenceScorePerLabel confidenceScores, int offset, int length, IReadOnlyList<SentenceTarget> targets, IReadOnlyList<SentenceAssessment> assessments, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
