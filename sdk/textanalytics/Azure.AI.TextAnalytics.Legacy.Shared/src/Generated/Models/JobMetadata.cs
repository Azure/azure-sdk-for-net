...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class JobMetadata
    {
        ...
        internal JobMetadata(DateTimeOffset createdDateTime, DateTimeOffset? expirationDateTime, Guid jobId, DateTimeOffset lastUpdateDateTime, State status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedDateTime = createdDateTime;
