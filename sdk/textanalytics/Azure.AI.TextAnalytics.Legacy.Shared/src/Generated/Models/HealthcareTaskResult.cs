...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class HealthcareTaskResult
    {
        ...
        internal HealthcareTaskResult(HealthcareResult results, IReadOnlyList<TextAnalyticsError> errors, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Results = results;
            Errors = errors;
