...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class DocumentHealthcareEntities
    {
        ...
        internal DocumentHealthcareEntities(string id, IReadOnlyList<HealthcareEntity> entities, IReadOnlyList<HealthcareRelation> relations, IReadOnlyList<TextAnalyticsWarning> warnings, DocumentStatistics statistics, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Entities = entities;
            Relations = relations;
