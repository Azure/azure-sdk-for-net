...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class SentenceAssessment
    {
        ...
        internal SentenceAssessment(TokenSentimentValue sentiment, TargetConfidenceScoreLabel confidenceScores, int offset, int length, string text, bool isNegated, Dictionary<string, BinaryData> rawData)
        {
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
            Offset = offset;
