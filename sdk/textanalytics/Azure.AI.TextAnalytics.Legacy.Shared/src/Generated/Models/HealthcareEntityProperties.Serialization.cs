...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    {
        internal static HealthcareEntityProperties DeserializeHealthcareEntityProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
