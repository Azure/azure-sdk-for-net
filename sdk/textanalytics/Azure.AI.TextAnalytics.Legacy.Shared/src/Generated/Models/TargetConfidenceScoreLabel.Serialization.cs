...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetConfidenceScoreLabel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TargetConfidenceScoreLabel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetConfidenceScoreLabel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TargetConfidenceScoreLabel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
