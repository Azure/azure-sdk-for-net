...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareEntityLink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthcareEntityLink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareEntityLink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareEntityLink>)} interface");
            }
        ...
        string IPersistableModel<HealthcareEntityLink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
