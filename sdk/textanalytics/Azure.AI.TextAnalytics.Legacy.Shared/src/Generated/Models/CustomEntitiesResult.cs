...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class CustomEntitiesResult
    {
        ...
        /// <param name="projectName"> This field indicates the project name for the model. </param>
        /// <param name="deploymentName"> This field indicates the deployment name for the model. </param>
        internal CustomEntitiesResult(IReadOnlyList<DocumentEntities> documents, IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string projectName, string deploymentName)
        {
            Documents = documents;
            Errors = errors;
