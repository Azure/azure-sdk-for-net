...
namespace Azure.AI.TextAnalytics.Legacy
{
    internal partial class HealthcareRelation : IUtf8JsonSerializable, IJsonModel<HealthcareRelation>
    {
        ...
        void IJsonModel<HealthcareRelation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HealthcareRelation)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HealthcareRelation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HealthcareRelation)} does not support '{options.Format}' format.");
            }
        }
