...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class ExtractedDocumentSummary
    {
        ...
        internal ExtractedDocumentSummary(string id, IEnumerable<ExtractedSummarySentence> sentences, IEnumerable<TextAnalyticsWarning> warnings)
        {
            if (id == null)
            {
        ...
        internal ExtractedDocumentSummary(string id, IReadOnlyList<ExtractedSummarySentence> sentences, IReadOnlyList<TextAnalyticsWarning> warnings, DocumentStatistics statistics)
        {
            Id = id;
            Sentences = sentences;
            Warnings = warnings;
