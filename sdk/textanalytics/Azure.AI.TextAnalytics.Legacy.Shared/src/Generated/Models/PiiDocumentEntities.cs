...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class PiiDocumentEntities
    {
        ...
        internal PiiDocumentEntities(string id, string redactedText, IReadOnlyList<Entity> entities, IReadOnlyList<TextAnalyticsWarning> warnings, DocumentStatistics statistics, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            RedactedText = redactedText;
            Entities = entities;
