...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class PiiTaskParameters
    {
        ...
        internal PiiTaskParameters(PiiTaskParametersDomain? domain, string modelVersion, bool? loggingOptOut, IList<PiiEntityLegacyCategory> piiCategories, StringIndexType? stringIndexType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
