...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobManifestTasks>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JobManifestTasks>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JobManifestTasks>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<JobManifestTasks>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
