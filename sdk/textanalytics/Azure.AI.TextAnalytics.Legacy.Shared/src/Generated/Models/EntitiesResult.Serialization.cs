...
namespace Azure.AI.TextAnalytics.Legacy
{
    internal partial class EntitiesResult : IUtf8JsonSerializable, IModelJsonSerializable<EntitiesResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<EntitiesResult>(this, options.Format);
            ...
            foreach (var item in Documents)
            {
                ...
                {
                    ((IModelJsonSerializable<DocumentEntities>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="EntitiesResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="EntitiesResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="EntitiesResult"/>. </summary>
