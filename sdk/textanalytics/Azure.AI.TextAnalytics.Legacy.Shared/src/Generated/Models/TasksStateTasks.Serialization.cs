...
namespace Azure.AI.TextAnalytics.Legacy.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TasksStateTasks>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TasksStateTasks>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TasksStateTasks>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TasksStateTasks>)} interface");
            }
        ...
        string IPersistableModel<TasksStateTasks>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
