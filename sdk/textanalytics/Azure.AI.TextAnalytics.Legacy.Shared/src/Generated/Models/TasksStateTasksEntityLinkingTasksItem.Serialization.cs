...
namespace Azure.AI.TextAnalytics.Legacy.Models
{
    ...
    {
        internal static TasksStateTasksEntityLinkingTasksItem DeserializeTasksStateTasksEntityLinkingTasksItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
