...
namespace Azure.AI.TextAnalytics.Legacy.Models
{
    ...
    {
        internal static TasksStateTasksEntityRecognitionTasksItem DeserializeTasksStateTasksEntityRecognitionTasksItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
