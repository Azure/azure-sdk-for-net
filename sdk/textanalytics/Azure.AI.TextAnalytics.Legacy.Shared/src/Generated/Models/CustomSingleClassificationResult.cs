...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class CustomSingleClassificationResult
    {
        ...
        /// <param name="projectName"> This field indicates the project name for the model. </param>
        /// <param name="deploymentName"> This field indicates the deployment name for the model. </param>
        internal CustomSingleClassificationResult(IReadOnlyList<SingleClassificationDocument> documents, IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string projectName, string deploymentName)
        {
            Documents = documents;
            Errors = errors;
