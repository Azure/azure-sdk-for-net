...
namespace Azure.AI.TextAnalytics.Legacy
{
    internal partial class HealthcareJobState : IUtf8JsonSerializable, IJsonModel<HealthcareJobState>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareJobState>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareJobState>)} interface");
            }
