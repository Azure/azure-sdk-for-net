...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareJobState>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthcareJobState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareJobState>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<HealthcareJobState>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
