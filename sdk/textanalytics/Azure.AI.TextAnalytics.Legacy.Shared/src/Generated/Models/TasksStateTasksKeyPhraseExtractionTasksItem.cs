...
namespace Azure.AI.TextAnalytics.Legacy.Models
{
    ...
    internal partial class TasksStateTasksKeyPhraseExtractionTasksItem : TaskState
    {
        ...
        internal TasksStateTasksKeyPhraseExtractionTasksItem(DateTimeOffset lastUpdateDateTime, string taskName, State status, KeyPhraseResult results, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(lastUpdateDateTime, taskName, status, serializedAdditionalRawData)
        {
            Results = results;
        }
