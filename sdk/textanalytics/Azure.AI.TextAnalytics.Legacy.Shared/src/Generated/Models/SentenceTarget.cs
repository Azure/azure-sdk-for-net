...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class SentenceTarget
    {
        ...
        internal SentenceTarget(TokenSentimentValue sentiment, TargetConfidenceScoreLabel confidenceScores, int offset, int length, string text, IReadOnlyList<TargetRelation> relations, Dictionary<string, BinaryData> rawData)
        {
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
            Offset = offset;
