...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    {
        internal static HealthcareLinkingProperties DeserializeHealthcareLinkingProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
