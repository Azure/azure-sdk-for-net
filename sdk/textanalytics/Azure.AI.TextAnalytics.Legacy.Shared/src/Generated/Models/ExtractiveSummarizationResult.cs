...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class ExtractiveSummarizationResult
    {
        ...
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        internal ExtractiveSummarizationResult(IReadOnlyList<ExtractedDocumentSummary> documents, IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion)
        {
            Documents = documents;
            Errors = errors;
