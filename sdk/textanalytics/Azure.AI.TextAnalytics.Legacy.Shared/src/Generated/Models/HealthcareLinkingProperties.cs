...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class HealthcareLinkingProperties
    {
        ...
        internal HealthcareLinkingProperties(HealthcareAssertion assertion, string name, IReadOnlyList<HealthcareEntityLink> links, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Assertion = assertion;
            Name = name;
            Links = links;
