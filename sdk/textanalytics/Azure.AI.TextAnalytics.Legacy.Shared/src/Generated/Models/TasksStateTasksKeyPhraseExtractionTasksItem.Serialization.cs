...
namespace Azure.AI.TextAnalytics.Legacy.Models
{
    ...
    {
        internal static TasksStateTasksKeyPhraseExtractionTasksItem DeserializeTasksStateTasksKeyPhraseExtractionTasksItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
