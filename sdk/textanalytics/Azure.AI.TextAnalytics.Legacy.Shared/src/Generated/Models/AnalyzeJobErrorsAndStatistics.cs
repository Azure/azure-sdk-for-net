...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class AnalyzeJobErrorsAndStatistics
    {
        ...
        internal AnalyzeJobErrorsAndStatistics(IReadOnlyList<TextAnalyticsError> errors, RequestStatistics statistics, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
