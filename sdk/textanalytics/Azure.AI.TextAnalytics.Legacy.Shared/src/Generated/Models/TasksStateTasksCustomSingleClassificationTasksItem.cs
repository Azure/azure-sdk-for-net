...
namespace Azure.AI.TextAnalytics.Legacy.Models
{
    ...
    internal partial class TasksStateTasksCustomSingleClassificationTasksItem : TaskState
    {
        ...
        internal TasksStateTasksCustomSingleClassificationTasksItem(DateTimeOffset lastUpdateDateTime, string taskName, State status, CustomSingleClassificationResult results) : base(lastUpdateDateTime, taskName, status)
        {
            Results = results;
        }
