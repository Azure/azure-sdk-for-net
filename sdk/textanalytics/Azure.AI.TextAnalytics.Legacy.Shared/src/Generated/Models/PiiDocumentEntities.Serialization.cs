...
namespace Azure.AI.TextAnalytics.Legacy
{
    internal partial class PiiDocumentEntities : IUtf8JsonSerializable, IJsonModel<PiiDocumentEntities>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PiiDocumentEntities>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PiiDocumentEntities>)} interface");
            }
