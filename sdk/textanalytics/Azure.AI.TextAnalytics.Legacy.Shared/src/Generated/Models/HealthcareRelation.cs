...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class HealthcareRelation
    {
        ...
        internal HealthcareRelation(RelationType relationType, IReadOnlyList<HealthcareRelationEntity> entities, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RelationType = relationType;
            Entities = entities;
