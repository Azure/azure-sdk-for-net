...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    internal partial class HealthcareEntityProperties
    {
        ...
        internal HealthcareEntityProperties(string text, HealthcareEntityCategory category, string subcategory, int offset, int length, double confidenceScore, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Category = category;
