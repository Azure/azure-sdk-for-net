...
namespace Azure.AI.TextAnalytics.Legacy.Models
{
    ...
    internal partial class TasksStateTasksSentimentAnalysisTasksItem : TaskState
    {
        ...
        internal TasksStateTasksSentimentAnalysisTasksItem(DateTimeOffset lastUpdateDateTime, string taskName, State status, SentimentResponse results, Dictionary<string, BinaryData> rawData) : base(lastUpdateDateTime, taskName, status, rawData)
        {
            Results = results;
        }
