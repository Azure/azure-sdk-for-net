...
namespace Azure.AI.TextAnalytics.Legacy
{
    ...
    {
        internal static DocumentHealthcareEntities DeserializeDocumentHealthcareEntities(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
