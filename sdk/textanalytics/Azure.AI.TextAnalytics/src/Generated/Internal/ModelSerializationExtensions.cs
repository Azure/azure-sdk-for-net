...
namespace Azure.AI.TextAnalytics
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureAITextAnalyticsContext.Default) } };
