...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class SentimentTaskResult : AnalyzeTextTaskResult
    {
        ...
        internal SentimentTaskResult(AnalyzeTextTaskResultsKind kind, SentimentResponse results, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Results = results;
            Kind = kind;
        }
