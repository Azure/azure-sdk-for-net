...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AbstractiveSummarizationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AbstractiveSummarizationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AbstractiveSummarizationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AbstractiveSummarizationResult>)} interface");
            }
        ...
        string IPersistableModel<AbstractiveSummarizationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
