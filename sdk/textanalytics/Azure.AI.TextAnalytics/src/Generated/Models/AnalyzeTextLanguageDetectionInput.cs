...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AnalyzeTextLanguageDetectionInput : AnalyzeTextTask
    {
        ...
        internal AnalyzeTextLanguageDetectionInput(AnalyzeTextTaskKind kind, LanguageDetectionAnalysisInput analysisInput, LanguageDetectionTaskParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
