...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class CustomLabelClassificationResult : CustomResult
    {
        ...
        internal CustomLabelClassificationResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string projectName, string deploymentName, IList<CustomLabelClassificationResultDocumentsItem> documents, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(errors, statistics, projectName, deploymentName, serializedAdditionalRawData)
        {
            Documents = documents;
        }
