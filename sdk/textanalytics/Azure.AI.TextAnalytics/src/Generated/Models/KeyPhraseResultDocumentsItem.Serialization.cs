...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyPhraseResultDocumentsItem>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<KeyPhraseResultDocumentsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<KeyPhraseResultDocumentsItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(KeyPhraseResultDocumentsItem)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<KeyPhraseResultDocumentsItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(KeyPhraseResultDocumentsItem)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<KeyPhraseResultDocumentsItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
