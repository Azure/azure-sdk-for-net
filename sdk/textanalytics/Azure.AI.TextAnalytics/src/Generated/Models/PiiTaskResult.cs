...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class PiiTaskResult : AnalyzeTextTaskResult
    {
        ...
        internal PiiTaskResult(AnalyzeTextTaskResultsKind kind, PiiEntitiesResult results, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Results = results;
            Kind = kind;
        }
