...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class HealthcareEntitiesDocumentResult : DocumentResult
    {
        ...
        internal HealthcareEntitiesDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<HealthcareEntityInternal> entities, IList<HealthcareRelationInternal> relations, Dictionary<string, BinaryData> rawData) : base(id, warnings, statistics, rawData)
        {
            Entities = entities;
            Relations = relations;
        }
