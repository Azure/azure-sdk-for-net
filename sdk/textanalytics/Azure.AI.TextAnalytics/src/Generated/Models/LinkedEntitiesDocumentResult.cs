...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class LinkedEntitiesDocumentResult : DocumentResult
    {
        ...
        internal LinkedEntitiesDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<LinkedEntity> entities, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
            Entities = entities;
        }
