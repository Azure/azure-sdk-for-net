...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class LinkedEntitiesDocumentResult : DocumentResult
    {
        ...
        internal LinkedEntitiesDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<LinkedEntity> entities, Dictionary<string, BinaryData> rawData) : base(id, warnings, statistics, rawData)
        {
            Entities = entities;
        }
