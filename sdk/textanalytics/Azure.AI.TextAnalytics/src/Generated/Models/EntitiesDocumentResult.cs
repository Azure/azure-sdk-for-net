...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntitiesDocumentResult : DocumentResult
    {
        ...
        internal EntitiesDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<Entity> entities, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
            Entities = entities;
        }
