...
namespace Azure.AI.TextAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentimentConfidenceScores>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SentimentConfidenceScores>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SentimentConfidenceScores>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SentimentConfidenceScores>)} interface");
            }
        ...
        string IPersistableModel<SentimentConfidenceScores>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
