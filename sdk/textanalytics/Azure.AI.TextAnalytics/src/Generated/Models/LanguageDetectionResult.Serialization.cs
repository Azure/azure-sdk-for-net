...
{
    internal partial class LanguageDetectionResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LanguageDetectionResult DeserializeLanguageDetectionResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
