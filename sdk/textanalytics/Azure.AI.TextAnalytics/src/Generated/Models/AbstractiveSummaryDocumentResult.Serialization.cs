...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AbstractiveSummaryDocumentResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AbstractiveSummaryDocumentResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AbstractiveSummaryDocumentResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AbstractiveSummaryDocumentResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
