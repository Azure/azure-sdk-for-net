...
{
    internal partial class AbstractiveSummaryDocumentResult : Core.IUtf8JsonSerializable
    {
        ...
        internal static AbstractiveSummaryDocumentResult DeserializeAbstractiveSummaryDocumentResult(JsonElement element)
        {
            ...
            return new AbstractiveSummaryDocumentResult(id, warnings, Core.Optional.ToNullable(statistics), summaries);
        }
    }
}
