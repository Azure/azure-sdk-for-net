...
{
    internal partial class AbstractiveSummaryDocumentResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AbstractiveSummaryDocumentResult DeserializeAbstractiveSummaryDocumentResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
