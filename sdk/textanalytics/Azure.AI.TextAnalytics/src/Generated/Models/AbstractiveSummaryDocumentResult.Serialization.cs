...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class AbstractiveSummaryDocumentResult : IUtf8JsonSerializable, IJsonModel<AbstractiveSummaryDocumentResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AbstractiveSummaryDocumentResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AbstractiveSummaryDocumentResult>)} interface");
            }
