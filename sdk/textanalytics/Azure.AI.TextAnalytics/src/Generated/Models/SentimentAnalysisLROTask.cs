...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class SentimentAnalysisLROTask : AnalyzeTextLROTask
    {
        ...
        internal SentimentAnalysisLROTask(string taskName, AnalyzeTextLROTaskKind kind, SentimentAnalysisTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(taskName, kind, rawData)
        {
