...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class EntityLinkingTaskParameters : IUtf8JsonSerializable
    {
        ...
        internal static new EntityLinkingTaskParameters FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeEntityLinkingTaskParameters(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<EntityLinkingTaskParameters>(this);
            return content;
        }
    }
}
