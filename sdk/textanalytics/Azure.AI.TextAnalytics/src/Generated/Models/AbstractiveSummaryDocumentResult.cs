...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AbstractiveSummaryDocumentResult : DocumentResult
    {
        ...
        /// <param name="summaries"> A list of abstractive summaries. </param>
        internal AbstractiveSummaryDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<AbstractiveSummaryInternal> summaries) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
            Summaries = summaries;
        }
