...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AbstractiveSummarizationLROTask : AnalyzeTextLROTask
    {
        ...
        internal AbstractiveSummarizationLROTask(string taskName, AnalyzeTextLROTaskKind kind, AbstractiveSummarizationTaskParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(taskName, kind, serializedAdditionalRawData)
        {
            Parameters = parameters;
            Kind = kind;
        }
