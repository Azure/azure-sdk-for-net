...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AbstractiveSummarizationLROTask : AnalyzeTextLROTask
    {
        ...
        internal AbstractiveSummarizationLROTask(string taskName, AnalyzeTextLROTaskKind kind, AbstractiveSummarizationTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(taskName, kind, rawData)
        {
            Parameters = parameters;
            Kind = kind;
        }
