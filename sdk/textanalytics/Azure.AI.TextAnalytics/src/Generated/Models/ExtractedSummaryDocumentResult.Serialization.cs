...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtractedSummaryDocumentResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtractedSummaryDocumentResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtractedSummaryDocumentResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ExtractedSummaryDocumentResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
