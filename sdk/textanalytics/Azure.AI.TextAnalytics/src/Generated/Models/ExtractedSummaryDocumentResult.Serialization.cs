...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class ExtractedSummaryDocumentResult : IUtf8JsonSerializable, IJsonModel<ExtractedSummaryDocumentResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtractedSummaryDocumentResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtractedSummaryDocumentResult>)} interface");
            }
