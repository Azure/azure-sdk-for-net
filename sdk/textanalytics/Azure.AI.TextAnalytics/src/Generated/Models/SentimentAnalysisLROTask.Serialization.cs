...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentimentAnalysisLROTask>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SentimentAnalysisLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SentimentAnalysisLROTask>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SentimentAnalysisLROTask>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
