...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class LanguageDetectionTaskParameters : IUtf8JsonSerializable
    {
        ...
        internal static new LanguageDetectionTaskParameters FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeLanguageDetectionTaskParameters(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<LanguageDetectionTaskParameters>(this);
            return content;
        }
    }
}
