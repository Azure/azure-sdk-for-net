...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class EntitiesResultDocumentsItem : IUtf8JsonSerializable
    {
        ...
        internal static new EntitiesResultDocumentsItem FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeEntitiesResultDocumentsItem(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<EntitiesResultDocumentsItem>(this);
            return content;
        }
    }
}
