...
{
    internal partial class EntitiesResultDocumentsItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static EntitiesResultDocumentsItem DeserializeEntitiesResultDocumentsItem(JsonElement element)
        {
            ...
            return new EntitiesResultDocumentsItem(id, warnings, Core.Optional.ToNullable(statistics), entities);
        }
    }
}
