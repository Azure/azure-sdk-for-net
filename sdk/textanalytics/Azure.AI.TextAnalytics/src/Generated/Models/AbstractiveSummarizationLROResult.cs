...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AbstractiveSummarizationLROResult : AnalyzeTextLROResult
    {
        ...
        internal AbstractiveSummarizationLROResult(DateTimeOffset lastUpdateDateTime, TextAnalyticsOperationStatus status, AnalyzeTextLROResultsKind kind, string taskName, AbstractiveSummarizationResult results, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(lastUpdateDateTime, status, kind, taskName, serializedAdditionalRawData)
        {
            Results = results;
            Kind = kind;
        }
