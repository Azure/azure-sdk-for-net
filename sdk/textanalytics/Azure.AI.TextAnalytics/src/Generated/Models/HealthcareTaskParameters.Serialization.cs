...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class HealthcareTaskParameters : IUtf8JsonSerializable, IJsonModel<HealthcareTaskParameters>
    {
        ...
        void IJsonModel<HealthcareTaskParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HealthcareTaskParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HealthcareTaskParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HealthcareTaskParameters)} does not support '{options.Format}' format.");
            }
        }
