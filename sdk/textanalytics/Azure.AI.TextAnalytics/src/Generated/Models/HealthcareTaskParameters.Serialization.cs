...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class HealthcareTaskParameters : IUtf8JsonSerializable
    {
        ...
        {
            Optional<HealthcareTaskParametersFhirVersion> fhirVersion = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("fhirVersion"))
                {
                    ...
                    fhirVersion = new HealthcareTaskParametersFhirVersion(property.Value.GetString());
                    continue;
                }
            ...
            return new HealthcareTaskParameters(Optional.ToNullable(loggingOptOut), modelVersion.Value, Optional.ToNullable(fhirVersion), Optional.ToNullable(stringIndexType));
        }
    }
}
