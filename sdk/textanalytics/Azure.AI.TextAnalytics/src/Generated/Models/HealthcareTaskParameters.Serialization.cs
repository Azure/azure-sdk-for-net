...
{
    internal partial class HealthcareTaskParameters : Core.IUtf8JsonSerializable
    {
        ...
        internal static HealthcareTaskParameters DeserializeHealthcareTaskParameters(JsonElement element)
        {
            ...
            return new HealthcareTaskParameters(Core.Optional.ToNullable(loggingOptOut), modelVersion.Value, Core.Optional.ToNullable(stringIndexType));
        }
    }
}
