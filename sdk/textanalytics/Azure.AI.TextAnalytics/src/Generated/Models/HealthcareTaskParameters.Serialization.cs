...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareTaskParameters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthcareTaskParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareTaskParameters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareTaskParameters>)} interface");
            }
        ...
        string IPersistableModel<HealthcareTaskParameters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
