...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class ClassificationDocumentResult : DocumentResult
    {
        ...
        /// <param name="class"></param>
        internal ClassificationDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<ClassificationResult> @class) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
            Class = @class;
        }

        /// <summary> Initializes a new instance of <see cref="ClassificationDocumentResult"/> for deserialization. </summary>
        internal ClassificationDocumentResult()
        {
        }
