...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AnalyzeTextLROResult : TaskState
    {
        ...
        internal AnalyzeTextLROResult(DateTimeOffset lastUpdateDateTime, TextAnalyticsOperationStatus status, AnalyzeTextLROResultsKind kind, string taskName, Dictionary<string, BinaryData> rawData) : base(lastUpdateDateTime, status, rawData)
        {
            Kind = kind;
            TaskName = taskName;
        }
