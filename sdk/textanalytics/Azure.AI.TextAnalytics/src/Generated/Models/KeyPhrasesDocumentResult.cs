...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class KeyPhrasesDocumentResult : DocumentResult
    {
        ...
        /// <param name="keyPhrases"> A list of representative words or phrases. The number of key phrases returned is proportional to the number of words in the input document. </param>
        internal KeyPhrasesDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<string> keyPhrases) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
