...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class KeyPhrasesDocumentResult : DocumentResult
    {
        ...
        internal KeyPhrasesDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<string> keyPhrases, Dictionary<string, BinaryData> rawData) : base(id, warnings, statistics, rawData)
        {
