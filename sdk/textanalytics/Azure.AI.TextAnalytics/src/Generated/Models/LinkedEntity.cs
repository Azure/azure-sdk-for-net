...
namespace Azure.AI.TextAnalytics
{
    ...
    public readonly partial struct LinkedEntity
    {
        ...
        internal LinkedEntity(string name, IEnumerable<LinkedEntityMatch> matches, string language, string dataSourceEntityId, Uri url, string dataSource, string bingEntitySearchApiId, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Matches = matches;
            Language = language;
