...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntityLinkingResult : PreBuiltResult
    {
        ...
        internal EntityLinkingResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<EntityLinkingResultDocumentsItem> documents, Dictionary<string, BinaryData> rawData) : base(errors, statistics, modelVersion, rawData)
        {
            Documents = documents;
        }
