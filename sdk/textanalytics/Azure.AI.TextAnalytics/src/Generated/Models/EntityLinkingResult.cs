...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntityLinkingResult : PreBuiltResult
    {
        ...
        internal EntityLinkingResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<EntityLinkingResultDocumentsItem> documents, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
