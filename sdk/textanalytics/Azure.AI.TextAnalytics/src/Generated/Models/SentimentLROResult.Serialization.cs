...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SentimentLROResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SentimentLROResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SentimentLROResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SentimentLROResult>)} interface");
            }
        ...
        string IPersistableModel<SentimentLROResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
