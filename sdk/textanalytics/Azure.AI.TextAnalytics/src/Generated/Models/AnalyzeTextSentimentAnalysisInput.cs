...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AnalyzeTextSentimentAnalysisInput : AnalyzeTextTask
    {
        ...
        internal AnalyzeTextSentimentAnalysisInput(AnalyzeTextTaskKind kind, MultiLanguageAnalysisInput analysisInput, SentimentAnalysisTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(kind, rawData)
        {
