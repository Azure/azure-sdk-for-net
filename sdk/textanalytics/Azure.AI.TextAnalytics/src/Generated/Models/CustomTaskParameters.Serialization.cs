...
{
    internal partial class CustomTaskParameters : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CustomTaskParameters DeserializeCustomTaskParameters(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
