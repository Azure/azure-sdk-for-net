...
{
    internal partial class HealthcareLROResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HealthcareLROResult DeserializeHealthcareLROResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
