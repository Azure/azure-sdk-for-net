...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class HealthcareLROResult : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<HealthcareResult>(Results);
        ...
        internal static HealthcareLROResult DeserializeHealthcareLROResult(JsonElement element)
        {
            ...
            return new HealthcareLROResult(lastUpdateDateTime, status, kind, taskName, results);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<HealthcareLROResult>(this);
            return content;
        }
    }
}
