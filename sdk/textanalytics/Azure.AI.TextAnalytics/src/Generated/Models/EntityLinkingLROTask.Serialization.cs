...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class EntityLinkingLROTask : IUtf8JsonSerializable, IJsonModel<EntityLinkingLROTask>
    {
        ...
        void IJsonModel<EntityLinkingLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EntityLinkingLROTask)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EntityLinkingLROTask>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EntityLinkingLROTask)} does not support '{options.Format}' format.");
            }
        }
