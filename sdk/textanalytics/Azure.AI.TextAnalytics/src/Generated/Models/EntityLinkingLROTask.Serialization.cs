...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EntityLinkingLROTask>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EntityLinkingLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EntityLinkingLROTask>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EntityLinkingLROTask>)} interface");
            }
        ...
        string IPersistableModel<EntityLinkingLROTask>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
