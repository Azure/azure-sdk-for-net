...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EntityLinkingLROTask>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<EntityLinkingLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EntityLinkingLROTask>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
