...
namespace Azure.AI.TextAnalytics
{
    ...
    internal partial class EntityRecognitionPiiTasksItem : TaskState
    {
        ...
        internal EntityRecognitionPiiTasksItem(DateTimeOffset lastUpdateDateTime, OperationStatus status, PiiEntitiesResult resultsInternal) : base(lastUpdateDateTime, status)
        {
        ...
        /// <param name="status"> . </param>
        /// <param name="resultsInternal"> . </param>
        internal EntityRecognitionPiiTasksItem(DateTimeOffset lastUpdateDateTime, string name, OperationStatus status, PiiEntitiesResult resultsInternal) : base(lastUpdateDateTime, name, status)
        {
            ResultsInternal = resultsInternal;
        }
    }
