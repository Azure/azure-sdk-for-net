...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class EntitiesTaskResult : IUtf8JsonSerializable, IJsonModel<EntitiesTaskResult>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<EntitiesTaskResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EntitiesTaskResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EntitiesTaskResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EntitiesTaskResult)} does not support '{options.Format}' format.");
            }
        }
