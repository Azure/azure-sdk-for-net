...
{
    internal partial class CustomSingleLabelClassificationTaskParameters : Core.IUtf8JsonSerializable
    {
        ...
        internal static CustomSingleLabelClassificationTaskParameters DeserializeCustomSingleLabelClassificationTaskParameters(JsonElement element)
        {
            ...
            return new CustomSingleLabelClassificationTaskParameters(Core.Optional.ToNullable(loggingOptOut), projectName, deploymentName);
        }
    }
}
