...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class ExtractiveSummarizationResult : PreBuiltResult
    {
        ...
        public ExtractiveSummarizationResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<ExtractiveSummarizationResultDocumentsItem> documents) : base(errors, modelVersion)
        {
            if (errors == null)
            {
        ...
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        /// <param name="documents"> Response by document. </param>
        internal ExtractiveSummarizationResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<ExtractiveSummarizationResultDocumentsItem> documents) : base(errors, statistics, modelVersion)
        {
            Documents = documents;
        }
