...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class ExtractiveSummarizationResult : PreBuiltResult
    {
        ...
        internal ExtractiveSummarizationResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<ExtractedSummaryDocumentResult> documents, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
