...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntityRecognitionLROResult : AnalyzeTextLROResult
    {
        ...
        internal EntityRecognitionLROResult(DateTimeOffset lastUpdateDateTime, TextAnalyticsOperationStatus status, AnalyzeTextLROResultsKind kind, string taskName, EntitiesResult results, Dictionary<string, BinaryData> rawData) : base(lastUpdateDateTime, status, kind, taskName, rawData)
        {
            Results = results;
            Kind = kind;
        }
