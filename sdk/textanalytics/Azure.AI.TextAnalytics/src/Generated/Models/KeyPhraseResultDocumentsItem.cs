...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class KeyPhraseResultDocumentsItem : KeyPhrasesDocumentResult
    {
        ...
        internal KeyPhraseResultDocumentsItem(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<string> keyPhrases, Dictionary<string, BinaryData> rawData) : base(id, warnings, statistics, keyPhrases, rawData)
        {
        }
