...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class KeyPhrasesDocumentResult : IUtf8JsonSerializable, IJsonModel<KeyPhrasesDocumentResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyPhrasesDocumentResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyPhrasesDocumentResult>)} interface");
            }
