...
{
    internal partial class KeyPhrasesDocumentResult : Core.IUtf8JsonSerializable
    {
        ...
        internal static KeyPhrasesDocumentResult DeserializeKeyPhrasesDocumentResult(JsonElement element)
        {
            ...
            return new KeyPhrasesDocumentResult(id, warnings, Core.Optional.ToNullable(statistics), keyPhrases);
        }
    }
}
