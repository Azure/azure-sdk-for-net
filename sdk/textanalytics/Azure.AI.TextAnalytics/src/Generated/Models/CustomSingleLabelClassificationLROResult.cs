...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class CustomSingleLabelClassificationLROResult : AnalyzeTextLROResult
    {
        ...
        internal CustomSingleLabelClassificationLROResult(DateTimeOffset lastUpdateDateTime, TextAnalyticsOperationStatus status, AnalyzeTextLROResultsKind kind, string taskName, CustomLabelClassificationResult results, Dictionary<string, BinaryData> rawData) : base(lastUpdateDateTime, status, kind, taskName, rawData)
        {
            Results = results;
            Kind = kind;
        }
