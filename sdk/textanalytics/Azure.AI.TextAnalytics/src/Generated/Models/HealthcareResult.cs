...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class HealthcareResult : PreBuiltResult
    {
        ...
        internal HealthcareResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<HealthcareResultDocumentsItem> documents, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
