...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class HealthcareResult : PreBuiltResult
    {
        ...
        internal HealthcareResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<HealthcareResultDocumentsItem> documents, Dictionary<string, BinaryData> rawData) : base(errors, statistics, modelVersion, rawData)
        {
            Documents = documents;
        }
