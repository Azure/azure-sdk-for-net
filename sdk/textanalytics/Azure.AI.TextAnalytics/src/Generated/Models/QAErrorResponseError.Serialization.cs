...
{
    internal partial class QAErrorResponseError
    {
        internal static QAErrorResponseError DeserializeQAErrorResponseError(JsonElement element)
        {
            ...
            return new QAErrorResponseError(code, message.Value, target.Value, Optional.ToList(details), innerError.Value);
        }
    }
}
