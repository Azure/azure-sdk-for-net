...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class ExtractiveSummarizationLROTask : AnalyzeTextLROTask
    {
        ...
        internal ExtractiveSummarizationLROTask(string taskName, AnalyzeTextLROTaskKind kind, ExtractiveSummarizationTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(taskName, kind, rawData)
        {
