...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class PiiLROTask : AnalyzeTextLROTask
    {
        ...
        internal PiiLROTask(string taskName, AnalyzeTextLROTaskKind kind, PiiTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(taskName, kind, rawData)
        {
