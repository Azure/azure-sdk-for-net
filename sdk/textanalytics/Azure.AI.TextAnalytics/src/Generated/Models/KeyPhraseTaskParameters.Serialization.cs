...
{
    internal partial class KeyPhraseTaskParameters : Core.IUtf8JsonSerializable
    {
        ...
        internal static KeyPhraseTaskParameters DeserializeKeyPhraseTaskParameters(JsonElement element)
        {
            ...
            return new KeyPhraseTaskParameters(Core.Optional.ToNullable(loggingOptOut), modelVersion.Value);
        }
    }
}
