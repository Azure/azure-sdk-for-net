...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal readonly partial struct SentenceSentiment_internal
    {
        /// <summary> Initializes a new instance of SentenceSentiment_internal. </summary>
        ...
        internal SentenceSentiment_internal(string text, string sentiment, SentimentConfidenceScores confidenceScores, int offset, int length, IEnumerable<SentenceAspect> aspects, IEnumerable<SentenceOpinion> opinions)
        {
            if (text == null)
            {
        ...
        /// <param name="aspects"> The array of aspect object for the sentence. </param>
        /// <param name="opinions"> The array of opinion object for the sentence. </param>
        internal SentenceSentiment_internal(string text, string sentiment, SentimentConfidenceScores confidenceScores, int offset, int length, IReadOnlyList<SentenceAspect> aspects, IReadOnlyList<SentenceOpinion> opinions)
        {
            Text = text;
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
