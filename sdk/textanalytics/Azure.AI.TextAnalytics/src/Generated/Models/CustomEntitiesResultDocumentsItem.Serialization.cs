...
{
    internal partial class CustomEntitiesResultDocumentsItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static CustomEntitiesResultDocumentsItem DeserializeCustomEntitiesResultDocumentsItem(JsonElement element)
        {
            ...
            return new CustomEntitiesResultDocumentsItem(id, warnings, Core.Optional.ToNullable(statistics), entities);
        }
    }
}
