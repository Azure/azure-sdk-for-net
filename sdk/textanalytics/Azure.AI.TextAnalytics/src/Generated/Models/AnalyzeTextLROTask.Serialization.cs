...
{
    internal partial class AnalyzeTextLROTask : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AnalyzeTextLROTask DeserializeAnalyzeTextLROTask(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
