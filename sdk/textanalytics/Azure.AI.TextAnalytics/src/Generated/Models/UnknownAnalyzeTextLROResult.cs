...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class UnknownAnalyzeTextLROResult : AnalyzeTextLROResult
    {
        ...
        internal UnknownAnalyzeTextLROResult(DateTimeOffset lastUpdateDateTime, TextAnalyticsOperationStatus status, AnalyzeTextLROResultsKind kind, string taskName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(lastUpdateDateTime, status, kind, taskName, serializedAdditionalRawData)
        {
            Kind = kind;
        }
