...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class KeyPhraseTaskResult : AnalyzeTextTaskResult
    {
        ...
        internal KeyPhraseTaskResult(AnalyzeTextTaskResultsKind kind, KeyPhraseResult results, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Results = results;
            Kind = kind;
        }
