...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class ExtractiveSummarizationResult : IUtf8JsonSerializable, IJsonModel<ExtractiveSummarizationResult>
    {
        ...
        void IJsonModel<ExtractiveSummarizationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ExtractiveSummarizationResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExtractiveSummarizationResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ExtractiveSummarizationResult)} does not support '{options.Format}' format.");
            }
        }
