...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtractiveSummarizationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtractiveSummarizationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtractiveSummarizationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtractiveSummarizationResult>)} interface");
            }
        ...
        string IPersistableModel<ExtractiveSummarizationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
