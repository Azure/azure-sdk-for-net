...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class ExtractiveSummarizationResult : IUtf8JsonSerializable, IModelJsonSerializable<ExtractiveSummarizationResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ExtractiveSummarizationResult>(this, options.Format);
            ...
            foreach (var item in Documents)
            {
                ...
                {
                    ((IModelJsonSerializable<ExtractedSummaryDocumentResult>)item).Serialize(writer, options);
                }
            }
        ...
        internal static ExtractiveSummarizationResult DeserializeExtractiveSummarizationResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ExtractiveSummarizationResult(errors, statistics.Value, modelVersion, documents, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ExtractiveSummarizationResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ExtractiveSummarizationResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ExtractiveSummarizationResult"/>. </summary>
