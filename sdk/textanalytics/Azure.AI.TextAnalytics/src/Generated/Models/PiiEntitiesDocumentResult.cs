...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class PiiEntitiesDocumentResult : DocumentResult
    {
        ...
        internal PiiEntitiesDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, string redactedText, IList<Entity> entities, Dictionary<string, BinaryData> rawData) : base(id, warnings, statistics, rawData)
        {
            RedactedText = redactedText;
            Entities = entities;
        }
