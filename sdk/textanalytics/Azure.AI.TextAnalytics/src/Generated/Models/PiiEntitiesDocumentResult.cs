...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class PiiEntitiesDocumentResult : DocumentResult
    {
        ...
        internal PiiEntitiesDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, string redactedText, IList<Entity> entities, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
            RedactedText = redactedText;
            Entities = entities;
        }
