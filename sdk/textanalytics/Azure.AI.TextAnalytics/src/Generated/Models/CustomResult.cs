...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class CustomResult
    {
        ...
        internal CustomResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string projectName, string deploymentName, Dictionary<string, BinaryData> rawData)
        {
            Errors = errors;
