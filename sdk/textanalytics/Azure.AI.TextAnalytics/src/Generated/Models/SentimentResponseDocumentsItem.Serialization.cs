...
{
    internal partial class SentimentResponseDocumentsItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static SentimentResponseDocumentsItem DeserializeSentimentResponseDocumentsItem(JsonElement element)
        {
            ...
            return new SentimentResponseDocumentsItem(id, warnings, Core.Optional.ToNullable(statistics), sentiment, confidenceScores, sentences);
        }
    }
}
