...
{
    internal partial class MultiClassificationDocumentResult : IUtf8JsonSerializable
    {
        ...
        internal static MultiClassificationDocumentResult DeserializeMultiClassificationDocumentResult(JsonElement element)
        {
            ...
            return new MultiClassificationDocumentResult(id, warnings, Optional.ToNullable(statistics), classifications);
        }
    }
}
