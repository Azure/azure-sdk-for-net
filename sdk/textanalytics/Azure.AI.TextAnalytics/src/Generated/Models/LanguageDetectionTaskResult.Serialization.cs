...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        internal static LanguageDetectionTaskResult DeserializeLanguageDetectionTaskResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
