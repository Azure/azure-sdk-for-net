...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class CustomMultiLabelClassificationLROTask : AnalyzeTextLROTask
    {
        ...
        internal CustomMultiLabelClassificationLROTask(string taskName, AnalyzeTextLROTaskKind kind, CustomMultiLabelClassificationTaskParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(taskName, kind, serializedAdditionalRawData)
        {
