...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class SentenceAssessment
    {
        ...
        internal SentenceAssessment(string sentiment, TargetConfidenceScoreLabel confidenceScores, int offset, int length, string text, bool isNegated, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
            Offset = offset;
