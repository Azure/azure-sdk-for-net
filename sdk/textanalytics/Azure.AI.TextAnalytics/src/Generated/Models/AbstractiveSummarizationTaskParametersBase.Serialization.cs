...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AbstractiveSummarizationTaskParametersBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AbstractiveSummarizationTaskParametersBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AbstractiveSummarizationTaskParametersBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AbstractiveSummarizationTaskParametersBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
