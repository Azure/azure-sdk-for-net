...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class ExtractiveSummarizationTaskParameters : PreBuiltTaskParameters
    {
        ...
        internal ExtractiveSummarizationTaskParameters(bool? loggingOptOut, string modelVersion, int? sentenceCount, ExtractiveSummarySentencesOrder? sortBy, StringIndexType? stringIndexType, Dictionary<string, BinaryData> rawData) : base(loggingOptOut, modelVersion, rawData)
        {
