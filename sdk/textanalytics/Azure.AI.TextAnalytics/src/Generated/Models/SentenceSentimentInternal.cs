...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal readonly partial struct SentenceSentimentInternal
    {
        ...
        internal SentenceSentimentInternal(string text, string sentiment, SentimentConfidenceScores confidenceScores, int offset, int length, IReadOnlyList<SentenceTarget> targets, IReadOnlyList<SentenceAssessment> assessments, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
