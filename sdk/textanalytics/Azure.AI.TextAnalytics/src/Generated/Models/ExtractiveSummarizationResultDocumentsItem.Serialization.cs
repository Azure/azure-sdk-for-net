...
{
    public partial class ExtractiveSummarizationResultDocumentsItem : IUtf8JsonSerializable
    {
        ...
        internal static ExtractiveSummarizationResultDocumentsItem DeserializeExtractiveSummarizationResultDocumentsItem(JsonElement element)
        {
            ...
            return new ExtractiveSummarizationResultDocumentsItem(id, warnings, Optional.ToNullable(statistics), sentences);
        }
    }
}
