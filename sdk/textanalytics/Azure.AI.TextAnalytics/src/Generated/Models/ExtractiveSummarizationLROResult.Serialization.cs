...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtractiveSummarizationLROResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtractiveSummarizationLROResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtractiveSummarizationLROResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtractiveSummarizationLROResult>)} interface");
            }
        ...
        string IPersistableModel<ExtractiveSummarizationLROResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
