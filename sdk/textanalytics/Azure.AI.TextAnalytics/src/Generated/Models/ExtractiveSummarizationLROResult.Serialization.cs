...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class ExtractiveSummarizationLROResult : IUtf8JsonSerializable, IJsonModel<ExtractiveSummarizationLROResult>
    {
        ...
        void IJsonModel<ExtractiveSummarizationLROResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ExtractiveSummarizationLROResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExtractiveSummarizationLROResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ExtractiveSummarizationLROResult)} does not support '{options.Format}' format.");
            }
        }
