...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class ExtractiveSummarizationLROResult : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<ExtractiveSummarizationResult>(Results);
        ...
        internal static ExtractiveSummarizationLROResult DeserializeExtractiveSummarizationLROResult(JsonElement element)
        {
            ...
            return new ExtractiveSummarizationLROResult(lastUpdateDateTime, status, kind, taskName, results);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static new ExtractiveSummarizationLROResult FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ExtractiveSummarizationLROResult>(this);
            return content;
        }
    }
}
