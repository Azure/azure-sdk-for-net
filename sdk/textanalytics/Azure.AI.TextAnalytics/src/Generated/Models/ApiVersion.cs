...
{
    /// <summary> Text Analytics API version (for example, v3.0). </summary>
    internal readonly partial struct ApiVersion : IEquatable<ApiVersion>
    {
        ...
        private const string V32Preview2Value = "v3.2-preview.2";

        /// <summary> v3.2-preview.2. </summary>
        public static ApiVersion V32Preview2 { get; } = new ApiVersion(V32Preview2Value);
