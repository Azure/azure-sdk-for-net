...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    public readonly partial struct ApiVersion : IEquatable<ApiVersion>
    {
        ...
        private const string V32Preview1Value = "v3.2-preview.1";

        /// <summary> v3.2-preview.1. </summary>
        public static ApiVersion V32Preview1 { get; } = new ApiVersion(V32Preview1Value);
