...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class HealthcareRelationInternal
    {
        ...
        internal HealthcareRelationInternal(HealthcareEntityRelationType relationType, double? confidenceScore, IList<HealthcareRelationEntity> entities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RelationType = relationType;
