...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AbstractiveSummarizationResult : AbstractiveSummarizationResultBase
    {
        ...
        internal AbstractiveSummarizationResult(IList<AbstractiveSummaryDocumentResult> documents, IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(documents, serializedAdditionalRawData)
        {
            Errors = errors;
