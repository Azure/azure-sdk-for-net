...
{
    internal partial class LinkedEntitiesDocumentResult : Core.IUtf8JsonSerializable
    {
        ...
        internal static LinkedEntitiesDocumentResult DeserializeLinkedEntitiesDocumentResult(JsonElement element)
        {
            ...
            return new LinkedEntitiesDocumentResult(id, warnings, Core.Optional.ToNullable(statistics), entities);
        }
    }
}
