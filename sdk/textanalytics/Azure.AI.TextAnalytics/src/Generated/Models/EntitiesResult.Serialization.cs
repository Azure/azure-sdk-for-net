...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class EntitiesResult : IUtf8JsonSerializable, IModelJsonSerializable<EntitiesResult>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<EntitiesResult>(this, options.Format);
            ...
            foreach (var item in Documents)
            {
                ...
                {
                    ((IModelJsonSerializable<EntitiesResultDocumentsItem>)item).Serialize(writer, options);
                }
            }
        ...
        internal static EntitiesResult DeserializeEntitiesResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new EntitiesResult(errors, statistics.Value, modelVersion, documents, rawData);
        }
