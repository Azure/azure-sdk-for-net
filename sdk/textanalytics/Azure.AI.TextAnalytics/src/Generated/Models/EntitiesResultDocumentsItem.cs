...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntitiesResultDocumentsItem : EntitiesDocumentResult
    {
        ...
        public EntitiesResultDocumentsItem(string id, IEnumerable<DocumentWarning> warnings, IEnumerable<EntityWithResolution> entities) : base(id, warnings, entities)
        {
        ...
        internal EntitiesResultDocumentsItem(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<EntityWithResolution> entities, DetectedLanguageInternal? detectedLanguage) : base(id, warnings, statistics, entities)
        {
