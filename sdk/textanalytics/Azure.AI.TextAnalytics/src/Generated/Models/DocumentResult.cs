...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class DocumentResult
    {
        ...
        internal DocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
