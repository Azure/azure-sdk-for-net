...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class ClassificationDocumentResult : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WriteObjectValue<ClassificationResult>(item);
            }
        ...
        internal static new ClassificationDocumentResult FromResponse(Response response)
        {
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ClassificationDocumentResult>(this);
            return content;
        }
    }
}
