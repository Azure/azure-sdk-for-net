...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class DocumentLinkedEntities
    {
        ...
        internal DocumentLinkedEntities(string id, IReadOnlyList<LinkedEntity> entities, IReadOnlyList<TextAnalyticsWarning> warnings, TextDocumentStatistics? statistics)
        {
            Id = id;
            Entities = entities;
            Warnings = warnings;
