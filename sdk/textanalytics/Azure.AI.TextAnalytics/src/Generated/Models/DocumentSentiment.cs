...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class DocumentSentiment
    {
        ...
        /// <param name="sentences"> Sentence level sentiment analysis. </param>
        /// <param name="warnings"> Warnings encountered while processing document. </param>
        internal DocumentSentiment(string id, DocumentSentimentValue sentiment, TextDocumentStatistics? statistics, SentimentConfidenceScorePerLabel confidenceScores, IReadOnlyList<SentenceSentiment> sentences, IReadOnlyList<TextAnalyticsWarning> warnings)
        {
            Id = id;
            Sentiment = sentiment;
