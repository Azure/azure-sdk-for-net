...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class TargetRelation : IUtf8JsonSerializable, IModelJsonSerializable<TargetRelation>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<TargetRelation>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="TargetRelation"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="TargetRelation"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="TargetRelation"/>. </summary>
