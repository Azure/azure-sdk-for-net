...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal readonly partial struct DetectedLanguageInternal
    {
        ...
        internal DetectedLanguageInternal(string name, string iso6391Name, double confidenceScore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Iso6391Name = iso6391Name;
            ConfidenceScore = confidenceScore;
        ...
        /// <summary> Initializes a new instance of <see cref="DetectedLanguageInternal"/> for deserialization. </summary>
        public DetectedLanguageInternal()
        {
        }
