...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class LanguageDetectionDocumentResult : DocumentResult
    {
        ...
        internal LanguageDetectionDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, DetectedLanguageInternal detectedLanguage, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
            DetectedLanguage = detectedLanguage;
        }
