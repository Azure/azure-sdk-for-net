...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class UnknownAnalyzeTextTaskResult : AnalyzeTextTaskResult
    {
        ...
        internal UnknownAnalyzeTextTaskResult(AnalyzeTextTaskResultsKind kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Kind = kind;
        }
