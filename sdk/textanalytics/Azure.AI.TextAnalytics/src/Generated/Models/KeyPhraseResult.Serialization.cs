...
{
    internal partial class KeyPhraseResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KeyPhraseResult DeserializeKeyPhraseResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
