...
{
    internal partial class AnalyzeTextLROResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AnalyzeTextLROResult DeserializeAnalyzeTextLROResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
