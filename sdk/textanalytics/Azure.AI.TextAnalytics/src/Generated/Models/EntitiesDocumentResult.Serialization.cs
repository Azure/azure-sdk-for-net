...
{
    internal partial class EntitiesDocumentResult : Core.IUtf8JsonSerializable
    {
        ...
        internal static EntitiesDocumentResult DeserializeEntitiesDocumentResult(JsonElement element)
        {
            ...
            return new EntitiesDocumentResult(id, warnings, Core.Optional.ToNullable(statistics), entities);
        }
    }
}
