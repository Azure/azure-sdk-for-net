...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class UnknownAnalyzeTextLROTask : IUtf8JsonSerializable, IJsonModel<AnalyzeTextLROTask>
    {
        ...
        AnalyzeTextLROTask IJsonModel<AnalyzeTextLROTask>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownAnalyzeTextLROTask(document.RootElement, options);
        }
        ...
        internal static UnknownAnalyzeTextLROTask DeserializeUnknownAnalyzeTextLROTask(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownAnalyzeTextLROTask(taskName.Value, serializedAdditionalRawData, kind);
        }
