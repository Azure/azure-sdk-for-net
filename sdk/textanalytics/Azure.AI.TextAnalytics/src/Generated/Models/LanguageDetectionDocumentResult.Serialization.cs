...
{
    internal partial class LanguageDetectionDocumentResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LanguageDetectionDocumentResult DeserializeLanguageDetectionDocumentResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
