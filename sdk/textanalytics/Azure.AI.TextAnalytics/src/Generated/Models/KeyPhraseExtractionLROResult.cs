...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class KeyPhraseExtractionLROResult : AnalyzeTextLROResult
    {
        ...
        internal KeyPhraseExtractionLROResult(DateTimeOffset lastUpdateDateTime, TextAnalyticsOperationStatus status, AnalyzeTextLROResultsKind kind, string taskName, KeyPhraseResult results, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(lastUpdateDateTime, status, kind, taskName, serializedAdditionalRawData)
        {
            Results = results;
            Kind = kind;
        }
