...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class CustomSingleLabelClassificationLROTask : AnalyzeTextLROTask
    {
        ...
        internal CustomSingleLabelClassificationLROTask(string taskName, AnalyzeTextLROTaskKind kind, CustomSingleLabelClassificationTaskParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(taskName, kind, serializedAdditionalRawData)
        {
