...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyPhraseLROTask>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyPhraseLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyPhraseLROTask>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyPhraseLROTask>)} interface");
            }
        ...
        string IPersistableModel<KeyPhraseLROTask>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
