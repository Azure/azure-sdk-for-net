...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class KeyPhraseLROTask : IUtf8JsonSerializable, IJsonModel<KeyPhraseLROTask>
    {
        ...
        void IJsonModel<KeyPhraseLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(KeyPhraseLROTask)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<KeyPhraseLROTask>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(KeyPhraseLROTask)} does not support '{options.Format}' format.");
            }
        }
