...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class CustomEntitiesLROTask : IUtf8JsonSerializable, IJsonModel<CustomEntitiesLROTask>
    {
        ...
        void IJsonModel<CustomEntitiesLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CustomEntitiesLROTask)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CustomEntitiesLROTask>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CustomEntitiesLROTask)} does not support '{options.Format}' format.");
            }
        }
