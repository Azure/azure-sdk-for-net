...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomEntitiesLROTask>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomEntitiesLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomEntitiesLROTask>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomEntitiesLROTask>)} interface");
            }
        ...
        string IPersistableModel<CustomEntitiesLROTask>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
