...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthcareResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareResult>)} interface");
            }
        ...
        string IPersistableModel<HealthcareResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
