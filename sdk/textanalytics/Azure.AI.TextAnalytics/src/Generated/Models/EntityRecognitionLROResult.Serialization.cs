...
{
    internal partial class EntityRecognitionLROResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EntityRecognitionLROResult DeserializeEntityRecognitionLROResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
