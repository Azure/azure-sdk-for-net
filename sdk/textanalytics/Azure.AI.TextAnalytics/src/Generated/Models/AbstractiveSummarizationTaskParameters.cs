...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AbstractiveSummarizationTaskParameters : AbstractiveSummarizationTaskParametersBase
    {
        ...
        internal AbstractiveSummarizationTaskParameters(int? sentenceCount, StringIndexType? stringIndexType, string modelVersion, bool? loggingOptOut, Dictionary<string, BinaryData> rawData) : base(sentenceCount, stringIndexType, rawData)
        {
