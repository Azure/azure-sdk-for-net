...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AbstractiveSummarizationTaskParameters : AbstractiveSummarizationTaskParametersBase
    {
        ...
        internal AbstractiveSummarizationTaskParameters(int? sentenceCount, StringIndexType? stringIndexType, string modelVersion, bool? loggingOptOut, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(sentenceCount, stringIndexType, serializedAdditionalRawData)
        {
