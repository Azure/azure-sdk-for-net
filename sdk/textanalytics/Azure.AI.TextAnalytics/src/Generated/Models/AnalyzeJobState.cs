...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AnalyzeJobState : AnalyzeJobMetadata
    {
        ...
        internal AnalyzeJobState(DateTimeOffset createdDateTime, string jobId, DateTimeOffset lastUpdateDateTime, OperationStatus status, AnalyzeTasks tasks) : base(createdDateTime, jobId, lastUpdateDateTime, status)
        {
            if (jobId == null)
            {
