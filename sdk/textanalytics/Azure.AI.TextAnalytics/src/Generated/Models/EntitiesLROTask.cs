...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntitiesLROTask : AnalyzeTextLROTask
    {
        ...
        internal EntitiesLROTask(string taskName, AnalyzeTextLROTaskKind kind, EntitiesTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(taskName, kind, rawData)
        {
