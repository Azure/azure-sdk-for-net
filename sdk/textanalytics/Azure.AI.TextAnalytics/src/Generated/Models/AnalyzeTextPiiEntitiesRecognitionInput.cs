...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AnalyzeTextPiiEntitiesRecognitionInput : AnalyzeTextTask
    {
        ...
        internal AnalyzeTextPiiEntitiesRecognitionInput(AnalyzeTextTaskKind kind, MultiLanguageAnalysisInput analysisInput, PiiTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(kind, rawData)
        {
