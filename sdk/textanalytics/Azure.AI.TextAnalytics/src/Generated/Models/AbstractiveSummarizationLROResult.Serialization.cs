...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class AbstractiveSummarizationLROResult : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteObjectValue<AbstractiveSummarizationResult>(Results);
        ...
        internal static AbstractiveSummarizationLROResult DeserializeAbstractiveSummarizationLROResult(JsonElement element)
        {
            ...
            return new AbstractiveSummarizationLROResult(lastUpdateDateTime, status, kind, taskName, results);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AbstractiveSummarizationLROResult>(this);
            return content;
        }
    }
}
