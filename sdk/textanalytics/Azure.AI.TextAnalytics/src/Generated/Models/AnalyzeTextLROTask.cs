...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AnalyzeTextLROTask : TaskIdentifier
    {
        ...
        internal AnalyzeTextLROTask(string taskName, AnalyzeTextLROTaskKind kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(taskName, serializedAdditionalRawData)
        {
            Kind = kind;
        }
