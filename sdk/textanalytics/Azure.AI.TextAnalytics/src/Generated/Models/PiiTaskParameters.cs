...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class PiiTaskParameters : PreBuiltTaskParameters
    {
        ...
        internal PiiTaskParameters(bool? loggingOptOut, string modelVersion, PiiDomain? domain, IList<PiiEntityCategory> piiCategories, StringIndexType? stringIndexType, Dictionary<string, BinaryData> rawData) : base(loggingOptOut, modelVersion, rawData)
        {
            Domain = domain;
