...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLabelClassificationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomLabelClassificationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLabelClassificationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomLabelClassificationResult>)} interface");
            }
        ...
        string IPersistableModel<CustomLabelClassificationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
