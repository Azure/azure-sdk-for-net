...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLabelClassificationResult>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<CustomLabelClassificationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLabelClassificationResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
