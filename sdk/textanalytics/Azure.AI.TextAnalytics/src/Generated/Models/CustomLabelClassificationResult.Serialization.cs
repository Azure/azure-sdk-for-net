...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class CustomLabelClassificationResult : IUtf8JsonSerializable, IJsonModel<CustomLabelClassificationResult>
    {
        ...
        void IJsonModel<CustomLabelClassificationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CustomLabelClassificationResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CustomLabelClassificationResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CustomLabelClassificationResult)} does not support '{options.Format}' format.");
            }
        }
