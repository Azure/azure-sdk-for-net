...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class JobState
    {
        ...
        internal JobState(string displayName, DateTimeOffset createdDateTime, DateTimeOffset? expirationDateTime, string jobId, DateTimeOffset lastUpdatedDateTime, TextAnalyticsOperationStatus status, IReadOnlyList<Error> errors, string nextLink, Dictionary<string, BinaryData> rawData)
        {
