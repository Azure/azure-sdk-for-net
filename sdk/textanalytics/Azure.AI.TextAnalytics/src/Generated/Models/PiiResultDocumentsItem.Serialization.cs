...
{
    internal partial class PiiResultDocumentsItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static PiiResultDocumentsItem DeserializePiiResultDocumentsItem(JsonElement element)
        {
            ...
            return new PiiResultDocumentsItem(id, warnings, Core.Optional.ToNullable(statistics), redactedText, entities);
        }
    }
}
