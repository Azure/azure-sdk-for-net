...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentWarning>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentWarning>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentWarning>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentWarning>)} interface");
            }
        ...
        string IPersistableModel<DocumentWarning>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
