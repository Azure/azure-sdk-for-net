...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class PreBuiltResult
    {
        ...
        internal PreBuiltResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
