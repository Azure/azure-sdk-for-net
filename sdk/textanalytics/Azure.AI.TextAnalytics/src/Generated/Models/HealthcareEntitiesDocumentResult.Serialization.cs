...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class HealthcareEntitiesDocumentResult : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WriteObjectValue<HealthcareEntityInternal>(item);
            }
            ...
            {
                writer.WriteObjectValue<HealthcareRelationInternal>(item);
            }
            writer.WriteEndArray();
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<HealthcareEntitiesDocumentResult>(this);
            return content;
        }
    }
}
