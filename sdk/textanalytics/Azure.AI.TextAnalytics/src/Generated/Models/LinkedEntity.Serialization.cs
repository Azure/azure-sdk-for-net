...
namespace Azure.AI.TextAnalytics
{
    public partial struct LinkedEntity : IUtf8JsonSerializable, IJsonModel<LinkedEntity>, IJsonModel<object>
    {
        ...
        object IJsonModel<object>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => ((IJsonModel<LinkedEntity>)this).Read(ref reader, options);
        ...
        BinaryData IModel<object>.Write(ModelReaderWriterOptions options) => ((IModel<LinkedEntity>)this).Write(options);

        object IModel<object>.Read(BinaryData data, ModelReaderWriterOptions options) => ((IModel<LinkedEntity>)this).Read(data, options);

        ModelReaderWriterFormat IModel<object>.GetWireFormat(ModelReaderWriterOptions options) => ((IModel<LinkedEntity>)this).GetWireFormat(options);
    }
}
