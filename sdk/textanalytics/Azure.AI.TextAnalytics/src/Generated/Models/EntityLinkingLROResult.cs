...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntityLinkingLROResult : AnalyzeTextLROResult
    {
        ...
        internal EntityLinkingLROResult(DateTimeOffset lastUpdateDateTime, TextAnalyticsOperationStatus status, AnalyzeTextLROResultsKind kind, string taskName, EntityLinkingResult results, Dictionary<string, BinaryData> rawData) : base(lastUpdateDateTime, status, kind, taskName, rawData)
        {
            Results = results;
            Kind = kind;
        }
