...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        internal static AnalyzeTextJobStatistics DeserializeAnalyzeTextJobStatistics(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
