...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class CustomSingleLabelClassificationTaskParameters : CustomTaskParameters
    {
        ...
        internal CustomSingleLabelClassificationTaskParameters(bool? loggingOptOut, string projectName, string deploymentName, Dictionary<string, BinaryData> rawData) : base(loggingOptOut, projectName, deploymentName, rawData)
        {
        }
