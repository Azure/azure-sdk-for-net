...
{
    internal partial struct DetectedLanguageInternal : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DetectedLanguageInternal DeserializeDetectedLanguageInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
            string name = default;
