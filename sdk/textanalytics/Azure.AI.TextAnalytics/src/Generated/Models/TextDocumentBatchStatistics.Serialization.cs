...
namespace Azure.AI.TextAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TextDocumentBatchStatistics>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TextDocumentBatchStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TextDocumentBatchStatistics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TextDocumentBatchStatistics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
