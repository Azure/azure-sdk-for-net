...
{
    public partial class TextDocumentBatchStatistics : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TextDocumentBatchStatistics DeserializeTextDocumentBatchStatistics(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
