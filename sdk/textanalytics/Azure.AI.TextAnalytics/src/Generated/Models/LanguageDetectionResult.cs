...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class LanguageDetectionResult : PreBuiltResult
    {
        ...
        internal LanguageDetectionResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<LanguageDetectionDocumentResult> documents, Dictionary<string, BinaryData> rawData) : base(errors, statistics, modelVersion, rawData)
        {
            Documents = documents;
        }
