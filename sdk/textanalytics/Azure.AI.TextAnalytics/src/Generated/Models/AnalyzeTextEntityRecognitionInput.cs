...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class AnalyzeTextEntityRecognitionInput : AnalyzeTextTask
    {
        ...
        internal AnalyzeTextEntityRecognitionInput(AnalyzeTextTaskKind kind, MultiLanguageAnalysisInput analysisInput, EntitiesTaskParameters parameters, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
