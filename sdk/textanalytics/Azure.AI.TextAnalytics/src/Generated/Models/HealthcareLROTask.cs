...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class HealthcareLROTask : AnalyzeTextLROTask
    {
        ...
        internal HealthcareLROTask(string taskName, AnalyzeTextLROTaskKind kind, HealthcareTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(taskName, kind, rawData)
        {
