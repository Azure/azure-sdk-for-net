...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class CustomTaskParameters : TaskParameters
    {
        ...
        internal CustomTaskParameters(bool? loggingOptOut, string projectName, string deploymentName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(loggingOptOut, serializedAdditionalRawData)
        {
            ProjectName = projectName;
            DeploymentName = deploymentName;
        }
