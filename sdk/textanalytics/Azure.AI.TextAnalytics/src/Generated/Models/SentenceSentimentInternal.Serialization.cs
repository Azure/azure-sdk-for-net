...
{
    internal partial struct SentenceSentimentInternal : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SentenceSentimentInternal DeserializeSentenceSentimentInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
            string text = default;
