...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class MultiClassificationDocumentResult : DocumentResult
    {
        ...
        public MultiClassificationDocumentResult(string id, IEnumerable<DocumentWarning> warnings, IEnumerable<ClassificationResult> classifications) : base(id, warnings)
        {
            if (id == null)
            {
        ...
        /// <param name="classifications"></param>
        internal MultiClassificationDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<ClassificationResult> classifications) : base(id, warnings, statistics)
        {
