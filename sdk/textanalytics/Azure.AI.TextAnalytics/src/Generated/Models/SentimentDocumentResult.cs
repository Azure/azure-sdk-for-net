...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class SentimentDocumentResult : DocumentResult
    {
        ...
        internal SentimentDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, TextSentiment sentiment, SentimentConfidenceScores confidenceScores, IList<SentenceSentimentInternal> sentences, Dictionary<string, BinaryData> rawData) : base(id, warnings, statistics, rawData)
        {
            Sentiment = sentiment;
            ConfidenceScores = confidenceScores;
            Sentences = sentences;
        ...
        /// <summary> Initializes a new instance of <see cref="SentimentDocumentResult"/> for deserialization. </summary>
        internal SentimentDocumentResult()
        {
        }
