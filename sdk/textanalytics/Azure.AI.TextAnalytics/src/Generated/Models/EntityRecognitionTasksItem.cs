...
namespace Azure.AI.TextAnalytics
{
    ...
    internal partial class EntityRecognitionTasksItem : TaskState
    {
        ...
        internal EntityRecognitionTasksItem(DateTimeOffset lastUpdateDateTime, OperationStatus status, EntitiesResult resultsInternal) : base(lastUpdateDateTime, status)
        {
        ...
        /// <param name="status"> . </param>
        /// <param name="resultsInternal"> . </param>
        internal EntityRecognitionTasksItem(DateTimeOffset lastUpdateDateTime, string name, OperationStatus status, EntitiesResult resultsInternal) : base(lastUpdateDateTime, name, status)
        {
            ResultsInternal = resultsInternal;
        }
    }
