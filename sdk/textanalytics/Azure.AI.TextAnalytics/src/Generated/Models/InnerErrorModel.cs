...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class InnerErrorModel
    {
        ...
        internal InnerErrorModel(InnerErrorCode code, string message, IDictionary<string, string> details, string target, InnerErrorModel innererror, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
