...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntityLinkingLROTask : AnalyzeTextLROTask
    {
        ...
        internal EntityLinkingLROTask(string taskName, AnalyzeTextLROTaskKind kind, EntityLinkingTaskParameters parameters, Dictionary<string, BinaryData> rawData) : base(taskName, kind, rawData)
        {
