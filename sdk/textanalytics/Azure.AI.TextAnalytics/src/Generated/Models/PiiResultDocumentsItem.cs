...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class PiiResultDocumentsItem : PiiEntitiesDocumentResult
    {
        ...
        internal PiiResultDocumentsItem(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, string redactedText, IList<Entity> entities, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, warnings, statistics, redactedText, entities, serializedAdditionalRawData)
        {
        }
