...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class EntityLinkingResultDocumentsItem : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WriteObjectValue<LinkedEntity>(item);
            }
        ...
        internal static new EntityLinkingResultDocumentsItem FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeEntityLinkingResultDocumentsItem(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<EntityLinkingResultDocumentsItem>(this);
            return content;
        }
    }
}
