...
{
    internal partial class EntityLinkingResultDocumentsItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static EntityLinkingResultDocumentsItem DeserializeEntityLinkingResultDocumentsItem(JsonElement element)
        {
            ...
            return new EntityLinkingResultDocumentsItem(id, warnings, Core.Optional.ToNullable(statistics), entities);
        }
    }
}
