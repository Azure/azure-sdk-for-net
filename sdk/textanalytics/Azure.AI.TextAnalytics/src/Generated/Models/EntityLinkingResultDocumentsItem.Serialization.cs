...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class EntityLinkingResultDocumentsItem : IUtf8JsonSerializable, IModelJsonSerializable<EntityLinkingResultDocumentsItem>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<EntityLinkingResultDocumentsItem>(this, options.Format);
        ...
        internal static EntityLinkingResultDocumentsItem DeserializeEntityLinkingResultDocumentsItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new EntityLinkingResultDocumentsItem(id, warnings, Optional.ToNullable(statistics), entities, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="EntityLinkingResultDocumentsItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="EntityLinkingResultDocumentsItem"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="EntityLinkingResultDocumentsItem"/>. </summary>
