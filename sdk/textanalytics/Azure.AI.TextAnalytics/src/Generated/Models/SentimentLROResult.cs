...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class SentimentLROResult : AnalyzeTextLROResult
    {
        ...
        internal SentimentLROResult(DateTimeOffset lastUpdateDateTime, TextAnalyticsOperationStatus status, AnalyzeTextLROResultsKind kind, string taskName, SentimentResponse results, Dictionary<string, BinaryData> rawData) : base(lastUpdateDateTime, status, kind, taskName, rawData)
        {
            Results = results;
            Kind = kind;
        }
