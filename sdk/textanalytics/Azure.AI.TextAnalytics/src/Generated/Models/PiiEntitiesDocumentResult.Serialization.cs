...
{
    internal partial class PiiEntitiesDocumentResult : Core.IUtf8JsonSerializable
    {
        ...
        internal static PiiEntitiesDocumentResult DeserializePiiEntitiesDocumentResult(JsonElement element)
        {
            ...
            return new PiiEntitiesDocumentResult(id, warnings, Core.Optional.ToNullable(statistics), redactedText, entities);
        }
    }
}
