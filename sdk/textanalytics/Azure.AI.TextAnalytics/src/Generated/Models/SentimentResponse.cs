...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class SentimentResponse : PreBuiltResult
    {
        ...
        internal SentimentResponse(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<SentimentResponseDocumentsItem> documents, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
