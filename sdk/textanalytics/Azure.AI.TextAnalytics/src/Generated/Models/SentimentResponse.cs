...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class SentimentResponse : PreBuiltResult
    {
        ...
        internal SentimentResponse(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<SentimentResponseDocumentsItem> documents, Dictionary<string, BinaryData> rawData) : base(errors, statistics, modelVersion, rawData)
        {
            Documents = documents;
        }
