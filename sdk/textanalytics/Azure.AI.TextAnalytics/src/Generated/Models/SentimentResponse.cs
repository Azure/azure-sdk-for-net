...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class SentimentResponse
    {
        ...
        internal SentimentResponse(IEnumerable<DocumentSentiment_internal> documents, IEnumerable<DocumentError> errors, string modelVersion)
        {
            if (documents == null)
            {
        ...
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        internal SentimentResponse(IReadOnlyList<DocumentSentiment_internal> documents, IReadOnlyList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion)
        {
            Documents = documents;
            Errors = errors;
        ...
        public IReadOnlyList<DocumentSentiment_internal> Documents { get; }
