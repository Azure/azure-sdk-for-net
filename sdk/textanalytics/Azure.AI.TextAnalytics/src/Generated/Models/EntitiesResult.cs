...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntitiesResult : PreBuiltResult
    {
        ...
        internal EntitiesResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<EntitiesResultDocumentsItem> documents, Dictionary<string, BinaryData> rawData) : base(errors, statistics, modelVersion, rawData)
        {
            Documents = documents;
        }
