...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntitiesResult : PreBuiltResult
    {
        ...
        internal EntitiesResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IList<EntitiesResultDocumentsItem> documents, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
