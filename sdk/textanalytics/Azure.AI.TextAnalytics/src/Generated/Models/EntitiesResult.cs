...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntitiesResult : PreBuiltResult
    {
        ...
        /// <param name="documents"> Response by document. </param>
        internal EntitiesResult(IList<DocumentError> errors, TextDocumentBatchStatistics statistics, string modelVersion, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<EntitiesResultDocumentsItem> documents) : base(errors, statistics, modelVersion, serializedAdditionalRawData)
        {
            Documents = documents;
        }
