...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PiiLROTask>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PiiLROTask>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PiiLROTask>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PiiLROTask>)} interface");
            }
        ...
        string IPersistableModel<PiiLROTask>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
