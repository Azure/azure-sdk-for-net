...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class EntityLinkingTaskResult : AnalyzeTextTaskResult
    {
        ...
        internal EntityLinkingTaskResult(AnalyzeTextTaskResultsKind kind, EntityLinkingResult results, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Results = results;
            Kind = kind;
        }
