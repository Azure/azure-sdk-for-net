...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class ExtractedSummaryDocumentResult : DocumentResult
    {
        ...
        internal ExtractedSummaryDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<ExtractedSummarySentence> sentences, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, warnings, statistics, serializedAdditionalRawData)
        {
            Sentences = sentences;
        }
