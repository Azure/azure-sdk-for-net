...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class ExtractedSummaryDocumentResult : DocumentResult
    {
        ...
        internal ExtractedSummaryDocumentResult(string id, IList<DocumentWarning> warnings, TextDocumentStatistics? statistics, IList<ExtractedSummarySentence> sentences, Dictionary<string, BinaryData> rawData) : base(id, warnings, statistics, rawData)
        {
            Sentences = sentences;
        }
