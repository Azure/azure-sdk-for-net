...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    internal partial class HealthcareJobState : JobMetadata
    {
        ...
        internal HealthcareJobState(DateTimeOffset createdDateTime, string jobId, DateTimeOffset lastUpdateDateTime, OperationStatus status) : base(createdDateTime, jobId, lastUpdateDateTime, status)
        {
            if (jobId == null)
            {
