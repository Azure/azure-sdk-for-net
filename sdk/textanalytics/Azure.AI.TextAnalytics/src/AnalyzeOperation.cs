...
namespace Azure.AI.TextAnalytics
{
    ...
    public class AnalyzeOperation : Operation<AnalyzeResultCollection>
    {
        ...
        /// </remarks>
        public override AnalyzeResultCollection Value
        {
            get
            {
...
#pragma warning restore CA1065 // Do not raise exceptions in unexpected locations
        ...
        private AnalyzeResultCollection _value;
        ...
        internal AnalyzeOperation(TextAnalyticsRestClient serviceClient, ClientDiagnostics diagnostics, string operationLocation)
        {
        ...
        /// </remarks>
        public override ValueTask<Response<AnalyzeResultCollection>> WaitForCompletionAsync(CancellationToken cancellationToken = default) =>
        ...
        /// This method will periodically call UpdateStatusAsync till HasCompleted is true, then return the final result of the operation.
        /// </remarks>
        public override ValueTask<Response<AnalyzeResultCollection>> WaitForCompletionAsync(TimeSpan pollingInterval, CancellationToken cancellationToken = default) =>
            ...
            if (!_hasCompleted)
            {
                ...
                try
                {
                    ...
                    Response<AnalyzeJobState> update = async
                        ? await _serviceClient.AnalyzeStatusAsync(new Guid(Id), _showStats, _top, _skip, cancellationToken).ConfigureAwait(false)
                        : _serviceClient.AnalyzeStatus(new Guid(Id), _showStats, _top, _skip, cancellationToken);
