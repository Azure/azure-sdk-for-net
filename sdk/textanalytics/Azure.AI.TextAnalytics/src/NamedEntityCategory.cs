...
namespace Azure.AI.TextAnalytics
{
    ...
    public readonly struct NamedEntityCategory : IEquatable<NamedEntityCategory>
    {
        /// <summary>
        /// Specifies that named entity contains recognized name.
        /// </summary>
        public static readonly NamedEntityCategory Person = new NamedEntityCategory("Person");
        ...
        /// </summary>
        public static readonly NamedEntityCategory Location = new NamedEntityCategory("Location");

        /// <summary>
        /// Specifies that named entity contains recognized name of organization, corporation, agency, or other group of people.
        /// </summary>
        public static readonly NamedEntityCategory Organization = new NamedEntityCategory("Organization");

        /// <summary>
        /// Specifies that named entity contains date, time or duration.
        /// </summary>
        public static readonly NamedEntityCategory DateTime = new NamedEntityCategory("DateTime");

        /// <summary>
        /// Specifies that named entity contains phone number (US Phone numbers only).
        /// </summary>
        public static readonly NamedEntityCategory PhoneNumber = new NamedEntityCategory("PhoneNumber");

        /// <summary>
        /// Specifies that named entity contains Internet URL.
        /// </summary>
        public static readonly NamedEntityCategory Email = new NamedEntityCategory("Email");

        /// <summary>
        /// Specifies that named entity contains Internet URL.
        /// </summary>
        public static readonly NamedEntityCategory Url = new NamedEntityCategory("URL");

        /// <summary>
        /// Specifies that named entity contains number or numeric quantity.
        /// </summary>
        public static readonly NamedEntityCategory Quantity = new NamedEntityCategory("Quantity");

        private readonly string _value;

        private NamedEntityCategory(string type)
        {
        ...
        public static implicit operator NamedEntityCategory(string type) => new NamedEntityCategory(type);
        ...
        public static explicit operator string(NamedEntityCategory type) => type._value;
        ...
        public static bool operator ==(NamedEntityCategory lhs, NamedEntityCategory rhs) => Equals(lhs, rhs);
        ...
        public bool Equals(NamedEntityCategory other) => _value == other._value;
        ...
        public override bool Equals(object obj) => obj is NamedEntityCategory type && Equals(type);
    ...
    internal class NamedEntityTypeJsonConverter : JsonConverter<NamedEntityCategory>
    {
        public override NamedEntityCategory Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            return reader.GetString();
        }

        public override void Write(Utf8JsonWriter writer, NamedEntityCategory value, JsonSerializerOptions options)
        {
