...
namespace Azure.AI.TextAnalytics
{
    ...
    /// for that document.
    /// </summary>
    public class SingleLabelClassifyResult : TextAnalyticsResult
    {
        private readonly ClassificationCategory _classification;
        internal SingleLabelClassifyResult(string id, TextDocumentStatistics statistics, ClassificationCategory classificationCategory , IReadOnlyCollection<TextAnalyticsWarning> warnings)
            : base(id, statistics)
        {
        ...
        internal SingleLabelClassifyResult(string id, TextAnalyticsError error) : base(id, error) { }
