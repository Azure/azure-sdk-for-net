...
``` yaml
input-file:
    -  https://github.com/Azure/azure-rest-api-specs/blob/91a067a87521c95fa28b5844b3fe7963f9245438/specification/cognitiveservices/data-plane/TextAnalytics/preview/v3.1-preview.4/TextAnalytics.json
```
