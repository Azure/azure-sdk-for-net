...
``` yaml
input-file:
    -  https://github.com/Azure/azure-rest-api-specs/blob/18e23905f161b2432cda9c373cb0db0f042b6878/specification/cognitiveservices/data-plane/TextAnalytics/preview/v3.1-preview.4/TextAnalytics.json
```
