...
``` yaml
input-file:
    -  https://github.com/Azure/azure-rest-api-specs/blob/c2e50d64a580169c9925b33712421f59462ad761/specification/cognitiveservices/data-plane/TextAnalytics/preview/v3.1-preview.4/TextAnalytics.json
```
