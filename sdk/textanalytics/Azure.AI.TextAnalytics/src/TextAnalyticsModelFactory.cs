...
namespace Azure.AI.TextAnalytics
{
    ...
    public static class TextAnalyticsModelFactory
    {
        ...
        public static RecognizePiiEntitiesResult RecognizePiiResult(string id, TextDocumentStatistics statistics, PiiEntityCollection entities)
        {
        ...
        /// <param name="error">Sets the <see cref="TextAnalyticsResult.Error"/> property.</param>
        /// <returns>A new instance of <see cref="TextAnalytics.RecognizePiiEntitiesResult"/> for mocking purposes.</returns>
        public static RecognizePiiEntitiesResult RecognizePiiResult(string id, TextAnalyticsError error)
        {
        ...
        public static RecognizePiiEntitiesResultCollection RecognizePiiResultCollection(IEnumerable<RecognizePiiEntitiesResult> list, TextDocumentBatchStatistics statistics, string modelVersion)
        {
