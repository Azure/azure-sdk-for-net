...
### Features Added
- Added keyword argument `FhirVersion` to `AnalyzeHealthcareEntitiesOptions`. Use the keyword to indicate the version for the `FhirBundle` contained on the `AnalyzeHealthcareEntitiesResult`.
