...
namespace Azure.AI.TextAnalytics.Samples
{
    ...
    {
        [Test]
        public async Task RecognizeEntitiesBatchWithResolutionsAsync()
        {
            ...
            #region Snippet:Sample4_RecognizeEntitiesBatchWithResolutionsAsync_GetDocuments
            ...
            #region Snippet:Sample4_RecognizeEntitiesBatchWithResolutionsAsync_SetModelVersion
            TextAnalyticsRequestOptions options = new() { ModelVersion = "2022-10-01-preview" };
            #endregion
            #region Snippet:Sample4_RecognizeEntitiesBatchWithResolutionsAsync_PerformOperation
            ...
            #region Snippet:Sample4_RecognizeEntitiesBatchWithResolutionsAsync_ViewResults
