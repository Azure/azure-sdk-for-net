...
namespace Azure.AI.TextAnalytics.Tests
{
    public class RecognizeHealthcareEntitiesTests : TextAnalyticsClientLiveTestBase
    {
        ...
        [Test]
        public async Task RecognizeHealthcareEntitiesBatchWithCancellationAsync()
        {
            TextAnalyticsClient client = GetClient();
            ...
            HealthcareOperation operation = await client.StartHealthcareBatchAsync(batchDocuments, "en");
            ...
            Assert.AreEqual(JobStatus.Cancelled, operation.Status);
        }
