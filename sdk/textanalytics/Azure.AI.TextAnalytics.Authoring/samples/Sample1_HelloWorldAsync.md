...
```C# Snippet:Azure_AI_TextAnalytics_Authoring_ScenarioAsync
```

To see the full example source files, see:
* [HelloWorld](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/textanalytics/Azure.AI.TextAnalytics.Authoring/tests/Samples/Sample1_HelloWorldAsync.cs))
