...
namespace Azure.AI.Text
{
    ...
    public partial class TextAnalyticsClient
    {
        ...
        private readonly _TextAnalyticsRestClient _serviceRestClient;
        ...
        public TextAnalyticsClient(Uri endpoint, TokenCredential credential, TextAnalyticsClientOptions options)
        {
            ...
            _serviceRestClient = new _TextAnalyticsRestClient(_clientDiagnostics, pipeline, endpoint.AbsoluteUri);
        }
