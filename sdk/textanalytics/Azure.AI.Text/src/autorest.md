...
``` yaml
input-file:
    -  https://github.com/Azure/azure-rest-api-specs/blob/955a026301ac02c88734742d13cce017098a52d7/specification/cognitiveservices/data-plane/TextAnalytics/preview/v3.2-preview.1/Text.json
```
