...
namespace Azure.AI.Text.Models
{
    ...
    internal partial class PiiEntitiesResult
    {
        ...
        /// <param name="modelVersion"> This field indicates which model is used for scoring. </param>
        internal PiiEntitiesResult(IReadOnlyList<PiiDocumentEntities> documents, IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion)
        {
            Documents = documents;
            Errors = errors;
