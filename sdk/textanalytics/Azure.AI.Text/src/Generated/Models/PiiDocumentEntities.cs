...
namespace Azure.AI.Text.Models
{
    ...
    internal partial class PiiDocumentEntities
    {
        ...
        internal PiiDocumentEntities(string id, IEnumerable<Entity> entities, IEnumerable<TextAnalyticsWarning> warnings)
        {
            if (id == null)
            {
        ...
        internal PiiDocumentEntities(string id, IReadOnlyList<Entity> entities, IReadOnlyList<TextAnalyticsWarning> warnings, DocumentStatistics statistics, string redactedText)
        {
            Id = id;
            Entities = entities;
            Warnings = warnings;
