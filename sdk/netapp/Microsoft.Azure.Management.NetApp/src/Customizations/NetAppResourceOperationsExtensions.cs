...
namespace Microsoft.Azure.Management.NetApp
{
    ...
    public static partial class NetAppResourceOperationsExtensions
    {
        ...
        /// </summary>
        /// <remarks>
        /// Check if a file path is available. Note this operation is deprecated. Please use CheckFilePathAvailability(string location, string name, string subnetId) instead
        /// </remarks>
