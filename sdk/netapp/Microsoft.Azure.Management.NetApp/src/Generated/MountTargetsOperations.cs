...
namespace Microsoft.Azure.Management.NetApp
{
    ...
    /// </summary>
    internal partial class MountTargetsOperations : IServiceOperations<AzureNetAppFilesManagementClient>, IMountTargetsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<MountTarget>>> ListWithHttpMessagesAsync(string resourceGroupName, string accountName, string poolName, string volumeName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<MountTarget>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<MountTarget>>(_responseContent, Client.DeserializationSettings);
                }
