...
namespace Microsoft.Azure.Management.NetApp.Models
{
    ...
    public partial class SnapshotPolicyDetails
    {
        ...
        /// not</param>
        public SnapshotPolicyDetails(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), object hourlySchedule = default(object), object dailySchedule = default(object), object weeklySchedule = default(object), object monthlySchedule = default(object), bool? enabled = default(bool?))
        {
            Location = location;
            Id = id;
            Name = name;
