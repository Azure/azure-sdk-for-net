...
{
    [ClientTestFixture]
    public class NetAppTestBase : ManagementRecordedTestBase<NetAppManagementTestEnvironment>
    {
        ...
        public static string DefaultSubnetId { get; set; }
        ...
        public static ActiveDirectory ActiveDirectory1 = new()
        {
            Username = "sdkuser",
            Password = "sdkpass",
            Domain = "sdkdomain",
        ...
        public static NetAppAccountData GetDefaultNetAppAccountParameters(string location = "", ActiveDirectory activeDirectory = null)
        {
        ...
        public static VolumeData GetDefaultVolumeParameters(string creationToken, long usageThreshold, string subnetId, string location = "")
        {
            if (string.IsNullOrWhiteSpace(location))
            {
                location = DefaultLocationString;
        ...
        public async Task<string> CreateValidAccountNameAsync(string prefix, ResourceGroupResource resourceGroup, string location = "")
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                ResourceNameAvailabilityContent parameter = new ResourceNameAvailabilityContent(accountName, CheckNameResourceTypes.MicrosoftNetAppNetAppAccounts, resourceGroup.Data.Name);
                CheckAvailabilityResponse result = await DefaultSubscription.CheckNameAvailabilityNetAppResourceAsync(location, parameter);
        ...
        public static void VerifyCapacityPoolProperties(CapacityPoolResource pool, bool useDefaults)
        {
            ...
            if (useDefaults)
            {
                ...
                Assert.AreEqual(ServiceLevel.Premium, pool.Data.ServiceLevel);
        ...
        public async Task<CapacityPoolResource> CreateCapacityPool(string location, ServiceLevel serviceLevel, long? size, string poolName = "")
        {
            location = string.IsNullOrEmpty(location) ? DefaultLocationString : location;
        ...
        public async Task<VolumeResource> CreateVolume(string location, ServiceLevel serviceLevel, long? usageThreshold, string volumeName = "", string subnetId = "", List<string> protocolTypes = null, ExportPolicyRule exportPolicyRule = null, VolumeCollection volumeCollection = null, VolumePropertiesDataProtection dataProtection = null, string snapshotId = "", string backupId = "")
        {
            location = string.IsNullOrEmpty(location) ? DefaultLocationString : location;
            ...
            subnetId = string.IsNullOrWhiteSpace(subnetId) ? DefaultSubnetId : subnetId;
            ...
            volumeData.SnapshotId = string.IsNullOrWhiteSpace(snapshotId) ? null : snapshotId;
            volumeData.BackupId = string.IsNullOrWhiteSpace(backupId) ? null : backupId;
