...
{
    public partial class Sample_NetAppElasticCapacityPoolCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_ElasticCapacityPoolsCreateOrUpdate()
        {
            // Generated from example definition: specification/netapp/resource-manager/Microsoft.NetApp/NetApp/preview/2025-12-15-preview/examples/ElasticCapacityPools_CreateOrUpdate.json
        ...
        public async Task Get_ElasticCapacityPoolsGet()
        {
            ...
            // invoke the operation
            string poolName = "pool1";
            NetAppElasticCapacityPoolResource result = await collection.GetAsync(poolName);
        ...
        {
            // Generated from example definition: specification/netapp/resource-manager/Microsoft.NetApp/NetApp/preview/2025-12-15-preview/examples/ElasticCapacityPools_ListByElasticAccount.json
            ...
            await foreach (NetAppElasticCapacityPoolResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                NetAppElasticCapacityPoolData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_ElasticCapacityPoolsGet()
        {
            ...
            // invoke the operation
            string poolName = "pool1";
            NullableResponse<NetAppElasticCapacityPoolResource> response = await collection.GetIfExistsAsync(poolName);
            NetAppElasticCapacityPoolResource result = response.HasValue ? response.Value : null;
