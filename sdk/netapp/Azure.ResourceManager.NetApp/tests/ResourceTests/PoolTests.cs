...
namespace Azure.ResourceManager.NetApp.Tests
{
    public class PoolTests : NetAppTestBase
    {
        ...
        public async Task GetAllPoolsByNetAppAccount()
        {
            ...
            CapacityPoolResource pool1 = await CreateCapacityPool(DefaultLocation, ServiceLevel.Premium, _poolSize, poolName1);
            CapacityPoolResource pool2 = await CreateCapacityPool(DefaultLocation, ServiceLevel.Premium, _poolSize, poolName2);
        ...
        public async Task PatchPool()
        {
            ...
            CapacityPoolResource pool1 = await CreateCapacityPool(DefaultLocation, ServiceLevel.Premium, _poolSize);
