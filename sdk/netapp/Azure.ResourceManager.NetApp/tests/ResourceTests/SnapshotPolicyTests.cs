...
namespace Azure.ResourceManager.NetApp.Tests
{
    public class SnapshotPolicyTests : NetAppTestBase
    {
        ...
        private readonly HourlySchedule _hourlySchedule = new HourlySchedule
        {
            SnapshotsToKeep = 2,
            Minute = 50
        };

        private readonly DailySchedule _dailySchedule = new DailySchedule
        {
            SnapshotsToKeep = 4,
            Hour = 14,
            Minute = 30
        ...
        private readonly MonthlySchedule _monthlySchedule = new MonthlySchedule
        {
            SnapshotsToKeep = 5,
        ...
        public async Task UpdateSnapshotPolicy()
        {
            ...
            DailySchedule patchDailySchedule = new DailySchedule
            {
                SnapshotsToKeep = 2,
                Hour = 10,
                Minute = 25
        ...
        public async Task CreateVolumeWithSnapshotPolicy()
        {
            ...
            _capacityPool = await CreateCapacityPool(DefaultLocationString, ServiceLevel.Premium, _poolSize);
            ...
            VolumePropertiesDataProtection dataProtectionProperties = new VolumePropertiesDataProtection(null, null, snapshot: snapshotPolicyProperties);
            VolumeResource volumeResource1 = await CreateVolume(DefaultLocationString, ServiceLevel.Premium, _defaultUsageThreshold, subnetId:DefaultSubnetId, dataProtection: dataProtectionProperties);
        ...
        public async Task ListVolumesWithSnapshotPolicy()
        {
            ...
            //List volumes
            //List<SnapshotPolicyResource> snapshotPoliciesList = await _snapshotPolicyCollection.GetAllAsync().ToEnumerableAsync();
            List<VolumeResource> volumesList = await snapshotPolicyResource1.GetVolumesAsync().ToEnumerableAsync();
