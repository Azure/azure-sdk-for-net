...
namespace Azure.ResourceManager.NetApp
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="CapacityPoolResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NetAppAccountResource"/> using the GetCapacityPools method.
    /// </summary>
    public partial class CapacityPoolResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of CapacityPoolResource for mocking. </summary>
        protected CapacityPoolResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="CapacityPoolResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string capacityPoolApiVersion);
            _poolsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.NetApp", ResourceType.Namespace, Diagnostics);
            _poolsRestClient = new Pools(_poolsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, capacityPoolApiVersion ?? "2026-06-15-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}";
        ...
        {
            using DiagnosticScope scope = _poolsClientDiagnostics.CreateScope("CapacityPoolResource.Get");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> CapacityPools_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-06-15-preview. </description>
        ...
        public virtual async Task<ArmOperation<CapacityPoolResource>> UpdateAsync(WaitUntil waitUntil, CapacityPoolPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _poolsClientDiagnostics.CreateScope("CapacityPoolResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _poolsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, CapacityPoolPatch.ToRequestContent(patch), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetAppArmOperation<CapacityPoolResource> operation = new NetAppArmOperation<CapacityPoolResource>(
                    new CapacityPoolResourceOperationSource(Client),
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> CapacityPools_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-06-15-preview. </description>
        ...
        {
            using DiagnosticScope scope = _poolsClientDiagnostics.CreateScope("CapacityPoolResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetAppArmOperation operation = new NetAppArmOperation(_poolsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<ArmOperation<CapacityPoolResource>> UpdateAsync(WaitUntil waitUntil, CapacityPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _poolsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, CapacityPoolData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetAppArmOperation<CapacityPoolResource> operation = new NetAppArmOperation<CapacityPoolResource>(
                    new CapacityPoolResourceOperationSource(Client),
                    _poolsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<CapacityPoolResource> Update(WaitUntil waitUntil, CapacityPoolData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<CapacityPoolResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _poolsClientDiagnostics.CreateScope("CapacityPoolResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    CapacityPoolData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    CapacityPoolPatch patch = new CapacityPoolPatch(current.Location);
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    }
                    patch.Tags[key] = value;
                    ArmOperation<CapacityPoolResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CapacityPoolResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    CapacityPoolData current = Get(cancellationToken: cancellationToken).Value.Data;
                    CapacityPoolPatch patch = new CapacityPoolPatch(current.Location);
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<CapacityPoolResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<CapacityPoolResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _poolsClientDiagnostics.CreateScope("CapacityPoolResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<CapacityPoolResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _poolsClientDiagnostics.CreateScope("CapacityPoolResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        /// <summary> Gets a collection of NetAppVolumes in the <see cref="CapacityPoolResource"/>. </summary>
        /// <returns> An object representing collection of NetAppVolumes and their operations over a NetAppVolumeResource. </returns>
