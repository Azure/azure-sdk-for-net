...
{
    internal partial class ActiveDirectoryConfigsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<ActiveDirectoryConfigData>
    {
        private readonly ActiveDirectoryConfigs _client;
        private readonly Guid _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of ActiveDirectoryConfigsGetBySubscriptionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ActiveDirectoryConfigs client used to send requests. </param>
        ...
        /// <summary> Gets the pages of ActiveDirectoryConfigsGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ActiveDirectoryConfigsGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </returns>
