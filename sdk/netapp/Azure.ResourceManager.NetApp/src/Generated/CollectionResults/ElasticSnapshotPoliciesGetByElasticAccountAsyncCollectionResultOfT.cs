...
namespace Azure.ResourceManager.NetApp
{
    internal partial class ElasticSnapshotPoliciesGetByElasticAccountAsyncCollectionResultOfT : AsyncPageable<NetAppElasticSnapshotPolicyData>
    {
        ...
        public ElasticSnapshotPoliciesGetByElasticAccountAsyncCollectionResultOfT(ElasticSnapshotPolicies client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
