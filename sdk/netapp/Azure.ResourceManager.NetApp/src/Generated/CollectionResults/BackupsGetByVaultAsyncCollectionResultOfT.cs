...
{
    internal partial class BackupsGetByVaultAsyncCollectionResultOfT : AsyncPageable<NetAppBackupData>
    {
        ...
        public override async IAsyncEnumerable<Page<NetAppBackupData>> AsPages(string continuationToken, int? pageSizeHint)
        {
