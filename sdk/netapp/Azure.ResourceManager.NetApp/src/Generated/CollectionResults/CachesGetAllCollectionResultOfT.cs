...
{
    internal partial class CachesGetAllCollectionResultOfT : Pageable<NetAppCacheData>
    {
        ...
        public CachesGetAllCollectionResultOfT(Caches client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
