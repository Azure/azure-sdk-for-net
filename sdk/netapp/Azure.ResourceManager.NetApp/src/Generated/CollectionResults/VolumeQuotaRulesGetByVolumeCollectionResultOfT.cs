...
namespace Azure.ResourceManager.NetApp
{
    internal partial class VolumeQuotaRulesGetByVolumeCollectionResultOfT : Pageable<NetAppVolumeQuotaRuleData>
    {
        ...
        public VolumeQuotaRulesGetByVolumeCollectionResultOfT(VolumeQuotaRules client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, string volumeName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
