...
namespace Azure.ResourceManager.NetApp
{
    internal partial class SnapshotsGetAllCollectionResultOfT : Pageable<NetAppVolumeSnapshotData>
    {
        ...
        public SnapshotsGetAllCollectionResultOfT(Snapshots client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, string volumeName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
