...
namespace Azure.ResourceManager.NetApp
{
    internal partial class BackupPoliciesGetAllAsyncCollectionResultOfT : AsyncPageable<NetAppBackupPolicyData>
    {
        ...
        public BackupPoliciesGetAllAsyncCollectionResultOfT(BackupPolicies client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
