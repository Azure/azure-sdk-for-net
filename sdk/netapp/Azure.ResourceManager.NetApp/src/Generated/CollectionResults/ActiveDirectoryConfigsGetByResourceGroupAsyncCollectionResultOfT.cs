...
namespace Azure.ResourceManager.NetApp
{
    internal partial class ActiveDirectoryConfigsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ActiveDirectoryConfigData>
    {
        ...
        /// <summary> Initializes a new instance of ActiveDirectoryConfigsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ActiveDirectoryConfigsGetByResourceGroupAsyncCollectionResultOfT(ActiveDirectoryConfigs client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ActiveDirectoryConfigsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
