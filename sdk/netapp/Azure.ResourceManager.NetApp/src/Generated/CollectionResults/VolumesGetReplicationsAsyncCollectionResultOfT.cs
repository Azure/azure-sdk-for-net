...
{
    internal partial class VolumesGetReplicationsAsyncCollectionResultOfT : AsyncPageable<NetAppVolumeReplication>
    {
        ...
        /// <returns> The pages of VolumesGetReplicationsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<NetAppVolumeReplication>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<NetAppVolumeReplication>.FromValues((IReadOnlyList<NetAppVolumeReplication>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
