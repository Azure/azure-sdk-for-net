...
namespace Azure.ResourceManager.NetApp
{
    internal partial class SubvolumesGetByVolumeCollectionResultOfT : Pageable<NetAppSubvolumeInfoData>
    {
        ...
        /// <summary> Initializes a new instance of SubvolumesGetByVolumeCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Subvolumes client used to send requests. </param>
        ...
        public SubvolumesGetByVolumeCollectionResultOfT(Subvolumes client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, string volumeName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SubvolumesGetByVolumeCollectionResultOfT as an enumerable collection. </summary>
