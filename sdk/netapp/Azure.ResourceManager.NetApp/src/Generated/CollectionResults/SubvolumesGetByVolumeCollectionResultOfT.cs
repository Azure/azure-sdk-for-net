...
namespace Azure.ResourceManager.NetApp
{
    internal partial class SubvolumesGetByVolumeCollectionResultOfT : Pageable<NetAppSubvolumeInfoData>
    {
        ...
        public SubvolumesGetByVolumeCollectionResultOfT(Subvolumes client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, string volumeName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
