...
namespace Azure.ResourceManager.NetApp
{
    internal partial class ElasticAccountsGetByResourceGroupCollectionResultOfT : Pageable<ElasticAccountData>
    {
        ...
        /// <summary> Initializes a new instance of ElasticAccountsGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ElasticAccountsGetByResourceGroupCollectionResultOfT(ElasticAccounts client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ElasticAccountsGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
