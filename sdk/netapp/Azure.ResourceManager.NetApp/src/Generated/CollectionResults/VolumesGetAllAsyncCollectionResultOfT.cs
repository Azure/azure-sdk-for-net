...
namespace Azure.ResourceManager.NetApp
{
    internal partial class VolumesGetAllAsyncCollectionResultOfT : AsyncPageable<NetAppVolumeData>
    {
        ...
        public VolumesGetAllAsyncCollectionResultOfT(Volumes client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
