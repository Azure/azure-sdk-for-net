...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppBackupPolicyResource : ArmResource
    {
        ...
        internal NetAppBackupPolicyResource(ArmClient client, NetAppBackupPolicyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NetAppBackupPolicyResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new NetAppBackupPolicyResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
