...
namespace Azure.ResourceManager.NetApp
{
    ...
    /// </summary>
    public partial class NetAppAccountBackupResource : NetAppBackupResource
    {
        ...
        internal NetAppAccountBackupResource(ArmClient client, NetAppBackupData data) : base(client, data)
        {
        ...
        protected override async Task<Response<NetAppBackupResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((NetAppBackupResource)new NetAppAccountBackupResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<NetAppAccountBackupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<NetAppAccountBackupResource> Get(CancellationToken cancellationToken = default)
        {
