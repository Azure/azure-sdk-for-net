...
namespace Azure.ResourceManager.NetApp
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="BucketResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="VolumeResource"/> using the GetBuckets method.
    /// </summary>
    public partial class BucketResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of BucketResource for mocking. </summary>
        protected BucketResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BucketResource"/> class. </summary>
        ...
        internal BucketResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _bucketsRestClient = new Buckets(_bucketsClientDiagnostics, Pipeline, Endpoint, bucketApiVersion ?? "2025-12-15-preview");
        ...
        {
            using DiagnosticScope scope = _bucketsClientDiagnostics.CreateScope("BucketResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<BucketResource>> UpdateAsync(WaitUntil waitUntil, BucketPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _bucketsClientDiagnostics.CreateScope("BucketResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _bucketsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, BucketPatch.ToRequestContent(patch), context);
        ...
        {
            using DiagnosticScope scope = _bucketsClientDiagnostics.CreateScope("BucketResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation> GenerateAkvCredentialsAsync(WaitUntil waitUntil, BucketCredentialsExpiry body, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _bucketsClientDiagnostics.CreateScope("BucketResource.GenerateAkvCredentials");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<BucketGenerateCredentials>> GenerateCredentialsAsync(BucketCredentialsExpiry body, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _bucketsClientDiagnostics.CreateScope("BucketResource.GenerateCredentials");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _bucketsClientDiagnostics.CreateScope("BucketResource.RefreshCertificate");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
