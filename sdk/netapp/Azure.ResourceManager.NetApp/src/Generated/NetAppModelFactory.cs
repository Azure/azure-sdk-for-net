...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public static partial class NetAppModelFactory
    {
        ...
        {
            return new NetAppVolumeDataProtection(backup, replication, new VolumeSnapshotProperties(snapshotPolicyId));
        }
