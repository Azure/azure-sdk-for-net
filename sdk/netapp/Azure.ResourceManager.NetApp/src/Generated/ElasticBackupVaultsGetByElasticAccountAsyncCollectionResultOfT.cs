...
namespace Azure.ResourceManager.NetApp
{
    internal partial class ElasticBackupVaultsGetByElasticAccountAsyncCollectionResultOfT : AsyncPageable<ElasticBackupVaultData>
    {
        ...
        /// <summary> Initializes a new instance of ElasticBackupVaultsGetByElasticAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ElasticBackupVaults client used to send requests. </param>
        ...
        public ElasticBackupVaultsGetByElasticAccountAsyncCollectionResultOfT(ElasticBackupVaults client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of ElasticBackupVaultsGetByElasticAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ElasticBackupVaultCollection.GetAll");
            scope.Start();
            try
            {
