...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppSubvolumeMetadata : IJsonModel<NetAppSubvolumeMetadata>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetAppSubvolumeMetadata IJsonModel<NetAppSubvolumeMetadata>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NetAppSubvolumeMetadata JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetAppSubvolumeMetadata>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NetAppSubvolumeMetadata DeserializeNetAppSubvolumeMetadata(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new NetAppSubvolumeMetadata(id, name, @type, properties, additionalBinaryDataProperties);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NetAppSubvolumeMetadata IPersistableModel<NetAppSubvolumeMetadata>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NetAppSubvolumeMetadata PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NetAppSubvolumeMetadata>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
