...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppSubvolumeMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetAppSubvolumeMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetAppSubvolumeMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetAppSubvolumeMetadata>)} interface");
            }
        ...
        string IPersistableModel<NetAppSubvolumeMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
