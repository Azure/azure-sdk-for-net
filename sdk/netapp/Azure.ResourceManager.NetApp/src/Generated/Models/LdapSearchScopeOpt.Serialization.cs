...
{
    public partial class LdapSearchScopeOpt : IUtf8JsonSerializable
    {
        ...
        internal static LdapSearchScopeOpt DeserializeLdapSearchScopeOpt(JsonElement element)
        {
            ...
            return new LdapSearchScopeOpt(userDN.Value, groupDN.Value, groupMembershipFilter.Value);
        }
    }
}
