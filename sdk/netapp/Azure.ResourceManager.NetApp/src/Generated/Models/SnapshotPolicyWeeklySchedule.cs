...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class SnapshotPolicyWeeklySchedule
    {
        ...
        internal SnapshotPolicyWeeklySchedule(int? snapshotsToKeep, string day, int? hour, int? minute, long? usedBytes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
