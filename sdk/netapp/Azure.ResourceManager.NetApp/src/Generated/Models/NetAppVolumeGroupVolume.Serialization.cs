...
{
    public partial class NetAppVolumeGroupVolume : IUtf8JsonSerializable, IJsonModel<NetAppVolumeGroupVolume>, IPersistableModel<NetAppVolumeGroupVolume>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataProtection))
            {
                ...
                AppendChildObject(builder, DataProtection, options, 2);
            }
            ...
            if (Optional.IsDefined(CoolnessPeriod))
            {
                ...
                builder.AppendLine($" '{CoolnessPeriod.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(CloneProgress))
            {
                ...
                builder.AppendLine($" '{CloneProgress.Value.ToString()}'");
            }
