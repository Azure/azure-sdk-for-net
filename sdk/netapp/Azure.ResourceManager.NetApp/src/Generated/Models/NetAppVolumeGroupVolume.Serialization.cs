...
{
    public partial class NetAppVolumeGroupVolume : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NetAppVolumeGroupVolume DeserializeNetAppVolumeGroupVolume(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
