    ...
    public partial class NetAppVolumeGroupVolume : IUtf8JsonSerializable, IJsonModel<NetAppVolumeGroupVolume>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CreationToken))
            {
                ...
                if (CreationToken.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ServiceLevel))
            {
                ...
                builder.AppendLine($" '{ServiceLevel.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SnapshotId))
            {
                ...
                if (SnapshotId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(BaremetalTenantId))
            {
                ...
                if (BaremetalTenantId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(NetworkFeatures))
            {
                ...
                builder.AppendLine($" '{NetworkFeatures.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(StorageToNetworkProximity))
            {
                ...
                builder.AppendLine($" '{StorageToNetworkProximity.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(VolumeType))
            {
                ...
                if (VolumeType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SecurityStyle))
            {
                ...
                builder.AppendLine($" '{SecurityStyle.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SmbAccessBasedEnumeration))
            {
                ...
                builder.AppendLine($" '{SmbAccessBasedEnumeration.Value.ToString()}'");
            }

            if (Optional.IsDefined(SmbNonBrowsable))
            {
                builder.Append("    smbNonBrowsable:");
                builder.AppendLine($" '{SmbNonBrowsable.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EncryptionKeySource))
            {
                ...
                builder.AppendLine($" '{EncryptionKeySource.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(CoolAccessRetrievalPolicy))
            {
                ...
                builder.AppendLine($" '{CoolAccessRetrievalPolicy.Value.ToString()}'");
            }

            if (Optional.IsDefined(UnixPermissions))
            {
                builder.Append("    unixPermissions:");
                if (UnixPermissions.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(FileAccessLogs))
            {
                ...
                builder.AppendLine($" '{FileAccessLogs.Value.ToString()}'");
            }

            if (Optional.IsDefined(AvsDataStore))
            {
                builder.Append("    avsDataStore:");
                builder.AppendLine($" '{AvsDataStore.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(VolumeGroupName))
            {
                ...
                if (VolumeGroupName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(T2Network))
            {
                ...
                if (T2Network.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VolumeSpecName))
            {
                ...
                if (VolumeSpecName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(EnableSubvolumes))
            {
                ...
                builder.AppendLine($" '{EnableSubvolumes.Value.ToString()}'");
            }

            if (Optional.IsDefined(ProvisionedAvailabilityZone))
            {
                builder.Append("    provisionedAvailabilityZone:");
                if (ProvisionedAvailabilityZone.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
