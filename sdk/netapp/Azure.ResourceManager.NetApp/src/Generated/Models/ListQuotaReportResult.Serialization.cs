        ...
        internal static ListQuotaReportResult DeserializeListQuotaReportResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = NetAppVolumeQuotaReportListResult.DeserializeNetAppVolumeQuotaReportListResult(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new ListQuotaReportResult(properties, serializedAdditionalRawData);
        }
