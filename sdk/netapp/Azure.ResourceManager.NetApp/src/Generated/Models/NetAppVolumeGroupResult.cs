...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppVolumeGroupResult : ResourceData
    {
        ...
        internal NetAppVolumeGroupResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, VolumeGroupListProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Location = location;
