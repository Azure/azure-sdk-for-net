...
{
    public partial class HourlySchedule : IUtf8JsonSerializable
    {
        ...
        internal static HourlySchedule DeserializeHourlySchedule(JsonElement element)
        {
            ...
            return new HourlySchedule(Optional.ToNullable(snapshotsToKeep), Optional.ToNullable(minute), Optional.ToNullable(usedBytes));
        }
    }
}
