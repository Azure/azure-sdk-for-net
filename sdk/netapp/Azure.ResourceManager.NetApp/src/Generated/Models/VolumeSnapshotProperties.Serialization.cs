...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VolumeSnapshotProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VolumeSnapshotProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VolumeSnapshotProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VolumeSnapshotProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
