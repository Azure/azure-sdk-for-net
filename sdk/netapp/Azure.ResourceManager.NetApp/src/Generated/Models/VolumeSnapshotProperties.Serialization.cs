...
{
    internal partial class VolumeSnapshotProperties : IUtf8JsonSerializable, IJsonModel<VolumeSnapshotProperties>, IPersistableModel<VolumeSnapshotProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SnapshotPolicyId))
            {
                builder.Append("  snapshotPolicyId:");
                builder.AppendLine($" '{SnapshotPolicyId.ToString()}'");
            }
