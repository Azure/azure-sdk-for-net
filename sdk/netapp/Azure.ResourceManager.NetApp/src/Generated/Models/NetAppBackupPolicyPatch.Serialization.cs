...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppBackupPolicyPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetAppBackupPolicyPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetAppBackupPolicyPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetAppBackupPolicyPatch>)} interface");
            }
        ...
        string IPersistableModel<NetAppBackupPolicyPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
