...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotPolicyHourlySchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SnapshotPolicyHourlySchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SnapshotPolicyHourlySchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SnapshotPolicyHourlySchedule>)} interface");
            }
        ...
        string IPersistableModel<SnapshotPolicyHourlySchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
