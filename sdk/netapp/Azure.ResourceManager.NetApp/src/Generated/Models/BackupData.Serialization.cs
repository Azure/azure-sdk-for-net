...
{
    public partial class BackupData : IUtf8JsonSerializable
    {
        ...
        internal static BackupData DeserializeBackupData(JsonElement element)
        {
            ...
            return new BackupData(id, name, type, systemData.Value, location, backupId.Value, Optional.ToNullable(creationDate), provisioningState.Value, Optional.ToNullable(size), label.Value, Optional.ToNullable(backupType), failureReason.Value, volumeName.Value, Optional.ToNullable(useExistingSnapshot));
        }
    }
}
