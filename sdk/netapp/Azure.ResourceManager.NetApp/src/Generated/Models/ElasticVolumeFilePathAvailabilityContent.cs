...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class ElasticVolumeFilePathAvailabilityContent
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ElasticVolumeFilePathAvailabilityContent"/>. </summary>
        ...
        internal ElasticVolumeFilePathAvailabilityContent(string filePath, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FilePath = filePath;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="ElasticVolumeFilePathAvailabilityContent"/> for deserialization. </summary>
        internal ElasticVolumeFilePathAvailabilityContent()
        {
        }
