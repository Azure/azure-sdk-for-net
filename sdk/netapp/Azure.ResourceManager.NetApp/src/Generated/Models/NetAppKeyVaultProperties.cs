...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppKeyVaultProperties
    {
        ...
        internal NetAppKeyVaultProperties(string keyVaultId, Uri keyVaultUri, string keyName, string keyVaultResourceId, NetAppKeyVaultStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
