...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VolumePatchPropertiesExportPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VolumePatchPropertiesExportPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VolumePatchPropertiesExportPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VolumePatchPropertiesExportPolicy>)} interface");
            }
        ...
        string IPersistableModel<VolumePatchPropertiesExportPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
