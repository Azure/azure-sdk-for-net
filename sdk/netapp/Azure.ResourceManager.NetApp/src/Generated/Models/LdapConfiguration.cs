...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class LdapConfiguration
    {
        ...
        internal LdapConfiguration(string domain, IList<IPAddress> ldapServers, bool? isLdapOverTlsEnabled, string serverCACertificate, string certificateCNHost, IList<IPAddress> dnsServers, int? ldapPort, string userDN, string groupDN, string netGroupDN, BindAuthenticationLevel? bindAuthenticationLevel, string bindDN, BindPasswordKeyVaultConfig bindPasswordAkvConfig, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Domain = domain;
