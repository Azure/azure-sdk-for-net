...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotPolicyPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SnapshotPolicyPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SnapshotPolicyPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SnapshotPolicyPatch>)} interface");
            }
        ...
        string IPersistableModel<SnapshotPolicyPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
