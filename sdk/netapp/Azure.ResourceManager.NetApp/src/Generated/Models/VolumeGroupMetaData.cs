...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        /// <summary> Initializes a new instance of VolumeGroupMetaData. </summary>
        public VolumeGroupMetaData()
        {
            GlobalPlacementRules = new ChangeTrackingList<PlacementKeyValuePairs>();
        }
        ...
        internal VolumeGroupMetaData(string groupDescription, ApplicationType? applicationType, string applicationIdentifier, IList<PlacementKeyValuePairs> globalPlacementRules, string deploymentSpecId, long? volumesCount)
        {
        ...
        public IList<PlacementKeyValuePairs> GlobalPlacementRules { get; }
