...
{
    public partial class ActiveDirectory : IUtf8JsonSerializable
    {
        ...
        internal static ActiveDirectory DeserializeActiveDirectory(JsonElement element)
        {
            ...
            Optional<ActiveDirectoryStatus> status = default;
            ...
            Optional<LdapSearchScopeOpt> ldapSearchScope = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("status"))
                {
                    ...
                    status = new ActiveDirectoryStatus(property.Value.GetString());
                    continue;
                }
