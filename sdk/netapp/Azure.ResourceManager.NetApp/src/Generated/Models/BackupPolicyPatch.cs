...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class BackupPolicyPatch : TrackedResourceData
    {
        /// <summary> Initializes a new instance of BackupPolicyPatch. </summary>
        /// <param name="location"> The location. </param>
        public BackupPolicyPatch(AzureLocation location) : base(location)
        {
