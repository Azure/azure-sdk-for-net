...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppSubvolumeInfoPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetAppSubvolumeInfoPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetAppSubvolumeInfoPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NetAppSubvolumeInfoPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
