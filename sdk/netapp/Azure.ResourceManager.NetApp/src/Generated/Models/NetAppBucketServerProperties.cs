...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppBucketServerProperties
    {
        ...
        internal NetAppBucketServerProperties(string fqdn, string certificateCommonName, DateTimeOffset? certificateExpiryOn, string ipAddress, string certificateObject, NetAppOnCertificateConflictAction? onCertificateConflictAction, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Fqdn = fqdn;
