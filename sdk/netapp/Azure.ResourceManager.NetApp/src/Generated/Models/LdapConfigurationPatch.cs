...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class LdapConfigurationPatch
    {
        ...
        internal LdapConfigurationPatch(string domain, IList<string> ldapServers, bool? ldapOverTls, string serverCACertificate, string certificateCNHost, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
