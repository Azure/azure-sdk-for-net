...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppAccountList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetAppAccountList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetAppAccountList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetAppAccountList>)} interface");
            }
        ...
        string IPersistableModel<NetAppAccountList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
