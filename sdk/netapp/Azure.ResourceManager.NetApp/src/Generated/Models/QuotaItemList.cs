...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    internal partial class QuotaItemList
    {
        ...
        {
            Value = new ChangeTrackingList<QuotaItemData>();
        }
        ...
        internal QuotaItemList(IReadOnlyList<QuotaItemData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
