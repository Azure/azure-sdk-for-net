...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class ReplicationObject
    {
        ...
        internal ReplicationObject(string replicationId, NetAppEndpointType? endpointType, NetAppReplicationSchedule? replicationSchedule, string remoteVolumeResourceId, RemotePath remotePath, string remoteVolumeRegion, IReadOnlyList<DestinationReplication> destinationReplications, ExternalReplicationSetupStatus? externalReplicationSetupStatus, string externalReplicationSetupInfo, NetAppMirrorState? mirrorState, VolumeReplicationRelationshipStatus? relationshipStatus, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
