...
{
    public partial class NetAppVolumeDataProtection : IUtf8JsonSerializable, IJsonModel<NetAppVolumeDataProtection>, IPersistableModel<NetAppVolumeDataProtection>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Replication))
            {
                ...
                AppendChildObject(builder, Replication, options, 2);
            }
            ...
            if (Optional.IsDefined(VolumeRelocation))
            {
                builder.Append("  volumeRelocation:");
                AppendChildObject(builder, VolumeRelocation, options, 2);
            }
