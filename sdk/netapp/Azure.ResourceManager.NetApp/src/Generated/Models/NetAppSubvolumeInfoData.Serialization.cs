...
namespace Azure.ResourceManager.NetApp
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppSubvolumeInfoData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetAppSubvolumeInfoData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetAppSubvolumeInfoData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetAppSubvolumeInfoData>)} interface");
            }
        ...
        string IPersistableModel<NetAppSubvolumeInfoData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
