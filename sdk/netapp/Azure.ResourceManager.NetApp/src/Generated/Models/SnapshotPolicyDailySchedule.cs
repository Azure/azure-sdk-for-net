...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class SnapshotPolicyDailySchedule
    {
        ...
        internal SnapshotPolicyDailySchedule(int? snapshotsToKeep, int? hour, int? minute, long? usedBytes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
