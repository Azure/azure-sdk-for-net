...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class BindPasswordAkvConfig
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BindPasswordAkvConfig"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="azureKeyVaultUri"/> or <paramref name="secretName"/> is null. </exception>
        public BindPasswordAkvConfig(Uri azureKeyVaultUri, string secretName)
        {
        ...
        internal BindPasswordAkvConfig(Uri azureKeyVaultUri, string secretName, ResourceIdentifier userAssignedIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AzureKeyVaultUri = azureKeyVaultUri;
            SecretName = secretName;
