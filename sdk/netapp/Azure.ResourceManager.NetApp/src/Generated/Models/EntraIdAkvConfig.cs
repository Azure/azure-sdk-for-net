...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class EntraIdAkvConfig
    {
        ...
        internal EntraIdAkvConfig(Uri azureKeyVaultUri, string certificateName, ResourceIdentifier userAssignedIdentity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AzureKeyVaultUri = azureKeyVaultUri;
            CertificateName = certificateName;
        ...
        /// <summary> Initializes a new instance of <see cref="EntraIdAkvConfig"/> for deserialization. </summary>
        internal EntraIdAkvConfig()
        {
        }
