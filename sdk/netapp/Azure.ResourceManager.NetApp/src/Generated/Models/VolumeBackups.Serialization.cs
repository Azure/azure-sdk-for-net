...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        internal static VolumeBackups DeserializeVolumeBackups(JsonElement element)
        {
            ...
            return new VolumeBackups(volumeName.Value, Optional.ToNullable(backupsCount), Optional.ToNullable(policyEnabled));
        }
    }
}
