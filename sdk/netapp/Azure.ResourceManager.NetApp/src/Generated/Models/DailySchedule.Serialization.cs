...
{
    public partial class DailySchedule : IUtf8JsonSerializable
    {
        ...
        internal static DailySchedule DeserializeDailySchedule(JsonElement element)
        {
            ...
            return new DailySchedule(Optional.ToNullable(snapshotsToKeep), Optional.ToNullable(hour), Optional.ToNullable(minute), Optional.ToNullable(usedBytes));
        }
    }
}
