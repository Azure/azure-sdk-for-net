...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppOriginClusterInformation
    {
        ...
        internal NetAppOriginClusterInformation(string peerClusterName, IList<string> peerAddresses, string peerVserverName, string peerVolumeName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PeerClusterName = peerClusterName;
