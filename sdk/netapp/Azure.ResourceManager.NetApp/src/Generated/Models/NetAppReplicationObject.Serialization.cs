...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppReplicationObject>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetAppReplicationObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetAppReplicationObject>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NetAppReplicationObject>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
