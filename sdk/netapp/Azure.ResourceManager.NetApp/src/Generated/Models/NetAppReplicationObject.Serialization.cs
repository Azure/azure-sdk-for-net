...
{
    public partial class NetAppReplicationObject : IUtf8JsonSerializable, IJsonModel<NetAppReplicationObject>, IPersistableModel<NetAppReplicationObject>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReplicationId))
            {
                ...
                builder.AppendLine($" '{ReplicationId}'");
            }
