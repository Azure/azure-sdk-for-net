...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VolumeQuotaRulesList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VolumeQuotaRulesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VolumeQuotaRulesList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VolumeQuotaRulesList>)} interface");
            }
        ...
        string IPersistableModel<VolumeQuotaRulesList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
