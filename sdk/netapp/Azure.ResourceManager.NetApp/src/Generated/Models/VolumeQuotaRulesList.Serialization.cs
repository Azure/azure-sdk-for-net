...
{
    internal partial class VolumeQuotaRulesList : IUtf8JsonSerializable, IJsonModel<VolumeQuotaRulesList>, IPersistableModel<VolumeQuotaRulesList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VolumeQuotaRulesList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VolumeQuotaRulesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VolumeQuotaRulesList)} does not support '{format}' format.");
            }
