...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        internal static SubscriptionQuotaItemList DeserializeSubscriptionQuotaItemList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
