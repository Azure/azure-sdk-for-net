...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionQuotaItemList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SubscriptionQuotaItemList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SubscriptionQuotaItemList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubscriptionQuotaItemList>)} interface");
            }
        ...
        string IPersistableModel<SubscriptionQuotaItemList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
