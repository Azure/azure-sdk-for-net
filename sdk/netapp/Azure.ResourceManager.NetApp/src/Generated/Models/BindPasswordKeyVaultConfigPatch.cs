...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class BindPasswordKeyVaultConfigPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BindPasswordKeyVaultConfigPatch"/>. </summary>
        ...
        internal BindPasswordKeyVaultConfigPatch(Uri azureKeyVaultUri, string secretName, ResourceIdentifier userAssignedIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
