...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class ActiveDirectoryConfigProperties
    {
        ...
        internal ActiveDirectoryConfigProperties(string userName, IList<string> dns, string smbServerName, string organizationalUnit, string site, IList<string> backupOperators, IList<string> administrators, IList<string> securityOperators, NetAppAccountActiveDirectoryStatus? activeDirectoryStatus, NetAppProvisioningState? provisioningState, string domain, SecretPassword secretPassword, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserName = userName;
            Dns = dns;
