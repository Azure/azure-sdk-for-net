...
namespace Azure.ResourceManager.NetApp.Models
{
    public partial class NetAppVolumeBackupPatch : IUtf8JsonSerializable, IModelJsonSerializable<NetAppVolumeBackupPatch>
    {
        ...
        internal static NetAppVolumeBackupPatch DeserializeNetAppVolumeBackupPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NetAppVolumeBackupPatch(Optional.ToDictionary(tags), backupId.Value, Optional.ToNullable(creationDate), provisioningState.Value, Optional.ToNullable(size), label.Value, Optional.ToNullable(backupType), failureReason.Value, volumeName.Value, Optional.ToNullable(useExistingSnapshot), serializedAdditionalRawData);
        }
