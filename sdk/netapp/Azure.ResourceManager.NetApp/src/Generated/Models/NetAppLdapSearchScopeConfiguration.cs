...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppLdapSearchScopeConfiguration
    {
        ...
        internal NetAppLdapSearchScopeConfiguration(string userDN, string groupDN, string groupMembershipFilter, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            UserDN = userDN;
            GroupDN = groupDN;
