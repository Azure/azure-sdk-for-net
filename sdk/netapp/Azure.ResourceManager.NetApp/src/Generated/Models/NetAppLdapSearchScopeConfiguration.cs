...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppLdapSearchScopeConfiguration
    {
        ...
        internal NetAppLdapSearchScopeConfiguration(string userDN, string groupDN, string groupMembershipFilter, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserDN = userDN;
            GroupDN = groupDN;
