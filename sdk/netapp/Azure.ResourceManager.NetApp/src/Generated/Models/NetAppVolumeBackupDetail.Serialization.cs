...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        internal static NetAppVolumeBackupDetail DeserializeNetAppVolumeBackupDetail(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
