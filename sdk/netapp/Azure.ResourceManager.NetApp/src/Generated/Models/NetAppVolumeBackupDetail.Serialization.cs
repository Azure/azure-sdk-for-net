...
{
    public partial class NetAppVolumeBackupDetail : IUtf8JsonSerializable, IJsonModel<NetAppVolumeBackupDetail>, IPersistableModel<NetAppVolumeBackupDetail>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BackupsCount))
            {
                builder.Append("  backupsCount:");
                builder.AppendLine($" '{BackupsCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(IsPolicyEnabled))
            {
                builder.Append("  policyEnabled:");
                var boolValue = IsPolicyEnabled.Value == true ? "true" : "false";
