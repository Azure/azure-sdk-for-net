...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetGroupIdListForLdapUserResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GetGroupIdListForLdapUserResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GetGroupIdListForLdapUserResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GetGroupIdListForLdapUserResult>)} interface");
            }
        ...
        string IPersistableModel<GetGroupIdListForLdapUserResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
