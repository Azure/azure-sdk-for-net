...
{
    public partial class NetAppVolumeExportPolicyRule : IUtf8JsonSerializable, IJsonModel<NetAppVolumeExportPolicyRule>, IPersistableModel<NetAppVolumeExportPolicyRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RuleIndex))
            {
                ...
                builder.AppendLine($" '{RuleIndex.Value.ToString()}'");
            }
