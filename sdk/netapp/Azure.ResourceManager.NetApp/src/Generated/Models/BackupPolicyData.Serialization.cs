...
namespace Azure.ResourceManager.NetApp
{
    public partial class BackupPolicyData : IUtf8JsonSerializable
    {
        ...
        internal static BackupPolicyData DeserializeBackupPolicyData(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<VolumeBackups>> volumeBackups = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("volumeBackups"))
                        {
                            ...
                            {
                                array.Add(Models.VolumeBackups.DeserializeVolumeBackups(item));
                            }
                            volumeBackups = array;
                            continue;
                        }
            ...
            return new BackupPolicyData(id, name, type, systemData, tags, location, etag.Value, backupPolicyId.Value, provisioningState.Value, Optional.ToNullable(dailyBackupsToKeep), Optional.ToNullable(weeklyBackupsToKeep), Optional.ToNullable(monthlyBackupsToKeep), Optional.ToNullable(volumesAssigned), Optional.ToNullable(enabled), Optional.ToList(volumeBackups));
        }
    }
}
