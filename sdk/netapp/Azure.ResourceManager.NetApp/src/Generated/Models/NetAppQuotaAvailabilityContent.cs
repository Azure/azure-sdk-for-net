...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppQuotaAvailabilityContent
    {
        ...
        internal NetAppQuotaAvailabilityContent(string name, NetAppQuotaAvailabilityResourceType availabilityResourceType, string resourceGroup, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            AvailabilityResourceType = availabilityResourceType;
            ResourceGroup = resourceGroup;
