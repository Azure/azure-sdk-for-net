...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppLdapConfiguration
    {
        ...
        internal NetAppLdapConfiguration(string domain, IList<string> ldapServers, bool? ldapOverTls, string serverCACertificate, string certificateCNHost, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
