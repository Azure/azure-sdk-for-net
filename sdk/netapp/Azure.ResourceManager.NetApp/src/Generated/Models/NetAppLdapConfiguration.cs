...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppLdapConfiguration
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="NetAppLdapConfiguration"/>. </summary>
        public NetAppLdapConfiguration()
        {
        ...
        internal NetAppLdapConfiguration(string domain, IList<string> ldapServers, bool? isLdapOverTlsEnabled, string serverCACertificate, string certificateCNHost, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
