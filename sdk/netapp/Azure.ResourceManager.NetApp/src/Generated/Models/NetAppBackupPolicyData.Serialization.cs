...
{
    public partial class NetAppBackupPolicyData : IUtf8JsonSerializable, IJsonModel<NetAppBackupPolicyData>, IPersistableModel<NetAppBackupPolicyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  backupPolicyId:");
                builder.AppendLine($" '{BackupPolicyId.ToString()}'");
            }
            ...
            if (Optional.IsDefined(DailyBackupsToKeep))
            {
                builder.Append("  dailyBackupsToKeep:");
                builder.AppendLine($" '{DailyBackupsToKeep.Value.ToString()}'");
            }

            if (Optional.IsDefined(WeeklyBackupsToKeep))
            {
                builder.Append("  weeklyBackupsToKeep:");
                builder.AppendLine($" '{WeeklyBackupsToKeep.Value.ToString()}'");
            }

            if (Optional.IsDefined(MonthlyBackupsToKeep))
            {
                builder.Append("  monthlyBackupsToKeep:");
                builder.AppendLine($" '{MonthlyBackupsToKeep.Value.ToString()}'");
            }

            if (Optional.IsDefined(VolumesAssigned))
            {
                builder.Append("  volumesAssigned:");
                builder.AppendLine($" '{VolumesAssigned.Value.ToString()}'");
            }
