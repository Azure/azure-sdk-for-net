...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotPolicyMonthlySchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SnapshotPolicyMonthlySchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SnapshotPolicyMonthlySchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SnapshotPolicyMonthlySchedule>)} interface");
            }
        ...
        string IPersistableModel<SnapshotPolicyMonthlySchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
