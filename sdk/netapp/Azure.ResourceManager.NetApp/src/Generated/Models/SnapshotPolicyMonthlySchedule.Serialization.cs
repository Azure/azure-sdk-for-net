...
{
    public partial class SnapshotPolicyMonthlySchedule : IUtf8JsonSerializable, IJsonModel<SnapshotPolicyMonthlySchedule>, IPersistableModel<SnapshotPolicyMonthlySchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DaysOfMonth))
            {
                ...
                builder.AppendLine($" '{DaysOfMonth}'");
            }
