...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        internal static SubvolumeModel DeserializeSubvolumeModel(JsonElement element)
        {
            ...
            return new SubvolumeModel(id, name, type, systemData, path.Value, parentPath.Value, Optional.ToNullable(size), Optional.ToNullable(bytesUsed), permissions.Value, Optional.ToNullable(creationTimeStamp), Optional.ToNullable(accessedTimeStamp), Optional.ToNullable(modifiedTimeStamp), Optional.ToNullable(changedTimeStamp), provisioningState.Value);
        }
    }
}
