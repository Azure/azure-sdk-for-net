...
namespace Azure.ResourceManager.NetApp.Models
{
    public partial class RestoreStatus
    {
        internal static RestoreStatus DeserializeRestoreStatus(JsonElement element)
        {
            ...
            return new RestoreStatus(Optional.ToNullable(healthy), Optional.ToNullable(relationshipStatus), Optional.ToNullable(mirrorState), unhealthyReason.Value, errorMessage.Value, Optional.ToNullable(totalTransferBytes));
        }
    }
}
