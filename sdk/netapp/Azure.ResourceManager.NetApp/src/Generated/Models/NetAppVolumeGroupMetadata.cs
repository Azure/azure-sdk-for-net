...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppVolumeGroupMetadata
    {
        ...
        internal NetAppVolumeGroupMetadata(string groupDescription, NetAppApplicationType? applicationType, string applicationIdentifier, IList<NetAppVolumePlacementRule> globalPlacementRules, string deploymentSpecId, long? volumesCount, Dictionary<string, BinaryData> rawData)
        {
