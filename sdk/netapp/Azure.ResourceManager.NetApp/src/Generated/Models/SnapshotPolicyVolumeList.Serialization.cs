...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        internal static SnapshotPolicyVolumeList DeserializeSnapshotPolicyVolumeList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
