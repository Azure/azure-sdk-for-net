...
{
    public partial class VolumeGroupDetailData : IUtf8JsonSerializable
    {
        ...
        internal static VolumeGroupDetailData DeserializeVolumeGroupDetailData(JsonElement element)
        {
            ...
            return new VolumeGroupDetailData(id, name, type, systemData.Value, Optional.ToNullable(location), provisioningState.Value, groupMetaData.Value, Optional.ToList(volumes));
        }
    }
}
