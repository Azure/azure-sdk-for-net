...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateNetworkSiblingSetContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateNetworkSiblingSetContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateNetworkSiblingSetContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateNetworkSiblingSetContent>)} interface");
            }
        ...
        string IPersistableModel<UpdateNetworkSiblingSetContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
