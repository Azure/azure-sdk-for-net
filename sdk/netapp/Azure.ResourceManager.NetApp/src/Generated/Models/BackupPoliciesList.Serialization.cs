...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupPoliciesList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupPoliciesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupPoliciesList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupPoliciesList>)} interface");
            }
        ...
        string IPersistableModel<BackupPoliciesList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
