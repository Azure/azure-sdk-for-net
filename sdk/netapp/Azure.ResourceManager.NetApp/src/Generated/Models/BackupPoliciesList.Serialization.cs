...
{
    internal partial class BackupPoliciesList : IUtf8JsonSerializable, IJsonModel<BackupPoliciesList>, IPersistableModel<BackupPoliciesList>
    {
        ...
        void IJsonModel<BackupPoliciesList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BackupPoliciesList)} does not support '{format}' format.");
            }
