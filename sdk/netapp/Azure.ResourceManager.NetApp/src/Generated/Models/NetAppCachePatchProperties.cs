...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppCachePatchProperties
    {
        ...
        internal NetAppCachePatchProperties(long? size, NetAppCachePropertiesExportPolicy exportPolicy, IList<NetAppProtocolType> protocolTypes, NetAppSmbSettings smbSettings, float? throughputMibps, ResourceIdentifier keyVaultPrivateEndpointResourceId, NetAppCifsChangeNotifyState? cifsChangeNotifications, NetAppEnableWriteBackState? writeBack, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Size = size;
