...
{
    public partial class CredentialsKeyVaultDetails : IUtf8JsonSerializable, IJsonModel<CredentialsKeyVaultDetails>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CredentialsKeyVaultDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CredentialsKeyVaultDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        CredentialsKeyVaultDetails IJsonModel<CredentialsKeyVaultDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CredentialsKeyVaultDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static CredentialsKeyVaultDetails DeserializeCredentialsKeyVaultDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CredentialsKeyVaultDetails(credentialsKeyVaultUri, secretName, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<CredentialsKeyVaultDetails>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CredentialsKeyVaultDetails>)this).GetFormatFromOptions(options) : options.Format;
        ...
        CredentialsKeyVaultDetails IPersistableModel<CredentialsKeyVaultDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CredentialsKeyVaultDetails>)this).GetFormatFromOptions(options) : options.Format;
