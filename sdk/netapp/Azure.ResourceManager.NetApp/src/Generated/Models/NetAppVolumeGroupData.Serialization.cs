...
namespace Azure.ResourceManager.NetApp
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppVolumeGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetAppVolumeGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetAppVolumeGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetAppVolumeGroupData>)} interface");
            }
        ...
        string IPersistableModel<NetAppVolumeGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
