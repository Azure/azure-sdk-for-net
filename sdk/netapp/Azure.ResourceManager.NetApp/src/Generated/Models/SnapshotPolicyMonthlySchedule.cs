...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class SnapshotPolicyMonthlySchedule
    {
        ...
        internal SnapshotPolicyMonthlySchedule(int? snapshotsToKeep, string daysOfMonth, int? hour, int? minute, long? usedBytes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
