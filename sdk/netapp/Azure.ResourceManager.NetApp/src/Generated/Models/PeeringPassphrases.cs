...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class PeeringPassphrases
    {
        ...
        internal PeeringPassphrases(string clusterPeeringCommand, string clusterPeeringPassphrase, string vserverPeeringCommand, string criticalWarning, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ClusterPeeringCommand = clusterPeeringCommand;
            ClusterPeeringPassphrase = clusterPeeringPassphrase;
            VserverPeeringCommand = vserverPeeringCommand;
