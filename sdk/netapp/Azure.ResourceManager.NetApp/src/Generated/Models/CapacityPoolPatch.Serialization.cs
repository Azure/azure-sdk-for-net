...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapacityPoolPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CapacityPoolPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CapacityPoolPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CapacityPoolPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
