...
namespace Azure.ResourceManager.NetApp.Models
{
    public partial class NetAppVolumeGroupMetadata : IUtf8JsonSerializable, IJsonModel<NetAppVolumeGroupMetadata>
    {
        ...
        internal static NetAppVolumeGroupMetadata DeserializeNetAppVolumeGroupMetadata(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetAppVolumeGroupMetadata(groupDescription.Value, Optional.ToNullable(applicationType), applicationIdentifier.Value, globalPlacementRules ?? new ChangeTrackingList<NetAppVolumePlacementRule>(), Optional.ToNullable(volumesCount), serializedAdditionalRawData);
        }
