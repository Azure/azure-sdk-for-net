...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        internal static NetAppVolumeReplicationStatus DeserializeNetAppVolumeReplicationStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
