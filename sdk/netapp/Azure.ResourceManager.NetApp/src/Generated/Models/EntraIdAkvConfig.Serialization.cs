...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class EntraIdAkvConfig : IJsonModel<EntraIdAkvConfig>
    {
        ...
        protected virtual EntraIdAkvConfig PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EntraIdAkvConfig>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EntraIdAkvConfig>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EntraIdAkvConfig IPersistableModel<EntraIdAkvConfig>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EntraIdAkvConfig DeserializeEntraIdAkvConfig(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new EntraIdAkvConfig(azureKeyVaultUri, certificateName, userAssignedIdentity, additionalBinaryDataProperties);
        }
    }
}
