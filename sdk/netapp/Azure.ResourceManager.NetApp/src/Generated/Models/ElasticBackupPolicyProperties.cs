...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class ElasticBackupPolicyProperties
    {
        ...
        internal ElasticBackupPolicyProperties(NetAppVolumeQuotaRuleProvisioningState? provisioningState, int? dailyBackupsToKeep, int? weeklyBackupsToKeep, int? monthlyBackupsToKeep, int? assignedVolumesCount, ElasticBackupPolicyState? policyState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
