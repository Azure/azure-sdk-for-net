...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class BindPasswordKeyVaultConfig
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BindPasswordKeyVaultConfig"/>. </summary>
        ...
        internal BindPasswordKeyVaultConfig(Uri azureKeyVaultUri, string secretName, ResourceIdentifier userAssignedIdentity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AzureKeyVaultUri = azureKeyVaultUri;
            SecretName = secretName;
