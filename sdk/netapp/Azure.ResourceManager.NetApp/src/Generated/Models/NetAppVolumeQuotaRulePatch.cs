...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppVolumeQuotaRulePatch
    {
        ...
        internal NetAppVolumeQuotaRulePatch(IDictionary<string, string> tags, NetAppProvisioningState? provisioningState, long? quotaSizeInKiBs, NetAppVolumeQuotaType? quotaType, string quotaTarget, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
