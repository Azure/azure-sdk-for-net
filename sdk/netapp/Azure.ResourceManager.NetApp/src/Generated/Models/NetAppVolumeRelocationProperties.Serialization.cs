...
{
    public partial class NetAppVolumeRelocationProperties : IUtf8JsonSerializable, IJsonModel<NetAppVolumeRelocationProperties>, IPersistableModel<NetAppVolumeRelocationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsRelocationRequested))
            {
                builder.Append("  relocationRequested:");
                var boolValue = IsRelocationRequested.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsReadyToBeFinalized))
            {
                builder.Append("  readyToBeFinalized:");
                var boolValue = IsReadyToBeFinalized.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
