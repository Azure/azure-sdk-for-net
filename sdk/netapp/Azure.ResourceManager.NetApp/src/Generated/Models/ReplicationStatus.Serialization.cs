...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class ReplicationStatus : IJsonModel<ReplicationStatus>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ReplicationStatus"/> from. </param>
        internal static ReplicationStatus FromResponse(Response response)
        {
