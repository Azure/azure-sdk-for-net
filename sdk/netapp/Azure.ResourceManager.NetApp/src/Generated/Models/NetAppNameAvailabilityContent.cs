...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppNameAvailabilityContent
    {
        ...
        internal NetAppNameAvailabilityContent(string name, NetAppNameAvailabilityResourceType resourceType, string resourceGroup, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            ResourceType = resourceType;
            ResourceGroup = resourceGroup;
