...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        internal static NetAppCheckAvailabilityResult DeserializeNetAppCheckAvailabilityResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
