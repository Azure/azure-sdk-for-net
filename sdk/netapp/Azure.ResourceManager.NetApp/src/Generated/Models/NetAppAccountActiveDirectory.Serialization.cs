...
{
    public partial class NetAppAccountActiveDirectory : IUtf8JsonSerializable, IJsonModel<NetAppAccountActiveDirectory>, IPersistableModel<NetAppAccountActiveDirectory>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LdapSearchScope))
            {
                ...
                AppendChildObject(builder, LdapSearchScope, options, 2);
            }
