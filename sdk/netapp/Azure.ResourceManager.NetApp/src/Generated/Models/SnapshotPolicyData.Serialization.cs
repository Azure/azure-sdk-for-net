    ...
    public partial class SnapshotPolicyData : IUtf8JsonSerializable, IJsonModel<SnapshotPolicyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HourlySchedule))
            {
                ...
                AppendChildObject(builder, HourlySchedule, options, 4, false);
            }

            if (Optional.IsDefined(DailySchedule))
            {
                builder.Append("    dailySchedule:");
                AppendChildObject(builder, DailySchedule, options, 4, false);
            }

            if (Optional.IsDefined(WeeklySchedule))
            {
                builder.Append("    weeklySchedule:");
                AppendChildObject(builder, WeeklySchedule, options, 4, false);
            }

            if (Optional.IsDefined(MonthlySchedule))
            {
                builder.Append("    monthlySchedule:");
                AppendChildObject(builder, MonthlySchedule, options, 4, false);
            }
