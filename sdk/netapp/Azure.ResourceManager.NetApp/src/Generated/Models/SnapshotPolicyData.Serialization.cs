...
namespace Azure.ResourceManager.NetApp
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SnapshotPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SnapshotPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SnapshotPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SnapshotPolicyData>)} interface");
            }
        ...
        string IPersistableModel<SnapshotPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
