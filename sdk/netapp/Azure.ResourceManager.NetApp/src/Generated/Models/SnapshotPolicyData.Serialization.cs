...
namespace Azure.ResourceManager.NetApp
{
    public partial class SnapshotPolicyData : IUtf8JsonSerializable
    {
        ...
        internal static SnapshotPolicyData DeserializeSnapshotPolicyData(JsonElement element)
        {
            ...
            return new SnapshotPolicyData(id, name, type, systemData, tags, location, etag.Value, hourlySchedule.Value, dailySchedule.Value, weeklySchedule.Value, monthlySchedule.Value, Optional.ToNullable(enabled), provisioningState.Value);
        }
    }
}
