...
{
    public partial class SecretPasswordIdentity : IUtf8JsonSerializable, IJsonModel<SecretPasswordIdentity>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecretPasswordIdentity>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecretPasswordIdentity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        SecretPasswordIdentity IJsonModel<SecretPasswordIdentity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecretPasswordIdentity>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static SecretPasswordIdentity DeserializeSecretPasswordIdentity(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SecretPasswordIdentity(principalId, userAssignedIdentity, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<SecretPasswordIdentity>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecretPasswordIdentity>)this).GetFormatFromOptions(options) : options.Format;
        ...
        SecretPasswordIdentity IPersistableModel<SecretPasswordIdentity>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecretPasswordIdentity>)this).GetFormatFromOptions(options) : options.Format;
