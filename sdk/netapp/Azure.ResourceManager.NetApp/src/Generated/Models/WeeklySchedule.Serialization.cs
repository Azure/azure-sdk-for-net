...
namespace Azure.ResourceManager.NetApp.Models
{
    public partial class WeeklySchedule : IUtf8JsonSerializable
    {
        ...
        internal static WeeklySchedule DeserializeWeeklySchedule(JsonElement element)
        {
            ...
            return new WeeklySchedule(Optional.ToNullable(snapshotsToKeep), day.Value, Optional.ToNullable(hour), Optional.ToNullable(minute), Optional.ToNullable(usedBytes));
        }
    }
}
