...
namespace Azure.ResourceManager.NetApp.Models
{
    public partial class SnapshotPolicyWeeklySchedule : IUtf8JsonSerializable, IJsonModel<SnapshotPolicyWeeklySchedule>
    {
        ...
        void IJsonModel<SnapshotPolicyWeeklySchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SnapshotPolicyWeeklySchedule)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SnapshotPolicyWeeklySchedule>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SnapshotPolicyWeeklySchedule)} does not support '{options.Format}' format.");
            }
        }
