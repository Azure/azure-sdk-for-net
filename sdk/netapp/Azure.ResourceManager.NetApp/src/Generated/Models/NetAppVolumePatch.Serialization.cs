...
namespace Azure.ResourceManager.NetApp.Models
{
    public partial class NetAppVolumePatch : IUtf8JsonSerializable, IModelJsonSerializable<NetAppVolumePatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NetAppVolumePatch>(this, options.Format);
            ...
            if (Optional.IsDefined(ExportPolicy))
            {
                ...
                {
                    ((IModelJsonSerializable<VolumePatchPropertiesExportPolicy>)ExportPolicy).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(DataProtection))
            {
                ...
                {
                    ((IModelJsonSerializable<NetAppVolumePatchDataProtection>)DataProtection).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="NetAppVolumePatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NetAppVolumePatch"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NetAppVolumePatch"/>. </summary>
