...
{
    public partial class NetAppActiveDirectoryConfigPatchProperties : IUtf8JsonSerializable, IJsonModel<NetAppActiveDirectoryConfigPatchProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppActiveDirectoryConfigPatchProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetAppActiveDirectoryConfigPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetAppActiveDirectoryConfigPatchProperties)} does not support writing '{format}' format.");
            }
        ...
        NetAppActiveDirectoryConfigPatchProperties IJsonModel<NetAppActiveDirectoryConfigPatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetAppActiveDirectoryConfigPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetAppActiveDirectoryConfigPatchProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeNetAppActiveDirectoryConfigPatchProperties(document.RootElement, options);
        }

        internal static NetAppActiveDirectoryConfigPatchProperties DeserializeNetAppActiveDirectoryConfigPatchProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            NetAppSecretPasswordPatch secretPassword = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("secretPassword"u8))
                {
                    ...
                    secretPassword = NetAppSecretPasswordPatch.DeserializeNetAppSecretPasswordPatch(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<NetAppActiveDirectoryConfigPatchProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetAppActiveDirectoryConfigPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetAppActiveDirectoryConfigPatchProperties)} does not support writing '{options.Format}' format.");
            }
        }

        NetAppActiveDirectoryConfigPatchProperties IPersistableModel<NetAppActiveDirectoryConfigPatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetAppActiveDirectoryConfigPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetAppActiveDirectoryConfigPatchProperties)} does not support reading '{options.Format}' format.");
            }
        }
