...
namespace Azure.ResourceManager.NetApp
{
    public partial class NetAppAccountData : IUtf8JsonSerializable
    {
        ...
        internal static NetAppAccountData DeserializeNetAppAccountData(JsonElement element)
        {
            ...
            return new NetAppAccountData(id, name, type, systemData, tags, location, etag.Value, provisioningState.Value, Optional.ToList(activeDirectories), encryption.Value);
        }
    }
}
