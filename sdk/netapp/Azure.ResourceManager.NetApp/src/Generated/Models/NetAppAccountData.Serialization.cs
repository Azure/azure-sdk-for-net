...
{
    public partial class NetAppAccountData : IUtf8JsonSerializable, IJsonModel<NetAppAccountData>, IPersistableModel<NetAppAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ActiveDirectories))
            {
                builder.Append("  activeDirectories:");
                builder.AppendLine(" [");
                foreach (var item in ActiveDirectories)
                {
            ...
            {
                builder.Append("  disableShowmount:");
                var boolValue = DisableShowmount.Value == true ? "true" : "false";
