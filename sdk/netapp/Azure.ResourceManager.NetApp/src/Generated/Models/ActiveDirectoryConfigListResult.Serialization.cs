...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    internal partial class ActiveDirectoryConfigListResult : IJsonModel<ActiveDirectoryConfigListResult>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="ActiveDirectoryConfigListResult"/> from. </param>
        internal static ActiveDirectoryConfigListResult FromResponse(Response result)
        {
