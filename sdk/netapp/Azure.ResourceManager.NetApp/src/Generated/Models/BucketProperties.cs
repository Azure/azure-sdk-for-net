...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    internal partial class BucketProperties
    {
        ...
        internal BucketProperties(string path, FileSystemUser fileSystemUser, NetAppProvisioningState? provisioningState, CredentialsStatus? status, BucketServerProperties server, BucketPermissions? permissions, AzureKeyVaultDetails akvDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Path = path;
