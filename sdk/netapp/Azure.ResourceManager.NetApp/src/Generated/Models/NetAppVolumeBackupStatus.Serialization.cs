...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    {
        internal static NetAppVolumeBackupStatus DeserializeNetAppVolumeBackupStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
