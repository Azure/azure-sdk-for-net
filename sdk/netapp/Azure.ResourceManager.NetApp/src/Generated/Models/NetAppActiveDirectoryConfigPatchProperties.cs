...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public partial class NetAppActiveDirectoryConfigPatchProperties
    {
        ...
        internal NetAppActiveDirectoryConfigPatchProperties(string userName, IList<string> dns, string smbServerName, string organizationalUnit, string site, IList<string> backupOperators, IList<string> administrators, IList<string> securityOperators, string domain, NetAppSecretPasswordPatch secretPassword, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserName = userName;
            Dns = dns;
        ...
        public NetAppSecretPasswordPatch SecretPassword { get; set; }
    }
}
