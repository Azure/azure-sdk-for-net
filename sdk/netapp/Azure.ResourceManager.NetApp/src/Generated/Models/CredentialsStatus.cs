...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public readonly partial struct CredentialsStatus : IEquatable<CredentialsStatus>
    {
        ...
        /// <summary> Converts a string to a <see cref="CredentialsStatus"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator CredentialsStatus(string value) => new CredentialsStatus(value);

        /// <summary> Converts a string to a <see cref="CredentialsStatus"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator CredentialsStatus?(string value) => value == null ? null : new CredentialsStatus(value);
