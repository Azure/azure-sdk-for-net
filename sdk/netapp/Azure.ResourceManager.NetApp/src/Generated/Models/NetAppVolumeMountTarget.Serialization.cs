...
{
    public partial class NetAppVolumeMountTarget : IUtf8JsonSerializable, IJsonModel<NetAppVolumeMountTarget>, IPersistableModel<NetAppVolumeMountTarget>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  mountTargetId:");
                builder.AppendLine($" '{MountTargetId.Value.ToString()}'");
            }

            if (Optional.IsDefined(FileSystemId))
            {
                builder.Append("  fileSystemId:");
                builder.AppendLine($" '{FileSystemId.ToString()}'");
            }
            ...
            if (Optional.IsDefined(SmbServerFqdn))
            {
                builder.Append("  smbServerFqdn:");
                builder.AppendLine($" '{SmbServerFqdn}'");
            }
