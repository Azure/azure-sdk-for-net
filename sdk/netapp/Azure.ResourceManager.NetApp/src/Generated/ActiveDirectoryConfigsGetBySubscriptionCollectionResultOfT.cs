...
{
    internal partial class ActiveDirectoryConfigsGetBySubscriptionCollectionResultOfT : Pageable<ActiveDirectoryConfigData>
    {
        private readonly ActiveDirectoryConfigs _client;
        private readonly Guid _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of ActiveDirectoryConfigsGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of ActiveDirectoryConfigsGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ActiveDirectoryConfigsGetBySubscriptionCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ActiveDirectoryConfigData>> AsPages(string continuationToken, int? pageSizeHint)
        {
