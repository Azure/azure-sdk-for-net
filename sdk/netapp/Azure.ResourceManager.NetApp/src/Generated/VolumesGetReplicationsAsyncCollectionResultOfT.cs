...
{
    internal partial class VolumesGetReplicationsAsyncCollectionResultOfT : AsyncPageable<Replication>
    {
        ...
        public override async IAsyncEnumerable<Page<Replication>> AsPages(string continuationToken, int? pageSizeHint)
        {
