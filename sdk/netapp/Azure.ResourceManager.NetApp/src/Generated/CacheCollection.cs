...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class CacheCollection : ArmCollection, IEnumerable<CacheResource>, IAsyncEnumerable<CacheResource>
    {
        ...
        internal CacheCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _cachesRestClient = new Caches(_cachesClientDiagnostics, Pipeline, Endpoint, cacheApiVersion ?? "2025-12-15-preview");
        ...
        public virtual AsyncPageable<CacheResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<CacheData, CacheResource>(new CachesGetByCapacityPoolsAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "CacheCollection.GetAll"), data => new CacheResource(Client, data));
        }
