...
namespace Azure.ResourceManager.NetApp
{
    internal partial class SnapshotsGetAllCollectionResultOfT : Pageable<SnapshotData>
    {
        ...
        /// <summary> Initializes a new instance of SnapshotsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SnapshotsGetAllCollectionResultOfT(Snapshots client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, string volumeName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of SnapshotsGetAllCollectionResultOfT as an enumerable collection. </summary>
