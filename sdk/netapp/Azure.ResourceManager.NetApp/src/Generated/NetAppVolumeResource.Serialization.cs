...
namespace Azure.ResourceManager.NetApp
{
    public partial class NetAppVolumeResource : IJsonModel<NetAppVolumeData>
    {
        ...
        BinaryData IPersistableModel<NetAppVolumeData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        NetAppVolumeData IPersistableModel<NetAppVolumeData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<NetAppVolumeData>(data, options);
