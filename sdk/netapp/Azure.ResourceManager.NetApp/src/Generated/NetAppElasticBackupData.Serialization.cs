...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppElasticBackupData : ResourceData, IJsonModel<NetAppElasticBackupData>
    {
        ...
        {
            if (netAppElasticBackupData == null)
            {
                return null;
            }
            return RequestContent.Create(netAppElasticBackupData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="NetAppElasticBackupData"/> from. </param>
        internal static NetAppElasticBackupData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeNetAppElasticBackupData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NetAppElasticBackupData DeserializeNetAppElasticBackupData(JsonElement element, ModelReaderWriterOptions options)
        {
