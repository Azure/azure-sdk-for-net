...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppVolumeQuotaRuleResource : ArmResource
    {
        ...
        internal NetAppVolumeQuotaRuleResource(ArmClient client, NetAppVolumeQuotaRuleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NetAppVolumeQuotaRuleResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new NetAppVolumeQuotaRuleResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
