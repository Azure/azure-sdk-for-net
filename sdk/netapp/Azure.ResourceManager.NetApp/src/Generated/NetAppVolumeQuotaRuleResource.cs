...
namespace Azure.ResourceManager.NetApp
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="NetAppVolumeQuotaRuleResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NetAppVolumeResource"/> using the GetNetAppVolumeQuotaRules method.
    /// </summary>
    public partial class NetAppVolumeQuotaRuleResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of NetAppVolumeQuotaRuleResource for mocking. </summary>
        protected NetAppVolumeQuotaRuleResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="NetAppVolumeQuotaRuleResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _volumeQuotaRulesClientDiagnostics.CreateScope("NetAppVolumeQuotaRuleResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<NetAppVolumeQuotaRuleResource>> UpdateAsync(WaitUntil waitUntil, NetAppVolumeQuotaRulePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _volumeQuotaRulesClientDiagnostics.CreateScope("NetAppVolumeQuotaRuleResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _volumeQuotaRulesClientDiagnostics.CreateScope("NetAppVolumeQuotaRuleResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Updates the NetAppVolumeQuotaRule.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/volumeQuotaRules/{volumeQuotaRuleName}. </description>
        ...
        public virtual async Task<ArmOperation<NetAppVolumeQuotaRuleResource>> UpdateAsync(WaitUntil waitUntil, NetAppVolumeQuotaRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _volumeQuotaRulesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, NetAppVolumeQuotaRuleData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetAppArmOperation<NetAppVolumeQuotaRuleResource> operation = new NetAppArmOperation<NetAppVolumeQuotaRuleResource>(
                    new NetAppVolumeQuotaRuleResourceOperationSource(Client),
                    _volumeQuotaRulesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetAppVolumeQuotaRuleResource> Update(WaitUntil waitUntil, NetAppVolumeQuotaRuleData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<NetAppVolumeQuotaRuleResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _volumeQuotaRulesClientDiagnostics.CreateScope("NetAppVolumeQuotaRuleResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    NetAppVolumeQuotaRuleData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    ArmOperation<NetAppVolumeQuotaRuleResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NetAppVolumeQuotaRuleResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    NetAppVolumeQuotaRuleData current = Get(cancellationToken: cancellationToken).Value.Data;
                    NetAppVolumeQuotaRulePatch patch = new NetAppVolumeQuotaRulePatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<NetAppVolumeQuotaRuleResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<NetAppVolumeQuotaRuleResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _volumeQuotaRulesClientDiagnostics.CreateScope("NetAppVolumeQuotaRuleResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<NetAppVolumeQuotaRuleResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _volumeQuotaRulesClientDiagnostics.CreateScope("NetAppVolumeQuotaRuleResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
