...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppVolumeQuotaRuleResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _netAppVolumeQuotaRuleVolumeQuotaRulesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = await _netAppVolumeQuotaRuleVolumeQuotaRulesRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new NetAppArmOperation(_netAppVolumeQuotaRuleVolumeQuotaRulesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _netAppVolumeQuotaRuleVolumeQuotaRulesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = _netAppVolumeQuotaRuleVolumeQuotaRulesRestClient.Delete(message, cancellationToken);
                var operation = new NetAppArmOperation(_netAppVolumeQuotaRuleVolumeQuotaRulesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<NetAppVolumeQuotaRuleResource>> UpdateAsync(WaitUntil waitUntil, NetAppVolumeQuotaRulePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _netAppVolumeQuotaRuleVolumeQuotaRulesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch);
                var response = await _netAppVolumeQuotaRuleVolumeQuotaRulesRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<NetAppVolumeQuotaRuleResource> Update(WaitUntil waitUntil, NetAppVolumeQuotaRulePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _netAppVolumeQuotaRuleVolumeQuotaRulesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch);
                var response = _netAppVolumeQuotaRuleVolumeQuotaRulesRestClient.Update(message, cancellationToken);
                var operation = new NetAppArmOperation<NetAppVolumeQuotaRuleResource>(new NetAppVolumeQuotaRuleOperationSource(Client), _netAppVolumeQuotaRuleVolumeQuotaRulesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
