...
namespace Azure.ResourceManager.NetApp.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class NetAppSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NetAppSubscriptionResourceExtension"/> class for mocking. </summary>
        protected NetAppSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetAppSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetAppSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<NetAppCheckAvailabilityResult>> CheckNetAppNameAvailabilityAsync(AzureLocation location, NetAppNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = NetAppResourceClientDiagnostics.CreateScope("NetAppSubscriptionResourceExtension.CheckNetAppNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<NetAppCheckAvailabilityResult>> CheckNetAppFilePathAvailabilityAsync(AzureLocation location, NetAppFilePathAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = NetAppResourceClientDiagnostics.CreateScope("NetAppSubscriptionResourceExtension.CheckNetAppFilePathAvailability");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<NetAppCheckAvailabilityResult>> CheckNetAppQuotaAvailabilityAsync(AzureLocation location, NetAppQuotaAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = NetAppResourceClientDiagnostics.CreateScope("NetAppSubscriptionResourceExtension.CheckNetAppQuotaAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = NetAppResourceClientDiagnostics.CreateScope("NetAppSubscriptionResourceExtension.QueryRegionInfoNetAppResource");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<NetAppSubscriptionQuotaItem> GetNetAppQuotaLimitsAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, NetAppSubscriptionQuotaItem.DeserializeNetAppSubscriptionQuotaItem, NetAppResourceQuotaLimitsClientDiagnostics, Pipeline, "NetAppSubscriptionResourceExtension.GetNetAppQuotaLimits", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetAppResourceQuotaLimitsRestClient.CreateListRequest(Id.SubscriptionId, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, NetAppSubscriptionQuotaItem.DeserializeNetAppSubscriptionQuotaItem, NetAppResourceQuotaLimitsClientDiagnostics, Pipeline, "NetAppSubscriptionResourceExtension.GetNetAppQuotaLimits", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<NetAppSubscriptionQuotaItem>> GetNetAppQuotaLimitAsync(AzureLocation location, string quotaLimitName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = NetAppResourceQuotaLimitsClientDiagnostics.CreateScope("NetAppSubscriptionResourceExtension.GetNetAppQuotaLimit");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<NetAppAccountResource> GetNetAppAccountsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NetAppAccountResource(Client, NetAppAccountData.DeserializeNetAppAccountData(e)), NetAppAccountAccountsClientDiagnostics, Pipeline, "NetAppSubscriptionResourceExtension.GetNetAppAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NetAppAccountResource> GetNetAppAccounts(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetAppAccountAccountsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NetAppAccountAccountsRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NetAppAccountResource(Client, NetAppAccountData.DeserializeNetAppAccountData(e)), NetAppAccountAccountsClientDiagnostics, Pipeline, "NetAppSubscriptionResourceExtension.GetNetAppAccounts", "value", "nextLink", cancellationToken);
        }
    }
}
