...
namespace Azure.ResourceManager.NetApp.Mocking
{
    ...
    internal partial class NetAppArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NetAppArmClientMockingExtension"/> class for mocking. </summary>
        protected NetAppArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetAppArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetAppArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal NetAppArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
