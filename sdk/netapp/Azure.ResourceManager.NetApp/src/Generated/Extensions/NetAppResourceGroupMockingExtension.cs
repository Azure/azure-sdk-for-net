...
namespace Azure.ResourceManager.NetApp.Mocking
{
    ...
    internal partial class NetAppResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NetAppResourceGroupMockingExtension"/> class for mocking. </summary>
        protected NetAppResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NetAppResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NetAppResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
