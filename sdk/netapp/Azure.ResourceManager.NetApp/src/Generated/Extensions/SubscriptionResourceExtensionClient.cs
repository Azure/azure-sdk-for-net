...
namespace Azure.ResourceManager.NetApp
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        public virtual SubscriptionQuotaItemCollection GetSubscriptionQuotaItems(string location)
        {
        ...
        public virtual async Task<Response<CheckAvailabilityResponse>> CheckNameAvailabilityNetAppResourceAsync(string location, ResourceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="content"> Name availability request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CheckAvailabilityResponse> CheckNameAvailabilityNetAppResource(string location, ResourceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            using var scope = NetAppResourceClientDiagnostics.CreateScope("SubscriptionResourceExtensionClient.CheckNameAvailabilityNetAppResource");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CheckAvailabilityResponse>> CheckFilePathAvailabilityNetAppResourceAsync(string location, FilePathAvailabilityContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="content"> File path availability request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CheckAvailabilityResponse> CheckFilePathAvailabilityNetAppResource(string location, FilePathAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            using var scope = NetAppResourceClientDiagnostics.CreateScope("SubscriptionResourceExtensionClient.CheckFilePathAvailabilityNetAppResource");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CheckAvailabilityResponse>> CheckQuotaAvailabilityNetAppResourceAsync(string location, QuotaAvailabilityContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="content"> Quota availability request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CheckAvailabilityResponse> CheckQuotaAvailabilityNetAppResource(string location, QuotaAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            using var scope = NetAppResourceClientDiagnostics.CreateScope("SubscriptionResourceExtensionClient.CheckQuotaAvailabilityNetAppResource");
            scope.Start();
            try
