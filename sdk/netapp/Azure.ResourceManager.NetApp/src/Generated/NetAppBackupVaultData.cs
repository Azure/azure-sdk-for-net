...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppBackupVaultData : TrackedResourceData
    {
        ...
        internal NetAppBackupVaultData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, BackupVaultProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
