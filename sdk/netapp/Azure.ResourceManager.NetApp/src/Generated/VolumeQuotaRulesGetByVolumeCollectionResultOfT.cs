...
namespace Azure.ResourceManager.NetApp
{
    internal partial class VolumeQuotaRulesGetByVolumeCollectionResultOfT : Pageable<VolumeQuotaRuleData>
    {
        ...
        /// <summary> Initializes a new instance of VolumeQuotaRulesGetByVolumeCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The VolumeQuotaRules client used to send requests. </param>
        ...
        public VolumeQuotaRulesGetByVolumeCollectionResultOfT(VolumeQuotaRules client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, string volumeName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of VolumeQuotaRulesGetByVolumeCollectionResultOfT as an enumerable collection. </summary>
