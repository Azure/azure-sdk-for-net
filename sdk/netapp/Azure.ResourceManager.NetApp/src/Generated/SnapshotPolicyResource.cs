...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class SnapshotPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SnapshotPolicyResource>> UpdateAsync(WaitUntil waitUntil, SnapshotPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _snapshotPoliciesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, SnapshotPolicyData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<SnapshotPolicyData> response = Response.FromValue(SnapshotPolicyData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SnapshotPolicyResource> Update(WaitUntil waitUntil, SnapshotPolicyData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
