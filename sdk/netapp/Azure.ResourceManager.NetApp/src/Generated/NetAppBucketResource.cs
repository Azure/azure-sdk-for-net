...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppBucketResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<NetAppBucketResource>> UpdateAsync(WaitUntil waitUntil, NetAppBucketData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _bucketsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, NetAppBucketData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                NetAppArmOperation<NetAppBucketResource> operation = new NetAppArmOperation<NetAppBucketResource>(
                    new NetAppBucketResourceOperationSource(Client),
                    _bucketsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<NetAppBucketResource> Update(WaitUntil waitUntil, NetAppBucketData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
