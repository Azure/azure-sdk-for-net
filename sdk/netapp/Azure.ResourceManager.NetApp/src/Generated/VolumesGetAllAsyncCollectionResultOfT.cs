...
namespace Azure.ResourceManager.NetApp
{
    internal partial class VolumesGetAllAsyncCollectionResultOfT : AsyncPageable<VolumeData>
    {
        ...
        /// <summary> Initializes a new instance of VolumesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public VolumesGetAllAsyncCollectionResultOfT(Volumes client, Guid subscriptionId, string resourceGroupName, string accountName, string poolName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of VolumesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
