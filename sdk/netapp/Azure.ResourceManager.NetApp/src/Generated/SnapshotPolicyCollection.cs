...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class SnapshotPolicyCollection : ArmCollection, IEnumerable<SnapshotPolicyResource>, IAsyncEnumerable<SnapshotPolicyResource>
    {
        ...
        internal SnapshotPolicyCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _snapshotPoliciesRestClient = new SnapshotPolicies(_snapshotPoliciesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, snapshotPolicyApiVersion ?? "2026-06-15-preview");
        ...
        public virtual AsyncPageable<SnapshotPolicyResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SnapshotPolicyData, SnapshotPolicyResource>(new SnapshotPoliciesGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SnapshotPolicyCollection.GetAll"), data => new SnapshotPolicyResource(Client, data));
        }
