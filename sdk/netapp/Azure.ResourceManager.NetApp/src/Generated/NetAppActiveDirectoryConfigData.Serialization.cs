...
{
    public partial class NetAppActiveDirectoryConfigData : IUtf8JsonSerializable, IJsonModel<NetAppActiveDirectoryConfigData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetAppActiveDirectoryConfigData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetAppActiveDirectoryConfigData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NetAppActiveDirectoryConfigData DeserializeNetAppActiveDirectoryConfigData(JsonElement element, ModelReaderWriterOptions options = null)
        {
