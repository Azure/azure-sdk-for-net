...
{
    /// <summary></summary>
    internal partial class CapacityPoolResourceOperationSource : IOperationSource<CapacityPoolResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CapacityPoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
