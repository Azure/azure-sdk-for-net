...
{
    /// <summary></summary>
    internal partial class NetAppVolumeSnapshotResourceOperationSource : IOperationSource<NetAppVolumeSnapshotResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetAppVolumeSnapshotResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
