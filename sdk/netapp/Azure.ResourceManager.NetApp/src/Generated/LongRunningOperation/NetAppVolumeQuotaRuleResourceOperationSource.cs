...
{
    /// <summary></summary>
    internal partial class NetAppVolumeQuotaRuleResourceOperationSource : IOperationSource<NetAppVolumeQuotaRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetAppVolumeQuotaRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
