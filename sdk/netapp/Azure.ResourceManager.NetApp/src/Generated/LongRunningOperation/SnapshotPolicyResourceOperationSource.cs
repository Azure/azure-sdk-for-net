...
{
    /// <summary></summary>
    internal partial class SnapshotPolicyResourceOperationSource : IOperationSource<SnapshotPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SnapshotPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
