...
{
    /// <summary></summary>
    internal partial class NetAppVolumeResourceOperationSource : IOperationSource<NetAppVolumeResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetAppVolumeResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
