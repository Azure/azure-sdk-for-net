...
{
    /// <summary></summary>
    internal partial class NetAppElasticBackupResourceOperationSource : IOperationSource<NetAppElasticBackupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetAppElasticBackupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
