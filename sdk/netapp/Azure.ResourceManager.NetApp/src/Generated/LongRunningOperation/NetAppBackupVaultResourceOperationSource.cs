...
{
    /// <summary></summary>
    internal partial class NetAppBackupVaultResourceOperationSource : IOperationSource<NetAppBackupVaultResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetAppBackupVaultResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
