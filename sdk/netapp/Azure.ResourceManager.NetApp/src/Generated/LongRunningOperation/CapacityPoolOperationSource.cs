...
{
    /// <summary></summary>
    internal partial class CapacityPoolOperationSource : IOperationSource<CapacityPoolResource>
    {
        ...
        CapacityPoolResource IOperationSource<CapacityPoolResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CapacityPoolData data = CapacityPoolData.DeserializeCapacityPoolData(document.RootElement, ModelSerializationExtensions.WireOptions);
