...
{
    /// <summary></summary>
    internal partial class NetAppElasticVolumeResourceOperationSource : IOperationSource<NetAppElasticVolumeResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetAppElasticVolumeResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
