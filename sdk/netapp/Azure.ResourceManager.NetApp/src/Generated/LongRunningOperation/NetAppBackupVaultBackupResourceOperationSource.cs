...
{
    /// <summary></summary>
    internal partial class NetAppBackupVaultBackupResourceOperationSource : IOperationSource<NetAppBackupVaultBackupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetAppBackupVaultBackupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
