...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public static partial class ArmNetAppModelFactory
    {
        ...
        public static GetGroupIdListForLdapUserResponse GetGroupIdListForLdapUserResponse(IEnumerable<string> groupIdsForLdapUser = null)
        {
            groupIdsForLdapUser ??= new List<string>();

            return new GetGroupIdListForLdapUserResponse(groupIdsForLdapUser?.ToList());
        }
