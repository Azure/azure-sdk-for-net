...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppElasticSnapshotPolicyData : TrackedResourceData, IJsonModel<NetAppElasticSnapshotPolicyData>
    {
        ...
        {
            if (netAppElasticSnapshotPolicyData == null)
            {
                return null;
            }
            return RequestContent.Create(netAppElasticSnapshotPolicyData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="NetAppElasticSnapshotPolicyData"/> from. </param>
        internal static NetAppElasticSnapshotPolicyData FromResponse(Response response)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NetAppElasticSnapshotPolicyData DeserializeNetAppElasticSnapshotPolicyData(JsonElement element, ModelReaderWriterOptions options)
        {
