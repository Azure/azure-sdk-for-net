    ...
    public partial class NetAppVolumeBackupResource : NetAppBackupResource
    {
        ...
        protected override async Task<Response<NetAppBackupResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((NetAppBackupResource)new NetAppVolumeBackupResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<NetAppVolumeBackupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<NetAppVolumeBackupResource> Get(CancellationToken cancellationToken = default)
        {
