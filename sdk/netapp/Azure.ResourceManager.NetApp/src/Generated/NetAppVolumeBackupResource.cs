...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppVolumeBackupResource : ArmResource
    {
        ...
        internal NetAppVolumeBackupResource(ArmClient client, NetAppBackupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NetAppVolumeBackupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new NetAppVolumeBackupResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
