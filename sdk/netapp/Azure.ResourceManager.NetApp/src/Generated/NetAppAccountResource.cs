...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class NetAppAccountResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of VolumeGroupDetailsResources in the NetAppAccount. </summary>
        /// <returns> An object representing collection of VolumeGroupDetailsResources and their operations over a VolumeGroupDetailsResource. </returns>
        ...
        public virtual AsyncPageable<VolumeGroup> GetVolumeGroupsByNetAppAccountAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _volumeGroupDetailsVolumeGroupsClientDiagnostics.CreateScope("NetAppAccountResource.GetVolumeGroupsByNetAppAccount");
                scope.Start();
                try
                {
                    var response = await _volumeGroupDetailsVolumeGroupsRestClient.ListByNetAppAccountAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<VolumeGroup> GetVolumeGroupsByNetAppAccount(CancellationToken cancellationToken = default)
        {
            Page<VolumeGroup> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _volumeGroupDetailsVolumeGroupsRestClient.ListByNetAppAccount(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
