...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class RansomwareReportData : ResourceData
    {
        ...
        internal RansomwareReportData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RansomwareReportProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
