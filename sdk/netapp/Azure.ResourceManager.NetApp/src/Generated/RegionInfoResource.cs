...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class RegionInfoResource : ArmResource
    {
        ...
        internal RegionInfoResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _netAppResourceRegionInfosRestClient = new NetAppResourceRegionInfos(_netAppResourceRegionInfosClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, regionInfoResourceApiVersion ?? "2026-05-01");
