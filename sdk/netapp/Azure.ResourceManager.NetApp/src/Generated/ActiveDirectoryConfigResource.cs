...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class ActiveDirectoryConfigResource : ArmResource
    {
        ...
        internal ActiveDirectoryConfigResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _activeDirectoryConfigsRestClient = new ActiveDirectoryConfigs(_activeDirectoryConfigsClientDiagnostics, Pipeline, Endpoint, activeDirectoryConfigApiVersion ?? "2025-12-15-preview");
        ...
        public virtual async Task<Response<ActiveDirectoryConfigResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<ActiveDirectoryConfigResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ActiveDirectoryConfigResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<ActiveDirectoryConfigResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
