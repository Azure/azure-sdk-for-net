...
namespace Azure.ResourceManager.NetApp
{
    internal partial class NetAppSubscriptionQuotaItems
    {
        ...
        internal NetAppSubscriptionQuotaItems(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(NetAppSubscriptionQuotaItems).Assembly, applicationId);
        }
