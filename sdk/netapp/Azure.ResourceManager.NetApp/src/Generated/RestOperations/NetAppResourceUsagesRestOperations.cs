...
namespace Azure.ResourceManager.NetApp
{
    internal partial class NetAppResourceUsages
    {
        ...
        internal NetAppResourceUsages(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(NetAppResourceUsages).Assembly, applicationId);
        }
