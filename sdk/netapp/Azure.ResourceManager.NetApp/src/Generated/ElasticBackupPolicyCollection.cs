...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class ElasticBackupPolicyCollection : ArmCollection, IEnumerable<ElasticBackupPolicyResource>, IAsyncEnumerable<ElasticBackupPolicyResource>
    {
        ...
        internal ElasticBackupPolicyCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _elasticBackupPoliciesRestClient = new ElasticBackupPolicies(_elasticBackupPoliciesClientDiagnostics, Pipeline, Endpoint, elasticBackupPolicyApiVersion ?? "2025-12-15-preview");
        ...
        public virtual AsyncPageable<ElasticBackupPolicyResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ElasticBackupPolicyData, ElasticBackupPolicyResource>(new ElasticBackupPoliciesGetByElasticAccountAsyncCollectionResultOfT(
                _elasticBackupPoliciesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "ElasticBackupPolicyCollection.GetAll"), data => new ElasticBackupPolicyResource(Client, data));
        }
        ...
        public virtual Pageable<ElasticBackupPolicyResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ElasticBackupPolicyData, ElasticBackupPolicyResource>(new ElasticBackupPoliciesGetByElasticAccountCollectionResultOfT(
                _elasticBackupPoliciesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
