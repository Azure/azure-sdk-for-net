...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class BackupData : ResourceData
    {
        ...
        internal BackupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation location, string backupId, DateTimeOffset? createdOn, string provisioningState, long? size, string label, BackupType? backupType, string failureReason, string volumeName, bool? useExistingSnapshot) : base(id, name, resourceType, systemData)
        {
            Location = location;
            BackupId = backupId;
            CreatedOn = createdOn;
