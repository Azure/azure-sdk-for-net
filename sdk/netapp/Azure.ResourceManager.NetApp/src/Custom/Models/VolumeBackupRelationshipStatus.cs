...
// Backward-compat: VolumeBackupRelationshipStatus was previously a separate generated type.
// With unified NetAppRelationshipStatus, this is now a custom shim type.
...
{
    /// <summary> Backup SnapMirror relationship status. </summary>
    public readonly partial struct VolumeBackupRelationshipStatus : IEquatable<VolumeBackupRelationshipStatus>
    {
        ...
        public VolumeBackupRelationshipStatus(string value) => _value = value ?? throw new ArgumentNullException(nameof(value));
