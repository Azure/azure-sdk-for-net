...
{
    // The spec now maps NetAppProvisioningState to the extensible union used by
    // current properties. Keep this v1.15 quota-rule state type for source
    // compatibility with older ModelFactory overloads.
