...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    // The TypeSpec generator emits it as `CacheUpdateProperties` (synthesized by the
    ...
    // generated `CacheUpdateProperties` directly, and the test compatibility layer
    ...
    public partial class NetAppCachePatchProperties : IJsonModel<NetAppCachePatchProperties>, IPersistableModel<NetAppCachePatchProperties>
    {
        NetAppCachePatchProperties IJsonModel<NetAppCachePatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        void IJsonModel<NetAppCachePatchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        NetAppCachePatchProperties IPersistableModel<NetAppCachePatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        string IPersistableModel<NetAppCachePatchProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        BinaryData IPersistableModel<NetAppCachePatchProperties>.Write(ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
    }
}
