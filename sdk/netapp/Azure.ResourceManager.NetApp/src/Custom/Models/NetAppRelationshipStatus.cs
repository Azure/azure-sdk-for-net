...
namespace Azure.ResourceManager.NetApp.Models
{
    ...
    public readonly partial struct NetAppRelationshipStatus
    {
        private readonly string _value;

        /// <summary> Initializes a new instance of <see cref="NetAppRelationshipStatus"/>. </summary>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        public NetAppRelationshipStatus(string value) => _value = value ?? throw new ArgumentNullException(nameof(value));
