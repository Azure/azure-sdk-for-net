...
{
    // Backward compatibility: the v1.15.0 SDK exposed this type as `NetAppElasticCapacityPoolPatchProperties`.
    // The TypeSpec generator emits it as `ElasticCapacityPoolUpdateProperties` (synthesized by the
    ...
    // generated `ElasticCapacityPoolUpdateProperties` directly, and the test compatibility layer
    ...
    {
        NetAppElasticCapacityPoolPatchProperties IJsonModel<NetAppElasticCapacityPoolPatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        void IJsonModel<NetAppElasticCapacityPoolPatchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        NetAppElasticCapacityPoolPatchProperties IPersistableModel<NetAppElasticCapacityPoolPatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        ...
        BinaryData IPersistableModel<NetAppElasticCapacityPoolPatchProperties>.Write(ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
    }
}
