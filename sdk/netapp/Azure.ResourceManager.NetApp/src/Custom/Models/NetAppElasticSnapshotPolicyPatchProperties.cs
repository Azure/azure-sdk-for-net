...
{
    // Backward compatibility: the v1.15.0 SDK exposed this type as `NetAppElasticSnapshotPolicyPatchProperties`.
    // The TypeSpec generator emits it as `ElasticSnapshotPolicyUpdateProperties` (synthesized by the
    ...
    // generated `ElasticSnapshotPolicyUpdateProperties` directly, and the test compatibility layer
    ...
    [CodeGenType("ElasticSnapshotPolicyUpdateProperties")]
    ...
    {
        NetAppElasticSnapshotPolicyPatchProperties IJsonModel<NetAppElasticSnapshotPolicyPatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        void IJsonModel<NetAppElasticSnapshotPolicyPatchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        NetAppElasticSnapshotPolicyPatchProperties IPersistableModel<NetAppElasticSnapshotPolicyPatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
        ...
        BinaryData IPersistableModel<NetAppElasticSnapshotPolicyPatchProperties>.Write(ModelReaderWriterOptions options) => throw new NotSupportedException("Deprecated type.");
    }
}
