...
{
    // RegionInfoResource is generated as a singleton child of SubscriptionLocationResource.
    // That shape produces direct `GetRegionInfoResource` accessors instead of a collection.
    // Keep this GA collection type only as a compatibility shim for old source references;
    // every member throws with guidance to use the singleton resource accessors.
