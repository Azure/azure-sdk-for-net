...
namespace Azure.ResourceManager.Hybridcloud
{
    ...
    internal partial class ResourceGroupResourceExtensionClient : ArmResource
    {
        ...
        public virtual CloudConnectorCollection GetCloudConnectors()
        {
            return GetCachedClient(Client => new CloudConnectorCollection(Client, Id));
        }
        ...
        public virtual CloudConnectionCollection GetCloudConnections()
        {
            return GetCachedClient(Client => new CloudConnectionCollection(Client, Id));
        }
    }
}
