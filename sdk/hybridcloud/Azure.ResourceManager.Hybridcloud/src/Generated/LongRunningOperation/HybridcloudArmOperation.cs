...
#pragma warning disable SA1649 // File name should match first type name
    internal class HybridcloudArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal HybridcloudArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal HybridcloudArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "HybridcloudArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
