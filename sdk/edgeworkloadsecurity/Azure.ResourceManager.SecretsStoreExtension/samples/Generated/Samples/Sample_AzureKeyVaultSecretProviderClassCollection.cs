...
{
    public partial class Sample_AzureKeyVaultSecretProviderClassCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_AzureKeyVaultSecretProviderClassesCreateOrUpdate()
        {
            ...
            // get the collection of this AzureKeyVaultSecretProviderClassResource
            ...
            AzureKeyVaultSecretProviderClassData data = new AzureKeyVaultSecretProviderClassData(new AzureLocation("eastus"))
            {
                Properties = new AzureKeyVaultSecretProviderClassProperties("example-ssc-key-vault", "00000000-0000-0000-0000-000000000000", "00000000-0000-0000-0000-000000000000")
                {
...
["example-tag"] = "example-tag-value"
            ...
            ArmOperation<AzureKeyVaultSecretProviderClassResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, azureKeyVaultSecretProviderClassName, data);
        ...
        public async Task Get_AzureKeyVaultSecretProviderClassesGet()
        {
            ...
            // invoke the operation
            string azureKeyVaultSecretProviderClassName = "akvspc-ssc-example";
            AzureKeyVaultSecretProviderClassResource result = await collection.GetAsync(azureKeyVaultSecretProviderClassName);
        ...
        public async Task GetAll_AzureKeyVaultSecretProviderClassesListByResourceGroup()
        {
            ...
            await foreach (AzureKeyVaultSecretProviderClassResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_AzureKeyVaultSecretProviderClassesGet()
        {
            ...
            // invoke the operation
            string azureKeyVaultSecretProviderClassName = "akvspc-ssc-example";
            NullableResponse<AzureKeyVaultSecretProviderClassResource> response = await collection.GetIfExistsAsync(azureKeyVaultSecretProviderClassName);
            AzureKeyVaultSecretProviderClassResource result = response.HasValue ? response.Value : null;
