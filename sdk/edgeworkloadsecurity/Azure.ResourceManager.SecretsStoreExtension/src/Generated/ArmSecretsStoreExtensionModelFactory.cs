...
namespace Azure.ResourceManager.SecretsStoreExtension.Models
{
    ...
    public static partial class ArmSecretsStoreExtensionModelFactory
    {
        ...
        public static SecretSyncCondition SecretSyncCondition(DateTimeOffset? lastTransitionOn = null, string message = null, long? observedGeneration = null, string reason = null, StatusConditionType status = default, string type = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="SecretsStoreExtension.AzureKeyVaultSecretProviderClassData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <param name="properties"> The resource-specific properties for this resource. </param>
        /// <param name="extendedLocation"></param>
        /// <returns> A new <see cref="SecretsStoreExtension.AzureKeyVaultSecretProviderClassData"/> instance for mocking. </returns>
        public static AzureKeyVaultSecretProviderClassData AzureKeyVaultSecretProviderClassData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AzureKeyVaultSecretProviderClassProperties properties = null, ExtendedLocation extendedLocation = null)
        {
            tags ??= new Dictionary<string, string>();

            return new AzureKeyVaultSecretProviderClassData(
                id,
                name,
                resourceType,
                systemData,
        ...
        /// <summary> Initializes a new instance of <see cref="Models.AzureKeyVaultSecretProviderClassProperties"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.AzureKeyVaultSecretProviderClassProperties"/> instance for mocking. </returns>
        public static AzureKeyVaultSecretProviderClassProperties AzureKeyVaultSecretProviderClassProperties(string keyvaultName = null, string clientId = null, string tenantId = null, string objects = null, ProvisioningState? provisioningState = null)
        {
            return new AzureKeyVaultSecretProviderClassProperties(
                keyvaultName,
                clientId,
                tenantId,
                objects,
