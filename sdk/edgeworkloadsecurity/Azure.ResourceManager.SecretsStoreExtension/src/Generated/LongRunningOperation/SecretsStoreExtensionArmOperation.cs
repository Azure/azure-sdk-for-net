...
#pragma warning disable SA1649 // File name should match first type name
    internal class SecretsStoreExtensionArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of SecretsStoreExtensionArmOperation for mocking. </summary>
        protected SecretsStoreExtensionArmOperation()
        {
        }

        internal SecretsStoreExtensionArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SecretsStoreExtensionArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SecretsStoreExtensionArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
