...
namespace Azure.ResourceManager.SecretsStoreExtension.Models
{
    ...
    public partial class SecretSyncCondition
    {
        ...
        internal SecretSyncCondition(string message, string reason, StatusConditionType status, string type)
        {
            Message = message;
            Reason = reason;
            Status = status;
        ...
        internal SecretSyncCondition(DateTimeOffset? lastTransitionOn, string message, long? observedGeneration, string reason, StatusConditionType status, string type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public StatusConditionType Status { get; }
