...
namespace Azure.ResourceManager.SecretsStoreExtension.Models
{
    ...
    public partial class AzureKeyVaultSecretProviderClassProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureKeyVaultSecretProviderClassProperties"/>. </summary>
        ...
        internal AzureKeyVaultSecretProviderClassProperties(string keyvaultName, string clientId, string tenantId, string objects, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyvaultName = keyvaultName;
            ClientId = clientId;
            TenantId = tenantId;
        ...
        /// <summary> Initializes a new instance of <see cref="AzureKeyVaultSecretProviderClassProperties"/> for deserialization. </summary>
        internal AzureKeyVaultSecretProviderClassProperties()
        {
        }
