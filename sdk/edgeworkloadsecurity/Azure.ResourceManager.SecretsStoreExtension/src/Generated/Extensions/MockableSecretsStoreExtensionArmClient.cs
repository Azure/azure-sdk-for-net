...
namespace Azure.ResourceManager.SecretsStoreExtension.Mocking
{
    ...
    public partial class MockableSecretsStoreExtensionArmClient : ArmResource
    {
        ...
        public virtual AzureKeyVaultSecretProviderClassResource GetAzureKeyVaultSecretProviderClassResource(ResourceIdentifier id)
        {
            AzureKeyVaultSecretProviderClassResource.ValidateResourceId(id);
            return new AzureKeyVaultSecretProviderClassResource(Client, id);
        }
