...
{
    public partial class Sample_ArtifactSigningAccountCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CreateAArtifactSigningAccount()
        {
            ...
            // get the collection of this ArtifactSigningAccountResource
            ArtifactSigningAccountCollection collection = resourceGroupResource.GetArtifactSigningAccounts();

            // invoke the operation
            string accountName = "MyAccount";
            ArtifactSigningAccountData data = new ArtifactSigningAccountData(new AzureLocation("westus"));
            ArmOperation<ArtifactSigningAccountResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, accountName, data);
        ...
        public async Task Get_GetAArtifactSigningAccount()
        {
            ...
            // invoke the operation
            string accountName = "MyAccount";
            ArtifactSigningAccountResource result = await collection.GetAsync(accountName);
        ...
        public async Task GetIfExists_GetAArtifactSigningAccount()
        {
            ...
            ArtifactSigningAccountResource result = response.HasValue ? response.Value : null;
