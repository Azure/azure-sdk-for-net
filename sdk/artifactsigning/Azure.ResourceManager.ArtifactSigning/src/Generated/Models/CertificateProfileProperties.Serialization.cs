    ...
    internal partial class CertificateProfileProperties : IJsonModel<CertificateProfileProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Certificates))
            {
                ...
                foreach (ArtifactSigningCertificate item in Certificates)
                {
        ...
        internal static CertificateProfileProperties DeserializeCertificateProfileProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new ArtifactSigningProvisioningState(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("certificates"u8))
                {
                    ...
                    List<ArtifactSigningCertificate> array = new List<ArtifactSigningCertificate>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(ArtifactSigningCertificate.DeserializeArtifactSigningCertificate(item, options));
                    }
                    certificates = array;
                    continue;
                }
