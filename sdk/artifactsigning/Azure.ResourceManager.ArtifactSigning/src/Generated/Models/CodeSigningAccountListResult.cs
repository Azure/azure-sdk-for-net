...
namespace Azure.ResourceManager.ArtifactSigning.Models
{
    ...
    internal partial class CodeSigningAccountListResult
    {
        ...
        internal CodeSigningAccountListResult(IEnumerable<ArtifactSigningAccountData> value)
        {
            Value = value.ToList();
        }
        ...
        internal CodeSigningAccountListResult(IList<ArtifactSigningAccountData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ArtifactSigningAccountData> Value { get; }
