...
namespace Azure.ResourceManager.ArtifactSigning.Models
{
    ...
    public partial class ArtifactSigningCertificate
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ArtifactSigningCertificate"/>. </summary>
        ...
        internal ArtifactSigningCertificate(string serialNumber, string enhancedKeyUsage, string subjectName, string thumbprint, DateTimeOffset? createOn, DateTimeOffset? expireOn, ArtifactSigningCertificateStatus? status, Revocation revocation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public ArtifactSigningCertificateStatus? Status { get; }
