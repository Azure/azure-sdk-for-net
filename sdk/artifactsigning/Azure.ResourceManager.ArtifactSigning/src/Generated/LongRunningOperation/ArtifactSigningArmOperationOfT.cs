...
{
    internal partial class ArtifactSigningArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ArtifactSigningArmOperation for mocking. </summary>
        protected ArtifactSigningArmOperation()
        {
        }
        ...
        internal ArtifactSigningArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ArtifactSigningArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
