...
{
    /// <summary>
    /// A class representing a ArtifactSigningCertificateProfile along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ArtifactSigningCertificateProfileResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ArtifactSigningAccountResource"/> using the GetArtifactSigningCertificateProfiles method.
    /// </summary>
    public partial class ArtifactSigningCertificateProfileResource : ArmResource
    {
        ...
        private readonly ArtifactSigningCertificateProfileData _data;
        ...
        /// <summary> Initializes a new instance of ArtifactSigningCertificateProfileResource for mocking. </summary>
        protected ArtifactSigningCertificateProfileResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ArtifactSigningCertificateProfileResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal ArtifactSigningCertificateProfileResource(ArmClient client, ArtifactSigningCertificateProfileData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ArtifactSigningCertificateProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual ArtifactSigningCertificateProfileData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="ArtifactSigningCertificateProfileResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ArtifactSigningCertificateProfileResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _certificateProfilesClientDiagnostics.CreateScope("ArtifactSigningCertificateProfileResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ArtifactSigningCertificateProfileResource> Get(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _certificateProfilesClientDiagnostics.CreateScope("ArtifactSigningCertificateProfileResource.Get");
            scope.Start();
            try
        ...
        {
            using DiagnosticScope scope = _certificateProfilesClientDiagnostics.CreateScope("ArtifactSigningCertificateProfileResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                ArtifactSigningArmOperation operation = new ArtifactSigningArmOperation(_certificateProfilesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary>
        /// Update a ArtifactSigningCertificateProfile.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CodeSigning/codeSigningAccounts/{accountName}/certificateProfiles/{profileName}. </description>
        ...
        public virtual async Task<ArmOperation<ArtifactSigningCertificateProfileResource>> UpdateAsync(WaitUntil waitUntil, ArtifactSigningCertificateProfileData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _certificateProfilesClientDiagnostics.CreateScope("ArtifactSigningCertificateProfileResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _certificateProfilesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ArtifactSigningCertificateProfileData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ArtifactSigningCertificateProfileResource> Update(WaitUntil waitUntil, ArtifactSigningCertificateProfileData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
