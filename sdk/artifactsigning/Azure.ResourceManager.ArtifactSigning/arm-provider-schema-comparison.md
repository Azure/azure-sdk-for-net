# ARM provider schema comparison: Azure.ResourceManager.ArtifactSigning
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CodeSigning/codeSigningAccounts/{accountName}` | `ArtifactSigningAccount` | `CodeSigningAccount` |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CodeSigning/codeSigningAccounts/{accountName}/certificateProfiles/{profileName}` | `ArtifactSigningCertificateProfile` | `CertificateProfile` |
