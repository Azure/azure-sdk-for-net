...
namespace Azure.Provisioning.ServiceFabric
{
    ...
    public partial class Cluster : ProvisionableResource
    {
        ...
        /// <summary> Creates a new Cluster. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public Cluster(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ServiceFabric/clusters", resourceVersion ?? "2026-03-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Cluster. </summary>
        ...
        /// <summary> Creates a reference to an existing Cluster. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Cluster FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Cluster result = new Cluster(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Cluster that are not part of the generated code. </summary>
