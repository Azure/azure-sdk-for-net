...
namespace Microsoft.Azure.Management.ServiceFabricMesh
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<ServiceFabricMeshManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(ServiceFabricMeshManagementClient client)
        {
            if (client == null)
            {
