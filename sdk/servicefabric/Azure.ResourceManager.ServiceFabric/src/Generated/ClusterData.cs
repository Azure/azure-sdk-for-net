...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    public partial class ClusterData : TrackedResourceData
    {
        ...
        internal ClusterData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, ClusterProperties properties, string eTag) : base(id, name, resourceType, systemData, tags, location)
        {
