...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ClusterResource" /> using the GetApplicationTypeResource method.
    /// </summary>
    public partial class ApplicationTypeResource : ArmResource
    {
        ...
        {
            _applicationTypeResourceApplicationTypesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceFabric", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceFabricArmOperation(_applicationTypeResourceApplicationTypesClientDiagnostics, Pipeline, _applicationTypeResourceApplicationTypesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<ApplicationTypeResource>> UpdateAsync(WaitUntil waitUntil, ApplicationTypeResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _applicationTypeResourceApplicationTypesRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ApplicationTypeResource> Update(WaitUntil waitUntil, ApplicationTypeResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _applicationTypeResourceApplicationTypesRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new ServiceFabricArmOperation<ApplicationTypeResource>(Response.FromValue(new ApplicationTypeResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
