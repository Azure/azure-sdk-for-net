...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterEndpointRangeDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterEndpointRangeDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterEndpointRangeDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ClusterEndpointRangeDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
