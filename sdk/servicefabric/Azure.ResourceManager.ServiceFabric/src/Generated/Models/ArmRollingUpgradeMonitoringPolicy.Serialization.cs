...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmRollingUpgradeMonitoringPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmRollingUpgradeMonitoringPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmRollingUpgradeMonitoringPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmRollingUpgradeMonitoringPolicy>)} interface");
            }
        ...
        string IPersistableModel<ArmRollingUpgradeMonitoringPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
