...
{
    public partial class ArmRollingUpgradeMonitoringPolicy : IUtf8JsonSerializable, IJsonModel<ArmRollingUpgradeMonitoringPolicy>, IPersistableModel<ArmRollingUpgradeMonitoringPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HealthCheckWaitDuration))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(HealthCheckWaitDuration.Value);
            ...
            if (Optional.IsDefined(HealthCheckStableDuration))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(HealthCheckStableDuration.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
            ...
            if (Optional.IsDefined(HealthCheckRetryTimeout))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(HealthCheckRetryTimeout.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
            ...
            if (Optional.IsDefined(UpgradeTimeout))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(UpgradeTimeout.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
            ...
            if (Optional.IsDefined(UpgradeDomainTimeout))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(UpgradeDomainTimeout.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
