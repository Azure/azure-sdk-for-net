...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class UniformInt64RangePartitionSchemeDescription : PartitionSchemeDescription
    {
        ...
        internal UniformInt64RangePartitionSchemeDescription(ApplicationPartitionScheme partitionScheme, int count, string lowKey, string highKey, Dictionary<string, BinaryData> rawData) : base(partitionScheme, rawData)
        {
            Count = count;
            LowKey = lowKey;
            HighKey = highKey;
