...
{
    public partial class ApplicationDeltaHealthPolicy : IUtf8JsonSerializable, IJsonModel<ApplicationDeltaHealthPolicy>, IPersistableModel<ApplicationDeltaHealthPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultServiceTypeDeltaHealthPolicy))
            {
                builder.Append("  defaultServiceTypeDeltaHealthPolicy:");
                AppendChildObject(builder, DefaultServiceTypeDeltaHealthPolicy, options, 2);
            }

            if (Optional.IsCollectionDefined(ServiceTypeDeltaHealthPolicies))
            {
                builder.Append("  serviceTypeDeltaHealthPolicies:");
                builder.AppendLine(" {");
                foreach (var item in ServiceTypeDeltaHealthPolicies)
                {
