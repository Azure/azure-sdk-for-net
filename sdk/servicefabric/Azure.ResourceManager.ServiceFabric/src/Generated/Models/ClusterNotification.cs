...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class ClusterNotification
    {
        ...
        internal ClusterNotification(bool isEnabled, ClusterNotificationCategory notificationCategory, ClusterNotificationLevel notificationLevel, IList<ClusterNotificationTarget> notificationTargets, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            IsEnabled = isEnabled;
            NotificationCategory = notificationCategory;
            NotificationLevel = notificationLevel;
