...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricServicePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceFabricServicePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricServicePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricServicePatch>)} interface");
            }
        ...
        string IPersistableModel<ServiceFabricServicePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
