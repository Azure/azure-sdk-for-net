...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class ClusterCodeVersionsResult : ResourceData
    {
        ...
        internal ClusterCodeVersionsResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string codeVersion, DateTimeOffset? supportExpireOn, ClusterEnvironment? environment, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
