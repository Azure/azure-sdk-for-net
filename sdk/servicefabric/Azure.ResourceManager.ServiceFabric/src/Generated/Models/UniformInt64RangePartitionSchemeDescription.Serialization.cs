...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class UniformInt64RangePartitionSchemeDescription : PartitionSchemeDescription, IJsonModel<UniformInt64RangePartitionSchemeDescription>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UniformInt64RangePartitionSchemeDescription>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UniformInt64RangePartitionSchemeDescription>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        UniformInt64RangePartitionSchemeDescription IPersistableModel<UniformInt64RangePartitionSchemeDescription>.Create(BinaryData data, ModelReaderWriterOptions options) => (UniformInt64RangePartitionSchemeDescription)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        UniformInt64RangePartitionSchemeDescription IJsonModel<UniformInt64RangePartitionSchemeDescription>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UniformInt64RangePartitionSchemeDescription)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UniformInt64RangePartitionSchemeDescription DeserializeUniformInt64RangePartitionSchemeDescription(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    lowKey = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("highKey"u8))
                {
                    highKey = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new UniformInt64RangePartitionSchemeDescription(partitionScheme, additionalBinaryDataProperties, count, lowKey, highKey);
        }
    }
}
