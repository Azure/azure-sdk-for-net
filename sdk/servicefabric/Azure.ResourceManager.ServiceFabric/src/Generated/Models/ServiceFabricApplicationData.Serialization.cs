...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricApplicationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceFabricApplicationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricApplicationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricApplicationData>)} interface");
            }
        ...
        string IPersistableModel<ServiceFabricApplicationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
