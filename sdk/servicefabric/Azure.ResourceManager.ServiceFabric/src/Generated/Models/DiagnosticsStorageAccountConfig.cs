...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class DiagnosticsStorageAccountConfig
    {
        ...
        internal DiagnosticsStorageAccountConfig(string storageAccountName, string protectedAccountKeyName, string protectedAccountKeyName2, Uri blobEndpoint, Uri queueEndpoint, Uri tableEndpoint, Dictionary<string, BinaryData> rawData)
        {
            StorageAccountName = storageAccountName;
            ProtectedAccountKeyName = protectedAccountKeyName;
