...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class StatelessServiceProperties : ServiceResourceProperties, IJsonModel<StatelessServiceProperties>
    {
        ...
        internal static StatelessServiceProperties DeserializeStatelessServiceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            BinaryData minInstancePercentage = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("minInstancePercentage"u8))
                {
                    ...
                    minInstancePercentage = BinaryData.FromBytes(prop.Value.GetBytesFromBase64("D"));
                    continue;
                }
                if (options.Format != "W")
                {
