...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        internal static ClusterCodeVersionsResult DeserializeClusterCodeVersionsResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
