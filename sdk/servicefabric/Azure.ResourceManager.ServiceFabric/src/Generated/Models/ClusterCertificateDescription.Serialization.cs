...
{
    public partial class ClusterCertificateDescription : IUtf8JsonSerializable, IJsonModel<ClusterCertificateDescription>, IPersistableModel<ClusterCertificateDescription>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ThumbprintSecondary))
            {
                builder.Append("  thumbprintSecondary:");
                builder.AppendLine($" '{ThumbprintSecondary}'");
            }

            if (Optional.IsDefined(X509StoreName))
            {
                builder.Append("  x509StoreName:");
                builder.AppendLine($" '{X509StoreName.ToString()}'");
            }
