...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class ServiceLoadMetricDescription
    {
        ...
        internal ServiceLoadMetricDescription(string name, ServiceLoadMetricWeight? weight, int? primaryDefaultLoad, int? secondaryDefaultLoad, int? defaultLoad, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Weight = weight;
