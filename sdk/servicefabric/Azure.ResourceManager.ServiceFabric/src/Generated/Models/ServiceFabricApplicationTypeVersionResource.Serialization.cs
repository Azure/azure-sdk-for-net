...
namespace Azure.ResourceManager.ServiceFabric
{
    public partial class ServiceFabricApplicationTypeVersionResource : IJsonModel<ServiceFabricApplicationTypeVersionData>
    {
        ...
        {
            return ModelReaderWriter.Read<ServiceFabricApplicationTypeVersionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ServiceFabricApplicationTypeVersionData>(data, options);
        }
