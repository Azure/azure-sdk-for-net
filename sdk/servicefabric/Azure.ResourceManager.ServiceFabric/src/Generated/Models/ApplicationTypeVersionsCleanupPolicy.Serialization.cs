...
{
    internal partial class ApplicationTypeVersionsCleanupPolicy : IUtf8JsonSerializable, IJsonModel<ApplicationTypeVersionsCleanupPolicy>, IPersistableModel<ApplicationTypeVersionsCleanupPolicy>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationTypeVersionsCleanupPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApplicationTypeVersionsCleanupPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplicationTypeVersionsCleanupPolicy)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxUnusedVersionsToKeep))
            {
                builder.Append("  maxUnusedVersionsToKeep:");
                builder.AppendLine($" '{MaxUnusedVersionsToKeep.ToString()}'");
            }
