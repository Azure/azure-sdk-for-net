...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceTypeHealthPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceTypeHealthPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceTypeHealthPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceTypeHealthPolicy>)} interface");
            }
        ...
        string IPersistableModel<ServiceTypeHealthPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
