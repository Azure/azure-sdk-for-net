...
{
    public partial class ClusterAadSetting : IUtf8JsonSerializable, IJsonModel<ClusterAadSetting>, IPersistableModel<ClusterAadSetting>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterApplication))
            {
                builder.Append("  clusterApplication:");
                builder.AppendLine($" '{ClusterApplication}'");
            }

            if (Optional.IsDefined(ClientApplication))
            {
                builder.Append("  clientApplication:");
                builder.AppendLine($" '{ClientApplication}'");
            }
