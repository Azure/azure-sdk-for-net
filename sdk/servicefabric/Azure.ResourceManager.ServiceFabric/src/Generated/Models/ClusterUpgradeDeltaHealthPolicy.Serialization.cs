...
{
    public partial class ClusterUpgradeDeltaHealthPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ClusterUpgradeDeltaHealthPolicy DeserializeClusterUpgradeDeltaHealthPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
