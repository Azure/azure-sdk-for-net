...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class ServiceFabricApplicationPatch : TrackedResourceData
    {
        ...
        /// Serialized Name: ApplicationResourceUpdate.properties.typeVersion
        /// </param>
        /// <param name="parameters">
        /// List of application parameters with overridden values from their default values specified in the application manifest.
        /// Serialized Name: ApplicationResourceUpdate.properties.parameters
        /// </param>
        /// <param name="upgradePolicy">
        /// Describes the policy for a monitored application upgrade.
        /// Serialized Name: ApplicationResourceUpdate.properties.upgradePolicy
        /// </param>
        /// <param name="minimumNodes">
        /// The minimum number of nodes where Service Fabric will reserve capacity for this application. Note that this does not mean that the services of this application will be placed on all of those nodes. If this property is set to zero, no capacity will be reserved. The value of this property cannot be more than the value of the MaximumNodes property.
        /// Serialized Name: ApplicationResourceUpdate.properties.minimumNodes
        /// </param>
        /// <param name="maximumNodes">
        /// The maximum number of nodes where Service Fabric will reserve capacity for this application. Note that this does not mean that the services of this application will be placed on all of those nodes. By default, the value of this property is zero and it means that the services can be placed on any node.
        /// Serialized Name: ApplicationResourceUpdate.properties.maximumNodes
        /// </param>
        /// <param name="removeApplicationCapacity">
        /// Remove the current application capacity settings.
        /// Serialized Name: ApplicationResourceUpdate.properties.removeApplicationCapacity
        /// </param>
        /// <param name="metrics">
        /// List of application capacity metric description.
        /// Serialized Name: ApplicationResourceUpdate.properties.metrics
        /// </param>
        /// <param name="managedIdentities">
        /// List of user assigned identities for the application, each mapped to a friendly name.
        /// Serialized Name: ApplicationResourceUpdate.properties.managedIdentities
        /// </param>
        /// <param name="etag">
        /// Azure resource etag.
