...
{
    public partial class ClusterHealthPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ClusterHealthPolicy DeserializeClusterHealthPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
