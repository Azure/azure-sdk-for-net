...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterNotification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterNotification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterNotification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterNotification>)} interface");
            }
        ...
        string IPersistableModel<ClusterNotification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
