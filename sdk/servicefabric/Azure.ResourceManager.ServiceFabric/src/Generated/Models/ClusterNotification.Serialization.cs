...
{
    public partial class ClusterNotification : IUtf8JsonSerializable, IJsonModel<ClusterNotification>, IPersistableModel<ClusterNotification>
    {
        ...
        void IJsonModel<ClusterNotification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterNotification)} does not support '{format}' format.");
            }
