...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public abstract partial class ServicePlacementPolicyDescription : IJsonModel<ServicePlacementPolicyDescription>
    {
        ...
        protected virtual ServicePlacementPolicyDescription PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ServicePlacementPolicyDescription JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ServicePlacementPolicyDescription>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ServicePlacementPolicyDescription DeserializeServicePlacementPolicyDescription(JsonElement element, ModelReaderWriterOptions options)
        {
