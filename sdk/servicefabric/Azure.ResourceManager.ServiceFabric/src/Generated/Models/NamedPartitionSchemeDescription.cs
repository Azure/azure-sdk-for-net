...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class NamedPartitionSchemeDescription : PartitionSchemeDescription
    {
        ...
        internal NamedPartitionSchemeDescription(ApplicationPartitionScheme partitionScheme, int count, IList<string> names, Dictionary<string, BinaryData> rawData) : base(partitionScheme, rawData)
        {
            Count = count;
            Names = names;
