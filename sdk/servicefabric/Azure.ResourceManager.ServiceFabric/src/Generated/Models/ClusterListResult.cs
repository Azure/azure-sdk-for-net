...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    internal partial class ClusterListResult
    {
        ...
        internal ClusterListResult(IEnumerable<ServiceFabricClusterData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ClusterListResult(IList<ServiceFabricClusterData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ServiceFabricClusterData> Value { get; }
