...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    internal partial class ClusterListResult
    {
        ...
        internal ClusterListResult(IEnumerable<ClusterData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ClusterListResult(IList<ClusterData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ClusterData> Value { get; }
