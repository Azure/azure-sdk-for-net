...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmServiceTypeHealthPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmServiceTypeHealthPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmServiceTypeHealthPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArmServiceTypeHealthPolicy>)} interface");
            }
        ...
        string IPersistableModel<ArmServiceTypeHealthPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
