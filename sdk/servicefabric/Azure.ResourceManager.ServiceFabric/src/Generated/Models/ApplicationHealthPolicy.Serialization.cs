...
{
    public partial class ApplicationHealthPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApplicationHealthPolicy DeserializeApplicationHealthPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
