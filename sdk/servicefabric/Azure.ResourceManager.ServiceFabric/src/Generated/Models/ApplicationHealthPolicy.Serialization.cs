...
{
    public partial class ApplicationHealthPolicy : IUtf8JsonSerializable, IJsonModel<ApplicationHealthPolicy>, IPersistableModel<ApplicationHealthPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ServiceTypeHealthPolicies))
            {
                builder.Append("  serviceTypeHealthPolicies:");
                builder.AppendLine(" {");
                foreach (var item in ServiceTypeHealthPolicies)
                {
