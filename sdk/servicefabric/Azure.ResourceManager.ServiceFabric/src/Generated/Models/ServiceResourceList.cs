...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    internal partial class ServiceResourceList
    {
        ...
        internal ServiceResourceList(IEnumerable<ServiceFabricServiceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ServiceResourceList(IList<ServiceFabricServiceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ServiceFabricServiceData> Value { get; }
