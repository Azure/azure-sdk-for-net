...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    internal partial class ServiceResourceList
    {
        ...
        internal ServiceResourceList(IEnumerable<ServiceResourceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ServiceResourceList(IList<ServiceResourceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ServiceResourceData> Value { get; }
