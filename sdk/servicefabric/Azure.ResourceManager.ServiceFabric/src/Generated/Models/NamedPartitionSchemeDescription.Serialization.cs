...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamedPartitionSchemeDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NamedPartitionSchemeDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NamedPartitionSchemeDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NamedPartitionSchemeDescription>)} interface");
            }
        ...
        string IPersistableModel<NamedPartitionSchemeDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
