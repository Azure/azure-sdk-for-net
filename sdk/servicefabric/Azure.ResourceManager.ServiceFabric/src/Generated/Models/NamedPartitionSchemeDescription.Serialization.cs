...
{
    public partial class NamedPartitionSchemeDescription : IUtf8JsonSerializable, IJsonModel<NamedPartitionSchemeDescription>, IPersistableModel<NamedPartitionSchemeDescription>
    {
        ...
        void IJsonModel<NamedPartitionSchemeDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NamedPartitionSchemeDescription)} does not support '{format}' format.");
            }
