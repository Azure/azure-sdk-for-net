...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    /// Serialized Name: ApplicationUpgradePolicy
    /// </summary>
    public partial class ApplicationUpgradePolicy
    {
        ...
        /// Serialized Name: ApplicationUpgradePolicy.upgradeReplicaSetCheckTimeout
        /// </param>
        /// <param name="forceRestart">
        /// If true, then processes are forcefully restarted during upgrade even when the code version has not changed (the upgrade only changes configuration or data).
        /// Serialized Name: ApplicationUpgradePolicy.forceRestart
        /// </param>
        /// <param name="rollingUpgradeMonitoringPolicy">
        /// The policy used for monitoring the application upgrade
        /// Serialized Name: ApplicationUpgradePolicy.rollingUpgradeMonitoringPolicy
        /// </param>
        /// <param name="applicationHealthPolicy">
        /// Defines a health policy used to evaluate the health of an application or one of its children entities.
        /// 
        /// Serialized Name: ApplicationUpgradePolicy.applicationHealthPolicy
        /// </param>
        /// <param name="upgradeMode">
        /// The mode used to monitor health during a rolling upgrade. The values are UnmonitoredAuto, UnmonitoredManual, and Monitored.
        /// Serialized Name: ApplicationUpgradePolicy.upgradeMode
        /// </param>
        /// <param name="recreateApplication">
        ...
        /// Serialized Name: ApplicationUpgradePolicy.recreateApplication
        /// </param>
