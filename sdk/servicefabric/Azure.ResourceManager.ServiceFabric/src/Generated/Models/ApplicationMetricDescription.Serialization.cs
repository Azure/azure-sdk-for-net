...
{
    public partial class ApplicationMetricDescription : IUtf8JsonSerializable, IJsonModel<ApplicationMetricDescription>, IPersistableModel<ApplicationMetricDescription>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaximumCapacity))
            {
                builder.Append("  maximumCapacity:");
                builder.AppendLine($" '{MaximumCapacity.Value.ToString()}'");
            }

            if (Optional.IsDefined(ReservationCapacity))
            {
                builder.Append("  reservationCapacity:");
                builder.AppendLine($" '{ReservationCapacity.Value.ToString()}'");
            }

            if (Optional.IsDefined(TotalApplicationCapacity))
            {
                builder.Append("  totalApplicationCapacity:");
                builder.AppendLine($" '{TotalApplicationCapacity.Value.ToString()}'");
            }
