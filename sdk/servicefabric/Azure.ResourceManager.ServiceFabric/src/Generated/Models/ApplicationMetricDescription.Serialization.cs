...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApplicationMetricDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApplicationMetricDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApplicationMetricDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApplicationMetricDescription>)} interface");
            }
        ...
        string IPersistableModel<ApplicationMetricDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
