...
{
    public partial class ServiceResourcePatch : IUtf8JsonSerializable
    {
        ...
        internal static ServiceResourcePatch DeserializeServiceResourcePatch(JsonElement element)
        {
            ...
            Optional<ServiceKind> serviceKind = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("defaultMoveCost"))
                        {
                            ...
                            defaultMoveCost = new MoveCost(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("serviceKind"))
                        {
                            ...
                            serviceKind = new ServiceKind(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
