...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SingletonPartitionSchemeDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SingletonPartitionSchemeDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SingletonPartitionSchemeDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SingletonPartitionSchemeDescription>)} interface");
            }
        ...
        string IPersistableModel<SingletonPartitionSchemeDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
