...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricApplicationTypeList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceFabricApplicationTypeList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricApplicationTypeList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricApplicationTypeList>)} interface");
            }
        ...
        string IPersistableModel<ServiceFabricApplicationTypeList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
