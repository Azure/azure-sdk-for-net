...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceLoadMetricDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceLoadMetricDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceLoadMetricDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceLoadMetricDescription>)} interface");
            }
        ...
        string IPersistableModel<ServiceLoadMetricDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
