...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class ClusterClientCertificateCommonName
    {
        ...
        internal ClusterClientCertificateCommonName(bool isAdmin, string certificateCommonName, BinaryData certificateIssuerThumbprint, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IsAdmin = isAdmin;
            CertificateCommonName = certificateCommonName;
            CertificateIssuerThumbprint = certificateIssuerThumbprint;
