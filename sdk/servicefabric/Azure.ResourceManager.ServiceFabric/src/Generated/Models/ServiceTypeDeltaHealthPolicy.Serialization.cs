...
{
    public partial class ServiceTypeDeltaHealthPolicy : IUtf8JsonSerializable, IJsonModel<ServiceTypeDeltaHealthPolicy>, IPersistableModel<ServiceTypeDeltaHealthPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxPercentDeltaUnhealthyServices))
            {
                builder.Append("  maxPercentDeltaUnhealthyServices:");
                builder.AppendLine($" '{MaxPercentDeltaUnhealthyServices.Value.ToString()}'");
            }
