...
{
    public partial class ServiceTypeDeltaHealthPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceTypeDeltaHealthPolicy DeserializeServiceTypeDeltaHealthPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
