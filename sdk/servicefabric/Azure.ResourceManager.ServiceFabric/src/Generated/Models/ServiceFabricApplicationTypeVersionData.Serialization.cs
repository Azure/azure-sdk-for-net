...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricApplicationTypeVersionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceFabricApplicationTypeVersionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceFabricApplicationTypeVersionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceFabricApplicationTypeVersionData>)} interface");
            }
        ...
        string IPersistableModel<ServiceFabricApplicationTypeVersionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
