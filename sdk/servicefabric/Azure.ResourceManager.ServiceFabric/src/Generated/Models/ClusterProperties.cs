...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    internal partial class ClusterProperties
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="managementEndpoint"/> or <paramref name="nodeTypes"/> is null. </exception>
        public ClusterProperties(string managementEndpoint, IEnumerable<ClusterNodeTypeDescription> nodeTypes)
        {
            Argument.AssertNotNull(managementEndpoint, nameof(managementEndpoint));
            Argument.AssertNotNull(nodeTypes, nameof(nodeTypes));
        ...
        /// <param name="upgradePauseStartTimestampUtc"> Indicates the start date and time to pause automatic runtime version upgrades on the cluster for an specific period of time on the cluster (UTC). </param>
        ...
        public IList<ClusterAddOnFeature> AddOnFeatures { get; } = new ChangeTrackingList<ClusterAddOnFeature>();

        /// <summary> The Service Fabric runtime versions available for this cluster. </summary>
        public IReadOnlyList<ClusterVersionDetails> AvailableClusterVersions { get; } = new ChangeTrackingList<ClusterVersionDetails>();
        ...
        public IList<ClusterClientCertificateCommonName> ClientCertificateCommonNames { get; } = new ChangeTrackingList<ClusterClientCertificateCommonName>();

        /// <summary> The list of client certificates referenced by thumbprint that are allowed to manage the cluster. </summary>
        public IList<ClusterClientCertificateThumbprint> ClientCertificateThumbprints { get; } = new ChangeTrackingList<ClusterClientCertificateThumbprint>();
        ...
        public IList<ClusterNodeTypeDescription> NodeTypes { get; } = new ChangeTrackingList<ClusterNodeTypeDescription>();
        ...
        public long? MaxUnusedVersionsToKeep
        {
            ...
            set
            {
                ApplicationTypeVersionsCleanupPolicy = value.HasValue ? new ApplicationTypeVersionsCleanupPolicy(value.Value) : default;
            }
        }
    }
}
