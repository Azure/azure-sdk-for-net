...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    {
        internal static UpgradableVersionPathResult DeserializeUpgradableVersionPathResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
