...
namespace Azure.ResourceManager.ServiceFabric
{
    internal partial class UnsupportedVmSizesGetAllAsyncCollectionResultOfT : AsyncPageable<ServiceFabricVmSizeResourceData>
    {
        ...
        /// <summary> Initializes a new instance of UnsupportedVmSizesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public UnsupportedVmSizesGetAllAsyncCollectionResultOfT(UnsupportedVmSizes client, string subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of UnsupportedVmSizesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
