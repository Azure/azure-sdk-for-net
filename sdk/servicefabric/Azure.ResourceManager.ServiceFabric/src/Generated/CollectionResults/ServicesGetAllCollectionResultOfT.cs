...
{
    internal partial class ServicesGetAllCollectionResultOfT : Pageable<ServiceResourceData>
    {
        ...
        public override IEnumerable<Page<ServiceResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
