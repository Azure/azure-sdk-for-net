...
namespace Azure.ResourceManager.ServiceFabric
{
    internal partial class UnsupportedVmSizesGetAllCollectionResultOfT : Pageable<ServiceFabricVmSizeResourceData>
    {
        ...
        /// <summary> Initializes a new instance of UnsupportedVmSizesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The UnsupportedVmSizes client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="location"> The name of the Azure region. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public UnsupportedVmSizesGetAllCollectionResultOfT(UnsupportedVmSizes client, string subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of UnsupportedVmSizesGetAllCollectionResultOfT as an enumerable collection. </summary>
