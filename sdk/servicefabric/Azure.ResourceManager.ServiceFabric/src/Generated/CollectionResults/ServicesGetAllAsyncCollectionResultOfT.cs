...
namespace Azure.ResourceManager.ServiceFabric
{
    internal partial class ServicesGetAllAsyncCollectionResultOfT : AsyncPageable<ServiceFabricServiceData>
    {
        ...
        public ServicesGetAllAsyncCollectionResultOfT(Services client, string subscriptionId, string resourceGroupName, string clusterName, string applicationName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
