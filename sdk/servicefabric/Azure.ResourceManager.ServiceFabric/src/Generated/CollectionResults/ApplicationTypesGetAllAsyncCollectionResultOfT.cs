...
namespace Azure.ResourceManager.ServiceFabric
{
    internal partial class ApplicationTypesGetAllAsyncCollectionResultOfT : AsyncPageable<ApplicationTypeResourceData>
    {
        ...
        public ApplicationTypesGetAllAsyncCollectionResultOfT(ApplicationTypes client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
