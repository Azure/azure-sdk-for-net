...
namespace Azure.ResourceManager.ServiceFabric
{
    internal partial class ApplicationTypesGetAllAsyncCollectionResultOfT : AsyncPageable<ServiceFabricApplicationTypeData>
    {
        ...
        /// <summary> Initializes a new instance of ApplicationTypesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ApplicationTypes client used to send requests. </param>
        ...
        public ApplicationTypesGetAllAsyncCollectionResultOfT(ApplicationTypes client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApplicationTypesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
