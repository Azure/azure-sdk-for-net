...
namespace Azure.ResourceManager.ServiceFabric
{
    internal partial class ClustersGetAllCollectionResultOfT : Pageable<ServiceFabricClusterData>
    {
        ...
        public ClustersGetAllCollectionResultOfT(Clusters client, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
