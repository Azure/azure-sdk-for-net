...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    public partial class ServiceResourceCollection : ArmCollection, IEnumerable<ServiceResource>, IAsyncEnumerable<ServiceResource>
    {
        ...
        {
            _serviceResourceServicesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceFabric", ServiceResource.ResourceType.Namespace, Diagnostics);
        ...
        /// <remarks> Create or update a Service Fabric service resource with the specified name. </remarks>
        ...
        /// <remarks> Gets all service resources created or in the process of being created in the Service Fabric application resource. </remarks>
        public virtual AsyncPageable<ServiceResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<ServiceResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _serviceResourceServicesRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<ServiceResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ServiceResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _serviceResourceServicesRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ServiceResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
