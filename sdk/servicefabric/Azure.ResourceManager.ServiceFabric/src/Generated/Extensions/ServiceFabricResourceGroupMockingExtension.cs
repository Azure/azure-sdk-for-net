...
namespace Azure.ResourceManager.ServiceFabric.Mocking
{
    ...
    internal partial class ServiceFabricResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ServiceFabricResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ServiceFabricResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceFabricResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceFabricResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
