...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ClusterResource" /> using the GetApplicationResource method.
    /// </summary>
    public partial class ApplicationResource : ArmResource
    {
        ...
        {
            _applicationResourceApplicationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceFabric", ResourceType.Namespace, Diagnostics);
        ...
        /// <remarks> Get a Service Fabric service resource created or in the process of being created in the Service Fabric application resource. </remarks>
        [ForwardsClientCalls]
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceFabricArmOperation(_applicationResourceApplicationsClientDiagnostics, Pipeline, _applicationResourceApplicationsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<ApplicationResource>> UpdateAsync(WaitUntil waitUntil, ApplicationResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceFabricArmOperation<ApplicationResource>(new ApplicationResourceOperationSource(Client), _applicationResourceApplicationsClientDiagnostics, Pipeline, _applicationResourceApplicationsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
