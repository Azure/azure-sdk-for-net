...
namespace Azure.ResourceManager.ServiceFabric
{
    public partial class ServiceFabricApplicationResource : IJsonModel<ServiceFabricApplicationData>
    {
        ...
        {
            return ModelReaderWriter.Read<ServiceFabricApplicationData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ServiceFabricApplicationData>(data, options);
        }
