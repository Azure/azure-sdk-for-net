...
{
    /// <summary> A class representing the ApplicationResource data model. </summary>
    public partial class ApplicationResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ApplicationResourceData. </summary>
        /// <param name="location"> The location. </param>
        public ApplicationResourceData(AzureLocation location) : base(location)
        {
