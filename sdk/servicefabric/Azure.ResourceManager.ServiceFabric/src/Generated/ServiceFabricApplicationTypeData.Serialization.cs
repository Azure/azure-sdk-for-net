...
{
    public partial class ServiceFabricApplicationTypeData : IUtf8JsonSerializable, IJsonModel<ServiceFabricApplicationTypeData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceFabricApplicationTypeData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ServiceFabricApplicationTypeData DeserializeServiceFabricApplicationTypeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
