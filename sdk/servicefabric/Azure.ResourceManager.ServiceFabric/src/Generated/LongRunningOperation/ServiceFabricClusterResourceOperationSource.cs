...
{
    /// <summary></summary>
    internal partial class ServiceFabricClusterResourceOperationSource : IOperationSource<ServiceFabricClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceFabricClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
