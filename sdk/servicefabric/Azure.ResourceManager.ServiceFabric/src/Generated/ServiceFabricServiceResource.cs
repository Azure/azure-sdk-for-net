...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    public partial class ServiceFabricServiceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ServiceFabricServiceResource>> UpdateAsync(WaitUntil waitUntil, ServiceFabricServicePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                ServiceFabricArmOperation<ServiceFabricServiceResource> operation = new ServiceFabricArmOperation<ServiceFabricServiceResource>(
                    new ServiceFabricServiceResourceOperationSource(Client),
        ...
        /// <summary>
        /// Updates the ServiceFabricService.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/clusters/{clusterName}/applications/{applicationName}/services/{serviceName}. </description>
        ...
        public virtual async Task<ArmOperation<ServiceFabricServiceResource>> UpdateAsync(WaitUntil waitUntil, ServiceFabricServiceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _servicesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ServiceFabricServiceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ServiceFabricArmOperation<ServiceFabricServiceResource> operation = new ServiceFabricArmOperation<ServiceFabricServiceResource>(
                    new ServiceFabricServiceResourceOperationSource(Client),
                    _servicesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ServiceFabricServiceResource> Update(WaitUntil waitUntil, ServiceFabricServiceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
