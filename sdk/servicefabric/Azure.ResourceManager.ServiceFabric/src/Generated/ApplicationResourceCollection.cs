...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    /// To get an <see cref="ApplicationResourceCollection" /> instance call the GetApplicationResources method from an instance of <see cref="ClusterResource" />.
    /// </summary>
    public partial class ApplicationResourceCollection : ArmCollection, IEnumerable<ApplicationResource>, IAsyncEnumerable<ApplicationResource>
    {
        ...
        {
            _applicationResourceApplicationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceFabric", ApplicationResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ApplicationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string applicationName, ApplicationResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceFabricArmOperation<ApplicationResource>(new ApplicationResourceOperationSource(Client), _applicationResourceApplicationsClientDiagnostics, Pipeline, _applicationResourceApplicationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, applicationName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual AsyncPageable<ApplicationResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<ApplicationResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new ApplicationResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
