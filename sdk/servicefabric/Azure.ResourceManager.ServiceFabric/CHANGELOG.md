...
This release is the first stable release of the Service Fabric Management client library.
...
The package name has been changed from `Microsoft.Azure.Management.Fabric` to `Azure.ResourceManager.Fabric`.
