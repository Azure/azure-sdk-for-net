namespace Azure.ResourceManager.ServiceFabric
{
    ...
    [System.ClientModel.Primitives.ModelReaderWriterBuildableAttribute(typeof(Azure.ResourceManager.ServiceFabric.Models.ServiceResourceProperties))]
    [System.ClientModel.Primitives.ModelReaderWriterBuildableAttribute(typeof(Azure.ResourceManager.ServiceFabric.Models.ServiceResourcePropertiesBase))]
    [System.ClientModel.Primitives.ModelReaderWriterBuildableAttribute(typeof(Azure.ResourceManager.ServiceFabric.Models.ServiceResourceUpdateProperties))]
    ...
    [System.ClientModel.Primitives.ModelReaderWriterBuildableAttribute(typeof(Azure.ResourceManager.ServiceFabric.Models.StatefulServiceProperties))]
    [System.ClientModel.Primitives.ModelReaderWriterBuildableAttribute(typeof(Azure.ResourceManager.ServiceFabric.Models.StatefulServiceUpdateProperties))]
    [System.ClientModel.Primitives.ModelReaderWriterBuildableAttribute(typeof(Azure.ResourceManager.ServiceFabric.Models.StatelessServiceProperties))]
    [System.ClientModel.Primitives.ModelReaderWriterBuildableAttribute(typeof(Azure.ResourceManager.ServiceFabric.Models.StatelessServiceUpdateProperties))]
...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public static partial class ArmServiceFabricModelFactory
    {
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.ApplicationMetricDescription ApplicationMetricDescription(string name = null, long? maximumCapacity = default(long?), long? reservationCapacity = default(long?), long? totalApplicationCapacity = default(long?)) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ApplicationUpgradePolicy ApplicationUpgradePolicy(System.TimeSpan? upgradeReplicaSetCheckTimeout = default(System.TimeSpan?), bool? forceRestart = default(bool?), Azure.ResourceManager.ServiceFabric.Models.ArmRollingUpgradeMonitoringPolicy rollingUpgradeMonitoringPolicy = null, Azure.ResourceManager.ServiceFabric.Models.ArmApplicationHealthPolicy applicationHealthPolicy = null, Azure.ResourceManager.ServiceFabric.Models.ApplicationRollingUpgradeMode? upgradeMode = default(Azure.ResourceManager.ServiceFabric.Models.ApplicationRollingUpgradeMode?), bool? recreateApplication = default(bool?)) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ApplicationUserAssignedIdentity ApplicationUserAssignedIdentity(string name = null, System.Guid principalId = default(System.Guid)) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.ArmRollingUpgradeMonitoringPolicy ArmRollingUpgradeMonitoringPolicy(Azure.ResourceManager.ServiceFabric.Models.ArmUpgradeFailureAction? failureAction = default(Azure.ResourceManager.ServiceFabric.Models.ArmUpgradeFailureAction?), System.TimeSpan? healthCheckWaitDuration = default(System.TimeSpan?), System.TimeSpan? healthCheckStableDuration = default(System.TimeSpan?), System.TimeSpan? healthCheckRetryTimeout = default(System.TimeSpan?), System.TimeSpan? upgradeTimeout = default(System.TimeSpan?), System.TimeSpan? upgradeDomainTimeout = default(System.TimeSpan?)) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ArmServiceTypeHealthPolicy ArmServiceTypeHealthPolicy(int? maxPercentUnhealthyServices = default(int?), int? maxPercentUnhealthyPartitionsPerService = default(int?), int? maxPercentUnhealthyReplicasPerPartition = default(int?)) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ClusterAadSetting ClusterAadSetting(System.Guid? tenantId = default(System.Guid?), string clusterApplication = null, string clientApplication = null) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ClusterCertificateDescription ClusterCertificateDescription(System.BinaryData thumbprint = null, string thumbprintSecondary = null, Azure.ResourceManager.ServiceFabric.Models.ClusterCertificateStoreName? x509StoreName = default(Azure.ResourceManager.ServiceFabric.Models.ClusterCertificateStoreName?)) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ClusterClientCertificateCommonName ClusterClientCertificateCommonName(bool isAdmin = false, string certificateCommonName = null, System.BinaryData certificateIssuerThumbprint = null) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ClusterClientCertificateThumbprint ClusterClientCertificateThumbprint(bool isAdmin = false, System.BinaryData certificateThumbprint = null) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.ClusterEndpointRangeDescription ClusterEndpointRangeDescription(int startPort = 0, int endPort = 0) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.ClusterServerCertificateCommonName ClusterServerCertificateCommonName(string certificateCommonName = null, System.BinaryData certificateIssuerThumbprint = null) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.ClusterUpgradePolicy ClusterUpgradePolicy(bool? forceRestart = default(bool?), System.TimeSpan upgradeReplicaSetCheckTimeout = default(System.TimeSpan), System.TimeSpan healthCheckWaitDuration = default(System.TimeSpan), System.TimeSpan healthCheckStableDuration = default(System.TimeSpan), System.TimeSpan healthCheckRetryTimeout = default(System.TimeSpan), System.TimeSpan upgradeTimeout = default(System.TimeSpan), System.TimeSpan upgradeDomainTimeout = default(System.TimeSpan), Azure.ResourceManager.ServiceFabric.Models.ClusterHealthPolicy healthPolicy = null, Azure.ResourceManager.ServiceFabric.Models.ClusterUpgradeDeltaHealthPolicy deltaHealthPolicy = null) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.DiagnosticsStorageAccountConfig DiagnosticsStorageAccountConfig(string storageAccountName = null, string protectedAccountKeyName = null, string protectedAccountKeyName2 = null, System.Uri blobEndpoint = null, System.Uri queueEndpoint = null, System.Uri tableEndpoint = null) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.PartitionSchemeDescription PartitionSchemeDescription(string partitionScheme = null) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ServiceCorrelationDescription ServiceCorrelationDescription(Azure.ResourceManager.ServiceFabric.Models.ServiceCorrelationScheme scheme = default(Azure.ResourceManager.ServiceFabric.Models.ServiceCorrelationScheme), string serviceName = null) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.ServiceLoadMetricDescription ServiceLoadMetricDescription(string name = null, Azure.ResourceManager.ServiceFabric.Models.ServiceLoadMetricWeight? weight = default(Azure.ResourceManager.ServiceFabric.Models.ServiceLoadMetricWeight?), int? primaryDefaultLoad = default(int?), int? secondaryDefaultLoad = default(int?), int? defaultLoad = default(int?)) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ServicePlacementPolicyDescription ServicePlacementPolicyDescription(string type = null) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.ServiceTypeDeltaHealthPolicy ServiceTypeDeltaHealthPolicy(int? maxPercentDeltaUnhealthyServices = default(int?)) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.ServiceTypeHealthPolicy ServiceTypeHealthPolicy(int? maxPercentUnhealthyServices = default(int?)) { throw null; }
        public static Azure.ResourceManager.ServiceFabric.Models.SettingsParameterDescription SettingsParameterDescription(string name = null, string value = null) { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.SingletonPartitionSchemeDescription SingletonPartitionSchemeDescription() { throw null; }
        ...
        public static Azure.ResourceManager.ServiceFabric.Models.UniformInt64RangePartitionSchemeDescription UniformInt64RangePartitionSchemeDescription(int count = 0, string lowKey = null, string highKey = null) { throw null; }
