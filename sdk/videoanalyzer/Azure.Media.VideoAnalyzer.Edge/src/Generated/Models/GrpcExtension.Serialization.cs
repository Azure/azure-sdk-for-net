...
{
    public partial class GrpcExtension : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GrpcExtension DeserializeGrpcExtension(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
