...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class PipelineTopologyGetRequest : MethodRequestEmptyBodyBase
    {
        ...
        internal PipelineTopologyGetRequest(string methodName, string apiVersion, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, name, serializedAdditionalRawData)
        {
