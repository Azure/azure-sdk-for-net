...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class UnknownNamedLineBase : NamedLineBase
    {
        ...
        internal UnknownNamedLineBase(string type, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, serializedAdditionalRawData)
        {
            Type = type ?? "Unknown";
        }
