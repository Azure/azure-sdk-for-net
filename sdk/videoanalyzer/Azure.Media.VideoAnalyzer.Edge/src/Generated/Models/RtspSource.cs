...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class RtspSource : SourceNodeBase
    {
        ...
        internal RtspSource(string type, string name, RtspTransport? transport, EndpointBase endpoint, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, serializedAdditionalRawData)
        {
            Transport = transport;
            Endpoint = endpoint;
