...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class ImageFormatBmp : IUtf8JsonSerializable, IModelJsonSerializable<ImageFormatBmp>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ImageFormatBmp>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ImageFormatBmp"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ImageFormatBmp"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ImageFormatBmp"/>. </summary>
