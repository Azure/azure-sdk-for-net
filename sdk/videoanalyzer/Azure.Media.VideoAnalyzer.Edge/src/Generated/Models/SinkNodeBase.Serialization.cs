...
{
    public partial class SinkNodeBase : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SinkNodeBase DeserializeSinkNodeBase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
