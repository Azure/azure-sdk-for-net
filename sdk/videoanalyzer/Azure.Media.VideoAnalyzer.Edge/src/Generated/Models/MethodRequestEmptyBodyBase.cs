...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class MethodRequestEmptyBodyBase : MethodRequest
    {
        ...
        internal MethodRequestEmptyBodyBase(string methodName, string apiVersion, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, serializedAdditionalRawData)
        {
            Name = name;
