...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class MethodRequestEmptyBodyBase : MethodRequest
    {
        ...
        internal MethodRequestEmptyBodyBase(string methodName, string apiVersion, string name, Dictionary<string, BinaryData> rawData) : base(methodName, apiVersion, rawData)
        {
            Name = name;
