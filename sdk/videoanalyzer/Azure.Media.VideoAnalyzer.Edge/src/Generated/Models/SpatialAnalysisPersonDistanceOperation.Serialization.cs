...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnalysisPersonDistanceOperation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SpatialAnalysisPersonDistanceOperation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisPersonDistanceOperation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SpatialAnalysisPersonDistanceOperation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
