...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class SpatialAnalysisPersonDistanceOperation : IUtf8JsonSerializable, IJsonModel<SpatialAnalysisPersonDistanceOperation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisPersonDistanceOperation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpatialAnalysisPersonDistanceOperation>)} interface");
            }
        ...
        SpatialAnalysisPersonDistanceOperation IJsonModel<SpatialAnalysisPersonDistanceOperation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SpatialAnalysisPersonDistanceOperation)} does not support '{options.Format}' format.");
            }
