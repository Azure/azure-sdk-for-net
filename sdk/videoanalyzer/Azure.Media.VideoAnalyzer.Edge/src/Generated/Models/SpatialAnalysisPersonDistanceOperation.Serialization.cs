...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnalysisPersonDistanceOperation>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SpatialAnalysisPersonDistanceOperation IJsonModel<SpatialAnalysisPersonDistanceOperation>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<SpatialAnalysisPersonDistanceOperation>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SpatialAnalysisPersonDistanceOperation IModel<SpatialAnalysisPersonDistanceOperation>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SpatialAnalysisPersonDistanceOperation>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
