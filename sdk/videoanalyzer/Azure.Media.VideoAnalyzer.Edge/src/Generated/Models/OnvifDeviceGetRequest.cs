...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class OnvifDeviceGetRequest : MethodRequest
    {
        ...
        internal OnvifDeviceGetRequest(string methodName, string apiVersion, EndpointBase endpoint, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, serializedAdditionalRawData)
        {
            Endpoint = endpoint;
