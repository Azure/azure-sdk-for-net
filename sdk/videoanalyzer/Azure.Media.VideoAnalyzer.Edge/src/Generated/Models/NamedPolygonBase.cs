...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownNamedPolygonBase))]
    public abstract partial class NamedPolygonBase
    {
        ...
        internal NamedPolygonBase(string type, string name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            Name = name;
