...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class UnknownNamedPolygonBase : NamedPolygonBase
    {
        ...
        internal UnknownNamedPolygonBase(string type, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, serializedAdditionalRawData)
        {
            Type = type ?? "Unknown";
        }
