...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class SpatialAnalysisOperationEventBase : IUtf8JsonSerializable
    {
        ...
        internal static SpatialAnalysisOperationEventBase FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeSpatialAnalysisOperationEventBase(document.RootElement);
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<SpatialAnalysisOperationEventBase>(this);
            return content;
        }
    }
}
