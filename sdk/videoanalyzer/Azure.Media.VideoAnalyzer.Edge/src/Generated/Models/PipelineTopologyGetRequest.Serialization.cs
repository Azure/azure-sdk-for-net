...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class PipelineTopologyGetRequest : IUtf8JsonSerializable, IJsonModel<PipelineTopologyGetRequest>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineTopologyGetRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PipelineTopologyGetRequest)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PipelineTopologyGetRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PipelineTopologyGetRequest)} does not support '{options.Format}' format.");
            }
        }
