...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PipelineTopologyGetRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PipelineTopologyGetRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PipelineTopologyGetRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PipelineTopologyGetRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
