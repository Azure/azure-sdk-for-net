...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class PipelineTopologyGetRequest : IUtf8JsonSerializable
    {
        ...
        internal static new PipelineTopologyGetRequest FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializePipelineTopologyGetRequest(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<PipelineTopologyGetRequest>(this);
            return content;
        }
    }
}
