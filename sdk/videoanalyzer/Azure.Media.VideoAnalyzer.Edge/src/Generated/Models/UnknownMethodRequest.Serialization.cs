...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    internal partial class UnknownMethodRequest : IUtf8JsonSerializable
    {
        ...
        internal static new UnknownMethodRequest FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownMethodRequest(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UnknownMethodRequest>(this);
            return content;
        }
    }
}
