...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class PemCertificateList : CertificateSource
    {
        ...
        internal PemCertificateList(string type, IList<string> certificates, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
