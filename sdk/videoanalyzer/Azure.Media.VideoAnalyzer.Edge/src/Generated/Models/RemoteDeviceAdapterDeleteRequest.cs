...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class RemoteDeviceAdapterDeleteRequest : MethodRequestEmptyBodyBase
    {
        ...
        internal RemoteDeviceAdapterDeleteRequest(string methodName, string apiVersion, string name, Dictionary<string, BinaryData> rawData) : base(methodName, apiVersion, name, rawData)
        {
