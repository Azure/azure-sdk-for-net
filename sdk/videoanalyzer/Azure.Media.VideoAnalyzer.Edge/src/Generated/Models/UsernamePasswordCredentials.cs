...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class UsernamePasswordCredentials : CredentialsBase
    {
        ...
        internal UsernamePasswordCredentials(string type, string username, string password, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            Username = username;
            Password = password;
