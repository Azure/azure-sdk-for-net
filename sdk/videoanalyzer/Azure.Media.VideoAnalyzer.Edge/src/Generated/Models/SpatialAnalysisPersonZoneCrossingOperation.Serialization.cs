...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class SpatialAnalysisPersonZoneCrossingOperation : IUtf8JsonSerializable, IJsonModel<SpatialAnalysisPersonZoneCrossingOperation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisPersonZoneCrossingOperation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpatialAnalysisPersonZoneCrossingOperation>)} interface");
            }
