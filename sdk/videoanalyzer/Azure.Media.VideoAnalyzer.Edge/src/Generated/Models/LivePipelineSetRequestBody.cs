...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class LivePipelineSetRequestBody : MethodRequest
    {
        ...
        internal LivePipelineSetRequestBody(string methodName, string apiVersion, string name, SystemData systemData, LivePipelineProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, serializedAdditionalRawData)
        {
            Name = name;
