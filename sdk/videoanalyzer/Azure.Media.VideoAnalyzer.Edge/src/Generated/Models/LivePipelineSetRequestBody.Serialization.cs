...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    internal partial class LivePipelineSetRequestBody : IUtf8JsonSerializable, IJsonModel<LivePipelineSetRequestBody>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LivePipelineSetRequestBody>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LivePipelineSetRequestBody>)} interface");
            }
