...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LivePipelineSetRequestBody>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LivePipelineSetRequestBody>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LivePipelineSetRequestBody>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LivePipelineSetRequestBody>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
