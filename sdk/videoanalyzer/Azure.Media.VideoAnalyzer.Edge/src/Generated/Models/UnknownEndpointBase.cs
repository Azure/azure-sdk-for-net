...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class UnknownEndpointBase : EndpointBase
    {
        ...
        internal UnknownEndpointBase(string type, CredentialsBase credentials, string url, Dictionary<string, BinaryData> rawData) : base(type, credentials, url, rawData)
        {
            Type = type ?? "Unknown";
        }
