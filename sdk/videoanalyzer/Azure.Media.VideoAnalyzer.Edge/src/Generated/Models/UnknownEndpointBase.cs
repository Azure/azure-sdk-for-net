...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class UnknownEndpointBase : EndpointBase
    {
        ...
        internal UnknownEndpointBase(string type, CredentialsBase credentials, string url, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, credentials, url, serializedAdditionalRawData)
        {
            Type = type ?? "Unknown";
        }
