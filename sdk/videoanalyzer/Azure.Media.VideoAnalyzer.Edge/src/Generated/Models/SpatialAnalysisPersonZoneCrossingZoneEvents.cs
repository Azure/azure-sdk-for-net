...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class SpatialAnalysisPersonZoneCrossingZoneEvents
    {
        ...
        internal SpatialAnalysisPersonZoneCrossingZoneEvents(NamedPolygonBase zone, IList<SpatialAnalysisPersonZoneCrossingEvent> events, Dictionary<string, BinaryData> rawData)
        {
            Zone = zone;
            Events = events;
            _rawData = rawData;
