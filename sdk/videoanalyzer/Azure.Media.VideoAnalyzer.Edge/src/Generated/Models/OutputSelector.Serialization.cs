...
{
    public partial class OutputSelector : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OutputSelector DeserializeOutputSelector(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
