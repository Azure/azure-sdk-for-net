...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class NamedPolygonString : NamedPolygonBase
    {
        ...
        internal NamedPolygonString(string type, string name, string polygon, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, serializedAdditionalRawData)
        {
            Polygon = polygon;
