...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class VideoEncoderConfiguration : IUtf8JsonSerializable, IJsonModel<VideoEncoderConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VideoEncoderConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VideoEncoderConfiguration>)} interface");
            }
