...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class FileSink : SinkNodeBase
    {
        ...
        internal FileSink(string type, string name, IList<NodeInput> inputs, string baseDirectoryPath, string fileNamePattern, string maximumSizeMiB, Dictionary<string, BinaryData> rawData) : base(type, name, inputs, rawData)
        {
            BaseDirectoryPath = baseDirectoryPath;
            FileNamePattern = fileNamePattern;
            MaximumSizeMiB = maximumSizeMiB;
