...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class FileSink : SinkNodeBase
    {
        ...
        internal FileSink(string type, string name, IList<NodeInput> inputs, string baseDirectoryPath, string fileNamePattern, string maximumSizeMiB, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, inputs, serializedAdditionalRawData)
        {
            BaseDirectoryPath = baseDirectoryPath;
            FileNamePattern = fileNamePattern;
            MaximumSizeMiB = maximumSizeMiB;
