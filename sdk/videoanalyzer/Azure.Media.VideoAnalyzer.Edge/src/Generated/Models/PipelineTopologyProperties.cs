...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class PipelineTopologyProperties
    {
        ...
        internal PipelineTopologyProperties(string description, IList<ParameterDeclaration> parameters, IList<SourceNodeBase> sources, IList<ProcessorNodeBase> processors, IList<SinkNodeBase> sinks, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
