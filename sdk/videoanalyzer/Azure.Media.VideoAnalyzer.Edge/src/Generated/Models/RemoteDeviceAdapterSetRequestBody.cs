...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class RemoteDeviceAdapterSetRequestBody : MethodRequest
    {
        ...
        internal RemoteDeviceAdapterSetRequestBody(string methodName, string apiVersion, string name, SystemData systemData, RemoteDeviceAdapterProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, serializedAdditionalRawData)
        {
            Name = name;
