...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class MotionDetectionProcessor : ProcessorNodeBase
    {
        ...
        internal MotionDetectionProcessor(string type, string name, IList<NodeInput> inputs, MotionDetectionSensitivity? sensitivity, bool? outputMotionRegion, string eventAggregationWindow, Dictionary<string, BinaryData> rawData) : base(type, name, inputs, rawData)
        {
