...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class Mpeg4Configuration : IUtf8JsonSerializable, IModelJsonSerializable<Mpeg4Configuration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<Mpeg4Configuration>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="Mpeg4Configuration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="Mpeg4Configuration"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="Mpeg4Configuration"/>. </summary>
