...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownImageFormatProperties))]
    public abstract partial class ImageFormatProperties
    {
        ...
        internal ImageFormatProperties(string type, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
