...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class ImageFormatJpeg : IUtf8JsonSerializable
    {
        ...
        internal static new ImageFormatJpeg FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeImageFormatJpeg(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ImageFormatJpeg>(this);
            return content;
        }
    }
}
