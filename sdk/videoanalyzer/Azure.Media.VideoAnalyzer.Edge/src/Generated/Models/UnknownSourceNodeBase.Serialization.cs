...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    internal partial class UnknownSourceNodeBase : IUtf8JsonSerializable
    {
        ...
        internal static new UnknownSourceNodeBase FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownSourceNodeBase(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UnknownSourceNodeBase>(this);
            return content;
        }
    }
}
