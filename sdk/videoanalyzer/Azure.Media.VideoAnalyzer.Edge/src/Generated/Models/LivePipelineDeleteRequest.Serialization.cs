...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class LivePipelineDeleteRequest : IUtf8JsonSerializable
    {
        ...
        internal static LivePipelineDeleteRequest DeserializeLivePipelineDeleteRequest(JsonElement element)
        {
            ...
            return new LivePipelineDeleteRequest(methodName, apiVersion, name);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static new LivePipelineDeleteRequest FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeLivePipelineDeleteRequest(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<LivePipelineDeleteRequest>(this);
            return content;
        }
    }
}
