...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class OutputSelector
    {
        ...
        internal OutputSelector(OutputSelectorProperty? property, OutputSelectorOperator? @operator, string value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Property = property;
            Operator = @operator;
            Value = value;
