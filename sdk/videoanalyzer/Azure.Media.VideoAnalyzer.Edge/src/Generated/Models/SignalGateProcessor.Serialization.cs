...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class SignalGateProcessor : IUtf8JsonSerializable, IModelJsonSerializable<SignalGateProcessor>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SignalGateProcessor>(this, options.Format);
        ...
        internal static SignalGateProcessor DeserializeSignalGateProcessor(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SignalGateProcessor(type, name, inputs, activationEvaluationWindow.Value, activationSignalOffset.Value, minimumActivationTime.Value, maximumActivationTime.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="SignalGateProcessor"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SignalGateProcessor"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SignalGateProcessor"/>. </summary>
