...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class ExtensionProcessorBase : ProcessorNodeBase
    {
        ...
        internal ExtensionProcessorBase(string type, string name, IList<NodeInput> inputs, EndpointBase endpoint, ImageProperties image, SamplingOptions samplingOptions, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, inputs, serializedAdditionalRawData)
        {
            Endpoint = endpoint;
            Image = image;
