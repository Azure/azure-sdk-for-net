...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class SpatialAnalysisPersonDistanceEvent : SpatialAnalysisOperationEventBase
    {
        ...
        internal SpatialAnalysisPersonDistanceEvent(string threshold, SpatialAnalysisOperationFocus? focus, SpatialAnalysisPersonDistanceEventTrigger? trigger, string outputFrequency, string minimumDistanceThreshold, string maximumDistanceThreshold, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(threshold, focus, serializedAdditionalRawData)
        {
            Trigger = trigger;
