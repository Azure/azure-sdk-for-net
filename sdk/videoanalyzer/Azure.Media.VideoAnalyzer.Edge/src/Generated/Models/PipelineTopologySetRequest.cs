...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class PipelineTopologySetRequest : MethodRequest
    {
        ...
        internal PipelineTopologySetRequest(string methodName, string apiVersion, PipelineTopology pipelineTopology, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, serializedAdditionalRawData)
        {
            PipelineTopology = pipelineTopology;
