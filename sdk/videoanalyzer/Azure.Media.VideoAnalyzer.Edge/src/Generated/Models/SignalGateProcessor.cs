...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class SignalGateProcessor : ProcessorNodeBase
    {
        ...
        internal SignalGateProcessor(string type, string name, IList<NodeInput> inputs, string activationEvaluationWindow, string activationSignalOffset, string minimumActivationTime, string maximumActivationTime, Dictionary<string, BinaryData> rawData) : base(type, name, inputs, rawData)
        {
