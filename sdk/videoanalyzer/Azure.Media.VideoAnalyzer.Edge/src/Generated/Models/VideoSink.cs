...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class VideoSink : SinkNodeBase
    {
        ...
        internal VideoSink(string type, string name, IList<NodeInput> inputs, string videoName, VideoCreationProperties videoCreationProperties, VideoPublishingOptions videoPublishingOptions, string localMediaCachePath, string localMediaCacheMaximumSizeMiB, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, inputs, serializedAdditionalRawData)
        {
            VideoName = videoName;
        ...
        /// <summary> Initializes a new instance of <see cref="VideoSink"/> for deserialization. </summary>
        internal VideoSink()
        {
        }
