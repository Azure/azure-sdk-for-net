...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class PipelineTopologyDeleteRequest : IUtf8JsonSerializable
    {
        ...
        internal static PipelineTopologyDeleteRequest DeserializePipelineTopologyDeleteRequest(JsonElement element)
        {
            ...
            return new PipelineTopologyDeleteRequest(methodName, apiVersion, name);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static new PipelineTopologyDeleteRequest FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializePipelineTopologyDeleteRequest(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<PipelineTopologyDeleteRequest>(this);
            return content;
        }
    }
}
