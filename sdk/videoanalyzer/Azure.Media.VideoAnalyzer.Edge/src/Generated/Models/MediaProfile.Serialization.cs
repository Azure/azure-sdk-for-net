...
{
    public partial class MediaProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaProfile DeserializeMediaProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
