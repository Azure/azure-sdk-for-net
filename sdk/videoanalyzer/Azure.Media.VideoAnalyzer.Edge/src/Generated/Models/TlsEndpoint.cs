...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class TlsEndpoint : EndpointBase
    {
        ...
        internal TlsEndpoint(string type, CredentialsBase credentials, string url, CertificateSource trustedCertificates, TlsValidationOptions validationOptions, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, credentials, url, serializedAdditionalRawData)
        {
