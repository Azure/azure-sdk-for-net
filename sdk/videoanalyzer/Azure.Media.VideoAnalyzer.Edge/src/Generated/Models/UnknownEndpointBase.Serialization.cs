...
{
    internal partial class UnknownEndpointBase : IUtf8JsonSerializable, IJsonModel<EndpointBase>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EndpointBase>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        EndpointBase IJsonModel<EndpointBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownEndpointBase(document.RootElement, options);
        }

        internal static UnknownEndpointBase DeserializeUnknownEndpointBase(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownEndpointBase(type, credentials.Value, url, serializedAdditionalRawData);
        }
