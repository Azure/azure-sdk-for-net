...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class HttpHeaderCredentials : CredentialsBase
    {
        ...
        internal HttpHeaderCredentials(string type, string headerName, string headerValue, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            HeaderName = headerName;
            HeaderValue = headerValue;
