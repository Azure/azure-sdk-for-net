...
{
    public partial class EndpointBase : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EndpointBase DeserializeEndpointBase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
