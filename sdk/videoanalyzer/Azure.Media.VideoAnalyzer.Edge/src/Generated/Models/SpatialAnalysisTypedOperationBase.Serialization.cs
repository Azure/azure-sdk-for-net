...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnalysisTypedOperationBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SpatialAnalysisTypedOperationBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisTypedOperationBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpatialAnalysisTypedOperationBase>)} interface");
            }
        ...
        string IPersistableModel<SpatialAnalysisTypedOperationBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
