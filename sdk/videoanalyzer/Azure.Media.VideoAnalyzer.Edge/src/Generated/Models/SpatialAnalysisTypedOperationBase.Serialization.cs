...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class SpatialAnalysisTypedOperationBase : IUtf8JsonSerializable, IModelJsonSerializable<SpatialAnalysisTypedOperationBase>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SpatialAnalysisTypedOperationBase>(this, options.Format);
        ...
        internal static SpatialAnalysisTypedOperationBase DeserializeSpatialAnalysisTypedOperationBase(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SpatialAnalysisTypedOperationBase(type, debug.Value, calibrationConfiguration.Value, cameraConfiguration.Value, cameraCalibratorNodeConfiguration.Value, detectorNodeConfiguration.Value, trackerNodeConfiguration.Value, enableFaceMaskClassifier.Value, serializedAdditionalRawData);
        }
