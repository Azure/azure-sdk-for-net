...
{
    public partial class MethodRequest : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MethodRequest DeserializeMethodRequest(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
