...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class RemoteDeviceAdapterGetRequest : MethodRequestEmptyBodyBase
    {
        ...
        internal RemoteDeviceAdapterGetRequest(string methodName, string apiVersion, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, name, serializedAdditionalRawData)
        {
