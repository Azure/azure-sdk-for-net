...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PipelineTopologySetRequestBody>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<PipelineTopologySetRequestBody>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PipelineTopologySetRequestBody>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PipelineTopologySetRequestBody)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PipelineTopologySetRequestBody>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PipelineTopologySetRequestBody)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<PipelineTopologySetRequestBody>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
