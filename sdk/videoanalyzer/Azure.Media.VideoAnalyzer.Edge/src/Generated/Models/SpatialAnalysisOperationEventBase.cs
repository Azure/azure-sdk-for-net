...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class SpatialAnalysisOperationEventBase
    {
        ...
        internal SpatialAnalysisOperationEventBase(string threshold, SpatialAnalysisOperationFocus? focus, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Threshold = threshold;
            Focus = focus;
