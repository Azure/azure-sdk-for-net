...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class LineCrossingProcessor : ProcessorNodeBase
    {
        ...
        internal LineCrossingProcessor(string type, string name, IList<NodeInput> inputs, IList<NamedLineBase> lines, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, inputs, serializedAdditionalRawData)
        {
            Lines = lines;
