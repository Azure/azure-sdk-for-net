...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class UnsecuredEndpoint : EndpointBase
    {
        ...
        internal UnsecuredEndpoint(string type, CredentialsBase credentials, string url, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, credentials, url, serializedAdditionalRawData)
        {
