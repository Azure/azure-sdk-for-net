...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class SpatialAnalysisPersonCountEvent : IUtf8JsonSerializable, IJsonModel<SpatialAnalysisPersonCountEvent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisPersonCountEvent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpatialAnalysisPersonCountEvent>)} interface");
            }
