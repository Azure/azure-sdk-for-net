...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnalysisPersonCountEvent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SpatialAnalysisPersonCountEvent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisPersonCountEvent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SpatialAnalysisPersonCountEvent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
