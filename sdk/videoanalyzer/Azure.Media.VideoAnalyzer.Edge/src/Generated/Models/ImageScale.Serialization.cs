...
{
    public partial class ImageScale : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ImageScale DeserializeImageScale(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
