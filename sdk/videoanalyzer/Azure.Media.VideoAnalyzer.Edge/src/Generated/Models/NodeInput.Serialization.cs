...
{
    public partial class NodeInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NodeInput DeserializeNodeInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
