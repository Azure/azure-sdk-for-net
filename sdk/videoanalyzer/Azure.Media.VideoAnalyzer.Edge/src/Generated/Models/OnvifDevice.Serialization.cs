...
{
    public partial class OnvifDevice : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OnvifDevice DeserializeOnvifDevice(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
