...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class UnknownSinkNodeBase : SinkNodeBase
    {
        ...
        internal UnknownSinkNodeBase(string type, string name, IList<NodeInput> inputs, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, inputs, serializedAdditionalRawData)
        {
            Type = type ?? "Unknown";
        }
