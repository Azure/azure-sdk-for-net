...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class UnknownSpatialAnalysisOperationBase : SpatialAnalysisOperationBase
    {
        ...
        internal UnknownSpatialAnalysisOperationBase(string type, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            Type = type ?? "Unknown";
        }
