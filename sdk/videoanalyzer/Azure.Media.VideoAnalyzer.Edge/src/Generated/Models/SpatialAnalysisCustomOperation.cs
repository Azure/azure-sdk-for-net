...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class SpatialAnalysisCustomOperation : SpatialAnalysisOperationBase
    {
        ...
        internal SpatialAnalysisCustomOperation(string type, string extensionConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            ExtensionConfiguration = extensionConfiguration;
