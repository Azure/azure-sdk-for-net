...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    internal partial class PipelineTopologySetRequestBody : MethodRequest
    {
        ...
        internal PipelineTopologySetRequestBody(string methodName, string apiVersion, string name, SystemData systemData, PipelineTopologyProperties properties, Dictionary<string, BinaryData> rawData) : base(methodName, apiVersion, rawData)
        {
            Name = name;
