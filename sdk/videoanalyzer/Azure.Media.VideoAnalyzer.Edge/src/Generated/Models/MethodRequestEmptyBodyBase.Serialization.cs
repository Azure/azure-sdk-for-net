...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MethodRequestEmptyBodyBase>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<MethodRequestEmptyBodyBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MethodRequestEmptyBodyBase>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MethodRequestEmptyBodyBase)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MethodRequestEmptyBodyBase>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MethodRequestEmptyBodyBase)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<MethodRequestEmptyBodyBase>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
