...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class LivePipelineActivateRequest : MethodRequestEmptyBodyBase
    {
        ...
        internal LivePipelineActivateRequest(string methodName, string apiVersion, string name, Dictionary<string, BinaryData> rawData) : base(methodName, apiVersion, name, rawData)
        {
