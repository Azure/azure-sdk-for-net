...
{
    public partial class VideoSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VideoSink DeserializeVideoSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
