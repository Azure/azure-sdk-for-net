...
{
    public partial class RateControl : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RateControl DeserializeRateControl(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
