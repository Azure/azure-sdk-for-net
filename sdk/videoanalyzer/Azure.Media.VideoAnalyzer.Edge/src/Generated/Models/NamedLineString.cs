...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class NamedLineString : NamedLineBase
    {
        ...
        internal NamedLineString(string type, string name, string line, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, serializedAdditionalRawData)
        {
            Line = line;
