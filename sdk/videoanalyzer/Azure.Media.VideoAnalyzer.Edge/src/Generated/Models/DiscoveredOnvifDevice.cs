...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class DiscoveredOnvifDevice
    {
        ...
        internal DiscoveredOnvifDevice(string serviceIdentifier, string remoteIPAddress, IList<string> scopes, IList<string> endpoints, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
