...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class ImageFormatRaw : ImageFormatProperties
    {
        ...
        internal ImageFormatRaw(string type, ImageFormatRawPixelFormat pixelFormat, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            PixelFormat = pixelFormat;
