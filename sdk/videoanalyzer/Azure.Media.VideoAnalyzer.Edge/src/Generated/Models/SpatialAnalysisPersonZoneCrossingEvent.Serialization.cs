...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnalysisPersonZoneCrossingEvent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SpatialAnalysisPersonZoneCrossingEvent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisPersonZoneCrossingEvent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpatialAnalysisPersonZoneCrossingEvent>)} interface");
            }
        ...
        string IPersistableModel<SpatialAnalysisPersonZoneCrossingEvent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
