...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnalysisPersonLineCrossingLineEvents>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SpatialAnalysisPersonLineCrossingLineEvents>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisPersonLineCrossingLineEvents>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpatialAnalysisPersonLineCrossingLineEvents>)} interface");
            }
        ...
        string IPersistableModel<SpatialAnalysisPersonLineCrossingLineEvents>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
