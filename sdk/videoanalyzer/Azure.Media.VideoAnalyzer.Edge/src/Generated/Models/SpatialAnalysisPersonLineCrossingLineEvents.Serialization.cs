...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnalysisPersonLineCrossingLineEvents>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SpatialAnalysisPersonLineCrossingLineEvents IJsonModel<SpatialAnalysisPersonLineCrossingLineEvents>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SpatialAnalysisPersonLineCrossingLineEvents)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<SpatialAnalysisPersonLineCrossingLineEvents>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SpatialAnalysisPersonLineCrossingLineEvents IModel<SpatialAnalysisPersonLineCrossingLineEvents>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SpatialAnalysisPersonLineCrossingLineEvents>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
