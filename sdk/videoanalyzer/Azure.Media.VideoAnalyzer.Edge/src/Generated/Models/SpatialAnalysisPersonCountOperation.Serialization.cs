...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class SpatialAnalysisPersonCountOperation : IUtf8JsonSerializable, IJsonModel<SpatialAnalysisPersonCountOperation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnalysisPersonCountOperation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpatialAnalysisPersonCountOperation>)} interface");
            }
        ...
        SpatialAnalysisPersonCountOperation IJsonModel<SpatialAnalysisPersonCountOperation>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SpatialAnalysisPersonCountOperation)} does not support '{options.Format}' format.");
            }
