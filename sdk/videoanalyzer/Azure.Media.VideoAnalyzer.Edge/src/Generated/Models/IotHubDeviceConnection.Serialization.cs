...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotHubDeviceConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotHubDeviceConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotHubDeviceConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotHubDeviceConnection>)} interface");
            }
        ...
        string IPersistableModel<IotHubDeviceConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
