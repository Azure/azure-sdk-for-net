...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class OnvifDevice
    {
        ...
        internal OnvifDevice(OnvifHostName hostname, OnvifSystemDateTime systemDateTime, OnvifDns dns, IList<MediaProfile> mediaProfiles, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Hostname = hostname;
