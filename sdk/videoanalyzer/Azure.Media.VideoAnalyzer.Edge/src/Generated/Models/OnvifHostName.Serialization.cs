...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnvifHostName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OnvifHostName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OnvifHostName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<OnvifHostName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
