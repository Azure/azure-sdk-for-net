...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class GrpcExtensionDataTransfer : IUtf8JsonSerializable, IJsonModel<GrpcExtensionDataTransfer>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GrpcExtensionDataTransfer>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GrpcExtensionDataTransfer)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GrpcExtensionDataTransfer>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GrpcExtensionDataTransfer)} does not support '{options.Format}' format.");
            }
        }
