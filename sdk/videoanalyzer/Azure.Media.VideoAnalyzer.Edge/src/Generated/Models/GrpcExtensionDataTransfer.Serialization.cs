...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GrpcExtensionDataTransfer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GrpcExtensionDataTransfer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GrpcExtensionDataTransfer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GrpcExtensionDataTransfer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
