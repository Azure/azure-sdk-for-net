...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class LivePipelineProperties
    {
        ...
        internal LivePipelineProperties(string description, string topologyName, IList<ParameterDefinition> parameters, LivePipelineState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
