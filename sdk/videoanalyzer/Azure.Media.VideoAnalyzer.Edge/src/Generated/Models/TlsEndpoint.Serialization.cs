...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class TlsEndpoint : IUtf8JsonSerializable, IModelJsonSerializable<TlsEndpoint>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<TlsEndpoint>(this, options.Format);
        ...
        internal static TlsEndpoint DeserializeTlsEndpoint(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new TlsEndpoint(type, credentials.Value, url, trustedCertificates.Value, validationOptions.Value, serializedAdditionalRawData);
        }
