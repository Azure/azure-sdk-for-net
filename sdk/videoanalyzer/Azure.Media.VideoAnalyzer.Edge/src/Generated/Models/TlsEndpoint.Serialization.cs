...
{
    public partial class TlsEndpoint : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TlsEndpoint DeserializeTlsEndpoint(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
