...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class TlsEndpoint : IUtf8JsonSerializable, IJsonModel<TlsEndpoint>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<TlsEndpoint>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TlsEndpoint)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TlsEndpoint>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TlsEndpoint)} does not support '{options.Format}' format.");
            }
        }
