...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class MediaProfile
    {
        ...
        internal MediaProfile(string name, object mediaUri, VideoEncoderConfiguration videoEncoderConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            MediaUri = mediaUri;
