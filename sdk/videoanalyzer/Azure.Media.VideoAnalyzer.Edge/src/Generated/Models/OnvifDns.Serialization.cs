...
{
    public partial class OnvifDns : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OnvifDns DeserializeOnvifDns(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
