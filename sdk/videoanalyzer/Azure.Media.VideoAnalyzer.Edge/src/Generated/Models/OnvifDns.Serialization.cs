...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnvifDns>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OnvifDns>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OnvifDns>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OnvifDns>)} interface");
            }
        ...
        string IPersistableModel<OnvifDns>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
