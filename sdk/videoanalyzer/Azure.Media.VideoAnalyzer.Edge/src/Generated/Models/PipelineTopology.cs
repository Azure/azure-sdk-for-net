...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class PipelineTopology
    {
        ...
        internal PipelineTopology(string name, SystemData systemData, PipelineTopologyProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
