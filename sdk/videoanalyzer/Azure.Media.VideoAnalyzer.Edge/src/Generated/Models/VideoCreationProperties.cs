...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class VideoCreationProperties
    {
        ...
        internal VideoCreationProperties(string title, string description, string segmentLength, string retentionPeriod, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
