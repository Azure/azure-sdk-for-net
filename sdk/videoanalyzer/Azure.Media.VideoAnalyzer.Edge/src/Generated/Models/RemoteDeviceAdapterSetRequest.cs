...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class RemoteDeviceAdapterSetRequest : MethodRequest
    {
        ...
        internal RemoteDeviceAdapterSetRequest(string methodName, string apiVersion, RemoteDeviceAdapter remoteDeviceAdapter, Dictionary<string, BinaryData> rawData) : base(methodName, apiVersion, rawData)
        {
            RemoteDeviceAdapter = remoteDeviceAdapter;
