...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownProcessorNodeBase))]
    public abstract partial class ProcessorNodeBase
    {
        ...
        internal ProcessorNodeBase(string type, string name, IList<NodeInput> inputs, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
            Name = name;
            Inputs = inputs;
