...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class LivePipelineSetRequest : MethodRequest
    {
        ...
        internal LivePipelineSetRequest(string methodName, string apiVersion, LivePipeline livePipeline, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, serializedAdditionalRawData)
        {
            LivePipeline = livePipeline;
