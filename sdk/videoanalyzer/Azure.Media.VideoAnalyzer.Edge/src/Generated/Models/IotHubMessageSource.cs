...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class IotHubMessageSource : SourceNodeBase
    {
        ...
        internal IotHubMessageSource(string type, string name, string hubInputName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, serializedAdditionalRawData)
        {
