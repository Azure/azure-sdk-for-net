...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class HttpExtension : ExtensionProcessorBase
    {
        ...
        internal HttpExtension(string type, string name, IList<NodeInput> inputs, EndpointBase endpoint, ImageProperties image, SamplingOptions samplingOptions, Dictionary<string, BinaryData> rawData) : base(type, name, inputs, endpoint, image, samplingOptions, rawData)
        {
