...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class HttpExtension : ExtensionProcessorBase
    {
        ...
        internal HttpExtension(string type, string name, IList<NodeInput> inputs, IDictionary<string, BinaryData> serializedAdditionalRawData, EndpointBase endpoint, ImageProperties image, SamplingOptions samplingOptions) : base(type, name, inputs, serializedAdditionalRawData, endpoint, image, samplingOptions)
        {
            Type = type ?? "#Microsoft.VideoAnalyzer.HttpExtension";
        }

        /// <summary> Initializes a new instance of <see cref="HttpExtension"/> for deserialization. </summary>
        internal HttpExtension()
        {
        }
    }
}
