...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnalysisPersonLineCrossingOperation>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SpatialAnalysisPersonLineCrossingOperation IJsonModel<SpatialAnalysisPersonLineCrossingOperation>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SpatialAnalysisPersonLineCrossingOperation)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<SpatialAnalysisPersonLineCrossingOperation>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SpatialAnalysisPersonLineCrossingOperation IModel<SpatialAnalysisPersonLineCrossingOperation>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SpatialAnalysisPersonLineCrossingOperation>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
