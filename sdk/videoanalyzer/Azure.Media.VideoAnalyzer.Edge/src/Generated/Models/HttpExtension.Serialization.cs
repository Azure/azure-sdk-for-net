...
{
    public partial class HttpExtension : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HttpExtension DeserializeHttpExtension(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
