...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HttpExtension>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<HttpExtension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HttpExtension>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HttpExtension)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HttpExtension>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HttpExtension)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<HttpExtension>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
