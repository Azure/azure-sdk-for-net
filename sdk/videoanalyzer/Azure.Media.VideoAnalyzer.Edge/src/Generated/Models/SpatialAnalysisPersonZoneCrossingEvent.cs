...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class SpatialAnalysisPersonZoneCrossingEvent : SpatialAnalysisOperationEventBase
    {
        ...
        internal SpatialAnalysisPersonZoneCrossingEvent(string threshold, SpatialAnalysisOperationFocus? focus, SpatialAnalysisPersonZoneCrossingEventType? eventType, Dictionary<string, BinaryData> rawData) : base(threshold, focus, rawData)
        {
            EventType = eventType;
        }
