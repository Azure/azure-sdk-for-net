...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class SpatialAnalysisPersonZoneCrossingEvent : SpatialAnalysisOperationEventBase
    {
        ...
        internal SpatialAnalysisPersonZoneCrossingEvent(string threshold, SpatialAnalysisOperationFocus? focus, SpatialAnalysisPersonZoneCrossingEventType? eventType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(threshold, focus, serializedAdditionalRawData)
        {
            EventType = eventType;
        }
