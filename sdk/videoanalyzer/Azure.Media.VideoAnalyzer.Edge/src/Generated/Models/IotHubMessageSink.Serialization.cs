...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class IotHubMessageSink : IUtf8JsonSerializable
    {
        ...
        internal static new IotHubMessageSink FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeIotHubMessageSink(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<IotHubMessageSink>(this);
            return content;
        }
    }
}
