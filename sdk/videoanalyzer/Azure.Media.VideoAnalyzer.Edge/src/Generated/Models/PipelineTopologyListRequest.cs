...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class PipelineTopologyListRequest : MethodRequest
    {
        ...
        internal PipelineTopologyListRequest(string methodName, string apiVersion, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, serializedAdditionalRawData)
        {
