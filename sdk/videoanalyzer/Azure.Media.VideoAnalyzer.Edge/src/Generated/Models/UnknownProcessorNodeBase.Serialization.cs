...
{
    internal partial class UnknownProcessorNodeBase : IUtf8JsonSerializable, IJsonModel<ProcessorNodeBase>
    {
        ...
        ProcessorNodeBase IJsonModel<ProcessorNodeBase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownProcessorNodeBase(document.RootElement, options);
        }

        internal static UnknownProcessorNodeBase DeserializeUnknownProcessorNodeBase(JsonElement element, ModelReaderWriterOptions options = null)
        {
