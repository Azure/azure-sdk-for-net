...
{
    public partial class LivePipeline : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LivePipeline DeserializeLivePipeline(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
