...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class ObjectTrackingProcessor : ProcessorNodeBase
    {
        ...
        internal ObjectTrackingProcessor(string type, string name, IList<NodeInput> inputs, ObjectTrackingAccuracy? accuracy, Dictionary<string, BinaryData> rawData) : base(type, name, inputs, rawData)
        {
            Accuracy = accuracy;
