...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class ObjectTrackingProcessor : ProcessorNodeBase
    {
        ...
        internal ObjectTrackingProcessor(string type, string name, IList<NodeInput> inputs, ObjectTrackingAccuracy? accuracy, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, name, inputs, serializedAdditionalRawData)
        {
            Accuracy = accuracy;
