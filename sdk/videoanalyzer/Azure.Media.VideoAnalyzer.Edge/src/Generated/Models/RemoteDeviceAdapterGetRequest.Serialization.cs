...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class RemoteDeviceAdapterGetRequest : IUtf8JsonSerializable
    {
        ...
        internal static RemoteDeviceAdapterGetRequest DeserializeRemoteDeviceAdapterGetRequest(JsonElement element)
        {
            ...
            return new RemoteDeviceAdapterGetRequest(methodName, apiVersion, name);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static new RemoteDeviceAdapterGetRequest FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeRemoteDeviceAdapterGetRequest(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<RemoteDeviceAdapterGetRequest>(this);
            return content;
        }
    }
}
