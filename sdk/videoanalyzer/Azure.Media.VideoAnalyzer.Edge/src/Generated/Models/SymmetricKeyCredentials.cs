...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class SymmetricKeyCredentials : CredentialsBase
    {
        ...
        internal SymmetricKeyCredentials(string type, string key, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            Key = key;
