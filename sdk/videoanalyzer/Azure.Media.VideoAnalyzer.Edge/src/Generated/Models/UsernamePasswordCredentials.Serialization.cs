...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class UsernamePasswordCredentials : IUtf8JsonSerializable, IModelJsonSerializable<UsernamePasswordCredentials>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<UsernamePasswordCredentials>(this, options.Format);
        ...
        internal static UsernamePasswordCredentials DeserializeUsernamePasswordCredentials(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UsernamePasswordCredentials(type, username, password, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="UsernamePasswordCredentials"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="UsernamePasswordCredentials"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="UsernamePasswordCredentials"/>. </summary>
