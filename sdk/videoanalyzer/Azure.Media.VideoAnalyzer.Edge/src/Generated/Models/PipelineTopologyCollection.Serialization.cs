...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    public partial class PipelineTopologyCollection : IUtf8JsonSerializable, IModelJsonSerializable<PipelineTopologyCollection>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PipelineTopologyCollection>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<PipelineTopology>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="PipelineTopologyCollection"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PipelineTopologyCollection"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PipelineTopologyCollection"/>. </summary>
