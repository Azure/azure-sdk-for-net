...
{
    public partial class PipelineTopologyCollection : Core.IUtf8JsonSerializable
    {
        ...
        internal static PipelineTopologyCollection DeserializePipelineTopologyCollection(JsonElement element)
        {
            ...
            Core.Optional<IList<PipelineTopology>> value = default;
            ...
            return new PipelineTopologyCollection(Core.Optional.ToList(value), continuationToken.Value);
        }
    }
}
