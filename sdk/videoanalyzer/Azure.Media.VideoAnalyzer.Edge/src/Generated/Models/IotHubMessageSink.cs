...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class IotHubMessageSink : SinkNodeBase
    {
        ...
        internal IotHubMessageSink(string type, string name, IList<NodeInput> inputs, string hubOutputName, Dictionary<string, BinaryData> rawData) : base(type, name, inputs, rawData)
        {
            HubOutputName = hubOutputName;
