...
{
    public partial class FileSink : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FileSink DeserializeFileSink(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
