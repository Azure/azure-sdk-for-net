...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnvifDeviceGetRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OnvifDeviceGetRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OnvifDeviceGetRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<OnvifDeviceGetRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
