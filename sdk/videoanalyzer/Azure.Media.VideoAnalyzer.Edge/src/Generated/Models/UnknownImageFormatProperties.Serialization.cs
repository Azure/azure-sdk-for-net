...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    internal partial class UnknownImageFormatProperties : IUtf8JsonSerializable
    {
        ...
        internal static new UnknownImageFormatProperties FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownImageFormatProperties(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<UnknownImageFormatProperties>(this);
            return content;
        }
    }
}
