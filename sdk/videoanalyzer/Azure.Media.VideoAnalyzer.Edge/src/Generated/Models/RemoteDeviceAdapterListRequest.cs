...
namespace Azure.Media.VideoAnalyzer.Edge.Models
{
    ...
    public partial class RemoteDeviceAdapterListRequest : MethodRequest
    {
        ...
        internal RemoteDeviceAdapterListRequest(string methodName, string apiVersion, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(methodName, apiVersion, serializedAdditionalRawData)
        {
