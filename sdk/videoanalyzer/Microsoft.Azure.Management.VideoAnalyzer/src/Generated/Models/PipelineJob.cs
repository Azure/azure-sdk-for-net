...
namespace Microsoft.Azure.Management.VideoAnalyzer.Models
{
    ...
    public partial class PipelineJob : ProxyResource
    {
        /// <summary>
        ...
        public PipelineJob(string topologyName, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string description = default(string), PipelineJobState state = default(PipelineJobState), System.DateTime expiration = default(System.DateTime), PipelineJobError error = default(PipelineJobError), IList<ParameterDefinition> parameters = default(IList<ParameterDefinition>))
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "TopologyName");
            }
            if (Parameters != null)
            {
