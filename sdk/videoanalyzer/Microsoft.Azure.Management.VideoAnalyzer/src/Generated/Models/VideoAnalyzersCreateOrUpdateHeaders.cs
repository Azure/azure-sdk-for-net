...
namespace Microsoft.Azure.Management.VideoAnalyzer.Models
{
    ...
    /// </summary>
    public partial class VideoAnalyzersCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VideoAnalyzersCreateOrUpdateHeaders class.
        /// </summary>
        public VideoAnalyzersCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VideoAnalyzersCreateOrUpdateHeaders(int? retryAfter = default(int?), string location = default(string), string azureAsyncOperation = default(string))
        {
