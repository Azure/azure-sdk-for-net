...
namespace Microsoft.Azure.Management.VideoAnalyzer.Models
{
    ...
    /// </summary>
    public partial class VideoAnalyzersUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the VideoAnalyzersUpdateHeaders
        /// class.
        /// </summary>
        public VideoAnalyzersUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public VideoAnalyzersUpdateHeaders(int? retryAfter = default(int?), string location = default(string), string azureAsyncOperation = default(string))
        {
