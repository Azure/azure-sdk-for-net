...
namespace Microsoft.Azure.Management.VideoAnalyzer.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("#Microsoft.VideoAnalyzer.ProcessorNodeBase")]
    public partial class ProcessorNodeBase : NodeBase
    {
        /// <summary>
        ...
        public ProcessorNodeBase(string name, IList<NodeInput> inputs)
            : base(name)
        {
            Inputs = inputs;
            CustomInit();
