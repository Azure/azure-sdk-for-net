...
namespace Microsoft.Azure.Management.VideoAnalyzer.Models
{
    ...
    public partial class PrivateEndpointConnectionsCreateOrUpdateHeaders
    {
        ...
        /// status.</param>
        public PrivateEndpointConnectionsCreateOrUpdateHeaders(int? retryAfter = default(int?), string location = default(string), string azureAsyncOperation = default(string))
        {
