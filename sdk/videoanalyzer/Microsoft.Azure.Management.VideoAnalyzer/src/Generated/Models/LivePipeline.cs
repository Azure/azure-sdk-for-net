...
namespace Microsoft.Azure.Management.VideoAnalyzer.Models
{
    ...
    public partial class LivePipeline : ProxyResource
    {
        /// <summary>
        ...
        public LivePipeline(string topologyName, int bitrateKbps, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string description = default(string), LivePipelineState state = default(LivePipelineState), IList<ParameterDefinition> parameters = default(IList<ParameterDefinition>))
