...
namespace Microsoft.Azure.Management.VideoAnalyzer.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the VideoAnalyzerOperationStatus
        /// class.
        /// </summary>
        ...
        public VideoAnalyzerOperationStatus(string name, string id = default(string), string startTime = default(string), string endTime = default(string), string status = default(string), ErrorDetail error = default(ErrorDetail))
        {
            Name = name;
            Id = id;
            StartTime = startTime;
