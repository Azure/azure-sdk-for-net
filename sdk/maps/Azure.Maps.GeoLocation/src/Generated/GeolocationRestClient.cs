...
namespace Azure.Maps.GeoLocation
{
    internal partial class GeolocationRestClient
    {
        ...
        public async Task<Response<IpAddressToLocationResult>> GetLocationAsync(string ipAddress, JsonFormat? format = null, CancellationToken cancellationToken = default)
        {
            if (ipAddress == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ipAddress"/> is null. </exception>
        public Response<IpAddressToLocationResult> GetLocation(string ipAddress, JsonFormat? format = null, CancellationToken cancellationToken = default)
        {
            if (ipAddress == null)
            {
                throw new ArgumentNullException(nameof(ipAddress));
