...
namespace Azure.Provisioning.Maps
{
    ...
    internal partial class MapsPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new MapsPrivateLinkResourceProperties. </summary>
        public MapsPrivateLinkResourceProperties()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for MapsPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for MapsPrivateLinkResourceProperties that are not part of the generated code. </summary>
