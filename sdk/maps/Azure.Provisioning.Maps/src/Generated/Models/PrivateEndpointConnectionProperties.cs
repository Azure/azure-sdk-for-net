...
namespace Azure.Provisioning.Maps
{
    ...
    internal partial class PrivateEndpointConnectionProperties : ProvisionableConstruct
    {
        ...
        private MapsPrivateLinkServiceConnectionState _privateLinkServiceConnectionState;
        private BicepValue<MapsPrivateEndpointConnectionProvisioningState> _provisioningState;
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _privateLinkServiceConnectionState = DefineModelProperty<MapsPrivateLinkServiceConnectionState>(nameof(PrivateLinkServiceConnectionState), new string[] { "privateLinkServiceConnectionState" }, isRequired: true);
            _provisioningState = DefineProperty<MapsPrivateEndpointConnectionProvisioningState>(nameof(ProvisioningState), new string[] { "provisioningState" }, isOutput: true);
