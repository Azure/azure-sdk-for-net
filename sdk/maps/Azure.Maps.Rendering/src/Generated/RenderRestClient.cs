...
namespace Azure.Maps.Rendering
{
    internal partial class RenderRestClient
    {
        ...
        public RenderRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null, string clientId = null, string apiVersion = "1.0")
        {
        ...
        internal HttpMessage CreateGetMapStaticImageRequest(RasterTileFormat? format, MapImageLayer? layer, MapImageStyle? style, int? zoom, IEnumerable<double> center, IEnumerable<double> boundingBox, int? height, int? width, string language, LocalizedMapView? localizedMapView, IEnumerable<string> pins, IEnumerable<string> path)
        {
            ...
            if (boundingBox != null)
            {
                uri.AppendQueryDelimited("bbox", boundingBox, ",", true);
            }
            if (height != null)
            {
        ...
        /// <param name="zoom"> Desired zoom level of the map. Zoom value must be in the range: 0-20 (inclusive). Default value is 12.&lt;br&gt;&lt;br&gt;Please see [Zoom Levels and Tile Grid](https://docs.microsoft.com/en-us/azure/location-based-services/zoom-levels-and-tile-grid) for details. </param>
        /// <param name="center">
        ...
        public async Task<ResponseWithHeaders<Stream, RenderGetMapStaticImageHeaders>> GetMapStaticImageAsync(RasterTileFormat? format = null, MapImageLayer? layer = null, MapImageStyle? style = null, int? zoom = null, IEnumerable<double> center = null, IEnumerable<double> boundingBox = null, int? height = null, int? width = null, string language = null, LocalizedMapView? localizedMapView = null, IEnumerable<string> pins = null, IEnumerable<string> path = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetMapStaticImageRequest(format, layer, style, zoom, center, boundingBox, height, width, language, localizedMapView, pins, path);
        ...
        internal HttpMessage CreateGetMapTileRequest(MapTileFormat format, MapTileLayer layer, MapTileStyle style, MapTileIndex tileIndex, MapTileSize? tileSize, string language, LocalizedMapView? localizedMapView)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            uri.AppendQuery("api-version", _apiVersion, true);
            uri.AppendQuery("layer", layer.ToString(), true);
        ...
        /// <param name="layer"> Map layer requested. Possible values are basic, hybrid, labels and terra. </param>
        /// <param name="style"> Map style to be returned. Possible values are main, dark, and shaded_relief. </param>
        ...
        public async Task<ResponseWithHeaders<Stream, RenderGetMapTileHeaders>> GetMapTileAsync(MapTileFormat format, MapTileLayer layer, MapTileStyle style, MapTileIndex tileIndex, MapTileSize? tileSize = null, string language = null, LocalizedMapView? localizedMapView = null, CancellationToken cancellationToken = default)
        {
            if (tileIndex == null)
            {
            ...
            using var message = CreateGetMapTileRequest(format, layer, style, tileIndex, tileSize, language, localizedMapView);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tileIndex"/> is null. </exception>
        public ResponseWithHeaders<Stream, RenderGetMapTileHeaders> GetMapTile(MapTileFormat format, MapTileLayer layer, MapTileStyle style, MapTileIndex tileIndex, MapTileSize? tileSize = null, string language = null, LocalizedMapView? localizedMapView = null, CancellationToken cancellationToken = default)
        {
            if (tileIndex == null)
            {
                throw new ArgumentNullException(nameof(tileIndex));
        ...
        internal HttpMessage CreateGetMapImageryTileRequest(MapTileIndex tileIndex, RasterTileFormat? format, MapImageryStyle? style)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/map/imagery/", false);
            uri.AppendPath(format.Value.ToString(), true);
            uri.AppendQuery("api-version", _apiVersion, true);
            if (style != null)
            {
            ...
            request.Headers.Add("Accept", "application/json, image/jpeg, image/png");
            return message;
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tileIndex"/> is null. </exception>
        public async Task<ResponseWithHeaders<Stream, RenderGetMapImageryTileHeaders>> GetMapImageryTileAsync(MapTileIndex tileIndex, RasterTileFormat? format = null, MapImageryStyle? style = null, CancellationToken cancellationToken = default)
        {
            if (tileIndex == null)
            {
                throw new ArgumentNullException(nameof(tileIndex));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tileIndex"/> is null. </exception>
        public ResponseWithHeaders<Stream, RenderGetMapImageryTileHeaders> GetMapImageryTile(MapTileIndex tileIndex, RasterTileFormat? format = null, MapImageryStyle? style = null, CancellationToken cancellationToken = default)
        {
            if (tileIndex == null)
            {
                throw new ArgumentNullException(nameof(tileIndex));
