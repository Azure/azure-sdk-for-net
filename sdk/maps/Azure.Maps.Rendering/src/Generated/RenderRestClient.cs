...
namespace Azure.Maps.Rendering
{
    internal partial class RenderRestClient
    {
        ...
        /// <param name="apiVersion"> Api Version. The default is "2022-08-01". </param>
        ...
        /// </summary>
        /// <param name="format"> Desired format of the response. Possible value: png. The default is AutoRest.CSharp.Output.Models.Types.EnumTypeValue. </param>
