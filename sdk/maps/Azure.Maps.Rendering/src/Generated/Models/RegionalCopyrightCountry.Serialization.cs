...
namespace Azure.Maps.Rendering
{
    ...
    {
        internal static RegionalCopyrightCountry DeserializeRegionalCopyrightCountry(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
