...
namespace Azure.Maps.Rendering
{
    ...
    public partial class MapTileSet
    {
        ...
        internal MapTileSet(string tileJsonVersion, string tileSetName, string tileSetDescription, string tileSetVersion, string copyrightAttribution, string template, string mapTileLegend, string schemeInternal, IReadOnlyList<string> tileEndpoints, IReadOnlyList<string> grids, IReadOnlyList<string> geoJsonDataFiles, int? minZoomLevel, int? maxZoomLevel, IReadOnlyList<float> boundsInternal, IReadOnlyList<float> centerInternal, Dictionary<string, BinaryData> rawData)
        {
