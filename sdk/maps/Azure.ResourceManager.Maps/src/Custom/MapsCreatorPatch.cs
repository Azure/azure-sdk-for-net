...
{
    /// <summary>
    /// Backward compatibility shim: the TypeSpec spec defines storageUnits as required (int32),
    /// but the previous GA SDK (1.1.0) exposed it as nullable (int?). This preserves the
    /// nullable type to avoid a breaking change for existing callers.
    /// </summary>
