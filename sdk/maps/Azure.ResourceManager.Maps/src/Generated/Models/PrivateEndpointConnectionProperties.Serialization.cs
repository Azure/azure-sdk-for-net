...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            MapsPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default;
            MapsPrivateEndpointConnectionProvisioningState? provisioningState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    privateLinkServiceConnectionState = MapsPrivateLinkServiceConnectionState.DeserializeMapsPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new MapsPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
