...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    public partial class MapsAccountPatch
    {
        ...
        internal MapsAccountPatch(IDictionary<string, string> tags, MapsAccountKind? kind, MapsSku sku, ManagedServiceIdentity identity, Guid? uniqueId, bool? disableLocalAuth, string provisioningState, IList<MapsLinkedResource> linkedResources, CorsRules cors, Dictionary<string, BinaryData> rawData)
        {
            Tags = tags;
            Kind = kind;
            Sku = sku;
