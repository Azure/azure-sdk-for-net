...
{
    public partial class MapsAccountData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MapsAccountData DeserializeMapsAccountData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
