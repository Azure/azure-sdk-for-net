...
namespace Azure.ResourceManager.Maps
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsAccountData>)} interface");
            }
        ...
        string IPersistableModel<MapsAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
