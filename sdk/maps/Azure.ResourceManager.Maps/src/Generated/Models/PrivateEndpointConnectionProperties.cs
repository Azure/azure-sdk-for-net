...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties
    {
        ...
        public PrivateEndpointConnectionProperties(MapsPrivateLinkServiceConnectionState privateLinkServiceConnectionState)
        {
        ...
        internal PrivateEndpointConnectionProperties(IReadOnlyList<string> groupIds, PrivateEndpoint privateEndpoint, MapsPrivateLinkServiceConnectionState privateLinkServiceConnectionState, MapsPrivateEndpointConnectionProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GroupIds = groupIds;
        ...
        public MapsPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState { get; set; }

        /// <summary> The provisioning state of the private endpoint connection resource. </summary>
        public MapsPrivateEndpointConnectionProvisioningState? ProvisioningState { get; }
