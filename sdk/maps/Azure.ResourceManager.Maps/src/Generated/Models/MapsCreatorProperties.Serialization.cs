...
{
    public partial class MapsCreatorProperties : IUtf8JsonSerializable, IJsonModel<MapsCreatorProperties>, IPersistableModel<MapsCreatorProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  storageUnits:");
                builder.AppendLine($" '{StorageUnits.ToString()}'");
            }
