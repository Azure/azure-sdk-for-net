...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsCreatorProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsCreatorProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsCreatorProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsCreatorProperties>)} interface");
            }
        ...
        string IPersistableModel<MapsCreatorProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
