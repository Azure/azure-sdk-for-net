...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsAccounts>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsAccounts>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsAccounts>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsAccounts>)} interface");
            }
        ...
        string IPersistableModel<MapsAccounts>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
