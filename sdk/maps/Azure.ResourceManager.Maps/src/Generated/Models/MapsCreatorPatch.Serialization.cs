...
namespace Azure.ResourceManager.Maps.Models
{
    public partial class MapsCreatorPatch : IUtf8JsonSerializable, IJsonModel<MapsCreatorPatch>
    {
        ...
        void IJsonModel<MapsCreatorPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MapsCreatorPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MapsCreatorPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MapsCreatorPatch)} does not support '{options.Format}' format.");
            }
        }
