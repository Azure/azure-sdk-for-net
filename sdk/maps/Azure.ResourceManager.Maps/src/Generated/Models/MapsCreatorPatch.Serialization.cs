...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsCreatorPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsCreatorPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsCreatorPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsCreatorPatch>)} interface");
            }
        ...
        string IPersistableModel<MapsCreatorPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
