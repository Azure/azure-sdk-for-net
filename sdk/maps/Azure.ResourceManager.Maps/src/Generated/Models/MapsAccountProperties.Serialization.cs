...
namespace Azure.ResourceManager.Maps.Models
{
    public partial class MapsAccountProperties : IUtf8JsonSerializable, IModelJsonSerializable<MapsAccountProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MapsAccountProperties>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MapsAccountProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MapsAccountProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MapsAccountProperties"/>. </summary>
