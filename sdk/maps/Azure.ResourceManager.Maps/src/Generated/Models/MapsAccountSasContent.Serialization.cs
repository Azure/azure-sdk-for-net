...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsAccountSasContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsAccountSasContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsAccountSasContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsAccountSasContent>)} interface");
            }
        ...
        string IPersistableModel<MapsAccountSasContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
