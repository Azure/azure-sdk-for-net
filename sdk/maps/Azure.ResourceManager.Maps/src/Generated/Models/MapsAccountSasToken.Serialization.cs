...
namespace Azure.ResourceManager.Maps.Models
{
    public partial class MapsAccountSasToken : IUtf8JsonSerializable, IJsonModel<MapsAccountSasToken>
    {
        ...
        void IJsonModel<MapsAccountSasToken>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MapsAccountSasToken)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MapsAccountSasToken>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MapsAccountSasToken)} does not support '{options.Format}' format.");
            }
        }
