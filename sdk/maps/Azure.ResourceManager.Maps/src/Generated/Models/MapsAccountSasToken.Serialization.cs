...
{
    public partial class MapsAccountSasToken : IUtf8JsonSerializable, IJsonModel<MapsAccountSasToken>, IPersistableModel<MapsAccountSasToken>
    {
        ...
        void IJsonModel<MapsAccountSasToken>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MapsAccountSasToken)} does not support '{format}' format.");
            }
