...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    public partial class MapsAccountSasContent
    {
        ...
        internal MapsAccountSasContent(MapsSigningKey signingKey, string principalId, IList<string> regions, int maxRatePerSecond, string start, string expiry, Dictionary<string, BinaryData> rawData)
        {
            SigningKey = signingKey;
            PrincipalId = principalId;
            Regions = regions;
