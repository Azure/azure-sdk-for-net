...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    public partial class MapsAccountSasContent
    {
        ...
        internal MapsAccountSasContent(MapsSigningKey signingKey, string principalId, IList<string> regions, int maxRatePerSecond, string start, string expiry, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SigningKey = signingKey;
            PrincipalId = principalId;
            Regions = regions;
        ...
        /// <summary> The principal Id also known as the object Id of a User Assigned Managed Identity currently assigned to the Maps Account. To assign a Managed Identity of the account, use operation Create or Update an assign a User Assigned Identity resource Id. </summary>
