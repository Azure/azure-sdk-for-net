...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsCorsRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsCorsRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsCorsRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsCorsRule>)} interface");
            }
        ...
        string IPersistableModel<MapsCorsRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
