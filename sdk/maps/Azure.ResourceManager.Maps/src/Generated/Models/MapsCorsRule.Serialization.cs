...
{
    public partial class MapsCorsRule : IUtf8JsonSerializable, IJsonModel<MapsCorsRule>, IPersistableModel<MapsCorsRule>
    {
        ...
        void IJsonModel<MapsCorsRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MapsCorsRule)} does not support '{format}' format.");
            }
