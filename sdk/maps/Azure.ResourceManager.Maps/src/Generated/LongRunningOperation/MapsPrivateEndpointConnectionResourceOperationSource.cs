...
{
    /// <summary></summary>
    internal partial class MapsPrivateEndpointConnectionResourceOperationSource : IOperationSource<MapsPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MapsPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
