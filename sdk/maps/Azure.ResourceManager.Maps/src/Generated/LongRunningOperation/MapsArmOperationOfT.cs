...
namespace Azure.ResourceManager.Maps
{
    internal partial class MapsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal MapsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
