...
namespace Azure.ResourceManager.Maps
{
    internal partial class MapsArmOperation : ArmOperation
    {
        ...
        internal MapsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
