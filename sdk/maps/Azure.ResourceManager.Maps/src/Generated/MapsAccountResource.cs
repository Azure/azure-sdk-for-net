...
namespace Azure.ResourceManager.Maps
{
    ...
    public partial class MapsAccountResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<MapsAccountResource>> UpdateAsync(WaitUntil waitUntil, MapsAccountData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _accountsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, MapsAccountData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MapsAccountData> response = Response.FromValue(MapsAccountData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<MapsAccountResource> Update(WaitUntil waitUntil, MapsAccountData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
