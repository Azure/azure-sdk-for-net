...
namespace Azure.ResourceManager.Maps
{
    ...
    public partial class MapsCreatorResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<MapsCreatorResource>> UpdateAsync(WaitUntil waitUntil, MapsCreatorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _creatorsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, MapsCreatorData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MapsCreatorData> response = Response.FromValue(MapsCreatorData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<MapsCreatorResource> Update(WaitUntil waitUntil, MapsCreatorData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
