...
namespace Azure.ResourceManager.Maps.Models
{
    ...
    public static partial class ArmMapsModelFactory
    {
        ...
        /// <param name="mapsCorsRuleValue"> Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service. </param>
        /// <returns> A new <see cref="Models.MapsAccountProperties"/> instance for mocking. </returns>
        public static MapsAccountProperties MapsAccountProperties(Guid? uniqueId = null, bool? disableLocalAuth = null, string provisioningState = null, IEnumerable<MapsLinkedResource> linkedResources = null, IEnumerable<CorsRule> mapsCorsRuleValue = null)
        {
            linkedResources ??= new List<MapsLinkedResource>();
            mapsCorsRuleValue ??= new List<CorsRule>();

            return new MapsAccountProperties(uniqueId, disableLocalAuth, provisioningState, linkedResources?.ToList(), mapsCorsRuleValue != null ? new MapsCorsRule(mapsCorsRuleValue?.ToList()) : null);
        }
