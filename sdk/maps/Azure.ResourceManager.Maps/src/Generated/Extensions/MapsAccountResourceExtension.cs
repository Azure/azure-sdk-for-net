...
namespace Azure.ResourceManager.Maps.Mock
{
    ...
    public partial class MapsAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MapsAccountResourceExtension"/> class for mocking. </summary>
        protected MapsAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MapsAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MapsAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MapsAccountResource> GetMapsAccountsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new MapsAccountResource(Client, MapsAccountData.DeserializeMapsAccountData(e)), MapsAccountAccountsClientDiagnostics, Pipeline, "MapsAccountResourceExtension.GetMapsAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<MapsAccountResource> GetMapsAccounts(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MapsAccountAccountsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MapsAccountAccountsRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new MapsAccountResource(Client, MapsAccountData.DeserializeMapsAccountData(e)), MapsAccountAccountsClientDiagnostics, Pipeline, "MapsAccountResourceExtension.GetMapsAccounts", "value", "nextLink", cancellationToken);
        }
    }
}
