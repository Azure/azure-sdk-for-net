...
namespace Azure.ResourceManager.Maps.Mocking
{
    ...
    internal partial class MapsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MapsArmClientMockingExtension"/> class for mocking. </summary>
        protected MapsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MapsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MapsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MapsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
