...
namespace Azure.ResourceManager.Maps
{
    internal partial class AccountsGetByResourceGroupCollectionResultOfT : Pageable<MapsAccountData>
    {
        ...
        public AccountsGetByResourceGroupCollectionResultOfT(Accounts client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
