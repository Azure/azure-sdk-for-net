...
{
    internal partial class CreatorsGetByAccountCollectionResultOfT : Pageable<MapsCreatorData>
    {
        private readonly Creators _client;
        ...
        /// <returns> The pages of CreatorsGetByAccountCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<MapsCreatorData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                MapsCreatorListResult result = MapsCreatorListResult.FromResponse(response);
                yield return Page<MapsCreatorData>.FromValues((IReadOnlyList<MapsCreatorData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
