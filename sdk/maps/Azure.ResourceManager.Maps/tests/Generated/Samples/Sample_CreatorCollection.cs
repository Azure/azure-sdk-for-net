...
{
    public partial class Sample_CreatorCollection
    {
        ...
        public async Task GetAll_ListCreatorResourcesByAccount()
        {
            ...
            // get the collection of this CreatorResource
            CreatorCollection collection = mapsAccount.GetCreators();

            // invoke the operation and iterate over the result
            await foreach (CreatorResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                CreatorData resourceData = item.Data;
        ...
        public async Task CreateOrUpdate_CreateCreatorResource()
        {
            ...
            CreatorData data = new CreatorData(new AzureLocation("eastus2"), new CreatorProperties(5))
            {
                Tags =
{
["test"] = "true",
            ...
            ArmOperation<CreatorResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, creatorName, data);
            CreatorResource result = lro.Value;
        ...
        public async Task Get_GetCreatorResource()
        {
            ...
            // invoke the operation
            string creatorName = "myCreator";
            CreatorResource result = await collection.GetAsync(creatorName);
