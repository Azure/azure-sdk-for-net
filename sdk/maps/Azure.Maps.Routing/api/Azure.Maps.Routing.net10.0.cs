...
namespace Azure.Maps.Routing.Models
{
    ...
    public static partial class MapsRoutingModelFactory
    {
        ...
        public static Azure.Maps.Routing.Models.RouteDirectionsBatchResult RouteDirectionsBatchResult(int? successfulRequests = default(int?), int? totalRequests = default(int?), System.Collections.Generic.IEnumerable<Azure.Maps.Routing.Models.RouteDirectionsBatchItemResponse> results = null) { throw null; }
