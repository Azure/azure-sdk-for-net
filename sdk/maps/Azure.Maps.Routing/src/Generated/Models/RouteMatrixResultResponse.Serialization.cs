...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        internal static RouteMatrixResultResponse DeserializeRouteMatrixResultResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
