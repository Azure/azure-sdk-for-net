...
namespace Azure.Maps.Routing.Models
{
    ...
    public partial class RouteInstructionGroup
    {
        ...
        internal RouteInstructionGroup(int? firstInstructionIndex, int? lastInstructionIndex, int? groupLengthInMeters, string groupMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
