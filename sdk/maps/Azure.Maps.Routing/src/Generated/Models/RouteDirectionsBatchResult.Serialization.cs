...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        internal static RouteDirectionsBatchResult DeserializeRouteDirectionsBatchResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
