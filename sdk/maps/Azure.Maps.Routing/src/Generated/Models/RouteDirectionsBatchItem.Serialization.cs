...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        internal static RouteDirectionsBatchItem DeserializeRouteDirectionsBatchItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
