...
namespace Azure.Maps.Routing.Models
{
    ...
    internal partial class GeoJsonFeature : GeoJsonObject
    {
        ...
        internal GeoJsonFeature(GeoJsonObjectType type, GeoJsonGeometry geometry, object properties, string id, string featureType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(type, serializedAdditionalRawData)
        {
            Geometry = geometry;
