...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteRangeResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouteRangeResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteRangeResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RouteRangeResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
