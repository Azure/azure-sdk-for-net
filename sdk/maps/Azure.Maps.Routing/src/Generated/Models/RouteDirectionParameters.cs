...
namespace Azure.Maps.Routing
{
    ...
    public partial class RouteDirectionParameters
    {
        ...
        internal RouteDirectionParameters(GeoJsonGeometryCollection geoJsonSupportingPoints, IList<string> avoidVignette, IList<string> allowVignette, GeoJsonMultiPolygon geoJsonAvoidAreas, Dictionary<string, BinaryData> rawData)
        {
