...
namespace Azure.Maps.Routing.Models
{
    ...
    internal partial class GeoJsonLineString : GeoJsonGeometry
    {
        ...
        /// <param name="coordinates"> Coordinates for the `GeoJson LineString` geometry. </param>
        internal GeoJsonLineString(GeoJsonObjectType type, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<IList<double>> coordinates) : base(type, serializedAdditionalRawData)
        {
