...
namespace Azure.Maps.Routing.Models
{
    ...
    public partial class RouteData
    {
        ...
        internal RouteData(RouteSummary summary, IReadOnlyList<RouteLeg> legs, IReadOnlyList<RouteSection> sections, RouteGuidance guidance, Dictionary<string, BinaryData> rawData)
        {
            Summary = summary;
            Legs = legs;
            Sections = sections;
