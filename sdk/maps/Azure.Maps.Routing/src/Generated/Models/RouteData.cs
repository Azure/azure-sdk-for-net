...
namespace Azure.Maps.Routing.Models
{
    ...
    public partial class RouteData
    {
        ...
        internal RouteData(RouteSummary summary, IReadOnlyList<RouteLeg> legs, IReadOnlyList<RouteSection> sections, RouteGuidance guidance, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Summary = summary;
            Legs = legs;
            Sections = sections;
