...
namespace Azure.Maps.Routing.Models
{
    public partial class RouteRange
    {
        internal static RouteRange DeserializeRouteRange(JsonElement element)
        {
            ...
            Core.Optional<LatLongPair> center = default;
            Core.Optional<IReadOnlyList<LatLongPair>> boundary = default;
            ...
            return new RouteRange(center.Value, Core.Optional.ToList(boundary));
        }
    }
}
