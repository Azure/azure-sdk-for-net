...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteMatrix>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<RouteMatrix>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RouteMatrix>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RouteMatrix)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RouteMatrix>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RouteMatrix)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<RouteMatrix>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
