...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteInstruction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouteInstruction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteInstruction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RouteInstruction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
