...
{
    public partial class RouteInstruction : IUtf8JsonSerializable, IModelJsonSerializable<RouteInstruction>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<RouteInstruction>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<RouteInstruction>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RouteInstruction>(this, options.Format);
            ...
            if (Optional.IsDefined(_Point))
            {
                ...
                {
                    ((IModelJsonSerializable<LatLongPair>)_Point).Serialize(writer, options);
                }
            }
        ...
        internal static RouteInstruction DeserializeRouteInstruction(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        RouteInstruction IModelJsonSerializable<RouteInstruction>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RouteInstruction>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeRouteInstruction(doc.RootElement, options);
        }

        BinaryData IModelSerializable<RouteInstruction>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RouteInstruction>(this, options.Format);
        ...
        RouteInstruction IModelSerializable<RouteInstruction>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RouteInstruction>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="RouteInstruction"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RouteInstruction"/> to convert. </param>
        public static implicit operator RequestContent(RouteInstruction model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RouteInstruction"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator RouteInstruction(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeRouteInstruction(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
