...
namespace Azure.Maps.Routing.Models
{
    internal partial class GeoJsonPoint : IUtf8JsonSerializable, IModelJsonSerializable<GeoJsonPoint>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GeoJsonPoint>(this, options.Format);
        ...
        internal static GeoJsonPoint DeserializeGeoJsonPoint(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GeoJsonPoint(type, coordinates, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="GeoJsonPoint"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GeoJsonPoint"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GeoJsonPoint"/>. </summary>
