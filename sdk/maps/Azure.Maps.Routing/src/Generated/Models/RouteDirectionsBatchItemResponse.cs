...
namespace Azure.Maps.Routing.Models
{
    ...
    public partial class RouteDirectionsBatchItemResponse : RouteDirections
    {
        ...
        internal RouteDirectionsBatchItemResponse(string formatVersion, IReadOnlyList<RouteData> routes, IReadOnlyList<RouteOptimizedWaypoint> optimizedWaypoints, RouteReport report, ErrorDetail errorDetail, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(formatVersion, routes, optimizedWaypoints, report, serializedAdditionalRawData)
        {
