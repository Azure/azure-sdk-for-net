...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeoJsonLineStringData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GeoJsonLineStringData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GeoJsonLineStringData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GeoJsonLineStringData>)} interface");
            }
        ...
        string IPersistableModel<GeoJsonLineStringData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
