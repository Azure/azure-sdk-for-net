...
namespace Azure.Maps.Routing.Models
{
    internal partial class GeoJsonMultiLineString : IUtf8JsonSerializable, IJsonModel<GeoJsonMultiLineString>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GeoJsonMultiLineString>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GeoJsonMultiLineString)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GeoJsonMultiLineString>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GeoJsonMultiLineString)} does not support '{options.Format}' format.");
            }
        }
