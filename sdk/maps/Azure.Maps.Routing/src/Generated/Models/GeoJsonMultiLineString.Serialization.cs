...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeoJsonMultiLineString>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GeoJsonMultiLineString>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GeoJsonMultiLineString>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GeoJsonMultiLineString>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
