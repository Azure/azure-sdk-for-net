...
namespace Azure.Maps.Routing.Models
{
    public partial class RouteDirectionsBatchItemResponse : IUtf8JsonSerializable, IJsonModel<RouteDirectionsBatchItemResponse>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteDirectionsBatchItemResponse>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RouteDirectionsBatchItemResponse>)} interface");
            }
