...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteDirectionsBatchItemResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouteDirectionsBatchItemResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteDirectionsBatchItemResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RouteDirectionsBatchItemResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
