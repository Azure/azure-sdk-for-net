...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteDirections>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouteDirections>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteDirections>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RouteDirections>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
