...
namespace Azure.Maps.Routing.Models
{
    ...
    internal partial class GeoJsonFeatureData
    {
        ...
        internal GeoJsonFeatureData(GeoJsonGeometry geometry, object properties, string id, string featureType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Geometry = geometry;
