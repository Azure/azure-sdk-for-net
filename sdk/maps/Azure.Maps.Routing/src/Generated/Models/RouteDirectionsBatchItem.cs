...
namespace Azure.Maps.Routing.Models
{
    ...
    internal partial class RouteDirectionsBatchItem : BatchResultItem
    {
        ...
        internal RouteDirectionsBatchItem(int? statusCode, RouteDirectionsBatchItemResponse response, Dictionary<string, BinaryData> rawData) : base(statusCode, rawData)
        {
            Response = response;
        }
