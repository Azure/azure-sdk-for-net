...
namespace Azure.Maps.Routing.Models
{
    ...
    internal partial class RouteDirectionsBatchItem : BatchResultItem
    {
        ...
        internal RouteDirectionsBatchItem(int? statusCode, RouteDirectionsBatchItemResponse response, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(statusCode, serializedAdditionalRawData)
        {
            Response = response;
        }
