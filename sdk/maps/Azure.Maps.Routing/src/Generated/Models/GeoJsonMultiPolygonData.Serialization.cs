...
namespace Azure.Maps.Routing.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeoJsonMultiPolygonData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GeoJsonMultiPolygonData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GeoJsonMultiPolygonData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GeoJsonMultiPolygonData>)} interface");
            }
        ...
        string IPersistableModel<GeoJsonMultiPolygonData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
