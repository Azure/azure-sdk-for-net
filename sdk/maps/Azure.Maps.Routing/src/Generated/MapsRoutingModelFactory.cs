...
namespace Azure.Maps.Routing.Models
{
    ...
    public static partial class MapsRoutingModelFactory
    {
        ...
        public static RouteMatrixResult RouteMatrixResult(string formatVersion = null, IEnumerable<IList<RouteMatrix>> matrix = null, RouteMatrixSummary summary = null)
        {
            ...
            return new RouteMatrixResult(formatVersion, matrix?.ToList(), summary, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteLegSummary(lengthInMeters, travelTimeInSeconds, trafficDelayInSeconds, departureTime, arrivalTime, noTrafficTravelTimeInSeconds, historicTrafficTravelTimeInSeconds, liveTrafficIncidentsTravelTimeInSeconds, fuelConsumptionInLiters, batteryConsumptionInKwH, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteMatrixSummary(successfulRoutes, totalRoutes, new Dictionary<string, BinaryData>());
        }
        ...
        public static RouteDirections RouteDirections(string formatVersion = null, IEnumerable<RouteData> routes = null, IEnumerable<RouteOptimizedWaypoint> optimizedWaypoints = null, RouteReport report = null)
        {
            ...
            return new RouteDirections(formatVersion, routes?.ToList(), optimizedWaypoints?.ToList(), report, new Dictionary<string, BinaryData>());
        }
        ...
        public static RouteData RouteData(RouteSummary summary = null, IEnumerable<RouteLeg> legs = null, IEnumerable<RouteSection> sections = null, RouteGuidance guidance = null)
        {
            ...
            return new RouteData(summary, legs?.ToList(), sections?.ToList(), guidance, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteSection(startPointIndex, endPointIndex, sectionType, travelMode, simpleCategory, effectiveSpeedInKmh, delayInSeconds, delayMagnitude, tec, new Dictionary<string, BinaryData>());
        }
        ...
        public static RouteSectionTec RouteSectionTec(int? effectCode = null, IEnumerable<RouteSectionTecCause> causes = null)
        {
            ...
            return new RouteSectionTec(effectCode, causes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteSectionTecCause(mainCauseCode, subCauseCode, new Dictionary<string, BinaryData>());
        }
        ...
        public static RouteGuidance RouteGuidance(IEnumerable<RouteInstruction> instructions = null, IEnumerable<RouteInstructionGroup> instructionGroups = null)
        {
            ...
            return new RouteGuidance(instructions?.ToList(), instructionGroups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteInstructionGroup(firstInstructionIndex, lastInstructionIndex, groupLengthInMeters, groupMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteOptimizedWaypoint(providedIndex, optimizedIndex, new Dictionary<string, BinaryData>());
        }
        ...
        public static RouteReport RouteReport(IEnumerable<EffectiveSetting> effectiveSettings = null)
        {
            ...
            return new RouteReport(effectiveSettings?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EffectiveSetting(key, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouteRangeResult(formatVersion, reachableRange, report, new Dictionary<string, BinaryData>());
        }
    }
}
