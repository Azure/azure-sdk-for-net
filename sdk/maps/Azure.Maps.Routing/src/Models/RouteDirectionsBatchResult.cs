...
namespace Azure.Maps.Routing.Models
{
    ...
    public partial class RouteDirectionsBatchResult : BatchResult
    {
        ...
        internal RouteDirectionsBatchResult(BatchResultSummary batchSummary, IReadOnlyList<RouteDirectionsBatchItem> batchItems, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(batchSummary, serializedAdditionalRawData)
        {
