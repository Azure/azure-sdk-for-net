...
See our [list of samples](https://github.com/Azure/azure-sdk-for-net/tree/main/sdk/maps/Azure.Maps.TimeZones/samples) for more explanation about how to use this client library.
