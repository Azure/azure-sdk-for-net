...
namespace Azure.Maps.Creator
{
    ...
    public static partial class DatasetExtensions
    {
            ...
            /// </param>
            public static async Task<LongRunningOperationResult> CreateAsync(this IDataset operations, string conversionId, string datasetId = default(string), string descriptionDataset = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
