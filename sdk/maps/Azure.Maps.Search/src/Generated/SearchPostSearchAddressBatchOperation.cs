...
namespace Azure.Maps.Search
{
    ...
    /// ```.
    /// </summary>
    public partial class SearchPostSearchAddressBatchOperation : Operation<SearchAddressBatchResponse>, IOperationSource<SearchAddressBatchResponse>
    {
        private readonly OperationInternals<SearchAddressBatchResponse> _operation;

        /// <summary> Initializes a new instance of SearchPostSearchAddressBatchOperation for mocking. </summary>
        protected SearchPostSearchAddressBatchOperation()
        {
        }

        internal SearchPostSearchAddressBatchOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SearchAddressBatchResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SearchPostSearchAddressBatchOperation");
        }
