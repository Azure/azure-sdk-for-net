...
namespace Azure.Maps.Search.Models
{
    ...
    {
        internal static PointOfInterestCategoryTreeResult DeserializePointOfInterestCategoryTreeResult(JsonElement element, SerializableOptions options = default)
        {
