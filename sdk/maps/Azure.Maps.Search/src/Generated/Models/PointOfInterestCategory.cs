...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class PointOfInterestCategory
    {
        ...
        internal PointOfInterestCategory(int? id, string name, IReadOnlyList<int> childIds, IReadOnlyList<string> synonyms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            ChildIds = childIds;
