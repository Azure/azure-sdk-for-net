...
namespace Azure.Maps.Search.Models
{
    internal partial class GeoJsonFeature : IUtf8JsonSerializable, IModelJsonSerializable<GeoJsonFeature>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GeoJsonFeature>(this, options.Format);
        ...
        internal static GeoJsonFeature DeserializeGeoJsonFeature(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GeoJsonFeature(type, geometry, properties.Value, id.Value, featureType.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="GeoJsonFeature"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GeoJsonFeature"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GeoJsonFeature"/>. </summary>
