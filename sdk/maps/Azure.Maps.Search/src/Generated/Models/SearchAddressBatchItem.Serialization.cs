...
namespace Azure.Maps.Search.Models
{
    internal partial class SearchAddressBatchItem
    {
        internal static SearchAddressBatchItem DeserializeSearchAddressBatchItem(JsonElement element)
        {
            ...
            SearchAddressBatchItemResponse response = default;
        ...
        internal static new SearchAddressBatchItem FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeSearchAddressBatchItem(document.RootElement);
        }
    }
}
