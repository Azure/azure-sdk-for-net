...
namespace Azure.Maps.Search.Models
{
    public partial class PolygonResult : IUtf8JsonSerializable, IJsonModel<PolygonResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PolygonResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolygonResult>)} interface");
            }
