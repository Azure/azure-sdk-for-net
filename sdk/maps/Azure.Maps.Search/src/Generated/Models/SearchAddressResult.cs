...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class SearchAddressResult
    {
        ...
        internal SearchAddressResult(SearchSummary summary, IReadOnlyList<SearchAddressResultItem> results, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Summary = summary;
            Results = results;
