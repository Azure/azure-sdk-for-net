...
namespace Azure.Maps.Search.Models
{
    ...
    {
        internal static ReverseSearchAddressBatchItem DeserializeReverseSearchAddressBatchItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
