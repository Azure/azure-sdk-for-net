...
namespace Azure.Maps.Search.Models
{
    ...
    {
        internal static ReverseSearchAddressBatchResult DeserializeReverseSearchAddressBatchResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
