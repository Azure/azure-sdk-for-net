...
namespace Azure.Maps.Search.Models
{
    ...
    {
        internal static ReverseSearchAddressResult DeserializeReverseSearchAddressResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
