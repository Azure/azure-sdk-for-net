...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class ReverseSearchAddressResult
    {
        ...
        internal ReverseSearchAddressResult(SearchSummary summary, IReadOnlyList<ReverseSearchAddressItem> addresses, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Summary = summary;
            Addresses = addresses;
