...
namespace Azure.Maps.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsAddress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsAddress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsAddress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MapsAddress>)} interface");
            }
        ...
        string IPersistableModel<MapsAddress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
