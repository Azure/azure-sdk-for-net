...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class ReverseSearchAddressBatchItemResponse : ReverseSearchAddressResult
    {
        ...
        internal ReverseSearchAddressBatchItemResponse(SearchSummary summary, IReadOnlyList<ReverseSearchAddressItem> addresses, ErrorDetail errorDetail, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(summary, addresses, serializedAdditionalRawData)
        {
