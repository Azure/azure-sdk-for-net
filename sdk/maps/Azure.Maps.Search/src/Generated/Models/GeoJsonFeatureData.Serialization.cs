...
namespace Azure.Maps.Search.Models
{
    internal partial class GeoJsonFeatureData : IUtf8JsonSerializable, IJsonModel<GeoJsonFeatureData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GeoJsonFeatureData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GeoJsonFeatureData>)} interface");
            }
