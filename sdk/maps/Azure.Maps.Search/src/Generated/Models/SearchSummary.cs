...
namespace Azure.Maps.Search.Models
{
    ...
    internal partial class SearchSummary
    {
        ...
        internal SearchSummary(string query, MapsQueryType? queryType, int? queryTime, int resultCount, int? top, int? skip, int? totalResults, int? fuzzyLevel, LatLongPairAbbreviated geoBiasInternal, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Query = query;
            QueryType = queryType;
            QueryTime = queryTime;
