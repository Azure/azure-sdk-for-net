...
namespace Azure.Maps.Search.Models
{
    ...
    {
        internal static ReverseSearchCrossStreetAddressResult DeserializeReverseSearchCrossStreetAddressResult(JsonElement element, SerializableOptions options = default)
        {
