...
namespace Azure.Maps.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BoundingBox>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BoundingBox>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BoundingBox>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BoundingBox>)} interface");
            }
        ...
        string IPersistableModel<BoundingBox>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
