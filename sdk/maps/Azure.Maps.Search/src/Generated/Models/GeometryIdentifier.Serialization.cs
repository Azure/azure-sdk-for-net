...
namespace Azure.Maps.Search.Models
{
    public partial class GeometryIdentifier : IUtf8JsonSerializable, IJsonModel<GeometryIdentifier>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GeometryIdentifier>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GeometryIdentifier)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GeometryIdentifier>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GeometryIdentifier)} does not support '{options.Format}' format.");
            }
        }
