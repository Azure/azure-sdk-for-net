...
namespace Azure.Maps.Search.Models
{
    ...
    {
        internal static ReverseSearchAddressBatchItemResponse DeserializeReverseSearchAddressBatchItemResponse(JsonElement element, SerializableOptions options = default)
        {
