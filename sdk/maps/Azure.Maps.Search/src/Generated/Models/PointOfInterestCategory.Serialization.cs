...
namespace Azure.Maps.Search.Models
{
    public partial class PointOfInterestCategory : IUtf8JsonSerializable, IJsonModel<PointOfInterestCategory>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PointOfInterestCategory>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PointOfInterestCategory)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(ChildIds))
            {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Synonyms))
            {
        ...
        BinaryData IPersistableModel<PointOfInterestCategory>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PointOfInterestCategory)} does not support '{options.Format}' format.");
            }
        }
