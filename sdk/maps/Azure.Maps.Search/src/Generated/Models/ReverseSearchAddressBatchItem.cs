...
namespace Azure.Maps.Search.Models
{
    ...
    internal partial class ReverseSearchAddressBatchItem : BatchResultItem
    {
        ...
        internal ReverseSearchAddressBatchItem(int? statusCode, ReverseSearchAddressBatchItemResponse response, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(statusCode, serializedAdditionalRawData)
        {
            Response = response;
        }
