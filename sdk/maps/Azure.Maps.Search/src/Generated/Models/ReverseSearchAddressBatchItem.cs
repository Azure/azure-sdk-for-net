...
namespace Azure.Maps.Search.Models
{
    ...
    internal partial class ReverseSearchAddressBatchItem : BatchResultItem
    {
        ...
        internal ReverseSearchAddressBatchItem(int? statusCode, ReverseSearchAddressBatchItemResponse response, Dictionary<string, BinaryData> rawData) : base(statusCode, rawData)
        {
            Response = response;
        }
