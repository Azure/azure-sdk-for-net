...
namespace Azure.Maps.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PointOfInterest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PointOfInterest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PointOfInterest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PointOfInterest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
