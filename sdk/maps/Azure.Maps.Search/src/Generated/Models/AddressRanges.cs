...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class AddressRanges
    {
        ...
        internal AddressRanges(string rangeLeft, string rangeRight, LatLongPairAbbreviated fromInternal, LatLongPairAbbreviated toInternal, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RangeLeft = rangeLeft;
