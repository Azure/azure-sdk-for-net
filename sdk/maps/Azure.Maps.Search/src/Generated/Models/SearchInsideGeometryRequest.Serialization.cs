...
namespace Azure.Maps.Search.Models
{
    internal partial class SearchInsideGeometryRequest : IUtf8JsonSerializable, IJsonModel<SearchInsideGeometryRequest>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchInsideGeometryRequest>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchInsideGeometryRequest>)} interface");
            }
