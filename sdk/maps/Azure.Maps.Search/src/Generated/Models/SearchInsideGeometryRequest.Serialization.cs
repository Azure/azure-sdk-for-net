...
namespace Azure.Maps.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchInsideGeometryRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchInsideGeometryRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchInsideGeometryRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SearchInsideGeometryRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
