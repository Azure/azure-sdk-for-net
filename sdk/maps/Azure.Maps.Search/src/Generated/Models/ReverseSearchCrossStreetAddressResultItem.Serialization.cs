...
namespace Azure.Maps.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReverseSearchCrossStreetAddressResultItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReverseSearchCrossStreetAddressResultItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReverseSearchCrossStreetAddressResultItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ReverseSearchCrossStreetAddressResultItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
