...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class Address
    {
        ...
        internal Address(string buildingNumber, string street, string crossStreet, string streetNumber, IReadOnlyList<int> routeNumbers, string streetName, string streetNameAndNumber, string municipality, string municipalitySubdivision, string countryTertiarySubdivision, string countrySecondarySubdivision, string countrySubdivision, string postalCode, string extendedPostalCode, string countryCode, string country, string countryCodeISO3, string freeformAddress, string countrySubdivisionName, string localName, object boundingBox)
        {
