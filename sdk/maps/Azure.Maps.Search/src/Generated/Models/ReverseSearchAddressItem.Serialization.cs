...
namespace Azure.Maps.Search.Models
{
    ...
    {
        internal static ReverseSearchAddressItem DeserializeReverseSearchAddressItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
