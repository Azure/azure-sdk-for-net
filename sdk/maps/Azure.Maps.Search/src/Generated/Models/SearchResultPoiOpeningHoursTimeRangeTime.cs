...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class SearchResultPoiOpeningHoursTimeRangeTime
    {
        ...
        internal SearchResultPoiOpeningHoursTimeRangeTime()
        {
        }
        ...
        internal SearchResultPoiOpeningHoursTimeRangeTime(string date, int? hour, int? minute)
        {
            Date = date;
            Hour = hour;
            Minute = minute;
        ...
        /// <summary> Represents current day in calendar year in POI time zone. </summary>
