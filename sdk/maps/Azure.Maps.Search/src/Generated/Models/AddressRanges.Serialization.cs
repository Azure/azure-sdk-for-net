...
namespace Azure.Maps.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddressRanges>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AddressRanges>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddressRanges>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AddressRanges>)} interface");
            }
        ...
        string IPersistableModel<AddressRanges>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
