...
namespace Azure.Maps.Search.Models
{
    ...
    public partial class ReverseSearchCrossStreetAddressResult
    {
        ...
        internal ReverseSearchCrossStreetAddressResult(SearchSummary summary, IReadOnlyList<ReverseSearchCrossStreetAddressResultItem> addresses, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Summary = summary;
            Addresses = addresses;
