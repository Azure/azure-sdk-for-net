...
namespace Azure.Maps.Search.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MapsDataSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MapsDataSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MapsDataSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MapsDataSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
