...
{
    public partial class GeoJsonObject : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GeoJsonObject DeserializeGeoJsonObject(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
