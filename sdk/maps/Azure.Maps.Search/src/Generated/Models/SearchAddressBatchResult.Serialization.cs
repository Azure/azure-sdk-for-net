...
namespace Azure.Maps.Search.Models
{
    public partial class SearchAddressBatchResult
    {
        internal static SearchAddressBatchResult DeserializeSearchAddressBatchResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<SearchAddressBatchItem>> batchItems = default;
            ...
            return new SearchAddressBatchResult(summary.Value, Core.Optional.ToList(batchItems));
        }
    }
}
