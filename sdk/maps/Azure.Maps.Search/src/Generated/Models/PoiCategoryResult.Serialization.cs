...
namespace Azure.Maps.Search.Models
{
    ...
    {
        internal static PoiCategoryResult DeserializePoiCategoryResult(JsonElement element)
        {
            ...
            return new PoiCategoryResult(Optional.ToNullable(id), name.Value, Optional.ToList(childCategoryIds), Optional.ToList(synonyms));
        }
    }
}
