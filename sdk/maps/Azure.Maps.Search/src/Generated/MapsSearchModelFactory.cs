...
namespace Azure.Maps.Search.Models
{
    ...
    public static partial class MapsSearchModelFactory
    {
        ...
        public static PolygonResult PolygonResult(IEnumerable<PolygonObject> polygons = null)
        {
            ...
            return new PolygonResult(polygons?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolygonObject(providerId, geometryData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PointOfInterestCategorySet(id, new Dictionary<string, BinaryData>());
        }
        ...
        public static PointOfInterestClassification PointOfInterestClassification(string code = null, IEnumerable<ClassificationName> names = null)
        {
            ...
            return new PointOfInterestClassification(code, names?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ClassificationName(nameLocale, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BrandName(name, new Dictionary<string, BinaryData>());
        }
        ...
        public static OperatingHours OperatingHours(string mode = null, IEnumerable<OperatingHoursTimeRange> timeRanges = null)
        {
            ...
            return new OperatingHours(mode, timeRanges?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MapsDataSource(geometry, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GeometryIdentifier(id, new Dictionary<string, BinaryData>());
        }
        ...
        public static PointOfInterestCategoryTreeResult PointOfInterestCategoryTreeResult(IEnumerable<PointOfInterestCategory> categories = null)
        {
            ...
            return new PointOfInterestCategoryTreeResult(categories?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static PointOfInterestCategory PointOfInterestCategory(int? id = null, string name = null, IEnumerable<int> childIds = null, IEnumerable<string> synonyms = null)
        {
            ...
            return new PointOfInterestCategory(id, name, childIds?.ToList(), synonyms?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ReverseSearchAddressItem ReverseSearchAddressItem(MapsAddress address = null, string position = null, IEnumerable<RoadKind> roadUse = null, MapsSearchMatchType? matchType = null)
        {
            ...
            return new ReverseSearchAddressItem(address, position, roadUse?.ToList(), matchType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReverseSearchCrossStreetAddressResultItem(address, position, new Dictionary<string, BinaryData>());
        }
    }
}
