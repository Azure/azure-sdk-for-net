...
namespace Azure.Maps.Search
{
    ...
    /// ```.
    /// </summary>
    public partial class SearchGetSearchAddressReverseBatchOperation : Operation<SearchAddressReverseBatchResponse>, IOperationSource<SearchAddressReverseBatchResponse>
    {
        private readonly OperationInternals<SearchAddressReverseBatchResponse> _operation;

        /// <summary> Initializes a new instance of SearchGetSearchAddressReverseBatchOperation for mocking. </summary>
        protected SearchGetSearchAddressReverseBatchOperation()
        {
        }

        internal SearchGetSearchAddressReverseBatchOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SearchAddressReverseBatchResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.OriginalUri, "SearchGetSearchAddressReverseBatchOperation");
        }
