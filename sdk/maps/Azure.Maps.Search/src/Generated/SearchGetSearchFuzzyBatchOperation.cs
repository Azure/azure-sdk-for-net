...
namespace Azure.Maps.Search
{
    ...
    /// ```.
    /// </summary>
    public partial class SearchGetSearchFuzzyBatchOperation : Operation<SearchFuzzyBatchResponse>, IOperationSource<SearchFuzzyBatchResponse>
    {
        private readonly OperationInternals<SearchFuzzyBatchResponse> _operation;

        /// <summary> Initializes a new instance of SearchGetSearchFuzzyBatchOperation for mocking. </summary>
        protected SearchGetSearchFuzzyBatchOperation()
        {
        }

        internal SearchGetSearchFuzzyBatchOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SearchFuzzyBatchResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.OriginalUri, "SearchGetSearchFuzzyBatchOperation");
        }
