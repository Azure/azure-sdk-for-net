...
namespace Azure.Maps.Search
{
    ...
    /// ```.
    /// </summary>
    public partial class SearchGetSearchAddressBatchOperation : Operation<SearchAddressBatchResponse>, IOperationSource<SearchAddressBatchResponse>
    {
        private readonly OperationInternals<SearchAddressBatchResponse> _operation;

        /// <summary> Initializes a new instance of SearchGetSearchAddressBatchOperation for mocking. </summary>
        protected SearchGetSearchAddressBatchOperation()
        {
        }

        internal SearchGetSearchAddressBatchOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SearchAddressBatchResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.OriginalUri, "SearchGetSearchAddressBatchOperation");
        }
        ...
        /// <inheritdoc />
        public override SearchAddressBatchResponse Value => _operation.Value;
        ...
        /// <inheritdoc />
        public override ValueTask<Response<SearchAddressBatchResponse>> WaitForCompletionAsync(CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(cancellationToken);

        /// <inheritdoc />
        public override ValueTask<Response<SearchAddressBatchResponse>> WaitForCompletionAsync(TimeSpan pollingInterval, CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(pollingInterval, cancellationToken);

        SearchAddressBatchResponse IOperationSource<SearchAddressBatchResponse>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            using var document = JsonDocument.Parse(response.ContentStream);
            return SearchAddressBatchResponse.DeserializeSearchAddressBatchResponse(document.RootElement);
        }

        async ValueTask<SearchAddressBatchResponse> IOperationSource<SearchAddressBatchResponse>.CreateResultAsync(Response response, CancellationToken cancellationToken)
        {
