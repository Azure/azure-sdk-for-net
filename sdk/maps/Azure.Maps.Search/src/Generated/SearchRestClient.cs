...
namespace Azure.Maps.Search
{
    internal partial class SearchRestClient
    {
        ...
        /// <param name="endpoint"> server parameter. The default is "https://atlas.microsoft.com". </param>
        ...
        /// </summary>
        /// <param name="format"> Desired format of the response. Only `json` format is supported. The default is AutoRest.CSharp.Output.Models.Types.EnumTypeValue. </param>
        ...
        /// </summary>
        /// <param name="format"> Desired format of the response. Value can be either _json_ or _xml_. The default is AutoRest.CSharp.Output.Models.Types.EnumTypeValue. </param>
