...
namespace Azure.Maps.Search
{
    ...
    public partial class MapsSearchClient
    {
        ...
        ///
        ///
        /// POI Category API provides a full list of supported Points of Interest (POI) categories and subcategories together with their translations and synonyms. The returned content can be used to provide more meaningful results through other Search Service APIs, like <see href="https://docs.microsoft.com/rest/api/maps/search/getsearchpoi">Get Search POI</see>.
        /// </summary>
        /// <param name="language">
        ...
        public virtual Response<ReverseSearchAddressResult> ReverseSearchAddress(ReverseSearchOptions options = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return RestClient.ReverseSearchAddress(
                    ...
                    ResponseFormat.Json, options?.Language.ToString(), options?.IncludeSpeedLimit, options?.Heading, options?.RadiusInMeters, options?.Number, options?.IncludeRoadUse, options?.RoadUse, options?.AllowFreeformNewline, options?.IncludeMatchType, options?.EntityType, localizedMapView, cancellationToken
                );
            }
            catch (Exception e)
            {
