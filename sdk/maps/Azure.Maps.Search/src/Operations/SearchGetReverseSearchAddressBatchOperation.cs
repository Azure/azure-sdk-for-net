...
namespace Azure.Maps.Search
{
    ...
    /// ```
    /// </summary>
    public partial class SearchGetReverseSearchAddressBatchOperation : Operation<ReverseSearchAddressBatchResult>, IOperationSource<ReverseSearchAddressBatchResult>
    {
        ...
        {
            _operation = new OperationInternals<ReverseSearchAddressBatchResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.OriginalUri, "SearchGetReverseSearchAddressBatchOperation");
        }
