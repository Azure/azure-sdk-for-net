...
namespace Azure.Maps.Search
{
    ...
    /// ```
    /// </summary>
    public partial class SearchGetReverseSearchAddressBatchOperation : Operation<ReverseSearchAddressBatchProcessResult>, IOperationSource<ReverseSearchAddressBatchProcessResult>
    {
        ...
        internal SearchGetReverseSearchAddressBatchOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ReverseSearchAddressBatchProcessResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.OriginalUri, "SearchGetReverseSearchAddressBatchOperation");
        }
