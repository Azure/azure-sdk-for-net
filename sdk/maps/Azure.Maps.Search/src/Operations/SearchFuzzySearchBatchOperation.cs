...
namespace Azure.Maps.Search
{
    ...
    /// ```
    /// </summary>
    public partial class SearchFuzzySearchBatchOperation : Operation<SearchAddressBatchResult>, IOperationSource<SearchAddressBatchResult>
    {
        ...
        internal SearchFuzzySearchBatchOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SearchAddressBatchResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SearchFuzzySearchBatchOperation");
        }
