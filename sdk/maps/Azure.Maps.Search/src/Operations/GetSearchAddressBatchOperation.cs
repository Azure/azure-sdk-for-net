...
namespace Azure.Maps.Search
{
    ...
    /// ```
    /// </summary>
    public partial class GetSearchAddressBatchOperation : Operation<SearchAddressBatchResult>
    {
        /// <summary> Initializes a new instance of GetSearchAddressBatchOperation for mocking. </summary>
