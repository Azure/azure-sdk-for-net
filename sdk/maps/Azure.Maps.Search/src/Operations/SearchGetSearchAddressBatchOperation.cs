...
namespace Azure.Maps.Search
{
    ...
    /// ```
    /// </summary>
    public partial class SearchGetSearchAddressBatchOperation : Operation<SearchAddressBatchResult>, IOperationSource<SearchAddressBatchResult>
    {
        ...
        {
            _operation = new OperationInternals<SearchAddressBatchResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.OriginalUri, "SearchGetSearchAddressBatchOperation");
        }
