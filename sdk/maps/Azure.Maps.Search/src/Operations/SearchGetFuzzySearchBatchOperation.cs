...
namespace Azure.Maps.Search
{
    ...
    /// ```
    /// </summary>
    public partial class SearchGetFuzzySearchBatchOperation : Operation<SearchAddressBatchResult>, IOperationSource<SearchAddressBatchResult>
    {
        ...
        internal SearchGetFuzzySearchBatchOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SearchAddressBatchResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.OriginalUri, "SearchGetFuzzySearchBatchOperation");
        }
        ...
        /// <inheritdoc />
        public override SearchAddressBatchResult Value => _operation.Value;
        ...
        /// <inheritdoc />
        public override ValueTask<Response<SearchAddressBatchResult>> WaitForCompletionAsync(CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(cancellationToken);

        /// <inheritdoc />
        public override ValueTask<Response<SearchAddressBatchResult>> WaitForCompletionAsync(TimeSpan pollingInterval, CancellationToken cancellationToken = default) => _operation.WaitForCompletionAsync(pollingInterval, cancellationToken);

        SearchAddressBatchResult IOperationSource<SearchAddressBatchResult>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            using var document = JsonDocument.Parse(response.ContentStream);
            return SearchAddressBatchResult.DeserializeSearchAddressBatchResult(document.RootElement);
        }

        async ValueTask<SearchAddressBatchResult> IOperationSource<SearchAddressBatchResult>.CreateResultAsync(Response response, CancellationToken cancellationToken)
        {
