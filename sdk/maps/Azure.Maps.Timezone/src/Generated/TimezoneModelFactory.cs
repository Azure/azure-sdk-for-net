...
namespace Azure.Maps.Timezone
{
    ...
    public static partial class TimezoneModelFactory
    {
        ...
        public static TimezoneByIdResult TimezoneByIdResult(string version = null, DateTimeOffset? referenceUtcTimestamp = null, IEnumerable<TimezoneById> timeZones = null)
        {
            timeZones ??= new List<TimezoneById>();

            return new TimezoneByIdResult(version, referenceUtcTimestamp, timeZones?.ToList());
        }
        ...
        public static TimezoneById TimezoneById(string id = null, IEnumerable<string> aliases = null, IEnumerable<CountryRecord> countries = null, TimezoneNames names = null, ReferenceTimeById referenceTime = null, RepresentativePoint representativePoint = null, IEnumerable<TimeTransition> timeTransitions = null)
        {
            aliases ??= new List<string>();
            countries ??= new List<CountryRecord>();
            timeTransitions ??= new List<TimeTransition>();

            return new TimezoneById(id, aliases?.ToList(), countries?.ToList(), names, referenceTime, representativePoint, timeTransitions?.ToList());
        }
        ...
        public static ReferenceTimeById ReferenceTimeById(string tag = null, string standardOffset = null, string daylightSavings = null, string wallTime = null, int? posixTzValidYear = null, string posixTz = null)
        {
        ...
        /// <summary> Initializes a new instance of TimeTransition. </summary>
        ...
        public static TimezoneByCoordinatesResult TimezoneByCoordinatesResult(string version = null, DateTimeOffset? referenceUtcTimestamp = null, IEnumerable<TimeZoneByCoordinates> timeZones = null)
        {
            timeZones ??= new List<TimeZoneByCoordinates>();

            return new TimezoneByCoordinatesResult(version, referenceUtcTimestamp, timeZones?.ToList());
        }
        ...
        public static TimeZoneByCoordinates TimeZoneByCoordinates(string id = null, IEnumerable<string> aliases = null, IEnumerable<CountryRecord> countries = null, TimezoneNames names = null, ReferenceTimeByCoordinates referenceTime = null, RepresentativePoint representativePoint = null, IEnumerable<TimeTransition> timeTransitions = null)
        {
            aliases ??= new List<string>();
            countries ??= new List<CountryRecord>();
            timeTransitions ??= new List<TimeTransition>();

            return new TimeZoneByCoordinates(id, aliases?.ToList(), countries?.ToList(), names, referenceTime, representativePoint, timeTransitions?.ToList());
        }
        ...
        public static ReferenceTimeByCoordinates ReferenceTimeByCoordinates(string tag = null, string standardOffset = null, string daylightSavings = null, string wallTime = null, int? posixTzValidYear = null, string posixTz = null, string sunrise = null, string sunset = null)
        {
        ...
        public static TimezoneEnumWindow TimezoneEnumWindow(string windowsId = null, string territory = null, IEnumerable<string> ianaIds = null)
        {
            ianaIds ??= new List<string>();

            return new TimezoneEnumWindow(windowsId, territory, ianaIds?.ToList());
        }
