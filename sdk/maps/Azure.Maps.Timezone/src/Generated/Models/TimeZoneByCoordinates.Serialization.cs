...
namespace Azure.Maps.Timezone.Models
{
    ...
    {
        internal static TimeZoneByCoordinates DeserializeTimeZoneByCoordinates(JsonElement element)
        {
            ...
            Optional<ReferenceTimeByCoordinates> referenceTime = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("ReferenceTime"))
                {
                    ...
                    referenceTime = ReferenceTimeByCoordinates.DeserializeReferenceTimeByCoordinates(property.Value);
                    continue;
                }
            ...
            return new TimeZoneByCoordinates(id.Value, Optional.ToList(aliases), Optional.ToList(countries), names.Value, referenceTime.Value, representativePoint.Value, Optional.ToList(timeTransitions));
        }
    }
}
