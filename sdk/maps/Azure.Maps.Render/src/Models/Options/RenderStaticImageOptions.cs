...
namespace Azure.Maps.Render
{
    ...
    public class RenderStaticImageOptions
    {
        ...
        public RenderStaticImageOptions(GeoBoundingBox boundingBox)
        {
        ...
        /// <summary>
        /// </summary>
        public RenderStaticImageOptions(GeoPosition centerCoordinate, int widthInPixels, int heightInPixels)
        {
...
#pragma warning disable CA2227 // Collection properties should be read only
        ...
        /// </summary>
        public IList<PushpinStyle> Pins { get; set; }
        /// <summary>
        ...
        /// </summary>
        public IList<PathStyle> Paths { get; set; }
