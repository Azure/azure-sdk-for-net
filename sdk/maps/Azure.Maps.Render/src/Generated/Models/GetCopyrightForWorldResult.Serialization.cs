...
namespace Azure.Maps.Render.Models
{
    ...
    {
        internal static GetCopyrightForWorldResult DeserializeGetCopyrightForWorldResult(JsonElement element)
        {
            ...
            return new GetCopyrightForWorldResult(formatVersion.Value, Optional.ToList(generalCopyrights), Optional.ToList(regions));
        }
    }
}
