...
namespace Azure.Maps.Render.Models
{
    ...
    {
        internal static GetCopyrightForTileResult DeserializeGetCopyrightForTileResult(JsonElement element)
        {
            ...
            return new GetCopyrightForTileResult(formatVersion.Value, Optional.ToList(generalCopyrights), Optional.ToList(regions));
        }
    }
}
