...
namespace Azure.Maps.Render
{
    internal partial class RenderRestClient
    {
        ...
        internal HttpMessage CreateGetMapTileRequest(TileFormat format, MapTileLayer layer, MapTileStyle style, TileIndex tileIndex, MapTileSize? tileSize, string language, LocalizedMapView? localizedMapView)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<ResponseWithHeaders<Stream, RenderGetMapTileHeaders>> GetMapTileAsync(TileFormat format, MapTileLayer layer, MapTileStyle style, TileIndex tileIndex, MapTileSize? tileSize = null, string language = null, LocalizedMapView? localizedMapView = null, CancellationToken cancellationToken = default)
        {
            if (tileIndex == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tileIndex"/> is null. </exception>
        public ResponseWithHeaders<Stream, RenderGetMapTileHeaders> GetMapTile(TileFormat format, MapTileLayer layer, MapTileStyle style, TileIndex tileIndex, MapTileSize? tileSize = null, string language = null, LocalizedMapView? localizedMapView = null, CancellationToken cancellationToken = default)
        {
            if (tileIndex == null)
            {
                throw new ArgumentNullException(nameof(tileIndex));
        ...
        internal HttpMessage CreateGetMapStateTileRequest(string statesetId, TileIndex tileIndex)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<ResponseWithHeaders<Stream, RenderGetMapStateTileHeaders>> GetMapStateTileAsync(string statesetId, TileIndex tileIndex, CancellationToken cancellationToken = default)
        {
            if (statesetId == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="statesetId"/> or <paramref name="tileIndex"/> is null. </exception>
        public ResponseWithHeaders<Stream, RenderGetMapStateTileHeaders> GetMapStateTile(string statesetId, TileIndex tileIndex, CancellationToken cancellationToken = default)
        {
            if (statesetId == null)
            {
                throw new ArgumentNullException(nameof(statesetId));
        ...
        public async Task<Response<RenderCopyrights>> GetCopyrightFromBoundingBoxAsync(BoundingBox boundingBox, ResponseFormat? format = null, IncludeText? includeText = null, CancellationToken cancellationToken = default)
        {
            if (boundingBox == null)
            {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        RenderCopyrights value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = RenderCopyrights.DeserializeRenderCopyrights(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await ClientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="boundingBox"/> is null. </exception>
        public Response<RenderCopyrights> GetCopyrightFromBoundingBox(BoundingBox boundingBox, ResponseFormat? format = null, IncludeText? includeText = null, CancellationToken cancellationToken = default)
        {
            if (boundingBox == null)
            {
                throw new ArgumentNullException(nameof(boundingBox));
        ...
        internal HttpMessage CreateGetCopyrightForTileRequest(TileIndex tileIndex, ResponseFormat? format, IncludeText? includeText)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tileIndex"/> is null. </exception>
        public async Task<Response<RenderCopyrights>> GetCopyrightForTileAsync(TileIndex tileIndex, ResponseFormat? format = null, IncludeText? includeText = null, CancellationToken cancellationToken = default)
        {
            if (tileIndex == null)
            {
                throw new ArgumentNullException(nameof(tileIndex));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tileIndex"/> is null. </exception>
        public Response<RenderCopyrights> GetCopyrightForTile(TileIndex tileIndex, ResponseFormat? format = null, IncludeText? includeText = null, CancellationToken cancellationToken = default)
        {
            if (tileIndex == null)
            {
                throw new ArgumentNullException(nameof(tileIndex));
        ...
        /// <param name="includeText"> Yes/no value to exclude textual data from response. Only images and country names will be in response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<RenderCopyrights>> GetCopyrightForWorldAsync(ResponseFormat? format = null, IncludeText? includeText = null, CancellationToken cancellationToken = default)
        {
            format ??= ResponseFormat.Json;
        ...
        /// <param name="includeText"> Yes/no value to exclude textual data from response. Only images and country names will be in response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<RenderCopyrights> GetCopyrightForWorld(ResponseFormat? format = null, IncludeText? includeText = null, CancellationToken cancellationToken = default)
        {
            format ??= ResponseFormat.Json;
