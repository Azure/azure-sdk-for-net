...
namespace Microsoft.Azure.Management.Maps.Models
{
    ...
    /// </summary>
    public partial class CreatorCreateParameters
    {
        /// <summary>
        /// Initializes a new instance of the CreatorCreateParameters class.
        /// </summary>
        public CreatorCreateParameters()
        {
            CustomInit();
        }
        ...
        /// characters.</param>
        public CreatorCreateParameters(string location, IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Location = location;
            Tags = tags;
            CustomInit();
