...
namespace Microsoft.Azure.Management.Maps.Models
{
    ...
    /// </summary>
    public partial class PrivateAtlasUpdateParameters
    {
        /// <summary>
        /// Initializes a new instance of the PrivateAtlasUpdateParameters
        /// class.
        /// </summary>
        ...
        /// characters.</param>
        public PrivateAtlasUpdateParameters(IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Tags = tags;
            CustomInit();
        }
