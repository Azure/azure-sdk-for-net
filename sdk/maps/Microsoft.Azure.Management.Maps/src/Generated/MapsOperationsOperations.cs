...
namespace Microsoft.Azure.Management.Maps
{
    ...
    /// </summary>
    internal partial class MapsOperationsOperations : IServiceOperations<MapsManagementClient>, IMapsOperationsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal MapsOperationsOperations(MapsManagementClient client)
        {
            if (client == null)
            {
