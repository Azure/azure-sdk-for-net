...
namespace Azure.Maps.Traffic.Models
{
    ...
    {
        internal static TrafficIncidentPoiCtr DeserializeTrafficIncidentPoiCtr(JsonElement element)
        {
            ...
            return new TrafficIncidentPoiCtr(Optional.ToNullable(x), Optional.ToNullable(y));
        }
    }
}
