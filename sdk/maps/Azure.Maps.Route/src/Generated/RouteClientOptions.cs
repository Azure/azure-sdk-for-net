...
namespace Azure.Maps.Route
{
    ...
    public partial class RouteClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes new instance of RouteClientOptions. </summary>
        public RouteClientOptions(ServiceVersion version = LatestVersion)
        {
