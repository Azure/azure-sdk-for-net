...
namespace Azure.Maps.Route.Models
{
    ...
    public partial class RouteMatrixResponse
    {
        ...
        internal RouteMatrixResponse()
        {
            Matrix = new ChangeTrackingList<IList<RouteMatrixResult>>();
        }
        ...
        internal RouteMatrixResponse(string formatVersion, IReadOnlyList<IList<RouteMatrixResult>> matrix, RouteMatrixSummary summary)
        {
        ...
        public IReadOnlyList<IList<RouteMatrixResult>> Matrix { get; }
