...
namespace Azure.Maps.Route.Models
{
    ...
    public partial class RouteResultInstructionGroup
    {
        ...
        internal RouteResultInstructionGroup()
        {
        }
        ...
        internal RouteResultInstructionGroup(int? firstInstructionIndex, int? lastInstructionIndex, int? groupLengthInMeters, string groupMessage)
        {
        ...
        /// <summary> Index of the first instruction. </summary>
        public int? FirstInstructionIndex { get; }
        /// <summary> Index of the last instruction. </summary>
