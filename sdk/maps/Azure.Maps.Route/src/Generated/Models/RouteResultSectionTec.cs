...
namespace Azure.Maps.Route.Models
{
    ...
    public partial class RouteResultSectionTec
    {
        ...
        internal RouteResultSectionTec()
        {
            Causes = new ChangeTrackingList<RouteResultSectionTecCause>();
        }
        ...
        internal RouteResultSectionTec(int? effectCode, IReadOnlyList<RouteResultSectionTecCause> causes)
        {
        ...
        public IReadOnlyList<RouteResultSectionTecCause> Causes { get; }
    }
}
