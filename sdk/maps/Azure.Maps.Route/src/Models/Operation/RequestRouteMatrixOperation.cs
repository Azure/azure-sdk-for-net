...
namespace Azure.Maps.Route.Models
{
    ...
    /// </summary>
    public class RequestRouteMatrixOperation : Operation<RouteMatrixResult>
    {
        /// <summary>
        /// The client used to check for completion.
        /// </summary>
        private readonly MapsRouteClient _client;
        ...
        /// <summary>
        /// Initializes a new <see cref="RequestRouteMatrixOperation"/> instance for
        /// mocking.
        /// </summary>
        ...
        internal RequestRouteMatrixOperation(MapsRouteClient client, Uri followUpUrl)
        {
        ...
        public RequestRouteMatrixOperation(MapsRouteClient client, string id) :
            this(client, id, null)
        {
        }
        ...
        /// </param>
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> or <paramref name="id"/> is null. </exception>
        internal RequestRouteMatrixOperation(
            MapsRouteClient client,
            string id,
