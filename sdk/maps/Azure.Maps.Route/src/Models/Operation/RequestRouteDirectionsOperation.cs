...
namespace Azure.Maps.Route.Models
{
    ...
    public class RequestRouteDirectionsOperation : Operation<RouteDirectionsBatchResult>
    {
        ...
        /// The client used to check for completion.
        /// </param>
        internal RequestRouteDirectionsOperation(MapsRouteClient client, Uri followUpUrl)
        {
        ...
        public RequestRouteDirectionsOperation(MapsRouteClient client, string id) :
            this(client, id, null)
        {
        }
