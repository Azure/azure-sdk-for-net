...
namespace Azure.Maps.Weather.Models
{
    ...
    public partial class DailyAirQuality
    {
        ...
        internal DailyAirQuality(DateTimeOffset? timestamp, float? index, float? globalIndex, DominantPollutant? dominantPollutant, string category, string categoryColor, string description)
        {
            Timestamp = timestamp;
            Index = index;
