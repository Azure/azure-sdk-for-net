...
namespace Azure.Maps.Weather.Models
{
    ...
    {
        internal static WeatherValueRange DeserializeWeatherValueRange(JsonElement element)
        {
        ...
        internal static WeatherValueRange FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeWeatherValueRange(document.RootElement);
        }
    }
}
