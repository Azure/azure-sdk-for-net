        ...
        internal static StormWindRadiiSummary DeserializeStormWindRadiiSummary(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("radiiGeometry"u8))
                {
                    ...
                    radiiGeometry = ModelReaderWriter.Read<GeoObject>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureMapsWeatherContext.Default);
                    continue;
                }
            }
