...
namespace Azure.ResourceManager.WorkloadOrchestration.Samples
{
    public partial class Sample_WorkflowVersionResource
    {
        ...
        {
            // Generated from example definition: specification/edge/resource-manager/Microsoft.Edge/configurationmanager/preview/2025-06-01-preview/examples/WorkflowVersions_Get_MaximumSet_Gen.json
        ...
        {
            // Generated from example definition: specification/edge/resource-manager/Microsoft.Edge/configurationmanager/preview/2025-06-01-preview/examples/WorkflowVersions_Delete_MaximumSet_Gen.json
        ...
        {
            // Generated from example definition: specification/edge/resource-manager/Microsoft.Edge/configurationmanager/preview/2025-06-01-preview/examples/WorkflowVersions_Update_MaximumSet_Gen.json
            ...
            WorkflowVersionPatch patch = new WorkflowVersionPatch
            {
                ...
                {
                    StageSpec = {new StageSpec("amrbjd", new Dictionary<string, BinaryData>(), new TaskSpec[]
{
new TaskSpec("xxmeyvmgydbcwxqwjhadjxjod", new Dictionary<string, BinaryData>())
{
