...
{
    public partial class Sample_ContextCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_ContextsCreateOrUpdateMaximumSet()
        {
            // Generated from example definition: specification/edge/resource-manager/Microsoft.Edge/configurationmanager/stable/2025-08-01/examples/Contexts_CreateOrUpdate_MaximumSet_Gen.json
            ...
            // get the collection of this ContextResource
            ContextCollection collection = resourceGroupResource.GetContexts();

            // invoke the operation
            string contextName = "testname";
            ContextData data = new ContextData(new AzureLocation("pkquwbplcp"))
            {
...
["key3046"] = "clcnhzwypk"
            ...
            ArmOperation<ContextResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, contextName, data);
        ...
        public async Task Get_ContextsGetMaximumSet()
        {
            ...
            // invoke the operation
            string contextName = "testname";
            ContextResource result = await collection.GetAsync(contextName);
        ...
        {
            // Generated from example definition: specification/edge/resource-manager/Microsoft.Edge/configurationmanager/stable/2025-08-01/examples/Contexts_ListByResourceGroup_MaximumSet_Gen.json
            ...
            await foreach (ContextResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_ContextsGetMaximumSet()
        {
            ...
            // invoke the operation
            string contextName = "testname";
            NullableResponse<ContextResource> response = await collection.GetIfExistsAsync(contextName);
            ContextResource result = response.HasValue ? response.Value : null;
