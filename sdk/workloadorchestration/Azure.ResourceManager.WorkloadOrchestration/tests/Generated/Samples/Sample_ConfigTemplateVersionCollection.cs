...
{
    public partial class Sample_ConfigTemplateVersionCollection
    {
        [Test]
        ...
        public async Task Get_ConfigTemplateVersionsGetMaximumSet()
        {
            ...
            // get the collection of this ConfigTemplateVersionResource
            ConfigTemplateVersionCollection collection = configTemplate.GetConfigTemplateVersions();

            // invoke the operation
            string configTemplateVersionName = "1.0.0";
            ConfigTemplateVersionResource result = await collection.GetAsync(configTemplateVersionName);
        ...
        {
            // Generated from example definition: specification/edge/resource-manager/Microsoft.Edge/configurationmanager/preview/2025-06-01-preview/examples/ConfigTemplateVersions_ListByConfigTemplate_MaximumSet_Gen.json
            ...
            await foreach (ConfigTemplateVersionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ConfigTemplateVersionData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_ConfigTemplateVersionsGetMaximumSet()
        {
            ...
            // invoke the operation
            string configTemplateVersionName = "1.0.0";
            NullableResponse<ConfigTemplateVersionResource> response = await collection.GetIfExistsAsync(configTemplateVersionName);
            ConfigTemplateVersionResource result = response.HasValue ? response.Value : null;
