...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeConfigTemplateVersionData : ResourceData
    {
        ...
        internal EdgeConfigTemplateVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EdgeConfigTemplateVersionProperties properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
