...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeConfigTemplateVersionData : ResourceData
    {
        ...
        internal EdgeConfigTemplateVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EdgeConfigTemplateVersionProperties properties, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
