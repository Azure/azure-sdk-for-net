...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeDynamicSchemaData : ResourceData
    {
        ...
        internal EdgeDynamicSchemaData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EdgeDynamicSchemaProperties properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
