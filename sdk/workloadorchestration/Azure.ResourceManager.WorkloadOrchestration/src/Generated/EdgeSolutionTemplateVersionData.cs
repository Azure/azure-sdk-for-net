...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeSolutionTemplateVersionData : ResourceData
    {
        ...
        internal EdgeSolutionTemplateVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EdgeSolutionTemplateVersionProperties properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
