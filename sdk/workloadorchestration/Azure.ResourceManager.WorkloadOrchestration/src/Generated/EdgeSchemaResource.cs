...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeSchemaResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EdgeSchemaVersionResource>> CreateVersionAsync(WaitUntil waitUntil, EdgeSchemaVersionWithUpdateType body, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _schemasClientDiagnostics.CreateScope("EdgeSchemaResource.CreateVersion");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<RemoveVersionResult>> RemoveVersionAsync(EdgeVersionContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _schemasClientDiagnostics.CreateScope("EdgeSchemaResource.RemoveVersion");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _schemasRestClient.CreateRemoveVersionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EdgeVersionContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation<EdgeSchemaResource>> UpdateAsync(WaitUntil waitUntil, EdgeSchemaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _schemasRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EdgeSchemaData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EdgeSchemaResource> Update(WaitUntil waitUntil, EdgeSchemaData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
