...
namespace Azure.ResourceManager.WorkloadOrchestration.Models
{
    ...
    public partial class EdgeExecutionProperties
    {
        ...
        internal EdgeExecutionProperties(string workflowVersionId, IDictionary<string, BinaryData> specification, EdgeExecutionStatus status, WorkloadOrchestrationProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            WorkflowVersionId = workflowVersionId;
