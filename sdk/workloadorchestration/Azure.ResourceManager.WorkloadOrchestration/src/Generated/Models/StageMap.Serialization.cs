...
namespace Azure.ResourceManager.WorkloadOrchestration.Models
{
    ...
    public partial class StageMap : IJsonModel<StageMap>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual StageMap PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StageMap>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StageMap>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StageMap IPersistableModel<StageMap>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(ChildStages))
            {
                ...
                foreach (StageMap item in ChildStages)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StageMap IJsonModel<StageMap>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual StageMap JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StageMap>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StageMap DeserializeStageMap(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("displayState"u8))
                {
                    displayState = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("stage"u8))
                {
                    stage = new CMStages(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("status"u8))
                {
                    status = new StateCategory(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("childStages"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
