...
namespace Azure.ResourceManager.WorkloadOrchestration.Models
{
    ...
    public partial class EdgeExecutionStageStatus : IJsonModel<EdgeExecutionStageStatus>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeExecutionStageStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeExecutionStageStatus IJsonModel<EdgeExecutionStageStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EdgeExecutionStageStatus JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeExecutionStageStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EdgeExecutionStageStatus DeserializeEdgeExecutionStageStatus(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("nextstage"u8))
                {
                    nextstage = prop.Value.GetString();
                    continue;
                }
                ...
                if (prop.NameEquals("isActive"u8))
                {
                    ...
                    isActive = new InstanceActiveState(prop.Value.GetString());
                    continue;
                }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EdgeExecutionStageStatus>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeExecutionStageStatus IPersistableModel<EdgeExecutionStageStatus>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EdgeExecutionStageStatus PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeExecutionStageStatus>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
