...
namespace Azure.ResourceManager.WorkloadOrchestration.Models
{
    ...
    public partial class BulkReviewSolutionParameter
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BulkReviewSolutionParameter"/>. </summary>
        ...
        public BulkReviewSolutionParameter(IEnumerable<BulkReviewTargetDetails> targets)
        {
        ...
        internal BulkReviewSolutionParameter(IList<BulkReviewTargetDetails> targets, string solutionInstanceName, IList<EdgeSolutionDependencyContent> solutionDependencies, string solutionConfiguration, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Targets = targets;
