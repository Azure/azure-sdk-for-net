...
namespace Azure.ResourceManager.WorkloadOrchestration.Models
{
    ...
    public partial class EdgeConfigTemplateVersionProperties : IJsonModel<EdgeConfigTemplateVersionProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeConfigTemplateVersionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeConfigTemplateVersionProperties IJsonModel<EdgeConfigTemplateVersionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EdgeConfigTemplateVersionProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeConfigTemplateVersionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EdgeConfigTemplateVersionProperties DeserializeEdgeConfigTemplateVersionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new EdgeConfigTemplateVersionProperties(configurations, provisioningState, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EdgeConfigTemplateVersionProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeConfigTemplateVersionProperties IPersistableModel<EdgeConfigTemplateVersionProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EdgeConfigTemplateVersionProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeConfigTemplateVersionProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
