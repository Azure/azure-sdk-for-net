...
namespace Azure.ResourceManager.WorkloadOrchestration.Models
{
    ...
    public partial class BulkDeployTargetDetails : IJsonModel<BulkDeployTargetDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<BulkDeployTargetDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BulkDeployTargetDetails IJsonModel<BulkDeployTargetDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual BulkDeployTargetDetails JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<BulkDeployTargetDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BulkDeployTargetDetails DeserializeBulkDeployTargetDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new BulkDeployTargetDetails(solutionVersionId, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BulkDeployTargetDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BulkDeployTargetDetails IPersistableModel<BulkDeployTargetDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual BulkDeployTargetDetails PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<BulkDeployTargetDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
