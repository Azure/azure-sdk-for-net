...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    /// </summary>
    public partial class TargetData : TrackedResourceData
    {
        /// <summary>
        ...
        public TargetData(AzureLocation location) : base(location)
        {
        }
        ...
        internal TargetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, TargetProperties properties, string etag, ExtendedLocation extendedLocation, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
