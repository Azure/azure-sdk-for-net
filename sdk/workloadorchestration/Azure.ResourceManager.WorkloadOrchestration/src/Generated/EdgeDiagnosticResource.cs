...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="EdgeDiagnosticResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetEdgeDiagnostics method.
    /// </summary>
    public partial class EdgeDiagnosticResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of EdgeDiagnosticResource for mocking. </summary>
        protected EdgeDiagnosticResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="EdgeDiagnosticResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/diagnostics/{diagnosticName}";
        ...
        {
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("EdgeDiagnosticResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _diagnosticsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<EdgeDiagnosticResource>> UpdateAsync(WaitUntil waitUntil, EdgeDiagnosticPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("EdgeDiagnosticResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("EdgeDiagnosticResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _diagnosticsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                WorkloadOrchestrationArmOperation operation = new WorkloadOrchestrationArmOperation(_diagnosticsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<ArmOperation<EdgeDiagnosticResource>> UpdateAsync(WaitUntil waitUntil, EdgeDiagnosticData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _diagnosticsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EdgeDiagnosticData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                WorkloadOrchestrationArmOperation<EdgeDiagnosticResource> operation = new WorkloadOrchestrationArmOperation<EdgeDiagnosticResource>(
                    new EdgeDiagnosticResourceOperationSource(Client),
                    _diagnosticsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EdgeDiagnosticResource> Update(WaitUntil waitUntil, EdgeDiagnosticData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<EdgeDiagnosticResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("EdgeDiagnosticResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    EdgeDiagnosticData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    ArmOperation<EdgeDiagnosticResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<EdgeDiagnosticResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    EdgeDiagnosticData current = Get(cancellationToken: cancellationToken).Value.Data;
                    EdgeDiagnosticPatch patch = new EdgeDiagnosticPatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<EdgeDiagnosticResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<EdgeDiagnosticResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("EdgeDiagnosticResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<EdgeDiagnosticResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _diagnosticsClientDiagnostics.CreateScope("EdgeDiagnosticResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
