...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeSiteReferenceData : ResourceData
    {
        ...
        internal EdgeSiteReferenceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EdgeSiteReferenceProperties properties) : base(id, name, resourceType, systemData)
        {
