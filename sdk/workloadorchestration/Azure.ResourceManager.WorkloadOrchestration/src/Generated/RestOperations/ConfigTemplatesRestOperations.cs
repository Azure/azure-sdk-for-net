...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    internal partial class ConfigTemplatesRestOperations
    {
        ...
        internal RequestUriBuilder CreateRemoveVersionRequestUri(string subscriptionId, string resourceGroupName, string configTemplateName, EdgeVersionContent content)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateRemoveVersionRequest(string subscriptionId, string resourceGroupName, string configTemplateName, EdgeVersionContent content)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="configTemplateName"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<RemoveVersionResult>> RemoveVersionAsync(string subscriptionId, string resourceGroupName, string configTemplateName, EdgeVersionContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(configTemplateName, nameof(configTemplateName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="configTemplateName"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/> or <paramref name="configTemplateName"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<RemoveVersionResult> RemoveVersion(string subscriptionId, string resourceGroupName, string configTemplateName, EdgeVersionContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(configTemplateName, nameof(configTemplateName));
