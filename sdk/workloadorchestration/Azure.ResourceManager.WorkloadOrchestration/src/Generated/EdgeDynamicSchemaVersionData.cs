...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeDynamicSchemaVersionData : ResourceData
    {
        ...
        internal EdgeDynamicSchemaVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EdgeSchemaVersionProperties properties, ETag? eTag) : base(id, name, resourceType, systemData)
        {
