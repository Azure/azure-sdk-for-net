...
{
    /// <summary>
    /// A class representing a EdgeDeploymentInstanceHistory along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="EdgeDeploymentInstanceHistoryResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="EdgeDeploymentInstanceResource"/> using the GetEdgeDeploymentInstanceHistories method.
    /// </summary>
    public partial class EdgeDeploymentInstanceHistoryResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of EdgeDeploymentInstanceHistoryResource for mocking. </summary>
        protected EdgeDeploymentInstanceHistoryResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="EdgeDeploymentInstanceHistoryResource"/> class. </summary>
        ...
        internal EdgeDeploymentInstanceHistoryResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _instanceHistoriesRestClient = new InstanceHistories(_instanceHistoriesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, edgeDeploymentInstanceHistoryApiVersion ?? "2026-05-01-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/targets/{targetName}/solutions/{solutionName}/instances/{instanceName}/histories/{instanceHistoryName}";
        ...
        {
            using DiagnosticScope scope = _instanceHistoriesClientDiagnostics.CreateScope("EdgeDeploymentInstanceHistoryResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _instanceHistoriesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
