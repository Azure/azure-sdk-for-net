...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    public partial class WorkflowVersionResource : IJsonModel<WorkflowVersionData>
    {
        ...
        BinaryData IPersistableModel<WorkflowVersionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<WorkflowVersionData>(Data, options, AzureResourceManagerWorkloadOrchestrationContext.Default);

        WorkflowVersionData IPersistableModel<WorkflowVersionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<WorkflowVersionData>(data, options, AzureResourceManagerWorkloadOrchestrationContext.Default);
