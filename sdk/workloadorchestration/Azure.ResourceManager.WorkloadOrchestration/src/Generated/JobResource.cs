...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetJob method.
    /// </summary>
    public partial class JobResource : ArmResource
    {
        ...
        {
            _jobClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.WorkloadOrchestration", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<JobResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jobRestClient.GetAsync(Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<JobResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jobRestClient.Get(Id.Parent, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new JobResource(Client, response.Value), response.GetRawResponse());
            }
