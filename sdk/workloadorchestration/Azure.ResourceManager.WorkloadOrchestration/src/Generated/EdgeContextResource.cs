...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeContextResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EdgeContextResource>> UpdateAsync(WaitUntil waitUntil, EdgeContextData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _contextsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EdgeContextData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                WorkloadOrchestrationArmOperation<EdgeContextResource> operation = new WorkloadOrchestrationArmOperation<EdgeContextResource>(
                    new EdgeContextResourceOperationSource(Client),
                    _contextsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EdgeContextResource> Update(WaitUntil waitUntil, EdgeContextData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
