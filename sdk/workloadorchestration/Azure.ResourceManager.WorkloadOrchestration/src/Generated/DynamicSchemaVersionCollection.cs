...
{
    /// <summary>
    /// A class representing a collection of <see cref="DynamicSchemaVersionResource"/> and their operations.
    /// Each <see cref="DynamicSchemaVersionResource"/> in the collection will belong to the same instance of <see cref="DynamicSchemaResource"/>.
    /// To get a <see cref="DynamicSchemaVersionCollection"/> instance call the GetDynamicSchemaVersions method from an instance of <see cref="DynamicSchemaResource"/>.
    /// </summary>
    public partial class DynamicSchemaVersionCollection : ArmCollection, IEnumerable<DynamicSchemaVersionResource>, IAsyncEnumerable<DynamicSchemaVersionResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DynamicSchemaVersionCollection"/> class for mocking. </summary>
        protected DynamicSchemaVersionCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DynamicSchemaVersionCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal DynamicSchemaVersionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _dynamicSchemaVersionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.WorkloadOrchestration", DynamicSchemaVersionResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(DynamicSchemaVersionResource.ResourceType, out string dynamicSchemaVersionApiVersion);
        ...
        {
            if (id.ResourceType != DynamicSchemaResource.ResourceType)
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid resource type {0} expected {1}", id.ResourceType, DynamicSchemaResource.ResourceType), nameof(id));
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="DynamicSchemaVersionResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<DynamicSchemaVersionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _dynamicSchemaVersionRestClient.CreateListByDynamicSchemaRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _dynamicSchemaVersionRestClient.CreateListByDynamicSchemaNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="DynamicSchemaVersionResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<DynamicSchemaVersionResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _dynamicSchemaVersionRestClient.CreateListByDynamicSchemaRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _dynamicSchemaVersionRestClient.CreateListByDynamicSchemaNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DynamicSchemaVersionResource(Client, DynamicSchemaVersionData.DeserializeDynamicSchemaVersionData(e)), _dynamicSchemaVersionClientDiagnostics, Pipeline, "DynamicSchemaVersionCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        IEnumerator<DynamicSchemaVersionResource> IEnumerable<DynamicSchemaVersionResource>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<DynamicSchemaVersionResource> IAsyncEnumerable<DynamicSchemaVersionResource>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
