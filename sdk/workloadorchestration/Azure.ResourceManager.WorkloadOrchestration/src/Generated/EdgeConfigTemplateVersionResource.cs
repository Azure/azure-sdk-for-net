...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeConfigTemplateVersionResource : ArmResource
    {
        ...
        internal EdgeConfigTemplateVersionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _configTemplateVersionsRestClient = new ConfigTemplateVersions(_configTemplateVersionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, edgeConfigTemplateVersionApiVersion ?? "2026-05-01-preview");
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ConfigTemplateVersions_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-05-01-preview. </description>
        ...
        public virtual async Task<Response<EdgeConfigTemplateVersionResource>> UpdateAsync(EdgeConfigTemplateVersionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _configTemplateVersionsClientDiagnostics.CreateScope("EdgeConfigTemplateVersionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _configTemplateVersionsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, EdgeConfigTemplateVersionData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<EdgeConfigTemplateVersionData> response = Response.FromValue(EdgeConfigTemplateVersionData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<EdgeConfigTemplateVersionResource> Update(EdgeConfigTemplateVersionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ConfigTemplateVersions_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-05-01-preview. </description>
        ...
        {
            using DiagnosticScope scope = _configTemplateVersionsClientDiagnostics.CreateScope("EdgeConfigTemplateVersionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _configTemplateVersionsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                WorkloadOrchestrationArmOperation operation = new WorkloadOrchestrationArmOperation(_configTemplateVersionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary> Gets a collection of ConfigTemplateSchemas in the <see cref="EdgeConfigTemplateVersionResource"/>. </summary>
        /// <returns> An object representing collection of ConfigTemplateSchemas and their operations over a ConfigTemplateSchemaResource. </returns>
        public virtual ConfigTemplateSchemaCollection GetConfigTemplateSchemas()
        {
            return GetCachedClient(client => new ConfigTemplateSchemaCollection(client, Id));
        }

        /// <summary> Get a ConfigTemplateSchema Resource. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ConfigTemplateSchemaResource>> GetConfigTemplateSchemaAsync(string configTemplateSchemaName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(configTemplateSchemaName, nameof(configTemplateSchemaName));

            return await GetConfigTemplateSchemas().GetAsync(configTemplateSchemaName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="configTemplateSchemaName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ConfigTemplateSchemaResource> GetConfigTemplateSchema(string configTemplateSchemaName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(configTemplateSchemaName, nameof(configTemplateSchemaName));

            return GetConfigTemplateSchemas().Get(configTemplateSchemaName, cancellationToken);
        }
    }
}
