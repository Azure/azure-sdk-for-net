...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="TargetResource"/> using the GetSolution method.
    /// </summary>
    public partial class SolutionResource : ArmResource
    {
        ...
        {
            _solutionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.WorkloadOrchestration", ResourceType.Namespace, Diagnostics);
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<SolutionVersionResource>> GetSolutionVersionAsync(string solutionVersionName, CancellationToken cancellationToken = default)
        {
            return await GetSolutionVersions().GetAsync(solutionVersionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="solutionVersionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<SolutionVersionResource> GetSolutionVersion(string solutionVersionName, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new WorkloadOrchestrationArmOperation(_solutionClientDiagnostics, Pipeline, _solutionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<SolutionResource>> UpdateAsync(WaitUntil waitUntil, SolutionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _solutionRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new WorkloadOrchestrationArmOperation<SolutionResource>(new SolutionOperationSource(Client), _solutionClientDiagnostics, Pipeline, _solutionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<SolutionResource> Update(WaitUntil waitUntil, SolutionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _solutionRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch, cancellationToken);
                var operation = new WorkloadOrchestrationArmOperation<SolutionResource>(new SolutionOperationSource(Client), _solutionClientDiagnostics, Pipeline, _solutionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
