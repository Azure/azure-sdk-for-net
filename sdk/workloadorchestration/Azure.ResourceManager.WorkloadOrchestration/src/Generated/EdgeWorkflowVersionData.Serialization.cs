...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeWorkflowVersionData : ResourceData, IJsonModel<EdgeWorkflowVersionData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeWorkflowVersionData IJsonModel<EdgeWorkflowVersionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (EdgeWorkflowVersionData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EdgeWorkflowVersionData DeserializeEdgeWorkflowVersionData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = EdgeWorkflowVersionProperties.DeserializeEdgeWorkflowVersionProperties(prop.Value, options);
                    continue;
                }
