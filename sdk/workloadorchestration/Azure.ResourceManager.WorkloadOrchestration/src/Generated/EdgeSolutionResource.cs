...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeSolutionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EdgeSolutionResource>> UpdateAsync(WaitUntil waitUntil, EdgeSolutionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                WorkloadOrchestrationArmOperation<EdgeSolutionResource> operation = new WorkloadOrchestrationArmOperation<EdgeSolutionResource>(
                    new EdgeSolutionResourceOperationSource(Client),
        ...
        public virtual async Task<ArmOperation<EdgeSolutionResource>> UpdateAsync(WaitUntil waitUntil, EdgeSolutionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _solutionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, EdgeSolutionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                WorkloadOrchestrationArmOperation<EdgeSolutionResource> operation = new WorkloadOrchestrationArmOperation<EdgeSolutionResource>(
                    new EdgeSolutionResourceOperationSource(Client),
                    _solutionsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EdgeSolutionResource> Update(WaitUntil waitUntil, EdgeSolutionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
