    ...
    internal partial class SolutionVersionsGetBySolutionCollectionResultOfT : Pageable<EdgeSolutionVersionData>
    {
        ...
        public override IEnumerable<Page<EdgeSolutionVersionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<EdgeSolutionVersionData>.FromValues((IReadOnlyList<EdgeSolutionVersionData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
