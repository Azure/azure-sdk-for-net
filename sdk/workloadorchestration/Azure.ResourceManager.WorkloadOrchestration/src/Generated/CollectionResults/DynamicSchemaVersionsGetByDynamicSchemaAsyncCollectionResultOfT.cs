...
{
    internal partial class DynamicSchemaVersionsGetByDynamicSchemaAsyncCollectionResultOfT : AsyncPageable<EdgeDynamicSchemaVersionData>
    {
        private readonly DynamicSchemaVersions _client;
        ...
        /// <returns> The pages of DynamicSchemaVersionsGetByDynamicSchemaAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<EdgeDynamicSchemaVersionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                DynamicSchemaVersionListResult result = DynamicSchemaVersionListResult.FromResponse(response);
                yield return Page<EdgeDynamicSchemaVersionData>.FromValues((IReadOnlyList<EdgeDynamicSchemaVersionData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
