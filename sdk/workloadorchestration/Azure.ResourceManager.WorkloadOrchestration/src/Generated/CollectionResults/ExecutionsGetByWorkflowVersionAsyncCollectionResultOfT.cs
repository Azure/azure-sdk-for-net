...
{
    internal partial class ExecutionsGetByWorkflowVersionAsyncCollectionResultOfT : AsyncPageable<EdgeExecutionData>
    {
        ...
        /// <returns> The pages of ExecutionsGetByWorkflowVersionAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<EdgeExecutionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
