...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeSolutionVersionData : ResourceData
    {
        ...
        internal EdgeSolutionVersionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EdgeSolutionVersionProperties properties, ExtendedLocation extendedLocation, ETag? eTag) : base(id, name, resourceType, systemData)
        {
