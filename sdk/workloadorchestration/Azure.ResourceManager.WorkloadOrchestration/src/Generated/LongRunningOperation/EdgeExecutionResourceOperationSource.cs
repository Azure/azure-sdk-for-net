...
{
    /// <summary></summary>
    internal partial class EdgeExecutionResourceOperationSource : IOperationSource<EdgeExecutionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeExecutionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
