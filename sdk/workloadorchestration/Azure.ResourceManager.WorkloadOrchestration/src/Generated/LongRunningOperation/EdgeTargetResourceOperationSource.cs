...
{
    /// <summary></summary>
    internal partial class EdgeTargetResourceOperationSource : IOperationSource<EdgeTargetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeTargetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
