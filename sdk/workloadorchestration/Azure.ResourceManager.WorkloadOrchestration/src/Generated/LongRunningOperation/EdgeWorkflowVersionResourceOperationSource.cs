...
{
    /// <summary></summary>
    internal partial class EdgeWorkflowVersionResourceOperationSource : IOperationSource<EdgeWorkflowVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeWorkflowVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
