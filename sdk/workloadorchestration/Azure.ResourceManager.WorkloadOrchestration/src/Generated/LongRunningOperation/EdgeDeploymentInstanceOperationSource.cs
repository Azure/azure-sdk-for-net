...
{
    /// <summary></summary>
    internal partial class EdgeDeploymentInstanceOperationSource : IOperationSource<EdgeDeploymentInstanceResource>
    {
        ...
        EdgeDeploymentInstanceResource IOperationSource<EdgeDeploymentInstanceResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            EdgeDeploymentInstanceData data = EdgeDeploymentInstanceData.DeserializeEdgeDeploymentInstanceData(document.RootElement, ModelSerializationExtensions.WireOptions);
