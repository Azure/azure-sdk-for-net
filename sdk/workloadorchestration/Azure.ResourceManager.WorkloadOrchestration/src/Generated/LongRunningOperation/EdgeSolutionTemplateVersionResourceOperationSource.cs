...
{
    /// <summary></summary>
    internal partial class EdgeSolutionTemplateVersionResourceOperationSource : IOperationSource<EdgeSolutionTemplateVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeSolutionTemplateVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
