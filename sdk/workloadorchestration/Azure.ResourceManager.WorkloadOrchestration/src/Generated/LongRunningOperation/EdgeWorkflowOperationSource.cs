...
{
    /// <summary></summary>
    internal partial class EdgeWorkflowOperationSource : IOperationSource<EdgeWorkflowResource>
    {
        ...
        EdgeWorkflowResource IOperationSource<EdgeWorkflowResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            EdgeWorkflowData data = EdgeWorkflowData.DeserializeEdgeWorkflowData(document.RootElement, ModelSerializationExtensions.WireOptions);
