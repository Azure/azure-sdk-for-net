...
{
    /// <summary></summary>
    internal partial class EdgeSchemaResourceOperationSource : IOperationSource<EdgeSchemaResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeSchemaResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
