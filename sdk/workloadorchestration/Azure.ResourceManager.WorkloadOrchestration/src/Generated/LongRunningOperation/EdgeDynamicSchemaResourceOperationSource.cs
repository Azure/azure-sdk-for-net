...
{
    /// <summary></summary>
    internal partial class EdgeDynamicSchemaResourceOperationSource : IOperationSource<EdgeDynamicSchemaResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeDynamicSchemaResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
