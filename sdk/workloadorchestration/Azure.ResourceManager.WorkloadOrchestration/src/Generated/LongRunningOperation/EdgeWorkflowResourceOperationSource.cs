...
{
    /// <summary></summary>
    internal partial class EdgeWorkflowResourceOperationSource : IOperationSource<EdgeWorkflowResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeWorkflowResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
