...
{
    /// <summary></summary>
    internal partial class EdgeSchemaVersionResourceOperationSource : IOperationSource<EdgeSchemaVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeSchemaVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
