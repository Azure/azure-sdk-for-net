...
{
    /// <summary></summary>
    internal partial class EdgeDynamicSchemaVersionResourceOperationSource : IOperationSource<EdgeDynamicSchemaVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeDynamicSchemaVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
