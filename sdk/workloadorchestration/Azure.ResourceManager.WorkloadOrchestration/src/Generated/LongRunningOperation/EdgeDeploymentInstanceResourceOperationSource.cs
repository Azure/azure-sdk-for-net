...
{
    /// <summary></summary>
    internal partial class EdgeDeploymentInstanceResourceOperationSource : IOperationSource<EdgeDeploymentInstanceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeDeploymentInstanceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
