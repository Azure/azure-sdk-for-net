...
{
    internal partial class WorkloadOrchestrationArmOperation : ArmOperation
    {
        ...
        internal WorkloadOrchestrationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
