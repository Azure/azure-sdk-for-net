...
{
    /// <summary></summary>
    internal partial class EdgeSolutionTemplateResourceOperationSource : IOperationSource<EdgeSolutionTemplateResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeSolutionTemplateResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
