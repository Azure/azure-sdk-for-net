...
{
    internal partial class WorkloadOrchestrationArmOperation<T> : ArmOperation<T>
    {
        ...
        internal WorkloadOrchestrationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "WorkloadOrchestrationArmOperation",
                null,
