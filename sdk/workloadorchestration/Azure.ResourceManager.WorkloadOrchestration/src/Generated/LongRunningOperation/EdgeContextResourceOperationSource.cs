...
{
    /// <summary></summary>
    internal partial class EdgeContextResourceOperationSource : IOperationSource<EdgeContextResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeContextResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
