...
{
    /// <summary></summary>
    internal partial class EdgeConfigTemplateResourceOperationSource : IOperationSource<EdgeConfigTemplateResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeConfigTemplateResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
