...
{
    /// <summary></summary>
    internal partial class EdgeConfigTemplateVersionResourceOperationSource : IOperationSource<EdgeConfigTemplateVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeConfigTemplateVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
