...
{
    /// <summary></summary>
    internal partial class EdgeSiteReferenceResourceOperationSource : IOperationSource<EdgeSiteReferenceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeSiteReferenceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
