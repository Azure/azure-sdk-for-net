...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class WorkflowVersionResource : ArmResource
    {
        ...
        {
            _workflowVersionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.WorkloadOrchestration", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of ExecutionResources in the WorkflowVersion. </summary>
        /// <returns> An object representing collection of ExecutionResources and their operations over a ExecutionResource. </returns>
        public virtual ExecutionCollection GetExecutions()
        {
            return GetCachedClient(client => new ExecutionCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ExecutionResource>> GetExecutionAsync(string executionName, CancellationToken cancellationToken = default)
        {
            return await GetExecutions().GetAsync(executionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="executionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ExecutionResource> GetExecution(string executionName, CancellationToken cancellationToken = default)
        {
            return GetExecutions().Get(executionName, cancellationToken);
        }
        ...
        public virtual async Task<Response<WorkflowVersionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowVersionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WorkflowVersionResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowVersionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new WorkflowVersionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _workflowVersionClientDiagnostics.CreateScope("WorkflowVersionResource.Delete");
            scope.Start();
            try
            {
                var response = await _workflowVersionRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new WorkloadOrchestrationArmOperation(_workflowVersionClientDiagnostics, Pipeline, _workflowVersionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowVersionRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new WorkloadOrchestrationArmOperation(_workflowVersionClientDiagnostics, Pipeline, _workflowVersionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<WorkflowVersionResource>> UpdateAsync(WaitUntil waitUntil, WorkflowVersionPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));

            using var scope = _workflowVersionClientDiagnostics.CreateScope("WorkflowVersionResource.Update");
            scope.Start();
            try
            {
                var response = await _workflowVersionRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new WorkloadOrchestrationArmOperation<WorkflowVersionResource>(new WorkflowVersionOperationSource(Client), _workflowVersionClientDiagnostics, Pipeline, _workflowVersionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<WorkflowVersionResource> Update(WaitUntil waitUntil, WorkflowVersionPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _workflowVersionRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch, cancellationToken);
                var operation = new WorkloadOrchestrationArmOperation<WorkflowVersionResource>(new WorkflowVersionOperationSource(Client), _workflowVersionClientDiagnostics, Pipeline, _workflowVersionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
