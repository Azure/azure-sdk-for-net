...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class WorkflowVersionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<WorkflowVersionResource>> UpdateAsync(WaitUntil waitUntil, WorkflowVersionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowVersionRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var operation = new WorkloadOrchestrationArmOperation<WorkflowVersionResource>(new WorkflowVersionOperationSource(Client), _workflowVersionClientDiagnostics, Pipeline, _workflowVersionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<WorkflowVersionResource> Update(WaitUntil waitUntil, WorkflowVersionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _workflowVersionRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new WorkloadOrchestrationArmOperation<WorkflowVersionResource>(new WorkflowVersionOperationSource(Client), _workflowVersionClientDiagnostics, Pipeline, _workflowVersionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
