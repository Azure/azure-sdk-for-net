...
namespace Azure.ResourceManager.WorkloadOrchestration
{
    ...
    public partial class EdgeSchemaVersionCollection : ArmCollection, IEnumerable<EdgeSchemaVersionResource>, IAsyncEnumerable<EdgeSchemaVersionResource>
    {
        ...
        internal EdgeSchemaVersionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _schemaVersionsRestClient = new SchemaVersions(_schemaVersionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, edgeSchemaVersionApiVersion ?? "2026-05-01-preview");
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, EdgeSchemaResource.ResourceType), nameof(id));
            }
        }
