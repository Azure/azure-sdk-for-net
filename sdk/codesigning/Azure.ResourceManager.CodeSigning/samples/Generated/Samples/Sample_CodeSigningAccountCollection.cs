...
namespace Azure.ResourceManager.CodeSigning.Samples
{
    public partial class Sample_CodeSigningAccountCollection
    {
        ...
        public async Task CreateOrUpdate_CreateCodeSigningAccount()
        {
            ...
            CodeSigningAccountData data = new CodeSigningAccountData(new AzureLocation("placeholder"));
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_GetCodeSigningAccount()
        {
            // Generated from example definition: specification/codesigning/resource-manager/Microsoft.CodeSigning/preview/2023-04-30-preview/examples/getCodeSigningAccount.json
            // this example is just showing the usage of "CodeSigningAccount_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_GetCodeSigningAccount()
        {
            // Generated from example definition: specification/codesigning/resource-manager/Microsoft.CodeSigning/preview/2023-04-30-preview/examples/getCodeSigningAccount.json
            // this example is just showing the usage of "CodeSigningAccount_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_ListCodeSigningAccountsByResourceGroup()
        {
