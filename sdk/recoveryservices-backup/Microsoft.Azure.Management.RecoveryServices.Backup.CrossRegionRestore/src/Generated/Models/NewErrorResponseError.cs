...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    public partial class NewErrorResponseError
    {
        ...
        public NewErrorResponseError(string code = default(string), string message = default(string), string target = default(string), IList<NewErrorResponse> details = default(IList<NewErrorResponse>), IList<ErrorAdditionalInfo> additionalInfo = default(IList<ErrorAdditionalInfo>))
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IList<NewErrorResponse> Details { get; private set; }
