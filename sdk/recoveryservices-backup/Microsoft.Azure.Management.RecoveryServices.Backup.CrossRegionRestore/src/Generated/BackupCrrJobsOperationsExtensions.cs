...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore
{
    ...
    public static partial class BackupCrrJobsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<JobResource> List(this IBackupCrrJobsOperations operations, string azureRegion, ODataQuery<JobQueryObject> odataQuery = default(ODataQuery<JobQueryObject>), string skipToken = default(string), string resourceId = default(string), string jobName = default(string))
            {
