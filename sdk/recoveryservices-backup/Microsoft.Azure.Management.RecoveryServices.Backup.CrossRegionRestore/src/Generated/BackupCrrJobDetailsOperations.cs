...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore
{
    ...
    internal partial class BackupCrrJobDetailsOperations : IServiceOperations<RecoveryServicesBackupClient>, IBackupCrrJobDetailsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<JobResource>> GetWithHttpMessagesAsync(string azureRegion, string resourceId = default(string), string jobName = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
