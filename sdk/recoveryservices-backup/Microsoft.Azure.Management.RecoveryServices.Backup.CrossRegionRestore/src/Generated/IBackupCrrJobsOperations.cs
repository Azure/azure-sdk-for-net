...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore
{
    ...
    public partial interface IBackupCrrJobsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<JobResource>>> ListWithHttpMessagesAsync(string azureRegion, ODataQuery<JobQueryObject> odataQuery = default(ODataQuery<JobQueryObject>), string skipToken = default(string), string resourceId = default(string), string jobName = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets the list of CRR jobs from the target region.
        /// </summary>
