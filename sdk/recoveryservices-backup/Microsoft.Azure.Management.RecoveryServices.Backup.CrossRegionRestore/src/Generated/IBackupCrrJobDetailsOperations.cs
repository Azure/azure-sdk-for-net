...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore
{
    ...
    public partial interface IBackupCrrJobDetailsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<JobResource>> GetWithHttpMessagesAsync(string azureRegion, string resourceId = default(string), string jobName = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
