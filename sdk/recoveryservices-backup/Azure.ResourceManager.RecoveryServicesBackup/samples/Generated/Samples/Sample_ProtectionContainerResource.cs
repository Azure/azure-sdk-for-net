...
namespace Azure.ResourceManager.RecoveryServicesBackup.Samples
{
    public partial class Sample_ProtectionContainerResource
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/AzureWorkload/ProtectionContainers_Get.json
            ...
            ProtectionContainerResource result = await protectionContainerResource.GetAsync();
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/AzureStorage/ProtectionContainers_Register.json
            ...
            // invoke the operation
            ProtectionContainerResourceData data = new ProtectionContainerResourceData(new AzureLocation("placeholder"))
            {
            ...
            ArmOperation<ProtectionContainerResource> lro = await protectionContainerResource.UpdateAsync(WaitUntil.Completed, data);
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/AzureWorkload/ProtectionContainers_Unregister.json
            ...
            // invoke the operation
            await protectionContainerResource.DeleteAsync(WaitUntil.Completed);
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/AzureStorage/ProtectionContainers_Inquire.json
            ...
            // invoke the operation
            await protectionContainerResource.InquireAsync();
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/Common/RefreshContainers.json
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/AzureWorkload/BackupWorkloadItems_List.json
            ...
            await foreach (WorkloadItemResource item in protectionContainerResource.GetBackupWorkloadItemsAsync(filter: filter))
            {
