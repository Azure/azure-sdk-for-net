...
namespace Azure.ResourceManager.RecoveryServicesBackup.Samples
{
    public partial class Sample_PrivateEndpointConnectionResourceCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/PrivateEndpointConnection/GetPrivateEndpointConnection.json
            ...
            PrivateEndpointConnectionResourceCollection collection = resourceGroupResource.GetPrivateEndpointConnectionResources();
            ...
            PrivateEndpointConnectionResource result = await collection.GetAsync(vaultName, privateEndpointConnectionName);
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/PrivateEndpointConnection/PutPrivateEndpointConnection.json
            ...
            string vaultName = "gaallavaultbvtd2msi";
            string privateEndpointConnectionName = "gaallatestpe2.5704c932-249a-490b-a142-1396838cd3b";
            PrivateEndpointConnectionResourceData data = new PrivateEndpointConnectionResourceData(new AzureLocation("placeholder"))
            {
            ...
            ArmOperation<PrivateEndpointConnectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, vaultName, privateEndpointConnectionName, data);
