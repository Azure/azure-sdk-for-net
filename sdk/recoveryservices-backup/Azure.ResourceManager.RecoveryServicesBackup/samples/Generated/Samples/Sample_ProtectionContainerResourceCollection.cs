...
{
    public partial class Sample_ProtectionContainerResourceCollection
    {
        ...
        public async Task Get_GetProtectionContainerDetails()
        {
            ...
            ProtectionContainerResourceCollection collection = resourceGroupResource.GetProtectionContainerResources();

            // invoke the operation
            string vaultName = "testVault";
            string fabricName = "Azure";
            string containerName = "VMAppContainer;Compute;testRG;testSQL";
            ProtectionContainerResource result = await collection.GetAsync(vaultName, fabricName, containerName);
        ...
        public async Task CreateOrUpdate_RegisterAzureStorageProtectionContainers()
        {
            ...
            ArmOperation<ProtectionContainerResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, vaultName, fabricName, containerName, data);
