...
{
    public partial class Sample_JobResourceCollection
    {
        // List All Jobs
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/Common/ListJobs.json
            ...
            JobResourceCollection collection = resourceGroupResource.GetJobResources(vaultName);
            ...
            await foreach (JobResource item in collection.GetAllAsync())
            {
                ...
                JobResourceData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/Common/ListJobsWithAllSupportedFilters.json
            // this example is just showing the usage of "BackupJobs_List" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (JobResource item in collection.GetAllAsync(filter: filter))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                JobResourceData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2022-06-01-preview/examples/Common/ListJobsWithStartTimeAndEndTimeFilters.json
            // this example is just showing the usage of "BackupJobs_List" operation, for the dependent resources, they will have to be created separately.
