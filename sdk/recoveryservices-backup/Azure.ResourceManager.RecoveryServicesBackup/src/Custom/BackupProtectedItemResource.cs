...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupProtectedItemResource
    {
        ...
        /// <returns></returns>
        public virtual ArmOperation<BackupProtectedItemResource> Update(WaitUntil waitUntil, BackupProtectedItemData backupProtectedItemData, CancellationToken cancellationToken)
        {
            return Update(waitUntil, backupProtectedItemData, xMsAuthorizationAuxiliary: null, cancellationToken: cancellationToken);
        }
