...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class BackupManagementUsage
    {
        ...
        internal BackupManagementUsage(UsagesUnit? unit, string quotaPeriod, DateTimeOffset? nextResetOn, long? currentValue, long? limit, NameInfo name, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Unit = unit;
