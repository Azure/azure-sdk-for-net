...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureVMAppContainerProtectableContainer"/>. </summary>
        internal AzureVMAppContainerProtectableContainer() : base(ProtectableContainerType.VMAppContainer)
        {
        }
