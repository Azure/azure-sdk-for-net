...
{
    /// <summary></summary>
    internal partial class BackupProtectionContainerResourceOperationSource : IOperationSource<BackupProtectionContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BackupProtectionContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
