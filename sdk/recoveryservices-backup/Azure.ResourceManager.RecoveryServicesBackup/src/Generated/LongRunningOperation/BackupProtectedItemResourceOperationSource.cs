...
{
    /// <summary></summary>
    internal partial class BackupProtectedItemResourceOperationSource : IOperationSource<BackupProtectedItemResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BackupProtectedItemResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
