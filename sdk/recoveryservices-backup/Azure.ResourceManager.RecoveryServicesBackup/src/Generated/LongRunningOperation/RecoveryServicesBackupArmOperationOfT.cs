...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class RecoveryServicesBackupArmOperation<T> : ArmOperation<T>
    {
        ...
        internal RecoveryServicesBackupArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
