...
{
    /// <summary></summary>
    internal partial class BackupPrivateEndpointConnectionResourceOperationSource : IOperationSource<BackupPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BackupPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
