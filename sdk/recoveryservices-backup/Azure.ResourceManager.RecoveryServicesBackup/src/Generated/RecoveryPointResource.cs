...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ProtectedItemResource"/> using the GetRecoveryPointResources method.
    /// </summary>
    public partial class RecoveryPointResource : ArmResource
    {
        ...
        {
            TryGetApiVersion(ResourceType, out string recoveryPointResourceApiVersion);
        ...
        public virtual async Task<Response<RecoveryPointResource>> UpdateAsync(RecoveryPointResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _recoveryPointsClientDiagnostics.CreateScope("RecoveryPointResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recoveryPointsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Parent.Name, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, RecoveryPointResourcePatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<RecoveryPointResourceData> response = Response.FromValue(RecoveryPointResourceData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _itemLevelRecoveryConnectionsClientDiagnostics.CreateScope("RecoveryPointResource.Revoke");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation> MoveRecoveryPointAsync(WaitUntil waitUntil, MoveRPAcrossTiersContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _recoveryServicesClientClientDiagnostics.CreateScope("RecoveryPointResource.MoveRecoveryPoint");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation> TriggerAsync(WaitUntil waitUntil, TriggerRestoreContent content, string xMsAuthorizationAuxiliary = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _restoresClientDiagnostics.CreateScope("RecoveryPointResource.Trigger");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
