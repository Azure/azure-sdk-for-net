...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupResourceConfigResourceData : ResourceData
    {
        ...
        internal BackupResourceConfigResourceData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BackupResourceConfigProperties properties, IDictionary<string, string> tags, string location, string eTag) : base(new ResourceIdentifier(id), name, resourceType, systemData)
        {
