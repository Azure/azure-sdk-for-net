...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class ProtectionContainerResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of ProtectedItems in the <see cref="ProtectionContainerResource"/>. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ProtectedItemResource>> GetProtectedItemAsync(string protectedItemName, string filter = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(protectedItemName, nameof(protectedItemName));

            return await GetProtectedItems().GetAsync(protectedItemName, filter, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="protectedItemName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ProtectedItemResource> GetProtectedItem(string protectedItemName, string filter = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(protectedItemName, nameof(protectedItemName));

            return GetProtectedItems().Get(protectedItemName, filter, cancellationToken);
        }
