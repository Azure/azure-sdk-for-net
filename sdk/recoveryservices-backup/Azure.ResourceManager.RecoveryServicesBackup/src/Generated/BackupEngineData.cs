...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupEngineData : ResourceData
    {
        ...
        internal BackupEngineData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BackupGenericEngine properties, IDictionary<string, string> tags, string location, string eTag) : base(new ResourceIdentifier(id), name, resourceType, systemData)
        {
