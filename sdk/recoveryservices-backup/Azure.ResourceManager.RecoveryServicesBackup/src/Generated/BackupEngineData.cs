...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupEngineData : TrackedResourceData
    {
        ...
        internal BackupEngineData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, BackupGenericEngine properties, ETag? eTag, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, tags, location)
        {
