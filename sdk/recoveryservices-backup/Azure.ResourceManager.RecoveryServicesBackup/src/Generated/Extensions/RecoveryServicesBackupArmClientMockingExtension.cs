...
namespace Azure.ResourceManager.RecoveryServicesBackup.Mocking
{
    ...
    internal partial class RecoveryServicesBackupArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesBackupArmClientMockingExtension"/> class for mocking. </summary>
        protected RecoveryServicesBackupArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesBackupArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesBackupArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal RecoveryServicesBackupArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
