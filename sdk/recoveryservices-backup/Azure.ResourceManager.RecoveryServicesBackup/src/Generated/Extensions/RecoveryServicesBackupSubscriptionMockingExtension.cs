...
namespace Azure.ResourceManager.RecoveryServicesBackup.Mocking
{
    ...
    internal partial class RecoveryServicesBackupSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesBackupSubscriptionMockingExtension"/> class for mocking. </summary>
        protected RecoveryServicesBackupSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesBackupSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesBackupSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = BackupProtectionIntentProtectionIntentClientDiagnostics.CreateScope("RecoveryServicesBackupSubscriptionMockingExtension.ValidateProtectionIntent");
            scope.Start();
            try
            {
        ...
        {
            using var scope = BackupStatusClientDiagnostics.CreateScope("RecoveryServicesBackupSubscriptionMockingExtension.GetBackupStatus");
            scope.Start();
            try
            {
        ...
        {
            using var scope = FeatureSupportClientDiagnostics.CreateScope("RecoveryServicesBackupSubscriptionMockingExtension.ValidateFeatureSupport");
            scope.Start();
            try
            {
