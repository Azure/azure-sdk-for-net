...
namespace Azure.ResourceManager.RecoveryServicesBackup.Mock
{
    ...
    public partial class BackupProtectionIntentResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="BackupProtectionIntentResourceExtension"/> class for mocking. </summary>
        protected BackupProtectionIntentResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BackupProtectionIntentResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BackupProtectionIntentResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<PreValidateEnableBackupResult>> ValidateProtectionIntentAsync(AzureLocation location, PreValidateEnableBackupContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = BackupProtectionIntentProtectionIntentClientDiagnostics.CreateScope("BackupProtectionIntentResourceExtension.ValidateProtectionIntent");
            scope.Start();
            try
            {
