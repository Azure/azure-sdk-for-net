...
namespace Azure.ResourceManager.RecoveryServicesBackup.Testing
{
    ...
    public partial class RecoveryServicesBackupSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesBackupSubscriptionResourceExtension"/> class for mocking. </summary>
        protected RecoveryServicesBackupSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RecoveryServicesBackupSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecoveryServicesBackupSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<PreValidateEnableBackupResult>> ValidateProtectionIntentAsync(AzureLocation location, PreValidateEnableBackupContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = BackupProtectionIntentProtectionIntentClientDiagnostics.CreateScope("RecoveryServicesBackupSubscriptionResourceExtension.ValidateProtectionIntent");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<BackupStatusResult>> GetBackupStatusAsync(AzureLocation location, BackupStatusContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = BackupStatusClientDiagnostics.CreateScope("RecoveryServicesBackupSubscriptionResourceExtension.GetBackupStatus");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<VmResourceFeatureSupportResult>> ValidateFeatureSupportAsync(AzureLocation location, FeatureSupportContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = FeatureSupportClientDiagnostics.CreateScope("RecoveryServicesBackupSubscriptionResourceExtension.ValidateFeatureSupport");
            scope.Start();
            try
            {
