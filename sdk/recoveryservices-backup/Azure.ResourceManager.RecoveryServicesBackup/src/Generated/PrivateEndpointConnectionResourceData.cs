...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class PrivateEndpointConnectionResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of PrivateEndpointConnectionResourceData. </summary>
        /// <param name="location"> The location. </param>
        public PrivateEndpointConnectionResourceData(AzureLocation location) : base(location)
        {
        }
