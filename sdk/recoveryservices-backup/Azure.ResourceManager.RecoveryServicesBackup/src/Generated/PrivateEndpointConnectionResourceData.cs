...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class PrivateEndpointConnectionResourceData : ResourceData
    {
        ...
        internal PrivateEndpointConnectionResourceData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BackupPrivateEndpointConnectionProperties properties, IDictionary<string, string> tags, string location, string eTag) : base(new ResourceIdentifier(id), name, resourceType, systemData)
        {
