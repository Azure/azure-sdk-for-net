...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupResourceConfigData : TrackedResourceData
    {
        ...
        internal BackupResourceConfigData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, BackupResourceConfigProperties properties, ETag? eTag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="BackupResourceConfigData"/> for deserialization. </summary>
        internal BackupResourceConfigData()
        {
        }
