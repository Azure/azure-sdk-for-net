...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupJobCollection : ArmCollection, IEnumerable<BackupJobResource>, IAsyncEnumerable<BackupJobResource>
    {
        ...
        internal BackupJobCollection(ArmClient client, ResourceIdentifier id, string vaultName) : base(client, id)
        {
            ...
            _backupJobRestClient = new BackupJob(_backupJobClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, backupJobApiVersion ?? "2026-08-01");
            ...
            _backupJobsRestClient = new BackupJobs(_backupJobsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, backupJobApiVersion ?? "2026-08-01");
