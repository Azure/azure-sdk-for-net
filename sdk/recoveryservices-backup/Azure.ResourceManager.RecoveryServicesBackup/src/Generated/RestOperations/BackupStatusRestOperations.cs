...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class BackupStatusRestOperations
    {
        ...
        internal HttpMessage CreateGetRequest(string subscriptionId, AzureLocation azureRegion, BackupStatusContent content)
        {
        ...
        public async Task<Response<BackupStatusResult>> GetAsync(string subscriptionId, AzureLocation azureRegion, BackupStatusContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<BackupStatusResult> Get(string subscriptionId, AzureLocation azureRegion, BackupStatusContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(content, nameof(content));
