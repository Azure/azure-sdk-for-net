...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class RestoresRestOperations
    {
        ...
        internal RequestUriBuilder CreateTriggerRequestUri(string subscriptionId, string resourceGroupName, string vaultName, string fabricName, string containerName, string protectedItemName, string recoveryPointId, TriggerRestoreContent content)
        {
        ...
        internal HttpMessage CreateTriggerRequest(string subscriptionId, string resourceGroupName, string vaultName, string fabricName, string containerName, string protectedItemName, string recoveryPointId, TriggerRestoreContent content)
        {
            ...
            content0.JsonWriter.WriteObjectValue<TriggerRestoreContent>(content, new ModelReaderWriterOptions("W"));
