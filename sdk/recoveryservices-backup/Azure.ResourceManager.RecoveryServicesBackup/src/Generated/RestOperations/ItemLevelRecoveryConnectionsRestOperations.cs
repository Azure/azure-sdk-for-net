...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class ItemLevelRecoveryConnections
    {
        ...
        internal ItemLevelRecoveryConnections(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ItemLevelRecoveryConnections).Assembly, applicationId);
        }
