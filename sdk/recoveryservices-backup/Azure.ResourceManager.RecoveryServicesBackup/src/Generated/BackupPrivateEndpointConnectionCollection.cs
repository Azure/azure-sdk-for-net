...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupPrivateEndpointConnectionCollection : ArmCollection
    {
        ...
        internal BackupPrivateEndpointConnectionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateEndpointConnectionResourcesRestClient = new PrivateEndpointConnectionResources(_privateEndpointConnectionResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, backupPrivateEndpointConnectionApiVersion ?? "2026-07-01");
