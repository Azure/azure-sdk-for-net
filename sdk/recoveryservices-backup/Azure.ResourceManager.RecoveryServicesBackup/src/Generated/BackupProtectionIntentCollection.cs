...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupProtectionIntentCollection : ArmCollection
    {
        ...
        internal BackupProtectionIntentCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _protectionIntentClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.RecoveryServicesBackup", BackupProtectionIntentResource.ResourceType.Namespace, Diagnostics);
            _protectionIntentRestClient = new ProtectionIntent(_protectionIntentClientDiagnostics, Pipeline, Endpoint, backupProtectionIntentApiVersion ?? "2026-01-01-preview");
        ...
        public virtual async Task<ArmOperation<BackupProtectionIntentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string vaultName, string fabricName, string intentObjectName, BackupProtectionIntentData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _protectionIntentClientDiagnostics.CreateScope("BackupProtectionIntentCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _protectionIntentRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, vaultName, fabricName, intentObjectName, BackupProtectionIntentData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<BackupProtectionIntentResource>> GetAsync(string vaultName, string fabricName, string intentObjectName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _protectionIntentClientDiagnostics.CreateScope("BackupProtectionIntentCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string vaultName, string fabricName, string intentObjectName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _protectionIntentClientDiagnostics.CreateScope("BackupProtectionIntentCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<BackupProtectionIntentResource>> GetIfExistsAsync(string vaultName, string fabricName, string intentObjectName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _protectionIntentClientDiagnostics.CreateScope("BackupProtectionIntentCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
