...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupResourceEncryptionConfigExtendedData : TrackedResourceData, IJsonModel<BackupResourceEncryptionConfigExtendedData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<BackupResourceEncryptionConfigExtendedData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BackupResourceEncryptionConfigExtendedData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BackupResourceEncryptionConfigExtendedData IPersistableModel<BackupResourceEncryptionConfigExtendedData>.Create(BinaryData data, ModelReaderWriterOptions options) => (BackupResourceEncryptionConfigExtendedData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="BackupResourceEncryptionConfigExtendedData"/> from. </param>
        internal static BackupResourceEncryptionConfigExtendedData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeBackupResourceEncryptionConfigExtendedData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BackupResourceEncryptionConfigExtendedData IJsonModel<BackupResourceEncryptionConfigExtendedData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (BackupResourceEncryptionConfigExtendedData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BackupResourceEncryptionConfigExtendedData DeserializeBackupResourceEncryptionConfigExtendedData(JsonElement element, ModelReaderWriterOptions options)
        {
