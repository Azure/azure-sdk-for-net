...
{
    /// <summary> A class representing the RecoveryPointResource data model. </summary>
    public partial class RecoveryPointResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of RecoveryPointResourceData. </summary>
        /// <param name="location"> The location. </param>
        public RecoveryPointResourceData(AzureLocation location) : base(location)
        {
        }
        ...
        internal RecoveryPointResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, RecoveryPoint properties, ETag? eTag) : base(id, name, resourceType, systemData, tags, location)
        {
