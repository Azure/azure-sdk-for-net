...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupJobResource : ArmResource
    {
        ...
        internal BackupJobResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _jobCancellationsRestClient = new JobCancellations(_jobCancellationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, backupJobApiVersion ?? "2026-08-01");
