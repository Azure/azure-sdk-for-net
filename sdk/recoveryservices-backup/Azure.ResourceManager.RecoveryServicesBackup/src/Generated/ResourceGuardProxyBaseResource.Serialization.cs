...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class ResourceGuardProxyBaseResource : IJsonModel<ResourceGuardProxyBaseResourceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceGuardProxyBaseResourceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ResourceGuardProxyBaseResourceData>(Data, options, AzureResourceManagerRecoveryServicesBackupContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceGuardProxyBaseResourceData IPersistableModel<ResourceGuardProxyBaseResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ResourceGuardProxyBaseResourceData>(data, options, AzureResourceManagerRecoveryServicesBackupContext.Default);
