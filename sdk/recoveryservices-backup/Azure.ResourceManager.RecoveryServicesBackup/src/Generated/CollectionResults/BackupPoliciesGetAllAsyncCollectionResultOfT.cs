...
{
    internal partial class BackupPoliciesGetAllAsyncCollectionResultOfT : AsyncPageable<ProtectionPolicyResourceData>
    {
        ...
        public override async IAsyncEnumerable<Page<ProtectionPolicyResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ProtectionPolicyResourceList result = ProtectionPolicyResourceList.FromResponse(response);
                yield return Page<ProtectionPolicyResourceData>.FromValues((IReadOnlyList<ProtectionPolicyResourceData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ProtectionPolicyCollection.GetAll");
            scope.Start();
            try
            {
