...
{
    internal partial class BackupPoliciesGetAllAsyncCollectionResultOfT : AsyncPageable<BackupProtectionPolicyData>
    {
        ...
        public override async IAsyncEnumerable<Page<BackupProtectionPolicyData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<BackupProtectionPolicyData>.FromValues((IReadOnlyList<BackupProtectionPolicyData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
