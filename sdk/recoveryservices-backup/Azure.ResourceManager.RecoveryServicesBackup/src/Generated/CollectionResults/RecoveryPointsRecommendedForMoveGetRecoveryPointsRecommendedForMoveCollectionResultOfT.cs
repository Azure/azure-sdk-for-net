...
{
    internal partial class RecoveryPointsRecommendedForMoveGetRecoveryPointsRecommendedForMoveCollectionResultOfT : Pageable<BackupRecoveryPointData>
    {
        ...
        /// <summary> Initializes a new instance of RecoveryPointsRecommendedForMoveGetRecoveryPointsRecommendedForMoveCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of RecoveryPointsRecommendedForMoveGetRecoveryPointsRecommendedForMoveCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RecoveryPointsRecommendedForMoveGetRecoveryPointsRecommendedForMoveCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BackupRecoveryPointData>> AsPages(string continuationToken, int? pageSizeHint)
        {
