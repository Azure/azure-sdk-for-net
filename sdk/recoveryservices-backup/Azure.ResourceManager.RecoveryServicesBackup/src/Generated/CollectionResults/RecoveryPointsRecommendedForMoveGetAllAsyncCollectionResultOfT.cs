...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class RecoveryPointsRecommendedForMoveGetAllAsyncCollectionResultOfT : AsyncPageable<BackupRecoveryPointData>
    {
        ...
        /// <summary> Initializes a new instance of RecoveryPointsRecommendedForMoveGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of RecoveryPointsRecommendedForMoveGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetAllRequest(nextLink, _subscriptionId, _resourceGroupName, _vaultName, _fabricName, _containerName, _protectedItemName, _content, _context) : _client.CreateGetAllRequest(_subscriptionId, _resourceGroupName, _vaultName, _fabricName, _containerName, _protectedItemName, _content, _context);
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("BackupProtectedItemResource.GetAll");
            scope.Start();
            try
            {
