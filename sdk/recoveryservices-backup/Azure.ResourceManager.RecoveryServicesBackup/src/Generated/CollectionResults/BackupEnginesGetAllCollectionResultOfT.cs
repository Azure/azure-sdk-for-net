...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class BackupEnginesGetAllCollectionResultOfT : Pageable<BackupEngineData>
    {
        ...
        /// <summary> Initializes a new instance of BackupEnginesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BackupEngines client used to send requests. </param>
        ...
        public BackupEnginesGetAllCollectionResultOfT(BackupEngines client, string subscriptionId, string resourceGroupName, string vaultName, string filter, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BackupEnginesGetAllCollectionResultOfT as an enumerable collection. </summary>
