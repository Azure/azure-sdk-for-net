...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class BackupEnginesGetAllCollectionResultOfT : Pageable<BackupEngineData>
    {
        ...
        public BackupEnginesGetAllCollectionResultOfT(BackupEngines client, string subscriptionId, string resourceGroupName, string vaultName, string filter, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
