...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class BackupJobsGetAllCollectionResultOfT : Pageable<BackupJobData>
    {
        ...
        public BackupJobsGetAllCollectionResultOfT(BackupJobs client, string subscriptionId, string resourceGroupName, string vaultName, string filter, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
