...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class BackupJobsGetAllCollectionResultOfT : Pageable<BackupJobData>
    {
        ...
        /// <summary> Initializes a new instance of BackupJobsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BackupJobsGetAllCollectionResultOfT(BackupJobs client, string subscriptionId, string resourceGroupName, string vaultName, string filter, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BackupJobsGetAllCollectionResultOfT as an enumerable collection. </summary>
