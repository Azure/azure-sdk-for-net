...
{
    internal partial class RecoveryPointsGetAllAsyncCollectionResultOfT : AsyncPageable<BackupRecoveryPointData>
    {
        ...
        public RecoveryPointsGetAllAsyncCollectionResultOfT(RecoveryPoints client, string subscriptionId, string resourceGroupName, string vaultName, string fabricName, string containerName, string protectedItemName, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
