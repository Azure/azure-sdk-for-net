...
{
    internal partial class RecoveryPointsGetAllAsyncCollectionResultOfT : AsyncPageable<RecoveryPointResourceData>
    {
        private readonly RecoveryPoints _client;
        ...
        /// <summary> Initializes a new instance of RecoveryPointsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RecoveryPointsGetAllAsyncCollectionResultOfT(RecoveryPoints client, string subscriptionId, string resourceGroupName, string vaultName, string fabricName, string containerName, string protectedItemName, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RecoveryPointsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RecoveryPointsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("RecoveryPointResourceCollection.GetAll");
            scope.Start();
            try
            {
