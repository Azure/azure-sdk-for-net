...
{
    internal partial class BackupProtectionIntentGetBackupProtectionIntentsCollectionResultOfT : Pageable<BackupProtectionIntentData>
    {
        ...
        /// <returns> The pages of BackupProtectionIntentGetBackupProtectionIntentsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BackupProtectionIntentData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<BackupProtectionIntentData>.FromValues((IReadOnlyList<BackupProtectionIntentData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
