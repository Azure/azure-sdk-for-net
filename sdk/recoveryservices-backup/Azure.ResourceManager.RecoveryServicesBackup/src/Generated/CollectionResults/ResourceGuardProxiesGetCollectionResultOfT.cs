...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class ResourceGuardProxiesGetCollectionResultOfT : Pageable<ResourceGuardProxyData>
    {
        ...
        public ResourceGuardProxiesGetCollectionResultOfT(ResourceGuardProxies client, string subscriptionId, string resourceGroupName, string vaultName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
