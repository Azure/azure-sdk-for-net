...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    internal partial class ResourceGuardProxiesGetCollectionResultOfT : Pageable<ResourceGuardProxyData>
    {
        ...
        /// <summary> Initializes a new instance of ResourceGuardProxiesGetCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ResourceGuardProxiesGetCollectionResultOfT(ResourceGuardProxies client, string subscriptionId, string resourceGroupName, string vaultName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ResourceGuardProxiesGetCollectionResultOfT as an enumerable collection. </summary>
