...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupResourceEncryptionConfigExtendedResource : ArmResource
    {
        ...
        internal BackupResourceEncryptionConfigExtendedResource(ArmClient client, BackupResourceEncryptionConfigExtendedData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<BackupResourceEncryptionConfigExtendedResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new BackupResourceEncryptionConfigExtendedResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
