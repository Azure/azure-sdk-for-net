...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    public partial class BackupResourceEncryptionConfigExtendedResource : ArmResource
    {
        ...
        internal BackupResourceEncryptionConfigExtendedResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _backupResourceEncryptionConfigsRestClient = new BackupResourceEncryptionConfigs(_backupResourceEncryptionConfigsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, backupResourceEncryptionConfigExtendedApiVersion ?? "2026-07-01");
        ...
        public virtual async Task<ArmOperation> CreateOrUpdateAsync(WaitUntil waitUntil, BackupResourceEncryptionConfigExtendedCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _backupResourceEncryptionConfigsClientDiagnostics.CreateScope("BackupResourceEncryptionConfigExtendedResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _backupResourceEncryptionConfigsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, BackupResourceEncryptionConfigExtendedCreateOrUpdateContent.ToRequestContent(content), context);
