...
{
    public partial class FileShareBackupRequest : IUtf8JsonSerializable
    {
        ...
        internal static FileShareBackupRequest DeserializeFileShareBackupRequest(JsonElement element)
        {
            ...
            return new FileShareBackupRequest(objectType, Optional.ToNullable(recoveryPointExpiryTimeInUTC));
        }
    }
}
