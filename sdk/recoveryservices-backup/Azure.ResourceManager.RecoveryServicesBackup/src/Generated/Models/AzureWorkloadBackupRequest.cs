...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureWorkloadBackupRequest : BackupContent
    {
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadBackupRequest"/>. </summary>
        public AzureWorkloadBackupRequest() : base("AzureWorkloadBackupRequest")
        {
        }
        ...
        internal AzureWorkloadBackupRequest(string objectType, IDictionary<string, BinaryData> additionalBinaryDataProperties, BackupType? backupType, bool? enableCompression, DateTimeOffset? recoveryPointExpiryTimeInUTC) : base(objectType, additionalBinaryDataProperties)
        {
