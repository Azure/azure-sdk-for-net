...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class GenericRecoveryPoint : IUtf8JsonSerializable, IModelJsonSerializable<GenericRecoveryPoint>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GenericRecoveryPoint>(this, options.Format);
        ...
        internal static GenericRecoveryPoint DeserializeGenericRecoveryPoint(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GenericRecoveryPoint(objectType, friendlyName.Value, recoveryPointType.Value, Optional.ToNullable(recoveryPointTime), recoveryPointAdditionalInfo.Value, recoveryPointProperties.Value, serializedAdditionalRawData);
        }
