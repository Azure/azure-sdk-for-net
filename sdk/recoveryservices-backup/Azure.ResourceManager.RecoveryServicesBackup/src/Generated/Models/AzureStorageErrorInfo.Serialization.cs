...
{
    public partial class AzureStorageErrorInfo : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageErrorInfo DeserializeAzureStorageErrorInfo(JsonElement element)
        {
            ...
            return new AzureStorageErrorInfo(Optional.ToNullable(errorCode), errorString.Value, Optional.ToList(recommendations));
        }
    }
}
