...
{
    internal partial class UnknownBackupGenericProtectionPolicy : BackupGenericProtectionPolicy, IJsonModel<BackupGenericProtectionPolicy>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBackupGenericProtectionPolicy"/> for deserialization. </summary>
        internal UnknownBackupGenericProtectionPolicy()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupGenericProtectionPolicy DeserializeUnknownBackupGenericProtectionPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownBackupGenericProtectionPolicy(protectedItemsCount, backupManagementType, resourceGuardOperationRequests ?? new ChangeTrackingList<string>(), additionalBinaryDataProperties);
        }
    }
}
