...
{
    public partial class AzureIaasVmJobExtendedInfo : IUtf8JsonSerializable
    {
        ...
        internal static AzureIaasVmJobExtendedInfo DeserializeAzureIaasVmJobExtendedInfo(JsonElement element)
        {
            Optional<IList<AzureIaasVmJobTaskDetails>> tasksList = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("tasksList"u8))
                {
                    ...
                    {
                        array.Add(AzureIaasVmJobTaskDetails.DeserializeAzureIaasVmJobTaskDetails(item));
                    }
                    tasksList = array;
                    continue;
                }
            ...
            return new AzureIaasVmJobExtendedInfo(Optional.ToList(tasksList), Optional.ToDictionary(propertyBag), Optional.ToDictionary(internalPropertyBag), Optional.ToNullable(progressPercentage), estimatedRemainingDuration.Value, dynamicErrorMessage.Value);
        }
    }
}
