...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSapAseSystemProtectableItem : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadSapAseSystemProtectableItem>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadSapAseSystemProtectableItem>(this, options.Format);
        ...
        internal static VmWorkloadSapAseSystemProtectableItem DeserializeVmWorkloadSapAseSystemProtectableItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VmWorkloadSapAseSystemProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value, serializedAdditionalRawData);
        }
