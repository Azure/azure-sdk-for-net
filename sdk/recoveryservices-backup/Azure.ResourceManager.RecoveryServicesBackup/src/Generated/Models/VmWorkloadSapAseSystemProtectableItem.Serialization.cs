...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSapAseSystemProtectableItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmWorkloadSapAseSystemProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSapAseSystemProtectableItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSapAseSystemProtectableItem>)} interface");
            }
        ...
        VmWorkloadSapAseSystemProtectableItem IJsonModel<VmWorkloadSapAseSystemProtectableItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IPersistableModel<VmWorkloadSapAseSystemProtectableItem>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        VmWorkloadSapAseSystemProtectableItem IPersistableModel<VmWorkloadSapAseSystemProtectableItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<VmWorkloadSapAseSystemProtectableItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
