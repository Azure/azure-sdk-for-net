...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSqlInstanceWorkloadItem : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadSqlInstanceWorkloadItem>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<VmWorkloadSqlInstanceWorkloadItem>(this, options.Format);
        ...
        internal static VmWorkloadSqlInstanceWorkloadItem DeserializeVmWorkloadSqlInstanceWorkloadItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VmWorkloadSqlInstanceWorkloadItem(backupManagementType.Value, workloadType.Value, workloadItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subWorkloadItemCount), Optional.ToList(dataDirectoryPaths), rawData);
        }
