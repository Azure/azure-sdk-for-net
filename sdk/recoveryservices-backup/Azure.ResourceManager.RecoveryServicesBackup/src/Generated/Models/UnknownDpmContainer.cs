...
{
    internal partial class UnknownDpmContainer : DpmContainer
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDpmContainer"/>. </summary>
        ...
        internal UnknownDpmContainer(string friendlyName, BackupManagementType? backupManagementType, string registrationStatus, string healthStatus, ProtectableContainerType containerType, string protectableObjectType, IDictionary<string, BinaryData> additionalBinaryDataProperties, bool? canReRegister, string containerId, long? protectedItemCount, string dpmAgentVersion, IList<string> dpmServers, bool? isUpgradeAvailable, string protectionStatus, DPMContainerExtendedInfo extendedInfo) : base(friendlyName, backupManagementType, registrationStatus, healthStatus, containerType != default ? containerType : "unknown", protectableObjectType, additionalBinaryDataProperties, canReRegister, containerId, protectedItemCount, dpmAgentVersion, dpmServers, isUpgradeAvailable, protectionStatus, extendedInfo)
        {
        }
    }
}
