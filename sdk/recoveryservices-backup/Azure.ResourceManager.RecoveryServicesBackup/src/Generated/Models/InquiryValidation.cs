...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class InquiryValidation
    {
        ...
        internal InquiryValidation(string status, BackupErrorDetail errorDetail, string additionalDetail, BinaryData protectableItemCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
