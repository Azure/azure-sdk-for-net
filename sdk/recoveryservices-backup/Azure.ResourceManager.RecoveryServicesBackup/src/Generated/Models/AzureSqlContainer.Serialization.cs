...
{
    public partial class AzureSqlContainer : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlContainer DeserializeAzureSqlContainer(JsonElement element)
        {
            ...
            return new AzureSqlContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value);
        }
    }
}
