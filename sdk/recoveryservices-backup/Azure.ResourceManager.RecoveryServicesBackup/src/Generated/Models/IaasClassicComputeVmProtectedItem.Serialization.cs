...
{
    public partial class IaasClassicComputeVmProtectedItem : IUtf8JsonSerializable, IJsonModel<IaasClassicComputeVmProtectedItem>, IPersistableModel<IaasClassicComputeVmProtectedItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastBackupOn))
            {
                ...
                builder.AppendLine($" '{LastBackupOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ExtendedProperties))
            {
                ...
                AppendChildObject(builder, ExtendedProperties, options, 2);
            }
