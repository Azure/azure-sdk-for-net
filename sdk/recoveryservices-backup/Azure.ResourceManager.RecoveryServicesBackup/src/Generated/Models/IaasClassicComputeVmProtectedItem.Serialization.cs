...
{
    public partial class IaasClassicComputeVmProtectedItem : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsCollectionDefined(HealthDetails))
            {
            ...
            if (Core.Optional.IsCollectionDefined(KpisHealths))
            {
            ...
            if (Core.Optional.IsDefined(ExtendedProperties))
            {
        ...
        internal static IaasClassicComputeVmProtectedItem DeserializeIaasClassicComputeVmProtectedItem(JsonElement element)
        {
            ...
            Core.Optional<IaasVmProtectedItemHealthStatus> healthStatus = default;
            Core.Optional<IList<IaasVmHealthDetails>> healthDetails = default;
            Core.Optional<IDictionary<string, KpiResourceHealthDetails>> kpisHealths = default;
            Core.Optional<string> lastBackupStatus = default;
            Core.Optional<DateTimeOffset> lastBackupTime = default;
            Core.Optional<string> protectedItemDataId = default;
            Core.Optional<IaasVmProtectedItemExtendedInfo> extendedInfo = default;
            Core.Optional<IaasVmBackupExtendedProperties> extendedProperties = default;
            ...
            return new IaasClassicComputeVmProtectedItem(protectedItemType, Core.Optional.ToNullable(backupManagementType), Core.Optional.ToNullable(workloadType), containerName.Value, sourceResourceId.Value, policyId.Value, Core.Optional.ToNullable(lastRecoveryPoint), backupSetName.Value, Core.Optional.ToNullable(createMode), Core.Optional.ToNullable(deferredDeleteTimeInUTC), Core.Optional.ToNullable(isScheduledForDeferredDelete), deferredDeleteTimeRemaining.Value, Core.Optional.ToNullable(isDeferredDeleteScheduleUpcoming), Core.Optional.ToNullable(isRehydrate), Core.Optional.ToList(resourceGuardOperationRequests), Core.Optional.ToNullable(isArchiveEnabled), policyName.Value, Core.Optional.ToNullable(softDeleteRetentionPeriod), friendlyName.Value, virtualMachineId.Value, protectionStatus.Value, Core.Optional.ToNullable(protectionState), Core.Optional.ToNullable(healthStatus), Core.Optional.ToList(healthDetails), Core.Optional.ToDictionary(kpisHealths), lastBackupStatus.Value, Core.Optional.ToNullable(lastBackupTime), protectedItemDataId.Value, extendedInfo.Value, extendedProperties.Value);
        }
    }
}
