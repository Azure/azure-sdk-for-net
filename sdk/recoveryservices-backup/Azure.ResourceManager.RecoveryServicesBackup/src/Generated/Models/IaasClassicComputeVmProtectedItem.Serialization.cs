...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasClassicComputeVmProtectedItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasClassicComputeVmProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasClassicComputeVmProtectedItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasClassicComputeVmProtectedItem>)} interface");
            }
        ...
        string IPersistableModel<IaasClassicComputeVmProtectedItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
