...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureVmWorkloadSAPAseDatabaseProtectableItem : VmWorkloadProtectableItem, IJsonModel<AzureVmWorkloadSAPAseDatabaseProtectableItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPAseDatabaseProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureVmWorkloadSAPAseDatabaseProtectableItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureVmWorkloadSAPAseDatabaseProtectableItem IPersistableModel<AzureVmWorkloadSAPAseDatabaseProtectableItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureVmWorkloadSAPAseDatabaseProtectableItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureVmWorkloadSAPAseDatabaseProtectableItem IJsonModel<AzureVmWorkloadSAPAseDatabaseProtectableItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureVmWorkloadSAPAseDatabaseProtectableItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureVmWorkloadSAPAseDatabaseProtectableItem DeserializeAzureVmWorkloadSAPAseDatabaseProtectableItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string protectableItemType = "SAPAseDatabase";
