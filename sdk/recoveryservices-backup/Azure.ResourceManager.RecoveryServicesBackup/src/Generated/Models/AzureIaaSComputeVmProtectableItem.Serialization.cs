...
{
    public partial class AzureIaaSComputeVmProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static AzureIaaSComputeVmProtectableItem DeserializeAzureIaaSComputeVmProtectableItem(JsonElement element)
        {
            ...
            return new AzureIaaSComputeVmProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), virtualMachineId.Value, virtualMachineVersion.Value, resourceGroup.Value);
        }
    }
}
