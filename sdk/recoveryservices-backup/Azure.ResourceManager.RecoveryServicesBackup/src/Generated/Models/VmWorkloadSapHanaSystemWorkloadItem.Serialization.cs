...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSapHanaSystemWorkloadItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmWorkloadSapHanaSystemWorkloadItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSapHanaSystemWorkloadItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSapHanaSystemWorkloadItem>)} interface");
            }
        ...
        string IPersistableModel<VmWorkloadSapHanaSystemWorkloadItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
