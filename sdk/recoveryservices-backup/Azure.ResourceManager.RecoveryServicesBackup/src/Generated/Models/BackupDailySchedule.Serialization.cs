...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupDailySchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupDailySchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupDailySchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupDailySchedule>)} interface");
            }
        ...
        string IPersistableModel<BackupDailySchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
