...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVmHealthDetails : ResourceHealthDetails
    {
        ...
        internal IaasVmHealthDetails(int? code, string title, string message, IReadOnlyList<string> recommendations, Dictionary<string, BinaryData> rawData) : base(code, title, message, recommendations, rawData)
        {
        }
    }
}
