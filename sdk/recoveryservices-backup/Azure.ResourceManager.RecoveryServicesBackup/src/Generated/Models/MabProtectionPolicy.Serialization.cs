...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MabProtectionPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MabProtectionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MabProtectionPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MabProtectionPolicy>)} interface");
            }
        ...
        internal static MabProtectionPolicy DeserializeMabProtectionPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MabProtectionPolicy(Optional.ToNullable(protectedItemsCount), backupManagementType, Optional.ToList(resourceGuardOperationRequests), serializedAdditionalRawData, schedulePolicy.Value, retentionPolicy.Value);
        }
        ...
        string IPersistableModel<MabProtectionPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
