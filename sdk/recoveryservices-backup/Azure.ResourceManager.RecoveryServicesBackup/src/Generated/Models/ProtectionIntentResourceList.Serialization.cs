...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProtectionIntentResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProtectionIntentResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProtectionIntentResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProtectionIntentResourceList>)} interface");
            }
        ...
        string IPersistableModel<ProtectionIntentResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
