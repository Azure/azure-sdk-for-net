...
{
    public partial class VmAppContainerProtectionContainer : Core.IUtf8JsonSerializable
    {
        ...
        internal static VmAppContainerProtectionContainer DeserializeVmAppContainerProtectionContainer(JsonElement element)
        {
            ...
            return new VmAppContainerProtectionContainer(friendlyName.Value, Core.Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, sourceResourceId.Value, Core.Optional.ToNullable(lastUpdatedTime), extendedInfo.Value, Core.Optional.ToNullable(workloadType), Core.Optional.ToNullable(operationType));
        }
    }
}
