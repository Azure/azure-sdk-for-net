...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasVmProtectableItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasVmProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasVmProtectableItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasVmProtectableItem>)} interface");
            }
        ...
        string IPersistableModel<IaasVmProtectableItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
