...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class IaasVmProtectableItem : IUtf8JsonSerializable, IModelJsonSerializable<IaasVmProtectableItem>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<IaasVmProtectableItem>(this, options.Format);
        ...
        internal static IaasVmProtectableItem DeserializeIaasVmProtectableItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IaasVmProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), virtualMachineId.Value, virtualMachineVersion.Value, resourceGroup.Value, rawData);
        }
