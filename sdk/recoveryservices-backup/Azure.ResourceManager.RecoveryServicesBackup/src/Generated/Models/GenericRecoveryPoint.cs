...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class GenericRecoveryPoint : BackupGenericRecoveryPoint
    {
        ...
        internal GenericRecoveryPoint(string objectType, string friendlyName, string recoveryPointType, DateTimeOffset? recoveryPointOn, string recoveryPointAdditionalInfo, RecoveryPointProperties recoveryPointProperties, Dictionary<string, BinaryData> rawData) : base(objectType, rawData)
        {
