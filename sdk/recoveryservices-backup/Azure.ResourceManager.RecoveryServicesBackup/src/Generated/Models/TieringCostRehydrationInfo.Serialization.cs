...
{
    public partial class TieringCostRehydrationInfo : IUtf8JsonSerializable, IJsonModel<TieringCostRehydrationInfo>, IPersistableModel<TieringCostRehydrationInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RehydrationSizeInBytes))
            {
                builder.Append("  rehydrationSizeInBytes:");
                builder.AppendLine($" '{RehydrationSizeInBytes.ToString()}'");
            }

            if (Optional.IsDefined(RetailRehydrationCostPerGBPerMonth))
            {
                builder.Append("  retailRehydrationCostPerGBPerMonth:");
                builder.AppendLine($" '{RetailRehydrationCostPerGBPerMonth.ToString()}'");
            }
