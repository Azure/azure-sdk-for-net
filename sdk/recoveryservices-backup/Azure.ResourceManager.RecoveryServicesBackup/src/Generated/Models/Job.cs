...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public abstract partial class Job
    {
        ...
        internal Job(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType)
        {
