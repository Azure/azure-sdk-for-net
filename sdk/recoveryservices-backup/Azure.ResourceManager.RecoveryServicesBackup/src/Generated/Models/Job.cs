...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public abstract partial class Job
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Job"/>. </summary>
        ...
        private protected Job(string jobType)
        {
            JobType = jobType;
        }
        ...
        internal Job(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
