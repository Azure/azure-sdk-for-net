...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadSapHanaRecoveryPoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadSapHanaRecoveryPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadSapHanaRecoveryPoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadSapHanaRecoveryPoint>)} interface");
            }
        ...
        string IPersistableModel<WorkloadSapHanaRecoveryPoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
