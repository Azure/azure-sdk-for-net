...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class WorkloadSapHanaRecoveryPoint : IUtf8JsonSerializable, IModelJsonSerializable<WorkloadSapHanaRecoveryPoint>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkloadSapHanaRecoveryPoint>(this, options.Format);
        ...
        internal static WorkloadSapHanaRecoveryPoint DeserializeWorkloadSapHanaRecoveryPoint(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new WorkloadSapHanaRecoveryPoint(objectType, Optional.ToNullable(recoveryPointTimeInUTC), Optional.ToNullable(type), Optional.ToList(recoveryPointTierDetails), Optional.ToDictionary(recoveryPointMoveReadinessInfo), recoveryPointProperties.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="WorkloadSapHanaRecoveryPoint"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="WorkloadSapHanaRecoveryPoint"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="WorkloadSapHanaRecoveryPoint"/>. </summary>
