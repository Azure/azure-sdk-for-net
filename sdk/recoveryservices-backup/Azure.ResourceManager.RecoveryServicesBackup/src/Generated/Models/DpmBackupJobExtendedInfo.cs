...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class DpmBackupJobExtendedInfo
    {
        ...
        internal DpmBackupJobExtendedInfo(IList<DpmBackupJobTaskDetails> tasksList, IDictionary<string, string> propertyBag, string dynamicErrorMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TasksList = tasksList;
