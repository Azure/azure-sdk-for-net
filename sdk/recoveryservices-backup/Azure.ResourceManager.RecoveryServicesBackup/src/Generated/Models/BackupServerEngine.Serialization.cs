...
{
    public partial class BackupServerEngine : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupServerEngine DeserializeBackupServerEngine(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
