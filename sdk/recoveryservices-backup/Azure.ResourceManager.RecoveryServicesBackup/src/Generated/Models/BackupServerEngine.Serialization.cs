...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupServerEngine>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupServerEngine>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupServerEngine>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupServerEngine>)} interface");
            }
        ...
        string IPersistableModel<BackupServerEngine>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
