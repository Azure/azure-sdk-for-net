...
{
    public partial class AzureWorkloadAutoProtectionIntent : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadAutoProtectionIntent DeserializeAzureWorkloadAutoProtectionIntent(JsonElement element)
        {
            ...
            return new AzureWorkloadAutoProtectionIntent(protectionIntentItemType, Optional.ToNullable(backupManagementType), sourceResourceId.Value, itemId.Value, policyId.Value, Optional.ToNullable(protectionState));
        }
    }
}
