...
{
    internal partial class UnknownAzureVmWorkloadItem : AzureVmWorkloadItem
    {
        /// <summary> Initializes a new instance of <see cref="UnknownAzureVmWorkloadItem"/>. </summary>
        ...
        internal UnknownAzureVmWorkloadItem(string backupManagementType, string workloadType, string workloadItemType, string friendlyName, BackupProtectionStatus? protectionState, IDictionary<string, BinaryData> additionalBinaryDataProperties, string parentName, string serverName, bool? isAutoProtectable, int? subinquireditemcount, int? subWorkloadItemCount) : base(backupManagementType, workloadType, workloadItemType ?? "unknown", friendlyName, protectionState, additionalBinaryDataProperties, parentName, serverName, isAutoProtectable, subinquireditemcount, subWorkloadItemCount)
        {
        }
    }
}
