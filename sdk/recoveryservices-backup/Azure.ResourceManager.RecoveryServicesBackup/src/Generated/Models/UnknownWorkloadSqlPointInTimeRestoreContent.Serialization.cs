...
{
    internal partial class UnknownWorkloadSqlPointInTimeRestoreContent : WorkloadSqlPointInTimeRestoreContent, IJsonModel<WorkloadSqlPointInTimeRestoreContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadSqlPointInTimeRestoreContent"/> for deserialization. </summary>
        internal UnknownWorkloadSqlPointInTimeRestoreContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWorkloadSqlPointInTimeRestoreContent DeserializeUnknownWorkloadSqlPointInTimeRestoreContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownWorkloadSqlPointInTimeRestoreContent(
                objectType,
