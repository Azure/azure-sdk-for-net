...
{
    public partial class BackupGenericProtectionContainer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupGenericProtectionContainer DeserializeBackupGenericProtectionContainer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
