...
{
    [ModelReaderProxy(typeof(UnknownProtectionContainer))]
    public partial class BackupGenericProtectionContainer : IUtf8JsonSerializable, IJsonModel<BackupGenericProtectionContainer>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupGenericProtectionContainer>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        BackupGenericProtectionContainer IJsonModel<BackupGenericProtectionContainer>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<BackupGenericProtectionContainer>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        BackupGenericProtectionContainer IModel<BackupGenericProtectionContainer>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<BackupGenericProtectionContainer>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
