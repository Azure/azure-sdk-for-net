...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSqlAvailabilityGroupProtectableItem>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSqlAvailabilityGroupProtectableItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSqlAvailabilityGroupProtectableItem>)} interface");
            }
        ...
        string IPersistableModel<VmWorkloadSqlAvailabilityGroupProtectableItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
