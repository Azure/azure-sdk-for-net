...
{
    internal partial class UnknownWorkloadSqlRecoveryPoint : WorkloadSqlRecoveryPoint, IJsonModel<WorkloadSqlRecoveryPoint>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadSqlRecoveryPoint"/> for deserialization. </summary>
        internal UnknownWorkloadSqlRecoveryPoint()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSqlRecoveryPoint IPersistableModel<WorkloadSqlRecoveryPoint>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownWorkloadSqlRecoveryPoint)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSqlRecoveryPoint IJsonModel<WorkloadSqlRecoveryPoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownWorkloadSqlRecoveryPoint)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWorkloadSqlRecoveryPoint DeserializeUnknownWorkloadSqlRecoveryPoint(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = WorkloadSqlRecoveryPointExtendedInfo.DeserializeWorkloadSqlRecoveryPointExtendedInfo(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new UnknownWorkloadSqlRecoveryPoint(
                objectType,
                threatStatus,
