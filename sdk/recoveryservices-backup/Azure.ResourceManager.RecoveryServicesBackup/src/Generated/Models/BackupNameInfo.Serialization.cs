...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupNameInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupNameInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupNameInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupNameInfo>)} interface");
            }
        ...
        string IPersistableModel<BackupNameInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
