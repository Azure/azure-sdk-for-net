...
{
    public partial class BackupNameInfo : IUtf8JsonSerializable, IJsonModel<BackupNameInfo>, IPersistableModel<BackupNameInfo>
    {
        ...
        void IJsonModel<BackupNameInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BackupNameInfo)} does not support '{format}' format.");
            }
