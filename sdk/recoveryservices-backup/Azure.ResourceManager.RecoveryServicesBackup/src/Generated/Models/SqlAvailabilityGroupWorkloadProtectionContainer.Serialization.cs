...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlAvailabilityGroupWorkloadProtectionContainer>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SqlAvailabilityGroupWorkloadProtectionContainer IJsonModel<SqlAvailabilityGroupWorkloadProtectionContainer>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<SqlAvailabilityGroupWorkloadProtectionContainer>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SqlAvailabilityGroupWorkloadProtectionContainer IModel<SqlAvailabilityGroupWorkloadProtectionContainer>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SqlAvailabilityGroupWorkloadProtectionContainer>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
