...
{
    internal partial class UnknownBackupGenericJob : BackupGenericJob, IJsonModel<BackupGenericJob>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBackupGenericJob"/> for deserialization. </summary>
        internal UnknownBackupGenericJob()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupGenericJob DeserializeUnknownBackupGenericJob(JsonElement element, ModelReaderWriterOptions options)
        {
