...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmAppContainerProtectableContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmAppContainerProtectableContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmAppContainerProtectableContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmAppContainerProtectableContainer>)} interface");
            }
        ...
        string IPersistableModel<VmAppContainerProtectableContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
