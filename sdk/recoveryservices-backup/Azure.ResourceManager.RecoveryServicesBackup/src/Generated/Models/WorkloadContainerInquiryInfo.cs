...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadContainerInquiryInfo
    {
        ...
        internal WorkloadContainerInquiryInfo(string status, BackupErrorDetail errorDetail, IList<WorkloadInquiryDetails> inquiryDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
