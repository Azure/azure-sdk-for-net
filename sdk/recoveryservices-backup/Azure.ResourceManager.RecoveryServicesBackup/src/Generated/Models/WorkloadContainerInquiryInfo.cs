...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadContainerInquiryInfo
    {
        ...
        internal WorkloadContainerInquiryInfo(string status, ErrorDetailAutoGenerated errorDetail, IList<WorkloadInquiryDetails> inquiryDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
