...
{
    public partial class UnlockDeleteResult : IUtf8JsonSerializable, IJsonModel<UnlockDeleteResult>, IPersistableModel<UnlockDeleteResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnlockDeleteResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<UnlockDeleteResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnlockDeleteResult)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UnlockDeleteExpireOn))
            {
                builder.Append("  unlockDeleteExpiryTime:");
                builder.AppendLine($" '{UnlockDeleteExpireOn.Value.ToString()}'");
            }
