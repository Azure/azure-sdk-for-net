...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnlockDeleteResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UnlockDeleteResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnlockDeleteResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UnlockDeleteResult>)} interface");
            }
        ...
        string IPersistableModel<UnlockDeleteResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
