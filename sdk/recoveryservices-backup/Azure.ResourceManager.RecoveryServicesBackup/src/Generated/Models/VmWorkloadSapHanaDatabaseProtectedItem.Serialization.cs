...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSapHanaDatabaseProtectedItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSapHanaDatabaseProtectedItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSapHanaDatabaseProtectedItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSapHanaDatabaseProtectedItem>)} interface");
            }
