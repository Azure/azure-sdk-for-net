...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class PrepareDataMoveContent
    {
        ...
        internal PrepareDataMoveContent(string targetResourceId, string targetRegion, DataMoveLevel dataMoveLevel, IList<ResourceIdentifier> sourceContainerArmIds, bool? ignoreMoved, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TargetResourceId = targetResourceId;
            TargetRegion = targetRegion;
            DataMoveLevel = dataMoveLevel;
