...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class PrepareDataMoveContent
    {
        ...
        internal PrepareDataMoveContent(ResourceIdentifier targetResourceId, AzureLocation targetRegion, DataMoveLevel dataMoveLevel, IList<ResourceIdentifier> sourceContainerArmIds, bool? ignoreMoved, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetResourceId = targetResourceId;
            TargetRegion = targetRegion;
            DataMoveLevel = dataMoveLevel;
