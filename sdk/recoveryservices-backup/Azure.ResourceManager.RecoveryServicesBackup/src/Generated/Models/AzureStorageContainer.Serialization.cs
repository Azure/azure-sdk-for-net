...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureStorageContainer : ProtectionContainer, IJsonModel<AzureStorageContainer>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureStorageContainer>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureStorageContainer>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureStorageContainer IPersistableModel<AzureStorageContainer>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureStorageContainer)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureStorageContainer IJsonModel<AzureStorageContainer>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureStorageContainer)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureStorageContainer DeserializeAzureStorageContainer(JsonElement element, ModelReaderWriterOptions options)
        {
