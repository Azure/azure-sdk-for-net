...
{
    public partial class AzureStorageContainer : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageContainer DeserializeAzureStorageContainer(JsonElement element)
        {
            ...
            return new AzureStorageContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, sourceResourceId.Value, storageAccountVersion.Value, resourceGroup.Value, Optional.ToNullable(protectedItemCount), Optional.ToNullable(acquireStorageAccountLock));
        }
    }
}
