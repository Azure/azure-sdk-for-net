...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryPointTierInformationV2>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryPointTierInformationV2>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryPointTierInformationV2>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryPointTierInformationV2>)} interface");
            }
        ...
        string IPersistableModel<RecoveryPointTierInformationV2>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
