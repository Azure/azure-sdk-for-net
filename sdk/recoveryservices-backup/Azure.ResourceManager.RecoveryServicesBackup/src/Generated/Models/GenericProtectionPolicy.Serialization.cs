...
{
    public partial class GenericProtectionPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GenericProtectionPolicy DeserializeGenericProtectionPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
