...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenericProtectionPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GenericProtectionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GenericProtectionPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GenericProtectionPolicy>)} interface");
            }
        ...
        string IPersistableModel<GenericProtectionPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
