...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class FetchTieringCostSavingsInfoForPolicyContent : FetchTieringCostInfoContent
    {
        ...
        public FetchTieringCostSavingsInfoForPolicyContent(RecoveryPointTierType sourceTierType, RecoveryPointTierType targetTierType, string policyName) : base(sourceTierType, targetTierType, "FetchTieringCostSavingsInfoForPolicyRequest")
        {
        ...
        /// <param name="policyName"> Name of the backup policy for which the cost savings information is requested. </param>
        internal FetchTieringCostSavingsInfoForPolicyContent(RecoveryPointTierType sourceTierType, RecoveryPointTierType targetTierType, string objectType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string policyName) : base(sourceTierType, targetTierType, objectType, additionalBinaryDataProperties)
        {
            PolicyName = policyName;
        }
