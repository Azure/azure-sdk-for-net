...
{
    public partial class AzureVmWorkloadProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static AzureVmWorkloadProtectableItem DeserializeAzureVmWorkloadProtectableItem(JsonElement element)
        {
            ...
            return new AzureVmWorkloadProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value);
        }
    }
}
