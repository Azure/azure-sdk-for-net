...
{
    public partial class AzureIaasVmJob : IUtf8JsonSerializable
    {
        ...
        internal static AzureIaasVmJob DeserializeAzureIaasVmJob(JsonElement element)
        {
            ...
            return new AzureIaasVmJob(entityFriendlyName.Value, Optional.ToNullable(backupManagementType), operation.Value, status.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), activityId.Value, jobType, Optional.ToNullable(duration), Optional.ToList(actionsInfo), Optional.ToList(errorDetails), virtualMachineVersion.Value, extendedInfo.Value, containerName.Value, Optional.ToNullable(isUserTriggered));
        }
    }
}
