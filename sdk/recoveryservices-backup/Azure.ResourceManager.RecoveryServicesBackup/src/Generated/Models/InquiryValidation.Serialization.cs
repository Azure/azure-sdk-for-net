...
{
    public partial class InquiryValidation : IUtf8JsonSerializable, IJsonModel<InquiryValidation>, IPersistableModel<InquiryValidation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  additionalDetail:");
                builder.AppendLine($" '{AdditionalDetail}'");
            }

            if (Optional.IsDefined(ProtectableItemCount))
            {
                builder.Append("  protectableItemCount:");
                builder.AppendLine($" '{ProtectableItemCount.ToString()}'");
            }
