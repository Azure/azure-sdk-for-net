...
{
    public partial class AzureSqlProtectedItemExtendedInfo : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlProtectedItemExtendedInfo DeserializeAzureSqlProtectedItemExtendedInfo(JsonElement element)
        {
            ...
            return new AzureSqlProtectedItemExtendedInfo(Optional.ToNullable(oldestRecoveryPoint), Optional.ToNullable(recoveryPointCount), policyState.Value);
        }
    }
}
