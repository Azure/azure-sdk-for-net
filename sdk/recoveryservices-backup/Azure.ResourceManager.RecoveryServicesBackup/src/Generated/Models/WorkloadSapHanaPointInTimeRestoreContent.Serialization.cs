...
{
    public partial class WorkloadSapHanaPointInTimeRestoreContent : Core.IUtf8JsonSerializable
    {
        ...
        internal static WorkloadSapHanaPointInTimeRestoreContent DeserializeWorkloadSapHanaPointInTimeRestoreContent(JsonElement element)
        {
            ...
            return new WorkloadSapHanaPointInTimeRestoreContent(objectType, Core.Optional.ToNullable(recoveryType), sourceResourceId.Value, Core.Optional.ToDictionary(propertyBag), targetInfo.Value, Core.Optional.ToNullable(recoveryMode), targetVirtualMachineId.Value, Core.Optional.ToNullable(pointInTime));
        }
    }
}
