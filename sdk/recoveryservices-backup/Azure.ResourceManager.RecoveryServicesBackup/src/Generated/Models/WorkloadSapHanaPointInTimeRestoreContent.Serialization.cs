...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadSapHanaPointInTimeRestoreContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadSapHanaPointInTimeRestoreContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadSapHanaPointInTimeRestoreContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadSapHanaPointInTimeRestoreContent>)} interface");
            }
        ...
        string IPersistableModel<WorkloadSapHanaPointInTimeRestoreContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
