...
{
    internal partial class UnknownBackupGenericProtectionContainer : BackupGenericProtectionContainer, IJsonModel<BackupGenericProtectionContainer>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBackupGenericProtectionContainer"/> for deserialization. </summary>
        internal UnknownBackupGenericProtectionContainer()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupGenericProtectionContainer DeserializeUnknownBackupGenericProtectionContainer(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownBackupGenericProtectionContainer(
                friendlyName,
