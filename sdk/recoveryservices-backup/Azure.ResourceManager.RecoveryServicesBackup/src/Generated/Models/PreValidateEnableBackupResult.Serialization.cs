...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PreValidateEnableBackupResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PreValidateEnableBackupResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PreValidateEnableBackupResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PreValidateEnableBackupResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
