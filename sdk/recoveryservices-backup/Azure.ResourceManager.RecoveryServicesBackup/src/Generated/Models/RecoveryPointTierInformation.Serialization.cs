...
{
    public partial class RecoveryPointTierInformation : Core.IUtf8JsonSerializable
    {
        ...
        internal static RecoveryPointTierInformation DeserializeRecoveryPointTierInformation(JsonElement element)
        {
            ...
            return new RecoveryPointTierInformation(Core.Optional.ToNullable(type), Core.Optional.ToNullable(status), Core.Optional.ToDictionary(extendedInfo));
        }
    }
}
