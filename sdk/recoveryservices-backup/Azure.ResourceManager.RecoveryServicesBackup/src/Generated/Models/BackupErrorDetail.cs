...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class BackupErrorDetail
    {
        ...
        internal BackupErrorDetail(string code, string message, IReadOnlyList<string> recommendations, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
