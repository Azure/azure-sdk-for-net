...
{
    public partial class GenericContainer : IUtf8JsonSerializable, IJsonModel<GenericContainer>, IPersistableModel<GenericContainer>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExtendedInformation))
            {
                ...
                AppendChildObject(builder, ExtendedInformation, options, 2);
            }
