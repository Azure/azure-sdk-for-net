...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenericContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GenericContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GenericContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GenericContainer>)} interface");
            }
        ...
        string IPersistableModel<GenericContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
