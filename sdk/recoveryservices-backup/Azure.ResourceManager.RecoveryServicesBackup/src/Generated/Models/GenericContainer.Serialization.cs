...
{
    public partial class GenericContainer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GenericContainer DeserializeGenericContainer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
