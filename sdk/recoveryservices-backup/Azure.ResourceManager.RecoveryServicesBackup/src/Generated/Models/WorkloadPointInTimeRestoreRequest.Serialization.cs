...
{
    public partial class WorkloadPointInTimeRestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadPointInTimeRestoreRequest DeserializeWorkloadPointInTimeRestoreRequest(JsonElement element)
        {
            ...
            return new WorkloadPointInTimeRestoreRequest(objectType, Optional.ToNullable(recoveryType), sourceResourceId.Value, Optional.ToDictionary(propertyBag), targetInfo.Value, Optional.ToNullable(recoveryMode), targetVirtualMachineId.Value, Optional.ToNullable(pointInTime));
        }
    }
}
