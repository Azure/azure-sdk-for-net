...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public abstract partial class BackupGenericProtectionIntent
    {
        ...
        internal BackupGenericProtectionIntent(ProtectionIntentItemType protectionIntentItemType, BackupManagementType? backupManagementType, string sourceResourceId, string itemId, string policyId, BackupProtectionStatus? protectionState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ProtectionIntentItemType = protectionIntentItemType;
