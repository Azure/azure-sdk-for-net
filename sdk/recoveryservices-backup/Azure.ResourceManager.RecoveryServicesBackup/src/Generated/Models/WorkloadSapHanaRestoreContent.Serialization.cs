...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadSapHanaRestoreContent : WorkloadRestoreContent, IJsonModel<WorkloadSapHanaRestoreContent>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSapHanaRestoreContent IPersistableModel<WorkloadSapHanaRestoreContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (WorkloadSapHanaRestoreContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSapHanaRestoreContent IJsonModel<WorkloadSapHanaRestoreContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WorkloadSapHanaRestoreContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkloadSapHanaRestoreContent DeserializeWorkloadSapHanaRestoreContent(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            return UnknownWorkloadSapHanaRestoreContent.DeserializeUnknownWorkloadSapHanaRestoreContent(element, options);
        }
    }
}
