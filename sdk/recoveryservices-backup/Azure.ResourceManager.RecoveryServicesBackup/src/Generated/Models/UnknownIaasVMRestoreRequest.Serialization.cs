...
{
    internal partial class UnknownIaasVMRestoreRequest : IaasVMRestoreRequest, IJsonModel<IaasVMRestoreRequest>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownIaasVMRestoreRequest"/> for deserialization. </summary>
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IaasVMRestoreRequest IPersistableModel<IaasVMRestoreRequest>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownIaasVMRestoreRequest)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IaasVMRestoreRequest IJsonModel<IaasVMRestoreRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownIaasVMRestoreRequest)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownIaasVMRestoreRequest DeserializeUnknownIaasVMRestoreRequest(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("encryptionDetails"u8))
                {
                    ...
                    encryptionDetails = EncryptionDetails.DeserializeEncryptionDetails(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("identityInfo"u8))
                {
                    ...
                    identityInfo = IdentityInfo.DeserializeIdentityInfo(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("targetDiskNetworkAccessSettings"u8))
                {
                    ...
                    targetDiskNetworkAccessSettings = TargetDiskNetworkAccessSettings.DeserializeTargetDiskNetworkAccessSettings(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new UnknownIaasVMRestoreRequest(
                objectType,
