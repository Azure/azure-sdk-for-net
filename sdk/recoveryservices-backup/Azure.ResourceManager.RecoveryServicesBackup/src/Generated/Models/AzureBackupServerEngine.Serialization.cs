...
{
    public partial class AzureBackupServerEngine : IUtf8JsonSerializable
    {
        ...
        internal static AzureBackupServerEngine DeserializeAzureBackupServerEngine(JsonElement element)
        {
            ...
            return new AzureBackupServerEngine(friendlyName.Value, Optional.ToNullable(backupManagementType), registrationStatus.Value, backupEngineState.Value, healthStatus.Value, backupEngineType, Optional.ToNullable(canReRegister), backupEngineId.Value, dpmVersion.Value, azureBackupAgentVersion.Value, Optional.ToNullable(isAzureBackupAgentUpgradeAvailable), Optional.ToNullable(isDpmUpgradeAvailable), extendedInfo.Value);
        }
    }
}
