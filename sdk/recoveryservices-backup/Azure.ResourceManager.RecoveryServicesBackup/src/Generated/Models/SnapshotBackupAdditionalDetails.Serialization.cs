...
{
    public partial class SnapshotBackupAdditionalDetails : IUtf8JsonSerializable, IJsonModel<SnapshotBackupAdditionalDetails>, IPersistableModel<SnapshotBackupAdditionalDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InstantRpRetentionRangeInDays))
            {
                ...
                builder.AppendLine($" '{InstantRpRetentionRangeInDays.Value.ToString()}'");
            }

            if (Optional.IsDefined(InstantRPDetails))
            {
                builder.Append("  instantRPDetails:");
                builder.AppendLine($" '{InstantRPDetails}'");
            }
