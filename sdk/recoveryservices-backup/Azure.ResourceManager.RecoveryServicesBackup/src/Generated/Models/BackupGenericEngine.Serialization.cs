...
{
    public partial class BackupGenericEngine : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupGenericEngine DeserializeBackupGenericEngine(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
