...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupTieringPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupTieringPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupTieringPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupTieringPolicy>)} interface");
            }
        ...
        string IPersistableModel<BackupTieringPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
