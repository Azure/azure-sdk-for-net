...
{
    public partial class BackupTieringPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupTieringPolicy DeserializeBackupTieringPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
