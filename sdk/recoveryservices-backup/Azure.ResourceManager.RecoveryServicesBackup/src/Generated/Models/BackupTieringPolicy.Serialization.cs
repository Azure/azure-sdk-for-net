...
{
    public partial class BackupTieringPolicy : IUtf8JsonSerializable, IJsonModel<BackupTieringPolicy>, IPersistableModel<BackupTieringPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DurationValue))
            {
                ...
                builder.AppendLine($" '{DurationValue.Value.ToString()}'");
            }
