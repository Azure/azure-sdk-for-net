...
{
    public partial class StorageBackupJobExtendedInfo : Core.IUtf8JsonSerializable
    {
        ...
        internal static StorageBackupJobExtendedInfo DeserializeStorageBackupJobExtendedInfo(JsonElement element)
        {
            ...
            Core.Optional<IList<StorageBackupJobTaskDetails>> tasksList = default;
            ...
            return new StorageBackupJobExtendedInfo(Core.Optional.ToList(tasksList), Core.Optional.ToDictionary(propertyBag), dynamicErrorMessage.Value);
        }
    }
}
