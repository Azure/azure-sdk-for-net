...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageBackupJobExtendedInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageBackupJobExtendedInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageBackupJobExtendedInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageBackupJobExtendedInfo>)} interface");
            }
        ...
        string IPersistableModel<StorageBackupJobExtendedInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
