...
{
    public partial class DpmJob : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("dpmServerName");
        ...
        internal static DpmJob DeserializeDpmJob(JsonElement element)
        {
            ...
            Optional<DpmJobExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("dpmServerName"))
                {
                ...
                if (property.NameEquals("extendedInfo"))
                {
                    ...
                    extendedInfo = DpmJobExtendedInfo.DeserializeDpmJobExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new DpmJob(entityFriendlyName.Value, Optional.ToNullable(backupManagementType), operation.Value, status.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), activityId.Value, jobType, Optional.ToNullable(duration), dpmServerName.Value, containerName.Value, containerType.Value, workloadType.Value, Optional.ToList(actionsInfo), Optional.ToList(errorDetails), extendedInfo.Value);
        }
    }
}
