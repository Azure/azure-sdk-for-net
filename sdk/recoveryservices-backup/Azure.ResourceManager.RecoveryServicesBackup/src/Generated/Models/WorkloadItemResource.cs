...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadItemResource : ResourceData
    {
        ...
        internal WorkloadItemResource(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, string location, IDictionary<string, string> tags, string eTag, WorkloadItem properties) : base(id, name, resourceType, systemData)
        {
