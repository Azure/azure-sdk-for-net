...
{
    public partial class SnapshotRestoreContent : IUtf8JsonSerializable, IJsonModel<SnapshotRestoreContent>, IPersistableModel<SnapshotRestoreContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SkipAttachAndMount))
            {
                builder.Append("  skipAttachAndMount:");
                var boolValue = SkipAttachAndMount.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(LogPointInTimeForDBRecovery))
            {
                builder.Append("  logPointInTimeForDBRecovery:");
                builder.AppendLine($" '{LogPointInTimeForDBRecovery}'");
            }
