...
{
    public partial class StorageBackupJob : IUtf8JsonSerializable, IJsonModel<StorageBackupJob>, IPersistableModel<StorageBackupJob>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StorageAccountVersion))
            {
                builder.Append("  storageAccountVersion:");
                builder.AppendLine($" '{StorageAccountVersion}'");
            }
            ...
            if (Optional.IsDefined(IsUserTriggered))
            {
                ...
                var boolValue = IsUserTriggered.Value == true ? "true" : "false";
