...
{
    public partial class StorageBackupJob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StorageBackupJob DeserializeStorageBackupJob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
