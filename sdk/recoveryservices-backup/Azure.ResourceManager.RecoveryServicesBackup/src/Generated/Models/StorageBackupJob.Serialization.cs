...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageBackupJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageBackupJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageBackupJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageBackupJob>)} interface");
            }
        ...
        string IPersistableModel<StorageBackupJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
