...
{
    public partial class AzureIaaSClassicComputeVmProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static AzureIaaSClassicComputeVmProtectableItem DeserializeAzureIaaSClassicComputeVmProtectableItem(JsonElement element)
        {
            ...
            return new AzureIaaSClassicComputeVmProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), virtualMachineId.Value, virtualMachineVersion.Value, resourceGroup.Value);
        }
    }
}
