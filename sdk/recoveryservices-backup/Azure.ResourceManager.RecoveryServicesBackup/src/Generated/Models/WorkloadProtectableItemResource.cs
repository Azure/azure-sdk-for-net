...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadProtectableItemResource : TrackedResourceData
    {
        ...
        internal WorkloadProtectableItemResource(AzureLocation location) : base(location)
        {
        }
        ...
        internal WorkloadProtectableItemResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureLocation location, IDictionary<string, string> tags, ETag? eTag, WorkloadProtectableItem properties) : base(id, name, resourceType, systemData, tags, location)
        {
