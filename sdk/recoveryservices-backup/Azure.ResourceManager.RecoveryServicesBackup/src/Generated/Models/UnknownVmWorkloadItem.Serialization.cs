...
{
    internal partial class UnknownVmWorkloadItem : VmWorkloadItem, IJsonModel<VmWorkloadItem>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownVmWorkloadItem"/> for deserialization. </summary>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownVmWorkloadItem DeserializeUnknownVmWorkloadItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownVmWorkloadItem(
