...
{
    public partial class BackupGenericProtectedItem : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupGenericProtectedItem DeserializeBackupGenericProtectedItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
