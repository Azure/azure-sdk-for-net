...
{
    public partial class LogSchedulePolicy : IUtf8JsonSerializable, IJsonModel<LogSchedulePolicy>, IPersistableModel<LogSchedulePolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScheduleFrequencyInMins))
            {
                builder.Append("  scheduleFrequencyInMins:");
                builder.AppendLine($" '{ScheduleFrequencyInMins.Value.ToString()}'");
            }
