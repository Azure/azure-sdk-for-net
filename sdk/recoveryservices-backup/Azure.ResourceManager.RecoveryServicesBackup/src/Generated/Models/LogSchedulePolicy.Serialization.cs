...
{
    public partial class LogSchedulePolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LogSchedulePolicy DeserializeLogSchedulePolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
