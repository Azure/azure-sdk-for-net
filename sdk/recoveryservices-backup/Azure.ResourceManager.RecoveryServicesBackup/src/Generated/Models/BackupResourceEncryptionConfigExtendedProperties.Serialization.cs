...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupResourceEncryptionConfigExtendedProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupResourceEncryptionConfigExtendedProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupResourceEncryptionConfigExtendedProperties>)} interface");
            }
        ...
        string IPersistableModel<BackupResourceEncryptionConfigExtendedProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
