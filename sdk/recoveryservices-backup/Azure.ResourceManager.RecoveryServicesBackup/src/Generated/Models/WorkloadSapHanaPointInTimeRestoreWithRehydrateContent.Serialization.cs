...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadSapHanaPointInTimeRestoreWithRehydrateContent : WorkloadSapHanaPointInTimeRestoreContent, IJsonModel<WorkloadSapHanaPointInTimeRestoreWithRehydrateContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkloadSapHanaPointInTimeRestoreWithRehydrateContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WorkloadSapHanaPointInTimeRestoreWithRehydrateContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSapHanaPointInTimeRestoreWithRehydrateContent IPersistableModel<WorkloadSapHanaPointInTimeRestoreWithRehydrateContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (WorkloadSapHanaPointInTimeRestoreWithRehydrateContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSapHanaPointInTimeRestoreWithRehydrateContent IJsonModel<WorkloadSapHanaPointInTimeRestoreWithRehydrateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WorkloadSapHanaPointInTimeRestoreWithRehydrateContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkloadSapHanaPointInTimeRestoreWithRehydrateContent DeserializeWorkloadSapHanaPointInTimeRestoreWithRehydrateContent(JsonElement element, ModelReaderWriterOptions options)
        {
