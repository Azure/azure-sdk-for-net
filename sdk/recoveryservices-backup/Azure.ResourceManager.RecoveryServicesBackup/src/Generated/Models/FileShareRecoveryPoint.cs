...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class FileShareRecoveryPoint : BackupGenericRecoveryPoint
    {
        ...
        internal FileShareRecoveryPoint(string objectType, string recoveryPointType, DateTimeOffset? recoveryPointOn, Uri fileShareSnapshotUri, int? recoveryPointSizeInGB, RecoveryPointProperties recoveryPointProperties, Dictionary<string, BinaryData> rawData) : base(objectType, rawData)
        {
