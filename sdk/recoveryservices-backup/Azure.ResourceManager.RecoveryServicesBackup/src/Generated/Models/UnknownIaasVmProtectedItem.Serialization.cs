...
{
    internal partial class UnknownIaasVmProtectedItem : IaasVmProtectedItem, IJsonModel<IaasVmProtectedItem>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownIaasVmProtectedItem"/> for deserialization. </summary>
        internal UnknownIaasVmProtectedItem()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IaasVmProtectedItem IPersistableModel<IaasVmProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownIaasVmProtectedItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IaasVmProtectedItem IJsonModel<IaasVmProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownIaasVmProtectedItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownIaasVmProtectedItem DeserializeUnknownIaasVmProtectedItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownIaasVmProtectedItem(
                protectedItemType,
