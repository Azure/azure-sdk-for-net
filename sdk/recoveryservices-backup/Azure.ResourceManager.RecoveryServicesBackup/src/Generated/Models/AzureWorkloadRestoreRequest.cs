...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureWorkloadRestoreRequest : RestoreContent
    {
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadRestoreRequest"/>. </summary>
        public AzureWorkloadRestoreRequest() : base("AzureWorkloadRestoreRequest")
        {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadRestoreRequest"/>. </summary>
        /// <param name="objectType"> This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types. </param>
        private protected AzureWorkloadRestoreRequest(string objectType) : base(objectType)
        {
            PropertyBag = new ChangeTrackingDictionary<string, string>();
        }
