...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class GenericProtectionPolicy : BackupGenericProtectionPolicy
    {
        ...
        internal GenericProtectionPolicy(int? protectedItemsCount, string backupManagementType, IList<string> resourceGuardOperationRequests, IList<SubProtectionPolicy> subProtectionPolicy, string timeZone, string fabricName, Dictionary<string, BinaryData> rawData) : base(protectedItemsCount, backupManagementType, resourceGuardOperationRequests, rawData)
        {
