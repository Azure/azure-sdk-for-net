...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MabFileFolderProtectedItemExtendedInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MabFileFolderProtectedItemExtendedInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MabFileFolderProtectedItemExtendedInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MabFileFolderProtectedItemExtendedInfo>)} interface");
            }
        ...
        string IPersistableModel<MabFileFolderProtectedItemExtendedInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
