...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupResourceConfigProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupResourceConfigProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupResourceConfigProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupResourceConfigProperties>)} interface");
            }
        ...
        string IPersistableModel<BackupResourceConfigProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
