...
{
    public partial class AzureWorkloadContainerAutoProtectionIntent : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadContainerAutoProtectionIntent DeserializeAzureWorkloadContainerAutoProtectionIntent(JsonElement element)
        {
            ...
            return new AzureWorkloadContainerAutoProtectionIntent(protectionIntentItemType, Optional.ToNullable(backupManagementType), sourceResourceId.Value, itemId.Value, policyId.Value, Optional.ToNullable(protectionState));
        }
    }
}
