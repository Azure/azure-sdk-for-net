...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class ErrorDetailAutoGenerated
    {
        ...
        internal ErrorDetailAutoGenerated(string code, string message, IReadOnlyList<string> recommendations, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
