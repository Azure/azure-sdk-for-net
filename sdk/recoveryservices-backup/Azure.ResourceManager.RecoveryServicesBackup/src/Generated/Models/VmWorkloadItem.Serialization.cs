...
{
    public partial class VmWorkloadItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static VmWorkloadItem DeserializeVmWorkloadItem(JsonElement element)
        {
            ...
            return new VmWorkloadItem(backupManagementType.Value, workloadType.Value, workloadItemType, friendlyName.Value, Core.Optional.ToNullable(protectionState), parentName.Value, serverName.Value, Core.Optional.ToNullable(isAutoProtectable), Core.Optional.ToNullable(subinquireditemcount), Core.Optional.ToNullable(subWorkloadItemCount));
        }
    }
}
