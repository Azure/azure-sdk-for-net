...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureStorageJobExtendedInfo
    {
        ...
        internal AzureStorageJobExtendedInfo(IList<AzureStorageJobTaskDetails> tasksList, IDictionary<string, string> propertyBag, string dynamicErrorMessage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TasksList = tasksList;
