...
{
    public partial class BackupIdentityInfo : IUtf8JsonSerializable, IJsonModel<BackupIdentityInfo>, IPersistableModel<BackupIdentityInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsSystemAssignedIdentity))
            {
                builder.Append("  isSystemAssignedIdentity:");
                var boolValue = IsSystemAssignedIdentity.Value == true ? "true" : "false";
