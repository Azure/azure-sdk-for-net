...
{
    public partial class BackupIdentityInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupIdentityInfo DeserializeBackupIdentityInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
