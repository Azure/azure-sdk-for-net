...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSapAseDatabaseWorkloadItem>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        VmWorkloadSapAseDatabaseWorkloadItem IJsonModel<VmWorkloadSapAseDatabaseWorkloadItem>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<VmWorkloadSapAseDatabaseWorkloadItem>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        VmWorkloadSapAseDatabaseWorkloadItem IModel<VmWorkloadSapAseDatabaseWorkloadItem>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<VmWorkloadSapAseDatabaseWorkloadItem>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
