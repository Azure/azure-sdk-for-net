...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSapAseDatabaseWorkloadItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSapAseDatabaseWorkloadItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSapAseDatabaseWorkloadItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSapAseDatabaseWorkloadItem>)} interface");
            }
