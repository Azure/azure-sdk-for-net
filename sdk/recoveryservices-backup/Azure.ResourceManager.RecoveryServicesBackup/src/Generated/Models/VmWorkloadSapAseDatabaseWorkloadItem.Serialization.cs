...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSapAseDatabaseWorkloadItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmWorkloadSapAseDatabaseWorkloadItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSapAseDatabaseWorkloadItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VmWorkloadSapAseDatabaseWorkloadItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
