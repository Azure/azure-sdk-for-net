...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSapAseDatabaseWorkloadItem : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadSapAseDatabaseWorkloadItem>
    {
        ...
        internal static VmWorkloadSapAseDatabaseWorkloadItem DeserializeVmWorkloadSapAseDatabaseWorkloadItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VmWorkloadSapAseDatabaseWorkloadItem(backupManagementType.Value, workloadType.Value, workloadItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subWorkloadItemCount), serializedAdditionalRawData);
        }
