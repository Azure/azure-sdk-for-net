...
{
    public partial class AzureVmWorkloadSAPHanaDatabaseProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static AzureVmWorkloadSAPHanaDatabaseProtectableItem DeserializeAzureVmWorkloadSAPHanaDatabaseProtectableItem(JsonElement element)
        {
            ...
            return new AzureVmWorkloadSAPHanaDatabaseProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value);
        }
    }
}
