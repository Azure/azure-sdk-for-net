...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownWorkloadItem))]
    public abstract partial class WorkloadItem
    {
        ...
        internal WorkloadItem(string backupManagementType, string workloadType, string workloadItemType, string friendlyName, BackupProtectionStatus? protectionState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
