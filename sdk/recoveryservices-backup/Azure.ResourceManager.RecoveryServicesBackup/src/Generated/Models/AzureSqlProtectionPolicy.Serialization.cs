...
{
    public partial class AzureSqlProtectionPolicy : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlProtectionPolicy DeserializeAzureSqlProtectionPolicy(JsonElement element)
        {
            ...
            return new AzureSqlProtectionPolicy(Optional.ToNullable(protectedItemsCount), backupManagementType, Optional.ToList(resourceGuardOperationRequests), retentionPolicy.Value);
        }
    }
}
