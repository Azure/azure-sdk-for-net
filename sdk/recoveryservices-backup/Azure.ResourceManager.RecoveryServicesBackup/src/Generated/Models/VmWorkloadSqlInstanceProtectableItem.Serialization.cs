...
{
    public partial class VmWorkloadSqlInstanceProtectableItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static VmWorkloadSqlInstanceProtectableItem DeserializeVmWorkloadSqlInstanceProtectableItem(JsonElement element)
        {
            ...
            return new VmWorkloadSqlInstanceProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Core.Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Core.Optional.ToNullable(isAutoProtectable), Core.Optional.ToNullable(isAutoProtected), Core.Optional.ToNullable(subinquireditemcount), Core.Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value);
        }
    }
}
