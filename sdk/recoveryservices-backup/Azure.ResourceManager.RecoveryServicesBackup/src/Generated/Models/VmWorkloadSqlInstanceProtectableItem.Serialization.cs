...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSqlInstanceProtectableItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSqlInstanceProtectableItem>
    {
        ...
        void IJsonModel<VmWorkloadSqlInstanceProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VmWorkloadSqlInstanceProtectableItem)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VmWorkloadSqlInstanceProtectableItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VmWorkloadSqlInstanceProtectableItem)} does not support '{options.Format}' format.");
            }
        }
