...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSqlInstanceProtectableItem : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadSqlInstanceProtectableItem>
    {
        ...
        internal static VmWorkloadSqlInstanceProtectableItem DeserializeVmWorkloadSqlInstanceProtectableItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VmWorkloadSqlInstanceProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value, rawData);
        }
