...
{
    public partial class VmWorkloadSqlInstanceProtectableItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSqlInstanceProtectableItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSqlInstanceProtectableItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSqlInstanceProtectableItem>)} interface");
            }
