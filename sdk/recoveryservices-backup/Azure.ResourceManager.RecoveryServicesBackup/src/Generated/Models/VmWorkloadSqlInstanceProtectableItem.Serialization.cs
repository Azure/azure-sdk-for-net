...
{
    public partial class VmWorkloadSqlInstanceProtectableItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSqlInstanceProtectableItem>, IPersistableModel<VmWorkloadSqlInstanceProtectableItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSqlInstanceProtectableItem>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<VmWorkloadSqlInstanceProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlInstanceProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmWorkloadSqlInstanceProtectableItem)} does not support '{format}' format.");
            }
        ...
        VmWorkloadSqlInstanceProtectableItem IJsonModel<VmWorkloadSqlInstanceProtectableItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlInstanceProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeVmWorkloadSqlInstanceProtectableItem(document.RootElement, options);
        }

        internal static VmWorkloadSqlInstanceProtectableItem DeserializeVmWorkloadSqlInstanceProtectableItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VmWorkloadSqlInstanceProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), serializedAdditionalRawData, parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value, Optional.ToNullable(isProtectable));
        }
        ...
        BinaryData IPersistableModel<VmWorkloadSqlInstanceProtectableItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlInstanceProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VmWorkloadSqlInstanceProtectableItem)} does not support '{options.Format}' format.");
            }
        }

        VmWorkloadSqlInstanceProtectableItem IPersistableModel<VmWorkloadSqlInstanceProtectableItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlInstanceProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<VmWorkloadSqlInstanceProtectableItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
