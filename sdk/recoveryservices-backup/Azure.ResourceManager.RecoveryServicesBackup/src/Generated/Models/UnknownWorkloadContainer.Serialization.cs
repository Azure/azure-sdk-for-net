...
{
    internal partial class UnknownWorkloadContainer : WorkloadContainer, IJsonModel<WorkloadContainer>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadContainer"/> for deserialization. </summary>
        internal UnknownWorkloadContainer()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWorkloadContainer DeserializeUnknownWorkloadContainer(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownWorkloadContainer(
                friendlyName,
