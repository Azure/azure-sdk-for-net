...
{
    public partial class RecoveryPointRehydrationInfo : IUtf8JsonSerializable, IJsonModel<RecoveryPointRehydrationInfo>, IPersistableModel<RecoveryPointRehydrationInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RehydrationRetentionDuration))
            {
                builder.Append("  rehydrationRetentionDuration:");
                var formattedTimeSpan = XmlConvert.ToString(RehydrationRetentionDuration.Value);
            ...
            if (Optional.IsDefined(RehydrationPriority))
            {
                ...
                builder.AppendLine($" '{RehydrationPriority.ToString()}'");
            }
