...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSqlDatabaseWorkloadItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmWorkloadSqlDatabaseWorkloadItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSqlDatabaseWorkloadItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSqlDatabaseWorkloadItem>)} interface");
            }
        ...
        string IPersistableModel<VmWorkloadSqlDatabaseWorkloadItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
