...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VmWorkloadSqlDatabaseWorkloadItem : VmWorkloadItem, IJsonModel<VmWorkloadSqlDatabaseWorkloadItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlDatabaseWorkloadItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(VmWorkloadSqlDatabaseWorkloadItem)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VmWorkloadSqlDatabaseWorkloadItem)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VmWorkloadSqlDatabaseWorkloadItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSqlDatabaseWorkloadItem IPersistableModel<VmWorkloadSqlDatabaseWorkloadItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (VmWorkloadSqlDatabaseWorkloadItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSqlDatabaseWorkloadItem IJsonModel<VmWorkloadSqlDatabaseWorkloadItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VmWorkloadSqlDatabaseWorkloadItem)JsonModelCreateCore(ref reader, options);
        ...
        protected override WorkloadItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmWorkloadSqlDatabaseWorkloadItem)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VmWorkloadSqlDatabaseWorkloadItem DeserializeVmWorkloadSqlDatabaseWorkloadItem(JsonElement element, ModelReaderWriterOptions options)
        {
