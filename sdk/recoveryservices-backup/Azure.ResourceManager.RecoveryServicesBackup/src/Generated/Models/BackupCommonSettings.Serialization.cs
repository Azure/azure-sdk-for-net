...
{
    public partial class BackupCommonSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupCommonSettings DeserializeBackupCommonSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
