...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public abstract partial class BackupSchedulePolicy : IJsonModel<BackupSchedulePolicy>
    {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual BackupSchedulePolicy JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<BackupSchedulePolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BackupSchedulePolicy DeserializeBackupSchedulePolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return UnknownBackupSchedulePolicy.DeserializeUnknownBackupSchedulePolicy(element, options);
        }
    }
}
