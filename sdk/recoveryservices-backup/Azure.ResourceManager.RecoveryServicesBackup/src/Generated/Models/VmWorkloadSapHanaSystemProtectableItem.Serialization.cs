...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VmWorkloadSapHanaSystemProtectableItem : VmWorkloadProtectableItem, IJsonModel<VmWorkloadSapHanaSystemProtectableItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSapHanaSystemProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VmWorkloadSapHanaSystemProtectableItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapHanaSystemProtectableItem IPersistableModel<VmWorkloadSapHanaSystemProtectableItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (VmWorkloadSapHanaSystemProtectableItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapHanaSystemProtectableItem IJsonModel<VmWorkloadSapHanaSystemProtectableItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VmWorkloadSapHanaSystemProtectableItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VmWorkloadSapHanaSystemProtectableItem DeserializeVmWorkloadSapHanaSystemProtectableItem(JsonElement element, ModelReaderWriterOptions options)
        {
