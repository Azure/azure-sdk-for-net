...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadSQLRestoreRequest"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AzureWorkloadSQLRestoreRequest"/>. </summary>
        /// <param name="objectType"> This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types. </param>
        private protected AzureWorkloadSQLRestoreRequest(string objectType) : base("AzureWorkloadSQLRestoreRequest")
        {
            AlternateDirectoryPaths = new ChangeTrackingList<SQLDataDirectoryMapping>();
        }
