...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVmBackupJobTaskDetails
    {
        ...
        internal IaasVmBackupJobTaskDetails(string taskId, DateTimeOffset? startOn, DateTimeOffset? endOn, string instanceId, TimeSpan? duration, string status, double? progressPercentage, string taskExecutionDetails, Dictionary<string, BinaryData> rawData)
        {
            TaskId = taskId;
            StartOn = startOn;
            EndOn = endOn;
