...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageBackupJobTaskDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageBackupJobTaskDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageBackupJobTaskDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageBackupJobTaskDetails>)} interface");
            }
        ...
        string IPersistableModel<StorageBackupJobTaskDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
