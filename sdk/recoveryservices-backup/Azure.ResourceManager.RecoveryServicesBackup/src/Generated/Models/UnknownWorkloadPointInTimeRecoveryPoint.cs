...
{
    internal partial class UnknownWorkloadPointInTimeRecoveryPoint : WorkloadPointInTimeRecoveryPoint
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadPointInTimeRecoveryPoint"/>. </summary>
        ...
        internal UnknownWorkloadPointInTimeRecoveryPoint(string objectType, BackupThreatStatus? threatStatus, IList<BackupThreatInfo> threatInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties, DateTimeOffset? recoveryPointCreatedOn, RestorePointType? restorePointType, IList<RecoveryPointTierInformationV2> recoveryPointTierDetails, IDictionary<string, RecoveryPointMoveReadinessInfo> recoveryPointMoveReadinessInfo, RecoveryPointProperties recoveryPointProperties, IList<PointInTimeRange> timeRanges) : base(objectType ?? "unknown", threatStatus, threatInfo, additionalBinaryDataProperties, recoveryPointCreatedOn, restorePointType, recoveryPointTierDetails, recoveryPointMoveReadinessInfo, recoveryPointProperties, timeRanges)
        {
        }
    }
}
