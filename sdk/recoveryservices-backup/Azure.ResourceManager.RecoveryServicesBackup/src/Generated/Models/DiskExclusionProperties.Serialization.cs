...
{
    public partial class DiskExclusionProperties : IUtf8JsonSerializable, IJsonModel<DiskExclusionProperties>, IPersistableModel<DiskExclusionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsInclusionList))
            {
                builder.Append("  isInclusionList:");
                var boolValue = IsInclusionList.Value == true ? "true" : "false";
