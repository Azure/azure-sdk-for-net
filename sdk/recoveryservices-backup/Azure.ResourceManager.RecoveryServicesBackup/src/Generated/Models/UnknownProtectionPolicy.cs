...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    internal partial class UnknownProtectionPolicy : BackupGenericProtectionPolicy
    {
        ...
        internal UnknownProtectionPolicy(int? protectedItemsCount, string backupManagementType, IList<string> resourceGuardOperationRequests, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(protectedItemsCount, backupManagementType, resourceGuardOperationRequests, serializedAdditionalRawData)
        {
