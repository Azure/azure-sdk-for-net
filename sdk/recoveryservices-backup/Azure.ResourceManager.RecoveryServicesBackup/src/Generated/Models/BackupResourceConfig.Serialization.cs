...
{
    public partial class BackupResourceConfig : IUtf8JsonSerializable
    {
        ...
        internal static BackupResourceConfig DeserializeBackupResourceConfig(JsonElement element)
        {
            ...
            return new BackupResourceConfig(Optional.ToNullable(storageModelType), Optional.ToNullable(storageType), Optional.ToNullable(storageTypeState), Optional.ToNullable(crossRegionRestoreFlag), Optional.ToNullable(dedupState), Optional.ToNullable(xcoolState));
        }
    }
}
