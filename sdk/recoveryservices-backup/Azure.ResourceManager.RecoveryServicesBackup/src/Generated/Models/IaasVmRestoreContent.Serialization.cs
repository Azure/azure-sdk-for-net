...
{
    public partial class IaasVmRestoreContent : IUtf8JsonSerializable, IModelJsonSerializable<IaasVmRestoreContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<IaasVmRestoreContent>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<IaasVmRestoreContent>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<IaasVmRestoreContent>(this, options.Format);
        ...
        internal static IaasVmRestoreContent DeserializeIaasVmRestoreContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IaasVmRestoreContent(objectType, recoveryPointId.Value, Optional.ToNullable(recoveryType), sourceResourceId.Value, targetVirtualMachineId.Value, targetResourceGroupId.Value, storageAccountId.Value, virtualNetworkId.Value, subnetId.Value, targetDomainNameId.Value, Optional.ToNullable(region), affinityGroup.Value, Optional.ToNullable(createNewCloudService), Optional.ToNullable(originalStorageAccountOption), encryptionDetails.Value, Optional.ToList(restoreDiskLunList), Optional.ToNullable(restoreWithManagedDisks), diskEncryptionSetId.Value, Optional.ToList(zones), identityInfo.Value, identityBasedRestoreDetails.Value, extendedLocation, securedVmDetails.Value, targetDiskNetworkAccessSettings.Value, serializedAdditionalRawData);
        }

        IaasVmRestoreContent IModelJsonSerializable<IaasVmRestoreContent>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<IaasVmRestoreContent>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeIaasVmRestoreContent(doc.RootElement, options);
        }

        BinaryData IModelSerializable<IaasVmRestoreContent>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<IaasVmRestoreContent>(this, options.Format);
        ...
        IaasVmRestoreContent IModelSerializable<IaasVmRestoreContent>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<IaasVmRestoreContent>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="IaasVmRestoreContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="IaasVmRestoreContent"/> to convert. </param>
        public static implicit operator RequestContent(IaasVmRestoreContent model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="IaasVmRestoreContent"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator IaasVmRestoreContent(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeIaasVmRestoreContent(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
