...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownJob))]
    public abstract partial class BackupGenericJob
    {
        ...
        internal BackupGenericJob(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
