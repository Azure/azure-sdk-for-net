...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasVmProtectedItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasVmProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasVmProtectedItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasVmProtectedItem>)} interface");
            }
        ...
        string IPersistableModel<IaasVmProtectedItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
