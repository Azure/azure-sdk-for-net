...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class SqlProtectedItem : BackupProtectedItemProperties
    {
        ...
        /// Serialized Name: AzureSqlProtectedItem.protectedItemDataId
        /// </param>
        /// <param name="protectionState">
        /// Backup state of the backed up item.
        /// Serialized Name: AzureSqlProtectedItem.protectionState
        /// </param>
        /// <param name="extendedInfo">
        /// Additional information for this backup item.
        /// Serialized Name: AzureSqlProtectedItem.extendedInfo
        /// </param>
        internal SqlProtectedItem(string protectedItemType, BackupManagementType? backupManagementType, DataSourceType? workloadType, string containerName, string sourceResourceId, string policyId, DateTimeOffset? lastRecoveryPoint, string backupSetName, CreateMode? createMode, DateTimeOffset? deferredDeleteTimeInUTC, bool? isScheduledForDeferredDelete, string deferredDeleteTimeRemaining, bool? isDeferredDeleteScheduleUpcoming, bool? isRehydrate, IList<string> resourceGuardOperationRequests, bool? isArchiveEnabled, string policyName, int? softDeleteRetentionPeriod, string protectedItemDataId, ProtectedItemState? protectionState, SqlProtectedItemExtendedInfo extendedInfo) : base(protectedItemType, backupManagementType, workloadType, containerName, sourceResourceId, policyId, lastRecoveryPoint, backupSetName, createMode, deferredDeleteTimeInUTC, isScheduledForDeferredDelete, deferredDeleteTimeRemaining, isDeferredDeleteScheduleUpcoming, isRehydrate, resourceGuardOperationRequests, isArchiveEnabled, policyName, softDeleteRetentionPeriod)
        {
