...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PreValidateEnableBackupContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PreValidateEnableBackupContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PreValidateEnableBackupContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PreValidateEnableBackupContent>)} interface");
            }
        ...
        string IPersistableModel<PreValidateEnableBackupContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
