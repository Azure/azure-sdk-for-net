...
{
    public partial class VaultJobErrorInfo : IUtf8JsonSerializable
    {
        ...
        internal static VaultJobErrorInfo DeserializeVaultJobErrorInfo(JsonElement element)
        {
            ...
            return new VaultJobErrorInfo(Optional.ToNullable(errorCode), errorString.Value, Optional.ToList(recommendations));
        }
    }
}
