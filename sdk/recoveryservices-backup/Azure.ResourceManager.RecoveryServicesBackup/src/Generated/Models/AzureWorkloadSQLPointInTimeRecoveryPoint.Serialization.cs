...
{
    public partial class AzureWorkloadSQLPointInTimeRecoveryPoint : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadSQLPointInTimeRecoveryPoint DeserializeAzureWorkloadSQLPointInTimeRecoveryPoint(JsonElement element)
        {
            Optional<IList<PointInTimeRange>> timeRanges = default;
            Optional<AzureWorkloadSQLRecoveryPointExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = AzureWorkloadSQLRecoveryPointExtendedInfo.DeserializeAzureWorkloadSQLRecoveryPointExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new AzureWorkloadSQLPointInTimeRecoveryPoint(objectType, Optional.ToNullable(recoveryPointTimeInUTC), Optional.ToNullable(type), Optional.ToList(recoveryPointTierDetails), Optional.ToDictionary(recoveryPointMoveReadinessInfo), recoveryPointProperties.Value, extendedInfo.Value, Optional.ToList(timeRanges));
        }
    }
}
