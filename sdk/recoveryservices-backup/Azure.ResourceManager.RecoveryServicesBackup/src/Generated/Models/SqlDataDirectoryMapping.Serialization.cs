...
{
    public partial class SqlDataDirectoryMapping : IUtf8JsonSerializable, IJsonModel<SqlDataDirectoryMapping>, IPersistableModel<SqlDataDirectoryMapping>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceLogicalName))
            {
                builder.Append("  sourceLogicalName:");
                builder.AppendLine($" '{SourceLogicalName}'");
            }
