...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureIaaSVMErrorInfo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureIaaSVMErrorInfo"/>. </summary>
        internal AzureIaaSVMErrorInfo()
        {
        ...
        internal AzureIaaSVMErrorInfo(int? errorCode, string errorTitle, string errorString, IReadOnlyList<string> recommendations, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ErrorCode = errorCode;
