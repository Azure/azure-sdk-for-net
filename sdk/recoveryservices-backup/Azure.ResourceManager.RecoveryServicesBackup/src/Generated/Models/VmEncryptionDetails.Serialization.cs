...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmEncryptionDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmEncryptionDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmEncryptionDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VmEncryptionDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
