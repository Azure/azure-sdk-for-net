...
{
    public partial class VmEncryptionDetails : IUtf8JsonSerializable, IJsonModel<VmEncryptionDetails>, IPersistableModel<VmEncryptionDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsEncryptionEnabled))
            {
                builder.Append("  encryptionEnabled:");
            ...
            if (Optional.IsDefined(SecretKeyUri))
            {
                builder.Append("  secretKeyUrl:");
                builder.AppendLine($" '{SecretKeyUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(KekVaultId))
            {
                builder.Append("  kekVaultId:");
                builder.AppendLine($" '{KekVaultId.ToString()}'");
            }

            if (Optional.IsDefined(SecretKeyVaultId))
            {
                builder.Append("  secretKeyVaultId:");
                builder.AppendLine($" '{SecretKeyVaultId.ToString()}'");
            }
