...
{
    internal partial class UnknownWorkloadSapAseRestoreContent : WorkloadSapAseRestoreContent, IJsonModel<WorkloadSapAseRestoreContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadSapAseRestoreContent"/> for deserialization. </summary>
        internal UnknownWorkloadSapAseRestoreContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWorkloadSapAseRestoreContent DeserializeUnknownWorkloadSapAseRestoreContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownWorkloadSapAseRestoreContent(
                objectType,
