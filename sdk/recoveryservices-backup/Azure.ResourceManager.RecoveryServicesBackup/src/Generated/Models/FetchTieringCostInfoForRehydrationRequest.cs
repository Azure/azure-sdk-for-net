...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class FetchTieringCostInfoForRehydrationRequest : FetchTieringCostInfoRequest
    {
        ...
        public FetchTieringCostInfoForRehydrationRequest(RecoveryPointTierType sourceTierType, RecoveryPointTierType targetTierType, string containerName, string protectedItemName, string recoveryPointId, RehydrationPriority rehydrationPriority) : base(sourceTierType, targetTierType, "FetchTieringCostInfoForRehydrationRequest")
        {
        ...
        /// <param name="recoveryPointId"> ID of the backup copy for rehydration cost info needs to be fetched. </param>
        /// <param name="rehydrationPriority"> Rehydration Priority. </param>
        internal FetchTieringCostInfoForRehydrationRequest(RecoveryPointTierType sourceTierType, RecoveryPointTierType targetTierType, string objectType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string containerName, string protectedItemName, string recoveryPointId, RehydrationPriority rehydrationPriority) : base(sourceTierType, targetTierType, objectType, additionalBinaryDataProperties)
        {
            ContainerName = containerName;
            ProtectedItemName = protectedItemName;
            RecoveryPointId = recoveryPointId;
