...
{
    public partial class AzureWorkloadSAPHanaRestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadSAPHanaRestoreRequest DeserializeAzureWorkloadSAPHanaRestoreRequest(JsonElement element)
        {
            ...
            return new AzureWorkloadSAPHanaRestoreRequest(objectType, Optional.ToNullable(recoveryType), sourceResourceId.Value, Optional.ToDictionary(propertyBag), targetInfo.Value, Optional.ToNullable(recoveryMode), targetVirtualMachineId.Value);
        }
    }
}
