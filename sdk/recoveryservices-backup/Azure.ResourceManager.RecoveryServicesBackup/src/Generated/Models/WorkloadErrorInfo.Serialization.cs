...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadErrorInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadErrorInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadErrorInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadErrorInfo>)} interface");
            }
        ...
        string IPersistableModel<WorkloadErrorInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
