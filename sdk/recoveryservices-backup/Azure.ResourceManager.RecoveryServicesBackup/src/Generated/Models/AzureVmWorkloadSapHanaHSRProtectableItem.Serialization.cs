...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureVmWorkloadSapHanaHSRProtectableItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureVmWorkloadSapHanaHSRProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureVmWorkloadSapHanaHSRProtectableItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureVmWorkloadSapHanaHSRProtectableItem>)} interface");
            }
        ...
        string IPersistableModel<AzureVmWorkloadSapHanaHSRProtectableItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
