...
{
    public partial class GenericProtectedItem : IUtf8JsonSerializable, IModelJsonSerializable<GenericProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<GenericProtectedItem>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<GenericProtectedItem>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<GenericProtectedItem>(this, options.Format);
        ...
        internal static GenericProtectedItem DeserializeGenericProtectedItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GenericProtectedItem(protectedItemType, Optional.ToNullable(backupManagementType), Optional.ToNullable(workloadType), containerName.Value, sourceResourceId.Value, policyId.Value, Optional.ToNullable(lastRecoveryPoint), backupSetName.Value, Optional.ToNullable(createMode), Optional.ToNullable(deferredDeleteTimeInUTC), Optional.ToNullable(isScheduledForDeferredDelete), deferredDeleteTimeRemaining.Value, Optional.ToNullable(isDeferredDeleteScheduleUpcoming), Optional.ToNullable(isRehydrate), Optional.ToList(resourceGuardOperationRequests), Optional.ToNullable(isArchiveEnabled), policyName.Value, Optional.ToNullable(softDeleteRetentionPeriod), friendlyName.Value, policyState.Value, Optional.ToNullable(protectionState), Optional.ToNullable(protectedItemId), Optional.ToDictionary(sourceAssociations), fabricName.Value, serializedAdditionalRawData);
        }

        GenericProtectedItem IModelJsonSerializable<GenericProtectedItem>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<GenericProtectedItem>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeGenericProtectedItem(doc.RootElement, options);
        }

        BinaryData IModelSerializable<GenericProtectedItem>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<GenericProtectedItem>(this, options.Format);
        ...
        GenericProtectedItem IModelSerializable<GenericProtectedItem>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<GenericProtectedItem>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="GenericProtectedItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GenericProtectedItem"/> to convert. </param>
        public static implicit operator RequestContent(GenericProtectedItem model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GenericProtectedItem"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator GenericProtectedItem(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeGenericProtectedItem(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
