...
{
    public partial class GenericProtectedItem : IUtf8JsonSerializable, IJsonModel<GenericProtectedItem>, IPersistableModel<GenericProtectedItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProtectedItemId))
            {
                builder.Append("  protectedItemId:");
                builder.AppendLine($" '{ProtectedItemId.Value.ToString()}'");
            }

            if (Optional.IsCollectionDefined(SourceAssociations))
            {
                builder.Append("  sourceAssociations:");
                builder.AppendLine(" {");
                foreach (var item in SourceAssociations)
                {
