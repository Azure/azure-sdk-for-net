...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenericProtectedItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GenericProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GenericProtectedItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GenericProtectedItem>)} interface");
            }
        ...
        string IPersistableModel<GenericProtectedItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
