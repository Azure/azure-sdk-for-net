...
{
    public partial class GenericProtectedItem : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GenericProtectedItem DeserializeGenericProtectedItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
