...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FetchTieringCostSavingsInfoForProtectedItemContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FetchTieringCostSavingsInfoForProtectedItemContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FetchTieringCostSavingsInfoForProtectedItemContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FetchTieringCostSavingsInfoForProtectedItemContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FetchTieringCostSavingsInfoForProtectedItemContent)} does not support '{options.Format}' format.");
            }
        }
