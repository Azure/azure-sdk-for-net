...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class SqlDataDirectory : IJsonModel<SqlDataDirectory>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SqlDataDirectoryProperty))
            {
                writer.WritePropertyName("type"u8);
                writer.WriteStringValue(SqlDataDirectoryProperty.Value.ToString());
            }
        ...
        internal static SqlDataDirectory DeserializeSqlDataDirectory(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SQLDataDirectoryType? sqlDataDirectoryProperty = default;
            string path = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("type"u8))
                {
                    ...
                    sqlDataDirectoryProperty = new SQLDataDirectoryType(prop.Value.GetString());
                    continue;
                }
            ...
            return new SqlDataDirectory(sqlDataDirectoryProperty, path, logicalName, additionalBinaryDataProperties);
        }
    }
}
