...
{
    public partial class SqlDataDirectory : IUtf8JsonSerializable, IJsonModel<SqlDataDirectory>, IPersistableModel<SqlDataDirectory>
    {
        ...
        void IJsonModel<SqlDataDirectory>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SqlDataDirectory)} does not support '{format}' format.");
            }
