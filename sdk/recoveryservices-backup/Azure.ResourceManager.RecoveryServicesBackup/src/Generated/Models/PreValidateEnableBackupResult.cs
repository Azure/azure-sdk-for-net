...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class PreValidateEnableBackupResult
    {
        ...
        internal PreValidateEnableBackupResult(BackupValidationStatus? status, string errorCode, string errorMessage, string recommendation, string containerName, string protectedItemName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            ErrorCode = errorCode;
