...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MabErrorInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MabErrorInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MabErrorInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MabErrorInfo>)} interface");
            }
        ...
        string IPersistableModel<MabErrorInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
