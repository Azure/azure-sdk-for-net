...
{
    public partial class MabFileFolderProtectedItem : IUtf8JsonSerializable, IJsonModel<MabFileFolderProtectedItem>, IPersistableModel<MabFileFolderProtectedItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeferredDeleteSyncTimeInUTC))
            {
                builder.Append("  deferredDeleteSyncTimeInUTC:");
                builder.AppendLine($" '{DeferredDeleteSyncTimeInUTC.Value.ToString()}'");
            }
