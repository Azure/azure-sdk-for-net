...
{
    public partial class MabFileFolderProtectedItem : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(DeferredDeleteSyncTimeInUTC))
            {
        ...
        internal static MabFileFolderProtectedItem DeserializeMabFileFolderProtectedItem(JsonElement element)
        {
            ...
            Core.Optional<long> deferredDeleteSyncTimeInUTC = default;
            Core.Optional<MabFileFolderProtectedItemExtendedInfo> extendedInfo = default;
            ...
            return new MabFileFolderProtectedItem(protectedItemType, Core.Optional.ToNullable(backupManagementType), Core.Optional.ToNullable(workloadType), containerName.Value, sourceResourceId.Value, policyId.Value, Core.Optional.ToNullable(lastRecoveryPoint), backupSetName.Value, Core.Optional.ToNullable(createMode), Core.Optional.ToNullable(deferredDeleteTimeInUTC), Core.Optional.ToNullable(isScheduledForDeferredDelete), deferredDeleteTimeRemaining.Value, Core.Optional.ToNullable(isDeferredDeleteScheduleUpcoming), Core.Optional.ToNullable(isRehydrate), Core.Optional.ToList(resourceGuardOperationRequests), Core.Optional.ToNullable(isArchiveEnabled), policyName.Value, Core.Optional.ToNullable(softDeleteRetentionPeriod), friendlyName.Value, computerName.Value, lastBackupStatus.Value, Core.Optional.ToNullable(lastBackupTime), protectionState.Value, Core.Optional.ToNullable(deferredDeleteSyncTimeInUTC), extendedInfo.Value);
        }
    }
}
