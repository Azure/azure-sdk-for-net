...
{
    internal partial class UnknownProtectableContainer : Core.IUtf8JsonSerializable
    {
        ...
        internal static UnknownProtectableContainer DeserializeUnknownProtectableContainer(JsonElement element)
        {
            ...
            return new UnknownProtectableContainer(friendlyName.Value, Core.Optional.ToNullable(backupManagementType), protectableContainerType, healthStatus.Value, containerId.Value);
        }
    }
}
