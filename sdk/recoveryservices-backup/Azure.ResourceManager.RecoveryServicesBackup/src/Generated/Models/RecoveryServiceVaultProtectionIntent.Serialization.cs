...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecoveryServiceVaultProtectionIntent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecoveryServiceVaultProtectionIntent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecoveryServiceVaultProtectionIntent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecoveryServiceVaultProtectionIntent>)} interface");
            }
        ...
        string IPersistableModel<RecoveryServiceVaultProtectionIntent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
