...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class RecoveryServiceVaultProtectionIntent : IUtf8JsonSerializable, IModelJsonSerializable<RecoveryServiceVaultProtectionIntent>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<RecoveryServiceVaultProtectionIntent>(this, options.Format);
        ...
        internal static RecoveryServiceVaultProtectionIntent DeserializeRecoveryServiceVaultProtectionIntent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new RecoveryServiceVaultProtectionIntent(protectionIntentItemType, Optional.ToNullable(backupManagementType), sourceResourceId.Value, itemId.Value, policyId.Value, Optional.ToNullable(protectionState), rawData);
        }
