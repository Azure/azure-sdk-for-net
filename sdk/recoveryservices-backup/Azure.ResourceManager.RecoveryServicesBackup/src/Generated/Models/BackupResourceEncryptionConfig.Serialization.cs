...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupResourceEncryptionConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupResourceEncryptionConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupResourceEncryptionConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupResourceEncryptionConfig>)} interface");
            }
        ...
        string IPersistableModel<BackupResourceEncryptionConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
