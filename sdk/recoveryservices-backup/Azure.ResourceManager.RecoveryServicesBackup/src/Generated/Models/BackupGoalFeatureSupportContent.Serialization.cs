...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupGoalFeatureSupportContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupGoalFeatureSupportContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupGoalFeatureSupportContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupGoalFeatureSupportContent>)} interface");
            }
        ...
        string IPersistableModel<BackupGoalFeatureSupportContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
