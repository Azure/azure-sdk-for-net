...
{
    public partial class MabContainer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MabContainer DeserializeMabContainer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
