...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public abstract partial class ProtectionIntent
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ProtectionIntent"/>. </summary>
        /// <param name="protectionIntentItemType"> backup protectionIntent type. </param>
        private protected ProtectionIntent(ProtectionIntentItemType protectionIntentItemType)
        {
        ...
        internal ProtectionIntent(ProtectionIntentItemType protectionIntentItemType, BackupManagementType? backupManagementType, string sourceResourceId, string itemId, string policyId, BackupProtectionStatus? protectionState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ProtectionIntentItemType = protectionIntentItemType;
