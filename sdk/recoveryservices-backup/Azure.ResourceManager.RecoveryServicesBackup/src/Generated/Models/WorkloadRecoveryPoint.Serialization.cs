...
{
    public partial class WorkloadRecoveryPoint : Core.IUtf8JsonSerializable
    {
        ...
        internal static WorkloadRecoveryPoint DeserializeWorkloadRecoveryPoint(JsonElement element)
        {
            ...
            return new WorkloadRecoveryPoint(objectType, Core.Optional.ToNullable(recoveryPointTimeInUTC), Core.Optional.ToNullable(type), Core.Optional.ToList(recoveryPointTierDetails), Core.Optional.ToDictionary(recoveryPointMoveReadinessInfo), recoveryPointProperties.Value);
        }
    }
}
