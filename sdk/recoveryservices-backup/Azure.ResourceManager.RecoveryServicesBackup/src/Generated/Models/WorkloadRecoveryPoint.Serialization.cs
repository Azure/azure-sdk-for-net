...
{
    public partial class WorkloadRecoveryPoint : IUtf8JsonSerializable, IJsonModel<WorkloadRecoveryPoint>, IPersistableModel<WorkloadRecoveryPoint>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoveryPointCreatedOn))
            {
                ...
                builder.AppendLine($" '{RecoveryPointCreatedOn.Value.ToString()}'");
            }
