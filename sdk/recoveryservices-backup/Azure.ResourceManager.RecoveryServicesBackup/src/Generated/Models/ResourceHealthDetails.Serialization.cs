...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceHealthDetails>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ResourceHealthDetails DeserializeResourceHealthDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceHealthDetails(code, title, message, recommendations ?? new ChangeTrackingList<string>(), serializedAdditionalRawData);
        }
