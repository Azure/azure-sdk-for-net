...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSapHanaHsr : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadSapHanaHsr>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<VmWorkloadSapHanaHsr>(this, options.Format);
        ...
        internal static VmWorkloadSapHanaHsr DeserializeVmWorkloadSapHanaHsr(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VmWorkloadSapHanaHsr(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value, rawData);
        }
