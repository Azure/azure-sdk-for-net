...
{
    public partial class VmWorkloadSapAseSystemWorkloadItem : IUtf8JsonSerializable
    {
        ...
        internal static VmWorkloadSapAseSystemWorkloadItem DeserializeVmWorkloadSapAseSystemWorkloadItem(JsonElement element)
        {
            ...
            return new VmWorkloadSapAseSystemWorkloadItem(backupManagementType.Value, workloadType.Value, workloadItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subWorkloadItemCount));
        }
    }
}
