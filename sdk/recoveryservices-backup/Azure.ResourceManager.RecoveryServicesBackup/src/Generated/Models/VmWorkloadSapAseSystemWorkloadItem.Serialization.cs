...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSapAseSystemWorkloadItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmWorkloadSapAseSystemWorkloadItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSapAseSystemWorkloadItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSapAseSystemWorkloadItem>)} interface");
            }
        ...
        string IPersistableModel<VmWorkloadSapAseSystemWorkloadItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
