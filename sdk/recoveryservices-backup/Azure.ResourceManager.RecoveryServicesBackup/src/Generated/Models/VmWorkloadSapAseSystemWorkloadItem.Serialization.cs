...
{
    public partial class VmWorkloadSapAseSystemWorkloadItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static VmWorkloadSapAseSystemWorkloadItem DeserializeVmWorkloadSapAseSystemWorkloadItem(JsonElement element)
        {
            ...
            return new VmWorkloadSapAseSystemWorkloadItem(backupManagementType.Value, workloadType.Value, workloadItemType, friendlyName.Value, Core.Optional.ToNullable(protectionState), parentName.Value, serverName.Value, Core.Optional.ToNullable(isAutoProtectable), Core.Optional.ToNullable(subinquireditemcount), Core.Optional.ToNullable(subWorkloadItemCount));
        }
    }
}
