...
{
    public partial class VmWorkloadSapAseSystemWorkloadItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSapAseSystemWorkloadItem>, IPersistableModel<VmWorkloadSapAseSystemWorkloadItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubWorkloadItemCount))
            {
                ...
                builder.AppendLine($" '{SubWorkloadItemCount.Value.ToString()}'");
            }
