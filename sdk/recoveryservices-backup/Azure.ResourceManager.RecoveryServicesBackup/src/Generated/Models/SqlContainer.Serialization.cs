...
{
    public partial class SqlContainer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SqlContainer DeserializeSqlContainer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
