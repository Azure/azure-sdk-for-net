...
{
    public partial class AzureWorkloadSAPHanaPointInTimeRestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadSAPHanaPointInTimeRestoreRequest DeserializeAzureWorkloadSAPHanaPointInTimeRestoreRequest(JsonElement element)
        {
            ...
            return new AzureWorkloadSAPHanaPointInTimeRestoreRequest(objectType, Optional.ToNullable(recoveryType), sourceResourceId.Value, Optional.ToDictionary(propertyBag), targetInfo.Value, Optional.ToNullable(recoveryMode), targetVirtualMachineId.Value, Optional.ToNullable(pointInTime));
        }
    }
}
