...
{
    public partial class AzureBackupServerContainer : IUtf8JsonSerializable
    {
        ...
        internal static AzureBackupServerContainer DeserializeAzureBackupServerContainer(JsonElement element)
        {
            ...
            return new AzureBackupServerContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, Optional.ToNullable(canReRegister), containerId.Value, Optional.ToNullable(protectedItemCount), dpmAgentVersion.Value, Optional.ToList(dpmServers), Optional.ToNullable(upgradeAvailable), protectionStatus.Value, extendedInfo.Value);
        }
    }
}
