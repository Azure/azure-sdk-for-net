...
{
    public partial class VmWorkloadSapAseDatabaseProtectedItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSapAseDatabaseProtectedItem>, IPersistableModel<VmWorkloadSapAseDatabaseProtectedItem>
    {
        ...
        void IJsonModel<VmWorkloadSapAseDatabaseProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmWorkloadSapAseDatabaseProtectedItem)} does not support '{format}' format.");
            }
