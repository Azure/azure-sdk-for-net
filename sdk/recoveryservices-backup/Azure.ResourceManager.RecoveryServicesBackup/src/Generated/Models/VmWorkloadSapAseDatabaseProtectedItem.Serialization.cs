...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VmWorkloadSapAseDatabaseProtectedItem : VmWorkloadProtectedItem, IJsonModel<VmWorkloadSapAseDatabaseProtectedItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSapAseDatabaseProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VmWorkloadSapAseDatabaseProtectedItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapAseDatabaseProtectedItem IPersistableModel<VmWorkloadSapAseDatabaseProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (VmWorkloadSapAseDatabaseProtectedItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapAseDatabaseProtectedItem IJsonModel<VmWorkloadSapAseDatabaseProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VmWorkloadSapAseDatabaseProtectedItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VmWorkloadSapAseDatabaseProtectedItem DeserializeVmWorkloadSapAseDatabaseProtectedItem(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string protectedItemType = "AzureVmWorkloadSAPAseDatabase";
