...
{
    public partial class VmWorkloadProtectedItem : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<VmWorkloadProtectedItem>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<VmWorkloadProtectedItem>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadProtectedItem>(this, options.Format);
        ...
        internal static VmWorkloadProtectedItem DeserializeVmWorkloadProtectedItem(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        VmWorkloadProtectedItem IModelJsonSerializable<VmWorkloadProtectedItem>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadProtectedItem>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeVmWorkloadProtectedItem(doc.RootElement, options);
        }

        BinaryData IModelSerializable<VmWorkloadProtectedItem>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadProtectedItem>(this, options.Format);
        ...
        VmWorkloadProtectedItem IModelSerializable<VmWorkloadProtectedItem>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadProtectedItem>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="VmWorkloadProtectedItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VmWorkloadProtectedItem"/> to convert. </param>
        public static implicit operator RequestContent(VmWorkloadProtectedItem model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VmWorkloadProtectedItem"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VmWorkloadProtectedItem(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVmWorkloadProtectedItem(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
