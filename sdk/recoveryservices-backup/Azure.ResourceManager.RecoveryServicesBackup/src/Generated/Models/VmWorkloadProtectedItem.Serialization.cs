...
{
    public partial class VmWorkloadProtectedItem : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VmWorkloadProtectedItem DeserializeVmWorkloadProtectedItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
