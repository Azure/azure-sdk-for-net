...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileShareProtectionPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileShareProtectionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileShareProtectionPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FileShareProtectionPolicy>)} interface");
            }
        ...
        string IPersistableModel<FileShareProtectionPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
