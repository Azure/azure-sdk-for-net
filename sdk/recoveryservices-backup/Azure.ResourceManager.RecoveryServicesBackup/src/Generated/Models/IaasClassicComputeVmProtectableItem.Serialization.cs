...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasClassicComputeVmProtectableItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasClassicComputeVmProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasClassicComputeVmProtectableItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasClassicComputeVmProtectableItem>)} interface");
            }
        ...
        string IPersistableModel<IaasClassicComputeVmProtectableItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
