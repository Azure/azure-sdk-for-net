...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class BackupEngineExtendedInfo
    {
        ...
        internal BackupEngineExtendedInfo(string databaseName, int? protectedItemsCount, int? protectedServersCount, int? diskCount, double? usedDiskSpace, double? availableDiskSpace, DateTimeOffset? refreshedOn, int? azureProtectedInstances, Dictionary<string, BinaryData> rawData)
        {
