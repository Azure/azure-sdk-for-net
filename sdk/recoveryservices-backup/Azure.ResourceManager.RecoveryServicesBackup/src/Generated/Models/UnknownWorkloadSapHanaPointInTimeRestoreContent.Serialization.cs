...
{
    internal partial class UnknownWorkloadSapHanaPointInTimeRestoreContent : WorkloadSapHanaPointInTimeRestoreContent, IJsonModel<WorkloadSapHanaPointInTimeRestoreContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadSapHanaPointInTimeRestoreContent"/> for deserialization. </summary>
        internal UnknownWorkloadSapHanaPointInTimeRestoreContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWorkloadSapHanaPointInTimeRestoreContent DeserializeUnknownWorkloadSapHanaPointInTimeRestoreContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownWorkloadSapHanaPointInTimeRestoreContent(
                objectType,
