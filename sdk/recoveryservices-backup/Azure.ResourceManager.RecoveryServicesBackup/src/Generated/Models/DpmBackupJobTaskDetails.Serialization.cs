...
{
    public partial class DpmBackupJobTaskDetails : Core.IUtf8JsonSerializable
    {
        ...
        internal static DpmBackupJobTaskDetails DeserializeDpmBackupJobTaskDetails(JsonElement element)
        {
            ...
            return new DpmBackupJobTaskDetails(taskId.Value, Core.Optional.ToNullable(startTime), Core.Optional.ToNullable(endTime), Core.Optional.ToNullable(duration), status.Value);
        }
    }
}
