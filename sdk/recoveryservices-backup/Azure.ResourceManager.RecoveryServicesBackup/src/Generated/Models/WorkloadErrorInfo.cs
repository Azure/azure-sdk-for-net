...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadErrorInfo
    {
        ...
        internal WorkloadErrorInfo(int? errorCode, string errorString, string errorTitle, IList<string> recommendations, string additionalDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
