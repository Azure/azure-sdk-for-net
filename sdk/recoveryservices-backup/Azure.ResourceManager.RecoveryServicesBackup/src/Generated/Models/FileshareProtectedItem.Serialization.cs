...
{
    public partial class FileshareProtectedItem : Core.IUtf8JsonSerializable
    {
        ...
        internal static FileshareProtectedItem DeserializeFileshareProtectedItem(JsonElement element)
        {
            ...
            Core.Optional<FileshareProtectedItemExtendedInfo> extendedInfo = default;
            ...
            return new FileshareProtectedItem(protectedItemType, Core.Optional.ToNullable(backupManagementType), Core.Optional.ToNullable(workloadType), containerName.Value, sourceResourceId.Value, policyId.Value, Core.Optional.ToNullable(lastRecoveryPoint), backupSetName.Value, Core.Optional.ToNullable(createMode), Core.Optional.ToNullable(deferredDeleteTimeInUTC), Core.Optional.ToNullable(isScheduledForDeferredDelete), deferredDeleteTimeRemaining.Value, Core.Optional.ToNullable(isDeferredDeleteScheduleUpcoming), Core.Optional.ToNullable(isRehydrate), Core.Optional.ToList(resourceGuardOperationRequests), Core.Optional.ToNullable(isArchiveEnabled), policyName.Value, Core.Optional.ToNullable(softDeleteRetentionPeriod), friendlyName.Value, protectionStatus.Value, Core.Optional.ToNullable(protectionState), lastBackupStatus.Value, Core.Optional.ToNullable(lastBackupTime), Core.Optional.ToDictionary(kpisHealths), extendedInfo.Value);
        }
    }
}
