...
{
    public partial class FileshareProtectedItem : IUtf8JsonSerializable, IModelJsonSerializable<FileshareProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<FileshareProtectedItem>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<FileshareProtectedItem>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FileshareProtectedItem>(this, options.Format);
            ...
            if (Optional.IsDefined(ExtendedInfo))
            {
                ...
                {
                    ((IModelJsonSerializable<FileshareProtectedItemExtendedInfo>)ExtendedInfo).Serialize(writer, options);
                }
            }
        ...
        internal static FileshareProtectedItem DeserializeFileshareProtectedItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FileshareProtectedItem(protectedItemType, Optional.ToNullable(backupManagementType), Optional.ToNullable(workloadType), containerName.Value, sourceResourceId.Value, policyId.Value, Optional.ToNullable(lastRecoveryPoint), backupSetName.Value, Optional.ToNullable(createMode), Optional.ToNullable(deferredDeleteTimeInUTC), Optional.ToNullable(isScheduledForDeferredDelete), deferredDeleteTimeRemaining.Value, Optional.ToNullable(isDeferredDeleteScheduleUpcoming), Optional.ToNullable(isRehydrate), Optional.ToList(resourceGuardOperationRequests), Optional.ToNullable(isArchiveEnabled), policyName.Value, Optional.ToNullable(softDeleteRetentionPeriod), friendlyName.Value, protectionStatus.Value, Optional.ToNullable(protectionState), lastBackupStatus.Value, Optional.ToNullable(lastBackupTime), Optional.ToDictionary(kpisHealths), extendedInfo.Value, serializedAdditionalRawData);
        }

        FileshareProtectedItem IModelJsonSerializable<FileshareProtectedItem>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FileshareProtectedItem>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeFileshareProtectedItem(doc.RootElement, options);
        }

        BinaryData IModelSerializable<FileshareProtectedItem>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FileshareProtectedItem>(this, options.Format);
        ...
        FileshareProtectedItem IModelSerializable<FileshareProtectedItem>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FileshareProtectedItem>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="FileshareProtectedItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FileshareProtectedItem"/> to convert. </param>
        public static implicit operator RequestContent(FileshareProtectedItem model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FileshareProtectedItem"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FileshareProtectedItem(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFileshareProtectedItem(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
