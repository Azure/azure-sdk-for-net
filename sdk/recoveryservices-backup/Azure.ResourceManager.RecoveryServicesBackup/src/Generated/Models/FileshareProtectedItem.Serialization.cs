...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileshareProtectedItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileshareProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileshareProtectedItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FileshareProtectedItem>)} interface");
            }
        ...
        string IPersistableModel<FileshareProtectedItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
