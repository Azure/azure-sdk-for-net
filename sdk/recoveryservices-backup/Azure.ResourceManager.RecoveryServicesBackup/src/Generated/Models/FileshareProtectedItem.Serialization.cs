...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class FileshareProtectedItem : BackupGenericProtectedItem, IJsonModel<FileshareProtectedItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FileshareProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FileshareProtectedItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FileshareProtectedItem IPersistableModel<FileshareProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (FileshareProtectedItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FileshareProtectedItem IJsonModel<FileshareProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (FileshareProtectedItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FileshareProtectedItem DeserializeFileshareProtectedItem(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string protectedItemType = "AzureFileShareProtectedItem";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = FileshareProtectedItemExtendedInfo.DeserializeFileshareProtectedItemExtendedInfo(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
