...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadBackupJobTaskDetails
    {
        ...
        internal WorkloadBackupJobTaskDetails()
        {
        }
        ...
        internal WorkloadBackupJobTaskDetails(string taskId, string status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TaskId = taskId;
            Status = status;
