...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class WorkloadSqlPointInTimeRecoveryPoint : IUtf8JsonSerializable, IModelJsonSerializable<WorkloadSqlPointInTimeRecoveryPoint>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkloadSqlPointInTimeRecoveryPoint>(this, options.Format);
        ...
        internal static WorkloadSqlPointInTimeRecoveryPoint DeserializeWorkloadSqlPointInTimeRecoveryPoint(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new WorkloadSqlPointInTimeRecoveryPoint(objectType, Optional.ToNullable(recoveryPointTimeInUTC), Optional.ToNullable(type), Optional.ToList(recoveryPointTierDetails), Optional.ToDictionary(recoveryPointMoveReadinessInfo), recoveryPointProperties.Value, extendedInfo.Value, Optional.ToList(timeRanges), serializedAdditionalRawData);
        }
