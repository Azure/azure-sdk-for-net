...
{
    public partial class WorkloadSqlPointInTimeRecoveryPoint : Core.IUtf8JsonSerializable
    {
        ...
        internal static WorkloadSqlPointInTimeRecoveryPoint DeserializeWorkloadSqlPointInTimeRecoveryPoint(JsonElement element)
        {
            ...
            Core.Optional<WorkloadSqlRecoveryPointExtendedInfo> extendedInfo = default;
            ...
            return new WorkloadSqlPointInTimeRecoveryPoint(objectType, Core.Optional.ToNullable(recoveryPointTimeInUTC), Core.Optional.ToNullable(type), Core.Optional.ToList(recoveryPointTierDetails), Core.Optional.ToDictionary(recoveryPointMoveReadinessInfo), recoveryPointProperties.Value, extendedInfo.Value, Core.Optional.ToList(timeRanges));
        }
    }
}
