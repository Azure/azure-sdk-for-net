...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadRecoveryPoint : RecoveryPoint
    {
        ...
        internal WorkloadRecoveryPoint(string objectType, ThreatStatus? threatStatus, IList<ThreatInfo> threatInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties, DateTimeOffset? recoveryPointCreatedOn, RestorePointType? @type, IList<RecoveryPointTierInformationV2> recoveryPointTierDetails, IDictionary<string, RecoveryPointMoveReadinessInfo> recoveryPointMoveReadinessInfo, RecoveryPointProperties recoveryPointProperties) : base(objectType, threatStatus, threatInfo, additionalBinaryDataProperties)
        {
