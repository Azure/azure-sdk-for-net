...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class WorkloadPointInTimeRestoreContent : IUtf8JsonSerializable, IModelJsonSerializable<WorkloadPointInTimeRestoreContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkloadPointInTimeRestoreContent>(this, options.Format);
        ...
        internal static WorkloadPointInTimeRestoreContent DeserializeWorkloadPointInTimeRestoreContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new WorkloadPointInTimeRestoreContent(objectType, Optional.ToNullable(recoveryType), sourceResourceId.Value, Optional.ToDictionary(propertyBag), targetInfo.Value, Optional.ToNullable(recoveryMode), targetVirtualMachineId.Value, Optional.ToNullable(pointInTime), serializedAdditionalRawData);
        }
