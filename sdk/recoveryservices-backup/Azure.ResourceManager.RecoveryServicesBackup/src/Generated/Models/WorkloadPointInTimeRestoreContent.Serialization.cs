...
{
    public partial class WorkloadPointInTimeRestoreContent : Core.IUtf8JsonSerializable
    {
        ...
        internal static WorkloadPointInTimeRestoreContent DeserializeWorkloadPointInTimeRestoreContent(JsonElement element)
        {
            ...
            return new WorkloadPointInTimeRestoreContent(objectType, Core.Optional.ToNullable(recoveryType), sourceResourceId.Value, Core.Optional.ToDictionary(propertyBag), targetInfo.Value, Core.Optional.ToNullable(recoveryMode), targetVirtualMachineId.Value, Core.Optional.ToNullable(pointInTime));
        }
    }
}
