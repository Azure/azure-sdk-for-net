...
{
    public partial class VmWorkloadSqlDatabaseProtectedItem : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadSqlDatabaseProtectedItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<VmWorkloadSqlDatabaseProtectedItem>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<VmWorkloadSqlDatabaseProtectedItem>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadSqlDatabaseProtectedItem>(this, options.Format);
        ...
        internal static VmWorkloadSqlDatabaseProtectedItem DeserializeVmWorkloadSqlDatabaseProtectedItem(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        VmWorkloadSqlDatabaseProtectedItem IModelJsonSerializable<VmWorkloadSqlDatabaseProtectedItem>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadSqlDatabaseProtectedItem>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeVmWorkloadSqlDatabaseProtectedItem(doc.RootElement, options);
        }

        BinaryData IModelSerializable<VmWorkloadSqlDatabaseProtectedItem>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadSqlDatabaseProtectedItem>(this, options.Format);
        ...
        VmWorkloadSqlDatabaseProtectedItem IModelSerializable<VmWorkloadSqlDatabaseProtectedItem>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadSqlDatabaseProtectedItem>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="VmWorkloadSqlDatabaseProtectedItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VmWorkloadSqlDatabaseProtectedItem"/> to convert. </param>
        public static implicit operator RequestContent(VmWorkloadSqlDatabaseProtectedItem model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VmWorkloadSqlDatabaseProtectedItem"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VmWorkloadSqlDatabaseProtectedItem(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVmWorkloadSqlDatabaseProtectedItem(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
