...
{
    public partial class IaasVmContainer : Core.IUtf8JsonSerializable
    {
        ...
        internal static IaasVmContainer DeserializeIaasVmContainer(JsonElement element)
        {
            ...
            return new IaasVmContainer(friendlyName.Value, Core.Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, virtualMachineId.Value, virtualMachineVersion.Value, resourceGroup.Value);
        }
    }
}
