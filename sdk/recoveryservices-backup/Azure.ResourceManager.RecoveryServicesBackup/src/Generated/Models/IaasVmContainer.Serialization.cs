...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class IaasVmContainer : IUtf8JsonSerializable, IModelJsonSerializable<IaasVmContainer>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IaasVmContainer>(this, options.Format);
        ...
        internal static IaasVmContainer DeserializeIaasVmContainer(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IaasVmContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, virtualMachineId.Value, virtualMachineVersion.Value, resourceGroup.Value, serializedAdditionalRawData);
        }
