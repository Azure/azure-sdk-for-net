...
{
    internal partial class UnknownBackupRetentionPolicy : BackupRetentionPolicy, IJsonModel<BackupRetentionPolicy>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBackupRetentionPolicy"/> for deserialization. </summary>
        internal UnknownBackupRetentionPolicy()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupRetentionPolicy DeserializeUnknownBackupRetentionPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownBackupRetentionPolicy(retentionPolicyType, additionalBinaryDataProperties);
        }
    }
}
