...
{
    public partial class DpmJobExtendedInfo : IUtf8JsonSerializable
    {
        ...
        internal static DpmJobExtendedInfo DeserializeDpmJobExtendedInfo(JsonElement element)
        {
            Optional<IList<DpmJobTaskDetails>> tasksList = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("tasksList"u8))
                {
                    ...
                    {
                        array.Add(DpmJobTaskDetails.DeserializeDpmJobTaskDetails(item));
                    }
                    tasksList = array;
                    continue;
                }
            ...
            return new DpmJobExtendedInfo(Optional.ToList(tasksList), Optional.ToDictionary(propertyBag), dynamicErrorMessage.Value);
        }
    }
}
