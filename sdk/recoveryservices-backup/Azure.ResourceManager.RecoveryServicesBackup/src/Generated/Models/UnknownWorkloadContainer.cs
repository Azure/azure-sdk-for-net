...
{
    internal partial class UnknownWorkloadContainer : WorkloadContainer
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadContainer"/>. </summary>
        ...
        internal UnknownWorkloadContainer(string friendlyName, BackupManagementType? backupManagementType, string registrationStatus, string healthStatus, ProtectableContainerType containerType, string protectableObjectType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier sourceResourceId, DateTimeOffset? lastUpdatedOn, WorkloadContainerExtendedInfo extendedInfo, BackupWorkloadType? workloadType, WorkloadOperationType? operationType) : base(friendlyName, backupManagementType, registrationStatus, healthStatus, containerType != default ? containerType : "unknown", protectableObjectType, additionalBinaryDataProperties, sourceResourceId, lastUpdatedOn, extendedInfo, workloadType, operationType)
        {
        }
    }
}
