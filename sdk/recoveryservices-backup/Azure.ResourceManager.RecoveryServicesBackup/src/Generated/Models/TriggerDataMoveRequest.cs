...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class TriggerDataMoveRequest
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TriggerDataMoveRequest"/>. </summary>
        ...
        public TriggerDataMoveRequest(string sourceResourceId, string sourceRegion, DataMoveLevel dataMoveLevel, string correlationId)
        {
        ...
        internal TriggerDataMoveRequest(string sourceResourceId, string sourceRegion, DataMoveLevel dataMoveLevel, string correlationId, IList<string> sourceContainerArmIds, bool? pauseGC, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SourceResourceId = sourceResourceId;
            SourceRegion = sourceRegion;
            DataMoveLevel = dataMoveLevel;
