...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BekDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BekDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BekDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BekDetails>)} interface");
            }
        ...
        string IPersistableModel<BekDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
