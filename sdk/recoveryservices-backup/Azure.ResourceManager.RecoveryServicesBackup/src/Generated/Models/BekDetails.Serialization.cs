...
{
    public partial class BekDetails : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BekDetails DeserializeBekDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
