...
{
    public partial class WorkloadContainerAutoProtectionIntent : Core.IUtf8JsonSerializable
    {
        ...
        internal static WorkloadContainerAutoProtectionIntent DeserializeWorkloadContainerAutoProtectionIntent(JsonElement element)
        {
            ...
            return new WorkloadContainerAutoProtectionIntent(protectionIntentItemType, Core.Optional.ToNullable(backupManagementType), sourceResourceId.Value, itemId.Value, policyId.Value, Core.Optional.ToNullable(protectionState));
        }
    }
}
