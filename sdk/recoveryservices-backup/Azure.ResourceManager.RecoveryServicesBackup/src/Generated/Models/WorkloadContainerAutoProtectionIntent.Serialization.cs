...
{
    public partial class WorkloadContainerAutoProtectionIntent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WorkloadContainerAutoProtectionIntent DeserializeWorkloadContainerAutoProtectionIntent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
