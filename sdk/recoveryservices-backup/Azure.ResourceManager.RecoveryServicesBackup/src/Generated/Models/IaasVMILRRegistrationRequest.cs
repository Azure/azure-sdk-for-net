...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="IaasVMILRRegistrationRequest"/>. </summary>
        public IaasVMILRRegistrationRequest() : base("IaasVMILRRegistrationRequest")
        {
        }
        ...
        internal IaasVMILRRegistrationRequest(string objectType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string recoveryPointId, string virtualMachineId, string initiatorName, bool? renewExistingRegistration) : base(objectType, additionalBinaryDataProperties)
        {
