...
{
    public partial class IaasVmBackupJob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IaasVmBackupJob DeserializeIaasVmBackupJob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
