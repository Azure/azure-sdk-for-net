...
{
    public partial class IaasVmBackupJob : Core.IUtf8JsonSerializable
    {
        ...
        internal static IaasVmBackupJob DeserializeIaasVmBackupJob(JsonElement element)
        {
            ...
            Core.Optional<IList<IaasVmErrorInfo>> errorDetails = default;
            Core.Optional<string> virtualMachineVersion = default;
            Core.Optional<IaasVmBackupJobExtendedInfo> extendedInfo = default;
            ...
            return new IaasVmBackupJob(entityFriendlyName.Value, Core.Optional.ToNullable(backupManagementType), operation.Value, status.Value, Core.Optional.ToNullable(startTime), Core.Optional.ToNullable(endTime), activityId.Value, jobType, Core.Optional.ToNullable(duration), Core.Optional.ToList(actionsInfo), Core.Optional.ToList(errorDetails), virtualMachineVersion.Value, extendedInfo.Value, containerName.Value, Core.Optional.ToNullable(isUserTriggered));
        }
    }
}
