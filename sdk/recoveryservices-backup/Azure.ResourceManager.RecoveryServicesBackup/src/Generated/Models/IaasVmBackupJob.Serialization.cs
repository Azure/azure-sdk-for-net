...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasVmBackupJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasVmBackupJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasVmBackupJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasVmBackupJob>)} interface");
            }
        ...
        string IPersistableModel<IaasVmBackupJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
