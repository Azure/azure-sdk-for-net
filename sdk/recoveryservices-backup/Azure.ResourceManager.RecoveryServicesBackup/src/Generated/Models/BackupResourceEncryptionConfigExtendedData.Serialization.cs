...
namespace Azure.ResourceManager.RecoveryServicesBackup
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupResourceEncryptionConfigExtendedData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupResourceEncryptionConfigExtendedData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupResourceEncryptionConfigExtendedData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupResourceEncryptionConfigExtendedData>)} interface");
            }
        ...
        string IPersistableModel<BackupResourceEncryptionConfigExtendedData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
