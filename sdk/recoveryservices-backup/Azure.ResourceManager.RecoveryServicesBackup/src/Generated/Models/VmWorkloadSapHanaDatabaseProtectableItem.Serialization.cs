...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSapHanaDatabaseProtectableItem : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadSapHanaDatabaseProtectableItem>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadSapHanaDatabaseProtectableItem>(this, options.Format);
        ...
        internal static VmWorkloadSapHanaDatabaseProtectableItem DeserializeVmWorkloadSapHanaDatabaseProtectableItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VmWorkloadSapHanaDatabaseProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="VmWorkloadSapHanaDatabaseProtectableItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VmWorkloadSapHanaDatabaseProtectableItem"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VmWorkloadSapHanaDatabaseProtectableItem"/>. </summary>
