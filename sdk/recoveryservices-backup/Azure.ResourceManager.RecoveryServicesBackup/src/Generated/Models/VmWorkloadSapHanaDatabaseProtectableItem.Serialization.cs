...
{
    public partial class VmWorkloadSapHanaDatabaseProtectableItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSapHanaDatabaseProtectableItem>, IPersistableModel<VmWorkloadSapHanaDatabaseProtectableItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSapHanaDatabaseProtectableItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VmWorkloadSapHanaDatabaseProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmWorkloadSapHanaDatabaseProtectableItem)} does not support '{format}' format.");
            }
