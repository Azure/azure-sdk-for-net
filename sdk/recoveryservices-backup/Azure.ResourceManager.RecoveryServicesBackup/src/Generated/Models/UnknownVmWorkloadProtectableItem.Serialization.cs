...
{
    internal partial class UnknownVmWorkloadProtectableItem : VmWorkloadProtectableItem, IJsonModel<VmWorkloadProtectableItem>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownVmWorkloadProtectableItem"/> for deserialization. </summary>
        internal UnknownVmWorkloadProtectableItem()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadProtectableItem IPersistableModel<VmWorkloadProtectableItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownVmWorkloadProtectableItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadProtectableItem IJsonModel<VmWorkloadProtectableItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownVmWorkloadProtectableItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownVmWorkloadProtectableItem DeserializeUnknownVmWorkloadProtectableItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownVmWorkloadProtectableItem(
