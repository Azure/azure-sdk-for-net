...
{
    internal partial class UnknownWorkloadRecoveryPoint : WorkloadRecoveryPoint, IJsonModel<WorkloadRecoveryPoint>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadRecoveryPoint"/> for deserialization. </summary>
        internal UnknownWorkloadRecoveryPoint()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWorkloadRecoveryPoint DeserializeUnknownWorkloadRecoveryPoint(JsonElement element, ModelReaderWriterOptions options)
        {
