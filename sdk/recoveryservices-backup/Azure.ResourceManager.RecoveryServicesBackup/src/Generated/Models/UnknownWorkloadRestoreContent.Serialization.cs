...
{
    internal partial class UnknownWorkloadRestoreContent : WorkloadRestoreContent, IJsonModel<WorkloadRestoreContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadRestoreContent"/> for deserialization. </summary>
        internal UnknownWorkloadRestoreContent()
        {
        }
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadRestoreContent IPersistableModel<WorkloadRestoreContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownWorkloadRestoreContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadRestoreContent IJsonModel<WorkloadRestoreContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownWorkloadRestoreContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWorkloadRestoreContent DeserializeUnknownWorkloadRestoreContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownWorkloadRestoreContent(
                objectType,
