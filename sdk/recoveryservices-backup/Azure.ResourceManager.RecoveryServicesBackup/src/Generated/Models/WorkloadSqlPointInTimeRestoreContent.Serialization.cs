...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadSqlPointInTimeRestoreContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadSqlPointInTimeRestoreContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadSqlPointInTimeRestoreContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadSqlPointInTimeRestoreContent>)} interface");
            }
        ...
        string IPersistableModel<WorkloadSqlPointInTimeRestoreContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
