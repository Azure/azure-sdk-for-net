...
{
    public partial class FileShareRestoreContent : IUtf8JsonSerializable, IJsonModel<FileShareRestoreContent>, IPersistableModel<FileShareRestoreContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CopyOptions))
            {
                ...
                builder.AppendLine($" '{CopyOptions.ToString()}'");
            }

            if (Optional.IsDefined(RestoreRequestType))
            {
                builder.Append("  restoreRequestType:");
                builder.AppendLine($" '{RestoreRequestType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(TargetDetails))
            {
                ...
                AppendChildObject(builder, TargetDetails, options, 2);
            }
