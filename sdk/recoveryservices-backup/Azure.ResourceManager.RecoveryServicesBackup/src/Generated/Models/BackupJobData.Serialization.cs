...
{
    public partial class BackupJobData : IUtf8JsonSerializable
    {
        ...
        internal static BackupJobData DeserializeBackupJobData(JsonElement element)
        {
            ...
            return new BackupJobData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, Optional.ToNullable(eTag));
        }
    }
}
