...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VmResourceFeatureSupportContent : FeatureSupportContent
    {
        ...
        internal VmResourceFeatureSupportContent(string featureType, string vmSize, string vmSku, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(featureType, serializedAdditionalRawData)
        {
            VmSize = vmSize;
            VmSku = vmSku;
