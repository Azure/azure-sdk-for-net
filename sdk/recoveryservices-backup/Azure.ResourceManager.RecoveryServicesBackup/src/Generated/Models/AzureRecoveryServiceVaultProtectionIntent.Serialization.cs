...
{
    public partial class AzureRecoveryServiceVaultProtectionIntent : IUtf8JsonSerializable
    {
        ...
        internal static AzureRecoveryServiceVaultProtectionIntent DeserializeAzureRecoveryServiceVaultProtectionIntent(JsonElement element)
        {
            ...
            return new AzureRecoveryServiceVaultProtectionIntent(protectionIntentItemType, Optional.ToNullable(backupManagementType), sourceResourceId.Value, itemId.Value, policyId.Value, Optional.ToNullable(protectionState));
        }
    }
}
