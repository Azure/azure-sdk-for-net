...
{
    internal partial class UnknownWorkloadPointInTimeRecoveryPoint : WorkloadPointInTimeRecoveryPoint, IJsonModel<WorkloadPointInTimeRecoveryPoint>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownWorkloadPointInTimeRecoveryPoint"/> for deserialization. </summary>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWorkloadPointInTimeRecoveryPoint DeserializeUnknownWorkloadPointInTimeRecoveryPoint(JsonElement element, ModelReaderWriterOptions options)
        {
