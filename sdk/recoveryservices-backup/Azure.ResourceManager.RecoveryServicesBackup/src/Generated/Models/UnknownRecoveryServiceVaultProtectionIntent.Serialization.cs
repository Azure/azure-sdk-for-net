...
{
    internal partial class UnknownRecoveryServiceVaultProtectionIntent : RecoveryServiceVaultProtectionIntent, IJsonModel<RecoveryServiceVaultProtectionIntent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownRecoveryServiceVaultProtectionIntent"/> for deserialization. </summary>
        internal UnknownRecoveryServiceVaultProtectionIntent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownRecoveryServiceVaultProtectionIntent DeserializeUnknownRecoveryServiceVaultProtectionIntent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownRecoveryServiceVaultProtectionIntent(
