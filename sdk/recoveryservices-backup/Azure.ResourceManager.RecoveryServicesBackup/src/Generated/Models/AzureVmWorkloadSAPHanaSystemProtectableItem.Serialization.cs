...
{
    public partial class AzureVmWorkloadSAPHanaSystemProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static AzureVmWorkloadSAPHanaSystemProtectableItem DeserializeAzureVmWorkloadSAPHanaSystemProtectableItem(JsonElement element)
        {
            ...
            return new AzureVmWorkloadSAPHanaSystemProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value);
        }
    }
}
