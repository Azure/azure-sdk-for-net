...
{
    public partial class StorageJob : IUtf8JsonSerializable
    {
        ...
        internal static StorageJob DeserializeStorageJob(JsonElement element)
        {
            ...
            Optional<StorageJobExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = StorageJobExtendedInfo.DeserializeStorageJobExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new StorageJob(entityFriendlyName.Value, Optional.ToNullable(backupManagementType), operation.Value, status.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), activityId.Value, jobType, Optional.ToNullable(duration), Optional.ToList(actionsInfo), Optional.ToList(errorDetails), storageAccountName.Value, storageAccountVersion.Value, extendedInfo.Value, Optional.ToNullable(isUserTriggered));
        }
    }
}
