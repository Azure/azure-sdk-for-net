...
{
    public partial class DpmBackupEngine : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DpmBackupEngine DeserializeDpmBackupEngine(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
