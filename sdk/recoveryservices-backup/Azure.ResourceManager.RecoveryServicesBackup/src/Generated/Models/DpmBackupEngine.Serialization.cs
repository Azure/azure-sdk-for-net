...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DpmBackupEngine>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DpmBackupEngine>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DpmBackupEngine>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DpmBackupEngine>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
