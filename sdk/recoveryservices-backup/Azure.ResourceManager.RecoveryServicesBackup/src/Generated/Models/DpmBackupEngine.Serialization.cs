...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class DpmBackupEngine : IUtf8JsonSerializable, IJsonModel<DpmBackupEngine>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DpmBackupEngine>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DpmBackupEngine>)} interface");
            }
