...
{
    public partial class WorkloadAutoProtectionIntent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WorkloadAutoProtectionIntent DeserializeWorkloadAutoProtectionIntent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
