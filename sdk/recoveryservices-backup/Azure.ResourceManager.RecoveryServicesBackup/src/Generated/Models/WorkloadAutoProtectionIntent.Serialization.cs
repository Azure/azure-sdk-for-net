...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadAutoProtectionIntent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadAutoProtectionIntent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadAutoProtectionIntent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadAutoProtectionIntent>)} interface");
            }
        ...
        string IPersistableModel<WorkloadAutoProtectionIntent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
