...
{
    public partial class DpmBackupJobExtendedInfo : Core.IUtf8JsonSerializable
    {
        ...
        internal static DpmBackupJobExtendedInfo DeserializeDpmBackupJobExtendedInfo(JsonElement element)
        {
            ...
            Core.Optional<IList<DpmBackupJobTaskDetails>> tasksList = default;
            ...
            return new DpmBackupJobExtendedInfo(Core.Optional.ToList(tasksList), Core.Optional.ToDictionary(propertyBag), dynamicErrorMessage.Value);
        }
    }
}
