...
{
    public partial class WorkloadSapHanaRestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadSapHanaRestoreRequest DeserializeWorkloadSapHanaRestoreRequest(JsonElement element)
        {
            ...
            return new WorkloadSapHanaRestoreRequest(objectType, Optional.ToNullable(recoveryType), sourceResourceId.Value, Optional.ToDictionary(propertyBag), targetInfo.Value, Optional.ToNullable(recoveryMode), targetVirtualMachineId.Value);
        }
    }
}
