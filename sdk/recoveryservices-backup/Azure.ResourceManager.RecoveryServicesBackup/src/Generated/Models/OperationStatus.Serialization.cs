...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class OperationStatus : IJsonModel<OperationStatus>
    {
        ...
        internal static OperationStatus DeserializeOperationStatus(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string id = default;
            string name = default;
            OperationStatusValues? status = default;
            DateTimeOffset? startOn = default;
            DateTimeOffset? endOn = default;
            OperationStatusError error = default;
            OperationStatusExtendedInfo properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("status"u8))
                {
                    ...
                    status = new OperationStatusValues(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("error"u8))
                {
                    ...
                    error = OperationStatusError.DeserializeOperationStatusError(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = OperationStatusExtendedInfo.DeserializeOperationStatusExtendedInfo(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
