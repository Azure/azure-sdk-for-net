...
{
    public partial class BackupRecoveryPointData : IUtf8JsonSerializable
    {
        ...
        internal static BackupRecoveryPointData DeserializeBackupRecoveryPointData(JsonElement element)
        {
            ...
            return new BackupRecoveryPointData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, Optional.ToNullable(eTag));
        }
    }
}
