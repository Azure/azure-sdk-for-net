...
{
    internal partial class UnknownIlrRequest : IUtf8JsonSerializable, IModelJsonSerializable<IlrContent>
    {
        ...
        internal static IlrContent DeserializeUnknownIlrRequest(JsonElement element, ModelSerializerOptions options = default) => DeserializeIlrContent(element, options);
        ...
        IlrContent IModelJsonSerializable<IlrContent>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            ...
            return DeserializeUnknownIlrRequest(doc.RootElement, options);
        }
