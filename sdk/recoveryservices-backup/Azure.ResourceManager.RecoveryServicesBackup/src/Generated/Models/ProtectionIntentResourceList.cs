...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    internal partial class ProtectionIntentResourceList : ResourceList
    {
        ...
        internal ProtectionIntentResourceList(string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<ProtectionIntentResourceData> value) : base(nextLink, additionalBinaryDataProperties)
        {
            Value = value;
        }

        /// <summary> List of resources. </summary>
        public IList<ProtectionIntentResourceData> Value { get; }
    }
}
