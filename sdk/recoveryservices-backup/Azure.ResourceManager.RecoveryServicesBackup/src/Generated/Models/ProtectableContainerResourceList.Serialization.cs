...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProtectableContainerResourceList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ProtectableContainerResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProtectableContainerResourceList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<ProtectableContainerResource> collection && collection.IsUndefined))
            {
        ...
        internal static ProtectableContainerResourceList DeserializeProtectableContainerResourceList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ProtectableContainerResourceList(value ?? new ChangeTrackingList<ProtectableContainerResource>(), nextLink.Value, serializedAdditionalRawData);
        }
