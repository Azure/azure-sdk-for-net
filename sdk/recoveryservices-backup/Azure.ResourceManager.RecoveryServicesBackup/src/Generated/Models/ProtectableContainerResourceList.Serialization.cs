...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProtectableContainerResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProtectableContainerResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProtectableContainerResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProtectableContainerResourceList>)} interface");
            }
        ...
        string IPersistableModel<ProtectableContainerResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
