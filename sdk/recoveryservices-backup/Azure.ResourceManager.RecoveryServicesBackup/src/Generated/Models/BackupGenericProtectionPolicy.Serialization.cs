...
{
    public partial class BackupGenericProtectionPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupGenericProtectionPolicy DeserializeBackupGenericProtectionPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
