...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class FileShareProvisionIlrContent : IlrContent
    {
        ...
        internal FileShareProvisionIlrContent(string objectType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string recoveryPointId, string sourceResourceId) : base(objectType, additionalBinaryDataProperties)
        {
