...
{
    public partial class AzureWorkloadContainer : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadContainer DeserializeAzureWorkloadContainer(JsonElement element)
        {
            ...
            Optional<AzureWorkloadContainerExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = AzureWorkloadContainerExtendedInfo.DeserializeAzureWorkloadContainerExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new AzureWorkloadContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, sourceResourceId.Value, Optional.ToNullable(lastUpdatedTime), extendedInfo.Value, Optional.ToNullable(workloadType), Optional.ToNullable(operationType));
        }
    }
}
