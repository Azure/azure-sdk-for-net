...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    internal partial class BackupEngineBaseResourceList : ResourceList
    {
        ...
        internal BackupEngineBaseResourceList(string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<BackupEngineBaseResourceData> value) : base(nextLink, additionalBinaryDataProperties)
        {
            Value = value;
        }

        /// <summary> List of resources. </summary>
        public IList<BackupEngineBaseResourceData> Value { get; }
    }
}
