...
{
    public partial class AzureVmWorkloadSQLInstanceProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static AzureVmWorkloadSQLInstanceProtectableItem DeserializeAzureVmWorkloadSQLInstanceProtectableItem(JsonElement element)
        {
            ...
            return new AzureVmWorkloadSQLInstanceProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value);
        }
    }
}
