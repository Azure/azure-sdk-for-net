...
{
    public partial class AzureFileShareProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static AzureFileShareProtectableItem DeserializeAzureFileShareProtectableItem(JsonElement element)
        {
            ...
            return new AzureFileShareProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentContainerFabricId.Value, parentContainerFriendlyName.Value, Optional.ToNullable(azureFileShareType));
        }
    }
}
