...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadSqlRestoreWithRehydrateContent : WorkloadSqlRestoreContent, IJsonModel<WorkloadSqlRestoreWithRehydrateContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkloadSqlRestoreWithRehydrateContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WorkloadSqlRestoreWithRehydrateContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSqlRestoreWithRehydrateContent IPersistableModel<WorkloadSqlRestoreWithRehydrateContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (WorkloadSqlRestoreWithRehydrateContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSqlRestoreWithRehydrateContent IJsonModel<WorkloadSqlRestoreWithRehydrateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WorkloadSqlRestoreWithRehydrateContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkloadSqlRestoreWithRehydrateContent DeserializeWorkloadSqlRestoreWithRehydrateContent(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string objectType = "AzureWorkloadSQLRestoreWithRehydrateRequest";
