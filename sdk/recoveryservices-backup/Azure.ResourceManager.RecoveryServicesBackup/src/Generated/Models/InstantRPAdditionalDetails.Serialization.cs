...
{
    public partial class InstantRPAdditionalDetails : IUtf8JsonSerializable, IJsonModel<InstantRPAdditionalDetails>, IPersistableModel<InstantRPAdditionalDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AzureBackupRGNamePrefix))
            {
                builder.Append("  azureBackupRGNamePrefix:");
                builder.AppendLine($" '{AzureBackupRGNamePrefix}'");
            }

            if (Optional.IsDefined(AzureBackupRGNameSuffix))
            {
                builder.Append("  azureBackupRGNameSuffix:");
                builder.AppendLine($" '{AzureBackupRGNameSuffix}'");
            }
