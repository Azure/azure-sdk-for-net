...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// </summary>
    public partial class AzureIaasVmJob : BackupJobProperties
    {
        ...
        /// </param>
        internal AzureIaasVmJob(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, TimeSpan? duration, IList<JobSupportedAction> actionsInfo, IList<AzureIaasVmErrorInfo> errorDetails, string virtualMachineVersion, AzureIaasVmJobExtendedInfo extendedInfo, string containerName, bool? isUserTriggered) : base(entityFriendlyName, backupManagementType, operation, status, startOn, endOn, activityId, jobType)
        {
            Duration = duration;
