...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// Serialized Name: AzureFileshareProtectedItem
    /// </summary>
    public partial class FileshareProtectedItem : BackupProtectedItemProperties
    {
        ...
        /// Serialized Name: AzureFileshareProtectedItem.friendlyName
        /// </param>
        /// <param name="protectionStatus">
        /// Backup status of this backup item.
        /// Serialized Name: AzureFileshareProtectedItem.protectionStatus
        /// </param>
        /// <param name="protectionState">
        /// Backup state of this backup item.
        /// Serialized Name: AzureFileshareProtectedItem.protectionState
        /// </param>
        /// <param name="lastBackupStatus">
        /// Last backup operation status. Possible values: Healthy, Unhealthy.
        /// Serialized Name: AzureFileshareProtectedItem.lastBackupStatus
        /// </param>
        /// <param name="lastBackupOn">
        /// Timestamp of the last backup operation on this backup item.
        /// Serialized Name: AzureFileshareProtectedItem.lastBackupTime
        /// </param>
        /// <param name="kpisHealths">
        /// Health details of different KPIs
        /// Serialized Name: AzureFileshareProtectedItem.kpisHealths
        /// </param>
        /// <param name="extendedInfo">
        /// Additional information with this backup item.
        /// Serialized Name: AzureFileshareProtectedItem.extendedInfo
        /// </param>
        internal FileshareProtectedItem(string protectedItemType, BackupManagementType? backupManagementType, DataSourceType? workloadType, string containerName, string sourceResourceId, string policyId, DateTimeOffset? lastRecoveryPoint, string backupSetName, CreateMode? createMode, DateTimeOffset? deferredDeleteTimeInUTC, bool? isScheduledForDeferredDelete, string deferredDeleteTimeRemaining, bool? isDeferredDeleteScheduleUpcoming, bool? isRehydrate, IList<string> resourceGuardOperationRequests, bool? isArchiveEnabled, string policyName, int? softDeleteRetentionPeriod, string friendlyName, string protectionStatus, ProtectionState? protectionState, string lastBackupStatus, DateTimeOffset? lastBackupOn, IDictionary<string, KPIResourceHealthDetails> kpisHealths, FileshareProtectedItemExtendedInfo extendedInfo) : base(protectedItemType, backupManagementType, workloadType, containerName, sourceResourceId, policyId, lastRecoveryPoint, backupSetName, createMode, deferredDeleteTimeInUTC, isScheduledForDeferredDelete, deferredDeleteTimeRemaining, isDeferredDeleteScheduleUpcoming, isRehydrate, resourceGuardOperationRequests, isArchiveEnabled, policyName, softDeleteRetentionPeriod)
        {
