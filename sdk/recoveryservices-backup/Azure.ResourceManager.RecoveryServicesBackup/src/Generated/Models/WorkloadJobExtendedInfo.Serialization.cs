...
{
    public partial class WorkloadJobExtendedInfo : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadJobExtendedInfo DeserializeWorkloadJobExtendedInfo(JsonElement element)
        {
            Optional<IList<WorkloadJobTaskDetails>> tasksList = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("tasksList"))
                {
                    ...
                    List<WorkloadJobTaskDetails> array = new List<WorkloadJobTaskDetails>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(WorkloadJobTaskDetails.DeserializeWorkloadJobTaskDetails(item));
                    }
                    tasksList = array;
                    continue;
                }
            ...
            return new WorkloadJobExtendedInfo(Optional.ToList(tasksList), Optional.ToDictionary(propertyBag), dynamicErrorMessage.Value);
        }
    }
}
