...
{
    public partial class WorkloadJob : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadJob DeserializeWorkloadJob(JsonElement element)
        {
            Optional<string> workloadType = default;
            Optional<TimeSpan> duration = default;
            Optional<IList<JobSupportedAction>> actionsInfo = default;
            Optional<IList<WorkloadErrorInfo>> errorDetails = default;
            Optional<WorkloadJobExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = WorkloadJobExtendedInfo.DeserializeWorkloadJobExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new WorkloadJob(entityFriendlyName.Value, Optional.ToNullable(backupManagementType), operation.Value, status.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), activityId.Value, jobType, workloadType.Value, Optional.ToNullable(duration), Optional.ToList(actionsInfo), Optional.ToList(errorDetails), extendedInfo.Value);
        }
    }
}
