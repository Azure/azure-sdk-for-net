...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadSapAsePointInTimeRecoveryPoint : WorkloadPointInTimeRecoveryPoint, IJsonModel<WorkloadSapAsePointInTimeRecoveryPoint>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkloadSapAsePointInTimeRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeWorkloadSapAsePointInTimeRecoveryPoint(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(WorkloadSapAsePointInTimeRecoveryPoint)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(WorkloadSapAsePointInTimeRecoveryPoint)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WorkloadSapAsePointInTimeRecoveryPoint>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSapAsePointInTimeRecoveryPoint IPersistableModel<WorkloadSapAsePointInTimeRecoveryPoint>.Create(BinaryData data, ModelReaderWriterOptions options) => (WorkloadSapAsePointInTimeRecoveryPoint)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<WorkloadSapAsePointInTimeRecoveryPoint>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<WorkloadSapAsePointInTimeRecoveryPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkloadSapAsePointInTimeRecoveryPoint)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSapAsePointInTimeRecoveryPoint IJsonModel<WorkloadSapAsePointInTimeRecoveryPoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WorkloadSapAsePointInTimeRecoveryPoint)JsonModelCreateCore(ref reader, options);
        ...
        protected override BackupGenericRecoveryPoint JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkloadSapAsePointInTimeRecoveryPoint)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkloadSapAsePointInTimeRecoveryPoint DeserializeWorkloadSapAsePointInTimeRecoveryPoint(JsonElement element, ModelReaderWriterOptions options)
        {
