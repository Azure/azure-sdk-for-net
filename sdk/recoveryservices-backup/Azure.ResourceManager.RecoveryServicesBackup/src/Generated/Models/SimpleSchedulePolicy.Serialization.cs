...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class SimpleSchedulePolicy : IUtf8JsonSerializable, IModelJsonSerializable<SimpleSchedulePolicy>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SimpleSchedulePolicy>(this, options.Format);
        ...
        internal static SimpleSchedulePolicy DeserializeSimpleSchedulePolicy(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SimpleSchedulePolicy(schedulePolicyType, Optional.ToNullable(scheduleRunFrequency), Optional.ToList(scheduleRunDays), Optional.ToList(scheduleRunTimes), hourlySchedule.Value, Optional.ToNullable(scheduleWeeklyFrequency), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="SimpleSchedulePolicy"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SimpleSchedulePolicy"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SimpleSchedulePolicy"/>. </summary>
