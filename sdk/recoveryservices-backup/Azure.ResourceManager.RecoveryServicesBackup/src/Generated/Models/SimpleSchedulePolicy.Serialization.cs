...
{
    public partial class SimpleSchedulePolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SimpleSchedulePolicy DeserializeSimpleSchedulePolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
