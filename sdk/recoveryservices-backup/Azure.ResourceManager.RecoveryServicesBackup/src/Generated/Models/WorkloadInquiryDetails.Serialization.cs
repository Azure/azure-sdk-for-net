...
{
    public partial class WorkloadInquiryDetails : IUtf8JsonSerializable, IJsonModel<WorkloadInquiryDetails>, IPersistableModel<WorkloadInquiryDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{WorkloadInquiryDetailsType}'");
            }

            if (Optional.IsDefined(ItemCount))
            {
                builder.Append("  itemCount:");
                builder.AppendLine($" '{ItemCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(InquiryValidation))
            {
                builder.Append("  inquiryValidation:");
                AppendChildObject(builder, InquiryValidation, options, 2);
            }
