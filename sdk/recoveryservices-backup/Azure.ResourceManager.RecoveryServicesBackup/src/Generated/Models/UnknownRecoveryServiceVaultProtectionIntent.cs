...
{
    internal partial class UnknownRecoveryServiceVaultProtectionIntent : RecoveryServiceVaultProtectionIntent
    {
        /// <summary> Initializes a new instance of <see cref="UnknownRecoveryServiceVaultProtectionIntent"/>. </summary>
        ...
        internal UnknownRecoveryServiceVaultProtectionIntent(ProtectionIntentItemType protectionIntentItemType, BackupManagementType? backupManagementType, string sourceResourceId, string itemId, string policyId, BackupProtectionStatus? protectionState, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(protectionIntentItemType != default ? protectionIntentItemType : "unknown", backupManagementType, sourceResourceId, itemId, policyId, protectionState, additionalBinaryDataProperties)
        {
        }
    }
}
