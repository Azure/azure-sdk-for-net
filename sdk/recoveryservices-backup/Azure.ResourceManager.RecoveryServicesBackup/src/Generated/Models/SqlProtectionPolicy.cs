...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class SqlProtectionPolicy : BackupGenericProtectionPolicy
    {
        ...
        internal SqlProtectionPolicy(int? protectedItemsCount, string backupManagementType, IList<string> resourceGuardOperationRequests, BackupRetentionPolicy retentionPolicy, Dictionary<string, BinaryData> rawData) : base(protectedItemsCount, backupManagementType, resourceGuardOperationRequests, rawData)
        {
