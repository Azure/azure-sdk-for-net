...
{
    public partial class AzureWorkloadSAPHanaPointInTimeRestoreWithRehydrateRequest : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadSAPHanaPointInTimeRestoreWithRehydrateRequest DeserializeAzureWorkloadSAPHanaPointInTimeRestoreWithRehydrateRequest(JsonElement element)
        {
            ...
            return new AzureWorkloadSAPHanaPointInTimeRestoreWithRehydrateRequest(objectType, Optional.ToNullable(recoveryType), sourceResourceId.Value, Optional.ToDictionary(propertyBag), targetInfo.Value, Optional.ToNullable(recoveryMode), targetVirtualMachineId.Value, Optional.ToNullable(pointInTime), recoveryPointRehydrationInfo.Value);
        }
    }
}
