...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureVmWorkloadSAPHanaDBInstance : VmWorkloadProtectableItem, IJsonModel<AzureVmWorkloadSAPHanaDBInstance>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureVmWorkloadSAPHanaDBInstance>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeAzureVmWorkloadSAPHanaDBInstance(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDBInstance)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDBInstance)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureVmWorkloadSAPHanaDBInstance>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureVmWorkloadSAPHanaDBInstance IPersistableModel<AzureVmWorkloadSAPHanaDBInstance>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureVmWorkloadSAPHanaDBInstance)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<AzureVmWorkloadSAPHanaDBInstance>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<AzureVmWorkloadSAPHanaDBInstance>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDBInstance)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureVmWorkloadSAPHanaDBInstance IJsonModel<AzureVmWorkloadSAPHanaDBInstance>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureVmWorkloadSAPHanaDBInstance)JsonModelCreateCore(ref reader, options);
        ...
        protected override WorkloadProtectableItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureVmWorkloadSAPHanaDBInstance)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureVmWorkloadSAPHanaDBInstance DeserializeAzureVmWorkloadSAPHanaDBInstance(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string protectableItemType = "SAPHanaDBInstance";
