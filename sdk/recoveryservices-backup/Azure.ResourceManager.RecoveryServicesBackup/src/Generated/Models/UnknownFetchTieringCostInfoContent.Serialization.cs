...
{
    internal partial class UnknownFetchTieringCostInfoContent : FetchTieringCostInfoContent, IJsonModel<FetchTieringCostInfoContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownFetchTieringCostInfoContent"/> for deserialization. </summary>
        internal UnknownFetchTieringCostInfoContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownFetchTieringCostInfoContent DeserializeUnknownFetchTieringCostInfoContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownFetchTieringCostInfoContent(sourceTierType, targetTierType, objectType, additionalBinaryDataProperties);
        }
    }
}
