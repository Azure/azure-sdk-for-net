...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadSqlRecoveryPointExtendedInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadSqlRecoveryPointExtendedInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadSqlRecoveryPointExtendedInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadSqlRecoveryPointExtendedInfo>)} interface");
            }
        ...
        string IPersistableModel<WorkloadSqlRecoveryPointExtendedInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
