...
{
    public partial class WorkloadSqlRecoveryPointExtendedInfo : IUtf8JsonSerializable, IJsonModel<WorkloadSqlRecoveryPointExtendedInfo>, IPersistableModel<WorkloadSqlRecoveryPointExtendedInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataDirectoryInfoCapturedOn))
            {
                builder.Append("  dataDirectoryTimeInUTC:");
                builder.AppendLine($" '{DataDirectoryInfoCapturedOn.Value.ToString()}'");
            }
