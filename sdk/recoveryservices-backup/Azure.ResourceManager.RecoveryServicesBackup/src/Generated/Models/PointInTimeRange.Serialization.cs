...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PointInTimeRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PointInTimeRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PointInTimeRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PointInTimeRange>)} interface");
            }
        ...
        string IPersistableModel<PointInTimeRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
