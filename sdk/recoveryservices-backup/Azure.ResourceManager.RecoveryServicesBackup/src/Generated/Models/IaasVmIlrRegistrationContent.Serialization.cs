...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasVmIlrRegistrationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasVmIlrRegistrationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasVmIlrRegistrationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasVmIlrRegistrationContent>)} interface");
            }
        ...
        string IPersistableModel<IaasVmIlrRegistrationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
