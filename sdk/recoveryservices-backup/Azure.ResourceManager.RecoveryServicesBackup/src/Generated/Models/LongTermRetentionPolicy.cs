...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class LongTermRetentionPolicy : BackupRetentionPolicy
    {
        ...
        internal LongTermRetentionPolicy(string retentionPolicyType, DailyRetentionSchedule dailySchedule, WeeklyRetentionSchedule weeklySchedule, MonthlyRetentionSchedule monthlySchedule, YearlyRetentionSchedule yearlySchedule, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(retentionPolicyType, serializedAdditionalRawData)
        {
