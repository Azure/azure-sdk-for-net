...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MoveRPAcrossTiersContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MoveRPAcrossTiersContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MoveRPAcrossTiersContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MoveRPAcrossTiersContent>)} interface");
            }
        ...
        string IPersistableModel<MoveRPAcrossTiersContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
