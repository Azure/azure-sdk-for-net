...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DpmErrorInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DpmErrorInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DpmErrorInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DpmErrorInfo>)} interface");
            }
        ...
        string IPersistableModel<DpmErrorInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
