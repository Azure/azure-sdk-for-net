...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceGuardProxyProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceGuardProxyProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceGuardProxyProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceGuardProxyProperties>)} interface");
            }
        ...
        string IPersistableModel<ResourceGuardProxyProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
