...
{
    internal partial class UnknownBackupGenericProtectionIntent : BackupGenericProtectionIntent, IJsonModel<BackupGenericProtectionIntent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBackupGenericProtectionIntent"/> for deserialization. </summary>
        internal UnknownBackupGenericProtectionIntent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupGenericProtectionIntent DeserializeUnknownBackupGenericProtectionIntent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownBackupGenericProtectionIntent(
