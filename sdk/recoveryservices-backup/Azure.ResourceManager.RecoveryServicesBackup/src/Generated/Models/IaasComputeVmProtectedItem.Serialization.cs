...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasComputeVmProtectedItem : IaasVmProtectedItem, IJsonModel<IaasComputeVmProtectedItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<IaasComputeVmProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<IaasComputeVmProtectedItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IaasComputeVmProtectedItem IPersistableModel<IaasComputeVmProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (IaasComputeVmProtectedItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IaasComputeVmProtectedItem IJsonModel<IaasComputeVmProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (IaasComputeVmProtectedItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static IaasComputeVmProtectedItem DeserializeIaasComputeVmProtectedItem(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string protectedItemType = "Microsoft.Compute/virtualMachines";
