...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class IaasComputeVmProtectedItem : IUtf8JsonSerializable, IJsonModel<IaasComputeVmProtectedItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasComputeVmProtectedItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasComputeVmProtectedItem>)} interface");
            }
