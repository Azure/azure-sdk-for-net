...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVmErrorInfo
    {
        ...
        internal IaasVmErrorInfo(int? errorCode, string errorTitle, string errorString, IReadOnlyList<string> recommendations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
