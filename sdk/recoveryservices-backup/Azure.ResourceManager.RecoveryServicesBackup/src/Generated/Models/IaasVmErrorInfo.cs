...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVmErrorInfo
    {
        ...
        internal IaasVmErrorInfo(int? errorCode, string errorTitle, string errorString, IReadOnlyList<string> recommendations, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ErrorCode = errorCode;
