...
{
    public partial class FileshareProtectedItemExtendedInfo : IUtf8JsonSerializable, IJsonModel<FileshareProtectedItemExtendedInfo>, IPersistableModel<FileshareProtectedItemExtendedInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResourceStateSyncOn))
            {
                ...
                builder.AppendLine($" '{ResourceStateSyncOn.Value.ToString()}'");
            }
