...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public abstract partial class BackupRetentionPolicy : IJsonModel<BackupRetentionPolicy>
    {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual BackupRetentionPolicy JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<BackupRetentionPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BackupRetentionPolicy DeserializeBackupRetentionPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return UnknownBackupRetentionPolicy.DeserializeUnknownBackupRetentionPolicy(element, options);
        }
    }
}
