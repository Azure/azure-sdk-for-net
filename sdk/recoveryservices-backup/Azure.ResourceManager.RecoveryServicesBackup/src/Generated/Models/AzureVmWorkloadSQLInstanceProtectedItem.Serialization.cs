...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureVmWorkloadSQLInstanceProtectedItem : VmWorkloadProtectedItem, IJsonModel<AzureVmWorkloadSQLInstanceProtectedItem>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WritePropertyName("childDBNames"u8);
                writer.WriteStartArray();
                foreach (string item in ChildDBNames)
                {
                    if (item == null)
                    {
            ...
            if (Optional.IsDefined(InstanceProtectionReadiness))
            {
                writer.WritePropertyName("instanceProtectionReadiness"u8);
                writer.WriteStringValue(InstanceProtectionReadiness.Value.ToString());
            }
        }
        ...
        internal static AzureVmWorkloadSQLInstanceProtectedItem DeserializeAzureVmWorkloadSQLInstanceProtectedItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string protectedItemType = "AzureVmWorkloadSQLInstance";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("childDBNames"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (prop.NameEquals("instanceProtectionReadiness"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
