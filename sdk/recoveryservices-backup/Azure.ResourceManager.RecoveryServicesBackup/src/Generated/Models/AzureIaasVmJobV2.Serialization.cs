...
{
    public partial class AzureIaasVmJobV2 : IUtf8JsonSerializable
    {
        ...
        internal static AzureIaasVmJobV2 DeserializeAzureIaasVmJobV2(JsonElement element)
        {
            Optional<IList<JobSupportedAction>> actionsInfo = default;
            Optional<string> containerName = default;
            Optional<TimeSpan> duration = default;
            Optional<IList<AzureIaasVmErrorInfo>> errorDetails = default;
            Optional<string> virtualMachineVersion = default;
            Optional<AzureIaasVmJobExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("errorDetails"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(AzureIaasVmErrorInfo.DeserializeAzureIaasVmErrorInfo(item));
                    }
                    errorDetails = array;
                    continue;
                }
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = AzureIaasVmJobExtendedInfo.DeserializeAzureIaasVmJobExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new AzureIaasVmJobV2(entityFriendlyName.Value, Optional.ToNullable(backupManagementType), operation.Value, status.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), activityId.Value, jobType, Optional.ToList(actionsInfo), containerName.Value, Optional.ToNullable(duration), Optional.ToList(errorDetails), virtualMachineVersion.Value, extendedInfo.Value);
        }
    }
}
