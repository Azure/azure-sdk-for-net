...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadSapHanaRestoreWithRehydrateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadSapHanaRestoreWithRehydrateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadSapHanaRestoreWithRehydrateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadSapHanaRestoreWithRehydrateContent>)} interface");
            }
        ...
        string IPersistableModel<WorkloadSapHanaRestoreWithRehydrateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
