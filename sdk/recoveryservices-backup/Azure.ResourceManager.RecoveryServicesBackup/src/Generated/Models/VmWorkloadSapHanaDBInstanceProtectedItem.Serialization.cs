...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VmWorkloadSapHanaDBInstanceProtectedItem : VmWorkloadProtectedItem, IJsonModel<VmWorkloadSapHanaDBInstanceProtectedItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSapHanaDBInstanceProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(VmWorkloadSapHanaDBInstanceProtectedItem)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VmWorkloadSapHanaDBInstanceProtectedItem)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VmWorkloadSapHanaDBInstanceProtectedItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapHanaDBInstanceProtectedItem IPersistableModel<VmWorkloadSapHanaDBInstanceProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (VmWorkloadSapHanaDBInstanceProtectedItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapHanaDBInstanceProtectedItem IJsonModel<VmWorkloadSapHanaDBInstanceProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VmWorkloadSapHanaDBInstanceProtectedItem)JsonModelCreateCore(ref reader, options);
        ...
        protected override BackupGenericProtectedItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmWorkloadSapHanaDBInstanceProtectedItem)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VmWorkloadSapHanaDBInstanceProtectedItem DeserializeVmWorkloadSapHanaDBInstanceProtectedItem(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string protectedItemType = "AzureVmWorkloadSAPHanaDBInstance";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("parentType"u8))
                {
                    parentType = prop.Value.GetString();
                    continue;
                }
                ...
                if (prop.NameEquals("lastBackupStatus"u8))
                {
                    ...
                    lastBackupStatus = new LastBackupStatus(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("lastBackupErrorDetail"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    lastBackupErrorDetail = BackupErrorDetail.DeserializeBackupErrorDetail(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("protectedItemDataSourceId"u8))
                {
                    protectedItemDataSourceId = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("protectedItemHealthStatus"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    protectedItemHealthStatus = new VmWorkloadProtectedItemHealthStatus(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = VmWorkloadProtectedItemExtendedInfo.DeserializeVmWorkloadProtectedItemExtendedInfo(prop.Value, options);
                    continue;
                }
