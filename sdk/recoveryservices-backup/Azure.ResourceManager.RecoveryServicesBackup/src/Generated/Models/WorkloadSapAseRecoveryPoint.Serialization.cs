...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadSapAseRecoveryPoint : WorkloadRecoveryPoint, IJsonModel<WorkloadSapAseRecoveryPoint>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkloadSapAseRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WorkloadSapAseRecoveryPoint>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSapAseRecoveryPoint IPersistableModel<WorkloadSapAseRecoveryPoint>.Create(BinaryData data, ModelReaderWriterOptions options) => (WorkloadSapAseRecoveryPoint)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkloadSapAseRecoveryPoint IJsonModel<WorkloadSapAseRecoveryPoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WorkloadSapAseRecoveryPoint)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkloadSapAseRecoveryPoint DeserializeWorkloadSapAseRecoveryPoint(JsonElement element, ModelReaderWriterOptions options)
        {
