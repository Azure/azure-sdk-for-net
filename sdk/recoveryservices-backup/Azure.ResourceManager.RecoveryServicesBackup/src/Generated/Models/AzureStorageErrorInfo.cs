...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureStorageErrorInfo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AzureStorageErrorInfo"/>. </summary>
        internal AzureStorageErrorInfo()
        {
        ...
        internal AzureStorageErrorInfo(int? errorCode, string errorString, IList<string> recommendations, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ErrorCode = errorCode;
