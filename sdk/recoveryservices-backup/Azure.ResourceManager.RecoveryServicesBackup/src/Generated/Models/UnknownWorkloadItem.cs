...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    internal partial class UnknownWorkloadItem : WorkloadItem
    {
        ...
        internal UnknownWorkloadItem(string backupManagementType, string workloadType, string workloadItemType, string friendlyName, BackupProtectionStatus? protectionState, Dictionary<string, BinaryData> rawData) : base(backupManagementType, workloadType, workloadItemType, friendlyName, protectionState, rawData)
        {
