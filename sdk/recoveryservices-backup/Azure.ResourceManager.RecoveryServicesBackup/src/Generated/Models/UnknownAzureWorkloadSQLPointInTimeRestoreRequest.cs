...
{
    internal partial class UnknownAzureWorkloadSQLPointInTimeRestoreRequest : AzureWorkloadSQLPointInTimeRestoreRequest
    {
        /// <summary> Initializes a new instance of <see cref="UnknownAzureWorkloadSQLPointInTimeRestoreRequest"/>. </summary>
        ...
        internal UnknownAzureWorkloadSQLPointInTimeRestoreRequest(string objectType, IList<string> resourceGuardOperationRequests, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecoveryType? recoveryType, string sourceResourceId, IDictionary<string, string> propertyBag, TargetRestoreInfo targetInfo, RecoveryMode? recoveryMode, string targetResourceGroupName, UserAssignedManagedIdentityDetails userAssignedManagedIdentityDetails, SnapshotRestoreParameters snapshotRestoreParameters, string targetVirtualMachineId, bool? shouldUseAlternateTargetLocation, bool? isNonRecoverable, IList<SQLDataDirectoryMapping> alternateDirectoryPaths, DateTimeOffset? pointInTime) : base(objectType ?? "unknown", resourceGuardOperationRequests, additionalBinaryDataProperties, recoveryType, sourceResourceId, propertyBag, targetInfo, recoveryMode, targetResourceGroupName, userAssignedManagedIdentityDetails, snapshotRestoreParameters, targetVirtualMachineId, shouldUseAlternateTargetLocation, isNonRecoverable, alternateDirectoryPaths, pointInTime)
        {
        }
    }
}
