...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class PreValidateEnableBackupResponse
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PreValidateEnableBackupResponse"/>. </summary>
        ...
        internal PreValidateEnableBackupResponse(ValidationStatus? status, string errorCode, string errorMessage, string recommendation, string containerName, string protectedItemName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            ErrorCode = errorCode;
