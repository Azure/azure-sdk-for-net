...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class StorageBackupJobExtendedInfo
    {
        ...
        internal StorageBackupJobExtendedInfo(IList<StorageBackupJobTaskDetails> tasksList, IDictionary<string, string> propertyBag, string dynamicErrorMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TasksList = tasksList;
