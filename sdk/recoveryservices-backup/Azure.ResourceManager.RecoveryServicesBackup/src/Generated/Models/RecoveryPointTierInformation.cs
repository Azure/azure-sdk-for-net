...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class RecoveryPointTierInformation
    {
        ...
        internal RecoveryPointTierInformation(RecoveryPointTierType? tierType, RecoveryPointTierStatus? status, IDictionary<string, string> extendedInfo, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TierType = tierType;
            Status = status;
