...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVmIlrRegistrationContent : IlrContent
    {
        ...
        internal IaasVmIlrRegistrationContent(string objectType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string recoveryPointId, string virtualMachineId, string initiatorName, bool? renewExistingRegistration) : base(objectType, additionalBinaryDataProperties)
        {
