...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVmIlrRegistrationContent : IlrContent
    {
        ...
        internal IaasVmIlrRegistrationContent(string objectType, string recoveryPointId, ResourceIdentifier virtualMachineId, string initiatorName, bool? renewExistingRegistration, Dictionary<string, BinaryData> rawData) : base(objectType, rawData)
        {
