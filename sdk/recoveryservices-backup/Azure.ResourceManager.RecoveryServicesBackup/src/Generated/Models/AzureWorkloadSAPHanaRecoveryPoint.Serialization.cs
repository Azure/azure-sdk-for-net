...
{
    public partial class AzureWorkloadSAPHanaRecoveryPoint : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadSAPHanaRecoveryPoint DeserializeAzureWorkloadSAPHanaRecoveryPoint(JsonElement element)
        {
            ...
            return new AzureWorkloadSAPHanaRecoveryPoint(objectType, Optional.ToNullable(recoveryPointTimeInUTC), Optional.ToNullable(type), Optional.ToList(recoveryPointTierDetails), Optional.ToDictionary(recoveryPointMoveReadinessInfo), recoveryPointProperties.Value);
        }
    }
}
