...
{
    public partial class SqlProtectedItem : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(ProtectedItemDataId))
            {
        ...
        internal static SqlProtectedItem DeserializeSqlProtectedItem(JsonElement element)
        {
            ...
            Core.Optional<SqlProtectedItemExtendedInfo> extendedInfo = default;
