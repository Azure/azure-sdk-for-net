...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class SqlProtectedItem : BackupGenericProtectedItem, IJsonModel<SqlProtectedItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SqlProtectedItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SqlProtectedItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlProtectedItem IPersistableModel<SqlProtectedItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (SqlProtectedItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlProtectedItem IJsonModel<SqlProtectedItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SqlProtectedItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SqlProtectedItem DeserializeSqlProtectedItem(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string protectedItemType = "Microsoft.Sql/servers/databases";
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = SqlProtectedItemExtendedInfo.DeserializeSqlProtectedItemExtendedInfo(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
