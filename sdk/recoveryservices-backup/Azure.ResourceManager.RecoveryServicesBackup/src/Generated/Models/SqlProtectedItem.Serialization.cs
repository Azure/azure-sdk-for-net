...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlProtectedItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlProtectedItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlProtectedItem>)} interface");
            }
        ...
        string IPersistableModel<SqlProtectedItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
