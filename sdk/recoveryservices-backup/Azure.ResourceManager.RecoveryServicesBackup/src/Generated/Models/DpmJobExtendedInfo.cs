...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class DpmJobExtendedInfo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DpmJobExtendedInfo"/>. </summary>
        internal DpmJobExtendedInfo()
        {
        ...
        internal DpmJobExtendedInfo(IList<DpmJobTaskDetails> tasksList, IDictionary<string, string> propertyBag, string dynamicErrorMessage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TasksList = tasksList;
