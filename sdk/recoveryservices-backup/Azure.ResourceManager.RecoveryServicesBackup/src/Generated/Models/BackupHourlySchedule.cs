...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class BackupHourlySchedule
    {
        ...
        internal BackupHourlySchedule(int? interval, DateTimeOffset? scheduleWindowStartOn, int? scheduleWindowDuration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Interval = interval;
