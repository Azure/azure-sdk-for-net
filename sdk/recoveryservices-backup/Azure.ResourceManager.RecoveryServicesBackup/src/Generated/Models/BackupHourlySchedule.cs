...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class BackupHourlySchedule
    {
        ...
        internal BackupHourlySchedule(int? interval, DateTimeOffset? scheduleWindowStartOn, int? scheduleWindowDuration, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Interval = interval;
