...
{
    public partial class MabBackupJobTaskDetails : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MabBackupJobTaskDetails DeserializeMabBackupJobTaskDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
