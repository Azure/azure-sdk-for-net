...
{
    public partial class VmWorkloadSqlDatabaseProtectableItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSqlDatabaseProtectableItem>, IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSqlDatabaseProtectableItem>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<VmWorkloadSqlDatabaseProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmWorkloadSqlDatabaseProtectableItem)} does not support '{format}' format.");
            }
        ...
        VmWorkloadSqlDatabaseProtectableItem IJsonModel<VmWorkloadSqlDatabaseProtectableItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeVmWorkloadSqlDatabaseProtectableItem(document.RootElement, options);
        }

        internal static VmWorkloadSqlDatabaseProtectableItem DeserializeVmWorkloadSqlDatabaseProtectableItem(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VmWorkloadSqlDatabaseProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), serializedAdditionalRawData, parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value, Optional.ToNullable(isProtectable));
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubInquiredItemCount))
            {
                ...
                builder.AppendLine($" '{SubInquiredItemCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(SubProtectableItemCount))
            {
                builder.Append("  subprotectableitemcount:");
                builder.AppendLine($" '{SubProtectableItemCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(PreBackupValidation))
            {
                builder.Append("  prebackupvalidation:");
                AppendChildObject(builder, PreBackupValidation, options, 2);
            }
        ...
        BinaryData IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VmWorkloadSqlDatabaseProtectableItem)} does not support '{options.Format}' format.");
            }
        }

        VmWorkloadSqlDatabaseProtectableItem IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
