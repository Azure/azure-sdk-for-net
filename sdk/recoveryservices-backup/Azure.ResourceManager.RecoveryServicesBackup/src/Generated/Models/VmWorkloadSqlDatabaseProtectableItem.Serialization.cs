...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VmWorkloadSqlDatabaseProtectableItem : VmWorkloadProtectableItem, IJsonModel<VmWorkloadSqlDatabaseProtectableItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(VmWorkloadSqlDatabaseProtectableItem)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VmWorkloadSqlDatabaseProtectableItem)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSqlDatabaseProtectableItem IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (VmWorkloadSqlDatabaseProtectableItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSqlDatabaseProtectableItem IJsonModel<VmWorkloadSqlDatabaseProtectableItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VmWorkloadSqlDatabaseProtectableItem)JsonModelCreateCore(ref reader, options);
        ...
        protected override WorkloadProtectableItem JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmWorkloadSqlDatabaseProtectableItem)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VmWorkloadSqlDatabaseProtectableItem DeserializeVmWorkloadSqlDatabaseProtectableItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string protectableItemType = "SQLDataBase";
