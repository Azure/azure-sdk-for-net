...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSqlDatabaseProtectableItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSqlDatabaseProtectableItem>
    {
        ...
        void IJsonModel<VmWorkloadSqlDatabaseProtectableItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VmWorkloadSqlDatabaseProtectableItem)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VmWorkloadSqlDatabaseProtectableItem)} does not support '{options.Format}' format.");
            }
        }
