...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSqlDatabaseProtectableItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSqlDatabaseProtectableItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSqlDatabaseProtectableItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSqlDatabaseProtectableItem>)} interface");
            }
