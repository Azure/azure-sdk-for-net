...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class TriggerRestoreContent : ResourceData
    {
        ...
        internal TriggerRestoreContent(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, string location, IDictionary<string, string> tags, string eTag, RestoreContent properties) : base(new ResourceIdentifier(id), name, resourceType, systemData)
        {
