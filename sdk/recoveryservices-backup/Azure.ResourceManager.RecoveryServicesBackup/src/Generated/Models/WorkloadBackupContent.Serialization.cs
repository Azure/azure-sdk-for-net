...
{
    public partial class WorkloadBackupContent : IUtf8JsonSerializable, IJsonModel<WorkloadBackupContent>, IPersistableModel<WorkloadBackupContent>
    {
        ...
        void IJsonModel<WorkloadBackupContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkloadBackupContent)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnableCompression))
            {
                builder.Append("  enableCompression:");
                var boolValue = EnableCompression.Value == true ? "true" : "false";
