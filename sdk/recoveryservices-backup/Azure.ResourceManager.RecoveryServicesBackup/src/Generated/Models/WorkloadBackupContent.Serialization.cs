...
{
    public partial class WorkloadBackupContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WorkloadBackupContent DeserializeWorkloadBackupContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
