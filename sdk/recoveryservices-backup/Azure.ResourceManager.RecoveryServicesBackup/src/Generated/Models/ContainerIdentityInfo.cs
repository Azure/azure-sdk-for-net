...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class ContainerIdentityInfo
    {
        ...
        internal ContainerIdentityInfo(string uniqueName, string aadTenantId, string servicePrincipalClientId, string audience, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
