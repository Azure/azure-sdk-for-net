...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class ContainerIdentityInfo
    {
        ...
        internal ContainerIdentityInfo(string uniqueName, Guid? aadTenantId, string servicePrincipalClientId, string audience, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
