...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasVmBackupJobV2>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasVmBackupJobV2>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasVmBackupJobV2>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasVmBackupJobV2>)} interface");
            }
        ...
        string IPersistableModel<IaasVmBackupJobV2>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
