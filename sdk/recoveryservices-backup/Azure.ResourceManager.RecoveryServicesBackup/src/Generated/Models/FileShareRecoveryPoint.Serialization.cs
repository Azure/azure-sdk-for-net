...
{
    public partial class FileShareRecoveryPoint : IUtf8JsonSerializable, IJsonModel<FileShareRecoveryPoint>, IPersistableModel<FileShareRecoveryPoint>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FileShareSnapshotUri))
            {
                builder.Append("  fileShareSnapshotUri:");
                builder.AppendLine($" '{FileShareSnapshotUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(RecoveryPointSizeInGB))
            {
                builder.Append("  recoveryPointSizeInGB:");
                builder.AppendLine($" '{RecoveryPointSizeInGB.Value.ToString()}'");
            }
