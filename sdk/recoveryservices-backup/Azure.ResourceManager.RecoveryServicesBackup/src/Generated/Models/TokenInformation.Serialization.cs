...
{
    public partial class TokenInformation : IUtf8JsonSerializable, IJsonModel<TokenInformation>, IPersistableModel<TokenInformation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExpiryTimeInUtcTicks))
            {
                builder.Append("  expiryTimeInUtcTicks:");
                builder.AppendLine($" '{ExpiryTimeInUtcTicks.Value.ToString()}'");
            }

            if (Optional.IsDefined(SecurityPin))
            {
                builder.Append("  securityPIN:");
                builder.AppendLine($" '{SecurityPin}'");
            }
