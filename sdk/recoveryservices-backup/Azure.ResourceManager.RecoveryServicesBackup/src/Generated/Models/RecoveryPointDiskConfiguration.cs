...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class RecoveryPointDiskConfiguration
    {
        ...
        internal RecoveryPointDiskConfiguration(int? numberOfDisksIncludedInBackup, int? numberOfDisksAttachedToVm, IList<DiskInformation> includedDiskList, IList<DiskInformation> excludedDiskList, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
