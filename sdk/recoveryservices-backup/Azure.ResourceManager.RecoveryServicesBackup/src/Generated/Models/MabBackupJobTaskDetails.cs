...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class MabBackupJobTaskDetails
    {
        ...
        internal MabBackupJobTaskDetails(string taskId, DateTimeOffset? startOn, DateTimeOffset? endOn, TimeSpan? duration, string status, Dictionary<string, BinaryData> rawData)
        {
            TaskId = taskId;
            StartOn = startOn;
            EndOn = endOn;
