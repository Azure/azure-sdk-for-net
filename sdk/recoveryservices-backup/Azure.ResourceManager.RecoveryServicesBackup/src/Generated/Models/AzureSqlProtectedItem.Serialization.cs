...
{
    public partial class AzureSqlProtectedItem : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("protectedItemDataId");
        ...
        internal static AzureSqlProtectedItem DeserializeAzureSqlProtectedItem(JsonElement element)
        {
            Optional<string> protectedItemDataId = default;
            Optional<ProtectedItemState> protectionState = default;
            Optional<AzureSqlProtectedItemExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("extendedInfo"))
                {
                    ...
                    extendedInfo = AzureSqlProtectedItemExtendedInfo.DeserializeAzureSqlProtectedItemExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new AzureSqlProtectedItem(protectedItemType, Optional.ToNullable(backupManagementType), Optional.ToNullable(workloadType), containerName.Value, sourceResourceId.Value, policyId.Value, Optional.ToNullable(lastRecoveryPoint), backupSetName.Value, Optional.ToNullable(createMode), Optional.ToNullable(deferredDeleteTimeInUTC), Optional.ToNullable(isScheduledForDeferredDelete), deferredDeleteTimeRemaining.Value, Optional.ToNullable(isDeferredDeleteScheduleUpcoming), Optional.ToNullable(isRehydrate), Optional.ToList(resourceGuardOperationRequests), Optional.ToNullable(isArchiveEnabled), policyName.Value, Optional.ToNullable(softDeleteRetentionPeriod), protectedItemDataId.Value, Optional.ToNullable(protectionState), extendedInfo.Value);
        }
    }
}
