...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VaultBackupJobErrorInfo
    {
        ...
        internal VaultBackupJobErrorInfo(int? errorCode, string errorString, IList<string> recommendations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ErrorCode = errorCode;
