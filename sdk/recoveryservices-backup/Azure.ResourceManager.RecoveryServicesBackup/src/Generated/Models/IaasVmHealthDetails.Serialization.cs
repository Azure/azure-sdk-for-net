...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasVmHealthDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasVmHealthDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasVmHealthDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IaasVmHealthDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
