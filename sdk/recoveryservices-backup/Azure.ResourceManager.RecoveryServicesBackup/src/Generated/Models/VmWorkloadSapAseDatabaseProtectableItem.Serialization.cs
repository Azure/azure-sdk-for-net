...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VmWorkloadSapAseDatabaseProtectableItem : VmWorkloadProtectableItem, IJsonModel<VmWorkloadSapAseDatabaseProtectableItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSapAseDatabaseProtectableItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VmWorkloadSapAseDatabaseProtectableItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapAseDatabaseProtectableItem IPersistableModel<VmWorkloadSapAseDatabaseProtectableItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (VmWorkloadSapAseDatabaseProtectableItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapAseDatabaseProtectableItem IJsonModel<VmWorkloadSapAseDatabaseProtectableItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VmWorkloadSapAseDatabaseProtectableItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VmWorkloadSapAseDatabaseProtectableItem DeserializeVmWorkloadSapAseDatabaseProtectableItem(JsonElement element, ModelReaderWriterOptions options)
        {
