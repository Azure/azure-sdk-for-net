...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DpmProtectedItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DpmProtectedItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DpmProtectedItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DpmProtectedItem>)} interface");
            }
        ...
        string IPersistableModel<DpmProtectedItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
