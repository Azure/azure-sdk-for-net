...
{
    public partial class AzureVmWorkloadProtectionPolicy : IUtf8JsonSerializable
    {
        ...
        internal static AzureVmWorkloadProtectionPolicy DeserializeAzureVmWorkloadProtectionPolicy(JsonElement element)
        {
            ...
            return new AzureVmWorkloadProtectionPolicy(Optional.ToNullable(protectedItemsCount), backupManagementType, Optional.ToList(resourceGuardOperationRequests), Optional.ToNullable(workLoadType), settings.Value, Optional.ToList(subProtectionPolicy), Optional.ToNullable(makePolicyConsistent));
        }
    }
}
