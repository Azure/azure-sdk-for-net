...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestoreFileSpecs>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestoreFileSpecs>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestoreFileSpecs>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RestoreFileSpecs>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
