...
{
    public partial class RestoreFileSpecs : IUtf8JsonSerializable, IJsonModel<RestoreFileSpecs>, IPersistableModel<RestoreFileSpecs>
    {
        ...
        void IJsonModel<RestoreFileSpecs>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RestoreFileSpecs)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FileSpecType))
            {
                builder.Append("  fileSpecType:");
                builder.AppendLine($" '{FileSpecType}'");
            }

            if (Optional.IsDefined(TargetFolderPath))
            {
                builder.Append("  targetFolderPath:");
                builder.AppendLine($" '{TargetFolderPath}'");
            }
