...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// </summary>
    public partial class KeyAndSecretDetails : IJsonModel<KeyAndSecretDetails>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual KeyAndSecretDetails PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<KeyAndSecretDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KeyAndSecretDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyAndSecretDetails IPersistableModel<KeyAndSecretDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyAndSecretDetails IJsonModel<KeyAndSecretDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual KeyAndSecretDetails JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<KeyAndSecretDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KeyAndSecretDetails DeserializeKeyAndSecretDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("kekDetails"u8))
                {
                ...
                {
                    encryptionMechanism = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new KeyAndSecretDetails(kekDetails, bekDetails, encryptionMechanism, additionalBinaryDataProperties);
        }
    }
}
