    ...
    public partial class KeyAndSecretDetails : IUtf8JsonSerializable, IJsonModel<KeyAndSecretDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KekDetails))
            {
                ...
                AppendChildObject(builder, KekDetails, options, 2, false);
            }

            if (Optional.IsDefined(BekDetails))
            {
                builder.Append("  bekDetails:");
                AppendChildObject(builder, BekDetails, options, 2, false);
            }

            if (Optional.IsDefined(EncryptionMechanism))
            {
                builder.Append("  encryptionMechanism:");
                if (EncryptionMechanism.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
