...
{
    public partial class KeyAndSecretDetails : IUtf8JsonSerializable, IJsonModel<KeyAndSecretDetails>, IPersistableModel<KeyAndSecretDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KekDetails))
            {
                builder.Append("  kekDetails:");
                AppendChildObject(builder, KekDetails, options, 2);
            }

            if (Optional.IsDefined(BekDetails))
            {
                builder.Append("  bekDetails:");
                AppendChildObject(builder, BekDetails, options, 2);
            }

            if (Optional.IsDefined(EncryptionMechanism))
            {
                builder.Append("  encryptionMechanism:");
                builder.AppendLine($" '{EncryptionMechanism}'");
            }
