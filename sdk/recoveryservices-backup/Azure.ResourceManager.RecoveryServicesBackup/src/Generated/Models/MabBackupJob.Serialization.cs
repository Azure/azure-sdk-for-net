...
{
    public partial class MabBackupJob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MabBackupJob DeserializeMabBackupJob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
