...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MabBackupJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MabBackupJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MabBackupJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MabBackupJob>)} interface");
            }
        ...
        string IPersistableModel<MabBackupJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
