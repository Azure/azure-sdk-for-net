...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class MabBackupJob : IUtf8JsonSerializable, IModelJsonSerializable<MabBackupJob>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MabBackupJob>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(ErrorDetails))
            {
                ...
                foreach (var item in ErrorDetails)
                {
                    ...
                    {
                        ((IModelJsonSerializable<MabErrorInfo>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
            if (Optional.IsDefined(ExtendedInfo))
            {
                ...
                {
                    ((IModelJsonSerializable<MabBackupJobExtendedInfo>)ExtendedInfo).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="MabBackupJob"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MabBackupJob"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MabBackupJob"/>. </summary>
