...
{
    public partial class BackupGenericJob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupGenericJob DeserializeBackupGenericJob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
