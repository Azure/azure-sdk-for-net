...
{
    public partial class AzureVmAppContainerProtectableContainer : IUtf8JsonSerializable
    {
        ...
        internal static AzureVmAppContainerProtectableContainer DeserializeAzureVmAppContainerProtectableContainer(JsonElement element)
        {
            ...
            return new AzureVmAppContainerProtectableContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), protectableContainerType, healthStatus.Value, containerId.Value);
        }
    }
}
