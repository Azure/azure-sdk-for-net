...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class MabBackupJobExtendedInfo
    {
        ...
        internal MabBackupJobExtendedInfo(IList<MabBackupJobTaskDetails> tasksList, IDictionary<string, string> propertyBag, string dynamicErrorMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TasksList = tasksList;
