...
{
    internal partial class SecuredVmDetails : IUtf8JsonSerializable, IJsonModel<SecuredVmDetails>, IPersistableModel<SecuredVmDetails>
    {
        ...
        void IJsonModel<SecuredVmDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecuredVmDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecuredVmOSDiskEncryptionSetId))
            {
                builder.Append("  securedVMOsDiskEncryptionSetId:");
                builder.AppendLine($" '{SecuredVmOSDiskEncryptionSetId.ToString()}'");
            }
