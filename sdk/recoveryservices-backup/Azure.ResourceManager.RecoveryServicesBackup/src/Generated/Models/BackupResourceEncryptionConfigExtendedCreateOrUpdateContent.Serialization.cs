...
{
    public partial class BackupResourceEncryptionConfigExtendedCreateOrUpdateContent : IUtf8JsonSerializable, IJsonModel<BackupResourceEncryptionConfigExtendedCreateOrUpdateContent>, IPersistableModel<BackupResourceEncryptionConfigExtendedCreateOrUpdateContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupResourceEncryptionConfigExtendedCreateOrUpdateContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BackupResourceEncryptionConfigExtendedCreateOrUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BackupResourceEncryptionConfigExtendedCreateOrUpdateContent)} does not support '{format}' format.");
            }
