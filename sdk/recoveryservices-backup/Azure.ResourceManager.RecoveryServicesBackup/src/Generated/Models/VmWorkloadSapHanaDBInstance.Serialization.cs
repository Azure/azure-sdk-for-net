...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmWorkloadSapHanaDBInstance>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmWorkloadSapHanaDBInstance>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSapHanaDBInstance>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSapHanaDBInstance>)} interface");
            }
        ...
        string IPersistableModel<VmWorkloadSapHanaDBInstance>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
