...
{
    public partial class RecoveryPointDiskConfiguration : IUtf8JsonSerializable, IJsonModel<RecoveryPointDiskConfiguration>, IPersistableModel<RecoveryPointDiskConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NumberOfDisksIncludedInBackup))
            {
                builder.Append("  numberOfDisksIncludedInBackup:");
                builder.AppendLine($" '{NumberOfDisksIncludedInBackup.Value.ToString()}'");
            }

            if (Optional.IsDefined(NumberOfDisksAttachedToVm))
            {
                builder.Append("  numberOfDisksAttachedToVm:");
                builder.AppendLine($" '{NumberOfDisksAttachedToVm.Value.ToString()}'");
            }

            if (Optional.IsCollectionDefined(IncludedDiskList))
            {
                builder.Append("  includedDiskList:");
                builder.AppendLine(" [");
                foreach (var item in IncludedDiskList)
                {
            ...
            if (Optional.IsCollectionDefined(ExcludedDiskList))
            {
                builder.Append("  excludedDiskList:");
                builder.AppendLine(" [");
                foreach (var item in ExcludedDiskList)
                {
                    AppendChildObject(builder, item, options, 4);
