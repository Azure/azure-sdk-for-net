...
{
    public partial class RecoveryPointDiskConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RecoveryPointDiskConfiguration DeserializeRecoveryPointDiskConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
