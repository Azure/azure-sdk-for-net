...
{
    internal partial class UnknownTieringCostInfo : TieringCostInfo, IJsonModel<TieringCostInfo>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownTieringCostInfo DeserializeUnknownTieringCostInfo(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownTieringCostInfo(objectType, additionalBinaryDataProperties);
        }
    }
}
