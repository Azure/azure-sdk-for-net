...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AzureIaaSVMJob"/>. </summary>
        internal AzureIaaSVMJob() : base("AzureIaaSVMJob")
        {
        ...
        internal AzureIaaSVMJob(string entityFriendlyName, BackupManagementType? backupManagementType, string operation, string status, DateTimeOffset? startOn, DateTimeOffset? endOn, string activityId, string jobType, IDictionary<string, BinaryData> additionalBinaryDataProperties, TimeSpan? duration, IList<JobSupportedAction> actionsInfo, IList<AzureIaaSVMErrorInfo> errorDetails, string virtualMachineVersion, AzureIaaSVMJobExtendedInfo extendedInfo, string containerName, bool? isUserTriggered) : base(entityFriendlyName, backupManagementType, operation, status, startOn, endOn, activityId, jobType, additionalBinaryDataProperties)
        {
            Duration = duration;
