...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileShareProvisionIlrContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileShareProvisionIlrContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileShareProvisionIlrContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FileShareProvisionIlrContent>)} interface");
            }
        ...
        string IPersistableModel<FileShareProvisionIlrContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
