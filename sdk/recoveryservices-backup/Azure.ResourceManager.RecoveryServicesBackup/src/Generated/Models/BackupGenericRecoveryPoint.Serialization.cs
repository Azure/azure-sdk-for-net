...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupGenericRecoveryPoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupGenericRecoveryPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupGenericRecoveryPoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BackupGenericRecoveryPoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
