...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class BackupGenericRecoveryPoint : RecoveryPoint, IJsonModel<BackupGenericRecoveryPoint>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BackupGenericRecoveryPoint IPersistableModel<BackupGenericRecoveryPoint>.Create(BinaryData data, ModelReaderWriterOptions options) => (BackupGenericRecoveryPoint)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BackupGenericRecoveryPoint IJsonModel<BackupGenericRecoveryPoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (BackupGenericRecoveryPoint)JsonModelCreateCore(ref reader, options);
        ...
        internal static BackupGenericRecoveryPoint DeserializeBackupGenericRecoveryPoint(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new BackupGenericRecoveryPoint(
                objectType,
                threatStatus,
