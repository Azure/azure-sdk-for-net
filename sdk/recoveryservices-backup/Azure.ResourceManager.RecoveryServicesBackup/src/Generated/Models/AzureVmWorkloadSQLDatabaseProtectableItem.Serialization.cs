...
{
    public partial class AzureVmWorkloadSQLDatabaseProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static AzureVmWorkloadSQLDatabaseProtectableItem DeserializeAzureVmWorkloadSQLDatabaseProtectableItem(JsonElement element)
        {
            ...
            return new AzureVmWorkloadSQLDatabaseProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value);
        }
    }
}
