...
{
    public partial class BackupTargetDiskNetworkAccessSettings : IUtf8JsonSerializable, IJsonModel<BackupTargetDiskNetworkAccessSettings>, IPersistableModel<BackupTargetDiskNetworkAccessSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TargetDiskNetworkAccessOption))
            {
                builder.Append("  targetDiskNetworkAccessOption:");
                builder.AppendLine($" '{TargetDiskNetworkAccessOption.ToString()}'");
            }

            if (Optional.IsDefined(TargetDiskAccessId))
            {
                builder.Append("  targetDiskAccessId:");
                builder.AppendLine($" '{TargetDiskAccessId.ToString()}'");
            }
