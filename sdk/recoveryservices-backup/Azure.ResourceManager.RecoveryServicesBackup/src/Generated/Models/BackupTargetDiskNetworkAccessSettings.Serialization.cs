...
{
    public partial class BackupTargetDiskNetworkAccessSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupTargetDiskNetworkAccessSettings DeserializeBackupTargetDiskNetworkAccessSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
