...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VaultBackupJobErrorInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VaultBackupJobErrorInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VaultBackupJobErrorInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VaultBackupJobErrorInfo>)} interface");
            }
        ...
        string IPersistableModel<VaultBackupJobErrorInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
