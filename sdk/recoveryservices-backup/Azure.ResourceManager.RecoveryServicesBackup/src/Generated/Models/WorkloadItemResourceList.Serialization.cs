...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadItemResourceList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadItemResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadItemResourceList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadItemResourceList>)} interface");
            }
        ...
        string IPersistableModel<WorkloadItemResourceList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
