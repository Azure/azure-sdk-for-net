...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadItemResourceList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkloadItemResourceList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkloadItemResourceList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<WorkloadItemResource> collection && collection.IsUndefined))
            {
        ...
        internal static WorkloadItemResourceList DeserializeWorkloadItemResourceList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WorkloadItemResourceList(value ?? new ChangeTrackingList<WorkloadItemResource>(), nextLink.Value, serializedAdditionalRawData);
        }
