...
{
    public partial class AzureIaasVmErrorInfo : IUtf8JsonSerializable
    {
        ...
        internal static AzureIaasVmErrorInfo DeserializeAzureIaasVmErrorInfo(JsonElement element)
        {
            ...
            return new AzureIaasVmErrorInfo(Optional.ToNullable(errorCode), errorTitle.Value, errorString.Value, Optional.ToList(recommendations));
        }
    }
}
