...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadProtectionPolicy : IUtf8JsonSerializable, IModelJsonSerializable<VmWorkloadProtectionPolicy>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VmWorkloadProtectionPolicy>(this, options.Format);
            ...
            if (Optional.IsDefined(Settings))
            {
                ...
                {
                    ((IModelJsonSerializable<BackupCommonSettings>)Settings).Serialize(writer, options);
                }
            }
        ...
        internal static VmWorkloadProtectionPolicy DeserializeVmWorkloadProtectionPolicy(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VmWorkloadProtectionPolicy(Optional.ToNullable(protectedItemsCount), backupManagementType, Optional.ToList(resourceGuardOperationRequests), Optional.ToNullable(workLoadType), settings.Value, Optional.ToList(subProtectionPolicy), Optional.ToNullable(makePolicyConsistent), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="VmWorkloadProtectionPolicy"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VmWorkloadProtectionPolicy"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VmWorkloadProtectionPolicy"/>. </summary>
