...
{
    public partial class VmWorkloadProtectionPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VmWorkloadProtectionPolicy DeserializeVmWorkloadProtectionPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
