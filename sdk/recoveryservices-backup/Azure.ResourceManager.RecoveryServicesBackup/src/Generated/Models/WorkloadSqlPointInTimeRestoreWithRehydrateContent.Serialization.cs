...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class WorkloadSqlPointInTimeRestoreWithRehydrateContent : IUtf8JsonSerializable, IJsonModel<WorkloadSqlPointInTimeRestoreWithRehydrateContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadSqlPointInTimeRestoreWithRehydrateContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadSqlPointInTimeRestoreWithRehydrateContent>)} interface");
            }
