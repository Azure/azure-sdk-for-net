...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadSqlPointInTimeRestoreWithRehydrateContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        WorkloadSqlPointInTimeRestoreWithRehydrateContent IJsonModel<WorkloadSqlPointInTimeRestoreWithRehydrateContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<WorkloadSqlPointInTimeRestoreWithRehydrateContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        WorkloadSqlPointInTimeRestoreWithRehydrateContent IModel<WorkloadSqlPointInTimeRestoreWithRehydrateContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<WorkloadSqlPointInTimeRestoreWithRehydrateContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
