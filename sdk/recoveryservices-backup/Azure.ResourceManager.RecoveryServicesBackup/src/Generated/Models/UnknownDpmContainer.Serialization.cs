...
{
    internal partial class UnknownDpmContainer : DpmContainer, IJsonModel<DpmContainer>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDpmContainer"/> for deserialization. </summary>
        internal UnknownDpmContainer()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDpmContainer DeserializeUnknownDpmContainer(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDpmContainer(
                friendlyName,
