...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public abstract partial class ProtectionPolicy
    {
        ...
        private protected ProtectionPolicy(string backupManagementType)
        {
        ...
        internal ProtectionPolicy(int? protectedItemsCount, string backupManagementType, IList<string> resourceGuardOperationRequests, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
