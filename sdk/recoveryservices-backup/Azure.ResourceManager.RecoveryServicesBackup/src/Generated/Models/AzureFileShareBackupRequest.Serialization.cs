...
{
    public partial class AzureFileShareBackupRequest : IUtf8JsonSerializable
    {
        ...
        internal static AzureFileShareBackupRequest DeserializeAzureFileShareBackupRequest(JsonElement element)
        {
            ...
            return new AzureFileShareBackupRequest(objectType, Optional.ToNullable(recoveryPointExpiryTimeInUTC));
        }
    }
}
