...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnlockDeleteContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UnlockDeleteContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnlockDeleteContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UnlockDeleteContent>)} interface");
            }
        ...
        string IPersistableModel<UnlockDeleteContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
