...
{
    public partial class AzureStorageProtectableContainer : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageProtectableContainer DeserializeAzureStorageProtectableContainer(JsonElement element)
        {
            ...
            return new AzureStorageProtectableContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), protectableContainerType, healthStatus.Value, containerId.Value);
        }
    }
}
