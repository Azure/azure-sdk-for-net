            ...
            if (element.TryGetProperty("protectableContainerType"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "StorageContainer":
                        return AzureStorageProtectableContainer.DeserializeAzureStorageProtectableContainer(element, options);
                    case "VMAppContainer":
                        return AzureVMAppContainerProtectableContainer.DeserializeAzureVMAppContainerProtectableContainer(element, options);
                }
            }
