...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupWeeklySchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupWeeklySchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupWeeklySchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupWeeklySchedule>)} interface");
            }
        ...
        string IPersistableModel<BackupWeeklySchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
