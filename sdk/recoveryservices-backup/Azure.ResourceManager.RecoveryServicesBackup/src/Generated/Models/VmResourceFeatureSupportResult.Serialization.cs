...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmResourceFeatureSupportResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmResourceFeatureSupportResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmResourceFeatureSupportResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmResourceFeatureSupportResult>)} interface");
            }
        ...
        string IPersistableModel<VmResourceFeatureSupportResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
