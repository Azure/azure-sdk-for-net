...
{
    public partial class BackupHourlySchedule : IUtf8JsonSerializable, IJsonModel<BackupHourlySchedule>, IPersistableModel<BackupHourlySchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScheduleWindowStartOn))
            {
                ...
                builder.AppendLine($" '{ScheduleWindowStartOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(ScheduleWindowDuration))
            {
                builder.Append("  scheduleWindowDuration:");
                builder.AppendLine($" '{ScheduleWindowDuration.Value.ToString()}'");
            }
