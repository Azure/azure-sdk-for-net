...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadPointInTimeRecoveryPoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadPointInTimeRecoveryPoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadPointInTimeRecoveryPoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadPointInTimeRecoveryPoint>)} interface");
            }
        ...
        string IPersistableModel<WorkloadPointInTimeRecoveryPoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
