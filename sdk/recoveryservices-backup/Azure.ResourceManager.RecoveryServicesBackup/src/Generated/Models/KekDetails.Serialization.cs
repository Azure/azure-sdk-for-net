...
{
    public partial class KekDetails : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KekDetails DeserializeKekDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
