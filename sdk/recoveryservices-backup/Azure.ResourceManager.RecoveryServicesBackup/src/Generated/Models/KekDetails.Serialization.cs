...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KekDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KekDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KekDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KekDetails>)} interface");
            }
        ...
        string IPersistableModel<KekDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
