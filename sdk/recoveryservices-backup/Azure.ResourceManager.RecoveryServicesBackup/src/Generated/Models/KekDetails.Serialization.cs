...
{
    public partial class KekDetails : IUtf8JsonSerializable, IJsonModel<KekDetails>, IPersistableModel<KekDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KeyBackupData))
            {
                builder.Append("  keyBackupData:");
                builder.AppendLine($" '{KeyBackupData}'");
            }
