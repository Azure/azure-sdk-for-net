...
{
    public partial class BackupContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupContent DeserializeBackupContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
