...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class MabContainerExtendedInfo
    {
        ...
        internal MabContainerExtendedInfo(DateTimeOffset? lastRefreshedOn, BackupItemType? backupItemType, IList<string> backupItems, string policyName, string lastBackupStatus, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
