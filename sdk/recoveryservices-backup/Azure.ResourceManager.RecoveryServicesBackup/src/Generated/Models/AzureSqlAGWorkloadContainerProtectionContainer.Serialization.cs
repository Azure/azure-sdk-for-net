...
{
    public partial class AzureSqlAGWorkloadContainerProtectionContainer : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlAGWorkloadContainerProtectionContainer DeserializeAzureSqlAGWorkloadContainerProtectionContainer(JsonElement element)
        {
            ...
            return new AzureSqlAGWorkloadContainerProtectionContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, sourceResourceId.Value, Optional.ToNullable(lastUpdatedTime), extendedInfo.Value, Optional.ToNullable(workloadType), Optional.ToNullable(operationType));
        }
    }
}
