...
{
    public partial class ResourceGuardOperationDetail : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceGuardOperationDetail DeserializeResourceGuardOperationDetail(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
