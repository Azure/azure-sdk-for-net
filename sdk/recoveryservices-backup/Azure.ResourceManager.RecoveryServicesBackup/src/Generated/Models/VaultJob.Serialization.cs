...
{
    public partial class VaultJob : IUtf8JsonSerializable
    {
        ...
        internal static VaultJob DeserializeVaultJob(JsonElement element)
        {
            Optional<TimeSpan> duration = default;
            Optional<IList<JobSupportedAction>> actionsInfo = default;
            Optional<IList<VaultJobErrorInfo>> errorDetails = default;
            Optional<VaultJobExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("errorDetails"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(VaultJobErrorInfo.DeserializeVaultJobErrorInfo(item));
                    }
                    errorDetails = array;
                    continue;
                }
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = VaultJobExtendedInfo.DeserializeVaultJobExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new VaultJob(entityFriendlyName.Value, Optional.ToNullable(backupManagementType), operation.Value, status.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), activityId.Value, jobType, Optional.ToNullable(duration), Optional.ToList(actionsInfo), Optional.ToList(errorDetails), extendedInfo.Value);
        }
    }
}
