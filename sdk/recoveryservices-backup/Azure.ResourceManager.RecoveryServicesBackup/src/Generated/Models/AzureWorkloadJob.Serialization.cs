...
{
    public partial class AzureWorkloadJob : IUtf8JsonSerializable
    {
        ...
        internal static AzureWorkloadJob DeserializeAzureWorkloadJob(JsonElement element)
        {
            Optional<string> workloadType = default;
            Optional<TimeSpan> duration = default;
            Optional<IList<JobSupportedAction>> actionsInfo = default;
            Optional<IList<AzureWorkloadErrorInfo>> errorDetails = default;
            Optional<AzureWorkloadJobExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("errorDetails"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(AzureWorkloadErrorInfo.DeserializeAzureWorkloadErrorInfo(item));
                    }
                    errorDetails = array;
                    continue;
                }
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = AzureWorkloadJobExtendedInfo.DeserializeAzureWorkloadJobExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new AzureWorkloadJob(entityFriendlyName.Value, Optional.ToNullable(backupManagementType), operation.Value, status.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), activityId.Value, jobType, workloadType.Value, Optional.ToNullable(duration), Optional.ToList(actionsInfo), Optional.ToList(errorDetails), extendedInfo.Value);
        }
    }
}
