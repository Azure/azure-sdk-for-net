...
{
    public partial class AzureStorageJob : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageJob DeserializeAzureStorageJob(JsonElement element)
        {
            Optional<TimeSpan> duration = default;
            Optional<IList<JobSupportedAction>> actionsInfo = default;
            Optional<IList<AzureStorageErrorInfo>> errorDetails = default;
            Optional<string> storageAccountName = default;
            Optional<string> storageAccountVersion = default;
            Optional<AzureStorageJobExtendedInfo> extendedInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("errorDetails"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(AzureStorageErrorInfo.DeserializeAzureStorageErrorInfo(item));
                    }
                    errorDetails = array;
                    continue;
                }
                ...
                if (property.NameEquals("extendedInfo"u8))
                {
                    ...
                    extendedInfo = AzureStorageJobExtendedInfo.DeserializeAzureStorageJobExtendedInfo(property.Value);
                    continue;
                }
            ...
            return new AzureStorageJob(entityFriendlyName.Value, Optional.ToNullable(backupManagementType), operation.Value, status.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), activityId.Value, jobType, Optional.ToNullable(duration), Optional.ToList(actionsInfo), Optional.ToList(errorDetails), storageAccountName.Value, storageAccountVersion.Value, extendedInfo.Value, Optional.ToNullable(isUserTriggered));
        }
    }
}
