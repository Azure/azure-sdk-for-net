...
{
    public partial class SubProtectionPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SubProtectionPolicy DeserializeSubProtectionPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
