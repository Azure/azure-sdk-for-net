...
{
    public partial class SubProtectionPolicy : IUtf8JsonSerializable, IJsonModel<SubProtectionPolicy>, IPersistableModel<SubProtectionPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SnapshotBackupAdditionalDetails))
            {
                builder.Append("  snapshotBackupAdditionalDetails:");
                AppendChildObject(builder, SnapshotBackupAdditionalDetails, options, 2);
            }
