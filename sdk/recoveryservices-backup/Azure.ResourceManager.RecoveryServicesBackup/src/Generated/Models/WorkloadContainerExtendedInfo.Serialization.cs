...
{
    public partial class WorkloadContainerExtendedInfo : IUtf8JsonSerializable, IJsonModel<WorkloadContainerExtendedInfo>, IPersistableModel<WorkloadContainerExtendedInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InquiryInfo))
            {
                ...
                AppendChildObject(builder, InquiryInfo, options, 2);
            }
