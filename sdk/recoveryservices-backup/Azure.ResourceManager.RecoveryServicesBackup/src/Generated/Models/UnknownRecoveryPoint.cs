...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    internal partial class UnknownRecoveryPoint : BackupGenericRecoveryPoint
    {
        ...
        internal UnknownRecoveryPoint(string objectType, BackupThreatStatus? threatStatus, IList<BackupThreatInfo> threatInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(objectType ?? "unknown", threatStatus, threatInfo, additionalBinaryDataProperties)
        {
        }
    }
}
