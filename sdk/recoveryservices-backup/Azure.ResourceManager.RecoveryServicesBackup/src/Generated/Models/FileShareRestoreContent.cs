...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class FileShareRestoreContent : RestoreContent
    {
        ...
        internal FileShareRestoreContent(string objectType, FileShareRecoveryType? recoveryType, ResourceIdentifier sourceResourceId, FileShareCopyOption? copyOptions, FileShareRestoreType? restoreRequestType, IList<RestoreFileSpecs> restoreFileSpecs, TargetAfsRestoreInfo targetDetails, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(objectType, serializedAdditionalRawData)
        {
