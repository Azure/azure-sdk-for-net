...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// Please note <see cref="WorkloadSqlPointInTimeRestoreRequest"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="WorkloadSqlPointInTimeRestoreWithRehydrateRequest"/>.
    /// </summary>
    public partial class WorkloadSqlPointInTimeRestoreRequest : WorkloadSqlRestoreRequest
    {
        /// <summary> Initializes a new instance of WorkloadSqlPointInTimeRestoreRequest. </summary>
