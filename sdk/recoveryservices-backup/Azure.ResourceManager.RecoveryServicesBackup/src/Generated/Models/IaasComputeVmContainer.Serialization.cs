...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasComputeVmContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasComputeVmContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasComputeVmContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasComputeVmContainer>)} interface");
            }
        ...
        string IPersistableModel<IaasComputeVmContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
