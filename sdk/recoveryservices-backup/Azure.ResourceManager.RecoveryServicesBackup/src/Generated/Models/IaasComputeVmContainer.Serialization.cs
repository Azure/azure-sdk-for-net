...
{
    public partial class IaasComputeVmContainer : Core.IUtf8JsonSerializable
    {
        ...
        internal static IaasComputeVmContainer DeserializeIaasComputeVmContainer(JsonElement element)
        {
            ...
            return new IaasComputeVmContainer(friendlyName.Value, Core.Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, virtualMachineId.Value, virtualMachineVersion.Value, resourceGroup.Value);
        }
    }
}
