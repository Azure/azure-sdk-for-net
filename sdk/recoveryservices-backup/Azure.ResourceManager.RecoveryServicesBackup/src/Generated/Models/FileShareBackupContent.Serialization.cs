...
{
    public partial class FileShareBackupContent : IUtf8JsonSerializable, IJsonModel<FileShareBackupContent>, IPersistableModel<FileShareBackupContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RecoveryPointExpireOn))
            {
                builder.Append("  recoveryPointExpiryTimeInUTC:");
                builder.AppendLine($" '{RecoveryPointExpireOn.Value.ToString()}'");
            }
