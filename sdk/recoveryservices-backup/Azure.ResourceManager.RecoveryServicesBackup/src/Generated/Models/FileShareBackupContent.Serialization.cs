...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FileShareBackupContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FileShareBackupContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FileShareBackupContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<FileShareBackupContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
