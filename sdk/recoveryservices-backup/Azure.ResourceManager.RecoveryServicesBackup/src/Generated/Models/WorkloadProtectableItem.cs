...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownWorkloadProtectableItem))]
    public abstract partial class WorkloadProtectableItem
    {
        ...
        internal WorkloadProtectableItem(string backupManagementType, string workloadType, string protectableItemType, string friendlyName, BackupProtectionStatus? protectionState, Dictionary<string, BinaryData> rawData)
        {
