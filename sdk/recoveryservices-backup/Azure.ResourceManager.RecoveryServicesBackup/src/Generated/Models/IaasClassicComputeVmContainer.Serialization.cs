...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IaasClassicComputeVmContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IaasClassicComputeVmContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IaasClassicComputeVmContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IaasClassicComputeVmContainer>)} interface");
            }
        ...
        string IPersistableModel<IaasClassicComputeVmContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
