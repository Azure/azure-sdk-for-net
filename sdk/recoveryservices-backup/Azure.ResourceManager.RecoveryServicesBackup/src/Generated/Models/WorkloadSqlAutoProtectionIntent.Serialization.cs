...
{
    public partial class WorkloadSqlAutoProtectionIntent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WorkloadSqlAutoProtectionIntent DeserializeWorkloadSqlAutoProtectionIntent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
