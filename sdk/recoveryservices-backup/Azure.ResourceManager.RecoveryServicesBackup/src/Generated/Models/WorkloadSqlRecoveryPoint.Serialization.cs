...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class WorkloadSqlRecoveryPoint : IUtf8JsonSerializable, IModelJsonSerializable<WorkloadSqlRecoveryPoint>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkloadSqlRecoveryPoint>(this, options.Format);
        ...
        internal static WorkloadSqlRecoveryPoint DeserializeWorkloadSqlRecoveryPoint(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new WorkloadSqlRecoveryPoint(objectType, Optional.ToNullable(recoveryPointTimeInUTC), Optional.ToNullable(type), Optional.ToList(recoveryPointTierDetails), Optional.ToDictionary(recoveryPointMoveReadinessInfo), recoveryPointProperties.Value, extendedInfo.Value, serializedAdditionalRawData);
        }
