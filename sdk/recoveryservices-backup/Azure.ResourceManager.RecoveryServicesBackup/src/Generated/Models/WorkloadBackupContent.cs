...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadBackupContent : BackupContent
    {
        ...
        internal WorkloadBackupContent(string objectType, BackupType? backupType, bool? enableCompression, DateTimeOffset? recoveryPointExpireOn, Dictionary<string, BinaryData> rawData) : base(objectType, rawData)
        {
