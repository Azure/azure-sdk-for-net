...
{
    public partial class AzureIaaSClassicComputeVmContainer : IUtf8JsonSerializable
    {
        ...
        internal static AzureIaaSClassicComputeVmContainer DeserializeAzureIaaSClassicComputeVmContainer(JsonElement element)
        {
            ...
            return new AzureIaaSClassicComputeVmContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), registrationStatus.Value, healthStatus.Value, containerType, protectableObjectType.Value, virtualMachineId.Value, virtualMachineVersion.Value, resourceGroup.Value);
        }
    }
}
