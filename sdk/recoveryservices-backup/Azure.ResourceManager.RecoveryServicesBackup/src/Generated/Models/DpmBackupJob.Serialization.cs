...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DpmBackupJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DpmBackupJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DpmBackupJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DpmBackupJob>)} interface");
            }
        ...
        string IPersistableModel<DpmBackupJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
