...
{
    public partial class DpmBackupJob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DpmBackupJob DeserializeDpmBackupJob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
