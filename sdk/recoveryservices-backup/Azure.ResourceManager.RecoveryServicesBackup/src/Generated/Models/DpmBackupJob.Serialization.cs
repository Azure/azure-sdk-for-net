...
{
    public partial class DpmBackupJob : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(DpmServerName))
            {
        ...
        internal static DpmBackupJob DeserializeDpmBackupJob(JsonElement element)
        {
            ...
            Core.Optional<string> dpmServerName = default;
            Core.Optional<string> containerName = default;
            Core.Optional<string> containerType = default;
            Core.Optional<string> workloadType = default;
            Core.Optional<IList<JobSupportedAction>> actionsInfo = default;
            Core.Optional<IList<DpmErrorInfo>> errorDetails = default;
            Core.Optional<DpmBackupJobExtendedInfo> extendedInfo = default;
            ...
            return new DpmBackupJob(entityFriendlyName.Value, Core.Optional.ToNullable(backupManagementType), operation.Value, status.Value, Core.Optional.ToNullable(startTime), Core.Optional.ToNullable(endTime), activityId.Value, jobType, Core.Optional.ToNullable(duration), dpmServerName.Value, containerName.Value, containerType.Value, workloadType.Value, Core.Optional.ToList(actionsInfo), Core.Optional.ToList(errorDetails), extendedInfo.Value);
        }
    }
}
