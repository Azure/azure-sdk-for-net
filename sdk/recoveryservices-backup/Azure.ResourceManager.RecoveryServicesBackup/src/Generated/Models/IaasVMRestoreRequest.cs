...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class IaasVMRestoreRequest : RestoreContent
    {
        /// <summary> Initializes a new instance of <see cref="IaasVMRestoreRequest"/>. </summary>
        public IaasVMRestoreRequest() : base("IaasVMRestoreRequest")
        {
        ...
        /// <summary> Initializes a new instance of <see cref="IaasVMRestoreRequest"/>. </summary>
        /// <param name="objectType"> This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types. </param>
        private protected IaasVMRestoreRequest(string objectType) : base(objectType)
        {
            RestoreDiskLunList = new ChangeTrackingList<int>();
            Zones = new ChangeTrackingList<string>();
        }
