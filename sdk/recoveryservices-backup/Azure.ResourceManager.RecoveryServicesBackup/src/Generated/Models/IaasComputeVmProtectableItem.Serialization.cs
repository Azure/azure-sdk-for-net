...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class IaasComputeVmProtectableItem : IUtf8JsonSerializable, IModelJsonSerializable<IaasComputeVmProtectableItem>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IaasComputeVmProtectableItem>(this, options.Format);
        ...
        internal static IaasComputeVmProtectableItem DeserializeIaasComputeVmProtectableItem(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new IaasComputeVmProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), virtualMachineId.Value, virtualMachineVersion.Value, resourceGroup.Value, serializedAdditionalRawData);
        }
