...
{
    public partial class BackupDay : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupDay DeserializeBackupDay(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
