...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackupDay>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackupDay>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackupDay>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackupDay>)} interface");
            }
        ...
        string IPersistableModel<BackupDay>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
