...
{
    public partial class BackupDay : IUtf8JsonSerializable, IJsonModel<BackupDay>, IPersistableModel<BackupDay>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  date:");
                builder.AppendLine($" '{Date.Value.ToString()}'");
            }

            if (Optional.IsDefined(IsLast))
            {
                builder.Append("  isLast:");
                var boolValue = IsLast.Value == true ? "true" : "false";
