...
{
    public partial class ResourceProtectionIntent : IUtf8JsonSerializable, IJsonModel<ResourceProtectionIntent>, IPersistableModel<ResourceProtectionIntent>
    {
        ...
        void IJsonModel<ResourceProtectionIntent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceProtectionIntent)} does not support '{format}' format.");
            }
