...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceProtectionIntent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceProtectionIntent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceProtectionIntent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceProtectionIntent>)} interface");
            }
        ...
        string IPersistableModel<ResourceProtectionIntent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
