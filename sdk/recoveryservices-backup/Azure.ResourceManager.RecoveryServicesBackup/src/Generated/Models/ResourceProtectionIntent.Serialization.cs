...
{
    public partial class ResourceProtectionIntent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceProtectionIntent DeserializeResourceProtectionIntent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
