...
{
    public partial class StorageProtectableContainer : IUtf8JsonSerializable
    {
        ...
        internal static StorageProtectableContainer DeserializeStorageProtectableContainer(JsonElement element)
        {
            ...
            return new StorageProtectableContainer(friendlyName.Value, Optional.ToNullable(backupManagementType), protectableContainerType, healthStatus.Value, containerId.Value);
        }
    }
}
