...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class StorageProtectableContainer : ProtectableContainer, IJsonModel<StorageProtectableContainer>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<StorageProtectableContainer>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StorageProtectableContainer>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StorageProtectableContainer IPersistableModel<StorageProtectableContainer>.Create(BinaryData data, ModelReaderWriterOptions options) => (StorageProtectableContainer)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StorageProtectableContainer IJsonModel<StorageProtectableContainer>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StorageProtectableContainer)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StorageProtectableContainer DeserializeStorageProtectableContainer(JsonElement element, ModelReaderWriterOptions options)
        {
