...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageProtectableContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageProtectableContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageProtectableContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageProtectableContainer>)} interface");
            }
        ...
        string IPersistableModel<StorageProtectableContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
