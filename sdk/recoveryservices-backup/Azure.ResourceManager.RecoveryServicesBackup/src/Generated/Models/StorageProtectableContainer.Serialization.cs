...
{
    public partial class StorageProtectableContainer : Core.IUtf8JsonSerializable
    {
        ...
        internal static StorageProtectableContainer DeserializeStorageProtectableContainer(JsonElement element)
        {
            ...
            return new StorageProtectableContainer(friendlyName.Value, Core.Optional.ToNullable(backupManagementType), protectableContainerType, healthStatus.Value, containerId.Value);
        }
    }
}
