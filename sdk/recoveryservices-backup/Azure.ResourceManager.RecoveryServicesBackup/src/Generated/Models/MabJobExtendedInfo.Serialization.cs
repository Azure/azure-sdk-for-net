...
{
    public partial class MabJobExtendedInfo : IUtf8JsonSerializable
    {
        ...
        internal static MabJobExtendedInfo DeserializeMabJobExtendedInfo(JsonElement element)
        {
            Optional<IList<MabJobTaskDetails>> tasksList = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("tasksList"u8))
                {
                    ...
                    {
                        array.Add(MabJobTaskDetails.DeserializeMabJobTaskDetails(item));
                    }
                    tasksList = array;
                    continue;
                }
            ...
            return new MabJobExtendedInfo(Optional.ToList(tasksList), Optional.ToDictionary(propertyBag), dynamicErrorMessage.Value);
        }
    }
}
