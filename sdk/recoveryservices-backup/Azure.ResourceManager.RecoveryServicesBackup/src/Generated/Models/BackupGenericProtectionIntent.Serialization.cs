...
{
    public partial class BackupGenericProtectionIntent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackupGenericProtectionIntent DeserializeBackupGenericProtectionIntent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
