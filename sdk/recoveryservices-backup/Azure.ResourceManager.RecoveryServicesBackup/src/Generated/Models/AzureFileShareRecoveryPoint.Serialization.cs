...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class AzureFileShareRecoveryPoint : RecoveryPoint, IJsonModel<AzureFileShareRecoveryPoint>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureFileShareRecoveryPoint>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureFileShareRecoveryPoint>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureFileShareRecoveryPoint IPersistableModel<AzureFileShareRecoveryPoint>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureFileShareRecoveryPoint)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureFileShareRecoveryPoint IJsonModel<AzureFileShareRecoveryPoint>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureFileShareRecoveryPoint)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureFileShareRecoveryPoint DeserializeAzureFileShareRecoveryPoint(JsonElement element, ModelReaderWriterOptions options)
        {
