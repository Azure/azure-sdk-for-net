...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadSapHanaDatabaseWorkloadItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSapHanaDatabaseWorkloadItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadSapHanaDatabaseWorkloadItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadSapHanaDatabaseWorkloadItem>)} interface");
            }
