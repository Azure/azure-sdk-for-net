...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class VmWorkloadSapHanaDatabaseWorkloadItem : VmWorkloadItem, IJsonModel<VmWorkloadSapHanaDatabaseWorkloadItem>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<VmWorkloadSapHanaDatabaseWorkloadItem>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VmWorkloadSapHanaDatabaseWorkloadItem>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapHanaDatabaseWorkloadItem IPersistableModel<VmWorkloadSapHanaDatabaseWorkloadItem>.Create(BinaryData data, ModelReaderWriterOptions options) => (VmWorkloadSapHanaDatabaseWorkloadItem)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VmWorkloadSapHanaDatabaseWorkloadItem IJsonModel<VmWorkloadSapHanaDatabaseWorkloadItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (VmWorkloadSapHanaDatabaseWorkloadItem)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VmWorkloadSapHanaDatabaseWorkloadItem DeserializeVmWorkloadSapHanaDatabaseWorkloadItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string workloadItemType = "SAPHanaDatabase";
