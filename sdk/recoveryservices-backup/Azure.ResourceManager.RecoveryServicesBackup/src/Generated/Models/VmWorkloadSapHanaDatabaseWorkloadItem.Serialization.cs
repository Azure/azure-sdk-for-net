...
{
    public partial class VmWorkloadSapHanaDatabaseWorkloadItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadSapHanaDatabaseWorkloadItem>, IPersistableModel<VmWorkloadSapHanaDatabaseWorkloadItem>
    {
        ...
        void IJsonModel<VmWorkloadSapHanaDatabaseWorkloadItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmWorkloadSapHanaDatabaseWorkloadItem)} does not support '{format}' format.");
            }
