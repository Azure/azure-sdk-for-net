...
{
    internal partial class UnknownSchedulePolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UnknownSchedulePolicy DeserializeUnknownSchedulePolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
