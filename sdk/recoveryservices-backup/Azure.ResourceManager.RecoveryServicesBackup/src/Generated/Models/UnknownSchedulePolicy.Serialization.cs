...
{
    internal partial class UnknownSchedulePolicy : BackupSchedulePolicy, IJsonModel<BackupSchedulePolicy>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSchedulePolicy DeserializeUnknownSchedulePolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSchedulePolicy(schedulePolicyType, additionalBinaryDataProperties);
        }
    }
}
