...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadBackupJobExtendedInfo
    {
        ...
        internal WorkloadBackupJobExtendedInfo(IList<WorkloadBackupJobTaskDetails> tasksList, IDictionary<string, string> propertyBag, string dynamicErrorMessage, Dictionary<string, BinaryData> rawData)
        {
            TasksList = tasksList;
