...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class WorkloadBackupJobExtendedInfo
    {
        ...
        internal WorkloadBackupJobExtendedInfo()
        {
        ...
        internal WorkloadBackupJobExtendedInfo(IList<WorkloadBackupJobTaskDetails> tasksList, IDictionary<string, string> propertyBag, string dynamicErrorMessage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TasksList = tasksList;
