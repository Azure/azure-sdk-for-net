...
{
    internal partial class UnknownBackupGenericEngine : BackupGenericEngine, IJsonModel<BackupGenericEngine>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBackupGenericEngine"/> for deserialization. </summary>
        internal UnknownBackupGenericEngine()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupGenericEngine DeserializeUnknownBackupGenericEngine(JsonElement element, ModelReaderWriterOptions options)
        {
