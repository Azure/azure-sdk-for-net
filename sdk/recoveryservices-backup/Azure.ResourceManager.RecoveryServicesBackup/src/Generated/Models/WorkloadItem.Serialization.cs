...
{
    public partial class WorkloadItem : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WorkloadItem DeserializeWorkloadItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
