...
{
    internal partial class UnknownIlrContent : IlrContent, IJsonModel<IlrContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownIlrContent"/> for deserialization. </summary>
        internal UnknownIlrContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownIlrContent DeserializeUnknownIlrContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownIlrContent(objectType, additionalBinaryDataProperties);
        }
    }
}
