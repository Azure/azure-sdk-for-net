...
{
    internal partial class UnknownBackupGenericProtectedItem : BackupGenericProtectedItem, IJsonModel<BackupGenericProtectedItem>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownBackupGenericProtectedItem"/> for deserialization. </summary>
        internal UnknownBackupGenericProtectedItem()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupGenericProtectedItem DeserializeUnknownBackupGenericProtectedItem(JsonElement element, ModelReaderWriterOptions options)
        {
