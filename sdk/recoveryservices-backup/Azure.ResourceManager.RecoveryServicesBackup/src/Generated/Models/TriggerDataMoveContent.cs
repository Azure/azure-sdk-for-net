...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    ...
    public partial class TriggerDataMoveContent
    {
        ...
        internal TriggerDataMoveContent(ResourceIdentifier sourceResourceId, AzureLocation sourceRegion, DataMoveLevel dataMoveLevel, string correlationId, IList<ResourceIdentifier> sourceContainerArmIds, bool? doesPauseGC, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourceResourceId = sourceResourceId;
            SourceRegion = sourceRegion;
            DataMoveLevel = dataMoveLevel;
