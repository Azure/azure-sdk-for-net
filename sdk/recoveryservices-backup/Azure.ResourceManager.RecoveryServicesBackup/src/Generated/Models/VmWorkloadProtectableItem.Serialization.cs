...
namespace Azure.ResourceManager.RecoveryServicesBackup.Models
{
    public partial class VmWorkloadProtectableItem : IUtf8JsonSerializable, IJsonModel<VmWorkloadProtectableItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<VmWorkloadProtectableItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmWorkloadProtectableItem>)} interface");
            }
