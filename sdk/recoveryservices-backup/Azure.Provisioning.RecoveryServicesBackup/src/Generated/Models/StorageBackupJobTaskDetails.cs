...
namespace Azure.Provisioning.RecoveryServicesBackup
{
    ...
    public partial class StorageBackupJobTaskDetails : ProvisionableConstruct
    {
        private BicepValue<string> _taskId;
        private BicepValue<string> _status;

        /// <summary> Creates a new StorageBackupJobTaskDetails. </summary>
        ...
        /// <summary> Define all the provisionable properties for StorageBackupJobTaskDetails. </summary>
        ...
        /// <summary> Define additional provisionable properties for StorageBackupJobTaskDetails that are not part of the generated code. </summary>
