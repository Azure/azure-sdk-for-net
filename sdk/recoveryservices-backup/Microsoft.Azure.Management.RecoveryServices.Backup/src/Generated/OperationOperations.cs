...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    internal partial class OperationOperations : IServiceOperations<RecoveryServicesBackupClient>, IOperationOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ValidateOperationsResponse>> ValidateWithHttpMessagesAsync(string vaultName, string resourceGroupName, string id, ValidateOperationRequest properties, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
