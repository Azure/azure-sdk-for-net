...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    public static partial class ValidateOperationOperationsExtensions
    {
            ...
            {
                operations.TriggerAsync(vaultName, resourceGroupName, id, properties).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task TriggerAsync(this IValidateOperationOperations operations, string vaultName, string resourceGroupName, string id, ValidateOperationRequest properties, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                operations.BeginTriggerAsync(vaultName, resourceGroupName, id, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginTriggerAsync(this IValidateOperationOperations operations, string vaultName, string resourceGroupName, string id, ValidateOperationRequest properties, CancellationToken cancellationToken = default(CancellationToken))
            {
