...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class AADPropertiesResource : Resource
    {
        ...
        /// <param name="properties">AADPropertiesResource properties</param>
        public AADPropertiesResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string eTag = default(string), AADProperties properties = default(AADProperties))
