...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class AzureWorkloadSAPHanaRestoreRequest : AzureWorkloadRestoreRequest
    {
        ...
        /// 'RecoveryUsingSnapshot', 'SnapshotAttachAndRecover'</param>
        /// <param name="targetResourceGroupName">Defines the Resource group of
        /// the Target VM</param>
        /// <param name="userAssignedManagedIdentityDetails">User Assigned
        /// managed identity details
        /// Currently used for snapshot.</param>
        /// <param name="snapshotRestoreParameters">Additional details for
        /// snapshot recovery
        /// Currently used for snapshot for SAP Hana.</param>
