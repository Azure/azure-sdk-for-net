...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class SubProtectionPolicy
    {
        ...
        /// tier.</param>
        public SubProtectionPolicy(string policyType = default(string), SchedulePolicy schedulePolicy = default(SchedulePolicy), RetentionPolicy retentionPolicy = default(RetentionPolicy), IDictionary<string, TieringPolicy> tieringPolicy = default(IDictionary<string, TieringPolicy>), SnapshotBackupAdditionalDetails snapshotBackupAdditionalDetails = default(SnapshotBackupAdditionalDetails))
        {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "snapshotBackupAdditionalDetails")]
