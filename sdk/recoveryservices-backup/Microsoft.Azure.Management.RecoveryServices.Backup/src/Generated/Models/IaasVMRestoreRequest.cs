...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class IaasVMRestoreRequest : RestoreRequest
    {
        ...
        /// <param name="extendedLocation">Target extended location where the
        /// VM should be restored,
        /// should be null if restore is to be done in public cloud</param>
        /// <param name="securedVMDetails">Stores Secured VM Details</param>
        /// <param name="targetDiskNetworkAccessSettings">Specifies target
        /// network access settings for disks of VM to be restored,</param>
        ...
        /// <summary>
        /// Gets or sets target extended location where the VM should be
        /// restored,
        ...
        /// </summary>
        [JsonProperty(PropertyName = "securedVMDetails")]
        public SecuredVMDetails SecuredVMDetails { get; set; }

        /// <summary>
        /// Gets or sets specifies target network access settings for disks of
        /// VM to be restored,
        /// </summary>
        [JsonProperty(PropertyName = "targetDiskNetworkAccessSettings")]
