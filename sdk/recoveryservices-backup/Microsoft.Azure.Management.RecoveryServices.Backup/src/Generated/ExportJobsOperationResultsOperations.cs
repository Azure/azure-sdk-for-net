...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class ExportJobsOperationResultsOperations : IServiceOperations<RecoveryServicesBackupClient>, IExportJobsOperationResultsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<OperationResultInfoBaseResource>> GetWithHttpMessagesAsync(string vaultName, string resourceGroupName, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vaultName == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<OperationResultInfoBaseResource>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<OperationResultInfoBaseResource>(_responseContent, Client.DeserializationSettings);
                }
