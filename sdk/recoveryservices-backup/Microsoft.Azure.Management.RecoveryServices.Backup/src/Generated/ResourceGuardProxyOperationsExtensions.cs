...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    public static partial class ResourceGuardProxyOperationsExtensions
    {
            ...
            /// </param>
            public static UnlockDeleteResponse UnlockDelete(this IResourceGuardProxyOperations operations, string vaultName, string resourceGroupName, string resourceGuardProxyName, IList<string> resourceGuardOperationRequests = default(IList<string>), string resourceToBeDeleted = default(string))
            {
                return operations.UnlockDeleteAsync(vaultName, resourceGroupName, resourceGuardProxyName, resourceGuardOperationRequests, resourceToBeDeleted).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<UnlockDeleteResponse> UnlockDeleteAsync(this IResourceGuardProxyOperations operations, string vaultName, string resourceGroupName, string resourceGuardProxyName, IList<string> resourceGuardOperationRequests = default(IList<string>), string resourceToBeDeleted = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
