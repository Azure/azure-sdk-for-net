...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    public static partial class ProtectionContainersOperationsExtensions
    {
            ...
            {
                return operations.BeginRegisterAsync(vaultName, resourceGroupName, fabricName, containerName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ProtectionContainerResource> BeginRegisterAsync(this IProtectionContainersOperations operations, string vaultName, string resourceGroupName, string fabricName, string containerName, ProtectionContainerResource parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
