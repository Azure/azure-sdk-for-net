...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    public static partial class OperationOperationsExtensions
    {
            ...
            {
                return operations.ValidateAsync(vaultName, resourceGroupName, id, properties).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<ValidateOperationsResponse> ValidateAsync(this IOperationOperations operations, string vaultName, string resourceGroupName, string id, ValidateOperationRequest properties, CancellationToken cancellationToken = default(CancellationToken))
            {
