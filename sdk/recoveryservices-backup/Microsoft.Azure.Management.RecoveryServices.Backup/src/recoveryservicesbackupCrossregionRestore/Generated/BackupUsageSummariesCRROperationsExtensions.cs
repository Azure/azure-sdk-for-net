...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore
{
    ...
    public static partial class BackupUsageSummariesCRROperationsExtensions
    {
            ...
            /// skipToken Filter.
            /// </param>
            public static IEnumerable<BackupManagementUsage> List(this IBackupUsageSummariesCRROperations operations, string vaultName, string resourceGroupName, ODataQuery<BMSBackupSummariesQueryObject> odataQuery = default(ODataQuery<BMSBackupSummariesQueryObject>), string skipToken = default(string))
            {
            ...
            /// </param>
            public static async Task<IEnumerable<BackupManagementUsage>> ListAsync(this IBackupUsageSummariesCRROperations operations, string vaultName, string resourceGroupName, ODataQuery<BMSBackupSummariesQueryObject> odataQuery = default(ODataQuery<BMSBackupSummariesQueryObject>), string skipToken = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
