...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.CrossRegionRestore.Models
{
    ...
    public partial class AzureIaaSVMJobExtendedInfo
    {
        ...
        public IList<AzureIaaSVMJobTaskDetails> TasksList { get; set; }
        ...
        /// </summary>
        [JsonProperty(PropertyName = "internalPropertyBag")]
        public IDictionary<string, string> InternalPropertyBag { get; set; }
