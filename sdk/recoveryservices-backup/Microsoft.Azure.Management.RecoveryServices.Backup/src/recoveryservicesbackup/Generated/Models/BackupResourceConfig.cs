...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class BackupResourceConfig
    {
        ...
        /// <param name="dedupState">Vault Dedup state. Possible values
        /// include: 'Invalid', 'Enabled', 'Disabled'</param>
        /// <param name="xcoolState">Vault x-cool state. Possible values
        /// include: 'Invalid', 'Enabled', 'Disabled'</param>
        ...
        /// <summary>
        /// Gets or sets vault Dedup state. Possible values include: 'Invalid',
        /// 'Enabled', 'Disabled'
        /// </summary>
        [JsonProperty(PropertyName = "dedupState")]
        public string DedupState { get; set; }

        /// <summary>
        /// Gets or sets vault x-cool state. Possible values include:
        /// 'Invalid', 'Enabled', 'Disabled'
        /// </summary>
        [JsonProperty(PropertyName = "xcoolState")]
