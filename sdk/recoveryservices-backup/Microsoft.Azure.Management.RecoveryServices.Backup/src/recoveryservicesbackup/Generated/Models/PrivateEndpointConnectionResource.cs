...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class PrivateEndpointConnectionResource : Resource
    {
        ...
        /// <param name="properties">PrivateEndpointConnectionResource
        /// properties</param>
        public PrivateEndpointConnectionResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string eTag = default(string), PrivateEndpointConnection properties = default(PrivateEndpointConnection))
