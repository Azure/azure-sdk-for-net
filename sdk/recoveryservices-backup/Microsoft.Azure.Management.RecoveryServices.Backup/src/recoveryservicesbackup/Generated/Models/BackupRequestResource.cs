...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class BackupRequestResource : Resource
    {
        ...
        public BackupRequestResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string eTag = default(string), BackupRequest properties = default(BackupRequest))
        ...
        /// <summary>
        /// Gets or sets backupRequestResource properties
        /// </summary>
