...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class BackupResourceVaultConfig
    {
        ...
        /// <param name="isSoftDeleteFeatureStateEditable">Is soft delete
        /// feature state editable</param>
        public BackupResourceVaultConfig(string storageModelType = default(string), string storageType = default(string), string storageTypeState = default(string), string enhancedSecurityState = default(string), string softDeleteFeatureState = default(string), IList<string> resourceGuardOperationRequests = default(IList<string>), bool? isSoftDeleteFeatureStateEditable = default(bool?))
        {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "isSoftDeleteFeatureStateEditable")]
