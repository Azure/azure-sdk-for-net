...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class AzureIaaSVMJobV2 : Job
    {
        ...
        /// job.</param>
        public AzureIaaSVMJobV2(string entityFriendlyName = default(string), string backupManagementType = default(string), string operation = default(string), string status = default(string), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), string activityId = default(string), IList<JobSupportedAction?> actionsInfo = default(IList<JobSupportedAction?>), string containerName = default(string), System.TimeSpan? duration = default(System.TimeSpan?), IList<AzureIaaSVMErrorInfo> errorDetails = default(IList<AzureIaaSVMErrorInfo>), string virtualMachineVersion = default(string), AzureIaaSVMJobExtendedInfo extendedInfo = default(AzureIaaSVMJobExtendedInfo))
        ...
        /// <summary>
        /// Gets or sets container name of the entity on which the current job
        /// is executing.
        /// </summary>
