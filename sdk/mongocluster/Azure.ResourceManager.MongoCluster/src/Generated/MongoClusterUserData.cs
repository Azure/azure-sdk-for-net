...
namespace Azure.ResourceManager.MongoCluster
{
    ...
    public partial class MongoClusterUserData : ResourceData
    {
        ...
        internal MongoClusterUserData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MongoClusterUserProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
