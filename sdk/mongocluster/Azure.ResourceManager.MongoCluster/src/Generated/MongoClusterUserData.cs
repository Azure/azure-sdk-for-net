...
namespace Azure.ResourceManager.MongoCluster
{
    ...
    public partial class MongoClusterUserData : ResourceData
    {
        ...
        internal MongoClusterUserData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, MongoClusterUserProperties properties) : base(id, name, resourceType, systemData)
        {
