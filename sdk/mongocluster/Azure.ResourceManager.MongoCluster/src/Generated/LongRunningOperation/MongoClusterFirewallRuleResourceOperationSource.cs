...
{
    /// <summary></summary>
    internal partial class MongoClusterFirewallRuleResourceOperationSource : IOperationSource<MongoClusterFirewallRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MongoClusterFirewallRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
