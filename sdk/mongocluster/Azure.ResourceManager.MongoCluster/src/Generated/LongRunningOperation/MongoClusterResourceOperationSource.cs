...
{
    /// <summary></summary>
    internal partial class MongoClusterResourceOperationSource : IOperationSource<MongoClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MongoClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
