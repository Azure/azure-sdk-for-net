...
namespace Azure.ResourceManager.MongoCluster.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicaListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<MongoClusterReplica>)item).Write(writer, options);
            }
        ...
        internal static ReplicaListResult DeserializeReplicaListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ReplicaListResult(value, nextLink, serializedAdditionalRawData);
        }
