...
namespace Azure.ResourceManager.MongoCluster.Models
{
    ...
    public partial class MongoClusterEntraIdentityProviderProperties : IJsonModel<MongoClusterEntraIdentityProviderProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MongoClusterEntraIdentityProviderProperties IJsonModel<MongoClusterEntraIdentityProviderProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MongoClusterEntraIdentityProviderProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MongoClusterEntraIdentityProviderProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MongoClusterEntraIdentityProviderProperties DeserializeMongoClusterEntraIdentityProviderProperties(JsonElement element, ModelReaderWriterOptions options)
        {
