...
namespace Azure.ResourceManager.MongoCluster.Models
{
    ...
    public partial class MongoClusterPrivateLinkResourceProperties
    {
        ...
        internal MongoClusterPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GroupId = groupId;
