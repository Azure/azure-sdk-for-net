    ...
    public partial class MongoClusterReplica : IUtf8JsonSerializable, IJsonModel<MongoClusterReplica>
    {
        ...
        internal static MongoClusterReplica DeserializeMongoClusterReplica(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.MongoCluster.ModelSerializationExtensions.WireOptions, AzureResourceManagerMongoClusterContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerMongoClusterContext.Default)
#endif
;
                    continue;
                }
