        ...
        internal static MongoClusterPatch DeserializeMongoClusterPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), new ModelReaderWriterOptions("W|v3"), AzureResourceManagerMongoClusterContext.Default);
                    continue;
                }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = MongoClusterUpdateProperties.DeserializeMongoClusterUpdateProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
