...
namespace Azure.ResourceManager.MongoCluster
{
    internal partial class PrivateLinksGetPrivateLinksCollectionResultOfT : Pageable<MongoClusterPrivateLinkResourceData>
    {
        ...
        public PrivateLinksGetPrivateLinksCollectionResultOfT(PrivateLinks client, Guid subscriptionId, string resourceGroupName, string mongoClusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
