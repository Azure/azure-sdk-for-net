...
namespace Azure.ResourceManager.MongoCluster
{
    internal partial class MongoClustersRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string mongoClusterName, MongoClusterData data)
        {
            ...
            ((IJsonModel<MongoClusterData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string mongoClusterName, MongoClusterPatch patch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<MongoClusterPatch>)patch).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateCheckMongoClusterNameAvailabilityRequest(string subscriptionId, AzureLocation location, MongoClusterNameAvailabilityContent content)
        {
            ...
            ((IJsonModel<MongoClusterNameAvailabilityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreatePromoteRequest(string subscriptionId, string resourceGroupName, string mongoClusterName, PromoteReplicaContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<PromoteReplicaContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
