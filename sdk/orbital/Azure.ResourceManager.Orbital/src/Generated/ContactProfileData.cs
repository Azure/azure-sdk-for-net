...
{
    /// <summary> A class representing the ContactProfile data model. </summary>
    public partial class ContactProfileData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ContactProfileData. </summary>
        /// <param name="location"> The location. </param>
        public ContactProfileData(AzureLocation location) : base(location)
        {
        ...
        internal ContactProfileData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ETag? etag, ContactProfilesPropertiesProvisioningState? provisioningState, TimeSpan? minimumViableContactDuration, float? minimumElevationDegrees, AutoTrackingConfiguration? autoTrackingConfiguration, Uri eventHubUri, ContactProfilesPropertiesNetworkConfiguration networkConfiguration, IList<ContactProfileLink> links) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
        ...
        public ContactProfilesPropertiesProvisioningState? ProvisioningState { get; set; }
