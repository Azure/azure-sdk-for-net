...
namespace Azure.ResourceManager.Orbital
{
    public partial class OrbitalContactResource : IJsonModel<OrbitalContactData>
    {
        ...
        {
            return ModelReaderWriter.Read<OrbitalContactData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<OrbitalContactData>(data, options);
        }
