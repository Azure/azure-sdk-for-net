...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrbitalContactProfileLinkChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OrbitalContactProfileLinkChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OrbitalContactProfileLinkChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OrbitalContactProfileLinkChannel>)} interface");
            }
        ...
        string IPersistableModel<OrbitalContactProfileLinkChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
