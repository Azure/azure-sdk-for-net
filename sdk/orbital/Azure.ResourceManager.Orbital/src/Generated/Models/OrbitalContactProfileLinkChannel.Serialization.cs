    ...
    public partial class OrbitalContactProfileLinkChannel : IUtf8JsonSerializable, IJsonModel<OrbitalContactProfileLinkChannel>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EndPoint))
            {
                ...
                AppendChildObject(builder, EndPoint, options, 2, false);
            }

            if (Optional.IsDefined(ModulationConfiguration))
            {
                builder.Append("  modulationConfiguration:");
                if (ModulationConfiguration.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ModulationConfiguration}'''");
                }
                else
                {
                    builder.AppendLine($" '{ModulationConfiguration}'");
            ...
            if (Optional.IsDefined(DemodulationConfiguration))
            {
                builder.Append("  demodulationConfiguration:");
                if (DemodulationConfiguration.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{DemodulationConfiguration}'''");
                }
                else
                {
                    builder.AppendLine($" '{DemodulationConfiguration}'");
            ...
            if (Optional.IsDefined(EncodingConfiguration))
            {
                builder.Append("  encodingConfiguration:");
                if (EncodingConfiguration.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{EncodingConfiguration}'''");
                }
                else
                {
                    builder.AppendLine($" '{EncodingConfiguration}'");
            ...
            if (Optional.IsDefined(DecodingConfiguration))
            {
                builder.Append("  decodingConfiguration:");
                if (DecodingConfiguration.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{DecodingConfiguration}'''");
                }
                else
                {
                    builder.AppendLine($" '{DecodingConfiguration}'");
