...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    public partial class OrbitalAvailableContactsContent
    {
        ...
        internal OrbitalAvailableContactsContent(WritableSubResource contactProfile, string groundStationName, DateTimeOffset startOn, DateTimeOffset endOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ContactProfile = contactProfile;
            GroundStationName = groundStationName;
            StartOn = startOn;
