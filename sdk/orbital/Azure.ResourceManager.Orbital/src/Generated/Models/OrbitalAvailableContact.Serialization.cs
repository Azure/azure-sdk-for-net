...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrbitalAvailableContact>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OrbitalAvailableContact>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OrbitalAvailableContact>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OrbitalAvailableContact>)} interface");
            }
        ...
        string IPersistableModel<OrbitalAvailableContact>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
