...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    public partial class OrbitalContactEndpoint
    {
        ...
        internal OrbitalContactEndpoint(IPAddress ipAddress, string endPointName, string port, OrbitalContactProtocol protocol, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IPAddress = ipAddress;
            EndPointName = endPointName;
            Port = port;
