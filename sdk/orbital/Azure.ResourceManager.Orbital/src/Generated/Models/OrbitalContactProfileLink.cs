...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    public partial class OrbitalContactProfileLink
    {
        ...
        internal OrbitalContactProfileLink(string name, OrbitalLinkPolarization polarization, OrbitalLinkDirection direction, float? gainOverTemperature, float? eirpdBW, IList<OrbitalContactProfileLinkChannel> channels, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Polarization = polarization;
            Direction = direction;
