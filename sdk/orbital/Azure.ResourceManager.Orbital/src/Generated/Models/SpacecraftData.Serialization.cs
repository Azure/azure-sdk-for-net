...
{
    public partial class SpacecraftData : IUtf8JsonSerializable
    {
        ...
        internal static SpacecraftData DeserializeSpacecraftData(JsonElement element)
        {
            ...
            Optional<SpacecraftsPropertiesProvisioningState> provisioningState = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("provisioningState"))
                        {
                            ...
                            provisioningState = new SpacecraftsPropertiesProvisioningState(property0.Value.GetString());
                            continue;
                        }
            ...
            return new SpacecraftData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(etag), Optional.ToNullable(provisioningState), noradId.Value, titleLine.Value, tleLine1.Value, tleLine2.Value, Optional.ToList(links));
        }
    }
}
