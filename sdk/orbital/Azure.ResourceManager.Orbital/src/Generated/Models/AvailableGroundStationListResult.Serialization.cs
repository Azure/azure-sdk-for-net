...
namespace Azure.ResourceManager.Orbital.Models
{
    internal partial class AvailableGroundStationListResult : IUtf8JsonSerializable, IJsonModel<AvailableGroundStationListResult>
    {
        ...
        void IJsonModel<AvailableGroundStationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AvailableGroundStationListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AvailableGroundStationListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AvailableGroundStationListResult)} does not support '{options.Format}' format.");
            }
        }
