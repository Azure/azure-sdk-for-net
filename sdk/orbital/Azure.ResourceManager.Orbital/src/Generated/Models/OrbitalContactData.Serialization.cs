...
namespace Azure.ResourceManager.Orbital
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrbitalContactData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OrbitalContactData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OrbitalContactData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OrbitalContactData>)} interface");
            }
        ...
        string IPersistableModel<OrbitalContactData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
