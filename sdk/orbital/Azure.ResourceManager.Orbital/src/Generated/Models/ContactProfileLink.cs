...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    public partial class ContactProfileLink
    {
        ...
        public ContactProfileLink(string name, Polarization polarization, Direction direction, IEnumerable<ContactProfileLinkChannel> channels)
        {
            if (name == null)
            {
        ...
        /// <param name="channels"> Contact Profile Link Channel. </param>
        internal ContactProfileLink(string name, Polarization polarization, Direction direction, float? gainOverTemperature, float? eirpdBW, IList<ContactProfileLinkChannel> channels)
        {
            Name = name;
            Polarization = polarization;
            Direction = direction;
