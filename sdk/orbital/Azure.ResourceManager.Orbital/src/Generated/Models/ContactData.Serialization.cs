...
{
    public partial class ContactData : IUtf8JsonSerializable
    {
        ...
        internal static ContactData DeserializeContactData(JsonElement element)
        {
            ...
            Optional<ContactsPropertiesProvisioningState> provisioningState = default;
            Optional<ContactsStatus> status = default;
            ...
            Optional<ContactsPropertiesAntennaConfiguration> antennaConfiguration = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("provisioningState"))
                        {
                            ...
                            provisioningState = new ContactsPropertiesProvisioningState(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("status"))
                        {
                            ...
                            status = new ContactsStatus(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("antennaConfiguration"))
                        {
                            ...
                            antennaConfiguration = ContactsPropertiesAntennaConfiguration.DeserializeContactsPropertiesAntennaConfiguration(property0.Value);
                            continue;
                        }
