...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrbitalSpacecraftTags>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OrbitalSpacecraftTags>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OrbitalSpacecraftTags>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OrbitalSpacecraftTags>)} interface");
            }
        ...
        string IPersistableModel<OrbitalSpacecraftTags>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
