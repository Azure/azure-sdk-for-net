...
namespace Azure.ResourceManager.Orbital
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrbitalContactProfileData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OrbitalContactProfileData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OrbitalContactProfileData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<OrbitalContactProfileData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
