...
{
    public partial class OrbitalContactProfileData : IUtf8JsonSerializable, IJsonModel<OrbitalContactProfileData>, IPersistableModel<OrbitalContactProfileData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinimumViableContactDuration))
            {
                builder.Append("  minimumViableContactDuration:");
                var formattedTimeSpan = XmlConvert.ToString(MinimumViableContactDuration.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }

            if (Optional.IsDefined(MinimumElevationDegrees))
            {
                builder.Append("  minimumElevationDegrees:");
                builder.AppendLine($" '{MinimumElevationDegrees.Value.ToString()}'");
            }

            if (Optional.IsDefined(AutoTrackingConfiguration))
            {
                builder.Append("  autoTrackingConfiguration:");
                builder.AppendLine($" '{AutoTrackingConfiguration.ToString()}'");
            }

            if (Optional.IsDefined(EventHubUri))
            {
                builder.Append("  eventHubUri:");
                builder.AppendLine($" '{EventHubUri.AbsoluteUri}'");
            }
