...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContactProfileListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContactProfileListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContactProfileListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContactProfileListResult>)} interface");
            }
        ...
        string IPersistableModel<ContactProfileListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
