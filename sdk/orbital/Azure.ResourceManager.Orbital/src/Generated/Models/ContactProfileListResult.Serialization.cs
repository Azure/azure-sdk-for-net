...
{
    internal partial class ContactProfileListResult : IUtf8JsonSerializable, IJsonModel<ContactProfileListResult>, IPersistableModel<ContactProfileListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContactProfileListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContactProfileListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContactProfileListResult)} does not support '{format}' format.");
            }
