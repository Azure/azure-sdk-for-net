...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    {
        internal static ContactProfileListResult DeserializeContactProfileListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
