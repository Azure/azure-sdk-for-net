...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    {
        internal static OrbitalSpacecraftListResult DeserializeOrbitalSpacecraftListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
