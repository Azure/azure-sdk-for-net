...
{
    public partial class AvailableGroundStationData : IUtf8JsonSerializable, IJsonModel<AvailableGroundStationData>, IPersistableModel<AvailableGroundStationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReleaseMode))
            {
                ...
                builder.AppendLine($" '{ReleaseMode.ToString()}'");
            }
