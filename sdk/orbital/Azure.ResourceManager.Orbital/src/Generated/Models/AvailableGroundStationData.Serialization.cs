...
namespace Azure.ResourceManager.Orbital
{
    ...
    {
        internal static AvailableGroundStationData DeserializeAvailableGroundStationData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
