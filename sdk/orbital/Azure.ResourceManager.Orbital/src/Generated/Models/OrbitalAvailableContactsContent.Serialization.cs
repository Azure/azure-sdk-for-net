...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrbitalAvailableContactsContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OrbitalAvailableContactsContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OrbitalAvailableContactsContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OrbitalAvailableContactsContent>)} interface");
            }
        ...
        string IPersistableModel<OrbitalAvailableContactsContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
