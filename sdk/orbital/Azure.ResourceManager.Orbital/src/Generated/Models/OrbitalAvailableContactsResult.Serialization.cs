...
namespace Azure.ResourceManager.Orbital.Models
{
    ...
    {
        internal static OrbitalAvailableContactsResult DeserializeOrbitalAvailableContactsResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
