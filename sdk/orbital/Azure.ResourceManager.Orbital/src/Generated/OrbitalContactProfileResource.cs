...
namespace Azure.ResourceManager.Orbital
{
    ...
    public partial class OrbitalContactProfileResource : ArmResource
    {
        ...
        internal OrbitalContactProfileResource(ArmClient client, OrbitalContactProfileData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<OrbitalContactProfileResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new OrbitalContactProfileResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
