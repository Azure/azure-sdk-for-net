...
{
    /// <summary> A class representing the Spacecraft data model. </summary>
    public partial class SpacecraftData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SpacecraftData. </summary>
        /// <param name="location"> The location. </param>
        public SpacecraftData(AzureLocation location) : base(location)
        {
        ...
        internal SpacecraftData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ETag? etag, SpacecraftsPropertiesProvisioningState? provisioningState, string noradId, string titleLine, string tleLine1, string tleLine2, IList<SpacecraftLink> links) : base(id, name, resourceType, systemData, tags, location)
        {
            ETag = etag;
        ...
        public SpacecraftsPropertiesProvisioningState? ProvisioningState { get; set; }
