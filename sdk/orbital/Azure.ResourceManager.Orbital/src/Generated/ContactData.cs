...
{
    /// <summary> A class representing the Contact data model. </summary>
    public partial class ContactData : ResourceData
    {
        /// <summary> Initializes a new instance of ContactData. </summary>
        public ContactData()
        {
        }
        ...
        internal ContactData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, ContactsPropertiesProvisioningState? provisioningState, ContactsStatus? status, DateTimeOffset? reservationStartOn, DateTimeOffset? reservationEndOn, DateTimeOffset? rxStartOn, DateTimeOffset? rxEndOn, DateTimeOffset? txStartOn, DateTimeOffset? txEndOn, string errorMessage, float? maximumElevationDegrees, float? startAzimuthDegrees, float? endAzimuthDegrees, string groundStationName, float? startElevationDegrees, float? endElevationDegrees, ContactsPropertiesAntennaConfiguration antennaConfiguration, WritableSubResource contactProfile) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
        ...
        public ContactsPropertiesProvisioningState? ProvisioningState { get; set; }
        /// <summary> Status of a contact. </summary>
        public ContactsStatus? Status { get; }
        ...
        public ContactsPropertiesAntennaConfiguration AntennaConfiguration { get; }
