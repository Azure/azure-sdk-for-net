...
namespace Azure.ResourceManager.Orbital.Testing
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class OrbitalResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="OrbitalResourceGroupResourceExtension"/> class for mocking. </summary>
        protected OrbitalResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="OrbitalResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal OrbitalResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
