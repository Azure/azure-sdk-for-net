# Azure Orbital Management client library for .NET
...
Install the Azure Orbital management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.Orbital --prerelease
```
