...
namespace Microsoft.Azure.Management.Orbital.Models
{
    ...
    public partial class GroundStation
    {
        ...
        public GroundStation(string name = default(string), string location = default(string), string city = default(string), string providerName = default(string), double? longitudeDegrees = default(double?), double? latitudeDegrees = default(double?), double? altitudeMeters = default(double?))
        {
            Name = name;
            Location = location;
            City = city;
