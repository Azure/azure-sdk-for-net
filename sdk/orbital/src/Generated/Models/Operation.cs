...
namespace Microsoft.Azure.Management.Orbital.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Orbital REST API operation definition.
    /// </remarks>
    public partial class Operation
    {
        ...
        public Operation(string name = default(string), bool? isDataAction = default(bool?), OperationDisplay display = default(OperationDisplay), string origin = default(string))
        {
            Name = name;
