...
namespace Microsoft.Azure.Management.Orbital.Models
{
    ...
    public partial class Contact : ProxyResource
    {
        ...
        /// <param name="startElevationDegrees">Start Elevation in
        /// degrees.</param>
        /// <param name="endElevationDegrees">End Elevation in degrees.</param>
        /// <param name="etag">A unique read-only string that changes whenever
        /// the resource is updated.</param>
        public Contact(System.DateTime reservationStartTime, System.DateTime reservationEndTime, string groundStationName, ResourceReference contactProfile, string id = default(string), string type = default(string), string name = default(string), string status = default(string), System.DateTime? rxStartTime = default(System.DateTime?), System.DateTime? rxEndTime = default(System.DateTime?), System.DateTime? txStartTime = default(System.DateTime?), System.DateTime? txEndTime = default(System.DateTime?), string errorMessage = default(string), double? maximumElevationDegrees = default(double?), double? startAzimuthDegrees = default(double?), double? endAzimuthDegrees = default(double?), double? startElevationDegrees = default(double?), double? endElevationDegrees = default(double?), string etag = default(string))
            : base(id, type, name)
        {
            Status = status;
        ...
        public ResourceReference ContactProfile { get; set; }
