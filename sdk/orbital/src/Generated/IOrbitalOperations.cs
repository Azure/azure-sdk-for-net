...
namespace Microsoft.Azure.Management.Orbital
{
    ...
    public partial interface IOrbitalOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<GroundStationListResult>> ListGroundStationsWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<Spacecraft>> SpacecraftUpdateTagsWithHttpMessagesAsync(string resourceGroupName, string spacecraftName, IDictionary<string, string> tags = default(IDictionary<string, string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
