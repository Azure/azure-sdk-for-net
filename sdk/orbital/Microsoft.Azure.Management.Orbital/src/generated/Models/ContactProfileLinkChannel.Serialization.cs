...
{
    public partial class ContactProfileLinkChannel : IUtf8JsonSerializable
    {
        ...
        internal static ContactProfileLinkChannel DeserializeContactProfileLinkChannel(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    endPoint = EndPoint.DeserializeEndPoint(property.Value);
                    continue;
                }
            ...
            return new ContactProfileLinkChannel(centerFrequencyMHz, bandwidthMHz, endPoint, modulationConfiguration.Value, demodulationConfiguration.Value, encodingConfiguration.Value, decodingConfiguration.Value);
        }
    }
}
