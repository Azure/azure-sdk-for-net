...
{
    public partial class ResourceSystemData
    {
        internal static ResourceSystemData DeserializeResourceSystemData(JsonElement element)
        {
            ...
            return new ResourceSystemData(createdBy.Value, Optional.ToNullable(createdByType), Optional.ToNullable(createdAt), lastModifiedBy.Value, Optional.ToNullable(lastModifiedByType));
        }
    }
}
