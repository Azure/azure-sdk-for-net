...
namespace AzureOrbital.Models
{
    ...
    {
        internal static ContactInstanceProperties DeserializeContactInstanceProperties(JsonElement element)
        {
            ...
            return new ContactInstanceProperties(Optional.ToNullable(maximumElevationDegrees), Optional.ToNullable(txStartTime), Optional.ToNullable(txEndTime), Optional.ToNullable(rxStartTime), Optional.ToNullable(rxEndTime), Optional.ToNullable(startAzimuthDegrees), Optional.ToNullable(endAzimuthDegrees), Optional.ToNullable(startElevationDegrees), Optional.ToNullable(endElevationDegrees));
        }
    }
}
