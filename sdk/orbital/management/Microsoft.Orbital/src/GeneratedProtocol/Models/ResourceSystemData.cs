...
namespace Microsoft.Orbital.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ResourceSystemData class.
        /// </summary>
        public ResourceSystemData()
        {
            CustomInit();
        }
        ...
        public ResourceSystemData(string createdBy = default(string), string createdByType = default(string), System.DateTime? createdAt = default(System.DateTime?), string lastModifiedBy = default(string), string lastModifiedByType = default(string))
