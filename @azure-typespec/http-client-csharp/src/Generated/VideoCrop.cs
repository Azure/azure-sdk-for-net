...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class VideoCrop
    {
        ...
        /// <summary> Top-left corner of the crop region. Array of [x, y], must be non-negative integers. </summary>
        public IList<int> TopLeftInternal { get; }

        /// <summary> Bottom-right corner of the crop region. Array of [x, y], must be non-negative integers. </summary>
        public IList<int> BottomRightInternal { get; }
    }
}
