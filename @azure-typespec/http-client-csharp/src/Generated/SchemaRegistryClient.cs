...
namespace Azure.Data.SchemaRegistry
{
    ...
    public partial class SchemaRegistryClient
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="fullyQualifiedNamespace"/> or <paramref name="credential"/> is null. </exception>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="fullyQualifiedNamespace"/> or <paramref name="credential"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="fullyQualifiedNamespace"/> is an empty string, and was expected to be non-empty. </exception>
        public SchemaRegistryClient(string fullyQualifiedNamespace, TokenCredential credential, SchemaRegistryClientOptions options)
        {
