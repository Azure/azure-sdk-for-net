...
namespace Azure.AI.VoiceLive
{
    ...
    internal partial class OutputTextContentPart : IJsonModel<OutputTextContentPart>
    {
        ...
        void IJsonModel<OutputTextContentPart>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual OutputTextContentPart JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OutputTextContentPart)} does not support reading '{format}' format.");
            }
        ...
        protected virtual OutputTextContentPart PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OutputTextContentPart)} does not support reading '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<OutputTextContentPart>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
