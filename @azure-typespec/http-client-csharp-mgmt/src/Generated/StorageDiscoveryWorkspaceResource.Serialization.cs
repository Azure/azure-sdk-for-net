...
namespace Microsoft.StorageDiscovery
{
    ...
    public partial class StorageDiscoveryWorkspaceResource : IJsonModel<StorageDiscoveryWorkspaceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StorageDiscoveryWorkspaceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<StorageDiscoveryWorkspaceData>(Data, options, MicrosoftStorageDiscoveryContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StorageDiscoveryWorkspaceData IPersistableModel<StorageDiscoveryWorkspaceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<StorageDiscoveryWorkspaceData>(data, options, MicrosoftStorageDiscoveryContext.Default);
