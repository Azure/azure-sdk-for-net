...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class ContainerizedNetworkFunctionDefinitionVersion : NetworkFunctionDefinitionVersionPropertiesFormat
    {
        ...
        public ContainerizedNetworkFunctionDefinitionVersion() : base(NetworkFunctionType.ContainerizedNetworkFunction)
        {
        }
        ...
        internal ContainerizedNetworkFunctionDefinitionVersion(ProvisioningState? provisioningState, VersionState? versionState, string description, string deployParameters, NetworkFunctionType networkFunctionType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ContainerizedNetworkFunctionTemplate networkFunctionTemplate) : base(provisioningState, versionState, description, deployParameters, networkFunctionType, additionalBinaryDataProperties)
        {
