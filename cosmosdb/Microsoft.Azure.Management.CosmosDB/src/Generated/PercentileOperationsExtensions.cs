...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    public static partial class PercentileOperationsExtensions
    {
            ...
            /// </param>
            public static IEnumerable<PercentileMetric> ListMetrics(this IPercentileOperations operations, string resourceGroupName, string accountName, string filter)
            {
            ...
            /// </param>
            public static async Task<IEnumerable<PercentileMetric>> ListMetricsAsync(this IPercentileOperations operations, string resourceGroupName, string accountName, string filter, CancellationToken cancellationToken = default(CancellationToken))
            {
