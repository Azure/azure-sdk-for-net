...
namespace Microsoft.Azure.Management.CosmosDB.Models
{
    ...
    public partial class MongoDBDatabaseCreateUpdateParameters : ARMResourceProperties
    {
        ...
        /// request.</param>
        public MongoDBDatabaseCreateUpdateParameters(MongoDBDatabaseResource resource, string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), ManagedServiceIdentity identity = default(ManagedServiceIdentity), CreateUpdateOptions options = default(CreateUpdateOptions))
