...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    public static partial class PercentileTargetOperationsExtensions
    {
            ...
            /// </param>
            public static IEnumerable<PercentileMetric> ListMetrics(this IPercentileTargetOperations operations, string resourceGroupName, string accountName, string targetRegion, string filter)
            {
