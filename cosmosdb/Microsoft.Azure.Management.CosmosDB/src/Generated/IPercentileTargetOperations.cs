...
namespace Microsoft.Azure.Management.CosmosDB
{
    ...
    /// </summary>
    public partial interface IPercentileTargetOperations
    {
        /// <summary>
        ...
        /// </exception>
        Task<AzureOperationResponse<IEnumerable<PercentileMetric>>> ListMetricsWithHttpMessagesAsync(string resourceGroupName, string accountName, string targetRegion, string filter, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
