# Repository ProjectGraph dependency-selection trade-offs

This document records the detailed comparison with the existing `ResolveReferences`
implementation and the known semantic and operational trade-offs. See
[`README.md`](README.md) for the current architecture and lifecycle.
