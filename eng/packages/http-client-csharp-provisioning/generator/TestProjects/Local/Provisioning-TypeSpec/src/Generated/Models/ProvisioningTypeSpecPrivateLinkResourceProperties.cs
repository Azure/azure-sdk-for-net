...
namespace Azure.Provisioning.ProvisioningTypeSpec
{
    ...
    public partial class ProvisioningTypeSpecPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new ProvisioningTypeSpecPrivateLinkResourceProperties. </summary>
        public ProvisioningTypeSpecPrivateLinkResourceProperties()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ProvisioningTypeSpecPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for ProvisioningTypeSpecPrivateLinkResourceProperties that are not part of the generated code. </summary>
