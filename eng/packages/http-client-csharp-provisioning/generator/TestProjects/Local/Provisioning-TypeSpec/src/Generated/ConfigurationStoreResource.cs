...
namespace Azure.Provisioning.ProvisioningTypeSpec
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ConfigurationStoreResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetConfigurationStores method.
    /// </summary>
    public partial class ConfigurationStoreResource : ArmResource
    {
        ...
        public static readonly ResourceType ResourceType = "ProvisioningTypeSpec/configurationStores";

        /// <summary> Initializes a new instance of ConfigurationStoreResource for mocking. </summary>
        protected ConfigurationStoreResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ConfigurationStoreResource"/> class. </summary>
        ...
        /// <param name="configurationStoreName"> The configurationStoreName. </param>
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string configurationStoreName)
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/ProvisioningTypeSpec/configurationStores/{configurationStoreName}";
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="ConfigurationStoreResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _configurationStoresClientDiagnostics.CreateScope("ConfigurationStoreResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<ConfigurationStoreResource>> UpdateAsync(WaitUntil waitUntil, ConfigurationStoreData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _configurationStoresClientDiagnostics.CreateScope("ConfigurationStoreResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ConfigurationStoreResource> Update(WaitUntil waitUntil, ConfigurationStoreData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        {
            using DiagnosticScope scope = _configurationStoresClientDiagnostics.CreateScope("ConfigurationStoreResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<ConfigurationStoreResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _configurationStoresClientDiagnostics.CreateScope("ConfigurationStoreResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    ConfigurationStoreData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ConfigurationStoreData patch = new ConfigurationStoreData();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    }
                    patch.Tags[key] = value;
                    ArmOperation<ConfigurationStoreResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ConfigurationStoreResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    ConfigurationStoreData current = Get(cancellationToken: cancellationToken).Value.Data;
                    ConfigurationStoreData patch = new ConfigurationStoreData();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<ConfigurationStoreResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<ConfigurationStoreResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _configurationStoresClientDiagnostics.CreateScope("ConfigurationStoreResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<ConfigurationStoreResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _configurationStoresClientDiagnostics.CreateScope("ConfigurationStoreResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
