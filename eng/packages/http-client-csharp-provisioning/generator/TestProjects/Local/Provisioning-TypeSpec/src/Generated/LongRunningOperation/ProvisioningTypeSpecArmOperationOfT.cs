...
{
    internal partial class ProvisioningTypeSpecArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ProvisioningTypeSpecArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ProvisioningTypeSpecArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
