...
namespace Azure.Provisioning.ProvisioningTypeSpec
{
    ...
    /// Please note this is the abstract base class. The derived classes available for instantiation are: <see cref="SpecializedResourceProfile"/>.
    /// </summary>
    public partial class DiscriminatedResourceProfile : ProvisionableResource
    {
        ...
        public DiscriminatedResourceProfile(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "ProvisioningTypeSpec/configurationStores/discriminatedResourceProfiles", resourceVersion ?? "2024-05-01")
        {
        }
