...
namespace Azure.Provisioning.ProvisioningTypeSpec.Models
{
    ...
    public partial class ArmOperationStatusResourceProvisioningState : IJsonModel<ArmOperationStatusResourceProvisioningState>
    {
        ...
        internal static ArmOperationStatusResourceProvisioningState DeserializeArmOperationStatusResourceProvisioningState(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("error"u8))
                {
                    ...
                    error = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureProvisioningProvisioningTypeSpecContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
