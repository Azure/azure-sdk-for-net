...
namespace Azure.Provisioning.ProvisioningTypeSpec.Preview
{
    ...
    public partial class DiscriminatedResourceProfile : ProvisionableResource
    {
        ...
        public DiscriminatedResourceProfile(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "ProvisioningTypeSpec/configurationStores/discriminatedResourceProfiles", resourceVersion ?? "2024-03-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DiscriminatedResourceProfile. </summary>
        ...
        /// <summary> Creates a reference to an existing DiscriminatedResourceProfile. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DiscriminatedResourceProfile FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DiscriminatedResourceProfile result = new DiscriminatedResourceProfile(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DiscriminatedResourceProfile that are not part of the generated code. </summary>
