...
namespace Azure.Provisioning.ProvisioningTypeSpec.Preview
{
    ...
    public partial class ConfigurationStore : ProvisionableResource
    {
        ...
        public ConfigurationStore(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "ProvisioningTypeSpec/configurationStores", resourceVersion ?? "2024-03-01-preview")
        {
        }
        ...
        public RoleAssignment CreateRoleAssignment(ProvisioningTypeSpecPreviewBuiltInRole role, UserAssignedIdentity identity)
        {
            string roleName = ProvisioningTypeSpecPreviewBuiltInRole.GetBuiltInRoleName(role);
        ...
        /// <returns> The <see cref="RoleAssignment"/>. </returns>
        public RoleAssignment CreateRoleAssignment(ProvisioningTypeSpecPreviewBuiltInRole role, BicepValue<RoleManagementPrincipalType> principalType, BicepValue<Guid> principalId, string bicepIdentifierSuffix = null)
        {
            string roleName = ProvisioningTypeSpecPreviewBuiltInRole.GetBuiltInRoleName(role);
