...
namespace Azure.Provisioning.ProvisioningTypeSpec.Preview
{
    ...
    public partial class SingletonSetting : ProvisionableResource
    {
        ...
        public SingletonSetting(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "ProvisioningTypeSpec/configurationStores/settings", resourceVersion ?? "2024-03-01-preview")
        {
        }
