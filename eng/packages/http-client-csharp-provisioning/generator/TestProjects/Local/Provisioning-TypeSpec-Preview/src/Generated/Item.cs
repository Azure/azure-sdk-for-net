...
namespace Azure.Provisioning.ProvisioningTypeSpec.Preview
{
    ...
    public partial class Item : ProvisionableResource
    {
        ...
        public Item(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "ProvisioningTypeSpec/configurationStores/items", resourceVersion ?? "2024-03-01-preview")
        {
        }
