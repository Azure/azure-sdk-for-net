...
namespace Azure.Provisioning.ProvisioningTypeSpec.Preview
{
    ...
    public partial class Profile : ProvisionableResource
    {
        ...
        public Profile(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "ProvisioningTypeSpec/configurationStores/profiles", resourceVersion ?? "2024-03-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Profile. </summary>
        ...
        /// <summary> Creates a reference to an existing Profile. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Profile FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Profile result = new Profile(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Profile that are not part of the generated code. </summary>
