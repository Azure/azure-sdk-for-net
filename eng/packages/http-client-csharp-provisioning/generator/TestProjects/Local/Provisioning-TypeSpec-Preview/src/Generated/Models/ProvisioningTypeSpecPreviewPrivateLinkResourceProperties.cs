...
namespace Azure.Provisioning.ProvisioningTypeSpec.Preview
{
    ...
    public partial class ProvisioningTypeSpecPreviewPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new ProvisioningTypeSpecPreviewPrivateLinkResourceProperties. </summary>
        public ProvisioningTypeSpecPreviewPrivateLinkResourceProperties()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ProvisioningTypeSpecPreviewPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for ProvisioningTypeSpecPreviewPrivateLinkResourceProperties that are not part of the generated code. </summary>
