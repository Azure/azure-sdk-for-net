...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class BestPracticeResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData _data;
        ...
        internal BestPracticeResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal BestPracticeResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _bestPracticesClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec", ResourceType.Namespace, Diagnostics);
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData Data
        {
            get
            {
                if (!HasData)
