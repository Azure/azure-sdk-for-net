...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class BarCollection : ArmCollection, IEnumerable<BarResource>, IAsyncEnumerable<BarResource>
    {
        ...
        public virtual async Task<ArmOperation<BarResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string barName, global::"Azure.Generator.MgmtTypeSpec.Tests".BarData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _barsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, barName, global::"Azure.Generator.MgmtTypeSpec.Tests".BarData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="barName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="barName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<BarResource> CreateOrUpdate(WaitUntil waitUntil, string barName, global::"Azure.Generator.MgmtTypeSpec.Tests".BarData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(barName, nameof(barName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<BarResource>> GetAsync(string barName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".BarData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<BarResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.AsyncPageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData, MgmtTypeSpec.BarResource>(new BarsGetAllAsyncCollectionResultOfT(_barsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new BarResource(Client, data));
        }
        ...
        public virtual Pageable<BarResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.PageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData, MgmtTypeSpec.BarResource>(new BarsGetAllCollectionResultOfT(_barsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new BarResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string barName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".BarData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".BarData)null), result);
                        break;
                    default:
