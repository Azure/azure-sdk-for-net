...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class BarQuotaResourceCollection : ArmCollection
    {
        ...
        internal BarQuotaResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _barQuotaOperationsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec", BarQuotaResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(QuotaName barQuotaResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".BarQuotaResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".BarQuotaResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".BarQuotaResourceData)null), result);
                        break;
                    default:
