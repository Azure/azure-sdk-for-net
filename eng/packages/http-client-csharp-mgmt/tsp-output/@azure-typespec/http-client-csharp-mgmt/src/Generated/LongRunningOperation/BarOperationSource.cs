...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    internal partial class BarOperationSource : IOperationSource<BarResource>
    {
        ...
        BarResource IOperationSource<BarResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            global::"Azure.Generator.MgmtTypeSpec.Tests".BarData data = global::"Azure.Generator.MgmtTypeSpec.Tests".BarData.DeserializeBarData(document.RootElement, ModelSerializationExtensions.WireOptions);
