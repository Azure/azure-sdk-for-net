...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class WorkloadNetworkVmGroupResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData _data;
        ...
        internal WorkloadNetworkVmGroupResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<ArmOperation<WorkloadNetworkVmGroupResource>> UpdateAsync(WaitUntil waitUntil, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workloadNetworkVmGroupsRestClient.CreateUpdateVmGroupRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData.ToRequestContent(data), context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<WorkloadNetworkVmGroupResource> Update(WaitUntil waitUntil, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<WorkloadNetworkVmGroupResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData patch = new global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    }
                    patch.Tags[key] = value;
                    ArmOperation<WorkloadNetworkVmGroupResource> result = await this.UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WorkloadNetworkVmGroupResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData current = Get(cancellationToken: cancellationToken).Value.Data;
                    global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData patch = new global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<WorkloadNetworkVmGroupResource> result = this.Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
