...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class HciVmInstanceResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".HciVmInstanceData _data;
        ...
        internal HciVmInstanceResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".HciVmInstanceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".HciVmInstanceData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<HciVmInstanceResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".HciVmInstanceData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".HciVmInstanceData.FromResponse(result), result);
