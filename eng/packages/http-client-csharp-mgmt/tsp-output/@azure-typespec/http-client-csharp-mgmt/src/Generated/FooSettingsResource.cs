...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class FooSettingsResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".FooSettingsData _data;
        ...
        internal FooSettingsResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".FooSettingsData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal FooSettingsResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _fooSettingsOperationsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec", ResourceType.Namespace, Diagnostics);
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".FooSettingsData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<ArmOperation<FooSettingsResource>> CreateOrUpdateAsync(WaitUntil waitUntil, global::"Azure.Generator.MgmtTypeSpec.Tests".FooSettingsData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _fooSettingsOperationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, global::"Azure.Generator.MgmtTypeSpec.Tests".FooSettingsData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".FooSettingsData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".FooSettingsData.FromResponse(result), result);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<FooSettingsResource> CreateOrUpdate(WaitUntil waitUntil, global::"Azure.Generator.MgmtTypeSpec.Tests".FooSettingsData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
