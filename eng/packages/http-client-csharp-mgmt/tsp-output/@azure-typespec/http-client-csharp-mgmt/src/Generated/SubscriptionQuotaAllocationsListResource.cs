...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ManagementGroupResource"/> using the GetSubscriptionQuotaAllocationsLists method.
    /// </summary>
    public partial class SubscriptionQuotaAllocationsListResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".SubscriptionQuotaAllocationsListData _data;
        /// <summary> Gets the resource type for the operations. </summary>
        public static readonly ResourceType ResourceType = "MgmtTypeSpec/groupQuotas/resourceProviders/quotaAllocations";
        ...
        internal SubscriptionQuotaAllocationsListResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".SubscriptionQuotaAllocationsListData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal SubscriptionQuotaAllocationsListResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _subscriptionQuotaAllocationsListsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec", ResourceType.Namespace, Diagnostics);
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".SubscriptionQuotaAllocationsListData Data
        {
            get
            {
                if (!HasData)
        ...
        {
            string resourceId = $"/providers/Microsoft.Management/managementGroups/{managementGroupId}/subscriptions/{subscriptionId}/providers/MgmtTypeSpec/groupQuotas/{groupQuotaName}/resourceProviders/{resourceProviderName}/quotaAllocations/{location}";
        ...
        {
            using DiagnosticScope scope = _subscriptionQuotaAllocationsListsClientDiagnostics.CreateScope("SubscriptionQuotaAllocationsListResource.Get");
            scope.Start();
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".SubscriptionQuotaAllocationsListData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".SubscriptionQuotaAllocationsListData.FromResponse(result), result);
