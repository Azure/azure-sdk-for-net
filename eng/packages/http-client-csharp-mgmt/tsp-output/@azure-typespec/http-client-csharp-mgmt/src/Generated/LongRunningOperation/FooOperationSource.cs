...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    internal partial class FooOperationSource : IOperationSource<FooResource>
    {
        ...
        FooResource IOperationSource<FooResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            global::"Azure.Generator.MgmtTypeSpec.Tests".FooData data = global::"Azure.Generator.MgmtTypeSpec.Tests".FooData.DeserializeFooData(document.RootElement, ModelSerializationExtensions.WireOptions);
