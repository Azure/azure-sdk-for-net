...
{
    internal partial class PlaywrightQuotasGetBySubscriptionCollectionResultOfT : Azure.Pageable<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData>
    {
        ...
        public override IEnumerable<Azure.Page<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Azure.Page<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData>.FromValues(((System.Collections.Generic.IReadOnlyList<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData>)result.Value), nextPage?.AbsoluteUri, response);
