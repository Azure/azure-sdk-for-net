...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class GroupQuotaSubscriptionRequestStatusResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaSubscriptionRequestStatusData _data;
        ...
        internal GroupQuotaSubscriptionRequestStatusResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaSubscriptionRequestStatusData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaSubscriptionRequestStatusData Data
        {
            get
            {
                if (!HasData)
