    ...
    public partial class StorageSyncServiceCollection : ArmCollection
    {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string storageSyncServiceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".StorageSyncServiceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".StorageSyncServiceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".StorageSyncServiceData)null), result);
                        break;
                    default:
