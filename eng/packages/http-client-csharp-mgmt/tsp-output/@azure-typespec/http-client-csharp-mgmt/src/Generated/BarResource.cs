...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class BarResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".BarData _data;
        ...
        internal BarResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".BarData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".BarData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<BarResource>> UpdateAsync(global::"Azure.Generator.MgmtTypeSpec.Tests".BarData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _barRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, global::"Azure.Generator.MgmtTypeSpec.Tests".BarData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".BarData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<BarResource> Update(global::"Azure.Generator.MgmtTypeSpec.Tests".BarData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<BarResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    global::"Azure.Generator.MgmtTypeSpec.Tests".BarData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    global::"Azure.Generator.MgmtTypeSpec.Tests".BarData patch = new global::"Azure.Generator.MgmtTypeSpec.Tests".BarData();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    }
                    patch.Tags[key] = value;
                    Response<BarResource> result = await this.UpdateAsync(patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<BarResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    global::"Azure.Generator.MgmtTypeSpec.Tests".BarData current = Get(cancellationToken: cancellationToken).Value.Data;
                    global::"Azure.Generator.MgmtTypeSpec.Tests".BarData patch = new global::"Azure.Generator.MgmtTypeSpec.Tests".BarData();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    Response<BarResource> result = this.Update(patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
