...
namespace Azure.Generator.MgmtTypeSpec.Models
{
    ...
    public partial class ZooProperties : IJsonModel<ZooProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ZooProperties)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ZooProperties IJsonModel<ZooProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ZooProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ZooProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ZooProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ZooProperties DeserializeZooProperties(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        internal partial class ZooPropertiesConverter : JsonConverter<ZooProperties>
        {
            ...
            public override void Write(Utf8JsonWriter writer, ZooProperties model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue<IJsonModel<ZooProperties>>(model, ModelSerializationExtensions.WireOptions);
            }
            ...
            /// <param name="options"> The serialization options. </param>
            public override ZooProperties Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using JsonDocument document = JsonDocument.ParseValue(ref reader);
                return DeserializeZooProperties(document.RootElement, ModelSerializationExtensions.WireOptions);
            }
        }
    }
}
