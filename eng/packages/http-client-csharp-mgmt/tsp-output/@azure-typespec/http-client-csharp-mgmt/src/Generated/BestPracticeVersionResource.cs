...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class BestPracticeVersionResource : ArmResource
    {
        ...
        internal BestPracticeVersionResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal BestPracticeVersionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _bestPracticeVersionsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec", ResourceType.Namespace, Diagnostics);
