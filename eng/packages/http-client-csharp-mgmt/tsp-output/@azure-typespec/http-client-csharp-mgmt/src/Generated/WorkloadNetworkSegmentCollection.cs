...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class WorkloadNetworkSegmentCollection : ArmCollection, IEnumerable<WorkloadNetworkSegmentResource>, IAsyncEnumerable<WorkloadNetworkSegmentResource>
    {
        ...
        internal WorkloadNetworkSegmentCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workloadNetworkSegmentsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec", WorkloadNetworkSegmentResource.ResourceType.Namespace, Diagnostics);
            ...
            _workloadNetworksClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec", WorkloadNetworkSegmentResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<WorkloadNetworkSegmentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string segmentId, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkSegmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workloadNetworkSegmentsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, segmentId, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkSegmentData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="segmentId"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="segmentId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<WorkloadNetworkSegmentResource> CreateOrUpdate(WaitUntil waitUntil, string segmentId, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkSegmentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(segmentId, nameof(segmentId));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<WorkloadNetworkSegmentResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.AsyncPageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkSegmentData, MgmtTypeSpec.WorkloadNetworkSegmentResource>(new WorkloadNetworkSegmentsGetAllAsyncCollectionResultOfT(_workloadNetworkSegmentsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new WorkloadNetworkSegmentResource(Client, data));
        }
        ...
        public virtual Pageable<WorkloadNetworkSegmentResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.PageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkSegmentData, MgmtTypeSpec.WorkloadNetworkSegmentResource>(new WorkloadNetworkSegmentsGetAllCollectionResultOfT(_workloadNetworkSegmentsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new WorkloadNetworkSegmentResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string segmentId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkSegmentData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkSegmentData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkSegmentData)null), result);
                        break;
                    default:
