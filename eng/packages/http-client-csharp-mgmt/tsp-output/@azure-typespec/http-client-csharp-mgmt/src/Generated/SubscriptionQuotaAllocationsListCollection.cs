...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class SubscriptionQuotaAllocationsListCollection : ArmCollection
    {
        ...
        internal SubscriptionQuotaAllocationsListCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _subscriptionQuotaAllocationsListsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec", SubscriptionQuotaAllocationsListResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(Guid subscriptionId, string groupQuotaName, string resourceProviderName, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".SubscriptionQuotaAllocationsListData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".SubscriptionQuotaAllocationsListData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".SubscriptionQuotaAllocationsListData)null), result);
                        break;
                    default:
