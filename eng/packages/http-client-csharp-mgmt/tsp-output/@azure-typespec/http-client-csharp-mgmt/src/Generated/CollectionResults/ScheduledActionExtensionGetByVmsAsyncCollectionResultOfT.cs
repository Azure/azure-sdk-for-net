...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class ScheduledActionExtensionGetByVmsAsyncCollectionResultOfT : AsyncPageable<ScheduledActionResources>
    {
        ...
        /// <returns> The pages of ScheduledActionExtensionGetByVmsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<ScheduledActionResources>> AsPages(string continuationToken, int? pageSizeHint)
        {
