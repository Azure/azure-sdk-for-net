...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class BazCollection : ArmCollection, IEnumerable<BazResource>, IAsyncEnumerable<BazResource>
    {
        ...
        public virtual async Task<ArmOperation<BazResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string bazName, global::"Azure.Generator.MgmtTypeSpec.Tests".BazData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _bazsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, bazName, global::"Azure.Generator.MgmtTypeSpec.Tests".BazData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="bazName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="bazName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<BazResource> CreateOrUpdate(WaitUntil waitUntil, string bazName, global::"Azure.Generator.MgmtTypeSpec.Tests".BazData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(bazName, nameof(bazName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<BazResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.AsyncPageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".BazData, MgmtTypeSpec.BazResource>(new BazsGetAllAsyncCollectionResultOfT(_bazsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new BazResource(Client, data));
        }
        ...
        public virtual Pageable<BazResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.PageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".BazData, MgmtTypeSpec.BazResource>(new BazsGetAllCollectionResultOfT(_bazsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new BazResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string bazName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".BazData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".BazData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".BazData)null), result);
                        break;
                    default:
