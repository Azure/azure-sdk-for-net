...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    internal partial class ZooOperationSource : IOperationSource<ZooResource>
    {
        ...
        ZooResource IOperationSource<ZooResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData data = global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData.DeserializeZooData(document.RootElement, ModelSerializationExtensions.WireOptions);
