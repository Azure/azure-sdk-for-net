...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class BestPracticeVersionCollection : ArmCollection, IEnumerable<BestPracticeVersionResource>, IAsyncEnumerable<BestPracticeVersionResource>
    {
        ...
        public virtual async Task<ArmOperation<BestPracticeVersionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string versionName, global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _bestPracticeVersionsRestClient.CreateCreateOrUpdateRequest(Id.Name, versionName, global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="versionName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="versionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<BestPracticeVersionResource> CreateOrUpdate(WaitUntil waitUntil, string versionName, global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(versionName, nameof(versionName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<BestPracticeVersionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.AsyncPageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData, MgmtTypeSpec.BestPracticeVersionResource>(new BestPracticeVersionsGetAllAsyncCollectionResultOfT(_bestPracticeVersionsRestClient, Id.Name, context), data => new BestPracticeVersionResource(Client, data));
        }
        ...
        public virtual Pageable<BestPracticeVersionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.PageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData, MgmtTypeSpec.BestPracticeVersionResource>(new BestPracticeVersionsGetAllCollectionResultOfT(_bestPracticeVersionsRestClient, Id.Name, context), data => new BestPracticeVersionResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string versionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".BestPracticeData)null), result);
                        break;
                    default:
