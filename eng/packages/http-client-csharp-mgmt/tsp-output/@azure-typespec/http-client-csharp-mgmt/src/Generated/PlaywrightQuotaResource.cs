...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class PlaywrightQuotaResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData _data;
        ...
        internal PlaywrightQuotaResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<PlaywrightQuotaResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData.FromResponse(result), result);
        ...
        public virtual async Task<ArmOperation<PlaywrightQuotaResource>> UpdateAsync(WaitUntil waitUntil, global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _playwrightQuotasRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData.FromResponse(result), result);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<PlaywrightQuotaResource> Update(WaitUntil waitUntil, global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
