...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class BarSettingsResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData _data;
        ...
        internal BarSettingsResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<ArmOperation<BarSettingsResource>> CreateOrUpdateAsync(WaitUntil waitUntil, global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _barSettingsOperationsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData.ToRequestContent(data), context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<BarSettingsResource> CreateOrUpdate(WaitUntil waitUntil, global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<BarSettingsResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData.FromResponse(result), result);
