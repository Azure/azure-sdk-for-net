...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class StorageSyncServiceResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".StorageSyncServiceData _data;
        ...
        internal StorageSyncServiceResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".StorageSyncServiceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".StorageSyncServiceData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<StorageSyncServiceResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".StorageSyncServiceData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".StorageSyncServiceData.FromResponse(result), result);
