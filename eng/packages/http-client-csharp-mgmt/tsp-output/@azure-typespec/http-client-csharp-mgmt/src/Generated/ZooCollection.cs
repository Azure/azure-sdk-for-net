...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class ZooCollection : ArmCollection, IEnumerable<ZooResource>, IAsyncEnumerable<ZooResource>
    {
        ...
        public virtual async Task<ArmOperation<ZooResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string zooName, global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _zoosRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, zooName, global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="zooName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="zooName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ZooResource> CreateOrUpdate(WaitUntil waitUntil, string zooName, global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(zooName, nameof(zooName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<ZooResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.AsyncPageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData, MgmtTypeSpec.ZooResource>(new ZoosGetAllAsyncCollectionResultOfT(_zoosRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new ZooResource(Client, data));
        }
        ...
        public virtual Pageable<ZooResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.PageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData, MgmtTypeSpec.ZooResource>(new ZoosGetAllCollectionResultOfT(_zoosRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new ZooResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string zooName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData)null), result);
                        break;
                    default:
