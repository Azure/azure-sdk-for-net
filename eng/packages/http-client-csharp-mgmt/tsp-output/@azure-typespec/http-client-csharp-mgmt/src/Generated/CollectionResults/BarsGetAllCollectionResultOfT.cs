...
{
    internal partial class BarsGetAllCollectionResultOfT : Azure.Pageable<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData>
    {
        ...
        public override IEnumerable<Azure.Page<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Azure.Page<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData>.FromValues(((System.Collections.Generic.IReadOnlyList<global::"Azure.Generator.MgmtTypeSpec.Tests".BarData>)result.Value), nextPage?.AbsoluteUri, response);
