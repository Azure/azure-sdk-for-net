...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class ZooResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData _data;
        ...
        internal ZooResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<ZooResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData.FromResponse(result), result);
        ...
        public virtual async Task<Response<ZooResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
        ...
        public virtual Response<ZooResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    global::"Azure.Generator.MgmtTypeSpec.Tests".ZooData current = Get(cancellationToken: cancellationToken).Value.Data;
                    ZooPatch patch = new ZooPatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
