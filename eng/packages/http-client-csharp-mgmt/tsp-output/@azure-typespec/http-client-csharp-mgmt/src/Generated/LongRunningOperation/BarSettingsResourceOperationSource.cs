...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    internal partial class BarSettingsResourceOperationSource : IOperationSource<BarSettingsResource>
    {
        ...
        BarSettingsResource IOperationSource<BarSettingsResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData data = global::"Azure.Generator.MgmtTypeSpec.Tests".BarSettingsResourceData.DeserializeBarSettingsResourceData(document.RootElement, ModelSerializationExtensions.WireOptions);
