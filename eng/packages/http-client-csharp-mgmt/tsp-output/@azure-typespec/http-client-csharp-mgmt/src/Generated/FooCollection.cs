...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class FooCollection : ArmCollection, IEnumerable<FooResource>, IAsyncEnumerable<FooResource>
    {
        ...
        public virtual async Task<ArmOperation<FooResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string fooName, global::"Azure.Generator.MgmtTypeSpec.Tests".FooData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _foosRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, fooName, global::"Azure.Generator.MgmtTypeSpec.Tests".FooData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="fooName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="fooName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<FooResource> CreateOrUpdate(WaitUntil waitUntil, string fooName, global::"Azure.Generator.MgmtTypeSpec.Tests".FooData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(fooName, nameof(fooName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<FooResource>> GetAsync(string fooName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".FooData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".FooData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<FooResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.AsyncPageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".FooData, MgmtTypeSpec.FooResource>(new FoosGetAllAsyncCollectionResultOfT(_foosRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new FooResource(Client, data));
        }
        ...
        public virtual Pageable<FooResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.PageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".FooData, MgmtTypeSpec.FooResource>(new FoosGetAllCollectionResultOfT(_foosRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new FooResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string fooName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".FooData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".FooData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".FooData)null), result);
                        break;
                    default:
