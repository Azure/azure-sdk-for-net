    ...
    public partial class GroupQuotaSubscriptionRequestStatusCollection : ArmCollection
    {
        ...
        public virtual async Task<Response<GroupQuotaSubscriptionRequestStatusResource>> GetAsync(string requestId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaSubscriptionRequestStatusData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaSubscriptionRequestStatusData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string requestId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaSubscriptionRequestStatusData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaSubscriptionRequestStatusData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaSubscriptionRequestStatusData)null), result);
                        break;
                    default:
