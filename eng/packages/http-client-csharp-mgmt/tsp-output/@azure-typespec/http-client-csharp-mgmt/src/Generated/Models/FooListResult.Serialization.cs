...
namespace Azure.Generator.MgmtTypeSpec.Models
{
    ...
    internal partial class FooListResult : IJsonModel<FooListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (global::"Azure.Generator.MgmtTypeSpec.Tests".FooData item in Value)
            {
                writer.WriteObjectValue<global::"Azure.Generator.MgmtTypeSpec.Tests".FooData>(item, options);
            }
        ...
        internal static FooListResult DeserializeFooListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            System.Collections.Generic.IList<global::"Azure.Generator.MgmtTypeSpec.Tests".FooData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    System.Collections.Generic.List<global::"Azure.Generator.MgmtTypeSpec.Tests".FooData> array = new List<global::"Azure.Generator.MgmtTypeSpec.Tests".FooData>;
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(global::"Azure.Generator.MgmtTypeSpec.Tests".FooData.DeserializeFooData(item, options));
                    }
                    value = array;
                    continue;
                }
