    ...
    public partial class GroupQuotaLimitListCollection : ArmCollection
    {
        ...
        public virtual async Task<ArmOperation<GroupQuotaLimitListResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string groupQuotaName, string resourceProviderName, AzureLocation location, global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaLimitListData data = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _groupQuotaLimitListsRestClient.CreateCreateOrUpdateRequest(Id.Name, groupQuotaName, resourceProviderName, location, global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaLimitListData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="groupQuotaName"/> or <paramref name="resourceProviderName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="groupQuotaName"/> or <paramref name="resourceProviderName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<GroupQuotaLimitListResource> CreateOrUpdate(WaitUntil waitUntil, string groupQuotaName, string resourceProviderName, AzureLocation location, global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaLimitListData data = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupQuotaName, nameof(groupQuotaName));
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));
        ...
        public virtual async Task<Response<GroupQuotaLimitListResource>> GetAsync(string groupQuotaName, string resourceProviderName, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaLimitListData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaLimitListData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string groupQuotaName, string resourceProviderName, AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaLimitListData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaLimitListData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".GroupQuotaLimitListData)null), result);
                        break;
                    default:
