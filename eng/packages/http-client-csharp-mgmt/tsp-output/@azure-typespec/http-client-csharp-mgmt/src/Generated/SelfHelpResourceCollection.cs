    ...
    public partial class SelfHelpResourceCollection : ArmCollection
    {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string selfHelpName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".SelfHelpResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".SelfHelpResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".SelfHelpResourceData)null), result);
                        break;
                    default:
