...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class WorkloadNetworkVmGroupCollection : ArmCollection, IEnumerable<WorkloadNetworkVmGroupResource>, IAsyncEnumerable<WorkloadNetworkVmGroupResource>
    {
        ...
        public virtual async Task<ArmOperation<WorkloadNetworkVmGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string vmGroupId, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workloadNetworkVmGroupsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, vmGroupId, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="vmGroupId"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="vmGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<WorkloadNetworkVmGroupResource> CreateOrUpdate(WaitUntil waitUntil, string vmGroupId, global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(vmGroupId, nameof(vmGroupId));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<WorkloadNetworkVmGroupResource>> GetAsync(string vmGroupId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<WorkloadNetworkVmGroupResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.AsyncPageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData, MgmtTypeSpec.WorkloadNetworkVmGroupResource>(new WorkloadNetworkVmGroupsGetAllAsyncCollectionResultOfT(_workloadNetworkVmGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new WorkloadNetworkVmGroupResource(Client, data));
        }
        ...
        public virtual Pageable<WorkloadNetworkVmGroupResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.PageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData, MgmtTypeSpec.WorkloadNetworkVmGroupResource>(new WorkloadNetworkVmGroupsGetAllCollectionResultOfT(_workloadNetworkVmGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new WorkloadNetworkVmGroupResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string vmGroupId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".WorkloadNetworkVmGroupData)null), result);
                        break;
                    default:
