...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    internal partial class BazOperationSource : IOperationSource<BazResource>
    {
        ...
        BazResource IOperationSource<BazResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            global::"Azure.Generator.MgmtTypeSpec.Tests".BazData data = global::"Azure.Generator.MgmtTypeSpec.Tests".BazData.DeserializeBazData(document.RootElement, ModelSerializationExtensions.WireOptions);
