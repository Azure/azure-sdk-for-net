...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class JobResource : ArmResource
    {
        ...
        private readonly global::"Azure.Generator.MgmtTypeSpec.Tests".JobResourceData _data;
        ...
        internal JobResource(ArmClient client, global::"Azure.Generator.MgmtTypeSpec.Tests".JobResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual global::"Azure.Generator.MgmtTypeSpec.Tests".JobResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<JobResource>> GetAsync(string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".JobResourceData> response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".JobResourceData.FromResponse(result), result);
        ...
        public virtual async Task<Response<JobResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    global::"Azure.Generator.MgmtTypeSpec.Tests".JobResourceData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
        ...
        public virtual Response<JobResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    global::"Azure.Generator.MgmtTypeSpec.Tests".JobResourceData current = Get(cancellationToken: cancellationToken).Value.Data;
                    JobResourcePatch patch = new JobResourcePatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
