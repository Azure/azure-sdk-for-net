...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class PlaywrightQuotaCollection : ArmCollection, IEnumerable<PlaywrightQuotaResource>, IAsyncEnumerable<PlaywrightQuotaResource>
    {
        ...
        public virtual async Task<ArmOperation<PlaywrightQuotaResource>> CreateOrUpdateAsync(WaitUntil waitUntil, PlaywrightQuotaName playwrightQuotaName, global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _playwrightQuotasRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), _location, playwrightQuotaName.ToString(), global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData.ToRequestContent(data), context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<PlaywrightQuotaResource> CreateOrUpdate(WaitUntil waitUntil, PlaywrightQuotaName playwrightQuotaName, global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<PlaywrightQuotaResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.AsyncPageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData, MgmtTypeSpec.PlaywrightQuotaResource>(new PlaywrightQuotasGetBySubscriptionAsyncCollectionResultOfT(_playwrightQuotasRestClient, Guid.Parse(Id.SubscriptionId), _location, context), data => new PlaywrightQuotaResource(Client, data));
        }
        ...
        public virtual Pageable<PlaywrightQuotaResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new MgmtTypeSpec.PageableWrapper<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData, MgmtTypeSpec.PlaywrightQuotaResource>(new PlaywrightQuotasGetBySubscriptionCollectionResultOfT(_playwrightQuotasRestClient, Guid.Parse(Id.SubscriptionId), _location, context), data => new PlaywrightQuotaResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(PlaywrightQuotaName playwrightQuotaName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Azure.Response<global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue(((global::"Azure.Generator.MgmtTypeSpec.Tests".PlaywrightQuotaData)null), result);
                        break;
                    default:
