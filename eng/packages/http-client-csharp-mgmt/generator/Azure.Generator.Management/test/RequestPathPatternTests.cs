...
namespace Azure.Generator.Management.Tests
{
    public class RequestPathPatternTests
    {
        ...
        [TestCase("resource", "resourceName", true, Description = "resource should match resourceName (suffix variation)")]
        [TestCase("resourceName", "resource", true, Description = "resourceName should match resource (bidirectional)")]
