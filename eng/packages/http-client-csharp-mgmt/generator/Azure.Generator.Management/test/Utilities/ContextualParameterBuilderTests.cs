...
namespace Azure.Generator.Mgmt.Tests.Utilities
{
    public class ContextualParameterBuilderTests
    {
        ...
        [TestCase]
        public void ValidateContextualParameters_ChildResourceOfResourceGroupResource()
        {
        ...
        [TestCase]
        public void ValidateContextualParameters_ThreeLayersOfChildResourcesUnderResourceGroup()
        {
