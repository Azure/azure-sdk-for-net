...
namespace Azure.Generator.Management.Visitors
{
    internal class FlattenPropertyVisitor : ScmLibraryVisitor
    {
        ...
        /// <summary>
        /// Replaces flattened 'properties' bag parameters with their individual sub-parameters in-place.
        /// This preserves the FullConstructor's relative parameter order, which is critical for
        /// backward-compat overloads: the base framework's BuildMethodsForBackCompatibility (which
        /// runs after all visitors) builds forwarding-call arguments by iterating the primary method's
        /// current parameters. By keeping the same relative order, the forwarding-call arguments
        /// naturally align with the primary method's parameter positions.
        /// </summary>
