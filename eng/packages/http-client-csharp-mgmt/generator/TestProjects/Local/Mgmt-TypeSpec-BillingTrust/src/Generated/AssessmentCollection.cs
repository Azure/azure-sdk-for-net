...
namespace Azure.Generator.MgmtTypeSpec.BillingTrust.Tests
{
    ...
    public partial class AssessmentCollection : ArmCollection, IEnumerable<AssessmentResource>, IAsyncEnumerable<AssessmentResource>
    {
        ...
        internal AssessmentCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _assessmentsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.BillingTrust.Tests", AssessmentResource.ResourceType.Namespace, Diagnostics);
