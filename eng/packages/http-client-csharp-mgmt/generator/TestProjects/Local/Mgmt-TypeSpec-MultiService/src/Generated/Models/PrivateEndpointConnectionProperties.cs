...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests.Models
{
    ...
    public partial class PrivateEndpointConnectionProperties
    {
        ...
        public PrivateEndpointConnectionProperties(AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateLinkServiceConnectionState privateLinkServiceConnectionState)
        {
        ...
        internal PrivateEndpointConnectionProperties(IReadOnlyList<string> groupIds, SubResource privateEndpoint, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateLinkServiceConnectionState privateLinkServiceConnectionState, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GroupIds = groupIds;
        ...
        public AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState { get; set; }

        /// <summary> The provisioning state of the private endpoint connection resource. </summary>
        [WirePath("provisioningState")]
        public AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionProvisioningState? ProvisioningState { get; }
    }
}
