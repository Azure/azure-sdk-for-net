...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class EndpointResourceCollection : ArmCollection, IEnumerable<EndpointResource>, IAsyncEnumerable<EndpointResource>
    {
        ...
        internal EndpointResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _endpointResourcesClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", EndpointResource.ResourceType.Namespace, Diagnostics);
