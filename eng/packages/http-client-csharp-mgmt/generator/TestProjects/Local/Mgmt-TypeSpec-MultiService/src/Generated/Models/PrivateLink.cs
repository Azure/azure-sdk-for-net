...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests.Models
{
    ...
    public partial class PrivateLink : ResourceData
    {
        ...
        internal PrivateLink(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateLinkResourceProperties properties, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        public AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateLinkResourceProperties Properties { get; }
