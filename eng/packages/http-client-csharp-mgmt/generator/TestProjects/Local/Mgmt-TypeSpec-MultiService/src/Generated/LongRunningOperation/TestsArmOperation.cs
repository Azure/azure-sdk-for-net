...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class TestsArmOperation : ArmOperation
    {
        ...
        internal TestsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
