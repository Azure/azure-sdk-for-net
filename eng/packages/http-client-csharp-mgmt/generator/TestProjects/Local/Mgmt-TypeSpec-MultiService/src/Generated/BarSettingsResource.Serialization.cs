...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class BarSettingsResource : IJsonModel<BarSettingsResourceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BarSettingsResourceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<BarSettingsResourceData>(Data, options, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BarSettingsResourceData IPersistableModel<BarSettingsResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<BarSettingsResourceData>(data, options, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);
