...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class PrivateEndpointConnectionCollection : ArmCollection
    {
        ...
        internal PrivateEndpointConnectionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", PrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<PrivateEndpointConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string privateEndpointConnectionName, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateEndpointConnectionsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="privateEndpointConnectionName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="privateEndpointConnectionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<PrivateEndpointConnectionResource> CreateOrUpdate(WaitUntil waitUntil, string privateEndpointConnectionName, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(privateEndpointConnectionName, nameof(privateEndpointConnectionName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<PrivateEndpointConnectionResource>> GetAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData> response = Response.FromValue(AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData)null, result);
                        break;
                    default:
