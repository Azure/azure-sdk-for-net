...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class PrivateEndpointConnectionResource : ArmResource
    {
        ...
        private readonly AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData _data;
        ...
        internal PrivateEndpointConnectionResource(ArmClient client, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal PrivateEndpointConnectionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", ResourceType.Namespace, Diagnostics);
        ...
        public virtual AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<ArmOperation<PrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateEndpointConnectionsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData.ToRequestContent(data), context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<PrivateEndpointConnectionResource> Update(WaitUntil waitUntil, AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
