...
{
    internal partial class BestPracticesGetAllAsyncCollectionResultOfT : AsyncPageable<BestPracticeData>
    {
        ...
        public override async IAsyncEnumerable<Page<BestPracticeData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<BestPracticeData>.FromValues((IReadOnlyList<BestPracticeData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
