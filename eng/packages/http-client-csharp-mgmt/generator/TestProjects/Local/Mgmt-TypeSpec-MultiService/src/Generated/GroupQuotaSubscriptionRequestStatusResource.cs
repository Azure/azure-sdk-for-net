...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class GroupQuotaSubscriptionRequestStatusResource : ArmResource
    {
        ...
        internal GroupQuotaSubscriptionRequestStatusResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _groupQuotaSubscriptionRequestStatusesClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", ResourceType.Namespace, Diagnostics);
