...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class SubscriptionQuotaAllocationsListCollection : ArmCollection
    {
        ...
        internal SubscriptionQuotaAllocationsListCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _subscriptionQuotaAllocationsListsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", SubscriptionQuotaAllocationsListResource.ResourceType.Namespace, Diagnostics);
