...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsSubscriptionResource : ArmResource
    {
        ...
        private ClientDiagnostics _gadgetsClientDiagnostics;
        private Gadgets _gadgetsRestClient;
        private ClientDiagnostics _mgmtTypeSpecCombinedClientClientDiagnostics;
        private MgmtTypeSpecCombinedClient _mgmtTypeSpecCombinedClientRestClient;
        ...
        private ClientDiagnostics FoosClientDiagnostics => _foosClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);

        private Foos FoosRestClient => _foosRestClient ??= new Foos(FoosClientDiagnostics, Pipeline, Endpoint, "2024-05-01");

        private ClientDiagnostics BazsClientDiagnostics => _bazsClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);

        private Bazs BazsRestClient => _bazsRestClient ??= new Bazs(BazsClientDiagnostics, Pipeline, Endpoint, "2024-05-01");

        private ClientDiagnostics ZoosClientDiagnostics => _zoosClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);

        private Zoos ZoosRestClient => _zoosRestClient ??= new Zoos(ZoosClientDiagnostics, Pipeline, Endpoint, "2024-05-01");

        private ClientDiagnostics ClustersClientDiagnostics => _clustersClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics GadgetsClientDiagnostics => _gadgetsClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);

        private Gadgets GadgetsRestClient => _gadgetsRestClient ??= new Gadgets(GadgetsClientDiagnostics, Pipeline, Endpoint, "2024-06-01");

        private ClientDiagnostics MgmtTypeSpecCombinedClientClientDiagnostics => _mgmtTypeSpecCombinedClientClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);

        private MgmtTypeSpecCombinedClient MgmtTypeSpecCombinedClientRestClient => _mgmtTypeSpecCombinedClientRestClient ??= new MgmtTypeSpecCombinedClient(MgmtTypeSpecCombinedClientClientDiagnostics, Pipeline, Endpoint, "2024-05-01");

        private ClientDiagnostics SAPVirtualInstancesClientDiagnostics => _sapVirtualInstancesClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/providers/MgmtTypeSpec/gadgets. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Gadgets_ListBySubscription. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        ...
        public virtual AsyncPageable<GadgetResource> GetGadgetsAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AsyncPageableWrapper<GadgetData, GadgetResource>(new GadgetsGetBySubscriptionAsyncCollectionResultOfT(GadgetsRestClient, Guid.Parse(Id.SubscriptionId), context), data => new GadgetResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="GadgetResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<GadgetResource> GetGadgets(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PageableWrapper<GadgetData, GadgetResource>(new GadgetsGetBySubscriptionCollectionResultOfT(GadgetsRestClient, Guid.Parse(Id.SubscriptionId), context), data => new GadgetResource(Client, data));
        }
        ...
        public virtual async Task<Response<FooPreviewAction>> PreviewActionsAsync(AzureLocation location, FooPreviewAction body, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = MgmtTypeSpecCombinedClientClientDiagnostics.CreateScope("MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsSubscriptionResource.PreviewActions");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = MgmtTypeSpecCombinedClientRestClient.CreatePreviewActionsRequest(Guid.Parse(Id.SubscriptionId), location, FooPreviewAction.ToRequestContent(body), context);
        ...
        public virtual async Task<Response<SAPAvailabilityZoneDetailsResult>> GetAvailabilityZoneDetailsAsync(AzureLocation location, SAPAvailabilityZoneDetailsRequest content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = SAPVirtualInstancesClientDiagnostics.CreateScope("MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsSubscriptionResource.GetAvailabilityZoneDetails");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
