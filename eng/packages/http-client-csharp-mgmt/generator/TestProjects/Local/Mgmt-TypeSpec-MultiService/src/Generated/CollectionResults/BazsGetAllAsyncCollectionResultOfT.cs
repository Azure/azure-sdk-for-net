...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class BazsGetAllAsyncCollectionResultOfT : AsyncPageable<BazData>
    {
        ...
        /// <summary> Initializes a new instance of BazsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BazsGetAllAsyncCollectionResultOfT(Bazs client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BazsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BazsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
