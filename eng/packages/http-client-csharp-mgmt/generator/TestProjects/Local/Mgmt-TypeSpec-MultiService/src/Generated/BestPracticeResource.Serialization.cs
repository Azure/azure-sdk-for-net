...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class BestPracticeResource : IJsonModel<BestPracticeData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BestPracticeData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<BestPracticeData>(Data, options, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BestPracticeData IPersistableModel<BestPracticeData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<BestPracticeData>(data, options, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);
