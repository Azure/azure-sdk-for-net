...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class WorkloadNetworkVmGroups
    {
        ...
        internal HttpMessage CreateUpdateVmGroupRequest(Guid subscriptionId, string resourceGroupName, string vmGroupId, RequestContent content, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
