...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsManagementGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsManagementGroupResource for mocking. </summary>
        protected MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsManagementGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsManagementGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsManagementGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
