...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class BarsGetAllCollectionResultOfT : Pageable<BarData>
    {
        ...
        public BarsGetAllCollectionResultOfT(Bars client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
