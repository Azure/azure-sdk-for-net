...
{
    internal partial class ServiceGroupSitesGetByServiceGroupCollectionResultOfT : Pageable<ServiceGroupSiteData>
    {
        private readonly ServiceGroupSites _client;
        private readonly string _servicegroupName;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of ServiceGroupSitesGetByServiceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ServiceGroupSitesGetByServiceGroupCollectionResultOfT(ServiceGroupSites client, string servicegroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ServiceGroupSitesGetByServiceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ServiceGroupSitesGetByServiceGroupCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ServiceGroupSiteData>> AsPages(string continuationToken, int? pageSizeHint)
        {
