...
{
    internal partial class FooResourceGetPropertiesCollectionResultOfT : Pageable<FooProperties>
    {
        ...
        /// <summary> Initializes a new instance of FooResourceGetPropertiesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FooResourceGetPropertiesCollectionResultOfT(Foos client, Guid subscriptionId, string resourceGroupName, string fooName, RequestContent content, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FooResourceGetPropertiesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FooResourceGetPropertiesCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<FooProperties>> AsPages(string continuationToken, int? pageSizeHint)
        {
