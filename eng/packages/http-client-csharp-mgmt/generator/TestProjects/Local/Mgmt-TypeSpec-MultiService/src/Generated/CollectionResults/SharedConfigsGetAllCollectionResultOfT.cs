...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class SharedConfigsGetAllCollectionResultOfT : Pageable<SharedConfigData>
    {
        ...
        /// <summary> Initializes a new instance of SharedConfigsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The SharedConfigs client used to send requests. </param>
        ...
        /// <summary> Gets the pages of SharedConfigsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SharedConfigsGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<SharedConfigData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("SharedConfigCollection.GetAll");
            scope.Start();
            try
            {
