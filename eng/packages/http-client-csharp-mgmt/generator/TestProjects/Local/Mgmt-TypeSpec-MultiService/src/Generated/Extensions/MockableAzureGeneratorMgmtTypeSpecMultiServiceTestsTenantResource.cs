...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsTenantResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsTenantResource for mocking. </summary>
        protected MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsTenantResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsTenantResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsTenantResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics NetworkProviderActionsClientDiagnostics => _networkProviderActionsClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<NetworkSiblingSet>> QueryNetworkSiblingSetAsync(WaitUntil waitUntil, QueryNetworkSiblingSetRequest content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = NetworkProviderActionsClientDiagnostics.CreateScope("MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsTenantResource.QueryNetworkSiblingSet");
            scope.Start();
            try
            {
