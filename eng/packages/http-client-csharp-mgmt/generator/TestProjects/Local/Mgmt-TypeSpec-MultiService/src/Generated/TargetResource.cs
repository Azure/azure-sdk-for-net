...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="TargetResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetTargets method.
    /// </summary>
    public partial class TargetResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of TargetResource for mocking. </summary>
        protected TargetResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="TargetResource"/> class. </summary>
        ...
        internal TargetResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _targetsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{parentProviderNamespace}/{parentResourceType}/{parentResourceName}/providers/MgmtTypeSpec/targets/{targetName}";
        ...
        {
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("TargetResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("TargetResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation<TargetResource>> UpdateAsync(WaitUntil waitUntil, TargetData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("TargetResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                TestsArmOperation<TargetResource> operation = new TestsArmOperation<TargetResource>(Response.FromValue(new TargetResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
                {
