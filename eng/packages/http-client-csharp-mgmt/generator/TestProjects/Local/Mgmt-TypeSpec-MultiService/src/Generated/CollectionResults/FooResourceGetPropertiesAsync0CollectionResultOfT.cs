...
{
    internal partial class FooResourceGetPropertiesAsync0CollectionResultOfT : AsyncPageable<FooProperties>
    {
        ...
        /// <summary> Initializes a new instance of FooResourceGetPropertiesAsync0CollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FooResourceGetPropertiesAsync0CollectionResultOfT(Foos client, Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FooResourceGetPropertiesAsync0CollectionResultOfT as an enumerable collection. </summary>
