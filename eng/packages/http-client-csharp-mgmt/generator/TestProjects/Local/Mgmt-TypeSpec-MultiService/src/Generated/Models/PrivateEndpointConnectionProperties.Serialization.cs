...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests.Models
{
    ...
    public partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateLinkServiceConnectionState privateLinkServiceConnectionState = default;
            AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionProvisioningState? provisioningState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("privateEndpoint"u8))
                {
                    ...
                    privateEndpoint = ModelReaderWriter.Read<SubResource>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);
                    continue;
                }
                if (prop.NameEquals("privateLinkServiceConnectionState"u8))
                {
                    privateLinkServiceConnectionState = AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateLinkServiceConnectionState.DeserializeAzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new AzureGeneratorMgmtTypeSpecMultiServiceTestsPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
