...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class FooResourceGetDependenciesCollectionResultOfT : Pageable<FooDependency>
    {
        ...
        private static IReadOnlyList<FooDependency> ParseArrayFromResponse(Response response)
        {
            ...
            {
                result.Add(ModelReaderWriter.Read<FooDependency>(new BinaryData(Encoding.UTF8.GetBytes(element.GetRawText())), ModelSerializationExtensions.WireOptions, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default));
            }
            return result;
        }
    }
