    ...
    public partial class FooProperties : IJsonModel<FooProperties>
    {
        ...
        internal static FooProperties DeserializeFooProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    something = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("writableSubResourceProp"u8))
                {
                    ...
                    writableSubResourceProp = ModelReaderWriter.Read<WritableSubResource>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);
                    continue;
                }
