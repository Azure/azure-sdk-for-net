        ...
        internal static ZooData DeserializeZooData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("extendedLocation"u8))
                {
                    ...
                    extendedLocation = ModelReaderWriter.Read<ExtendedLocation>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
