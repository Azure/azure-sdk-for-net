...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsArmClient : ArmResource
    {
        ...
        private ClientDiagnostics CheckNameAvailabilityOperationGroupClientDiagnostics => _checkNameAvailabilityOperationGroupClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics ScheduledActionExtensionClientDiagnostics => _scheduledActionExtensionClientDiagnostics ??= new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        /// <summary> Gets an object representing a <see cref="GadgetResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="GadgetResource"/> object. </returns>
        public virtual GadgetResource GetGadgetResource(ResourceIdentifier id)
        {
            GadgetResource.ValidateResourceId(id);
            return new GadgetResource(Client, id);
        }
        ...
        public virtual async Task<Response<CheckNameAvailabilityResponse>> CheckNameAvailabilityAsync(ResourceIdentifier scope, CheckNameAvailabilityRequest content = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope0 = CheckNameAvailabilityOperationGroupClientDiagnostics.CreateScope("MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsArmClient.CheckNameAvailability");
            scope0.Start();
            try
            {
