    ...
    internal partial class PrivateLinksGetAllPrivateLinkResourcesAsyncCollectionResultOfT : AsyncPageable<PrivateLink>
    {
        ...
        public override async IAsyncEnumerable<Page<PrivateLink>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<PrivateLink>.FromValues((IReadOnlyList<PrivateLink>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsResourceGroupResource.GetAllPrivateLinkResources");
            scope.Start();
            try
            {
