...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class SAPVirtualInstanceCollection : ArmCollection
    {
        ...
        internal SAPVirtualInstanceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sapVirtualInstancesClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", SAPVirtualInstanceResource.ResourceType.Namespace, Diagnostics);
