...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class GroupQuotaLimitListResource : IJsonModel<GroupQuotaLimitListData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GroupQuotaLimitListData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<GroupQuotaLimitListData>(Data, options, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GroupQuotaLimitListData IPersistableModel<GroupQuotaLimitListData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<GroupQuotaLimitListData>(data, options, AzureGeneratorMgmtTypeSpecMultiServiceTestsContext.Default);
