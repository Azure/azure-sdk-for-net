...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class BestPracticeVersionCollection : ArmCollection, IEnumerable<BestPracticeVersionResource>, IAsyncEnumerable<BestPracticeVersionResource>
    {
        ...
        internal BestPracticeVersionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _bestPracticeVersionsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", BestPracticeVersionResource.ResourceType.Namespace, Diagnostics);
