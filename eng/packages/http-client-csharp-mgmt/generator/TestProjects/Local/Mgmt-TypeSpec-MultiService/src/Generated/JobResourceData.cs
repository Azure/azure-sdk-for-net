...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class JobResourceData : TrackedResourceData
    {
        ...
        internal JobResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, JobProperties properties) : base(id, name, resourceType, systemData, tags, location)
        {
