...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class SelfHelpResourceCollection : ArmCollection
    {
        ...
        internal SelfHelpResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _solutionResourcesClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", SelfHelpResource.ResourceType.Namespace, Diagnostics);
