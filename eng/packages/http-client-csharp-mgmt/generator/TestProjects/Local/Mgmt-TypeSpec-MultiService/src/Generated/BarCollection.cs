    ...
    public partial class BarCollection : ArmCollection, IEnumerable<BarResource>, IAsyncEnumerable<BarResource>
    {
        ...
        public virtual async Task<Response<BarResource>> GetAsync(string barName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _barsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, barName, context);
        ...
        /// <summary>
        /// List Bar resources by resource group
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/ServiceOne/bars. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        ...
        public virtual AsyncPageable<BarResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<BarData, BarResource>(new BarsGetAllAsyncCollectionResultOfT(_barsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new BarResource(Client, data));
        }
        ...
        public virtual Pageable<BarResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<BarData, BarResource>(new BarsGetAllCollectionResultOfT(_barsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new BarResource(Client, data));
        }
