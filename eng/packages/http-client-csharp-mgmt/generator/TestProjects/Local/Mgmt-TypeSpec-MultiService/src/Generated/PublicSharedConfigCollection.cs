...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class PublicSharedConfigCollection : ArmCollection, IEnumerable<PublicSharedConfigResource>, IAsyncEnumerable<PublicSharedConfigResource>
    {
        ...
        internal PublicSharedConfigCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _publicSharedConfigsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", PublicSharedConfigResource.ResourceType.Namespace, Diagnostics);
