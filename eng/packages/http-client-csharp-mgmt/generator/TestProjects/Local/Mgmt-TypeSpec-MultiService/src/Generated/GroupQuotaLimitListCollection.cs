...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class GroupQuotaLimitListCollection : ArmCollection
    {
        ...
        internal GroupQuotaLimitListCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _groupQuotaLimitListsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", GroupQuotaLimitListResource.ResourceType.Namespace, Diagnostics);
