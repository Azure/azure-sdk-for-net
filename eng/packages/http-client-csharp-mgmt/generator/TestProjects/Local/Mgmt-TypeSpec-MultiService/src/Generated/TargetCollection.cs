...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class TargetCollection : ArmCollection, IEnumerable<TargetResource>, IAsyncEnumerable<TargetResource>
    {
        ...
        /// <summary> Initializes a new instance of TargetCollection for mocking. </summary>
        protected TargetCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="TargetCollection"/> class. </summary>
        ...
        internal TargetCollection(ArmClient client, ResourceIdentifier id, string parentProviderNamespace, string parentResourceType, string parentResourceName) : base(client, id)
        {
            ...
            _targetsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", TargetResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<TargetResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string targetName, TargetData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("TargetCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _targetsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, _parentProviderNamespace, _parentResourceType, _parentResourceName, targetName, TargetData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<TargetResource>> GetAsync(string targetName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("TargetCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{parentProviderNamespace}/{parentResourceType}/{parentResourceName}/providers/MgmtTypeSpec/targets. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        ...
        public virtual AsyncPageable<TargetResource> GetAllAsync(string continuationToken = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="TargetResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<TargetResource> GetAll(string continuationToken = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string targetName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("TargetCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                {
                    case 200:
                        response = Response.FromValue(TargetData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((TargetData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<TargetResource>> GetIfExistsAsync(string targetName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _targetsClientDiagnostics.CreateScope("TargetCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
