...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class StorageSyncServiceCollection : ArmCollection
    {
        ...
        internal StorageSyncServiceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _storageSyncServicesClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", StorageSyncServiceResource.ResourceType.Namespace, Diagnostics);
