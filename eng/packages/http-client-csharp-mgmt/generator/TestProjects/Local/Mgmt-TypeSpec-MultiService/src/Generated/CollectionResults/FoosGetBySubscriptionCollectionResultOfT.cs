...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class FoosGetBySubscriptionCollectionResultOfT : Pageable<FooData>
    {
        ...
        /// <summary> Initializes a new instance of FoosGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of FoosGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableAzureGeneratorMgmtTypeSpecMultiServiceTestsSubscriptionResource.GetFoos");
            scope.Start();
            try
            {
