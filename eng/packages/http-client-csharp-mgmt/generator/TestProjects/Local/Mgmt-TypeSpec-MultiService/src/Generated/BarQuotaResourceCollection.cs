...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    public partial class BarQuotaResourceCollection : ArmCollection
    {
        ...
        internal BarQuotaResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _barQuotaOperationsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", BarQuotaResource.ResourceType.Namespace, Diagnostics);
