    ...
    internal partial class PropertyOverrideCreateProperties : PropertyOverrideBaseProperties, IJsonModel<PropertyOverrideCreateProperties>
    {
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PropertyOverrideCreateProperties)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PropertyOverrideCreateProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PropertyOverrideCreateProperties)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PropertyOverrideCreateProperties IJsonModel<PropertyOverrideCreateProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PropertyOverrideCreateProperties)JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override PropertyOverrideBaseProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PropertyOverrideCreateProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PropertyOverrideCreateProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PropertyOverrideCreateProperties DeserializePropertyOverrideCreateProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new PropertyOverrideCreateProperties(baseOnlyProperty, overridableProperty, additionalBinaryDataProperties);
        }
    }
}
