...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class PlaywrightQuotasGetBySubscriptionCollectionResultOfT : Pageable<PlaywrightQuotaData>
    {
        ...
        /// <returns> The pages of PlaywrightQuotasGetBySubscriptionCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<PlaywrightQuotaData>> AsPages(string continuationToken, int? pageSizeHint)
        {
