...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="BestPracticeResource"/> using the GetBestPracticeVersions method.
    /// </summary>
    public partial class BestPracticeVersionResource : ArmResource
    {
        ...
        internal BestPracticeVersionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _bestPracticeVersionsClientDiagnostics = new ClientDiagnostics("Azure.Generator.MgmtTypeSpec.MultiService.Tests", ResourceType.Namespace, Diagnostics);
