...
namespace Azure.Generator.MgmtTypeSpec.MultiService.Tests
{
    internal partial class BarsGetAllAsyncCollectionResultOfT : AsyncPageable<BarData>
    {
        ...
        public BarsGetAllAsyncCollectionResultOfT(Bars client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
