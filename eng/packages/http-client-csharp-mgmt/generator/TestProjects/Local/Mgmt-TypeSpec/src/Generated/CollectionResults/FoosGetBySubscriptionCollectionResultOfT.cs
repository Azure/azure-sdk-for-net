...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class FoosGetBySubscriptionCollectionResultOfT : Pageable<FooData>
    {
        ...
        public FoosGetBySubscriptionCollectionResultOfT(Foos client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
