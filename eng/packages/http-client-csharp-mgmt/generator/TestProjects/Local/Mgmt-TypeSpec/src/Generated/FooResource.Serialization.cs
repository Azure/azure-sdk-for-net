...
namespace Azure.Generator.MgmtTypeSpec
{
    ...
    public partial class FooResource : IJsonModel<FooData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FooData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<FooData>(Data, options, AzureGeneratorMgmtTypeSpecContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FooData IPersistableModel<FooData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<FooData>(data, options, AzureGeneratorMgmtTypeSpecContext.Default);
