    ...
    public partial class WorkloadNetworkVmGroupResource : ArmResource
    {
        ...
        public virtual async Task<Response<WorkloadNetworkVmGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workloadNetworkVmGroupsRestClient.CreateGetVmGroupRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> WorkloadNetworkVmGroups_DeleteVmGroup. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-05-01. </description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workloadNetworkVmGroupsRestClient.CreateDeleteVmGroupRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                TestsArmOperation operation = new TestsArmOperation(_workloadNetworkVmGroupsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
