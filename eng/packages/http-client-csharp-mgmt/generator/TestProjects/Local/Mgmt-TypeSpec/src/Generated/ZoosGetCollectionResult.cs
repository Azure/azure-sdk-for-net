...
{
    internal partial class ZoosGetCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of ZoosGetCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ZoosGetCollectionResult(Zoos client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of ZoosGetCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ZoosGetCollectionResult as an enumerable collection. </returns>
