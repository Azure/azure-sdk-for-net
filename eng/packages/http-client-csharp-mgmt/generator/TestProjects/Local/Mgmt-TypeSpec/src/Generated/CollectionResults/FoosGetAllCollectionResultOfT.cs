...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class FoosGetAllCollectionResultOfT : Pageable<FooData>
    {
        ...
        public FoosGetAllCollectionResultOfT(FoosRestOperations client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
