...
{
    internal partial class ZoosGetAllAsyncCollectionResultOfT : AsyncPageable<ZooData>
    {
        ...
        public ZoosGetAllAsyncCollectionResultOfT(Zoos client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
