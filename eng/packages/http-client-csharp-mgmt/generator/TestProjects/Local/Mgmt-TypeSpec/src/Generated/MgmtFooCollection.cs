...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class MgmtFooCollection : ArmCollection, IEnumerable<MgmtFooResource>, IAsyncEnumerable<MgmtFooResource>
    {
        ...
        public virtual AsyncPageable<MgmtFooResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<MgmtFooData, MgmtFooResource>(new FoosGetAllAsyncCollectionResultOfT(_foosRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "MgmtFooCollection.GetAll"), data => new MgmtFooResource(Client, data));
        }
        ...
        public virtual Pageable<MgmtFooResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<MgmtFooData, MgmtFooResource>(new FoosGetAllCollectionResultOfT(_foosRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "MgmtFooCollection.GetAll"), data => new MgmtFooResource(Client, data));
        }
