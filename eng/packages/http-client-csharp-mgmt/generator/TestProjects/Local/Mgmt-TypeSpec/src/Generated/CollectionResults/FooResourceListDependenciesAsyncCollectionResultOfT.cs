...
{
    internal partial class FooResourceListDependenciesAsyncCollectionResultOfT : AsyncPageable<FooDependency>
    {
        ...
        /// <summary> Initializes a new instance of FooResourceListDependenciesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FooResourceListDependenciesAsyncCollectionResultOfT(Foos client, Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FooResourceListDependenciesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FooResourceListDependenciesAsyncCollectionResultOfT as an enumerable collection. </returns>
