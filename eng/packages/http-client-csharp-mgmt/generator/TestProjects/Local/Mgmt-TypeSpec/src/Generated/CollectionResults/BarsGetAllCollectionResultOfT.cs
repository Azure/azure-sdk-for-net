...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class BarsGetAllCollectionResultOfT : Pageable<BarData>
    {
        ...
        public BarsGetAllCollectionResultOfT(Bars client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
