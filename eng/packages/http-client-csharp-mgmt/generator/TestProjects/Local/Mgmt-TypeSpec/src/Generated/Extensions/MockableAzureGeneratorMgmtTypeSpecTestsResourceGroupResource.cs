...
namespace Azure.Generator.MgmtTypeSpec.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecTestsResourceGroupResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of EnvelopePropertyTests in the <see cref="ResourceGroupResource"/>. </summary>
        ...
        public virtual EnvelopePropertyTestCollection GetEnvelopePropertyTests()
        {
            return GetCachedClient(client => new EnvelopePropertyTestCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<EnvelopePropertyTestResource>> GetEnvelopePropertyTestAsync(string envelopePropertyTestName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(envelopePropertyTestName, nameof(envelopePropertyTestName));

            return await GetEnvelopePropertyTests().GetAsync(envelopePropertyTestName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="envelopePropertyTestName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<EnvelopePropertyTestResource> GetEnvelopePropertyTest(string envelopePropertyTestName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(envelopePropertyTestName, nameof(envelopePropertyTestName));

            return GetEnvelopePropertyTests().Get(envelopePropertyTestName, cancellationToken);
        }
