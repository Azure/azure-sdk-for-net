...
namespace Azure.Generator.MgmtTypeSpec.Tests.Models
{
    ...
    public partial class AssessmentProperties : IJsonModel<AssessmentProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WritePropertyName("ruleTemplateId"u8);
            writer.WriteStringValue(RuleTemplateId);
        ...
        internal static AssessmentProperties DeserializeAssessmentProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("ruleTemplateId"u8))
                {
                    ruleTemplateId = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new AssessmentProperties(provisioningState, ruleTemplateId, additionalBinaryDataProperties);
        }
    }
}
