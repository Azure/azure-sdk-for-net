...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class BestPracticeVersionResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the BestPracticeVersion.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /providers/MgmtTypeSpec/bestPractices/{bestPracticeName}/versions/{versionName}. </description>
        ...
        public virtual async Task<ArmOperation<BestPracticeVersionResource>> UpdateAsync(WaitUntil waitUntil, BestPracticeData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _bestPracticeVersionsRestClient.CreateCreateOrUpdateRequest(Id.Parent.Name, Id.Name, BestPracticeData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BestPracticeData> response = Response.FromValue(BestPracticeData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<BestPracticeVersionResource> Update(WaitUntil waitUntil, BestPracticeData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
