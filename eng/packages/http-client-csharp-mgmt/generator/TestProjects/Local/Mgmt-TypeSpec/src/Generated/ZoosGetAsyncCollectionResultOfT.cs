...
{
    internal partial class ZoosGetAsyncCollectionResultOfT : AsyncPageable<ZooData>
    {
        ...
        /// <summary> Initializes a new instance of ZoosGetAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ZoosGetAsyncCollectionResultOfT(Zoos client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of ZoosGetAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ZoosGetAsyncCollectionResultOfT as an enumerable collection. </returns>
