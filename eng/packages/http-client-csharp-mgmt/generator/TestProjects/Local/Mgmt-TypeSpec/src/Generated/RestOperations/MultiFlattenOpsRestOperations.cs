...
{
    /// <summary> The MultiFlattenOpsRestOperations sub-client. </summary>
    internal partial class MultiFlattenOpsRestOperations
    {
        ...
        internal MultiFlattenOpsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of MultiFlattenOpsRestOperations for mocking. </summary>
        protected MultiFlattenOpsRestOperations()
        {
        }
