...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    /// </summary>
    public partial class PolicyAssignmentData : ResourceData, IJsonModel<PolicyAssignmentData>
    {
        ...
        internal static RequestContent ToRequestContent(PolicyAssignmentData policyAssignmentData)
        {
            ...
            return RequestContent.Create(policyAssignmentData, ModelSerializationExtensions.WireOptions);
        }
        ...
        internal static PolicyAssignmentData FromResponse(Response response)
        {
            ...
            return DeserializePolicyAssignmentData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PolicyAssignmentData IJsonModel<PolicyAssignmentData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PolicyAssignmentData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PolicyAssignmentData DeserializePolicyAssignmentData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = PolicyAssignmentProperties.DeserializePolicyAssignmentProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
