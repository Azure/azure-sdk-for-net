...
namespace Azure.Generator.MgmtTypeSpec.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecTestsSubscriptionResource : ArmResource
    {
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/providers/MgmtTypeSpec/locations/{location}/performTestAction. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> MgmtTypeSpec_PerformTestAction. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-05-01. </description>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual async Task<Response<TestActionResponse>> PerformTestActionAsync(AzureLocation location, TestActionResponse body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));

            using DiagnosticScope scope = MgmtTypeSpecClientClientDiagnostics.CreateScope("MockableAzureGeneratorMgmtTypeSpecTestsSubscriptionResource.PerformTestAction");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = MgmtTypeSpecClientRestClient.CreatePerformTestActionRequest(Guid.Parse(Id.SubscriptionId), location, TestActionResponse.ToRequestContent(body), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<TestActionResponse> response = Response.FromValue(TestActionResponse.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual Response<TestActionResponse> PerformTestAction(AzureLocation location, TestActionResponse body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
