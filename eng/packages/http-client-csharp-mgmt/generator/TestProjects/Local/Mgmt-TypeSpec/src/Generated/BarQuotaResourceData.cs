...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class BarQuotaResourceData : ResourceData
    {
        ...
        internal BarQuotaResourceData(ResourceIdentifier id, string name, ResourceType? @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BarQuotaProperties properties) : base(id, name, @type, systemData)
        {
