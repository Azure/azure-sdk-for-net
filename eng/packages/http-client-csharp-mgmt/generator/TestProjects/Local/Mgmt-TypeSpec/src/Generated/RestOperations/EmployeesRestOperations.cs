...
{
    /// <summary> The EmployeesRestOperations sub-client. </summary>
    internal partial class EmployeesRestOperations
    {
        ...
        internal EmployeesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of EmployeesRestOperations for mocking. </summary>
        protected EmployeesRestOperations()
        {
        }
