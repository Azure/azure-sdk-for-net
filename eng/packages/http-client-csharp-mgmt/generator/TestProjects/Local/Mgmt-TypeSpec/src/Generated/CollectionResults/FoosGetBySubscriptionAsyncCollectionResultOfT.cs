...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class FoosGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<FooData>
    {
        ...
        public FoosGetBySubscriptionAsyncCollectionResultOfT(FoosRestOperations client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
