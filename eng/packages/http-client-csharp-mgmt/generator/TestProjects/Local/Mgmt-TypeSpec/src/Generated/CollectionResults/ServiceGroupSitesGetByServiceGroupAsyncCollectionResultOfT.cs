...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class ServiceGroupSitesGetByServiceGroupAsyncCollectionResultOfT : AsyncPageable<ServiceGroupSiteData>
    {
        ...
        /// <summary> Initializes a new instance of ServiceGroupSitesGetByServiceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ServiceGroupSitesGetByServiceGroupAsyncCollectionResultOfT(ServiceGroupSites client, string servicegroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ServiceGroupSitesGetByServiceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ServiceGroupSitesGetByServiceGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<ServiceGroupSiteData>> AsPages(string continuationToken, int? pageSizeHint)
        {
