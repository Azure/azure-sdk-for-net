...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class JobResource : ArmResource
    {
        ...
        internal JobResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _jobResourcesRestClient = new JobResources(_jobResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, jobResourceApiVersion ?? "2024-05-01");
        ...
        public virtual async Task<ArmOperation<JobResource>> UpdateAsync(WaitUntil waitUntil, JobResourceCustomUpdate properties, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _jobResourcesRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, JobResourceCustomUpdate.ToRequestContent(properties), ifMatch, context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public virtual ArmOperation<JobResource> Update(WaitUntil waitUntil, JobResourceCustomUpdate properties, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(properties, nameof(properties));
        ...
        public virtual async Task<ArmOperation<JobResource>> UpdateAsync(WaitUntil waitUntil, JobResourceData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _jobResourcesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, JobResourceData.ToRequestContent(data), matchConditions, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                TestsArmOperation<JobResource> operation = new TestsArmOperation<JobResource>(
                    new JobResourceOperationSource(Client),
                    _jobResourcesClientDiagnostics,
        ...
        public virtual async Task<Response<JobResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    JobResourceCustomUpdate patch = new JobResourceCustomUpdate();
