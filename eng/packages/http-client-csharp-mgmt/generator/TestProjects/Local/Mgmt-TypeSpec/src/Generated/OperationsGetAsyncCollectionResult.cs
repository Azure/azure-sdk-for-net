...
{
    internal partial class OperationsGetAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        private readonly Operations _client;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of OperationsGetAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of OperationsGetAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OperationsGetAsyncCollectionResult as an enumerable collection. </returns>
