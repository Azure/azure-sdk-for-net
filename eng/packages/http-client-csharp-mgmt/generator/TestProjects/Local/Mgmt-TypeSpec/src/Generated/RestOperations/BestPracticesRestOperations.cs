...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class BestPractices
    {
        ...
        internal BestPractices(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(BestPractices).Assembly, applicationId);
        }
