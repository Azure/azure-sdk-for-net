...
{
    /// <summary> Best practice operations on /bestPractices/{bestPracticeName}. </summary>
    internal partial class BestPracticesRestOperations
    {
        ...
        internal BestPracticesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of BestPracticesRestOperations for mocking. </summary>
        protected BestPracticesRestOperations()
        {
        }
