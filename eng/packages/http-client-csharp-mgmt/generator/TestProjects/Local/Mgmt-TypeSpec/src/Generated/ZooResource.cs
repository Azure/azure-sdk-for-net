    ...
    public partial class ZooResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ZooResource>> UpdateAsync(WaitUntil waitUntil, ZooData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _zoosRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ZooData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                TestsArmOperation<ZooResource> operation = new TestsArmOperation<ZooResource>(
                    new ZooResourceOperationSource(Client),
                    _zoosClientDiagnostics,
