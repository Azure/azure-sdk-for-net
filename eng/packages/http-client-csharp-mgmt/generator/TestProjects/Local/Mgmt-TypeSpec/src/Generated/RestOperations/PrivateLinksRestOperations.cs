...
{
    /// <summary> The PrivateLinksRestOperations sub-client. </summary>
    internal partial class PrivateLinksRestOperations
    {
        ...
        internal PrivateLinksRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of PrivateLinksRestOperations for mocking. </summary>
        protected PrivateLinksRestOperations()
        {
        }
