...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class JobResourceData : TrackedResourceData
    {
        ...
        /// <param name="location"> The geo-location where the resource lives. </param>
        /// <param name="properties"> The resource-specific properties for this resource. </param>
        internal JobResourceData(ResourceIdentifier id, string name, ResourceType? @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, JobProperties properties) : base(id, name, @type, systemData, tags, location)
        {
