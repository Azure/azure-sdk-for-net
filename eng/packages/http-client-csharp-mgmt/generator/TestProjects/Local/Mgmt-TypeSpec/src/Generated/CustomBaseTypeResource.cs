...
{
    /// <summary>
    /// A class representing a CustomBaseTypeResource along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="CustomBaseTypeResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetCustomBaseTypeResources method.
    /// </summary>
    public partial class CustomBaseTypeResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of CustomBaseTypeResource for mocking. </summary>
        protected CustomBaseTypeResource()
        {
        }
        ...
        internal CustomBaseTypeResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string customBaseTypeResourceName)
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MgmtTypeSpec/customBaseTypeResources/{customBaseTypeResourceName}";
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="CustomBaseTypeResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CustomBaseTypeResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _customBaseTypeResourcesClientDiagnostics.CreateScope("CustomBaseTypeResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CustomBaseTypeResource> Get(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _customBaseTypeResourcesClientDiagnostics.CreateScope("CustomBaseTypeResource.Get");
            scope.Start();
            try
        ...
        /// <summary>
        /// Update a CustomBaseTypeResource.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MgmtTypeSpec/customBaseTypeResources/{customBaseTypeResourceName}. </description>
        ...
        public virtual async Task<Response<CustomBaseTypeResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));

            using DiagnosticScope scope = _customBaseTypeResourcesClientDiagnostics.CreateScope("CustomBaseTypeResource.AddTag");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<CustomBaseTypeResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
        ...
        public virtual async Task<Response<CustomBaseTypeResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));

            using DiagnosticScope scope = _customBaseTypeResourcesClientDiagnostics.CreateScope("CustomBaseTypeResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<CustomBaseTypeResource> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));
        ...
        public virtual async Task<Response<CustomBaseTypeResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));

            using DiagnosticScope scope = _customBaseTypeResourcesClientDiagnostics.CreateScope("CustomBaseTypeResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<CustomBaseTypeResource> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
