...
namespace Azure.Generator.MgmtTypeSpec.Tests.Models
{
    ...
    public partial class ScheduledActionResources : ResourceData
    {
        ...
        internal ScheduledActionResources(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ScheduledActionsExtensionProperties properties) : base(id, name, resourceType, systemData)
        {
