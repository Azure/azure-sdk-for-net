...
namespace MgmtTypeSpec.Models
{
    ...
    public partial class UserAssignedIdentity : IJsonModel<UserAssignedIdentity>
    {
        ...
        /// <param name="userAssignedIdentity"> The <see cref="UserAssignedIdentity"/> to serialize into <see cref="RequestContent"/>. </param>
        public static implicit operator RequestContent(UserAssignedIdentity userAssignedIdentity)
        {
            ...
            content.JsonWriter.WriteObjectValue(userAssignedIdentity, ModelSerializationExtensions.WireOptions);
            return content;
        }

        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="UserAssignedIdentity"/> from. </param>
        public static explicit operator UserAssignedIdentity(Response result)
        {
            using Response response = result;
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeUserAssignedIdentity(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
