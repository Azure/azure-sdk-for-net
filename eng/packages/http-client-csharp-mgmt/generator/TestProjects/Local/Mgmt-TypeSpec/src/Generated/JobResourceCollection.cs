...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class JobResourceCollection : ArmCollection
    {
        ...
        public virtual async Task<ArmOperation<JobResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string jobName, JobResourceData data, MatchConditions matchConditions, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="jobName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="jobName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<JobResource> CreateOrUpdate(WaitUntil waitUntil, string jobName, JobResourceData data, MatchConditions matchConditions, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(jobName, nameof(jobName));
            Argument.AssertNotNull(data, nameof(data));
