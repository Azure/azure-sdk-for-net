...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class JobResourceCollection : ArmCollection
    {
        ...
        /// <summary>
        /// Creates or updates a job with both If-Match and If-None-Match conditions.
        /// <list type="bullet">
        /// <item>
        ...
        public virtual async Task<ArmOperation<JobResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string jobName, JobResourceData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _jobResourcesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, jobName, JobResourceData.ToRequestContent(data), matchConditions, context);
