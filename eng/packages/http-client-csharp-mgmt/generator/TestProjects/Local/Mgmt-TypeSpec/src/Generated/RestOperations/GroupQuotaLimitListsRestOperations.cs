...
{
    /// <summary> The GroupQuotaLimitListsRestOperations sub-client. </summary>
    internal partial class GroupQuotaLimitListsRestOperations
    {
        ...
        internal GroupQuotaLimitListsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of GroupQuotaLimitListsRestOperations for mocking. </summary>
        protected GroupQuotaLimitListsRestOperations()
        {
        }
