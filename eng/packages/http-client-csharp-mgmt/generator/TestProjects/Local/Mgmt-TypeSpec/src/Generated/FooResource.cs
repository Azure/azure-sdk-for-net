...
namespace MgmtTypeSpec
{
    ...
    public partial class FooResource : ArmResource
    {
        ...
        public virtual ArmOperation<FooResource> Update(WaitUntil waitUntil, FooData properties, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                ;
                HttpMessage message = _foosRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, FooData.ToRequestContent(properties), context);
                Response response = Pipeline.ProcessMessage(message, context);
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public virtual async Task<ArmOperation<FooResource>> UpdateAsync(WaitUntil waitUntil, FooData properties, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(properties, nameof(properties));
        ...
        public virtual async Task<Response<FooResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    ;
                    HttpMessage message = _foosRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
                    Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                    Response<FooData> response = Response.FromValue(FooData.FromResponse(result), result);
                    return Response.FromValue(new FooResource(Client, response.Value), response.GetRawResponse());
                }
