...
namespace Azure.Generator.MgmtTypeSpec.Tests.Models
{
    ...
    public static partial class MgmtTypeSpecTestsModelFactory
    {
        ...
        /// <param name="bytesArrayValue"> Gets the BytesArrayValue. </param>
        ...
        public static FooData FooData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, Uri serviceUri = default, ManagedServiceIdentity something = default, bool? boolValue = default, float? floatValue = default, IEnumerable<BinaryData> bytesArrayValue = default, double? doubleValue = default, IEnumerable<string> prop1 = default, IEnumerable<int> prop2 = default, ETag? etag = default, WritableSubResource writableSubResourceProp = default, FooProperties nestedPropertyProperties = default, IEnumerable<string> flattenedProperty = default, ExtendedLocation extendedLocation = default, ManagedServiceIdentity identity = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
            ...
            return new FooData(
                ...
                tags,
                location,
                serviceUri is null && something is null && boolValue is null && floatValue is null && bytesArrayValue is null && doubleValue is null && prop1 is null && prop2 is null && etag is null && writableSubResourceProp is null && nestedPropertyProperties is null && flattenedProperty is null ? default : new FooProperties(
                    serviceUri,
                    something,
                    boolValue,
                    floatValue,
                    (bytesArrayValue ?? new ChangeTrackingList<BinaryData>()).ToList(),
                    doubleValue,
        ...
        public static FooProperties FooProperties(Uri serviceUri = default, ManagedServiceIdentity something = default, bool? boolValue = default, float? floatValue = default, IEnumerable<BinaryData> bytesArrayValue = default, double? doubleValue = default, IEnumerable<string> prop1 = default, IEnumerable<int> prop2 = default, FooProperties nestedPropertyProperties = default, IEnumerable<string> flattenedProperty = default, ETag? etag = default, WritableSubResource writableSubResourceProp = default)
        {
