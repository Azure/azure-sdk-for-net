...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class Zoos
    {
        ...
        internal HttpMessage CreateGetZooAddressesRequest(Guid subscriptionId, string resourceGroupName, string zooName, int? maxpagesize, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetZooAddressesRequest(Uri nextPage, Guid subscriptionId, string resourceGroupName, string zooName, int? maxpagesize, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            if (nextPage.IsAbsoluteUri)
            {
