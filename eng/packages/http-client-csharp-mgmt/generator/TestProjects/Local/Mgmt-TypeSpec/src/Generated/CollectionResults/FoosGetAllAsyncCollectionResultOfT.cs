...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class FoosGetAllAsyncCollectionResultOfT : AsyncPageable<FooData>
    {
        ...
        public FoosGetAllAsyncCollectionResultOfT(Foos client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
