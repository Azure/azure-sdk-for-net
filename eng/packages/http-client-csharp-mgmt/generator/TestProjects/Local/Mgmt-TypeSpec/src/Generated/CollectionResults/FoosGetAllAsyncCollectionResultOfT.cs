...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class FoosGetAllAsyncCollectionResultOfT : AsyncPageable<FooData>
    {
        ...
        public FoosGetAllAsyncCollectionResultOfT(FoosRestOperations client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
