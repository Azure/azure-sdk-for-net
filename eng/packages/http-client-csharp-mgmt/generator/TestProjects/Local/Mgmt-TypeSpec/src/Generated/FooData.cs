...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class FooData : TrackedResourceData
    {
        ...
        internal FooData(ResourceIdentifier id, string name, ResourceType? @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, FooProperties properties, ExtendedLocation extendedLocation) : base(id, name, @type, systemData, tags, location)
        {
