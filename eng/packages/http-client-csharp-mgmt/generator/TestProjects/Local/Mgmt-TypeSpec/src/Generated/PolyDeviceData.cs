...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public abstract partial class PolyDeviceData : ResourceData
    {
        ...
        internal PolyDeviceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
