...
namespace MgmtTypeSpec.Models
{
    ...
    internal partial class PrivateLinkResourceListResult
    {
        ...
        internal PrivateLinkResourceListResult(IEnumerable<PrivateLinkResourceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal PrivateLinkResourceListResult(IList<PrivateLinkResourceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<PrivateLinkResourceData> Value { get; }
