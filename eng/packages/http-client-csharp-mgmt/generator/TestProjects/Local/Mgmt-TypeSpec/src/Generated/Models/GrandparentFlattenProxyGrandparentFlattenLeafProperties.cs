...
namespace Azure.Generator.MgmtTypeSpec.Tests.Models
{
    ...
    public partial class GrandparentFlattenProxyGrandparentFlattenLeafProperties : GrandparentFlattenBase
    {
        ...
        internal GrandparentFlattenProxyGrandparentFlattenLeafProperties(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, GrandparentFlattenIdentifier identifier, IDictionary<string, BinaryData> additionalBinaryDataProperties, GrandparentFlattenLeafProperties properties) : base(id, name, resourceType, systemData, identifier, additionalBinaryDataProperties)
        {
