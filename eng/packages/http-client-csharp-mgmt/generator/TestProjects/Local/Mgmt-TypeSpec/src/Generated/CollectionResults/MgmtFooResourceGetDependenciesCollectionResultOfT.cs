...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class FooResourceGetDependenciesCollectionResultOfT : Pageable<FooDependency>
    {
        ...
        public FooResourceGetDependenciesCollectionResultOfT(Foos client, Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context, string diagnosticScope)
        {
            _client = client;
