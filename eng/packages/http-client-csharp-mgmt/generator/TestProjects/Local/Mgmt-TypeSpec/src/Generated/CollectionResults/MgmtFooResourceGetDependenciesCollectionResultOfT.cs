...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class MgmtFooResourceGetDependenciesCollectionResultOfT : Pageable<FooDependency>
    {
        ...
        public MgmtFooResourceGetDependenciesCollectionResultOfT(Foos client, Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context, string diagnosticScope)
        {
            _client = client;
