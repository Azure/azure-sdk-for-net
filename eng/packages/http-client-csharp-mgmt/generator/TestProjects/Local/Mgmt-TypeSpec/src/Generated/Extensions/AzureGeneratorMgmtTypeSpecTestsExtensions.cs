...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public static partial class AzureGeneratorMgmtTypeSpecTestsExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="InternalPropertyModelResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableAzureGeneratorMgmtTypeSpecTestsArmClient.GetInternalPropertyModelResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static InternalPropertyModelResource GetInternalPropertyModelResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableAzureGeneratorMgmtTypeSpecTestsArmClient(client).GetInternalPropertyModelResource(id);
        }
