...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class SelfHelpResourceData : ResourceData
    {
        ...
        internal SelfHelpResourceData(ResourceIdentifier id, string name, ResourceType? @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SelfHelpResourceProperties properties) : base(id, name, @type, systemData)
        {
