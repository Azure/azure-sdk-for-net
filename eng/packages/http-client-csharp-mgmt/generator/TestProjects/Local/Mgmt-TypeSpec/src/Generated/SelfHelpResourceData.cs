...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class SelfHelpResourceData : ResourceData
    {
        ...
        internal SelfHelpResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SelfHelpResourceProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
