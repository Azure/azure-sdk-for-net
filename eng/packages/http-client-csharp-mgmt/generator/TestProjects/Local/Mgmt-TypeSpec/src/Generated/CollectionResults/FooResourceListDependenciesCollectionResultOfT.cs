...
{
    internal partial class FooResourceListDependenciesCollectionResultOfT : Pageable<FooDependency>
    {
        ...
        /// <summary> Initializes a new instance of FooResourceListDependenciesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FooResourceListDependenciesCollectionResultOfT(Foos client, Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FooResourceListDependenciesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FooResourceListDependenciesCollectionResultOfT as an enumerable collection. </returns>
