...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class EndpointResourceData : ResourceData
    {
        ...
        internal EndpointResourceData(ResourceIdentifier id, string name, ResourceType? @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EndpointProperties properties) : base(id, name, @type, systemData)
        {
