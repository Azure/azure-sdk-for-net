    ...
    internal partial class ZoosGetZooAddressesCollectionResultOfT : Pageable<SubResource>
    {
        ...
        public override IEnumerable<Page<SubResource>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ZooAddressListListResult result = ZooAddressListListResult.FromResponse(response);
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetZooAddressesRequest(nextLink, _subscriptionId, _resourceGroupName, _zooName, _maxpagesize, _context) : _client.CreateGetZooAddressesRequest(_subscriptionId, _resourceGroupName, _zooName, _maxpagesize, _context);
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ZooResource.GetZooAddresses");
            scope.Start();
            try
            {
