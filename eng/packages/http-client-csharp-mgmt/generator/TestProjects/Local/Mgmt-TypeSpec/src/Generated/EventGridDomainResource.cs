...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class EventGridDomainResource : ArmResource
    {
        ...
        public static readonly ResourceType ResourceType = "MgmtTypeSpec/eventGridDomains";
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/MgmtTypeSpec/eventGridDomains/{domainName}";
        ...
        {
            using DiagnosticScope scope = _eventGridDomainsClientDiagnostics.CreateScope("EventGridDomainResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _eventGridDomainsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> EventGridDomains_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-05-01. </description>
        ...
        {
            using DiagnosticScope scope = _eventGridDomainsClientDiagnostics.CreateScope("EventGridDomainResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _eventGridDomainsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<EventGridDomainResource>> UpdateAsync(WaitUntil waitUntil, EventGridDomainData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventGridDomainsClientDiagnostics.CreateScope("EventGridDomainResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<EventGridDomainResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventGridDomainsClientDiagnostics.CreateScope("EventGridDomainResource.AddTag");
            scope.Start();
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<EventGridDomainResource> result = await UpdateAsync(WaitUntil.Completed, current, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<EventGridDomainResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    current.Tags[key] = value;
                    ArmOperation<EventGridDomainResource> result = Update(WaitUntil.Completed, current, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<EventGridDomainResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventGridDomainsClientDiagnostics.CreateScope("EventGridDomainResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<EventGridDomainResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _eventGridDomainsClientDiagnostics.CreateScope("EventGridDomainResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
