...
namespace Azure.Generator.MgmtTypeSpec.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecTestsManagementGroupResource : ArmResource
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="groupQuotaName"/> or <paramref name="resourceProviderName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual async Task<Response<SubscriptionQuotaAllocationsListResource>> GetSubscriptionQuotaAllocationsListAsync(string groupQuotaName, string resourceProviderName, AzureLocation location, Guid subscriptionId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupQuotaName, nameof(groupQuotaName));
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));

            return await GetSubscriptionQuotaAllocationsLists().GetAsync(groupQuotaName, resourceProviderName, location, subscriptionId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="groupQuotaName"/> or <paramref name="resourceProviderName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<SubscriptionQuotaAllocationsListResource> GetSubscriptionQuotaAllocationsList(string groupQuotaName, string resourceProviderName, AzureLocation location, Guid subscriptionId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupQuotaName, nameof(groupQuotaName));
            Argument.AssertNotNullOrEmpty(resourceProviderName, nameof(resourceProviderName));

            return GetSubscriptionQuotaAllocationsLists().Get(groupQuotaName, resourceProviderName, location, subscriptionId, cancellationToken);
        }
    }
}
