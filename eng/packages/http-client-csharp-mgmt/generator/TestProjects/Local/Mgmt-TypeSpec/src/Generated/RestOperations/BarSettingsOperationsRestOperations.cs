...
{
    /// <summary> The BarSettingsOperationsRestOperations sub-client. </summary>
    internal partial class BarSettingsOperationsRestOperations
    {
        ...
        internal BarSettingsOperationsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of BarSettingsOperationsRestOperations for mocking. </summary>
        protected BarSettingsOperationsRestOperations()
        {
        }
