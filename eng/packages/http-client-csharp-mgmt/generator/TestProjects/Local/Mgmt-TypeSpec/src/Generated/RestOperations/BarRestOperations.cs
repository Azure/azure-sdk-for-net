...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class Bar
    {
        ...
        internal Bar(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(Bar).Assembly, applicationId);
        }
