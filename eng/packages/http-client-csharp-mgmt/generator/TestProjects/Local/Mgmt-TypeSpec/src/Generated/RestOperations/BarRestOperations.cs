...
{
    /// <summary> The BarRestOperations sub-client. </summary>
    internal partial class BarRestOperations
    {
        ...
        internal BarRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of BarRestOperations for mocking. </summary>
        protected BarRestOperations()
        {
        }
