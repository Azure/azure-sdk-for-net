...
{
    /// <summary> The FoosRestOperations sub-client. </summary>
    internal partial class FoosRestOperations
    {
        ...
        internal FoosRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of FoosRestOperations for mocking. </summary>
        protected FoosRestOperations()
        {
        }
