...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class Foos
    {
        ...
        internal HttpMessage CreateGetPathLengthReproRequest(Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
            ...
            uri.AppendPath("/providers/MgmtTypeSpec/foos/", false);
            uri.AppendPath(fooName, true);
            uri.AppendPath("/retrieveCertificateEmailHistoryPathLengthRepro", false);
            if (_apiVersion != null)
            {
                uri.AppendQuery("api-version", _apiVersion, true);
            }
