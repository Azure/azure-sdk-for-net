...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class Foos
    {
        ...
        internal HttpMessage CreateSplitDependenciesRequest(Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateGetMetadataRequest(Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateGetOperationStatusRequest(Guid subscriptionId, string resourceGroupName, string fooName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
            ...
            uri.AppendPath("/providers/MgmtTypeSpec/foos/", false);
            uri.AppendPath(fooName, true);
            uri.AppendPath("/getOperationStatus", false);
            if (_apiVersion != null)
            {
                uri.AppendQuery("api-version", _apiVersion, true);
            }
