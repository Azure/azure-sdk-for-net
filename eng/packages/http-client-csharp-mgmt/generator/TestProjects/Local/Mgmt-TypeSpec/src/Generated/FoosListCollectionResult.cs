...
{
    internal partial class FoosListCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of FoosListCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public FoosListCollectionResult(Foos client, Uri nextPage, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of FoosListCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FoosListCollectionResult as an enumerable collection. </returns>
