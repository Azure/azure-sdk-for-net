...
namespace Azure.Generator.MgmtTypeSpec.Tests.Models
{
    ...
    public partial class CycleTestConnectionReference : ResourceData
    {
        ...
        internal CycleTestConnectionReference(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CycleTestConnectionProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
