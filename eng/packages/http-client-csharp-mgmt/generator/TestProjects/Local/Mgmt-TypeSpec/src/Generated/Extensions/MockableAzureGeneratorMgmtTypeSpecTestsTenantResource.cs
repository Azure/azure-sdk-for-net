...
namespace Azure.Generator.MgmtTypeSpec.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecTestsTenantResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of BestPracticeVersions in the <see cref="TenantResource"/>. </summary>
        ...
        public virtual async Task<Response<BestPracticeResource>> GetBestPracticeVersionAsync(string bestPracticeName, string versionName, CancellationToken cancellationToken = default)
        {
            ...
            return await GetBestPracticeVersions().GetAsync(bestPracticeName, versionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        public virtual Response<BestPracticeResource> GetBestPracticeVersion(string bestPracticeName, string versionName, CancellationToken cancellationToken = default)
        {
            ...
            return GetBestPracticeVersions().Get(bestPracticeName, versionName, cancellationToken);
        }
