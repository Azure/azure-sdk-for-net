...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class TargetsGetAllAsyncCollectionResultOfT : AsyncPageable<TargetData>
    {
        ...
        public TargetsGetAllAsyncCollectionResultOfT(Targets client, Guid subscriptionId, string resourceGroupName, string parentProviderNamespace, string parentResourceType, string parentResourceName, string continuationToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<TargetData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<TargetData>.FromValues((IReadOnlyList<TargetData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
