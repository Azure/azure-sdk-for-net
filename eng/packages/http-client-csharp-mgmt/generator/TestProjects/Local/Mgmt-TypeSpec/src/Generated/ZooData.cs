...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class ZooData : TrackedResourceData
    {
        ...
        internal ZooData(ResourceIdentifier id, string name, ResourceType? @type, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, ZooProperties properties, ExtendedLocation extendedLocation) : base(id, name, @type, systemData, tags, location)
        {
