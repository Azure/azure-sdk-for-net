...
namespace MgmtTypeSpec
{
    ...
    public partial class BarResource : ArmResource
    {
        ...
        public virtual ArmOperation<BarResource> Update(WaitUntil waitUntil, BarData properties, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                ;
                HttpMessage message = _barsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, BarData.ToRequestContent(properties), context);
                Response response = Pipeline.ProcessMessage(message, context);
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public virtual async Task<ArmOperation<BarResource>> UpdateAsync(WaitUntil waitUntil, BarData properties, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(properties, nameof(properties));
        ...
        public virtual async Task<Response<BarResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    ;
                    HttpMessage message = _barsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                    Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                    Response<BarData> response = Response.FromValue(BarData.FromResponse(result), result);
                    return Response.FromValue(new BarResource(Client, response.Value), response.GetRawResponse());
                }
