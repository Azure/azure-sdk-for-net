...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class BarResource : ArmResource
    {
        ...
        /// <summary> Create a <see cref="BarSettingsResource"/>. </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="data"> The data for creating or updating the BarSettingsResource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<BarSettingsResource>> CreateOrUpdateBarSettingsResourceAsync(WaitUntil waitUntil, BarSettingsResourceData data, CancellationToken cancellationToken = default)
        {
            return await GetBarSettingsResource().CreateOrUpdateAsync(waitUntil, data, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="data"> The data for creating or updating the BarSettingsResource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<BarSettingsResource> CreateOrUpdateBarSettingsResource(WaitUntil waitUntil, BarSettingsResourceData data, CancellationToken cancellationToken = default)
        {
            return GetBarSettingsResource().CreateOrUpdate(waitUntil, data, cancellationToken);
        }
