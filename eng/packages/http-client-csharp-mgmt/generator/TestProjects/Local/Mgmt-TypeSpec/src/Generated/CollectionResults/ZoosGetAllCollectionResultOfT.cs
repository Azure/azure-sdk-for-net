...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class ZoosGetAllCollectionResultOfT : Pageable<ZooData>
    {
        ...
        public ZoosGetAllCollectionResultOfT(ZoosRestOperations client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
