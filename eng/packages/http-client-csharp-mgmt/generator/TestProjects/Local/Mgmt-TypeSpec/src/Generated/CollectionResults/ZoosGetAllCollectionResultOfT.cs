...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class ZoosGetAllCollectionResultOfT : Pageable<ZooData>
    {
        ...
        public ZoosGetAllCollectionResultOfT(Zoos client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
