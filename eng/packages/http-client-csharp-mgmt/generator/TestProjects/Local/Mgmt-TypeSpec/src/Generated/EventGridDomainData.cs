...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    ...
    public partial class EventGridDomainData : TrackedResourceData
    {
        ...
        [WirePath("properties")]
        internal EventGridDomainProperties Properties { get; set; }

        /// <summary> Domain endpoint. </summary>
        [WirePath("properties.endpoint")]
        public string EventGridDomainEndpoint
        {
            get
            {
            ...
            set
            {
                ...
                {
                    Properties = new EventGridDomainProperties();
                }
