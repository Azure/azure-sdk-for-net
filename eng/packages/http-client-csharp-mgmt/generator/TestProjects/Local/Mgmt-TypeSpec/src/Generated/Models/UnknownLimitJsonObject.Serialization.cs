...
namespace Azure.Generator.MgmtTypeSpec.Tests.Models
{
    internal partial class UnknownLimitJsonObject : LimitJsonObject, IJsonModel<LimitJsonObject>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        LimitJsonObject IPersistableModel<LimitJsonObject>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LimitJsonObject IJsonModel<LimitJsonObject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
