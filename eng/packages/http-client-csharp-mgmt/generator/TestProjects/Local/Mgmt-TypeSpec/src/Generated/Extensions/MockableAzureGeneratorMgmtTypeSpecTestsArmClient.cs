...
namespace Azure.Generator.MgmtTypeSpec.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecTestsArmClient : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="SafeFlattenCtorTestResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="SafeFlattenCtorTestResource"/> object. </returns>
        public virtual SafeFlattenCtorTestResource GetSafeFlattenCtorTestResource(ResourceIdentifier id)
        {
            SafeFlattenCtorTestResource.ValidateResourceId(id);
            return new SafeFlattenCtorTestResource(Client, id);
        }
