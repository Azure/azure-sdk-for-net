...
namespace Azure.Generator.MgmtTypeSpec.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecTestsArmClient : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="TestClusterResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="TestClusterResource"/> object. </returns>
        public virtual TestClusterResource GetTestClusterResource(ResourceIdentifier id)
        {
            TestClusterResource.ValidateResourceId(id);
            return new TestClusterResource(Client, id);
        }
