...
namespace Azure.Generator.MgmtTypeSpec.Tests.Mocking
{
    ...
    public partial class MockableAzureGeneratorMgmtTypeSpecTestsArmClient : ArmResource
    {
        ...
        /// <summary> Gets an object representing a <see cref="SolutionsQuerySuffixApplicationDefinitionResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="SolutionsQuerySuffixApplicationDefinitionResource"/> object. </returns>
        public virtual SolutionsQuerySuffixApplicationDefinitionResource GetSolutionsQuerySuffixApplicationDefinitionResource(ResourceIdentifier id)
        {
            SolutionsQuerySuffixApplicationDefinitionResource.ValidateResourceId(id);
            return new SolutionsQuerySuffixApplicationDefinitionResource(Client, id);
        }
