...
{
    /// <summary> The BarsRestOperations sub-client. </summary>
    internal partial class BarsRestOperations
    {
        ...
        internal BarsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        /// <summary> Initializes a new instance of BarsRestOperations for mocking. </summary>
        protected BarsRestOperations()
        {
        }
