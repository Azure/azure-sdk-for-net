...
{
    internal partial class PrivateLinksGetAllPrivateLinkResourcesCollectionResultOfT : Pageable<PrivateLink>
    {
        ...
        public override IEnumerable<Page<PrivateLink>> AsPages(string continuationToken, int? pageSizeHint)
        {
