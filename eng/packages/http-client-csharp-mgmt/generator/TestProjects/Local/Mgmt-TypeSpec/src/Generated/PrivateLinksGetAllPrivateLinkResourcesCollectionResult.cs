...
namespace MgmtTypeSpec
{
    internal partial class PrivateLinksGetAllPrivateLinkResourcesCollectionResult : Pageable<BinaryData>
    {
        ...
        public PrivateLinksGetAllPrivateLinkResourcesCollectionResult(PrivateLinks client, Uri nextPage, Guid subscriptionId, string resourceGroupName, RequestContext context)
        {
