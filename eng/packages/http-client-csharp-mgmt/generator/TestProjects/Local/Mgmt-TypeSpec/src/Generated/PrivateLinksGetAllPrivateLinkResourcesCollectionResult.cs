...
{
    internal partial class PrivateLinksGetAllPrivateLinkResourcesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateLinksGetAllPrivateLinkResourcesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateLinksGetAllPrivateLinkResourcesCollectionResult(PrivateLinks client, Uri nextPage, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PrivateLinksGetAllPrivateLinkResourcesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PrivateLinksGetAllPrivateLinkResourcesCollectionResult as an enumerable collection. </returns>
