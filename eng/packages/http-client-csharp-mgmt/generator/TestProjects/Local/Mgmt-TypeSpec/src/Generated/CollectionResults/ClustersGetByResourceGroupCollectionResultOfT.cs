...
namespace Azure.Generator.MgmtTypeSpec.Tests
{
    internal partial class ClustersGetByResourceGroupCollectionResultOfT : Pageable<ClusterData>
    {
        ...
        public ClustersGetByResourceGroupCollectionResultOfT(ClustersRestOperations client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
