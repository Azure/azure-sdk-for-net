...
{
    internal partial class PagingPostActionPagingAsyncCollectionResultOfT : AsyncPageable<MonitoredResource>
    {
        private readonly Paging _client;
        ...
        /// <summary> Initializes a new instance of PagingPostActionPagingAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Paging client used to send requests. </param>
        ...
        public PagingPostActionPagingAsyncCollectionResultOfT(Paging client, Guid subscriptionId, string resourceGroupName, string monitorName, RequestContent content, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of PagingPostActionPagingAsyncCollectionResultOfT as an enumerable collection. </summary>
