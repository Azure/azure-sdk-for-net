...
namespace Azure.ResourceManager.OperationTemplates.Models
{
    ...
    internal partial class ProductListResult
    {
        ...
        internal ProductListResult(IEnumerable<Product> value)
        {
            Value = value.ToList();
        }
        ...
        internal ProductListResult(IList<Product> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
