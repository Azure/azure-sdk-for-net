    ...
    internal partial class ServiceGroupExtensionResourcesGetByServiceGroupAsyncCollectionResultOfT : AsyncPageable<ServiceGroupExtensionResourceData>
    {
        ...
        public override async IAsyncEnumerable<Page<ServiceGroupExtensionResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ServiceGroupExtensionResourceListResult result = ServiceGroupExtensionResourceListResult.FromResponse(response);
                nextPage = result.NextLink;
                yield return Page<ServiceGroupExtensionResourceData>.FromValues((IReadOnlyList<ServiceGroupExtensionResourceData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
                if (nextPage == null)
                {
                    yield break;
                }
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByServiceGroupRequest(nextLink, _serviceGroupId, _context) : _client.CreateGetByServiceGroupRequest(_serviceGroupId, _context);
