...
namespace Azure.ResourceManager.MultiServiceSharedModels.Combined
{
    ...
    public partial class StorageAccountResource : ArmResource
    {
        ...
        internal StorageAccountResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _storageAccountsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MultiServiceSharedModels.Combined", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<StorageAccountResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<StorageAccountResource> result = await UpdateAsync(WaitUntil.Completed, current, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<StorageAccountResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    current.Tags[key] = value;
                    ArmOperation<StorageAccountResource> result = Update(WaitUntil.Completed, current, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
