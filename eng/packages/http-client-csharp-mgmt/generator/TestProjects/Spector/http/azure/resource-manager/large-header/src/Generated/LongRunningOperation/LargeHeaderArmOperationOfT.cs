...
{
    internal partial class LargeHeaderArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of LargeHeaderArmOperation for mocking. </summary>
        protected LargeHeaderArmOperation()
        {
        }
        ...
        internal LargeHeaderArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal LargeHeaderArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
