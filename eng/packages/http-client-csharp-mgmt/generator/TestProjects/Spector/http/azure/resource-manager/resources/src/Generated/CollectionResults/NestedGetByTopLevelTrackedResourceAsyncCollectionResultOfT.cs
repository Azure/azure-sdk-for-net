...
{
    internal partial class NestedGetByTopLevelTrackedResourceAsyncCollectionResultOfT : AsyncPageable<NestedProxyResourceData>
    {
        private readonly Nested _client;
        ...
        /// <returns> The pages of NestedGetByTopLevelTrackedResourceAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<NestedProxyResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
