...
{
    internal partial class OperationTemplatesArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of OperationTemplatesArmOperation for mocking. </summary>
        protected OperationTemplatesArmOperation()
        {
        }
        ...
        internal OperationTemplatesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal OperationTemplatesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
