...
{
    internal partial class MethodSubscriptionIdArmOperation<T> : ArmOperation<T>
    {
        ...
        internal MethodSubscriptionIdArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MethodSubscriptionIdArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
