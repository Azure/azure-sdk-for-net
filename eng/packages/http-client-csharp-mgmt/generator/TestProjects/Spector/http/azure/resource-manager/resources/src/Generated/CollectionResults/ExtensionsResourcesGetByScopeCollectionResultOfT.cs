...
{
    internal partial class ExtensionsResourcesGetByScopeCollectionResultOfT : Pageable<ExtensionsResourceData>
    {
        ...
        /// <returns> The pages of ExtensionsResourcesGetByScopeCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ExtensionsResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
