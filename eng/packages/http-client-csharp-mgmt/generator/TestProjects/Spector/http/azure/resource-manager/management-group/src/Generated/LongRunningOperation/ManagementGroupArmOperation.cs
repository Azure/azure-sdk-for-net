...
{
    internal partial class ManagementGroupArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of ManagementGroupArmOperation for mocking. </summary>
        protected ManagementGroupArmOperation()
        {
        }
        ...
        internal ManagementGroupArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ManagementGroupArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
