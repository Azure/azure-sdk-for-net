...
{
    internal partial class MethodSubscriptionIdArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of MethodSubscriptionIdArmOperation for mocking. </summary>
        protected MethodSubscriptionIdArmOperation()
        {
        }
        ...
        internal MethodSubscriptionIdArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MethodSubscriptionIdArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(
                ...
                clientDiagnostics,
                response,
                "MethodSubscriptionIdArmOperation",
                null,
