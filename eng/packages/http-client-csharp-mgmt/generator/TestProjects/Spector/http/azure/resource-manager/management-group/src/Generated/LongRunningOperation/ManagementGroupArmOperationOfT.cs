...
{
    internal partial class ManagementGroupArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ManagementGroupArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ManagementGroupArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
