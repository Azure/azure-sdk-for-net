...
namespace Azure.ResourceManager.MultiService.Combined
{
    ...
    public partial class DiskResource : ArmResource
    {
        ...
        internal DiskResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _disksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MultiService.Combined", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<DiskResource>> UpdateAsync(WaitUntil waitUntil, DiskData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<DiskResource> Update(WaitUntil waitUntil, DiskData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<DiskResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<DiskResource> result = await UpdateAsync(WaitUntil.Completed, current, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DiskResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    current.Tags[key] = value;
                    ArmOperation<DiskResource> result = Update(WaitUntil.Completed, current, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
