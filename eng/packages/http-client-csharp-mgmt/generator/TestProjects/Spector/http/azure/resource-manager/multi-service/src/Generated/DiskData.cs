...
namespace Azure.ResourceManager.MultiService.Combined
{
    ...
    public partial class DiskData : TrackedResourceData
    {
        ...
        internal DiskData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, DiskProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public ResourceProvisioningState? DiskProvisioningState
        {
            get
            {
