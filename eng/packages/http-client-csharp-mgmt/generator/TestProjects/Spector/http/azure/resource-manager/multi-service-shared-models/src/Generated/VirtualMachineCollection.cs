...
using Azure.ResourceManager.MultiServiceSharedModels.Compute;
...
namespace Azure.ResourceManager.MultiServiceSharedModels.Combined
{
    ...
    public partial class VirtualMachineCollection : ArmCollection
    {
        ...
        internal VirtualMachineCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _virtualMachinesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MultiServiceSharedModels.Combined", VirtualMachineResource.ResourceType.Namespace, Diagnostics);
            _virtualMachinesRestClient = new VirtualMachines(_virtualMachinesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, virtualMachineApiVersion ?? "2025-05-01");
