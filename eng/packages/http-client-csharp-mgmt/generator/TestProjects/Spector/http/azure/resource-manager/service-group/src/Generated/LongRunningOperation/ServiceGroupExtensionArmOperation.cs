...
{
    internal partial class ServiceGroupExtensionArmOperation : ArmOperation
    {
        ...
        internal ServiceGroupExtensionArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ServiceGroupExtensionArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
