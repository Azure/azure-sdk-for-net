...
namespace Azure.ResourceManager.OperationTemplates.Models
{
    ...
    public partial class MonitorProperties : IJsonModel<MonitorProperties>
    {
        ...
        internal static MonitorProperties DeserializeMonitorProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new MonitorProperties(status, provisioningState, additionalBinaryDataProperties);
        }
    }
}
