...
{
    internal partial class ServiceGroupExtensionArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ServiceGroupExtensionArmOperation for mocking. </summary>
        protected ServiceGroupExtensionArmOperation()
        {
        }
        ...
        internal ServiceGroupExtensionArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ServiceGroupExtensionArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "ServiceGroupExtensionArmOperation",
                null,
