...
{
    internal partial class CombinedArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of CombinedArmOperation for mocking. </summary>
        protected CombinedArmOperation()
        {
        }
        ...
        internal CombinedArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal CombinedArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
