...
namespace Visitors.Tests.TestHelpers
{
    internal class MockHelpers
    {
            ...
            string? inputNamespace = null)
        {
            ...
            Mock<TypeFactory>? mockTypeFactory = null;
            if (createCSharpTypeCore is not null)
            {
                mockTypeFactory = new Mock<TypeFactory>() { CallBase = true };
            ...
            var mockPluginInstance = new Mock<CodeModelGenerator>(mockGeneratorContext.Object) { CallBase = true };
