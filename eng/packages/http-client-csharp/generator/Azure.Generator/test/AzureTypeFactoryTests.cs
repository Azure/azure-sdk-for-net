...
namespace Azure.Generator.Tests
{
    public class AzureTypeFactoryTests
    {
        ...
        public void DataFactoryElementDeserializationUsesDeserializeMethod()
        {
            ...
            Assert.That(
                displayString,
                Is.EqualTo("global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.Core.Expressions.DataFactory.DataFactoryElement<string>>(data, global::Samples.ModelSerializationExtensions.WireOptions, global::Samples.SamplesContext.Default)"));
        }
    }
}
