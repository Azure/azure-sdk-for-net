...
namespace Azure.Generator.Tests.Visitors
{
    public class ClientRequestIdHeaderVisitorTests
    {
            ...
            bool addBackXMsClientRequestId)
        {
            ...
            {
                Assert.That(serviceMethod.Parameters.Count, Is.EqualTo(expectedInitialCount));
            ...
            foreach (var serviceMethod in serviceMethods)
            {
                ...
                Assert.That(serviceMethod.Parameters.Count, Is.EqualTo(1));
        ...
        public void DoesNotChangeExistingParameters()
        {
            ...
            Assert.That(serviceMethod.Operation.Parameters.Count, Is.EqualTo(1));
