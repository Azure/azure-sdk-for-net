...
namespace Samples
{
    internal partial class CatClientGetCatsAsyncCollectionResultOfT : global::Azure.AsyncPageable<global::Samples.Models.Cat>
    {
        ...
        public CatClientGetCatsAsyncCollectionResultOfT(global::Samples.CatClient client, string animalKind, global::Azure.RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
