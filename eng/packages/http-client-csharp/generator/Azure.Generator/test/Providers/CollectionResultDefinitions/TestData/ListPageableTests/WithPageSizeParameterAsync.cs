...
namespace Samples
{
    internal partial class CatClientGetCatsAsyncCollectionResult : global::Azure.AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <param name="pageSize"> pageSize description. </param>
        ...
        public CatClientGetCatsAsyncCollectionResult(global::Samples.CatClient client, string animalKind, int? pageSize, global::Azure.RequestContext context) : base((context?.CancellationToken ?? default))
        {
        ...
        {
            global::Azure.Core.HttpMessage message = _client.CreateGetCatsRequest(_animalKind, pageSizeHint, _context);
