...
namespace Samples
{
    internal partial class CatClientgetCatsCollectionResult : global::Azure.Pageable<global::System.BinaryData>
    {
        ...
        public CatClientgetCatsCollectionResult(global::Samples.CatClient client, global::System.Uri nextPage, global::Azure.RequestContext context)
        {
            _client = client;
            _nextPage = nextPage;
            _context = context;
        ...
        public override global::System.Collections.Generic.IEnumerable<global::Azure.Page<global::System.BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                nextLink = ((root.TryGetProperty("NextCat", out global::System.Text.Json.JsonElement value) ? value.GetString()) : null);
