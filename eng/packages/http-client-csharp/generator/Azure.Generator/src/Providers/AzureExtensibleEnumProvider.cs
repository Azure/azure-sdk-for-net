...
{
    internal class AzureExtensibleEnumProvider : ExtensibleEnumProvider
    {
        public AzureExtensibleEnumProvider(InputEnumType input, TypeProvider? declaringType) : base(input, declaringType) { }
