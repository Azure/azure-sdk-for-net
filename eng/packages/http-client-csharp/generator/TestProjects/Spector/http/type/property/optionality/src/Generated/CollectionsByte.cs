...
namespace _Type.Property.Optional
{
    ...
    public partial class CollectionsByte
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsByte.GetAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsByte.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsByte.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsByte.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
