...
namespace _Type.Union
{
    ...
    internal partial class SendRequest7 : IJsonModel<SendRequest7>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="SendRequest7"/> from. </param>
        public static explicit operator SendRequest7(Response result)
        {
            using Response response = result;
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeSendRequest7(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
