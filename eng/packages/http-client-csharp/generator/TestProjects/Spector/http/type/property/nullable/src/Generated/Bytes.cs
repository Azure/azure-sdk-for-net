...
namespace _Type.Property.Nullable
{
    ...
    public partial class Bytes
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Bytes.GetNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Bytes.GetNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Bytes.PatchNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Bytes.PatchNull");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
