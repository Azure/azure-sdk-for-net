...
namespace _Type.Property.Optional
{
    ...
    public partial class UnionIntLiteral
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnionIntLiteral.GetAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnionIntLiteral.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnionIntLiteral.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnionIntLiteral.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
