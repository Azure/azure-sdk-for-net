...
namespace _Type.Property.Optional
{
    ...
    public partial class FloatLiteral
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("FloatLiteral.GetAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("FloatLiteral.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("FloatLiteral.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("FloatLiteral.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
