# Type.Model.Inheritance.EnumDiscriminator client library for .NET

Type.Model.Inheritance.EnumDiscriminator is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Model.Inheritance.EnumDiscriminator --prerelease
```
