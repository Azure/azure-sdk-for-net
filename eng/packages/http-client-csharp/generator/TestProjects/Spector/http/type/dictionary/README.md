# Type.Dictionary client library for .NET

Type.Dictionary is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Dictionary --prerelease
```
