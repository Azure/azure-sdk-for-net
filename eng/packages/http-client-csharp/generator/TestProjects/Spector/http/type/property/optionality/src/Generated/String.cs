...
namespace _Type.Property.Optional
{
    ...
    public partial class String
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("String.GetAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("String.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("String.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("String.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
