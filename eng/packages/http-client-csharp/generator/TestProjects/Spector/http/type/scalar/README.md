# Type.Scalar client library for .NET

Type.Scalar is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Scalar --prerelease
```
