...
namespace _Type.Property.Optional
{
    ...
    public partial class CollectionsModel
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsModel.GetAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsModel.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsModel.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsModel.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
