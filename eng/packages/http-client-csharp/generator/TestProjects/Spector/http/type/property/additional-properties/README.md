# Type.Property.AdditionalProperties client library for .NET

Type.Property.AdditionalProperties is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Property.AdditionalProperties --prerelease
```
