# Type.Model.Usage client library for .NET

Type.Model.Usage is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Model.Usage --prerelease
```
