...
namespace _Type.Property.Nullable
{
    ...
    public partial class Datetime
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Datetime.GetNonNull");
            scope.Start();
            try
            {
        ...
        public virtual Response<DatetimeProperty> GetNonNull(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((DatetimeProperty)result, result);
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Datetime.GetNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Datetime.PatchNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Datetime.PatchNull");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
