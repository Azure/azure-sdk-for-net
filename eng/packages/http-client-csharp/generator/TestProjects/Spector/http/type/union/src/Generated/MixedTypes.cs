...
namespace _Type.Union
{
    ...
    public partial class MixedTypes
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MixedTypes.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<GetResponse9> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((GetResponse9)result, result);
        }

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<GetResponse9>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MixedTypes.Send");
            scope.Start();
            try
            {
        ...
        public virtual Response Send(MixedTypesCases prop, CancellationToken cancellationToken = default)
        {
            ...
            SendRequest9 spreadModel = new SendRequest9(prop, null);
