...
namespace _Type.Property.Optional
{
    ...
    public partial class IntLiteral
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("IntLiteral.GetAll");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IntLiteralProperty> GetAll(CancellationToken cancellationToken = default)
        {
            Response result = GetAll(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((IntLiteralProperty)result, result);
        }

        /// <summary> Get models that will return all properties in the model. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<IntLiteralProperty>> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("IntLiteral.GetDefault");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IntLiteralProperty> GetDefault(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<IntLiteralProperty>> GetDefaultAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("IntLiteral.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("IntLiteral.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
