...
namespace _Type._Array
{
    ...
    public partial class NullableFloatValue
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("NullableFloatValue.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("NullableFloatValue.Put");
            scope.Start();
            try
            {
