...
namespace _Type.Scalar
{
    ...
    public partial class Decimal128Verify
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Decimal128Verify.PrepareVerify");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Decimal128Verify.Verify");
            scope.Start();
            try
            {
