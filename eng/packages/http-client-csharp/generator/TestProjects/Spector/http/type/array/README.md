# Type.Array client library for .NET

Type.Array is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Array --prerelease
```
