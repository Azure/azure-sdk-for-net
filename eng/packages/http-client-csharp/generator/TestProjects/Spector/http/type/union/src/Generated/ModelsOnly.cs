...
namespace _Type.Union
{
    ...
    public partial class ModelsOnly
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ModelsOnly.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<GetResponse5> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((GetResponse5)result, result);
        }

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<GetResponse5>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ModelsOnly.Send");
            scope.Start();
            try
            {
        ...
        public virtual Response Send(BinaryData prop, CancellationToken cancellationToken = default)
        {
            ...
            SendRequest5 spreadModel = new SendRequest5(prop, null);
