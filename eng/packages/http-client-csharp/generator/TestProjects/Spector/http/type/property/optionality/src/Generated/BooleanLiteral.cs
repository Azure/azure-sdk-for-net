...
namespace _Type.Property.Optional
{
    ...
    public partial class BooleanLiteral
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("BooleanLiteral.GetAll");
            scope.Start();
            try
            {
        ...
        public virtual Response<BooleanLiteralProperty> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((BooleanLiteralProperty)result, result);
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("BooleanLiteral.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("BooleanLiteral.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("BooleanLiteral.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
