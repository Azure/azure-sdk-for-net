# Type.Property.ValueTypes client library for .NET

Type.Property.ValueTypes is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Property.ValueTypes --prerelease
```
