...
namespace _Type.Property.Nullable
{
    ...
    public partial class CollectionsByte
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsByte.GetNonNull");
            scope.Start();
            try
            {
        ...
        public virtual Response<CollectionsByteProperty> GetNonNull(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((CollectionsByteProperty)result, result);
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsByte.GetNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsByte.PatchNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsByte.PatchNull");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
