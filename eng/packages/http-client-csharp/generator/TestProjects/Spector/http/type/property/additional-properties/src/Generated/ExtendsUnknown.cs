...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class ExtendsUnknown
    {
        ...
        /// <summary> Initializes a new instance of ExtendsUnknown for mocking. </summary>
        protected ExtendsUnknown()
        {
        }
        ...
        internal ExtendsUnknown(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ExtendsUnknown.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<ExtendsUnknownAdditionalProperties> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((ExtendsUnknownAdditionalProperties)result, result);
        }

        /// <summary> Get call. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<ExtendsUnknownAdditionalProperties>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ExtendsUnknown.Put");
            scope.Start();
            try
            {
