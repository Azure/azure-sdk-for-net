...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class SpreadRecordNonDiscriminatedUnion2
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("SpreadRecordNonDiscriminatedUnion2.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<SpreadRecordForNonDiscriminatedUnion2> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((SpreadRecordForNonDiscriminatedUnion2)result, result);
        }

        /// <summary> Get call. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<SpreadRecordForNonDiscriminatedUnion2>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("SpreadRecordNonDiscriminatedUnion2.Put");
            scope.Start();
            try
            {
