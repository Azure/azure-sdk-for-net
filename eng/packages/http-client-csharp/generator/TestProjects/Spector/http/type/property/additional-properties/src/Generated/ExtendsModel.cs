...
namespace _Type.Property.AdditionalProperties
{
    ...
    public partial class ExtendsModel
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ExtendsModel.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<ExtendsModelAdditionalProperties> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((ExtendsModelAdditionalProperties)result, result);
        }

        /// <summary> Get call. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<ExtendsModelAdditionalProperties>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ExtendsModel.Put");
            scope.Start();
            try
            {
