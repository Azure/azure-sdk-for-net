...
namespace _Type.Union
{
    ...
    public partial class EnumsOnly
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("EnumsOnly.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<GetResponse6> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((GetResponse6)result, result);
        }

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<GetResponse6>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("EnumsOnly.Send");
            scope.Start();
            try
            {
        ...
        public virtual Response Send(EnumsOnlyCases prop, CancellationToken cancellationToken = default)
        {
            ...
            SendRequest6 spreadModel = new SendRequest6(prop, null);
