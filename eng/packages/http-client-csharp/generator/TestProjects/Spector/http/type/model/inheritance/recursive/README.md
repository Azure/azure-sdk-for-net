# Type.Model.Inheritance.Recursive client library for .NET

Type.Model.Inheritance.Recursive is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Model.Inheritance.Recursive --prerelease
```
