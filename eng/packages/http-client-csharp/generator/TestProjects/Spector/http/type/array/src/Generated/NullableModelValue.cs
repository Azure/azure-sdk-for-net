...
namespace _Type._Array
{
    ...
    public partial class NullableModelValue
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("NullableModelValue.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IReadOnlyList<InnerModel>> Get(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((IReadOnlyList<InnerModel>)value, result);
        }

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<IReadOnlyList<InnerModel>>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("NullableModelValue.Put");
            scope.Start();
            try
            {
