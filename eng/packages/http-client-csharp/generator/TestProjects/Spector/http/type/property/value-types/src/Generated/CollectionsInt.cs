...
namespace _Type.Property.ValueTypes
{
    ...
    public partial class CollectionsInt
    {
        ...
        /// <summary> Initializes a new instance of CollectionsInt for mocking. </summary>
        protected CollectionsInt()
        {
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsInt.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<CollectionsIntProperty> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((CollectionsIntProperty)result, result);
        }

        /// <summary> Get call. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<CollectionsIntProperty>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsInt.Put");
            scope.Start();
            try
            {
