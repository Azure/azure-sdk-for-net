# Type.Model.Inheritance.NestedDiscriminator client library for .NET

Type.Model.Inheritance.NestedDiscriminator is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Model.Inheritance.NestedDiscriminator --prerelease
```
