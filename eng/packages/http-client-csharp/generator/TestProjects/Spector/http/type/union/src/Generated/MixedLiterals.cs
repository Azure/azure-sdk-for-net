...
namespace _Type.Union
{
    ...
    public partial class MixedLiterals
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MixedLiterals.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<GetResponse8> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((GetResponse8)result, result);
        }

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<GetResponse8>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("MixedLiterals.Send");
            scope.Start();
            try
            {
        ...
        public virtual Response Send(MixedLiteralsCases prop, CancellationToken cancellationToken = default)
        {
            ...
            SendRequest8 spreadModel = new SendRequest8(prop, null);
