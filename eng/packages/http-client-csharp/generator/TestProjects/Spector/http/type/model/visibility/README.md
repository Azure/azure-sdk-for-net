# Type.Model.Visibility client library for .NET

Type.Model.Visibility is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Model.Visibility --prerelease
```
