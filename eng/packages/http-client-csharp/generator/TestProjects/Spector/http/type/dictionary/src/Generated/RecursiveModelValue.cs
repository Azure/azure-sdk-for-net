...
namespace _Type.Dictionary
{
    ...
    public partial class RecursiveModelValue
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("RecursiveModelValue.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IReadOnlyDictionary<string, InnerModel>> Get(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((IReadOnlyDictionary<string, InnerModel>)value, result);
        }

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<IReadOnlyDictionary<string, InnerModel>>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("RecursiveModelValue.Put");
            scope.Start();
            try
            {
