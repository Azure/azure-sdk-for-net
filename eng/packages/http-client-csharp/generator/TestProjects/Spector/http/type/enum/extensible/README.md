# Type.Enum.Extensible client library for .NET

Type.Enum.Extensible is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Enum.Extensible --prerelease
```
