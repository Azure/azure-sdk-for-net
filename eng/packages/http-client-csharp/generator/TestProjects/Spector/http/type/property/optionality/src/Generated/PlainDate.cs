...
namespace _Type.Property.Optional
{
    ...
    public partial class PlainDate
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("PlainDate.GetAll");
            scope.Start();
            try
            {
        ...
        public virtual Response<PlainDateProperty> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((PlainDateProperty)result, result);
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("PlainDate.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("PlainDate.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("PlainDate.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
