...
namespace _Type.Property.Optional
{
    ...
    public partial class PlainTime
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("PlainTime.GetAll");
            scope.Start();
            try
            {
        ...
        public virtual Response<PlainTimeProperty> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((PlainTimeProperty)result, result);
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("PlainTime.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("PlainTime.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("PlainTime.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
