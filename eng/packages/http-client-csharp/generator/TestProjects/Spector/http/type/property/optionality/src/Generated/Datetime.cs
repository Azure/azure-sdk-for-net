...
namespace _Type.Property.Optional
{
    ...
    public partial class Datetime
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Datetime.GetAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Datetime.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Datetime.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Datetime.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
