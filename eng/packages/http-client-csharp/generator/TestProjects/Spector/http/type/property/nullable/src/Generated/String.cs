...
namespace _Type.Property.Nullable
{
    ...
    public partial class String
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("String.GetNonNull");
            scope.Start();
            try
            {
        ...
        public virtual Response<StringProperty> GetNonNull(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((StringProperty)result, result);
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("String.GetNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("String.PatchNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("String.PatchNull");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
