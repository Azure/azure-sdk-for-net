...
namespace _Type.Property.Nullable
{
    ...
    public partial class Duration
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Duration.GetNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Duration.GetNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Duration.PatchNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Duration.PatchNull");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
