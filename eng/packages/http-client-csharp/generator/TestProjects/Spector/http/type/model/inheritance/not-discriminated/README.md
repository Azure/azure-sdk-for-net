# Type.Model.Inheritance.NotDiscriminated client library for .NET

Type.Model.Inheritance.NotDiscriminated is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Model.Inheritance.NotDiscriminated --prerelease
```
