...
namespace _Type.Property.Optional
{
    ...
    public partial class Duration
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Duration.GetAll");
            scope.Start();
            try
            {
        ...
        public virtual Response<DurationProperty> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((DurationProperty)result, result);
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Duration.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Duration.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Duration.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
