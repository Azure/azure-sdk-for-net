...
namespace _Type.Property.Nullable
{
    ...
    public partial class CollectionsString
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsString.GetNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsString.GetNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsString.PatchNonNull");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("CollectionsString.PatchNull");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
