...
namespace _Type.Property.Nullable
{
    ...
    public partial class NullableClient
    {
        ...
        {
            return Volatile.Read(ref _cachedCollectionsByte) ?? Interlocked.CompareExchange(ref _cachedCollectionsByte, new CollectionsByte(Pipeline, _endpoint), null) ?? _cachedCollectionsByte;
        }
