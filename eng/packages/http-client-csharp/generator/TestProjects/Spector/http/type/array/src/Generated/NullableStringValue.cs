...
namespace _Type._Array
{
    ...
    public partial class NullableStringValue
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("NullableStringValue.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("NullableStringValue.Put");
            scope.Start();
            try
            {
