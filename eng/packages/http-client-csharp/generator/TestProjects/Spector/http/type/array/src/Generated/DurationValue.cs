...
namespace _Type._Array
{
    ...
    public partial class DurationValue
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IReadOnlyList<TimeSpan>> Get(CancellationToken cancellationToken = default)
        {
            ...
            return Response.FromValue((IReadOnlyList<TimeSpan>)value, result);
        }

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<IReadOnlyList<TimeSpan>>> GetAsync(CancellationToken cancellationToken = default)
        {
