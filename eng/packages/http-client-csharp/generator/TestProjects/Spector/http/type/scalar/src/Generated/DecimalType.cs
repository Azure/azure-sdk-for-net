...
namespace _Type.Scalar
{
    ...
    public partial class DecimalType
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DecimalType.ResponseBody");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DecimalType.RequestBody");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DecimalType.RequestParameter");
            scope.Start();
            try
            {
