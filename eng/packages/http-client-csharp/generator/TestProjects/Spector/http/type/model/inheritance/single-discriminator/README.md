# Type.Model.Inheritance.SingleDiscriminator client library for .NET

Type.Model.Inheritance.SingleDiscriminator is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Type.Model.Inheritance.SingleDiscriminator --prerelease
```
