...
namespace _Type.Property.Optional
{
    ...
    public partial class Bytes
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Bytes.GetAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Bytes.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Bytes.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Bytes.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
