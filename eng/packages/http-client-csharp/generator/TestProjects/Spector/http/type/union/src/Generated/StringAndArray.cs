...
namespace _Type.Union
{
    ...
    public partial class StringAndArray
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("StringAndArray.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<GetResponse7> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
            return Response.FromValue((GetResponse7)result, result);
        }

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<GetResponse7>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("StringAndArray.Send");
            scope.Start();
            try
            {
        ...
        public virtual Response Send(StringAndArrayCases prop, CancellationToken cancellationToken = default)
        {
            ...
            SendRequest7 spreadModel = new SendRequest7(prop, null);
