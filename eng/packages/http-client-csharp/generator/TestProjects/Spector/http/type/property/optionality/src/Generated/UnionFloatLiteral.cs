...
namespace _Type.Property.Optional
{
    ...
    public partial class UnionFloatLiteral
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnionFloatLiteral.GetAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnionFloatLiteral.GetDefault");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnionFloatLiteral.PutAll");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("UnionFloatLiteral.PutDefault");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
