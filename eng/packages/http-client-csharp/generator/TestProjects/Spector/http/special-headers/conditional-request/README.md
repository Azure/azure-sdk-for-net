# SpecialHeaders.ConditionalRequest client library for .NET

SpecialHeaders.ConditionalRequest is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package SpecialHeaders.ConditionalRequest --prerelease
```
