# Resiliency.SrvDriven.V2 client library for .NET

Resiliency.SrvDriven.V2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Resiliency.SrvDriven.V2 --prerelease
```
