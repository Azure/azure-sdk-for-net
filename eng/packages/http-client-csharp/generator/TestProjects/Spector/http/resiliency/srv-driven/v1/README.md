# Resiliency.SrvDriven.V1 client library for .NET

Resiliency.SrvDriven.V1 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Resiliency.SrvDriven.V1 --prerelease
```
