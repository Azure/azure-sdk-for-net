# Serialization.EncodedName.Json client library for .NET

Serialization.EncodedName.Json is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Serialization.EncodedName.Json --prerelease
```
