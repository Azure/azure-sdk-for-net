# Parameters.Path client library for .NET

Parameters.Path is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Parameters.Path --prerelease
```
