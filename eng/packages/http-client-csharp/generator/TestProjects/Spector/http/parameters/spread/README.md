# Parameters.Spread client library for .NET

Parameters.Spread is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Parameters.Spread --prerelease
```
