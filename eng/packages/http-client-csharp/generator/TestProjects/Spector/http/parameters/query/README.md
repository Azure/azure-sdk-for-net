# Parameters.Query client library for .NET

Parameters.Query is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Parameters.Query --prerelease
```
