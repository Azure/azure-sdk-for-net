# Parameters.BodyOptionality client library for .NET

Parameters.BodyOptionality is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Parameters.BodyOptionality --prerelease
```
