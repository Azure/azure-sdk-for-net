# Parameters.CollectionFormat client library for .NET

Parameters.CollectionFormat is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Parameters.CollectionFormat --prerelease
```
