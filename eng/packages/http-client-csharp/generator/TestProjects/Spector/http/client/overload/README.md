# Client.Overload client library for .NET

Client.Overload is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.Overload --prerelease
```
