# Client.Naming.EnumConflict client library for .NET

Client.Naming.EnumConflict is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.Naming.EnumConflict --prerelease
```
