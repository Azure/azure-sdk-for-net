# Client.Structure.Service.Default client library for .NET

Client.Structure.Service.Default is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.Structure.Service.Default --prerelease
```
