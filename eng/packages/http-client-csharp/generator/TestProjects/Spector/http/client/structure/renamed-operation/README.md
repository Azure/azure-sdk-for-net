# Client.Structure.Service.Renamed.Operation client library for .NET

Client.Structure.Service.Renamed.Operation is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.Structure.Service.Renamed.Operation --prerelease
```
