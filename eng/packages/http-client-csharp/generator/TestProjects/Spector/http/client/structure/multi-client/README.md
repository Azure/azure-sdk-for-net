# Client.Structure.Service.Multi.Client client library for .NET

Client.Structure.Service.Multi.Client is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.Structure.Service.Multi.Client --prerelease
```
