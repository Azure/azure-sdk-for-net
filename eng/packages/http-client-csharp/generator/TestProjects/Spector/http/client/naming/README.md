# Client.Naming client library for .NET

Client.Naming is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.Naming --prerelease
```
