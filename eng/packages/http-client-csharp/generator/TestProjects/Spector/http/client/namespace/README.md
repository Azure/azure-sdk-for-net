# Client.ClientNamespace client library for .NET

Client.ClientNamespace is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.ClientNamespace --prerelease
```
