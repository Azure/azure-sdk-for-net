...
namespace Client.Clientnamespace.Second
{
    public partial class ClientNamespaceSecondClient
    {
        ...
        public ClientNamespaceSecondClient(ClientNamespaceSecondClientSettings settings) : this(AuthenticationPolicy.Create(settings), settings?.Endpoint, settings?.Options) => throw null;
