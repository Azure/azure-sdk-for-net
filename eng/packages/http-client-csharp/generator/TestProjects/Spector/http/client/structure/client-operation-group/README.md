# Client.Structure.Service client library for .NET

Client.Structure.Service is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.Structure.Service --prerelease
```
