# Client.Structure.Service.TwoOperationGroup client library for .NET

Client.Structure.Service.TwoOperationGroup is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Client.Structure.Service.TwoOperationGroup --prerelease
```
