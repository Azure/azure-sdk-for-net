...
namespace Versioning.TypeChangedFrom
{
    ...
    public partial class TestModel : IJsonModel<TestModel>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteNumberValue(ChangedProp);
        ...
        internal static TestModel DeserializeTestModel(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop0 in element.EnumerateObject())
            {
                ...
                {
                    changedProp = prop0.Value.GetInt32();
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, VersioningTypeChangedFromV1Context.Default);
                default:
