# Versioning.RenamedFrom.V2 client library for .NET

Versioning.RenamedFrom.V2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.RenamedFrom.V2 --prerelease
```
