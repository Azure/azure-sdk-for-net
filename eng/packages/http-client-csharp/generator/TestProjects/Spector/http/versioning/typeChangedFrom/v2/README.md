# Versioning.TypeChangedFrom.V2 client library for .NET

Versioning.TypeChangedFrom.V2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.TypeChangedFrom.V2 --prerelease
```
