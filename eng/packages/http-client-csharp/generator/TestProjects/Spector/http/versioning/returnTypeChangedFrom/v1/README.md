# Versioning.ReturnTypeChangedFrom.V1 client library for .NET

Versioning.ReturnTypeChangedFrom.V1 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.ReturnTypeChangedFrom.V1 --prerelease
```
