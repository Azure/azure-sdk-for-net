# Versioning.MadeOptional.V2 client library for .NET

Versioning.MadeOptional.V2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.MadeOptional.V2 --prerelease
```
