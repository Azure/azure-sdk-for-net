# Versioning.Added.V1 client library for .NET

Versioning.Added.V1 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.Added.V1 --prerelease
```
