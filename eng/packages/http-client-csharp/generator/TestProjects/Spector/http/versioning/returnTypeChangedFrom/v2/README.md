# Versioning.ReturnTypeChangedFrom.V2 client library for .NET

Versioning.ReturnTypeChangedFrom.V2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.ReturnTypeChangedFrom.V2 --prerelease
```
