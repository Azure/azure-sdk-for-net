    ...
    public partial class ModelV2 : IJsonModel<ModelV2>
    {
        ...
        internal static ModelV2 DeserializeModelV2(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop0 in element.EnumerateObject())
            {
                ...
                if (prop0.NameEquals("removedProp"u8))
                {
                    removedProp = prop0.Value.GetString();
                    continue;
                }
            ...
            return new ModelV2(prop, removedProp, enumProp, unionProp, additionalBinaryDataProperties);
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, VersioningRemovedV1Context.Default);
                default:
