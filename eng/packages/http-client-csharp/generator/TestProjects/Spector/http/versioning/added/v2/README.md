# Versioning.Added.V2 client library for .NET

Versioning.Added.V2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.Added.V2 --prerelease
```
