# Versioning.Removed.V2 client library for .NET

Versioning.Removed.V2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.Removed.V2 --prerelease
```
