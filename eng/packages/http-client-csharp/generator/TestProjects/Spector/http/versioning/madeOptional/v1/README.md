# Versioning.MadeOptional.V1 client library for .NET

Versioning.MadeOptional.V1 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.MadeOptional.V1 --prerelease
```
