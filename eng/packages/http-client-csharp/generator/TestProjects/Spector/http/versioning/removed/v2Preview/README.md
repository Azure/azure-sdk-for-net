# Versioning.Removed.V2Preview client library for .NET

Versioning.Removed.V2Preview is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.Removed.V2Preview --prerelease
```
