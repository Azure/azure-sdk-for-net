# Versioning.TypeChangedFrom.V1 client library for .NET

Versioning.TypeChangedFrom.V1 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.TypeChangedFrom.V1 --prerelease
```
