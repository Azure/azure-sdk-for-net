# SpecialWords client library for .NET

SpecialWords is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package SpecialWords --prerelease
```
