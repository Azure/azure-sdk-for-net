# Payload.Pageable client library for .NET

Payload.Pageable is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Payload.Pageable --prerelease
```
