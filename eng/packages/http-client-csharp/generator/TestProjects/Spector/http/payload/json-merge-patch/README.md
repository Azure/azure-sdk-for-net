# Payload.JsonMergePatch client library for .NET

Payload.JsonMergePatch is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Payload.JsonMergePatch --prerelease
```
