# Payload.MediaType client library for .NET

Payload.MediaType is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Payload.MediaType --prerelease
```
