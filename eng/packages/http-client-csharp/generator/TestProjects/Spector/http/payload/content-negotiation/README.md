# Payload.ContentNegotiation client library for .NET

Payload.ContentNegotiation is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Payload.ContentNegotiation --prerelease
```
