# Payload.Xml client library for .NET

Payload.Xml is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Payload.Xml --prerelease
```
