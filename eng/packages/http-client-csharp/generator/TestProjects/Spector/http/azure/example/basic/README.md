# _Specs_.Azure.Example.Basic client library for .NET

_Specs_.Azure.Example.Basic is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.Example.Basic --prerelease
```
