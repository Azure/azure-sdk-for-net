...
{
    internal partial class BasicClientGetAsyncCollectionResultOfT : AsyncPageable<User>
    {
        ...
        /// <summary> Initializes a new instance of BasicClientGetAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BasicClientGetAsyncCollectionResultOfT(BasicClient client, int? top, int? skip, int? maxpagesize, IEnumerable<string> @orderby, string filter, IEnumerable<string> @select, IEnumerable<string> expand, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _top = top;
            _skip = skip;
        ...
        /// <summary> Gets the pages of BasicClientGetAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BasicClientGetAsyncCollectionResultOfT as an enumerable collection. </returns>
