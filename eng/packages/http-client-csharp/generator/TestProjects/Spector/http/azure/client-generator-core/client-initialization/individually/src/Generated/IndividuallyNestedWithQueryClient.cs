...
namespace Specs.Azure.ClientGenerator.Core.ClientInitialization.IndividuallyClient
{
    public partial class IndividuallyNestedWithQueryClient
    {
        ...
        public IndividuallyNestedWithQueryClient(IndividuallyNestedWithQueryClientSettings settings) : this(AuthenticationPolicy.Create(settings), settings?.Endpoint, settings?.BlobName, settings?.Options) => throw null;
