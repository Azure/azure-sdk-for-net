...
{
    internal partial class PageClientWithParameterizedNextLinkAsyncCollectionResultOfT : AsyncPageable<User>
    {
        ...
        /// <summary> Initializes a new instance of PageClientWithParameterizedNextLinkAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PageClientWithParameterizedNextLinkAsyncCollectionResultOfT(PageClient client, string @select, bool? includePending, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PageClientWithParameterizedNextLinkAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PageClientWithParameterizedNextLinkAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<User>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            do
            {
                ...
                yield return Page<User>.FromValues((IReadOnlyList<User>)responseWithType.Values, nextPage?.AbsoluteUri, response);
            }
            while (nextPage != null);
        }
