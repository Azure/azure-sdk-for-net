# _Specs_.Azure.Core.Basic client library for .NET

_Specs_.Azure.Core.Basic is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.Core.Basic --prerelease
```
