...
namespace Specs.Azure.ClientGenerator.Core.ClientLocation._MoveMethodParameterToClient
{
    public partial class MoveMethodParameterToClient
    {
        ...
        public MoveMethodParameterToClient(MoveMethodParameterToClientSettings settings) : this(AuthenticationPolicy.Create(settings), settings?.Endpoint, settings?.StorageAccount, settings?.Options) => throw null;
