...
namespace Specs.Azure.ClientGenerator.Core.ClientInitialization.IndividuallyClient
{
    public partial class IndividuallyNestedWithMixedClient
    {
        ...
        public IndividuallyNestedWithMixedClient(Uri endpoint, string name, IndividuallyNestedWithMixedClientOptions options) : this(null, endpoint, name, options) => throw null;

        [Experimental("SCME0002")]
        public IndividuallyNestedWithMixedClient(IndividuallyNestedWithMixedClientSettings settings) : this(AuthenticationPolicy.Create(settings), settings?.Endpoint, settings?.Name, settings?.Options) => throw null;
