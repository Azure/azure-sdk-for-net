...
{
    internal partial class PageClientWithParameterizedNextLinkCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of PageClientWithParameterizedNextLinkCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public PageClientWithParameterizedNextLinkCollectionResult(PageClient client, string @select, bool? includePending, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PageClientWithParameterizedNextLinkCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PageClientWithParameterizedNextLinkCollectionResult as an enumerable collection. </returns>
