# Specs.Azure.Tcgc.ClientInit.Individually client library for .NET

Specs.Azure.Tcgc.ClientInit.Individually is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Specs.Azure.Tcgc.ClientInit.Individually --prerelease
```
