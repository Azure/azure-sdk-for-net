# Azure.SpecialHeaders.XmsClientRequestId client library for .NET

Azure.SpecialHeaders.XmsClientRequestId is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Azure.SpecialHeaders.XmsClientRequestId --prerelease
```
