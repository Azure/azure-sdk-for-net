# Specs.Azure.Tcgc.ClientInit.Both client library for .NET

Specs.Azure.Tcgc.ClientInit.Both is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Specs.Azure.Tcgc.ClientInit.Both --prerelease
```
