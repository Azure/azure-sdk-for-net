# _Specs_.Azure.ClientGenerator.Core.Override client library for .NET

_Specs_.Azure.ClientGenerator.Core.Override is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.ClientGenerator.Core.Override --prerelease
```
