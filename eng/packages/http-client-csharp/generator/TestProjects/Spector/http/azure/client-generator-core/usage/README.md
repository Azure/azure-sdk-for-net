# _Specs_.Azure.ClientGenerator.Core.Usage client library for .NET

_Specs_.Azure.ClientGenerator.Core.Usage is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.ClientGenerator.Core.Usage --prerelease
```
