...
{
    internal partial class PageClientWithParameterizedNextLinkCollectionResultOfT : Pageable<User>
    {
        ...
        /// <summary> Initializes a new instance of PageClientWithParameterizedNextLinkCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PageClientWithParameterizedNextLinkCollectionResultOfT(PageClient client, string @select, bool? includePending, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PageClientWithParameterizedNextLinkCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PageClientWithParameterizedNextLinkCollectionResultOfT as an enumerable collection. </returns>
