...
namespace Specs.Azure.ClientGenerator.Core.ClientInitialization.IndividuallyClient
{
    public partial class IndividuallyNestedWithPathClient
    {
        ...
        public IndividuallyNestedWithPathClient(IndividuallyNestedWithPathClientSettings settings) : this(AuthenticationPolicy.Create(settings), settings?.Endpoint, settings?.BlobName, settings?.Options) => throw null;
