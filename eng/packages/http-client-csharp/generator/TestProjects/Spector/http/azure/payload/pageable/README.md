# _Specs_.Azure.Payload.Pageable client library for .NET

_Specs_.Azure.Payload.Pageable is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.Payload.Pageable --prerelease
```
