...
namespace Specs.Azure.Versioning.PreviewVersion
{
    public partial class PreviewVersionClient
    {
        ...
        public PreviewVersionClient(PreviewVersionClientSettings settings) : this(AuthenticationPolicy.Create(settings), settings?.Endpoint, settings?.Options) => throw null;
