# Versioning.PreviewVersion.V1 client library for .NET

Versioning.PreviewVersion.V1 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.PreviewVersion.V1 --prerelease
```
