# Specs.Azure.Tcgc.ClientLo.Root client library for .NET

Specs.Azure.Tcgc.ClientLo.Root is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Specs.Azure.Tcgc.ClientLo.Root --prerelease
```
