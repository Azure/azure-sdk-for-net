# _Specs_.Azure.Encode.Duration client library for .NET

_Specs_.Azure.Encode.Duration is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.Encode.Duration --prerelease
```
