...
namespace Azure.SpecialHeaders.XmsClientRequestId
{
    ...
    public partial class XmsClientRequestIdClient
    {
        ...
        {
            return Get(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null);
        }
        ...
        {
            return await GetAsync(cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null).ConfigureAwait(false);
        }
    }
}
