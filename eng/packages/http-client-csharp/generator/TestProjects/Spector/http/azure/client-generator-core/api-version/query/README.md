# _Specs_.Azure.ClientGenerator.Core.ApiVersion.Query client library for .NET

_Specs_.Azure.ClientGenerator.Core.ApiVersion.Query is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.ClientGenerator.Core.ApiVersion.Query --prerelease
```
