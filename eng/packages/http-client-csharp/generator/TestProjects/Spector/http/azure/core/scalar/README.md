# _Specs_.Azure.Core.Scalar client library for .NET

_Specs_.Azure.Core.Scalar is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.Core.Scalar --prerelease
```
