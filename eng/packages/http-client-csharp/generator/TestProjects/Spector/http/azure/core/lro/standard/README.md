# _Specs_.Azure.Core.Lro.Standard client library for .NET

_Specs_.Azure.Core.Lro.Standard is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.Core.Lro.Standard --prerelease
```
