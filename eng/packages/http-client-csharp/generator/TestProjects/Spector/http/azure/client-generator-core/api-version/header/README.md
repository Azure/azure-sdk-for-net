# _Specs_.Azure.ClientGenerator.Core.ApiVersion.Header client library for .NET

_Specs_.Azure.ClientGenerator.Core.ApiVersion.Header is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.ClientGenerator.Core.ApiVersion.Header --prerelease
```
