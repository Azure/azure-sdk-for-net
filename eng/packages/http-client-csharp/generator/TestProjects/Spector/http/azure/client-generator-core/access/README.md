# _Specs_.Azure.ClientGenerator.Core.Access client library for .NET

_Specs_.Azure.ClientGenerator.Core.Access is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package _Specs_.Azure.ClientGenerator.Core.Access --prerelease
```
