# Specs.Azure.Tcgc.ClientLo.NewSub client library for .NET

Specs.Azure.Tcgc.ClientLo.NewSub is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Specs.Azure.Tcgc.ClientLo.NewSub --prerelease
```
