# Specs.Azure.Tcgc.ClientInit.Default client library for .NET

Specs.Azure.Tcgc.ClientInit.Default is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Specs.Azure.Tcgc.ClientInit.Default --prerelease
```
