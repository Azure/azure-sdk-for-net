# Versioning.PreviewVersion.V2 client library for .NET

Versioning.PreviewVersion.V2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Versioning.PreviewVersion.V2 --prerelease
```
