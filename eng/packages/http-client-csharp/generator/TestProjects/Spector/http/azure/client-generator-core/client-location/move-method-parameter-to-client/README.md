# Specs.Azure.Tcgc.ClientLo.Param client library for .NET

Specs.Azure.Tcgc.ClientLo.Param is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Specs.Azure.Tcgc.ClientLo.Param --prerelease
```
