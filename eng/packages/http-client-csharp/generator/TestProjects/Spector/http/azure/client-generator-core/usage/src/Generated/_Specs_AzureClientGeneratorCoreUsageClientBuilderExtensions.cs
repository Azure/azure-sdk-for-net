...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class _Specs_AzureClientGeneratorCoreUsageClientBuilderExtensions
    {
        /// <summary> Registers a <see cref="UsageClient"/> client with the specified <see cref="IAzureClientBuilder{TClient,TOptions}"/>. </summary>
