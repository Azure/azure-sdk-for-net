# Specs.Azure.Tcgc.ClientLo.Sub client library for .NET

Specs.Azure.Tcgc.ClientLo.Sub is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Specs.Azure.Tcgc.ClientLo.Sub --prerelease
```
