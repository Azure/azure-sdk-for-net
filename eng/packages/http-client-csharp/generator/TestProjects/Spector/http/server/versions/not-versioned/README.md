# Server.Versions.NotVersioned client library for .NET

Server.Versions.NotVersioned is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Server.Versions.NotVersioned --prerelease
```
