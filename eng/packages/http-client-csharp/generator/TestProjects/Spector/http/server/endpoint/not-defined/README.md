# Server.Endpoint.NotDefined client library for .NET

Server.Endpoint.NotDefined is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Server.Endpoint.NotDefined --prerelease
```
