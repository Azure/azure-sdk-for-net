# Server.Path.Single client library for .NET

Server.Path.Single is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Server.Path.Single --prerelease
```
