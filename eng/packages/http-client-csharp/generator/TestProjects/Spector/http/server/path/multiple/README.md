# Server.Path.Multiple client library for .NET

Server.Path.Multiple is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Server.Path.Multiple --prerelease
```
