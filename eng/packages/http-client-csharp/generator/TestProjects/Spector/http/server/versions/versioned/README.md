# Server.Versions.Versioned client library for .NET

Server.Versions.Versioned is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Server.Versions.Versioned --prerelease
```
