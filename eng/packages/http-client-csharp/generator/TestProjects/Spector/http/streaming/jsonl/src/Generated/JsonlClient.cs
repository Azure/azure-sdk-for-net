...
namespace Streaming.Jsonl
{
    public partial class JsonlClient
    {
        ...
        internal JsonlClient(HttpPipelinePolicy authenticationPolicy, Uri endpoint, JsonlClientOptions options) => throw null;

        public JsonlClient(Uri endpoint, JsonlClientOptions options) : this(null, endpoint, options) => throw null;

        [Experimental("SCME0002")]
        public JsonlClient(JsonlClientSettings settings) : this(null, settings?.Endpoint, settings?.Options) => throw null;
