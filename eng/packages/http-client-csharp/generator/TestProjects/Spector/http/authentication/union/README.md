# Authentication.Union client library for .NET

Authentication.Union is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Authentication.Union --prerelease
```
