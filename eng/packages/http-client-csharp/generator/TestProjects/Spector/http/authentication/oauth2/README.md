# Authentication.OAuth2 client library for .NET

Authentication.OAuth2 is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Authentication.OAuth2 --prerelease
```
