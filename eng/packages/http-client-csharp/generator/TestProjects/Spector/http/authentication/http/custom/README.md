# Authentication.Http.Custom client library for .NET

Authentication.Http.Custom is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Authentication.Http.Custom --prerelease
```
