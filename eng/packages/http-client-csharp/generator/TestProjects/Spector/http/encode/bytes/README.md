# Encode.Bytes client library for .NET

Encode.Bytes is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Encode.Bytes --prerelease
```
