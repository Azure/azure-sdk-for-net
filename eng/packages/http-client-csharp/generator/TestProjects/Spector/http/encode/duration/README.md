# Encode.Duration client library for .NET

Encode.Duration is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Encode.Duration --prerelease
```
