...
namespace Encode.Bytes
{
    ...
    public partial class Header
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Header.Base64");
            scope.Start();
            try
            {
                Argument.AssertNotNull(value, nameof(value));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Header.Base64url");
            scope.Start();
            try
            {
                Argument.AssertNotNull(value, nameof(value));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Header.Base64urlArray");
            scope.Start();
            try
            {
                Argument.AssertNotNull(value, nameof(value));
