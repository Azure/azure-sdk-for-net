...
namespace Encode.Datetime
{
    ...
    public partial class Query
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Query.Rfc3339");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Query.Rfc7231");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Query.UnixTimestamp");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("Query.UnixTimestampArray");
            scope.Start();
            try
            {
