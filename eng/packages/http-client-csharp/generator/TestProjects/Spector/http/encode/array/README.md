# Encode.Array client library for .NET

Encode.Array is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Encode.Array --prerelease
```
