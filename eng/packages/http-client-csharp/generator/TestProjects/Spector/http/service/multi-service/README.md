# Service.MultiService.Combined client library for .NET

Service.MultiService.Combined is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Service.MultiService.Combined --prerelease
```
