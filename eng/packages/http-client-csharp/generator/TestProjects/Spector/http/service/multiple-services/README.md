# Service.MultipleServices.ServiceA client library for .NET

Service.MultipleServices.ServiceA is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Service.MultipleServices.ServiceA --prerelease
```
