...
namespace TestProjects.Spector.Tests.Http.Encode.Duration
{
    public class EncodeDurationTests : SpectorTestBase
    {
        ...
        public Task PropertyFloatMillisecondsArray() => Test(async (host) =>
        {
            ...
            var response = await new DurationClient(host, null).GetPropertyClient().FloatMillisecondsArrayAsync(body);
            Assert.AreEqual(body.Value, response.Value.Value);
        });
        ...
        {
            var input = TimeSpan.FromMinutes(2);
            var response = await new DurationClient(host, null).GetQueryClient().Int32SecondsLargerUnitAsync(input);
            Assert.AreEqual(204, response.Status);
        });
        ...
        {
            var input = TimeSpan.FromMinutes(2.5);
            var response = await new DurationClient(host, null).GetQueryClient().FloatSecondsLargerUnitAsync(input);
            Assert.AreEqual(204, response.Status);
        });
        ...
        {
            var input = TimeSpan.FromMilliseconds(36000);
            var response = await new DurationClient(host, null).GetQueryClient().Int32MillisecondsAsync(input);
            Assert.AreEqual(204, response.Status);
        });
        ...
        {
            var input = TimeSpan.FromMinutes(3);
            var response = await new DurationClient(host, null).GetQueryClient().Int32MillisecondsLargerUnitAsync(input);
            Assert.AreEqual(204, response.Status);
        });
        ...
        {
            var input = TimeSpan.FromMilliseconds(35625);
            var response = await new DurationClient(host, null).GetQueryClient().FloatMillisecondsAsync(input);
            Assert.AreEqual(204, response.Status);
        });
        ...
        {
            var input = TimeSpan.FromMinutes(3.5);
            var response = await new DurationClient(host, null).GetQueryClient().FloatMillisecondsLargerUnitAsync(input);
            Assert.AreEqual(204, response.Status);
        });
        ...
        {
            var input = TimeSpan.FromMilliseconds(35625);
            var response = await new DurationClient(host, null).GetQueryClient().Float64MillisecondsAsync(input);
            Assert.AreEqual(204, response.Status);
        });
