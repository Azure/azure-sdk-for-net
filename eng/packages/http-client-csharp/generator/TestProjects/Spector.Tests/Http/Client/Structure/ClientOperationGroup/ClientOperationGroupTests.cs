...
namespace TestProjects.Spector.Tests.Http.Client.Structure.ClientOperationGroup
{
    public class ClientOperationGroupTests : SpectorTestBase
    {
        ...
        public void VerifyMethods()
        {
            ...
            Assert.That(methodsOfGroup3.Where(method => method.Name.EndsWith("Async")).ToArray().Length, Is.EqualTo(4));
            ...
            Assert.That(methodsOfGroup4.Where(method => method.Name.EndsWith("Async")).ToArray().Length, Is.EqualTo(2));
            ...
            Assert.That(methodsOfGroup5.Where(method => method.Name.EndsWith("Async")).ToArray().Length, Is.EqualTo(2));
