...
namespace SpecialWords.Models
{
    ...
    public partial class Or : IJsonModel<Or>
    {
        ...
        /// <param name="or"> The <see cref="Or"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(Or @or) => throw null;

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="Or"/> from. </param>
