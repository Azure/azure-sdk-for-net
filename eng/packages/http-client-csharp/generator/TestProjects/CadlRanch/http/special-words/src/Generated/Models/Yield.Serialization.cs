...
namespace SpecialWords.Models
{
    ...
    public partial class Yield : IJsonModel<Yield>
    {
        ...
        /// <param name="yield"> The <see cref="Yield"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(Yield @yield) => throw null;

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="Yield"/> from. </param>
