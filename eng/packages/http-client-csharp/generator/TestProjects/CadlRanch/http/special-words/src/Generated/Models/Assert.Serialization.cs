...
namespace SpecialWords.Models
{
    ...
    public partial class Assert : IJsonModel<Assert>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="Assert"/> from. </param>
        public static explicit operator Assert(Response result) => throw null;
    }
}
