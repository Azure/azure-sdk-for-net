...
namespace SpecialWords.Models
{
    ...
    public partial class Assert : IJsonModel<Assert>
    {
        ...
        /// <param name="assert"> The <see cref="Assert"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(Assert assert) => throw null;

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="Assert"/> from. </param>
