...
namespace _Type.Model.Inheritance.SingleDiscriminator.Models
{
    ...
    public partial class SeaGull : IJsonModel<SeaGull>
    {
        ...
        /// <param name="seaGull"> The <see cref="SeaGull"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(SeaGull seaGull) => throw null;

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="SeaGull"/> from. </param>
