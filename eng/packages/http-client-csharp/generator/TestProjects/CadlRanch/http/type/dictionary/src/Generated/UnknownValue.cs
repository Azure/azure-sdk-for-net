...
namespace _Type.Dictionary
{
    ...
    public partial class UnknownValue
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IDictionary<string, BinaryData>> Get(CancellationToken cancellationToken = default) => throw null;

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<IDictionary<string, BinaryData>>> GetAsync(CancellationToken cancellationToken = default) => throw null;
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response Put(IDictionary<string, BinaryData> body, CancellationToken cancellationToken = default) => throw null;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response> PutAsync(IDictionary<string, BinaryData> body, CancellationToken cancellationToken = default) => throw null;
    }
}
