...
namespace _Type.Scalar
{
    ...
    public partial class DecimalVerify
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IList<decimal>> PrepareVerify(CancellationToken cancellationToken = default) => throw null;

        /// <summary> prepareVerify. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<IList<decimal>>> PrepareVerifyAsync(CancellationToken cancellationToken = default) => throw null;
