...
namespace _Type._Array
{
    ...
    public partial class DatetimeValue
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IList<DateTimeOffset>> Get(CancellationToken cancellationToken = default) => throw null;

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<IList<DateTimeOffset>>> GetAsync(CancellationToken cancellationToken = default) => throw null;
