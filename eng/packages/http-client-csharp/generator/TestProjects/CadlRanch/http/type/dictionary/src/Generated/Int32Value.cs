...
namespace _Type.Dictionary
{
    ...
    public partial class Int32Value
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IDictionary<string, int>> Get(CancellationToken cancellationToken = default) => throw null;

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<IDictionary<string, int>>> GetAsync(CancellationToken cancellationToken = default) => throw null;
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response Put(IDictionary<string, int> body, CancellationToken cancellationToken = default) => throw null;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response> PutAsync(IDictionary<string, int> body, CancellationToken cancellationToken = default) => throw null;
    }
}
