...
namespace _Type.Property.Nullable
{
    ...
    public partial class Datetime
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<DatetimeProperty> GetNonNull(CancellationToken cancellationToken = default) => throw null;

        /// <summary> Get models that will return all properties in the model. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<DatetimeProperty>> GetNonNullAsync(CancellationToken cancellationToken = default) => throw null;
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<DatetimeProperty> GetNull(CancellationToken cancellationToken = default) => throw null;

        /// <summary> Get models that will return the default object. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<DatetimeProperty>> GetNullAsync(CancellationToken cancellationToken = default) => throw null;
