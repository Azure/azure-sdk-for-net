...
namespace _Type._Array
{
    ...
    public partial class NullableFloatValue
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IList<float?>> Get(CancellationToken cancellationToken = default) => throw null;

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<IList<float?>>> GetAsync(CancellationToken cancellationToken = default) => throw null;
