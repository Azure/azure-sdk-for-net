...
namespace _Type.Property.Nullable
{
    ...
    public partial class Bytes
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<BytesProperty> GetNonNull(CancellationToken cancellationToken = default) => throw null;

        /// <summary> Get models that will return all properties in the model. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<BytesProperty>> GetNonNullAsync(CancellationToken cancellationToken = default) => throw null;
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<BytesProperty> GetNull(CancellationToken cancellationToken = default) => throw null;

        /// <summary> Get models that will return the default object. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<BytesProperty>> GetNullAsync(CancellationToken cancellationToken = default) => throw null;
