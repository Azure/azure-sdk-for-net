...
namespace _Type.Dictionary
{
    ...
    public partial class Int64Value
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IDictionary<string, long>> Get(CancellationToken cancellationToken = default) => throw null;

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<IDictionary<string, long>>> GetAsync(CancellationToken cancellationToken = default) => throw null;
