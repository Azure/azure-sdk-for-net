...
namespace _Type._Array
{
    ...
    public partial class Int64Value
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<IList<long>> Get(CancellationToken cancellationToken = default) => throw null;

        /// <summary> get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response<IList<long>>> GetAsync(CancellationToken cancellationToken = default) => throw null;
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response Put(IEnumerable<long> body, CancellationToken cancellationToken = default) => throw null;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Task<Response> PutAsync(IEnumerable<long> body, CancellationToken cancellationToken = default) => throw null;
    }
}
