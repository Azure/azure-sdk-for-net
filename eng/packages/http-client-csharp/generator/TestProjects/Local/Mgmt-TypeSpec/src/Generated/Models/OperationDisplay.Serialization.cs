...
namespace MgmtTypeSpec.Models
{
    ...
    public partial class OperationDisplay : IJsonModel<OperationDisplay>
    {
        ...
        /// <param name="operationDisplay"> The <see cref="OperationDisplay"/> to serialize into <see cref="RequestContent"/>. </param>
        public static implicit operator RequestContent(OperationDisplay operationDisplay)
        {
            ...
            content.JsonWriter.WriteObjectValue(operationDisplay, ModelSerializationExtensions.WireOptions);
            return content;
        }

        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="OperationDisplay"/> from. </param>
        public static explicit operator OperationDisplay(Response result)
        {
            using Response response = result;
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeOperationDisplay(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
