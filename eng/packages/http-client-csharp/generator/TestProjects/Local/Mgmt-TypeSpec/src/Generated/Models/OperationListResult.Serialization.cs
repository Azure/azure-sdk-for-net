...
namespace MgmtTypeSpec.Models
{
    ...
    public partial class OperationListResult : IJsonModel<OperationListResult>
    {
        ...
        /// <param name="operationListResult"> The <see cref="OperationListResult"/> to serialize into <see cref="RequestContent"/>. </param>
        public static implicit operator RequestContent(OperationListResult operationListResult)
        {
            ...
            content.JsonWriter.WriteObjectValue(operationListResult, ModelSerializationExtensions.WireOptions);
            return content;
        }

        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="OperationListResult"/> from. </param>
        public static explicit operator OperationListResult(Response result)
        {
