# BasicTypeSpec client library for .NET

BasicTypeSpec is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package BasicTypeSpec --prerelease
```
