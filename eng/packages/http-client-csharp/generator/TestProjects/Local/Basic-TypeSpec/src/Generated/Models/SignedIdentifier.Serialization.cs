...
namespace BasicTypeSpec
{
    ...
    public partial class SignedIdentifier : IPersistableModel<SignedIdentifier>, IXmlSerializable
    {
        ...
        protected virtual SignedIdentifier PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SignedIdentifier>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "X":
                    using (Stream dataStream = data.ToStream())
                    {
                        return DeserializeSignedIdentifier(XElement.Load(dataStream, LoadOptions.PreserveWhitespace), options);
                    }
                default:
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SignedIdentifier>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SignedIdentifier IPersistableModel<SignedIdentifier>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SignedIdentifier DeserializeSignedIdentifier(XElement element, ModelReaderWriterOptions options)
        {
            if (element == null)
            {
                return null;
            ...
            return new SignedIdentifier(id, additionalBinaryDataProperties);
        }
