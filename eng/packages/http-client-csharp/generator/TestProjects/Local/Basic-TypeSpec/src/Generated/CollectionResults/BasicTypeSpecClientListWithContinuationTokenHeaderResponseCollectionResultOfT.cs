...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithContinuationTokenHeaderResponseCollectionResultOfT : Pageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientListWithContinuationTokenHeaderResponseCollectionResultOfT(BasicTypeSpecClient client, string token, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _token = token;
            _context = context;
