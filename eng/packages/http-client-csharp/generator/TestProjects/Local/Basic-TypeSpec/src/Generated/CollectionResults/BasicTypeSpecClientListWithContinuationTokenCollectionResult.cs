...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithContinuationTokenCollectionResult : Pageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientListWithContinuationTokenCollectionResult(BasicTypeSpecClient client, string token, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _token = token;
            _context = context;
