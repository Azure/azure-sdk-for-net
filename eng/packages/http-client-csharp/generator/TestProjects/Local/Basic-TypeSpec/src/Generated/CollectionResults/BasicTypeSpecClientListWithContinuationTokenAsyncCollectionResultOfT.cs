...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithContinuationTokenAsyncCollectionResultOfT : AsyncPageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientListWithContinuationTokenAsyncCollectionResultOfT(BasicTypeSpecClient client, string token, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _token = token;
            _context = context;
