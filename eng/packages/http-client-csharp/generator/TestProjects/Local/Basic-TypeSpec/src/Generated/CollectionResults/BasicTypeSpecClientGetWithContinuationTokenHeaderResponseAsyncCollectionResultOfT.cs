...
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenHeaderResponseAsyncCollectionResultOfT : AsyncPageable<global::BasicTypeSpec.ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenHeaderResponseAsyncCollectionResultOfT(BasicTypeSpecClient client, string token, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _token = token;
            _context = context;
