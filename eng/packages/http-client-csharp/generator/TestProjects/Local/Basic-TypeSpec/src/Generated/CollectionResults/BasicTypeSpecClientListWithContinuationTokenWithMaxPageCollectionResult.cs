...
{
    internal partial class BasicTypeSpecClientListWithContinuationTokenWithMaxPageCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of BasicTypeSpecClientListWithContinuationTokenWithMaxPageCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BasicTypeSpecClient client used to send requests. </param>
        /// <param name="numElements"></param>
        /// <param name="token"></param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public BasicTypeSpecClientListWithContinuationTokenWithMaxPageCollectionResult(BasicTypeSpecClient client, int numElements, string token, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BasicTypeSpecClientListWithContinuationTokenWithMaxPageCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BasicTypeSpecClientListWithContinuationTokenWithMaxPageCollectionResult as an enumerable collection. </returns>
