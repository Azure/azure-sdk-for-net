...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithStringNextLinkAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithStringNextLinkAsyncCollectionResult(BasicTypeSpecClient client, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
        }
