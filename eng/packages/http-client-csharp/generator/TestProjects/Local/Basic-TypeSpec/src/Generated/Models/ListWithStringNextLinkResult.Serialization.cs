...
namespace BasicTypeSpec
{
    ...
    internal partial class ListWithStringNextLinkResult : IJsonModel<ListWithStringNextLinkResult>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ListWithStringNextLinkResult"/> from. </param>
        public static explicit operator ListWithStringNextLinkResult(Response response)
        {
