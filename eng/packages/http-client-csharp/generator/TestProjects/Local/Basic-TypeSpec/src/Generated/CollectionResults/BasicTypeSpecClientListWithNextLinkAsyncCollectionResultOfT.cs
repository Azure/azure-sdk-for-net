...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithNextLinkAsyncCollectionResultOfT : AsyncPageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientListWithNextLinkAsyncCollectionResultOfT(BasicTypeSpecClient client, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
