...
namespace BasicTypeSpec
{
    ...
    internal partial class ListWithContinuationTokenWithMaxPageResponse : IJsonModel<ListWithContinuationTokenWithMaxPageResponse>
    {
        /// <summary> Initializes a new instance of <see cref="ListWithContinuationTokenWithMaxPageResponse"/> for deserialization. </summary>
        internal ListWithContinuationTokenWithMaxPageResponse()
        {
        }
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListWithContinuationTokenWithMaxPageResponse)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ListWithContinuationTokenWithMaxPageResponse IJsonModel<ListWithContinuationTokenWithMaxPageResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ListWithContinuationTokenWithMaxPageResponse JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ListWithContinuationTokenWithMaxPageResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListWithContinuationTokenWithMaxPageResponse)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ListWithContinuationTokenWithMaxPageResponse DeserializeListWithContinuationTokenWithMaxPageResponse(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ListWithContinuationTokenWithMaxPageResponse>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListWithContinuationTokenWithMaxPageResponse)} does not support writing '{options.Format}' format.");
            }
        }
