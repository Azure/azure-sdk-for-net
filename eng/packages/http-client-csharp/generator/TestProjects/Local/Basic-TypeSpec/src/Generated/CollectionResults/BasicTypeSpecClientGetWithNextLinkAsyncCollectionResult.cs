...
{
    internal partial class BasicTypeSpecClientGetWithNextLinkAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithNextLinkAsyncCollectionResult(BasicTypeSpecClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
