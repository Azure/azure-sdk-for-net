...
{
    internal partial class BasicTypeSpecClientGetWithHeaderNextLinkCollectionResult : Pageable<BinaryData>
    {
        private readonly BasicTypeSpecClient _client;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of BasicTypeSpecClientGetWithHeaderNextLinkCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BasicTypeSpecClient client used to send requests. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public BasicTypeSpecClientGetWithHeaderNextLinkCollectionResult(BasicTypeSpecClient client, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
        }

        /// <summary> Gets the pages of BasicTypeSpecClientGetWithHeaderNextLinkCollectionResult as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextListWithHeaderNextLinkRequest(nextLink, _context) : _client.CreateListWithHeaderNextLinkRequest(_context);
