...
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenAsyncCollectionResultOfT : AsyncPageable<global::BasicTypeSpec.ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenAsyncCollectionResultOfT(BasicTypeSpecClient client, string token, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _token = token;
            _context = context;
