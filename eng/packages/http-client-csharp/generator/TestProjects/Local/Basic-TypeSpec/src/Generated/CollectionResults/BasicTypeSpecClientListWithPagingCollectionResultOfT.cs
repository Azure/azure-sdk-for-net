...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithPagingCollectionResultOfT : Pageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientListWithPagingCollectionResultOfT(BasicTypeSpecClient client, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
