...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithPagingAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientListWithPagingAsyncCollectionResult(BasicTypeSpecClient client, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
