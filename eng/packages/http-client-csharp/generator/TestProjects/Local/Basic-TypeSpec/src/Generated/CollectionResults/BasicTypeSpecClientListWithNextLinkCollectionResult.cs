...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithNextLinkCollectionResult : Pageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientListWithNextLinkCollectionResult(BasicTypeSpecClient client, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
