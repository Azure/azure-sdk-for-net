...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithNextLinkCollectionResultOfT : Pageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientListWithNextLinkCollectionResultOfT(BasicTypeSpecClient client, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
