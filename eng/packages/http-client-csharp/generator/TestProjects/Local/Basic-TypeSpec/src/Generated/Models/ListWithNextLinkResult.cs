...
namespace BasicTypeSpec
{
    ...
    internal partial class ListWithNextLinkResult
    {
        ...
        internal ListWithNextLinkResult(IEnumerable<ThingModel> things)
        {
        ...
        internal ListWithNextLinkResult(IList<ThingModel> things, Uri next, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Things = things;
            Next = next;
