...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenWithMaxPageCollectionResult : Pageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenWithMaxPageCollectionResult(BasicTypeSpecClient client, int numElements, string token, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
