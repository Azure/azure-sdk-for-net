...
{
    internal partial class BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BasicTypeSpecClient client used to send requests. </param>
        /// <param name="numElements"></param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageAsyncCollectionResult(BasicTypeSpecClient client, int numElements, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageAsyncCollectionResult as an enumerable collection. </summary>
