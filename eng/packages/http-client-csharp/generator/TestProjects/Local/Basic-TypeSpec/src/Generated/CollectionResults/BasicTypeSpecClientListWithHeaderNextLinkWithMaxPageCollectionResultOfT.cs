...
{
    internal partial class BasicTypeSpecClientListWithHeaderNextLinkWithMaxPageCollectionResultOfT : Pageable<ThingModel>
    {
        ...
        /// <summary> Initializes a new instance of BasicTypeSpecClientListWithHeaderNextLinkWithMaxPageCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BasicTypeSpecClient client used to send requests. </param>
        /// <param name="numElements"></param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public BasicTypeSpecClientListWithHeaderNextLinkWithMaxPageCollectionResultOfT(BasicTypeSpecClient client, int numElements, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BasicTypeSpecClientListWithHeaderNextLinkWithMaxPageCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BasicTypeSpecClientListWithHeaderNextLinkWithMaxPageCollectionResultOfT as an enumerable collection. </returns>
