...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageCollectionResultOfT : Pageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithHeaderNextLinkWithMaxPageCollectionResultOfT(BasicTypeSpecClient client, int numElements, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
