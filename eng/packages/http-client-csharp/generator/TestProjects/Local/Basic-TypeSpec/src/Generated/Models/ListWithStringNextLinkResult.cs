...
namespace BasicTypeSpec
{
    ...
    internal partial class ListWithStringNextLinkResult
    {
        ...
        internal ListWithStringNextLinkResult(IEnumerable<ThingModel> things)
        {
        ...
        internal ListWithStringNextLinkResult(IList<ThingModel> things, string next, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Things = things;
            Next = next;
