...
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenHeaderResponseCollectionResultOfT : Pageable<global::BasicTypeSpec.ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenHeaderResponseCollectionResultOfT(BasicTypeSpecClient client, string token, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _token = token;
            _context = context;
