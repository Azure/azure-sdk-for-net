...
{
    internal partial class BasicTypeSpecClientListWithStringNextLinkCollectionResultOfT : Pageable<ThingModel>
    {
        private readonly BasicTypeSpecClient _client;
        private readonly RequestContext _context;
        private readonly string _diagnosticScope;

        /// <summary> Initializes a new instance of BasicTypeSpecClientListWithStringNextLinkCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BasicTypeSpecClient client used to send requests. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public BasicTypeSpecClientListWithStringNextLinkCollectionResultOfT(BasicTypeSpecClient client, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
        ...
        /// <summary> Gets the pages of BasicTypeSpecClientListWithStringNextLinkCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BasicTypeSpecClientListWithStringNextLinkCollectionResultOfT as an enumerable collection. </returns>
