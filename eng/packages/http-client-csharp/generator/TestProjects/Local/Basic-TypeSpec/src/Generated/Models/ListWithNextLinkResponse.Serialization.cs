...
namespace BasicTypeSpec
{
    ...
    internal partial class ListWithNextLinkResponse : IJsonModel<ListWithNextLinkResponse>
    {
        ...
        /// <param name="listWithNextLinkResponse"> The <see cref="ListWithNextLinkResponse"/> to serialize into <see cref="RequestContent"/>. </param>
        public static implicit operator RequestContent(ListWithNextLinkResponse listWithNextLinkResponse)
        {
            ...
            content.JsonWriter.WriteObjectValue(listWithNextLinkResponse, ModelSerializationExtensions.WireOptions);
            return content;
        }
