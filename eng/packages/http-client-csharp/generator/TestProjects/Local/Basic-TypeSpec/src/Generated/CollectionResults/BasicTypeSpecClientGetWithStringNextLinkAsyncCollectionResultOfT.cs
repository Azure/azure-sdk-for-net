...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithStringNextLinkAsyncCollectionResultOfT : AsyncPageable<ThingModel>
    {
        ...
        public BasicTypeSpecClientGetWithStringNextLinkAsyncCollectionResultOfT(BasicTypeSpecClient client, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _context = context;
        }
