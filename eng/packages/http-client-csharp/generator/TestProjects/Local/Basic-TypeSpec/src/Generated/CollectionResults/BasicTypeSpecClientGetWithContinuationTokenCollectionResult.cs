...
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public BasicTypeSpecClientGetWithContinuationTokenCollectionResult(BasicTypeSpecClient client, string token, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _token = token;
            _context = context;
