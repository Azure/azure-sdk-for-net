...
namespace BasicTypeSpec
{
    internal partial class MultiPartFormDataRequestContent : RequestContent
    {
        ...
        {
            _multipartContent = new MultipartFormDataContent(global::BasicTypeSpec.MultiPartFormDataRequestContent.CreateBoundary());
        }
        ...
        private void Add(HttpContent content, string name, string filename, string contentType)
        {
            if ((contentType != null))
            {
                global::BasicTypeSpec.Argument.AssertNotNullOrEmpty(contentType, nameof(contentType));
                global::BasicTypeSpec.MultiPartFormDataRequestContent.AddContentTypeHeader(content, contentType);
            }
            if ((filename != null))
            {
                global::BasicTypeSpec.Argument.AssertNotNullOrEmpty(filename, nameof(filename));
