...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientListWithContinuationTokenHeaderResponseAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public BasicTypeSpecClientListWithContinuationTokenHeaderResponseAsyncCollectionResult(BasicTypeSpecClient client, string token, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _token = token;
            _context = context;
