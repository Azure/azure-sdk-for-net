...
namespace BasicTypeSpec
{
    ...
    internal partial class ListWithContinuationTokenHeaderResponseResult : IJsonModel<ListWithContinuationTokenHeaderResponseResult>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ListWithContinuationTokenHeaderResponseResult"/> from. </param>
        public static explicit operator ListWithContinuationTokenHeaderResponseResult(Response response)
        {
