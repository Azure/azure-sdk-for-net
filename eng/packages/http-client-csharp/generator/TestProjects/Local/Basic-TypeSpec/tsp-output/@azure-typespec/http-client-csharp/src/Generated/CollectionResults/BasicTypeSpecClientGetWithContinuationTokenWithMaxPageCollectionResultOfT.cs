...
namespace BasicTypeSpec
{
    internal partial class BasicTypeSpecClientGetWithContinuationTokenWithMaxPageCollectionResultOfT : Pageable<ThingModel>
    {
        ...
        /// <summary> Initializes a new instance of BasicTypeSpecClientGetWithContinuationTokenWithMaxPageCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BasicTypeSpecClient client used to send requests. </param>
        /// <param name="numElements"></param>
        /// <param name="token"></param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public BasicTypeSpecClientGetWithContinuationTokenWithMaxPageCollectionResultOfT(BasicTypeSpecClient client, int numElements, string token, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BasicTypeSpecClientGetWithContinuationTokenWithMaxPageCollectionResultOfT as an enumerable collection. </summary>
