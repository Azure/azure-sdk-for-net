...
function New-PackageFolder() {
  ...
  $projectFolder="$sdkPath/sdk/$packageName/Azure.$ServiceGrouop.$packageName"
  if (Test-Path -Path $projectFolder) {
    ...
    dotnet new dataplane --provider $packageName --includeCI true --force
  }
