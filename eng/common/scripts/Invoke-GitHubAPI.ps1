...
function Invoke-GitHubAPIPost {
  ...
  try {
    ...
    LogWarning "Invoke-GitHubAPIPost failed Uri [ $apiURI ] `nBody [ $body ]"
    throw 
  }
}
...
function Invoke-GitHubAPIPatch {
  ...
  try {
    ...
    LogWarning "Invoke-GitHubAPIPatch failed `nUri [ $apiURI ] `nBody [ $body ]"
    throw 
  }
}
...
function Invoke-GitHubAPIDelete {
  ...
  try {
    ...
    LogWarning "Invoke-GitHubAPIDelete failed `nUri [ $apiURI ]"
    throw 
  }
}
...
function Invoke-GitHubAPIGet {
  ...
  try {
    ...
    LogWarning "Invoke-GitHubAPIGet failed `nUri [ $apiURI ]"
    throw 
  }
}
