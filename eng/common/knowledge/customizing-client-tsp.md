...
| **JavaScript** | [JS Customization Guide]([https://github.com/Azure/azure-sdk-for-js/wiki/Modular-(DPG)-Customization-Guide](https://github.com/Azure/azure-sdk-for-js/blob/main/documentation/modular-customization.md)) | Copy `src/` to `generated/`, add customizations in `src/` |
