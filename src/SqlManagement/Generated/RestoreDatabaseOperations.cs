...
namespace Microsoft.WindowsAzure.Management.Sql
{
    ...
    internal partial class RestoreDatabaseOperations : IServiceOperations<SqlManagementClient>, IRestoreDatabaseOperations
    {
        ...
        public async Task<RestoreDatabaseOperationCreateResponse> CreateAsync(string sourceServerName, RestoreDatabaseOperationCreateParameters parameters, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/" + (this.Client.Credentials.SubscriptionId == null ? "" : Uri.EscapeDataString(this.Client.Credentials.SubscriptionId)) + "/services/sqlservers/servers/" + Uri.EscapeDataString(sourceServerName) + "/restoredatabaseoperations";
