...
namespace Microsoft.WindowsAzure.Management.Sql
{
    ...
    internal partial class DatabaseCopyOperations : IServiceOperations<SqlManagementClient>, Microsoft.WindowsAzure.Management.Sql.IDatabaseCopyOperations
    {
        ...
        public async System.Threading.Tasks.Task<Microsoft.WindowsAzure.Management.Sql.Models.DatabaseCopyCreateResponse> CreateAsync(string serverName, string databaseName, DatabaseCopyCreateParameters parameters, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/" + Uri.EscapeDataString(this.Client.Credentials.SubscriptionId != null ? this.Client.Credentials.SubscriptionId.Trim() : "") + "/services/sqlservers/servers/" + Uri.EscapeDataString(serverName.Trim()) + "/databases/" + Uri.EscapeDataString(databaseName.Trim()) + "/databasecopies";
        ...
        public async System.Threading.Tasks.Task<OperationResponse> DeleteAsync(string serverName, string databaseName, Guid databaseCopyName, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/" + Uri.EscapeDataString(this.Client.Credentials.SubscriptionId != null ? this.Client.Credentials.SubscriptionId.Trim() : "") + "/services/sqlservers/servers/" + Uri.EscapeDataString(serverName.Trim()) + "/databases/" + Uri.EscapeDataString(databaseName.Trim()) + "/databasecopies/" + Uri.EscapeDataString(databaseCopyName.ToString());
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.WindowsAzure.Management.Sql.Models.DatabaseCopyGetResponse> GetAsync(string serverName, string databaseName, string databaseCopyName, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/" + Uri.EscapeDataString(this.Client.Credentials.SubscriptionId != null ? this.Client.Credentials.SubscriptionId.Trim() : "") + "/services/sqlservers/servers/" + Uri.EscapeDataString(serverName.Trim()) + "/databases/" + Uri.EscapeDataString(databaseName.Trim()) + "/databasecopies/" + Uri.EscapeDataString(databaseCopyName.Trim());
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
            {
