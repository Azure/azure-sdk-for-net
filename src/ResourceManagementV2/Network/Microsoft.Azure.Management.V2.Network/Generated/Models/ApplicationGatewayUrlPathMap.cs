...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    [JsonTransformation]
    public partial class ApplicationGatewayUrlPathMap : Resource
    {
        /// <summary>
        ...
        public ApplicationGatewayUrlPathMap(String location = default(String), String id = default(String), String name = default(String), String type = default(String), IDictionary<string, String> tags = default(IDictionary<string, String>), SubResource defaultBackendAddressPool = default(SubResource), SubResource defaultBackendHttpSettings = default(SubResource), IList<ApplicationGatewayPathRule> pathRules = default(IList<ApplicationGatewayPathRule>), string provisioningState = default(string), string name = default(string), string etag = default(string))
