...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class VirtualNetworkGatewayListResultInner
    {
        ...
        /// results.</param>
        public VirtualNetworkGatewayListResultInner(IList<VirtualNetworkGatewayInner> value = default(IList<VirtualNetworkGatewayInner>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IList<VirtualNetworkGatewayInner> Value { get; set; }
