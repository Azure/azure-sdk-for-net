    ...
    internal partial class ExpressRouteCircuitAuthorizationsOperations : IServiceOperations<NetworkManagementClient>, IExpressRouteCircuitAuthorizationsOperations
    {
        ...
        public async Task<AzureOperationResponse<ExpressRouteCircuitAuthorizationInner>> GetWithHttpMessagesAsync(string resourceGroupName, string circuitName, string authorizationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<ExpressRouteCircuitAuthorizationInner>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        {
            // Send Request
            AzureOperationResponse<ExpressRouteCircuitAuthorizationInner> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(
        ...
        public async Task<AzureOperationResponse<IPage<ExpressRouteCircuitAuthorizationInner>>> ListWithHttpMessagesAsync(string resourceGroupName, string circuitName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<Page<ExpressRouteCircuitAuthorizationInner>>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
