    ...
    internal partial class VirtualNetworkPeeringsOperations : IServiceOperations<NetworkManagementClient>, IVirtualNetworkPeeringsOperations
    {
        ...
        public async Task<AzureOperationResponse<VirtualNetworkPeeringInner>> GetWithHttpMessagesAsync(string resourceGroupName, string virtualNetworkName, string virtualNetworkPeeringName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<VirtualNetworkPeeringInner>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        {
            // Send Request
            AzureOperationResponse<VirtualNetworkPeeringInner> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(
        ...
        public async Task<AzureOperationResponse<IPage<VirtualNetworkPeeringInner>>> ListWithHttpMessagesAsync(string resourceGroupName, string virtualNetworkName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<Page<VirtualNetworkPeeringInner>>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
