...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class VirtualNetworkGatewaysOperations : IServiceOperations<NetworkManagementClient>, IVirtualNetworkGatewaysOperations
    {
        ...
        {
            // Send Request
            AzureOperationResponse<VirtualNetworkGatewayInner> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(
        ...
        public async Task<AzureOperationResponse<VirtualNetworkGatewayInner>> BeginCreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string virtualNetworkGatewayName, VirtualNetworkGatewayInner parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<VirtualNetworkGatewayInner>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<IPage<VirtualNetworkGatewayInner>>> ListWithHttpMessagesAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<Page<VirtualNetworkGatewayInner>>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        {
            // Send request
            AzureOperationResponse<VirtualNetworkGatewayInner> _response = await BeginResetWithHttpMessagesAsync(
                resourceGroupName, virtualNetworkGatewayName, parameters, customHeaders, cancellationToken);
            return await this.Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken);
        }
