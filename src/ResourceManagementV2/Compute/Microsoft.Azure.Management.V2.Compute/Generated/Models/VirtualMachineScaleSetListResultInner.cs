...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineScaleSetListResultInner
    {
        ...
        /// page of VMSS.</param>
        public VirtualMachineScaleSetListResultInner(IList<VirtualMachineScaleSetInner> value = default(IList<VirtualMachineScaleSetInner>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
        }
