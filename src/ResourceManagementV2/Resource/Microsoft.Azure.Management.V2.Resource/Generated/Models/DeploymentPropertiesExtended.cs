...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class DeploymentPropertiesExtended
    {
        ...
        /// provisioning.</param>
        /// <param name="correlationId">Gets or sets the correlation ID of the
        /// deployment.</param>
        /// <param name="timestamp">Gets or sets the timestamp of the template
        /// deployment.</param>
        /// <param name="outputs">Gets or sets key/value pairs that represent
        /// deploymentoutput.</param>
        /// <param name="providers">Gets the list of resource providers needed
        /// for the deployment.</param>
        /// <param name="dependencies">Gets the list of deployment
        /// dependencies.</param>
