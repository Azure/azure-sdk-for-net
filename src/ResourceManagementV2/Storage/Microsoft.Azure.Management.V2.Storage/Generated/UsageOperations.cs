...
namespace Microsoft.Azure.Management.Storage
{
    ...
    internal partial class UsageOperations : IServiceOperations<StorageManagementClient>, IUsageOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<UsageListResultInner>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<UsageListResultInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<UsageListResultInner>(_responseContent, this.Client.DeserializationSettings);
                }
