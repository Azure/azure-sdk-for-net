...
namespace Microsoft.Azure.Management.Sql
{
    ...
    internal partial class ServerOperations : IServiceOperations<SqlManagementClient>, IServerOperations
    {
        ...
        public async Task<ServerGetResponse> CreateOrUpdateAsync(string resourceGroupName, string serverName, ServerCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/subscriptions/" + Uri.EscapeDataString(this.Client.Credentials.SubscriptionId != null ? this.Client.Credentials.SubscriptionId.Trim() : "") + "/resourceGroups/" + Uri.EscapeDataString(resourceGroupName.Trim()) + "/providers/Microsoft.Sql/servers/" + Uri.EscapeDataString(serverName.Trim()) + "?";
        ...
        public async Task<ServerListResponse> ListAsync(string resourceGroupName, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/subscriptions/" + Uri.EscapeDataString(this.Client.Credentials.SubscriptionId != null ? this.Client.Credentials.SubscriptionId.Trim() : "") + "/resourceGroups/" + Uri.EscapeDataString(resourceGroupName.Trim()) + "/providers/Microsoft.Sql/servers?";
            url = url + "api-version=2014-04-01";
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
