...
namespace Microsoft.AzureStack.Management.Commerce.Admin
{
    ...
    internal partial class SubscriberUsageAggregatesOperations : IServiceOperations<CommerceAdminClient>, ISubscriberUsageAggregatesOperations
    {
        ...
        public async Task<AzureOperationResponse<UsageAggregatePage>> ListWithHttpMessagesAsync(System.DateTime reportedStartTime, System.DateTime reportedEndTime, string aggregationGranularity = default(string), string subscriberId = default(string), string continuationToken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<UsageAggregatePage>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<UsageAggregatePage>(_responseContent, Client.DeserializationSettings);
                }
