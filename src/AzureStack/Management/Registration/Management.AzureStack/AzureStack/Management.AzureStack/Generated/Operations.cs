...
namespace Microsoft.Azure.Management.AzureStack
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureStackManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureStackManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.AzureStack/operations").ToString();
