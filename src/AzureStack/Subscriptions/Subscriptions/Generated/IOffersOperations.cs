...
namespace Microsoft.AzureStack.Management.Subscriptions
{
    ...
    public partial interface IOffersOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<Offer>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get the list of public offers for the root provider.
        /// </summary>
