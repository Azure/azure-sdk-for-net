...
namespace Microsoft.AzureStack.Management.Subscriptions
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<SubscriptionsManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(SubscriptionsManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationList>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Subscriptions/operations").ToString();
