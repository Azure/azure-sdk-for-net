...
namespace Microsoft.AzureStack.Management.Network.Admin
{
    ...
    public partial interface IPublicIPAddressesOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<PublicIpAddress>>> ListWithHttpMessagesAsync(ODataQuery<PublicIpAddress> odataQuery = default(ODataQuery<PublicIpAddress>), string inlineCount = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List of public ip addresses.
        /// </summary>
