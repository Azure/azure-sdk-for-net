...
namespace Microsoft.AzureStack.Management.InfrastructureInsights.Admin
{
    ...
    /// </summary>
    internal partial class AlertsOperations : IServiceOperations<InfrastructureInsightsAdminClient>, IAlertsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal AlertsOperations(InfrastructureInsightsAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<Alert>> CloseWithHttpMessagesAsync(string resourceGroupName, string location, string alertName, string user, Alert alert, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if(alert != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(alert, Client.SerializationSettings);
