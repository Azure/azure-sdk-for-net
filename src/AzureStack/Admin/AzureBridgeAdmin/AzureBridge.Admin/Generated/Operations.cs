...
namespace Microsoft.AzureStack.Management.AzureBridge.Admin
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureBridgeAdminClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureBridgeAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.AzureBridge.Admin/operations").ToString();
