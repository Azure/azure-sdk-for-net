...
namespace Microsoft.WindowsAzure.Management.StorSimple
{
    ...
    /// more information)
    /// </summary>
    internal partial class DeviceDetailsOperations : IServiceOperations<StorSimpleManagementClient>, Microsoft.WindowsAzure.Management.StorSimple.IDeviceDetailsOperations
    {
        /// <summary>
        ...
        /// </returns>
        public async System.Threading.Tasks.Task<Microsoft.WindowsAzure.Management.StorSimple.Models.DeviceDetailsResponse> GetAsync(string deviceId, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (deviceId == null)
            {
            ...
            // Construct URL
            string url = "/" + (this.Client.Credentials.SubscriptionId != null ? this.Client.Credentials.SubscriptionId.Trim() : "") + "/cloudservices/" + this.Client.CloudServiceName.Trim() + "/resources/" + this.Client.ResourceNamespace.Trim() + "/~/CiSVault/" + this.Client.ResourceName.Trim() + "/api/devices/" + deviceId.Trim() + "?";
            url = url + "api-version=2014-01-01.3.0";
