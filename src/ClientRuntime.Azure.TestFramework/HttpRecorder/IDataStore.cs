...
namespace Microsoft.Azure.Test.HttpRecorder
{
    public interface IDataStore
    {
        ...
        string[] GetDirectories(string sourceDirName, string pattern, bool recursive);


        /*New one for test framework*/
        string[] GetFiles(string sourceDirName, string pattern, bool recursive);
