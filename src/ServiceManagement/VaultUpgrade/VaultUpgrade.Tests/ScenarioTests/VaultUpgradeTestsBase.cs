...
namespace VaultUpgrade.Tests
{
    public class VaultUpgradeTestsBase : TestBase
    {
        ...
        public VaultUpgradeManagementClient GetVaultUpgradeClient(RecordedDelegationHandler handler)
        {
            handler.IsPassThrough = true;
            return this.GetVaultUpgradeManagementClient().WithHandler(handler); ;
        }
    }
}