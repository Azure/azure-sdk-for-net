...
namespace VaultUpgrade.Tests
{
    public class VaultUpgradeTests : VaultUpgradeTestsBase
    {
        ...
        public void VaultUpgrade_CheckPrereqsTests()
        {
            ...
            {
                context.Start();
                var client = GetVaultUpgradeClient(CustomHttpHandler);
                ...
                var response = client.VaultUpgrade.CheckPrerequisitesForVaultUpgrade(input, requestHeaders);
        ...
        public void VaultUpgrade_UpgradeResourceTests()
        {
            using (UndoContext context = UndoContext.Current)
            {
                ...
                var response = client.VaultUpgrade.UpgradeResource(input, requestHeaders);
        ...
        public void VaultUpgrade_TrackResourceUpgradationTests()
        {
            using (UndoContext context = UndoContext.Current)
            {
                ...
                var response = client.VaultUpgrade.TrackResourceUpgrade(requestHeaders);
