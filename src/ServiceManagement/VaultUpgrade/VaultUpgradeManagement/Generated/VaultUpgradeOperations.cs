...
{
    /// <summary>
    /// Definition of vault upgrade operations for the VaultUpgrade extension.
    /// </summary>
    internal partial class VaultUpgradeOperations : IServiceOperations<VaultUpgradeManagementClient>, IVaultUpgradeOperations
    {
        /// <summary>
        /// Initializes a new instance of the VaultUpgradeOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal VaultUpgradeOperations(VaultUpgradeManagementClient client)
        {
            this._client = client;
        }

        private VaultUpgradeManagementClient _client;

        /// <summary>
        /// Gets a reference to the
        /// Microsoft.WindowsAzure.Management.VaultUpgrade.VaultUpgradeManagementClient.
        /// </summary>
        public VaultUpgradeManagementClient Client
        {
        ...
        /// </returns>
        public async Task<AzureResponse> CheckPrerequisitesForVaultUpgradeAsync(ResourceUpgradeInput resourceUpgradeInput, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            ...
            if (shouldTrace)
            {
                ...
                TracingAdapter.Enter(invocationId, this, "CheckPrerequisitesForVaultUpgradeAsync", tracingParameters);
            }
