...
namespace Microsoft.WindowsAzure.Management.StorSimple.Models
{
    ...
    public partial class BackupPolicyListResponse : AzureOperationResponse, IEnumerable<BackupPolicy>
    {
        ...
        /// </summary>
        public IList<BackupPolicy> BackupPolicies
        {
        ...
        /// </summary>
        public BackupPolicyListResponse()
        {
            this.BackupPolicies = new List<BackupPolicy>();
        }
        
        /// <summary>
        /// Gets the sequence of BackupPolicies.
        /// </summary>
        public IEnumerator<BackupPolicy> GetEnumerator()
        {
            return this.BackupPolicies.GetEnumerator();
        }
