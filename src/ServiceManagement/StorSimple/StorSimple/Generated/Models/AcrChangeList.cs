...
namespace Microsoft.WindowsAzure.Management.StorSimple.Models
{
    ...
    /// </summary>
    public partial class AcrChangeList
    {
        private IList<AccessControlRecord> _added;
        
        /// <summary>
        /// Optional. List of access control record to add
        /// </summary>
        public IList<AccessControlRecord> Added
        {
        ...
        private IList<AccessControlRecord> _updated;
        
        /// <summary>
        /// Optional. List of access control record to update
        /// </summary>
        public IList<AccessControlRecord> Updated
        {
        ...
        /// </summary>
        public AcrChangeList()
        {
            this.Added = new List<AccessControlRecord>();
            this.Deleted = new List<string>();
            this.Updated = new List<AccessControlRecord>();
        }
    }
}
