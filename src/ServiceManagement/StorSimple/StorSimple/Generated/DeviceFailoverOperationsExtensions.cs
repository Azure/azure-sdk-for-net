...
namespace Microsoft.WindowsAzure.Management.StorSimple
{
    ...
    /// </summary>
    public static partial class DeviceFailoverOperationsExtensions
    {
        ...
        /// Represents the response model for DataContainerGroups Get call
        /// </returns>
        public static Task<DataContainerGroupsGetResponse> ListDCGroupsAsync(this IDeviceFailoverOperations operations, string deviceId, CustomRequestHeaders customRequestHeaders)
        {
            return operations.ListDCGroupsAsync(deviceId, customRequestHeaders, CancellationToken.None);
        }
