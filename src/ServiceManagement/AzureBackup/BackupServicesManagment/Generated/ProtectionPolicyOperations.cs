...
namespace Microsoft.WindowsAzure.Management.BackupServices
{
    ...
    internal partial class ProtectionPolicyOperations : IServiceOperations<BackupServicesManagementClient>, IProtectionPolicyOperations
    {
        ...
        /// Microsoft.WindowsAzure.Management.BackupServices.BackupServicesManagementClient.
        /// </summary>
        ...
        /// </returns>
        public async Task<ProtectionPolicyListResponse> ListAsync(string resourceId, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (statusCode == HttpStatusCode.OK)
                    {
                        ...
                        {
                            ProtectionPolicyResponse protectionPoliciesInstance = new ProtectionPolicyResponse();
