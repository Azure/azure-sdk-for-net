...
namespace Microsoft.WindowsAzure.Management.TrafficManager
{
        ...
        : CloudException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the TrafficManagereCloudException class.
        /// </summary>
        /// <param name="message">The exception message.</param>
        public TrafficManagerCloudException(string message)
            : this(message, null)
        {
        }

        /// <summary>
        /// Initializes a new instance of the TrafficManagerCloudException class.
        /// </summary>
        /// <param name="message">The exception message.</param>
        /// <param name="innerException">Inner exception.</param>
        public TrafficManagerCloudException(string message, Exception innerException)
