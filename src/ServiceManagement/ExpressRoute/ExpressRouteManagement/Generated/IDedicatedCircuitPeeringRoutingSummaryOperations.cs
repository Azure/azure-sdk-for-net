...
namespace Microsoft.WindowsAzure.Management.ExpressRoute
{
    public partial interface IDedicatedCircuitPeeringRoutingSummaryOperations
    {
        ...
        /// response.
        /// </returns>
        Task<DedicatedCircuitPeeringRoutingSummaryGetResponse> GetAsync(string serviceKey, BgpPeeringAccessType accessType, DeviceHAState deviceHAState, CancellationToken cancellationToken);
    }
}
