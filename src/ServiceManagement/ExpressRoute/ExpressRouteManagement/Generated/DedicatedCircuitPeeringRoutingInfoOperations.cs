...
{
    internal partial class DedicatedCircuitPeeringRoutingInfoOperations : IServiceOperations<ExpressRouteManagementClient>, IDedicatedCircuitPeeringRoutingInfoOperations
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DedicatedCircuitPeeringRoutingInfoOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal DedicatedCircuitPeeringRoutingInfoOperations(ExpressRouteManagementClient client)
        {
            this._client = client;
        }
        ...
        /// response.
        /// </returns>
        public async Task<DedicatedCircuitPeeringRoutingInfoGetResponse> GetAsync(string serviceKey, BgpPeeringAccessType accessType, DevicePath devicePath, CancellationToken cancellationToken)
        {
            // Validate
            if (serviceKey == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    DedicatedCircuitPeeringRoutingInfoGetResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new DedicatedCircuitPeeringRoutingInfoGetResponse();
                        XDocument responseDoc = XDocument.Parse(responseContent);
                        
                        XElement dedicatedCircuitPeeringRoutingInfoElement = responseDoc.Element(XName.Get("DedicatedCircuitPeeringRoutingInfo", "http://schemas.microsoft.com/windowsazure"));
                        if (dedicatedCircuitPeeringRoutingInfoElement != null)
                        {
                            ...
                            XElement networkElement = dedicatedCircuitPeeringRoutingInfoElement.Element(XName.Get("Network", "http://schemas.microsoft.com/windowsazure"));
                            ...
                            XElement nextHopElement = dedicatedCircuitPeeringRoutingInfoElement.Element(XName.Get("NextHop", "http://schemas.microsoft.com/windowsazure"));
                            ...
                            XElement locPrfElement = dedicatedCircuitPeeringRoutingInfoElement.Element(XName.Get("LocPrf", "http://schemas.microsoft.com/windowsazure"));
                            ...
                            XElement weightElement = dedicatedCircuitPeeringRoutingInfoElement.Element(XName.Get("Weight", "http://schemas.microsoft.com/windowsazure"));
                            ...
                            XElement pathElement = dedicatedCircuitPeeringRoutingInfoElement.Element(XName.Get("Path", "http://schemas.microsoft.com/windowsazure"));
                            if (pathElement != null)
                            {
