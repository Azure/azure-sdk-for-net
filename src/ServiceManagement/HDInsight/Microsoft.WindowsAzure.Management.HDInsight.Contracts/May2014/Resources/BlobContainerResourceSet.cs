...
namespace Microsoft.WindowsAzure.Management.HDInsight.Contracts.May2014.Resources
{
    ...
    internal class BlobContainerResourceSet : RestCollectionDataContract<BlobContainerCredentialBackedResource>
    {
         public BlobContainerResourceSet()
         {
         }

         public BlobContainerResourceSet(IEnumerable<BlobContainerCredentialBackedResource> blobContainers)
            : base(blobContainers)
        {
        }
    }
