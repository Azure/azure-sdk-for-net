...
namespace Microsoft.WindowsAzure.Management.SiteRecovery.Models
{
    ...
    /// </summary>
    public partial class StorageListResponse : AzureOperationResponse, IEnumerable<AsrStorage>
    {
        private IList<AsrStorage> _storages;
        
        /// <summary>
        /// Optional. The list of storages for the given vault.
        /// </summary>
        public IList<AsrStorage> Storages
        {
            get { return this._storages; }
            set { this._storages = value; }
        }
        ...
        {
            this.Storages = new LazyList<AsrStorage>();
        }
        
        /// <summary>
        /// Gets the sequence of Storages.
        /// </summary>
        public IEnumerator<AsrStorage> GetEnumerator()
        {
