...
namespace Microsoft.WindowsAzure.Management.SiteRecovery
{
    ...
    internal partial class NetworkMappingOperations : IServiceOperations<SiteRecoveryManagementClient>, INetworkMappingOperations
    {
        ...
        /// </returns>
        public async Task<JobResponse> CreateAsync(NetworkMappingInput parameters, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (parameters == null)
            {
            ...
            if (parameters.CreateNetworkMappingInput == null)
            {
                throw new ArgumentNullException("parameters.CreateNetworkMappingInput");
            }
            if (parameters.NetworkTargetType == null)
            {
                throw new ArgumentNullException("parameters.NetworkTargetType");
            }
            ...
            try
            {
                ...
                XElement networkMappingInputElement = new XElement(XName.Get("NetworkMappingInput", "http://schemas.microsoft.com/windowsazure"));
                requestDoc.Add(networkMappingInputElement);
                
                XElement networkTargetTypeElement = new XElement(XName.Get("NetworkTargetType", "http://schemas.microsoft.com/windowsazure"));
                networkTargetTypeElement.Value = parameters.NetworkTargetType;
                networkMappingInputElement.Add(networkTargetTypeElement);
                
                XElement createNetworkMappingInputElement = new XElement(XName.Get("CreateNetworkMappingInput", "http://schemas.microsoft.com/windowsazure"));
                createNetworkMappingInputElement.Value = parameters.CreateNetworkMappingInput;
                networkMappingInputElement.Add(createNetworkMappingInputElement);
        ...
        /// The response model for the Job details object.
        /// </returns>
        public async Task<JobResponse> DeleteAsync(NetworkUnMappingInput parameters, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (parameters == null)
            {
            ...
            if (parameters.PrimaryNetworkId == null)
            {
                throw new ArgumentNullException("parameters.PrimaryNetworkId");
            }
            ...
            try
            {
                ...
                XElement networkUnMappingInputElement = new XElement(XName.Get("NetworkUnMappingInput", "http://schemas.microsoft.com/windowsazure"));
                requestDoc.Add(networkUnMappingInputElement);
                ...
                networkUnMappingInputElement.Add(primaryServerIdElement);
                
                XElement primaryNetworkIdElement = new XElement(XName.Get("PrimaryNetworkId", "http://schemas.microsoft.com/windowsazure"));
                primaryNetworkIdElement.Value = parameters.PrimaryNetworkId;
                networkUnMappingInputElement.Add(primaryNetworkIdElement);
                ...
                networkUnMappingInputElement.Add(recoveryServerIdElement);
        ...
        /// </returns>
        public async Task<NetworkMappingListResponse> ListAsync(string primaryServerId, string recoveryServerId, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    NetworkMappingListResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new NetworkMappingListResponse();
                        XDocument responseDoc = XDocument.Parse(responseContent);
                        
                        XElement arrayOfNetworkMappingSequenceElement = responseDoc.Element(XName.Get("ArrayOfNetworkMapping", "http://schemas.microsoft.com/windowsazure"));
                        if (arrayOfNetworkMappingSequenceElement != null)
                        {
                            foreach (XElement arrayOfNetworkMappingElement in arrayOfNetworkMappingSequenceElement.Elements(XName.Get("NetworkMapping", "http://schemas.microsoft.com/windowsazure")))
                            {
                                NetworkMapping networkMappingInstance = new NetworkMapping();
                                result.NetworkMappings.Add(networkMappingInstance);
                                
                                XElement primaryServerIdElement = arrayOfNetworkMappingElement.Element(XName.Get("PrimaryServerId", "http://schemas.microsoft.com/windowsazure"));
                                if (primaryServerIdElement != null)
                                {
                                    string primaryServerIdInstance = primaryServerIdElement.Value;
                                    networkMappingInstance.PrimaryServerId = primaryServerIdInstance;
                                }
                                
                                XElement primaryNetworkIdElement = arrayOfNetworkMappingElement.Element(XName.Get("PrimaryNetworkId", "http://schemas.microsoft.com/windowsazure"));
                                if (primaryNetworkIdElement != null)
                                {
                                    string primaryNetworkIdInstance = primaryNetworkIdElement.Value;
                                    networkMappingInstance.PrimaryNetworkId = primaryNetworkIdInstance;
                                }
                                
                                XElement primaryNetworkNameElement = arrayOfNetworkMappingElement.Element(XName.Get("PrimaryNetworkName", "http://schemas.microsoft.com/windowsazure"));
                                if (primaryNetworkNameElement != null)
                                {
                                    string primaryNetworkNameInstance = primaryNetworkNameElement.Value;
                                    networkMappingInstance.PrimaryNetworkName = primaryNetworkNameInstance;
                                }
                                
                                XElement recoveryServerIdElement = arrayOfNetworkMappingElement.Element(XName.Get("RecoveryServerId", "http://schemas.microsoft.com/windowsazure"));
                                if (recoveryServerIdElement != null)
                                {
                                    string recoveryServerIdInstance = recoveryServerIdElement.Value;
                                    networkMappingInstance.RecoveryServerId = recoveryServerIdInstance;
                                }
                                
                                XElement recoveryNetworkIdElement = arrayOfNetworkMappingElement.Element(XName.Get("RecoveryNetworkId", "http://schemas.microsoft.com/windowsazure"));
                                if (recoveryNetworkIdElement != null)
                                {
                                    string recoveryNetworkIdInstance = recoveryNetworkIdElement.Value;
                                    networkMappingInstance.RecoveryNetworkId = recoveryNetworkIdInstance;
                                }
                                
                                XElement recoveryNetworkNameElement = arrayOfNetworkMappingElement.Element(XName.Get("RecoveryNetworkName", "http://schemas.microsoft.com/windowsazure"));
                                if (recoveryNetworkNameElement != null)
                                {
                                    string recoveryNetworkNameInstance = recoveryNetworkNameElement.Value;
                                    networkMappingInstance.RecoveryNetworkName = recoveryNetworkNameInstance;
                                }
                                
                                XElement pairingStatusElement = arrayOfNetworkMappingElement.Element(XName.Get("PairingStatus", "http://schemas.microsoft.com/windowsazure"));
                                if (pairingStatusElement != null)
                                {
                                    string pairingStatusInstance = pairingStatusElement.Value;
                                    networkMappingInstance.PairingStatus = pairingStatusInstance;
                                }
                            }
                        }
