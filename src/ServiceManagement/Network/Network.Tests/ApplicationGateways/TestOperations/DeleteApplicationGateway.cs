...
{
    public class DeleteApplicationGateway : TestOperation
    {
        ...
        public DeleteApplicationGateway(IApplicationGatewayOperations applicationGatewayClient, string gatewayName)
        {
