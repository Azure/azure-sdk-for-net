...
{
    public partial interface IDedicatedCircuitServiceProviderOperations
    {
        /// <summary>
        ...
        /// </returns>
        Task<DedicatedCircuitServiceProviderListResponse> ListAsync(CancellationToken cancellationToken);
    }
}
