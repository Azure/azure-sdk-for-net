...
namespace Microsoft.Azure.Management.Automation
{
    ...
    internal partial class CredentialOperations : IServiceOperations<AutomationManagementClient>, ICredentialOperations
    {
        ...
        /// </returns>
        public async Task<CredentialCreateResponse> CreateAsync(string automationAccount, CredentialCreateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            ...
            try
            {
                ...
                JObject credentialCreateParametersValue = new JObject();
                requestDoc = credentialCreateParametersValue;
                
                credentialCreateParametersValue["name"] = parameters.Name;
                
                JObject propertiesValue = new JObject();
                credentialCreateParametersValue["properties"] = propertiesValue;
                ...
                try
                {
                    ...
                    // Create Result
                    CredentialCreateResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.Created)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new CredentialCreateResponse();
        ...
        /// request ID.
        /// </returns>
        public async Task<AzureOperationResponse> DeleteAsync(string automationAccount, string credentialName, CancellationToken cancellationToken)
        {
            // Validate
            if (automationAccount == null)
            {
        ...
        /// </returns>
        public async Task<CredentialGetResponse> GetAsync(string automationAccount, string credentialName, CancellationToken cancellationToken)
        {
            // Validate
            if (automationAccount == null)
            {
        ...
        /// </returns>
        public async Task<CredentialListResponse> ListAsync(string automationAccount, CancellationToken cancellationToken)
        {
            // Validate
            if (automationAccount == null)
            {
        ...
        /// request ID.
        /// </returns>
        public async Task<AzureOperationResponse> UpdateAsync(string automationAccount, CredentialUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (automationAccount == null)
            {
