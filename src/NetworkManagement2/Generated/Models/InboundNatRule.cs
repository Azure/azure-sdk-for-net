...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    /// </summary>
    public partial class InboundNatRule : ChildResource
    {
        private ResourceId _backendIPConfiguration;
        ...
        {
            get { return this._backendIPConfiguration; }
            set { this._backendIPConfiguration = value; }
        }
        ...
        /// required arguments.
        /// </summary>
        public InboundNatRule(string protocol, int frontendPort, bool enableFloatingIP)
            : this()
        {
            if (protocol == null)
            {
