...
namespace Microsoft.Azure.Management.DataFactories
{
    ...
    /// </summary>
    internal partial class InternalTableOperations : IServiceOperations<InternalDataFactoryManagementClient>, IInternalTableOperations
    {
        /// <summary>
        /// Initializes a new instance of the InternalTableOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal InternalTableOperations(InternalDataFactoryManagementClient client)
        {
            this._client = client;
        }
        ...
        /// </returns>
        public async Task<InternalTableCreateOrUpdateResponse> BeginCreateOrUpdateAsync(string resourceGroupName, string dataFactoryName, InternalTableCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            ...
            try
            {
                ...
                JObject internalTableCreateOrUpdateParametersValue = new JObject();
                requestDoc = internalTableCreateOrUpdateParametersValue;
                
                if (parameters.Table != null)
                {
                    internalTableCreateOrUpdateParametersValue["name"] = parameters.Table.Name;
                    
                    JObject propertiesValue = new JObject();
                    internalTableCreateOrUpdateParametersValue["properties"] = propertiesValue;
                ...
                try
                {
                    ...
                    // Create Result
                    InternalTableCreateOrUpdateResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK || statusCode == HttpStatusCode.Created)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalTableCreateOrUpdateResponse();
                        ...
                        {
                            InternalTable tableInstance = new InternalTable();
                            ...
                            {
                                InternalTableProperties propertiesInstance = new InternalTableProperties();
        ...
        /// The CreateOrUpdate table operation response.
        /// </returns>
        public async Task<InternalTableCreateOrUpdateResponse> BeginCreateOrUpdateWithRawJsonContentAsync(string resourceGroupName, string dataFactoryName, string tableName, TableCreateOrUpdateWithRawJsonContentParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        /// The CreateOrUpdate table operation response.
        /// </returns>
        public async Task<InternalTableCreateOrUpdateResponse> CreateOrUpdateAsync(string resourceGroupName, string dataFactoryName, InternalTableCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            ...
            cancellationToken.ThrowIfCancellationRequested();
            InternalTableCreateOrUpdateResponse response = await client.InternalTables.BeginCreateOrUpdateAsync(resourceGroupName, dataFactoryName, parameters, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
            cancellationToken.ThrowIfCancellationRequested();
            InternalTableCreateOrUpdateResponse result = await client.InternalTables.GetCreateOrUpdateStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
            ...
            while ((result.Status != OperationStatus.InProgress) == false)
            {
                ...
                cancellationToken.ThrowIfCancellationRequested();
                result = await client.InternalTables.GetCreateOrUpdateStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
                delayInSeconds = 5;
        ...
        /// The CreateOrUpdate table operation response.
        /// </returns>
        public async Task<InternalTableCreateOrUpdateResponse> CreateOrUpdateWithRawJsonContentAsync(string resourceGroupName, string dataFactoryName, string tableName, TableCreateOrUpdateWithRawJsonContentParameters parameters, CancellationToken cancellationToken)
        {
            InternalDataFactoryManagementClient client = this.Client;
            bool shouldTrace = TracingAdapter.IsEnabled;
            string invocationId = null;
            ...
            cancellationToken.ThrowIfCancellationRequested();
            InternalTableCreateOrUpdateResponse response = await client.InternalTables.BeginCreateOrUpdateWithRawJsonContentAsync(resourceGroupName, dataFactoryName, tableName, parameters, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
        ...
        public async Task<LongRunningOperationResponse> DeleteAsync(string resourceGroupName, string dataFactoryName, string tableName, CancellationToken cancellationToken)
        {
            ...
            cancellationToken.ThrowIfCancellationRequested();
            LongRunningOperationResponse response = await client.InternalTables.BeginDeleteAsync(resourceGroupName, dataFactoryName, tableName, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
        ...
        /// </returns>
        public async Task<InternalTableGetResponse> GetAsync(string resourceGroupName, string dataFactoryName, string tableName, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    InternalTableGetResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalTableGetResponse();
                        JToken responseDoc = null;
                        if (string.IsNullOrEmpty(responseContent) == false)
                        {
                            responseDoc = JToken.Parse(responseContent);
        ...
        /// The CreateOrUpdate table operation response.
        /// </returns>
        public async Task<InternalTableCreateOrUpdateResponse> GetCreateOrUpdateStatusAsync(string operationStatusLink, CancellationToken cancellationToken)
        {
            // Validate
        ...
        /// </returns>
        public async Task<InternalTableListResponse> ListAsync(string resourceGroupName, string dataFactoryName, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    InternalTableListResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalTableListResponse();
                        JToken responseDoc = null;
                        if (string.IsNullOrEmpty(responseContent) == false)
                        {
                            responseDoc = JToken.Parse(responseContent);
                        ...
                        if (responseDoc != null && responseDoc.Type != JTokenType.Null)
                        {
                            ...
                            if (valueArray != null && valueArray.Type != JTokenType.Null)
                            {
                                ...
                                {
                                    InternalTable internalTableInstance = new InternalTable();
                                    result.Tables.Add(internalTableInstance);
                                    
                                    JToken nameValue = valueValue["name"];
                                    if (nameValue != null && nameValue.Type != JTokenType.Null)
                                    {
                                        string nameInstance = ((string)nameValue);
                                        internalTableInstance.Name = nameInstance;
                                    }
                                    ...
                                    {
                                        InternalTableProperties propertiesInstance = new InternalTableProperties();
                                        internalTableInstance.Properties = propertiesInstance;
        ...
        /// The List tables operation response.
        /// </returns>
        public async Task<InternalTableListResponse> ListNextAsync(string nextLink, CancellationToken cancellationToken)
        {
            // Validate
            if (nextLink == null)
            {
