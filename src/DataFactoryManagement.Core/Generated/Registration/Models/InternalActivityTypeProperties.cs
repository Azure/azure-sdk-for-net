...
namespace Microsoft.Azure.Management.DataFactories.Registration.Models
{
    ...
    /// </summary>
    public partial class InternalActivityTypeProperties
    {
        ...
        /// <summary>
        /// Initializes a new instance of the InternalActivityTypeProperties
        /// class.
        /// </summary>
        public InternalActivityTypeProperties()
        {
        }
        ...
        /// </summary>
        public InternalActivityTypeProperties(string scope, string schema)
            : this()
        {
            if (scope == null)
            {
