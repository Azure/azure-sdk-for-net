...
namespace Microsoft.Azure.Management.DataFactories
{
    ...
    /// </summary>
    internal partial class InternalComputeTypeOperations : IServiceOperations<InternalDataFactoryManagementClient>, IInternalComputeTypeOperations
    {
        /// <summary>
        /// Initializes a new instance of the InternalComputeTypeOperations
        /// class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal InternalComputeTypeOperations(InternalDataFactoryManagementClient client)
        {
            this._client = client;
        }
        ...
        /// </returns>
        public async Task<InternalComputeTypeCreateOrUpdateResponse> CreateOrUpdateAsync(string resourceGroupName, string dataFactoryName, InternalComputeTypeCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                JObject internalComputeTypeCreateOrUpdateParametersValue = new JObject();
                requestDoc = internalComputeTypeCreateOrUpdateParametersValue;
                
                internalComputeTypeCreateOrUpdateParametersValue["name"] = parameters.ComputeType.Name;
                
                JObject propertiesValue = new JObject();
                internalComputeTypeCreateOrUpdateParametersValue["properties"] = propertiesValue;
                ...
                try
                {
                    ...
                    // Create Result
                    InternalComputeTypeCreateOrUpdateResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK || statusCode == HttpStatusCode.Created)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalComputeTypeCreateOrUpdateResponse();
                        ...
                        {
                            InternalComputeType computeTypeInstance = new InternalComputeType();
                            ...
                            {
                                InternalComputeTypeProperties propertiesInstance = new InternalComputeTypeProperties();
        ...
        /// The create or update ComputeType operation response.
        /// </returns>
        public async Task<InternalComputeTypeCreateOrUpdateResponse> CreateOrUpdateWithRawJsonContentAsync(string resourceGroupName, string dataFactoryName, string computeTypeName, ComputeTypeCreateOrUpdateWithRawJsonContentParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        public async Task<LongRunningOperationResponse> DeleteAsync(string resourceGroupName, string dataFactoryName, string computeTypeName, CancellationToken cancellationToken)
        {
            ...
            cancellationToken.ThrowIfCancellationRequested();
            LongRunningOperationResponse response = await client.InternalComputeTypes.BeginDeleteAsync(resourceGroupName, dataFactoryName, computeTypeName, cancellationToken).ConfigureAwait(false);
        ...
        /// </returns>
        public async Task<InternalComputeTypeGetResponse> GetAsync(string resourceGroupName, string dataFactoryName, ComputeTypeGetParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    InternalComputeTypeGetResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalComputeTypeGetResponse();
                        JToken responseDoc = null;
                        if (string.IsNullOrEmpty(responseContent) == false)
                        {
                            responseDoc = JToken.Parse(responseContent);
        ...
        /// </returns>
        public async Task<InternalComputeTypeListResponse> ListAsync(string resourceGroupName, string dataFactoryName, ComputeTypeListParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    InternalComputeTypeListResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalComputeTypeListResponse();
                        JToken responseDoc = null;
                        if (string.IsNullOrEmpty(responseContent) == false)
                        {
                            responseDoc = JToken.Parse(responseContent);
                        ...
                        if (responseDoc != null && responseDoc.Type != JTokenType.Null)
                        {
                            ...
                            if (valueArray != null && valueArray.Type != JTokenType.Null)
                            {
                                ...
                                {
                                    InternalComputeType internalComputeTypeInstance = new InternalComputeType();
                                    result.ComputeTypes.Add(internalComputeTypeInstance);
                                    
                                    JToken nameValue = valueValue["name"];
                                    if (nameValue != null && nameValue.Type != JTokenType.Null)
                                    {
                                        string nameInstance = ((string)nameValue);
                                        internalComputeTypeInstance.Name = nameInstance;
                                    }
                                    ...
                                    {
                                        InternalComputeTypeProperties propertiesInstance = new InternalComputeTypeProperties();
                                        internalComputeTypeInstance.Properties = propertiesInstance;
        ...
        /// The List ComputeType operation response.
        /// </returns>
        public async Task<InternalComputeTypeListResponse> ListNextAsync(string nextLink, CancellationToken cancellationToken)
        {
            // Validate
            if (nextLink == null)
            {
