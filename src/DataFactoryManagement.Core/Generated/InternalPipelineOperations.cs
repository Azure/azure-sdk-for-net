...
namespace Microsoft.Azure.Management.DataFactories
{
    ...
    /// </summary>
    internal partial class InternalPipelineOperations : IServiceOperations<InternalDataFactoryManagementClient>, IInternalPipelineOperations
    {
        /// <summary>
        /// Initializes a new instance of the InternalPipelineOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal InternalPipelineOperations(InternalDataFactoryManagementClient client)
        {
            this._client = client;
        }
        ...
        /// </returns>
        public async Task<InternalPipelineCreateOrUpdateResponse> BeginCreateOrUpdateAsync(string resourceGroupName, string dataFactoryName, InternalPipelineCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            ...
            if (parameters.Pipeline != null)
            {
                ...
                if (parameters.Pipeline.Properties.Activities != null)
                {
                    foreach (InternalActivity activitiesParameterItem in parameters.Pipeline.Properties.Activities)
                    {
            ...
            try
            {
                ...
                JObject internalPipelineCreateOrUpdateParametersValue = new JObject();
                requestDoc = internalPipelineCreateOrUpdateParametersValue;
                
                if (parameters.Pipeline != null)
                {
                    internalPipelineCreateOrUpdateParametersValue["name"] = parameters.Pipeline.Name;
                    
                    JObject propertiesValue = new JObject();
                    internalPipelineCreateOrUpdateParametersValue["properties"] = propertiesValue;
                    ...
                    if (parameters.Pipeline.Properties.Activities != null)
                    {
                        if (parameters.Pipeline.Properties.Activities is ILazyCollection == false || ((ILazyCollection)parameters.Pipeline.Properties.Activities).IsInitialized)
                        {
                            ...
                            foreach (InternalActivity activitiesItem in parameters.Pipeline.Properties.Activities)
                            {
                                JObject internalActivityValue = new JObject();
                                activitiesArray.Add(internalActivityValue);
                                
                                internalActivityValue["name"] = activitiesItem.Name;
                                
                                internalActivityValue["type"] = activitiesItem.Type;
                                
                                internalActivityValue["typeProperties"] = JObject.Parse(activitiesItem.TypeProperties);
                                
                                if (activitiesItem.Description != null)
                                {
                                    internalActivityValue["description"] = activitiesItem.Description;
                                }
                                
                                if (activitiesItem.LinkedServiceName != null)
                                {
                                    internalActivityValue["linkedServiceName"] = activitiesItem.LinkedServiceName;
                                }
                                
                                if (activitiesItem.Policy != null)
                                {
                                    JObject policyValue = new JObject();
                                    internalActivityValue["policy"] = policyValue;
                                ...
                                if (activitiesItem.Inputs != null)
                                {
                                    if (activitiesItem.Inputs is ILazyCollection == false || ((ILazyCollection)activitiesItem.Inputs).IsInitialized)
                                    {
                                        ...
                                        internalActivityValue["inputs"] = inputsArray;
                                    }
                                }
                                ...
                                if (activitiesItem.Outputs != null)
                                {
                                    if (activitiesItem.Outputs is ILazyCollection == false || ((ILazyCollection)activitiesItem.Outputs).IsInitialized)
                                    {
                                        ...
                                        internalActivityValue["outputs"] = outputsArray;
                                    }
                                }
                            }
                ...
                try
                {
                    ...
                    // Create Result
                    InternalPipelineCreateOrUpdateResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK || statusCode == HttpStatusCode.Created)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalPipelineCreateOrUpdateResponse();
                        ...
                        {
                            InternalPipeline pipelineInstance = new InternalPipeline();
                            ...
                            {
                                InternalPipelineProperties propertiesInstance = new InternalPipelineProperties();
                                ...
                                if (activitiesArray2 != null && activitiesArray2.Type != JTokenType.Null)
                                {
                                    ...
                                    {
                                        InternalActivity internalActivityInstance = new InternalActivity();
                                        propertiesInstance.Activities.Add(internalActivityInstance);
                                        
                                        JToken nameValue2 = activitiesValue["name"];
                                        if (nameValue2 != null && nameValue2.Type != JTokenType.Null)
                                        {
                                            string nameInstance2 = ((string)nameValue2);
                                            internalActivityInstance.Name = nameInstance2;
                                        }
                                        ...
                                        if (typeValue != null && typeValue.Type != JTokenType.Null)
                                        {
                                            ...
                                            internalActivityInstance.Type = typeInstance;
                                        }
                                        ...
                                        if (typePropertiesValue != null && typePropertiesValue.Type != JTokenType.Null)
                                        {
                                            ...
                                            internalActivityInstance.TypeProperties = typePropertiesInstance;
                                        }
                                        ...
                                        if (descriptionValue2 != null && descriptionValue2.Type != JTokenType.Null)
                                        {
                                            ...
                                            internalActivityInstance.Description = descriptionInstance2;
                                        }
                                        ...
                                        if (linkedServiceNameValue != null && linkedServiceNameValue.Type != JTokenType.Null)
                                        {
                                            ...
                                            internalActivityInstance.LinkedServiceName = linkedServiceNameInstance;
                                        }
                                        ...
                                        if (policyValue2 != null && policyValue2.Type != JTokenType.Null)
                                        {
                                            ...
                                            internalActivityInstance.Policy = policyInstance;
                                        ...
                                        if (inputsArray2 != null && inputsArray2.Type != JTokenType.Null)
                                        {
                                            foreach (JToken inputsValue in ((JArray)inputsArray2))
                                            {
                                                ...
                                                internalActivityInstance.Inputs.Add(activityInputInstance);
                                        ...
                                        if (outputsArray2 != null && outputsArray2.Type != JTokenType.Null)
                                        {
                                            foreach (JToken outputsValue in ((JArray)outputsArray2))
                                            {
                                                ...
                                                internalActivityInstance.Outputs.Add(activityOutputInstance);
        ...
        /// The create or update pipeline operation response.
        /// </returns>
        public async Task<InternalPipelineCreateOrUpdateResponse> BeginCreateOrUpdateWithRawJsonContentAsync(string resourceGroupName, string dataFactoryName, string dataPipelineName, PipelineCreateOrUpdateWithRawJsonContentParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        /// The create or update pipeline operation response.
        /// </returns>
        public async Task<InternalPipelineCreateOrUpdateResponse> CreateOrUpdateAsync(string resourceGroupName, string dataFactoryName, InternalPipelineCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            ...
            cancellationToken.ThrowIfCancellationRequested();
            InternalPipelineCreateOrUpdateResponse response = await client.InternalPipelines.BeginCreateOrUpdateAsync(resourceGroupName, dataFactoryName, parameters, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
            cancellationToken.ThrowIfCancellationRequested();
            InternalPipelineCreateOrUpdateResponse result = await client.InternalPipelines.GetCreateOrUpdateStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
            ...
            while ((result.Status != OperationStatus.InProgress) == false)
            {
                ...
                cancellationToken.ThrowIfCancellationRequested();
                result = await client.InternalPipelines.GetCreateOrUpdateStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
                delayInSeconds = 5;
        ...
        /// The create or update pipeline operation response.
        /// </returns>
        public async Task<InternalPipelineCreateOrUpdateResponse> CreateOrUpdateWithRawJsonContentAsync(string resourceGroupName, string dataFactoryName, string dataPipelineName, PipelineCreateOrUpdateWithRawJsonContentParameters parameters, CancellationToken cancellationToken)
        {
            InternalDataFactoryManagementClient client = this.Client;
            bool shouldTrace = TracingAdapter.IsEnabled;
            string invocationId = null;
            ...
            cancellationToken.ThrowIfCancellationRequested();
            InternalPipelineCreateOrUpdateResponse response = await client.InternalPipelines.BeginCreateOrUpdateWithRawJsonContentAsync(resourceGroupName, dataFactoryName, dataPipelineName, parameters, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
        ...
        public async Task<LongRunningOperationResponse> DeleteAsync(string resourceGroupName, string dataFactoryName, string dataPipelineName, CancellationToken cancellationToken)
        {
            ...
            cancellationToken.ThrowIfCancellationRequested();
            LongRunningOperationResponse response = await client.InternalPipelines.BeginDeleteAsync(resourceGroupName, dataFactoryName, dataPipelineName, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
        ...
        /// </returns>
        public async Task<InternalPipelineGetResponse> GetAsync(string resourceGroupName, string dataFactoryName, string dataPipelineName, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    InternalPipelineGetResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalPipelineGetResponse();
                        JToken responseDoc = null;
                        if (string.IsNullOrEmpty(responseContent) == false)
                        {
                            responseDoc = JToken.Parse(responseContent);
        ...
        /// The create or update pipeline operation response.
        /// </returns>
        public async Task<InternalPipelineCreateOrUpdateResponse> GetCreateOrUpdateStatusAsync(string operationStatusLink, CancellationToken cancellationToken)
        {
            // Validate
        ...
        /// </returns>
        public async Task<InternalPipelineListResponse> ListAsync(string resourceGroupName, string dataFactoryName, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    InternalPipelineListResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalPipelineListResponse();
                        JToken responseDoc = null;
                        if (string.IsNullOrEmpty(responseContent) == false)
                        {
                            responseDoc = JToken.Parse(responseContent);
                        ...
                        if (responseDoc != null && responseDoc.Type != JTokenType.Null)
                        {
                            ...
                            if (valueArray != null && valueArray.Type != JTokenType.Null)
                            {
                                ...
                                {
                                    InternalPipeline internalPipelineInstance = new InternalPipeline();
                                    result.Pipelines.Add(internalPipelineInstance);
                                    
                                    JToken nameValue = valueValue["name"];
                                    if (nameValue != null && nameValue.Type != JTokenType.Null)
                                    {
                                        string nameInstance = ((string)nameValue);
                                        internalPipelineInstance.Name = nameInstance;
                                    }
                                    ...
                                    {
                                        InternalPipelineProperties propertiesInstance = new InternalPipelineProperties();
                                        internalPipelineInstance.Properties = propertiesInstance;
        ...
        /// The List pipeline operation response.
        /// </returns>
        public async Task<InternalPipelineListResponse> ListNextAsync(string nextLink, CancellationToken cancellationToken)
        {
            // Validate
            if (nextLink == null)
            {
