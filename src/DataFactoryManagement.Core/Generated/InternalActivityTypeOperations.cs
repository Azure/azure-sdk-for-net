...
namespace Microsoft.Azure.Management.DataFactories
{
    ...
    /// </summary>
    internal partial class InternalActivityTypeOperations : IServiceOperations<InternalDataFactoryManagementClient>, IInternalActivityTypeOperations
    {
        /// <summary>
        /// Initializes a new instance of the InternalActivityTypeOperations
        /// class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal InternalActivityTypeOperations(InternalDataFactoryManagementClient client)
        {
            this._client = client;
        }
        ...
        /// </returns>
        public async Task<InternalActivityTypeCreateOrUpdateResponse> CreateOrUpdateAsync(string resourceGroupName, string dataFactoryName, InternalActivityTypeCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                JObject internalActivityTypeCreateOrUpdateParametersValue = new JObject();
                requestDoc = internalActivityTypeCreateOrUpdateParametersValue;
                
                internalActivityTypeCreateOrUpdateParametersValue["name"] = parameters.ActivityType.Name;
                
                JObject propertiesValue = new JObject();
                internalActivityTypeCreateOrUpdateParametersValue["properties"] = propertiesValue;
                ...
                try
                {
                    ...
                    // Create Result
                    InternalActivityTypeCreateOrUpdateResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK || statusCode == HttpStatusCode.Created)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalActivityTypeCreateOrUpdateResponse();
                        ...
                        {
                            InternalActivityType activityTypeInstance = new InternalActivityType();
                            ...
                            {
                                InternalActivityTypeProperties propertiesInstance = new InternalActivityTypeProperties();
        ...
        /// The create or update ActivityType operation response.
        /// </returns>
        public async Task<InternalActivityTypeCreateOrUpdateResponse> CreateOrUpdateWithRawJsonContentAsync(string resourceGroupName, string dataFactoryName, string activityTypeName, ActivityTypeCreateOrUpdateWithRawJsonContentParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        public async Task<LongRunningOperationResponse> DeleteAsync(string resourceGroupName, string dataFactoryName, string activityTypeName, CancellationToken cancellationToken)
        {
            ...
            cancellationToken.ThrowIfCancellationRequested();
            LongRunningOperationResponse response = await client.InternalActivityTypes.BeginDeleteAsync(resourceGroupName, dataFactoryName, activityTypeName, cancellationToken).ConfigureAwait(false);
        ...
        /// </returns>
        public async Task<InternalActivityTypeGetResponse> GetAsync(string resourceGroupName, string dataFactoryName, ActivityTypeGetParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    InternalActivityTypeGetResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalActivityTypeGetResponse();
                        JToken responseDoc = null;
                        if (string.IsNullOrEmpty(responseContent) == false)
                        {
                            responseDoc = JToken.Parse(responseContent);
        ...
        /// </returns>
        public async Task<InternalActivityTypeListResponse> ListAsync(string resourceGroupName, string dataFactoryName, ActivityTypeListParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    // Create Result
                    InternalActivityTypeListResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new InternalActivityTypeListResponse();
                        JToken responseDoc = null;
                        if (string.IsNullOrEmpty(responseContent) == false)
                        {
                            responseDoc = JToken.Parse(responseContent);
                        ...
                        if (responseDoc != null && responseDoc.Type != JTokenType.Null)
                        {
                            ...
                            if (valueArray != null && valueArray.Type != JTokenType.Null)
                            {
                                ...
                                {
                                    InternalActivityType internalActivityTypeInstance = new InternalActivityType();
                                    result.ActivityTypes.Add(internalActivityTypeInstance);
                                    
                                    JToken nameValue = valueValue["name"];
                                    if (nameValue != null && nameValue.Type != JTokenType.Null)
                                    {
                                        string nameInstance = ((string)nameValue);
                                        internalActivityTypeInstance.Name = nameInstance;
                                    }
                                    ...
                                    {
                                        InternalActivityTypeProperties propertiesInstance = new InternalActivityTypeProperties();
                                        internalActivityTypeInstance.Properties = propertiesInstance;
        ...
        /// The List ActivityType operation response.
        /// </returns>
        public async Task<InternalActivityTypeListResponse> ListNextAsync(string nextLink, CancellationToken cancellationToken)
        {
            // Validate
            if (nextLink == null)
            {
