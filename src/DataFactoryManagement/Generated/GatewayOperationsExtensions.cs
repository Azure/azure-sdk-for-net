...
namespace Microsoft.Azure.Management.DataFactories
{
    public static partial class GatewayOperationsExtensions
    {
        ...
        /// request ID.
        /// </returns>
        public static OperationResponse Delete(this IGatewayOperations operations, string resourceGroupName, string dataFactoryName, string gatewayName)
        {
            return Task.Factory.StartNew((object s) => 
            {
        ...
        /// request ID.
        /// </returns>
        public static Task<OperationResponse> DeleteAsync(this IGatewayOperations operations, string resourceGroupName, string dataFactoryName, string gatewayName)
        {
