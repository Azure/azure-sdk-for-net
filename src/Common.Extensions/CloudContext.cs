...
namespace Microsoft.Azure
{
    ...
    /// with Hyak Common libraries.  CloudContext.Clients contains
    /// helpful methods to create any of the clients currently referenced in
    /// your project (be sure to import the Microsoft.Azure namespace so
    ...
    public static class CloudContext
    {
        ...
        /// discovery.  The Hyak.Common namespace should be imported
