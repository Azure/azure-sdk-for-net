...
namespace Microsoft.Azure.Management.WebSites
{
    ...
    internal partial class ServerFarmOperations : IServiceOperations<WebSiteManagementClient>, IServerFarmOperations
    {
        ...
        public async Task<ServerFarmCreateResponse> CreateAsync(string resourceGroupName, ServerFarmCreateParameters parameters, CancellationToken cancellationToken)
        {
            ...
            string url = "/subscriptions/" + this.Client.Credentials.SubscriptionId.Trim() + "/resourceGroups/" + resourceGroupName.Trim() + "/providers/Microsoft.Web/serverFarms/" + parameters.Name.Trim() + "?";
        ...
        public async Task<OperationResponse> DeleteAsync(string resourceGroupName, string name, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            string url = "/subscriptions/" + this.Client.Credentials.SubscriptionId.Trim() + "/resourceGroups/" + resourceGroupName.Trim() + "/providers/Microsoft.Web/serverFarms/" + name.Trim() + "?";
            url = url + "api-version=2014-04-01";
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
            {
        ...
        public async Task<ServerFarmGetResponse> GetAsync(string resourceGroupName, string serverFarmName, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            string url = "/subscriptions/" + this.Client.Credentials.SubscriptionId.Trim() + "/resourceGroups/" + resourceGroupName.Trim() + "/providers/Microsoft.Web/serverFarms/" + serverFarmName.Trim() + "?";
            url = url + "api-version=2014-04-01";
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
            {
        ...
        public async Task<ServerFarmListResponse> ListAsync(string resourceGroupName, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            string url = "/subscriptions/" + this.Client.Credentials.SubscriptionId.Trim() + "/resourceGroups/" + resourceGroupName.Trim() + "/providers/Microsoft.Web/serverFarms?";
            url = url + "api-version=2014-04-01";
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
            {
