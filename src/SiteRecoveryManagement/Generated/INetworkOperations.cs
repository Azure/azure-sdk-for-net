...
namespace Microsoft.WindowsAzure.Management.SiteRecovery
{
    ...
    public partial interface INetworkOperations
    {
        ...
        /// </returns>
        Task<NetworkListResponse> ListAsync(string serverId, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<AzureNetworkListResponse> ListAzureNetworksAsync(string subscriptionId, CancellationToken cancellationToken);
    }
}
