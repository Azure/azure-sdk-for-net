...
namespace Microsoft.Azure.Management.RemoteApp.Operations
{
    ...
    internal partial class PublishingOperations : IServiceOperations<RemoteAppManagementClient>, IPublishingOperations
    {
        ...
        /// </returns>
        public async Task<GetPublishedApplicationResult> GetAsync(string collectionId, string alias, CancellationToken cancellationToken)
        {
            // Validate
            ...
            // Construct URL
            string url = "/" + (this.Client.Credentials.SubscriptionId == null ? "" : Uri.EscapeDataString(this.Client.Credentials.SubscriptionId)) + "/services/" + (this.Client.RdfeNamespace == null ? "" : Uri.EscapeDataString(this.Client.RdfeNamespace)) + "/remoteappServices/" + Uri.EscapeDataString(collectionId) + "/applications/" + Uri.EscapeDataString(alias) + "?";
                ...
                try
                {
                    ...
                    if (statusCode == HttpStatusCode.OK)
                    {
                        ...
                        if (getPublishedApplicationResultValue != null && getPublishedApplicationResultValue.Type != JTokenType.Null)
                        {
                            ...
                            JToken iconPngUrisValue = getPublishedApplicationResultValue["IconPngUris"];
        ...
        /// </returns>
        public async Task<GetPublishedApplicationListResult> ListAsync(string collectionId, CancellationToken cancellationToken)
        {
            // Validate
            if (collectionId == null)
            {
            ...
            // Construct URL
            string url = "/" + (this.Client.Credentials.SubscriptionId == null ? "" : Uri.EscapeDataString(this.Client.Credentials.SubscriptionId)) + "/services/" + (this.Client.RdfeNamespace == null ? "" : Uri.EscapeDataString(this.Client.RdfeNamespace)) + "/remoteappServices/" + Uri.EscapeDataString(collectionId) + "/applications?";
            url = url + "api-version=2014-09-01";
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
        ...
        public async Task<GetStartMenuApplicationResult> StartMenuApplicationAsync(string collectionId, string applicationId, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/" + (this.Client.Credentials.SubscriptionId == null ? "" : Uri.EscapeDataString(this.Client.Credentials.SubscriptionId)) + "/services/" + (this.Client.RdfeNamespace == null ? "" : Uri.EscapeDataString(this.Client.RdfeNamespace)) + "/remoteappServices/" + Uri.EscapeDataString(collectionId) + "/startMenuApplications/" + Uri.EscapeDataString(applicationId) + "?";
            url = url + "api-version=2014-09-01";
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
        ...
        public async Task<GetStartMenuApplicationListResult> StartMenuApplicationListAsync(string collectionId, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/" + (this.Client.Credentials.SubscriptionId == null ? "" : Uri.EscapeDataString(this.Client.Credentials.SubscriptionId)) + "/services/" + (this.Client.RdfeNamespace == null ? "" : Uri.EscapeDataString(this.Client.RdfeNamespace)) + "/remoteappServices/" + Uri.EscapeDataString(collectionId) + "/startMenuApplications?";
            url = url + "api-version=2014-09-01";
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
        ...
        public async Task<UnpublishAllApplicationsResult> UnpublishAllAsync(string collectionId, CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = "/" + (this.Client.Credentials.SubscriptionId == null ? "" : Uri.EscapeDataString(this.Client.Credentials.SubscriptionId)) + "/services/" + (this.Client.RdfeNamespace == null ? "" : Uri.EscapeDataString(this.Client.RdfeNamespace)) + "/remoteappServices/" + Uri.EscapeDataString(collectionId) + "/applications/unpublishAll?";
            url = url + "api-version=2014-09-01";
            string baseUrl = this.Client.BaseUri.AbsoluteUri;
            // Trim '/' character from the end of baseUrl and beginning of url.
            if (baseUrl[baseUrl.Length - 1] == '/')
