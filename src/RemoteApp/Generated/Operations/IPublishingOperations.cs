...
namespace Microsoft.Azure.Management.RemoteApp.Operations
{
    ...
    public partial interface IPublishingOperations
    {
        ...
        /// </returns>
        Task<GetPublishedApplicationResult> GetAsync(string collectionId, string alias, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<GetPublishedApplicationListResult> ListAsync(string collectionId, CancellationToken cancellationToken);
