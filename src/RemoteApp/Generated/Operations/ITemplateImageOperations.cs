...
namespace Microsoft.Azure.Management.RemoteApp.Operations
{
    ...
    public partial interface ITemplateImageOperations
    {
        ...
        /// request ID.
        /// </returns>
        Task<AzureOperationResponse> DeleteAsync(string imageId, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<TemplateImageResponse> GetAsync(string imageName, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<GetUploadScriptResult> GetUploadScriptAsync(CancellationToken cancellationToken);
