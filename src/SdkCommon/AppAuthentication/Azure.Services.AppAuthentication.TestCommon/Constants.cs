...
namespace Microsoft.Azure.Services.AppAuthentication.TestCommon
{
    public class Constants
    {
        ...
        // The Microsoft.Azure.Services.AppAuthentication.TestCertUrl environment variable should point to a cert in key vault. 
        public static readonly string TestCertUrlEnv = "Microsoft.Azure.Services.AppAuthentication.TestCertUrl";
    }
}
