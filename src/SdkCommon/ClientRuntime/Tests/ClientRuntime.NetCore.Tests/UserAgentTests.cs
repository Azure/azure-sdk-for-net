...
namespace ClientRuntime.NetCore.Tests
{
    ...
    /// <summary>
    /// Same set of tests are currently being executed in the FullDesktop test projects
    /// Any updates you make needs to be made in the FullDesktop test project as well.
    /// </summary>
