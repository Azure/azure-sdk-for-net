...
namespace Microsoft.WindowsAzure.Management.ExpressRoute
{
    public partial interface IAuthorizedDedicatedCircuitOperations
    {
        ...
        /// </returns>
        Task<AuthorizedDedicatedCircuitGetResponse> GetAsync(string serviceKey, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<AuthorizedDedicatedCircuitListResponse> ListAsync(CancellationToken cancellationToken);
    }
}
