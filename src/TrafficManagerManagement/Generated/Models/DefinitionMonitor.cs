...
namespace Microsoft.WindowsAzure.Management.TrafficManager.Models
{
    ...
    public partial class DefinitionMonitor
    {
        ...
        /// <summary>
        /// The option to use when making an HTTP request to monitor endpoint
        /// health.
        /// </summary>
        ...
        /// <summary>
        /// The number of seconds between consecutive attempts to check the
        /// status of a monitoring endpoint. The value must be set to 30.
        /// </summary>
        ...
        /// <summary>
        /// The port used to monitor endpoint health. Accepted values are
        /// integer values greater than 0 and less or equal to 65,535.
        /// </summary>
        public int Port
        {
        ...
        /// <summary>
        /// The time to wait for a response from the monitoring endpoint. The
        ...
        /// <summary>
        /// The number of consecutive failures to allow on an endpoint before
        /// taking the endpoint out of the rotation in the load balancer. The
