            ...
            Action test = () =>
            {
                using (BatchClient batchCli = TestUtilities.OpenBatchClientAsync(TestUtilities.GetCredentialsFromEnvironment()).Result)
                {
                    ...
                    try
                    {
                        ...
                        Assert.False(timedOut, "TSM timed out in Bug1480489NodeFileMissingIsDirectory");
                ...
                using (BatchClient batchCli = TestUtilities.OpenBatchClientAsync(TestUtilities.GetCredentialsFromEnvironment()).Result)
                {
                    ...
                    try
                    {
                        ...
                        bool timedOut = taskStateMonitor.WaitAll(
                                ...
                                Microsoft.Azure.Batch.Common.TaskState.Completed,
                                new TimeSpan(0, 3 /*min*/, 0));
                        Assert.False(timedOut, "TSM timed out in Bug230385SupportDeleteNodeFileByTask");
                ...
                using (BatchClient batchCli = TestUtilities.OpenBatchClientAsync(TestUtilities.GetCredentialsFromEnvironment()).Result)
                {
                    ...
                    try
                    {
                        ...
                        bool timedOut = taskStateMonitor.WaitAll(
                                    ...
                                    Microsoft.Azure.Batch.Common.TaskState.Completed,
                                    new TimeSpan(0, 3 /*min*/, 0));
                        Assert.False(timedOut, "TSM timed out in Bug1771166_1771181_1771038_GetListDeleteNodeFile");
                ...
                using (BatchClient batchCli = TestUtilities.OpenBatchClientAsync(TestUtilities.GetCredentialsFromEnvironment()).Result)
                {
                    JobOperations jobOperations = batchCli.JobOperations;
                    {
                        ...
                        try
                        {
                            ...
                            // we have issues if it timed out.
            ...
            Action test = () =>
            {
                using (BatchClient batchCli = TestUtilities.OpenBatchClientAsync(TestUtilities.GetCredentialsFromEnvironment()).Result)
                {
                    ...
                    try
                    {
                        ...
                        Assert.False(timedOut, "TSM timed out in Bug1480491NodeFileFileProperties");
            ...
            Action test = () =>
            {
                using (BatchClient batchCli = TestUtilities.OpenBatchClientAsync(TestUtilities.GetCredentialsFromEnvironment()).Result)
                {
                    ...
                    try
                    {
                        ...
                        Assert.False(timedOut, "TSM timed out in Bug1501413TestGetNodeFileByTask");
