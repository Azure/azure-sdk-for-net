...
namespace Microsoft.Azure.Batch.Protocol
{
    ...
    public partial interface ITaskOperations
    {
        ...
        /// executionInfo and nodeInfo refer to the primary task. Use the
        /// list subtasks API to retrieve information about subtasks.
        /// </remarks>
        /// <param name='jobId'>
        /// The ID of the job.
        /// </param>
        ...
        /// connection is closed during the request, the request may have
        /// been partially or fully processed, or not at all. In such cases,
        /// the user should re-issue the request. Note that it is up to the
        /// user to correctly handle failures when re-issuing a request. For
        /// example, you should use the same task ids during a retry so that
        /// if the prior operation succeeded, the retry will not create extra
        /// tasks unexpectedly.
        /// </remarks>
        /// <param name='jobId'>
        ...
        /// </summary>
        /// <remarks>
        /// If the task is not a multi-instance task then this returns an
        /// empty collection.
        /// </remarks>
        /// <param name='jobId'>
        /// The ID of the job.
        ...
        /// </summary>
        /// <remarks>
        /// When the task has been terminated, it moves to the completed
        /// state. For multi-instance tasks, the terminate task operation
        /// applies synchronously to the primary task; subtasks are then
        ...
        /// maximum retry count. The task's state is changed to active. As
        /// the task is no longer in the completed state, any previous exit
        /// code or scheduling error is no longer available after
        /// reactivation. This will fail for tasks that are not completed or
        /// that previously completed successfully (with an exit code of 0).
