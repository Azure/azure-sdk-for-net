...
namespace Microsoft.Azure.Batch.Protocol
{
   ...
   using Models;
    ...
    public static partial class JobOperationsExtensions
    {
            ...
            /// currently running tasks of the job. The job remains in the disabling
            ...
            /// the disabled state. No new tasks are started under the job until it moves
            /// back to active state. If you try to disable a job that is in any state
            /// other than active, disabling, or disabled, the request fails with status
            /// code 409.
            /// </remarks>
            /// <param name='operations'>
            /// The operations group for this extension method.
            ...
            /// more than 7 days. Therefore, if you enable a job containing active tasks
            ...
            /// to the terminating state. The Batch service then terminates any active or
