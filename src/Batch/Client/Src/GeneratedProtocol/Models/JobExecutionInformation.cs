...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobExecutionInformation
    {
        ...
        /// contain a poolId element. If it does, the two IDs are the same.
        /// If it does not, it means the job ran on an auto pool, and this
        ...
        /// AllTasksComplete – the job's onAllTasksComplete attribute is set
        /// to terminatejob, and all tasks in the job are complete.
