...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobManagerTask
    {
        ...
        /// package is already on the compute node, and is up to date, then
        /// it is not re-downloaded; the existing copy on the compute node is
        /// used. If a referenced application package cannot be installed,
        /// for example because the package has been deleted or because
        /// download failed, the task fails with a scheduling error. This
        /// property is currently not supported on jobs running on pools
        /// created using the virtualMachineConfiguration (IaaS) property. If
        /// a task specifying applicationPackageReferences runs on such a
