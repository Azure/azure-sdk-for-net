...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class StartTaskInformation
    {
        ...
        /// </summary>
        /// <remarks>
        /// Possible values are: running – The start task is currently
        /// running. completed – The start task has exited with exit code 0,
        /// or the start task has failed and the retry limit has reached, or
        /// the start task process did not run due to scheduling errors.
