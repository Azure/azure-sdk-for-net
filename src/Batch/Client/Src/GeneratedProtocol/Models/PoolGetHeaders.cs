...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class PoolGetHeaders
    {
        ...
        public PoolGetHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), System.DateTime? lastModified = default(System.DateTime?))
        {
