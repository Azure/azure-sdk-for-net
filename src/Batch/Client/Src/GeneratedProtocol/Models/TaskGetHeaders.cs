...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class TaskGetHeaders
    {
        ...
        public TaskGetHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), System.DateTime? lastModified = default(System.DateTime?), string dataServiceId = default(string))
        {
