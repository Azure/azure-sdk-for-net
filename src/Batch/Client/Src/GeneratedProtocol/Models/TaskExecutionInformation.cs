...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class TaskExecutionInformation
    {
        ...
        /// deploying these. If the task has been restarted or retried, this
        /// is the most recent time at which the task started running. This
        ...
        /// task (due to timeout, or user termination via the API) you may
        ...
        /// </summary>
        /// <remarks>
        /// The task is retried if it exits with a nonzero exit code, up to
        /// the specified maxTaskRetryCount.
        /// </remarks>
        ...
        /// startTime, but may be different if the task has been restarted
        /// for reasons other than retry; for example, if the compute node
        /// was rebooted during a retry, then the startTime is updated but
        ...
        /// pool) or when the job is being disabled, the user can specify
        /// that running tasks on the nodes be requeued for execution. This
