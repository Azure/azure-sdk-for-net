...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class FileListFromTaskHeaders
    {
        ...
        public FileListFromTaskHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
