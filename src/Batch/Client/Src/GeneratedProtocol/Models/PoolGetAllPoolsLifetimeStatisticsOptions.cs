...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// <summary>
    /// Additional parameters for the Pool_GetAllPoolsLifetimeStatistics
    /// operation.
    /// </summary>
    public partial class PoolGetAllPoolsLifetimeStatisticsOptions
    {
        ...
        public PoolGetAllPoolsLifetimeStatisticsOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), System.DateTime? ocpDate = default(System.DateTime?))
        {
            Timeout = timeout;
