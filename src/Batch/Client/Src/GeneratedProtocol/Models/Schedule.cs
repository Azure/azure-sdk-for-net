...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class Schedule
    {
        ...
        /// service rejects the schedule with an error; if you are calling
        ...
        /// will be scheduled for that interval. For recurring jobs, you
        /// should normally specify a jobManagerTask in the jobSpecification.
        /// If you do not use jobManagerTask, you will need an external
        /// process to monitor when jobs are created, add tasks to the jobs
        /// and terminate the jobs ready for the next recurrence. The default
        /// is that the schedule does not recur: one job is created, within
        /// the startWindow after the doNotRunUntil time, and the schedule is
        /// complete as soon as that job finishes. The minimum value is 1
        /// minute. If you specify a lower value, the Batch service rejects
        /// the schedule with an error; if you are calling the REST API
