...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeListOptions
    {
        ...
        public ComputeNodeListOptions(string filter = default(string), string select = default(string), int? maxResults = default(int?), int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), System.DateTime? ocpDate = default(System.DateTime?))
        {
            Filter = filter;
            Select = select;
        ...
        /// response. A maximum of 1000 nodes can be returned.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "")]
