...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ApplicationGetOptions
    {
        ...
        public ApplicationGetOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), System.DateTime? ocpDate = default(System.DateTime?))
        {
            Timeout = timeout;
