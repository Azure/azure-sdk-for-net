...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobSpecification
    {
        ...
        /// should take when all tasks in a job created under this schedule
        /// are in the completed state.</param>
        ...
        /// value is 0. This priority is used as the default for all jobs
        /// under the job schedule. You can update a job's priority after it
        ...
        /// task fails in a job created under this schedule. A task is
        /// considered to have failed if it completes with a non-zero exit
        /// code and has exhausted its retry count, or if it had a scheduling
        /// error.
        /// </summary>
        /// <remarks>
        ...
        /// explicitly add tasks to the job using the Task API. If the job
        /// does specify a Job Manager task, the Batch service creates the
        /// Job Manager task when the job is created, and will try to
        /// schedule the Job Manager task before scheduling other tasks in
        /// the job.
        /// </remarks>
        ...
        /// compute nodes made by the Job Preparation task. Example
        /// activities include deleting local files, or shutting down
        /// services that were started as part of job preparation. A Job
        /// Release task cannot be specified without also specifying a Job
        /// Preparation task for the job. The Batch service runs the Job
        ...
        /// </summary>
        /// <remarks>
        /// Individual tasks can override an environment setting specified
