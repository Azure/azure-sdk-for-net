...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class FileListFromComputeNodeOptions
    {
        ...
        public FileListFromComputeNodeOptions(string filter = default(string), int? maxResults = default(int?), int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), System.DateTime? ocpDate = default(System.DateTime?))
        {
            Filter = filter;
