...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class ComputeNodeRebootHeaders
    {
        /// <summary>
        ...
        /// <param name="dataServiceId">The OData id of the resource to which the request applied.</param>
        public ComputeNodeRebootHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?), string dataServiceId = default(string))
        {
