...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class TaskConstraints
    {
        ...
        /// delete the task directory and all its contents.</param>
        ...
        /// The Batch service will try the task once, and may then retry up
        /// to this limit. For example, if the maximum retry count is 3,
        /// Batch tries the task up to 4 times (one initial try and 3
        /// retries). If the maximum retry count is 0, the Batch service does
        /// not retry the task. If the maximum retry count is -1, the Batch
