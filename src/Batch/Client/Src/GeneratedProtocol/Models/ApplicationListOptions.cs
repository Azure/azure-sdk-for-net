...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ApplicationListOptions
    {
        ...
        public ApplicationListOptions(int? maxResults = default(int?), int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), System.DateTime? ocpDate = default(System.DateTime?))
        {
        ...
        /// response. A maximum of 1000 applications can be returned.
        /// </summary>
