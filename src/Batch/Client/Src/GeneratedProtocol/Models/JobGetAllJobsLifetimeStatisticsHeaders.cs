...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobGetAllJobsLifetimeStatisticsHeaders
    {
        ...
        public JobGetAllJobsLifetimeStatisticsHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), System.DateTime? lastModified = default(System.DateTime?))
        {
