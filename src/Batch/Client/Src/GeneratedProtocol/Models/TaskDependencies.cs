...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class TaskDependencies
    {
        ...
        /// task depends on. All tasks in all ranges must complete
        /// successfully before the dependent task can be scheduled.</param>
        ...
        /// tasks in this list must complete successfully before the
