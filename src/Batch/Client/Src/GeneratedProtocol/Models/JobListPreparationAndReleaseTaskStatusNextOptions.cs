...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobListPreparationAndReleaseTaskStatusNextOptions
    {
        ...
        public JobListPreparationAndReleaseTaskStatusNextOptions(string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
