...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobAddParameter
    {
        ...
        /// example by deciding what additional tasks to run, determining
        /// when the work is complete, etc. (However, a Job Manager task is
        /// not restricted to these activities – it is a fully-fledged task
        /// in the system and perform whatever actions are required for the
        /// job.) For example, a Job Manager task might download a file
        ...
        /// </summary>
        /// <remarks>
        /// If a job has a Job Preparation task, the Batch service will run
        /// the Job Preparation task on a compute node before starting any
        ...
        /// Release task on the compute nodes that have run the Job
        /// Preparation task. The primary purpose of the Job Release task is
        /// to undo changes to compute nodes made by the Job Preparation
        /// task. Example activities include deleting local files, or
        /// shutting down services that were started as part of job
        /// preparation.
        /// </remarks>
        ...
        /// considered complete. This option is therefore most commonly used
        /// with a job manager task; if you want to use automatic job
        /// termination without a job manager, you should initially set
        /// onAllTasksComplete to noaction and update the job properties to
        /// set onAllTasksComplete to terminatejob once you have finished
        /// adding tasks. Permitted values are: noaction – do nothing. The
        /// job remains active unless terminated or disabled by some other
        /// means. terminatejob – terminate the job. The job’s
        /// terminateReason is set to 'AllTasksComplete'. The default is
