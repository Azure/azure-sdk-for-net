...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobConstraints
    {
        ...
        /// service terminates it and any tasks that are still running. In
        /// this case, the termination reason will be MaxWallClockTimeExpiry.
        /// If this property is not specified, there is no time limit on how
        ...
        /// The Batch service will try each task once, and may then retry up
        /// to this limit. For example, if the maximum retry count is 3,
        /// Batch tries a task up to 4 times (one initial try and 3 retries).
        /// If the maximum retry count is 0, the Batch service does not retry
