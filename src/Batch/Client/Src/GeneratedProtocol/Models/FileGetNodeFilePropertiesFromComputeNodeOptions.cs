...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// File_GetNodeFilePropertiesFromComputeNode operation.
    /// </summary>
    public partial class FileGetNodeFilePropertiesFromComputeNodeOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FileGetNodeFilePropertiesFromComputeNodeOptions class.
        /// </summary>
        public FileGetNodeFilePropertiesFromComputeNodeOptions() { }
        ...
        public FileGetNodeFilePropertiesFromComputeNodeOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?), DateTime? ifModifiedSince = default(DateTime?), DateTime? ifUnmodifiedSince = default(DateTime?))
        {
            Timeout = timeout;
