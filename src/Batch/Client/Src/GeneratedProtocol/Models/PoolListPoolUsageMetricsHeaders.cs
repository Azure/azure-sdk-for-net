...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class PoolListPoolUsageMetricsHeaders
    {
        ...
        public PoolListPoolUsageMetricsHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
