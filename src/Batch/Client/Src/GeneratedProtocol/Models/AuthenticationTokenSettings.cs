...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class AuthenticationTokenSettings
    {
        ...
        /// </summary>
        /// <remarks>
        /// The authentication token grants access only to a limited set of
        /// Batch service operations. Currently the only supported value for
        /// the Access property is 'job', which grants access to all
