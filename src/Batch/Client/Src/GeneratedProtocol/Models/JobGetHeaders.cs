...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobGetHeaders
    {
        ...
        public JobGetHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), System.DateTime? lastModified = default(System.DateTime?))
        {
