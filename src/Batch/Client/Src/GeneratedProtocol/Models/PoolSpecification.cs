...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class PoolSpecification
    {
        ...
        /// with Azure PaaS VMs. This property and
        /// virtualMachineConfiguration are mutually exclusive and one of the
        /// properties must be specified. If neither is specified then the
        ...
        /// are mutually exclusive and one of the properties must be
        /// specified. If neither is specified then the Batch service returns
        /// an error; if you are calling the REST API directly, the HTTP
        ...
        /// 5 minutes, the Batch service rejects the request with an error;
        ...
        /// </summary>
        /// <remarks>
        /// This property is currently not supported on auto pools created
        /// with the virtualMachineConfiguration (IaaS) property.
        /// </remarks>
