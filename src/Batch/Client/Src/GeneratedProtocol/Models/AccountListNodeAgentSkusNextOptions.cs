...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class AccountListNodeAgentSkusNextOptions
    {
        ...
        public AccountListNodeAgentSkusNextOptions(string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
