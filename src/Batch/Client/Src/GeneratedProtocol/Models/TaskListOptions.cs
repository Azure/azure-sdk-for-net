...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class TaskListOptions
    {
        ...
        public TaskListOptions(string filter = default(string), string select = default(string), string expand = default(string), int? maxResults = default(int?), int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), System.DateTime? ocpDate = default(System.DateTime?))
        {
            Filter = filter;
            Select = select;
            Expand = expand;
        ...
        /// response. A maximum of 1000 tasks can be returned.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "")]
