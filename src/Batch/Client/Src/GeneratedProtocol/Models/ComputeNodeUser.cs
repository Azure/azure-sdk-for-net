...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeUser
    {
        ...
        /// For Linux compute nodes, the password can optionally be specified
        ...
        /// should be base 64 encoded. This property can be specified only
        /// for Linux nodes. If this is specified for a Windows node, then
        /// the Batch service rejects the request; if you are calling the
