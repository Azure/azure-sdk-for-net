...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class TaskListSubtasksOptions
    {
        ...
        public TaskListSubtasksOptions(string select = default(string), int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Select = select;
            Timeout = timeout;
