...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class PoolGetAllPoolsLifetimeStatisticsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PoolGetAllPoolsLifetimeStatisticsHeaders class.
        /// </summary>
        public PoolGetAllPoolsLifetimeStatisticsHeaders() { }
        ...
        public PoolGetAllPoolsLifetimeStatisticsHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), System.DateTime? lastModified = default(System.DateTime?))
        {
