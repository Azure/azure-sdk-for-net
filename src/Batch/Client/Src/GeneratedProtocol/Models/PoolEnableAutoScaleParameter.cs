...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class PoolEnableAutoScaleParameter
    {
        ...
        /// request with detailed error information. For more information
        /// about specifying this formula, see Automatically scale compute
        ...
        /// rejects the request with an invalid property value error; if you
        /// are calling the REST API directly, the HTTP status code is 400
