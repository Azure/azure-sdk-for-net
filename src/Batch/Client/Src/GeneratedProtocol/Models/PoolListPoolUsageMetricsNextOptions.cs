...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class PoolListPoolUsageMetricsNextOptions
    {
        ...
        public PoolListPoolUsageMetricsNextOptions(string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
