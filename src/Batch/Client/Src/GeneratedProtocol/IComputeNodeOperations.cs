...
namespace Microsoft.Azure.Batch.Protocol
{
    ...
    public partial interface IComputeNodeOperations
    {
        ...
        /// </summary>
        /// <remarks>
        /// You can add a user account to a node only when it is in the idle
        /// or running state.
        /// </remarks>
        /// <param name='poolId'>
        ...
        /// </summary>
        /// <remarks>
        /// You can delete a user account to a node only when it is in the
        ...
        /// unmodified. You can update a user account on a node only when it
        ...
        /// settings, you must create a user account on the node. This API
        ...
        /// </summary>
        /// <remarks>
        /// Before you can access a node by using the RDP file, you must
        /// create a user account on the node. This API can only be invoked
        /// on pools created with the cloud service configuration property.
        /// </remarks>
        /// <param name='poolId'>
        /// The ID of the pool that contains the compute node.
        /// </param>
