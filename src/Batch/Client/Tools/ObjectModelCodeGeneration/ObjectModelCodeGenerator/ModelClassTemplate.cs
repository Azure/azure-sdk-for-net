...
namespace ObjectModelCodeGenerator
{
    ...
    public partial class ModelClassTemplate : ModelClassTemplateBase
    {
        ...
        {
            this.Write(@"// Copyright (c) Microsoft and contributors.  All rights reserved.
// 
...
foreach (string include in type.Includes)
{
            ...
            this.Write("\r\n");
            this.Write(this.ToStringHelper.ToStringWithCulture(classContent));
            this.Write("\r\n}");
            return this.GenerationEnvironment.ToString();
        }

private string _classContentField;

/// <summary>
/// Access the classContent parameter of the template.
/// </summary>
private string classContent
{
    get
    {
        return this._classContentField;
    }
}
...
public virtual void Initialize()
{
    ...
    {
bool classContentValueAcquired = false;
if (this.Session.ContainsKey("classContent"))
{
    this._classContentField = ((string)(this.Session["classContent"]));
    classContentValueAcquired = true;
}
if ((classContentValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("classContent");
    if ((data != null))
    {
        this._classContentField = ((string)(data));
    }
}
