...
namespace ObjectModelCodeGenerator
{
    ...
    public partial class NamedBatchRequests : NamedBatchRequestsBase
    {
        /// <summary>
        ...
        {
            this.Write(@"//This file was autogenerated by a tool.  Do not modify it by hand.
...
foreach (var operationType in batchRequests.Keys)
{
    ...
    foreach (var batchRequest in batchRequests[operationType])
    {
        ...
        if (string.IsNullOrEmpty(batchRequest.ParameterType))
        {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(fullClassName));
            this.Write("BatchRequest : Protocol.BatchRequest<\r\n        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(batchRequest.OptionsType));
            this.Write(",\r\n        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(batchRequest.ReturnType));
            this.Write(">\r\n");
        ...
        else
        {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(fullClassName));
            this.Write("BatchRequest : Protocol.BatchRequest<\r\n        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(batchRequest.ParameterType));
            this.Write(",\r\n        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(batchRequest.OptionsType));
            this.Write(",\r\n        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(batchRequest.ReturnType));
            ...
            this.Write("    {\r\n        /// <summary>\r\n        /// Initializes a new instance of the <see " +
                    "cref=\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(fullClassName));
            this.Write("BatchRequest\" /> class.\r\n        /// </summary>\r\n        /// <param name=\"service" +
                    "Client\">The service client to use.</param>\r\n");

        if (!string.IsNullOrEmpty(batchRequest.ParameterType))
        {

            this.Write("        /// <param name=\"parameters\">The parameters to use.</param>\r\n");

        }

            this.Write("        /// <param name=\"cancellationToken\">A <see cref=\"CancellationToken\"/> con" +
                    "trolling the request lifetime.</param>\r\n");
        ...
        if (string.IsNullOrEmpty(batchRequest.ParameterType))
        {
            ...
            this.Write("        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(fullClassName));
            this.Write("BatchRequest(\r\n            BatchServiceClient serviceClient,\r\n            Cancell" +
                    "ationToken cancellationToken) : base(serviceClient, cancellationToken)\r\n");
        ...
        else
        {
            ...
            this.Write("BatchRequest(\r\n            BatchServiceClient serviceClient,\r\n            ");
            this.Write(this.ToStringHelper.ToStringWithCulture(batchRequest.ParameterType));
            this.Write(" parameters,\r\n            CancellationToken cancellationToken) : base(serviceClie" +
                    "nt, parameters, cancellationToken)\r\n");
...
private global::System.Collections.Generic.Dictionary<string, System.Collections.Generic.IEnumerable<RoslynParser.BatchRequestTemplate>> batchRequests
{
    get
    {
        return this._batchRequestsField;
    }
}
...
if ((batchRequestsValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "14.0.0.0")]
    public class NamedBatchRequestsBase
    {
        #region Fields
