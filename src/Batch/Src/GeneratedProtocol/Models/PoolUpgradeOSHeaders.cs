...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class PoolUpgradeOSHeaders
    {
        ...
        /// Initializes a new instance of the PoolUpgradeOSHeaders class.
        /// </summary>
        public PoolUpgradeOSHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?), string dataServiceId = default(string))
        {
