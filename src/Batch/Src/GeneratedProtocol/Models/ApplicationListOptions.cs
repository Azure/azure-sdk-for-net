...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ApplicationListOptions
    {
        ...
        /// Initializes a new instance of the ApplicationListOptions class.
        /// </summary>
        public ApplicationListOptions(int? maxResults = default(int?), int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
