...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobScheduleGetHeaders
    {
        ...
        /// Initializes a new instance of the JobScheduleGetHeaders class.
        /// </summary>
        public JobScheduleGetHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
