...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeListHeaders
    {
        ...
        /// Initializes a new instance of the ComputeNodeListHeaders class.
        /// </summary>
        public ComputeNodeListHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
