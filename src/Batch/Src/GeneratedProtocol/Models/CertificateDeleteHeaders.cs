...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class CertificateDeleteHeaders
    {
        ...
        /// Initializes a new instance of the CertificateDeleteHeaders class.
        /// </summary>
        public CertificateDeleteHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
