...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class PoolEnableAutoScaleHeaders
    {
        ...
        /// Initializes a new instance of the PoolEnableAutoScaleHeaders class.
        /// </summary>
        public PoolEnableAutoScaleHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?), string dataServiceId = default(string))
        {
