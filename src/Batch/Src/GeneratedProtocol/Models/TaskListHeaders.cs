...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class TaskListHeaders
    {
        /// <summary>
        ...
        /// Initializes a new instance of the TaskListHeaders class.
        /// </summary>
        public TaskListHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
