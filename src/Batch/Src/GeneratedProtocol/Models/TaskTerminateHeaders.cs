...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class TaskTerminateHeaders
    {
        ...
        /// Initializes a new instance of the TaskTerminateHeaders class.
        /// </summary>
        public TaskTerminateHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?), string dataServiceId = default(string))
        {
