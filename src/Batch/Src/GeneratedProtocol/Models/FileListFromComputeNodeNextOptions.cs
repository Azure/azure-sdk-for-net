...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class FileListFromComputeNodeNextOptions
    {
        ...
        /// FileListFromComputeNodeNextOptions class.
        /// </summary>
        public FileListFromComputeNodeNextOptions(string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
