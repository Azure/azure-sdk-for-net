...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeRebootOptions
    {
        ...
        /// Initializes a new instance of the ComputeNodeRebootOptions class.
        /// </summary>
        public ComputeNodeRebootOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Timeout = timeout;
