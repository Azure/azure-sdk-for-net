...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobScheduleListOptions
    {
        ...
        /// Initializes a new instance of the JobScheduleListOptions class.
        /// </summary>
        public JobScheduleListOptions(string filter = default(string), string select = default(string), string expand = default(string), int? maxResults = default(int?), int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Filter = filter;
            Select = select;
            Expand = expand;
