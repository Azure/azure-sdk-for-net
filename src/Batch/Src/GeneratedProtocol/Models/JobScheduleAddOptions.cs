...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobScheduleAddOptions
    {
        ...
        /// Initializes a new instance of the JobScheduleAddOptions class.
        /// </summary>
        public JobScheduleAddOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Timeout = timeout;
