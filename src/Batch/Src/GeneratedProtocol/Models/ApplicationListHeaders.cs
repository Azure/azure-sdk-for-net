...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ApplicationListHeaders
    {
        ...
        /// Initializes a new instance of the ApplicationListHeaders class.
        /// </summary>
        public ApplicationListHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
