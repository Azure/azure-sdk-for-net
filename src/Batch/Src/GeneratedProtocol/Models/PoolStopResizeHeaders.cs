...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class PoolStopResizeHeaders
    {
        ...
        /// Initializes a new instance of the PoolStopResizeHeaders class.
        /// </summary>
        public PoolStopResizeHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?), string dataServiceId = default(string))
        {
