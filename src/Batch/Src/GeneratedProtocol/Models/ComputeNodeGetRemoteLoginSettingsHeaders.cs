...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeGetRemoteLoginSettingsHeaders
    {
        ...
        /// ComputeNodeGetRemoteLoginSettingsHeaders class.
        /// </summary>
        public ComputeNodeGetRemoteLoginSettingsHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
