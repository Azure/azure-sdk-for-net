...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeAddUserOptions
    {
        ...
        /// Initializes a new instance of the ComputeNodeAddUserOptions class.
        /// </summary>
        public ComputeNodeAddUserOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Timeout = timeout;
