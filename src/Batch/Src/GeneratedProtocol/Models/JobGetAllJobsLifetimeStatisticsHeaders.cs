...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class JobGetAllJobsLifetimeStatisticsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// JobGetAllJobsLifetimeStatisticsHeaders class.
        /// </summary>
        public JobGetAllJobsLifetimeStatisticsHeaders() { }

        /// <summary>
        /// Initializes a new instance of the
        /// JobGetAllJobsLifetimeStatisticsHeaders class.
        /// </summary>
        public JobGetAllJobsLifetimeStatisticsHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
