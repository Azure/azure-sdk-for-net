...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class FileDeleteFromTaskOptions
    {
        ...
        /// Initializes a new instance of the FileDeleteFromTaskOptions class.
        /// </summary>
        public FileDeleteFromTaskOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Timeout = timeout;
