...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ApplicationGetHeaders
    {
        ...
        /// Initializes a new instance of the ApplicationGetHeaders class.
        /// </summary>
        public ApplicationGetHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
