...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class CertificateListHeaders
    {
        /// <summary>
        ...
        /// Initializes a new instance of the CertificateListHeaders class.
        /// </summary>
        public CertificateListHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
