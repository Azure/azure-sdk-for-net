...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeGetOptions
    {
        ...
        /// Initializes a new instance of the ComputeNodeGetOptions class.
        /// </summary>
        public ComputeNodeGetOptions(string select = default(string), int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Select = select;
            Timeout = timeout;
