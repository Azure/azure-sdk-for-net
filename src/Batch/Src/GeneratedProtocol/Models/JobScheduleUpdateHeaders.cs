...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class JobScheduleUpdateHeaders
    {
        /// <summary>
        ...
        /// Initializes a new instance of the JobScheduleUpdateHeaders class.
        /// </summary>
        public JobScheduleUpdateHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?), string dataServiceId = default(string))
        {
