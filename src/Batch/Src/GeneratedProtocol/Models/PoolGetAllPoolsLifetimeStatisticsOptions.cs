...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class PoolGetAllPoolsLifetimeStatisticsOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PoolGetAllPoolsLifetimeStatisticsOptions class.
        /// </summary>
        public PoolGetAllPoolsLifetimeStatisticsOptions() { }

        /// <summary>
        /// Initializes a new instance of the
        /// PoolGetAllPoolsLifetimeStatisticsOptions class.
        /// </summary>
        public PoolGetAllPoolsLifetimeStatisticsOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Timeout = timeout;
