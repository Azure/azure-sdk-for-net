...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class ComputeNodeReimageHeaders
    {
        /// <summary>
        ...
        /// Initializes a new instance of the ComputeNodeReimageHeaders class.
        /// </summary>
        public ComputeNodeReimageHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?), string dataServiceId = default(string))
        {
