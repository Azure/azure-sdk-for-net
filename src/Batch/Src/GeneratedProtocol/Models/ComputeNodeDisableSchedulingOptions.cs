...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class ComputeNodeDisableSchedulingOptions
    {
        ...
        /// ComputeNodeDisableSchedulingOptions class.
        /// </summary>
        public ComputeNodeDisableSchedulingOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Timeout = timeout;
