...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    /// </summary>
    public partial class JobGetAllJobsLifetimeStatisticsOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// JobGetAllJobsLifetimeStatisticsOptions class.
        /// </summary>
        public JobGetAllJobsLifetimeStatisticsOptions() { }

        /// <summary>
        /// Initializes a new instance of the
        /// JobGetAllJobsLifetimeStatisticsOptions class.
        /// </summary>
        public JobGetAllJobsLifetimeStatisticsOptions(int? timeout = default(int?), string clientRequestId = default(string), bool? returnClientRequestId = default(bool?), DateTime? ocpDate = default(DateTime?))
        {
            Timeout = timeout;
