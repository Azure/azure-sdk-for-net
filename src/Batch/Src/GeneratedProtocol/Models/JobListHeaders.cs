...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobListHeaders
    {
        ...
        /// Initializes a new instance of the JobListHeaders class.
        /// </summary>
        public JobListHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?))
        {
