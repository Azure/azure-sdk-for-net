...
namespace Microsoft.Azure.Batch.Protocol.Models
{
    ...
    public partial class JobUpdateHeaders
    {
        ...
        /// Initializes a new instance of the JobUpdateHeaders class.
        /// </summary>
        public JobUpdateHeaders(string clientRequestId = default(string), string requestId = default(string), string eTag = default(string), DateTime? lastModified = default(DateTime?), string dataServiceId = default(string))
        {
