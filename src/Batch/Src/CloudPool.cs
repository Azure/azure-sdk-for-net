namespace Microsoft.Azure.Batch
{
    ...
    public partial class CloudPool : IRefreshable
    {
        ...
        public async System.Threading.Tasks.Task DeleteAsync(IEnumerable<BatchClientBehavior> additionalBehaviors = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            using (System.Threading.Tasks.Task asyncDelete = this.parentBatchClient.PoolOperations.DeletePoolAsync(
                this.Id, 
        ...
        public void Resize(
            ...
            IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            using (System.Threading.Tasks.Task asyncTask = ResizeAsync(targetDedicated, resizeTimeout, deallocationOption, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        {
            using (System.Threading.Tasks.Task asyncTask = StopResizeAsync(additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        {
            using (System.Threading.Tasks.Task<ComputeNode> asyncTask = GetComputeNodeAsync(computeNodeId, detailLevel, additionalBehaviors))
            {
        ...
        public void EnableAutoScale(
            ...
            IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            using (System.Threading.Tasks.Task asyncTask = EnableAutoScaleAsync(autoscaleFormula, autoscaleEvaluationInterval, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        {
            using (System.Threading.Tasks.Task asyncTask = DisableAutoScaleAsync(additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        {
            using (System.Threading.Tasks.Task<AutoScaleRun> asyncTask = EvaluateAutoScaleAsync(autoscaleFormula, additionalBehaviors))
            {
        ...
        public void RemoveFromPool(
            ...
            IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            using (System.Threading.Tasks.Task asyncTask = RemoveFromPoolAsync(computeNodeId, deallocationOption, resizeTimeout, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        public void RemoveFromPool(
            ...
            IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            using (System.Threading.Tasks.Task asyncTask = RemoveFromPoolAsync(computeNodeIds, deallocationOption, resizeTimeout, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        public void RemoveFromPool(
            ...
            IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            using (System.Threading.Tasks.Task asyncTask = RemoveFromPoolAsync(computeNode, deallocationOption, resizeTimeout, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
            ...
            IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            ...
            using (System.Threading.Tasks.Task asyncTask = RemoveFromPoolAsync(computeNodes, deallocationOption, resizeTimeout, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        {
            using (System.Threading.Tasks.Task asyncTask = ChangeOSVersionAsync(targetOSVersion, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
