...
#region // JobOperations
        ...
        {
            using (System.Threading.Tasks.Task<CloudJob> asyncTask = GetJobAsync( jobId, detailLevel, additionalBehaviors))
            {
        ...
        {
            using (System.Threading.Tasks.Task asyncTask = EnableJobAsync(jobId, additionalBehaviors))
            {
        ...
        {
            using (System.Threading.Tasks.Task asyncTask = DisableJobAsync(jobId, disableJobOption, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        {
            using (System.Threading.Tasks.Task asyncTask = TerminateJobAsync(jobId, terminateReason, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        {
            using (System.Threading.Tasks.Task asyncTask = DeleteJobAsync(jobId, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        {
            using (System.Threading.Tasks.Task<AzureOperationResponse<Models.CloudTask, Models.TaskGetHeaders>> asyncTask = 
        ...
        {
            using (System.Threading.Tasks.Task<CloudTask> asyncTask = GetTaskAsync(jobId, taskId, detailLevel, additionalBehaviors))
            {
        ...
        public ConcurrentDictionary<Type, IFileStagingArtifact> AddTask(string jobId, CloudTask taskToAdd, IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            ...
            using (System.Threading.Tasks.Task asyncTask = this.AddTaskAsync(jobId, taskToAdd, artifacts, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        ...
        public void TerminateTask(
            ...
            IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            using (System.Threading.Tasks.Task asyncTask = TerminateTaskAsync(jobId, taskId, additionalBehaviors))
            {
                asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
            }
        }
        ...
        public void AddTask(
            ...
            IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            using (System.Threading.Tasks.Task asyncTask = this.AddTaskAsync(
                jobId, 
                tasksToAdd,
                parallelOptions, 
                fileStagingArtifacts,
