namespace Microsoft.Azure.Management.Compute
{
    ...
    internal partial class UsageOperations : IServiceOperations<ComputeManagementClient>, IUsageOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<ListUsagesResult>> ListWithOperationResponseAsync(string location, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
