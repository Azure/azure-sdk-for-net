...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class VirtualMachineExtensionImageProperties
    {
        ...
        /// VirtualMachineExtensionImageProperties class.
        /// </summary>
        public VirtualMachineExtensionImageProperties(string operatingSystem = default(string), string computeRole = default(string), string handlerSchema = default(string), bool? vmScaleSetEnabled = default(bool?), bool? supportsMultipleExtensions = default(bool?))
        {
