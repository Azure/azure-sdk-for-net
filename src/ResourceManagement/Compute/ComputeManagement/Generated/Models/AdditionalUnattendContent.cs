...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class AdditionalUnattendContent
    {
        ...
        /// Initializes a new instance of the AdditionalUnattendContent class.
        /// </summary>
        public AdditionalUnattendContent(string passName = default(string), string componentName = default(string), string settingName = default(string), string content = default(string))
        {
            PassName = passName;
