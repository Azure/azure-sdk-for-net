...
namespace Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update
{
    ...
    public interface IWithDataDisk 
    {
        ...
        IAttachNewDataDisk<Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate> DefineNewDataDisk (string name);
        ...
        /// <param name="name">name the name for the data disk</param>
        /// <returns>the stage representing configuration for the data disk</returns>
        IAttachExistingDataDisk<Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate> DefineExistingDataDisk (string name);
