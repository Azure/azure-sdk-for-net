...
namespace Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update
{
    ...
    public interface IWithDataDisk 
    {
        ...
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithNewDataDisk(int sizeInGB);
        ...
        /// <returns>the stage representing creatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithExistingDataDisk(string storageAccountName, string containerName, string vhdName);
        ...
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachineDataDisk.UpdateDefinition.IAttachNewDataDisk<Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate> DefineNewDataDisk(string name);
        ...
        /// <param name="name">name the name for the data disk</param>
        /// <returns>the stage representing configuration for the data disk</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachineDataDisk.UpdateDefinition.IAttachExistingDataDisk<Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate> DefineExistingDataDisk(string name);
        ...
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachineDataDisk.Update.IUpdate UpdateDataDisk(string name);
        ...
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithoutDataDisk(string name);
        ...
        /// <returns>the stage representing updatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithoutDataDisk(int lun);
    ...
    public interface IWithExtension 
    {
        ...
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachineExtension.UpdateDefinition.IBlank<Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate> DefineNewExtension(string name);
        ...
        /// <param name="name">name the reference name for the extension</param>
        /// <returns>the stage representing updatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachineExtension.Update.IUpdate UpdateExtension(string name);
        ...
        /// <returns>the stage representing updatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithoutExtension(string name);
    ...
    public interface IWithSecondaryNetworkInterface 
    {
        ...
        /// <returns>the stage representing creatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithNewSecondaryNetworkInterface(ICreatable<Microsoft.Azure.Management.Fluent.Network.INetworkInterface> creatable);
        ...
        /// <returns>the stage representing creatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithExistingSecondaryNetworkInterface(INetworkInterface networkInterface);
        ...
        /// <returns>the stage representing updatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithoutSecondaryNetworkInterface(string name);
    ...
    public interface IUpdate  :
        IAppliable<Microsoft.Azure.Management.Fluent.Compute.IVirtualMachine>,
        IUpdateWithTags<Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate>,
        IWithDataDisk,
        ...
        IWithExtension
    {
        ...
        /// <returns>the stage representing updatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithOsDiskCaching(CachingTypes cachingType);
        ...
        /// <returns>the stage representing updatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithOsDiskSizeInGb(int size);
        ...
        /// <returns>the stage representing updatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithSize(string sizeName);
        ...
        /// <returns>the stage representing updatable VM definition</returns>
        Microsoft.Azure.Management.Fluent.Compute.VirtualMachine.Update.IUpdate WithSize(VirtualMachineSizeTypes size);
