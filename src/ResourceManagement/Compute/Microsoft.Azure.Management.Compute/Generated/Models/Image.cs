...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class Image : Resource
    {
        ...
        public Image(string location, string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), SubResource sourceVirtualMachine = default(SubResource), ImageStorageProfile storageProfile = default(ImageStorageProfile), string provisioningState = default(string))
