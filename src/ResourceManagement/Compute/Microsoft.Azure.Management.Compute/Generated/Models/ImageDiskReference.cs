...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class ImageDiskReference
    {
        ...
        /// Initializes a new instance of the ImageDiskReference class.
        /// </summary>
        /// <param name="id">A relative uri containing either a Platform
        /// Imgage Repository or user image reference.</param>
        /// <param name="lun">If the disk is created from an image's data
        /// disk, this is an index that indicates which of the data disks in
        /// the image to use. For OS disks, this field is null.</param>
        ...
        /// <summary>
        /// Gets or sets if the disk is created from an image's data disk,
