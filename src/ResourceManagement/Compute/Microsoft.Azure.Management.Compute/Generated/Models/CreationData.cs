...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class CreationData
    {
        ...
        /// <param name="storageAccountId">If createOption is Import, the
        /// Azure Resource Manager identifier of the storage account
        /// containing the blob to import as a disk. Required only if the
        /// blob is in a different subscription</param>
        /// <param name="imageReference">Disk source information.</param>
        /// <param name="sourceUri">If creationOption is Import, this is a SAS
        /// URI to a blob to be imported into a managed disk. If
        /// creationOption is Copy, this is a relative Uri containing the id
        /// of the source snapshot to be copied into a managed disk.</param>
        /// <param name="sourceResourceId">If createOption is Copy, this is
        /// the ARM id of the source snapshot or disk. If creationOption is
        ...
        /// as a disk. Required only if the blob is in a different
        /// subscription
        /// </summary>
        ...
        /// blob to be imported into a managed disk. If creationOption is
        /// Copy, this is a relative Uri containing the id of the source
        ...
        /// source snapshot or disk. If creationOption is Restore, this is
