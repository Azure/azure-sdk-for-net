...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class Snapshot : Resource
    {
        ...
        /// create. If this field is present for updates or creation with
        /// other options, it indicates a resize. Resizes are only allowed if
        /// the disk is not attached to a running VM, and can only increase
        /// the disk's size.</param>
        ...
        /// state.</param>
        public Snapshot(string location, CreationData creationData, string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), StorageAccountTypes? accountType = default(StorageAccountTypes?), System.DateTime? timeCreated = default(System.DateTime?), OperatingSystemTypes? osType = default(OperatingSystemTypes?), int? diskSizeGB = default(int?), EncryptionSettings encryptionSettings = default(EncryptionSettings), string ownerId = default(string), string provisioningState = default(string))
