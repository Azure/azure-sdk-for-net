...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class DiskUpdate : ResourceUpdate
    {
        ...
        /// snapshot</param>
        public DiskUpdate(System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), StorageAccountTypes? accountType = default(StorageAccountTypes?), OperatingSystemTypes? osType = default(OperatingSystemTypes?), CreationData creationData = default(CreationData), int? diskSizeGB = default(int?), EncryptionSettings encryptionSettings = default(EncryptionSettings))
            : base(tags)
        {
