...
namespace Microsoft.Azure.Management.Compute.Fluent
{
        ...
        IDefinition<VirtualMachineCustomImage.Definition.IWithCreateAndDataDiskImageOSDiskSettings>
    {
        ...
        {
            this.Inner.ManagedDisk = new SubResource()
            {
        ...
        {
            return string.Format("%d", this.Inner.Lun);
        }
        ...
        {
            this.Inner.DiskSizeGB = diskSizeGB;
            return this;
        }
        ...
        {
            this.Inner.BlobUri = sourceVhdUrl;
            return this;
        }
        ...
        {
            this.Inner.Snapshot = new SubResource()
            {
                Id = sourceSnapshotId
            };
            return this;
