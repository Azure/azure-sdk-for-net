...
namespace Microsoft.Azure.Management.Fluent.Compute
{
        ...
        IWrapper<Microsoft.Azure.Management.Compute.Models.VirtualMachineImageInner>
    {
        ...
        Microsoft.Azure.Management.Fluent.Resource.Core.Region Location { get; }
        ...
        Microsoft.Azure.Management.Compute.Models.ImageReference ImageReference { get; }

        /// <returns>the purchase plan for the virtual machine image</returns>
        Microsoft.Azure.Management.Compute.Models.PurchasePlan Plan { get; }

        /// <returns>OS disk image in the virtual machine image</returns>
        Microsoft.Azure.Management.Compute.Models.OSDiskImage OsDiskImage { get; }

        /// <returns>data disk images in the virtual machine image</returns>
        System.Collections.Generic.IList<Microsoft.Azure.Management.Compute.Models.DataDiskImage> DataDiskImages { get; }
