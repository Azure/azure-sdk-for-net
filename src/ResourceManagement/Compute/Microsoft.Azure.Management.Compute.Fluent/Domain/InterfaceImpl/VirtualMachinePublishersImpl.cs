...
namespace Microsoft.Azure.Management.Compute.Fluent
{
    ...
    internal partial class VirtualMachinePublishersImpl
    {
        ...
        {
            return this.ListByRegion(region) as Microsoft.Azure.Management.Resource.Fluent.Core.PagedList<Microsoft.Azure.Management.Compute.Fluent.IVirtualMachinePublisher>;
        }
        ...
        {
            return this.ListByRegion(regionName) as Microsoft.Azure.Management.Resource.Fluent.Core.PagedList<Microsoft.Azure.Management.Compute.Fluent.IVirtualMachinePublisher>;
        }
    }
}