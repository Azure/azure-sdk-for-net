...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LmNvbXB1dGUuaW1wbGVtZW50YXRpb24uVmlydHVhbE1hY2hpbmVFbmNyeXB0aW9uSW1wbA==
        ...
        IVirtualMachineEncryption
    {
        ...
        public Task<Microsoft.Azure.Management.Compute.Fluent.IDiskVolumeEncryptionMonitor> GetMonitorAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return monitor.RefreshAsync(cancellationToken);
        }
        ...
        {
            return EnableAsync(keyVaultId, aadClientId, aadSecret).Result;
        }
        ...
        {
            return EnableAsync(encryptionSettings).Result;
        }
        ...
        {
            return DisableAsync(volumeType).Result;
        }
