...
namespace Microsoft.Azure.Management.Compute.Fluent.Models
{
    ...
    public partial class SnapshotInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        ...
        /// state.</param>
        public SnapshotInner(CreationData creationData, string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), StorageAccountTypes? accountType = default(StorageAccountTypes?), System.DateTime? timeCreated = default(System.DateTime?), OperatingSystemTypes? osType = default(OperatingSystemTypes?), int? diskSizeGB = default(int?), EncryptionSettings encryptionSettings = default(EncryptionSettings), string ownerId = default(string), string provisioningState = default(string))
