...
namespace Microsoft.Azure.Management.Compute.Fluent.Models
{
    ...
    public partial class DiskUpdateInner : ResourceUpdate
    {
        ...
        /// snapshot</param>
        public DiskUpdateInner(IDictionary<string, string> tags = default(IDictionary<string, string>), StorageAccountTypes? accountType = default(StorageAccountTypes?), OperatingSystemTypes? osType = default(OperatingSystemTypes?), CreationData creationData = default(CreationData), int? diskSizeGB = default(int?), EncryptionSettings encryptionSettings = default(EncryptionSettings))
            : base(tags)
        {
