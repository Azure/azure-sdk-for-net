...
namespace Microsoft.Azure.Management.Compute.Fluent
{
    ...
    internal partial class ContainerServicesOperations : IServiceOperations<ComputeManagementClient>, IContainerServicesOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<ContainerServiceInner>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<ContainerServiceInner>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<ContainerServiceInner>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        {
            // Send Request
            AzureOperationResponse<ContainerServiceInner> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, containerServiceName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async Task<AzureOperationResponse<ContainerServiceInner>> GetWithHttpMessagesAsync(string resourceGroupName, string containerServiceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ContainerServiceInner>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ContainerServiceInner>(_responseContent, Client.DeserializationSettings);
                }
                catch (Newtonsoft.Json.JsonException ex)
                {
                    _httpRequest.Dispose();
