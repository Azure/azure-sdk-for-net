...
namespace Microsoft.Azure.Management.SiteRecovery
{
    ...
    internal partial class StorageOperations : IServiceOperations<SiteRecoveryManagementClient>, IStorageOperations
    {
        ...
        /// </returns>
        public async Task<StorageResponse> GetAsync(string fabricName, string storageName, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (fabricName == null)
            {
                ...
                try
                {
                    ...
                    if (statusCode == HttpStatusCode.OK)
                    {
                        ...
                        if (responseDoc != null && responseDoc.Type != JTokenType.Null)
                        {
                            ...
                            {
                                StorageProperties propertiesInstance = new StorageProperties();
                                storageInstance.Properties = propertiesInstance;
                                ...
                                {
                                    StorageSpecificDetails customDetailsInstance = new StorageSpecificDetails();
                                    propertiesInstance.CustomDetails = customDetailsInstance;
                                    
                                    JToken typeValue = customDetailsValue["type"];
                                    if (typeValue != null && typeValue.Type != JTokenType.Null)
                                    {
                                        string typeInstance = ((string)typeValue);
                                        customDetailsInstance.Type = typeInstance;
                                    }
                                }
                            }
                            ...
                            if (typeValue2 != null && typeValue2.Type != JTokenType.Null)
                            {
                                ...
                                storageInstance.Type = typeInstance2;
                            }
                            ...
                            if (locationValue != null && locationValue.Type != JTokenType.Null)
                            {
                                ...
                                storageInstance.Location = locationInstance;
                            }
                            ...
                            if (tagsSequenceElement != null && tagsSequenceElement.Type != JTokenType.Null)
                            {
                                foreach (JProperty property in tagsSequenceElement)
                                {
                                    ...
                                    storageInstance.Tags.Add(tagsKey, tagsValue);
                                }
                            }
                        }
