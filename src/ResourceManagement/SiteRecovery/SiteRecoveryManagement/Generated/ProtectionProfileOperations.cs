...
namespace Microsoft.Azure.Management.SiteRecovery
{
    ...
    internal partial class ProtectionProfileOperations : IServiceOperations<SiteRecoveryManagementClient>, IProtectionProfileOperations
    {
        ...
        /// </returns>
        public async Task<JobResponse> BeginAssociatingAsync(string name, ProtectionProfileAssociationInput input, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (name == null)
            {
        ...
        public async Task<LongRunningOperationResponse> BeginCreatingAsync(CreateProtectionProfileInput input, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    createProtectionProfileInputValue["replicationProviderSettings"] = input.ReplicationProviderSettings;
                }
        ...
        public async Task<JobResponse> CreateAndAssociateAsync(CreateAndAssociateProtectionProfileInput input, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                requestDoc = inputValue;
                
                if (input.ProtectionProfileInput != null)
                {
                    JObject protectionProfileInputValue = new JObject();
                    inputValue["ProtectionProfileInput"] = protectionProfileInputValue;
                    
                    protectionProfileInputValue["name"] = protectionProfileInputValue;
                    
                    protectionProfileInputValue["replicationProvider"] = protectionProfileInputValue;
                    
                    protectionProfileInputValue["replicationProviderSettings"] = protectionProfileInputValue;
                }
                
                JObject associationInputValue = new JObject();
                inputValue["AssociationInput"] = associationInputValue;
                
                associationInputValue["PrimaryProtectionContainerId"] = input.AssociationInput.PrimaryProtectionContainerId;
                
                associationInputValue["RecoveryProtectionContainerId"] = input.AssociationInput.RecoveryProtectionContainerId;
