...
namespace Microsoft.Azure.Management.DataLake.AnalyticsJob.Models
{
    ...
    /// </summary>
    public partial class JobInfoListResponse : AzureOperationResponse
    {
        private long _count;
        ...
        private IList<JobInformation> _value;
        
        /// <summary>
        /// Optional. Gets or sets the list of jobInfo items.
        /// </summary>
        public IList<JobInformation> Value
        {
        ...
        /// <summary>
        /// Initializes a new instance of the JobInfoListResponse class.
        /// </summary>
        public JobInfoListResponse()
        {
            this.Value = new LazyList<JobInformation>();
        }
    }
}
