...
namespace DataLakeAnalyticsJob.Tests
{
    public static class ClientManagementUtilities
    {
        ...
        /// <param name="testBase">the test class</param>
        /// <returns>A bigAnalytics management client, created from the current context (environment variables)</returns>
        public static IDataLakeAnalyticsJobManagementClient GetDataLakeAnalyticsJobManagementClient(this TestBase testBase)
        {
            return DataLakeAnalyticsJobTestBase.GetDataLakeAnalyticsJobServiceClient<DataLakeAnalyticsJobManagementClient>(new CSMTestEnvironmentFactory());
        }
        ...
        public static DataLakeStoreManagementClient GetDataLakeManagementClient(this TestBase testBase)
        {
