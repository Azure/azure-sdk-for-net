...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnRyYWZmaWNtYW5hZ2VyLmltcGxlbWVudGF0aW9uLlRyYWZmaWNNYW5hZ2VyUHJvZmlsZUltcGw=
    internal partial class TrafficManagerProfileImpl  :
        GroupableResource<ITrafficManagerProfile,ProfileInner,TrafficManagerProfileImpl,TrafficManager>,
        ITrafficManagerProfile,
        IDefinition,
        IUpdate
    {
        private ProfilesInner innerCollection;
        private EndpointsInner endpointsClient;
        private string profileStatusDisabled;
        private string profileStatusEnabled;
        ...
        internal  TrafficManagerProfileImpl(string name, ProfileInner innerModel, ProfilesInner innerCollection, EndpointsInner endpointsClient, TrafficManager trafficManager)
        {
            //$ {
        ...
        public async Task<ITrafficManagerProfile> UpdateResourceAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            //$ TrafficManagerProfileImpl self = this;
        ...
        public async Task<ITrafficManagerProfile> CreateResourceAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            //$ TrafficManagerProfileImpl self = this;
            //$ return innerCollection.CreateOrUpdateAsync(resourceGroupName(), name(), Inner)
            //$ .Map(new Func1<ProfileInner, TrafficManagerProfile>() {
        ...
        public ITrafficManagerProfile Refresh()
        {
        ...
        public TrafficRoutingMethod TrafficRoutingMethod()
        {
            ...
            return TrafficRoutingMethod.PERFORMANCE;
        }
