...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnRyYWZmaWNtYW5hZ2VyLmltcGxlbWVudGF0aW9uLlRyYWZmaWNNYW5hZ2VyRW5kcG9pbnRJbXBs
    internal partial class TrafficManagerEndpointImpl  :
        ExternalChildResourceImpl<ITrafficManagerEndpoint,EndpointInner,TrafficManagerProfileImpl,ITrafficManagerProfile>,
        ...
        IUpdateNestedProfileEndpoint
    {
        ...
        private string endpointStatusDisabled;
        private string endpointStatusEnabled;
        ...
        internal  TrafficManagerEndpointImpl(string name, TrafficManagerProfileImpl parent, EndpointInner inner, EndpointsInner client)
        {
            //$ {
        ...
        public async Task<ITrafficManagerEndpoint> CreateAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            //$ TrafficManagerEndpointImpl self = this;
        ...
        public async Task<ITrafficManagerEndpoint> UpdateAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            //$ return createAsync();
