...
namespace Microsoft.Azure.Management.TrafficManager
{
    ...
    public partial class TrafficManagerManagementClient : ServiceClient<TrafficManagerManagementClient>, ITrafficManagerManagementClient, IAzureClient
    {
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected TrafficManagerManagementClient(Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected TrafficManagerManagementClient(Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public TrafficManagerManagementClient(Uri baseUri, ServiceClientCredentials credentials, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public TrafficManagerManagementClient(Uri baseUri, ServiceClientCredentials credentials, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
