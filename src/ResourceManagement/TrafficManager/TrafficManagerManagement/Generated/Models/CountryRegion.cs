...
namespace Microsoft.Azure.Management.TrafficManager.Models
{
    ...
    /// </summary>
    public partial class CountryRegion : GeographicEntity
    {
        private IList<StateProvince> _regions;
        
        /// <summary>
        /// Optional. Gets or sets the list of Regions grouped under this
        /// Region in the Geographic Hierarchy.
        /// </summary>
        public IList<StateProvince> Regions
        {
        ...
        /// <summary>
        /// Initializes a new instance of the CountryRegion class with required
        /// arguments.
        /// </summary>
        public CountryRegion(string code)
            : this()
        {
            if (code == null)
            {
