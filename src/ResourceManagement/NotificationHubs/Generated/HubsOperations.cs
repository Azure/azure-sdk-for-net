...
namespace Microsoft.Azure.Management.NotificationHubs.Fluent
{
    ...
    internal partial class HubsOperations : IServiceOperations<NotificationHubsManagementClient>, IHubsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CheckNameAvailabilityResponseInner>> CheckAvailabilityWithHttpMessagesAsync(string resourceGroupName, string namespaceName, string name, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
