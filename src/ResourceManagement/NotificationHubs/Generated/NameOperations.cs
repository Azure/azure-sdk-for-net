...
namespace Microsoft.Azure.Management.NotificationHubs.Fluent
{
    ...
    /// </summary>
    internal partial class NameOperations : IServiceOperations<NotificationHubsManagementClient>, INameOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<CheckNameAvailabilityResponseInner>> CheckAvailabilityWithHttpMessagesAsync(string name, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<CheckNameAvailabilityResponseInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<CheckNameAvailabilityResponseInner>(_responseContent, Client.DeserializationSettings);
                }
