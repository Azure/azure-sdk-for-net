...
namespace Microsoft.Azure.Management.NotificationHubs.Fluent.Models
{
    ...
    /// NotificationHubs.
    /// </summary>
    public partial class CheckAvailabilityParametersInner
    {
        /// <summary>
        /// Initializes a new instance of the CheckAvailabilityParametersInner
        /// class.
        /// </summary>
        public CheckAvailabilityParametersInner()
        {
          CustomInit();
        }
        ...
        /// false.</param>
        public CheckAvailabilityParametersInner(string name, string location, string id = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), bool? isAvailiable = default(bool?))
        {
            Id = id;
            Name = name;
            Type = type;
