...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    public partial class ApplicationInner
    {
        ...
        public ApplicationInner(string id = default(string), string displayName = default(string), System.Collections.Generic.IList<ApplicationPackageInner> packages = default(System.Collections.Generic.IList<ApplicationPackageInner>), bool? allowUpdates = default(bool?), string defaultVersion = default(string))
        {
            Id = id;
        ...
        public System.Collections.Generic.IList<ApplicationPackageInner> Packages { get; set; }
