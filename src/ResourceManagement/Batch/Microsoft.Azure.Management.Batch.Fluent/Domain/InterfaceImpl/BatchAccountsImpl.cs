...
namespace Microsoft.Azure.Management.Batch.Fluent
{
    ...
    public partial class BatchAccountsImpl 
    {
        ...
        async Task Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsDeletingByGroup.DeleteByGroupAsync(string groupName, string name, CancellationToken cancellationToken = default(CancellationToken)) { 
