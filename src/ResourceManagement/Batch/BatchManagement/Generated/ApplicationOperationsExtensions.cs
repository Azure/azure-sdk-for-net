...
namespace Microsoft.Azure.Management.Batch
{
    ...
    public static partial class ApplicationOperationsExtensions
    {
            ...
            /// The parameters for the request.
            /// </param>
            public static void AddApplication(this IApplicationOperations operations, string resourceGroupName, string accountName, string applicationId, AddApplicationParameters parameters = default(AddApplicationParameters))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task AddApplicationAsync(this IApplicationOperations operations, string resourceGroupName, string accountName, string applicationId, AddApplicationParameters parameters = default(AddApplicationParameters), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static ListApplicationsResult List(this IApplicationOperations operations, string resourceGroupName, string accountName, int? maxresults = default(int?))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ListApplicationsResult> ListAsync(this IApplicationOperations operations, string resourceGroupName, string accountName, int? maxresults = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
