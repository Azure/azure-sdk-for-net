...
namespace Microsoft.Azure.Management.Batch
{
   ...
   using Models;
    ...
    public static partial class ApplicationOperationsExtensions
    {
            ...
            /// </param>
            public static ApplicationInner Create(this IApplicationOperations operations, string resourceGroupName, string accountName, string applicationId, AddApplicationParametersInner parameters = default(AddApplicationParametersInner))
            {
            ...
            /// </param>
            public static async System.Threading.Tasks.Task<ApplicationInner> CreateAsync(this IApplicationOperations operations, string resourceGroupName, string accountName, string applicationId, AddApplicationParametersInner parameters = default(AddApplicationParametersInner), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task<ApplicationInner> GetAsync(this IApplicationOperations operations, string resourceGroupName, string accountName, string applicationId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
            ...
            /// The parameters for the request.
            /// </param>
            public static void Update(this IApplicationOperations operations, string resourceGroupName, string accountName, string applicationId, UpdateApplicationParametersInner parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task UpdateAsync(this IApplicationOperations operations, string resourceGroupName, string accountName, string applicationId, UpdateApplicationParametersInner parameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
