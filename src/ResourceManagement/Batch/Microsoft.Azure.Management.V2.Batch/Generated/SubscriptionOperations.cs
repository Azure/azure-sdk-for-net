...
namespace Microsoft.Azure.Management.Batch
{
    ...
    /// </summary>
    internal partial class SubscriptionOperations : Microsoft.Rest.IServiceOperations<BatchManagementClient>, ISubscriptionOperations
    {
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<SubscriptionQuotasGetResultInner>> GetSubscriptionQuotasWithHttpMessagesAsync(string locationName, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                Microsoft.Rest.ServiceClientTracing.Enter(_invocationId, this, "GetSubscriptionQuotas", tracingParameters);
            }
            // Construct URL
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<SubscriptionQuotasGetResultInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<SubscriptionQuotasGetResultInner>(_responseContent, this.Client.DeserializationSettings);
                }
