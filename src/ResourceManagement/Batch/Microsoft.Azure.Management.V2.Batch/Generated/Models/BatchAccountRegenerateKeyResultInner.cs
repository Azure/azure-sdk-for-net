...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    /// </summary>
    public partial class BatchAccountRegenerateKeyResultInner
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BatchAccountRegenerateKeyResultInner class.
        /// </summary>
        public BatchAccountRegenerateKeyResultInner() { }
        ...
        /// account.</param>
        public BatchAccountRegenerateKeyResultInner(string primary = default(string), string secondary = default(string))
        {
            Primary = primary;
            Secondary = secondary;
        }
