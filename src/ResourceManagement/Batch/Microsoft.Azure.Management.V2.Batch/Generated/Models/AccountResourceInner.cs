...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    public partial class AccountResourceInner : Microsoft.Rest.Azure.Resource
    {
        /// <summary>
        /// Initializes a new instance of the AccountResourceInner class.
        /// </summary>
        ...
        public AccountResourceInner(int coreQuota, int poolQuota, int activeJobAndJobScheduleQuota, string location = default(string), string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string accountEndpoint = default(string), AccountProvisioningState? provisioningState = default(AccountProvisioningState?), AutoStorageProperties autoStorage = default(AutoStorageProperties))
