...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    public partial class BatchAccountCreateParametersInner
    {
        ...
        /// BatchAccountCreateParametersInner class.
        /// </summary>
        /// <param name="location">The region in which the account is
        /// created.</param>
        /// <param name="tags">The user specified tags associated with the
        /// account.</param>
        /// <param name="autoStorage">The properties related to auto storage
        /// account.</param>
        public BatchAccountCreateParametersInner(string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), AutoStorageBaseProperties autoStorage = default(AutoStorageBaseProperties))
        {
            Location = location;
            Tags = tags;
