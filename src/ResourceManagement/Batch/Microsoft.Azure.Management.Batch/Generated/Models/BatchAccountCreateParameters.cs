...
namespace Microsoft.Azure.Management.Batch.Models
{
    ...
    public partial class BatchAccountCreateParameters
    {
        ...
        /// account.</param>
        public BatchAccountCreateParameters(string location, IDictionary<string, string> tags = default(IDictionary<string, string>), AutoStorageBaseProperties autoStorage = default(AutoStorageBaseProperties))
        {
            Location = location;
            Tags = tags;
