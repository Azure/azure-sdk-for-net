...
namespace Microsoft.Azure.Management.DevTestLab.Fluent
{
    ...
    public static partial class ServiceRunnersOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<IPage<ServiceRunnerInner>> ListAsync(this IServiceRunnersOperations operations, string resourceGroupName, string labName, ODataQuery<ServiceRunnerInner> odataQuery = default(ODataQuery<ServiceRunnerInner>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceRunnerInner> GetAsync(this IServiceRunnersOperations operations, string resourceGroupName, string labName, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ServiceRunnerInner> CreateOrUpdateAsync(this IServiceRunnersOperations operations, string resourceGroupName, string labName, string name, ServiceRunnerInner serviceRunner, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<ServiceRunnerInner>> ListNextAsync(this IServiceRunnersOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
