...
namespace Microsoft.Azure.Management.DevTestLab.Fluent.Models
{
    ...
    public partial class NotificationChannelFragmentInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        /// <summary>
        /// Initializes a new instance of the NotificationChannelFragmentInner
        /// class.
        /// </summary>
        public NotificationChannelFragmentInner()
        {
          CustomInit();
        }
        ...
        /// resource (Guid).</param>
        public NotificationChannelFragmentInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string webHookUrl = default(string), string description = default(string), IList<EventFragment> events = default(IList<EventFragment>), string provisioningState = default(string), string uniqueIdentifier = default(string))
