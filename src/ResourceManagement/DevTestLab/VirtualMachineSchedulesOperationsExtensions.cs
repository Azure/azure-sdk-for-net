...
namespace Microsoft.Azure.Management.DevTestLab.Fluent
{
    ...
    public static partial class VirtualMachineSchedulesOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<ScheduleInner> List(this IVirtualMachineSchedulesOperations operations, string resourceGroupName, string labName, string virtualMachineName, ODataQuery<ScheduleInner> odataQuery = default(ODataQuery<ScheduleInner>))
            {
                return ((IVirtualMachineSchedulesOperations)operations).ListAsync(resourceGroupName, labName, virtualMachineName, odataQuery).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<ScheduleInner>> ListAsync(this IVirtualMachineSchedulesOperations operations, string resourceGroupName, string labName, string virtualMachineName, ODataQuery<ScheduleInner> odataQuery = default(ODataQuery<ScheduleInner>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static ScheduleInner Get(this IVirtualMachineSchedulesOperations operations, string resourceGroupName, string labName, string virtualMachineName, string name, string expand = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ScheduleInner> GetAsync(this IVirtualMachineSchedulesOperations operations, string resourceGroupName, string labName, string virtualMachineName, string name, string expand = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// A schedule.
            /// </param>
            public static ScheduleInner CreateOrUpdate(this IVirtualMachineSchedulesOperations operations, string resourceGroupName, string labName, string virtualMachineName, string name, ScheduleInner schedule)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ScheduleInner> CreateOrUpdateAsync(this IVirtualMachineSchedulesOperations operations, string resourceGroupName, string labName, string virtualMachineName, string name, ScheduleInner schedule, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// A schedule.
            /// </param>
            public static ScheduleInner Update(this IVirtualMachineSchedulesOperations operations, string resourceGroupName, string labName, string virtualMachineName, string name, ScheduleFragmentInner schedule)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ScheduleInner> UpdateAsync(this IVirtualMachineSchedulesOperations operations, string resourceGroupName, string labName, string virtualMachineName, string name, ScheduleFragmentInner schedule, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IPage<ScheduleInner> ListNext(this IVirtualMachineSchedulesOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<ScheduleInner>> ListNextAsync(this IVirtualMachineSchedulesOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
