...
namespace Microsoft.Azure.Management.DevTestLab.Fluent
{
    ...
    public static partial class UsersOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<UserInner> List(this IUsersOperations operations, string resourceGroupName, string labName, ODataQuery<UserInner> odataQuery = default(ODataQuery<UserInner>))
            {
            ...
            /// </param>
            public static UserInner Get(this IUsersOperations operations, string resourceGroupName, string labName, string name, string expand = default(string))
            {
            ...
            /// </param>
            public static UserInner CreateOrUpdate(this IUsersOperations operations, string resourceGroupName, string labName, string name, UserInner user)
            {
            ...
            /// Profile of a lab user.
            /// </param>
            public static UserInner Update(this IUsersOperations operations, string resourceGroupName, string labName, string name, UserFragmentInner user)
            {
            ...
            /// </param>
            public static IPage<UserInner> ListNext(this IUsersOperations operations, string nextPageLink)
            {
