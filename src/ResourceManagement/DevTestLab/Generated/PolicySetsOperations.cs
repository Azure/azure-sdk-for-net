...
namespace Microsoft.Azure.Management.DevTestLab.Fluent
{
    ...
    internal partial class PolicySetsOperations : IServiceOperations<DevTestLabsClient>, IPolicySetsOperations
    {
        ...
        public async Task<AzureOperationResponse<EvaluatePoliciesResponseInner>> EvaluatePoliciesWithHttpMessagesAsync(string resourceGroupName, string labName, string name, IList<EvaluatePoliciesPropertiesInner> policies = default(IList<EvaluatePoliciesPropertiesInner>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (policies != null)
            {
                evaluatePoliciesRequest.Policies = policies;
            }
            // Tracing
            ...
            // Create Result
            var _result = new AzureOperationResponse<EvaluatePoliciesResponseInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<EvaluatePoliciesResponseInner>(_responseContent, Client.DeserializationSettings);
                }
