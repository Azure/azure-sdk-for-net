...
namespace Microsoft.Azure.Management.DevTestLab.Fluent.Models
{
    ...
    /// </summary>
    public partial class ArtifactInstallPropertiesInner
    {
        /// <summary>
        /// Initializes a new instance of the ArtifactInstallPropertiesInner
        /// class.
        /// </summary>
        public ArtifactInstallPropertiesInner()
        {
          CustomInit();
        }
        ...
        public ArtifactInstallPropertiesInner(string artifactId = default(string), IList<ArtifactParameterProperties> parameters = default(IList<ArtifactParameterProperties>), string status = default(string), string deploymentStatusMessage = default(string), string vmExtensionStatusMessage = default(string), System.DateTime? installTime = default(System.DateTime?))
        {
