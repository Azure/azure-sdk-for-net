...
namespace AzureStackAdmin.Tests
{
    public class AdminSubscriptionTests
    {
        ...
        [Fact]
        public void GetAdminSubscription()
        {
            var response = new HttpResponseMessage(HttpStatusCode.OK)
            {
                Content = new StringContent(@"{
                    'id': '/subscriptions/7B9E2B97-C218-4577-9582-6F390D5CD2E7/providers/Microsoft.Subscriptions.Admin/subscriptions/001f675f-daad-4357-993f-2203a22a1935',
                    'subscriptionId': '001f675f-daad-4357-993f-2203a22a1935',
                    'delegatedProviderSubscriptionId': '001f675f-daad-4357-993f-2203a22a1935',
            ...
            var result = client.TenantSubscriptions.Get("001f675f-daad-4357-993f-2203a22a1935");
            ...
            Assert.Equal("001f675f-daad-4357-993f-2203a22a1935", result.Subscription.DelegatedProviderSubscriptionId);
        ...
        public void CreateOrUpdateSubscription()
        {
            ...
            var result = client.TenantSubscriptions.CreateOrUpdate(
                new SubscriptionCreateOrUpdateAsAdminParameters()
                {
        ...
        public void DeleteSubscription()
        {
            ...
            var result = client.TenantSubscriptions.Delete("001f675f-daad-4357-993f-2203a22a1935");
