...
namespace Microsoft.Azure.Management.PowerBIEmbedded.Models
{
    ...
    public partial class Display
    {
        ...
        /// <summary>
        /// The localized friendly form of the resource provider name â€“ it
        /// is expected to also include the publisher/company responsible. It
        /// should use Title Casing and begin with â€œMicrosoftâ€ for 1st
        /// party services.
        /// </summary>
        ...
        /// action/operation â€“ it should match the public documentation for
        /// the resource provider. It should use Title Casing â€“ for
        /// examples, please refer to the â€œnameâ€ section.
        /// </summary>
        ...
        /// shown to the user. It should be concise (to fit in drop downs)
        ...
        /// be shown to the user. It should be thorough, yet concise â€“ it
