...
namespace Microsoft.Azure.Management.IotHub.Models
{
    ...
    /// <summary>
    /// The properties related to service bus queue or topic endpoint types.
    /// </summary>
    public partial class RoutingMessagingEndpointProperties
    {
        /// <summary>
        /// Initializes a new instance of the
        /// RoutingMessagingEndpointProperties class.
        /// </summary>
        public RoutingMessagingEndpointProperties() { }

        /// <summary>
        /// Initializes a new instance of the
        /// RoutingMessagingEndpointProperties class.
        /// </summary>
        public RoutingMessagingEndpointProperties(string connectionString, string name, string id = default(string), string subscriptionId = default(string), string resourceGroup = default(string))
        {
        ...
        /// <summary>
        /// The connectionstring of the service bus queue or topic endpoint.
        /// </summary>
        [JsonProperty(PropertyName = "connectionString")]
        public string ConnectionString { get; set; }

        /// <summary>
        /// The name of the service bus queue or topic endpoint. name can only
        /// include alphanumeric characters, periods, underscores, hyphens
        /// with maximum length of 64 characters. The following names are
        ...
        /// <summary>
        /// The subscription identifier of the service bus queue or topic
        /// endpoint.
        /// </summary>
        ...
        /// <summary>
        /// The name of the resource group of the service bus queue or topic
        /// endpoint.
        /// </summary>
