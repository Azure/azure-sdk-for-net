...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public partial interface IPolicyOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<Policy>> GetResourceWithHttpMessagesAsync(string resourceGroupName, string labName, string policySetName, string name, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<Policy>> CreateOrUpdateResourceWithHttpMessagesAsync(string resourceGroupName, string labName, string policySetName, string name, Policy policy, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Delete policy.
        /// </summary>
        /// <param name='resourceGroupName'>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse> DeleteResourceWithHttpMessagesAsync(string resourceGroupName, string labName, string policySetName, string name, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
