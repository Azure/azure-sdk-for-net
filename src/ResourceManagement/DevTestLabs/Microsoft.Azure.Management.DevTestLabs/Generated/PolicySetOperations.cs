...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    /// </summary>
    internal partial class PolicySetOperations : IServiceOperations<DevTestLabsClient>, IPolicySetOperations
    {
        /// <summary>
        /// Initializes a new instance of the PolicySetOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal PolicySetOperations(DevTestLabsClient client)
        {
            if (client == null) 
            {
