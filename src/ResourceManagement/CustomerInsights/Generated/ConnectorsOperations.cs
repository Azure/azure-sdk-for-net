...
namespace Microsoft.Azure.Management.CustomerInsights.Fluent
{
    ...
    internal partial class ConnectorsOperations : IServiceOperations<CustomerInsightsManagementClient>, IConnectorsOperations
    {
        ...
        /// </param>
        public async Task<AzureOperationResponse<ConnectorResourceFormatInner>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string hubName, string connectorName, ConnectorResourceFormatInner parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<ConnectorResourceFormatInner> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, hubName, connectorName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// </return>
        public async Task<AzureOperationResponse<ConnectorResourceFormatInner>> GetWithHttpMessagesAsync(string resourceGroupName, string hubName, string connectorName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ConnectorResourceFormatInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ConnectorResourceFormatInner>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ConnectorResourceFormatInner>>> ListByHubWithHttpMessagesAsync(string resourceGroupName, string hubName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<ConnectorResourceFormatInner>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ConnectorResourceFormatInner>>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ConnectorResourceFormatInner>> BeginCreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string hubName, string connectorName, ConnectorResourceFormatInner parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ConnectorResourceFormatInner>>> ListByHubNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
