...
namespace Microsoft.Azure.Management.CustomerInsights.Fluent.Models
{
    ...
    public partial class AuthorizationPolicyResourceFormatInner : ProxyResource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AuthorizationPolicyResourceFormatInner class.
        /// </summary>
        ...
        /// policy.</param>
        public AuthorizationPolicyResourceFormatInner(IList<PermissionTypes?> permissions, string id = default(string), string name = default(string), string type = default(string), string policyName = default(string), string primaryKey = default(string), string secondaryKey = default(string))
            : base(id, name, type)
        {
