...
namespace Microsoft.Azure.Management.CustomerInsights.Fluent.Models
{
    ...
    /// </summary>
    public partial class ImageDefinitionInner
    {
        /// <summary>
        /// Initializes a new instance of the ImageDefinitionInner class.
        /// </summary>
        ...
        public ImageDefinitionInner(bool? imageExists = default(bool?), string contentUrl = default(string), string relativePath = default(string))
        {
