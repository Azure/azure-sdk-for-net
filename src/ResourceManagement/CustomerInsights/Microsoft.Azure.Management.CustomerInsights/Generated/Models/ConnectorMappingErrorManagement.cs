...
namespace Microsoft.Azure.Management.CustomerInsights.Models
{
    ...
    public partial class ConnectorMappingErrorManagement
    {
        ...
        /// use for the mapping. Possible values include:
        /// 'RejectAndContinue', 'StopImport', 'RejectUntilLimit'</param>
        ...
        /// 'RejectUntilLimit'
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "errorManagementType")]
        public ErrorManagementTypes ErrorManagementType { get; set; }

        /// <summary>
        /// Gets or sets the error limit allowed while importing data.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "errorLimit")]
