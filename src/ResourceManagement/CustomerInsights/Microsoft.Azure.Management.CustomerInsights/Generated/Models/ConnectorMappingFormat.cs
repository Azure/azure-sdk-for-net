...
namespace Microsoft.Azure.Management.CustomerInsights.Models
{
    ...
    public partial class ConnectorMappingFormat
    {
        ...
        /// <param name="quoteEscapeCharacter">Escape character for quotes,
        /// can be the same as the quoteCharacter.</param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "acceptLanguage")]
        public string AcceptLanguage { get; set; }

        /// <summary>
        /// Gets or sets quote character, used to indicate enquoted fields.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "quoteCharacter")]
        ...
        /// quoteCharacter.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "quoteEscapeCharacter")]
        public string QuoteEscapeCharacter { get; set; }

        /// <summary>
        /// Gets or sets character separating array elements.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "arraySeparator")]
