...
namespace Microsoft.Azure.Management.CustomerInsights.Models
{
    ...
    public partial class ConnectorMappingResourceFormat : ProxyResource
    {
        ...
        /// map to. Possible values include: 'None', 'Profile',
        /// 'Interaction', 'Relationship'</param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.connectorMappingName")]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.dataFormatId")]
        public string DataFormatId { get; private set; }

        /// <summary>
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.mappingProperties")]
        public ConnectorMappingProperties MappingProperties { get; set; }

        /// <summary>
        /// Gets the next run time based on customer's settings.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.nextRunTime")]
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "MappingProperties");
            }
            if (this.MappingProperties != null)
            {
                this.MappingProperties.Validate();
            }
        }
    }
}
