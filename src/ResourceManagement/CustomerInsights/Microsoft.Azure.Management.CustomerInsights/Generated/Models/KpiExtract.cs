...
namespace Microsoft.Azure.Management.CustomerInsights.Models
{
    ...
    public partial class KpiExtract
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "extractName")]
        ...
        public virtual void Validate()
        {
            if (ExtractName == null)
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "ExtractName");
            }
            if (Expression == null)
            {
