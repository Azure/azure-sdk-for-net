...
namespace Microsoft.Azure.Management.CustomerInsights.Models
{
    ...
    public partial class KpiThresholds
    {
        ...
        /// <param name="increasingKpi">Whether or not the KPI is an
        /// increasing KPI.</param>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "lowerLimit")]
        public decimal LowerLimit { get; set; }

        /// <summary>
        /// Gets or sets the upper threshold limit.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "upperLimit")]
        public decimal UpperLimit { get; set; }

        /// <summary>
        /// Gets or sets whether or not the KPI is an increasing KPI.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "increasingKpi")]
