...
namespace Microsoft.Azure.Management.CustomerInsights.Fluent
{
    ...
    public static partial class ViewsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<IPage<ViewResourceFormatInner>> ListByHubAsync(this IViewsOperations operations, string resourceGroupName, string hubName, string userId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ViewResourceFormatInner> CreateOrUpdateAsync(this IViewsOperations operations, string resourceGroupName, string hubName, string viewName, ViewResourceFormatInner parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ViewResourceFormatInner> GetAsync(this IViewsOperations operations, string resourceGroupName, string hubName, string viewName, string userId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<ViewResourceFormatInner>> ListByHubNextAsync(this IViewsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
