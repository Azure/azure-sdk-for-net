...
namespace Microsoft.Azure.Management.CustomerInsights.Fluent.Models
{
    ...
    public partial class RelationshipResourceFormatInner : ProxyResource
    {
        /// <summary>
        /// Initializes a new instance of the RelationshipResourceFormatInner
        /// class.
        /// </summary>
        ...
        public RelationshipResourceFormatInner(string profileType, string relatedProfileType, string id = default(string), string name = default(string), string type = default(string), CardinalityTypes? cardinality = default(CardinalityTypes?), IDictionary<string, string> displayName = default(IDictionary<string, string>), IDictionary<string, string> description = default(IDictionary<string, string>), System.DateTime? expiryDateTimeUtc = default(System.DateTime?), IList<PropertyDefinition> fields = default(IList<PropertyDefinition>), IList<RelationshipTypeMapping> lookupMappings = default(IList<RelationshipTypeMapping>), string provisioningState = default(string), string relationshipName = default(string), string relationshipGuidId = default(string), string tenantId = default(string))
            : base(id, name, type)
        {
