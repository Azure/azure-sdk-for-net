...
namespace Microsoft.Azure.Management.AppService.Fluent
{
    ...
    internal partial class AppServiceCertificateOrdersImpl 
    {
        ...
        async Task<IAppServiceCertificateOrder> ISupportsGettingByResourceGroup<IAppServiceCertificateOrder>.GetByResourceGroupAsync(string resourceGroupName, string name, CancellationToken cancellationToken)
        {
            return await this.GetByResourceGroupAsync(resourceGroupName, name, cancellationToken) as IAppServiceCertificateOrder;
        }
