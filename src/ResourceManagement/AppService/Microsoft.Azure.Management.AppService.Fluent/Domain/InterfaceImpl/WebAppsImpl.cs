...
namespace Microsoft.Azure.Management.AppService.Fluent
{
    ...
    internal partial class WebAppsImpl 
    {
        ...
        /// <param name="resourceGroupName">The name of the resource group to list the resources from.</param>
         IEnumerable<Microsoft.Azure.Management.AppService.Fluent.IWebApp> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsListingByGroup<Microsoft.Azure.Management.AppService.Fluent.IWebApp>.ListByGroup(string resourceGroupName)
        {
