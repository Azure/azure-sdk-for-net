...
namespace Microsoft.Azure.Management.Appservice.Fluent
{
    ...
    internal partial class AppServiceCertificatesImpl 
    {
        ...
        AppServiceCertificate.Definition.IBlank Microsoft.Azure.Management.Resource.Fluent.Core.CollectionActions.ISupportsCreating<AppServiceCertificate.Definition.IBlank>.Define(string name)
        {
        ...
        Microsoft.Azure.Management.Resource.Fluent.Core.PagedList<Microsoft.Azure.Management.Appservice.Fluent.IAppServiceCertificate> Microsoft.Azure.Management.Resource.Fluent.Core.CollectionActions.ISupportsListingByGroup<Microsoft.Azure.Management.Appservice.Fluent.IAppServiceCertificate>.ListByGroup(string resourceGroupName)
        {
            return this.ListByGroup(resourceGroupName) as Microsoft.Azure.Management.Resource.Fluent.Core.PagedList<Microsoft.Azure.Management.Appservice.Fluent.IAppServiceCertificate>;
        }
        ...
        async Task<Microsoft.Azure.Management.Appservice.Fluent.IAppServiceCertificate> Microsoft.Azure.Management.Resource.Fluent.Core.CollectionActions.ISupportsGettingByGroup<Microsoft.Azure.Management.Appservice.Fluent.IAppServiceCertificate>.GetByGroupAsync(string resourceGroupName, string name, CancellationToken cancellationToken)
        {
            return await this.GetByGroupAsync(resourceGroupName, name, cancellationToken) as Microsoft.Azure.Management.Appservice.Fluent.IAppServiceCertificate;
        }
