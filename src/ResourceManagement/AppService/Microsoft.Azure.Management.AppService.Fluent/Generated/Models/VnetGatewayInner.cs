...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class VnetGatewayInner : Rest.Azure.Resource
    {
        ...
        /// downloaded.</param>
        public VnetGatewayInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string vnetName = default(string), string vpnPackageUri = default(string))
