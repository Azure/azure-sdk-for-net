...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class ResourceMetric
    {
        ...
        public ResourceMetric(ResourceMetricName name = default(ResourceMetricName), string unit = default(string), string timeGrain = default(string), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), string resourceId = default(string), string id = default(string), System.Collections.Generic.IList<ResourceMetricValue> metricValues = default(System.Collections.Generic.IList<ResourceMetricValue>), System.Collections.Generic.IList<ResourceMetricProperty> properties = default(System.Collections.Generic.IList<ResourceMetricProperty>))
        {
            Name = name;
            Unit = unit;
            TimeGrain = timeGrain;
        ...
        public System.Collections.Generic.IList<ResourceMetricValue> MetricValues { get; private set; }
