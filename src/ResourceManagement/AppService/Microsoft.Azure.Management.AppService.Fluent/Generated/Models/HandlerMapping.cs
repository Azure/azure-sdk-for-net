...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    /// For example, it is used to configure php-cgi.exe process to handle
    /// all HTTP requests with *.php extension.
    /// </summary>
    public partial class HandlerMapping
    {
        ...
        /// <summary>
        /// Gets or sets requests with this extension will be handled using
