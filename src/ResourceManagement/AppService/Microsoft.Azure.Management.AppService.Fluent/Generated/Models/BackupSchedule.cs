...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class BackupSchedule
    {
        ...
        /// <param name="frequencyUnit">How often should be the backup
        ...
        /// weekly backup, this should be set to 7 and FrequencyUnit should
        /// be set to Day)
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "frequencyUnit")]
        public FrequencyUnit FrequencyUnit { get; set; }

        /// <summary>
        /// Gets or sets true if the retention policy should always keep at
        /// least one backup in the storage account, regardless how old it
        /// is; false otherwise.
        /// </summary>
