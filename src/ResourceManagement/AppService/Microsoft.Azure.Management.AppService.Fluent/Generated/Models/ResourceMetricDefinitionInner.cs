...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class ResourceMetricDefinitionInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        ...
        public ResourceMetricDefinitionInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), ResourceMetricName resourceMetricDefinitionName = default(ResourceMetricName), string unit = default(string), string primaryAggregationType = default(string), IList<ResourceMetricAvailability> metricAvailabilities = default(IList<ResourceMetricAvailability>), string resourceUri = default(string), string resourceMetricDefinitionId = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>))
