...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class UsageInner : Rest.Azure.Resource
    {
        /// <summary>
        ...
        public UsageInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string displayName = default(string), string usageName = default(string), string resourceName = default(string), string unit = default(string), long? currentValue = default(long?), long? limit = default(long?), System.DateTime? nextResetTime = default(System.DateTime?), ComputeModeOptions? computeMode = default(ComputeModeOptions?), string siteMode = default(string))
