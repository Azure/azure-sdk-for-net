...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LmFwcHNlcnZpY2UuaW1wbGVtZW50YXRpb24uRGVwbG95bWVudFNsb3RzSW1wbA==
        ...
        IDeploymentSlots
    {
        ...
        internal  DeploymentSlotsImpl(WebAppImpl parent, WebAppsInner innerCollection, AppServiceManager manager, WebSiteManagementClientImpl serviceClient)
        {
        ...
        public PagedList<Microsoft.Azure.Management.AppService.Fluent.IDeploymentSlot> ListByParent(string resourceGroupName, string parentName)
        {
        ...
        public IDeploymentSlot GetByParent(string resourceGroup, string parentName, string name)
        {
