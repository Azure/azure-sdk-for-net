...
namespace Microsoft.Azure.Management.AppService.Fluent
{
        ...
        WebAppBase.Update.IWithSourceControl<IDeploymentSlot>
    {
        ...
        {
            return await client.CreateOrUpdateSourceControlSlotAsync(ResourceGroupName, parent.Name, inner, Name());
        }
        ...
        {
            return await client.ListApplicationSettingsSlotAsync(ResourceGroupName, parent.Name, Name());
        }
        ...
        {
            return await client.ListSlotConfigurationNamesAsync(ResourceGroupName, parent.Name);
        }
        ...
        {
            await client.DeleteSourceControlSlotAsync(ResourceGroupName, parent.Name, Name());
        }
        ...
        public override async Task VerifyDomainOwnershipAsync(string certificateOrderName, string domainVerificationToken, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await client.CreateOrUpdateDomainOwnershipIdentifierSlotAsync(ResourceGroupName, parent.Name, Name(), identifierInner, certificateOrderName);
        }
        ...
        {
            return await client.CreateOrUpdateConfigurationSlotAsync(ResourceGroupName, parent.Name, siteConfig, Name());
        }
        ...
        {
            return await client.UpdateSlotConfigurationNamesAsync(ResourceGroupName, parent.Name, inner);
        }
        ...
        {
            client.ApplySlotConfigurationSlot(ResourceGroupName, parent.Name, new CsmSlotEntityInner()
            {
                TargetSlot = slotName
            }, Name());
            Refresh();
        ...
        {
            return await client.ListConnectionStringsSlotAsync(ResourceGroupName, parent.Name, Name());
        }
        ...
        {
            return await client.GetConfigurationSlotAsync(ResourceGroupName, parent.Name, Name());
        }
        ...
        {
            client.SwapSlotSlot(ResourceGroupName, parent.Name, new CsmSlotEntityInner()
            {
                TargetSlot = slotName
            }, Name());
        ...
        {
            await client.DeleteHostNameBindingSlotAsync(ResourceGroupName, parent.Name, Name(), hostname);
        }
    }
}