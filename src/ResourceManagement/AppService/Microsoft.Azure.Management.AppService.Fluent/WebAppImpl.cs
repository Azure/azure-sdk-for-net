...
namespace Microsoft.Azure.Management.AppService.Fluent
{
        ...
        WebApp.Update.IWithNewAppServicePlan
    {
        ...
        internal WebAppImpl(string name, SiteInner innerObject, SiteConfigInner configObject, IWebAppsOperations client, IAppServiceManager manager, WebSiteManagementClient serviceClient)
