...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class StorageMigrationOptionsInner : ProxyOnlyResource
    {
        /// <summary>
        ...
        /// &lt;code&gt;false&lt;/code&gt;.</param>
        public StorageMigrationOptionsInner(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), string azurefilesConnectionString = default(string), string azurefilesShare = default(string), bool? switchSiteAfterMigration = default(bool?), bool? blockWriteAccessToSite = default(bool?))
