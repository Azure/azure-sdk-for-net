...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class StorageMigrationOptionsInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        ...
        /// &lt;code&gt;false&lt;/code&gt;.</param>
        public StorageMigrationOptionsInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string azurefilesConnectionString = default(string), string azurefilesShare = default(string), bool? switchSiteAfterMigration = default(bool?), bool? blockWriteAccessToSite = default(bool?))
