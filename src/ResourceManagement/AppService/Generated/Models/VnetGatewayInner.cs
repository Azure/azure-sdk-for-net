...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class VnetGatewayInner : ProxyOnlyResource
    {
        ...
        /// downloaded.</param>
        public VnetGatewayInner(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), string vnetName = default(string), string vpnPackageUri = default(string))
