...
namespace Microsoft.Azure.Management.AppService.Fluent.Models
{
    ...
    public partial class SiteConfigurationSnapshotInfoInner : ProxyOnlyResource
    {
        /// <summary>
        ...
        /// snapshot</param>
        public SiteConfigurationSnapshotInfoInner(string id = default(string), string name = default(string), string kind = default(string), string type = default(string), System.DateTime? time = default(System.DateTime?), int? siteConfigurationSnapshotInfoId = default(int?))
