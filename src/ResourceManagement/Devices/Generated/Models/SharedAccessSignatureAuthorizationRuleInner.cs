...
namespace Microsoft.Azure.Management.Devices.Fluent.Models
{
    ...
    /// </summary>
    public partial class SharedAccessSignatureAuthorizationRuleInner
    {
        /// <summary>
        ...
        public SharedAccessSignatureAuthorizationRuleInner(string keyName, AccessRights rights, string primaryKey = default(string), string secondaryKey = default(string))
        {
            KeyName = keyName;
