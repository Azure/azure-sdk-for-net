...
namespace Microsoft.Azure.Management.Devices.Fluent.Models
{
    ...
    /// </summary>
    public partial class JobResponseInner
    {
        /// <summary>
        /// Initializes a new instance of the JobResponseInner class.
        /// </summary>
        ...
        /// any.</param>
        public JobResponseInner(string jobId = default(string), System.DateTime? startTimeUtc = default(System.DateTime?), System.DateTime? endTimeUtc = default(System.DateTime?), string type = default(string), JobStatus? status = default(JobStatus?), string failureReason = default(string), string statusMessage = default(string), string parentJobId = default(string))
        {
            JobId = jobId;
