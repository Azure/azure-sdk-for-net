...
namespace Microsoft.Azure.Management.ServiceBus.Fluent
{
    ...
    internal partial class TopicsImpl 
    {
        ...
        Microsoft.Azure.Management.ServiceBus.Fluent.Topic.Definition.IBlank Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsCreating<Microsoft.Azure.Management.ServiceBus.Fluent.Topic.Definition.IBlank>.Define(string name)
        {
            return this.Define(name) as Microsoft.Azure.Management.ServiceBus.Fluent.Topic.Definition.IBlank;
        }
