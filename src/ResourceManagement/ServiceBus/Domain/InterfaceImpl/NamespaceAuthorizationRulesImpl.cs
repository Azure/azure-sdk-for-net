...
namespace Microsoft.Azure.Management.ServiceBus.Fluent
{
    ...
    internal partial class NamespaceAuthorizationRulesImpl 
    {
        ...
        Microsoft.Azure.Management.ServiceBus.Fluent.NamespaceAuthorizationRule.Definition.IBlank Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsCreating<Microsoft.Azure.Management.ServiceBus.Fluent.NamespaceAuthorizationRule.Definition.IBlank>.Define(string name)
        {
            return this.Define(name) as Microsoft.Azure.Management.ServiceBus.Fluent.NamespaceAuthorizationRule.Definition.IBlank;
        }
