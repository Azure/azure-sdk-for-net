...
namespace Microsoft.Azure.Management.Servicebus.Fluent
{
    ...
    internal partial class QueueAuthorizationRulesImpl 
    {
        ...
        QueueAuthorizationRule.Definition.IBlank ResourceManager.Fluent.Core.CollectionActions.ISupportsCreating<QueueAuthorizationRule.Definition.IBlank>.Define(string name)
        {
