...
namespace Microsoft.Azure.Management.Servicebus.Fluent
{
    ...
    internal partial class QueueAuthorizationRulesImpl 
    {
        ...
        QueueAuthorizationRule.Definition.IBlank Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsCreating<QueueAuthorizationRule.Definition.IBlank>.Define(string name)
        {
            return this.Define(name) as QueueAuthorizationRule.Definition.IBlank;
        }
