...
namespace Microsoft.Azure.Management.Servicebus.Fluent
{
    ...
    internal partial class ServiceBusNamespacesImpl 
    {
        ...
        ServiceBusNamespace.Definition.IBlank ResourceManager.Fluent.Core.CollectionActions.ISupportsCreating<ServiceBusNamespace.Definition.IBlank>.Define(string name)
        {
