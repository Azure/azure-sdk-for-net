...
namespace Microsoft.Azure.Management.Servicebus.Fluent
{
    ...
    internal partial class NamespaceAuthorizationRulesImpl 
    {
        ...
        NamespaceAuthorizationRule.Definition.IBlank Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsCreating<NamespaceAuthorizationRule.Definition.IBlank>.Define(string name)
        {
            return this.Define(name) as NamespaceAuthorizationRule.Definition.IBlank;
        }
