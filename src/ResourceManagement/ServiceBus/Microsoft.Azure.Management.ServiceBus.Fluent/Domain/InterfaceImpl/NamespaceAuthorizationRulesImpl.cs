...
namespace Microsoft.Azure.Management.Servicebus.Fluent
{
    ...
    internal partial class NamespaceAuthorizationRulesImpl 
    {
        ...
        NamespaceAuthorizationRule.Definition.IBlank ResourceManager.Fluent.Core.CollectionActions.ISupportsCreating<NamespaceAuthorizationRule.Definition.IBlank>.Define(string name)
        {
