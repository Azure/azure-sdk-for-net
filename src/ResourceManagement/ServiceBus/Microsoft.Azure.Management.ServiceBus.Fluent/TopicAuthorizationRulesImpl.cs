...
namespace Microsoft.Azure.Management.Servicebus.Fluent
{
            ...
            ITopicAuthorizationRules
    {
        ...
        public override Task<PagedList<Microsoft.Azure.Management.Servicebus.Fluent.ITopicAuthorizationRule>> ListByParentAsync(string resourceGroupName, string parentName, CancellationToken cancellationToken = default(CancellationToken))
        {
