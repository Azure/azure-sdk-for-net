...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnNlcnZpY2VidXMuaW1wbGVtZW50YXRpb24uUXVldWVBdXRob3JpemF0aW9uUnVsZXNJbXBs
        ...
        IQueueAuthorizationRules
    {
        ...
        public PagedList<Microsoft.Azure.Management.Servicebus.Fluent.IQueueAuthorizationRule> ListByParent(string resourceGroupName, string parentName)
        {
        ...
        internal  QueueAuthorizationRulesImpl(string resourceGroupName, string namespaceName, string queueName, Region region, ServiceBusManager manager)
        {
            //$ {
