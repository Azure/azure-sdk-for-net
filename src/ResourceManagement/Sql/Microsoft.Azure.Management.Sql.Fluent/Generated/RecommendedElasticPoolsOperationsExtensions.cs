...
namespace Microsoft.Azure.Management.Sql.Fluent
{
   ...
   using Models;
    ...
    public static partial class RecommendedElasticPoolsOperationsExtensions
    {
            ...
            /// </param>
            public static async System.Threading.Tasks.Task<RecommendedElasticPoolInner> GetAsync(this IRecommendedElasticPoolsOperations operations, string resourceGroupName, string serverName, string recommendedElasticPoolName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task<DatabaseInner> GetDatabasesAsync(this IRecommendedElasticPoolsOperations operations, string resourceGroupName, string serverName, string recommendedElasticPoolName, string databaseName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
            ...
            /// The name of the Azure SQL server.
            /// </param>
            public static System.Collections.Generic.IEnumerable<RecommendedElasticPoolInner> List(this IRecommendedElasticPoolsOperations operations, string resourceGroupName, string serverName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<System.Collections.Generic.IEnumerable<RecommendedElasticPoolInner>> ListAsync(this IRecommendedElasticPoolsOperations operations, string resourceGroupName, string serverName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
            ...
            /// The name of the Azure SQL Recommended Elastic Pool to be retrieved.
            /// </param>
            public static System.Collections.Generic.IEnumerable<DatabaseInner> ListDatabases(this IRecommendedElasticPoolsOperations operations, string resourceGroupName, string serverName, string recommendedElasticPoolName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<System.Collections.Generic.IEnumerable<DatabaseInner>> ListDatabasesAsync(this IRecommendedElasticPoolsOperations operations, string resourceGroupName, string serverName, string recommendedElasticPoolName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
