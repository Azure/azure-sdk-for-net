...
namespace Microsoft.Azure.Management.Sql.Fluent.Models
{
    ...
    public partial class RecommendedElasticPoolInner : Microsoft.Azure.Management.Resource.Fluent.Resource
    {
        ...
        public RecommendedElasticPoolInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string databaseEdition = default(string), double? dtu = default(double?), double? databaseDtuMin = default(double?), double? databaseDtuMax = default(double?), double? storageMB = default(double?), System.DateTime? observationPeriodStart = default(System.DateTime?), System.DateTime? observationPeriodEnd = default(System.DateTime?), double? maxObservedDtu = default(double?), double? maxObservedStorageMB = default(double?), System.Collections.Generic.IList<DatabaseInner> databases = default(System.Collections.Generic.IList<DatabaseInner>), System.Collections.Generic.IList<RecommendedElasticPoolMetric> metrics = default(System.Collections.Generic.IList<RecommendedElasticPoolMetric>))
        ...
        public System.Collections.Generic.IList<DatabaseInner> Databases { get; private set; }
