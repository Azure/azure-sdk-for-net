...
namespace Microsoft.Azure.Management.Sql.Fluent.Models
{
    ...
    public partial class DatabaseInner : Microsoft.Azure.Management.Resource.Fluent.Resource
    {
        ...
        /// database.</param>
        public DatabaseInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string collation = default(string), System.DateTime? creationDate = default(System.DateTime?), long? containmentState = default(long?), System.Guid? currentServiceObjectiveId = default(System.Guid?), string databaseId = default(string), System.DateTime? earliestRestoreDate = default(System.DateTime?), string createMode = default(string), string sourceDatabaseId = default(string), string edition = default(string), string maxSizeBytes = default(string), System.Guid? requestedServiceObjectiveId = default(System.Guid?), string requestedServiceObjectiveName = default(string), string serviceLevelObjective = default(string), string status = default(string), string elasticPoolName = default(string), string defaultSecondaryLocation = default(string), System.Collections.Generic.IList<ServiceTierAdvisorInner> serviceTierAdvisors = default(System.Collections.Generic.IList<ServiceTierAdvisorInner>), UpgradeHintInner upgradeHint = default(UpgradeHintInner), System.Collections.Generic.IList<SchemaInner> schemas = default(System.Collections.Generic.IList<SchemaInner>), System.Collections.Generic.IList<TransparentDataEncryptionInner> transparentDataEncryption = default(System.Collections.Generic.IList<TransparentDataEncryptionInner>), System.Collections.Generic.IList<RecommendedIndexInner> recommendedIndex = default(System.Collections.Generic.IList<RecommendedIndexInner>))
        ...
        public System.Collections.Generic.IList<ServiceTierAdvisorInner> ServiceTierAdvisors { get; private set; }

        /// <summary>
        /// Gets the upgrade hint for this database.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.upgradeHint")]
        public UpgradeHintInner UpgradeHint { get; private set; }

        /// <summary>
        /// Gets the schemas from this database.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.schemas")]
        public System.Collections.Generic.IList<SchemaInner> Schemas { get; private set; }
        ...
        public System.Collections.Generic.IList<TransparentDataEncryptionInner> TransparentDataEncryption { get; private set; }

        /// <summary>
        /// Gets the recommended indices for this database.
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.recommendedIndex")]
        public System.Collections.Generic.IList<RecommendedIndexInner> RecommendedIndex { get; private set; }
