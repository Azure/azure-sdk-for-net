...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public static partial class DataMaskingOperationsExtensions
    {
        ...
        /// </returns>
        public static DataMaskingRuleGetResponse GetRule(this IDataMaskingOperations operations, string resourceGroupName, string serverName, string databaseName, string dataMaskingRule)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IDataMaskingOperations)s).GetRuleAsync(resourceGroupName, serverName, databaseName, dataMaskingRule);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// Represents the response to a data masking rule get request.
        /// </returns>
        public static Task<DataMaskingRuleGetResponse> GetRuleAsync(this IDataMaskingOperations operations, string resourceGroupName, string serverName, string databaseName, string dataMaskingRule)
        {
            return operations.GetRuleAsync(resourceGroupName, serverName, databaseName, dataMaskingRule, CancellationToken.None);
        }
