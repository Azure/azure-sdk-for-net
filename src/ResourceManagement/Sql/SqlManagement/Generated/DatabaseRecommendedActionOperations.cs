...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// update its state.
    /// </summary>
    internal partial class DatabaseRecommendedActionOperations : IServiceOperations<SqlManagementClient>, IDatabaseRecommendedActionOperations
    {
        /// <summary>
        ...
        /// </param>
        internal DatabaseRecommendedActionOperations(SqlManagementClient client)
        {
            this._client = client;
        }
        ...
        /// </returns>
        public async Task<RecommendedActionGetResponse> GetAsync(string resourceGroupName, string serverName, string databaseName, string advisorName, string recommendedActionName, CancellationToken cancellationToken)
        {
            // Validate
        ...
        /// </returns>
        public async Task<RecommendedActionListResponse> ListAsync(string resourceGroupName, string serverName, string databaseName, string advisorName, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        /// </returns>
        public async Task<RecommendedActionUpdateResponse> UpdateAsync(string resourceGroupName, string serverName, string databaseName, string advisorName, string recommendedActionName, RecommendedActionUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
