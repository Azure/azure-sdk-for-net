...
namespace Microsoft.Azure.Management.Sql.Fluent.Models
{
    ...
    public partial class ServerFirewallRuleInner : SqlSubResource
    {
        /// <summary>
        /// Initializes a new instance of the ServerFirewallRuleInner class.
        /// </summary>
        public ServerFirewallRuleInner()
        {
          CustomInit();
        }
        ...
        /// server firewall rule. Must be IPv4 format.</param>
        public ServerFirewallRuleInner(string name = default(string), string id = default(string), string kind = default(string), string location = default(string), string startIpAddress = default(string), string endIpAddress = default(string))
            : base(name, id)
        {
            Kind = kind;
            Location = location;
