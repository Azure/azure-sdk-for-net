...
namespace ApiManagement.Tests
{
    ...
    public class ApiManagementUndoHandler : ComplexTypedOperationUndoHandler<IApiManagementOperations, ApiManagementClient>
    {
        /// <summary>
                ...
                !string.IsNullOrWhiteSpace(name))
            {
                undoAction = () =>
                {
                    using (var apiManagementClient = GetClientFromOperations(client))
                    {
                        ...
                        apiManagementClient.ApiManagement.Delete(resourceGroupName, name);
                    }
                };
