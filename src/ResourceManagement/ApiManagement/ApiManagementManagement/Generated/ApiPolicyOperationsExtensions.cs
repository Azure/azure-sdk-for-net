...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class ApiPolicyOperationsExtensions
    {
        ...
        /// request ID.
        /// </returns>
        public static AzureOperationResponse Delete(this IApiPolicyOperations operations, string resourceGroupName, string serviceName, string aid, string etag)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IApiPolicyOperations)s).DeleteAsync(resourceGroupName, serviceName, aid, etag);
            }
        ...
        /// </returns>
        public static PolicyGetResponse Get(this IApiPolicyOperations operations, string resourceGroupName, string serviceName, string aid, string format)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IApiPolicyOperations)s).GetAsync(resourceGroupName, serviceName, aid, format);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
