...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public partial interface IApiPolicyOperations
    {
        ...
        /// </returns>
        Task<PolicyGetResponse> GetAsync(string resourceGroupName, string serviceName, string aid, string format, CancellationToken cancellationToken);
        ...
        /// request ID.
        /// </returns>
        Task<AzureOperationResponse> SetAsync(string resourceGroupName, string serviceName, string aid, string format, Stream policyStream, string etag, CancellationToken cancellationToken);
    }
}
