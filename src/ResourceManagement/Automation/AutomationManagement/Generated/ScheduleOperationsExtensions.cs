...
namespace Microsoft.Azure.Management.Automation
{
    public static partial class ScheduleOperationsExtensions
    {
        ...
        /// The response model for the create or update schedule operation.
        /// </returns>
        public static ScheduleCreateOrUpdateResponse CreateOrUpdateWithTimeConversion(this IScheduleOperations operations, string resourceGroupName, string automationAccount, ScheduleCreateOrUpdateParameters parameters)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IScheduleOperations)s).CreateOrUpdateWithTimeConversionAsync(resourceGroupName, automationAccount, parameters);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// The response model for the create or update schedule operation.
        /// </returns>
        public static Task<ScheduleCreateOrUpdateResponse> CreateOrUpdateWithTimeConversionAsync(this IScheduleOperations operations, string resourceGroupName, string automationAccount, ScheduleCreateOrUpdateParameters parameters)
        {
            return operations.CreateOrUpdateWithTimeConversionAsync(resourceGroupName, automationAccount, parameters, CancellationToken.None);
        }
