...
namespace Microsoft.Azure.Management.Automation
{
    ...
    /// information)
    /// </summary>
    public partial interface IObjectDataTypeOperations
    {
        /// <summary>
        ...
        /// </returns>
        Task<TypeFieldListResponse> ListFieldsByModuleAndTypeAsync(string resourceGroupName, string automationAccount, string moduleName, string typeName, CancellationToken cancellationToken);
