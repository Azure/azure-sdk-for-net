...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public partial interface IScheduleOperations
    {
        ...
        /// The response model for the create or update schedule operation.
        /// </returns>
        Task<ScheduleCreateOrUpdateResponse> CreateOrUpdateAndConvertTimesAsync(string resourceGroupName, string automationAccount, ScheduleCreateOrUpdateParameters parameters, CancellationToken cancellationToken);
