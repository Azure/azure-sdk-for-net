...
namespace Microsoft.Azure.Management.Automation
{
    ...
    internal partial class ScheduleOperations : IServiceOperations<AutomationManagementClient>, IScheduleOperations
    {
        ...
        /// The response model for the create or update schedule operation.
        /// </returns>
        public async Task<ScheduleCreateOrUpdateResponse> CreateOrUpdateWithTimeConversionAsync(string resourceGroupName, string automationAccount, ScheduleCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("automationAccount", automationAccount);
                tracingParameters.Add("parameters", parameters);
                TracingAdapter.Enter(invocationId, this, "CreateOrUpdateWithTimeConversionAsync", tracingParameters);
            }
            ...
            url = url + Uri.EscapeDataString(parameters.Name);
            List<string> queryParameters = new List<string>();
            queryParameters.Add("convertTimesFromTimeZone=true");
            queryParameters.Add("api-version=2015-10-31");
            if (queryParameters.Count > 0)
            {
                url = url + "?" + string.Join("&", queryParameters);
