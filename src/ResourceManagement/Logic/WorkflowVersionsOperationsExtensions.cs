...
namespace Microsoft.Azure.Management.Logic.Fluent
{
    ...
    public static partial class WorkflowVersionsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<WorkflowVersionInner> List(this IWorkflowVersionsOperations operations, string resourceGroupName, string workflowName, int? top = default(int?))
            {
            ...
            /// </param>
            public static WorkflowVersionInner Get(this IWorkflowVersionsOperations operations, string resourceGroupName, string workflowName, string versionId)
            {
            ...
            /// </param>
            public static WorkflowTriggerCallbackUrlInner ListCallbackUrl(this IWorkflowVersionsOperations operations, string resourceGroupName, string workflowName, string versionId, string triggerName, GetCallbackUrlParametersInner parameters = default(GetCallbackUrlParametersInner))
            {
            ...
            /// </param>
            public static IPage<WorkflowVersionInner> ListNext(this IWorkflowVersionsOperations operations, string nextPageLink)
            {
