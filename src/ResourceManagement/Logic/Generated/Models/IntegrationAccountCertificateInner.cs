...
namespace Microsoft.Azure.Management.Logic.Fluent.Models
{
    ...
    public partial class IntegrationAccountCertificateInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        /// <summary>
        ...
        public IntegrationAccountCertificateInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), System.DateTime? createdTime = default(System.DateTime?), System.DateTime? changedTime = default(System.DateTime?), object metadata = default(object), KeyVaultKeyReference key = default(KeyVaultKeyReference), string publicCertificate = default(string))
