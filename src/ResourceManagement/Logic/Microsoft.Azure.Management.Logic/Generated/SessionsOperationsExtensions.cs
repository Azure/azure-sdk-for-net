...
namespace Microsoft.Azure.Management.Logic
{
    ...
    public static partial class SessionsOperationsExtensions
    {
            ...
            {
                return Task.Factory.StartNew(s => ((ISessionsOperations)s).ListByIntegrationAccountsAsync(resourceGroupName, integrationAccountName, odataQuery), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                return Task.Factory.StartNew(s => ((ISessionsOperations)s).GetAsync(resourceGroupName, integrationAccountName, sessionName), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                return Task.Factory.StartNew(s => ((ISessionsOperations)s).CreateOrUpdateAsync(resourceGroupName, integrationAccountName, sessionName, session), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                Task.Factory.StartNew(s => ((ISessionsOperations)s).DeleteAsync(resourceGroupName, integrationAccountName, sessionName), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                return Task.Factory.StartNew(s => ((ISessionsOperations)s).ListByIntegrationAccountsNextAsync(nextPageLink), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
