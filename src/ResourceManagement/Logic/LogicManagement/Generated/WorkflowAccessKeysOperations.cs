...
namespace Microsoft.Azure.Management.Logic
{
    ...
    internal partial class WorkflowAccessKeysOperations : IServiceOperations<LogicManagementClient>, IWorkflowAccessKeysOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<WorkflowAccessKey>>> ListWithHttpMessagesAsync(string resourceGroupName, string workflowName, int? top = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var result = new AzureOperationResponse<Page<WorkflowAccessKey>>();
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<WorkflowAccessKey>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
