...
namespace Microsoft.Azure.Management.Logic.Models
{
    ...
    public partial class WorkflowAccessKey : SubResource
    {
        ...
        /// Initializes a new instance of the WorkflowAccessKey class.
        /// </summary>
        public WorkflowAccessKey(string id = default(string), string name = default(string), string type = default(string), DateTime? notBefore = default(DateTime?), DateTime? notAfter = default(DateTime?))
            : base(id)
        {
            Name = name;
            Type = type;
