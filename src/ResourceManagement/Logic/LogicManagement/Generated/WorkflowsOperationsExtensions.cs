...
namespace Microsoft.Azure.Management.Logic
{
    ...
    public static partial class WorkflowsOperationsExtensions
    {
            ...
            {
                using (var _result = await operations.RunWithHttpMessagesAsync(resourceGroupName, workflowName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            {
                using (var _result = await operations.BeginRunWithHttpMessagesAsync(resourceGroupName, workflowName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
