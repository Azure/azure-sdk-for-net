...
namespace Microsoft.Azure.Graph.RBAC
{
    ...
    public static partial class UserOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<User> List(this IUserOperations operations, ODataQuery<User> odataQuery = default(ODataQuery<User>))
            {
                return Task.Factory.StartNew(s => ((IUserOperations)s).ListAsync(odataQuery), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
