...
namespace Microsoft.Azure.Graph.RBAC
{
    ...
    internal partial class UserOperations : IServiceOperations<GraphRbacManagementClient>, IUserOperations
    {
        ...
        public async Task<AzureOperationResponse> DeleteWithHttpMessagesAsync(string user, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{tenantID}/users/{user}").ToString();
        ...
        public async Task<AzureOperationResponse<IPage<string>>> GetMemberGroupsNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("nextPageLink", nextPageLink);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetMemberGroupsNext", tracingParameters);
            }
            // Construct URL
            string _url = "{nextLink}";
            _url = _url.Replace("{nextLink}", nextPageLink);
