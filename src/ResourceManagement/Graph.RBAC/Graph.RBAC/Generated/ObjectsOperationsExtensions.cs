...
namespace Microsoft.Azure.Graph.RBAC
{
    ...
    public static partial class ObjectsOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<IPage<AADObject>> result = await operations.GetObjectsByObjectIdsWithHttpMessagesAsync(parameters, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<IPage<AADObject>> result = await operations.GetObjectsByObjectIdsNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
