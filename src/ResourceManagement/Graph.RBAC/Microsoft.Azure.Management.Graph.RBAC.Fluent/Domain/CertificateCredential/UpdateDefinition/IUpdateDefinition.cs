...
namespace Microsoft.Azure.Management.Graph.RBAC.Fluent.CertificateCredential.UpdateDefinition
{
    ...
    public interface IWithDuration<ParentT> 
    {
        ...
        /// <return>The next stage in credential definition.</return>
        Microsoft.Azure.Management.Graph.RBAC.Fluent.CertificateCredential.UpdateDefinition.IWithAttach<ParentT> WithDuration(DateTimeOffset duration);
    }
    ...
    public interface IWithAuthFile<ParentT> 
    {
        ...
        /// <return>The next stage in credential definition.</return>
        Microsoft.Azure.Management.Graph.RBAC.Fluent.CertificateCredential.UpdateDefinition.IWithAuthFileCertificate<ParentT> WithAuthFileToExport(FileStream outputStream);
    }
