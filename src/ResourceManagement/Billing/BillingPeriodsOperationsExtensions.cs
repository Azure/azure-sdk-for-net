...
namespace Microsoft.Azure.Management.Billing.Fluent
{
    ...
    public static partial class BillingPeriodsOperationsExtensions
    {
            ...
            /// periods.
            /// </param>
            public static IPage<BillingPeriodInner> List(this IBillingPeriodsOperations operations, string filter = default(string), string skiptoken = default(string), int? top = default(int?))
            {
            ...
            /// </param>
            public static BillingPeriodInner Get(this IBillingPeriodsOperations operations, string billingPeriodName)
            {
            ...
            /// </param>
            public static IPage<BillingPeriodInner> ListNext(this IBillingPeriodsOperations operations, string nextPageLink)
            {
