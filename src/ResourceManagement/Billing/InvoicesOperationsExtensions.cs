...
namespace Microsoft.Azure.Management.Billing.Fluent
{
    ...
    public static partial class InvoicesOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<InvoiceInner> List(this IInvoicesOperations operations, string expand = default(string), string filter = default(string), string skiptoken = default(string), int? top = default(int?))
            {
            ...
            /// </param>
            public static async Task<IPage<InvoiceInner>> ListAsync(this IInvoicesOperations operations, string expand = default(string), string filter = default(string), string skiptoken = default(string), int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static InvoiceInner Get(this IInvoicesOperations operations, string invoiceName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<InvoiceInner> GetAsync(this IInvoicesOperations operations, string invoiceName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static InvoiceInner GetLatest(this IInvoicesOperations operations)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<InvoiceInner> GetLatestAsync(this IInvoicesOperations operations, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IPage<InvoiceInner> ListNext(this IInvoicesOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<InvoiceInner>> ListNextAsync(this IInvoicesOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
