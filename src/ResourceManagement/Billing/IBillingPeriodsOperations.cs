...
namespace Microsoft.Azure.Management.Billing.Fluent
{
    ...
    public partial interface IBillingPeriodsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<BillingPeriodInner>>> ListWithHttpMessagesAsync(string filter = default(string), string skiptoken = default(string), int? top = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<BillingPeriodInner>> GetWithHttpMessagesAsync(string billingPeriodName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Lists the available billing periods for a subscription in reverse
        /// chronological order.
        /// <see href="https://go.microsoft.com/fwlink/?linkid=844490" />
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<BillingPeriodInner>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
