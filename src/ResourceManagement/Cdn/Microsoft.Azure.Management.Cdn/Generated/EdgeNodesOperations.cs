...
namespace Microsoft.Azure.Management.Cdn
{
    ...
    internal partial class EdgeNodesOperations : IServiceOperations<CdnManagementClient>, IEdgeNodesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<EdgenodeResult>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<EdgenodeResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<EdgenodeResult>(_responseContent, Client.DeserializationSettings);
                }
