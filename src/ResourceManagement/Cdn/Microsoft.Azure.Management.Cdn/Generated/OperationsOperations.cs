...
namespace Microsoft.Azure.Management.Cdn
{
    ...
    internal partial class OperationsOperations : IServiceOperations<CdnManagementClient>, IOperationsOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var url = new Uri(new Uri(baseUrl + (baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Cdn/operations").ToString();
            ...
            // Create Result
            var result = new AzureOperationResponse<IPage<Operation>>();
            ...
            if ((int)statusCode == 200)
            {
                ...
                {
                    string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                    result.Body = SafeJsonConvert.DeserializeObject<Page<Operation>>(responseContent, this.Client.DeserializationSettings);
                }
