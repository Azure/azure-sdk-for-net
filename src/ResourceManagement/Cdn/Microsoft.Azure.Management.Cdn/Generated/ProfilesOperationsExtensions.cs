...
namespace Microsoft.Azure.Management.Cdn
{
    ...
    public static partial class ProfilesOperationsExtensions
    {
            ...
            {
                var result = await operations.ListByResourceGroupWithHttpMessagesAsync(resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.GetWithHttpMessagesAsync(profileName, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.CreateWithHttpMessagesAsync(profileName, profileProperties, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.BeginCreateWithHttpMessagesAsync(profileName, profileProperties, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.UpdateWithHttpMessagesAsync(profileName, resourceGroupName, tags, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.GenerateSsoUriWithHttpMessagesAsync(profileName, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                return Task.Factory.StartNew(s => ((IProfilesOperations)s).ListByResourceGroupNextAsync(nextPageLink), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                var result = await operations.ListByResourceGroupNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
