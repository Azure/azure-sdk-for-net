...
namespace Microsoft.Azure.Management.Cdn
{
    ...
    public static partial class OriginsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<Origin> ListByEndpoint(this IOriginsOperations operations, string endpointName, string profileName, string resourceGroupName)
            {
            ...
            /// </param>
            public static async Task<IPage<Origin>> ListByEndpointAsync( this IOriginsOperations operations, string endpointName, string profileName, string resourceGroupName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                var result = await operations.GetWithHttpMessagesAsync(originName, endpointName, profileName, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.CreateWithHttpMessagesAsync(originName, originProperties, endpointName, profileName, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.BeginCreateWithHttpMessagesAsync(originName, originProperties, endpointName, profileName, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.UpdateWithHttpMessagesAsync(originName, originProperties, endpointName, profileName, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.DeleteIfExistsWithHttpMessagesAsync(originName, endpointName, profileName, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.BeginDeleteIfExistsWithHttpMessagesAsync(originName, endpointName, profileName, resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                return Task.Factory.StartNew(s => ((IOriginsOperations)s).ListByEndpointNextAsync(nextPageLink), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
