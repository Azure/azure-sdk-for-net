...
namespace Cdn.Tests.ScenarioTests
{
    ...
    {
        [Fact(Skip = "TODO: Fix the failing test after code regeneration")]
        public void CustomDomainCRUDTest()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType().FullName))
            {
                ...
                cdnMgmtClient.CustomDomains.Create(
                    resourceGroupName, 
                    profileName, 
                    endpointName, 
                    customDomainName1, 
                    "sdk-1-5b4d5e6b9f56.azureedge-test.net");
                ...
                cdnMgmtClient.CustomDomains.Create(
                    ...
                    endpointName, 
                    customDomainName2,
                    "sdk-2-5b4d5e6b9f56.azureedge-test.net");
