...
namespace Microsoft.Azure.Management.Cdn.Fluent.Models
{
    ...
    public partial class OriginInner : Microsoft.Azure.Management.Resource.Fluent.Resource
    {
        /// <summary>
        ...
        /// origin.</param>
        public OriginInner(string hostName, string location = default(string), string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), int? httpPort = default(int?), int? httpsPort = default(int?), string resourceState = default(string), string provisioningState = default(string))
