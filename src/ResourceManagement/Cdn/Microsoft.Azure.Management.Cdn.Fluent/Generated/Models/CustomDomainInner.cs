...
namespace Microsoft.Azure.Management.Cdn.Fluent.Models
{
    ...
    public partial class CustomDomainInner : Microsoft.Azure.Management.Resource.Fluent.Resource
    {
        /// <summary>
        ...
        /// domain.</param>
        public CustomDomainInner(string hostName, string location = default(string), string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string resourceState = default(string), string validationData = default(string), string provisioningState = default(string))
