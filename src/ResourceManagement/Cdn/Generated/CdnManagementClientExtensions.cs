...
namespace Microsoft.Azure.Management.Cdn.Fluent
{
    ...
    public static partial class CdnManagementClientExtensions
    {
            ...
            /// </param>
            public static async Task<CheckNameAvailabilityOutputInner> CheckNameAvailabilityAsync(this ICdnManagementClient operations, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
