...
namespace Microsoft.Azure.Management.Storage
{
    ...
    public static partial class UsageOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<Usage> List(this IUsageOperations operations, string apiVersion)
            {
            ...
            /// </param>
            public static async Task<IPage<Usage>> ListAsync( this IUsageOperations operations, string apiVersion, CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<IPage<Usage>> result = await operations.ListWithHttpMessagesAsync(apiVersion, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
