...
namespace Microsoft.Azure.Management.Authorization
{
    ...
    public static partial class RoleDefinitionsOperationsExtensions
    {
            ...
            /// </param>
            public static RoleDefinition CreateOrUpdate(this IRoleDefinitionsOperations operations, string scope, string roleDefinitionId, RoleDefinition roleDefinition = default(RoleDefinition))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RoleDefinition> CreateOrUpdateAsync( this IRoleDefinitionsOperations operations, string scope, string roleDefinitionId, RoleDefinition roleDefinition = default(RoleDefinition), CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<RoleDefinition> result = await operations.CreateOrUpdateWithHttpMessagesAsync(scope, roleDefinitionId, roleDefinition, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<RoleDefinition> result = await operations.GetByIdWithHttpMessagesAsync(roleDefinitionId, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<IPage<RoleDefinition>> result = await operations.ListNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
