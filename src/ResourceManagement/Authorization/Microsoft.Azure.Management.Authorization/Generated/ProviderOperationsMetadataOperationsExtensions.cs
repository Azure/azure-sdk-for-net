...
namespace Microsoft.Azure.Management.Authorization
{
    ...
    public static partial class ProviderOperationsMetadataOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<IPage<ProviderOperationsMetadata>> result = await operations.ListWithHttpMessagesAsync(apiVersion, expand, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<IPage<ProviderOperationsMetadata>> result = await operations.ListNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
