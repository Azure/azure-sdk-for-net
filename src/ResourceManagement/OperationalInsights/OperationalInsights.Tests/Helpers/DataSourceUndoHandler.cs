...
namespace OperationalInsights.Tests.Helpers
{
    ...
    public class DataSourceUndoHandler : ComplexTypedOperationUndoHandler<IDataSourceOperations, OperationalInsightsManagementClient>
    {
        ...
        {
            undoAction = null;
            DataSourceCreateOrUpdateParameters createParameters;
            string resourceGroupName;
            string workspaceName;
            if (TryAssignParameter<DataSourceCreateOrUpdateParameters>(TestHelper.ParametersParameter, parameters, out createParameters)
                && createParameters != null
                && createParameters.DataSource != null
                && createParameters.DataSource.Name != null
                ...
                && TryAssignParameter<string>(TestHelper.WorkspaceNameParameter, parameters, out workspaceName))
            {
                undoAction = () =>
                {
                    ...
                    {
                        operationalInsights.StorageInsights.Delete(resourceGroupName, workspaceName, createParameters.DataSource.Name);
                    }
                };
