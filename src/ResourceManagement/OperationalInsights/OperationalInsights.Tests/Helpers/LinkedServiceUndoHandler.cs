...
{
    /// <summary>
    /// Undo Handler for linked service operations
    /// </summary>
    public class LinkedServiceUndoHandler : ComplexTypedOperationUndoHandler<ILinkedServiceOperations, OperationalInsightsManagementClient>
    {
        /// <summary>
        /// Look up the undo operation for the given linked service operation
        /// </summary>
        ...
        {
            undoAction = null;
            LinkedServiceCreateOrUpdateParameters createParameters;
            string resourceGroupName;
            string workspaceName;
            if (TryAssignParameter<LinkedServiceCreateOrUpdateParameters>(TestHelper.ParametersParameter, parameters, out createParameters)
                && createParameters != null
                && createParameters.Name != null
                && createParameters.Properties != null
                ...
                && TryAssignParameter<string>(TestHelper.WorkspaceNameParameter, parameters, out workspaceName))
            {
                undoAction = () =>
                {
                    ...
                    {
                        operationalInsights.LinkedServices.Delete(resourceGroupName, workspaceName, createParameters.Name);
                    }
                };
