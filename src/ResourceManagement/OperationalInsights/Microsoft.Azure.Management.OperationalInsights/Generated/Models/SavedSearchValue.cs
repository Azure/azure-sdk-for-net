...
namespace Microsoft.Azure.Management.OperationalInsights.Models
{
    ...
    public partial class SavedSearchValue
    {
        ...
        /// Initializes a new instance of the SavedSearchValue class.
        /// </summary>
        public SavedSearchValue(string id = default(string), string etag = default(string), string category = default(string), string displayName = default(string), string query = default(string), long? version = default(long?), IList<Tag> tags = default(IList<Tag>))
        {
            Id = id;
            Etag = etag;
            Category = category;
