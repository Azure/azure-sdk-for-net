...
namespace Microsoft.Azure.Management.KeyVault.Fluent.Models
{
    ...
    public partial class VaultProperties
    {
        ...
        public VaultProperties(System.Guid tenantId, Sku sku, System.Collections.Generic.IList<AccessPolicyEntry> accessPolicies, string vaultUri = default(string), bool? enabledForDeployment = default(bool?), bool? enabledForDiskEncryption = default(bool?), bool? enabledForTemplateDeployment = default(bool?))
        {
            Sku = new Sku();
            VaultUri = vaultUri;
            TenantId = tenantId;
        ...
        public virtual void Validate()
        {
            ...
            if (this.AccessPolicies != null)
            {
                ...
                {
                    throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.MaxItems, "AccessPolicies", 16);
                }
