...
namespace Microsoft.Azure.Management.KeyVault.Fluent.Models
{
    ...
    public partial class VaultProperties
    {
        ...
        public VaultProperties(System.Guid tenantId, Sku sku, IList<AccessPolicyEntry> accessPolicies, string vaultUri = default(string), bool? enabledForDeployment = default(bool?), bool? enabledForDiskEncryption = default(bool?), bool? enabledForTemplateDeployment = default(bool?))
        {
            Sku = new Sku();
            VaultUri = vaultUri;
            TenantId = tenantId;
