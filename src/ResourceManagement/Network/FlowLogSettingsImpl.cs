...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50Lm5ldHdvcmsuaW1wbGVtZW50YXRpb24uRmxvd0xvZ1NldHRpbmdzSW1wbA==
    internal partial class FlowLogSettingsImpl  :
        IndexableRefreshableWrapper<Microsoft.Azure.Management.Network.Fluent.IFlowLogSettings, Models.FlowLogInformationInner>,
        IFlowLogSettings,
        IUpdate
    {
        ...
        public async Task<Microsoft.Azure.Management.Network.Fluent.IFlowLogSettings> ApplyAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        protected override async Task<Models.FlowLogInformationInner> GetInnerAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            //$ return this.parent().Manager().Inner.NetworkWatchers()
