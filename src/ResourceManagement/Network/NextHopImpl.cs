...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50Lm5ldHdvcmsuaW1wbGVtZW50YXRpb24uTmV4dEhvcEltcGw=
    internal partial class NextHopImpl  :
        ExecutableImpl<Microsoft.Azure.Management.Network.Fluent.INextHop>,
        INextHop,
        IDefinition
    {
        ...
        public async Task<Microsoft.Azure.Management.Network.Fluent.INextHop> ExecuteWorkAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
