...
namespace Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update
{
    ...
    public interface IWithPublicIpAddress  :
        Microsoft.Azure.Management.V2.Network.HasPublicIpAddress.Update.IWithPublicIpAddress<Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update.IUpdate>
    {
    }
    /// <summary>
    ...
    public interface IUpdate  :
        ...
        IWithSubnet,
        IWithPrivateIp,
        Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update.IWithPublicIpAddress,
        IWithLoadBalancer
    {
    }
    /// <summary>
    ...
    public interface IWithLoadBalancer 
    {
        ...
        Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update.IUpdate WithExistingLoadBalancerBackend (ILoadBalancer loadBalancer, string backendName);
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update.IUpdate WithExistingLoadBalancerInboundNatRule (ILoadBalancer loadBalancer, string inboundNatRuleName);

        /// <summary>
        /// Removes all the existing associations with load balancer backends.
        /// </summary>
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update.IUpdate WithoutLoadBalancerBackends ();

        /// <summary>
        /// Removes all the existing associations with load balancer inbound NAT rules.
        /// </summary>
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update.IUpdate WithoutLoadBalancerInboundNatRules ();
    ...
    public interface IWithPrivateIp  :
        IWithPrivateIpAddress<Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update.IUpdate>
    {
        /// <summary>
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.NicIpConfiguration.Update.IUpdate WithPrivateIpVersion (string ipVersion);
