...
namespace Microsoft.Azure.Management.V2.Network.LoadBalancer.Update
{
    ...
    public interface IWithProbe 
    {
        ...
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithTcpProbe (int port);
        ...
        /// <returns>the next stage of the definition</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithHttpProbe (string requestPath);
        ...
        /// <returns>the next stage of the definition</returns>
        Microsoft.Azure.Management.V2.Network.HttpProbe.UpdateDefinition.IBlank<Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate> DefineHttpProbe (string name);
        ...
        /// <param name="name">name the name of the new probe</param>
        /// <returns>the next stage of the definition</returns>
        Microsoft.Azure.Management.V2.Network.TcpProbe.UpdateDefinition.IBlank<Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate> DefineTcpProbe (string name);
        ...
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithoutProbe (string name);
        ...
        Microsoft.Azure.Management.V2.Network.TcpProbe.Update.IUpdate UpdateTcpProbe (string name);
        ...
        /// <param name="name">name the name of the probe to update</param>
        /// <returns>the first stage of the probe update</returns>
        Microsoft.Azure.Management.V2.Network.HttpProbe.Update.IUpdate UpdateHttpProbe (string name);
    ...
    public interface IWithPublicIpAddress 
    {
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithExistingPublicIpAddress (IPublicIpAddress publicIpAddress);
        ...
        /// </summary>
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithNewPublicIpAddress ();
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithNewPublicIpAddress (string dnsLeafLabel);
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithNewPublicIpAddress (ICreatable<Microsoft.Azure.Management.V2.Network.IPublicIpAddress> creatablePublicIpAddress);
    ...
    public interface IWithNetworkSubnet 
    {
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithExistingSubnet (INetwork network, string subnetName);
    ...
    public interface IWithBackend 
    {
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithoutBackend (string name);
        ...
        Microsoft.Azure.Management.V2.Network.Backend.UpdateDefinition.IBlank<Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate> DefineBackend (string name);
        ...
        Microsoft.Azure.Management.V2.Network.Backend.Update.IUpdate UpdateBackend (string name);
        ...
        IWithPublicIpAddress
    {
        ...
        Microsoft.Azure.Management.V2.Network.PublicFrontend.UpdateDefinition.IBlank<Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate> DefinePublicFrontend (string name);
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithoutFrontend (string name);
        ...
        Microsoft.Azure.Management.V2.Network.PublicFrontend.Update.IUpdate UpdateInternetFrontend (string name);
    ...
    public interface IWithInboundNatRule 
    {
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithoutInboundNatRule (string name);
        ...
        Microsoft.Azure.Management.V2.Network.InboundNatRule.UpdateDefinition.IBlank<Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate> DefineInboundNatRule (string name);
        ...
        Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IUpdate UpdateInboundNatRule (string name);
        ...
        IWithNetworkSubnet
    {
        ...
        /// <param name="name">name the name for the frontend</param>
        /// <returns>the first stage of the new frontend definition</returns>
        Microsoft.Azure.Management.V2.Network.PrivateFrontend.UpdateDefinition.IBlank<Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate> DefinePrivateFrontend (string name);
        ...
        /// <returns>the first stage of the frontend update</returns>
        Microsoft.Azure.Management.V2.Network.PrivateFrontend.Update.IUpdate UpdateInternalFrontend (string name);
    ...
    public interface IWithLoadBalancingRule 
    {
        ...
        /// <returns>the next stage of the definition</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithLoadBalancingRule (int frontendPort, string protocol, int backendPort);
        ...
        /// <param name="protocol">protocol the protocol to load balance</param>
        /// <returns>the next stage of the definition</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithLoadBalancingRule (int port, string protocol);
        ...
        Microsoft.Azure.Management.V2.Network.LoadBalancingRule.UpdateDefinition.IBlank<Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate> DefineLoadBalancingRule (string name);
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithoutLoadBalancingRule (string name);
        ...
        Microsoft.Azure.Management.V2.Network.LoadBalancingRule.Update.IUpdate UpdateLoadBalancingRule (string name);
    ...
    public interface IWithInboundNatPool 
    {
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate WithoutInboundNatPool (string name);
        ...
        Microsoft.Azure.Management.V2.Network.InboundNatPool.UpdateDefinition.IBlank<Microsoft.Azure.Management.V2.Network.LoadBalancer.Update.IUpdate> DefineInboundNatPool (string name);
        ...
        Microsoft.Azure.Management.V2.Network.InboundNatPool.Update.IUpdate UpdateInboundNatPool (string name);
