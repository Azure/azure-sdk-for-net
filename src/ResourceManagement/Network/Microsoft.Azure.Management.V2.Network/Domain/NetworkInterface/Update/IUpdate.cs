...
namespace Microsoft.Azure.Management.V2.Network.NetworkInterface.Update
{
    ...
    public interface IWithLoadBalancer 
    {
        ...
        Microsoft.Azure.Management.V2.Network.NetworkInterface.Update.IUpdate WithExistingLoadBalancerBackend (ILoadBalancer loadBalancer, string backendName);
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.NetworkInterface.Update.IUpdate WithExistingLoadBalancerInboundNatRule (ILoadBalancer loadBalancer, string inboundNatRuleName);

        /// <summary>
        /// Removes all the existing associations with any load balancer backends.
        /// </summary>
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.NetworkInterface.Update.IUpdate WithoutLoadBalancerBackends ();

        /// <summary>
        /// Removes all the existing associations with any load balancer inbound NAT rules.
        /// </summary>
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.NetworkInterface.Update.IUpdate WithoutLoadBalancerInboundNatRules ();
