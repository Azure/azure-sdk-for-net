...
namespace Microsoft.Azure.Management.V2.Network
{
    ...
    public partial class PublicIpAddressImpl 
    {
        ...
        bool? Microsoft.Azure.Management.V2.Network.IPublicIpAddress.HasAssignedNetworkInterface
        {
            get
            {
        ...
        string Microsoft.Azure.Management.V2.Network.IPublicIpAddress.Version
        {
            get
            {
        ...
        Microsoft.Azure.Management.V2.Network.IPublicFrontend Microsoft.Azure.Management.V2.Network.IPublicIpAddress.GetAssignedLoadBalancerFrontend () { 
            return this.GetAssignedLoadBalancerFrontend() as Microsoft.Azure.Management.V2.Network.IPublicFrontend;
        }

        /// <returns>true if this public IP address is assigned to a load balancer</returns>
        bool? Microsoft.Azure.Management.V2.Network.IPublicIpAddress.HasAssignedLoadBalancer
        {
            get
            {
        ...
        Microsoft.Azure.Management.V2.Network.INicIpConfiguration Microsoft.Azure.Management.V2.Network.IPublicIpAddress.GetAssignedNetworkInterfaceIpConfiguration () { 
            return this.GetAssignedNetworkInterfaceIpConfiguration() as Microsoft.Azure.Management.V2.Network.INicIpConfiguration;
        }
