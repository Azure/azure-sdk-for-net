...
namespace Microsoft.Azure.Management.V2.Network.PublicFrontend.Definition
{
    ...
    public interface IWithPublicIpAddress<ParentT>  :
        IWithExistingPublicIpAddress<Microsoft.Azure.Management.V2.Network.PublicFrontend.Definition.IWithAttach<ParentT>>
    {
    }
}