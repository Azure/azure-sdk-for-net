...
namespace Microsoft.Azure.Management.V2.Network.InboundNatRule.Update
{
    ...
    public interface IWithFrontendPort 
    {
        ...
        Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IUpdate WithFrontendPort (int port);
    ...
    public interface IWithProtocol  :
        Microsoft.Azure.Management.V2.Network.HasProtocol.Update.IWithProtocol<Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IUpdate,string>
    {
    }
    /// <summary>
    ...
    public interface IWithIdleTimeout 
    {
        ...
        /// <returns>the next stage of the update</returns>
        Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IUpdate WithIdleTimeoutInMinutes (int minutes);
    ...
    public interface IWithFloatingIp  :
        Microsoft.Azure.Management.V2.Network.HasFloatingIp.Update.IWithFloatingIp<Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IUpdate>
    {
    }
    /// <summary>
    ...
    public interface IWithBackendPort  :
        Microsoft.Azure.Management.V2.Network.HasBackendPort.Update.IWithBackendPort<Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IUpdate>
    {
    }
    /// <summary>
    ...
    public interface IUpdate  :
        ...
        Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IWithBackendPort,
        Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IWithFloatingIp,
        Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IWithFrontend,
        IWithFrontendPort,
        IWithIdleTimeout,
        Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IWithProtocol
    {
    }
    /// <summary>
    ...
    public interface IWithFrontend  :
        Microsoft.Azure.Management.V2.Network.HasFrontend.Update.IWithFrontend<Microsoft.Azure.Management.V2.Network.InboundNatRule.Update.IUpdate>
    {
    }
}