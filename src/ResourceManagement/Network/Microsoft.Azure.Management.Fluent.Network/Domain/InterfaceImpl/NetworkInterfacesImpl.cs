...
namespace Microsoft.Azure.Management.Fluent.Network
{
    ...
    public partial class NetworkInterfacesImpl 
    {
        ...
        Microsoft.Azure.Management.Fluent.Network.NetworkInterface.Definition.IBlank Microsoft.Azure.Management.Fluent.Resource.Core.CollectionActions.ISupportsCreating<Microsoft.Azure.Management.Fluent.Network.NetworkInterface.Definition.IBlank>.Define (string name) { 
            return this.Define( name) as Microsoft.Azure.Management.Fluent.Network.NetworkInterface.Definition.IBlank;
        }
        ...
        Microsoft.Azure.Management.Fluent.Resource.Core.PagedList<Microsoft.Azure.Management.Fluent.Network.INetworkInterface> Microsoft.Azure.Management.Fluent.Resource.Core.CollectionActions.ISupportsListingByGroup<Microsoft.Azure.Management.Fluent.Network.INetworkInterface>.ListByGroup (string resourceGroupName) { 
            return this.ListByGroup( resourceGroupName) as Microsoft.Azure.Management.Fluent.Resource.Core.PagedList<Microsoft.Azure.Management.Fluent.Network.INetworkInterface>;
        }
        ...
        Microsoft.Azure.Management.Fluent.Network.INetworkInterface Microsoft.Azure.Management.Fluent.Resource.Core.CollectionActions.ISupportsGettingByGroup<Microsoft.Azure.Management.Fluent.Network.INetworkInterface>.GetByGroup (string resourceGroupName, string name) { 
            return this.GetByGroup( resourceGroupName,  name) as Microsoft.Azure.Management.Fluent.Network.INetworkInterface;
        }
        ...
        Microsoft.Azure.Management.Fluent.Resource.Core.PagedList<Microsoft.Azure.Management.Fluent.Network.INetworkInterface> Microsoft.Azure.Management.Fluent.Resource.Core.CollectionActions.ISupportsListing<Microsoft.Azure.Management.Fluent.Network.INetworkInterface>.List () { 
            return this.List() as Microsoft.Azure.Management.Fluent.Resource.Core.PagedList<Microsoft.Azure.Management.Fluent.Network.INetworkInterface>;
        }
