...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    using NextHop.Definition;
    using VerificationIPFlow.Definition;
    using Models;
        ...
        IUpdate
    {
        ...
        public async Task<Microsoft.Azure.Management.Network.Fluent.ITopology> GetTopologyAsync(string targetResourceGroup, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async Task<Microsoft.Azure.Management.Network.Fluent.IFlowLogSettings> GetFlowLogSettingsAsync(string nsgId, CancellationToken cancellationToken = default(CancellationToken))
        {
            //$ return this.Manager().Inner.NetworkWatchers()
        ...
        protected async override Task<Models.NetworkWatcherInner> GetInnerAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async override Task<Microsoft.Azure.Management.Network.Fluent.INetworkWatcher> CreateResourceAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async Task<Microsoft.Azure.Management.Network.Fluent.ISecurityGroupView> GetSecurityGroupViewAsync(string vmId, CancellationToken cancellationToken = default(CancellationToken))
        {
            //$ return this.Manager().Inner.NetworkWatchers()
