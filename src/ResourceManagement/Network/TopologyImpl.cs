...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50Lm5ldHdvcmsuaW1wbGVtZW50YXRpb24uVG9wb2xvZ3lJbXBs
        ...
        ITopology
    {
        ...
        public override async Task<Microsoft.Azure.Management.Network.Fluent.ITopology> RefreshAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        private void InitializeResourcesFromInner()
        {
            ...
            //$ foreach(var resource in topologyResources) {
