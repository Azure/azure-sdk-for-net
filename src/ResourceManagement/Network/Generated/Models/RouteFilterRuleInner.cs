...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class RouteFilterRuleInner : Microsoft.Azure.Management.ResourceManager.Fluent.SubResource
    {
        /// <summary>
        /// Initializes a new instance of the RouteFilterRuleInner class.
        /// </summary>
        ...
        public RouteFilterRuleInner(string access, IList<string> communities, string id = default(string), string provisioningState = default(string), string name = default(string), string location = default(string), string etag = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
            : base(id)
        {
            Access = access;
        ...
        /// <summary>
        /// Static constructor for RouteFilterRuleInner class.
        /// </summary>
        static RouteFilterRuleInner()
        {
