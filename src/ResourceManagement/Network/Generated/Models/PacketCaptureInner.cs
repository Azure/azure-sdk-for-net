...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class PacketCaptureInner
    {
        /// <summary>
        ...
        public PacketCaptureInner(string target, PacketCaptureStorageLocation storageLocation, int? bytesToCapturePerPacket = default(int?), int? totalBytesPerSession = default(int?), int? timeLimitInSeconds = default(int?), IList<PacketCaptureFilter> filters = default(IList<PacketCaptureFilter>))
        {
            Target = target;
