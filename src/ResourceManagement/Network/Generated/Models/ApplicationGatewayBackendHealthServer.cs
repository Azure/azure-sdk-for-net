...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class ApplicationGatewayBackendHealthServer
    {
        ...
        public ApplicationGatewayBackendHealthServer(string address = default(string), Microsoft.Azure.Management.ResourceManager.Fluent.SubResource ipConfiguration = default(Microsoft.Azure.Management.ResourceManager.Fluent.SubResource), string health = default(string))
        {
            Address = address;
