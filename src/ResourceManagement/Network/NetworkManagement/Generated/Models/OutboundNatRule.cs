...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class OutboundNatRule : SubResource
    {
        ...
        /// Initializes a new instance of the OutboundNatRule class.
        /// </summary>
        public OutboundNatRule(string name = default(string), string etag = default(string), int? allocatedOutboundPorts = default(int?), IList<SubResource> frontendIPConfigurations = default(IList<SubResource>), SubResource backendAddressPool = default(SubResource), string provisioningState = default(string))
        {
            Name = name;
            Etag = etag;
