...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class SecurityRule : SubResource
    {
        ...
        /// Initializes a new instance of the SecurityRule class.
        /// </summary>
        public SecurityRule(string name = default(string), string etag = default(string), string description = default(string), string protocol = default(string), string sourcePortRange = default(string), string destinationPortRange = default(string), string sourceAddressPrefix = default(string), string destinationAddressPrefix = default(string), string access = default(string), int? priority = default(int?), string direction = default(string), string provisioningState = default(string))
        {
            Name = name;
            Etag = etag;
