...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteCircuitAuthorization : SubResource
    {
        ...
        /// class.
        /// </summary>
        public ExpressRouteCircuitAuthorization(string name = default(string), string etag = default(string), string authorizationKey = default(string), string authorizationUseStatus = default(string), string provisioningState = default(string))
        {
            Name = name;
            Etag = etag;
