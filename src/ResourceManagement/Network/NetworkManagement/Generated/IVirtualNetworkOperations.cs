...
namespace Microsoft.Azure.Management.Network
{
    ...
    public partial interface IVirtualNetworkOperations
    {
        ...
        /// </returns>
        Task<VirtualNetworkPutResponse> BeginCreateOrUpdatingAsync(string resourceGroupName, string virtualNetworkName, VirtualNetwork parameters, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<UpdateOperationResponse> BeginDeletingAsync(string resourceGroupName, string virtualNetworkName, CancellationToken cancellationToken);
        ...
        /// the failure.
        /// </returns>
        Task<AzureAsyncOperationResponse> CreateOrUpdateAsync(string resourceGroupName, string virtualNetworkName, VirtualNetwork parameters, CancellationToken cancellationToken);
        ...
        /// request ID.
        /// </returns>
        Task<AzureOperationResponse> DeleteAsync(string resourceGroupName, string virtualNetworkName, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<VirtualNetworkGetResponse> GetAsync(string resourceGroupName, string virtualNetworkName, CancellationToken cancellationToken);
        ...
        /// </returns>
        Task<VirtualNetworkListResponse> ListAsync(string resourceGroupName, CancellationToken cancellationToken);
        ...
        /// Response for ListVirtualNetworks Api servive call
        /// </returns>
        Task<VirtualNetworkListResponse> ListAllAsync(CancellationToken cancellationToken);
    }
}
