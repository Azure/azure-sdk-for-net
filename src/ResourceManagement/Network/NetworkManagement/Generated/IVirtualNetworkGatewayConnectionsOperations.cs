namespace Microsoft.Azure.Management.Network
{
    ...
    public partial interface IVirtualNetworkGatewayConnectionsOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        Task<AzureOperationResponse<VirtualNetworkGatewayConnectionPutResponse>> CreateOrUpdateWithOperationResponseAsync(string resourceGroupName, string virtualNetworkGatewayConnectionName, VirtualNetworkGatewayConnection parameters, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Cancellation token.
        /// </param>
        Task<AzureOperationResponse<string>> GetSharedKeyWithOperationResponseAsync(string resourceGroupName, string connectionSharedKeyName, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Cancellation token.
        /// </param>
        Task<AzureOperationResponse<ConnectionResetSharedKeyPutResponse>> ResetSharedKeyWithOperationResponseAsync(string resourceGroupName, string virtualNetworkGatewayConnectionName, ConnectionResetSharedKey parameters, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Cancellation token.
        /// </param>
        Task<AzureOperationResponse<ConnectionSharedKeyPutResponse>> SetSharedKeyWithOperationResponseAsync(string resourceGroupName, string virtualNetworkGatewayConnectionName, ConnectionSharedKey parameters, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// The List VirtualNetworkGatewayConnections operation retrieves all
        /// the virtual network gateways connections created.
        /// </summary>
