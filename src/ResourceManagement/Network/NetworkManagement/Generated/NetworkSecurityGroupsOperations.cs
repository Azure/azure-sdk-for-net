namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class NetworkSecurityGroupsOperations : IServiceOperations<NetworkResourceProviderClient>, INetworkSecurityGroupsOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<NetworkSecurityGroup>>> ListAllWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (this.Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            // Create Result
            var result = new AzureOperationResponse<Page<NetworkSecurityGroup>>();
            result.Request = httpRequest;
            result.Response = httpResponse;
            if (httpResponse.Headers.Contains("x-ms-request-id"))
            {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<NetworkSecurityGroup>>> ListWithHttpMessagesAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<NetworkSecurityGroup>>> ListAllNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<NetworkSecurityGroup>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (nextPageLink == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "nextPageLink");
