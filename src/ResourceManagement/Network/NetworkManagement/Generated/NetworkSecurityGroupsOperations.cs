namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class NetworkSecurityGroupsOperations : IServiceOperations<NetworkResourceProviderClient>, INetworkSecurityGroupsOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse> DeleteWithOperationResponseAsync(string resourceGroupName, string networkSecurityGroupName, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse response = await BeginDeleteWithOperationResponseAsync(
                resourceGroupName, networkSecurityGroupName, cancellationToken);
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse> BeginDeleteWithOperationResponseAsync(string resourceGroupName, string networkSecurityGroupName, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<NetworkSecurityGroup>> GetWithOperationResponseAsync(string resourceGroupName, string networkSecurityGroupName, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException("resourceGroupName");
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<NetworkSecurityGroup>> CreateOrUpdateWithOperationResponseAsync(string resourceGroupName, string networkSecurityGroupName, NetworkSecurityGroup parameters, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<NetworkSecurityGroup> response = await BeginCreateOrUpdateWithOperationResponseAsync(
                resourceGroupName, networkSecurityGroupName, parameters, cancellationToken);
            return await this.Client.GetPutOperationResultAsync<NetworkSecurityGroup>(response, 
                () => GetWithOperationResponseAsync(resourceGroupName, networkSecurityGroupName, cancellationToken),
                cancellationToken);
        }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<NetworkSecurityGroup>> BeginCreateOrUpdateWithOperationResponseAsync(string resourceGroupName, string networkSecurityGroupName, NetworkSecurityGroup parameters, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException("resourceGroupName");
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<NetworkSecurityGroupListResponse>> ListAllWithOperationResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool shouldTrace = ServiceClientTracing.IsEnabled;
            string invocationId = null;
            ...
            // Create Result
            var result = new AzureOperationResponse<NetworkSecurityGroupListResponse>();
            result.Request = httpRequest;
            result.Response = httpResponse;
            // Deserialize Response
            if (statusCode == (HttpStatusCode)Enum.Parse(typeof(HttpStatusCode), "OK"))
            {
                result.Body = JsonConvert.DeserializeObject<NetworkSecurityGroupListResponse>(responseContent, this.Client.DeserializationSettings);
            }
            if (shouldTrace)
            {
                ServiceClientTracing.Exit(invocationId, result);
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<NetworkSecurityGroupListResponse>> ListWithOperationResponseAsync(string resourceGroupName, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException("resourceGroupName");
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<NetworkSecurityGroupListResponse>> ListAllNextWithOperationResponseAsync(string nextLink, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (nextLink == null)
            {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<NetworkSecurityGroupListResponse>> ListNextWithOperationResponseAsync(string nextLink, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException("nextLink");
