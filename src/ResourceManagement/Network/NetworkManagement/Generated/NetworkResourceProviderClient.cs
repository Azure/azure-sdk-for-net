namespace Microsoft.Azure.Management.Network
{
    ...
    public partial class NetworkResourceProviderClient : ServiceClient<NetworkResourceProviderClient>, INetworkResourceProviderClient, IAzureClient
    {
        ...
        /// client pipeline.
        /// </param>
        public NetworkResourceProviderClient(SubscriptionCloudCredentials credentials, string subscriptionId, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (credentials == null)
            {
        ...
        /// client pipeline.
        /// </param>
        public NetworkResourceProviderClient(Uri baseUri, SubscriptionCloudCredentials credentials, string subscriptionId, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
