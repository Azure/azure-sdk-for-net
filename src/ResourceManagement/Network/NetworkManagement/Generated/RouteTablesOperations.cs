...
namespace Microsoft.Azure.Management.Network
{
    ...
    /// </summary>
    internal partial class RouteTablesOperations : IServiceOperations<NetworkResourceProviderClient>, IRouteTablesOperations
    {
        /// <summary>
        ...
        /// </param>
        internal RouteTablesOperations(NetworkResourceProviderClient client)
        {
            if (client == null) 
            {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<RouteTable>> GetWithHttpMessagesAsync(string resourceGroupName, string routeTableName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
