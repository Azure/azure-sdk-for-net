namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class PublicIpAddressesOperationsExtensions
    {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static Page<PublicIpAddress> ListAll(this IPublicIpAddressesOperations operations)
            {
            ...
            /// Cancellation token.
            /// </param>
            public static async Task<Page<PublicIpAddress>> ListAllAsync( this IPublicIpAddressesOperations operations, CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<Page<PublicIpAddress>> result = await operations.ListAllWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            /// The name of the resource group.
            /// </param>
            public static Page<PublicIpAddress> List(this IPublicIpAddressesOperations operations, string resourceGroupName)
            {
            ...
            /// Cancellation token.
            /// </param>
            public static async Task<Page<PublicIpAddress>> ListAsync( this IPublicIpAddressesOperations operations, string resourceGroupName, CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<Page<PublicIpAddress>> result = await operations.ListWithHttpMessagesAsync(resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            /// </param>
            public static Page<PublicIpAddress> ListAllNext(this IPublicIpAddressesOperations operations, string nextPageLink)
            {
            ...
            /// Cancellation token.
            /// </param>
            public static async Task<Page<PublicIpAddress>> ListAllNextAsync( this IPublicIpAddressesOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<Page<PublicIpAddress>> result = await operations.ListAllNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            /// NextLink from the previous successful call to List operation.
            /// </param>
            public static Page<PublicIpAddress> ListNext(this IPublicIpAddressesOperations operations, string nextPageLink)
            {
            ...
            /// Cancellation token.
            /// </param>
            public static async Task<Page<PublicIpAddress>> ListNextAsync( this IPublicIpAddressesOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<Page<PublicIpAddress>> result = await operations.ListNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
