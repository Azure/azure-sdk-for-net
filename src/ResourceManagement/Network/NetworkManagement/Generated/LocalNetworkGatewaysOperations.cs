namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class LocalNetworkGatewaysOperations : IServiceOperations<NetworkResourceProviderClient>, ILocalNetworkGatewaysOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<LocalNetworkGateway>>> ListWithHttpMessagesAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
            ...
            // Create Result
            var result = new AzureOperationResponse<Page<LocalNetworkGateway>>();
            result.Request = httpRequest;
            result.Response = httpResponse;
            if (httpResponse.Headers.Contains("x-ms-request-id"))
            {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<LocalNetworkGateway>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
