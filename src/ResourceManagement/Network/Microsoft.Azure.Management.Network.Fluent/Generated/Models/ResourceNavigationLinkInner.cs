...
namespace Microsoft.Azure.Management.Network.Fluent.Models
{
    ...
    public partial class ResourceNavigationLinkInner : Microsoft.Azure.Management.Resource.Fluent.SubResource
    {
        ...
        public ResourceNavigationLinkInner(string id = default(string), string linkedResourceType = default(string), string link = default(string), string provisioningState = default(string), string name = default(string), string etag = default(string))
            : base(id)
        {
