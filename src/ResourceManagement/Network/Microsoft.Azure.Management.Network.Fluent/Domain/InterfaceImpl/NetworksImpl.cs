...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class NetworksImpl 
    {
        ...
        IEnumerable<INetwork> ISupportsListingByResourceGroup<INetwork>.ListByResourceGroup(string resourceGroupName)
        {
        ...
        async Task<Microsoft.Azure.Management.Network.Fluent.INetwork> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByResourceGroup<Microsoft.Azure.Management.Network.Fluent.INetwork>.GetByResourceGroupAsync(string resourceGroupName, string name, CancellationToken cancellationToken)
        {
            return await this.GetByResourceGroupAsync(resourceGroupName, name, cancellationToken) as Microsoft.Azure.Management.Network.Fluent.INetwork;
        }
