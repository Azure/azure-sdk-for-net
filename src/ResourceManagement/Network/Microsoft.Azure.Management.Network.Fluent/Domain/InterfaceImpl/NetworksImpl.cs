...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    public partial class NetworksImpl 
    {
        ...
        Microsoft.Azure.Management.Network.Fluent.Network.Definition.IBlank Microsoft.Azure.Management.Resource.Fluent.Core.CollectionActions.ISupportsCreating<Microsoft.Azure.Management.Network.Fluent.Network.Definition.IBlank>.Define(string name) { 
            return this.Define( name) as Microsoft.Azure.Management.Network.Fluent.Network.Definition.IBlank;
        }
        ...
        Microsoft.Azure.Management.Network.Fluent.INetwork Microsoft.Azure.Management.Resource.Fluent.Core.CollectionActions.ISupportsGettingByGroup<Microsoft.Azure.Management.Network.Fluent.INetwork>.GetByGroup(string resourceGroupName, string name) { 
            return this.GetByGroup( resourceGroupName,  name) as Microsoft.Azure.Management.Network.Fluent.INetwork;
        }
