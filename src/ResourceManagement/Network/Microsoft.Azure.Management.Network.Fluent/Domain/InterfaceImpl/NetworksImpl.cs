...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class NetworksImpl 
    {
        ...
        IEnumerable<INetwork> ISupportsListingByGroup<INetwork>.ListByGroup(string resourceGroupName)
        {
        ...
        IEnumerable<Microsoft.Azure.Management.Network.Fluent.INetwork> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsListing<Microsoft.Azure.Management.Network.Fluent.INetwork>.List()
        {
            return this.List();
        }
    }
