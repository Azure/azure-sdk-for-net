...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class NetworkInterfacesImpl 
    {
        ...
        Microsoft.Azure.Management.Fluent.Resource.Core.IPagedCollection<Microsoft.Azure.Management.Network.Fluent.IVirtualMachineScaleSetNetworkInterface> Microsoft.Azure.Management.Network.Fluent.INetworkInterfaces.ListByVirtualMachineScaleSetId(string id)
        {
            return this.ListByVirtualMachineScaleSetId(id) as Microsoft.Azure.Management.Fluent.Resource.Core.IPagedCollection<Microsoft.Azure.Management.Network.Fluent.IVirtualMachineScaleSetNetworkInterface>;
        }
        ...
        /// <param name="instanceId">The virtual machine scale set vm instance id.</param>
        /// <return>List of network interfaces.</return>
        Microsoft.Azure.Management.Fluent.Resource.Core.IPagedCollection<Microsoft.Azure.Management.Network.Fluent.IVirtualMachineScaleSetNetworkInterface> Microsoft.Azure.Management.Network.Fluent.INetworkInterfaces.ListByVirtualMachineScaleSetInstanceId(string resourceGroupName, string scaleSetName, string instanceId)
        {
            return this.ListByVirtualMachineScaleSetInstanceId(resourceGroupName, scaleSetName, instanceId) as Microsoft.Azure.Management.Fluent.Resource.Core.IPagedCollection<Microsoft.Azure.Management.Network.Fluent.IVirtualMachineScaleSetNetworkInterface>;
        }
        ...
        /// <param name="scaleSetName">Scale set name.</param>
        /// <return>List of network interfaces.</return>
        Microsoft.Azure.Management.Fluent.Resource.Core.IPagedCollection<Microsoft.Azure.Management.Network.Fluent.IVirtualMachineScaleSetNetworkInterface> Microsoft.Azure.Management.Network.Fluent.INetworkInterfaces.ListByVirtualMachineScaleSet(string resourceGroupName, string scaleSetName)
        {
            return this.ListByVirtualMachineScaleSet(resourceGroupName, scaleSetName) as Microsoft.Azure.Management.Fluent.Resource.Core.IPagedCollection<Microsoft.Azure.Management.Network.Fluent.IVirtualMachineScaleSetNetworkInterface>;
        }
    }
}