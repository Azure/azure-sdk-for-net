...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class PublicIPAddressesImpl 
    {
        ...
        IEnumerable<Microsoft.Azure.Management.Network.Fluent.IPublicIPAddress> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsListingByResourceGroup<Microsoft.Azure.Management.Network.Fluent.IPublicIPAddress>.ListByResourceGroup(string resourceGroupName)
        {
        ...
        async Task<Microsoft.Azure.Management.Network.Fluent.IPublicIPAddress> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByResourceGroup<Microsoft.Azure.Management.Network.Fluent.IPublicIPAddress>.GetByResourceGroupAsync(string resourceGroupName, string name, CancellationToken cancellationToken)
        {
            return await this.GetByResourceGroupAsync(resourceGroupName, name, cancellationToken) as Microsoft.Azure.Management.Network.Fluent.IPublicIPAddress;
        }
