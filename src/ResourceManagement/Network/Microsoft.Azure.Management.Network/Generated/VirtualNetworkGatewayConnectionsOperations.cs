...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class VirtualNetworkGatewayConnectionsOperations : Microsoft.Rest.IServiceOperations<NetworkManagementClient>, IVirtualNetworkGatewayConnectionsOperations
    {
        ...
        {
            // Send Request
            Microsoft.Rest.Azure.AzureOperationResponse<VirtualNetworkGatewayConnection> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(
        ...
        {
            // Send Request
            Microsoft.Rest.Azure.AzureOperationResponse<ConnectionSharedKey> _response = await BeginSetSharedKeyWithHttpMessagesAsync(
                resourceGroupName, virtualNetworkGatewayConnectionName, parameters, customHeaders, cancellationToken);
            return await this.Client.GetPutOrPatchOperationResultAsync(_response,
                customHeaders,
                cancellationToken);
        ...
        {
            // Send request
            Microsoft.Rest.Azure.AzureOperationResponse<ConnectionResetSharedKey> _response = await BeginResetSharedKeyWithHttpMessagesAsync(
                resourceGroupName, virtualNetworkGatewayConnectionName, parameters, customHeaders, cancellationToken);
            return await this.Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken);
        }
