...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class UsagesOperations : IServiceOperations<NetworkManagementClient>, IUsagesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<Usage>>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/usages").ToString();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<Page1<Usage>>(_responseContent, this.Client.DeserializationSettings);
                }
