...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class LoadBalancingRule : SubResource
    {
        ...
        /// Initializes a new instance of the LoadBalancingRule class.
        /// </summary>
        public LoadBalancingRule(string name = default(string), string etag = default(string), SubResource frontendIPConfiguration = default(SubResource), SubResource backendAddressPool = default(SubResource), SubResource probe = default(SubResource), string protocol = default(string), string loadDistribution = default(string), int? frontendPort = default(int?), int? backendPort = default(int?), int? idleTimeoutInMinutes = default(int?), bool? enableFloatingIP = default(bool?), string provisioningState = default(string))
        {
            Name = name;
            Etag = etag;
