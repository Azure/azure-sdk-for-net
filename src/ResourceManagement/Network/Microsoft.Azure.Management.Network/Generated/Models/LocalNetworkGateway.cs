...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class LocalNetworkGateway : Resource
    {
        ...
        public LocalNetworkGateway(AddressSpace localNetworkAddressSpace, string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string gatewayIpAddress = default(string), BgpSettings bgpSettings = default(BgpSettings), string resourceGuid = default(string), string provisioningState = default(string), string etag = default(string))
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "LocalNetworkAddressSpace");
            }
        }
    }
}
