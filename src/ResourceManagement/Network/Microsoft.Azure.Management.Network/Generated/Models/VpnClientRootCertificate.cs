...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class VpnClientRootCertificate : SubResource
    {
        ...
        /// Initializes a new instance of the VpnClientRootCertificate class.
        /// </summary>
        public VpnClientRootCertificate(string id = default(string), string name = default(string), string etag = default(string), string publicCertData = default(string), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
