...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class Probe : SubResource
    {
        ...
        /// Initializes a new instance of the Probe class.
        /// </summary>
        public Probe(string protocol, int? port, string id = default(string), string name = default(string), string etag = default(string), IList<SubResource> loadBalancingRules = default(IList<SubResource>), int? intervalInSeconds = default(int?), int? numberOfProbes = default(int?), string requestPath = default(string), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
