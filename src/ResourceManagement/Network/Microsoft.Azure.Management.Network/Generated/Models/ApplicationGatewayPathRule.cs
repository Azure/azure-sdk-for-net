...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayPathRule : SubResource
    {
        ...
        /// Initializes a new instance of the ApplicationGatewayPathRule class.
        /// </summary>
        public ApplicationGatewayPathRule(string id = default(string), string name = default(string), string etag = default(string), IList<string> paths = default(IList<string>), SubResource backendAddressPool = default(SubResource), SubResource backendHttpSettings = default(SubResource), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
