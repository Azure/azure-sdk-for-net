...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class VpnClientRevokedCertificate : SubResource
    {
        ...
        /// class.
        /// </summary>
        public VpnClientRevokedCertificate(string id = default(string), string name = default(string), string etag = default(string), string thumbprint = default(string), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
