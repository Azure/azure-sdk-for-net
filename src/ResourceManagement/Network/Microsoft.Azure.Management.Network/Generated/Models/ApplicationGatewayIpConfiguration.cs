...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayIPConfiguration : SubResource
    {
        ...
        /// ApplicationGatewayIPConfiguration class.
        /// </summary>
        public ApplicationGatewayIPConfiguration(string id = default(string), string name = default(string), string etag = default(string), SubResource subnet = default(SubResource), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
