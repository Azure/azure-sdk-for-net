...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayFrontendPort : SubResource
    {
        ...
        /// class.
        /// </summary>
        public ApplicationGatewayFrontendPort(string id = default(string), string name = default(string), string etag = default(string), int? port = default(int?), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
