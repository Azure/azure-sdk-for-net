...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayFrontendPort : SubResource
    {
        ...
        /// class.
        /// </summary>
        public ApplicationGatewayFrontendPort(string name = default(string), string etag = default(string), int? port = default(int?), string provisioningState = default(string))
        {
            Name = name;
            Etag = etag;
            Port = port;
