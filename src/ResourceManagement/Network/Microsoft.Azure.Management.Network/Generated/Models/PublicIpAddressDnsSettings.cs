...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class PublicIPAddressDnsSettings
    {
        ...
        /// system.</param>
        /// <param name="fqdn">The FQDN (fully qualified domain name) of the A
        /// DNS record associated with the public IP. This is the
        ...
        /// <summary>
        /// Gets or sets the domain name label. The concatenation of the
        ...
        /// <summary>
        /// Gets or sets the FQDN (fully qualified domain name) of the A DNS
        /// record associated with the public IP. This is the concatenation
