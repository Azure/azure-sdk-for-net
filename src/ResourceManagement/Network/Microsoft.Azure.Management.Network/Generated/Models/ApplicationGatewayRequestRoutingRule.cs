...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayRequestRoutingRule : SubResource
    {
        ...
        /// ApplicationGatewayRequestRoutingRule class.
        /// </summary>
        public ApplicationGatewayRequestRoutingRule(string id = default(string), string name = default(string), string etag = default(string), string ruleType = default(string), SubResource backendAddressPool = default(SubResource), SubResource backendHttpSettings = default(SubResource), SubResource httpListener = default(SubResource), SubResource urlPathMap = default(SubResource), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
