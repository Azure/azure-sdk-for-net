...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class OutboundNatRule : SubResource
    {
        ...
        /// Initializes a new instance of the OutboundNatRule class.
        /// </summary>
        public OutboundNatRule(SubResource backendAddressPool, string id = default(string), string name = default(string), string etag = default(string), int? allocatedOutboundPorts = default(int?), IList<SubResource> frontendIPConfigurations = default(IList<SubResource>), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
