...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class Route : SubResource
    {
        ...
        /// <param name="addressPrefix">The destination CIDR to which the
        /// route applies.</param>
        /// <param name="nextHopIpAddress">The IP address packets should be
        /// forwarded to. Next hop values are only allowed in routes where
        /// the next hop type is VirtualAppliance.</param>
