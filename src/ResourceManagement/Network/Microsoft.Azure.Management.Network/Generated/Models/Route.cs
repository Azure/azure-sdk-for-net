...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class Route : SubResource
    {
        ...
        /// Initializes a new instance of the Route class.
        /// </summary>
        public Route(string nextHopType, string id = default(string), string name = default(string), string etag = default(string), string addressPrefix = default(string), string nextHopIpAddress = default(string), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
