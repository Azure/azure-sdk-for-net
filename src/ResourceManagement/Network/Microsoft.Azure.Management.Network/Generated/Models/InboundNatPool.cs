...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class InboundNatPool : SubResource
    {
        ...
        /// range of external ports that will be used to provide Inbound Nat
        /// to NICs associated with a load balancer. Acceptable values range
        /// between 1 and 65534.</param>
        /// <param name="frontendPortRangeEnd">The last port number in the
        /// range of external ports that will be used to provide Inbound Nat
        /// to NICs associated with a load balancer. Acceptable values range
        /// between 1 and 65535.</param>
        /// <param name="backendPort">The port used for internal connections
        /// on the endpoint. Acceptable values are between 1 and
        /// 65535.</param>
        ...
        /// that will be used to provide Inbound Nat to NICs associated with
