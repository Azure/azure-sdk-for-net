...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class InboundNatPool : SubResource
    {
        ...
        /// Initializes a new instance of the InboundNatPool class.
        /// </summary>
        public InboundNatPool(string protocol, int? frontendPortRangeStart, int? frontendPortRangeEnd, int? backendPort, string id = default(string), string name = default(string), string etag = default(string), SubResource frontendIPConfiguration = default(SubResource), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
