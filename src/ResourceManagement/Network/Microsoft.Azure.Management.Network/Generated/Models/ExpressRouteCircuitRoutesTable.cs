...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ExpressRouteCircuitRoutesTable
    {
        ...
        /// class.
        /// </summary>
        public ExpressRouteCircuitRoutesTable(string addressPrefix = default(string), string nextHopType = default(string), string nextHopIP = default(string), string asPath = default(string))
        {
