...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class SecurityRule : SubResource
    {
        ...
        /// Initializes a new instance of the SecurityRule class.
        /// </summary>
        public SecurityRule(string protocol, string sourceAddressPrefix, string destinationAddressPrefix, string access, string direction, string id = default(string), string name = default(string), string etag = default(string), string description = default(string), string sourcePortRange = default(string), string destinationPortRange = default(string), int? priority = default(int?), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
