...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayUrlPathMap : SubResource
    {
        ...
        public ApplicationGatewayUrlPathMap(string id = default(string), SubResource defaultBackendAddressPool = default(SubResource), SubResource defaultBackendHttpSettings = default(SubResource), System.Collections.Generic.IList<ApplicationGatewayPathRule> pathRules = default(System.Collections.Generic.IList<ApplicationGatewayPathRule>), string provisioningState = default(string), string name = default(string), string etag = default(string))
            : base(id)
        {
