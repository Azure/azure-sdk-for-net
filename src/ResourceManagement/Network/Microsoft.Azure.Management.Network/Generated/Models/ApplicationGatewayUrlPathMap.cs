...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewayUrlPathMap : SubResource
    {
        ...
        /// class.
        /// </summary>
        public ApplicationGatewayUrlPathMap(string id = default(string), string name = default(string), string etag = default(string), SubResource defaultBackendAddressPool = default(SubResource), SubResource defaultBackendHttpSettings = default(SubResource), IList<ApplicationGatewayPathRule> pathRules = default(IList<ApplicationGatewayPathRule>), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
