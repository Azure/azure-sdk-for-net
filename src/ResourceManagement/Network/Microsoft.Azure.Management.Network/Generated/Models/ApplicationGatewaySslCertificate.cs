...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewaySslCertificate : SubResource
    {
        ...
        /// <param name="data">Base-64 encoded pfx certificate. Only
        /// applicable in PUT Request.</param>
        /// <param name="password">Password for the pfx file specified in
        /// data. Only applicable in PUT request.</param>
