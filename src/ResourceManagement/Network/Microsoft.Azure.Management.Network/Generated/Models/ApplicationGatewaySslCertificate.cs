...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class ApplicationGatewaySslCertificate : SubResource
    {
        ...
        /// class.
        /// </summary>
        public ApplicationGatewaySslCertificate(string id = default(string), string name = default(string), string etag = default(string), string data = default(string), string password = default(string), string publicCertData = default(string), string provisioningState = default(string))
            : base(id)
        {
            Name = name;
            Etag = etag;
