...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class InboundNatRule : SubResource
    {
        ...
        /// address defined on a network interface of a VM. Traffic sent to
        /// the frontend port of each of the frontend IP configurations is
        ...
        /// 'Udp', 'Tcp'</param>
        /// <param name="frontendPort">The port for the external endpoint.
        /// Port numbers for each Rule must be unique within the Load
        /// Balancer. Acceptable values range from 1 to 65534.</param>
        ...
        /// interface of a VM. Traffic sent to the frontend port of each of
        /// the frontend IP configurations is forwarded to the backed IP.
        /// </summary>
        ...
        /// minutes. This element is only used when the protocol is set to
        /// TCP.
        /// </summary>
