...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class UsagesOperationsExtensions
    {
            ...
            /// </param>
            public static IEnumerable<Usage> List(this IUsagesOperations operations, string location)
            {
            ...
            /// </param>
            public static async Task<IEnumerable<Usage>> ListAsync(this IUsagesOperations operations, string location, CancellationToken cancellationToken = default(CancellationToken))
            {
