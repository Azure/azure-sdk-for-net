...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class RouteFiltersOperationsExtensions
    {
            ...
            {
                await operations.DeleteWithHttpMessagesAsync(resourceGroupName, routeFilterName, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, routeFilterName, null, cancellationToken).ConfigureAwait(false);
            }
