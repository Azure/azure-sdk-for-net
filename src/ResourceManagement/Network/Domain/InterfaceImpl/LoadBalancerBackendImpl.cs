...
namespace Microsoft.Azure.Management.Network.Fluent
{
    ...
    internal partial class LoadBalancerBackendImpl 
    {
        ...
        /// <param name="vms">Existing virtual machines.</param>
        /// <return>The next stage of the definition.</return>
        LoadBalancerBackend.Definition.IWithAttach<LoadBalancer.Definition.IWithCreate> LoadBalancerBackend.Definition.IWithVirtualMachineBeta<LoadBalancer.Definition.IWithCreate>.WithExistingVirtualMachines(IList<Microsoft.Azure.Management.Network.Fluent.IHasNetworkInterfaces> vms)
        {
            return this.WithExistingVirtualMachines(vms) as LoadBalancerBackend.Definition.IWithAttach<LoadBalancer.Definition.IWithCreate>;
        }
        ...
        /// <param name="vms">Existing virtual machines.</param>
        /// <return>The next stage of the definition.</return>
        LoadBalancerBackend.UpdateDefinition.IWithAttach<LoadBalancer.Update.IUpdate> LoadBalancerBackend.UpdateDefinition.IWithVirtualMachineBeta<LoadBalancer.Update.IUpdate>.WithExistingVirtualMachines(IList<Microsoft.Azure.Management.Network.Fluent.IHasNetworkInterfaces> vms)
        {
            return this.WithExistingVirtualMachines(vms) as LoadBalancerBackend.UpdateDefinition.IWithAttach<LoadBalancer.Update.IUpdate>;
        }
