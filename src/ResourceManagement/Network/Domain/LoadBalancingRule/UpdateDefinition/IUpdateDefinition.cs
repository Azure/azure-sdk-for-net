...
namespace Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.UpdateDefinition
{
        ...
        Microsoft.Azure.Management.ResourceManager.Fluent.Core.IBeta
    {
        ...
        /// <param name="vms">Existing virtual machines.</param>
        /// <return>The next stage of the definition.</return>
        Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.UpdateDefinition.IWithBackendPort<ReturnT> ToExistingVirtualMachines(IList<Microsoft.Azure.Management.Network.Fluent.IHasNetworkInterfaces> vms);
    }
}