...
namespace Microsoft.Azure.Management.CognitiveServices.Fluent
{
    ...
    internal partial class CheckSkuAvailabilityOperations : IServiceOperations<CognitiveServicesManagementClient>, ICheckSkuAvailabilityOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CheckSkuAvailabilityResultListInner>> ListWithHttpMessagesAsync(IList<string> skus, string kind, string type, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<CheckSkuAvailabilityResultListInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<CheckSkuAvailabilityResultListInner>(_responseContent, Client.DeserializationSettings);
                }
