...
namespace Microsoft.Azure.Management.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesAccount : IResource
    {
        ...
        /// Initializes a new instance of the CognitiveServicesAccount class.
        /// </summary>
        public CognitiveServicesAccount(string etag = default(string), string id = default(string), string kind = default(string), string location = default(string), string name = default(string), Sku sku = default(Sku), IDictionary<string, string> tags = default(IDictionary<string, string>), string type = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), string endpoint = default(string))
        {
            Etag = etag;
            Id = id;
            Kind = kind;
