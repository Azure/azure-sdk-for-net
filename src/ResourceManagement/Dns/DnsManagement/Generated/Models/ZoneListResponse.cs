...
namespace Microsoft.Azure.Management.Dns.Models
{
    ...
    /// </summary>
    public partial class ZoneListResponse : AzureOperationResponse
    {
        ...
        {
            this.Zones = new LazyList<Zone>();
        }
        
        /// <summary>
        /// Initializes a new instance of the ZoneListResponse class with
        /// required arguments.
        /// </summary>
        public ZoneListResponse(IList<Zone> zones)
            : this()
        {
            if (zones == null)
            {
