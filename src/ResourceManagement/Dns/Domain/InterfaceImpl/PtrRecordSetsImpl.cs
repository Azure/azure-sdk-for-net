...
namespace Microsoft.Azure.Management.Dns.Fluent
{
    ...
    internal partial class PtrRecordSetsImpl 
    {
        ...
        Task<Microsoft.Azure.Management.Dns.Fluent.IPtrRecordSet> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByName<Microsoft.Azure.Management.Dns.Fluent.IPtrRecordSet>.GetByNameAsync(string name, CancellationToken cancellationToken)
        {
            return this.GetByNameAsync(name, cancellationToken) as Task<Microsoft.Azure.Management.Dns.Fluent.IPtrRecordSet>;
        }
    }
}