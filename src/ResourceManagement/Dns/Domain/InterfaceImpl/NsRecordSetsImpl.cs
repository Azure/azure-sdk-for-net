...
namespace Microsoft.Azure.Management.Dns.Fluent
{
    ...
    internal partial class NSRecordSetsImpl 
    {
        ...
        Task<Microsoft.Azure.Management.Dns.Fluent.INSRecordSet> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByName<Microsoft.Azure.Management.Dns.Fluent.INSRecordSet>.GetByNameAsync(string name, CancellationToken cancellationToken)
        {
            return this.GetByNameAsync(name, cancellationToken) as Task<Microsoft.Azure.Management.Dns.Fluent.INSRecordSet>;
        }
    }
}