...
namespace Microsoft.Azure.Management.Dns.Fluent
{
    ...
    internal partial class CNameRecordSetsImpl 
    {
        ...
        Task<Microsoft.Azure.Management.Dns.Fluent.ICNameRecordSet> Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingByName<Microsoft.Azure.Management.Dns.Fluent.ICNameRecordSet>.GetByNameAsync(string name, CancellationToken cancellationToken)
        {
            return this.GetByNameAsync(name, cancellationToken) as Task<Microsoft.Azure.Management.Dns.Fluent.ICNameRecordSet>;
        }
    }
}