...
namespace Microsoft.Azure.Management.Dns.Fluent
{
    ...
    public static partial class RecordSetsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<RecordSetInner> UpdateAsync(this IRecordSetsOperations operations, string resourceGroupName, string zoneName, string relativeRecordSetName, RecordType recordType, RecordSetInner parameters, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// to 100 record sets.
            /// </param>
            public static IPage<RecordSetInner> ListByType(this IRecordSetsOperations operations, string resourceGroupName, string zoneName, RecordType recordType, int? top = default(int?))
            {
                return operations.ListByTypeAsync(resourceGroupName, zoneName, recordType, top).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<RecordSetInner>> ListByTypeAsync(this IRecordSetsOperations operations, string resourceGroupName, string zoneName, RecordType recordType, int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// to 100 record sets.
            /// </param>
            public static IPage<RecordSetInner> ListByDnsZone(this IRecordSetsOperations operations, string resourceGroupName, string zoneName, int? top = default(int?))
            {
                return operations.ListByDnsZoneAsync(resourceGroupName, zoneName, top).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<RecordSetInner>> ListByDnsZoneAsync(this IRecordSetsOperations operations, string resourceGroupName, string zoneName, int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<RecordSetInner>> ListByTypeNextAsync(this IRecordSetsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<RecordSetInner>> ListByDnsZoneNextAsync(this IRecordSetsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
