...
namespace Microsoft.Azure.Management.Dns.Fluent
{
    ...
    public partial interface IRecordSetsOperations
    {
        ...
        /// The type of DNS record in this record set. Possible values
        /// include: 'A', 'AAAA', 'CNAME', 'MX', 'NS', 'PTR', 'SOA', 'SRV',
        /// 'TXT'
        /// </param>
        ...
        /// </param>
        /// <param name='ifMatch'>
        /// The etag of the record set. Omit this value to always overwrite
        ...
        /// can be updated but not created (they are created when the DNS
        /// zone is created). Possible values include: 'A', 'AAAA', 'CNAME',
        ...
        /// <param name='recordType'>
        /// The type of DNS record in this record set. Record sets of type SOA
        /// cannot be deleted (they are deleted when the DNS zone is
