...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LmRucy5pbXBsZW1lbnRhdGlvbi5EbnNab25lc0ltcGw=
    internal partial class DnsZonesImpl  :
        GroupableResources<IDnsZone,DnsZoneImpl,ZoneInner,ZonesInner,DnsZoneManager>,
        IDnsZones
    {
        ...
        public async Task<IDnsZone> GetByGroupAsync(string groupName, string name, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        internal  DnsZonesImpl(DnsManagementClientImpl dnsManagementClient, DnsZoneManager dnsZoneManager)
        {
            //$ {
