    ...
    internal partial class JobOperations : IServiceOperations<HDInsightJobManagementClient>, IJobOperations
    {
        ...
        public async Task<JobGetResponse> GetJobAsync(string jobId, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                httpRequest.Headers.Add("useragent", "xplat get job");
                httpRequest.Headers.Add("User-Agent", "xplat get job");
        ...
        public async Task<JobListResponse> ListJobsAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                // Set Headers
                httpRequest.Headers.Add("accept", "application/json");
                httpRequest.Headers.Add("useragent", "xplat list jobs");
                httpRequest.Headers.Add("User-Agent", "xplat list jobs");
        ...
        public async Task<JobSubmissionResponse> SubmitHiveJobAsync(HiveJobSubmissionParameters parameters, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                // Set Headers
                httpRequest.Headers.Add("accept", "application/json");
                httpRequest.Headers.Add("useragent", "xplat Hive job submission");
                httpRequest.Headers.Add("User-Agent", "xplat Hive job submission");
        ...
        public async Task<JobSubmissionResponse> SubmitMapReduceJobAsync(MapReduceJobSubmissionParameters parameters, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                // Set Headers
                httpRequest.Headers.Add("accept", "application/json");
                httpRequest.Headers.Add("useragent", "xplat MapReduce job submission");
                httpRequest.Headers.Add("User-Agent", "xplat MapReduce job submission");
        ...
        public async Task<JobSubmissionResponse> SubmitMapReduceStreamingJobAsync(MapReduceStreamingJobSubmissionParameters parameters, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                // Set Headers
                httpRequest.Headers.Add("accept", "application/json");
                httpRequest.Headers.Add("useragent", "xplat MapReduce streaming job submission");
                httpRequest.Headers.Add("User-Agent", "xplat MapReduce streaming job submission");
