...
namespace Microsoft.Azure.Management.StorSimple.Fluent
{
    ...
    public partial interface IAccessControlRecordsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IEnumerable<AccessControlRecordInner>>> ListByManagerWithHttpMessagesAsync(string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<AccessControlRecordInner>> GetWithHttpMessagesAsync(string accessControlRecordName, string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<AccessControlRecordInner>> BeginCreateOrUpdateWithHttpMessagesAsync(string accessControlRecordName, AccessControlRecordInner parameters, string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Deletes the access control record.
        /// </summary>
        /// <param name='accessControlRecordName'>
