...
namespace Microsoft.Azure.Management.StorSimple.Fluent
{
    ...
    internal partial class StorageAccountCredentialsOperations : IServiceOperations<StorSimple8000SeriesManagementClient>, IStorageAccountCredentialsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<StorageAccountCredentialInner>>> ListByManagerWithHttpMessagesAsync(string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<StorageAccountCredentialInner>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<StorageAccountCredentialInner>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<StorageAccountCredentialInner>> GetWithHttpMessagesAsync(string storageAccountCredentialName, string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<StorageAccountCredentialInner>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<StorageAccountCredentialInner>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<StorageAccountCredentialInner>> CreateOrUpdateWithHttpMessagesAsync(string storageAccountCredentialName, StorageAccountCredentialInner parameters, string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<StorageAccountCredentialInner> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(storageAccountCredentialName, parameters, resourceGroupName, managerName, customHeaders, cancellationToken).ConfigureAwait(false);
