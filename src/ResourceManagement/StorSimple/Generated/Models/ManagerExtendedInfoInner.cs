...
namespace Microsoft.Azure.Management.StorSimple.Fluent.Models
{
    ...
    public partial class ManagerExtendedInfoInner : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the ManagerExtendedInfoInner class.
        /// </summary>
        ...
        public ManagerExtendedInfoInner(string integrityKey, string algorithm, string id = default(string), string name = default(string), string type = default(string), Kind? kind = default(Kind?), string version = default(string), string encryptionKey = default(string), string encryptionKeyThumbprint = default(string), string portalCertificateThumbprint = default(string), string etag = default(string))
