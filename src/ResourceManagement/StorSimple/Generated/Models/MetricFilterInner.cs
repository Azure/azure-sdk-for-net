...
namespace Microsoft.Azure.Management.StorSimple.Fluent.Models
{
    ...
    /// </summary>
    public partial class MetricFilterInner
    {
        /// <summary>
        /// Initializes a new instance of the MetricFilterInner class.
        /// </summary>
        public MetricFilterInner()
        {
          CustomInit();
        }
        ...
        /// this property.</param>
        public MetricFilterInner(string category, MetricNameFilter name = default(MetricNameFilter), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), string timeGrain = default(string), DimensionFilter dimensions = default(DimensionFilter))
        {
            Name = name;
            StartTime = startTime;
            EndTime = endTime;
