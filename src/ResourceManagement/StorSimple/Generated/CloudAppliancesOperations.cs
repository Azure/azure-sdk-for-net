...
namespace Microsoft.Azure.Management.StorSimple.Fluent
{
    ...
    internal partial class CloudAppliancesOperations : IServiceOperations<StorSimple8000SeriesManagementClient>, ICloudAppliancesOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse> ProvisionWithHttpMessagesAsync(CloudApplianceInner parameters, string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> BeginProvisionWithHttpMessagesAsync(CloudApplianceInner parameters, string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (parameters == null)
            {
