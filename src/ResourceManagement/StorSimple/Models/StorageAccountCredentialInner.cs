...
namespace Microsoft.Azure.Management.StorSimple.Fluent.Models
{
    ...
    public partial class StorageAccountCredentialInner : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the StorageAccountCredentialInner
        /// class.
        /// </summary>
        ...
        public StorageAccountCredentialInner(string endPoint, SslStatus sslStatus, string id = default(string), string name = default(string), string type = default(string), Kind? kind = default(Kind?), AsymmetricEncryptedSecret accessKey = default(AsymmetricEncryptedSecret), int? volumesCount = default(int?))
