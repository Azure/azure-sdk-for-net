...
namespace Microsoft.Azure.Management.StorSimple.Fluent
{
    ...
    public partial class StorSimple8000SeriesManagementClient : ServiceClient<StorSimple8000SeriesManagementClient>, IStorSimple8000SeriesManagementClient, IAzureClient
    {
        ...
        /// </param>
        protected StorSimple8000SeriesManagementClient(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected StorSimple8000SeriesManagementClient(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        protected StorSimple8000SeriesManagementClient(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        protected StorSimple8000SeriesManagementClient(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public StorSimple8000SeriesManagementClient(ServiceClientCredentials credentials, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (credentials == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public StorSimple8000SeriesManagementClient(ServiceClientCredentials credentials, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public StorSimple8000SeriesManagementClient(System.Uri baseUri, ServiceClientCredentials credentials, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public StorSimple8000SeriesManagementClient(System.Uri baseUri, ServiceClientCredentials credentials, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
