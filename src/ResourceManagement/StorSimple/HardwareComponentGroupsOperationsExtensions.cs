...
namespace Microsoft.Azure.Management.StorSimple.Fluent
{
    ...
    public static partial class HardwareComponentGroupsOperationsExtensions
    {
            ...
            /// The manager name
            /// </param>
            public static void ChangeControllerPowerState(this IHardwareComponentGroupsOperations operations, string deviceName, string hardwareComponentGroupName, ControllerPowerStateChangeRequestInner parameters, string resourceGroupName, string managerName)
            {
            ...
            /// The manager name
            /// </param>
            public static void BeginChangeControllerPowerState(this IHardwareComponentGroupsOperations operations, string deviceName, string hardwareComponentGroupName, ControllerPowerStateChangeRequestInner parameters, string resourceGroupName, string managerName)
            {
