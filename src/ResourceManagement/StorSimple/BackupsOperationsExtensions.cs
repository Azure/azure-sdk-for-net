...
namespace Microsoft.Azure.Management.StorSimple.Fluent
{
    ...
    public static partial class BackupsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<Backup> ListByDevice(this IBackupsOperations operations, string deviceName, string resourceGroupName, string managerName, ODataQuery<BackupFilterInner> odataQuery = default(ODataQuery<BackupFilterInner>))
            {
                return ((IBackupsOperations)operations).ListByDeviceAsync(deviceName, resourceGroupName, managerName, odataQuery).GetAwaiter().GetResult();
            }
            ...
            /// The manager name
            /// </param>
            public static void Clone(this IBackupsOperations operations, string deviceName, string backupName, string backupElementName, CloneRequestInner parameters, string resourceGroupName, string managerName)
            {
            ...
            /// The manager name
            /// </param>
            public static void BeginClone(this IBackupsOperations operations, string deviceName, string backupName, string backupElementName, CloneRequestInner parameters, string resourceGroupName, string managerName)
            {
