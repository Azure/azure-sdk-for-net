...
namespace Microsoft.Azure.Management.Search.Fluent
{
    ...
    internal partial class AdminKeysOperations : IServiceOperations<SearchManagementClient>, IAdminKeysOperations
    {
        ...
        public async Task<AzureOperationResponse<AdminKeyResultInner>> GetWithHttpMessagesAsync(string resourceGroupName, string searchServiceName, SearchManagementRequestOptionsInner searchManagementRequestOptions = default(SearchManagementRequestOptionsInner), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<AdminKeyResultInner>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<AdminKeyResultInner>(_responseContent, Client.DeserializationSettings);
                }
