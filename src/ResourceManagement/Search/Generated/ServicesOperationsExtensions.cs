...
namespace Microsoft.Azure.Management.Search.Fluent
{
    ...
    public static partial class ServicesOperationsExtensions
    {
            ...
            /// </param>
            public static SearchServiceInner CreateOrUpdate(this IServicesOperations operations, string resourceGroupName, string searchServiceName, SearchServiceInner service, SearchManagementRequestOptionsInner searchManagementRequestOptions = default(SearchManagementRequestOptionsInner))
            {
            ...
            /// Additional parameters for the operation
            /// </param>
            public static SearchServiceInner Get(this IServicesOperations operations, string resourceGroupName, string searchServiceName, SearchManagementRequestOptionsInner searchManagementRequestOptions = default(SearchManagementRequestOptionsInner))
            {
            ...
            /// Additional parameters for the operation
            /// </param>
            public static void Delete(this IServicesOperations operations, string resourceGroupName, string searchServiceName, SearchManagementRequestOptionsInner searchManagementRequestOptions = default(SearchManagementRequestOptionsInner))
            {
            ...
            /// Additional parameters for the operation
            /// </param>
            public static IEnumerable<SearchServiceInner> ListByResourceGroup(this IServicesOperations operations, string resourceGroupName, SearchManagementRequestOptionsInner searchManagementRequestOptions = default(SearchManagementRequestOptionsInner))
            {
            ...
            /// Additional parameters for the operation
            /// </param>
            public static CheckNameAvailabilityOutputInner CheckNameAvailability(this IServicesOperations operations, string name, SearchManagementRequestOptionsInner searchManagementRequestOptions = default(SearchManagementRequestOptionsInner))
            {
