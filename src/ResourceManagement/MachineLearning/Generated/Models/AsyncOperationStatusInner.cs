...
namespace Microsoft.Azure.Management.MachineLearning.Fluent.Models
{
    ...
    /// </summary>
    public partial class AsyncOperationStatusInner
    {
        /// <summary>
        /// Initializes a new instance of the AsyncOperationStatusInner class.
        /// </summary>
        ...
        public AsyncOperationStatusInner(string id = default(string), string name = default(string), string provisioningState = default(string), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?), double? percentComplete = default(double?), AsyncOperationErrorInfo errorInfo = default(AsyncOperationErrorInfo))
        {
            Id = id;
            Name = name;
