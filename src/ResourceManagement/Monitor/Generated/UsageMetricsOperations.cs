...
namespace Microsoft.Azure.Management.Fluent.ServiceBus
{
    ...
    internal partial class UsageMetricsOperations : IServiceOperations<MonitorClient>, IUsageMetricsOperations
    {
        ...
        public async Task<AzureOperationResponse<IEnumerable<UsageMetricInner>>> ListWithHttpMessagesAsync(string resourceUri, string apiVersion, ODataQuery<UsageMetricInner> odataQuery = default(ODataQuery<UsageMetricInner>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<UsageMetricInner>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<UsageMetricInner>>(_responseContent, Client.DeserializationSettings);
                }
