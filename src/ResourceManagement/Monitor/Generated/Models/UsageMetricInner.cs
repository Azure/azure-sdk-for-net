...
namespace Microsoft.Azure.Management.Fluent.ServiceBus.Models
{
    ...
    /// Usage Metric data.
    /// </summary>
    public partial class UsageMetricInner
    {
        /// <summary>
        /// Initializes a new instance of the UsageMetricInner class.
        /// </summary>
        ...
        /// value.</param>
        public UsageMetricInner(LocalizableString name = default(LocalizableString), double? currentValue = default(double?), string id = default(string), double? limit = default(double?), string unit = default(string), System.DateTime? nextResetTime = default(System.DateTime?), System.TimeSpan? quotaPeriod = default(System.TimeSpan?))
        {
            Name = name;
