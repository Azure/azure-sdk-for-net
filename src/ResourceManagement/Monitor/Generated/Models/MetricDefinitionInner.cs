...
namespace Microsoft.Azure.Management.Fluent.ServiceBus.Models
{
    ...
    public partial class MetricDefinitionInner
    {
        ...
        /// definition.</param>
        public MetricDefinitionInner(string resourceId = default(string), LocalizableString name = default(LocalizableString), Unit? unit = default(Unit?), AggregationType? primaryAggregationType = default(AggregationType?), IList<MetricAvailability> metricAvailabilities = default(IList<MetricAvailability>), string id = default(string))
        {
