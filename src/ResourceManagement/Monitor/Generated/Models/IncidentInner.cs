...
namespace Microsoft.Azure.Management.Fluent.ServiceBus.Models
{
    ...
    /// </summary>
    public partial class IncidentInner
    {
        /// <summary>
        /// Initializes a new instance of the IncidentInner class.
        /// </summary>
        ...
        /// active.</param>
        public IncidentInner(string name = default(string), string ruleName = default(string), bool? isActive = default(bool?), System.DateTime? activatedTime = default(System.DateTime?), System.DateTime? resolvedTime = default(System.DateTime?))
        {
            Name = name;
            RuleName = ruleName;
            IsActive = isActive;
