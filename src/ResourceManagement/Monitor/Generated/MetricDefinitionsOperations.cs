...
namespace Microsoft.Azure.Management.Fluent.ServiceBus
{
    ...
    internal partial class MetricDefinitionsOperations : IServiceOperations<MonitorClient>, IMetricDefinitionsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<MetricDefinitionInner>>> ListWithHttpMessagesAsync(string resourceUri, ODataQuery<MetricDefinitionInner> odataQuery = default(ODataQuery<MetricDefinitionInner>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceUri == null)
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<MetricDefinitionInner>>(_responseContent, Client.DeserializationSettings);
                }
