...
namespace Monitor.Tests.BasicTests
{
    public class DiagnosticSettingsTests : TestBase
    {
        ...
        public void DiagnosticSettings_PutTest()
        {
            ...
            DiagnosticSettingsResource response = insightsClient.DiagnosticSettings.CreateOrUpdate(resourceUri: ResourceUri, name: "service", parameters: parameters);
        ...
        public void DiagnosticSettings_DeleteTest()
        {
            ...
            insightsClient.DiagnosticSettings.Delete(resourceUri: ResourceUri, name: "service");
        }
