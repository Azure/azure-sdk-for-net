...
namespace Microsoft.Azure.Management.Insights.Models
{
    ...
    public partial class LogProfileResource : Resource
    {
        ...
        /// in the log.</param>
        public LogProfileResource(string location, IList<string> locations, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string storageAccountId = default(string), string serviceBusRuleId = default(string), IList<string> categories = default(IList<string>), RetentionPolicy retentionPolicy = default(RetentionPolicy))
