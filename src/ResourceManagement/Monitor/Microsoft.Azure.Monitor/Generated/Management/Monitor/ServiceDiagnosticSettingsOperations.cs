    ...
    internal partial class ServiceDiagnosticSettingsOperations : IServiceOperations<MonitorManagementClient>, IServiceDiagnosticSettingsOperations
    {
        ...
        public async Task<AzureOperationResponse<ServiceDiagnosticSettingsResource>> UpdateWithHttpMessagesAsync(string resourceUri, ServiceDiagnosticSettingsResource serviceDiagnosticSettingsResource, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("resourceUri", resourceUri);
                tracingParameters.Add("apiVersion", apiVersion);
                tracingParameters.Add("serviceDiagnosticSettingsResource", serviceDiagnosticSettingsResource);
                tracingParameters.Add("cancellationToken", cancellationToken);
            ...
            if(serviceDiagnosticSettingsResource != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(serviceDiagnosticSettingsResource, Client.SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType =System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
