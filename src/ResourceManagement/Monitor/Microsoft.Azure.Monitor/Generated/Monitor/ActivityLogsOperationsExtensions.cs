...
namespace Microsoft.Azure.Insights
{
   ...
   using Models;
    ...
    public static partial class ActivityLogsOperationsExtensions
    {
            ...
            {
                return System.Threading.Tasks.Task.Factory.StartNew(s => ((IActivityLogsOperations)s).ListAsync(odataQuery, select), operations, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskCreationOptions.None, System.Threading.Tasks.TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                return System.Threading.Tasks.Task.Factory.StartNew(s => ((IActivityLogsOperations)s).ListNextAsync(nextPageLink), operations, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskCreationOptions.None, System.Threading.Tasks.TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Microsoft.Rest.Azure.IPage<EventData>> ListNextAsync(this IActivityLogsOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
