...
namespace Microsoft.Azure.Insights
{
    ...
    /// </summary>
    internal partial class UsageMetricsOperations : IServiceOperations<MonitorClient>, IUsageMetricsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<UsageMetric>>> ListWithHttpMessagesAsync(string resourceUri, string apiVersion, ODataQuery<UsageMetric> odataQuery = default(ODataQuery<UsageMetric>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceUri == null)
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<UsageMetric>>(_responseContent, Client.DeserializationSettings);
                }
