...
namespace Microsoft.Azure.Monitor
{
   ...
   using Models;
    ...
    public static partial class TenantActivityLogsOperationsExtensions
    {
            ...
            /// </param>
            public static Microsoft.Rest.Azure.IPage<EventData> List(this ITenantActivityLogsOperations operations, Microsoft.Rest.Azure.OData.ODataQuery<EventData> odataQuery = default(Microsoft.Rest.Azure.OData.ODataQuery<EventData>), string select = default(string))
            {
                return System.Threading.Tasks.Task.Factory.StartNew(s => ((ITenantActivityLogsOperations)s).ListAsync(odataQuery, select), operations, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskCreationOptions.None, System.Threading.Tasks.TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static Microsoft.Rest.Azure.IPage<EventData> ListNext(this ITenantActivityLogsOperations operations, string nextPageLink)
            {
                return System.Threading.Tasks.Task.Factory.StartNew(s => ((ITenantActivityLogsOperations)s).ListNextAsync(nextPageLink), operations, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskCreationOptions.None, System.Threading.Tasks.TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Microsoft.Rest.Azure.IPage<EventData>> ListNextAsync(this ITenantActivityLogsOperations operations, string nextPageLink, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
