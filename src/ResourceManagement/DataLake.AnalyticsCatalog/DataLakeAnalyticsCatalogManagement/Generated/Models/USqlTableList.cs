...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class USqlTableList : CatalogItemList
    {
        private IList<USqlTable> _value;
        
        /// <summary>
        /// Optional. Gets or sets the list of tables in the database and
        /// schema combination
        /// </summary>
        public IList<USqlTable> Value
        {
        ...
        /// </summary>
        public USqlTableList()
        {
            this.Value = new LazyList<USqlTable>();
        }
    }
}
