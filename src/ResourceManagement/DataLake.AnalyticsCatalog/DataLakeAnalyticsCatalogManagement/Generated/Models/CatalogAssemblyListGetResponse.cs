...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class CatalogAssemblyListGetResponse : AzureOperationResponse
    {
        private USqlAssemblyList _assemblyList;
        
        /// <summary>
        /// Optional. Gets or sets the resulting list of assemblies.
        /// </summary>
        public USqlAssemblyList AssemblyList
        {
            get { return this._assemblyList; }
            set { this._assemblyList = value; }
        }
        ...
        /// class.
        /// </summary>
        public CatalogAssemblyListGetResponse()
        {
        }
    }
}
