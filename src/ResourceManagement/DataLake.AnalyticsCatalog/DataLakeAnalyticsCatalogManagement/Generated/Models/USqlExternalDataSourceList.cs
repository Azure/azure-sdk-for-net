...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class USqlExternalDataSourceList : CatalogItemList
    {
        private IList<USqlExternalDataSource> _value;
        
        /// <summary>
        /// Optional. Gets or sets the list of external data sources in the
        /// database
        /// </summary>
        public IList<USqlExternalDataSource> Value
        {
        ...
        {
            this.Value = new LazyList<USqlExternalDataSource>();
        }
    }
}
