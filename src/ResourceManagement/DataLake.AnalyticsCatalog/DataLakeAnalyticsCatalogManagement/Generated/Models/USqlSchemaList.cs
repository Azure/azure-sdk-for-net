...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class USqlSchemaList : CatalogItemList
    {
        private IList<USqlSchema> _value;
        
        /// <summary>
        /// Optional. Gets or sets the list of schemas in the database
        /// </summary>
        public IList<USqlSchema> Value
        {
        ...
        /// </summary>
        public USqlSchemaList()
        {
            this.Value = new LazyList<USqlSchema>();
        }
    }
}
