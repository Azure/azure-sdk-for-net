...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class USqlAssemblyList : CatalogItemList
    {
        private IList<USqlAssemblyClr> _value;
        
        /// <summary>
        /// Optional. Gets or sets the list of assemblies in the database
        /// </summary>
        public IList<USqlAssemblyClr> Value
        {
        ...
        {
            this.Value = new LazyList<USqlAssemblyClr>();
        }
    }
}
