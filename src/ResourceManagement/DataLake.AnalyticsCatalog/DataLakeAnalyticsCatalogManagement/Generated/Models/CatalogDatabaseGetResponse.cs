...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class CatalogDatabaseGetResponse : AzureOperationResponse
    {
        private USqlDatabase _database;
        
        /// <summary>
        /// Optional. Gets or sets the resulting database from the get.
        /// </summary>
        public USqlDatabase Database
        {
        ...
        /// </summary>
        public CatalogDatabaseGetResponse()
        {
        }
    }
}
