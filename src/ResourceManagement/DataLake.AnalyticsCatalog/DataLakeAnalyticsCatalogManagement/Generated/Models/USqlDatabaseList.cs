...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class USqlDatabaseList : CatalogItemList
    {
        private IList<USqlDatabase> _value;
        
        /// <summary>
        /// Optional. Gets or sets the list of databases
        /// </summary>
        public IList<USqlDatabase> Value
        {
        ...
        {
            this.Value = new LazyList<USqlDatabase>();
        }
    }
}
