...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class CatalogTableListResponse : AzureOperationResponse
    {
        private USqlTableList _tableList;
        
        /// <summary>
        /// Optional. Gets or sets the resulting list of tables.
        /// </summary>
        public USqlTableList TableList
        {
        ...
        /// </summary>
        public CatalogTableListResponse()
        {
        }
    }
}
