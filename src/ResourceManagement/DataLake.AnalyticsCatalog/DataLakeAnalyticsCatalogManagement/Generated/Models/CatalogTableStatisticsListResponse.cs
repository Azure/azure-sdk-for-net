...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class CatalogTableStatisticsListResponse : AzureOperationResponse
    {
        private USqlTableStatisticsList _statisticsList;
        
        /// <summary>
        /// Optional. Gets or sets the resulting list of table statistics.
        /// </summary>
        public USqlTableStatisticsList StatisticsList
        {
            get { return this._statisticsList; }
            set { this._statisticsList = value; }
        }
        ...
        /// </summary>
        public CatalogTableStatisticsListResponse()
        {
        }
    }
}
