...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class USqlTableStatisticsList : CatalogItemList
    {
        private IList<USqlTableStatistics> _value;
        
        /// <summary>
        /// Optional. Gets or sets the list of table statistics in the
        /// database, schema and table combination
        /// </summary>
        public IList<USqlTableStatistics> Value
        {
        ...
        /// </summary>
        public USqlTableStatisticsList()
        {
            this.Value = new LazyList<USqlTableStatistics>();
        }
    }
}
