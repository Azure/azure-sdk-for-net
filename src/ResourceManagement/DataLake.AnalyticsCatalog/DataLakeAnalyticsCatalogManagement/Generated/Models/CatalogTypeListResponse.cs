...
namespace Microsoft.Azure.Management.DataLake.AnalyticsCatalog.Models
{
    ...
    /// </summary>
    public partial class CatalogTypeListResponse : AzureOperationResponse
    {
        private USqlTypeList _typeList;
        
        /// <summary>
        /// Optional. Gets or sets the resulting list of types.
        /// </summary>
        public USqlTypeList TypeList
        {
        ...
        /// </summary>
        public CatalogTypeListResponse()
        {
        }
    }
}
