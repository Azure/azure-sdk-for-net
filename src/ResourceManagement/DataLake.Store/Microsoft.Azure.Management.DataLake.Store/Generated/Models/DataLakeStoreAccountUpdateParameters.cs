...
namespace Microsoft.Azure.Management.DataLake.Store.Models
{
    ...
    public partial class DataLakeStoreAccountUpdateParameters
    {
        ...
        public DataLakeStoreAccountUpdateParameters(IDictionary<string, string> tags = default(IDictionary<string, string>), FirewallState? firewallState = default(FirewallState?), TrustedIdProviderState? trustedIdProviderState = default(TrustedIdProviderState?), string defaultGroup = default(string), PricingTierType? newTier = default(PricingTierType?))
        {
            Tags = tags;
