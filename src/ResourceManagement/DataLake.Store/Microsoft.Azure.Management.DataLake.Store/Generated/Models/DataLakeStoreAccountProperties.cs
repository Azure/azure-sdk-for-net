...
namespace Microsoft.Azure.Management.DataLake.Store.Models
{
    ...
    public partial class DataLakeStoreAccountProperties
    {
        ...
        /// class.
        /// </summary>
        /// <param name="provisioningState">the status of the Data Lake Store account while being provisioned. Possible values include: 'Failed', 'Creating', 'Running', 'Succeeded', 'Patching', 'Suspending', 'Resuming', 'Deleting', 'Deleted'</param>
        /// <param name="state">the status of the Data Lake Store account after provisioning has completed. Possible values include: 'active', 'suspended'</param>
        /// <param name="creationTime">the account creation time.</param>
        /// <param name="lastModifiedTime">the account last modified time.</param>
