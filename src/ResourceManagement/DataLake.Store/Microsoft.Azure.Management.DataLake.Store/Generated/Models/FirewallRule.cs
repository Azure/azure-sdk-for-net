...
namespace Microsoft.Azure.Management.DataLake.Store.Models
{
    ...
    public partial class FirewallRule
    {
        ...
        /// <param name="type">the namespace and type of the firewall Rule.</param>
        /// <param name="id">the firewall rule's subscription ID.</param>
        /// <param name="location">the firewall rule's regional location.</param>
        /// <param name="properties">the properties of the firewall rule.</param>
