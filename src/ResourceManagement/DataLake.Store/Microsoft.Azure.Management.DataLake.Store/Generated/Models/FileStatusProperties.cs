...
namespace Microsoft.Azure.Management.DataLake.Store.Models
{
    ...
    public partial class FileStatusProperties
    {
        ...
        /// Initializes a new instance of the FileStatusProperties class.
        /// </summary>
        /// <param name="accessTime">the last access time as ticks since the epoch.</param>
        /// <param name="blockSize">the block size for the file.</param>
        /// <param name="childrenNum">the number of children in the directory.</param>
        /// <param name="group">the group owner.</param>
        /// <param name="length">the number of bytes in a file.</param>
        /// <param name="modificationTime">the modification time as ticks since the epoch.</param>
        /// <param name="owner">the user who is the owner.</param>
        /// <param name="pathSuffix">the path suffix.</param>
        /// <param name="permission">the permission represented as an string.</param>
        /// <param name="type">the type of the path object. Possible values include: 'FILE', 'DIRECTORY'</param>
