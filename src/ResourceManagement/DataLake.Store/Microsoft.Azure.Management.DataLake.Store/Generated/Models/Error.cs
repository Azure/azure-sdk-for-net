...
namespace Microsoft.Azure.Management.DataLake.Store.Models
{
    ...
    public partial class Error
    {
        ...
        /// <summary>
        /// Gets gets the error message to display.
        /// </summary>
        [JsonProperty(PropertyName = "message")]
        public string Message { get; private set; }

        /// <summary>
        /// Gets gets the target of the error.
        /// </summary>
        [JsonProperty(PropertyName = "target")]
        public string Target { get; private set; }

        /// <summary>
        /// Gets gets the list of error details
        /// </summary>
        [JsonProperty(PropertyName = "details")]
        public IList<ErrorDetails> Details { get; private set; }

        /// <summary>
        /// Gets gets the inner exceptions or errors, if any
        /// </summary>
