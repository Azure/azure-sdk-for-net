...
namespace Microsoft.Azure.Management.DataLake.Store
{
    ...
    public partial interface IFileSystemOperations
    {
        ...
        /// </param>
        Task<AzureOperationResponse> ConcurrentAppendWithHttpMessagesAsync(string filePath, string accountname, object streamContents, string op = "CONCURRENTAPPEND", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse> MsConcatWithHttpMessagesAsync(string msConcatDestinationPath, string accountname, object streamContents, bool? deletesourcedirectory = default(bool?), string op = "MSCONCAT", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse> DirectAppendWithHttpMessagesAsync(string directFilePath, string accountname, object streamContents, long? buffersize = default(long?), string op = "APPEND", bool? append = true, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse> DirectCreateWithHttpMessagesAsync(string directFilePath, string accountname, object streamContents = default(object), long? buffersize = default(long?), bool? overwrite = default(bool?), long? blocksize = default(long?), int? replication = default(int?), string permission = default(string), string op = "CREATE", bool? write = true, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse> AppendWithHttpMessagesAsync(string fileAppendRequestLink, object streamContents, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse> CreateWithHttpMessagesAsync(string fileCreateRequestLink, object streamContents = default(object), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
