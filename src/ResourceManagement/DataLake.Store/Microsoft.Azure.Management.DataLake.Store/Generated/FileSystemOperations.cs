...
namespace Microsoft.Azure.Management.DataLake.Store
{
    ...
    internal partial class FileSystemOperations : IServiceOperations<DataLakeStoreFileSystemManagementClient>, IFileSystemOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<FileInfoResult>> GetFileInfoWithHttpMessagesAsync(string filePath, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (filePath == null)
            {
        ...
        public async Task<AzureOperationResponse> ConcurrentAppendWithHttpMessagesAsync(string filePath, string accountname, System.IO.Stream streamContents, string accountName, string appendMode = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (appendMode != null)
            {
                _queryParameters.Add(string.Format("appendMode={0}", Uri.EscapeDataString(appendMode)));
            }
            if (op != null)
            {
                _queryParameters.Add(string.Format("op={0}", Uri.EscapeDataString(op)));
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> SetFileExpiryWithHttpMessagesAsync(string filePath, ExpiryOptionType expiryOption, string accountName, long? expireTime = default(long?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (filePath == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "filePath");
