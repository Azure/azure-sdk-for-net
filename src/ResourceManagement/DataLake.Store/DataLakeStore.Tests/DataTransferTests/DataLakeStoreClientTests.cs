...
namespace DataLakeStore.Tests
{
    ...
    public class DataLakeTransferClientTests : IDisposable
    {
        ...
        public void DataLakeUploader_ResumePartialFolderUploadWithProgress()
        {
            ...
            var up = CreateParameters(isResume: false, isRecursive: true);
            var uploader = new DataLakeStoreTransferClient(up, frontEnd, folderProgressTracker: progressTracker);
            uploader.DeleteMetadataFile();
            ...
            uploader = new DataLakeStoreTransferClient(up, backingFrontEnd, folderProgressTracker: progressTracker);
