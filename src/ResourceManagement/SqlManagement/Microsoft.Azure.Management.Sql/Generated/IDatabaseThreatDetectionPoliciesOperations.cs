...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public partial interface IDatabaseThreatDetectionPoliciesOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<DatabaseSecurityAlertPolicyResource>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, DatabaseSecurityAlertPolicyResource databaseSecurityAlertPolicy, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
