...
namespace Microsoft.Azure.Management.Sql
{
    ...
    internal partial class DatabaseBlobAuditingPoliciesOperations : IServiceOperations<SqlManagementClient>, IDatabaseBlobAuditingPoliciesOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DatabaseBlobAuditingPolicy>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, DatabaseBlobAuditingPolicy databaseBlobAuditingPolicy, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("serverName", serverName);
                tracingParameters.Add("databaseName", databaseName);
                tracingParameters.Add("databaseBlobAuditingPolicy", databaseBlobAuditingPolicy);
                tracingParameters.Add("apiVersion", apiVersion);
                tracingParameters.Add("cancellationToken", cancellationToken);
            ...
            if(databaseBlobAuditingPolicy != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(databaseBlobAuditingPolicy, Client.SerializationSettings);
