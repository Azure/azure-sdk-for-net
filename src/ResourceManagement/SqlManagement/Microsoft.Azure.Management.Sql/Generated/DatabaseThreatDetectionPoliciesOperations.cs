...
namespace Microsoft.Azure.Management.Sql
{
    ...
    internal partial class DatabaseThreatDetectionPoliciesOperations : IServiceOperations<SqlManagementClient>, IDatabaseThreatDetectionPoliciesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<DatabaseSecurityAlertPolicyResource>> GetWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<DatabaseSecurityAlertPolicyResource>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<DatabaseSecurityAlertPolicyResource>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serverName, string databaseName, DatabaseSecurityAlertPolicyResource databaseSecurityAlertPolicy, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("databaseName", databaseName);
                tracingParameters.Add("securityAlertPolicyName", securityAlertPolicyName);
                tracingParameters.Add("databaseSecurityAlertPolicy", databaseSecurityAlertPolicy);
                tracingParameters.Add("apiVersion", apiVersion);
                tracingParameters.Add("cancellationToken", cancellationToken);
            ...
            if(databaseSecurityAlertPolicy != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(databaseSecurityAlertPolicy, Client.SerializationSettings);
