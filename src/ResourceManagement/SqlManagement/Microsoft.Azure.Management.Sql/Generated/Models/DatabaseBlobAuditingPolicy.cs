...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class DatabaseBlobAuditingPolicy : SqlTypedSubResource
    {
        ...
        /// key.</param>
        public DatabaseBlobAuditingPolicy(string name = default(string), string id = default(string), string type = default(string), string state = default(string), string storageEndpoint = default(string), string storageAccountAccessKey = default(string), int? retentionDays = default(int?), IList<string> auditActionsAndGroups = default(IList<string>), string storageAccountSubscriptionId = default(string), bool? isStorageSecondaryKeyInUse = default(bool?))
            : base(name, id, type)
        {
            State = state;
