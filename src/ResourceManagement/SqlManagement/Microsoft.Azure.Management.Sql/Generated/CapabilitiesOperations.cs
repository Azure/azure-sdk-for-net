...
namespace Microsoft.Azure.Management.Sql
{
    ...
    internal partial class CapabilitiesOperations : IServiceOperations<SqlManagementClient>, ICapabilitiesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<LocationCapabilities>> GetWithHttpMessagesAsync(string locationID, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<LocationCapabilities>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<LocationCapabilities>(_responseContent, Client.DeserializationSettings);
                }
