...
namespace Microsoft.Azure.Management.Consumption.Fluent
{
    ...
    internal partial class UsageDetailsOperations : IServiceOperations<ConsumptionManagementClient>, IUsageDetailsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<UsageDetailInner>>> ListWithHttpMessagesAsync(string scope, string expand = default(string), string filter = default(string), string skiptoken = default(string), int? top = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (scope == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<UsageDetailInner>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<UsageDetailInner>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<UsageDetailInner>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
