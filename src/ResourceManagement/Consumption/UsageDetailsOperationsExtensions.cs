...
namespace Microsoft.Azure.Management.Consumption.Fluent
{
    ...
    public static partial class UsageDetailsOperationsExtensions
    {
            ...
            /// usageDetails.
            /// </param>
            public static IPage<UsageDetailInner> List(this IUsageDetailsOperations operations, string scope, string expand = default(string), string filter = default(string), string skiptoken = default(string), int? top = default(int?))
            {
            ...
            /// </param>
            public static IPage<UsageDetailInner> ListNext(this IUsageDetailsOperations operations, string nextPageLink)
            {
