...
namespace Microsoft.Azure.Management.DataFactories.Core
{
    ...
    /// </summary>
    public partial interface IOAuthOperations
    {
        /// <summary>
        ...
        /// </returns>
        Task<AuthorizationSessionGetResponse> GetAsync(string resourceGroupName, string dataFactoryName, string linkedServiceType, CancellationToken cancellationToken);
    }
}
