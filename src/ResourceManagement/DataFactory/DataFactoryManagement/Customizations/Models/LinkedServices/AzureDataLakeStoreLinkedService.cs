...
namespace Microsoft.Azure.Management.DataFactories.Models
{
    ...
    public class AzureDataLakeStoreLinkedService : OAuthLinkedServiceBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureDataLakeStoreLinkedService"/>
        /// class with required arguments.
        /// </summary>
        public AzureDataLakeStoreLinkedService(string authorization, string sessionId, string dataLakeStoreUri)
