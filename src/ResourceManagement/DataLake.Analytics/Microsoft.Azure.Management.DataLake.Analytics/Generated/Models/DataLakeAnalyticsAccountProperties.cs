...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class DataLakeAnalyticsAccountProperties
    {
        ...
        /// DataLakeAnalyticsAccountProperties class.
        /// </summary>
        /// <param name="provisioningState">the provisioning status of the Data Lake Analytics account. Possible values include: 'Failed', 'Creating', 'Running', 'Succeeded', 'Patching', 'Suspending', 'Resuming', 'Deleting', 'Deleted'</param>
        /// <param name="state">the state of the Data Lake Analytics account. Possible values include: 'active', 'suspended'</param>
        /// <param name="defaultDataLakeStoreAccount">the default data lake storage account associated with this Data Lake Analytics account.</param>
        ...
        /// <param name="dataLakeStoreAccounts">the list of Data Lake storage accounts associated with this account.</param>
