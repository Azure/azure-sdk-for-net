...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class JobErrorDetails
    {
        ...
        /// <param name="endOffset">the end offset in the job where the error was found.</param>
        /// <param name="errorId">the specific identifier for the type of error encountered in the job.</param>
        /// <param name="filePath">the path to any supplemental error files, if any.</param>
        ...
        /// <param name="lineNumber">the specific line number in the job where the error occured.</param>
        ...
        /// <param name="innerError">the inner error of this specific job error message, if any.</param>
        ...
        /// <param name="startOffset">the start offset in the job where the error was found</param>
