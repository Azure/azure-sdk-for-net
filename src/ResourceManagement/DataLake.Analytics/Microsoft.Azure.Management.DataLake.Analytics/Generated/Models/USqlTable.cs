...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlTable : CatalogItem
    {
        ...
        /// <param name="partitionKeyList">the list of partition keys in the table</param>
        /// <param name="externalTable">the external table associated with the table.</param>
        /// <param name="distributionInfo">the distributions info of the table</param>
