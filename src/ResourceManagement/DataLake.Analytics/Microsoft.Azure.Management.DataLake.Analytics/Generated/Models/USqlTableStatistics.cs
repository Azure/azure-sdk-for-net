...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlTableStatistics : CatalogItem
    {
        ...
        /// <param name="createTime">the creation time of the statistics.</param>
        /// <param name="updateTime">the last time the statistics were updated.</param>
        /// <param name="isUserCreated">the switch indicating if these statistics are user created.</param>
        /// <param name="isAutoCreated">the switch indicating if these statistics are automatically created.</param>
        /// <param name="hasFilter">the switch indicating if these statistics have a filter.</param>
        /// <param name="filterDefinition">the filter definition for the statistics.</param>
        /// <param name="colNames">the list of column names associated with these statistics.</param>
