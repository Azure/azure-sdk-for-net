...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlTableStatistics : CatalogItem
    {
        ...
        /// Initializes a new instance of the USqlTableStatistics class.
        /// </summary>
        public USqlTableStatistics(string computeAccountName = default(string), string version = default(string), string databaseName = default(string), string schemaName = default(string), string tableName = default(string), string statisticsName = default(string), string userStatName = default(string), string statDataPath = default(string), DateTime? createTime = default(DateTime?), DateTime? updateTime = default(DateTime?), bool? isUserCreated = default(bool?), bool? isAutoCreated = default(bool?), bool? hasFilter = default(bool?), string filterDefinition = default(string), IList<string> colNames = default(IList<string>))
