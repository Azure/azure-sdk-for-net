...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlTablePartition : CatalogItem
    {
        ...
        /// <param name="schemaName">the name of the schema associated with this table partition and database.</param>
        /// <param name="name">the name of the table partition.</param>
        /// <param name="parentName">the Ddl object of the partition's parent.</param>
