...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlAssembly : CatalogItem
    {
        ...
        /// <param name="isVisible">the switch indicating if this assembly is visible or not.</param>
        /// <param name="isUserDefined">the switch indicating if this assembly is user defined or not.</param>
        /// <param name="files">the list of files associated with the assembly</param>
        /// <param name="dependencies">the list of dependencies associated with the assembly</param>
