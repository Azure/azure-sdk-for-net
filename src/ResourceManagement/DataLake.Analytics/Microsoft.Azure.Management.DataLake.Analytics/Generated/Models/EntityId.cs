...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class EntityId
    {
        ...
        /// Initializes a new instance of the EntityId class.
        /// </summary>
        /// <param name="name">the name of the external table associated with this database, schema and table.</param>
        /// <param name="version">the version of the external data source.</param>
