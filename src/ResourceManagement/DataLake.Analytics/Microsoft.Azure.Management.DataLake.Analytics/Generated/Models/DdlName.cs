...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class DdlName
    {
        ...
        /// Initializes a new instance of the DdlName class.
        /// </summary>
        /// <param name="firstPart">the name of the table associated with this database and schema.</param>
        /// <param name="secondPart">the name of the table associated with this database and schema.</param>
        /// <param name="thirdPart">the name of the table associated with this database and schema.</param>
        /// <param name="server">the name of the table associated with this database and schema.</param>
