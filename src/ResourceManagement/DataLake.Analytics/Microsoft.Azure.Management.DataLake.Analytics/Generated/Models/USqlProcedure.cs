...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlProcedure : CatalogItem
    {
        ...
        /// <param name="schemaName">the name of the schema associated with this procedure and database.</param>
        /// <param name="name">the name of the procedure.</param>
        /// <param name="definition">the defined query of the procedure.</param>
