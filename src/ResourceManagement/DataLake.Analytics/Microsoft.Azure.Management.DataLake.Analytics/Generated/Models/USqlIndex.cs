...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlIndex
    {
        ...
        /// <summary>
        /// Gets or sets gets or sets the list of directed columns in the index
        /// </summary>
        [JsonProperty(PropertyName = "indexKeys")]
        public IList<USqlDirectedColumn> IndexKeys { get; set; }

        /// <summary>
        /// Gets or sets gets or sets the list of columns in the index
        /// </summary>
        [JsonProperty(PropertyName = "columns")]
        public IList<string> Columns { get; set; }

        /// <summary>
        /// Gets or sets gets or sets the distributions info of the index
        /// </summary>
        [JsonProperty(PropertyName = "distributionInfo")]
        public USqlDistributionInfo DistributionInfo { get; set; }

        /// <summary>
        /// Gets or sets gets or sets partition function ID for the index.
        /// </summary>
        [JsonProperty(PropertyName = "partitionFunction")]
        public Guid? PartitionFunction { get; set; }

        /// <summary>
        /// Gets or sets gets or sets the list of partion keys in the index
        /// </summary>
        [JsonProperty(PropertyName = "partitionKeyList")]
        public IList<string> PartitionKeyList { get; set; }

        /// <summary>
        /// Gets or sets gets or sets the list of full paths to the streams
        ...
        /// <summary>
        /// Gets or sets gets or sets the switch indicating if this index is a
        /// columnstore index.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets gets or sets the ID of this index within the table.
        /// </summary>
