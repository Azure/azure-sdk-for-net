...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlIndex
    {
        ...
        /// <param name="indexKeys">the list of directed columns in the index</param>
        /// <param name="columns">the list of columns in the index</param>
        /// <param name="distributionInfo">the distributions info of the index</param>
        /// <param name="partitionFunction">partition function ID for the index.</param>
        /// <param name="partitionKeyList">the list of partion keys in the index</param>
        /// <param name="streamNames">the list of full paths to the streams that contain this index in the DataLake account.</param>
        /// <param name="isColumnstore">the switch indicating if this index is a columnstore index.</param>
        /// <param name="indexId">the ID of this index within the table.</param>
        /// <param name="isUnique">the switch indicating if this index is a unique index.</param>
