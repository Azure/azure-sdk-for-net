...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlExternalDataSource : CatalogItem
    {
        ...
        /// <param name="provider">the name of the provider for the external data source.</param>
        /// <param name="providerString">the name of the provider string for the external data source.</param>
        /// <param name="pushdownTypes">the list of types to push down from the external data source.</param>
