...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class USqlType
    {
        ...
        /// Initializes a new instance of the USqlType class.
        /// </summary>
        public USqlType(string databaseName = default(string), string schemaName = default(string), string typeName = default(string), string typeFamily = default(string), string cSharpName = default(string), string fullCSharpName = default(string), int? systemTypeId = default(int?), int? userTypeId = default(int?), int? schemaId = default(int?), int? principalId = default(int?), bool? isNullable = default(bool?), bool? isUserDefined = default(bool?), bool? isAssemblyType = default(bool?), bool? isTableType = default(bool?), bool? isComplexType = default(bool?), string computeAccountName = default(string), string version = default(string))
        {
