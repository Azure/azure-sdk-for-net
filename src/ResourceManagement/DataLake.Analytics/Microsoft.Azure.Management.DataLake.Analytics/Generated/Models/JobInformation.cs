...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class JobInformation
    {
        ...
        /// <param name="type">the job type of the current job (Hive or USql). Possible values include: 'USql', 'Hive'</param>
        /// <param name="properties">the job specific properties.</param>
        /// <param name="jobId">the job's unique identifier (a GUID).</param>
        /// <param name="submitter">the user or account that submitted the job.</param>
        /// <param name="errorMessage">the error message details for the job, if the job failed.</param>
        /// <param name="degreeOfParallelism">the degree of parallelism used for this job. This must be greater than 0.</param>
        /// <param name="priority">the priority value for the current job. Lower numbers have a higher priority. By default, a job has a priority of 1000. This must be greater than 0.</param>
        /// <param name="submitTime">the time the job was submitted to the service.</param>
        /// <param name="startTime">the start time of the job.</param>
        /// <param name="endTime">the completion time of the job.</param>
        /// <param name="state">the job state. When the job is in the Ended state, refer to Result and ErrorMessage for details. Possible values include: 'Accepted', 'Compiling', 'Ended', 'New', 'Queued', 'Running', 'Scheduling', 'Starting', 'Paused', 'WaitingForCapacity'</param>
        /// <param name="result">the result of job execution or the current result of the running job. Possible values include: 'None', 'Succeeded', 'Cancelled', 'Failed'</param>
        /// <param name="logFolder">the log folder path to use in the following format: adl://<accountName>.azuredatalakestore.net/system/jobservice/jobs/Usql/2016/03/13/17/18/5fe51957-93bc-4de0-8ddc-c5a4753b068b/logs/.</param>
        /// <param name="logFilePatterns">the list of log file name patterns to find in the logFolder. '*' is the only matching character allowed. Example format: jobExecution*.log or *mylog*.txt</param>
        /// <param name="stateAuditRecords">the job state audit records, indicating when various operations have been performed on this job.</param>
