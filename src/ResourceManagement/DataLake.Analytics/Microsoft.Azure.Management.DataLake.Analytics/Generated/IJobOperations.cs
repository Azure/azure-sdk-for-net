...
namespace Microsoft.Azure.Management.DataLake.Analytics
{
    ...
    public partial interface IJobOperations
    {
        ...
        /// </param>
        Task<AzureOperationResponse<JobStatistics>> GetStatisticsWithHttpMessagesAsync(string jobIdentity, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<JobDataPath>> GetDebugDataPathWithHttpMessagesAsync(string jobIdentity, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<JobInformation>> BuildWithHttpMessagesAsync(JobInformation parameters, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<JobInformation>> CreateWithHttpMessagesAsync(string jobId, JobInformation parameters, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse> CancelWithHttpMessagesAsync(string jobIdentity, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<JobInformation>> GetWithHttpMessagesAsync(string jobIdentity, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
