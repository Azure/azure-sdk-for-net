...
namespace Microsoft.Azure.Management.DataLake.Analytics
{
    ...
    public static partial class JobOperationsExtensions
    {
            ...
            /// JobInfo ID.
            /// </param>
            public static JobStatistics GetStatistics(this IJobOperations operations, string accountname, string jobIdentity)
            {
            ...
            /// </param>
            public static async Task<JobStatistics> GetStatisticsAsync( this IJobOperations operations, string accountname, string jobIdentity, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// JobInfo ID.
            /// </param>
            public static JobDataPath GetDebugDataPath(this IJobOperations operations, string accountname, string jobIdentity)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<JobDataPath> GetDebugDataPathAsync( this IJobOperations operations, string accountname, string jobIdentity, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The parameters to submit a job.
            /// </param>
            public static JobInformation Create(this IJobOperations operations, string accountname, string jobId, JobInformation parameters)
            {
                return Task.Factory.StartNew(s => ((IJobOperations)s).CreateAsync(accountname, jobId, parameters), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<JobInformation> CreateAsync( this IJobOperations operations, string accountname, string jobId, JobInformation parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateWithHttpMessagesAsync(accountname, jobId, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static void Cancel(this IJobOperations operations, string accountname, string jobIdentity)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task CancelAsync( this IJobOperations operations, string accountname, string jobIdentity, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// JobInfo ID.
            /// </param>
            public static JobInformation Get(this IJobOperations operations, string accountname, string jobIdentity)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<JobInformation> GetAsync( this IJobOperations operations, string accountname, string jobIdentity, CancellationToken cancellationToken = default(CancellationToken))
            {
