...
namespace Microsoft.Azure.Management.DataLake.Analytics
{
    ...
    public partial class DataLakeAnalyticsJobManagementClient : ServiceClient<DataLakeAnalyticsJobManagementClient>, IDataLakeAnalyticsJobManagementClient, IAzureClient
    {
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected DataLakeAnalyticsJobManagementClient(Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected DataLakeAnalyticsJobManagementClient(Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
