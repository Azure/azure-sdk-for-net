...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    /// </summary>
    internal partial class BackupVaultConfigsOperations : IServiceOperations<RecoveryServicesClient>, IBackupVaultConfigsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<BackupVaultConfig>> GetWithHttpMessagesAsync(string resourceGroupName, string vaultName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<BackupVaultConfig>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<BackupVaultConfig>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<BackupVaultConfig>> UpdateWithHttpMessagesAsync(string resourceGroupName, string vaultName, BackupVaultConfig backupVaultConfig, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
