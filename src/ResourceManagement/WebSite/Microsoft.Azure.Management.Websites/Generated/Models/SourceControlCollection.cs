...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class SourceControlCollection
    {
        ...
        /// Initializes a new instance of the SourceControlCollection class.
        /// </summary>
        public SourceControlCollection(IList<SourceControl> value = default(IList<SourceControl>), string nextLink = default(string), string id = default(string))
        {
            Value = value;
            NextLink = nextLink;
            Id = id;
        ...
        public IList<SourceControl> Value { get; set; }
