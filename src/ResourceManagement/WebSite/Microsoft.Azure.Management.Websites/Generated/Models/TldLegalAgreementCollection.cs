...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class TldLegalAgreementCollection
    {
        ...
        /// class.
        /// </summary>
        public TldLegalAgreementCollection(IList<TldLegalAgreement> value = default(IList<TldLegalAgreement>), string nextLink = default(string), string id = default(string))
        {
            Value = value;
            NextLink = nextLink;
            Id = id;
