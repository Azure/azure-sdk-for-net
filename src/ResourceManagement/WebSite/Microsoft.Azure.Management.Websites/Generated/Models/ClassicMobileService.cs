...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ClassicMobileService : Resource
    {
        ...
        /// Initializes a new instance of the ClassicMobileService class.
        /// </summary>
        public ClassicMobileService(string name, string location, string id = default(string), string kind = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string classicMobileServiceName = default(string))
