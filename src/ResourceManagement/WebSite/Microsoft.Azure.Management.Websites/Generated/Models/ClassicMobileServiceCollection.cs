...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class ClassicMobileServiceCollection
    {
        ...
        /// class.
        /// </summary>
        public ClassicMobileServiceCollection(IList<ClassicMobileService> value = default(IList<ClassicMobileService>), string nextLink = default(string), string id = default(string))
        {
            Value = value;
            NextLink = nextLink;
            Id = id;
