...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class HostingEnvironmentCollection
    {
        ...
        /// class.
        /// </summary>
        public HostingEnvironmentCollection(IList<HostingEnvironment> value = default(IList<HostingEnvironment>), string nextLink = default(string), string id = default(string))
        {
            Value = value;
            NextLink = nextLink;
            Id = id;
