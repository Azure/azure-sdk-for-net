...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class Deployment : Resource
    {
        ...
        /// Initializes a new instance of the Deployment class.
        /// </summary>
        public Deployment(string deploymentId = default(string), int? status = default(int?), string message = default(string), string author = default(string), string deployer = default(string), string authorEmail = default(string), DateTime? startTime = default(DateTime?), DateTime? endTime = default(DateTime?), bool? active = default(bool?), string details = default(string))
        {
