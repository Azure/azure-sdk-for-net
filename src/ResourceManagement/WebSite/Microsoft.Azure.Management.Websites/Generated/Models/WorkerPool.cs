...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class WorkerPool : Resource
    {
        ...
        /// Initializes a new instance of the WorkerPool class.
        /// </summary>
        public WorkerPool(string name, string location, string id = default(string), string kind = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), int? workerSizeId = default(int?), ComputeModeOptions? computeMode = default(ComputeModeOptions?), string workerSize = default(string), int? workerCount = default(int?), IList<string> instanceNames = default(IList<string>), SkuDescription sku = default(SkuDescription))
        ...
        /// <summary>
        /// Shared or dedicated web app hosting. Possible values include:
