...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class TopLevelDomainCollection
    {
        ...
        /// Initializes a new instance of the TopLevelDomainCollection class.
        /// </summary>
        public TopLevelDomainCollection(IList<TopLevelDomain> value = default(IList<TopLevelDomain>), string nextLink = default(string), string id = default(string))
        {
            Value = value;
            NextLink = nextLink;
            Id = id;
        ...
        public IList<TopLevelDomain> Value { get; set; }
