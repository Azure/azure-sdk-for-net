...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class CertificateOrderAction : Resource
    {
        ...
        /// Initializes a new instance of the CertificateOrderAction class.
        /// </summary>
        public CertificateOrderAction(string location, string id = default(string), string name = default(string), string kind = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), CertificateOrderActionType? certificateOrderActionType = default(CertificateOrderActionType?), DateTime? createdAt = default(DateTime?))
        ...
        /// <summary>
        /// Type. Possible values for this property include:
