...
namespace Microsoft.Azure.Management.WebSites
{
    ...
    public static partial class GlobalDomainRegistrationOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<DomainCollection> result = await operations.GetAllDomainsWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<DomainControlCenterSsoRequest> result = await operations.GetDomainControlCenterSsoRequestWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<object> result = await operations.ValidateDomainPurchaseInformationWithHttpMessagesAsync(domainRegistrationInput, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<DomainAvailablilityCheckResult> result = await operations.CheckDomainAvailabilityWithHttpMessagesAsync(identifier, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<NameIdentifierCollection> result = await operations.ListDomainRecommendationsWithHttpMessagesAsync(parameters, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
