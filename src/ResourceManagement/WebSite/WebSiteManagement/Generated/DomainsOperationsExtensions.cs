...
namespace Microsoft.Azure.Management.WebSites
{
    ...
    public static partial class DomainsOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<DomainCollection> result = await operations.GetDomainsWithHttpMessagesAsync(resourceGroupName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Domain> result = await operations.GetDomainWithHttpMessagesAsync(resourceGroupName, domainName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Domain> result = await operations.CreateOrUpdateDomainWithHttpMessagesAsync(resourceGroupName, domainName, domain, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<object> result = await operations.DeleteDomainWithHttpMessagesAsync(resourceGroupName, domainName, forceHardDeleteDomain, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Domain> result = await operations.UpdateDomainWithHttpMessagesAsync(resourceGroupName, domainName, domain, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Domain> result = await operations.GetDomainOperationWithHttpMessagesAsync(resourceGroupName, domainName, operationId, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
