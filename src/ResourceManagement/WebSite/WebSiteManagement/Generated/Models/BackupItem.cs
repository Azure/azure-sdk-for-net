...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class BackupItem : Resource
    {
        ...
        /// Initializes a new instance of the BackupItem class.
        /// </summary>
        public BackupItem(string storageAccountUrl = default(string), string blobName = default(string), string backupItemName = default(string), BackupItemStatus? status = default(BackupItemStatus?), long? sizeInBytes = default(long?), DateTime? created = default(DateTime?), string log = default(string), IList<DatabaseBackupSetting> databases = default(IList<DatabaseBackupSetting>), bool? scheduled = default(bool?), DateTime? lastRestoreTimeStamp = default(DateTime?), DateTime? finishedTimeStamp = default(DateTime?), string correlationId = default(string), long? websiteSizeInBytes = default(long?))
        {
