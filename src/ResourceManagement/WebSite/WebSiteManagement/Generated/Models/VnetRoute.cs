...
namespace Microsoft.Azure.Management.WebSites.Models
{
    ...
    public partial class VnetRoute : Resource
    {
        ...
        /// Initializes a new instance of the VnetRoute class.
        /// </summary>
        public VnetRoute(string vnetRouteName = default(string), string startAddress = default(string), string endAddress = default(string), string routeType = default(string))
        {
