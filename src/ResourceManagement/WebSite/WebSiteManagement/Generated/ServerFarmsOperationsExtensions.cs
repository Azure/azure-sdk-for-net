...
namespace Microsoft.Azure.Management.WebSites
{
    ...
    public static partial class ServerFarmsOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<IPage<Site>> result = await operations.GetServerFarmSitesWithHttpMessagesAsync(resourceGroupName, name, skipToken, filter, top, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            /// List page size. If specified, results are paged.
            /// </param>
            public static IPage<Site> GetWebHostingPlanSites(this IServerFarmsOperations operations, string resourceGroupName, string name, string skipToken = default(string), string filter = default(string), string top = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<Site>> GetWebHostingPlanSitesAsync( this IServerFarmsOperations operations, string resourceGroupName, string name, string skipToken = default(string), string filter = default(string), string top = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<IPage<Site>> result = await operations.GetWebHostingPlanSitesWithHttpMessagesAsync(resourceGroupName, name, skipToken, filter, top, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<IPage<Site>> result = await operations.GetServerFarmSitesNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static IPage<Site> GetWebHostingPlanSitesNext(this IServerFarmsOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<Site>> GetWebHostingPlanSitesNextAsync( this IServerFarmsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<IPage<Site>> result = await operations.GetWebHostingPlanSitesNextWithHttpMessagesAsync(nextPageLink, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
