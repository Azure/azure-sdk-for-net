...
namespace Azure.Tests.TrafficManager
{
    public class TrafficManagerTests
    {
        ...
        public void CanCreateUpdateTrafficManagerProfile()
        {
            ...
            var groupName = ResourceNamer.RandomResourceName("rgchashtm", 24);
            var pipName = ResourceNamer.RandomResourceName("pip", 15);
            var pipDnsLabel = ResourceNamer.RandomResourceName("contoso", 15);

            var tmProfileName = ResourceNamer.RandomResourceName("tm", 15);
            var nestedTmProfileName = "nested" + tmProfileName;

            var tmProfileDnsLabel = ResourceNamer.RandomResourceName("tmdns", 15);
