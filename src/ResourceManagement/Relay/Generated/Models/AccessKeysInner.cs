...
namespace Microsoft.Azure.Management.Relay.Fluent.Models
{
    ...
    public partial class AccessKeysInner
    {
        ...
        /// rule</param>
        public AccessKeysInner(string primaryConnectionString = default(string), string secondaryConnectionString = default(string), string primaryKey = default(string), string secondaryKey = default(string), string keyName = default(string))
        {
