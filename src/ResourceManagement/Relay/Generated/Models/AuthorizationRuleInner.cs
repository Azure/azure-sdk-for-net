...
namespace Microsoft.Azure.Management.Relay.Fluent.Models
{
    ...
    public partial class AuthorizationRuleInner : Microsoft.Azure.Management.ResourceManager.Fluent.Resource
    {
        ...
        public AuthorizationRuleInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IList<AccessRights?> rights = default(IList<AccessRights?>))
