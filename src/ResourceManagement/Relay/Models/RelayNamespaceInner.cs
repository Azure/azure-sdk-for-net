...
namespace Microsoft.Azure.Management.Relay.Fluent.Models
{
    ...
    public partial class RelayNamespaceInner : TrackedResourceInner
    {
        /// <summary>
        /// Initializes a new instance of the RelayNamespaceInner class.
        /// </summary>
        ...
        /// metrics</param>
        public RelayNamespaceInner(string location = default(string), string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), ProvisioningStateEnum? provisioningState = default(ProvisioningStateEnum?), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? updatedAt = default(System.DateTime?), string serviceBusEndpoint = default(string), string metricId = default(string))
