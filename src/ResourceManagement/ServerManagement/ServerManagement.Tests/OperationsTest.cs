...
namespace ServerManagement.Tests
{
    public class OperationsTest : ServerManagementTestBase
    {
        ...
        {
            string GatewayName = "sdktest_gateway_201";
            ...
            using (var context = MockContext.Start("ServerManagement.Tests"))
            {
                ...
                await Assert.ThrowsAsync<CloudException>(() => client.Gateway.GetAsync(ResourceGroup, GatewayName));
            }
        }
        ...
        {
            string GatewayName = "sdktest_gateway_101";
        ...
        public async Task CreateGatewayFailTest()
        {
            ...
            using (var context = MockContext.Start("ServerManagement.Tests"))
            {
                ...
                await Assert.ThrowsAsync<CloudException>(() => client.Gateway.CreateAsync(ResourceGroup, ""));
