...
namespace Microsoft.Azure.Management.ServerManagement.Models
{
    ...
    public partial class NodeResource : Resource
    {
        ...
        /// Initializes a new instance of the NodeResource class.
        /// </summary>
        public NodeResource(string id = default(string), string type = default(string), string name = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), string gatewayId = default(string), string connectionName = default(string), string created = default(string), string updated = default(string))
