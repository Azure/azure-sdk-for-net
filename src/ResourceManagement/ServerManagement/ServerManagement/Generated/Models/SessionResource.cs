...
namespace Microsoft.Azure.Management.ServerManagement.Models
{
    ...
    public partial class SessionResource : Resource
    {
        ...
        /// Initializes a new instance of the SessionResource class.
        /// </summary>
        public SessionResource(string id = default(string), string type = default(string), string name = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), string userName = default(string), string created = default(string), string updated = default(string))
