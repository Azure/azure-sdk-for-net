...
namespace Microsoft.Azure.Management.Fluent.Redis.Models
{
    ...
    public partial class RedisCreateParametersInner : Microsoft.Rest.Azure.Resource
    {
        /// <summary>
        ...
        public RedisCreateParametersInner(Sku sku, string location = default(string), string id = default(string), string name = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), System.Collections.Generic.IDictionary<string, string> redisConfiguration = default(System.Collections.Generic.IDictionary<string, string>), bool? enableNonSslPort = default(bool?), System.Collections.Generic.IDictionary<string, string> tenantSettings = default(System.Collections.Generic.IDictionary<string, string>), int? shardCount = default(int?), string subnetId = default(string), string staticIP = default(string))
