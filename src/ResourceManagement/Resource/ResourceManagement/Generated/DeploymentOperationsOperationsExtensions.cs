...
namespace Microsoft.Azure.Management.Resources
{
    ...
    public static partial class DeploymentOperationsOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<IPage<DeploymentOperation>> result = await operations.ListWithHttpMessagesAsync(resourceGroupName, deploymentName, top, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
