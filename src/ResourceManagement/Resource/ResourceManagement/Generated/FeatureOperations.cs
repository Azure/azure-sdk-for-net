...
{
    internal partial class FeatureOperations : IServiceOperations<FeatureClient>, IFeatureOperations
    {
        /// <summary>
        /// Initializes a new instance of the FeatureOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal FeatureOperations(FeatureClient client)
        {
            this.Client = client;
        }
