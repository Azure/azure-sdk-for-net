...
namespace Microsoft.Azure.Management.Resources
{
    ...
    public partial interface IResourceGroupsOperations
    {
        ...
        /// </param>
        Task<AzureOperationResponse<IPage<GenericResource>>> ListResourcesWithHttpMessagesAsync(string resourceGroupName, Expression<Func<GenericResourceFilter, bool>> filter = default(Expression<Func<GenericResourceFilter, bool>>), int? top = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
