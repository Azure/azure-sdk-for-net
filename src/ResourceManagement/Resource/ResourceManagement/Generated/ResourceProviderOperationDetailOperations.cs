...
{
    internal partial class ResourceProviderOperationDetailOperations : IServiceOperations<ResourceManagementClient>, IResourceProviderOperationDetailOperations
    {
        /// <summary>
        /// Initializes a new instance of the ResourceProviderOperationDetailOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal ResourceProviderOperationDetailOperations(ResourceManagementClient client)
        {
            this.Client = client;
        }
