...
namespace Microsoft.Azure.Management.Resources
{
    internal partial class DeploymentOperations : IServiceOperations<ResourceManagementClient>, IDeploymentOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<DeploymentListResult>> ListWithOperationResponseAsync(string resourceGroupName, Expression<Func<DeploymentExtended, bool>> filter = default(Expression<Func<DeploymentExtended, bool>>), int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException("resourceGroupName");
