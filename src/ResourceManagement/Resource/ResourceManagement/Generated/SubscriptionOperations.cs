...
namespace Microsoft.Azure.Subscriptions
{
    internal partial class SubscriptionOperations : IServiceOperations<SubscriptionClient>, ISubscriptionOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Subscription>> GetWithOperationResponseAsync(string subscriptionId, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (statusCode == (HttpStatusCode)Enum.Parse(typeof(HttpStatusCode), "OK"))
            {
              result.Body = JsonConvert.DeserializeObject<Subscription>(responseContent, this.Client.DeserializationSettings);
            }
            if (shouldTrace)
            {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<IList<Subscription>>> ListWithOperationResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool shouldTrace = ServiceClientTracing.IsEnabled;
            string invocationId = null;
            ...
            // Create Result
            AzureOperationResponse<IList<Subscription>> result = new AzureOperationResponse<IList<Subscription>>();
            result.Request = httpRequest;
            result.Response = httpResponse;
            // Deserialize Response
            if (statusCode == (HttpStatusCode)Enum.Parse(typeof(HttpStatusCode), "OK"))
