...
namespace Microsoft.Azure.Management.Resources.Models
{
    ...
    public partial class ResourceGroup
    {
        ...
        /// Initializes a new instance of the ResourceGroup class.
        /// </summary>
        public ResourceGroup(string id = default(string), string name = default(string), ResourceGroupProperties properties = default(ResourceGroupProperties), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Id = id;
            Name = name;
