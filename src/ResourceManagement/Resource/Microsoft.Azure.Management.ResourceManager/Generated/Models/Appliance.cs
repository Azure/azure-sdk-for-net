...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class Appliance : GenericResource
    {
        /// <summary>
        ...
        public Appliance(string managedResourceGroupId, string kind, string id = default(string), string name = default(string), string type = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string managedBy = default(string), Sku sku = default(Sku), Identity identity = default(Identity), string applianceDefinitionId = default(string), object parameters = default(object), object outputs = default(object), string provisioningState = default(string), string uiDefinitionUri = default(string), Plan plan = default(Plan))
        ...
        public override void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "ManagedResourceGroupId");
            }
            if (Kind == null)
            {
