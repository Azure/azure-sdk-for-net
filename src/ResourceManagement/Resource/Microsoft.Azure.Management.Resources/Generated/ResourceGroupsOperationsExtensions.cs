...
namespace Microsoft.Azure.Management.Resources
{
    ...
    public static partial class ResourceGroupsOperationsExtensions
    {
            ...
            /// Query parameters. If null is passed returns all resource groups.
            /// </param>
            public static IPage<GenericResource> ListResources(this IResourceGroupsOperations operations, string resourceGroupName, Expression<Func<GenericResourceFilter, bool>> filter = default(Expression<Func<GenericResourceFilter, bool>>), int? top = default(int?))
            {
            ...
            /// </param>
            public static async Task<IPage<GenericResource>> ListResourcesAsync( this IResourceGroupsOperations operations, string resourceGroupName, Expression<Func<GenericResourceFilter, bool>> filter = default(Expression<Func<GenericResourceFilter, bool>>), int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<IPage<GenericResource>> result = await operations.ListResourcesWithHttpMessagesAsync(resourceGroupName, filter, top, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            /// Query parameters. If null is passed returns all resource groups.
            /// </param>
            public static IPage<ResourceGroup> List(this IResourceGroupsOperations operations, Expression<Func<ResourceGroupFilter, bool>> filter = default(Expression<Func<ResourceGroupFilter, bool>>), int? top = default(int?))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<ResourceGroup>> ListAsync( this IResourceGroupsOperations operations, Expression<Func<ResourceGroupFilter, bool>> filter = default(Expression<Func<ResourceGroupFilter, bool>>), int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
                AzureOperationResponse<IPage<ResourceGroup>> result = await operations.ListWithHttpMessagesAsync(filter, top, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
