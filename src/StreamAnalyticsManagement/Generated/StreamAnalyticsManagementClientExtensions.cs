...
{
    public static partial class StreamAnalyticsManagementClientExtensions
    {
        /// <summary>
        ...
        /// </returns>
        public static LongRunningOperationResponse GetLongRunningOperationStatus(this IStreamAnalyticsManagementClient operations, string operationStatusLink)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IStreamAnalyticsManagementClient)s).GetLongRunningOperationStatusAsync(operationStatusLink);
            }
