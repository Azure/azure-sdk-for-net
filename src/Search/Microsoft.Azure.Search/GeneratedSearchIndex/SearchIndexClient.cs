...
namespace Microsoft.Azure.Search
{
    ...
    public partial class SearchIndexClient : ServiceClient<SearchIndexClient>, ISearchIndexClient, IAzureClient
    {
        ...
        /// </param>
        protected SearchIndexClient(params DelegatingHandler[] handlers) : base(handlers)
        {
            this.Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected SearchIndexClient(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            this.Initialize();
        }
