...
namespace Microsoft.Azure.Search.Tests
{
 ...
 @"{
  ""@odata.nextLink"": ""https://tempuri.org?api-version=2016-09-01"",
 ...
 @"{
  ""@odata.nextLink"": ""https://tempuri.org?=&a=&=a&a=b=c&a=b&api-version=2016-09-01"",
  ""@search.nextPageParameters"": null
}";

        private SearchContinuationToken _token =
            new SearchContinuationToken(
                "https://tempuri.org?api-version=2016-09-01",
        ...
        private SearchContinuationToken _tokenWithOnlyLink =
            new SearchContinuationToken("https://tempuri.org?=&a=&=a&a=b=c&a=b&api-version=2016-09-01", null);
        ...
        {
            string tokenJson = TokenJson.Replace("2016-09-01", "1999-12-31");
            ...
            const string ExpectedMessage =
                ...
                "'1999-12-31'; Expected version '2016-09-01'.";
        ...
        {
            string tokenJson = TokenJson.Replace("2016-09-01", string.Empty);
