...
namespace Microsoft.Azure.Search.Models
{
    ...
    public partial class ScoringProfile
    {
        ...
        /// Initializes a new instance of the ScoringProfile class.
        /// </summary>
        public ScoringProfile(string name, TextWeights text = default(TextWeights), IList<ScoringFunction> functions = default(IList<ScoringFunction>), ScoringFunctionAggregation? functionAggregation = default(ScoringFunctionAggregation?))
        {
            Name = name;
            Text = text;
            Functions = functions;
