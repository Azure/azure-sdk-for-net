...
namespace Microsoft.Azure.Search.Models
{
    ...
    public partial class MagnitudeScoringParameters
    {
        ...
        /// Initializes a new instance of the MagnitudeScoringParameters class.
        /// </summary>
        public MagnitudeScoringParameters(double? boostingRangeStart, double? boostingRangeEnd, bool? constantBoostBeyondRange = default(bool?))
        {
        ...
        {
            if (BoostingRangeStart == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "BoostingRangeStart");
            }
            if (BoostingRangeEnd == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "BoostingRangeEnd");
            }
        }
    }
}
