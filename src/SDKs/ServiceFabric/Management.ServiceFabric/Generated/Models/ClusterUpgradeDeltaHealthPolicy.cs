...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    public partial class ClusterUpgradeDeltaHealthPolicy
    {
        ...
        /// cluster.</param>
        public ClusterUpgradeDeltaHealthPolicy(int maxPercentDeltaUnhealthyNodes, int maxPercentUpgradeDomainDeltaUnhealthyNodes, int maxPercentDeltaUnhealthyApplications, IList<ApplicationDeltaHealthPolicyMapItem> applicationDeltaHealthPolicies = default(IList<ApplicationDeltaHealthPolicyMapItem>))
        {
        ...
        public IList<ApplicationDeltaHealthPolicyMapItem> ApplicationDeltaHealthPolicies { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element in ApplicationDeltaHealthPolicies)
                {
                    if (element != null)
                    {
                        element.Validate();
