...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    public partial class ApplicationDeltaHealthPolicy
    {
        ...
        /// default.</param>
        public ApplicationDeltaHealthPolicy(ServiceTypeDeltaHealthPolicy defaultServiceTypeDeltaHealthPolicy = default(ServiceTypeDeltaHealthPolicy), IList<ServiceTypeDeltaHealthPolicyMapItem> serviceTypeDeltaHealthPolicies = default(IList<ServiceTypeDeltaHealthPolicyMapItem>))
        {
        ...
        public IList<ServiceTypeDeltaHealthPolicyMapItem> ServiceTypeDeltaHealthPolicies { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element in ServiceTypeDeltaHealthPolicies)
                {
                    if (element != null)
                    {
                        element.Validate();
