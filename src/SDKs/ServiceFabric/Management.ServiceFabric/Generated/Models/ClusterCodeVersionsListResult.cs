...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ClusterCodeVersionsListResult
        /// class.
        /// </summary>
        ...
        /// results.</param>
        public ClusterCodeVersionsListResult(IList<ClusterCodeVersionsResult> value = default(IList<ClusterCodeVersionsResult>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<ClusterCodeVersionsResult> Value { get; set; }
