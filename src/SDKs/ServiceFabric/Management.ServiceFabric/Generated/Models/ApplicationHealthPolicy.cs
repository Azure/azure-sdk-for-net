...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    public partial class ApplicationHealthPolicy
    {
        ...
        /// health policy per service type name. The map is empty by
        /// default.</param>
        public ApplicationHealthPolicy(ServiceTypeHealthPolicy defaultServiceTypeHealthPolicy = default(ServiceTypeHealthPolicy), IList<ServiceTypeHealthPolicyMapItem> serviceTypeHealthPolicies = default(IList<ServiceTypeHealthPolicyMapItem>), bool? considerWarningAsError = default(bool?), int? maxPercentUnhealthyDeployedApplications = default(int?), ServiceTypeHealthPolicy defaultServiceTypeHealthPolicy1 = default(ServiceTypeHealthPolicy), IList<ServiceTypeHealthPolicyMapItem> serviceTypeHealthPolicyMap = default(IList<ServiceTypeHealthPolicyMapItem>))
        {
        ...
        public IList<ServiceTypeHealthPolicyMapItem> ServiceTypeHealthPolicies { get; set; }
        ...
        public IList<ServiceTypeHealthPolicyMapItem> ServiceTypeHealthPolicyMap { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element in ServiceTypeHealthPolicies)
                {
                    if (element != null)
                    {
                        element.Validate();
            ...
            {
                foreach (var element1 in ServiceTypeHealthPolicyMap)
                {
                    if (element1 != null)
                    {
                        element1.Validate();
