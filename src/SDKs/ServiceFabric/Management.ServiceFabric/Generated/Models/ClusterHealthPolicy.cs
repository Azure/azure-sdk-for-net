...
namespace Microsoft.Azure.Management.ServiceFabric.Models
{
    ...
    public partial class ClusterHealthPolicy
    {
        ...
        public ClusterHealthPolicy(int? maxPercentUnhealthyNodes = default(int?), int? maxPercentUnhealthyApplications = default(int?), IList<ApplicationHealthPolicyMapItem> applicationHealthPolicies = default(IList<ApplicationHealthPolicyMapItem>))
        {
        ...
        public IList<ApplicationHealthPolicyMapItem> ApplicationHealthPolicies { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element in ApplicationHealthPolicies)
                {
                    if (element != null)
                    {
                        element.Validate();
