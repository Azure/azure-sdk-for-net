...
namespace Microsoft.Azure.Management.ServiceFabric
{
    ...
    internal partial class ClusterVersionsOperations : IServiceOperations<ServiceFabricManagementClient>, IClusterVersionsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ClusterCodeVersionsListResult>> GetWithHttpMessagesAsync(string location, string subscriptionId, string clusterVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ClusterCodeVersionsListResult>> GetByEnvironmentWithHttpMessagesAsync(string location, string environment, string subscriptionId, string clusterVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ClusterCodeVersionsListResult>> ListWithHttpMessagesAsync(string location, string subscriptionId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ClusterCodeVersionsListResult>> ListByEnvironmentWithHttpMessagesAsync(string location, string environment, string subscriptionId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "location");
