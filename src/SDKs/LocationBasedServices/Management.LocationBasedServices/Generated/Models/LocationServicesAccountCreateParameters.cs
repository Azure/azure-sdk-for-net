...
namespace Microsoft.Azure.Management.LocationServices.Models
{
    ...
    /// </summary>
    public partial class LocationServicesAccountCreateParameters
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LocationServicesAccountCreateParameters class.
        /// </summary>
        public LocationServicesAccountCreateParameters()
        {
          CustomInit();
        }
        ...
        /// characters.</param>
        public LocationServicesAccountCreateParameters(string location, Sku sku, IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Location = location;
            Tags = tags;
            Sku = sku;
