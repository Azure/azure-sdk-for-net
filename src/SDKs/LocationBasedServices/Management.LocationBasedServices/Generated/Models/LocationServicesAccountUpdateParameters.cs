...
namespace Microsoft.Azure.Management.LocationServices.Models
{
    ...
    /// </summary>
    public partial class LocationServicesAccountUpdateParameters
    {
        /// <summary>
        /// Initializes a new instance of the
        /// LocationServicesAccountUpdateParameters class.
        /// </summary>
        public LocationServicesAccountUpdateParameters()
        {
          CustomInit();
        }
        ...
        public LocationServicesAccountUpdateParameters(IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku))
        {
            Tags = tags;
            Sku = sku;
            CustomInit();
