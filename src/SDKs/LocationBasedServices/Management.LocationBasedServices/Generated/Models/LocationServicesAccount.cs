...
namespace Microsoft.Azure.Management.LocationServices.Models
{
    ...
    /// Services REST APIs.
    /// </summary>
    public partial class LocationServicesAccount : Resource
    {
        /// <summary>
        /// Initializes a new instance of the LocationServicesAccount class.
        /// </summary>
        public LocationServicesAccount()
        {
          CustomInit();
        }
        ...
        public LocationServicesAccount(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku))
            : base(id, name, type)
        {
            Location = location;
            Tags = tags;
