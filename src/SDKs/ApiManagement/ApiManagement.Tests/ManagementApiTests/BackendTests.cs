        ...
        public async Task ServiceFabricCreateUpdateDelete()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType().FullName))
            {
                ...
                try
                {
                    ...
                    backendCreateParameters.Properties.ServiceFabricCluster.PartitionResolutionRequestTimeout = TimeSpan.FromMinutes(5).ToString();
                    ...
                    Assert.Equal(TimeSpan.FromMinutes(5).ToString(), getResponse.Body.Properties.ServiceFabricCluster.PartitionResolutionRequestTimeout);
