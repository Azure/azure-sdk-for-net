        ...
        public async Task CreateListUpdateDelete()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType().FullName))
            {
                ...
                try
                {
                    ...
                    var createParameters = new PropertyCreateParameters(propertyDisplayName, propertyValue);
                    ...
                    var secretCreateParameters = new PropertyCreateParameters(secretPropertyDisplayName, secretPropertyValue)
                    {
                        Secret = true,
                        Tags = tags
                    };
