...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    /// </summary>
    internal partial class UserSubscriptionOperations : IServiceOperations<ApiManagementClient>, IUserSubscriptionOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<IPage<SubscriptionContract>>> ListWithHttpMessagesAsync(string resourceGroupName, string serviceName, string uid, ODataQuery<SubscriptionContract> odataQuery = default(ODataQuery<SubscriptionContract>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (uid != null)
            {
                if (uid.Length > 256)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "uid", 256);
                }
                if (uid.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "uid", 1);
                }
                if (!System.Text.RegularExpressions.Regex.IsMatch(uid, "^[^*#&+:<>?]+$"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "uid", "^[^*#&+:<>?]+$");
                }
            }
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/users/{uid}/subscriptions").ToString();
