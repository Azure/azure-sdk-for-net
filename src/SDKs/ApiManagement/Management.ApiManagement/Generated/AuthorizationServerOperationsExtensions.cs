...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class AuthorizationServerOperationsExtensions
    {
            ...
            /// </param>
            public static AuthorizationServerContract CreateOrUpdate(this IAuthorizationServerOperations operations, string resourceGroupName, string serviceName, string authsid, AuthorizationServerContract parameters)
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, serviceName, authsid, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<AuthorizationServerContract> CreateOrUpdateAsync(this IAuthorizationServerOperations operations, string resourceGroupName, string serviceName, string authsid, AuthorizationServerContract parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, serviceName, authsid, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
