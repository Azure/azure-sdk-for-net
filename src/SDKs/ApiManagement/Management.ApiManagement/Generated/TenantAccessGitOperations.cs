...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    internal partial class TenantAccessGitOperations : IServiceOperations<ApiManagementClient>, ITenantAccessGitOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<AccessInformationContract,TenantAccessGitGetHeaders>> GetWithHttpMessagesAsync(string resourceGroupName, string serviceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<AccessInformationContract,TenantAccessGitGetHeaders>();
