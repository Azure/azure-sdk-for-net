...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class PropertyOperationsExtensions
    {
            ...
            /// Create parameters.
            /// </param>
            public static PropertyContract CreateOrUpdate(this IPropertyOperations operations, string resourceGroupName, string serviceName, string propId, PropertyCreateParameters parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PropertyContract> CreateOrUpdateAsync(this IPropertyOperations operations, string resourceGroupName, string serviceName, string propId, PropertyCreateParameters parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
