...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    /// <summary>
    /// DiagnosticLoggerOperations operations.
    /// </summary>
    public partial interface IDiagnosticLoggerOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<LoggerContract>>> ListByServiceWithHttpMessagesAsync(string resourceGroupName, string serviceName, string diagnosticId, ODataQuery<LoggerContract> odataQuery = default(ODataQuery<LoggerContract>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<LoggerContract>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string serviceName, string diagnosticId, string loggerid, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
