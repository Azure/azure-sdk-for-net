...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class OpenIdConnectProviderOperationsExtensions
    {
            ...
            /// Create parameters.
            /// </param>
            public static OpenidConnectProviderContract CreateOrUpdate(this IOpenIdConnectProviderOperations operations, string resourceGroupName, string serviceName, string opid, OpenidConnectProviderCreateContract parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<OpenidConnectProviderContract> CreateOrUpdateAsync(this IOpenIdConnectProviderOperations operations, string resourceGroupName, string serviceName, string opid, OpenidConnectProviderCreateContract parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
