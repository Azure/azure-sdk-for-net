...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class UserCreateParameters
    {
        ...
        public UserCreateParameters(string email, string firstName, string lastName, UserState? state = default(UserState?), string note = default(string), IList<UserIdentityContract> identities = default(IList<UserIdentityContract>), string password = default(string))
        {
            State = state;
            Note = note;
