...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class OpenIdConnectProviderGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OpenIdConnectProviderGetHeaders
        /// class.
        /// </summary>
        public OpenIdConnectProviderGetHeaders()
        {
          CustomInit();
        }
        ...
        public OpenIdConnectProviderGetHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
