...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class ProductUpdateParameters
    {
        ...
        public ProductUpdateParameters(string description = default(string), string terms = default(string), bool? subscriptionRequired = default(bool?), bool? approvalRequired = default(bool?), int? subscriptionsLimit = default(int?), ProductState? state = default(ProductState?), string name = default(string))
        {
