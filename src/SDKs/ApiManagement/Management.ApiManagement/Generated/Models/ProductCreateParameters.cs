...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class ProductCreateParameters
    {
        ...
        public ProductCreateParameters(string displayName, string description = default(string), string terms = default(string), bool? subscriptionRequired = default(bool?), bool? approvalRequired = default(bool?), int? subscriptionsLimit = default(int?), ProductState? state = default(ProductState?))
        {
