...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class IdentityProviderUpdateParameters
    {
        ...
        public IdentityProviderUpdateParameters(IdentityProviderType? type = default(IdentityProviderType?), IList<string> allowedTenants = default(IList<string>), string signupPolicyName = default(string), string signinPolicyName = default(string), string profileEditingPolicyName = default(string), string passwordResetPolicyName = default(string), string clientId = default(string), string clientSecret = default(string))
        {
            Type = type;
