...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class ProductPolicyListByProductHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ProductPolicyListByProductHeaders
        /// class.
        /// </summary>
        public ProductPolicyListByProductHeaders()
        {
            CustomInit();
        }
        ...
        public ProductPolicyListByProductHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
