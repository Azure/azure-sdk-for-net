...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class SubscriptionContract : Resource
    {
        ...
        /// </param>
        /// <param name="startDate">Subscription activation date. The date
        /// conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as
        /// specified by the ISO 8601 standard.
        /// </param>
        /// <param name="expirationDate">Subscription expiration date. The date
        /// conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as
        /// specified by the ISO 8601 standard.
        /// </param>
        /// <param name="endDate">Date when subscription was cancelled or
        /// expired. The date conforms to the following format:
        ...
        /// <summary>
        /// Gets or sets subscription activation date. The date conforms to the
        ...
        /// <summary>
        /// Gets or sets subscription expiration date. The date conforms to the
        /// following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO
        /// 8601 standard.
        ///
        /// </summary>
