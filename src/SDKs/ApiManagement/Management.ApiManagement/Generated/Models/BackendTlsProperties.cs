...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class BackendTlsProperties
    {
        ...
        /// certificate chain validation should be skipped when using
        /// self-signed certificates for this backend host.</param>
        /// <param name="validateCertificateName">Flag indicating whether SSL
        /// certificate name validation should be skipped when using
        /// self-signed certificates for this backend host.</param>
        ...
        /// validation should be skipped when using self-signed certificates
        /// for this backend host.
        /// </summary>
