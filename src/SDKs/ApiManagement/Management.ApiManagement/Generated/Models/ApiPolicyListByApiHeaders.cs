...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class ApiPolicyListByApiHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ApiPolicyListByApiHeaders class.
        /// </summary>
        public ApiPolicyListByApiHeaders()
        {
            CustomInit();
        }
        ...
        public ApiPolicyListByApiHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
