...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class UserContract : Resource
    {
        ...
        /// Active. Possible values include: 'active', 'blocked'</param>
        ...
        public UserContract(string id = default(string), string name = default(string), string type = default(string), UserState? state = default(UserState?), string note = default(string), IList<UserIdentityContract> identities = default(IList<UserIdentityContract>), string firstName = default(string), string lastName = default(string), string email = default(string), System.DateTime? registrationDate = default(System.DateTime?), IList<GroupContract> groups = default(IList<GroupContract>))
            : base(id, name, type)
        {
            State = state;
            Note = note;
        ...
        /// Possible values include: 'active', 'blocked'
        /// </summary>
        ...
        public IList<GroupContract> Groups { get; private set; }
