...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class ApiSchemaListByApiHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ApiSchemaListByApiHeaders class.
        /// </summary>
        public ApiSchemaListByApiHeaders()
        {
            CustomInit();
        }
        ...
        public ApiSchemaListByApiHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
