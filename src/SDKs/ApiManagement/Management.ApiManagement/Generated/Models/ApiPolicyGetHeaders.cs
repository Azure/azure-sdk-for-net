...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class ApiPolicyGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ApiPolicyGetHeaders class.
        /// </summary>
        public ApiPolicyGetHeaders()
        {
          CustomInit();
        }
        ...
        public ApiPolicyGetHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
