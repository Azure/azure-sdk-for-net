...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class UserIdentityCollection
    {
        ...
        public UserIdentityCollection(IList<UserIdentityContract> value = default(IList<UserIdentityContract>), long? count = default(long?), string nextLink = default(string))
        {
            Value = value;
            Count = count;
            NextLink = nextLink;
        ...
        /// <summary>
        /// Gets or sets user Identity values.
        /// </summary>
        [JsonProperty(PropertyName = "value")]
        public IList<UserIdentityContract> Value { get; set; }
