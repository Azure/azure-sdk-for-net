...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class LoggerContract : Resource
    {
        ...
        public LoggerContract(IDictionary<string, string> credentials, string id = default(string), string name = default(string), string type = default(string), string description = default(string), bool? isBuffered = default(bool?))
            : base(id, name, type)
        {
        ...
        /// <summary>
        /// Static constructor for LoggerContract class.
        /// </summary>
        ...
        public static string LoggerType { get; private set; }
