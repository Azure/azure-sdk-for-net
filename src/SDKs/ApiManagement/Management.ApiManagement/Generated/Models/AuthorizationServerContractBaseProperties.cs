...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class AuthorizationServerContractBaseProperties
    {
        ...
        public AuthorizationServerContractBaseProperties(string description = default(string), IList<AuthorizationMethod?> authorizationMethods = default(IList<AuthorizationMethod?>), IList<ClientAuthenticationMethod?> clientAuthenticationMethod = default(IList<ClientAuthenticationMethod?>), IList<TokenBodyParameterContract> tokenBodyParameters = default(IList<TokenBodyParameterContract>), string tokenEndpoint = default(string), bool? supportState = default(bool?), string defaultScope = default(string), IList<BearerTokenSendingMethod?> bearerTokenSendingMethods = default(IList<BearerTokenSendingMethod?>), string clientSecret = default(string), string resourceOwnerUsername = default(string), string resourceOwnerPassword = default(string))
        {
        ...
        public IList<ClientAuthenticationMethod?> ClientAuthenticationMethod { get; set; }
        ...
        public IList<BearerTokenSendingMethod?> BearerTokenSendingMethods { get; set; }
