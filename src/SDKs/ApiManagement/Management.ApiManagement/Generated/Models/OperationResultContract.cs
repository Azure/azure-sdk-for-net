...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class OperationResultContract
    {
        ...
        public OperationResultContract(string id = default(string), AsyncOperationStatus? status = default(AsyncOperationStatus?), System.DateTime? started = default(System.DateTime?), System.DateTime? updated = default(System.DateTime?), string resultInfo = default(string), ErrorResponse error = default(ErrorResponse))
        {
            Id = id;
            Status = status;
            Started = started;
