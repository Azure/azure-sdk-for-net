...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class UserUpdateParameters
    {
        ...
        public UserUpdateParameters(UserState? state = default(UserState?), string note = default(string), IList<UserIdentityContract> identities = default(IList<UserIdentityContract>), string email = default(string), string password = default(string), string firstName = default(string), string lastName = default(string))
        {
            State = state;
            Note = note;
