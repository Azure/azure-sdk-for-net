...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class TagDescriptionGetEntityStateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TagDescriptionGetEntityStateHeaders class.
        /// </summary>
        public TagDescriptionGetEntityStateHeaders()
        {
            CustomInit();
        }
        ...
        public TagDescriptionGetEntityStateHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
