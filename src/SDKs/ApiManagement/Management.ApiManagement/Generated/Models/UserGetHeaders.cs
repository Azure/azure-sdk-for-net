...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class UserGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UserGetHeaders class.
        /// </summary>
        public UserGetHeaders()
        {
            CustomInit();
        }
        ...
        public UserGetHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
