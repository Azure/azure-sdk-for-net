...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class BackendServiceFabricClusterProperties
    {
        ...
        /// endpoint.</param>
        /// <param name="partitionResolutionRequestTimeout">The request timeout
        /// for partition resolution requests to the cluster. Timeout specified
        /// like 00:05:00</param>
        ...
        /// Collection</param>
        public BackendServiceFabricClusterProperties(string clientCertificatethumbprint, IList<string> managementEndpoints, string partitionResolutionRequestTimeout = default(string), int? maxPartitionResolutionRetries = default(int?), IList<string> serverCertificateThumbprints = default(IList<string>), IList<X509CertificateName> serverX509Names = default(IList<X509CertificateName>))
        {
            ClientCertificatethumbprint = clientCertificatethumbprint;
            PartitionResolutionRequestTimeout = partitionResolutionRequestTimeout;
        ...
        /// <summary>
        /// Gets or sets the request timeout for partition resolution requests
        /// to the cluster. Timeout specified like 00:05:00
        /// </summary>
        [JsonProperty(PropertyName = "partitionResolutionRequestTimeout")]
        public string PartitionResolutionRequestTimeout { get; set; }
