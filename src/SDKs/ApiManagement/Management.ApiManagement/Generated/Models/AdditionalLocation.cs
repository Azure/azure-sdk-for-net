...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class AdditionalLocation
    {
        ...
        /// service.</param>
        /// <param name="staticIps">Static IP addresses of the location's
        /// virtual machines.</param>
        /// <param name="virtualNetworkConfiguration">Virtual network
        /// configuration for the location.</param>
        public AdditionalLocation(string location, ApiManagementServiceSkuProperties sku, IList<string> staticIps = default(IList<string>), VirtualNetworkConfiguration virtualNetworkConfiguration = default(VirtualNetworkConfiguration))
        {
            Location = location;
            Sku = sku;
            StaticIps = staticIps;
