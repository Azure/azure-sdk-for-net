...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class TagDescriptionGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TagDescriptionGetHeaders class.
        /// </summary>
        public TagDescriptionGetHeaders()
        {
            CustomInit();
        }
        ...
        public TagDescriptionGetHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
