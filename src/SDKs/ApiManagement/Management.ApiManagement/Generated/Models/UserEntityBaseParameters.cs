...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class UserEntityBaseParameters
    {
        ...
        public UserEntityBaseParameters(UserState? state = default(UserState?), string note = default(string), IList<UserIdentityContract> identities = default(IList<UserIdentityContract>))
        {
            State = state;
            Note = note;
