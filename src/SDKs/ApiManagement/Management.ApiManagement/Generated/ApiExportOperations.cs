...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    /// </summary>
    internal partial class ApiExportOperations : IServiceOperations<ApiManagementClient>, IApiExportOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ApiExportResult>> GetWithHttpMessagesAsync(string resourceGroupName, string serviceName, string apiId, ExportFormat accept, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _httpRequest.Headers.TryAddWithoutValidation("Accept", Rest.Serialization.SafeJsonConvert.SerializeObject(accept, Client.SerializationSettings).Trim('"'));
            ...
            // Create Result
            var _result = new AzureOperationResponse<ApiExportResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ApiExportResult>(_responseContent, Client.DeserializationSettings);
                }
