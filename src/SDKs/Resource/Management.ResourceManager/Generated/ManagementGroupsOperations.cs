...
namespace Microsoft.Azure.Management.ResourceManager
{
    ...
    internal partial class ManagementGroupsOperations : IServiceOperations<ManagementGroupsAPIClient>, IManagementGroupsOperations
    {
        ...
        public async Task<AzureOperationResponse<ManagementGroup>> CreateOrUpdateWithHttpMessagesAsync(string groupId, CreateGroupRequest createGroupRequest, string cacheControl = "no-cache", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "createGroupRequest");
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            ...
            if(createGroupRequest != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(createGroupRequest, Client.SerializationSettings);
