...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class BudgetModel : ProxyResource
    {
        /// <summary>
        ...
        /// <param name="filter">May be used to filter budgets.</param>
        ...
        public BudgetModel(string category, decimal amount, string timeGrain, BudgetTimePeriod timePeriod, string id = default(string), string name = default(string), string type = default(string), string eTag = default(string), ReportConfigFilter filter = default(ReportConfigFilter), CurrentSpend currentSpend = default(CurrentSpend), IDictionary<string, Notification> notifications = default(IDictionary<string, Notification>))
        ...
        /// <summary>
        /// Gets or sets may be used to filter budgets.
        /// </summary>
