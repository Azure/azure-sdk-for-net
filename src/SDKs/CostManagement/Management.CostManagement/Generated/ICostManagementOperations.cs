...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    /// </summary>
    public partial interface ICostManagementOperations
    {
        /// <summary>
        /// The operation to check resource name availability under cost
        /// management. A name is available if no other resource exists with
        ...
        /// other resource exists with the same name, type and scope.
        /// <see href="https://docs.microsoft.com/en-us/rest/api/costmanagement/" />
        /// </summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<CheckNameAvailabilityResult>> CheckNameAvailabilityByExternalBillingAccountWithHttpMessagesAsync(string externalBillingAccountName, CheckNameAvailabilityRequestBody input, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// The operation to check resource name availability by external
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<CheckNameAvailabilityResult>> CheckNameAvailabilityByExternalSubscriptionWithHttpMessagesAsync(string externalSubscriptionName, CheckNameAvailabilityRequestBody input, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
