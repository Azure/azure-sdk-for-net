...
namespace Microsoft.Azure.Management.BotService.Models
{
    ...
    /// </summary>
    public partial class EnterpriseChannel : Resource
    {
        /// <summary>
        /// Initializes a new instance of the EnterpriseChannel class.
        /// </summary>
        ...
        /// <param name="properties">The set of properties specific to an
        /// Enterprise Channel resource.</param>
        public EnterpriseChannel(string id = default(string), string name = default(string), string location = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), string kind = default(string), string etag = default(string), EnterpriseChannelProperties properties = default(EnterpriseChannelProperties))
        ...
        /// <summary>
        /// Gets or sets the set of properties specific to an Enterprise
        /// Channel resource.
        /// </summary>
