...
namespace Microsoft.Azure.Management.BotService.Models
{
    ...
    /// </summary>
    public partial class BotResource : Resource
    {
        /// <summary>
        /// Initializes a new instance of the BotResource class.
        /// </summary>
        public BotResource()
        {
            CustomInit();
        ...
        /// resource</param>
        public BotResource(string id = default(string), string name = default(string), string location = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), string kind = default(string), string etag = default(string), BotResourceProperties properties = default(BotResourceProperties))
        ...
        public BotResourceProperties Properties { get; set; }
