...
namespace Microsoft.Azure.Management.IotHub
{
    ...
    internal partial class IotDpsResourceOperations : IServiceOperations<IotDpsClient>, IIotDpsResourceOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<NameAvailabilityInfo>> CheckNameAvailabilityWithHttpMessagesAsync(OperationInputs arguments, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
