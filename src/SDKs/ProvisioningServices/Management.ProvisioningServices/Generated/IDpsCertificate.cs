...
namespace Microsoft.Azure.Management.ProvisioningServices
{
    ...
    /// </summary>
    public partial interface IDpsCertificate
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<CertificateResponse>> GetWithHttpMessagesAsync(string certificateName, string resourceGroupName, string provisioningServiceName, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
