...
namespace Microsoft.Azure.Management.Storage
{
    ...
    /// </summary>
    internal partial class BlobServicesOperations : IServiceOperations<StorageManagementClient>, IBlobServicesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<BlobServiceProperties>> SetServicePropertiesWithHttpMessagesAsync(string resourceGroupName, string accountName, BlobServiceProperties parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<BlobServiceProperties>> GetServicePropertiesWithHttpMessagesAsync(string resourceGroupName, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
