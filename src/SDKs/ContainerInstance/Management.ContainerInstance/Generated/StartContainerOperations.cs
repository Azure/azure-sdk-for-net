...
namespace Microsoft.Azure.Management.ContainerInstance
{
    ...
    /// </summary>
    internal partial class StartContainerOperations : IServiceOperations<ContainerInstanceManagementClient>, IStartContainerOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ContainerExecResponse>> LaunchExecWithHttpMessagesAsync(string resourceGroupName, string containerGroupName, string containerName, ContainerExecRequest containerExecRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
