...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    internal partial class RecoveryServicesOperations : IServiceOperations<RecoveryServicesClient>, IRecoveryServicesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ResourceNameAvailabilityResponseResource>> CheckNameAvailabilityWithHttpMessagesAsync(string resourceGroupName, string location, ResourceNameAvailabilityParameters input, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ResourceNameAvailabilityResponseResource>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ResourceNameAvailabilityResponseResource>(_responseContent, Client.DeserializationSettings);
                }
