...
namespace Microsoft.Azure.Management.ManagementPartner
{
    ...
    /// </summary>
    internal partial class OperationOperations : IServiceOperations<ACEProvisioningGSMAPIClient>, IOperationOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OperationOperations(ACEProvisioningGSMAPIClient client)
        {
            if (client == null)
            {
