...
namespace Microsoft.Azure.Management.StorSimple8000Series
{
    ...
    /// </summary>
    internal partial class HardwareComponentGroupsOperations : IServiceOperations<StorSimple8000SeriesManagementClient>, IHardwareComponentGroupsOperations
    {
        /// <summary>
        /// Initializes a new instance of the HardwareComponentGroupsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal HardwareComponentGroupsOperations(StorSimple8000SeriesManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<HardwareComponentGroup>>> ListByDeviceWithHttpMessagesAsync(string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<HardwareComponentGroup>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<HardwareComponentGroup>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse> BeginChangeControllerPowerStateWithHttpMessagesAsync(string hardwareComponentGroupName, ControllerPowerStateChangeRequest parameters, string resourceGroupName, string managerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "hardwareComponentGroupName");
            }
            if (parameters == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("managerName", managerName);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginChangeControllerPowerState", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
