...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class ExecutionActivity : Activity
    {
        ...
        public ExecutionActivity(string name, string description = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>), LinkedServiceReference linkedServiceName = default(LinkedServiceReference), ActivityPolicy policy = default(ActivityPolicy))
