...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("AzureDataLakeStoreCosmosStructuredStreamFile")]
    [Rest.Serialization.JsonTransformation]
    public partial class AzureDataLakeStoreCosmosStructuredStreamDataset : Dataset
    {
        /// <summary>
        /// Initializes a new instance of the
        /// AzureDataLakeStoreCosmosStructuredStreamDataset class.
        /// </summary>
        public AzureDataLakeStoreCosmosStructuredStreamDataset()
        {
        ...
        /// <param name="generatedFromActivity">Flag to indicate if this
        /// dataset is been generated from Compilation Activity. Type: boolean
        /// (or Expression with resultType boolean).</param>
        public AzureDataLakeStoreCosmosStructuredStreamDataset(LinkedServiceReference linkedServiceName, object folderPath, object fileName, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder), object generatedFromActivity = default(object))
            : base(linkedServiceName, additionalProperties, description, structure, schema, parameters, annotations, folder)
        {
            FolderPath = folderPath;
            FileName = fileName;
            GeneratedFromActivity = generatedFromActivity;
            CustomInit();
        }
        ...
        /// <summary>
        /// Gets or sets flag to indicate if this dataset is been generated
        /// from Compilation Activity. Type: boolean (or Expression with
        /// resultType boolean).
        /// </summary>
        [JsonProperty(PropertyName = "typeProperties.generatedFromActivity")]
        public object GeneratedFromActivity { get; set; }
