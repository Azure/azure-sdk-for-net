...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class LookupActivity : ExecutionActivity
    {
        ...
        /// boolean).</param>
        public LookupActivity(string name, CopySource source, DatasetReference dataset, string description = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>), LinkedServiceReference linkedServiceName = default(LinkedServiceReference), ActivityPolicy policy = default(ActivityPolicy), object firstRowOnly = default(object))
