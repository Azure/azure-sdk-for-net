...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class OraclePartitionSettings
    {
        ...
        /// string).</param>
        /// <param name="partitionLowerBound">The maximum value of column
        /// specified in partitionColumnName that will be used for proceeding
        /// range partitioning. Type: string (or Expression with resultType
        /// string).</param>
        public OraclePartitionSettings(IList<object> partitionNames = default(IList<object>), object partitionColumnName = default(object), object partitionUpperBound = default(object), object partitionLowerBound = default(object))
        {
        ...
        public IList<object> PartitionNames { get; set; }
