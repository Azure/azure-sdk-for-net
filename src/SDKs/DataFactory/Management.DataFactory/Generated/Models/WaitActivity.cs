...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class WaitActivity : ControlActivity
    {
        ...
        public WaitActivity(string name, int waitTimeInSeconds, string description = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>))
