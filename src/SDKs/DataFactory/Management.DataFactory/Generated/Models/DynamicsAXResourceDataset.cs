...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class DynamicsAXResourceDataset : Dataset
    {
        ...
        public DynamicsAXResourceDataset(LinkedServiceReference linkedServiceName, object path, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), object structure = default(object), object schema = default(object), IDictionary<string, ParameterSpecification> parameters = default(IDictionary<string, ParameterSpecification>), IList<object> annotations = default(IList<object>), DatasetFolder folder = default(DatasetFolder))
