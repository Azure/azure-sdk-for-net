...
namespace Microsoft.Azure.Management.DataFactory
{
    ...
    internal partial class ActivityRunsOperations : IServiceOperations<DataFactoryManagementClient>, IActivityRunsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<ActivityRun>>> QueryByPipelineRunWithHttpMessagesAsync(string resourceGroupName, string factoryName, string runId, RunFilterParameters filterParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ActivityRun>>> QueryByPipelineRunNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "QueryByPipelineRunNext", tracingParameters);
            }
            // Construct URL
