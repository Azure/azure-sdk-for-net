...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public static partial class ArmTemplatesOperationsExtensions
    {
            ...
            {
                return Task.Factory.StartNew(s => ((IArmTemplatesOperations)s).ListAsync(labName, artifactSourceName, odataQuery), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                return Task.Factory.StartNew(s => ((IArmTemplatesOperations)s).GetAsync(labName, artifactSourceName, name, expand), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                return Task.Factory.StartNew(s => ((IArmTemplatesOperations)s).ListNextAsync(nextPageLink), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
