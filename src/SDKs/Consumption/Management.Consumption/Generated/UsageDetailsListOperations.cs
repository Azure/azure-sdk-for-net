...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    /// </summary>
    internal partial class UsageDetailsListOperations : IServiceOperations<ConsumptionManagementClient>, IUsageDetailsListOperations
    {
        /// <summary>
        /// Initializes a new instance of the UsageDetailsListOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal UsageDetailsListOperations(ConsumptionManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<UsageDetailsDownloadResponse,UsageDetailsListDownloadHeaders>> BeginDownloadWithHttpMessagesAsync(string scope, string metric = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{scope}/providers/Microsoft.Consumption/usageDetails/download").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<UsageDetailsDownloadResponse,UsageDetailsListDownloadHeaders>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<UsageDetailsDownloadResponse>(_responseContent, Client.DeserializationSettings);
                }
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<UsageDetailsListDownloadHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
