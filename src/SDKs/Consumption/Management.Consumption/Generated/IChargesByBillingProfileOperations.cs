...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public partial interface IChargesByBillingProfileOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<ChargesListByBillingProfile>> ListWithHttpMessagesAsync(string billingAccountId, string billingProfileId, string startDate, string endDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
