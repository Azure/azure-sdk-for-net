...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    /// </summary>
    internal partial class ChargesByBillingAccountOperations : IServiceOperations<ConsumptionManagementClient>, IChargesByBillingAccountOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ChargesListByBillingAccount>> ListWithHttpMessagesAsync(string billingAccountId, string startDate, string endDate, string apply = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ChargesListByBillingAccount>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ChargesListByBillingAccount>(_responseContent, Client.DeserializationSettings);
                }
