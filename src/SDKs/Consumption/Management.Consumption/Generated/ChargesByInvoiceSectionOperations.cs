...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    /// </summary>
    internal partial class ChargesByInvoiceSectionOperations : IServiceOperations<ConsumptionManagementClient>, IChargesByInvoiceSectionOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ChargesListByInvoiceSection>> ListWithHttpMessagesAsync(string billingAccountId, string invoiceSectionId, string startDate, string endDate, string apply = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ChargesListByInvoiceSection>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ChargesListByInvoiceSection>(_responseContent, Client.DeserializationSettings);
                }
