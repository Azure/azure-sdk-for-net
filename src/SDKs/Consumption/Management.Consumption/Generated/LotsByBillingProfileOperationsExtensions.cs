...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public static partial class LotsByBillingProfileOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<Lots> ListAsync(this ILotsByBillingProfileOperations operations, string billingAccountId, string billingProfileId, CancellationToken cancellationToken = default(CancellationToken))
            {
