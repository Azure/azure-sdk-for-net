...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public partial interface IChargesByBillingAccountOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<ChargesListByBillingAccount>> ListWithHttpMessagesAsync(string billingAccountId, string startDate, string endDate, string apply = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
