...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    internal partial class EventsByBillingProfileOperations : IServiceOperations<ConsumptionManagementClient>, IEventsByBillingProfileOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<Events>> ListWithHttpMessagesAsync(string billingAccountId, string billingProfileId, string startDate, string endDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<Events>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Events>(_responseContent, Client.DeserializationSettings);
                }
