...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    /// </summary>
    internal partial class ChargesByBillingProfileOperations : IServiceOperations<ConsumptionManagementClient>, IChargesByBillingProfileOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<ChargesListByBillingProfile>> ListWithHttpMessagesAsync(string billingAccountId, string billingProfileId, string startDate, string endDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ChargesListByBillingProfile>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ChargesListByBillingProfile>(_responseContent, Client.DeserializationSettings);
                }
