...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    internal partial class LotsByBillingProfileOperations : IServiceOperations<ConsumptionManagementClient>, ILotsByBillingProfileOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<Lots>> ListWithHttpMessagesAsync(string billingAccountId, string billingProfileId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<Lots>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Lots>(_responseContent, Client.DeserializationSettings);
                }
