...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public partial interface ILotsByBillingProfileOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<Lots>> ListWithHttpMessagesAsync(string billingAccountId, string billingProfileId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
