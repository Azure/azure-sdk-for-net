...
namespace Microsoft.Azure.Management.Consumption.Models
{
    ...
    public partial class EnrollmentAccount : Resource
    {
        ...
        public EnrollmentAccount(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string accountName = default(string), string costCenter = default(string), string accountOwner = default(string), string status = default(string), System.DateTime? startDate = default(System.DateTime?), System.DateTime? endDate = default(System.DateTime?), Department department = default(Department))
