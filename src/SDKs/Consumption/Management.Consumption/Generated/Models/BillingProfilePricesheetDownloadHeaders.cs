...
namespace Microsoft.Azure.Management.Consumption.Models
{
    ...
    /// </summary>
    public partial class BillingProfilePricesheetDownloadHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BillingProfilePricesheetDownloadHeaders class.
        /// </summary>
        public BillingProfilePricesheetDownloadHeaders()
        {
            CustomInit();
        }
        ...
        public BillingProfilePricesheetDownloadHeaders(string location = default(string), string retryAfter = default(string), string azureAsyncOperation = default(string), string oDataEntityId = default(string))
        {
            Location = location;
