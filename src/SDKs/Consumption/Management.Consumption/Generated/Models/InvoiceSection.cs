...
namespace Microsoft.Azure.Management.Consumption.Models
{
    ...
    public partial class InvoiceSection : Resource
    {
        ...
        public InvoiceSection(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string displayName = default(string), IList<BillingProfile> billingProfiles = default(IList<BillingProfile>))
