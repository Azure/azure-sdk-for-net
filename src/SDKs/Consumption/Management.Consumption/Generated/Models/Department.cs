...
namespace Microsoft.Azure.Management.Consumption.Models
{
    ...
    public partial class Department : Resource
    {
        ...
        /// $expand.</param>
        public Department(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string departmentName = default(string), string costCenter = default(string), string status = default(string), IList<EnrollmentAccount> enrollmentAccounts = default(IList<EnrollmentAccount>))
