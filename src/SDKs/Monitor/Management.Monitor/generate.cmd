...
@echo on
call autorest %specFile1% --csharp --csharp-sdks-folder=%sdksRoot% --latest --clear-output-folder
call autorest %specFile2% --csharp --csharp-sdks-folder=%sdksRoot% --latest --clear-output-folder
