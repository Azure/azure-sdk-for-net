...
namespace Microsoft.Azure.Management.EventHub.Models
{
    ...
    public partial class ConsumerGroup : Resource
    {
        ...
        /// stored.</param>
        public ConsumerGroup(string id = default(string), string name = default(string), string type = default(string), System.DateTime? createdAt = default(System.DateTime?), string eventHubPath = default(string), System.DateTime? updatedAt = default(System.DateTime?), string userMetadata = default(string))
            : base(id, name, type)
        {
            CreatedAt = createdAt;
