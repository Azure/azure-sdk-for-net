...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class NetworkInterfaceTapConfiguration : SubResource
    {
        ...
        public NetworkInterfaceTapConfiguration(string id = default(string), VirtualNetworkTap virtualNetworkTap = default(VirtualNetworkTap), string name = default(string), string etag = default(string), string type = default(string))
            : base(id)
        {
