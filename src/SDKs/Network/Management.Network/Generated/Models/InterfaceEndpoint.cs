...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class InterfaceEndpoint : Resource
    {
        ...
        public InterfaceEndpoint(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string fqdn = default(string), EndpointService endpointService = default(EndpointService), SubResource subnet = default(SubResource), IList<SubResource> networkInterfaces = default(IList<SubResource>), string owner = default(string), string etag = default(string))
