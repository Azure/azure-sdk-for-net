...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class Subnet : SubResource
    {
        ...
        /// resource.</param>
        /// <param name="privateAccessServices">An array of private access
        /// services values.</param>
        ...
        public Subnet(string id = default(string), string addressPrefix = default(string), NetworkSecurityGroup networkSecurityGroup = default(NetworkSecurityGroup), RouteTable routeTable = default(RouteTable), IList<PrivateAccessServicePropertiesFormat> privateAccessServices = default(IList<PrivateAccessServicePropertiesFormat>), IList<IPConfiguration> ipConfigurations = default(IList<IPConfiguration>), IList<ResourceNavigationLink> resourceNavigationLinks = default(IList<ResourceNavigationLink>), string provisioningState = default(string), string name = default(string), string etag = default(string))
            : base(id)
        {
            AddressPrefix = addressPrefix;
            NetworkSecurityGroup = networkSecurityGroup;
            RouteTable = routeTable;
            PrivateAccessServices = privateAccessServices;
        ...
        /// <summary>
        /// Gets or sets an array of private access services values.
        /// </summary>
        [JsonProperty(PropertyName = "properties.privateAccessServices")]
        public IList<PrivateAccessServicePropertiesFormat> PrivateAccessServices { get; set; }
