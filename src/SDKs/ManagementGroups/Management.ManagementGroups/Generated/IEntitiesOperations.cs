...
namespace Microsoft.Azure.Management.ManagementGroups
{
    ...
    public partial interface IEntitiesOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<EntityInfo>>> ListWithHttpMessagesAsync(string groupName = default(string), string cacheControl = "no-cache", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List all entities (Management Groups, Subscriptions, etc.) for the
        /// authenticated user.
        ///
