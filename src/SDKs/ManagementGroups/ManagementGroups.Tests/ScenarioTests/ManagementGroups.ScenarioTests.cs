    ...
    public class LiveManagementGroupsTests : TestBase
    {
        ...
        public void CreateGroup()
        {
            using (MockContext context = MockContext.Start(this.GetType().FullName))
            {
                ...
                var managementGroup = managementGroupsClient.ManagementGroups.CreateOrUpdate(groupId, new CreateManagementGroupRequest("TestGroup123->Child2", "/providers/Microsoft.Management/managementGroups/testGroup123"), cacheControl: "no-cache");
