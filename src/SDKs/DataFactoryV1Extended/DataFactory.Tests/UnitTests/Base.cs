...
namespace DataFactory.Tests.UnitTests
{
    ...
    {
        private class TestDataFactoryManagementExtendedClient : DataFactoryManagementExtendedClient
        {
            internal TestDataFactoryManagementExtendedClient(params DelegatingHandler[] handlers) : base(handlers)
            {
        ...
        /// </summary>
        /// <param name="TSample">JSON sample class</param>
        /// <param name="TResource">JSON sample type</param>
        ...
        public JsonSerializerSettings GetFullSerializerSettings(IDataFactoryManagementExtendedClient client, bool includeNulls = false)
        {
        ...
        public void TestJsonSample<TResource>(JsonSampleInfo sampleInfo)
        {
            ...
            IDataFactoryManagementExtendedClient client = this.CreateWorkflowClient(handler);
        ...
        /// <summary>
        /// Creates a mock DataFactoryManagementExtendedClient
        /// </summary>
        /// <param name="handler">delegating handler for http requests</param>
        /// <returns>DataFactoryManagementExtendedClient Client</returns>
        protected IDataFactoryManagementExtendedClient CreateWorkflowClient(RecordedDelegatingHandler handler = null)
        {
            if (handler == null)
            {
            ...
            var client = new TestDataFactoryManagementExtendedClient(handler);
