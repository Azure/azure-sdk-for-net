...
﻿namespace Microsoft.Azure.Batch
{
    ...
    public partial class CloudPool : IRefreshable
    {
        ...
        /// </remarks>
        public System.Threading.Tasks.Task ChangeOSVersionAsync(string targetOSVersion, IEnumerable<BatchClientBehavior> additionalBehaviors = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // throw if if this object is unbound
            UtilitiesInternal.ThrowOnUnbound(this.propertyContainer.BindingState);
            ...
            System.Threading.Tasks.Task asyncTask =  this.parentBatchClient.PoolOperations.ParentBatchClient.ProtocolLayer.UpgradePoolOS(this.Id, targetOSVersion, bhMgr, cancellationToken);
        ...
        /// </remarks>
        public void ChangeOSVersion(string targetOSVersion, IEnumerable<BatchClientBehavior> additionalBehaviors = null)
        {
            Task asyncTask = ChangeOSVersionAsync(targetOSVersion, additionalBehaviors);
            asyncTask.WaitAndUnaggregateException(this.CustomBehaviors, additionalBehaviors);
        }
