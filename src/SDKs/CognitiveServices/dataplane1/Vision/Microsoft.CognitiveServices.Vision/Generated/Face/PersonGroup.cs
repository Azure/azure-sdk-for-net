...
namespace Microsoft.CognitiveServices.Vision.Face
{
    ...
    /// </summary>
    public partial class PersonGroup : IServiceOperations<FaceAPI>, IPersonGroup
    {
        /// <summary>
        ...
        /// </exception>
        public PersonGroup(FaceAPI client)
        {
            if (client == null)
            {
        ...
        public async Task<HttpOperationResponse<PersonGroupResult>> GetWithHttpMessagesAsync(string personGroupId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new HttpOperationResponse<PersonGroupResult>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<PersonGroupResult>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<HttpOperationResponse<IList<PersonGroupResult>>> ListWithHttpMessagesAsync(string start = default(string), int? top = 1000, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<PersonGroupResult>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<IList<PersonGroupResult>>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
