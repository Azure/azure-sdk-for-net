...
namespace Microsoft.CognitiveServices.Vision.Face.Models
{
    ...
    /// </summary>
    public partial class CreateFaceListRequest
    {
        /// <summary>
        /// Initializes a new instance of the CreateFaceListRequest class.
        /// </summary>
        public CreateFaceListRequest()
        {
          CustomInit();
        }
        ...
        public CreateFaceListRequest(string name = default(string), string userData = default(string))
        {
            Name = name;
            UserData = userData;
            CustomInit();
