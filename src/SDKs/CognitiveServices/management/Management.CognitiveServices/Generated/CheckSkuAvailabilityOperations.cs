...
namespace Microsoft.Azure.Management.CognitiveServices
{
    ...
    /// </summary>
    internal partial class CheckSkuAvailabilityOperations : IServiceOperations<CognitiveServicesManagementClient>, ICheckSkuAvailabilityOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<CheckSkuAvailabilityResultList>> ListWithHttpMessagesAsync(string location, IList<string> skus, string kind, string type, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<CheckSkuAvailabilityResultList>(_responseContent, Client.DeserializationSettings);
                }
