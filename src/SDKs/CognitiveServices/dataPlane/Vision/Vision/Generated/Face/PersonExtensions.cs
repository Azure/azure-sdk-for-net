...
namespace Microsoft.Azure.CognitiveServices.Vision.Face
{
    ...
    public static partial class PersonExtensions
    {
            ...
            /// faces of the person). Start and top are used to specify a range of person
            /// groups to list indicated by a 'start'ing Person ID and the number (top) of
            /// persons to return.
            /// </summary>
            /// <param name='operations'>
            /// The operations group for this extension method.
            ...
            /// 'start' parameter.
            /// </param>
            public static IList<PersonResult> List(this IPerson operations, string personGroupId, string start = default(string), int? top = default(int?))
            {
