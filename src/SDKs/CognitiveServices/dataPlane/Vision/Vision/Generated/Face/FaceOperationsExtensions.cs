...
namespace Microsoft.Azure.CognitiveServices.Vision.Face
{
    ...
    public static partial class FaceOperationsExtensions
    {
            ...
            /// </param>
            public static IList<SimilarFaceResult> FindSimilar(this IFaceOperations operations, string faceId, string faceListId = default(string), IList<string> faceIds = default(IList<string>), int? maxNumOfCandidatesReturned = 20, string mode = default(string))
            {
                return operations.FindSimilarAsync(faceId, faceListId, faceIds, maxNumOfCandidatesReturned, mode).GetAwaiter().GetResult();
            }
            ...
            /// faces
            /// </param>
            public static GroupResponse Group(this IFaceOperations operations, IList<string> faceIds)
            {
                return operations.GroupAsync(faceIds).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static IList<IdentifyResultItem> Identify(this IFaceOperations operations, string personGroupId, IList<string> faceIds, int? maxNumOfCandidatesReturned = 1, double? confidenceThreshold = default(double?))
            {
                return operations.IdentifyAsync(personGroupId, faceIds, maxNumOfCandidatesReturned, confidenceThreshold).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static IList<DetectedFace> Detect(this IFaceOperations operations, string url, bool? returnFaceId = true, bool? returnFaceLandmarks = false, string returnFaceAttributes = default(string))
            {
                return operations.DetectAsync(url, returnFaceId, returnFaceLandmarks, returnFaceAttributes).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<DetectedFace>> DetectAsync(this IFaceOperations operations, string url, bool? returnFaceId = true, bool? returnFaceLandmarks = false, string returnFaceAttributes = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// computational and time cost.
            /// </param>
            public static IList<DetectedFace> DetectInStream(this IFaceOperations operations, Stream image, bool? returnFaceId = true, bool? returnFaceLandmarks = false, string returnFaceAttributes = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<DetectedFace>> DetectInStreamAsync(this IFaceOperations operations, Stream image, bool? returnFaceId = true, bool? returnFaceLandmarks = false, string returnFaceAttributes = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
