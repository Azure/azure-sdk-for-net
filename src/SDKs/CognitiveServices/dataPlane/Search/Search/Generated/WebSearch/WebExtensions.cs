...
namespace Microsoft.Azure.CognitiveServices.Search.WebSearch
{
    ...
    public static partial class WebExtensions
    {
            ...
            /// </param>
            public static async Task<SearchResponse> SearchAsync(this IWeb operations, string query, string acceptLanguage = default(string), string pragma = default(string), string userAgent = default(string), string clientId = default(string), string clientIp = default(string), string location = default(string), int? answerCount = default(int?), string countryCode = default(string), int? count = default(int?), Freshness? freshness = default(Freshness?), string market = default(string), int? offset = default(int?), IList<string> promote = default(IList<string>), IList<string> responseFilter = default(IList<string>), SafeSearch? safeSearch = default(SafeSearch?), string setLang = default(string), bool? textDecorations = default(bool?), TextFormat? textFormat = default(TextFormat?), CancellationToken cancellationToken = default(CancellationToken))
            {
