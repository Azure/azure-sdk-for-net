...
namespace Microsoft.Azure.CognitiveServices.Search.EntitySearch
{
    ...
    public static partial class EntitiesOperationsExtensions
    {
            ...
            /// </param>
            /// <param name='accept'>
            /// The default media type is application/json. To specify that the response
            /// use [JSON-LD](http://json-ld.org/), set the Accept header to
            /// application/ld+json.
            /// </param>
            ...
            /// </param>
            public static async Task<SearchResponse> SearchAsync(this IEntitiesOperations operations, string query, string accept = default(string), string acceptLanguage = default(string), string pragma = default(string), string userAgent = default(string), string clientId = default(string), string clientIp = default(string), string location = default(string), string countryCode = default(string), string market = default(string), IList<AnswerType?> responseFilter = default(IList<AnswerType?>), IList<ResponseFormat?> responseFormat = default(IList<ResponseFormat?>), SafeSearch? safeSearch = default(SafeSearch?), string setLang = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.SearchWithHttpMessagesAsync(query, accept, acceptLanguage, pragma, userAgent, clientId, clientIp, location, countryCode, market, responseFilter, responseFormat, safeSearch, setLang, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
