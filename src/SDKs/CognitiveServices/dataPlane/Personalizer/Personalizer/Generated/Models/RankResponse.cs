...
namespace Microsoft.Azure.CognitiveServices.Personalizer.Models
{
    ...
    public partial class RankResponse
    {
        ...
        /// <summary>
        /// Gets or sets the calculated ranking for the current request.
        /// </summary>
        [JsonProperty(PropertyName = "ranking")]
        public IList<RankedAction> Ranking { get; set; }

        /// <summary>
        /// Gets or sets the eventId for the round trip from request to
        /// response.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the action chosen by the Personalizer service. This is
