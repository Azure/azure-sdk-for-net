    ...
    public partial class RankResponse
    {
        ...
        public virtual void Validate()
        {
            ...
            if (EventId != null)
            {
                ...
                if (EventId.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "EventId", 1);
                }
            }
            if (RewardActionId != null)
            {
                ...
                if (RewardActionId.Length < 0)
                {
                    throw new ValidationException(ValidationRules.MinLength, "RewardActionId", 0);
                }
            }
        }
    }
