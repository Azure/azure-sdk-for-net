...
namespace Microsoft.Azure.CognitiveServices.Language.LUIS.Authoring.Models
{
    ...
    public partial class CustomPrebuiltModel
    {
        ...
        /// name.</param>
        public CustomPrebuiltModel(System.Guid id, string readableType, string name = default(string), int? typeId = default(int?), string customPrebuiltDomainName = default(string), string customPrebuiltModelName = default(string), IList<EntityRole> roles = default(IList<EntityRole>))
        {
            Id = id;
            Name = name;
            TypeId = typeId;
