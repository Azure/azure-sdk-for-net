...
namespace Microsoft.Azure.CognitiveServices.Language.TextAnalytics
{
    ...
    public static partial class TextAnalyticsClientExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> SentimentAsync(this ITextAnalyticsClient operations, bool? showStats = default(bool?), MultiLanguageBatchInput multiLanguageBatchInput = default(MultiLanguageBatchInput), CancellationToken cancellationToken = default(CancellationToken))
            {
