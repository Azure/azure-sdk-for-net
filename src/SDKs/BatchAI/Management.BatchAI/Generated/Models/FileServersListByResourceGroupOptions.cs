...
namespace Microsoft.Azure.Management.BatchAI.Models
{
    ...
    /// </summary>
    public partial class FileServersListByResourceGroupOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// FileServersListByResourceGroupOptions class.
        /// </summary>
        public FileServersListByResourceGroupOptions()
        {
            CustomInit();
        }
        ...
        public FileServersListByResourceGroupOptions(string filter = default(string), string select = default(string), int? maxResults = default(int?))
        {
            Filter = filter;
            Select = select;
