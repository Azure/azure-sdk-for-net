...
namespace Microsoft.Azure.Management.ManagedServices
{
    ...
    public partial interface IRegistrationDefinitionsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> DeleteWithHttpMessagesAsync(string registrationDefinitionId, string apiVersion, string scope, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<RegistrationDefinition>> BeginCreateOrUpdateWithHttpMessagesAsync(string registrationDefinitionId, string apiVersion, string scope, RegistrationDefinition requestBody, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a list of the registration definitions.
        /// </summary>
