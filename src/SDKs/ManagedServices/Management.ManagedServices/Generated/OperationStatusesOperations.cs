...
namespace Microsoft.Azure.Management.ManagedServices
{
    ...
    /// </summary>
    internal partial class OperationStatusesOperations : IServiceOperations<ManagedServicesClient>, IOperationStatusesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OperationStatusesOperations(ManagedServicesClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<OperationStatus>> BeginGetWithHttpMessagesAsync(string scope, string operationId, string apiVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (scope == null)
            {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{scope}/providers/Microsoft.ManagedServices/operationstatuses/{operationId}").ToString();
