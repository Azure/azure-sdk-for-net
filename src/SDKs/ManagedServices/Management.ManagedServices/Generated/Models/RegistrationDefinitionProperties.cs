...
namespace Microsoft.Azure.Management.ManagedServices.Models
{
    ...
    public partial class RegistrationDefinitionProperties
    {
        ...
        /// tenant.</param>
        public RegistrationDefinitionProperties(string description, IList<Authorization> authorizations, string managedByTenantId, ProvisioningState? provisioningState = default(ProvisioningState?), string managedByTenantName = default(string))
        {
