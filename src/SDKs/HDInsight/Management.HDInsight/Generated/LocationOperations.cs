...
namespace Microsoft.Azure.Management.HDInsight
{
    ...
    /// </summary>
    internal partial class LocationOperations : IServiceOperations<HDInsightManagementClient>, ILocationOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal LocationOperations(HDInsightManagementClient client)
        {
            if (client == null)
            {
