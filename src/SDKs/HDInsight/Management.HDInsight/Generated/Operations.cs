...
namespace Microsoft.HDInsight
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<HDInsightManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(HDInsightManagementClient client)
        {
            if (client == null)
            {
        ...
        {
            string apiVersion = "2015-03-01-preview";
            // Tracing
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.HDInsight/operations").ToString();
