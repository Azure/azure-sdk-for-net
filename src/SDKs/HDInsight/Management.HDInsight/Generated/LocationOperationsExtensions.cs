...
namespace Microsoft.Azure.Management.HDInsight
{
    ...
    public static partial class LocationOperationsExtensions
    {
            ...
            /// </param>
            public static CapabilitiesResult GetCapabilities(this ILocationOperations operations, string location)
            {
            ...
            /// </param>
            public static async Task<CapabilitiesResult> GetCapabilitiesAsync(this ILocationOperations operations, string location, CancellationToken cancellationToken = default(CancellationToken))
            {
