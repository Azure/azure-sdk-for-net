...
namespace EdgeGateway.Tests
{
    public class StorageAccountCredentialsTests : EdgeGatewayTestBase
    {
        ...
        public void Test_SACManagement()
        {
            ...
            AsymmetricEncryptedSecret encryptedSecret = Client.Devices.GetAsymmetricEncryptedSecret(TestConstants.GatewayResourceName, TestConstants.DefaultResourceGroupName, "<Access Key>", TestConstants.ActivationKey);
