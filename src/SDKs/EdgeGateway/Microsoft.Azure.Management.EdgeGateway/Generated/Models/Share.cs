...
namespace Microsoft.Azure.Management.EdgeGateway.Models
{
    ...
    public partial class Share : ARMBaseModel
    {
        ...
        /// values include: 'Online', 'Offline'</param>
        ...
        /// access rights on the share (mandatory for SMB protocol).</param>
        /// <param name="clientAccessRights">List of IP addresses and
        /// corresponding access rights on the share(mandatory for NFS
        /// protocol).</param>
        ...
        /// the share (mandatory for SMB protocol).
        /// </summary>
        ...
        /// on the share(mandatory for NFS protocol).
        /// </summary>
