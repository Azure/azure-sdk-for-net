...
namespace Microsoft.Azure.Management.EdgeGateway.Models
{
    ...
    public partial class Order : ARMBaseModel
    {
        ...
        /// <param name="deliveryTrackingInfo">Tracking information related to
        /// the packages being delivered to the customer whether original or
        /// replacement devices.</param>
        /// <param name="returnTrackingInfo">Tracking information related to
        /// the package being returned from the customer whether original or
        /// replacement devices.</param>
        ...
        /// <summary>
        /// Gets tracking information related to the packages being delivered
        /// to the customer whether original or replacement devices.
        /// </summary>
        [JsonProperty(PropertyName = "properties.deliveryTrackingInfo")]
        public IList<TrackingInfo> DeliveryTrackingInfo { get; private set; }

        /// <summary>
        /// Gets tracking information related to the package being returned
        /// from the customer whether original or replacement devices.
        /// </summary>
