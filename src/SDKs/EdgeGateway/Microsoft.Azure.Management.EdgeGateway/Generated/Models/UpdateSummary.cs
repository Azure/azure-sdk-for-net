...
namespace Microsoft.Azure.Management.EdgeGateway.Models
{
    ...
    public partial class UpdateSummary : ARMBaseModel
    {
        ...
        /// <param name="deviceVersionNumber">The current version of the
        /// device, of format: 1.2.17312.13.</param>
        /// <param name="friendlyDeviceVersionName">The current version of the
        /// device represented in text format.</param>
        ...
        /// appliance.</param>
        /// <param name="totalNumberOfUpdatesAvailable">Count of updates that
        /// are available for the current device version as per the last scan
        /// on the device.</param>
        ...
        /// values include: 'NeverReboots', 'RequiresReboot',
        /// 'RequestReboot'</param>
        ...
        /// job if a download is in progress.</param>
        /// <param name="inProgressInstallJobId">The Job ID of the install job
        /// if an install is in progress.</param>
        ...
        /// <param name="updateTitles">The list of update titles which are
        /// available for install.</param>
        ...
        /// <summary>
        /// Gets or sets the current version of the device, of format:
        /// 1.2.17312.13.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the current version of the device represented in text
        /// format.
        /// </summary>
        ...
        /// <summary>
        /// Gets count of updates that are available for the current device
        /// version as per the last scan on the device.
        /// </summary>
        ...
        /// update items detected needs a reboot. Possible values include:
        ...
        /// <summary>
        /// Gets the Job ID of the download job if a download is in progress.
        /// </summary>
        [JsonProperty(PropertyName = "properties.inProgressDownloadJobId")]
        public string InProgressDownloadJobId { get; private set; }

        /// <summary>
        /// Gets the Job ID of the install job if an install is in progress.
        /// </summary>
        ...
        /// <summary>
        /// Gets the list of update titles which are available for install.
        /// </summary>
