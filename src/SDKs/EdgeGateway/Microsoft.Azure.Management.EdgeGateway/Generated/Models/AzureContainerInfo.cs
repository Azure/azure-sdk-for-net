...
namespace Microsoft.Azure.Management.EdgeGateway.Models
{
    ...
    public partial class AzureContainerInfo
    {
        ...
        /// credential to be used for accessing storage.</param>
        /// <param name="containerName">Container name (Based on the data
        /// format specified, represents the name of Azure file/ Page blob /
        /// Block blob).</param>
        ...
        /// <summary>
        /// Gets or sets ID of the Storage account credential to be used for
        /// accessing storage.
        /// </summary>
