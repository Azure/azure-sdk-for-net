...
namespace Microsoft.Azure.Management.EdgeGateway.Models
{
    ...
    /// <summary>
    /// The mapping between a particular user and the type of access they have
    /// on the SMB share.
    /// </summary>
    public partial class UserAccessRight
    {
        ...
        /// Initializes a new instance of the UserAccessRight class.
        /// </summary>
        /// <param name="userId">Id of the user (already existing in the
        /// device).</param>
        ...
        /// <summary>
        /// Gets or sets id of the user (already existing in the device).
        /// </summary>
