...
namespace Microsoft.Azure.Management.EdgeGateway
{
    ...
    /// </summary>
    internal partial class StorageAccountCredentialsOperations : IServiceOperations<DataBoxEdgeManagementClient>, IStorageAccountCredentialsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<StorageAccountCredential>>> ListByDataBoxEdgeDeviceWithHttpMessagesAsync(string deviceName, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (deviceName == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<StorageAccountCredential>>();
        ...
        /// </param>
        /// <param name='name'>
        /// Name of the storage account credential to be fetched.
        /// </param>
        /// <param name='resourceGroupName'>
        /// The resource group name.
        /// </param>
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<StorageAccountCredential>> GetWithHttpMessagesAsync(string deviceName, string name, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (deviceName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "deviceName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<StorageAccountCredential>>> ListByDataBoxEdgeDeviceNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
