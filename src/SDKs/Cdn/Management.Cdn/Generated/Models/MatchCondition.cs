...
namespace Microsoft.Azure.Management.Cdn.Models
{
    ...
    public partial class MatchCondition
    {
        ...
        /// for QueryString, RequestUri, RequestHeaders or RequestBody.</param>
        /// <param name="negateCondition">Describes if the result of this
        /// condition should be negated.</param>
        public MatchCondition(string matchVariable, string operatorProperty, IList<string> matchValue, string selector = default(string), bool? negateCondition = default(bool?))
        {
        ...
        /// include: 'RemoteAddr', 'Country', 'RequestMethod', 'RequestHeader',
