...
namespace Microsoft.Azure.Management.Cdn.Models
{
    ...
    public partial class QueryStringMatchConditionParameters
    {
        ...
        public QueryStringMatchConditionParameters(string operatorProperty, IList<string> matchValues, bool? negateCondition = default(bool?), IList<string> transforms = default(IList<string>))
        {
