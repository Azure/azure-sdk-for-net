...
namespace Microsoft.Azure.Management.Cdn.Models
{
    ...
    public partial class RequestHeaderMatchConditionParameters
    {
        ...
        public RequestHeaderMatchConditionParameters(string selector, string operatorProperty, IList<string> matchValues, bool? negateCondition = default(bool?), IList<string> transforms = default(IList<string>))
        {
            Selector = selector;
