...
namespace Microsoft.Azure.Management.NotificationHubs
{
    ...
    internal partial class NamespacesOperations : IServiceOperations<NotificationHubsManagementClient>, INamespacesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CheckAvailabilityResource>> CheckNamespaceAvailabilityWithHttpMessagesAsync(CheckAvailabilityParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
