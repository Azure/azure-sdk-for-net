...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    ...
    public partial class NHNamespaceUpdateParameters : ResourceNamespacePatch
    {
        /// <summary>
        /// Initializes a new instance of the NHNamespaceUpdateParameters
        /// class.
        /// </summary>
        public NHNamespaceUpdateParameters()
        {
            CustomInit();
        }
        ...
        /// metrics</param>
        public NHNamespaceUpdateParameters(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), NHSku sku = default(NHSku), string provisioningState = default(string), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? updatedAt = default(System.DateTime?), string notificationHubsEndpoint = default(string), string metricId = default(string))
