...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    ...
    /// </summary>
    public partial class NHSku
    {
        /// <summary>
        /// Initializes a new instance of the NHSku class.
        /// </summary>
        public NHSku()
        {
            CustomInit();
        ...
        public NHSku(SkuName name, SkuTier? tier = default(SkuTier?), int? capacity = default(int?))
        {
            Name = name;
            Tier = tier;
            Capacity = capacity;
