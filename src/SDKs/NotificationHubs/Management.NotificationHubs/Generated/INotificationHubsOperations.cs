...
namespace Microsoft.Azure.Management.NotificationHubs
{
    ...
    public partial interface INotificationHubsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<CheckNameAvailabilityResponse>> CheckNotificationHubAvailabilityWithHttpMessagesAsync(string resourceGroupName, string namespaceName, CheckNameAvailabilityRequestParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
