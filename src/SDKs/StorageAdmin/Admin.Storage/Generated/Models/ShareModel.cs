...
namespace Microsoft.AzureStack.Storage.Admin.Models
{
    ...
    public partial class ShareModel : ResourceBase
    {
        ...
        /// Initializes a new instance of the ShareModel class.
        /// </summary>
        public ShareModel(string id, string name, string type, string location, IDictionary<string, string> tags = default(IDictionary<string, string>), Share properties = default(Share))
