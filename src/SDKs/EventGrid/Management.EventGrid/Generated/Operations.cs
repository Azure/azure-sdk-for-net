...
namespace Microsoft.Azure.Management.EventGrid
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<EventGridManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(EventGridManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.EventGrid/operations").ToString();
