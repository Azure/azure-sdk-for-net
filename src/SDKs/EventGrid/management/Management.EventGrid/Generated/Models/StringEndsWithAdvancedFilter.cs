...
namespace Microsoft.Azure.Management.EventGrid.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the StringEndsWithAdvancedFilter
        /// class.
        /// </summary>
        ...
        public StringEndsWithAdvancedFilter(string key = default(string), IList<string> values = default(IList<string>))
            : base(key)
        {
            Values = values;
            CustomInit();
