...
namespace Microsoft.Azure.EventGrid.Models
{
    ...
    public partial class IotHubDeviceCreatedEventData : DeviceLifeCycleEventProperties
    {
        ...
        public IotHubDeviceCreatedEventData(string deviceId = default(string), string hubName = default(string), string opType = default(string), string operationTimestamp = default(string), DeviceTwinInfo twin = default(DeviceTwinInfo))
