...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    internal partial class ReplicationStorageClassificationMappingsOperations : IServiceOperations<SiteRecoveryManagementClient>, IReplicationStorageClassificationMappingsOperations
    {
        ...
        {
            // Send Request
            AzureOperationResponse<StorageClassificationMapping> _response = await BeginCreateWithHttpMessagesAsync(fabricName, storageClassificationName, storageClassificationMappingName, pairingInput, customHeaders, cancellationToken).ConfigureAwait(false);
