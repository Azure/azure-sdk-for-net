...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    internal partial class ReplicationRecoveryServicesProvidersOperations : IServiceOperations<SiteRecoveryManagementClient>, IReplicationRecoveryServicesProvidersOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<RecoveryServicesProvider>> GetTrackAsyncOperationWithHttpMessagesAsync(string fabricName, string providerName, string jobName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
