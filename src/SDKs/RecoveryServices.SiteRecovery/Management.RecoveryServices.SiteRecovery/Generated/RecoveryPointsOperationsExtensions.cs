...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public static partial class RecoveryPointsOperationsExtensions
    {
            ...
            {
                return Task.Factory.StartNew(s => ((IRecoveryPointsOperations)s).ListByReplicationProtectedItemsAsync(fabricName, protectionContainerName, replicatedProtectedItemName), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            {
                return Task.Factory.StartNew(s => ((IRecoveryPointsOperations)s).ListByReplicationProtectedItemsNextAsync(nextPageLink), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
