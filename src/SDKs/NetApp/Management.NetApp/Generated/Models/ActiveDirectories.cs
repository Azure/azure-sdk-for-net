...
namespace Microsoft.NetApp.Models
{
    ...
    /// Active Directories
    /// </summary>
    public partial class ActiveDirectories
    {
        /// <summary>
        ...
        public ActiveDirectories(string activeDirectoryId = default(string), string username = default(string), string password = default(string), string domain = default(string), string dNS = default(string), string status = default(string), string sMBServerName = default(string), string organizationalUnit = default(string))
        {
