...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class BackupLongTermRetentionPolicy : ProxyResource
    {
        ...
        public BackupLongTermRetentionPolicy(string id = default(string), string name = default(string), string type = default(string), string location = default(string), BackupLongTermRetentionPolicyState? state = default(BackupLongTermRetentionPolicyState?), string recoveryServicesBackupPolicyResourceId = default(string))
            : base(id, name, type)
        {
            Location = location;
            State = state;
