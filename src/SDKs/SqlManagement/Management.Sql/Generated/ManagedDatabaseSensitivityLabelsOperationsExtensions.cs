...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public static partial class ManagedDatabaseSensitivityLabelsOperationsExtensions
    {
            ...
            {
                using (var _result = await operations.ListRecommendedByDatabaseWithHttpMessagesAsync(resourceGroupName, managedInstanceName, databaseName, odataQuery, skipToken, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
