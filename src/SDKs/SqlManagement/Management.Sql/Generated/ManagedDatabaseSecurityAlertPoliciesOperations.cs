...
namespace Microsoft.Azure.Management.Sql
{
    ...
    /// </summary>
    internal partial class ManagedDatabaseSecurityAlertPoliciesOperations : IServiceOperations<SqlManagementClient>, IManagedDatabaseSecurityAlertPoliciesOperations
    {
        /// <summary>
        /// Initializes a new instance of the ManagedDatabaseSecurityAlertPoliciesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ManagedDatabaseSecurityAlertPoliciesOperations(SqlManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ManagedDatabaseSecurityAlertPolicy>> GetWithHttpMessagesAsync(string resourceGroupName, string managedInstanceName, string databaseName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
