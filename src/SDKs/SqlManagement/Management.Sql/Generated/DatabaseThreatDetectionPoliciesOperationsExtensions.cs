...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public static partial class DatabaseThreatDetectionPoliciesOperationsExtensions
    {
            ...
            /// defined.
            /// </param>
            public static DatabaseSecurityAlertPolicy Get(this IDatabaseThreatDetectionPoliciesOperations operations, string resourceGroupName, string serverName, string databaseName)
            {
            ...
            /// </param>
            public static async Task<DatabaseSecurityAlertPolicy> GetAsync(this IDatabaseThreatDetectionPoliciesOperations operations, string resourceGroupName, string serverName, string databaseName, CancellationToken cancellationToken = default(CancellationToken))
            {
