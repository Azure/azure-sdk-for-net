...
namespace Microsoft.Azure.Management.StreamAnalytics.Models
{
    ...
    /// </summary>
    public partial class StreamingJobsCreateOrReplaceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// StreamingJobsCreateOrReplaceHeaders class.
        /// </summary>
        public StreamingJobsCreateOrReplaceHeaders()
        {
          CustomInit();
        }
        ...
        public StreamingJobsCreateOrReplaceHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
