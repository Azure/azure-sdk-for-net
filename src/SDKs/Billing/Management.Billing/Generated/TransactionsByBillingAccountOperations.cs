...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class TransactionsByBillingAccountOperations : IServiceOperations<BillingManagementClient>, ITransactionsByBillingAccountOperations
    {
        /// <summary>
        /// Initializes a new instance of the TransactionsByBillingAccountOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal TransactionsByBillingAccountOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<TransactionsSummary>>> ListWithHttpMessagesAsync(string billingAccountId, string startDate, string endDate, string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Billing/billingAccounts/{billingAccountId}/transactions").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<TransactionsSummary>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
