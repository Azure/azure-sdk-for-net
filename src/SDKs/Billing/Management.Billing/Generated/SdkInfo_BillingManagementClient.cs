      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_BillingManagementClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("Billing", "BillingProfileInvoiceSection", "2018-11-01-preview"),
                ...
                new Tuple<string, string, string>("Billing", "InvoiceSectionsByBillingProfileName", "2018-11-01-preview"),
