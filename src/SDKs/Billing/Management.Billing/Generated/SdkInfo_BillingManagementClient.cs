      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_BillingManagementClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("Billing", "AvailableBalance", "2018-11-01-preview"),
                ...
                new Tuple<string, string, string>("Billing", "BillingRoleAssignment", "2018-11-01-preview"),
                new Tuple<string, string, string>("Billing", "BillingRoleDefinition", "2018-11-01-preview"),
