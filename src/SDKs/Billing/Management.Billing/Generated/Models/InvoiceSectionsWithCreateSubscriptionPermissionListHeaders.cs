...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class InvoiceSectionsWithCreateSubscriptionPermissionListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// InvoiceSectionsWithCreateSubscriptionPermissionListHeaders class.
        /// </summary>
        public InvoiceSectionsWithCreateSubscriptionPermissionListHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public InvoiceSectionsWithCreateSubscriptionPermissionListHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
