...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class BillingAccountsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BillingAccountsUpdateHeaders
        /// class.
        /// </summary>
        public BillingAccountsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BillingAccountsUpdateHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
