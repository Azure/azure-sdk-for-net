...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class BillingSubscriptionTransferHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// BillingSubscriptionTransferHeaders class.
        /// </summary>
        public BillingSubscriptionTransferHeaders()
        {
            CustomInit();
        }
        ...
        /// status</param>
        public BillingSubscriptionTransferHeaders(string location = default(string), int? retryAfter = default(int?), string azureAsyncOperation = default(string))
        {
            Location = location;
