...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class InvoiceSectionsByBillingProfileNameListHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// InvoiceSectionsByBillingProfileNameListHeaders class.
        /// </summary>
        public InvoiceSectionsByBillingProfileNameListHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public InvoiceSectionsByBillingProfileNameListHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
