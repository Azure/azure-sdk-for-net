...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    public partial class ValidateAddressResponse
    {
        ...
        public ValidateAddressResponse(string status = default(string), IList<Address> suggestedAddresses = default(IList<Address>), string validationMessage = default(string))
        {
            Status = status;
        ...
        public IList<Address> SuggestedAddresses { get; set; }
