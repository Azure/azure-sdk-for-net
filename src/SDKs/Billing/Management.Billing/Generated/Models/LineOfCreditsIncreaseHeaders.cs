...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class LineOfCreditsIncreaseHeaders
    {
        /// <summary>
        /// Initializes a new instance of the LineOfCreditsIncreaseHeaders
        /// class.
        /// </summary>
        public LineOfCreditsIncreaseHeaders()
        {
            CustomInit();
        }
        ...
        /// status</param>
        public LineOfCreditsIncreaseHeaders(string location = default(string), int? retryAfter = default(int?), string azureAsyncOperation = default(string))
        {
            Location = location;
