...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class InvoiceSectionBillingRoleDefinitionOperations : IServiceOperations<BillingManagementClient>, IInvoiceSectionBillingRoleDefinitionOperations
    {
        /// <summary>
        /// Initializes a new instance of the InvoiceSectionBillingRoleDefinitionOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal InvoiceSectionBillingRoleDefinitionOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<BillingRoleDefinition>> GetWithHttpMessagesAsync(string billingAccountName, string invoiceSectionName, string billingRoleDefinitionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<BillingRoleDefinitionListResult>> ListWithHttpMessagesAsync(string billingAccountName, string invoiceSectionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
