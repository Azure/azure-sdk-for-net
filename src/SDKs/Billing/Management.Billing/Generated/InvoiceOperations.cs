...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class InvoiceOperations : IServiceOperations<BillingManagementClient>, IInvoiceOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal InvoiceOperations(BillingManagementClient client)
        {
            if (client == null)
            {
