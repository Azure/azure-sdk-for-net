...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class BillingAccountBillingPermissionsOperations : IServiceOperations<BillingManagementClient>, IBillingAccountBillingPermissionsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<BillingPermissionsListResult>> ListWithHttpMessagesAsync(string billingAccountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
