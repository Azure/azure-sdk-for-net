...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class BillingProfileBillingPermissionsOperations : IServiceOperations<BillingManagementClient>, IBillingProfileBillingPermissionsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<BillingPermissionsListResult>> ListWithHttpMessagesAsync(string billingAccountName, string billingProfileName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<BillingPermissionsListResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<BillingPermissionsListResult>(_responseContent, Client.DeserializationSettings);
                }
