...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class InvoicesByBillingAccountOperations : IServiceOperations<BillingManagementClient>, IInvoicesByBillingAccountOperations
    {
        /// <summary>
        /// Initializes a new instance of the InvoicesByBillingAccountOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal InvoicesByBillingAccountOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<InvoiceListResult>> ListWithHttpMessagesAsync(string billingAccountId, string periodStartDate, string periodEndDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoices").ToString();
