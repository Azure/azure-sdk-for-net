...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class BillingAccountsValidateAddressOperations : IServiceOperations<BillingManagementClient>, IBillingAccountsValidateAddressOperations
    {
        /// <summary>
        /// Initializes a new instance of the BillingAccountsValidateAddressOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal BillingAccountsValidateAddressOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ValidateAddressResponse>> PostWithHttpMessagesAsync(string billingAccountName, Address address, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Billing/billingAccounts/{billingAccountName}/validateAddress").ToString();
