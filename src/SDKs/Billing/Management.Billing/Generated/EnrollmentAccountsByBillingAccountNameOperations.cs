...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class EnrollmentAccountsByBillingAccountNameOperations : IServiceOperations<BillingManagementClient>, IEnrollmentAccountsByBillingAccountNameOperations
    {
        /// <summary>
        /// Initializes a new instance of the EnrollmentAccountsByBillingAccountNameOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal EnrollmentAccountsByBillingAccountNameOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<EnrollmentAccountListResult>> ListWithHttpMessagesAsync(string billingAccountName, string expand = default(string), string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
