...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class InvoicePricesheetOperations : IServiceOperations<BillingManagementClient>, IInvoicePricesheetOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal InvoicePricesheetOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<DownloadUrl,InvoicePricesheetDownloadHeaders>> BeginDownloadWithHttpMessagesAsync(string billingAccountName, string invoiceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<DownloadUrl,InvoicePricesheetDownloadHeaders>();
