...
namespace Microsoft.Azure.Management.Billing
{
    ...
    internal partial class InvoicesByBillingProfileOperations : IServiceOperations<BillingManagementClient>, IInvoicesByBillingProfileOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<InvoiceListResult>> ListWithHttpMessagesAsync(string billingAccountName, string billingProfileName, string periodStartDate, string periodEndDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
