...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class InvoicesByBillingProfileOperations : IServiceOperations<BillingManagementClient>, IInvoicesByBillingProfileOperations
    {
        /// <summary>
        /// Initializes a new instance of the InvoicesByBillingProfileOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal InvoicesByBillingProfileOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<InvoiceListResult>> ListWithHttpMessagesAsync(string billingAccountId, string billingProfileId, string periodStartDate, string periodEndDate, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/invoices").ToString();
