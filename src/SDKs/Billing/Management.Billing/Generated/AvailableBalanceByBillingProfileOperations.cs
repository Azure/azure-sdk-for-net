...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class AvailableBalanceByBillingProfileOperations : IServiceOperations<BillingManagementClient>, IAvailableBalanceByBillingProfileOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<AvailableBalance>> GetWithHttpMessagesAsync(string billingAccountId, string billingProfileId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/availableBalance/default").ToString();
