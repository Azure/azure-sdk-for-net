...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class ValidateAddressOperations : IServiceOperations<BillingManagementClient>, IValidateAddressOperations
    {
        /// <summary>
        /// Initializes a new instance of the ValidateAddressOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ValidateAddressOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ValidateAddressResponse>> ValidateWithHttpMessagesAsync(Address address, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
