...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class BillingAccountBillingRoleDefinitionOperations : IServiceOperations<BillingManagementClient>, IBillingAccountBillingRoleDefinitionOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<BillingRoleDefinition>> GetWithHttpMessagesAsync(string billingAccountName, string billingRoleDefinitionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<BillingRoleDefinitionListResult>> ListWithHttpMessagesAsync(string billingAccountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
