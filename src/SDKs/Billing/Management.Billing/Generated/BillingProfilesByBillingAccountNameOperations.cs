...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class BillingProfilesByBillingAccountNameOperations : IServiceOperations<BillingManagementClient>, IBillingProfilesByBillingAccountNameOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<BillingProfileListResult>> ListWithHttpMessagesAsync(string billingAccountName, string expand = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
