...
namespace Microsoft.Azure.Management.StorSimple1200Series
{
    ...
    public static partial class DevicesOperationsExtensions
    {
            ...
            /// The manager name
            /// </param>
            public static void PublishSupportPackage(this IDevicesOperations operations, string deviceName, SupportPackageRequest supportPackageRequest, string resourceGroupName, string managerName)
            {
                operations.PublishSupportPackageAsync(deviceName, supportPackageRequest, resourceGroupName, managerName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task PublishSupportPackageAsync(this IDevicesOperations operations, string deviceName, SupportPackageRequest supportPackageRequest, string resourceGroupName, string managerName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.PublishSupportPackageWithHttpMessagesAsync(deviceName, supportPackageRequest, resourceGroupName, managerName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// The manager name
            /// </param>
            public static void BeginPublishSupportPackage(this IDevicesOperations operations, string deviceName, SupportPackageRequest supportPackageRequest, string resourceGroupName, string managerName)
            {
                operations.BeginPublishSupportPackageAsync(deviceName, supportPackageRequest, resourceGroupName, managerName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginPublishSupportPackageAsync(this IDevicesOperations operations, string deviceName, SupportPackageRequest supportPackageRequest, string resourceGroupName, string managerName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginPublishSupportPackageWithHttpMessagesAsync(deviceName, supportPackageRequest, resourceGroupName, managerName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
