...
namespace Microsoft.Azure.Management.StorSimple1200Series
{
    ...
    public static partial class ChapSettingsOperationsExtensions
    {
            ...
            /// The manager name
            /// </param>
            public static ChapSettingsList ListByDevice(this IChapSettingsOperations operations, string deviceName, string resourceGroupName, string managerName)
            {
            ...
            /// </param>
            public static async Task<ChapSettingsList> ListByDeviceAsync(this IChapSettingsOperations operations, string deviceName, string resourceGroupName, string managerName, CancellationToken cancellationToken = default(CancellationToken))
            {
