...
namespace Microsoft.Azure.Management.Peering
{
    ...
    internal partial class PeeringLocationsOperations : IServiceOperations<PeeringManagementClient>, IPeeringLocationsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<PeeringLocation>>> ListWithHttpMessagesAsync(string kind, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (kind == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<PeeringLocation>>();
