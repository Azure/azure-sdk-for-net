...
namespace Microsoft.Azure.Management.Peering
{
    ...
    /// </summary>
    internal partial class PeeringLocationsOperations : IServiceOperations<EdgeRpClient>, IPeeringLocationsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PeeringLocationsOperations(EdgeRpClient client)
        {
            if (client == null)
            {
        ...
        /// </summary>
        /// <param name='kind'>
        /// The peering kind that the location should support. Possible values include:
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<PeeringLocation>>> ListWithHttpMessagesAsync(string kind, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (kind == null)
            {
