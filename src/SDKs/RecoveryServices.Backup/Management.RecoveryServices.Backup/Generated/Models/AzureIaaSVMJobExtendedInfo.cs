...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class AzureIaaSVMJobExtendedInfo
    {
        ...
        /// job execution.</param>
        public AzureIaaSVMJobExtendedInfo(IList<AzureIaaSVMJobTaskDetails> tasksList = default(IList<AzureIaaSVMJobTaskDetails>), IDictionary<string, string> propertyBag = default(IDictionary<string, string>), double? progressPercentage = default(double?), string dynamicErrorMessage = default(string))
        {
            TasksList = tasksList;
