...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class BackupEngineBaseResource : Resource
    {
        ...
        /// <param name="properties">BackupEngineBaseResource
        /// properties</param>
        public BackupEngineBaseResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string eTag = default(string), BackupEngineBase properties = default(BackupEngineBase))
