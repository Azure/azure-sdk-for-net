...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class ProtectionPolicyOperationStatusesOperations : IServiceOperations<RecoveryServicesBackupClient>, IProtectionPolicyOperationStatusesOperations
    {
        /// <summary>
        /// Initializes a new instance of the ProtectionPolicyOperationStatusesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ProtectionPolicyOperationStatusesOperations(RecoveryServicesBackupClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<OperationStatus>> GetWithHttpMessagesAsync(string vaultName, string resourceGroupName, string policyName, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vaultName == null)
            {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupPolicies/{policyName}/operations/{operationId}").ToString();
