...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// <summary>
    /// ScopedProtectionPolicyOperationResultsOperations operations.
    /// </summary>
    internal partial class ScopedProtectionPolicyOperationResultsOperations : IServiceOperations<RecoveryServicesBackupClient>, IScopedProtectionPolicyOperationResultsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ScopedProtectionPolicyOperationResultsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ScopedProtectionPolicyOperationResultsOperations(RecoveryServicesBackupClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ProtectionPolicyResource>> GetWithHttpMessagesAsync(string vaultName, string resourceGroupName, string fabricName, string policyName, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vaultName == null)
            {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/policies/{policyName}/operationResults/{operationId}").ToString();
