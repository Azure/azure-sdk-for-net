...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class ScopedBackupPoliciesOperations : IServiceOperations<RecoveryServicesBackupClient>, IScopedBackupPoliciesOperations
    {
        /// <summary>
        /// Initializes a new instance of the ScopedBackupPoliciesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ScopedBackupPoliciesOperations(RecoveryServicesBackupClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<ProtectionPolicyResource>>> ListWithHttpMessagesAsync(string vaultName, string resourceGroupName, string fabricName, ODataQuery<ProtectionPolicyQueryObject> odataQuery = default(ODataQuery<ProtectionPolicyQueryObject>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vaultName == null)
            {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/policies").ToString();
