...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    public partial interface IBackupOperationResultsOperations
    {
        ...
        /// backed up item. Once the operation has started, the status code in
        /// the response would be Accepted. It will continue to be in this
        /// state till it reaches completion. On successful completion, the
        /// status code will be OK. This method expects OperationID as an
        /// argument. OperationID is part of the Location header of the
        /// operation response.
        /// </summary>
