...
namespace Microsoft.Azure.Management.IotCentral.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AppTemplates class.
        /// </summary>
        public AppTemplates()
        {
            CustomInit();
        ...
        /// Templates.</param>
        public AppTemplates(string nextLink = default(string), IList<AppTemplate> value = default(IList<AppTemplate>))
        {
            NextLink = nextLink;
            Value = value;
            CustomInit();
