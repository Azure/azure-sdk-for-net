...
namespace Microsoft.Azure.Management.ResourceGraph.Models
{
    ...
    public partial class ResourceChangesRequestParameters
    {
        ...
        public ResourceChangesRequestParameters(string resourceId, ResourceChangesRequestParametersInterval interval, string skipToken = default(string), int? top = default(int?))
        {
