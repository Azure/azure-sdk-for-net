...
namespace Microsoft.Azure.Management.Search
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<SearchManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(SearchManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Search/operations").ToString();
