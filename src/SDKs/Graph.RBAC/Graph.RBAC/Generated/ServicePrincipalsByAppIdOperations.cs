...
namespace Microsoft.Azure.Graph.RBAC
{
    ...
    /// </summary>
    internal partial class ServicePrincipalsByAppIdOperations : IServiceOperations<GraphRbacManagementClient>, IServicePrincipalsByAppIdOperations
    {
        /// <summary>
        /// Initializes a new instance of the ServicePrincipalsByAppIdOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ServicePrincipalsByAppIdOperations(GraphRbacManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ServicePrincipalObjectResult>> GetWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
