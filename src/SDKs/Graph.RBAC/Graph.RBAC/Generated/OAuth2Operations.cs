...
namespace Microsoft.Azure.Graph.RBAC
{
    ...
    internal partial class OAuth2Operations : IServiceOperations<GraphRbacManagementClient>, IOAuth2Operations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<OAuth2PermissionGrant>> GrantWithHttpMessagesAsync(OAuth2PermissionGrant body = default(OAuth2PermissionGrant), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
