...
namespace Microsoft.Azure.Graph.RBAC
{
    ...
    /// </summary>
    internal partial class OAuth2Operations : IServiceOperations<GraphRbacManagementClient>, IOAuth2Operations
    {
        /// <summary>
        /// Initializes a new instance of the OAuth2Operations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal OAuth2Operations(GraphRbacManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<Permissions>> GetWithHttpMessagesAsync(string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<Permissions>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Permissions>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Permissions>> PostWithHttpMessagesAsync(Permissions body = default(Permissions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
