...
namespace Microsoft.Azure.Graph.RBAC.Models
{
    ...
    public partial class ServicePrincipalBase
    {
        ...
        public ServicePrincipalBase(IList<KeyCredential> keyCredentials = default(IList<KeyCredential>), IList<PasswordCredential> passwordCredentials = default(IList<PasswordCredential>), string servicePrincipalType = default(string), string accountEnabled = default(string), IList<string> tags = default(IList<string>))
        {
        ...
        /// <summary>
        /// Gets or sets the type of the servie principal
        /// </summary>
