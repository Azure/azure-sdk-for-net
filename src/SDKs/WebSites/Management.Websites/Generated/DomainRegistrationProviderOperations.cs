...
namespace Microsoft.Azure.Management.WebSites
{
    ...
    /// </summary>
    internal partial class DomainRegistrationProviderOperations : IServiceOperations<WebSiteManagementClient>, IDomainRegistrationProviderOperations
    {
        /// <summary>
        /// Initializes a new instance of the DomainRegistrationProviderOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal DomainRegistrationProviderOperations(WebSiteManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<CsmOperationDescription>>> ListOperationsWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.DomainRegistration/operations").ToString();
