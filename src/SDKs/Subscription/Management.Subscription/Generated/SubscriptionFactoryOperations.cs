...
namespace Microsoft.Azure.Management.Subscription
{
    ...
    internal partial class SubscriptionFactoryOperations : IServiceOperations<SubscriptionClient>, ISubscriptionFactoryOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<SubscriptionCreationResult,SubscriptionFactoryCustomerCreateSubscriptionHeaders>> CustomerCreateSubscriptionWithHttpMessagesAsync(string billingAccountName, string customerName, CustomerSubscriptionCreationParameters body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<SubscriptionCreationResult,SubscriptionFactoryCustomerCreateSubscriptionHeaders> _response = await BeginCustomerCreateSubscriptionWithHttpMessagesAsync(billingAccountName, customerName, body, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<SubscriptionCreationResult,SubscriptionFactoryCustomerCreateSubscriptionHeaders>> BeginCustomerCreateSubscriptionWithHttpMessagesAsync(string billingAccountName, string customerName, CustomerSubscriptionCreationParameters body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (billingAccountName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "billingAccountName");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("body", body);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginCustomerCreateSubscription", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            ...
            // Create Result
            var _result = new AzureOperationResponse<SubscriptionCreationResult,SubscriptionFactoryCustomerCreateSubscriptionHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<SubscriptionFactoryCustomerCreateSubscriptionHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
