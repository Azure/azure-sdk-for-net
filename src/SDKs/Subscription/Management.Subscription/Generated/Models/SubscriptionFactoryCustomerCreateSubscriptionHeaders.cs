...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    /// <summary>
    /// Defines headers for CustomerCreateSubscription operation.
    /// </summary>
    public partial class SubscriptionFactoryCustomerCreateSubscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionFactoryCustomerCreateSubscriptionHeaders class.
        /// </summary>
        public SubscriptionFactoryCustomerCreateSubscriptionHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public SubscriptionFactoryCustomerCreateSubscriptionHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
