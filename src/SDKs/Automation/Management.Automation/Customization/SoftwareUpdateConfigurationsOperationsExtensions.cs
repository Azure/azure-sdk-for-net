namespace Microsoft.Azure.Management.Automation
{
    ...
    public static partial class SoftwareUpdateConfigurationsOperationsExtensions
    {
        ...
        /// </param>
        public static SoftwareUpdateConfigurationListResult ListByAzureVirtualMachine(this ISoftwareUpdateConfigurationsOperations operations, string resourceGroupName, string automationAccountName, string virtualMachineId)
        {
            return operations.ListByAzureVirtualMachineAsync(resourceGroupName, automationAccountName, virtualMachineId).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async Task<SoftwareUpdateConfigurationListResult> ListByAzureVirtualMachineAsync(this ISoftwareUpdateConfigurationsOperations operations, string resourceGroupName, string automationAccountName, string virtualMachineId, string skip = default(string), string top = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            var filter = string.Format(LambdaFilterFormat, AzureVirtualMachinesProperty, virtualMachineId);
            using (var _result = await operations.ListWithHttpMessagesAsync(resourceGroupName, automationAccountName, null, filter, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
