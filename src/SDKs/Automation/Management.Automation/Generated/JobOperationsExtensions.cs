...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public static partial class JobOperationsExtensions
    {
            ...
            /// Identifies this specific client request.
            /// </param>
            public static IPage<JobCollectionItem> ListByAutomationAccount(this IJobOperations operations, string resourceGroupName, string automationAccountName, string filter = default(string), string clientRequestId = default(string))
            {
                return operations.ListByAutomationAccountAsync(resourceGroupName, automationAccountName, filter, clientRequestId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<JobCollectionItem>> ListByAutomationAccountAsync(this IJobOperations operations, string resourceGroupName, string automationAccountName, string filter = default(string), string clientRequestId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
