...
namespace Microsoft.Azure.Management.Automation
{
    public static partial class AutomationManagementClientExtensions
    {
        ...
        /// </returns>
        public static LongRunningOperationStatusResponse GetOperationStatus(this IAutomationManagementClient operations, string requestId)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IAutomationManagementClient)s).GetOperationStatusAsync(requestId);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
