...
namespace Microsoft.Azure.Management.Automation
{
    ...
    internal partial class FieldsOperations : IServiceOperations<AutomationClient>, IFieldsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<TypeField>>> ListByTypeWithHttpMessagesAsync(string automationAccountName, string moduleName, string typeName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
