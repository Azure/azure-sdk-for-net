...
namespace Microsoft.Azure.Management.Automation
{
    ...
    internal partial class ActivityOperations : IServiceOperations<AutomationClient>, IActivityOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<Activity>> GetWithHttpMessagesAsync(string automationAccountName, string moduleName, string activityName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<Activity>>> ListByModuleWithHttpMessagesAsync(string automationAccountName, string moduleName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ResourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ResourceGroupName");
