...
namespace Microsoft.Azure.Management.Automation
{
    ...
    internal partial class VariableOperations : IServiceOperations<AutomationManagementClient>, IVariableOperations
    {
        ...
        /// </returns>
        public async Task<VariableCreateOrUpdateResponse> CreateOrUpdateAsync(string resourceGroupName, string automationAccount, VariableCreateOrUpdateParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            ...
            try
            {
                ...
                JObject variableCreateOrUpdateParametersValue = new JObject();
                requestDoc = variableCreateOrUpdateParametersValue;
                
                variableCreateOrUpdateParametersValue["name"] = parameters.Name;
                
                JObject propertiesValue = new JObject();
                variableCreateOrUpdateParametersValue["properties"] = propertiesValue;
                ...
                try
                {
                    ...
                    // Create Result
                    VariableCreateOrUpdateResponse result = null;
                    // Deserialize Response
                    if (statusCode == HttpStatusCode.OK || statusCode == HttpStatusCode.Created)
                    {
                        cancellationToken.ThrowIfCancellationRequested();
                        string responseContent = await httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                        result = new VariableCreateOrUpdateResponse();
        ...
        /// request ID.
        /// </returns>
        public async Task<AzureOperationResponse> DeleteAsync(string resourceGroupName, string automationAccount, string variableName, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        /// </returns>
        public async Task<VariableGetResponse> GetAsync(string resourceGroupName, string automationAccount, string variableName, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
        ...
        /// </returns>
        public async Task<VariableListResponse> ListAsync(string resourceGroupName, string automationAccount, CancellationToken cancellationToken)
        {
            // Validate
            if (resourceGroupName == null)
            {
