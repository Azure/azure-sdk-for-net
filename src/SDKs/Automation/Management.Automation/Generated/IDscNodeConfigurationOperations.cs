...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public partial interface IDscNodeConfigurationOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<DscNodeConfiguration>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string automationAccountName, string nodeConfigurationName, DscNodeConfigurationCreateOrUpdateParametersProperties parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<IPage<DscNodeConfiguration>>> ListByAutomationAccountWithHttpMessagesAsync(string resourceGroupName, string automationAccountName, ODataQuery<DscNodeConfiguration> odataQuery = default(ODataQuery<DscNodeConfiguration>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Create the node configuration identified by node configuration
        /// name.
        /// <see href="http://aka.ms/azureautomationsdk/dscnodeconfigurations" />
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<DscNodeConfiguration>> BeginCreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string automationAccountName, string nodeConfigurationName, DscNodeConfigurationCreateOrUpdateParametersProperties parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve a list of dsc node configurations.
        /// <see href="http://aka.ms/azureautomationsdk/dscnodeconfigurations" />
        /// </summary>
