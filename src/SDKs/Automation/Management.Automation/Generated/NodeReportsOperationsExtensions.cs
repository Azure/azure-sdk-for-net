...
namespace Microsoft.Azure.Management.Automation
{
    ...
    public static partial class NodeReportsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<DscNodeReport> ListByNode(this INodeReportsOperations operations, string resourceGroupName, string automationAccountName, string nodeId, string filter = default(string))
            {
                return operations.ListByNodeAsync(resourceGroupName, automationAccountName, nodeId, filter).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<DscNodeReport>> ListByNodeAsync(this INodeReportsOperations operations, string resourceGroupName, string automationAccountName, string nodeId, string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The report id.
            /// </param>
            public static Stream GetContent(this INodeReportsOperations operations, string resourceGroupName, string automationAccountName, string nodeId, string reportId)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Stream> GetContentAsync(this INodeReportsOperations operations, string resourceGroupName, string automationAccountName, string nodeId, string reportId, CancellationToken cancellationToken = default(CancellationToken))
            {
