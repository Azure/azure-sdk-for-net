...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class SoftwareUpdateConfiguration : IResource
    {
        ...
        /// appears in the response.</param>
        public SoftwareUpdateConfiguration(UpdateConfiguration updateConfiguration, string name = default(string), string id = default(string), string type = default(string), ScheduleProperties scheduleInfo = default(ScheduleProperties), string provisioningState = default(string), ErrorResponse error = default(ErrorResponse), System.DateTime? creationTime = default(System.DateTime?), string createdBy = default(string), System.DateTime? lastModifiedTime = default(System.DateTime?), string lastModifiedBy = default(string))
        {
            Name = name;
            Id = id;
            Type = type;
