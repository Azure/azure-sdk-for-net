...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class DscNode : ProxyResource
    {
        ...
        public DscNode(string id = default(string), string name = default(string), string type = default(string), System.DateTimeOffset lastSeen = default(System.DateTimeOffset), System.DateTimeOffset registrationTime = default(System.DateTimeOffset), string ip = default(string), string accountId = default(string), string dscNodeName = default(string), string status = default(string), string nodeId = default(string), string etag = default(string), IList<DscNodeExtensionHandlerAssociationProperty> extensionHandler = default(IList<DscNodeExtensionHandlerAssociationProperty>))
            : base(id, name, type)
        {
            LastSeen = lastSeen;
