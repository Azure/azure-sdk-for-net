...
namespace Microsoft.Azure.Management.Security
{
    ...
    public static partial class AssessmentsOperationsExtensions
    {
            ...
            /// </param>
            public static SecurityAssessment Get(this IAssessmentsOperations operations, string resourceId, string assessmentName)
            {
                return operations.GetAsync(resourceId, assessmentName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SecurityAssessment> GetAsync(this IAssessmentsOperations operations, string resourceId, string assessmentName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetWithHttpMessagesAsync(resourceId, assessmentName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
