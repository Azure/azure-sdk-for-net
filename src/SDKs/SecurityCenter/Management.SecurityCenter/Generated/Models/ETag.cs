...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class ETag
    {
        ...
        /// entities from the same requested resource. ETags may be returned
        /// for individual resources, and then sent via If-Match /
        /// If-None-Match headers for concurrency control. </param>
        ...
        /// from the same requested resource. ETags may be returned for
        /// individual resources, and then sent via If-Match / If-None-Match
