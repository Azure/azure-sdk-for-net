...
namespace Microsoft.Azure.Management.Kusto
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<KustoManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(KustoManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Kusto/operations").ToString();
