...
namespace Microsoft.Azure.Management.Kusto.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("ReadOnlyAttached")]
    [Rest.Serialization.JsonTransformation]
    public partial class ReadOnlyAttachedDatabase : Database
    {
        /// <summary>
        /// Initializes a new instance of the ReadOnlyAttachedDatabase class.
        /// </summary>
        public ReadOnlyAttachedDatabase()
        {
            CustomInit();
        }
        ...
        public ReadOnlyAttachedDatabase(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string provisioningState = default(string), System.TimeSpan? softDeletePeriod = default(System.TimeSpan?), System.TimeSpan? hotCachePeriod = default(System.TimeSpan?), DatabaseStatistics statistics = default(DatabaseStatistics))
