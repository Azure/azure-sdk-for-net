...
namespace Microsoft.Azure.Management.DataMigration
{
    ...
    /// </summary>
    internal partial class UsagesOperations : IServiceOperations<DataMigrationServiceClient>, IUsagesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<Quota>>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
