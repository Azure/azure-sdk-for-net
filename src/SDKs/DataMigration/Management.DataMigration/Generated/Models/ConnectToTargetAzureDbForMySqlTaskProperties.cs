...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ConnectToTargetAzureDbForMySqlTaskProperties : ProjectTaskProperties
    {
        ...
        /// submitted.</param>
        public ConnectToTargetAzureDbForMySqlTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), ConnectToTargetAzureDbForMySqlTaskInput input = default(ConnectToTargetAzureDbForMySqlTaskInput), IList<ConnectToTargetAzureDbForMySqlTaskOutput> output = default(IList<ConnectToTargetAzureDbForMySqlTaskOutput>))
