...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ConnectToSourceSqlServerSyncTaskProperties : ProjectTaskProperties
    {
        ...
        /// ConnectToSourceSqlServerSyncTaskProperties class.
        /// </summary>
        ...
        /// submitted.</param>
        public ConnectToSourceSqlServerSyncTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), ConnectToSourceSqlServerTaskInput input = default(ConnectToSourceSqlServerTaskInput), IList<ConnectToSourceSqlServerTaskOutput> output = default(IList<ConnectToSourceSqlServerTaskOutput>))
