...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutput
    {
        ...
        /// the task</param>
        public ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskOutput(string targetServerVersion = default(string), IList<string> databases = default(IList<string>), string targetServerBrandVersion = default(string), IList<ReportableException> validationErrors = default(IList<ReportableException>))
        {
