...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class ValidateMigrationInputSqlServerSqlMITaskProperties : ProjectTaskProperties
    {
        ...
        /// submitted.</param>
        public ValidateMigrationInputSqlServerSqlMITaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), IDictionary<string, string> clientData = default(IDictionary<string, string>), ValidateMigrationInputSqlServerSqlMITaskInput input = default(ValidateMigrationInputSqlServerSqlMITaskInput), IList<ValidateMigrationInputSqlServerSqlMITaskOutput> output = default(IList<ValidateMigrationInputSqlServerSqlMITaskOutput>))
