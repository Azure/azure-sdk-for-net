...
namespace Microsoft.Azure.Management.DataMigration.Models
{
    ...
    public partial class GetTdeCertificatesSqlTaskProperties : ProjectTaskProperties
    {
        ...
        /// submitted.</param>
        public GetTdeCertificatesSqlTaskProperties(IList<ODataError> errors = default(IList<ODataError>), string state = default(string), IList<CommandProperties> commands = default(IList<CommandProperties>), GetTdeCertificatesSqlTaskInput input = default(GetTdeCertificatesSqlTaskInput), IList<GetTdeCertificatesSqlTaskOutput> output = default(IList<GetTdeCertificatesSqlTaskOutput>))
