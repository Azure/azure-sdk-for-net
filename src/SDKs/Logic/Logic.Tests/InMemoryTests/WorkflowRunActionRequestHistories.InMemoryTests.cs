...
namespace Test.Azure.Management.Logic
{
    ...
    public class WorkflowRunActionRequestHistoriesInMemoryTests : InMemoryTestsBase
    {
        private StringContent RequestHistory { get; set; }

        private StringContent RequestHistoryListResponse { get; set; }

        public WorkflowRunActionRequestHistoriesInMemoryTests()
        {
            var requestHistory = @"{
            'properties': {
        ...
        [Fact]
        public void WorkflowRunActionRequestHistories_Get_OK()
        {
            ...
            var requestHistory = client.WorkflowRunActionRequestHistories.Get("rgName", "wfName", "rName", "actName", "reqName");
        ...
        [Fact]
        public void WorkflowRunActionRequestHistories_Get_Exception()
        {
            var handler = new RecordedDelegatingHandler();
            var client = this.CreateWorkflowClient(handler);
            ...
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.Get(null, "wfName", "rName", "actName", "reqName"));
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.Get("rgName", null, "rName", "actName", "reqName"));
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.Get("rgName", "wfName", null, "actName", "reqName"));
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.Get("rgName", "wfName", "rName", null, "reqName"));
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.Get("rgName", "wfName", "rName", "actName", null));
            Assert.Throws<ErrorResponseException>(() => client.WorkflowRunActionRequestHistories.Get("rgName", "wfName", "rName", "actName", "reqName"));
        }

        [Fact]
        public void WorkflowRunActionRequestHistories_List_OK()
        {
            var handler = new RecordedDelegatingHandler();
            var client = this.CreateWorkflowClient(handler);
            ...
            var requestHistory = client.WorkflowRunActionRequestHistories.List("rgName", "wfName", "rName", "actName");
        ...
        [Fact]
        public void WorkflowRunActionRequestHistories_List_Exception()
        {
            var handler = new RecordedDelegatingHandler();
            var client = this.CreateWorkflowClient(handler);
            ...
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.List(null, "wfName", "rName", "actName"));
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.List("rgName", null, "rName", "actName"));
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.List("rgName", "wfName", null, "actName"));
            Assert.Throws<ValidationException>(() => client.WorkflowRunActionRequestHistories.List("rgName", "wfName", "rName", null));
            Assert.Throws<ErrorResponseException>(() => client.WorkflowRunActionRequestHistories.List("rgName", "wfName", "rName", "actName"));
        }
