...
namespace Microsoft.Azure.Management.Logic
{
    ...
    /// </summary>
    internal partial class WorkflowRunActionRepetitionsOperations : IServiceOperations<LogicManagementClient>, IWorkflowRunActionRepetitionsOperations
    {
        /// <summary>
        ...
        public async Task<AzureOperationResponse<IEnumerable<WorkflowRunActionRepetitionDefinition>>> ListWithHttpMessagesAsync(string resourceGroupName, string workflowName, string runName, string actionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<WorkflowRunActionRepetitionDefinition>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page2<WorkflowRunActionRepetitionDefinition>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<IEnumerable<ExpressionRoot>>> ListExpressionTracesWithHttpMessagesAsync(string resourceGroupName, string workflowName, string runName, string actionName, string repetitionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("repetitionName", repetitionName);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "ListExpressionTraces", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            ...
            // Create Result
            var _result = new AzureOperationResponse<IEnumerable<ExpressionRoot>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<ExpressionRoot>>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
