...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class Token : ProxyResource
    {
        ...
        /// <param name="tokenType">The type of the token. E.g. Device.</param>
        public Token(string id = default(string), string name = default(string), string type = default(string), System.DateTime? creationDate = default(System.DateTime?), string provisioningState = default(string), string scopeMapId = default(string), string objectId = default(string), string permissionsStatus = default(string), string tokenType = default(string))
            : base(id, name, type)
        {
