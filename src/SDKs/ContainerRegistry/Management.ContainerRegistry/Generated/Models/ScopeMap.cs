...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class ScopeMap : ProxyResource
    {
        ...
        /// propagation to all the tokens associated with this scope
        /// map.</param>
        public ScopeMap(IList<string> actions, string id = default(string), string name = default(string), string type = default(string), string description = default(string), string scopeMapType = default(string), System.DateTime? creationDate = default(System.DateTime?), string provisioningState = default(string), string permissionsStatus = default(string))
            : base(id, name, type)
        {
        ...
        /// <summary>
        /// Gets the status of the permission propagation to all the tokens
        /// associated with this scope map.
        /// </summary>
