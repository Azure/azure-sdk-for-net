...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class TokenPassword
    {
        ...
        /// <param name="name">The password name "password" or "password1".
        /// Possible values include: 'password', 'password2'</param>
        /// <param name="value">The password value.</param>
        public TokenPassword(System.DateTime? expiry = default(System.DateTime?), PasswordName? name = default(PasswordName?), string value = default(string))
        {
            Expiry = expiry;
            Name = name;
            Value = value;
        ...
        /// <summary>
        /// Gets or sets the password name "password" or "password1". Possible
