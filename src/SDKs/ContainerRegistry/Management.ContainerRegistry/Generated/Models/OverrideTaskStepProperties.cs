...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class OverrideTaskStepProperties
    {
        ...
        public OverrideTaskStepProperties(string contextPath = default(string), string file = default(string), IList<Argument> arguments = default(IList<Argument>), string target = default(string), IList<SetValue> values = default(IList<SetValue>))
        {
