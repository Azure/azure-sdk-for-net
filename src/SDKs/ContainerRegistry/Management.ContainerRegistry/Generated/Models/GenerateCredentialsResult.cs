...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class GenerateCredentialsResult
    {
        ...
        /// registry.</param>
        /// <param name="certificate">The public certificate that will be used
        /// for authenticating the token of a container registry.</param>
        public GenerateCredentialsResult(string username = default(string), IList<TokenPassword> passwords = default(IList<TokenPassword>), TokenCertificate certificate = default(TokenCertificate))
        {
            Username = username;
            Passwords = passwords;
        ...
        /// <summary>
        /// Gets or sets the public certificate that will be used for
        /// authenticating the token of a container registry.
        /// </summary>
        [JsonProperty(PropertyName = "certificate")]
        public TokenCertificate Certificate { get; set; }
