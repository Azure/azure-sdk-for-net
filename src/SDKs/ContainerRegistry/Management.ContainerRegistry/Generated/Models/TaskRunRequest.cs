...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class TaskRunRequest : RunRequest
    {
        ...
        /// <param name="continuationToken">Base64 encoded continuation token
        /// that will be attached with the base image trigger webhook.</param>
        public TaskRunRequest(string taskId, bool? isArchiveEnabled = default(bool?), OverrideTaskStepProperties overrideTaskStepProperties = default(OverrideTaskStepProperties), string continuationToken = default(string))
        ...
        /// <summary>
        /// Gets or sets base64 encoded continuation token that will be
