...
namespace Microsoft.Azure.Management.ContainerRegistry
{
    ...
    public partial interface ITokensOperations
    {
        ...
        /// </param>
        /// <param name='objectId'>
        /// The user/group/application object ID for which the token has to be
        /// created.
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        System.Threading.Tasks.Task<AzureOperationResponse<Token>> CreateWithHttpMessagesAsync(string resourceGroupName, string registryName, string tokenName, string scopeMapId = default(string), string objectId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        System.Threading.Tasks.Task<AzureOperationResponse<Token>> UpdateWithHttpMessagesAsync(string resourceGroupName, string registryName, string tokenName, string scopeMapId = default(string), string objectId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        System.Threading.Tasks.Task<AzureOperationResponse<Token>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string registryName, string tokenName, string scopeMapId = default(string), string objectId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Deletes a token from a container registry.
        /// </summary>
        /// <param name='resourceGroupName'>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        System.Threading.Tasks.Task<AzureOperationResponse<Token>> BeginUpdateWithHttpMessagesAsync(string resourceGroupName, string registryName, string tokenName, string scopeMapId = default(string), string objectId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Lists all the tokens for the specified container registry.
        /// </summary>
