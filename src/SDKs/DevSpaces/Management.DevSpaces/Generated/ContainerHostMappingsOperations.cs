...
namespace Microsoft.Azure.Management.DevSpaces
{
    ...
    /// </summary>
    internal partial class ContainerHostMappingsOperations : IServiceOperations<DevSpacesManagementClient>, IContainerHostMappingsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ContainerHostMappingsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ContainerHostMappingsOperations(DevSpacesManagementClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets a reference to the DevSpacesManagementClient
        /// </summary>
        public DevSpacesManagementClient Client { get; private set; }
        ...
        public async Task<AzureOperationResponse<ContainerHostMapping>> GetContainerHostMappingWithHttpMessagesAsync(string resourceGroupName, string location, string containerHostResourceId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                containerHostMapping.ContainerHostResourceId = containerHostResourceId;
            }
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("containerHostMapping", containerHostMapping);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetContainerHostMapping", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevSpaces/locations/{location}/checkContainerHostMapping").ToString();
            ...
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(containerHostMapping, Client.SerializationSettings);
