...
namespace Microsoft.Azure.Management.DevSpaces
{
    ...
    public static partial class ControllersOperationsExtensions
    {
            ...
            /// Name of the resource.
            /// </param>
            /// <param name='controllerUpdateParameters'>
            /// </param>
            public static Controller Update(this IControllersOperations operations, string resourceGroupName, string name, ControllerUpdateParameters controllerUpdateParameters)
            {
                return operations.UpdateAsync(resourceGroupName, name, controllerUpdateParameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Controller> UpdateAsync(this IControllersOperations operations, string resourceGroupName, string name, ControllerUpdateParameters controllerUpdateParameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateWithHttpMessagesAsync(resourceGroupName, name, controllerUpdateParameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
