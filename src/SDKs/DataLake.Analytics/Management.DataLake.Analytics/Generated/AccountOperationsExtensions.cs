...
namespace Microsoft.Azure.Management.DataLake.Analytics
{
    ...
    public static partial class AccountOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<DataLakeAnalyticsAccountBasic> ListByResourceGroup(this IAccountOperations operations, string resourceGroupName, ODataQuery<DataLakeAnalyticsAccount> odataQuery = default(ODataQuery<DataLakeAnalyticsAccount>), string select = default(string), bool? count = default(bool?))
            {
            ...
            /// Categories?$count=true. Optional.
            /// </param>
            public static IPage<DataLakeAnalyticsAccountBasic> List(this IAccountOperations operations, ODataQuery<DataLakeAnalyticsAccount> odataQuery = default(ODataQuery<DataLakeAnalyticsAccount>), string select = default(string), bool? count = default(bool?))
            {
