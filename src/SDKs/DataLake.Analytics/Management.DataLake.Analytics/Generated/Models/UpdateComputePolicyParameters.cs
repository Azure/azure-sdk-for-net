...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the UpdateComputePolicyParameters
        /// class.
        /// </summary>
        ...
        public UpdateComputePolicyParameters(System.Guid? objectId = default(System.Guid?), string objectType = default(string), int? maxDegreeOfParallelismPerJob = default(int?), int? minPriorityPerJob = default(int?))
        {
            ObjectId = objectId;
