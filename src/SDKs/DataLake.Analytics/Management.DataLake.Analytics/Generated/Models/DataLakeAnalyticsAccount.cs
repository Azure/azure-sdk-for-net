...
namespace Microsoft.Azure.Management.DataLake.Analytics.Models
{
    ...
    public partial class DataLakeAnalyticsAccount : Resource
    {
        ...
        public DataLakeAnalyticsAccount(string location, string defaultDataLakeStoreAccount, IList<AddDataLakeStoreWithAccountParameters> dataLakeStoreAccounts, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), DataLakeAnalyticsAccountStatus? provisioningState = default(DataLakeAnalyticsAccountStatus?), DataLakeAnalyticsAccountState? state = default(DataLakeAnalyticsAccountState?), System.DateTime? creationTime = default(System.DateTime?), System.DateTime? lastModifiedTime = default(System.DateTime?), string endpoint = default(string), System.Guid? accountId = default(System.Guid?), int? maxDegreeOfParallelism = default(int?), int? queryStoreRetention = default(int?), int? maxJobCount = default(int?), int? systemMaxDegreeOfParallelism = default(int?), int? systemMaxJobCount = default(int?), IList<AddStorageAccountWithAccountParameters> storageAccounts = default(IList<AddStorageAccountWithAccountParameters>), TierType? newTier = default(TierType?), TierType? currentTier = default(TierType?), FirewallState? firewallState = default(FirewallState?), FirewallAllowAzureIpsState? firewallAllowAzureIps = default(FirewallAllowAzureIpsState?), IList<CreateFirewallRuleWithAccountParameters> firewallRules = default(IList<CreateFirewallRuleWithAccountParameters>), int? maxDegreeOfParallelismPerJob = default(int?), int? minPriorityPerJob = default(int?), IList<CreateComputePolicyWithAccountParameters> computePolicies = default(IList<CreateComputePolicyWithAccountParameters>))
