...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    /// </summary>
    internal partial class MoveResourcesStatusOperations : IServiceOperations<HealthcareApisManagementClient>, IMoveResourcesStatusOperations
    {
        /// <summary>
        /// Initializes a new instance of the MoveResourcesStatusOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal MoveResourcesStatusOperations(HealthcareApisManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<object>> GetWithHttpMessagesAsync(string locationName, string operationResultId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.HealthcareApis/locations/{locationName}/moveResourcesStatus/{operationResultId}").ToString();
