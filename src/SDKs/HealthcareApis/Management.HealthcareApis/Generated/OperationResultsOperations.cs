...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    /// </summary>
    internal partial class OperationResultsOperations : IServiceOperations<HealthcareApisManagementClient>, IOperationResultsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OperationResultsOperations(HealthcareApisManagementClient client)
        {
            if (client == null)
            {
