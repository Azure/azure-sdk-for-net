        ...
        public async Task<JobCreateResponse> CreateAsync(JobCreateParameters parameters, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (responseDoc != null)
                    {
                        JToken jobValue = responseDoc["Job"];
                        if (jobValue != null)
                        {
                            Job jobInstance = new Job();
                            result.Job = jobInstance;
                            
                            JToken idValue = jobValue["id"];
                            if (idValue != null)
                            {
                            ...
                            JToken startTimeValue = jobValue["startTime"];
                            ...
                            JToken actionValue2 = jobValue["action"];
                            ...
                            JToken recurrenceValue2 = jobValue["recurrence"];
                            ...
                            JToken statusValue = jobValue["status"];
                            if (statusValue != null)
                            {
                            ...
                            JToken stateValue = jobValue["state"];
                            if (stateValue != null)
                            {
                                // how
                ...
                try
                {
                    ...
                    if (responseDoc != null)
                    {
                        ...
                        if (jobValue != null)
                        {
                            ...
                            JToken actionValue = jobValue["action"];
                            if (actionValue != null)
                            {
                                JobAction actionInstance = new JobAction();
                                jobInstance.Action = actionInstance;
                            ...
                            JToken recurrenceValue = jobValue["recurrence"];
        ...
        public async Task<JobGetHistoryResponse> GetHistoryAsync(string jobId, JobGetHistoryParameters parameters, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (responseDoc != null)
                    {
                        JArray jobHistoryArray = (JArray)responseDoc["JobHistory"];
        ...
        public async Task<JobListResponse> ListAsync(JobListParameters parameters, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (responseDoc != null)
                    {
                        JArray jobsArray = (JArray)responseDoc["Jobs"];
                        if (jobsArray != null)
                        {
