...
namespace SqlMigrationManagementClient
{
    ...
    /// <summary> The DatabaseMigrationsMongoToCosmosDbRUMongo service client. </summary>
    public partial class DatabaseMigrationsMongoToCosmosDbRUMongoClient
    {
        ...
        /// <summary> Initializes a new instance of DatabaseMigrationsMongoToCosmosDbRUMongoClient for mocking. </summary>
        protected DatabaseMigrationsMongoToCosmosDbRUMongoClient()
        {
        }

        /// <summary> Initializes a new instance of DatabaseMigrationsMongoToCosmosDbRUMongoClient. </summary>
        ...
        public DatabaseMigrationsMongoToCosmosDbRUMongoClient(string subscriptionId) : this(new Uri("https://management.azure.com"), subscriptionId, new SqlMigrationManagementClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public DatabaseMigrationsMongoToCosmosDbRUMongoClient(Uri endpoint, string subscriptionId, SqlMigrationManagementClientOptions options)
        {
        ...
        /// <include file="Docs/DatabaseMigrationsMongoToCosmosDbRUMongoClient.xml" path="doc/members/member[@name='GetDatabaseMigrationsMongoToCosmosDbRUMongoAsync(string,string,string,RequestContext)']/*" />
        public virtual async Task<Response> GetDatabaseMigrationsMongoToCosmosDbRUMongoAsync(string resourceGroupName, string targetResourceName, string migrationName, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("DatabaseMigrationsMongoToCosmosDbRUMongoClient.GetDatabaseMigrationsMongoToCosmosDbRUMongo");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetDatabaseMigrationsMongoToCosmosDbRUMongoRequest(resourceGroupName, targetResourceName, migrationName, context);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/DatabaseMigrationsMongoToCosmosDbRUMongoClient.xml" path="doc/members/member[@name='GetDatabaseMigrationsMongoToCosmosDbRUMongo(string,string,string,RequestContext)']/*" />
        public virtual Response GetDatabaseMigrationsMongoToCosmosDbRUMongo(string resourceGroupName, string targetResourceName, string migrationName, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(targetResourceName, nameof(targetResourceName));
            Argument.AssertNotNullOrEmpty(migrationName, nameof(migrationName));
        ...
        /// <include file="Docs/DatabaseMigrationsMongoToCosmosDbRUMongoClient.xml" path="doc/members/member[@name='GetForScopeAsync(string,string,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetForScopeAsync(string resourceGroupName, string targetResourceName, RequestContext context)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "DatabaseMigrationsMongoToCosmosDbRUMongoClient.GetForScope", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/DatabaseMigrationsMongoToCosmosDbRUMongoClient.xml" path="doc/members/member[@name='GetForScope(string,string,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetForScope(string resourceGroupName, string targetResourceName, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetForScopeRequest(resourceGroupName, targetResourceName, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetForScopeNextPageRequest(nextLink, resourceGroupName, targetResourceName, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "DatabaseMigrationsMongoToCosmosDbRUMongoClient.GetForScope", "value", "nextLink", context);
        }
        ...
        /// <include file="Docs/DatabaseMigrationsMongoToCosmosDbRUMongoClient.xml" path="doc/members/member[@name='CreateAsync(WaitUntil,string,string,string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> CreateAsync(WaitUntil waitUntil, string resourceGroupName, string targetResourceName, string migrationName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("DatabaseMigrationsMongoToCosmosDbRUMongoClient.Create");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCreateRequest(resourceGroupName, targetResourceName, migrationName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "DatabaseMigrationsMongoToCosmosDbRUMongoClient.Create", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/DatabaseMigrationsMongoToCosmosDbRUMongoClient.xml" path="doc/members/member[@name='Create(WaitUntil,string,string,string,RequestContent,RequestContext)']/*" />
        public virtual Operation<BinaryData> Create(WaitUntil waitUntil, string resourceGroupName, string targetResourceName, string migrationName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCreateRequest(resourceGroupName, targetResourceName, migrationName, content, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "DatabaseMigrationsMongoToCosmosDbRUMongoClient.Create", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/DatabaseMigrationsMongoToCosmosDbRUMongoClient.xml" path="doc/members/member[@name='DeleteAsync(WaitUntil,string,string,string,bool?,RequestContext)']/*" />
        public virtual async Task<Operation> DeleteAsync(WaitUntil waitUntil, string resourceGroupName, string targetResourceName, string migrationName, bool? force = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("DatabaseMigrationsMongoToCosmosDbRUMongoClient.Delete");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteRequest(resourceGroupName, targetResourceName, migrationName, force, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "DatabaseMigrationsMongoToCosmosDbRUMongoClient.Delete", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/DatabaseMigrationsMongoToCosmosDbRUMongoClient.xml" path="doc/members/member[@name='Delete(WaitUntil,string,string,string,bool?,RequestContext)']/*" />
        public virtual Operation Delete(WaitUntil waitUntil, string resourceGroupName, string targetResourceName, string migrationName, bool? force = null, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateDeleteRequest(resourceGroupName, targetResourceName, migrationName, force, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "DatabaseMigrationsMongoToCosmosDbRUMongoClient.Delete", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        internal HttpMessage CreateGetDatabaseMigrationsMongoToCosmosDbRUMongoRequest(string resourceGroupName, string targetResourceName, string migrationName, RequestContext context)
        {
