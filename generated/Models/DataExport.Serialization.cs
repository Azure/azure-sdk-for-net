...
{
    public partial class DataExport : IUtf8JsonSerializable
    {
        ...
        internal static DataExport DeserializeDataExport(JsonElement element)
        {
            ...
            return new DataExport(id.Value, name.Value, type.Value, dataExportId.Value, Optional.ToList(tableNames), Optional.ToNullable(enable), createdDate.Value, lastModifiedDate.Value, resourceId.Value, Optional.ToNullable(type0), eventHubName.Value);
        }
    }
}
