...
namespace OperationalInsightsManagementClient.Models
{
    ...
    internal partial class LinkedStorageAccountsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<LinkedStorageAccountsResource>();
        }

        /// <summary> Initializes a new instance of LinkedStorageAccountsListResult. </summary>
        /// <param name="value"> A list of linked storage accounts instances. </param>
        internal LinkedStorageAccountsListResult(IReadOnlyList<LinkedStorageAccountsResource> value)
        {
            Value = value;
        }

        /// <summary> A list of linked storage accounts instances. </summary>
        public IReadOnlyList<LinkedStorageAccountsResource> Value { get; }
    }
}
