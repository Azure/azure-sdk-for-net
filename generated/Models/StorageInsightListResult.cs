...
namespace OperationalInsightsManagementClient.Models
{
    ...
    internal partial class StorageInsightListResult
    {
        ...
        {
            Value = new ChangeTrackingList<StorageInsight>();
        }
        ...
        internal StorageInsightListResult(IReadOnlyList<StorageInsight> value, string odataNextLink)
        {
            Value = value;
        ...
        public IReadOnlyList<StorageInsight> Value { get; }
