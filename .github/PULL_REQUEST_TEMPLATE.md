...
- [ ] Management metadata is included.
...
- If the check fails at the `Verify Code Generation` step, please ensure:
	...
	- Do not selective include generated files in the PR.
	- Do run use `generate.ps1/cmd` to generate this PR instead of calling `autorest` directly.
