...
namespace Microsoft.WindowsAzure.ServiceLayer
{
    ...
    internal static class Validator
    {
        ...
        internal static void ArgumentIsNotNullOrEmptyString(string argumentName, string value)
        {
            ...
            {
                string message = string.Format(CultureInfo.InvariantCulture, Resources.ErrorArgumentMustBeNonEmpty, argumentName);
        ...
        internal static void ArgumentIsNonNegative(string argumentName, int value)
        {
            ...
            if (value < 0)
            {
                string message = string.Format(CultureInfo.InvariantCulture, Resources.ErrorArgumentMustBeZeroOrPositive, argumentName, value);
                throw new ArgumentException(message);
            }
        }
        ...
        internal static void ArgumentIsPositive(string argumentName, int value)
        {
            ...
            if (value <= 0)
            {
                string message = string.Format(CultureInfo.InvariantCulture, Resources.ErrorArgumentMustBePositive, argumentName, value);
                throw new ArgumentException(message);
            }
        }
    }
