...
### Prerequisites:
  ...
  Note, after done, run "_dnvm list_" command to check the 'coreclr' runtime is installed with right version of '_1.0.0-rc1-final_'. If not, run “_dnvm install 1.0.0-rc1-final -r coreclr -a x64 -p_”. Remember always use "_-p_" flag, so the selection can persist. 
