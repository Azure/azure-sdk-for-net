...
var serviceBusClient = new Microsoft.WindowsAzure.Services.ServiceBus.ServiceBusClient("<specify the serviceNamespace>", "<issuerName>", "<issuerPassword>");
...
function asyncSendMessage() {
    return new WinJS.Promise(function (complete, onerror) {
        ...
        var queueName = document.getElementById('queuenameTextBox').value;
        var message = new Microsoft.WindowsAzure.Services.ServiceBus.BrokeredMessageSettings.createFromText(messageTxt);
