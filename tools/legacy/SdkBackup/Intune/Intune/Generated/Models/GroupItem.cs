...
namespace Microsoft.Azure.Management.Intune.Models
{
    ...
    public partial class GroupItem : Resource
    {
        ...
        /// Initializes a new instance of the GroupItem class.
        /// </summary>
        public GroupItem(string friendlyName, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string))
