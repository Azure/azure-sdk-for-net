...
The script checks several indicators to determine if a library uses TypeSpec:

1. Checks for "typespec" or "tsp" keywords in `src/autorest.md`
2. Looks for `src/tspconfig.yaml`
3. Checks for a `src/tsp` directory
