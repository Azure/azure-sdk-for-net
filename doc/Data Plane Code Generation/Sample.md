Samples are where developers could start to learn a library. You should generate samples scaffold by running [quick start tool](AzureSDKCodeGeneration_DataPlane_Quickstart.md#create-starter-package). The samples should match the structure containing the following key features:
```
├── ...
├── samples
│   ├── README.md
