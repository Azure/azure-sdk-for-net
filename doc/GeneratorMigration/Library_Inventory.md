...
**Migration Status**: 32 / 59 migrated to TypeSpec-based generator

| Service | Library | Mgmt Peer Library | Generator |
| ------- | ------- | ----------------- | --------- |
| alertsmanagement | Azure.Provisioning.AlertProcessingRules | Azure.ResourceManager.AlertProcessingRules ✅ | TypeSpec ✅ |
| alertsmanagement | Azure.Provisioning.AlertRuleRecommendations | Azure.ResourceManager.AlertRuleRecommendations ✅ | TypeSpec ✅ |
| alertsmanagement | Azure.Provisioning.AlertsManagement | Azure.ResourceManager.AlertsManagement ✅ | TypeSpec ✅ |
| alertsmanagement | Azure.Provisioning.PreviewAlertRule | Azure.ResourceManager.PreviewAlertRule ✅ | TypeSpec ✅ |
| alertsmanagement | Azure.Provisioning.PrometheusRuleGroups | Azure.ResourceManager.PrometheusRuleGroups ✅ | TypeSpec ✅ |
| alertsmanagement | Azure.Provisioning.TenantActivityLogAlerts | Azure.ResourceManager.TenantActivityLogAlerts ✅ | TypeSpec ✅ |
