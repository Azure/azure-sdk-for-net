...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class AzureStorageProtectableContainer : ProtectableContainer
    {
        ...
        /// Id.</param>
        public AzureStorageProtectableContainer(string friendlyName = default(string), BackupManagementType? backupManagementType = default(BackupManagementType?), string healthStatus = default(string), string containerId = default(string))
