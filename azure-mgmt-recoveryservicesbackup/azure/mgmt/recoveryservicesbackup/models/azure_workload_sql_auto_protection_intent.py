...
class AzureWorkloadSQLAutoProtectionIntent(AzureWorkloadAutoProtectionIntent):
    ...
    def __init__(self, backup_management_type=None, source_resource_id=None, item_id=None, policy_id=None, protection_state=None, workload_item_type=None):
        super(AzureWorkloadSQLAutoProtectionIntent, self).__init__(backup_management_type=backup_management_type, source_resource_id=source_resource_id, item_id=item_id, policy_id=policy_id, protection_state=protection_state)
