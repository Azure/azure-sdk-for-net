...
class AzureVmWorkloadItem(WorkloadItem):
    ...
    def __init__(self, backup_management_type=None, workload_type=None, friendly_name=None, protection_state=None, parent_name=None, server_name=None, is_auto_protectable=None, subinquireditemcount=None, sub_workload_item_count=None):
        super(AzureVmWorkloadItem, self).__init__(backup_management_type=backup_management_type, workload_type=workload_type, friendly_name=friendly_name, protection_state=protection_state)
