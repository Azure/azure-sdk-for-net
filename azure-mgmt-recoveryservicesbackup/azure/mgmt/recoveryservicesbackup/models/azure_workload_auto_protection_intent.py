...
class AzureWorkloadAutoProtectionIntent(AzureRecoveryServiceVaultProtectionIntent):
    ...
    def __init__(self, backup_management_type=None, source_resource_id=None, item_id=None, policy_id=None, protection_state=None):
        super(AzureWorkloadAutoProtectionIntent, self).__init__(backup_management_type=backup_management_type, source_resource_id=source_resource_id, item_id=item_id, policy_id=policy_id, protection_state=protection_state)
