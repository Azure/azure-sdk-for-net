...
class AzureWorkloadSQLRestoreRequest(AzureWorkloadRestoreRequest):
    ...
    def __init__(self, recovery_type=None, source_resource_id=None, property_bag=None, should_use_alternate_target_location=None, is_non_recoverable=None, target_info=None, alternate_directory_paths=None):
        super(AzureWorkloadSQLRestoreRequest, self).__init__(recovery_type=recovery_type, source_resource_id=source_resource_id, property_bag=property_bag)
