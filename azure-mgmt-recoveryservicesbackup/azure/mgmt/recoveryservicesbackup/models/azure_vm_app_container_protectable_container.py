...
class AzureVMAppContainerProtectableContainer(ProtectableContainer):
    ...
    def __init__(self, friendly_name=None, backup_management_type=None, health_status=None, container_id=None):
        super(AzureVMAppContainerProtectableContainer, self).__init__(friendly_name=friendly_name, backup_management_type=backup_management_type, health_status=health_status, container_id=container_id)
