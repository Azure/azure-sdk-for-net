...
class AzureWorkloadJob(Job):
    ...
    def __init__(self, entity_friendly_name=None, backup_management_type=None, operation=None, status=None, start_time=None, end_time=None, activity_id=None, workload_type=None, duration=None, actions_info=None, error_details=None, extended_info=None):
