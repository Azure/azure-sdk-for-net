...
class ProtectionContainerRefreshOperationResultsOperations(object):
    ...
    def get(
            self, vault_name, resource_group_name, fabric_name, operation_id, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_id: Operation ID associated with the operation whose
    ...
    get.metadata = {'url': '/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{vaultName}/backupFabrics/{fabricName}/operationResults/{operationId}'}
